...
@interface AVAudioFile : NSObject {
    struct unique_ptr<AVAudioFileImpl, std::default_delete<AVAudioFileImpl>> { 
        struct __compressed_pair<AVAudioFileImpl *, std::default_delete<AVAudioFileImpl>> { 
            struct AVAudioFileImpl {} *__value_; 
        } __ptr_; 
    }  _impl;
}
