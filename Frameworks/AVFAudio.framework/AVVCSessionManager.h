...
- (bool)getSiriInputSource:(unsigned long long*)arg1 withIdentifier:(id*)arg2 withIsMicrophoneCheck:(bool*)arg3 forActivationMode:(long long)arg4;
...
- (id)pickedRoute;
- (id)playbackRoute;
- (bool)predictIfMicrophoneShouldBeUsedForActivationMode:(long long)arg1;
...
- (bool)setIsUsingBuiltInMicForRecording:(bool)arg1 error:(id*)arg2;
...
- (bool)setPrefersBeingInterruptedByNextActiveRecordingClient:(bool)arg1 error:(id*)arg2;
