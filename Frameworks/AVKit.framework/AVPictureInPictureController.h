...
@interface AVPictureInPictureController : NSObject <AVPictureInPictureControlsStyleAppearance, AVPictureInPicturePlatformAdapterDelegate> {
    <AVPictureInPictureControllerExtendedDelegate> * __extendedDelegate;
...
@property (nonatomic) <AVPictureInPictureControllerExtendedDelegate> *_extendedDelegate;
...
- (void)_logContentSourceType:(id)arg1;
...
- (void)set_extendedDelegate:(id)arg1;
- (id)source;
