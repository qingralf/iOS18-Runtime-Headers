...
@interface AVPlayerController : NSObject {
    ...
    long long  _captionAppearanceDisplayType;
...
@property (nonatomic, readonly) bool isPlayingHDRContent;
...
- (bool)_isScanningTV;
- (id)_languageCodesFromLanguageIdentifiers:(id)arg1;
...
- (void)_setMostRecentChosenOption:(id)arg1;
...
- (void)setCurrentAssetMediaOption:(id)arg1;
...
- (bool)setLegibleMediaOptionVisibility:(bool)arg1 prefersLastKnownCaptionType:(bool)arg2 prefersSystemLanguage:(bool)arg3;
...
- (void)setMediaOptionCriteriaAlwaysOn:(bool)arg1;
