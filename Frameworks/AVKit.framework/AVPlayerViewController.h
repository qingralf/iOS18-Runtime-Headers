...
@interface AVPlayerViewController : UIViewController <AVContentOverlayViewDelegate, AVFullScreenViewControllerDelegate, AVInterstitialControllerDelegateManager, AVMobileChromelessControlsViewControllerDelegate, AVPictureInPictureContentSource, AVPictureInPictureControllerDelegate, AVPlaybackControlsViewVisibilityDelegate, AVPlaybackSpeedCollectionDelegate, AVPlayerControllerDelegate, AVPlayerViewControllerContentViewDelegate, AVScrollingObserverDelegate, AVScrubbingGestureControllerDelegate, AVSmartSubtitlesControllerDelegate, AVTransitionControllerDelegate, AVVideoFrameVisualAnalyzerDelegate, AVVisualAnalysisViewDelegate, UIGestureRecognizerDelegate, UIPopoverPresentationControllerDelegate> {
    ...
    bool  _playbackControlsIncludeFullScreenLoadingSpinner;
    ...
    bool  _prefersDeviceUserInterfaceStyle;
...
@property (nonatomic) bool playbackControlsIncludeFullScreenLoadingSpinner;
...
@property (nonatomic) bool prefersDeviceUserInterfaceStyle;
...
@property (setter=vui_setAllowInfoMetadataSubpanel:, nonatomic) bool vui_allowInfoMetadataSubpanel;
...
- (double)_availableSpaceForContentTabWithVideoDodgingForSize:(struct CGSize { double x1; double x2; })arg1;
...
- (bool)_wantsNowPlayingInfoCenter:(bool)arg1;
...
- (struct { double x1; unsigned long long x2; })chromelessControlsViewController:(id)arg1 contentTabPresentationInfoWithPreferredHeight:(double)arg2;
...
- (void)chromelessControlsViewControllerDidPressSkipBackButton:(id)arg1;
- (void)chromelessControlsViewControllerDidPressSkipForwardButton:(id)arg1;
- (id)configuration;
...
- (bool)observesMediaSelectionForSmartSubtitlesController:(id)arg1;
...
- (void)pictureInPictureControllerDidSkipBackwardInPictureInPicture:(id)arg1;
- (void)pictureInPictureControllerDidSkipForwardInPictureInPicture:(id)arg1;
...
- (void)playerControllerDidUpdateIsPlayingHDRContent:(id)arg1;
- (id)playerLayerView;
...
- (long long)preferredPlaybackControlsSupplementalSubtitleDisplayOption;
...
- (id)presentingViewControllerForVisualAnalysisView:(id)arg1;
- (id)privateDelegate;
...
- (void)setPlaybackControlsIncludeFullScreenLoadingSpinner:(bool)arg1;
...
- (void)setPreferredPlaybackControlsSupplementalSubtitleDisplayOption:(long long)arg1;
- (void)setPreferredUnobscuredArea:(long long)arg1;
- (void)setPrefersDeviceUserInterfaceStyle:(bool)arg1;
...
- (bool)vui_allowInfoMetadataSubpanel;
- (void)vui_setAllowInfoMetadataSubpanel:(bool)arg1;
