...
@property (nonatomic, readonly) AVChromedLabel *detachedScrubInstructionsBackdropLabel;
...
@property (nonatomic, readonly) AVChromedLabel *elapsedTimeLabel;
...
@property (nonatomic, readonly) AVChromedLabel *liveBroadcastLabel;
@property (nonatomic, readonly) AVChromedLabel *liveBroadcastScrubberLabel;
...
@property (nonatomic, readonly) AVChromedLabel *timeRemainingLabel;
