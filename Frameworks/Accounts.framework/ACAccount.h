...
@property (nonatomic, readonly) unsigned long long aa_ageCategory;
...
@property (getter=ams_didAcknowledgeBundleHolderPrivacyAcknowledgementOnDevice, setter=ams_setDidAcknowledgeBundleHolderPrivacyAcknowledgementOnDevice:, nonatomic) bool ams_didAcknowledgeBundleHolderPrivacyAcknowledgementOnDevice;
@property (getter=ams_isEphemeralAccount, nonatomic, readonly) bool ams_ephemeralAccount;
...
@property (getter=ams_isRegulatoryAccount, nonatomic, readonly) bool ams_regulatoryAccount;
@property (getter=ams_isRegulatoryAccount, setter=ams_setRegulatoryAccount:, nonatomic) bool ams_regulatoryAccount;
...
@property (getter=ic_isU18MinorAccount, nonatomic, readonly) bool ic_u18MinorAccount;
...
- (id)changeTypeForEnabledDataclass:(id)arg1;
- (id)changeTypeForProvisionedDataclass:(id)arg1;
- (id)childAccounts;
...
- (id)creationDate;
- (id)credential;
- (unsigned long long)credentialLocation;
- (id)credentialType;
...
- (void)setCredentialLocation:(unsigned long long)arg1;
...
- (void)_aa_setTermsServerInfo:(id)arg1;
...
+ (id)ams_globalEphemeralAccountPropertiesForAccount:(id)arg1;
...
- (id)_ephemeralAccountPropertyForKey:(id)arg1 dataProtectionClass:(unsigned long long)arg2 expectedClasses:(id)arg3 error:(id*)arg4;
- (id)_hashedActiveState;
- (id)_hashedIdentifiers;
- (id)_hashedMultiUserIdentifiers;
- (id)_hashedMultiUserIdentifiers:(id)arg1;
...
- (void)_setEphemeralAccountProperty:(id)arg1 forKey:(id)arg2 dataProtectionClass:(unsigned long long)arg3 expectedClass:(Class)arg4;
- (id)_updateCookiesWithCookiesToAdd:(id)arg1 cookiesToRemove:(id)arg2;
...
- (id)ams_altDSID;
- (id)ams_asynchronouslyAddCookies:(id)arg1;
- (id)ams_asynchronouslyAddCookiesForResponse:(id)arg1;
- (id)ams_asynchronouslyAddGlobalCookiesForResponse:(id)arg1;
...
- (void)ams_setDidAcknowledgeBundleHolderPrivacyAcknowledgementOnDevice:(bool)arg1;
...
- (void)ams_setRegulatoryAccount:(bool)arg1;
...
- (void)fetchCredentialTokenWithCompletion:(id /* block */)arg1;
