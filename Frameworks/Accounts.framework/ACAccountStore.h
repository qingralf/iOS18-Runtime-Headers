...
@interface ACAccountStore : NSObject <HKACAccountStoreProtocol, HMDACAccountStore> {
...
- (void)_performUpdateRequestWithAccount:(id)arg1 serverInfo:(id)arg2 completion:(id /* block */)arg3;
...
- (void)aa_updatePropertiesForAppleAccount:(id)arg1 options:(id)arg2 serverInfo:(id)arg3 completion:(id /* block */)arg4;
...
+ (struct __CFDictionary { }*)_baseQueryDictionaryForIdentifier:(id)arg1 numValues:(long long*)arg2;
+ (bool)_isAccountsCachingEnabled;
+ (id)_multiUserTokenForIdentifier:(id)arg1;
+ (id)_secureTokenForIdentifier:(id)arg1 error:(id*)arg2;
...
- (id)_addGlobalCookiesForResponse:(id)arg1;
- (id)_addUserCookiesForResponse:(id)arg1 account:(id)arg2;
...
- (void)_ams_saveAccount:(id)arg1 withOptions:(long long)arg2 sync:(bool)arg3 completion:(id /* block */)arg4;
...
- (bool)_createLocaliTunesAccountForAccountType:(id)arg1 error:(id*)arg2;
- (id)_fetchLocalAccountForAccountType:(id)arg1 error:(id*)arg2;
...
- (id)ams_addCookiesForResponse:(id)arg1 account:(id)arg2;
...
- (id)ams_addCookiesForResult:(id)arg1 account:(id)arg2;
...
- (id)ams_fetchGrandSlamTokenForAccount:(id)arg1 withIdentifier:(id)arg2;
...
- (id)ams_localiTunesAccountForAccountMediaType:(id)arg1 error:(id*)arg2;
- (id)ams_localiTunesAccountForAccountType:(id)arg1;
- (id)ams_localiTunesAccountForAccountType:(id)arg1 error:(id*)arg2;
...
- (bool)ams_saveVerifiedAccount:(id)arg1 error:(id*)arg2;
- (bool)ams_saveVerifiedAccount:(id)arg1 withOptions:(long long)arg2 error:(id*)arg3;
...
- (id)_dmc_accountWithType:(id)arg1 error:(id*)arg2 criteria:(id /* block */)arg3;
...
- (bool)dmc_conflictingAccountsExistWithAltDSID:(id)arg1 error:(id*)arg2;
...
- (void)_gkRenewCredentialForUsername:(id)arg1 completionHandler:(id /* block */)arg2;
...
+ (bool)ic_canAccessAccountStore;
+ (bool)ic_canAccessAppleAccounts;
