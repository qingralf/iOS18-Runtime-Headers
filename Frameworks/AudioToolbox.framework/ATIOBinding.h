...
@property (nonatomic, readonly) struct ATIsolatedAudioUseCaseID { unsigned int x1; } useCaseID;
...
- (id)initWithUseCaseID:(struct ATIsolatedAudioUseCaseID { unsigned int x1; })arg1;
- (bool)isEqual:(id)arg1;
- (id)session;
- (unsigned int)sessionID;
- (struct ATIsolatedAudioUseCaseID { unsigned int x1; })useCaseID;
