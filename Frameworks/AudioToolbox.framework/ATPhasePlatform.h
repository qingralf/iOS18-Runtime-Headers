...
@property (nonatomic, readonly) <PHASERoomCongruenceInterface> *roomCongruenceInterface; /* unknown property attribute: ? */
@property (nonatomic, readonly) bool running;
@property (nonatomic, readonly) double sampleRate;
@property (nonatomic, readonly) <PHASESessionInterface> *sessionInterface; /* unknown property attribute: ? */
@property (readonly) Class superclass;
@property (nonatomic, readonly) <PHASETapInterface> *tapInterface;
@property (nonatomic, readonly) OS_os_workgroup *workgroup; /* unknown property attribute: ? */
...
- (int)muteAudioSessionBidirectional:(unsigned int)arg1 mute:(bool)arg2 inputFadeTime:(float)arg3 outputFadeTime:(float)arg4;
