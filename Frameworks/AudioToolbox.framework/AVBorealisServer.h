...
@interface AVBorealisServer : NSObject <NSXPCListenerDelegate, VoiceTriggerInterface> {
    ...
    struct BorealisServerImpl { int (**x1)(); unsigned int x2; struct HALListener {} *x3; struct HALListener {} *x4; struct HALListener {} *x5; int x6; char *x7; char *x8; bool x9; bool x10; bool x11; bool x12; bool x13; id x14; id x15; int x16; struct unfair_recursive_lock {} *x17; id x18; bool x19; unsigned int x20; id x21; } * serverImpl;
}
...
- (void).cxx_destruct;
- (void)activateSecureSession:(bool)arg1 reply:(id /* block */)arg2;
