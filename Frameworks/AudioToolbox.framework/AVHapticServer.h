...
- (id).cxx_construct;
- (void).cxx_destruct;
- (void)HandleInterruptionForSession:(const void*)arg1 command:(unsigned int)arg2 dictionary:(struct __CFDictionary { }*)arg3;
...
- (void)dealloc;
- (void)decrementInit;
- (void)decrementPrewarmCountAndStopAudio:(bool)arg1 stopHaptics:(bool)arg2 entry:(struct shared_ptr<ClientEntry> { struct ClientEntry {} *x1; struct __shared_weak_count {} *x2; })arg3;
...
- (void)incrementPrewarmCountForAudio:(bool)arg1 haptics:(bool)arg2 entry:(struct shared_ptr<ClientEntry> { struct ClientEntry {} *x1; struct __shared_weak_count {} *x2; })arg3;
...
- (int)loadSynthPreset;
- (void*)manager;
- (int)playVibePattern:(void*)arg1 gain:(float)arg2 synchronizer:(struct SSPlayerSynchronizer { }*)arg3 flags:(unsigned int)arg4 atTime:(double)arg5 completionHandler:(id /* block */)arg6;
- (void)removeListener:(id)arg1 withAudioSessionID:(unsigned int)arg2;
- (void)removeProcessEntry:(unsigned long long)arg1;
- (bool)setupSSSClient;
- (bool)shouldUnprewarmAllClientsAfterDisplayingPrewarmedProcessEntriesWithPrewarmTime:(unsigned long long)arg1;
- (int)startPrewarm;
- (int)stopPrewarm;
