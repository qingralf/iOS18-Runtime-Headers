...
@interface ASAuthorizationSecurityKeyPublicKeyCredentialProvider : NSObject <ASAuthorizationProvider, ASAuthorizationWebBrowserSecurityKeyPublicKeyCredentialProvider> {
...
- (id)createCredentialRegistrationRequestWithClientData:(id)arg1 displayName:(id)arg2 name:(id)arg3 userID:(id)arg4;
