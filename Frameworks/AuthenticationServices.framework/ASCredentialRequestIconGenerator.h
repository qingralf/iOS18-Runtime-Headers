...
+ (id)_iconForPresentationContext:(id)arg1 size:(struct CGSize { double x1; double x2; })arg2 outIconStyle:(long long*)arg3;
...
+ (id)iconForData:(id)arg1 scale:(double)arg2 size:(struct CGSize { double x1; double x2; })arg3;
