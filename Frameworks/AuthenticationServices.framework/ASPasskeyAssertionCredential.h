...
@property (nonatomic, copy) ASPasskeyAssertionCredentialExtensionOutput *extensionOutput;
...
- (id)initWithUserHandle:(id)arg1 relyingParty:(id)arg2 signature:(id)arg3 clientDataHash:(id)arg4 authenticatorData:(id)arg5 credentialID:(id)arg6 extensionOutput:(id)arg7;
- (id)relyingParty;
- (void)setExtensionOutput:(id)arg1;
- (id)signature;
- (id)userHandle;
