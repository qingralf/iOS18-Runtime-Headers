...
@property (nonatomic, copy) ASPasskeyRegistrationCredentialExtensionOutput *extensionOutput;
...
- (id)initWithRelyingParty:(id)arg1 clientDataHash:(id)arg2 credentialID:(id)arg3 attestationObject:(id)arg4 extensionOutput:(id)arg5;
- (id)relyingParty;
