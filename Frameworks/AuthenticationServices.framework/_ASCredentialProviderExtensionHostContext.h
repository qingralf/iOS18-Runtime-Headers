...
- (void)prepareToCompleteOneTimeCodeRequestWithSelectedCredential:(id)arg1 completion:(id /* block */)arg2;
...
- (void)prepareToCompleteRequestWithSelectedText:(id)arg1 completion:(id /* block */)arg2;
