...
+ (void)networkProcessWithBundleID:(id)arg1 interruptionHandler:(id /* block */)arg2 completion:(id /* block */)arg3;
+ (void)networkProcessWithInterruptionHandler:(id /* block */)arg1 completion:(id /* block */)arg2;
