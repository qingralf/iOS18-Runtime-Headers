...
+ (void)renderingProcessWithBundleID:(id)arg1 interruptionHandler:(id /* block */)arg2 completion:(id /* block */)arg3;
+ (void)renderingProcessWithInterruptionHandler:(id /* block */)arg1 completion:(id /* block */)arg2;
