...
@property (readonly) bool ams_isFraudReportCallbackResponse;
@property (readonly) bool ams_isFraudReportInitURLResponse;
@property (readonly) bool ams_isFraudReportRetryResponse;
