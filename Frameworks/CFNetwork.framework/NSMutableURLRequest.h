...
- (void)_setAllowOnlyPartitionedCookies:(bool)arg1;
- (void)_setAllowPrivateAccessTokensForThirdParty:(bool)arg1;
- (void)_setAllowsUCA:(bool)arg1;
...
- (void)_setSchemeWasUpgradedDueToDynamicHSTS:(bool)arg1;
...
- (void)setAllowsPersistentDNS:(bool)arg1;
...
- (void)setCookiePartitionIdentifier:(id)arg1;
...
- (id)ams_addHeadersFromPromise:(id)arg1;
...
- (id)ams_modifyRequestWithBlock:(id /* block */)arg1;
- (void)ams_removeAnisetteHeaders;
- (void)ams_removeFPDIHeaders;
- (bool)ams_setBodyParameters:(id)arg1 encoding:(long long)arg2 compressBody:(bool)arg3 error:(id*)arg4;
...
- (void)ak_addHeaderForDCRT:(id)arg1;
...
- (void)ak_addPreviousTransactionIdHeader:(id)arg1;
...
- (void)ak_addServiceHeaderForServiceType:(long long)arg1;
...
- (void)ndo_addBasicHeadersWithBundleID:(id)arg1;
- (void)ndo_addOASHeadersWithOfferID:(id)arg1 serialNumber:(id)arg2 primarySerialNumber:(id)arg3;
- (void)ndo_setCoverageRequestBodyWithSerialNumber:(id)arg1 primarySerialNumber:(id)arg2 displayedEvents:(id)arg3;
- (void)ndo_setDeviceListRequestBodyWithSerialNumber:(id)arg1 localDevices:(id)arg2 primaryAccount:(id)arg3;
- (bool)ndo_signWithAccountHeaders:(bool)arg1 avoidUI:(bool)arg2;
- (id)storeLocale;
- (id)storeLocaleWithAccountStore:(id)arg1;
...
- (void)icq_renewAuthorizationHeadersForAccount:(id)arg1 store:(id)arg2 completion:(id /* block */)arg3;
