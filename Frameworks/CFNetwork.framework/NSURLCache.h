...
+ (id)_tps_cacheDirectoryURLForIdentifier:(id)arg1;
+ (id)tps_urlCacheWithIdentifier:(id)arg1 memoryCapacity:(unsigned long long)arg2 diskCapacity:(unsigned long long)arg3;
