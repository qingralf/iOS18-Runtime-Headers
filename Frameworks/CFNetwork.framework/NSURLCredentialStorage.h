...
+ (id)_safari_personalSidecarDictionaryForPasskeyWithUserHandle:(id)arg1 relyingPartyID:(id)arg2 groupID:(id)arg3;
+ (id)safari_customTitleForPasskeyWithUserHandle:(id)arg1 relyingPartyID:(id)arg2 groupID:(id)arg3;
+ (void)safari_setLastUsedDate:(id)arg1 forPasskeyWithUserHandle:(id)arg2 relyingPartyID:(id)arg3 groupID:(id)arg4 context:(id)arg5;
+ (id)safari_test_addTestingPasskeyItemWithCredentialID:(id)arg1 groupID:(id)arg2 toRecentlyDeleted:(bool)arg3;
...
- (bool)_safari_copyPersonalSidecar:(id)arg1 fromGroupWithID:(id)arg2 toGroupWithID:(id)arg3 fromRecentlyDeleted:(bool)arg4;
- (bool)_safari_copyPersonalSidecarFromPersonalKeychainToSharedPersonalAccessGroup:(id)arg1 forGroupWithID:(id)arg2 fromRecentlyDeleted:(bool)arg3;
- (bool)_safari_copyPersonalSidecarFromSharedPersonalAccessGroupToPersonalKeychain:(id)arg1 fromRecentlyDeleted:(bool)arg2;
- (bool)_safari_copyPersonalSidecarFromSharedPersonalAccessGroupToPersonalKeychain:(id)arg1 withNewUsername:(id)arg2 fromRecentlyDeleted:(bool)arg3;
- (bool)_safari_copySharedSidecar:(id)arg1 fromGroupWithID:(id)arg2 toGroupWithID:(id)arg3 fromRecentlyDeleted:(bool)arg4;
