...
@property bool _allowsPersistentDNS;
...
@property (readonly) bool _gkHasValidServerURLRequest;
...
- (void)set_allowsPersistentDNS:(bool)arg1;
...
- (bool)_gkHasValidServerURLRequest;
