...
@property (nonatomic, copy) CXCallTokens *callTokens;
...
@property (nonatomic, copy) CXHandle *initiator;
...
@property (nonatomic) bool supportsRecording;
...
- (void)setCallSubType:(long long)arg1;
- (void)setCallTokens:(id)arg1;
...
- (void)setScreenSharingType:(long long)arg1;
...
- (void)setSupportsRecording:(bool)arg1;
- (void)setSupportsScreening:(bool)arg1;
