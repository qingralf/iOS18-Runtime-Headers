...
@property (nonatomic, readonly, copy) NSMeasurement *distanceRemainingToDisplay;
...
- (id)distanceRemainingToDisplay;
- (void)encodeWithCoder:(id)arg1;
- (id)initWithCoder:(id)arg1;
- (id)initWithDistanceRemaining:(id)arg1 distanceRemainingDisplay:(id)arg2 timeRemaining:(double)arg3;
- (id)initWithDistanceRemaining:(id)arg1 distanceRemainingToDisplay:(id)arg2 timeRemaining:(double)arg3;
