...
- (void).cxx_destruct;
- (bool)_encodeRenderToCommandBuffer:(id)arg1 frameAttributes:(id)arg2 sourceImage:(struct __CVBuffer { }*)arg3 sourceDisparity:(struct __CVBuffer { }*)arg4 destinationTexture:(id)arg5;
- (id)commandQueue;
- (void)dealloc;
