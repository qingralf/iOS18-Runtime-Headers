...
@interface CLSPerson : CLSObject <CLSContactsSearchable, CRKClassKitPerson> {
    NSString * _appleID;
...
@property (getter=isAccountFailedPasswordLocked, nonatomic, readonly) bool accountFailedPasswordLocked;
...
@property (getter=isFederatedAccount, nonatomic, readonly) bool federatedAccount;
...
@property (nonatomic, readonly) NSString *groupIdentifier; /* unknown property attribute: ? */
