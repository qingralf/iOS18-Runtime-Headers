...
@interface CLSSearchSpecification : NSObject <NSCopying, NSSecureCoding> {
    ...
    bool  _includeEmptyGroupsInResults;
...
@property (nonatomic, copy) NSArray *groupLocationIDs;
@property (copy) NSArray *groupSortDescriptors;
@property bool includeEmptyGroupsInResults;
...
- (void)requireGroupMemberIDs:(id)arg1;
...
- (id)requiredGroupMemberGroupIDs;
...
- (void)restrictToGroupsAtLocationIDs:(id)arg1;
...
- (void)setGroupLocationIDs:(id)arg1;
- (void)setGroupSortDescriptors:(id)arg1;
- (void)setIncludeEmptyGroupsInResults:(bool)arg1;
...
- (void)setRequiredGroupMemberGroupIDs:(id)arg1;
