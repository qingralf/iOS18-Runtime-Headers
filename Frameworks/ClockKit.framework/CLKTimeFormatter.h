...
@interface CLKTimeFormatter : NSObject {
    ...
    bool  _zeroPadTimeSubstringToSeparatorText;
}
...
@property (nonatomic, retain) NSNumber *fontTrackingAttribute;
...
@property (nonatomic) bool zeroPadTimeSubstringToSeparatorText;
...
- (id)designatorText;
- (id)fontTrackingAttribute;
- (unsigned long long)forcedNumberSystem;
- (bool)forcesLatinNumbers;
- (bool)includeSeparatorInTimeSubstringFromSeparatorText;
- (id)init;
- (id)initWithForcedNumberSystem:(unsigned long long)arg1;
- (id)initWithForcedNumberSystem:(unsigned long long)arg1 clockTimer:(id)arg2;
...
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })separatorNSRangeInTimeText:(id)arg1;
...
- (void)setFontTrackingAttribute:(id)arg1;
- (void)setForcedNumberSystem:(unsigned long long)arg1;
...
- (void)setZeroPadTimeSubstringToSeparatorText:(bool)arg1;
- (bool)showSeconds;
...
- (id)timeText;
- (id)timeTextForNumberSystem:(unsigned long long)arg1;
- (id)timeZone;
