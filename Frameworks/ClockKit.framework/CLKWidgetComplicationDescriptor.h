...
@property (nonatomic, readonly, copy) CLKIntentReference *intentReference;
...
- (id)initWithExtensionBundleIdentifier:(id)arg1 containerBundleIdentifier:(id)arg2 kind:(id)arg3 intentReference:(id)arg4;
