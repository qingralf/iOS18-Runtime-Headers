...
- (void)dealloc;
- (id)init;
- (id)timeAndDesignatorFormatterForTimeZone:(id)arg1 suppressWhitespace:(bool)arg2 forcedNumberSystem:(unsigned long long)arg3;
- (id)timeOnlyFormatterForTimeZone:(id)arg1 hasSeconds:(bool)arg2 forcedNumberSystem:(unsigned long long)arg3;
