...
@property (nonatomic, retain) NSString *llvmProfileFile;
...
- (void)_reallySetPref:(id)arg1 forKey:(id)arg2;
...
- (double)containerProxyInactiveTimeoutWithDefaultValue:(double)arg1;
...
- (void)setContainerProxyInactiveTimeout:(id)arg1;
...
- (void)setLlvmProfileFile:(id)arg1;
- (void)setLogTraffic:(bool)arg1;
- (void)setMaxPCSSizeForKeyRolls:(long long)arg1;
...
- (void)setOverrideSavePolicyForShareRecords:(bool)arg1;
