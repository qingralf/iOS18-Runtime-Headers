...
@interface CKContainerOptions : NSObject <CKPropertiesDescription, CKSQLiteItem, NSCopying, NSSecureCoding> {
    bool  _acceptServerSignedRecords;
...
- (id)immediateUseDatabaseScopeForTesting;
- (id)init;
...
- (void)setAcceptServerSignedRecords:(bool)arg1;
...
- (void)setImmediateUseDatabaseScopeForTesting:(id)arg1;
...
- (void)setSupportedDeviceCapabilities:(id)arg1;
...
- (id)supportedDeviceCapabilities;
