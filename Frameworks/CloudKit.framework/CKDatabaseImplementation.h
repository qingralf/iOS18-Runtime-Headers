...
- (void)checkSupportedDeviceCapabilitiesInZone:(id)arg1 desiredCapabilities:(id)arg2 options:(id)arg3 wrappingDatabase:(id)arg4 convenienceConfiguration:(id)arg5 completionHandler:(id /* block */)arg6;
...
- (void)fetchPCSFromCacheForZoneWithID:(id)arg1 localCacheOnly:(bool)arg2 completionHandler:(id /* block */)arg3;
