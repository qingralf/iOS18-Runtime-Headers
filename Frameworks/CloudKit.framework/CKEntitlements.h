...
@interface CKEntitlements : NSObject <CKSQLiteItem, NSCopying> {
...
@property (nonatomic, readonly) bool hasAssetBoundaryKeyEntitlement;
...
@property (nonatomic, readonly) bool hasNetworkSocketDelegateEntitlement;
...
@property (nonatomic, readonly) bool hasTemporaryDeviceCapabilitiesEntitlement;
...
- (void)daemonInitHook:(struct { unsigned int x1[8]; })arg1 mutableEntitlements:(id)arg2;
