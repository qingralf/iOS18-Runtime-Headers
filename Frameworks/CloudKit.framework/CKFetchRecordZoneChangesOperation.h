...
@interface CKFetchRecordZoneChangesOperation : CKDatabaseOperation <CKFetchRecordZoneChangesOperationCallbacks> {
    ...
    id /* block */  _zoneAttributesChangedBlock_wrapper;
...
@property (nonatomic, copy) id /* block */ zoneAttributesChangedBlock_wrapper;
...
- (void)setZoneAttributesChangedBlock_wrapper:(id /* block */)arg1;
...
- (id /* block */)zoneAttributesChangedBlock_wrapper;
