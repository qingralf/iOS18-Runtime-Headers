...
@property (nonatomic, readonly) unsigned long long keyRollsSkippedBySizeCheck;
@property (nonatomic, readonly) unsigned long long keysNotRemoved;
@property (nonatomic, readonly) unsigned long long perRecordKeysRolled;
@property (nonatomic, readonly) double queueing;
@property (nonatomic, readonly) unsigned long long recordKeysRemoved;
...
@property (nonatomic, readonly) unsigned long long zoneKeysRemoved;
@property (nonatomic, readonly) unsigned long long zoneKeysRolled;
@property (nonatomic, readonly) unsigned long long zoneishKeysRemoved;
