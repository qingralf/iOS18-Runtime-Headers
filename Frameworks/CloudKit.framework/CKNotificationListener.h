...
- (void)_registerForSubscriptionWithID:(id)arg1 inDatabase:(id)arg2 handler:(id /* block */)arg3 completionHandler:(id /* block */)arg4;
- (void)_unregisterForSubscriptionWithID:(id)arg1 inDatabase:(id)arg2 completionHandler:(id /* block */)arg3;
- (id)apsConnectionForEnvironment:(id)arg1;
...
- (void)handlePushNotificationWithPayload:(id)arg1 environment:(id)arg2 completionHandler:(id /* block */)arg3;
