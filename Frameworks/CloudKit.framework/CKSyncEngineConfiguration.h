...
@interface CKSyncEngineConfiguration : NSObject <CKPropertiesDescription> {
    ...
    bool  _continueSendingChangesAfterFailure;
    <CKSyncEngineDataSource> * _dataSource;
    CKDatabase * _database;
    <CKSyncEngineDelegate> * _delegate;
    bool  _immediatePushSyncEnabled;
    long long  _priority;
...
@property (getter=isImmediatePushSyncEnabled, nonatomic) bool immediatePushSyncEnabled;
...
- (void)setContinueSendingChangesAfterFailure:(bool)arg1;
- (void)setDataSource:(id)arg1;
- (void)setDatabase:(id)arg1;
- (void)setDatabaseSubscriptionIDOverride:(id)arg1;
- (void)setDelegate:(id)arg1;
- (void)setImmediatePushSyncEnabled:(bool)arg1;
