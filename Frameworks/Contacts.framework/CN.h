...
+ (id)_unifyContacts:(id)arg1 options:(id)arg2;
...
+ (id)contactUnifyingContacts:(id)arg1 options:(id)arg2;
...
+ (id)unifyMultivalues:(id)arg1 forProperty:(id)arg2 options:(id)arg3;
