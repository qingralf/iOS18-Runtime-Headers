...
@interface CNContact : NSObject <ABSCNLegacyIdentifiable, CNContactAugmentation, CNSuggested, NSCopying, NSItemProviderReading, NSItemProviderWriting, NSMutableCopying, NSSecureCoding, PXFaceTileImageCombinerItem, PXPerson, TUSearchResult> {
...
@property (nonatomic, readonly, copy) NSDate *imageSyncFailedTime;
...
@property (nonatomic, readonly) bool overrideSensitiveContent;
...
@property (nonatomic, readonly) NSArray *phoneNumberLastFourDigitStrings;
...
@property (nonatomic, readonly, copy) CNSensitiveContentConfiguration *sensitiveContentConfiguration;
...
@property (nonatomic, readonly, copy) NSDate *wallpaperSyncFailedTime;
@property (nonatomic, readonly, copy) NSString *wallpaperURI;
...
+ (id)predicateForContactsMatchingSmartDialerString:(id)arg1;
...
- (id)initWithIdentifier:(id)arg1 persisted:(bool)arg2;
...
- (id)tu_emailAddressesMatchingPersonHandleLabel:(id)arg1;
- (bool)tu_labeledValue:(id)arg1 matchesPersonHandleLabel:(id)arg2;
- (id)tu_personHandleMatchingHandle:(id)arg1 isoCountryCodes:(id)arg2;
- (id)tu_phoneNumbersMatchingPersonHandleLabel:(id)arg1;
...
- (id)tu_localizedDisplayStringForHandle:(id)arg1;
