...
+ (bool)isAccessLimitedForEntityType:(long long)arg1;
+ (bool)isAccessRestrictedForEntityType:(long long)arg1;
+ (bool)isSharedNamePhotoEnabled;
+ (bool)isXPCDataMapperStoreForFavorites:(id)arg1;
+ (bool)isXPCDataMapperStoreForSpotlight:(id)arg1;
+ (id)logSpotlight;
...
- (id)ic_contactForEmailAddressString:(id)arg1 keysToFetch:(id)arg2;
- (id)ic_contactForHandleString:(id)arg1 keysToFetch:(id)arg2;
- (id)ic_contatForPhoneNumberString:(id)arg1 keysToFetch:(id)arg2;
