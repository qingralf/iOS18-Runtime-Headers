...
@property (nonatomic, readonly, copy) CNProviderMetadata *providerMetadata;
...
+ (id)predicateForContainerWithProviderIdentifier:(id)arg1;
...
+ (id)predicateForContainersWithType:(long long)arg1 includingDisabledContainers:(bool)arg2;
