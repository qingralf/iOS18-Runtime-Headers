...
@property (nonatomic, copy) NSDate *imageSyncFailedTime;
...
@property (nonatomic, copy) CNSensitiveContentConfiguration *sensitiveContentConfiguration;
...
@property (nonatomic, copy) NSDate *wallpaperSyncFailedTime;
@property (nonatomic, copy) NSString *wallpaperURI;
...
- (void)_setImageSyncFailedTime:(id)arg1;
...
- (void)_setSensitiveContentConfiguration:(id)arg1;
...
- (void)_setWallpaperSyncFailedTime:(id)arg1;
- (void)_setWallpaperURI:(id)arg1;
...
- (void)setImageSyncFailedTime:(id)arg1;
...
- (void)setSensitiveContentConfiguration:(id)arg1;
...
- (void)setWallpaperSyncFailedTime:(id)arg1;
- (void)setWallpaperURI:(id)arg1;
