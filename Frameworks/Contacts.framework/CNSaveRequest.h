...
@interface CNSaveRequest : NSObject <NSSecureCoding> {
    ...
    bool  _ignoresContactProviderRestrictions;
...
@property (nonatomic) bool ignoresContactProviderRestrictions;
...
- (void)setIgnoresContactProviderRestrictions:(bool)arg1;
