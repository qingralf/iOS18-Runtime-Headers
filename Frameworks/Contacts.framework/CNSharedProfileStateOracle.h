...
+ (id)descriptionForUpdateState:(unsigned long long)arg1;
...
+ (bool)isTinker;
+ (id)log;
+ (bool)nicknameHasValidVisualIdentityData:(id)arg1;
...
+ (bool)shouldSaveCurrentPoster:(id)arg1 toRecentsForContact:(id)arg2;
...
- (bool)didPhotoOrWallpaperChangeFrom:(id)arg1 to:(id)arg2;
