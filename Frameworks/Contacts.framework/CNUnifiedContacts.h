...
+ (unsigned long long)indexOfPreferredContactForWallpaper:(id)arg1 prefersSharedImage:(bool)arg2;
...
+ (id)sortedContacts:(id)arg1 withPreferredContact:(id)arg2;
...
+ (void)unifyWallpaperOfContacts:(id)arg1 intoContact:(id)arg2 availableKeyDescriptor:(id)arg3;
