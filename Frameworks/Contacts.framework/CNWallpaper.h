...
- (id)initWithPosterArchiveData:(id)arg1 contentIsSensitive:(bool)arg2;
- (id)initWithPosterArchiveData:(id)arg1 fontDescription:(id)arg2 fontColorDescription:(id)arg3 backgroundColorDescription:(id)arg4 extensionBundleID:(id)arg5 vertical:(bool)arg6 visualFingerprintData:(id)arg7 contentIsSensitive:(bool)arg8;
- (id)initWithPosterArchiveData:(id)arg1 metadata:(id)arg2 contentIsSensitive:(bool)arg3;
- (bool)isEqual:(id)arg1;
- (bool)isVertical;
- (id)metadata;
- (id)posterArchiveData;
- (void)setContentIsSensitive:(bool)arg1;
...
+ (id)log;
+ (id)reducedSizePosterArchiveDataFromData:(id)arg1 posterConfiguration:(id)arg2;
+ (id)wallpaperTypeFromConfiguration:(id)arg1;
+ (id)wallpaperTypeFromExtensionBundleID:(id)arg1;
+ (id)wallpaperWithPosterArchiveData:(id)arg1 metadataFromConfiguration:(id)arg2 visualFingerprint:(id)arg3 contentIsSensitive:(bool)arg4;
...
- (id)posterAttributes;
- (void)posterSnapshotForSize:(struct CGSize { double x1; double x2; })arg1 topPadding:(double)arg2 contact:(id)arg3 posterConfiguration:(id)arg4 completion:(id /* block */)arg5;
...
- (void)snapshotImageDataForWatchForContact:(id)arg1 posterConfiguration:(id)arg2 completion:(id /* block */)arg3;
- (void)snapshotImageDataForWatchWithCompletion:(id /* block */)arg1;
- (void)snapshotImageDataWithPreferredSize:(struct CGSize { double x1; double x2; })arg1 topPadding:(double)arg2 contact:(id)arg3 posterConfiguration:(id)arg4 completion:(id /* block */)arg5;
- (id)wallpaperType;
