...
@interface CNiOSABSmartDialerStringContactPredicate : CNPredicate <CNiOSContactAsyncPredicate, CNiOSContactPredicate> {
    NSString * _smartDialerString;
}

@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (readonly, copy) NSString *description;
@property (readonly) unsigned long long hash;
@property (nonatomic, readonly, copy) NSString *smartDialerString;
