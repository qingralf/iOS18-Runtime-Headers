...
- (void).cxx_destruct;
- (long long)batchSize;
- (id)initWithPredicate:(id)arg1 keysToFetch:(id)arg2 shouldSort:(bool)arg3 sortOrder:(unsigned int)arg4 unifiedFetch:(bool)arg5 batchSize:(long long)arg6 managedConfiguration:(id)arg7 options:(unsigned long long)arg8;
- (id)keysToFetch;
