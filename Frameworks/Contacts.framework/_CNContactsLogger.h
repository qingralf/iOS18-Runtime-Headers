...
- (void)XPCConnectionWasInterruptedForService:(id)arg1;
- (void)XPCConnectionWasInvalidatedForService:(id)arg1;
...
- (void)gettingBackgroundColor:(id /* block */)arg1;
- (id)init;
...
- (void)requestingProviderDomainCommand:(id /* block */)arg1;
