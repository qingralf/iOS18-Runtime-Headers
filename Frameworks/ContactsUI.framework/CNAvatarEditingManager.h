...
- (void)combinedPickerViewController:(id)arg1 didSelectRecord:(id)arg2 withStickerConfiguration:(id)arg3;
- (void)combinedPickerViewControllerDidCancel:(id)arg1;
...
- (id)initWithAvatarRecord:(id)arg1 poseConfiguration:(id)arg2 variantsManager:(id)arg3;
