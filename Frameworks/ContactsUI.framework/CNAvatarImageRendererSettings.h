...
+ (id)defaultSettingsWithCacheSize:(unsigned long long)arg1 personaId:(id)arg2;
+ (id)defaultSettingsWithCacheSize:(unsigned long long)arg1 skipContactLookup:(bool)arg2;
...
+ (id)settingsWithContactStore:(id)arg1 cacheSize:(unsigned long long)arg2 schedulerProvider:(id)arg3 concurrentCaches:(bool)arg4 skipContactLookup:(bool)arg5 personaId:(id)arg6;
+ (id)settingsWithContactStore:(id)arg1 cacheSize:(unsigned long long)arg2 schedulerProvider:(id)arg3 skipContactLookup:(bool)arg4;
+ (id)settingsWithContactStore:(id)arg1 cacheSize:(unsigned long long)arg2 skipContactLookup:(bool)arg3;
