...
@interface CNAvatarView : UIView <CNAvatarCardControllerDelegate, CNCardTransitioning, CNContactChangesObserver, CNSharedProfileAnimatingAvatarView, CNUILikenessCachingRendererDelegate> {
    ...
    bool  _shouldFetchSharedMeContactPhoto;
...
@property (nonatomic) bool shouldFetchSharedMeContactPhoto;
...
@property (nonatomic, readonly) UIView *transitioningContentView; /* unknown property attribute: ? */
...
- (id)initWithImageRenderer:(id)arg1 threeDTouchEnabled:(bool)arg2 contactStore:(id)arg3 style:(unsigned long long)arg4 schedulerProvider:(id)arg5 backgroundStyle:(unsigned long long)arg6;
...
- (void)setShouldFetchSharedMeContactPhoto:(bool)arg1;
