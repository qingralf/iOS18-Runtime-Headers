...
@property (nonatomic, readonly) CNContactAddStaticIdentityAction *addStaticIdentityAction;
...
@property (nonatomic, readonly) CNPropertyStaticIdentityAction *staticIdentityAction;
