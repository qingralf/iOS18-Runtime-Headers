...
@interface CNContactActionsController : NSObject <CNAvatarCardActionListController, CNUINavigationListViewControllerDelegate, CNUIUserActionListConsumer> {
    ...
    bool  _displayDefaultAppsSectionedMenus;
    bool  _displayMenuIconAtTopLevel;
    bool  _displayNonDefaultAppsMenuTitle;
    bool  _generateDefaultAppListItemsOnly;
...
@property (nonatomic, copy) NSString *defaultAppBundleIdentifier;
@property (nonatomic) <CNContactActionsControllerDelegate> *delegate;
@property (readonly, copy) NSString *description;
@property (nonatomic) bool displayDefaultAppsSectionedMenus;
@property (nonatomic) bool displayMenuIconAtTopLevel;
@property (nonatomic) bool displayNonDefaultAppsMenuTitle;
@property (nonatomic) bool generateDefaultAppListItemsOnly;
...
- (void)setDefaultAppBundleIdentifier:(id)arg1;
- (void)setDelegate:(id)arg1;
- (void)setDisplayDefaultAppsSectionedMenus:(bool)arg1;
- (void)setDisplayMenuIconAtTopLevel:(bool)arg1;
- (void)setDisplayNonDefaultAppsMenuTitle:(bool)arg1;
- (void)setGenerateDefaultAppListItemsOnly:(bool)arg1;
