...
@interface CNContactContentUnitaryViewController : CNContactContentViewController <CNCardSharedProfileCellActionDelegate, CNContactActionDelegate, CNContactContainerPickerViewControllerDelegate, CNContactContentViewController, CNContactContentViewControllerDelegate, CNContactGroupPickerDelegate, CNContactHeaderViewDelegate, CNContactInlineActionsViewControllerDelegate_Internal, CNPresenterDelegate, CNPropertyActionDelegate, CNPropertyCellDelegate, CNPropertyGroupItemDelegate, CNShareLocationProtocol, CNSharedProfileBannerViewDelegate, CNUIContactSaveDelegate, CNUIEditAuthorizationControllerDelegate, CNUIGeminiDataSourceDelegate, CNUIObjectViewControllerDelegate, NSUserActivityDelegate, UIAdaptivePresentationControllerDelegate, UIGestureRecognizerDelegate, UIPopoverControllerDelegate, UITableViewDataSource, UITableViewDelegate, UIViewControllerRestoration> {
    ...
    bool  _canDisplayDefaultAppGroup;
    ...
    <CNTUCallProvider> * _defaultAppProvider;
    ...
    bool  _didFindStaticIdentity;
    bool  _didLookUpStaticIdentity;
    ...
    <UIGestureRecognizerDelegate> * _previousBackGestureDelegate;
    ...
    bool  _showContactPhotoPosterCell;
...
@property (nonatomic, retain) CNContactToggleBlockReportCallerAction *blockReportAction;
...
@property (nonatomic, readonly) bool canDisplayDefaultAppGroup;
...
@property (nonatomic, retain) <CNTUCallProvider> *defaultAppProvider;
...
@property (nonatomic) bool didFindStaticIdentity;
@property (nonatomic) bool didLookUpStaticIdentity;
...
@property (nonatomic, retain) CNContactAction *gameCenterAddFriendAction;
...
@property (nonatomic) bool hadAtLeastOneVerifiedHandle;
...
@property (nonatomic) bool hasSetupViewHierarchy;
...
@property (nonatomic, readonly) <CNScheduler> *ktWorkQueue;
...
@property (nonatomic, retain) <UIGestureRecognizerDelegate> *previousBackGestureDelegate;
...
@property (nonatomic) bool showContactPhotoPosterCell;
...
- (void)_addDefaultAppGroupAnimated:(bool)arg1;
...
- (void)_scrollContactView:(id)arg1 toVisibleGroup:(id)arg2 animated:(bool)arg3;
...
- (void)_setupContactBlockingReportingActionPreservingChanges:(bool)arg1 withUpdate:(bool)arg2;
...
- (void)actionDidFinishFromSecondaryAction:(id)arg1;
...
- (void)alertDetailsNotVerified:(id)arg1;
- (void)alertStaticIdentitySaveFailed:(id)arg1;
- (bool)allowsActions;
...
- (void)applyNavigationBarTintColorIfNeeded:(id)arg1;
...
- (id)blockReportAction;
- (id)buttonPlatterImage;
- (id)cachedLabelWidths;
- (id)cachedStaticIdentity;
- (id)cachedVerifiedHandles;
...
- (void)headerView:(id)arg1 didRequestToBlockContact:(bool)arg2;
...
- (void)headerView:(id)arg1 didUpdateSensitiveContentOverride:(bool)arg2;
...
- (bool)isHeaderViewContactBlocked:(id)arg1;
...
- (id)previousBackGestureDelegate;
...
- (void)setBlockReportAction:(id)arg1;
- (void)setCachedLabelWidths:(id)arg1;
- (void)setCachedStaticIdentity:(id)arg1;
- (void)setCachedVerifiedHandles:(id)arg1;
...
- (void)setCardDefaultAppGroup:(id)arg1;
...
- (void)setDefaultAppProvider:(id)arg1;
- (void)setDelegate:(id)arg1;
- (void)setDeleteContactAction:(id)arg1;
- (void)setDeletedEditingGroups:(id)arg1;
- (void)setDidEditPronouns:(bool)arg1;
- (void)setDidFindStaticIdentity:(bool)arg1;
- (void)setDidLookUpStaticIdentity:(bool)arg1;
...
- (void)setGameCenterAddFriendAction:(id)arg1;
...
- (void)setHadAtLeastOneVerifiedHandle:(bool)arg1;
...
- (void)setHasSetupViewHierarchy:(bool)arg1;
...
- (void)setPreviousBackGestureDelegate:(id)arg1;
...
- (void)setShowContactPhotoPosterCell:(bool)arg1;
...
- (void)updateEditNavigationItemsAnimated:(bool)arg1 updateTintColor:(bool)arg2;
...
- (void)updateViewAnnotationWithContact:(id)arg1;
