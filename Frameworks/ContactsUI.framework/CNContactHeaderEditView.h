...
- (void).cxx_destruct;
- (void)_presentRemotePosterAndAvatarEditorWithMode:(long long)arg1 isEditing:(bool)arg2;
...
- (void)didFinishUsing;
- (void)didTapPhotoViewWhileEditing:(bool)arg1;
- (void)discardPendingAvatarPosterEdits;
- (void)editAvatar;
- (id)editButton;
- (void)editButtonTapped;
- (void)editButtonTappedWhileEditing:(bool)arg1;
- (void)editPoster;
...
- (void)presentPosterAndAvatarEditorWithMode:(long long)arg1 isEditing:(bool)arg2;
...
- (void)updatePosterViewImageWithNewPosterConfiguration:(bool)arg1;
