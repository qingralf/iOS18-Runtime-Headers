...
@interface CNContactHeaderStaticDisplayView : CNContactHeaderView <CNPickerControllerDelegate, CNSensitiveContentBlurViewDelegate, CNSensitiveContentHelpButtonViewDelegate, CNUIReusableView, UINavigationControllerDelegate> {
    ...
    CNPRSPosterConfiguration * _cachedPosterConfiguration;
    ...
    CNSensitiveContentHelpButtonView * _sensitiveContentHelpButton;
...
@property (nonatomic, retain) CNPRSPosterConfiguration *cachedPosterConfiguration;
...
@property (nonatomic, retain) CNSensitiveContentHelpButtonView *sensitiveContentHelpButton;
@property (nonatomic, readonly) CNSensitiveContentAnalysisManager *sensitiveContentManager;
...
- (void)assignSnapshotImageToPosterView:(id)arg1 configuration:(id)arg2 contentIsSensitive:(bool)arg3;
...
- (id)blurView;
- (double)bottomMargin;
- (id)cachedPosterConfiguration;
- (void)calculateLabelSizes;
- (void)calculateLabelSizesIfNeeded;
- (bool)canPerformAction:(SEL)arg1 withSender:(id)arg2;
- (bool)canSensitiveContentHelpButtonBlockContact:(id)arg1;
- (bool)canSensitiveContentHelpButtonViewHidePhoto:(id)arg1;
- (void)configureSensitiveContentHelpButtonHidden:(bool)arg1;
- (id)contactFormatter;
...
- (id)imageDataForColorFetchingIsImageDataOrThumbnail:(bool*)arg1 bitmapFormat:(id*)arg2;
- (id)importantLabel;
- (id)importantMessage;
...
- (id)nameFont;
- (double)nameFontSize;
- (void)notifyDelegateOfUpdatedHiddenSensitiveContent:(bool)arg1;
- (id)personHeaderView;
- (void)picker:(id)arg1 didPickItem:(id)arg2;
- (void)pickerDidCancel:(id)arg1;
- (void)reloadDataPreservingChanges:(bool)arg1;
- (void)sensitiveContentBlurView:(id)arg1 didSetContentHidden:(bool)arg2;
- (void)sensitiveContentBlurView:(id)arg1 wantsToPresentInterventionController:(id)arg2;
- (id)sensitiveContentHelpButton;
- (void)sensitiveContentHelpButtonView:(id)arg1 didRequestToBlockContact:(bool)arg2;
- (void)sensitiveContentHelpButtonView:(id)arg1 didRequestToPresentMenu:(id)arg2;
- (void)sensitiveContentHelpButtonView:(id)arg1 didRequestToPresentMoreHelp:(id)arg2;
- (void)sensitiveContentHelpButtonView:(id)arg1 didSetContentHidden:(bool)arg2;
- (id)sensitiveContentManager;
...
- (void)setCachedPosterConfiguration:(id)arg1;
...
- (void)setSensitiveContentHelpButton:(id)arg1;
...
- (void)updateSensitiveContentBlurVisibility:(bool)arg1;
