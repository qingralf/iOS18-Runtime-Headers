...
@interface CNContactHeaderView : UIView <CNContactPhotoViewDelegate, CNUIReusableView> {
    ...
    CNSensitiveContentBlurView * _sensitiveContentBlurView;
...
@property (nonatomic, retain) CNSensitiveContentBlurView *sensitiveContentBlurView;
...
@property (nonatomic, retain) CNContactStore *xpcContactStore;
...
- (id)dataForBackgroundColorService:(id)arg1;
- (void)dealloc;
...
- (id)descriptorForRequiredKeys;
- (void)didFinishUsing;
- (void)fetchColorsForContactImageData:(id)arg1 bitmapFormat:(id)arg2 isPoster:(bool)arg3 forContact:(id)arg4 cacheResult:(bool)arg5 withCompletionHandler:(id /* block */)arg6;
...
- (void)setSensitiveContentBlurView:(id)arg1;
...
- (void)setXpcContactStore:(id)arg1;
