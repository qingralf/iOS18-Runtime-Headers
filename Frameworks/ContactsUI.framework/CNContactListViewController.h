...
@interface CNContactListViewController : UICollectionViewController <CNAvatarViewControllerDelegate, CNContactDataSourceDelegate, CNContactListActionHelperDelegate, CNContactListBannerViewDelegate, CNContactListCollectionViewDelegate, CNContactListCountViewDelegate, CNContactListDuplicatesBannerCellDelegate, CNContactListLimitedAccessTipCellDelegate, CNContactSuggestionsViewControllerDelegate, CNContactViewControllerDelegate, CNDuplicateContactsControllerDelegate, CNUIObjectViewControllerDelegate, CNVCardImportControllerDelegate, CNVCardImportControllerPresentationDelegate, UICollectionViewDelegate_Private, UICollectionViewDragDelegate, UICollectionViewDragDestination, UICollectionViewDragSource, UICollectionViewDropDelegate, UIGestureRecognizerDelegate, UISearchBarDelegate, UISearchControllerDelegate, UISearchResultsUpdating> {
    ...
    NSSet * _contactSelectionOnViewLoad;
    ...
    bool  _shouldSearchBarBecomeFirstResponder;
    bool  _shouldShowLimitedAccessTip;
...
@property (nonatomic, retain) NSSet *contactSelectionOnViewLoad;
...
@property (nonatomic) bool isCurrentViewStillOpen;
...
@property (nonatomic, retain) CNContactListSearchController *searchController;
...
@property (nonatomic, retain) UIView *selectButtonView;
...
@property (nonatomic) bool shouldSearchBarBecomeFirstResponder;
@property (nonatomic) bool shouldShowLimitedAccessTip;
...
- (bool)containsPathToLimitedAccessTipRow:(id)arg1;
...
- (void)limitedAccessTipCellDidTapDismiss:(id)arg1;
...
- (void)selectAllIndexPathsAnimated:(bool)arg1;
- (id)selectButton;
- (id)selectButtonView;
...
- (void)setContactSelectionOnViewLoad:(id)arg1;
...
- (void)setImageForContact:(id)arg1 imageUpdateBlock:(id /* block */)arg2;
- (void)setIndexPathToSelect:(id)arg1;
- (void)setIsCurrentViewStillOpen:(bool)arg1;
...
- (void)setSelectButtonView:(id)arg1;
...
- (void)setShouldSearchBarBecomeFirstResponder:(bool)arg1;
- (void)setShouldShowLimitedAccessTip:(bool)arg1;
...
- (void)startSearching;
- (void)startSearchingForString:(id)arg1 setSearchBarAsFirstResponder:(bool)arg2;
...
- (void)updateNavTitleWithCount:(unsigned long long)arg1;
