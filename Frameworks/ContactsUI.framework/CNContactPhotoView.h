...
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 shouldAllowTakePhotoAction:(bool)arg2 threeDTouchEnabled:(bool)arg3 contactStore:(id)arg4 allowsImageDrops:(bool)arg5 imageRenderer:(id)arg6 allowStaleRendering:(bool)arg7;
