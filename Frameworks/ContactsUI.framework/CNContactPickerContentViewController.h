...
@property (nonatomic, retain) NSString *limitedAccessInitialSearchQuery;
...
- (void)contactNavigationController:(id)arg1 didUpdateLimitedAccessSelection:(id)arg2;
...
- (void)contactNavigationControllerDidGoBack:(id)arg1;
...
- (void)contactNavigationControllerShouldEditLimitedAccess:(id)arg1;
...
- (id)limitedAccessInitialSearchQuery;
...
- (void)setLimitedAccessInitialSearchQuery:(id)arg1;
