...
@interface CNContactViewController : UIViewController <CNContactContentNavigationItemTarget, CNContactViewHostProtocol, UIAdaptivePresentationControllerDelegate, _UIRemoteViewControllerContaining> {
...
@property (nonatomic, retain) NSString *staticIdentity;
...
+ (id)viewControllerForUpdatingContact:(id)arg1 withPublicAccountIdentity:(id)arg2;
...
- (void)didTapBlockAndReportForContact:(id)arg1;
