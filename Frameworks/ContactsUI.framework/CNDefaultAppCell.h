...
@interface CNDefaultAppCell : CNLabeledCell <CNActionViewDelegate, CNContactActionsControllerDelegate, CNUIUserActionListConsumer> {
    ...
    bool  _isDefaultAppVideoAvailable;
...
@property (nonatomic, readonly) UILabel *defaultAppLabel;
...
@property (nonatomic) bool isDefaultAppVideoAvailable;
...
- (void)setIsDefaultAppVideoAvailable:(bool)arg1;
