...
- (id)avatarLayerForIdentifier:(id)arg1;
- (id)avatarLayers;
...
- (id)initWithGroup:(id)arg1 avatarViewControllerSettings:(id)arg2 avatarLayoutType:(unsigned long long)arg3 withLayoutDelegate:(id)arg4;
- (bool)isDoNotDisturb;
