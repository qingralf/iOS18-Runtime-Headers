...
@property (nonatomic, retain) UIImageView *staticIdentityBadge;
...
- (void)setShouldShowStaticKeyBadge:(bool)arg1;
- (void)setStaticIdentityBadge:(id)arg1;
