...
- (void).cxx_destruct;
- (id)animojiProviderItem:(id)arg1 backgroundColor:(id)arg2;
- (id)animojiProviderItemForAvatarImageData:(id)arg1 backgroundColor:(id)arg2;
...
- (id)memojiEditingManagerForAvatarRecord:(id)arg1 poseConfiguration:(id)arg2;
