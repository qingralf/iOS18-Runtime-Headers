...
@interface CNSharedProfileOnboardingController : NSObject <CNMeCardSharingSettingsViewControllerDelegate, CNPresenterDelegate, CNSNaPSetupFlowManagerDelegate> {
    ...
    <CNSharedProfileOnboardingStateController> * _stateController;
...
@property (nonatomic, retain) <CNSharedProfileOnboardingStateController> *stateController;
...
- (bool)accountCanCreateSNaPWithShouldShowErrorAlert:(bool)arg1 fromViewController:(id)arg2;
...
- (id)initWithContactStore:(id)arg1 stateController:(id)arg2;
...
- (bool)shouldShowOnboardingForSettingsWithNicknameContact:(id)arg1 meContact:(id)arg2;
- (void)showMultiplePhoneNumbersAlertForNicknamesFromViewController:(id)arg1;
- (void)showiCloudNotSignedInAlertForNicknamesFromViewController:(id)arg1;
