...
+ (id)bisectionTopLevelListItems:(id)arg1;
+ (id)defaultAppNavigationListItemsForUserActionListModel:(id)arg1 defaultAppBundleIdentifier:(id)arg2;
+ (id)faceTimeNavigationListItemsForUserActionListModel:(id)arg1;
+ (id)filterNavigationListItemsForUserActionListModel:(id)arg1 forBundleIdentifier:(id)arg2;
+ (id)itemForActionItem:(id)arg1 usePropertyLabel:(bool)arg2;
+ (id)localizedLabelForActionItem:(id)arg1 usePropertyLabel:(bool)arg2;
+ (id)navigationListItemForContactProperty:(id)arg1;
+ (id)navigationListItemsForUserActionListModel:(id)arg1 displayDefaultAppsSectionedMenus:(bool)arg2 displayNonDefaultAppsMenuTitle:(bool)arg3;
+ (id)parentListItemTitleForUserAction:(id)arg1 displayNonDefaultAppsMenuTitle:(bool)arg2;
