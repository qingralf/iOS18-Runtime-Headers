...
@property (nonatomic) struct CGPoint { double x1; double x2; } gestureStartLocation;
@property (nonatomic) struct CGPoint { double x1; double x2; } gestureStartLocationInWindow;
...
@property (nonatomic, retain) UIGestureRecognizer *pressGestureRecognizer;
...
- (struct CGPoint { double x1; double x2; })gestureStartLocation;
- (struct CGPoint { double x1; double x2; })gestureStartLocationInWindow;
...
- (void)setGestureStartLocation:(struct CGPoint { double x1; double x2; })arg1;
- (void)setGestureStartLocationInWindow:(struct CGPoint { double x1; double x2; })arg1;
