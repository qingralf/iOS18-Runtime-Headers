...
- (id)initWithVisualIdentity:(id)arg1 primaryAvatarProvider:(id)arg2 avatarImageRendererSettings:(id)arg3 avatarLayoutType:(unsigned long long)arg4 withLayoutDelegate:(id)arg5;
- (bool)isPerformingTransition;
- (long long)itemCount;
- (id)layerForPrimaryAvatar;
- (void)layoutAvatars;
- (void)layoutAvatarsWithIdentifiers:(id)arg1;
- (id)layoutDelegate;
