...
@interface Core_Audio_Driver : NSObject <Core_Audio_Driver_Protocol, NSXPCListenerDelegate> {
    ...
    struct function<void ()>="__f_"{__value_func<void ()>="__buf_"{type="__lx"[24C] {}  _m_invalidation_handler;
...
@property (nonatomic) struct function<void ()>={__value_func<void ()>={type=[24C] {} m_invalidation_handler;
...
- (void)add_device_client:(unsigned int)arg1 client_id:(unsigned int)arg2 process_id:(int)arg3 is_native_endianess:(bool)arg4 bundle_id:(id)arg5 reply:(id /* block */)arg6;
...
- (void)create_device:(id)arg1 client_id:(unsigned int)arg2 process_id:(int)arg3 is_native_endianess:(bool)arg4 bundle_id:(id)arg5 reply:(id /* block */)arg6;
- (void)dealloc;
...
- (id)init;
- (id)init_driver_interface:(struct AudioServerPlugInDriverInterface {}**)arg1 invalidation_handler:(struct function<void ()>={__value_func<void ()>={type=[24C] {})arg2;
...
- (struct function<void ()>={__value_func<void ()>={type=[24C] {})m_invalidation_handler;
...
- (void)remove_device_client:(unsigned int)arg1 client_id:(unsigned int)arg2 process_id:(int)arg3 is_native_endianess:(bool)arg4 bundle_id:(id)arg5 reply:(id /* block */)arg6;
...
- (void)setM_invalidation_handler:(struct function<void ()>={__value_func<void ()>={type=[24C] {})arg1;
