...
@property (nonatomic, copy) CBSpatialInteractionFilter *spatialInteractionfilter;
...
@property (nonatomic, copy) NSArray *typeToRssiThresholds;
...
- (unsigned char)deviceSetupState;
...
- (void)reportMockDeviceFound:(id)arg1;
- (void)reportMockDeviceLost:(id)arg1;
- (id)serviceUUIDs;
...
- (void)setDeviceSetupState:(unsigned char)arg1;
...
- (void)setSpatialInteractionFilter:(id)arg1;
- (void)setSpatialInteractionfilter:(id)arg1;
