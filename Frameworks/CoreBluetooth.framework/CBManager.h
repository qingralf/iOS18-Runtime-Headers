...
@property (nonatomic, copy) NSData *nonConnectableSecondaryAdvertisingAddress;
@property (nonatomic, readonly) long long nonConnectableSecondaryAdvertisingAddressType;
...
- (id)nonConnectableSecondaryAdvertisingAddress;
- (long long)nonConnectableSecondaryAdvertisingAddressType;
- (id)peerWithInfo:(id)arg1;
- (void)performTCCCheck:(id)arg1;
- (void)queryBluetoothStatus:(id)arg1 completion:(id /* block */)arg2;
- (void)removeCnxInstanceForIdentifier:(id)arg1;
- (void)removeWhbRemoteId:(id)arg1;
- (void)retrieveBundle:(id)arg1 sessionCountWithCompletion:(id /* block */)arg2;
...
- (void)setNonConnectableSecondaryAdvertisingAddress:(id)arg1;
