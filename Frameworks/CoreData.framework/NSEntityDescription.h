...
@interface NSEntityDescription : NSObject <NSCoding, NSCopying, NSFastEnumeration, NSSecureCoding> {
    ...
    struct _ExtraEntityIVars { id x1; id x2; _Atomic id x3; id x4; id x5; id x6; struct os_unfair_lock_s { unsigned int x_7_1_1; } x7; int x8; void *x9; } * _extraIvars;
...
- (id)name;
- (bool)performPostDecodeValidationInModel:(id)arg1 error:(id*)arg2;
- (id)properties;
- (id)propertiesByName;
