...
+ (id)ic_objectIDsMatchingPredicate:(id)arg1 sortDescriptors:(id)arg2 fetchLimit:(unsigned long long)arg3 context:(id)arg4;
...
+ (id)predicateForObjectsWithManagedObjectIDs:(id)arg1;
...
- (bool)parseValidationErrors:(id*)arg1 otherErrors:(id)arg2;
