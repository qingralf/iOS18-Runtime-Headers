...
@property (nonatomic, readonly) HMDCoreData *hmd_coreData;
@property (nonatomic, readonly) HMDCoreDataCloudTransformChangeSet *hmd_currentChangeSet;
...
- (bool)hmd_saveWithTransactionAuthor:(unsigned long long)arg1 clientIdentifier:(id)arg2 allowQoSEscalation:(bool)arg3 error:(id*)arg4;
...
- (void)setHmd_currentChangeSet:(id)arg1;
...
- (id)pl_graphCache;
- (void)pl_performBlockAndWait:(id /* block */)arg1;
- (void)pl_refresh;
...
- (id)episodesForManagedObjectIDs:(id)arg1;
...
- (id)unsafeCategoriesWithRelationshipToPodcastAdamID:(long long)arg1;
- (id)unsafeInterestForAdamID:(long long)arg1;
...
- (id)episodeForPlayerItem:(id)arg1;
