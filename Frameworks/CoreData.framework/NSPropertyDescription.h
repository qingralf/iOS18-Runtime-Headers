...
- (int)_encodedPropertyFlagsForFlags:(int)arg1;
- (long long)_entitysReferenceID;
- (bool)_epsilonEquals:(id)arg1 rhs:(id)arg2 withFlags:(int)arg3;
- (struct _NSExtraPropertyIVars { id x1; long long x2; long long x3; id x4; id x5; }*)_extraIVars;
...
- (void)setSuperCompositeAttribute:(id)arg1;
