...
- (bool)ensureContentsOfRecordStorageMatchForStorage:(id)arg1 andOtherStore:(id)arg2 error:(id*)arg3;
...
- (bool)ensureRecordMetadataMatchesForRecordID:(id)arg1 inStore:(id)arg2 andOtherStore:(id)arg3 error:(id*)arg4;
