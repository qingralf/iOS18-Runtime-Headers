...
@property (nonatomic, readonly) NSString *ef_longestCommonPrefix;
...
@property (nonatomic, readonly) NSArray *itk_generateAllPermutations;
@property (nonatomic, readonly) id itk_randomObject;
@property (nonatomic, readonly) NSArray *itk_randomizedArray;
...
@property (nonatomic, readonly) bool mr_containsVideoOutputDevice;
@property (nonatomic, readonly) NSArray *mr_distantEndpoints;
@property (nonatomic, readonly) NSArray *mr_distantOutputDevices;
...
@property (nonatomic, readonly) AXEventPathInfoRepresentation *secondPath;
...
- (id)CKFirstObjectWithOptions:(unsigned long long)arg1 passingTest:(id /* block */)arg2;
...
+ (id)sr_arrayWithHAAccelSamples:(id)arg1;
+ (id)sr_arrayWithHAOpticalSamples:(id)arg1;
...
- (bool)lt_ensureElementType:(Class)arg1;
...
- (bool)ams_allWithOptions:(unsigned long long)arg1 test:(id /* block */)arg2;
- (bool)ams_allWithTest:(id /* block */)arg1;
- (bool)ams_anyWithOptions:(unsigned long long)arg1 test:(id /* block */)arg2;
- (bool)ams_anyWithTest:(id /* block */)arg1;
- (id)ams_arrayByRemovingObjectsFromArray:(id)arg1;
- (bool)ams_concurrentAllWithTest:(id /* block */)arg1;
- (bool)ams_concurrentAnyWithTest:(id /* block */)arg1;
...
- (id)asdtNearestNumberToNumber:(id)arg1;
- (id)asdtNumericSortAscending:(bool)arg1;
...
+ (id)avt_arrayWithFloat3:(void *)arg1 roundingBehavior:(void *)arg2; // needs 2 arg types, found 1: id
+ (id)avt_arrayWithFloat4;
+ (id)avt_arrayWithFloat4:(void *)arg1 roundingBehavior:(void *)arg2; // needs 2 arg types, found 1: id
+ (id)avt_arrayWithFloat4x4:(struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; })arg1;
+ (id)avt_arrayWithFloat4x4:(struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; })arg1 roundingBehavior:(id)arg2;
...
- (struct CKCatchUpScrollTarget { unsigned long long x1; unsigned long long x2; })__ck_catchUpScrollTargetForMessageGUID:(id)arg1;
...
- (unsigned long long)__ck_indexOfPartOfMessageGUID:(id)arg1 withMessagePartIndex:(unsigned long long)arg2;
...
- (id)_br_minMaxWithMax:(bool)arg1 comparator:(id /* block */)arg2;
- (bool)br_all_of:(id /* block */)arg1;
- (bool)br_all_of_type:(Class)arg1;
- (bool)br_any_of:(id /* block */)arg1;
- (id)br_copy_if:(id /* block */)arg1;
- (unsigned long long)br_count_if:(id /* block */)arg1;
- (id)br_firstItemOf:(id /* block */)arg1;
- (unsigned long long)br_lastIndexOfObject:(id)arg1;
- (id)br_maxWithComparator:(id /* block */)arg1;
- (id)br_minWithComparator:(id /* block */)arg1;
...
- (bool)_cd_containsSiriLearningBundleId:(id)arg1;
...
- (id)_removeBackslashAndSpaceCharacter;
- (id)_shuffled;
...
- (id)ded_findWithBlock:(id /* block */)arg1;
- (id)ded_mapWithBlock:(id /* block */)arg1;
- (id)ded_rejectItemsPassingTest:(id /* block */)arg1;
- (id)ded_selectItemsPassingTest:(id /* block */)arg1;
...
+ (id)arrayWithObjectsFrom:(id)arg1;
...
- (bool)em_containsSmartMailboxType:(long long)arg1;
...
- (id)ef_shortDescriptionStringWithLimit:(long long)arg1;
...
- (id)fs_filter:(id /* block */)arg1;
- (id)fs_map:(id /* block */)arg1;
- (id)fs_mapWithIndex:(id /* block */)arg1;
...
- (void)_gkUpdateInternalPlayersScopedIDs:(id /* block */)arg1;
...
- (void)hmf_enumerateWithAutoreleasePoolUsingBlock:(id /* block */)arg1;
...
- (id)firstMessage;
- (id)firstMessageItem;
- (void)im_logGUIDsForReason:(id)arg1;
...
+ (id)itk_arrayFromNonNilObject:(id)arg1;

- (id)itk_arrayByAddingNonNilObject:(id)arg1;
- (id)itk_arrayByAddingObjectsFromNonNilArray:(id)arg1;
- (id)itk_arrayByGroupingIntoArraysWithMaxCount:(unsigned long long)arg1;
- (id)itk_arrayFromReplacingObject:(id)arg1 withObject:(id)arg2;
- (id)itk_compactMap:(id /* block */)arg1;
- (bool)itk_containsObjectPassingTest:(id /* block */)arg1;
- (unsigned long long)itk_countOfObjectsPassingTest:(id /* block */)arg1;
- (id)itk_firstObjectOfClass:(Class)arg1;
- (id)itk_flatMap:(id /* block */)arg1;
- (id)itk_generateAllPermutations;
- (bool)itk_indexIsValid:(long long)arg1;
- (unsigned long long)itk_indexOfSortedObject:(id)arg1 insertionIndex:(out unsigned long long*)arg2 usingComparator:(id /* block */)arg3;
- (id)itk_map:(id /* block */)arg1;
- (id)itk_objectAfter:(id)arg1;
- (id)itk_objectAfter:(id)arg1 wrap:(bool)arg2;
- (id)itk_objectBefore:(id)arg1;
- (id)itk_objectBefore:(id)arg1 wrap:(bool)arg2;
- (id)itk_objectPassingTest:(id /* block */)arg1;
- (id)itk_objectsConformingToProtocol:(id)arg1;
- (id)itk_objectsOfClass:(Class)arg1;
- (id)itk_objectsPassingTest:(id /* block */)arg1;
- (id)itk_randomObject;
- (id)itk_randomizedArray;
- (id)itk_safeObjectAtIndex:(long long)arg1;
...
- (id)mr_replaceEndpointsWithEndpoints:(id)arg1;
- (id)mr_replaceOutputDevicesWithOutputDevices:(id)arg1;
...
- (id)getFilteredArrayByDistinctProperty:(id)arg1;

// Image: /System/Library/PrivateFrameworks/MobileStoreDemoKit.framework/MobileStoreDemoKit

+ (id)arrayWithXPCArray:(id)arg1;

- (id)initWithXPCArray:(id)arg1;
...
- (id)na_safeSubarrayWithRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
...
- (id)ic_randomObject;
- (id)ic_reduceStartingWithState:(id)arg1 usingBlock:(id /* block */)arg2;
...
- (id)pk_createArrayByRemovingObjectAtIndex:(unsigned long long)arg1;
- (id)pk_createArrayByRemovingObjectsPassingTest:(id /* block */)arg1;
...
- (id)_pl_safeObjectAtIndex:(unsigned long long)arg1;
...
- (id)mt_uniqueOrdered;
- (id)mt_uniqued;
- (long long)pf_indexOfObjectWithValue:(id)arg1 forKeyPath:(id)arg2;
...
- (unsigned long long)indexOfNextGroupStartingAtIndex:(unsigned long long)arg1;
...
+ (id)_pas_arrayNoCopyLeavesWithPropertyListData:(id)arg1 error:(id*)arg2;
...
- (void)safari_enumerateZippedValuesWithArray:(id)arg1 options:(unsigned long long)arg2 withBlock:(id /* block */)arg3;
...
- (id)safari_objectsOfClass:(Class)arg1;
...
+ (id)arrayWithContentsOfCSVFile:(id)arg1;
+ (id)arrayWithContentsOfCSVFile:(id)arg1 delimiter:(unsigned short)arg2;
+ (id)arrayWithContentsOfCSVFile:(id)arg1 options:(unsigned long long)arg2;
+ (id)arrayWithContentsOfCSVFile:(id)arg1 options:(unsigned long long)arg2 delimiter:(unsigned short)arg3;
+ (id)arrayWithContentsOfCSVFile:(id)arg1 options:(unsigned long long)arg2 delimiter:(unsigned short)arg3 error:(id*)arg4;
+ (id)arrayWithContentsOfCSVURL:(id)arg1;
+ (id)arrayWithContentsOfCSVURL:(id)arg1 options:(unsigned long long)arg2;
+ (id)arrayWithContentsOfDelimitedURL:(id)arg1 delimiter:(unsigned short)arg2;
+ (id)arrayWithContentsOfDelimitedURL:(id)arg1 options:(unsigned long long)arg2 delimiter:(unsigned short)arg3;
+ (id)arrayWithContentsOfDelimitedURL:(id)arg1 options:(unsigned long long)arg2 delimiter:(unsigned short)arg3 error:(id*)arg4;
...
- (id)sbh_arrayByRemovingObjectsFromArray:(id)arg1;
...
- (id)_sortedArrayByFrequency:(unsigned long long)arg1 extensionCandidateIndex:(unsigned long long)arg2 maxEmojisPerCandidate:(unsigned long long)arg3 ignoreTransliterateCandidate:(bool)arg4;
...
+ (id)vg_arrayWithNumbersFromFloatSpan:(const void*)arg1;
+ (id)vg_arrayWithNumbersFromFloatVector:(const void*)arg1;
+ (id)vg_arrayWithNumbersFromVectorf:(const void*)arg1;
+ (id)vg_arrayWithRowMajorNumbersFromFloat3x3:(struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[3]; })arg1;
+ (id)vg_arrayWithRowMajorNumbersFromFloat4x4:(struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; })arg1;

- (id)vg_arrayByInvokingBlock:(id /* block */)arg1;
- (id)vg_compactArrayByInvokingBlock:(id /* block */)arg1;
- (id)vg_dataByInvokingFloatValue;
- (void)vg_float3ByInvokingFloatValue;
- (struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[3]; })vg_float3x3From1DArrayByInvokingFloatValue;
- (struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[3]; })vg_float3x3FromRowMajorByInvokingFloatValue;
- (void)vg_float4ByInvokingFloatValue;
- (struct vector<float, std::allocator<float>> { float *x1; float *x2; struct __compressed_pair<float *, std::allocator<float>> { float *x_3_1_1; } x3; })vg_vectorByInvokingFloatValue;
- (struct vector<float __attribute__((ext_vector_type(3))), std::allocator<float __attribute__((ext_vector_type(3)))>>=^^{__compressed_pair<float * __attribute__((ext_vector_type(3))), std::allocator<float __attribute__((ext_vector_type(3)))>>=^ {})vg_vectorFloat3ByInvokingFloatValue;
...
- (id)fragmentsWithTrackIndex:(unsigned long long)arg1;
