...
@interface NSData : NSObject <AFContextSnapshot, AFSecurityDigestibleChunksProviding, ASDNotificationType, ASParsingLeafNode, CCDatabaseValue, CKPropertiesDescription, CKRecordValue, CUByteCodable, DYVMBufferSubRegion, EFSQLBindable, FCKeyValueStoreCoding, GTVMBufferSubRegion, HAP2AccessoryCharacteristicEncodableBodyValue, HAP2AccessoryCharacteristicEncodedData, HFPropertyListConvertible, HKUUIDCollection, HMBQueryableModelFieldCoder, HMDOPACKValue, HMFObject, ICCRCoding, ICCRDataType, ICCREquatable, IMJSONSerializableValueProviding, INJSONSerializable, MPCPlaybackEngineEventPayloadValueJSONConvertible, NFCBOREncodable, NSCopying, NSMutableCopying, NSSecureCoding, PQLValuable, REDonatedActionIdentifierProviding, SEMDatabaseValue, SiriCoreSQLiteValue, TSPSplitableData, VCControlChannelMessageProtocol, WFActionReversalState, WFPropertyListObject, _PASDistilledString>
...
@property (nonatomic, readonly) NSData *ska_sha256;
...
+ (id)nonOwningDataWithBytes:(const void*)arg1 length:(unsigned long long)arg2;
...
+ (bool)_readBytesAndEncodingFromPath:(id)arg1 maxLength:(long long)arg2 encoding:(unsigned long long*)arg3 bytes:(void**)arg4 length:(long long*)arg5 didMap:(bool*)arg6 options:(unsigned long long)arg7 reportProgress:(bool)arg8 error:(id*)arg9;
+ (bool)_readBytesFromPath:(id)arg1 maxLength:(long long)arg2 bytes:(void**)arg3 length:(long long*)arg4 didMap:(bool*)arg5 options:(unsigned long long)arg6 reportProgress:(bool)arg7 error:(id*)arg8;
+ (bool)_subclassesMustBeExplicitlyMentionedWhenDecoded;
+ (bool)_writeDataToPath:(id)arg1 data:(id)arg2 options:(unsigned long long)arg3 reportProgress:(bool)arg4 error:(id*)arg5;
+ (bool)_writeDataToPath:(id)arg1 data:(id)arg2 options:(unsigned long long)arg3 stringEncodingAttributeData:(id)arg4 reportProgress:(bool)arg5 error:(id*)arg6;
...
+ (id)ams_createDataWithFPDIResult:(void*)arg1 length:(unsigned int)arg2;
...
+ (id)dataWithCBOR:(id)arg1 encodingKeyOrder:(unsigned long long)arg2;
...
+ (id)CAF_encodeBinaryPlistFrom:(id)arg1 error:(id*)arg2;

- (id)CAF_decodeBinaryPlist:(id*)arg1;
...
- (bool)isEqualToClipStrokeData:(id)arg1 withAccuracy:(float)arg2;
...
- (bool)DMCAtomicWriteToPath:(id)arg1 error:(id*)arg2;
- (bool)DMCAtomicWriteToURL:(id)arg1 error:(id*)arg2;
- (id)DMCHexString;
- (id)DMCSHA256Hash;
...
+ (unsigned long long)SHA224ChecksumSize;
...
+ (id)dataWithInteger:(long long)arg1;
...
+ (id)fp_dataWithContentsOfURL:(id)arg1 enforceSignatureCheck:(bool)arg2 shouldUpdateXattr:(bool*)arg3 error:(id*)arg4;

- (bool)fp_writeToURL:(id)arg1 withSignature:(bool)arg2 options:(unsigned long long)arg3 error:(id*)arg4;
...
- (struct { unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; float x5; float x6; float x7; float x8; float x9; float x10; unsigned char x11[8]; }*)__IS_imageHeader;
...
+ (id)dataWithHexString:(id)arg1;
+ (id)generateRandomBytesOfSize:(unsigned long long)arg1;
...
- (id)pf_hexadecimalEncodedString;

// Image: /System/Library/PrivateFrameworks/PosterUIFoundation.framework/PosterUIFoundation

+ (id)pui_loadImageDataFromFileURL:(id)arg1 error:(out id*)arg2;
...
+ (id)STS_dataFromHexString:(id)arg1;
...
- (id)_operateOnDataUsingCompressionAlgorithm:(int)arg1 operation:(int)arg2;
- (id)vfx_compressedDataUsingCompressionAlgorithm:(int)arg1;
- (id)vfx_indexedDataDecodingDeltaWithBytesPerIndex:(unsigned long long)arg1;
- (id)vfx_indexedDataDecodingHighWatermarkWithBytesPerIndex:(unsigned long long)arg1;
- (id)vfx_indexedDataDecodingTrianglePairsWithBytesPerIndex:(unsigned long long)arg1;
- (id)vfx_indexedDataEncodingDeltaWithBytesPerIndex:(unsigned long long)arg1;
- (id)vfx_indexedDataEncodingHighWatermarkWithBytesPerIndex:(unsigned long long)arg1;
- (id)vfx_indexedDataEncodingTrianglePairsWithBytesPerIndex:(unsigned long long)arg1;
- (id)vfx_uncompressedDataUsingCompressionAlgorithm:(int)arg1;
...
- (id)ical_digest;
- (id)ical_digestWithVersionNumber:(unsigned int)arg1;
...
- (bool)ses_isAllZero;
- (bool)ses_isEqualToBytes:(const void*)arg1 length:(unsigned long long)arg2;
- (bool)ses_isEqualToHexCString:(const char *)arg1;
- (id)ses_sha1;
- (id)ses_sha256;
- (id)ses_sha384;
