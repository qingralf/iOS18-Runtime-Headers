...
@property (nonatomic, readonly) NSString *ic_shortFormattedDateForAccessibility;
@property (nonatomic, readonly) NSDate *ic_startOfDay;
@property (nonatomic, readonly) NSDate *ic_truncated;
@property (nonatomic, readonly) NSString *itk_briefFormattedDate;
@property (nonatomic, readonly) NSString *itk_briefFormattedDateForAccessibility;
@property (nonatomic, readonly) bool itk_isToday;
@property (nonatomic, readonly) bool itk_isYesterday;
@property (nonatomic, readonly) NSString *itk_localDateWithSeconds;
@property (nonatomic, readonly) NSString *itk_shortFormattedDate;
...
@property (nonatomic, readonly, copy) NSString *safari_filenameFormattedString;
...
- (id)hk_rfc3339String;
- (id)hk_sleepDayMidnightWithCalendar:(id)arg1;
...
+ (id)CalDateForNow;
+ (id)CalDateRangeStringWithStart:(id)arg1 end:(id)arg2;
...
- (id)_dateByAddingDays:(long long)arg1;
...
+ (id)hkhr_ISO8601StringForDate:(id)arg1;
+ (id)hkhr_dateWithISO8601String:(id)arg1;
...
+ (id)__im_dateWithNanosecondTimeIntervalSinceReferenceDate:(double)arg1;
...
- (id)itk_briefFormattedDate:(bool)arg1;
- (id)itk_briefFormattedDateForAccessibility;
- (bool)itk_isEarlierThanDate:(id)arg1;
- (bool)itk_isLaterThanDate:(id)arg1;
- (bool)itk_isToday;
- (bool)itk_isYesterday;
...
+ (id)firstSaturdayBeforeReferenceDate:(id)arg1;
...
- (bool)isAfterDate:(id)arg1;
- (bool)isBeforeDate:(id)arg1;
- (bool)isFollowingDayAfterDate:(id)arg1;
- (bool)isFollowingMonthAfterDate:(id)arg1;
- (bool)isFollowingWeekAfterDate:(id)arg1;
- (bool)isFollowingYearAfterDate:(id)arg1;
- (bool)isOnOrAfter:(id)arg1;
- (bool)isOnOrBefore:(id)arg1;
- (bool)isSameDayWithDate:(id)arg1;
- (bool)isSameDayWithDate:(id)arg1 timeZone:(id)arg2;
- (bool)isSameMonthWithDate:(id)arg1;
- (bool)isSameWeekWithDate:(id)arg1;
- (bool)isSameYearWithDate:(id)arg1;
- (unsigned long long)minutes;
- (id)snapToTheDay;
- (id)startOfDay;
- (id)startOfDayWithBoundaryOfADay:(double)arg1;
- (id)stringFromDate;
...
- (id)ic_briefFormattedDate:(bool)arg1 locale:(id)arg2;
- (id)ic_briefFormattedDateForAccessibility;
- (id)ic_briefFormattedDateForSiriLocale:(id)arg1 forAccessibility:(bool)arg2;
- (id)ic_endOfDay;
...
- (id)ic_shortFormattedDateForAccessibility:(bool)arg1;
- (id)ic_startOfDay;
- (id)ic_truncated;
...
- (id)dateWithoutTime;
- (bool)isDateAtLeastNDays:(unsigned long long)arg1 afterDate:(id)arg2;
- (bool)isDateEqualToDateIgnoringTime:(id)arg1;
- (bool)isDateLessThanNDays:(unsigned long long)arg1 afterDate:(id)arg2;
- (bool)isToday;
- (bool)isTomorrow;
- (bool)isYesterday;
...
- (id)roundedFormattedTimeWithRoundedMinutesUnit:(long long)arg1 allowedUnits:(unsigned long long)arg2;
- (id)roundedTime;
...
- (bool)hksp_isWithinInterval:(double)arg1 ofDate:(id)arg2;
...
- (bool)ics_isTodayWithCalendar:(id)arg1;
