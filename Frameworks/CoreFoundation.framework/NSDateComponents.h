...
- (void)setDayOfYear:(long long)arg1;
...
- (id)wfName;
- (unsigned long long)wf_dateFormatterDateStyleForDisplayableCalendarUnits:(unsigned long long)arg1;
- (unsigned long long)wf_dateFormatterTimeStyleForDisplayableCalendarUnits:(unsigned long long)arg1;
