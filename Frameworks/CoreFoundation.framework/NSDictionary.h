...
@property (nonatomic, readonly, copy) NSString *privateMACAddress;
@property (nonatomic, readonly) bool privateMACAddressValid;
...
@property (nonatomic, readonly) bool wasConnectedDuringSleep;
...
- (bool)_hk_validateMetadataIntroducedWithIOS13WithValue:(id)arg1 forKey:(id)arg2 error:(id*)arg3;
- (bool)_hk_validateMetadataIntroducedWithIOS14WithValue:(id)arg1 forKey:(id)arg2 error:(id*)arg3;
- (bool)_hk_validateMetadataIntroducedWithIOS15WithValue:(id)arg1 forKey:(id)arg2 error:(id*)arg3;
- (bool)_hk_validateMetadataIntroducedWithIOS16WithValue:(id)arg1 forKey:(id)arg2 error:(id*)arg3;
- (bool)_hk_validateMetadataIntroducedWithIOS17WithValue:(id)arg1 forKey:(id)arg2 error:(id*)arg3;
- (bool)_hk_validateMetadataIntroducedWithIOS18WithValue:(id)arg1 forKey:(id)arg2 error:(id*)arg3;
- (bool)_hk_validateMetadataValueContent:(id)arg1 forKey:(id)arg2 applicationSDKVersionToken:(unsigned long long)arg3 error:(id*)arg4;
- (bool)_hk_validateMetadataValueForWorkoutEvent:(id)arg1 valueContent:(id)arg2 forKey:(id)arg3 applicationSDKVersionToken:(unsigned long long)arg4 error:(id*)arg5;
...
- (bool)hk_validateMetadataKeysAndValuesAllowingPrivateMetadataKeys:(bool)arg1 applicationSDKVersionToken:(unsigned long long)arg2 error:(id*)arg3;
- (bool)hk_validateMetadataKeysAndValuesForWorkoutEvent:(id)arg1 applicationSDKVersionToken:(unsigned long long)arg2 error:(id*)arg3;
...
- (long long)intents_int64ForKey:(id)arg1;
...
- (bool)lt_ensureTypesForKeys:(Class)arg1 values:(Class)arg2;
...
- (id)ams_compactMapValues:(id /* block */)arg1;
...
+ (bool)asdtGetFourCC:(unsigned int*)arg1 forObject:(id)arg2 withDefault:(unsigned int)arg3;

- (id)asdtArrayForKey:(id)arg1;
- (id)asdtArrayOfDictionariesForKey:(id)arg1;
- (id)asdtArrayOfNumbersForKey:(id)arg1;
- (id)asdtArrayOfStringsForKey:(id)arg1;
- (bool)asdtBoolForKey:(id)arg1;
- (Class)asdtBundleClass;
- (id)asdtBundleExtension;
- (id)asdtBundlePath;
- (id)asdtBundleResource;
- (id)asdtBundleSubdir;
- (bool)asdtCanBeDefaultInputDevice;
- (bool)asdtCanBeDefaultOutputDevice;
- (bool)asdtCanBeDefaultSystemDevice;
- (unsigned int)asdtClockDomain;
- (bool)asdtControlClassID:(unsigned int*)arg1;
- (id)asdtControls;
...
- (id)asdtDeviceUID;
- (id)asdtDevices;
- (bool)asdtDirection:(unsigned int*)arg1;
- (unsigned int)asdtElement;
- (id)asdtExclavesBufferName;
- (Class)asdtFactorySubclass;
- (id)asdtFilePath;
- (id)asdtFormats;
- (id)asdtFormatsWithSamplingRates:(id)arg1;
- (unsigned int)asdtFourCCForKey:(id)arg1 withDefault:(unsigned int)arg2;
- (bool)asdtGetSelector:(unsigned int*)arg1;
- (unsigned int)asdtIOThreadChangeContextID;
- (int)asdtIOThreadChangeEvent;
- (unsigned int)asdtIOThreadChangeIsolatedUseCase;
- (bool)asdtIOThreadUseCaseIsFirstOrWasLast;
- (unsigned int)asdtIOThreadUseCaseThreadCount;
- (id)asdtInputLatenciesForSamplingRates:(id)arg1;
- (bool)asdtIsSettable;
- (unsigned long long)asdtIsolatedUseCaseID;
- (id)asdtLatenciesForSamplingRates:(id)arg1;
- (id)asdtLatenciesForSamplingRates:(id)arg1 latencyUsKey:(id)arg2 latencyDictKey:(id)arg3;
...
- (bool)asdtManagerVerboseLogging;
- (id)asdtName;
- (id)asdtNumberForKey:(id)arg1;
- (unsigned int)asdtNumericCount;
- (bool)asdtNumericIsVectorWithCount:(unsigned int)arg1;
- (int)asdtNumericType;
- (id)asdtOutputLatenciesForSamplingRates:(id)arg1;
...
- (bool)asdtPMNoStateChangeOnFailure;
- (bool)asdtPMOrder:(unsigned int*)arg1 forPowerUp:(bool)arg2;
- (bool)asdtPMOrder:(unsigned int*)arg1 forPowerUp:(bool)arg2 allowDefault:(bool)arg3;
- (unsigned int)asdtPMOrderWithDefaultForPowerUp:(bool)arg1;
...
- (bool)asdtSamplingRate:(double*)arg1 andSamplingRates:(id*)arg2 withDefault:(double)arg3;
- (unsigned int)asdtScope;
- (unsigned int)asdtSelectorControlItemKind;
- (bool)asdtSelectorControlItemSelected;
- (bool)asdtSelectorControlItemValue:(unsigned int*)arg1;
- (id)asdtSelectorControlItems;
- (id)asdtServiceID;
- (unsigned int)asdtStartingChannel;
- (id)asdtStreams;
- (id)asdtStringForKey:(id)arg1;
- (Class)asdtSubclass;
...
- (void)setValueWithNilHandling:(id)arg1 forKey:(id)arg2;
- (void)setValueWithNilHandling:(id)arg1 forKey:(id)arg2;
- (void)setValueWithNilHandling:(id)arg1 forKey:(id)arg2;
- (void)setValueWithNilHandling:(id)arg1 forKey:(id)arg2;
- (void)setValueWithNilHandling:(id)arg1 forKey:(id)arg2;
...
- (void)setValueWithNilHandling:(id)arg1 forKey:(id)arg2;
- (void)setValueWithNilHandling:(id)arg1 forKey:(id)arg2;
- (id)valueWithNilHandlingForKey:(id)arg1;
- (id)valueWithNilHandlingForKey:(id)arg1;
- (id)valueWithNilHandlingForKey:(id)arg1;
- (id)valueWithNilHandlingForKey:(id)arg1;
- (id)valueWithNilHandlingForKey:(id)arg1;
...
- (id)ak_dictionaryWithKeysFromArray:(id)arg1;
- (id)ak_redactedCopy;
...
+ (id)bsobjc_attributesForProperty:(struct objc_property { }*)arg1;
...
- (id)cmi_dictionary;
- (id)cmi_dictionaryMergedWithDefaultDict:(id)arg1;
...
- (id)ckmfi_numberArrayForKey:(id)arg1;
- (id)ckmfi_numberForKey:(id)arg1;
...
+ (id)MCM_dictionaryWithContentsOfURL:(id)arg1 options:(unsigned long long)arg2 fileManager:(id)arg3 fsNode:(id*)arg4 error:(id*)arg5;
...
- (bool)MCM_writeToURL:(id)arg1 withOptions:(unsigned long long)arg2 fileManager:(id)arg3 error:(id*)arg4;
...
- (bool)crxu_containsKey:(id)arg1;
- (id)crxu_dataForKey:(id)arg1;
- (id)crxu_dateForKey:(id)arg1;
- (double)crxu_doubleForKey:(id)arg1;
- (long long)crxu_integerForKey:(id)arg1;
- (id)crxu_objectOfClass:(Class)arg1 forKey:(id)arg2;
...
+ (id)dmc_jsonDictionaryFromData:(id)arg1;
...
- (id)fa_eventTypeForFamilyActionURL;
...
- (bool)boolValueFromKey:(id)arg1 defaultValue:(bool)arg2;
- (double)doubleValueFromKey:(id)arg1 defaultValue:(double)arg2;
- (long long)integerValueFromKey:(id)arg1 defaultValue:(long long)arg2;
- (id)numberValueFromKey:(id)arg1;
- (unsigned long long)unsignedIntegerValueFromKey:(id)arg1 defaultValue:(unsigned long long)arg2;
...
- (void)hmf_enumerateKeysAndObjectsWithAutoreleasePoolUsingBlock:(id /* block */)arg1;
...
- (id)handsKit_jsonDataWithPrettyPrint:(bool)arg1;
- (id)handsKit_jsonStringWithPrettyPrint:(bool)arg1;
...
- (id)CHIPCommandID;
- (id)CHIPData;
- (id)CHIPDownloadLogType;
- (id)CHIPDownloadTimeout;
- (id)CHIPEndpointID;
- (id)CHIPMaxInterval;
- (id)CHIPMinInterval;
- (id)CHIPReadParams;
- (id)CHIPRemoteCommand;
- (id)CHIPRemoteMessageTimeout;
...
- (void)__message_defaultFileTransferEnforceMaxFileSize:(bool)arg1 withCompletion:(id /* block */)arg2;
- (void)__message_iterateFileTransferUserInfoWithCompletion:(id /* block */)arg1;
...
+ (id)dictionaryWithAssociatedMessageSummary:(id)arg1 contentType:(unsigned char)arg2 associatedMessagePartText:(id)arg3 pluginBundleID:(id)arg4 pluginDisplayName:(id)arg5;
...
- (id)__imami_attributedStringForKey:(id)arg1;
...
- (id)_IF_dictionarySubsetForKeys:(id)arg1;
...
- (id)itk_dictionaryByAddingEntriesFromNonNilDictionary:(id)arg1;
- (id)itk_md5;
- (id)itk_objectForNonNilKey:(id)arg1;
- (id)itk_prettyDescriptionWithTabLevel:(unsigned long long)arg1;

// Image: /System/Library/PrivateFrameworks/InstallCoordination.framework/InstallCoordination

+ (id)IX_dictionaryWithContentsOfURL:(id)arg1 options:(unsigned long long)arg2 error:(id*)arg3;

- (bool)IX_writeToURL:(id)arg1 format:(unsigned long long)arg2 options:(unsigned long long)arg3 error:(id*)arg4;

// Image: /System/Library/PrivateFrameworks/InstalledContentLibrary.framework/InstalledContentLibrary

+ (id)MI_dictionaryByMergingDictionaries:(id)arg1;
...
+ (id)_pas_dictionaryNoCopyLeavesWithPropertyListData:(id)arg1 error:(id*)arg2;
...
- (bool)safari_containsEntryPassingTest:(id /* block */)arg1;
...
- (id)safari_valuesOfEntriesPassingTest:(id /* block */)arg1;
...
- (id)unc_nonEmptyCopy;
- (id)unc_nonNilArrayForKey:(id)arg1;
- (id)unc_nonNilDictionaryForKey:(id)arg1;
- (id)unc_nonNilSetForKey:(id)arg1;
- (id)unc_safeCastNonNilStringForKey:(id)arg1;
- (id)unc_safeCastObjectForKey:(id)arg1 class:(Class)arg2;
- (id)unc_safeCastObjectForKey:(id)arg1 classes:(id)arg2;
...
- (void)VFXFloat3Value;
- (void)VFXFloat4Value;
- (struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; })VFXMatrix4Value;
...
- (id)dictionaryByMergingEntriesFromDictionary:(id)arg1;
...
- (id)fp_mergeAuxDatum:(id)arg1 withDatum:(id)arg2 forceAggregate:(bool)arg3;
- (id)fp_mergeWithData:(id)arg1;
- (id)fp_mergeWithData:(id)arg1 forceAggregate:(bool)arg2;
