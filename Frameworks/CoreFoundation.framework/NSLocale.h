...
@property (nonatomic, readonly) bool localeIsArabic;
...
+ (id)lt_bestMatchForPreferredLocales:(id)arg1 fromSupportedLocales:(id)arg2;
+ (id)lt_defaultTargetForSource:(id)arg1 systemLocale:(id)arg2 availableLocales:(id)arg3 targetMap:(id)arg4;
+ (id)lt_fallbackForLocale:(id)arg1;
...
+ (bool)atx_usesTwelveHourClock;
+ (bool)atx_usesTwelveHourClockWithLocaleIdentifier:(id)arg1;
...
+ (id)_displayNameForNormalizedLanguage:(id)arg1 context:(long long)arg2 displayLanguage:(id)arg3 length:(unsigned long long)arg4 isCalcium:(bool)arg5;
...
+ (bool)_defaultUsesTwelveHourClockForLocaleIdentifier:(id)arg1;
...
+ (void)_setUsesTwelveHourClockForLoginWindow:(bool)arg1;
...
+ (id)languageIdentifierForRegisteringPreferredLanguageFromAddedKeyboardLanguage:(id)arg1 forPreferredLanguages:(id)arg2;
