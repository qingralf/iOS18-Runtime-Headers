...
- (void)ef_insertOptionalObject:(id)arg1 atIndex:(unsigned long long)arg2;
...
- (unsigned long long)hf_insertObject:(id)arg1 intoSortedArrayWithOptions:(unsigned long long)arg2 comparator:(id /* block */)arg3;
...
- (void)itk_addNonNilObject:(id)arg1;
- (void)itk_addObjectsFromNonNilArray:(id)arg1;
- (void)itk_insertNonNilObject:(id)arg1 atIndex:(long long)arg2;
- (id)itk_peek;
- (id)itk_pop;
- (void)itk_push:(id)arg1;
- (void)itk_randomize;
- (void)itk_swapItemAtIndex:(long long)arg1 withItemAtIndex:(long long)arg2;
...
- (bool)triMoveFirstItemToFrontPassingTest:(id /* block */)arg1;
