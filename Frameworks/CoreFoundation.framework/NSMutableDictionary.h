...
- (void)ams_deleteValueForKeyPath:(id)arg1;
- (void)ams_flatInsertValue:(id)arg1 forKeyPath:(id)arg2;
- (void)ams_insertValue:(id)arg1 forKeyPath:(id)arg2;
- (void)ams_setNullableObject:(id)arg1 forKey:(id)arg2;
- (void)ams_setValue:(id)arg1 forKeyPath:(id)arg2;
- (void)ams_setValue:(id)arg1 forKeyPath:(id)arg2 shouldAppendToContainers:(bool)arg3 shouldFlatten:(bool)arg4;
- (void)ams_setValue:(id)arg1 forKeyPathComponents:(id)arg2 shouldAppendToContainers:(bool)arg3 shouldFlatten:(bool)arg4;
...
- (void)asdtAddMissingEntriesFromDictionary:(id)arg1;
...
- (id)__ck_fontUsedWhenTogglingTypingAttributesUsingBaseFont:(id)arg1;
- (void)_ck_addTextEffect:(long long)arg1;
- (void)_ck_removeTextEffect;
- (void)_ck_toggleTextStyleBoldUsingBaseFont:(id)arg1;
- (void)_ck_toggleTextStyleItalicUsingBaseFont:(id)arg1;
- (void)_ck_toggleTextStyleStrikethrough;
- (void)_ck_toggleTextStyleUnderline;
- (void)ck_addTypingAttributeFontTrait:(unsigned int)arg1;
- (void)ck_removeBoldItalicUnderlineAndStrikethroughTypingAttributes;
- (void)ck_removeTextAnimationsTypingAttributes;
- (void)ck_removeTypingAttributeFontTrait:(unsigned int)arg1;
- (void)ck_toggleTextEffect:(long long)arg1;
- (void)ck_toggleTextStyles:(unsigned long long)arg1 baseFont:(id)arg2;
...
- (id)MCM_deepCopy;
- (void)MCM_overlayDictionary:(id)arg1 existingValuesTakePrecedent:(bool)arg2;
- (void)MCM_replaceDeepDictionariesWithReplaceHandler:(id /* block */)arg1;
- (id)_createOrConvertToMutableDictionaryFromDictionary:(id)arg1;
- (id)_dictionaryAtKeyPath:(id)arg1;
- (id)_findKeyPathsSortedByDepthFirstOfKindOfClass:(Class)arg1;
...
- (void)safelyAddObjectToArrayCollection:(id)arg1 forKey:(id)arg2;
- (void)safelyAddObjectToSetCollection:(id)arg1 forKey:(id)arg2;
- (void)safelySetObject:(id)arg1 forKey:(id)arg2;
...
- (void)setOrAddToDecimalValue:(id)arg1 forKey:(id)arg2;
- (void)setOrAddToDoubleValue:(double)arg1 forKey:(id)arg2;
...
- (void)_gkSetIfNonNilObject:(id)arg1 forKey:(id)arg2;
...
- (void)setCHIPDownloadLogType:(id)arg1;
- (void)setCHIPDownloadTimeout:(id)arg1;
...
- (void)setCHIPRemoteMessageTimeout:(id)arg1;
...
- (void)__imami_setAttributedString:(id)arg1 forKey:(id)arg2;
...
- (void)itk_addEntriesFromNonNilDictionary:(id)arg1;
- (void)itk_addKey:(id)arg1 forNonNilObject:(id)arg2;
- (void)itk_removeObjectForNonNilKey:(id)arg1;
- (void)itk_setNonNilObject:(id)arg1 forKey:(id)arg2;
- (void)itk_setNonNilObject:(id)arg1 forNonNilKey:(id)arg2;
...
- (id)getOrCreateObjectForKey:(id)arg1 creationBlock:(id /* block */)arg2;
- (void)safelySetObject:(id)arg1 forKey:(id)arg2;
- (void)setBool:(bool)arg1 forKey:(id)arg2;
- (void)setDouble:(double)arg1 forKey:(id)arg2;
...
- (id)_pl_mutableDictionaryCreateAndInsertIfNeededForKey:(id)arg1;
- (void)_pl_safeAddObject:(id)arg1 toMutableArrayForKey:(id)arg2;
...
- (void)unc_safeSetNonEmptyArray:(id)arg1 forKey:(id)arg2;
- (void)unc_safeSetNonEmptyDictionary:(id)arg1 forKey:(id)arg2;
- (void)unc_safeSetNonEmptySet:(id)arg1 forKey:(id)arg2;
- (void)unc_safeSetNonEmptyString:(id)arg1 forKey:(id)arg2;
- (void)unc_safeSetNonEmptyString:(id)arg1 withLimit:(unsigned long long)arg2 forKey:(id)arg3;
- (void)unc_safeSetObject:(id)arg1 forKey:(id)arg2;
