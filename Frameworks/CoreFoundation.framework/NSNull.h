...
@interface NSNull : NSObject <AADataType, AFSecurityDigestibleChunksProviding, BMDSLNativeJSONArchiving, CAAction, CCDatabaseValue, CMSCoding, EFSQLBindable, EFSQLValueExpressable, GCSJSONObject, HAP2AccessoryCharacteristicEncodableBodyValue, HMDOPACKValue, IMJSONSerializableValueProviding, MGRemoteQueryDecodable, MPCPlaybackEngineEventPayloadValueJSONConvertible, NSCopying, NSSecureCoding, PQLBindable, REDonatedActionIdentifierProviding, SEMDatabaseValue, SiriCoreSQLiteValue, TSDMixing, TSDPathPainter, TSSPropertyValueArchiving, WFJSONObject, WFJavaScriptCoreBridgeableObject, _AFBundleResourceURLProviding>
