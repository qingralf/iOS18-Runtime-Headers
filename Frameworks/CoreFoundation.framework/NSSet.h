...
@interface NSSet : NSObject <BSCollection, CKDeepCopying, EFSQLValueCollectionExpressable, HKUUIDCollection, HMFObject, InnerContentHash, NSCopying, NSFastEnumeration, NSMutableCopying, NSSecureCoding, PQLBindable, PXFastEnumeration, _DASEnumerable, _SetOperable>
...
- (id)ded_flatMapWithBlock:(id /* block */)arg1;
...
+ (id)setWithObjectsFrom:(id)arg1;

- (bool)enumerateObjectsInChunksOfSize:(unsigned long long)arg1 block:(id /* block */)arg2;

// Image: /System/Library/PrivateFrameworks/EmailFoundation.framework/EmailFoundation

- (id)differenceFromSet:(id)arg1;
- (id)ef_SQLExpression;
...
- (unsigned long long)fc_countOfObjectsIntersectingSet:(id)arg1;
...
- (id)pk_setBySafelyApplyingBlock:(id /* block */)arg1;
...
- (id)_pas_setByRemovingObject:(id)arg1;
- (id)_pas_setByRemovingObjectsFromSet:(id)arg1;
...
- (id)safari_dictionaryByMappingObjectsToValuesUsingBlock:(id /* block */)arg1;
