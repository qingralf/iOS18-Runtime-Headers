...
@property (nonatomic, readonly) SWCollaborationShareOptions *ckCollaborationShareOptions;
...
@property (nonatomic, readonly) long long fc_fileSystemFreeSize;
@property (nonatomic, readonly) long long fc_volumeAvailableCapacityForOpportunisticUsage;
...
@property (nonatomic, readonly) NSString *gkFileSystemRepresentation;
...
@property (nonatomic, readonly) long long ic_fileOrDirectorySize;
...
@property (readonly) bool isQuickTime;
...
@property (nonatomic, readonly) bool msv_isValidMediaAssetURL;
@property (nonatomic, readonly) unsigned long long msv_mediaAssetPersistentID;
...
@property (nonatomic, readonly) bool needsDownload; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) NSURL *safari_URLByRemovingQuery;
@property (nonatomic, readonly, copy) NSURL *safari_URLByRemovingUserPasswordPathQueryAndFragment;
@property (nonatomic, readonly) NSURL *safari_URLWithUniqueFilename;
@property (nonatomic, readonly, copy) NSString *safari_absoluteStringWithoutFragment;
@property (nonatomic, readonly) bool safari_canQuirkBannerForNavigation;
...
@property (nonatomic, readonly) NSURL *safari_firstURLQueryValue;
@property (nonatomic, readonly) bool safari_hasCustomScheme;
@property (nonatomic, readonly) bool safari_hasFeedScheme;
@property (nonatomic, readonly) bool safari_hasLocalScheme;
@property (nonatomic, readonly, copy) NSString *safari_highLevelDomain;
@property (nonatomic, readonly, copy) NSString *safari_highLevelDomainFromHostFallingBackToHostOrAbsoluteString;
...
@property (nonatomic, readonly) bool safari_isAppleNewsURL;
@property (nonatomic, readonly) bool safari_isAppleOneURL;
...
@property (nonatomic, readonly) bool safari_isMarketplaceKitURL;
...
@property (nonatomic, readonly) bool safari_isSlackRedirectPage;
...
@property (nonatomic, readonly) bool safari_isXWebSearchURL;
...
@property (nonatomic, readonly, copy) NSString *safari_userVisibleScheme;
...
- (id)_URLByInsertingResolveFlags:(unsigned int)arg1;
...
+ (id)fp_supportDirectoryForVolume:(id)arg1;
...
- (long long)_fp_relationshipToItemAtURL:(id)arg1 bothAreRealpaths:(bool)arg2;
...
- (id)fp_copyToURL:(id)arg1 queue:(id)arg2 precomputedItemSize:(unsigned long long)arg3 replacePlaceholder:(bool)arg4 shouldCopyAppleDouble:(bool)arg5 completion:(id /* block */)arg6;
...
- (id)fp_fpfsProviderDomainID:(bool)arg1;
- (id)fp_fpfsProviderDomainID:(bool)arg1 error:(id*)arg2;
- (id)fp_fpfsProviderDomainID:(bool)arg1 skipTypeCheck:(bool)arg2 error:(id*)arg3;
- (id)fp_fpfsRootURL;
...
- (long long)fp_realPathRelationshipToItemAtRealPathURL:(id)arg1;
- (id)fp_realpathURL;
...
- (id)fp_resolveDetachedRootLogicalLocation:(bool*)arg1 error:(id*)arg2;
...
- (id)fp_volumeUUID;
- (bool)fp_volumeUsesAppleDouble:(id)arg1;
...
- (id)_QLFileSize;
- (bool)_QLIsDataLess;
- (bool)_QLIsThumbnailableWithError:(id*)arg1;
...
- (bool)_bcs_isSHCURL;
- (bool)_bcs_isUPIURL;
- (bool)_bcs_isWalletRemoteRequestURL;
...
+ (void)_br_bookmarkableStringForURL:(id)arg1 remoteOpeningAppWithBundleID:(id)arg2 onlyAllowItemKnowByServer:(bool)arg3 completion:(id /* block */)arg4;
+ (void)br_bookmarkableStringForURL:(id)arg1 withEtag:(bool)arg2 completion:(id /* block */)arg3;
+ (void)br_bookmarkableStringForURL:(id)arg1 withEtag:(bool)arg2 onlyAllowItemKnowByServer:(bool)arg3 completion:(id /* block */)arg4;
+ (void)br_containerIDsWithExternalReferencesTo:(id)arg1 completionHandler:(id /* block */)arg2;
+ (void)br_datalessMaterializationOffForBlock:(id /* block */)arg1;
...
+ (bool)br_isURL:(id)arg1 syncRootOwnedByICloudDrive:(bool*)arg2 withError:(id*)arg3;
+ (void)br_setIOPolicy:(int)arg1 type:(int)arg2 forBlock:(id /* block */)arg3;
...
- (bool)_br_isParentOfURL:(id)arg1 strictly:(bool)arg2 ignoreHomeDirectoryCheck:(bool)arg3;
- (bool)_br_isParentOfURL:(id)arg1 strictly:(bool)arg2 withNonMateralizingIOPolicy:(bool)arg3 ignoreHomeDirectoryCheck:(bool)arg4;
...
- (id)br_getSyncRootWithError:(id*)arg1;
...
- (bool)br_isExistWithNonMateralizingIOPolicy:(bool)arg1;
- (bool)br_isExternalDocumentReference;
- (bool)br_isIgnoredByFileProvider;
- (bool)br_isIgnoredByFileProviderWithError:(id*)arg1;
...
- (bool)br_isParentOfURL:(id)arg1 ignoreHomeDirectoryCheck:(bool)arg2;
...
+ (id)_cnui_dialRequestURLWithHandle:(id)arg1 contact:(id)arg2 faceTime:(bool)arg3 video:(bool)arg4 ttyType:(long long)arg5 channelIdentifier:(id)arg6 preferDefaultApp:(bool)arg7;
...
+ (id)_cnui_messagingURLFutureWithHandle:(id)arg1 contact:(id)arg2;
+ (id)_cnui_messagingURLWithHandle:(id)arg1 contact:(id)arg2;
...
+ (id)_cnui_telephonyURLFutureWithHandle:(id)arg1 contact:(id)arg2 channelIdentifier:(id)arg3 preferDefaultApp:(bool)arg4;
+ (id)_cnui_telephonyURLFutureWithHandle:(id)arg1 contact:(id)arg2 preferDefaultApp:(bool)arg3;
+ (id)_cnui_telephonyURLWithHandle:(id)arg1 contact:(id)arg2 channelIdentifier:(id)arg3 preferDefaultApp:(bool)arg4;
+ (id)_cnui_telephonyURLWithHandle:(id)arg1 contact:(id)arg2 preferDefaultApp:(bool)arg3;
...
- (id)dd_phoneNumberFromTelSchemeAndExtractBody:(id*)arg1 serviceID:(id*)arg2 suggestions:(id*)arg3;
...
+ (id)_launchURLWithHostname:(id)arg1 workoutIdentifier:(id)arg2 date:(id)arg3 source:(id)arg4;
+ (id)fi_endWorkoutURLWithIdentifier:(id)arg1;
+ (id)fi_pauseWorkoutURLWithIdentifier:(id)arg1;
+ (id)fi_resumeWorkoutURLWithIdentifier:(id)arg1 date:(id)arg2 source:(id)arg3;
...
- (id)ln_linkedFrameworksWithError:(id*)arg1;
...
+ (id)msv_urlForMediaAssetWithPersistentID:(long long)arg1 pathExtension:(id)arg2;
...
+ (id)fc_NewsURLForArticleID:(id)arg1 internal:(bool)arg2 targetIsVideo:(bool)arg3 hardPaywall:(bool)arg4;
+ (id)fc_NewsURLForArticleID:(id)arg1 routeURL:(id)arg2;
+ (id)fc_NewsURLForTagID:(id)arg1;
+ (id)fc_NewsURLWithPathComponents:(id)arg1;
+ (id)fc_NewsURLWithPathComponents:(id)arg1 internal:(bool)arg2;
+ (id)fc_NewsURLWithPathComponents:(id)arg1 queryItems:(id)arg2 internal:(bool)arg3;
...
- (id)fc_URLWithVideoTarget:(bool)arg1;
...
- (bool)fc_isGzippedWithMIMETypeHint:(id)arg1;
- (bool)fc_isHTTPScheme;
- (bool)fc_isHardPaywallNewsArticleURL:(out id*)arg1;
- (bool)fc_isNewsArticleURL;
- (bool)fc_isNewsArticleVideoURL;
- (bool)fc_isNewsIssueURL;
- (bool)fc_isNewsPuzzleTypeURL;
- (bool)fc_isNewsPuzzleURL;
- (bool)fc_isNewsSportsEventURL;
...
- (id)fc_valueForQueryItemWithName:(id)arg1;
- (long long)fc_volumeAvailableCapacityForOpportunisticUsage;
- (unsigned short)getUInt16XAttrWithName:(id)arg1;
- (void)setUInt16XAttr:(unsigned short)arg1 withName:(id)arg2;
...
+ (id)nss_NewsURLForFullArchivePuzzleTypeID:(id)arg1;
...
- (bool)nss_isNewsIssueURL;
- (bool)nss_isNewsTagURL;
- (bool)nss_isNewsURL;
- (bool)nss_isPuzzleTypeURL;
- (bool)nss_isPuzzleURL;
- (bool)nss_isSportsEventURL;
...
+ (id)pf_dictionaryToEscapedQueryString:(id)arg1;

- (id)im_jsonSerializableValue;
- (bool)isHLSPlaylist;
- (bool)isPackagedMedia;
- (id)pf_URLByAppendingHashString:(id)arg1;
- (id)pf_URLByAppendingQueryParameterKey:(id)arg1 value:(id)arg2;
- (id)pf_URLByAppendingQueryParameters:(id)arg1;
- (id)pf_URLByAppendingQueryString:(id)arg1;
- (id)pf_URLByRemovingQueryParameters:(id)arg1;
...
- (id)pf_components;
- (bool)pf_isHLSPlaylistObjC;
- (bool)pf_isPackagedMediaObjC;
...
- (bool)prs_URLExists:(bool*)arg1;
- (bool)prs_isDirectory;
- (bool)prs_isPosterSnapshot;
- (bool)prs_isPurgable;
- (bool)prs_setPurgable:(bool)arg1 afterDate:(id)arg2 error:(out id*)arg3;
- (bool)prs_unmarkAsPurgable;

// Image: /System/Library/PrivateFrameworks/PosterFoundation.framework/PosterFoundation

+ (id)pf_posterPathContentsURLForInstanceURL:(id)arg1;
+ (id)pf_posterPathContentsURLForProviderURL:(id)arg1 type:(long long)arg2 posterUUID:(id)arg3 version:(unsigned long long)arg4;
+ (id)pf_posterPathIdentifierURLProviderURL:(id)arg1 type:(long long)arg2 posterUUID:(id)arg3;
+ (id)pf_posterPathInstanceURLForProviderURL:(id)arg1 type:(long long)arg2 posterUUID:(id)arg3 version:(unsigned long long)arg4;
+ (id)pf_posterPathInstanceURLForVersionsURL:(id)arg1 version:(unsigned long long)arg2;
+ (id)pf_posterPathSupplementContainerURLForInstanceURL:(id)arg1;
+ (id)pf_posterPathSupplementURLForInstanceURL:(id)arg1 supplement:(unsigned long long)arg2;
+ (id)pf_posterPathTypeURLForProviderURL:(id)arg1 type:(long long)arg2;
+ (id)pf_posterPathVersionsURLForProviderURL:(id)arg1 type:(long long)arg2 posterUUID:(id)arg3;
+ (id)pf_temporaryDirectoryURL;
+ (id)pf_temporaryDirectoryURLNamed:(id)arg1;

- (id)pf_loadFromPlistWithError:(out id*)arg1;
- (bool)pf_storeToPlist:(id)arg1 error:(out id*)arg2;

// Image: /System/Library/PrivateFrameworks/ProVideo.framework/ProVideo

+ (id)motionBundleURLFromMotionDocURL:(id)arg1;
+ (id)motionDocURLFromMotionBundleURL:(id)arg1;
...
- (long long)safari_hostCompare:(id)arg1;
...
- (bool)safari_isSameAsURLRemovingFragment:(id)arg1;
...
- (bool)_safari_isWithinQuirkedNavigationScope:(id)arg1;
...
- (bool)safari_canQuirkBannerForNavigation;
...
- (bool)safari_isEqualToOrChildOfStartURL:(id)arg1;
...
- (bool)safari_isMarketplaceKitURL;
...
- (bool)safari_isSlackRedirectPage;
- (bool)safari_isTelURL;
- (bool)safari_isTopLevelURL;
- (bool)safari_isURLTooLongToDisplay;
- (bool)safari_isWithinWebAppNavigationScope:(id)arg1;
- (bool)safari_isWithinWebAppNavigationScope:(id)arg1 allowingQuirks:(bool)arg2;
...
+ (id)URLWithStringAndDataDetection:(id)arg1;
...
+ (bool)isDefaultAppScheme:(id)arg1;
+ (id)openNoteURLForRecordingSession:(id)arg1;
...
- (bool)isFaceTimeAppViewLinkRequestDetailsURL;
...
+ (id)vs_URLWithString:(id)arg1;

- (id)initWithVsString:(id)arg1;
...
- (id)vui_URLByRemovingQueryParamWithName:(id)arg1;
...
- (id)rc_URLByAppendingStringToLastComponentBasename:(id)arg1 replacingPathExtension:(id)arg2;
...
- (id)icq_URLByAppendingQueryItems:(id)arg1;
- (id)icq_URLByAppendingQueryParamName:(id)arg1 value:(id)arg2;
- (id)icq_URLByAppendingQueryParamtersFromContext:(id)arg1;
- (bool)icq_isICQLaunchURL;
- (id)icq_queryItemForName:(id)arg1;
