...
@property (nonatomic) bool BKMenuOnLeft;
@property (nonatomic) bool BKSettingFilterBrightImages;
@property (nonatomic, readonly) bool CompletedBuddyOniPadVersion;
@property (nonatomic, readonly) bool CompletedBuddyVersion;
@property (nonatomic, readonly) NSDictionary *DeviceIdentifierByChildDSID;
@property (nonatomic, readonly) NSString *DeviceIdentifierLocalUser;
@property (nonatomic, readonly) bool DisableBuddy;
@property (nonatomic, copy) NSData *UnitsConfiguration;
@property (nonatomic) bool UserRequestedSubscriptionHidden;
@property (setter=browsingAssistant_setFavoritedMenuActions:, nonatomic, copy) NSArray *browsingAssistant_favoritedMenuActions;
...
@property (nonatomic) bool kDisableAllCoachingAndOnboarding;
...
@property (nonatomic, readonly) unsigned long long shouldPresentAttachmentsInFullScreen;
...
@property (nonatomic, readonly) long long showHolidayCalendarEvents;
...
- (bool)pm_passwordManagerIsInDemoMode;
- (bool)safari_isJavaScriptEnabled;
- (bool)safari_javaScriptCanOpenWindowsAutomatically;
- (void)safari_registerMobileSafariDefaults;
- (void)safari_setShouldAutomaticallyDownloadReadingListItems:(bool)arg1;
- (bool)safari_shouldAutomaticallyDownloadReadingListItems;
- (bool)safari_warnAboutFraudulentWebsites;
...
+ (id)bu_createWithSuiteName:(id)arg1 container:(id)arg2;

- (bool)BKMenuOnLeft;
- (bool)BKSettingFilterBrightImages;
- (void)setBKMenuOnLeft:(bool)arg1;
- (void)setBKSettingFilterBrightImages:(bool)arg1;

// Image: /System/Library/PrivateFrameworks/BookUtility.framework/BookUtility

+ (id)bu_groupUserDefaults;
...
- (unsigned long long)analyticsDelay;
- (unsigned long long)cecActiveSourceRecentlySentDuration;
- (bool)cecDeferLossOfLink;
- (unsigned long long)lastKnownPhysicalAddress;
- (unsigned long long)powerNotificationDebounceTime;
- (void)setLastKnownPhysicalAddress:(unsigned long long)arg1;
...
- (void)setPreferredGroupedSenderGrouping:(long long)arg1;
- (unsigned long long)shouldPresentAttachmentsInFullScreen;
...
- (bool)CompletedBuddyOniPadVersion;
- (bool)CompletedBuddyVersion;
- (bool)DisableBuddy;
...
- (bool)kDisableAllCoachingAndOnboarding;
...
- (void)setKDisableAllCoachingAndOnboarding:(bool)arg1;
...
- (bool)browsingAssistant_isMenuActionFavorited:(id)arg1;
- (void)browsingAssistant_setFavoritedMenuActions:(id)arg1;
- (void)browsingAssistant_setMenuActionFavorited:(id)arg1 favorited:(bool)arg2;

// Image: /System/Library/PrivateFrameworks/MusicUI.framework/MusicUI

- (bool)UserRequestedSubscriptionHidden;
- (void)setUserRequestedSubscriptionHidden:(bool)arg1;
...
+ (void)pbf_ignoreExtension:(id)arg1;
...
+ (bool)pbf_stashedDeviceTypeOutOfSync;
+ (void)pbf_unignoreExtension:(id)arg1;
+ (id)pbf_unprotectedUserDefaults;
+ (bool)pbf_updateStashedDeviceType;
...
- (id)safari_observeValuesForKeys:(id)arg1 onQueue:(id)arg2 notifyForInitialValue:(bool)arg3 handler:(id /* block */)arg4;
- (void)safari_removeObjectsForKeysWithPrefix:(id)arg1;
...
- (id)safari_stringForKey:(id)arg1 defaultValue:(id)arg2;
...
- (bool)safari_resetWebKitExperimentalFeaturesIfNeeded:(id)arg1;
...
- (void)setLiveSpeechCategories:(id)arg1;
- (void)setLiveSpeechMaxRecentsCount:(long long)arg1;
- (void)setLiveSpeechPhrases:(id)arg1;
...
- (void)rc_setAudioQuality:(long long)arg1;
- (void)rc_setRecentlyDeletedWindow:(long long)arg1;
- (void)rc_setUseLocationBasedNaming:(bool)arg1;
- (void)rc_setUseStereoRecording:(bool)arg1;
...
- (id)UnitsConfiguration;
- (void)setUnitsConfiguration:(id)arg1;
...
- (bool)tsck_boolForKey:(id)arg1 withDefault:(bool)arg2;
- (unsigned long long)tsck_integerForKey:(id)arg1 withDefault:(unsigned long long)arg2;
- (id)tsck_stringForKey:(id)arg1 withDefault:(id)arg2;
