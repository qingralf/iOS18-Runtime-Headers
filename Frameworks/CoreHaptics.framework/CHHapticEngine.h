...
- (id)createOptionsFromAudioSessionID:(unsigned int)arg1 shared:(bool)arg2 bypassAudioSession:(bool)arg3;
...
- (bool)doInit:(unsigned int)arg1 sessionIsShared:(bool)arg2 options:(id)arg3 bypassAudioSession:(bool)arg4 error:(id*)arg5;
