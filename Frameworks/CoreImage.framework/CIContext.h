...
+ (id)_cachedContext:(id)arg1 options:(id)arg2;
...
+ (void*)internalSWContextWithOptions:(id)arg1;
+ (bool)loadArchive:(id)arg1;
+ (bool)loadArchiveWithName:(id)arg1 fromURL:(id)arg2;
+ (bool)loadArchiveWithURL:(id)arg1;
...
- (struct CGImage { }*)_createCGImage:(id)arg1 fromRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 format:(int)arg3 premultiplied:(bool)arg4 colorSpace:(struct CGColorSpace { }*)arg5 deferred:(struct Trilean { BOOL x1; })arg6 renderCallback:(id)arg7;
- (id)_createClone;
...
- (void)abort;
- (id)addAuxOptionsForSDR:(id)arg1 HDR:(id)arg2 colorSpace:(struct CGColorSpace { }*)arg3 rgbGainmap:(bool)arg4;
