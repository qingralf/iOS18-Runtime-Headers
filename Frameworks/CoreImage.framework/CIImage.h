...
- (struct CGColorSpace { }*)_copyHDRColorspaceFromSource:(struct CGImageSource { }*)arg1 index:(unsigned long long)arg2;
...
- (id)_imageByApplyingGainMap:(id)arg1 headroom:(float)arg2;
...
- (id)_imageByToneMappingColorSpaceToWorkingSpace:(struct CGColorSpace { }*)arg1 targetHeadroom:(float)arg2;
...
- (void)_setOriginalMTLTexture:(id)arg1 options:(id)arg2;
...
- (id)imageByApplyingGainMap:(id)arg1;
- (id)imageByApplyingGainMap:(id)arg1 headroom:(float)arg2;
...
- (id)initGainmapWithImageSource:(struct CGImageSource { }*)arg1 options:(id)arg2;
...
- (id)vg_surfaceWithPixelFormat:(unsigned int)arg1 colorSpaceName:(id)arg2;
