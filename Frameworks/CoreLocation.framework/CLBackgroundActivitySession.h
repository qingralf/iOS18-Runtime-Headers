...
+ (id)backgroundActivitySessionWithQueue:(id)arg1 handler:(id /* block */)arg2;
+ (id)sessionWithLocationManager:(id)arg1 queue:(id)arg2 handler:(id /* block */)arg3;
+ (id)sessionWithLocationManager:(id)arg1 requestPrivilege:(bool)arg2 queue:(id)arg3 handler:(id /* block */)arg4;
...
- (id)identityToken;
- (id)initWithLocationManager:(id)arg1 queue:(id)arg2 handler:(id /* block */)arg3;
- (void)invalidate;
