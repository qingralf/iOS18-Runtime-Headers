...
- (id)initWithInUseLevel:(int)arg1 registrationResult:(int)arg2 transientAwareRegistrationResult:(int)arg3 serviceMaskTuple:(struct CLClientServiceTypeMaskTuple { unsigned long long x1; unsigned long long x2; })arg4 diagnosticMask:(unsigned long long)arg5 authorizedForWidgetUpdates:(bool)arg6;
