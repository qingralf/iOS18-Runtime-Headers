...
- (void)fetchAISAccessoryCapabilities:(id)arg1;
- (void)fetchAISAccessoryCategory:(id)arg1;
- (void)fetchAISBatteryLevel:(id)arg1;
- (void)fetchAISBatteryType:(id)arg1;
- (void)fetchAISFirmwareVersion:(id)arg1;
- (void)fetchAISForTAUnknownBeacon:(id)arg1 macAddress:(id)arg2 deviceType:(id)arg3;
- (void)fetchAISManufacturerName:(id)arg1;
- (void)fetchAISModelName:(id)arg1;
- (void)fetchAISNetworkID:(id)arg1;
- (void)fetchAISProductData:(id)arg1;
- (void)fetchAISProtocolImplementation:(id)arg1;
- (void)fetchAISSerialNumber:(id)arg1;
...
- (void)forceSurfaceStagedDetections:(id)arg1 deviceType:(id)arg2 detailsBitmask:(id)arg3;
...
- (void)stageTADetection:(id)arg1 deviceType:(id)arg2 detailsBitmask:(id)arg3;
