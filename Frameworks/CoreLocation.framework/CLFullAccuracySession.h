...
@property (nonatomic, readonly, copy) NSString *purposeKey;
@property bool shouldBeRunning;
@property (nonatomic, retain) NSData *storageToken;
@property (readonly) Class superclass;
@property (nonatomic) id /* block */ weakClient;

+ (id)fullAccuracySessionWithLocationManager:(id)arg1 purposeKey:(id)arg2 queue:(id)arg3 handler:(id /* block */)arg4;
...
- (id)identityToken;
- (id)initWithLocationManager:(id)arg1 purposeKey:(id)arg2 queue:(id)arg3 handler:(id /* block */)arg4;
- (void)invalidate;
