...
- (void)geocodeAddressString:(id)arg1 inRegionCenteredAt:(struct CLLocationCoordinate2D { double x1; double x2; })arg2 inRegionRadius:(double)arg3 preferredLocale:(id)arg4 completionHandler:(id /* block */)arg5;
