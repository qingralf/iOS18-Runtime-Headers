...
@interface CLLocation : NSObject <CKRecordValue, HMBModelObjectCoder, HMFObject, INJSONSerializable, NSCopying, NSSecureCoding> {
    id  _internal;
}
...
- (id)description;
- (bool)isLocationSimulatedBasedOnCarPlay;
- (bool)isSimulated;
