...
- (void)_createCustomLocationOfInterestAtCurrentLocationWithRequestIdentifier:(id)arg1;
...
- (void)_removeCustomLocationOfInterestFromMonitoringWithIdentifier:(id)arg1 withRequestIdentifier:(id)arg2;
