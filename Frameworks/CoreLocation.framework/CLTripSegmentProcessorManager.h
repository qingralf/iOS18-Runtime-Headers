...
@interface CLTripSegmentProcessorManager : NSObject {
    struct CLTripSegmentProcessor { 
        ...
        struct CLTripSegmentRecorder { 
            ...
            bool fFileNameShouldContainTime; 
            NSString *fRecordingDirectory; 
        } fRecorder; 
        struct shared_ptr<CLTripSegmentRouteBuilder> { 
            struct CLTripSegmentRouteBuilder {} *__ptr_; 
...
- (void)simulateSparseTrajectoryAndSubmitCoreAnalytics:(id)arg1;
