...
+ (id)compileSpecification:(void*)arg1 blobMapping:(id)arg2 compilerClass:(Class)arg3 toArchive:(void*)arg4 options:(id)arg5 error:(id*)arg6;
+ (id)compileSpecification:(void*)arg1 blobMapping:(id)arg2 toArchive:(void*)arg3 options:(id)arg4 compilerEvent:(id)arg5 error:(id*)arg6;
