...
@interface MLDelegateModel : MLModel {
    ...
    <MLStatefulModelEngine> * _statefulModelEngine;
}
...
- (void)_predictionFromFeatures:(id)arg1 usingState:(id)arg2 options:(id)arg3 completionHandler:(id /* block */)arg4;
- (id)_predictionFromFeatures:(id)arg1 usingState:(id)arg2 options:(id)arg3 error:(id*)arg4;
- (id)_predictionsFromBatch:(id)arg1 options:(id)arg2 error:(id*)arg3;
...
- (void)_validateStateFeatureNamed:(id)arg1 backingMultiArray:(id)arg2;
...
- (id)newRequestWithInputFeatures:(id)arg1 usingState:(id)arg2 options:(id)arg3 error:(id*)arg4;
...
- (void)predictionFromFeatures:(id)arg1 usingState:(id)arg2 options:(id)arg3 completionHandler:(id /* block */)arg4;
