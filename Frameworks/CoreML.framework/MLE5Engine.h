...
@interface MLE5Engine : MLModelEngine <MLClassifier, MLCompiledModelLoader, MLDeprecatedStatefulModelEngine, MLModelAssetDescriptionLoader, MLPreparable, MLProgramInternal, MLStatefulModelEngine> {
...
+ (id)loadModelAssetDescriptionFromCompiledArchive:(struct _MLModelInputArchiver { }*)arg1 modelVersionInfo:(id)arg2 compilerVersionInfo:(id)arg3 configuration:(id)arg4 error:(id*)arg5;
...
- (bool)_cleanUpAndReconfigureStream:(id)arg1 forInputFeatures:(id)arg2 error:(id*)arg3;
- (void)_cleanUpStream:(id)arg1;
- (id)_conformInputFeatures:(id)arg1 error:(id*)arg2;
- (id)_conformState:(id)arg1 error:(id*)arg2;
...
- (id)_newRequestForModel:(id)arg1 inputFeatures:(id)arg2 usingState:(id)arg3 options:(id)arg4 error:(id*)arg5;
...
- (id)_predictionFromFeatures:(id)arg1 stream:(id)arg2 options:(id)arg3 error:(id*)arg4;
- (id)_predictionFromFeatures:(id)arg1 usingState:(id)arg2 options:(id)arg3 error:(id*)arg4;
- (id)_probabilityDictionaryWithMultiArray:(id)arg1 classifyTopK:(long long)arg2;
- (double)_totalRuntimeInMilliSecondsFromE5AnalyticsDictionary:(id)arg1;
- (id)_trimQuotesFromBackendName:(id)arg1;
- (bool)_validateStreamReuse:(bool)arg1 expectation:(id)arg2 error:(id*)arg3;
...
- (id)initWithProgramLibrary:(id)arg1 modelDescription:(id)arg2 configuration:(id)arg3 functionName:(id)arg4 classProbabilitiesFeatureName:(id)arg5 optionalInputDefaultValues:(id)arg6 compilerVersionInfo:(id)arg7;
...
- (id)newRequestForModel:(id)arg1 inputFeatures:(id)arg2 usingState:(id)arg3 options:(id)arg4 error:(id*)arg5;
- (id)newStateForFeatureNamed:(id)arg1 initializerBlock:(id /* block */)arg2;
- (id)newStateWithClientBuffers:(id)arg1;
- (id)operationPool;
- (id)predictionFromFeatures:(id)arg1 options:(id)arg2 error:(id*)arg3;
- (id)predictionFromFeatures:(id)arg1 usingState:(id)arg2 options:(id)arg3 error:(id*)arg4;
