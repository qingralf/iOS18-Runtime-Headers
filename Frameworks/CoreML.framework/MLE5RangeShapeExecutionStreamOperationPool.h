...
@property (nonatomic, readonly) NSString *milDefaultShapeFunctionName;
...
@property (nonatomic, readonly) NSMutableDictionary *shapeHashToPoolMap;
@property (readonly) Class superclass;

- (void).cxx_destruct;
- (id)_makeAndPreloadOperationForFunction:(id)arg1 error:(id*)arg2;
...
- (id)milDefaultShapeFunctionName;
- (id)milFunctionName;
- (id)modelDescription;
