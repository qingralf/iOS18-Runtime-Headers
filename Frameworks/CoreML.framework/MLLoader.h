...
+ (id)_loadModelAssetDescriptionFromArchive:(void*)arg1 configuration:(id)arg2 modelVersion:(id)arg3 compilerVersion:(id)arg4 loadingClasses:(id)arg5 error:(id*)arg6;
...
+ (id)loadModelAssetDescriptionFromArchive:(void*)arg1 error:(id*)arg2;
+ (id)loadModelAssetDescriptionFromAssetAtURL:(id)arg1 error:(id*)arg2;
