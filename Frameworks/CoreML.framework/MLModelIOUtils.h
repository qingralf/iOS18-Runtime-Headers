...
+ (id)defaultFunctionNameFromDescriptionSpecification:(void*)arg1;
...
+ (id)featureDescriptionsFromProto:(const void*)arg1;
+ (id)functionDescriptionsFromDescriptionSpecification:(void*)arg1;
...
+ (id)orderedInputFeatureNamesFromInterface:(void*)arg1;
+ (id)orderedNamesFromProto:(const void*)arg1;
+ (id)orderedOutputFeatureNamesFromInterface:(void*)arg1;
+ (id)orderedStateFeatureNamesFromInterface:(void*)arg1;
+ (id)outputDescriptionFromInterface:(void*)arg1;
+ (id)populateConstraintsForArrayFeatureType:(const void*)arg1 dataType:(long long)arg2 constraintClass:(Class)arg3 defaultOptionalValue:(id)arg4;
...
+ (id)stateDescriptionFromInterface:(void*)arg1;
