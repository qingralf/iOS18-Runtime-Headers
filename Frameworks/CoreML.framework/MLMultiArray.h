...
+ (id)newMultiArrayForState:(id)arg1 strides:(id)arg2 dtype:(long long)arg3 error:(id*)arg4;
...
- (id)initWithMultiArrayBuffer:(struct shared_ptr<CoreML::MultiArrayBuffer> { struct MultiArrayBuffer {} *x1; struct __shared_weak_count {} *x2; })arg1 mutableShapedBufferProvider:(id /* block */)arg2;
- (id)initWithPixelBuffer:(struct __CVBuffer { }*)arg1 shape:(id)arg2;
- (id)initWithPixelBuffer:(struct __CVBuffer { }*)arg1 shape:(id)arg2 strides:(id)arg3;
- (id)initWithPixelBuffer:(struct __CVBuffer { }*)arg1 shape:(id)arg2 strides:(id)arg3 mutableShapedBufferProvider:(id /* block */)arg4;
...
- (id)initWithShape:(id)arg1 dataType:(long long)arg2 strides:(id)arg3;
- (bool)isContiguous;
...
- (id)strides;
- (void)transferToMultiArray:(id)arg1;
