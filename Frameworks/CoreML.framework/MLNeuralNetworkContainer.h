...
@property (nonatomic, readonly, copy) MLModelDescription *modelDescription;
...
- (id)initWithFeatureDescriptions:(id)arg1 modelDescription:(id)arg2 outputLayerNames:(id)arg3 classScoreVectorName:(id)arg4 classLabels:(id)arg5 isEncrypted:(bool)arg6 modelVersionInfo:(id)arg7;
- (id)initWithFeatureDescriptions:(id)arg1 modelDescription:(id)arg2 outputLayerNames:(id)arg3 classScoreVectorName:(id)arg4 classLabels:(id)arg5 isEncrypted:(bool)arg6 modelVersionInfo:(id)arg7 compilerVersionInfo:(id)arg8;
