...
@interface MLNeuralNetworkEngine : MLModelEngine <MLClassifier, MLCompiledModelLoader, MLModelAssetDescriptionLoader, MLNeuralNetwork, MLRegressor> {
    ...
    struct map<std::string, _BlobShape, std::less<std::string>, std::allocator<std::pair<const std::string, _BlobShape>>> { 
        struct __tree<std::__value_type<std::string, _BlobShape>, std::__map_value_compare<std::string, std::__value_type<std::string, _BlobShape>, std::less<std::string>>, std::allocator<std::__value_type<std::string, _BlobShape>>> { 
            void *__begin_node_; 
            struct __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<std::string, _BlobShape>, void *>>> { 
                struct __tree_end_node<std::__tree_node_base<void *> *> { 
                    void *__left_; 
                } __value_; 
            } __pair1_; 
            struct __compressed_pair<unsigned long, std::__map_value_compare<std::string, std::__value_type<std::string, _BlobShape>, std::less<std::string>>> { 
                unsigned long long __value_; 
            } __pair3_; 
        } __tree_; 
    }  _currentBlobShapes;
...
- (bool)_setupContextAndPlanWithConfiguration:(id)arg1 priority:(int)arg2 error:(id*)arg3;
- (bool)_setupContextAndPlanWithConfiguration:(id)arg1 usingCPU:(bool)arg2 priority:(int)arg3 error:(id*)arg4;
- (bool)_setupContextAndPlanWithConfiguration:(id)arg1 usingCPU:(bool)arg2 priority:(int)arg3 reshapeWithContainer:(bool)arg4 error:(id*)arg5;
- (bool)_setupContextAndPlanWithForceCPU:(bool)arg1 priority:(int)arg2 error:(id*)arg3;
- (id)activeFunction;
- (id)addClassifierInformationToOutput:(id)arg1 options:(id)arg2 error:(id*)arg3;
- (id)availableOutputBlobList;
- (bool)bindDirectlyInputFeatureNamed:(id)arg1 pixelBuffer:(struct __CVBuffer { }*)arg2 cleanUpBlocks:(id)arg3 boundDirectly:(bool*)arg4 error:(id*)arg5;
...
- (bool)bindInputFeatureNamed:(id)arg1 featureValue:(id)arg2 bufferIndex:(unsigned long long)arg3 cleanUpBlocks:(id)arg4 boundDirectly:(bool*)arg5 error:(id*)arg6;
- (bool)bindInputFeatureNamed:(id)arg1 pixelBuffer:(struct __CVBuffer { }*)arg2 cleanUpBlocks:(id)arg3 error:(id*)arg4;
- (bool)bindInputFeatures:(id)arg1 bufferIndex:(unsigned long long)arg2 cleanUpBlocks:(id)arg3 directlyBoundFeatureNames:(id*)arg4 error:(id*)arg5;
