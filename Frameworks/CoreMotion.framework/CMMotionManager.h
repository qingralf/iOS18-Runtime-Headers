...
@property (getter=isDisplayGravityAvailable, nonatomic, readonly) bool displayGravityAvailable;
...
- (void)setDisplayGravityHandler:(id /* block */)arg1 interval:(double)arg2;
...
- (void)startFactoryGyroUpdatesPrivateToQueue:(id)arg1 atUpdateInterval:(double)arg2 withHandler:(id /* block */)arg3 residualHandler:(id /* block */)arg4;
- (void)startFactoryGyroUpdatesToQueue:(id)arg1 atUpdateInterval:(double)arg2 withHandler:(id /* block */)arg3;
- (void)startFactoryGyroUpdatesToQueue:(id)arg1 atUpdateInterval:(double)arg2 withHandler:(id /* block */)arg3 residualHandler:(id /* block */)arg4;
