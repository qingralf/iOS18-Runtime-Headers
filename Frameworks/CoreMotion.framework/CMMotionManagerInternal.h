...
@interface CMMotionManagerInternal : NSObject {
    ...
    id /* block */  _fDisplayGravityHandler;
    ...
    struct unique_ptr<CLDisplayGravityService, std::default_delete<CLDisplayGravityService>> { 
        struct __compressed_pair<CLDisplayGravityService *, std::default_delete<CLDisplayGravityService>> { 
            struct CLDisplayGravityService {} *__value_; 
        } __ptr_; 
...
@property (nonatomic, copy) id /* block */ fDisplayGravityHandler;
...
- (id /* block */)fDisplayGravityHandler;
- (id)init;
...
- (void)setFDisplayGravityHandler:(id /* block */)arg1;
