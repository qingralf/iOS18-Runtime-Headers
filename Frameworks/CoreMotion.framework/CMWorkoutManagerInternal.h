...
- (bool)_isReminderAllowedForType:(long long)arg1;
- (void)_muteReminderType:(long long)arg1 mute:(bool)arg2;
...
- (void)_setReminderMuteSettingsForType:(long long)arg1 mute:(bool)arg2;
...
- (void)_snapshotWithCompletion:(id /* block */)arg1;
