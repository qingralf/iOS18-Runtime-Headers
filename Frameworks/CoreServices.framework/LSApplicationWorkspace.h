...
- (bool)canChangeDefaultAppForCategory:(unsigned long long)arg1;
...
- (id)defaultApplicationForCategory:(unsigned long long)arg1 error:(id*)arg2;
...
- (bool)getDefaultApplicationCategories:(unsigned long long*)arg1 withCurrentDefaultApplication:(id)arg2 error:(id*)arg3;
...
- (id)getPreferredAppMarketplacesWithError:(id*)arg1;
...
- (bool)mayProcessWithAuditTokenMapDatabase:(struct { unsigned int x1[8]; })arg1;
...
- (void)setDefaultApplicationForCategory:(unsigned long long)arg1 toApplicationRecord:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (bool)setPersonaUniqueStrings:(id)arg1 forApplicationsWithBundleIdentifiers:(id)arg2 operationUUID:(id)arg3 requestContext:(id)arg4 saveObserver:(id)arg5 error:(id*)arg6;
- (bool)setPreferredAppMarketplaces:(id)arg1 error:(id*)arg2;
...
- (bool)urlContainsDeviceIdentifierForAdvertising:(id)arg1;
...
- (void)hk_asyncOpenURL:(id)arg1;

// Image: /System/Library/PrivateFrameworks/SafariCore.framework/SafariCore

- (void)safari_setAppleOTPAuthMigrationURLHandlerToApplicationWithBundleIdentifier:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)safari_setAppleOTPAuthURLHandlerToApplicationWithBundleIdentifier:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)safari_setDefaultOTPAuthMigrationURLHandlerToApplicationWithBundleIdentifier:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)safari_setDefaultOTPAuthMigrationURLHandlerToApplicationWithBundleIdentifier:(id)arg1 shouldFallBackToSystemHandlerIfNeeded:(bool)arg2 completionHandler:(id /* block */)arg3;
- (void)safari_setDefaultOTPAuthURLHandlerToApplicationWithBundleIdentifier:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)safari_setDefaultOTPAuthURLHandlerToApplicationWithBundleIdentifier:(id)arg1 shouldFallBackToSystemHandlerIfNeeded:(bool)arg2 completionHandler:(id /* block */)arg3;
- (void)safari_setDefaultURLHandlerForScheme:(id)arg1 toApplicationWithBundleIdentifier:(id)arg2 completionHandler:(id /* block */)arg3;
