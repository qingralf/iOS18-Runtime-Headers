...
- (unsigned int)_rawFlagsWithContext:(struct LSContext { id x1; }*)arg1 tableID:(unsigned int)arg2 unitID:(unsigned int)arg3 unitBytes:(const struct { unsigned int x1; unsigned int x2; unsigned int x3; short x4; unsigned short x5; unsigned int x6; unsigned int x7; unsigned int x8; unsigned int x9[8]; unsigned int x10; unsigned int x11; unsigned int x12; }*)arg4;
