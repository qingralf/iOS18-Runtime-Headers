...
@interface LSPropertyList : NSObject <LSDetachable, NSCopying, PFRoleProviding, PFRoleProvidingInternal, _EXDictionaryLike>
...
- (void)detach;
- (id)init;
- (id)objectForKey:(id)arg1 checkingKeyClass:(Class)arg2 checkingValueClass:(Class)arg3;
