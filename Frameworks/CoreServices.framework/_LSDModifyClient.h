...
- (bool)_canRegisterOrUnregisterURL:(id)arg1 withOptions:(unsigned int)arg2;
- (bool)canRegisterContainer;
- (bool)canRegisterURL:(id)arg1 withOptions:(unsigned int)arg2;
- (bool)canUnregisterWithOptions:(unsigned int)arg1;
...
- (void)performUpdateOfPersonasOfBundleIDs:(id)arg1 toPersonaUniqueStrings:(id)arg2 operationUUID:(id)arg3 reply:(id /* block */)arg4;
...
- (void)setPreferredAppMarketplaces:(id)arg1 completion:(id /* block */)arg2;
