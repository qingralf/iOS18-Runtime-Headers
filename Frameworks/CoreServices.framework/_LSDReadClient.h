...
- (void)getCurrentApplicationDefaultInfoForCategory:(unsigned long long)arg1 completion:(id /* block */)arg2;
- (void)getDiskUsage:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)getEligibilityAnswerForDomain:(unsigned long long)arg1 withCompletionHandler:(id /* block */)arg2;
...
- (void)getHasEverChangedPreferredAppForCategory:(unsigned long long)arg1 completion:(id /* block */)arg2;
...
- (void)getPreferredAppMarketplacesWithCompletion:(id /* block */)arg1;
- (void)getRedactedAppexRecordForSystemAppexWithUUID:(id)arg1 node:(id)arg2 bundleIdentifier:(id)arg3 platform:(unsigned int)arg4 completionHandler:(id /* block */)arg5;
