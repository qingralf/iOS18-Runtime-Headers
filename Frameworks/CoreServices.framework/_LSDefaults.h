...
@property (getter=isUserServer, readonly) bool userServer;
...
- (id)appMarketplacesPreferencesStateURL;
- (id)appProtectionStoreFileURL;
...
- (id)specialAppEligibilityStateURL;
