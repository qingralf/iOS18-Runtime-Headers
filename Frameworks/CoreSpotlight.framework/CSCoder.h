...
+ (id)encodeURLPreservingSecurityScope:(id)arg1;
...
- (void)encodeMDPlistObject:(struct { char *x1; unsigned long long x2; struct { unsigned int x_3_1_1; unsigned char x_3_1_2; } x3; })arg1;
