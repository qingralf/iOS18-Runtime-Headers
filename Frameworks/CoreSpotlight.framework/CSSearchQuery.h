...
@interface CSSearchQuery : NSObject <MDSearchQueryResultProcessor> {
    ...
    id /* block */  _photosComputedAttributesHandler;
...
@property (nonatomic, retain) NSMutableDictionary *currentDenseCandidates;
@property (nonatomic, retain) NSMutableDictionary *currentTopHitCandidates;
...
@property (nonatomic, retain) PRSQueryRankingConfiguration *rankConfig;
@property (nonatomic, retain) PRSRankingItemRanker *ranker;
...
- (bool)counting;
- (id)currentDenseCandidates;
- (double)currentTime;
- (id)currentTopHitCandidates;
- (void)deactivate;
- (void)dealloc;
- (id)debugDescription;
...
- (void)filterRankedItems:(id)arg1 maxCount:(unsigned long long)arg2 bundle:(id)arg3 userQuery:(id)arg4 queryID:(long long)arg5 privateQuery:(bool)arg6 rankingConfiguration:(id)arg7 currentTime:(double)arg8 clientBundle:(id)arg9 ranker:(id)arg10;
...
- (id)getTopHitResult:(id)arg1 fetchAttrs:(id)arg2;
- (bool)grouped;
...
- (id)options;
- (unsigned long long)originalHitCount;
- (unsigned long long)originalMaxRankedResultCount;
- (id /* block */)photosComputedAttributesHandler;
- (void)poll;
...
- (void)processPhotosComputedData:(id)arg1 protectionClass:(id)arg2;
...
- (void)processResultItems:(id)arg1;
- (void)processResultsData:(id)arg1 protectionClass:(id)arg2;
- (void)processResultsForTopHitRanking:(id)arg1 protectionClass:(id)arg2;
...
- (id)queryString;
- (id)queue;
- (id)rankBatch:(id)arg1 withRanker:(id)arg2 withBundle:(id)arg3 maxCount:(unsigned long long)arg4 userQuery:(id)arg5 queryID:(long long)arg6 rankingConfiguration:(id)arg7 isCJK:(bool)arg8 clientBundle:(id)arg9 isKeyboardCJK:(bool)arg10 privateQuery:(bool)arg11 collectL2Signals:(bool)arg12 onlyEmbeddingResults:(bool)arg13;
- (id)rankConfig;
- (id)ranker;
...
- (void)setCurrentDenseCandidates:(id)arg1;
- (void)setCurrentTopHitCandidates:(id)arg1;
...
- (void)setIsKeyboardCJK:(bool)arg1;
...
- (void)setOriginalHitCount:(unsigned long long)arg1;
- (void)setOriginalMaxRankedResultCount:(unsigned long long)arg1;
- (void)setPhotosComputedAttributesHandler:(id /* block */)arg1;
...
- (void)setupTopHitQueryContextForClientBundleId:(id)arg1;
- (void)start;
- (bool)suspended;
- (void)updateQueryContext:(id)arg1;
...
+ (void)performDiffOfIdentifiers:(id)arg1 inDomains:(id)arg2 withItemFetcher:(id /* block */)arg3 completionBlock:(id /* block */)arg4;
