...
+ (id)emptySuggestion;
+ (id)instantAnswerWithUserString:(id)arg1 currentSuggestion:(id)arg2 itemResult:(id)arg3 answerAttributes:(id)arg4;
...
+ (id)suggestionWithCurrentSuggestion:(id)arg1 userQueryString:(id)arg2 suggestionText:(id)arg3 queryString:(id)arg4;
+ (id)suggestionWithCurrentSuggestion:(id)arg1 userQueryString:(id)arg2 suggestionToken:(id)arg3;
...
- (id)initWithUserString:(id)arg1 currentSuggestion:(id)arg2 suggestionText:(id)arg3 queryString:(id)arg4;
- (id)initWithUserString:(id)arg1 currentSuggestion:(id)arg2 suggestionToken:(id)arg3;
...
- (void)mergeSuggestionAndUpdateLocalizedAttributedString:(id)arg1 queryContextScopeIsToPerson:(bool)arg2;
...
+ (id)mui_suggestionForSpotlightQueryWithString:(id)arg1;
