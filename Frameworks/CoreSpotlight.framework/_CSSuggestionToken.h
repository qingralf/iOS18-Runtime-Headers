...
+ (id)suggestionTokenWithUserString:(id)arg1 displayText:(id)arg2 queryString:(id)arg3;
+ (bool)supportsSecureCoding;

- (void).cxx_destruct;
- (void)addTokenScope:(id)arg1 tokenText:(id)arg2 queryString:(id)arg3;
- (double)age;
...
- (id)initWithUserString:(id)arg1 displayString:(id)arg2 queryString:(id)arg3;
