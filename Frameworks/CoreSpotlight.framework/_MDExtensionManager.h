...
@property (nonatomic, retain) NSSet *fileProviderBundleIDs;
...
+ (bool)_isSupported:(id)arg1 extension:(id)arg2;
...
- (bool)extensionExistsForBundleId:(id)arg1;
...
- (void)setFileProviderBundleIDs:(id)arg1;
