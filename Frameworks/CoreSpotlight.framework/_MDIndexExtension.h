...
@property (nonatomic, readonly) NSNumber *isAppleCodeSigned;
...
- (id)initWithExtension:(id)arg1 queue:(id)arg2 containerPath:(id)arg3 containerID:(id)arg4 supportedFileTypes:(id)arg5 extensionLabel:(id)arg6 isAppleCodeSigned:(id)arg7;
- (id)isAppleCodeSigned;
- (bool)isEnabled;
- (bool)isInternal;
