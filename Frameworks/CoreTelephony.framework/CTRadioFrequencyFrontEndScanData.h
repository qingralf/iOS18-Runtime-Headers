...
@property (nonatomic, retain) NSMutableArray *missingAtDevices;
@property (nonatomic, retain) NSMutableArray *missingMmwDevices;
@property (nonatomic, retain) NSMutableArray *missingRffeDevices;
...
- (id)missingAtDevices;
- (id)missingMmwDevices;
- (id)missingRffeDevices;
...
- (id)rffeScanInfo;
- (bool)rffeScanPass;
- (void)setFr2TrxRev:(unsigned long long)arg1;
...
- (void)setMissingAtDevices:(id)arg1;
- (void)setMissingMmwDevices:(id)arg1;
- (void)setMissingRffeDevices:(id)arg1;
