...
- (bool)_decodeCardData:(id)arg1 smdp:(id*)arg2 matchingID:(id*)arg3 OID:(id*)arg4;
- (bool)acknowledgeIncomingMessages:(id)arg1 withMessageIDList:(id)arg2 withError:(id*)arg3;
...
- (void)activateTurboMode:(id /* block */)arg1;
...
- (bool)addParticipants:(id)arg1 toGroupChat:(id)arg2 withParticipantsToAdd:(id)arg3 withOperationID:(id)arg4 withError:(id*)arg5;
...
- (void)addQRCodePlanWith:(id)arg1 appType:(unsigned long long)arg2 completionHandler:(id /* block */)arg3;
- (void)asynchronousRequest:(id)arg1 completion:(id /* block */)arg2;
- (void)asynchronousRequest:(id)arg1 completionWithArray:(id /* block */)arg2;
- (void)asynchronousRequest:(id)arg1 completionWithNumber:(id /* block */)arg2;
- (void)asynchronousRequest:(id)arg1 completionWithString:(id /* block */)arg2;
...
- (bool)changeIcon:(id)arg1 forGroupChat:(id)arg2 withNewIcon:(id)arg3 withOperationID:(id)arg4 withError:(id*)arg5;
...
- (bool)changeSubject:(id)arg1 forGroupChat:(id)arg2 withNewSubject:(id)arg3 withOperationID:(id)arg4 withError:(id*)arg5;
- (long long)checkCellularDiagnosticsStatus:(id*)arg1;
- (struct { long long x1; long long x2; })checkCellularDiagnosticsStatusDetails:(id*)arg1;
- (id)checkEmbeddedSimHealthWithError:(id*)arg1;
- (void)checkForUpdatedBundlesWithAutoInstall:(bool)arg1 completion:(id /* block */)arg2;
- (void)checkPreFlightEligibility:(id)arg1 mccs:(id)arg2 mncs:(id)arg3 gid1s:(id)arg4 gid2s:(id)arg5 smdpUrl:(id)arg6 iccidPrefix:(id)arg7 completion:(id /* block */)arg8;
- (void)checkProfileEligibility:(id)arg1 metadata:(id)arg2 completion:(id /* block */)arg3;
...
- (void)context:(id)arg1 resetPhoneNumber:(id /* block */)arg2;
...
- (bool)create:(id)arg1 groupChat:(id)arg2 withOperationID:(id)arg3 withError:(id*)arg4;
...
- (void)dealloc;
- (id)decodeSuggestionsBase64:(id)arg1 withBase64String:(id)arg2 withError:(id*)arg3;
- (id)delegate;
- (bool)deleteChat:(id)arg1 chat:(id)arg2 withError:(id*)arg3;
...
- (bool)disableBusinessMessaging:(id)arg1 withError:(id*)arg2;
- (bool)disableLazuli:(id)arg1 withError:(id*)arg2;
- (void)dispatchBlockToClientAsync:(id /* block */)arg1;
- (bool)enableBusinessMessaging:(id)arg1 withError:(id*)arg2;
- (bool)enableLazuli:(id)arg1 withError:(id*)arg2;
...
- (bool)exit:(id)arg1 groupChat:(id)arg2 withOperationID:(id)arg3 withError:(id*)arg4;
...
- (bool)fetchRemoteCapabilities:(id)arg1 forDestination:(id)arg2 withOptions:(id)arg3 withOperationID:(id)arg4 withError:(id*)arg5;
- (bool)fetchRenderInformation:(id)arg1 forChatBot:(id)arg2 withOperationID:(id)arg3 withError:(id*)arg4;
...
- (void)getActionForCardData:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)getEuiccData:(id /* block */)arg1;
...
- (id)getLocalDeviceIdentifierForSIMTransfer:(id*)arg1;
...
- (void)getPrivateNetworkCapabilitiesForContext:(id)arg1 completion:(id /* block */)arg2;
- (id)getPrivateNetworkCapabilitiesForContext:(id)arg1 error:(id*)arg2;
- (id)getPrivateNetworkSimInfoForContext:(id)arg1 error:(id*)arg2;
- (id)getProvisioningServerURL:(id)arg1 outError:(id*)arg2;
...
- (void)getRoamingStatus:(id)arg1 completion:(id /* block */)arg2;
- (id)getRoamingStatus:(id)arg1 error:(id*)arg2;
...
- (id)getSatelliteMsgCfgToUpdate:(id*)arg1;
- (void)getSatelliteMsgCfgToUpdateWithCompletion:(id /* block */)arg1;
...
- (id)getSystemConfiguration:(id)arg1 withError:(id*)arg2;
...
- (id)getVoicemailCallInDetails:(id)arg1 outError:(id*)arg2;
...
- (void)handleTermsAndConditionsCompleted:(id)arg1 consented:(bool)arg2 completion:(id /* block */)arg3;
- (void)handleUserEnteredOtp:(id)arg1 otp:(id)arg2 completion:(id /* block */)arg3;
...
- (id)installPrivateNetworkProfile:(id)arg1;
...
- (bool)isAutofilleSIMIdAllowedForDomain:(id)arg1 clientBundleIdentifier:(id)arg2 error:(id*)arg3;
- (bool)isAutofilleSIMIdAllowedForDomain:(id)arg1 error:(id*)arg2;
...
- (void)isPrivateNetworkContext:(id)arg1 completion:(id /* block */)arg2;
- (id)isPrivateNetworkContext:(id)arg1 error:(id*)arg2;
...
- (void)overridePlanSelection:(id)arg1 completion:(id /* block */)arg2;
...
- (void)prepareCrossPlatformCellularPlanLabel:(id)arg1 completion:(id /* block */)arg2;
...
- (id)readCachedCapabilities:(id)arg1 forDestination:(id)arg2 withError:(id*)arg3;
- (id)readCachedChatBotRenderInformation:(id)arg1 forChatBot:(id)arg2 withError:(id*)arg3;
...
- (bool)removeParticipants:(id)arg1 fromGroupChat:(id)arg2 withParticipantsToRemove:(id)arg3 withOperationID:(id)arg4 withError:(id*)arg5;
- (void)removePoliciesFromLocalDevice:(id)arg1 completion:(id /* block */)arg2;
- (id)removePrivateNetworkProfile:(id)arg1;
- (id)renamePersonalWallet:(id)arg1 to:(id)arg2;
- (void)renewOneTimePassword:(id)arg1 completion:(id /* block */)arg2;
- (bool)reportChatbotSpam:(id)arg1 forChatbot:(id)arg2 withSpamReportInfo:(id)arg3 andOperationID:(id)arg4 withError:(id*)arg5;
- (bool)reportLazuliSpamWithContext:(id)arg1 destination:(id)arg2 spamReportInfo:(id)arg3 operationID:(id)arg4 error:(id*)arg5;
...
- (id)reprovisionSatelliteMsg:(bool)arg1;
- (bool)requestBootstrapDataService:(id*)arg1;
- (id)requestQoSLinkCharacteristics;
- (void)requestSliceByUUID:(id)arg1 completion:(id /* block */)arg2;
- (void)requestSliceDeactivation:(id)arg1;
...
- (id)retrieveAllIncomingMessageIDs:(id)arg1 withError:(id*)arg2;
- (void)retrieveAppListURLWithCompletion:(id /* block */)arg1;
- (id)retrieveDeviceIdentifier:(unsigned long long)arg1 clientBundleIdentifier:(id)arg2 error:(id*)arg3;
- (id)retrieveDeviceIdentifier:(unsigned long long)arg1 error:(id*)arg2;
- (id)retrieveMessage:(id)arg1 withMessageID:(id)arg2 withError:(id*)arg3;
- (bool)revokeMessage:(id)arg1 withRevokeData:(id)arg2 withMessageID:(id)arg3 withError:(id*)arg4;
...
- (void)sendComposingIndicator:(id)arg1 to:(id)arg2 withMessageID:(id)arg3 withIndication:(id)arg4 withError:(id*)arg5;
- (void)sendComposingIndicator:(id)arg1 toGroup:(id)arg2 withMessageID:(id)arg3 withIndication:(id)arg4 withError:(id*)arg5;
- (bool)sendComposingIndicator:(id)arg1 toGroupDestination:(id)arg2 withMessageID:(id)arg3 withIndication:(id)arg4 withError:(id*)arg5;
- (bool)sendComposingIndicatorForContext:(id)arg1 to:(id)arg2 messageID:(id)arg3 indication:(id)arg4 error:(id*)arg5;
- (id)sendDeadPeerDetection;
- (void)sendDeadPeerDetection:(id /* block */)arg1;
- (bool)sendDeviceAction:(id)arg1 to:(id)arg2 withMessageID:(id)arg3 withAction:(id)arg4 withError:(id*)arg5;
- (bool)sendDeviceSettings:(id)arg1 to:(id)arg2 withMessageID:(id)arg3 withSetting:(id)arg4 withError:(id*)arg5;
- (bool)sendDispositionNotificationMessage:(id)arg1 to:(id)arg2 withMessageID:(id)arg3 withDisposition:(long long)arg4 forMessageID:(id)arg5 withError:(id*)arg6;
- (bool)sendFileTransferMessage:(id)arg1 to:(id)arg2 withMessageID:(id)arg3 withFileInformation:(id)arg4 withError:(id*)arg5;
- (bool)sendFileTransferMessage:(id)arg1 toGroupDestination:(id)arg2 withMessageID:(id)arg3 withFileInformation:(id)arg4 withError:(id*)arg5;
- (bool)sendGeolocationMessage:(id)arg1 to:(id)arg2 withMessageID:(id)arg3 withGeoPush:(id)arg4 withError:(id*)arg5;
- (bool)sendGeolocationMessage:(id)arg1 toGroupDestination:(id)arg2 withMessageID:(id)arg3 withGeoPush:(id)arg4 withError:(id*)arg5;
- (bool)sendGroupDispositionNotificationMessage:(id)arg1 toGroup:(id)arg2 to:(id)arg3 withMessageID:(id)arg4 withDisposition:(long long)arg5 forMessageID:(id)arg6 withError:(id*)arg7;
- (bool)sendOneToManyFileTransferMessage:(id)arg1 to:(id)arg2 withMessageID:(id)arg3 withDescriptor:(id)arg4 withError:(id*)arg5;
- (bool)sendOneToManyGeolocationMessage:(id)arg1 to:(id)arg2 withMessageID:(id)arg3 withGeoPush:(id)arg4 withError:(id*)arg5;
- (bool)sendOneToManyTextMessage:(id)arg1 to:(id)arg2 withMessageID:(id)arg3 withMessage:(id)arg4 withError:(id*)arg5;
- (bool)sendResponseForSuggestedAction:(id)arg1 to:(id)arg2 withMessageID:(id)arg3 response:(id)arg4 withError:(id*)arg5;
- (bool)sendResponseForSuggestedReply:(id)arg1 to:(id)arg2 withMessageID:(id)arg3 response:(id)arg4 withError:(id*)arg5;
...
- (bool)sendTextMessage:(id)arg1 to:(id)arg2 withMessageID:(id)arg3 withMessage:(id)arg4 withError:(id*)arg5;
- (bool)sendTextMessage:(id)arg1 toGroupDestination:(id)arg2 withMessageID:(id)arg3 withMessage:(id)arg4 withError:(id*)arg5;
- (bool)sendTravelBuddyCAEvent:(id)arg1 carrierName:(id)arg2 error:(id*)arg3;
...
- (id)setProvisioningServerURL:(id)arg1 url:(id)arg2;
...
- (id)setSatelliteMsgCfgUpdated:(id)arg1;
...
- (void)setVirtualSimMode:(bool)arg1 withDualSim:(bool)arg2 completion:(id /* block */)arg3;
...
- (void)startPendingPlanInstallationForPlan:(id)arg1 carrierName:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (void)synchronousRequest:(id)arg1 error:(id*)arg2;
- (id)synchronousRequestWithArrayResult:(id)arg1 error:(id*)arg2;
- (id)synchronousRequestWithNumberResult:(id)arg1 error:(id*)arg2;
- (id)synchronousRequestWithStringResult:(id)arg1 error:(id*)arg2;
- (id)terminateProcess;
- (void)terminateProcess:(id /* block */)arg1;
- (void)testStewieCommand:(id)arg1 completion:(id /* block */)arg2;
- (id)testStewieCommand:(id)arg1 error:(id*)arg2;
...
- (void)transferRemotePlan:(id)arg1 completion:(id /* block */)arg2;
- (void)transferRemotePlan:(id)arg1 fromDevice:(id)arg2 completion:(id /* block */)arg3;
- (void)triggerKeepaliveWakeupEvent:(int)arg1 completion:(id /* block */)arg2;
...
- (id)updatePrivateNetworkProfile:(id)arg1 setProfileAside:(bool)arg2;
- (id)updateSecureIntentData:(id)arg1;
- (bool)updateSecureIntentData:(id)arg1 error:(id*)arg2;
- (void)usageCollectionEnabled:(id /* block */)arg1;
- (id)usageCollectionEnabledSync:(id*)arg1;
- (id)userDidExitWebsheetFlowForPlan:(id)arg1;
- (bool)userDidExitWebsheetFlowForPlan:(id)arg1 error:(id*)arg2;
...
- (id)_getSystemConfiguration:(id)arg1 withError:(id*)arg2;
