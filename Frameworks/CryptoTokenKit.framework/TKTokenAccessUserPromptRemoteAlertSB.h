...
@interface TKTokenAccessUserPromptRemoteAlertSB : NSObject <NSXPCListenerDelegate, SBSRemoteAlertHandleObserver, TKTokenAccessUserPrompt, TKUIServerProtocol> {
...
- (void)registerTokenAccessRequestCorrelationID:(id)arg1 access:(long long)arg2 reply:(id /* block */)arg3;
