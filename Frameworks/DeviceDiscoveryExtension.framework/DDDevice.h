/* Generated by RuntimeBrowser
   Image: /System/Library/Frameworks/DeviceDiscoveryExtension.framework/DeviceDiscoveryExtension
 */
...
@interface DDDevice : NSObject <CUXPCCodable, NSCopying, NSSecureCoding> {
    ...
    long long  _category;
    unsigned long long  _deviceSupports;
...
- (unsigned long long)deviceSupports;
- (id)displayImageName;
- (id)displayName;
...
- (void)setDeviceSupports:(unsigned long long)arg1;
