...
- (id)_uniqueIdentifierToObjectMapForObjects:(id)arg1 identifierBlock:(id /* block */)arg2;
- (void)addChanges:(id)arg1;
- (void)addChanges:(id)arg1 shouldCopyKeyCallback:(id /* block */)arg2;
- (void)addChanges:(id)arg1 shouldCopyKeyCallback:(id /* block */)arg2 objectIdentifierBlock:(id /* block */)arg3;
...
- (void)addToChanges:(id)arg1 forMultiValueKey:(id)arg2 basedOn:(id)arg3 and:(id)arg4 shouldCopyKeyCallback:(id /* block */)arg5 objectIdentifierBlock:(id /* block */)arg6;
...
- (id)initWithChangeSet:(id)arg1 filter:(id /* block */)arg2;
...
- (void)removeFromChanges:(id)arg1 forMultiValueKey:(id)arg2 basedOn:(id)arg3 and:(id)arg4 objectIdentifierBlock:(id /* block */)arg5;
...
- (void)setIsUndetached:(bool)arg1;
