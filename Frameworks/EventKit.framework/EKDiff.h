...
+ (void)_populateMultiValueRelationshipKeysForDiff:(id)arg1 compareUIVisiblePropertiesOnly:(bool)arg2;
+ (void)_populateSingleValueKeysForDiff:(id)arg1 compareUIVisiblePropertiesOnly:(bool)arg2;
+ (void)_populateSingleValueRelationshipKeysForDiff:(id)arg1 compareUIVisiblePropertiesOnly:(bool)arg2;
+ (id)_summaryKeyForMultiValueChange:(id)arg1 ofPropertyKey:(id)arg2;
+ (id)diffBetweenObject:(id)arg1 andObject:(id)arg2;
+ (id)diffBetweenObject:(id)arg1 andObject:(id)arg2 compareUIVisiblePropertiesOnly:(bool)arg3;
