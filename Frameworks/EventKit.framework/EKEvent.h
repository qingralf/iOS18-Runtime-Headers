...
@property (nonatomic, readonly) unsigned long long CUIK_attendeesIconState;
@property (nonatomic, readonly) bool CUIK_deleteActionShouldDeclineEvent;
@property (nonatomic, readonly) UIColor *CUIK_disabledSymbolColor;
@property (nonatomic, readonly) id CUIK_reminderEntityAnnotation;
@property (nonatomic, readonly) NSString *CUIK_reminderEntityIdentifier;
@property (nonatomic, readonly) UIColor *CUIK_symbolColor;
...
@property (nonatomic, readonly) bool allowsClearingCommentsAsOrganizer;
@property (nonatomic, readonly) bool allowsNonzeroDuration;
...
@property (nonatomic, retain) EKColor *color;
...
@property (nonatomic, readonly) bool currentUserMayActAsOrganizer;
...
@property (nonatomic, readonly) bool hasCustomRecurrence;
...
@property (nonatomic, readonly) bool isIntegrationEvent;
...
@property (nonatomic, readonly) bool isReminderIntegrationEvent;
...
@property (nonatomic, readonly) unsigned long long reminderOccurrenceType;
...
- (void)_deleteFromOccurrenceDateOnward:(id)arg1 includeSlices:(bool)arg2;
...
- (void)_duplicateAddedAttachmentsToDetachedEvents:(id)arg1;
...
- (void)_propagateChangesToDetachedEvents:(id)arg1 originalItemBeforeSave:(id)arg2 startDateOffset:(id)arg3 duration:(id)arg4 calendar:(id)arg5;
- (void)_propagateChangesToSlice:(id)arg1 originalItemBeforeSave:(id)arg2 startDateOffset:(id)arg3 duration:(id)arg4 calendar:(id)arg5 updateRecurrenceEnd:(bool)arg6;
...
- (bool)_revertIncludingCoCommits:(bool)arg1;
...
- (void)_setNextCachedReminderOccurrenceDate:(id)arg1;
...
- (void)_updateRecurrenceEndDateForEvent:(id)arg1 calendar:(id)arg2 withOffset:(id)arg3;
...
- (void)adjustedDatesForDate:(id)arg1 persistedDateIsInUTC:(bool)arg2 withAdjustmentMode:(unsigned long long)arg3 pinMode:(unsigned long long)arg4 outClientCalendarDate:(id*)arg5 outPersistedDate:(id*)arg6;
...
- (bool)allowsRecurrenceModificationsForSpan:(long long)arg1;
- (bool)allowsResponseCommentModifications;
- (bool)allowsSpansOtherThanThisEvent;
- (bool)allowsTravelTimeModifications;
- (void)applyChangesFromEvent:(id)arg1 toEvent:(id)arg2 ignoringDifferencesFrom:(id)arg3;
...
- (void)prefetchAttendeesWithAdditionalProperties:(id)arg1;
- (bool)preventConferenceURLDetection;
- (id)previousOccurrence;
- (id)previousOccurrenceOrDetachmentBefore:(id)arg1;
...
- (bool)refreshIfRefreshableAndNotify:(bool)arg1;
- (void)rejectPredictedLocation;
- (unsigned long long)reminderOccurrenceType;
...
- (void)setFlag:(unsigned long long)arg1 value:(bool)arg2;
...
- (void)setIsOriginalItemPhantom:(bool)arg1;
...
- (void)setRecurrenceRuleFromICSString:(id)arg1;
...
- (void)setStartDateComponentsPreservingDuration:(id)arg1;
...
- (id)CUIK_attendeesIconSymbolWithAttendeesIconState:(unsigned long long)arg1 myParticipantStatus:(long long)arg2;
