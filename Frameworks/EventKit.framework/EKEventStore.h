...
@interface EKEventStore : NSObject <EKDaemonConnectionDelegate> {
    ...
    bool  _allowsIntegrationModifications;
...
@property (nonatomic) bool allowsIntegrationModifications;
...
@property (nonatomic, retain) <EKEmailSender> *emailSender;
...
@property (nonatomic, retain) NSMutableSet *uncommittableObjects;
...
+ (id)_filteredArrayWithIdentifiers:(id)arg1 fromObjects:(id)arg2 excludingObjects:(id)arg3;
+ (id)_filteredObjectsWithIdentifiers:(id)arg1 fromObjects:(id)arg2 excludingObjects:(id)arg3;
...
+ (bool)_shouldUseInProcessXPCWithInitOptions:(unsigned long long)arg1;
...
- (void)_addPendingIntegrationEvent:(id)arg1 toArrayOfHashTables:(id)arg2;
- (void)_addRemovedObjectToPendingCommits:(id)arg1;
- (id)_allCalendars;
...
- (id)_checkPendingIntegrationEvents:(id)arg1 changedIDsValid:(bool)arg2;
...
- (void)_markObjectUncommittable:(id)arg1;
- (id)_markObjectsWithIdentifiersAsCommitted:(id)arg1 excludingObjects:(id)arg2;
...
- (void)addPendingIntegrationEvent:(id)arg1;
...
- (id)colorWithProviderIdentifier:(id)arg1 externalIdentifier:(id)arg2;
...
- (id)eventsWithSameRecurrenceSetAsEvent:(id)arg1;
- (id)eventsWithUUIDToOccurrenceDateMap:(id)arg1 inCalendars:(id)arg2;
- (void)familyCalendarsWithCompletion:(id /* block */)arg1;
...
- (id)initWithEKOptions:(unsigned long long)arg1 path:(id)arg2 containerProvider:(id)arg3 changeTrackingClientId:(id)arg4 enablePropertyModificationLogging:(bool)arg5 allowDelegateSources:(bool)arg6 allowedSourceIdentifiers:(id)arg7;
- (id)initWithEKOptions:(unsigned long long)arg1 path:(id)arg2 containerProvider:(id)arg3 tccPermissionChecker:(id)arg4 changeTrackingClientId:(id)arg5 enablePropertyModificationLogging:(bool)arg6 allowDelegateSources:(bool)arg7 allowedSourceIdentifiers:(id)arg8;
...
- (bool)isPendingIntegrationEvent:(id)arg1;
...
- (void)loadEventIDs:(id*)arg1 uniqueIDs:(id*)arg2 calendar:(id)arg3;
...
- (void)pendingIntegrationEventChangedIdentifierFrom:(id)arg1 to:(id)arg2;
- (void)performHoldingReminderSourceMapLock:(id /* block */)arg1;
- (id)persistentObjectWithEntityName:(id)arg1;
- (id)personaIdentifierForDatabaseID:(int)arg1;
...
- (void)removeEmptyTablesInArray:(id)arg1;
...
- (void)removePendingIntegrationEvent:(id)arg1;
...
- (bool)saveColor:(id)arg1 commit:(bool)arg2 error:(id*)arg3;
...
- (int)sequenceNumber;
- (id)sequenceToken;
- (void)setAllowsIntegrationModifications:(bool)arg1;
...
- (void)setShowCompletedReminders:(bool)arg1;
...
- (void)setUncommittableObjects:(id)arg1;
...
- (void)showCompletedRemindersChanged:(id)arg1;
