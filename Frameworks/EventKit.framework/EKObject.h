...
+ (bool)_compareSingleValueRelationshipKey:(id)arg1 forObject:(id)arg2 againstObject:(id)arg3 propertiesToIgnore:(id)arg4 ignoreIdentityKeys:(bool)arg5;
...
+ (void)addChangesFromObject:(id)arg1 toObject:(id)arg2 exceptWhereObjectIsDifferentFrom:(id)arg3 skippingChanges:(id)arg4;
...
- (void)_addChanges:(id)arg1 copyingBackingObjects:(bool)arg2 objectIdentifierBlock:(id /* block */)arg3;
- (void)_addChangesFromObject:(id)arg1 ignoringDifferencesFrom:(id)arg2 changesToSkip:(id)arg3 copyingBackingObjects:(bool)arg4;
...
- (id)diffWithObject:(id)arg1 compareUIVisiblePropertiesOnly:(bool)arg2;
- (id)duplicate;
...
- (id)uniqueIdentifier;
- (void)updateAfterApplyingChanges:(id)arg1 objectIdentifierBlock:(id /* block */)arg2;
...
- (void)updateMeltedCacheForChangeSet:(id)arg1 objectIdentifierBlock:(id /* block */)arg2;
- (void)updateMultiValueCacheForChangeSet:(id)arg1 preservingExistingAdds:(bool)arg2 objectIdentifierBlock:(id /* block */)arg3;
