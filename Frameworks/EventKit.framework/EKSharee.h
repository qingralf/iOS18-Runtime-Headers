...
@property (nonatomic, retain) NSArray *familyEmailAddressAliases;
@property (nonatomic, copy) NSString *firstName;
@property (readonly) unsigned long long hash;
@property (nonatomic, readonly) bool isCurrentUserForScheduling; /* unknown property attribute: ? */
@property (nonatomic, readonly) bool isCurrentUserForSharing; /* unknown property attribute: ? */
...
- (void)setFamilyEmailAddressAliases:(id)arg1;
