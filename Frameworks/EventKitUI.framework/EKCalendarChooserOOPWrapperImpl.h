...
@interface EKCalendarChooserOOPWrapperImpl : UIViewController <EKCalendarChooserImpl, EKCalendarEditorDelegate> {
...
@property (nonatomic, retain) UIView *safeAreaCaulk;
...
@property (nonatomic, retain) _TtC10EventKitUI24EKCalendarChooserOOPImpl *vc;
...
- (void)remoteCalendarChooserSelectionChanged:(id)arg1 allSelected:(bool)arg2;
- (id)safeAreaCaulk;
- (id)selectedCalendar;
...
- (void)showCalendar:(id)arg1 completion:(id /* block */)arg2;
