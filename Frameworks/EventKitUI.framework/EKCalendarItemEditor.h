...
- (id)calendarItem;
- (unsigned long long)calendarItemCreationMethod;
...
- (void)refreshURL;
- (void)reloadTableViewSectionsForTime:(bool)arg1 invitees:(bool)arg2 location:(bool)arg3 recurrence:(bool)arg4;
...
- (void)setCalendarItemCreationMethod:(unsigned long long)arg1;
...
- (void)setupForEvent;
- (bool)shouldDisplayEditItem:(id)arg1;
- (bool)showsTimeZone;
- (id)store;
