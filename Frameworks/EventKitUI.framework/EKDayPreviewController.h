...
- (void)_updateIvarsWithDate:(id)arg1 event:(id)arg2 overriddenEventStartDate:(id)arg3 overriddenEventEndDate:(id)arg4;
...
- (id)initWithDate:(id)arg1 event:(id)arg2 overriddenEventStartDate:(id)arg3 overriddenEventEndDate:(id)arg4 model:(id)arg5;
- (id)initWithDate:(id)arg1 event:(id)arg2 overriddenEventStartDate:(id)arg3 overriddenEventEndDate:(id)arg4 model:(id)arg5 overriddenDayViewHourScale:(double)arg6 overriddenDayViewMinHourRange:(long long)arg7;
- (void)loadView;
- (long long)overriddenParticipantStatus;
- (struct CGSize { double x1; double x2; })preferredContentSize;
- (void)reload;
- (void)reloadWithNewDate:(id)arg1 event:(id)arg2 overriddenEventStartDate:(id)arg3 overriddenEventEndDate:(id)arg4;
