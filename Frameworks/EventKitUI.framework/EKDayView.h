...
@interface EKDayView : UIView <EKDayAllDayViewDelegate, EKDayTimeViewDelegate, EKDayViewContentDelegate, UIScrollViewDelegate> {
    ...
    id /* block */  _contentDidChangeCallback;
    ...
    id /* block */  _displayDateDidChangeCallback;
...
@property (nonatomic, copy) id /* block */ contentDidChangeCallback;
...
@property (nonatomic, copy) id /* block */ displayDateDidChangeCallback;
...
- (void)_createAllDayViewWithSizeClass:(long long)arg1 rightClickDelegate:(id)arg2;
...
- (id)allDayView;
- (void)allDayView:(id)arg1 didSelectEvent:(id)arg2 userInitiated:(bool)arg3;
...
- (bool)allDayViewShouldAnnotateAppEntities:(id)arg1;
...
- (id /* block */)contentDidChangeCallback;
...
- (void)dayViewContent:(id)arg1 didSelectEvent:(id)arg2 userInitiated:(bool)arg3 dateSelected:(id)arg4;
- (void)dayViewContent:(id)arg1 didSelectEvents:(id)arg2 userInitiated:(bool)arg3;
...
- (bool)dayViewContentShouldAnnotateAppEntities:(id)arg1 onDayStarting:(id)arg2;
...
- (id)dimmedOccurrence;
- (id)displayDate;
- (id /* block */)displayDateDidChangeCallback;
...
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 sizeClass:(long long)arg2 orientation:(long long)arg3 displayDate:(id)arg4 backgroundColor:(id)arg5 opaque:(bool)arg6 scrollbarShowsInside:(bool)arg7 isMiniPreviewInEventDetail:(bool)arg8 rightClickDelegate:(id)arg9;
...
- (void)setContentDidChangeCallback:(id /* block */)arg1;
- (void)setDataSource:(id)arg1;
- (void)setDelegate:(id)arg1;
- (void)setDimmedOccurrence:(id)arg1;
- (void)setDisplayDate:(id)arg1;
- (void)setDisplayDateDidChangeCallback:(id /* block */)arg1;
