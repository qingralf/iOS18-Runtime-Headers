...
@interface EKDayViewContent : UIView <CUIKSingleDayTimelineGroupingDelegate, CUIKSingleDayTimelineLayoutScreenUtils, EKDayOccurrenceViewDelegate, UIGestureRecognizerDelegate> {
...
@property (nonatomic) bool useMultiDayStyle;
...
- (bool)_layoutNeededForDay:(long long)arg1 isLoadingAsync:(bool)arg2;
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })_occurrencePaddingBetweenDays:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
- (bool)_shouldAnnotateAppEntitiesForDayAtIndex:(unsigned long long)arg1;
- (void)_tapRecognized:(id)arg1;
- (void)_updateShouldAnnotateAppEntitiesByDay;
- (id)allVisibleItems;
- (bool)allowsOccurrenceSelection;
- (void)applyContentItem:(id)arg1 toView:(id)arg2 shouldAnnotate:(bool)arg3;
...
- (id)grid;
- (id)groupItem:(id)arg1 withItem:(id)arg2;
...
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 sizeClass:(long long)arg2 orientation:(long long)arg3 backgroundColor:(id)arg4 opaque:(bool)arg5 isMiniPreviewInEventDetail:(bool)arg6 numberOfDaysToDisplay:(unsigned long long)arg7;
...
- (bool)itemIsEligibleForGrouping:(id)arg1;
...
- (void)setUseMultiDayStyle:(bool)arg1;
