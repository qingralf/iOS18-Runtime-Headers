...
@interface EKDayViewController : UIViewController <BlockableScrollViewDelegate, CUIKPasteboardManagerCopyDelegate, CUIKPasteboardManagerCutDelegate, CUIKPasteboardManagerPasteDelegate, EKDayOccurrenceViewDelegate, EKDayViewDataSource, EKDayViewDelegate, EKEventGestureControllerDelegate, EKUIRightClickEmptySpaceInteractionDelegate, UIScrollViewDelegate> {
...
@property (nonatomic, retain) UIViewController<EKEventOrIntegrationEditView> *currentEditor;
@property (nonatomic, readonly) UIView *currentTopLabelsContainer;
...
- (unsigned long long)_dateModeForAllDay:(bool)arg1;
- (bool)_delegateRespondsToDisplayedOccurrencesChangedMethod;
- (void)_didRespondToApplicationDidBecomeActiveStateChange;
- (long long)_effectiveInterfaceOrientationForSize:(struct CGSize { double x1; double x2; })arg1;
- (id)_eventGestureSuperview;
- (id)_eventsForCutOrCopy;
- (id)_eventsForDay:(id)arg1;
- (void)_highlightEvent:(id)arg1 dayViewDate:(double)arg2 isAllDay:(bool)arg3;
...
- (void)copy:(id)arg1;
- (void)createEvent:(bool)arg1 atPoint:(struct CGPoint { double x1; double x2; })arg2 inView:(id)arg3;
...
- (id)currentDayContentGridViewSubviews;
- (id)currentDayView;
- (id)currentEditor;
- (id)currentPresentationController;
- (id)currentTopLabelsContainer;
- (void)cut:(id)arg1;
- (id)dataSource;
...
- (void)dayView:(id)arg1 didSelectEvent:(id)arg2 userInitiated:(bool)arg3;
- (void)dayView:(id)arg1 didSelectEvents:(id)arg2 userInitiated:(bool)arg3;
...
- (void)dayViewDidTapEmptySpace:(id)arg1 onDate:(id)arg2;
- (bool)dayViewShouldAnnotateAppEntities:(id)arg1 onDayStarting:(id)arg2;
...
- (id)effectiveEventGestureSuperview;
...
- (void)eventGestureController:(id)arg1 didSingleTapOccurrence:(id)arg2 shouldExtendSelection:(bool)arg3;
- (double)eventGestureController:(id)arg1 heightForAllDayOccurrenceView:(id)arg2;
- (double)eventGestureController:(id)arg1 heightForOccurrenceViewOfDuration:(double)arg2;
- (bool)eventGestureController:(id)arg1 isAllDayAtPoint:(struct CGPoint { double x1; double x2; })arg2 requireInsistence:(bool)arg3;
- (id)eventGestureController:(id)arg1 occurrenceViewAtPoint:(struct CGPoint { double x1; double x2; })arg2 ignoreSelectedCopyView:(bool)arg3;
- (id)eventGestureController:(id)arg1 occurrenceViewForOccurrence:(id)arg2;
- (id)eventGestureController:(id)arg1 occurrenceViewForOccurrence:(id)arg2 occurrenceDate:(id)arg3;
...
- (bool)interaction:(id)arg1 canCreateEventAtPoint:(struct CGPoint { double x1; double x2; })arg2 inView:(id)arg3;
- (bool)interaction:(id)arg1 canCreateReminderAtPoint:(struct CGPoint { double x1; double x2; })arg2 inView:(id)arg3;
- (bool)interaction:(id)arg1 canPasteEventAtPoint:(struct CGPoint { double x1; double x2; })arg2 inView:(id)arg3;
- (void)interaction:(id)arg1 createEventAtPoint:(struct CGPoint { double x1; double x2; })arg2 inView:(id)arg3;
- (void)interaction:(id)arg1 createReminderAtPoint:(struct CGPoint { double x1; double x2; })arg2 inView:(id)arg3;
- (void)interaction:(id)arg1 pasteEventAtPoint:(struct CGPoint { double x1; double x2; })arg2 inView:(id)arg3;
- (bool)interaction:(id)arg1 shouldShowMenuAtPoint:(struct CGPoint { double x1; double x2; })arg2 inView:(id)arg3;
- (id)interaction:(id)arg1 subtitleForPasteActionAtPoint:(struct CGPoint { double x1; double x2; })arg2 inView:(id)arg3;
- (id)interaction:(id)arg1 titleForPasteActionAtPoint:(struct CGPoint { double x1; double x2; })arg2 inView:(id)arg3;
- (void)layoutContainerView:(id)arg1;
- (void)loadData:(bool)arg1 withTrigger:(int)arg2 withCompletion:(id /* block */)arg3;
- (void)loadDataBetweenStart:(id)arg1 end:(id)arg2 withTrigger:(int)arg3 generation:(int)arg4 completionForCurrentDayReload:(id /* block */)arg5;
- (void)loadView;
...
- (id)occurrenceViewForEvent:(id)arg1 occurrenceDate:(id)arg2;
...
- (void)preferredContentSizeDidChanged:(id)arg1;
- (id)preferredEventsToSelectOnDate:(id)arg1;
...
- (void)setShouldLogVisibleEvents:(bool)arg1;
