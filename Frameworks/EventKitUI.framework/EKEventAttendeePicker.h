...
@interface EKEventAttendeePicker : UIViewController <CNAutocompleteResultsTableViewControllerDelegate, CNAutocompleteSearchConsumer, CNAutocompleteUIFetchDelegate, CNComposeRecipientTextViewDelegate, CNContactPickerDelegate, CNContactViewControllerPrivateDelegate> {
