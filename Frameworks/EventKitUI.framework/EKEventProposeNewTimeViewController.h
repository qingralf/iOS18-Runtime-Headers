...
@interface EKEventProposeNewTimeViewController : UITableViewController <EKCalendarItemEditItemDelegate, EKEditItemViewControllerDelegate, EKEditItemViewControllerProtocol, EKEventDateEditItemDelegate, EKUIEventStatusButtonsViewDelegate, EKUINavigationDelegateProvider, EKViewControllerRemoteUIProtocol, UITableViewDataSource, UITableViewDelegate> {
...
@property (nonatomic, retain) UIActivityIndicatorView *availabilitySearcherRunningSpinner;
@property (nonatomic, retain) NSTimer *availabilitySearcherRunningSpinnerTimer;
...
@property (nonatomic, retain) EKUIInviteesViewAvailabilitySection *viewAvailabilitySection;
...
- (void)availabilityDateChangedTo:(id)arg1;
- (id)availabilitySearcher;
- (id)availabilitySearcherRunningSpinner;
- (id)availabilitySearcherRunningSpinnerTimer;
...
- (void)setAvailabilitySearcherRunningSpinner:(id)arg1;
- (void)setAvailabilitySearcherRunningSpinnerTimer:(id)arg1;
...
- (void)setViewAvailabilitySection:(id)arg1;
