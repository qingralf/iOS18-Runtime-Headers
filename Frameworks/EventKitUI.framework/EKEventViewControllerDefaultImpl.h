...
- (void)eventEditViewController:(id)arg1 didCompleteWithAction:(long long)arg2 completionHandler:(id /* block */)arg3;
...
- (void)reloadReminderWithEKEvent:(id)arg1;
...
- (id)toolbarItems;
- (void)uneditableButtonDetailItem:(id)arg1 requestsShowEvent:(id)arg2;
