...
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 calendarItem:(id)arg2 eventStore:(id)arg3;
...
- (void)searchTextChanged:(id)arg1 allowClearingCheckedVirtualConference:(bool)arg2;
