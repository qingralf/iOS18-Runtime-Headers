...
+ (bool)_reauthorizeForAccount:(id)arg1 usingViewController:(id)arg2 completion:(id /* block */)arg3;
...
+ (void)presentAlertForAccount:(id)arg1 error:(unsigned long long)arg2 usingViewController:(id)arg3 completion:(id /* block */)arg4;
