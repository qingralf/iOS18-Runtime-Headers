...
@interface EKUICustomRecurrenceViewController : UIViewController <EKRecurrenceChooserControllerDelegate, EKUIManagedViewController, UIPickerViewDataSource, UIPickerViewDelegate, UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate> {
...
- (id)_everyStringForFrequency:(long long)arg1 interval:(long long)arg2;
