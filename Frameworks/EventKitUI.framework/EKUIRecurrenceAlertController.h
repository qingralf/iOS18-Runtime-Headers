...
+ (id)_defaultStringForDeleteButtonForEvent:(id)arg1;
+ (id)_defaultStringForDeleteTitleWhenNotRecurring:(id)arg1;
...
+ (bool)shouldShowDeleteAlertForEvent:(id)arg1 options:(unsigned long long)arg2;
+ (bool)shouldShowDetachAlertForEvent:(id)arg1 options:(unsigned long long)arg2;
