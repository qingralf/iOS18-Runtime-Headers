...
- (void)nmeaSentenceArrived:(id)arg1 forAccessoryUUID:(id)arg2 withTimestamps:(id)arg3;
...
- (void)sendWiredCarPlayAvailable:(id)arg1 usbIdentifier:(id)arg2 wirelessCarPlayAvailable:(id)arg3 bluetoothIdentifier:(id)arg4 themeAssetsAvailable:(id)arg5 forUUID:(id)arg6;
