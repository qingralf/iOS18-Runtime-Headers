...
- (void)restoreUserURL:(id)arg1 cleanupOnSuccess:(bool)arg2 completionHandler:(id /* block */)arg3;
- (void)restoreUserURL:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)restoreUserURL:(id)arg1 fromBuild:(id)arg2 restoreType:(id)arg3 completionHandler:(id /* block */)arg4;
