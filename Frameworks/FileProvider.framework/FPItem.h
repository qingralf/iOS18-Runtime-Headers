...
@property (getter=isContentZoneRoot, nonatomic) bool contentZoneRoot;
...
@property (nonatomic, retain) NSString *parentFormerIdentifier;
@property (nonatomic, readonly) FPItemID *parentFormerItemID;
...
@property (getter=isPinnedSubitem, nonatomic, readonly) bool pinnedSubitem;
@property (getter=isPlaceholder, nonatomic, readonly) bool placeholder;
@property (nonatomic, copy) NSString *placeholderIdentifier;
...
+ (id)archivePlaceholderForItem:(id)arg1 underParent:(id)arg2 inProviderDomainID:(id)arg3 withArchiveFormat:(unsigned long long)arg4;
...
+ (id)genericArchivePlaceholderUnderParent:(id)arg1 inProviderDomainID:(id)arg2 withArchiveFormat:(unsigned long long)arg3;
...
- (void)itemIsSupportedSearchScopeWithCachePolicy:(unsigned long long)arg1 completionHandler:(id /* block */)arg2;
- (id)itemVersion;
- (id)lastUsedDate;
...
- (id)parentFormerIdentifier;
- (id)parentFormerItemID;
- (id)parentItemID;
...
- (void)setContentZoneRoot:(bool)arg1;
...
- (void)setParentFormerIdentifier:(id)arg1;
