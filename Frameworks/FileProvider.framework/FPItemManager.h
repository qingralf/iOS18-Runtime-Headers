...
- (void)_fetchURLForItemID:(id)arg1 creatingPlaceholderIfMissing:(bool)arg2 completionHandlerWithInfo:(id /* block */)arg3;
- (bool)_isValidDestination:(id)arg1;
- (bool)_itemIsOfArchiveType:(id)arg1;
- (void)addOperation:(id)arg1;
- (id)appLibraryCollectionForProviderDomain:(id)arg1;
- (id)appLibraryCollectionForProviderDomainID:(id)arg1;
...
- (id)eligibleActionsForItems:(id)arg1 domainCachePolicy:(unsigned long long)arg2;
...
- (id)newCollectionWithItemAtURL:(id)arg1 error:(id*)arg2;
- (id)newCollectionWithItemAtURL:(id)arg1 skipValidation:(bool)arg2 error:(id*)arg3;
