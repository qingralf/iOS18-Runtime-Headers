...
@interface FPProviderDomain : NSObject <NSCopying, NSSecureCoding> {
    ...
    bool  _storageURLsAreInTransientState;
...
@property (nonatomic, readonly) bool isFruitBasketProvider;
...
+ (id)_generateDomainIDFromDSID:(id)arg1;
...
+ (id)cachedProviderDomainWithID:(id)arg1 cachePolicy:(unsigned long long)arg2 error:(id*)arg3;
...
+ (void)fetchProviderDomainForItem:(id)arg1 cachePolicy:(unsigned long long)arg2 completionHandler:(id /* block */)arg3;
...
+ (void)providerDomainWithID:(id)arg1 cachePolicy:(unsigned long long)arg2 completionHandler:(id /* block */)arg3;
+ (id)providerDomainWithID:(id)arg1 cachePolicy:(unsigned long long)arg2 error:(id*)arg3;
...
- (void)reconnectAndReimportDomainWithCompletionHandler:(id /* block */)arg1;
...
- (void)setStorageURLsAreInTransientState:(bool)arg1;
...
+ (id)allowedFileProviderBundleIdentifiersFiltered:(id /* block */)arg1;
+ (id)domainPathCache;
