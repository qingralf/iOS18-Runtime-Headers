...
@interface FPSpotlightIndexer : NSObject {
    ...
    NSString * _domainID;
    <FPSpotlightDropIndexDelegate> * _dropIndexDelegate;
...
@property (nonatomic, readonly) <FPSpotlightDropIndexDelegate> *dropIndexDelegate;
...
- (id)domain;
- (id)domainContext;
- (void)dropIndexAndInvalidateWithDropReason:(unsigned long long)arg1 completionHandler:(id /* block */)arg2;
- (id)dropIndexDelegate;
- (void)dropIndexInQueue:(id)arg1 dropReason:(unsigned long long)arg2 completionHandler:(id /* block */)arg3;
- (void)dropIndexWithDropReason:(unsigned long long)arg1 completionHandler:(id /* block */)arg2;
...
- (void)indexOutOfBandUpdatedItems:(id)arg1 deletedItems:(id)arg2 indexReason:(long long)arg3 completionHandler:(id /* block */)arg4;
- (id)initWithDomain:(id)arg1 providerDomain:(id)arg2 indexName:(id)arg3 log:(id)arg4 supportURL:(id)arg5 dropIndexDelegate:(id)arg6;
- (id)initWithDomain:(id)arg1 providerDomain:(id)arg2 log:(id)arg3 supportURL:(id)arg4 dropIndexDelegate:(id)arg5;
- (void)invalidate;
