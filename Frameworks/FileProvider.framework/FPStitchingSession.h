...
- (id)createArchivePlaceholderForItem:(id)arg1 underParent:(id)arg2 inProviderDomainID:(id)arg3 withArchiveFormat:(unsigned long long)arg4;
- (id)createGenericArchivePlaceholderUnderParent:(id)arg1 inProviderDomainID:(id)arg2 withArchiveFormat:(unsigned long long)arg3;
