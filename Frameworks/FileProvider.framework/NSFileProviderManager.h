...
+ (void)addDomain:(id)arg1 forProviderIdentifier:(id)arg2 byImportingDirectoryAtURL:(id)arg3 userAllowedDBDrop:(bool)arg4 knownFolders:(id)arg5 completionHandler:(id /* block */)arg6;
+ (void)addDomain:(id)arg1 forProviderIdentifier:(id)arg2 byImportingDirectoryAtURL:(id)arg3 userAllowedDBDrop:(bool)arg4 knownFolders:(id)arg5 synchronous:(bool)arg6 completionHandler:(id /* block */)arg7;
...
+ (void)addDomain:(id)arg1 userAllowedDBDrop:(bool)arg2 completionHandler:(id /* block */)arg3;
+ (bool)checkDomainsCanBeStored:(bool*)arg1 onVolumeAtURL:(id)arg2 unsupportedReason:(unsigned long long*)arg3 error:(id*)arg4;
+ (id)defaultManager;
...
- (void)_fetchDomainServicer:(id)arg1 forProviderDomainID:(id)arg2 handler:(id /* block */)arg3;
...
- (void)addDomain:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)addDomain:(id)arg1 userAllowedDBDrop:(bool)arg2 completionHandler:(id /* block */)arg3;
- (void)claimKnownFolders:(id)arg1 localizedReason:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)dealloc;
- (void)deleteSearchableItemsWithSpotlightDomainIdentifiers:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)deleteSearchableItemsWithSpotlightDomainIdentifiers:(id)arg1 indexReason:(long long)arg2 completionHandler:(id /* block */)arg3;
- (id)description;
...
- (void)releaseKnownFolders:(unsigned long long)arg1 localizedReason:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)removeAllDomainsWithCompletionHandler:(id /* block */)arg1;
- (void)removeDomain:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (id)stateDirectoryURLWithError:(id*)arg1;
...
- (id)br_getFPDomainForAccount:(id)arg1 withError:(id*)arg2;
- (id)br_getFPDomainWithIdentifier:(id)arg1 withError:(id*)arg2;
- (id)br_getFPDomainsWithError:(id*)arg1;
...
- (void)br_signalEnumeratorForContainerItemIdentifier:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)br_signalWorkingSetEnumeratorWithCompletionHandler:(id /* block */)arg1;
