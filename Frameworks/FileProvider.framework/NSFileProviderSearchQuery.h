...
@interface NSFileProviderSearchQuery : NSObject <NSCopying, NSSecureCoding> {
    ...
    bool  _shouldPerformSemanticSearch;
...
@property (nonatomic) bool shouldPerformSemanticSearch;
...
@property (nonatomic, copy) NSString *userQueryString;
...
- (void)setShouldPerformSemanticSearch:(bool)arg1;
