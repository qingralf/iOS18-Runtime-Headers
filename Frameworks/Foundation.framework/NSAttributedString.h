...
@property (nonatomic, readonly) bool _ui_containsTables;
...
@property (nonatomic, readonly, copy) NSArray *lt_sentences;
...
+ (id)_un_attributedStringWithRTFDData:(id)arg1;

- (id)_un_RTFDData;
- (id)_un_attributedStringByKeepingOnlyAttachmentAttributes;
- (id)_un_truncatedAttributedStringToMaxLength:(unsigned long long)arg1;
...
- (id)ams_replaceOccurrencesOfString:(id)arg1 withString:(id)arg2 options:(unsigned long long)arg3;

// Image: /System/Library/PrivateFrameworks/BulletinBoard.framework/BulletinBoard

+ (id)_bb_attributedStringWithRTFDData:(id)arg1;
...
- (id)__ck_adaptiveImageGlyphAtIndex:(unsigned long long)arg1;
- (id)__ck_attributedStringByApplyingRichLinkInteraction:(long long)arg1 toRichLinkItems:(id)arg2 stringDidChange:(bool*)arg3;
- (id)__ck_attributedStringByRemovingAllAttributesExcept:(id)arg1;
- (id)__ck_attributedStringByTrimmingCharactersInSet:(id)arg1;
- (long long)__ck_bigEmojiStyle;
- (long long)__ck_bigEmojiStyleWithSingleBigEmojiSupported:(bool)arg1;
- (long long)__ck_bigEmojiStyleWithSingleBigEmojiSupported:(bool)arg1 mediaObjects:(id)arg2;
- (id)__ck_fileTransferGUIDAtIndex:(unsigned long long)arg1;
- (bool)__ck_hasAdaptiveImageGlyphAtIndex:(unsigned long long)arg1;
- (bool)__ck_isOnlyAdaptiveImageGlyphs;
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })__ck_rangeOfRichLinkItem:(id)arg1;
- (id)_fileTransferForMediaObjectInMediaObjects:(id)arg1 matchingAdaptiveGlyphContentIdentifier:(id)arg2;
- (bool)_fileTransferGUIDIsForGenmojiOrAnimojiSticker:(id)arg1;
- (unsigned long long)ck_actionForIMTextStyle:(unsigned long long)arg1 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2;
- (long long)ck_activeTextEffectTypeInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
- (long long)ck_activeTextEffectTypeInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 ignoreRangeLengthCheck:(bool)arg2;
- (unsigned long long)ck_activeTextStylesInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
- (id)ck_attributedStringByApplyingRichLinkInteraction:(long long)arg1 toLinkTextAttachments:(id)arg2 stringDidChange:(bool*)arg3;
- (id)ck_attributedStringByApplyingRichLinkInteraction:(long long)arg1 toRichLinkConfigurations:(id)arg2 stringDidChange:(bool*)arg3;
- (id)ck_attributedStringByApplyingTextEffectType:(long long)arg1 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2;
- (id)ck_attributedStringByApplyingTextStyle:(unsigned long long)arg1 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2;
- (id)ck_attributedStringByConverting:(id /* block */)arg1 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2;
...
- (id)ck_attributedStringByTogglingTextEffectNamed:(id)arg1 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2;
- (bool)ck_attributedStringHasTextEffectType:(long long)arg1 inRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2;
- (bool)ck_containsIMTextEffect;
- (bool)ck_containsNSTextAnimations;
- (bool)ck_containsStaleEntryViewFont;
- (void)ck_enumerateAllMentionAnimationIdentifiersUsingBlock:(id /* block */)arg1;
- (void)ck_enumerateTextAnimationsIn:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 options:(unsigned long long)arg2 using:(id /* block */)arg3;
- (bool)ck_hasTextAnimation;
- (bool)ck_hasTextStyle:(unsigned long long)arg1 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2;
- (id)ck_linkPreviewTextAttachmentsInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
- (id)ck_textAnimationAt:(long long)arg1;
- (id)ck_textAnimationAt:(long long)arg1 longestEffectiveRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; }*)arg2;
...
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })crk_familyNameRange;
...
+ (id)hf_attributedStringWithInflectableAccessoryStatus:(id)arg1 accessoryName:(id)arg2 forcePluralAgreement:(bool)arg3 markdownFormat:(id)arg4;
+ (id)hf_attributedStringWithString:(id)arg1 insertingSystemImageNamed:(id)arg2;
...
- (id)__imspi_attributedStringByReplacingAdaptiveImageGlyphFileTransfersUsingAttachmentProvider:(id /* block */)arg1 replacementTextProvider:(id /* block */)arg2 removedTransferGUIDsOut:(inout id*)arg3;
- (void)__imspi_enumerateAdaptiveImageGlyphFileTransfersUsingAttachmentProvider:(id /* block */)arg1 block:(id /* block */)arg2;
- (id)_pluginPayloadURLFromIMMessageItemBody;
...
+ (id)__im_attributedStringWithFileTransfers:(id)arg1;
...
- (id)__im_attributedStringByReplacingAdaptiveImageGlyphFileTransfersUsingFileTransferProvider:(id /* block */)arg1 replacementTextProvider:(id /* block */)arg2 removedTransferGUIDsOut:(inout id*)arg3;
- (id)__im_attributedStringByReplacingAdaptiveImageGlyphFileTransfersUsingIsAdaptiveImageGlyphProvider:(id /* block */)arg1 replacementTextProvider:(id /* block */)arg2 removedTransferGUIDsOut:(inout id*)arg3;
- (id)__im_attributedStringByReplacingAdaptiveImageGlyphsWithUnknownCharacterSymbol;
- (id)__im_attributedStringByReplacingFileTransferGUID:(id)arg1 withUpdatedTransferGUID:(id)arg2;
- (id)__im_attributedStringByReplacingRichCardGUID:(id)arg1 withUpdatedTransferGUID:(id)arg2;
- (id)__im_attributedSubstringFromRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
- (bool)__im_containsAdaptiveImageGlyphFileTransfersUsingFileTransferProvider:(id /* block */)arg1;
- (bool)__im_containsAdaptiveImageGlyphs;
- (bool)__im_containsAttributedValue:(id)arg1;
- (bool)__im_containsFileTransferGUID:(id)arg1;
- (unsigned long long)__im_countMessageParts;
- (id)__im_dataDetectedURLsFromAttributes;
- (void)__im_enumerateAdaptiveImageGlyphFileTransfersUsingFileTransferProvider:(id /* block */)arg1 block:(id /* block */)arg2;
- (void)__im_enumerateAdaptiveImageGlyphFileTransfersUsingIsAdaptiveImageGlyphProvider:(id /* block */)arg1 block:(id /* block */)arg2;
- (long long)__im_insertionIndexForMessagePartBody:(id)arg1;
- (bool)__im_isOnlyAdaptiveImageGlyphFileTransfersAndWhitespaceUsingFileTransferProvider:(id /* block */)arg1;
- (bool)__im_isOnlyAdaptiveImageGlyphFileTransfersAndWhitespaceUsingIsAdaptiveImageGlyphProvider:(id /* block */)arg1;
- (bool)__im_isRichCard;
- (bool)__im_isRichCardsOrSuggestedReply;
...
- (id)__im_messageTextByAddingMessagePart:(id)arg1 atIndex:(long long)arg2;
...
- (id)_currentLocale;
- (bool)_currentLocaleSupportsTrimming;
- (id)_localesSupportingTrim;
- (long long)im_activeTextEffectTypeInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 ignoreRangeLengthCheck:(bool)arg2;
- (bool)im_containsIMTextEffect;
- (id)im_trimmedSummaryIfNeededForTapback;
- (bool)isSingleCharacterString:(id)arg1;

// Image: /System/Library/PrivateFrameworks/InputToolKit.framework/InputToolKit

- (id)itk_attributedStringByReplacingCharactersInSet:(id)arg1 withString:(id)arg2;
- (id)itk_attributedStringByReplacingNewlineCharactersWithWhiteSpace;
- (id)itk_attributedSubstringFromRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
- (void)itk_enumerateClampedAttribute:(id)arg1 inRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 options:(unsigned long long)arg3 usingBlock:(id /* block */)arg4;
- (void)itk_enumerateUnclampedAttribute:(id)arg1 inRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 options:(unsigned long long)arg3 usingBlock:(id /* block */)arg4;
...
+ (id)mui_attributedStringWithAttributedString:(id)arg1 attributes:(id)arg2;
+ (id)mui_attributedStringWithImage:(id)arg1 string:(id)arg2 keyword:(id)arg3;
+ (id)mui_attributedStringWithString:(id)arg1 attributes:(id)arg2;

- (double)mui_boundingHeightForWidth:(double)arg1 font:(id)arg2;

// Image: /System/Library/PrivateFrameworks/MobileSafari.framework/MobileSafari

+ (id)safari_richListOfLinksForTabs:(id)arg1;
+ (id)safari_richListOfLinksForTabs:(id)arg1 includingBulletForSingleLink:(bool)arg2;
...
- (id)abstractAttachmentsInContext:(id)arg1 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 options:(unsigned long long)arg3;
...
- (id)ic_attributedStringByAppendingString:(id)arg1;
- (id)ic_attributedStringByPrependingAttributedString:(id)arg1;
- (id)ic_attributedStringByPrependingString:(id)arg1;
- (id)ic_attributedStringByRemovingAllAttributesExcept:(id /* block */)arg1;
...
- (id)ic_attributedStringByTrimmingCharactersInSet:(id)arg1;
...
- (id)ic_attributedStringByFlatteningCalculateAttachmentsWithContext:(id)arg1;
...
- (id)ic_attributedSubstringUntilLine:(unsigned int)arg1;
...
+ (id)px_localizedAttributedStringForUserPostWithCountsSet:(id)arg1 subjectName:(id)arg2 captionText:(id)arg3 defaultTextAttributes:(id)arg4 posterTextAttributes:(id)arg5 captionTextAttributes:(id)arg6;
...
+ (id)px_thumbnailVideoDurationAttributedString:(id)arg1 layoutDirection:(unsigned long long)arg2;
+ (id)px_thumbnailVideoDurationAttributedString:(id)arg1 layoutDirection:(unsigned long long)arg2 sizeClass:(long long)arg3;
...
- (id)stringByTruncatingToLength:(unsigned long long)arg1 options:(unsigned long long)arg2;
...
+ (struct UBreakIterator { }*)UIF_copyBreakIteratorWithLocale:(id)arg1 characters:(const unsigned short*)arg2 length:(unsigned long long)arg3 flags:(int)arg4 lineBreakStrategy:(unsigned long long)arg5;
+ (void)UIF_disposeBreakIterator:(struct UBreakIterator { }*)arg1 withLocale:(id)arg2 flags:(int)arg3;
...
+ (id)attributedStringWithAdaptiveImageGlyph:(id)arg1 attributes:(id)arg2;
...
- (bool)prefersRTFDInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
...
+ (id)_uikit_readableTypeIdentifiersForItemProviderConsideringLinkage:(bool)arg1;
+ (id)attributedStringWithAnimatedTextSpacer:(id)arg1 attributes:(id)arg2;
...
+ (id)nc_safeAttributedStringWithString:(id)arg1;
