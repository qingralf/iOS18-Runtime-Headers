...
@interface NSBundle : NSObject <PFRoleProviding, PFRoleProvidingInternal> {
...
@property (readonly, copy) NSString *ef_preferredLanguageIdentifier;
...
@property (nonatomic, readonly) bool safari_isInSyncAgent;
@property (nonatomic, readonly) bool safari_isPasswordsAppBundle;
@property (nonatomic, readonly) bool safari_isPasswordsMenuBarAppBundle;
...
@property (nonatomic, readonly, copy) NSString *safari_version;
...
+ (id)_mapkitBundle;
+ (bool)_mapkit_shouldShowAppleLogo;
...
+ (id)plistForClass:(Class)arg1 withPath:(id)arg2 defaultOverride:(id)arg3;
+ (id)plistFromDefaultOverride:(id)arg1;
...
+ (id)ln_uniqueBundleWithPath:(id)arg1;
+ (id)ln_uniqueBundleWithURL:(id)arg1;
...
+ (id)ULFrameworkBundle;

// Image: /System/Library/PrivateFrameworks/MobileSafari.framework/MobileSafari

+ (bool)safari_isSafariViewServiceBundle;
+ (bool)safari_isWebSheetApplicationBundle;
...
+ (id)pf_uniqueBundleWithURL:(id)arg1;
...
- (id)pcxImageForResource:(id)arg1;
- (id)pcxPathForImageResource:(id)arg1;
...
+ (bool)safari_isMobileSafariInstalled;
...
- (bool)safari_isInSyncAgent;
- (bool)safari_isPasswordsAppBundle;
- (bool)safari_isPasswordsMenuBarAppBundle;
...
+ (void)setVg_resourcePath:(id)arg1;
+ (id)vg_bundle;
+ (id)vg_bundleIdentifier;
+ (bool)vg_canSetResourcePath;
+ (id)vg_packageBundle:(id)arg1;
+ (id)vg_resourcePath;
...
+ (id)iCloudSettingsBundle;
+ (id)ics_loadBundle:(id)arg1 atPath:(id)arg2;
