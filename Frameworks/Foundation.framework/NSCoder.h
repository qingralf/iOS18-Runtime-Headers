...
@property (setter=_lp_setCoderOptions:, nonatomic) unsigned long long _lp_coderOptions;
...
- (void)_lp_setCoderOptions:(unsigned long long)arg1;
...
- (id)scn_decodeArrayOfObjectsOfClass:(Class)arg1 containingNestedContainersForKey:(id)arg2;
- (id)scn_decodeArrayOfObjectsOfClass:(Class)arg1 forKey:(id)arg2;
- (id)scn_decodeArrayOfObjectsOfClasses:(id)arg1 containingNestedContainersForKey:(id)arg2;
- (id)scn_decodeArrayOfObjectsOfClasses:(id)arg1 forKey:(id)arg2;
- (id)scn_decodeDictionaryWithKeysOfClass:(Class)arg1 objectsOfClass:(Class)arg2 containingNestedContainersForKey:(id)arg3;
- (id)scn_decodeDictionaryWithKeysOfClass:(Class)arg1 objectsOfClass:(Class)arg2 forKey:(id)arg3;
- (id)scn_decodeDictionaryWithKeysOfClasses:(id)arg1 objectsOfClasses:(id)arg2 containingNestedContainersForKey:(id)arg3;
- (id)scn_decodeDictionaryWithKeysOfClasses:(id)arg1 objectsOfClasses:(id)arg2 forKey:(id)arg3;
- (id)scn_decodeObjectOfClass:(Class)arg1 forKey:(id)arg2;
- (id)scn_decodeObjectOfClasses:(id)arg1 forKey:(id)arg2;

// Image: /System/Library/Frameworks/Vision.framework/Vision

+ (id)_vn_createEncodableDataWithMagicNumber:(unsigned int)arg1 forN:(unsigned long long)arg2 floatValues:(const float*)arg3 error:(id*)arg4;

- (struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[3]; })_vn_decode3x3MatrixFromDataRepresentation:(id)arg1 forKey:(id)arg2;
- (struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[3]; })_vn_decode3x3MatrixFromStringRepresentation:(id)arg1;
- (struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; })_vn_decode4x4MatrixFromDataRepresentation:(id)arg1 forKey:(id)arg2;
- (struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; })_vn_decode4x4MatrixFromStringRepresentation:(id)arg1;
- (bool)_vn_decodeFloatsFromEncodedData:(id)arg1 withExpectedMagicNumber:(unsigned int)arg2 valueCount:(unsigned long long)arg3 forKey:(id)arg4 usingBlock:(id /* block */)arg5;
- (void)_vn_decodeSimdFloat3FromDataRepresentation:(id)arg1 forKey:(id)arg2;
- (void)_vn_decodeSimdFloat3FromStringRepresentation:(id)arg1;
...
- (id)_asd_decodeJSONObjectForKey:(id)arg1 error:(id*)arg2;
- (bool)_asd_encodeJSONObject:(id)arg1 forKey:(id)arg2 error:(id*)arg3;
- (id)asd_decodeJSONDictionaryForKey:(id)arg1;
- (void)asd_encodeJSONDictionary:(id)arg1 forKey:(id)arg2;
...
- (id)ams_decodeBase64EncodedDataForKey:(id)arg1;
...
- (void)ams_encodeBase64EncodedData:(id)arg1 forKey:(id)arg2;
...
- (void)_bd_lp_encodeArrayIfNotEmpty:(id)arg1 forKey:(id)arg2;
- (void)_bd_lp_encodeColorIfNotNil:(id)arg1 forKey:(id)arg2;
- (void)_bd_lp_encodeObjectIfNotNil:(id)arg1 forKey:(id)arg2;
- (void)_bd_lp_encodeURLIfNotNilOrLocalFile:(id)arg1 forKey:(id)arg2;
...
- (id)bds_decodeArrayOfObjectsOfClass:(Class)arg1 forKey:(id)arg2;

// Image: /System/Library/PrivateFrameworks/CMContinuityCaptureCore.framework/CMContinuityCaptureCore

- (struct __CVBuffer { }*)decodeCVPixelBufferForKey:(id)arg1;
- (struct __CVBuffer { }*)decodeCVPixelBufferForKey:(id)arg1 expectSourceMedia:(bool)arg2;
- (void)encodeCVPixelBuffer:(struct __CVBuffer { }*)arg1 forKey:(id)arg2;

// Image: /System/Library/PrivateFrameworks/CloudPhotoLibrary.framework/CloudPhotoLibrary

- (bool)cplDecodeBoolForKey:(id)arg1;
- (BOOL)cplDecodeCharForKey:(id)arg1;
...
- (id)pui_decodeStyleForKey:(id)arg1 error:(out id*)arg2;
- (void)pui_encodeStyle:(id)arg1 forKey:(id)arg2 error:(out id*)arg3;
...
- (union { struct { double x_1_1_1; double x_1_1_2; double x_1_1_3; double x_1_1_4; } x1; })_uikit_decodeSPVector3DForKey:(id)arg1;
- (void)_uikit_encodeSPVector3D:(union { struct { double x_1_1_1; double x_1_1_2; double x_1_1_3; double x_1_1_4; } x1; })arg1 forKey:(id)arg2;
...
- (struct { double x1; double x2; double x3; })decodeUISize3DForKey:(id)arg1;
...
- (void)encodeUISize3D:(struct { double x1; double x2; double x3; })arg1 forKey:(id)arg2;
...
- (id)vfx_decodeArrayOfObjectsOfClass:(Class)arg1 containingNestedContainersForKey:(id)arg2;
- (id)vfx_decodeArrayOfObjectsOfClass:(Class)arg1 forKey:(id)arg2;
- (id)vfx_decodeArrayOfObjectsOfClasses:(id)arg1 containingNestedContainersForKey:(id)arg2;
- (id)vfx_decodeArrayOfObjectsOfClasses:(id)arg1 forKey:(id)arg2;
- (id)vfx_decodeDictionaryWithKeysOfClass:(Class)arg1 objectsOfClass:(Class)arg2 containingNestedContainersForKey:(id)arg3;
- (id)vfx_decodeDictionaryWithKeysOfClass:(Class)arg1 objectsOfClass:(Class)arg2 forKey:(id)arg3;
- (id)vfx_decodeDictionaryWithKeysOfClasses:(id)arg1 objectsOfClasses:(id)arg2 containingNestedContainersForKey:(id)arg3;
- (id)vfx_decodeDictionaryWithKeysOfClasses:(id)arg1 objectsOfClasses:(id)arg2 forKey:(id)arg3;

// Image: /System/Library/PrivateFrameworks/Visage.framework/Visage

- (id)_vg_decodeSurfaceForKey:(id)arg1;
- (struct __CVBuffer { }*)vg_createDecodedPixelBufferForKey:(id)arg1;
- (id)vg_decodeArrayOfSurfacesForKey:(id)arg1;
- (id)vg_decodeDictionaryOfSurfacesForKey:(id)arg1;
...
- (id)vg_decodeRasterizationRateMapDescriptorForKey:(id)arg1;
...
- (struct { double x1; double x2; double x3; double x4; double x5; double x6; })vg_decodeViewportForKey:(id)arg1;
- (void)vg_encodeArrayOfSurfaces:(id)arg1 forKey:(id)arg2;
- (void)vg_encodeDictionaryOfSurfaces:(id)arg1 forKey:(id)arg2;
...
- (void)vg_encodeRasterizationRateMapDescriptor:(id)arg1 forKey:(id)arg2;
...
- (void)vg_encodeViewport:(struct { double x1; double x2; double x3; double x4; double x5; double x6; })arg1 forKey:(id)arg2;
