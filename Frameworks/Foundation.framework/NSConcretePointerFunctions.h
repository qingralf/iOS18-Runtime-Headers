...
+ (void)initializeBackingStore:(struct NSSlice { void **x1; struct NSSliceExternalAcquisitionProperties {} *x2; struct NSSliceExternalPersonalityProperties {} *x3; struct NSSliceInternalProperties {} *x4; }*)arg1 sentinel:(bool)arg2 weakAutoreleasing:(bool)arg3 dynamic:(bool)arg4;
