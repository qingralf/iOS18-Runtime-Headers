...
+ (id)ef_formatDate:(id)arg1 shortStyle:(bool)arg2;
...
+ (bool)hkmc_shouldUseRelativeFormatForFertileWindowEndDate:(id)arg1 gregorianCalendar:(id)arg2 dateFormatArgumentOut:(id*)arg3;
...
- (id)hksp_timeStringFromDate:(id)arg1 designatorString:(id*)arg2 designatorIsBeforeTime:(bool*)arg3;
