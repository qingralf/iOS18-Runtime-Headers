...
@property (nonatomic, readonly) NSError *bl_securelyCodableError;
...
@property (nonatomic, readonly) NSString *crxf_errorToken;
...
@property (nonatomic, readonly) NSError *ef_secureCodableError;
...
@property (nonatomic, readonly) long long fs_posixCode;
@property (readonly) NSArray *gc_failingKeyPath;
@property (nonatomic, readonly) bool gkIsNotConnectedToInternetError;
@property (nonatomic, readonly) bool gkIsUnauthenticatedError;
...
@property (readonly) bool hmbIsCKZoneDisabledError;
@property (readonly) bool hmbIsCloudKitError;
@property (readonly) bool hmbIsSQLiteConstraintError;
@property (readonly) bool hmbIsSQLiteDatabaseCorruptedError;
...
@property (getter=hmd_isUnderlyingCKError, readonly) bool hmd_underlyingCKError;
...
@property (nonatomic, readonly) bool isAuthenticationErrorIncludingUnderlyingErrors;
...
@property (nonatomic, readonly) NSString *mf_markupString;
...
@property (nonatomic, readonly) bool mpc_isFileDoesNotExistError;
@property (nonatomic, readonly) bool mpc_isKeyServerNoOfflineSlotError;
@property (nonatomic, readonly) bool mpc_isLeaseTakenError;
@property (nonatomic, readonly) bool mpc_isNoPermissionsToReadFileError;
...
@property (nonatomic, readonly) bool mr_isMediaRemoteError;
...
@property (nonatomic, readonly) bool sh_hasShazamKitPublicErrorDomain;
...
@property (nonatomic, readonly) bool sh_isCoreDecompressionError;
@property (nonatomic, readonly) bool sh_isCoreFailedToStartAudioRecording;
@property (nonatomic, readonly) bool sh_isCoreJSONLFileParsingError;
...
@property (nonatomic, readonly) bool sh_isCoreServerResponseMissingRequiredProperties;
@property (nonatomic, readonly) bool sh_isCoreServerResponseWorkerAlreadyRegistered;
@property (nonatomic, readonly) bool sh_isCoreToldNotToResumeAudioRecordingAfterInterruption;
...
@property (nonatomic, readonly) bool sh_isMatchAttemptCancelledError;
...
@property (nonatomic, readonly) bool sh_isPrivacyDisclosureAcknowledgementNeededError;
...
+ (id)_cocoaErrorWithCode:(long long)arg1 path:(id)arg2 url:(id)arg3 underlying:(id)arg4 variant:(id)arg5 source:(id)arg6 destination:(id)arg7;
...
+ (bool)CKIsBusyDatabaseError:(id)arg1;
...
+ (id)fp_disallowedByManagement:(id)arg1;
...
+ (id)fp_externalDomainRejectedErrorWithUnderlyingError:(id)arg1;
...
+ (id)_hmUserInfoForDescription:(id)arg1 reason:(id)arg2 suggestion:(id)arg3 underlyingError:(id)arg4;
...
+ (id)hmInternalErrorWithCode:(long long)arg1 description:(id)arg2 reason:(id)arg3 suggestion:(id)arg4;
+ (id)hmInternalErrorWithCode:(long long)arg1 description:(id)arg2 reason:(id)arg3 suggestion:(id)arg4 underlyingError:(id)arg5;
...
+ (id)hmInternallErrorWithCode:(long long)arg1 userInfo:(id)arg2;
...
+ (id)hmPrivateErrorWithCode:(long long)arg1 userInfo:(id)arg2;
...
- (bool)sh_hasShazamKitPublicErrorDomain;
...
+ (id)lt_unsupportedLanguageError:(id)arg1;
+ (id)lt_unsupportedPairingErrorWithSource:(id)arg1 target:(id)arg2;
+ (id)lt_unsupportedSourceLanguageError:(id)arg1;
+ (id)lt_unsupportedTargetLanguageError:(id)arg1;
...
+ (id)forACSEError:(long long)arg1;
...
+ (id)ak_anisetteErrorWithCode:(long long)arg1 underlyingError:(id)arg2;
+ (id)ak_attestationErrorWithCode:(long long)arg1 underlyingError:(id)arg2;
+ (id)ak_deviceListErrorWithCode:(long long)arg1;
...
+ (id)ak_livenessErrorWithCode:(long long)arg1;
...
- (id)ak_allUnderlyingErrorsWithMaxDepth:(long long)arg1;
...
- (id)errorDescriptionIncludingUnderlyingErrorsWithMaxDepth:(long long)arg1;
...
+ (id)CAF_elementParseFailedForCharacteristic:(id)arg1;
+ (id)CAF_elementParseFailedForDataSupportType:(id)arg1;
+ (id)CAF_errorWithCode:(long long)arg1 userInfo:(id)arg2;
+ (id)CAF_groupRequestAlreadyPerformed;
+ (id)CAF_groupRequestErrors:(id)arg1;
+ (id)CAF_groupRequestNilForCharacteristics:(id)arg1;
+ (id)CAF_groupRequestWithNoCharacteristics;
+ (id)CAF_invalidDataForFormat:(id)arg1;
+ (id)CAF_outOfRangeErrorForValue:(id)arg1 min:(id)arg2 max:(id)arg3;
+ (id)CAF_outOfRangeErrorForValue:(id)arg1 range:(id)arg2;
+ (id)CAF_plistConversionFailedForError:(id)arg1;
...
+ (id)brc_errorAcceptShareFailedForItem:(id)arg1;
+ (id)brc_errorAcceptShareFailedWithUnderlyingError:(id)arg1;
...
+ (id)brc_errorDamagedDocumentOnDiskWithUnderlyingError:(id)arg1;
...
+ (id)brc_errorFromException:(id)arg1;
...
+ (id)brc_errorOperationAlreadyRunning:(id)arg1;
+ (id)brc_errorOperationCancelled;
+ (id)brc_errorParentItemRemotelyDeleted:(id)arg1;
...
+ (id)brc_errorThrottledWithDescription:(id)arg1;
+ (id)brc_errorThumbnailGenerationOperationTimedOut;
+ (id)brc_errorUnexpectedItemType:(id)arg1 description:(id)arg2;
...
- (void)_br_populateErrorMessageOnUserInfo:(id)arg1;
...
- (bool)_isTransientError:(id)arg1 code:(long long)arg2;
- (id)br_errorDescription;
- (id)br_fileProviderError;
- (id)br_fileProviderErrorWithFPFS:(bool)arg1;
- (bool)br_isCKErrorCode:(long long)arg1;
- (bool)br_isCKErrorCode:(long long)arg1 underlyingErrorCode:(long long)arg2;
- (bool)br_isCloudDocsErrorCode:(long long)arg1;
- (bool)br_isCocoaErrorCode:(long long)arg1;
- (bool)br_isFileProviderErrorCode:(long long)arg1;
- (bool)br_isNSURLErrorCode:(long long)arg1;
...
- (bool)brc_isCloudKitDestinationNeedsSalting;
- (bool)brc_isCloudKitErrorConsideredAsSuccessForZoneThrottle;
- (bool)brc_isCloudKitErrorDataProtectionClass;
- (bool)brc_isCloudKitErrorImplyingZoneNeedsCreation;
- (bool)brc_isCloudKitErrorMissingContentRecordForNewStructureRecord;
- (bool)brc_isCloudKitErrorNeedsPCSPrep;
- (bool)brc_isCloudKitErrorNoNetwork;
- (bool)brc_isCloudKitErrorRemappedToNewRecordName:(id*)arg1;
- (bool)brc_isCloudKitErrorReparentedToNewParent:(id*)arg1;
- (bool)brc_isCloudKitErrorRequiresVerifyTerms;
...
- (bool)brc_isCloudKitHasUnsaltedChildrenWithUnsaltedRecord:(id*)arg1 zoneID:(id)arg2;
- (bool)brc_isCloudKitMMCSErrorChunksCouldNotBeRegisteredError;
- (bool)brc_isCloudKitMMCSItemNotAvailable;
- (bool)brc_isCloudKitMMCSItemNotFound;
- (bool)brc_isCloudKitOutOfQuota;
- (bool)brc_isCloudKitPCSChainingError;
- (bool)brc_isCloudKitPCSDecryptionFailure;
- (bool)brc_isCloudKitParentValidationKeyMismatchErrorWithFieldName:(id*)arg1;
- (bool)brc_isCloudKitRequestRejectedError;
- (bool)brc_isCloudKitShouldBeUsingEnhancedDrivePrivacyWithFieldName:(id*)arg1;
- (bool)brc_isCloudKitUnknownItemError;
- (bool)brc_isCloudKitValidationKeyMismatchError;
...
- (bool)cdp_anyDescendantErrorDownToMaxDepth:(unsigned int)arg1 matchesPredicate:(id /* block */)arg2;
...
- (bool)indicatesRecoveryCanBeRetried;
- (bool)isAuthKitUnableToPromptDueToNetworkError;
- (bool)isAuthKitUnableToPromptError;
- (bool)isAuthenticationError;
- (bool)isAuthenticationErrorIncludingUnderlyingErrors;
...
+ (void)sendCECErrorAnalyticsWithContext:(id)arg1;
...
+ (id)dss_errorWithCode:(long long)arg1;
+ (id)dss_errorWithCode:(long long)arg1 userInfo:(id)arg2 retryable:(bool)arg3;

- (id)dss_copyRetryable:(bool)arg1;
- (bool)dss_isRetryable;
...
+ (id)em_itemNotFoundErrorWithItemID:(id)arg1;
...
+ (id)fp_errorForDataProtectionClass:(int)arg1;
...
- (bool)fp_isGSErrorWithCode:(int)arg1;
...
- (bool)gkIsNotConnectedToInternetError;
- (bool)gkIsServerUnauthenticatedError;
- (bool)gkIsUnauthenticatedError;
- (bool)gkRequiresCredentialRenewal;
...
+ (id)_geo_errorWithDirectionsError:(id)arg1;
...
+ (id)errorMessageForSQLite3Context:(struct sqlite3 { }*)arg1;
+ (id)hmbErrorWithSQLContext:(id)arg1;
+ (id)hmbErrorWithSQLContext:(id)arg1 statement:(const char *)arg2;
+ (id)hmbErrorWithSQLite3Connection:(struct sqlite3 { }*)arg1;
+ (id)hmbErrorWithSQLite3Connection:(struct sqlite3 { }*)arg1 statement:(const char *)arg2;
...
- (bool)_hmbHasCKUnderlyingErrorWithCode:(long long)arg1;
- (bool)_hmbIsCKErrorOrHasPartialFailurePassingFilter:(id /* block */)arg1;
- (bool)_hmbIsCKErrorOrHasPartialFailureWithCode:(long long)arg1;
- (bool)_hmbIsCKErrorWithCode:(long long)arg1;
- (bool)_hmbIsCKUnderlyingErrorWithCode:(long long)arg1;
...
- (bool)hmbIsCKZoneDisabledError;
- (bool)hmbIsCloudKitError;
- (bool)hmbIsCloudKitUnderlyingError;
...
+ (id)hmdErrorWithCode:(long long)arg1;
...
+ (id)hmmtrErrorWithCode:(long long)arg1;
...
+ (id)errorWithJoiningError:(long long)arg1 format:(id)arg2;
+ (id)errorWithJoiningError:(long long)arg1 format:(id)arg2 arguments:(char *)arg3;
...
- (id)initWithJoiningError:(long long)arg1 userInfo:(id)arg2;
...
+ (void)populateWriterError:(id*)arg1 message:(id)arg2 code:(long long)arg3;
...
+ (id)writerErrorWithMessage:(id)arg1 code:(long long)arg2;
...
+ (id)errorUsingError:(id)arg1 withUnderyingError:(id)arg2;
...
+ (id)musicKit_remotePlaybackEndpointDoesNotExist;
...
+ (id)_navigation_errorWithCode:(long long)arg1 debugDescription:(id)arg2;
...
+ (id)fc_notCachedErrorWithMissingObjects:(id)arg1;
...
- (bool)fc_hasXPCInterruptedOrInvalidError;
...
- (bool)pk_isLAErrorAuthenticationFailed;
- (bool)pk_isLAErrorUserCancel;
- (bool)pk_shouldSuppressAfterAuthenticationPolicyWasLocationBased:(bool)arg1;
...
+ (id)pf_errorWithCode:(long long)arg1;
+ (id)pf_errorWithCode:(long long)arg1 underlyingError:(id)arg2 userInfo:(id)arg3;
+ (id)pf_errorWithCode:(long long)arg1 userInfo:(id)arg2;
...
+ (id)pui_errorWithCode:(long long)arg1;
+ (id)pui_errorWithCode:(long long)arg1 underlyingError:(id)arg2 userInfo:(id)arg3;
+ (id)pui_errorWithCode:(long long)arg1 userInfo:(id)arg2;
...
- (bool)safari_matchesErrorDomain:(id)arg1;
...
- (bool)sh_isCoreDecompressionError;
- (bool)sh_isCoreFailedToStartAudioRecording;
- (bool)sh_isCoreJSONLFileParsingError;
...
- (bool)sh_isCoreServerResponseMissingRequiredProperties;
- (bool)sh_isCoreServerResponseWorkerAlreadyRegistered;
- (bool)sh_isCoreToldNotToResumeAudioRecordingAfterInterruption;
...
- (bool)sn_isNetworkConnectionRetryable;
- (bool)sn_isNetworkConnectionRetryableAfterDelay;
- (bool)sn_isNetworkConnectionRetryableNow;
- (bool)sn_isNetworkDown;
- (bool)sn_isNetworkOperationRetryable;
- (bool)sn_isNetworkUnreachable;
- (bool)sn_isNetworkUnreachableForServerCause;
...
- (id)errorWithExtendedUserInfoFromOptions:(id)arg1;
...
+ (void)VisionCoreAssert:(bool)arg1 log:(id)arg2;
...
+ (id)VisionCoreErrorForUnavailableDescriptorIdentifier:(id)arg1 version:(id)arg2;
