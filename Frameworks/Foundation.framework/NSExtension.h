...
@property (nonatomic, readonly) bool safari_isTestExtension;
@property (nonatomic, readonly) bool safari_isUnsignedExtension;
@property (nonatomic, readonly) NSString *safari_launchServicesDeveloperIdentifier;
@property (nonatomic, readonly) NSString *safari_launchServicesDeveloperName;
...
- (bool)safari_isTestExtension;
- (bool)safari_isUnsignedExtension;
