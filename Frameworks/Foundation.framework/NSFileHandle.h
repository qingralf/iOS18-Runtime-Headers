...
@property (nonatomic, readonly, copy) NSURL *safari_fileURL;
...
+ (id)safari_fileHandleByCreatingFileWithUniqueSubpath:(id)arg1 relativeToFileHandle:(id)arg2 options:(long long)arg3 createMode:(long long)arg4 error:(id*)arg5;
+ (id)safari_fileHandleWithSubpath:(id)arg1 relativeToFileHandle:(id)arg2 options:(long long)arg3 createMode:(long long)arg4 error:(id*)arg5;
+ (id)safari_fileHandleWithURL:(id)arg1 options:(long long)arg2 createMode:(long long)arg3 error:(id*)arg4;
