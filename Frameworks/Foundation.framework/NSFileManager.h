...
@interface NSFileManager : NSObject <HKSPFileManager, PLFileManager> {
    <NSFileManagerDelegate> * _delegate;
...
- (bool)_handleFaultedOutCloudDocFromSource:(id)arg1 toDestination:(id)arg2 handled:(bool*)arg3 error:(id*)arg4;
...
- (id)bu_nonCollidingNameForFileName:(id)arg1 inDestPath:(id)arg2;
...
- (long long)_im_fileSizeFor:(id)arg1;
- (id)im_generateCopyForURL:(id)arg1;
- (id)im_randomTemporaryFileURLWithFileName:(id)arg1;
- (id)im_temporaryFileURLForAdaptiveImageGlyphWithContentIdentifier:(id)arg1;
...
- (id)mf_copyFileAtURLToContainer:(id)arg1 securityScoped:(bool)arg2 preferredFileName:(id)arg3 error:(id*)arg4;
...
- (bool)mf_protectFileAtPath:(id)arg1 withClass:(long long)arg2 error:(id*)arg3;
...
- (id)mf_verifyProtectionClassesForFilesInDirectory:(id)arg1 usingBlock:(id /* block */)arg2;
...
- (unsigned long long)mk_fileSizeAtPath:(id)arg1;
...
- (bool)mb_markAsPurgeableItemAtPath:(id)arg1 error:(id*)arg2;
...
- (bool)mb_moveAsideAndMarkPurgeableDBFilesAtPath:(id)arg1 error:(id*)arg2;
- (id)mb_moveAsideItemAtPath:(id)arg1 error:(id*)arg2;
- (bool)mb_moveToTmpDirThenRemoveItemAtPath:(id)arg1 error:(id*)arg2;
- (bool)mb_savePlistAtPath:(id)arg1 addingItems:(id)arg2 removing:(id)arg3 error:(id*)arg4;
...
- (unsigned long long)fc_sizeOfItemAtPath:(id)arg1 error:(id*)arg2;
...
- (id)pf_createTransientDirectoryAtURL:(id)arg1 error:(id*)arg2;
...
- (void)_safari_getPasswordsAppContainerDirectoryURL:(id*)arg1 isContainerized:(bool*)arg2;
...
- (id)safari_createDirectoryWithUniqueName:(id)arg1 relativeToDirectoryFileHandle:(id)arg2 error:(id*)arg3;
...
- (bool)safari_imageExistsAtFileURL:(id)arg1;
...
- (id)safari_moveFileAtSubpath:(id)arg1 relativeToFileHandle:(id)arg2 toUniqueSubpath:(id)arg3 relativeToFileHandle:(id)arg4 error:(id*)arg5;
- (id)safari_moveFileAtSubpath:(id)arg1 relativeToFileHandle:(id)arg2 toUniqueSubpath:(id)arg3 relativeToFileHandle:(id)arg4 error:(id*)arg5 usingExistingFileRecoveryBlock:(id /* block */)arg6;
...
- (void)safari_removeContentsOfDirectory:(id)arg1 preservingContainerManagerMetadata:(bool)arg2;
...
- (id)safari_subpathOfURL:(id)arg1 relativeToDirectoryAtURL:(id)arg2 error:(id*)arg3;
- (id)safari_topLevelDirectoriesAtURL:(id)arg1;
- (id)safari_webExtensionsSettingsDirectoryURL;
- (bool)safari_zipContentsFromDirectory:(id)arg1 toZipFileURL:(id)arg2 error:(id*)arg3;

// Image: /System/Library/PrivateFrameworks/Sleep.framework/Sleep

+ (id)_bundleCacheDirectory;
+ (id)_bundleCachePathForFile:(id)arg1;

- (id)hkspDataForCacheFileWithName:(id)arg1;
- (bool)hkspFileWithNameExistsInCache:(id)arg1;
- (bool)hkspRemoveFileWithNameFromCache:(id)arg1 error:(id*)arg2;
- (bool)hkspWriteData:(id)arg1 toCacheFileWithName:(id)arg2 error:(id*)arg3;
...
- (id)unc_contentsSortedByLastModificationDateOfDirectoryAtPath:(id)arg1 error:(id*)arg2;
- (bool)unc_securelyCopyFile:(id)arg1 fromURL:(id)arg2 toURL:(id)arg3 error:(id*)arg4;
...
- (void)rc_cleanUpAssetsInDirectory:(id)arg1;
