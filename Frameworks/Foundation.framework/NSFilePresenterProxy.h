...
- (void)observeMoveByWriterWithPurposeID:(id)arg1 withPhysicalDestinationURL:(id)arg2 withFSID:(struct fsid { int x1[2]; })arg3 andFileID:(unsigned long long)arg4;
- (void)observeMoveOfSubitemAtURL:(id)arg1 toURL:(id)arg2 byWriterWithPurposeID:(id)arg3 withFSID:(struct fsid { int x1[2]; })arg4 andFileID:(unsigned long long)arg5;
