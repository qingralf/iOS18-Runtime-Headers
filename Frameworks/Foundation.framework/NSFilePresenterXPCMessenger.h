...
- (void)_makePresenter:(id)arg1 accommodateEvictionWithSubitemURL:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (oneway void)observeMoveToURL:(id)arg1 withSubitemURL:(id)arg2 byWriterWithPurposeID:(id)arg3 withFSID:(struct fsid { int x1[2]; })arg4 andFileID:(unsigned long long)arg5;
