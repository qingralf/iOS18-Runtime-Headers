...
- (void)invalidate;
- (void)movingItemAtURL:(id)arg1 requiresProvidingWithDestinationDirectoryURL:(id)arg2 newFileName:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (id /* block */)provideItemForKernelRequestWithInfo:(id)arg1 atURL:(id)arg2 forProcess:(struct { unsigned int x1[8]; })arg3 withOptions:(unsigned long long)arg4 completionHandler:(id /* block */)arg5;
