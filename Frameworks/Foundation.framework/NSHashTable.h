...
@property (nonatomic, readonly) bool safari_isEmpty;
...
- (void)_gkSafeAddObject:(id)arg1;
- (id)_gkSafeCopy;
- (void)_gkSafeRemoveObject:(id)arg1;
...
- (bool)tsp_saveDataReferencesToMessage:(void*)arg1 dataArchiver:(id)arg2;
