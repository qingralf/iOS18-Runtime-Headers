...
@property (nonatomic, readonly) NSString *itk_indexString;
@property (nonatomic, readonly) NSArray *itk_rangeArray;
...
@property (nonatomic, readonly) NSString *vk_indexString;
...
- (void)_addUIDsFromRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 toArray:(id)arg2;
- (id)_uidQueryExpressionForRanges:(id)arg1 andSingleUIDs:(id)arg2 withTableName:(id)arg3;
- (id)_uidRangesAndSingleUIDs:(id)arg1;
...
+ (id)itk_indexSetWithNSNumberIndex:(id)arg1;
...
- (void)tsu_enumeratePowerSetIncludingEmptySet:(bool)arg1 usingBlock:(id /* block */)arg2;
