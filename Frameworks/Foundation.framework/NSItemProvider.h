...
- (id)_objectOfClass:(Class)arg1 data:(id)arg2 typeIdentifier:(id)arg3 error:(id*)arg4;
- (id)_preferredRepresentationByType;
- (id)_readableTypeIdentifiersForItemProviderForClass:(Class)arg1;
...
+ (void)safari_loadObjectsFromItemProviders:(id)arg1 usingLoader:(int (*)arg2 completionHandler:(id /* block */)arg3;

- (void)safari_loadObjectOfClasses:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)safari_registerLinkMetadata:(id)arg1;
...
- (id)registerFileRepresentation:(id)arg1;
...
- (void)sf_loadSecurityContextWithCompletionHandler:(id /* block */)arg1;
...
- (void)sfui_loadAttributedStringForTypeIdentifier:(id)arg1 completionHandler:(id /* block */)arg2;
...
+ (id)_uikit_bestMatchConformingToTypes:(id)arg1 availableTypes:(id)arg2;
...
- (bool)isDerivedRepresentationForTypeIdentifier:(id)arg1;
...
- (void)setDerivedRepresentation:(bool)arg1 forTypeIdentifier:(id)arg2;
