...
- (bool)_validateAllowedClassesContainsClassOfReference:(id)arg1 forKey:(id)arg2;
...
+ (id)swiftui_unarchiveTopLevelLNActionWithData:(id)arg1 error:(id*)arg2;
...
- (bool)_cplDecodeBoolForKey:(id)arg1;
- (BOOL)_cplDecodeCharForKey:(id)arg1;
...
+ (id)pf_unarchivedObjectOfClass:(Class)arg1 fromData:(id)arg2 classReplacementMap:(id)arg3 error:(out id*)arg4;
+ (id)pf_unarchivedObjectOfClasses:(id)arg1 fromData:(id)arg2 classReplacementMap:(id)arg3 error:(out id*)arg4;
