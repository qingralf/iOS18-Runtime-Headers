...
@interface NSMapTable : NSObject <HVHeaderCollection, MPCSupportedCommands, NSCopying, NSFastEnumeration, NSSecureCoding>
...
+ (id)bw_strongVideoRequirementToMapTableWithValueFunctions:(id)arg1;
...
- (void)vfx_enumerateKeysAndValuesUsingBlock:(id /* block */)arg1;
