...
- (bool)addConstraintsTo:(struct MDInflectableStringConcept { }*)arg1;
- (void)applyPluralityRulesForNumbers:(id)arg1 inLanguages:(id)arg2;
...
- (id)initWithMorphunAttributeValues:(id)arg1;
...
- (void)set_adjectival:(long long)arg1;
- (void)set_clusivity:(long long)arg1;
