...
- (void)_inflectWithLocale:(id)arg1 replacements:(id)arg2 concepts:(id)arg3 preflight:(bool)arg4;
...
- (void)endEditing;
- (void)enumerateFormattableBlocksInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 usingBlock:(id /* block */)arg2;
...
- (id)_expandedDateFilter:(id)arg1;
- (void)_tagRangeWithFilters:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 key:(id)arg2 filters:(id)arg3 filterOp:(int)arg4;
- (void)tagRangeWithFilter:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 withCSAttributedEntityKey:(id)arg2;
- (void)tagRangeWithFilter:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 withCSAttributedEntityKey:(id)arg2 dateISOValues:(id)arg3;
- (void)tagRangeWithFilter:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 withCSAttributedEntityKey:(id)arg2 dateISOValues:(id)arg3 filterOperator:(int)arg4;
- (void)tagRangeWithFilter:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 withCSAttributedEntityKey:(id)arg2 numberValues:(id)arg3;
- (void)tagRangeWithFilter:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 withCSAttributedEntityKey:(id)arg2 numberValues:(id)arg3 filterOperator:(int)arg4;
- (void)tagRangeWithFilter:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 withCSAttributedEntityKey:(id)arg2 startDate:(id)arg3 endDate:(id)arg4;
- (void)tagRangeWithFilter:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 withCSAttributedEntityKey:(id)arg2 startDateComponents:(id)arg3 endDateComponents:(id)arg4;
- (void)tagRangeWithFilter:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 withCSAttributedEntityKey:(id)arg2 startDates:(id)arg3 endDates:(id)arg4 filterOperator:(int)arg5;
- (void)tagRangeWithFilter:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 withCSAttributedEntityKey:(id)arg2 stringValues:(id)arg3;
- (void)tagRangeWithFilter:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 withCSAttributedEntityKey:(id)arg2 stringValues:(id)arg3 filterOperator:(int)arg4;
- (void)tagRangeWithSceneFilter:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 withCSSceneType:(long long)arg2 sceneID:(id)arg3;
- (void)tagRangeWithSceneFilters:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 withCSSceneTypes:(id)arg2 sceneIDs:(id)arg3;
- (id)tokenizeAndAddFilter:(id)arg1 filterKey:(id)arg2;
...
- (void)__ck_filterAttributes:(id /* block */)arg1;
- (void)__ck_removeAllAttributesExcept:(id)arg1;
- (void)__ck_removeOccurencesOfString:(id)arg1;
- (id)_ck_intersectingTextAnimationOnRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 getExistingAnimationRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; }*)arg2;
- (void)ck_addAttribute:(id)arg1 from:(id)arg2 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg3;
- (void)ck_addDisplayableAttributeForIMTextEffectAttribute;
- (void)ck_addDisplayableAttributesForIMTextStyleAttributes;
- (void)ck_addTextStyle:(unsigned long long)arg1 options:(unsigned long long)arg2 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg3;
- (void)ck_adjustFontsForBigEmojisIfNeededWithSingleBigEmojiSupported:(bool)arg1 mediaObjects:(id)arg2;
- (void)ck_applyTextEffectType:(long long)arg1 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2;
- (void)ck_applyTextStyle:(unsigned long long)arg1 options:(unsigned long long)arg2 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg3;
- (void)ck_applyTextStyle:(unsigned long long)arg1 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2;
- (bool)ck_canApplyTextEffectInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
- (bool)ck_canToggleTextEffectInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
- (void)ck_convertAttributesUsingConversionHandler:(id /* block */)arg1 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2;
- (void)ck_removeAnimatedTextEffectsFromRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
- (void)ck_removeAttributesNotIn:(id)arg1;
- (void)ck_removeTextStyle:(unsigned long long)arg1 options:(unsigned long long)arg2 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg3;
- (void)ck_removeTextStyles:(unsigned long long)arg1 options:(unsigned long long)arg2 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg3;
- (void)ck_repairTextEffects;
- (void)ck_replaceBIUSWithIMTextStyles;
- (void)ck_replaceTextAnimationsWithIMTextEffects;
- (void)ck_toggleTextEffectNamed:(id)arg1 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 getAdded:(bool*)arg3;
- (void)ck_toggleTextEffectType:(long long)arg1 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 getAdded:(bool*)arg3;
...
- (id)addRippleAnimationForRange_emk:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
- (void)removeRippleAnimation:(id)arg1 includingFilterEffect_emk:(bool)arg2;
...
+ (id)hk_initWithString:(id)arg1 font:(id)arg2 hyphenationFactor:(float)arg3;
...
- (void)__im_insertAdaptiveImageGlyphsForFileTransfersUsingFileTransferProvider:(id /* block */)arg1 adaptiveImageGlyphProvider:(id /* block */)arg2 isCommSafetySensitiveProvider:(id /* block */)arg3;
- (void)__im_insertAdaptiveImageGlyphsForFileTransfersUsingIsAdaptiveImageGlyphProvider:(id /* block */)arg1 isCommSafetySensitiveProvider:(id /* block */)arg2 adaptiveImageGlyphProvider:(id /* block */)arg3;
- (void)__im_removeAllAttributesExcept:(id)arg1;

// Image: /System/Library/PrivateFrameworks/InputToolKit.framework/InputToolKit

- (void)itk_appendAttributedSubstring:(id)arg1 fromRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2;
- (void)itk_appendString:(id)arg1;
- (void)itk_replaceCharactersInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 withAttributedSubstring:(id)arg2 fromRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg3;
...
- (void)adjustCapsAndSpacingUsingLeadingText:(id)arg1 localeIdentifier:(id)arg2 vocabularyEntries:(id)arg3 spellingGuessesBlock:(id /* block */)arg4;
