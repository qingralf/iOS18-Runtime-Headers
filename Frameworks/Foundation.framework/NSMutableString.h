...
- (void)appendPrettyHex:(long long)arg1 withName:(id)arg2 andIndent:(int)arg3 options:(unsigned long long)arg4;
...
- (void)rightPaddToLength:(unsigned int)arg1;
...
- (void)_trimTrailingCharactersInSet:(id)arg1 ignoringCharactersInSet:(id)arg2;
...
- (void)ef_trimTrailingCharactersInSetIgnoringNewline:(id)arg1;
...
- (void)_hk_trimCharactersInSet:(id)arg1;
- (void)_hk_trimString:(id)arg1;
- (void)_hk_trimStrings:(id)arg1;
