...
+ (unsigned char)asdtDataSizeForNumericType:(int)arg1;
+ (id)asdtNumberFromData:(const void*)arg1 withNumericType:(int)arg2;

- (bool)asdtNumberToData:(void*)arg1 withNumericType:(int)arg2 andSize:(unsigned long long)arg3;

// Image: /System/Library/PrivateFrameworks/AuthKit.framework/AuthKit

- (id)ak_booleanAsInteger;
- (long long)ak_bucketWithSize:(long long)arg1;
- (bool)ak_isBoolean;

// Image: /System/Library/PrivateFrameworks/AvatarKit.framework/AvatarKit

+ (id)avt_numberWithFloat:(float)arg1 roundingBehavior:(id)arg2;

- (id)avt_numberByRoundingWithBehavior:(id)arg1;
...
- (bool)br_isEqualToNumber:(id)arg1;
...
+ (long long)_gkConvertInt64ClampingValue:(long long)arg1;
+ (unsigned long long)_gkConvertUInt64ClampingValue:(unsigned long long)arg1;
...
- (id)bucket;
- (id)roundToSignificantDigit:(long long)arg1;
