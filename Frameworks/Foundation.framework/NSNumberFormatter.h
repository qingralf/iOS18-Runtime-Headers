...
@property (nonatomic, readonly) bool shouldIgnoreChanges;
...
- (long long)minimumGroupingDigits;
...
- (void)setMinimumGroupingDigits:(long long)arg1;
...
- (id)formatString:(id)arg1 byAppendingExponent:(int)arg2;
- (id)formatString:(id)arg1 usesGroupingSeparator:(bool)arg2;
- (id)formatString:(id)arg1 usesGroupingSeparator:(bool)arg2 groupingSeparator:(id)arg3 decimalSeparator:(id)arg4 maximumIntegerDigits:(long long)arg5 maximumFractionDigits:(long long)arg6 localizeDigits:(bool)arg7;
- (void)ignoreChanges:(id /* block */)arg1;
...
+ (id)stringFromFileSize:(struct IMFileSize { unsigned long long x1; unsigned long long x2; })arg1;
