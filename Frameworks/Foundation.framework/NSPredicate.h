...
@property (nonatomic, readonly) bool ed_hasOnlySpotlightKeypaths;
...
- (bool)ed_hasOnlySpotlightKeypaths;
- (id)ed_searchableIndexQueryStringForQueryWithSuggestion:(bool)arg1 originalSearchString:(id*)arg2;
- (id)ed_transformSearchableIndexPredicateWithSuggestion:(id)arg1 searchableIndexManager:(id)arg2;
...
+ (id)__im_chatPredicateForFilterAction:(long long)arg1;
+ (id)__im_chatPredicateForServiceNames:(id)arg1;
+ (id)__im_chatPredicateForSyncState:(long long)arg1;
