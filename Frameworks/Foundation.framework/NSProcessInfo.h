...
@property (nonatomic, readonly) bool safari_isPasswordManagerTestMode;
...
- (bool)hasPerformanceProfile:(long long)arg1;
- (bool)isDeviceCertifiedFor:(long long)arg1;

// Image: /System/Library/PrivateFrameworks/AACCore.framework/AACCore

- (bool)ae_hasEntitlement:(id)arg1 withValue:(id)arg2;
...
- (bool)safari_isPasswordManagerTestMode;
...
+ (void)injectProcessInfo:(id)arg1;
