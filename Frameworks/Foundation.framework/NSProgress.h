...
@property (setter=ls_setExpectedFinalInstallPhase:, nonatomic) unsigned long long ls_expectedFinalInstallPhase;
...
- (void)ls_setExpectedFinalInstallPhase:(unsigned long long)arg1;
...
- (bool)fp_isAccountedAsCopyProgress;
- (bool)fp_isGlobalProgressForDomainAt:(id)arg1;
...
- (void)_geo_configureFromPairedDeviceProgress:(id)arg1;
