...
+ (id)itk_regexForSearchStrings:(id)arg1;
...
- (id)ic_attributedStringByReplacingMatchesInAttributedString:(id)arg1 options:(unsigned long long)arg2 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg3 withTemplate:(id)arg4;
