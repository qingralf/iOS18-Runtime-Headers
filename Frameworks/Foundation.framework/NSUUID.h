...
@property (readonly, copy) FSContainerIdentifier *containerIdentifier;
@property (nonatomic, readonly) NSData *data;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (readonly, copy) NSString *description;
@property (readonly, copy) FSContainerIdentifier *fs_containerIdentifier;
@property (readonly, copy) FSEntityIdentifier *fs_entityIdentifier;
@property (readonly, copy) FSVolumeIdentifier *fs_volumeIdentifier;
...
- (id)fp_UUID;
- (id)fp_UUIDWithObfuscation:(bool)arg1;
...
+ (id)ar_NSUUIDSetWithCFArrayRef:(struct __CFArray { }*)arg1;
+ (id)ar_NSUUIDsWithCFArrayRef:(struct __CFArray { }*)arg1;
...
+ (id)_geo_uuidForHighBytes:(unsigned long long)arg1 lowBytes:(unsigned long long)arg2;
+ (id)_geo_uuidForWaypointUUID:(id)arg1;
+ (id)_geo_waypointUUIDForData:(id)arg1;
+ (id)_maps_UUIDWithData:(id)arg1;

- (id)_geo_data;
- (void)_geo_getHighBytes:(unsigned long long*)arg1 lowBytes:(unsigned long long*)arg2;
...
+ (id)hmf_UUIDWithNamespace:(id)arg1 data:(id)arg2 salts:(id)arg3;
+ (id)hmf_zeroUUID;
+ (id)shortDescription;
+ (id)zeroUUID;
...
+ (id)pf_UUIDFromArbitraryString:(id)arg1;
+ (id)pf_defaultInstanceIdentifier;
+ (id)pf_invalidInstanceIdentifier;
+ (id)pf_nonnullUUIDStringOrSentinel:(id)arg1;
...
- (id)sem_base64EncodedStringNoPadding;
- (id)sem_data;
- (id)sem_initWithBase64EncodedString:(id)arg1;
...
+ (id)ses_withData:(id)arg1;
+ (id)ses_withUUIDString:(id)arg1;
