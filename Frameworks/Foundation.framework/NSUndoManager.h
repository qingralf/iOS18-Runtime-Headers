...
@property (nonatomic, readonly) bool itk_isUndoingOrRedoing;
...
- (id)redoActionName;
- (id)redoActionUserInfoValueForKey:(id)arg1;
...
- (void)setActionUserInfoValue:(id)arg1 forKey:(id)arg2;
...
- (id)undoActionName;
- (id)undoActionUserInfoValueForKey:(id)arg1;
...
- (bool)itk_isUndoingOrRedoing;
- (void)itk_performUndoGroup:(id /* block */)arg1;
- (void)itk_performUndoGroupWithActionName:(id)arg1 undoGroup:(id /* block */)arg2;
