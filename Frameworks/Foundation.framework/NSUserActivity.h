...
@property (nonatomic, retain) NSNumber *storeTrackID;
...
- (id)_initWithUserActivityData:(id)arg1 options:(id)arg2;
- (id)_initWithUserActivityStrings:(id)arg1 secondaryString:(id)arg2 optionalData:(id)arg3;
- (id)_initWithUserActivityStrings:(id)arg1 secondaryString:(id)arg2 optionalData:(id)arg3 options:(id)arg4;
