...
@interface NSValue : NSObject <BSXPCSecureCoding, MTFilterIdentityValueProviding, MTMaterialSettingsPropertyIdentityValueProviding, NSCopying, NSSecureCoding, OZSCNValueJSExport, REDonatedActionIdentifierProviding, TSDMixing, _HKPropertyAnimationProviding>
...
@property (nonatomic, readonly) struct GCPoint2 { float x1; float x2; } GCPoint2Value;
...
@property (readonly) struct _DAVersionUpgrade { unsigned long long x1; bool x2; unsigned long long x3; unsigned long long x4; } availableVersionUpgradeValue;
...
@property (readonly) struct { double x1; double x2; } deltaScalarsValue;
...
@property (readonly) struct NSEdgeInsets { double x1; double x2; double x3; double x4; } edgeInsetsValue;
...
@property (readonly) struct CGPoint { double x1; double x2; } nu_CGPoint;
@property (readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } nu_CGRect;
@property (readonly) struct { long long x1; long long x2; } nu_pixelPoint;
...
@property (readonly) struct CGPoint { double x1; double x2; } pointValue;
...
+ (id)valueWithGCPoint2:(struct GCPoint2 { float x1; float x2; })arg1;

- (struct GCPoint2 { float x1; float x2; })GCPoint2Value;
...
+ (id)ch_valueWithCGPoint:(struct CGPoint { double x1; double x2; })arg1;
+ (id)ch_valueWithCGRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;

- (struct CGPoint { double x1; double x2; })ch_CGPointValue;
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })ch_CGRectValue;
- (bool)ch_getValue:(out void*)arg1 ofSize:(unsigned long long)arg2;
...
+ (id)valueWithDAAvailableVersionUpgrade:(struct _DAVersionUpgrade { unsigned long long x1; bool x2; unsigned long long x3; unsigned long long x4; })arg1;

- (struct _DAVersionUpgrade { unsigned long long x1; bool x2; unsigned long long x3; unsigned long long x4; })availableVersionUpgradeValue;
...
+ (id)itk_valueWithPoint:(struct CGPoint { double x1; double x2; })arg1;
+ (id)itk_valueWithRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
+ (id)itk_valueWithSize:(struct CGSize { double x1; double x2; })arg1;

- (struct CGPoint { double x1; double x2; })itk_pointValue;
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })itk_rectValue;
...
+ (id)nu_valueWithCGPoint:(struct CGPoint { double x1; double x2; })arg1;
+ (id)nu_valueWithCGRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
+ (id)nu_valueWithPixelPoint:(struct { long long x1; long long x2; })arg1;
...
- (struct CGPoint { double x1; double x2; })nu_CGPoint;
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })nu_CGRect;
- (struct { long long x1; long long x2; })nu_pixelPoint;
...
+ (id)nf_valueWithCGPoint:(struct CGPoint { double x1; double x2; })arg1;
...
- (struct CGPoint { double x1; double x2; })nf_CGPointValue;
...
+ (id)sbh_valueWithSBHIconGridSize:(struct SBHIconGridSize { unsigned short x1; unsigned short x2; })arg1;
+ (id)sbh_valueWithSBIconCoordinate:(struct SBIconCoordinate { long long x1; long long x2; })arg1;
+ (id)sbh_valueWithSBIconImageInfo:(struct SBIconImageInfo { struct CGSize { double x_1_1_1; double x_1_1_2; } x1; double x2; double x3; })arg1;

- (struct SBHIconGridSize { unsigned short x1; unsigned short x2; })sbh_SBHIconGridSizeValue;
- (struct SBIconCoordinate { long long x1; long long x2; })sbh_SBIconCoordinateValue;
- (struct SBIconImageInfo { struct CGSize { double x_1_1_1; double x_1_1_2; } x1; double x2; double x3; })sbh_SBIconImageInfoValue;
...
+ (id)UIF_valueWithLineBreakContext:(struct { unsigned long long x1; unsigned long long x2; bool x3; })arg1;

- (struct { unsigned long long x1; unsigned long long x2; bool x3; })UIF_lineBreakContextValue;
...
+ (id)valueWithUISize3D:(struct { double x1; double x2; double x3; })arg1;
...
- (struct { double x1; double x2; double x3; })UISize3DValue;
...
+ (id)VFX_valueWithCGPoint:(struct CGPoint { double x1; double x2; })arg1;
+ (id)valueWithMatrix4:(id)arg1;
+ (id)valueWithVFXFloat2;
+ (id)valueWithVFXFloat3;
+ (id)valueWithVFXFloat4;
+ (id)valueWithVFXMatrix4:(struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; })arg1;
+ (id)valueWithVector3:(id)arg1;
+ (id)valueWithVector4:(id)arg1;

- (void)VFXFloat2Value;
- (void)VFXFloat3Value;
- (void)VFXFloat4Value;
- (struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; })VFXMatrix4Value;
- (struct CGPoint { double x1; double x2; })VFX_CGPointValue;
- (id)VFX_Description;
- (int)VFX_numberOfChannels;
- (id)VFX_valueForKey:(id)arg1;
- (id)matrix4;
- (id)vector3;
- (id)vector4;
...
+ (id)valueWithPlatformCGPoint:(struct CGPoint { double x1; double x2; })arg1;
+ (id)valueWithPlatformCGRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;

- (struct CGPoint { double x1; double x2; })platformCGPointValue;
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })platformCGRectValue;
