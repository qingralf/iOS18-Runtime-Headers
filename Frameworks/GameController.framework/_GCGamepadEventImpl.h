...
- (void)setButtonBackLeftPrimary:(float)arg1;
- (void)setButtonBackLeftSecondary:(float)arg1;
- (void)setButtonBackRightPrimary:(float)arg1;
- (void)setButtonBackRightSecondary:(float)arg1;
- (void)setButtonHome:(float)arg1;
- (void)setButtonLeftBumper:(float)arg1;
- (void)setButtonLeftShoulder:(float)arg1;
- (void)setButtonMenu:(float)arg1;
- (void)setButtonOptions:(float)arg1;
- (void)setButtonRightBumper:(float)arg1;
