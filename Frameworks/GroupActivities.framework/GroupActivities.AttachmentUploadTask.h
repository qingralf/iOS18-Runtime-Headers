...
@interface GroupActivities.AttachmentUploadTask : _TtCs12_SwiftObject {
    union { in /* Warning: Unrecognized filer type: 'u' using 'void*' */ void*x1; long x2; long x3; }  _state;
    void assetManager;
    void developerMetadata;
    ...
    union { in /* Warning: Unrecognized filer type: 'u' using 'void*' */ void*x1; long x2; long x3; }  protector;
    void signalHandler;
    void stateMachine;
    void topic;
    void topicUploadTask;
}
