...
+ (id)_createTestsFromLeftEarSensitivity:(id)arg1 rightEarSensitivity:(id)arg2 leftEarClampingRange:(id)arg3 rightEarClampingRange:(id)arg4 error:(id*)arg5;
+ (id)_incompatibleUnit:(id)arg1 incompatibleWith:(id)arg2;
+ (id)_rangeViolationMin:(id)arg1 max:(id)arg2 value:(id)arg3;
+ (bool)_validateAirConductionTests:(id)arg1 error:(id*)arg2;
...
+ (id)sensitivityPointWithFrequency:(id)arg1 tests:(id)arg2 error:(id*)arg3;
...
- (id)initWithFrequency:(id)arg1 tests:(id)arg2;
