...
+ (id)hkmc_categorySampleWithBleedingFlow:(long long)arg1 forBleedingType:(long long)arg2 date:(id)arg3 startOfCycle:(bool)arg4;
...
+ (id)hkmc_pregnancyCategorySampleWithStartDate:(id)arg1 startTimeZoneID:(id)arg2 endDate:(id)arg3 startDateSource:(long long)arg4 embryoAgeInDays:(id)arg5 detailsRecordedOnDate:(id)arg6;
