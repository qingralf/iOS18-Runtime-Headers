...
@property (nonatomic, copy) HKDataCollectorState *state;
...
- (void)_queue_batchDatums:(id)arg1 device:(id)arg2 metadata:(id)arg3 options:(unsigned long long)arg4 completion:(id /* block */)arg5;
...
- (void)_queue_sendState:(id)arg1;
- (void)_queue_taskServer_insertBatch:(id)arg1 completion:(id /* block */)arg2;
...
- (void)insertDatums:(id)arg1 device:(id)arg2 metadata:(id)arg3 options:(unsigned long long)arg4 completion:(id /* block */)arg5;
- (id)quantityType;
- (id)remoteInterface;
...
- (void)unitTest_preSetStateHandler:(id /* block */)arg1;
