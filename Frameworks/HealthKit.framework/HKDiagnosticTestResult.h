...
- (void)_displayItemsForCodedValueCollection:(id)arg1 healthRecordsStore:(id)arg2 preferredStyle:(long long)arg3 signedClinicalDataRecord:(id)arg4 completion:(id /* block */)arg5;
- (void)_displayItemsForValuePreferedStyle:(long long)arg1 healthRecordsStore:(id)arg2 signedClinicalDataRecord:(id)arg3 completion:(id /* block */)arg4;
- (id)chartableCodedQuantitySet;
- (id)codings;
