...
@interface HKFeatureAvailabilityRequirementActiveWatchIsNotUnderInternalDevelopmentImportExclusion : HKFeatureAvailabilityBaseRequirement <HKObservableFeatureAvailabilityRequirement> {
