...
@interface HKHealthServicesManager : NSObject <HKHealthServicesManagerClientInterface, _HKXPCExportable> {
...
- (void)_fetchHealthServicesServerProxyWithHandler:(id /* block */)arg1 errorHandler:(id /* block */)arg2;
- (void)_fetchSupportedServiceIDsWithCompletion:(id /* block */)arg1;
- (void)_getCBPeripheralforIdentifer:(id)arg1 withCompletion:(id /* block */)arg2;
- (void)_getHealthPeripheralsStatus:(id)arg1 withCompletion:(id /* block */)arg2;
- (void)_setHealthPeripheralsStatus:(id)arg1 status:(bool)arg2 withCompletion:(id /* block */)arg3;
