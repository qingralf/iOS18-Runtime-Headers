...
+ (id)predicateForStatesOfMindWithAssociation:(long long)arg1;
+ (id)predicateForStatesOfMindWithAssociations:(id)arg1;
+ (id)predicateForStatesOfMindWithKind:(long long)arg1;
+ (id)predicateForStatesOfMindWithLabel:(long long)arg1;
+ (id)predicateForStatesOfMindWithLabels:(id)arg1;
+ (id)predicateForStatesOfMindWithValence:(double)arg1 operatorType:(unsigned long long)arg2;
...
+ (id)predicateForWorkoutEffortSamplesRelatedToWorkout:(id)arg1 activity:(id)arg2;
