...
@interface HKWorkout : HKSample <HDCoding, HKAssociatableObject> {
    double  _duration;
    HKQuantity * _goal;
...
- (id)_validateWorkoutActivities:(id)arg1 withConfiguration:(struct HKObjectValidationConfiguration { unsigned long long x1; unsigned long long x2; })arg2;
- (id)_validateWorkoutEvents:(id)arg1 withConfiguration:(struct HKObjectValidationConfiguration { unsigned long long x1; unsigned long long x2; })arg2;
- (id)_zonesByType;
- (bool)acceptsAssociationWithObject:(id)arg1;
- (id)allStatistics;
- (id)description;
- (double)duration;
...
- (bool)supportsMetric:(unsigned long long)arg1;
