...
@interface _HKBehavior : NSObject {
    ...
    NSString * _currentDeviceProductType;
    NSString * _currentDeviceSerialNumber;
    ...
    }  _supportsPeriodicLiteCloudSync;
...
@property (nonatomic, copy) NSString *currentDeviceProductType;
...
@property (nonatomic, copy) NSString *currentDeviceSerialNumber;
...
@property (nonatomic, readonly) bool processHasLoadedUIKit;
...
- (void)setCurrentDeviceProductType:(id)arg1;
- (void)setCurrentDeviceSerialNumber:(id)arg1;
...
- (void)setHealthAppSupportedOnDevice:(bool)arg1;
...
- (void)setIsIOSDevice:(bool)arg1;
- (void)setIsProdFused:(bool)arg1;
...
- (void)setShouldOverrideSiriUOD:(bool)arg1;
...
- (void)setSupportsMedicalIDSync:(bool)arg1;
...
- (void)setSupportsPeriodicLiteCloudSync:(bool)arg1;
...
- (bool)hkui_isRunningInApp;
- (bool)hkui_isRunningInHealthApp;
- (bool)hkui_isRunningInPreferencesApp;
