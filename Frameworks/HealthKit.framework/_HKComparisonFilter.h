...
+ (id)_filterForKeyPath:(id)arg1 operatorType:(unsigned long long)arg2 value:(id)arg3 dataTypes:(id)arg4 applicationSDKVersionToken:(unsigned long long)arg5 isSubpredicate:(bool)arg6;
...
- (void).cxx_destruct;
- (id)_initWithKeyPath:(id)arg1 operatorType:(unsigned long long)arg2 value:(id)arg3 dataTypes:(id)arg4 applicationSDKVersionToken:(unsigned long long)arg5;
