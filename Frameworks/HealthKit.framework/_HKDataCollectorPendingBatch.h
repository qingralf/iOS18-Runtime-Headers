...
- (id)device;
- (id)init;
- (id)initWithIdentifier:(id)arg1 data:(id)arg2 metadata:(id)arg3 device:(id)arg4 options:(unsigned long long)arg5 completion:(id /* block */)arg6;
- (id)initWithIdentifier:(id)arg1 data:(id)arg2 metadata:(id)arg3 device:(id)arg4 options:(unsigned long long)arg5 completions:(id)arg6;
- (bool)isTransient;
- (id)metadata;
