...
@interface _HKMedicalIDData : NSObject <NSCopying, NSSecureCoding> {
    NSArray * _allergiesList;
    NSDate * _allergiesListModifiedDate;
    NSNumber * _allergiesListVersion;
    NSDate * _allergiesListVersionModifiedDate;
    ...
    NSArray * _conditionsList;
    NSDate * _conditionsListModifiedDate;
    NSNumber * _conditionsListVersion;
    NSDate * _conditionsListVersionModifiedDate;
    ...
    NSArray * _medicationsList;
    NSDate * _medicationsListModifiedDate;
    NSNumber * _medicationsListVersion;
    NSDate * _medicationsListVersionModifiedDate;
    NSString * _name;
    NSDate * _nameModifiedDate;
    NSData * _pictureData;
    NSDate * _pictureDataModifiedDate;
    NSDate * _pregnancyEstimatedDueDate;
    NSDate * _pregnancyEstimatedDueDateModifiedDate;
    NSDate * _pregnancyStartDate;
    NSDate * _pregnancyStartDateModifiedDate;
    NSString * _pregnancyStartDateTimeZoneID;
...
@property (nonatomic, copy) NSArray *allergiesList;
@property (nonatomic, retain) NSDate *allergiesListModifiedDate;
@property (nonatomic, copy) NSNumber *allergiesListVersion;
@property (nonatomic, retain) NSDate *allergiesListVersionModifiedDate;
...
@property (nonatomic, copy) NSArray *conditionsList;
@property (nonatomic, retain) NSDate *conditionsListModifiedDate;
@property (nonatomic, copy) NSNumber *conditionsListVersion;
@property (nonatomic, retain) NSDate *conditionsListVersionModifiedDate;
...
@property (nonatomic, copy) NSArray *medicationsList;
@property (nonatomic, retain) NSDate *medicationsListModifiedDate;
@property (nonatomic, copy) NSNumber *medicationsListVersion;
@property (nonatomic, retain) NSDate *medicationsListVersionModifiedDate;
...
@property (nonatomic, copy) NSDate *pregnancyEstimatedDueDate;
@property (nonatomic, retain) NSDate *pregnancyEstimatedDueDateModifiedDate;
@property (nonatomic, copy) NSDate *pregnancyStartDate;
@property (nonatomic, retain) NSDate *pregnancyStartDateModifiedDate;
@property (nonatomic, copy) NSString *pregnancyStartDateTimeZoneID;
...
- (id)allergiesList;
- (id)allergiesListModifiedDate;
- (id)allergiesListVersion;
- (id)allergiesListVersionModifiedDate;
- (id)allergyInfo;
...
- (id)conditionsList;
- (id)conditionsListModifiedDate;
- (id)conditionsListVersion;
- (id)conditionsListVersionModifiedDate;
...
- (id)medicationsList;
- (id)medicationsListModifiedDate;
- (id)medicationsListVersion;
- (id)medicationsListVersionModifiedDate;
- (id)merge:(id)arg1;
- (id)name;
- (id)nameModifiedDate;
- (id)pictureData;
...
- (id)pregnancyEstimatedDueDateModifiedDate;
- (id)pregnancyStartDate;
- (id)pregnancyStartDateModifiedDate;
- (id)pregnancyStartDateTimeZoneID;
- (id)primaryLanguageCode;
- (id)primaryLanguageCodeModifiedDate;
- (long long)schemaVersion;
- (void)setAllergiesList:(id)arg1;
- (void)setAllergiesListModifiedDate:(id)arg1;
- (void)setAllergiesListVersion:(id)arg1;
- (void)setAllergiesListVersionModifiedDate:(id)arg1;
...
- (void)setConditionsList:(id)arg1;
- (void)setConditionsListModifiedDate:(id)arg1;
- (void)setConditionsListVersion:(id)arg1;
- (void)setConditionsListVersionModifiedDate:(id)arg1;
...
- (void)setMedicationsList:(id)arg1;
- (void)setMedicationsListModifiedDate:(id)arg1;
- (void)setMedicationsListVersion:(id)arg1;
- (void)setMedicationsListVersionModifiedDate:(id)arg1;
...
- (void)setPregnancyEstimatedDueDate:(id)arg1;
- (void)setPregnancyEstimatedDueDateModifiedDate:(id)arg1;
- (void)setPregnancyStartDate:(id)arg1;
- (void)setPregnancyStartDateModifiedDate:(id)arg1;
- (void)setPregnancyStartDateTimeZoneID:(id)arg1;
