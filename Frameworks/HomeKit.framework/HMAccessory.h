...
@property (nonatomic, readonly) NSNumber *an_announceSettingFromAccessorySettings;
@property (nonatomic, readonly) bool an_isAnnounceEnabled;
@property (nonatomic, readonly) bool an_isAppleAnnounceAccessory;
@property (nonatomic, readonly) bool an_isAppleAnnounceHostAccessory;
@property (nonatomic, readonly) bool an_supportsAnnounce;
...
@property (nonatomic, readonly) id hdm_matterDevice;
@property (nonatomic, readonly, copy) NSNumber *hdm_matterNodeID;
...
@property (nonatomic, readonly) bool hf_fakeCDPSymptom;
...
@property (nonatomic, readonly) bool hf_isHomeMediaAccessory;
...
@property (nonatomic, readonly) bool mfiCertifiedACWG;
...
@property (nonatomic, copy) NSData *readerGroupSubIdentifierACWG;
@property (nonatomic, readonly, copy) NSData *readerIDACWG;
@property (nonatomic, copy) NSData *readerIDACWG;
...
@property (nonatomic, copy) NSNumber *weekDaySchedulesPerUserCapacity;
...
@property (nonatomic, copy) NSNumber *yearDaySchedulesPerUserCapacity;

// Image: /System/Library/Frameworks/HomeKit.framework/HomeKit

+ (id)_cameraProfilesForAccessoryProfiles:(id)arg1;
+ (id)_doorbellProfilesForAccessoryProfiles:(id)arg1;
...
+ (id)logCategory;
+ (unsigned long long)networkRouterStatusFromRouterStatus:(long long)arg1 wanStatusListData:(id)arg2;
+ (unsigned long long)networkRouterStatusFromWiFiSatelliteStatus:(long long)arg1;
+ (id)shortDescription;
+ (bool)supportsSecureCoding;
+ (id)televisionProfilesForAccessoryServices:(id)arg1 isSPIEntitled:(bool)arg2;
...
- (void)_handleRequiresThreadRouterUpdateMessage:(id)arg1;
...
- (void)_handleSupportsCompanionInitiatedObliterateUpdatedMessage:(id)arg1;
...
- (void)_invokeDidUpdateSupportsUWBUnlockDelegate:(bool)arg1;
- (void)_invokeDidUpdateSupportsWalletKeyDelegate:(bool)arg1;
- (void)_listPairingsWithCompletionHandler:(id /* block */)arg1;
- (bool)_mergeBulletinBoardNotificationByEndpoint:(id)arg1;
...
- (bool)_updateHasSymptomsHandler:(bool)arg1;
...
- (void)_writeValue:(id)arg1 forCharacteristic:(id)arg2 service:(id)arg3 completionHandler:(id /* block */)arg4;
- (id)accessoryFlags;
...
- (id)bulletinBoardNotificationForEndpoint:(id)arg1;
- (id)bundleID;
...
- (void)clearMatterCredentialWithType:(long long)arg1 forUserIndex:(long long)arg2 completion:(id /* block */)arg3;
- (void)clearMatterUserWithIndex:(long long)arg1 completion:(id /* block */)arg2;
...
- (id)deviceIRKData;
- (id)deviceIdentifier;
- (id)doorbellChimeProfile;
- (void)dumpMatterUsersWithCompletion:(id /* block */)arg1;
...
- (id)firmwareVersion;
- (void)getAccessoryDiagnosticCountersWithCompletion:(id /* block */)arg1;
- (void)getAccessoryDiagnosticEventsWithCompletion:(id /* block */)arg1;
...
- (void)installManagedConfigurationProfileWithData:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)setReaderGroupSubIdentifierACWG:(id)arg1;
- (void)setReaderIDACWG:(id)arg1;
...
- (void)setSupportsUWBUnlock:(bool)arg1;
...
- (void)setWeekDaySchedulesPerUserCapacity:(id)arg1;
- (void)setWifiNetworkInfo:(id)arg1;
- (void)setYearDaySchedulesPerUserCapacity:(id)arg1;
- (id)settings;
- (id)settingsAdapter;
- (id)shortDescription;
...
- (id)wifiNetworkInfo;
- (id)yearDaySchedulesPerUserCapacity;
...
+ (id)hf_minimumDescriptionsOfAccessories:(id)arg1;
+ (id /* block */)hf_softwareUpdateComparator;
+ (id)hf_userFriendlyLocalizedCapitalizedDescription:(id)arg1;
+ (id)hf_userFriendlyLocalizedCapitalizedPluralDescription:(id)arg1;
...
- (bool)hf_isRestrictedGuestAllowedAccessory;
...
- (id)hdm_createDeviceWithController:(id)arg1;
- (id)hdm_matterDevice;
- (id)hdm_matterNodeID;
