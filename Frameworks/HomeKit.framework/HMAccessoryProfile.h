...
@interface HMAccessoryProfile : NSObject <HFAccessoryLikeObjectRootHomeKitObjectProvider, HFAccessoryLikeObjectVendor, HFAccessoryRepresentable, HFFavoritable, HFHomeContainedObject, HFHomeStatusVisible, HFIncludedContextProtocol, HFRoomContextProviding, HFShowInHomeDashboard, HFStateDumpBuildable, HMObjectMerge> {
