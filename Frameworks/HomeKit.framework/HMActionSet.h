...
@interface HMActionSet : NSObject <HFApplicationData, HFFavoritable, HFHomeContainedObject, HFIncludedContextProtocol, HFReorderableHomeKitObject, HFShowInHomeDashboard, HFStateDumpBuildable, HMActionSetConfiguration, HMFMessageReceiver, HMMutableApplicationData, HMObjectMerge, NSSecureCoding> {
...
- (void)_removeActionsForAccessory:(id)arg1;
- (void)_unconfigure;
