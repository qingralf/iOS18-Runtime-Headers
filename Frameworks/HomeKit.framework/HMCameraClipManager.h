...
+ (id)logCategory;
+ (id)zoneNameForRecordingManagementServiceUUID:(id)arg1;
...
- (void)fetchIsCloudStorageEnabledWithCompletion:(id /* block */)arg1;
...
- (id)initWithContext:(id)arg1 profileUniqueIdentifier:(id)arg2 zoneName:(id)arg3;
- (id)initWithContext:(id)arg1 profileUniqueIdentifier:(id)arg2 zoneName:(id)arg3 notificationCenter:(id)arg4;
- (id)logIdentifier;
...
- (void)setCloudStorageEnabled:(bool)arg1 completion:(id /* block */)arg2;
