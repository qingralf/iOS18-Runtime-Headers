...
- (void)_updateMaximumVideoResolutionQuality:(long long)arg1 completionHandler:(id /* block */)arg2;
- (unsigned long long)audioStreamSetting;
- (id)audioVolume;
- (void)dealloc;
- (id)init;
- (id)initWithProfileUniqueIdentifier:(id)arg1 slotIdentifier:(id)arg2 aspectRatio:(double)arg3 sessionID:(id)arg4 audioStreamSetting:(unsigned long long)arg5;
