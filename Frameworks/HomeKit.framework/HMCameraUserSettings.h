...
- (unsigned long long)accessModeForCameraHomePresence:(unsigned long long)arg1;
...
- (id)uniqueIdentifier;
- (void)updateAccessMode:(unsigned long long)arg1 forCameraHomePresence:(unsigned long long)arg2 completionHandler:(id /* block */)arg3;
