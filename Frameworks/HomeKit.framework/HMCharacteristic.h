...
@property (nonatomic, readonly, copy) NSUUID *serviceUniqueIdentifier;
...
- (void)_updateValue:(id)arg1 valueUpdatedDate:(id)arg2;
...
- (id)initWithInstanceID:(id)arg1 characteristicType:(id)arg2 service:(id)arg3 metadata:(id)arg4;
- (id)instanceID;
