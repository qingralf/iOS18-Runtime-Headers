...
@interface HMHome : NSObject <HFAccessoryLikeObjectContainer, HFApplicationData, HFCharacteristicValueReader, HFCharacteristicValueWriter, HFDemoModeAccessoryContainer, HFHomeKitObject, HFReorderableHomeKitObject, HFStateDumpBuildable, HMAudioAnalysisLastKnownEventSubscriberDataSource, HMFLogging, HMFMessageReceiver, HMMediaSystemStageManagerDataSource, HMMutableApplicationData, HMObjectMerge, HMSiriEndpointProfilesMessengerFactory, NSSecureCoding> {
    ...
    bool  _dismissedWalletKeyUWBUnlockOnboarding;
...
@property (nonatomic, retain) NSArray *cachedPredictions;
@property (nonatomic, retain) _HMContext *context;
@property (nonatomic, readonly) HMMutableArray *currentAccessories;
@property (nonatomic, retain) HMMutableArray *currentAccessoryProtectionGroups;
@property (nonatomic, readonly) HMMutableArray *currentActionSets;
...
@property (nonatomic, readonly) HMMutableArray *currentTriggers;
...
@property (nonatomic) bool dismissedWalletKeyUWBUnlockOnboarding;
...
@property (nonatomic, readonly) MTRDeviceController *hdm_sharedMatterController;
...
@property (nonatomic, copy) NSMutableDictionary *hmModernMessagingOptionsByMessageName;
@property (nonatomic, copy) NSMutableDictionary *hmModernMessagingRequestHandlersByMessageName;
...
@property (nonatomic, readonly, copy) NSNumber *matterFabricID;
@property (nonatomic, readonly) id /* block */ matterStartupParametersXPCConnectBlock;
...
- (bool)_areAllUserInviteInformationValid:(id)arg1;
...
- (void)_clearRequestHandlerForMessageName:(id)arg1;
...
- (void)_handleHMMMRequestReceivedMessage:(id)arg1;
...
- (void)_handleLocationAuthorizationUpdatedNotification:(id)arg1;
...
- (void)_removeActionSetsForAccessory:(id)arg1;
- (void)_removeEventsForAccessory:(id)arg1;
- (void)_removeIncompatibleTrigger:(id)arg1;
- (void)_removeResidentDevicesForAccessory:(id)arg1;
...
- (void)_setRequestHandler:(id /* block */)arg1 forMessageName:(id)arg2 withOptions:(id)arg3;
...
- (void)confirmResidentWithCompletion:(id /* block */)arg1;
- (id)context;
...
- (void)enableUWBUnlockWithAuthData:(id)arg1 completion:(id /* block */)arg2;
...
- (void)fetchTriggerNameForTriggerIdentifier:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)fetchWiFiInfosWithTimeout:(double)arg1 completion:(id /* block */)arg2;
...
- (id)hmModernMessagingOptionsByMessageName;
- (id)hmModernMessagingRequestHandlersByMessageName;
...
- (id)matterFabricID;
- (id /* block */)matterStartupParametersXPCConnectBlock;
...
- (void)notifyDelegatesOfExecutionForActionSet:(id)arg1 atDate:(id)arg2;
- (id)numberOfCameras;
- (id)outgoingInvitations;
- (id)owner;
- (void)performBatchCharacteristicRequest:(id)arg1;
- (void)performBatchRequest:(id)arg1;
- (void)performMediaGroupReadinessCheckForAccessory:(id)arg1 timeout:(double)arg2 setupSessionIdentifier:(id)arg3 completion:(id /* block */)arg4;
- (id)personManager;
...
- (id)rooms;
- (void)selectPreferredResident:(id)arg1 completion:(id /* block */)arg2;
- (void)selectPreferredResident:(id)arg1 requireAutoUpdate:(bool)arg2 completion:(id /* block */)arg3;
...
- (void)setAccessoryInfoFetch:(id)arg1;
...
- (void)setAutoSelectedPreferredResidents:(id)arg1;
...
- (void)setDismissedWalletKeyUWBUnlockOnboarding:(bool)arg1;
- (void)setDismissedWalletKeyUWBUnlockOnboardingWithCompletion:(id /* block */)arg1;
- (void)setEventLogDuration:(unsigned long long)arg1;
- (void)setEventLogEnabled:(bool)arg1;
- (void)setExpressSettingsAuthData:(id)arg1 enableUWB:(bool)arg2 enableNFCExpress:(bool)arg3 completion:(id /* block */)arg4;
...
- (void)setHmModernMessagingOptionsByMessageName:(id)arg1;
- (void)setHmModernMessagingRequestHandlersByMessageName:(id)arg1;
...
- (void)setNumberOfCameras:(id)arg1;
...
- (void)setPreferredPrimary:(id)arg1 oneTime:(bool)arg2 triggerElection:(bool)arg3 completionHandler:(id /* block */)arg4;
...
- (void)setUserSelectedPreferredResident:(id)arg1;
...
- (void)switchBackToREV2FromResidentSelectionWithCompletion:(id /* block */)arg1;
...
- (void)updateResidentSelectionVersion:(id)arg1 completion:(id /* block */)arg2;
...
+ (id)hf_minimumDescriptionsOfHomes:(id)arg1;
...
- (id)hf_accessoryWithMatterNodeID:(id)arg1;
...
- (bool)hf_canAddRestrictedGuest;
- (bool)hf_canEnableAudioAnalysisAfterHH2Upgrade;
- (bool)hf_canShowTvViewingInfoForUser:(id)arg1;
...
- (bool)hf_currentUserIsRestrictedGuest;
...
- (id)hf_enableUWBForWalletKeyWithAuthData:(id)arg1 enableNFCExpress:(bool)arg2;
...
- (bool)hf_hasAppleTVs;
- (bool)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;
- (bool)hf_hasAtLeastOneReachableHomeMediaAccessory;
- (bool)hf_hasAtLeastOneRestrictedGuest;
...
- (bool)hf_hasUtilitySubscription;
...
- (bool)hf_isCurrentUserInRestrictedGuestAllowedPeriod;
- (bool)hf_isEmpty;
- (bool)hf_isFaceRecognitionAvailable;
- (bool)hf_isGridForecastAvailable;
- (bool)hf_isGridForecastAvailableForNewFeaturesView;
- (bool)hf_isGridForecastEnabled;
- (bool)hf_isGridForecastVisible;
- (bool)hf_isHomeElectricitySupported;
- (bool)hf_isHomeEnergyHomeEmpty;
- (bool)hf_isHomeEnergyVisible;
- (bool)hf_isInRestrictedGuestAllowedPeriodForUser:(id)arg1;
...
- (void)hf_setIsGridForecastEnabled:(bool)arg1;
...
- (bool)hf_shouldBlockCurrentRestrictedGuestFromHome;
- (bool)hf_shouldBlockCurrentUserFromHome;
- (bool)hf_shouldBlockCurrentUserFromHomeForRoarUpgrade;
- (bool)hf_shouldHideResidentDeviceReachabilityIssues;
...
- (bool)hf_shouldShowNoAccessForRestrictedGuest:(id)arg1;
- (bool)hf_shouldShowNoAccessOutsideOfScheduleForRestrictedGuest:(id)arg1;
...
- (bool)hf_userIsRestrictedGuest:(id)arg1;
...
- (id)hf_vacuumAccessoriesAffectedByServiceTopic:(id)arg1;
...
- (void)setCachedPredictions:(id)arg1;
- (bool)userSupportsActivityLog;

// Image: /System/Library/PrivateFrameworks/HomeDataModel.framework/HomeDataModel

- (void)hdm_addEventTriggerFromBuilder:(id)arg1 completionHandler:(id /* block */)arg2;
- (id)hdm_createMatterController;
- (id)hdm_newEventTriggerBuilderWithName:(id)arg1 events:(id)arg2;
