...
@property (getter=isUWBUnlockEnabled, readonly) bool uwbUnlockEnabled;
...
- (id)initWithUUID:(id)arg1 customURL:(id)arg2 expressEnabled:(bool)arg3 uwbUnlockEnabled:(bool)arg4 color:(long long)arg5;
