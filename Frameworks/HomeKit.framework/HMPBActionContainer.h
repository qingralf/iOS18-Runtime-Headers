...
@property (nonatomic, readonly) bool hasMatterCommandAction;
@property (nonatomic, readonly) bool hasMediaPlaybackAction;
@property (nonatomic, readonly) bool hasNaturalLightingAction;
@property (nonatomic) bool hasType;
@property (nonatomic, retain) HMPBMatterCommandAction *matterCommandAction;
...
- (void)setMatterCommandAction:(id)arg1;
