...
@interface HMRoom : NSObject <HFAccessoryLikeObjectContainer, HFApplicationData, HFDemoModeAccessoryContainer, HFHomeKitObject, HFReorderableHomeKitObject, HFStateDumpBuildable, HMMutableApplicationData, HMObjectMerge, NSSecureCoding> {
...
@property (nonatomic, readonly) bool hf_hasAtLeastOneAnnounceSupportedAccessory;
@property (nonatomic, readonly) bool hf_hasAtLeastOneReachableHomeMediaAccessory;
...
- (id)hf_displayName;
- (bool)hf_hasAtLeastOneAnnounceSupportedAccessory;
