...
@property (nonatomic, readonly, copy) NSNumber *matterEndpointID;
...
@property (getter=isUserInteractive, nonatomic) bool userInteractive;
...
- (void)setMatterEndpointID:(id)arg1;
