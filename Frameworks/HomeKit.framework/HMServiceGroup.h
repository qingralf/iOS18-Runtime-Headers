...
@interface HMServiceGroup : NSObject <HFAccessoryLikeObjectRootHomeKitObjectProvider, HFAccessoryLikeObjectVendor, HFAccessoryRepresentable, HFApplicationData, HFFavoritable, HFHomeContainedObject, HFHomeStatusVisible, HFIncludedContextProtocol, HFReorderableHomeKitObject, HFServiceNameComponentsProviding, HFShowInHomeDashboard, HFStateDumpBuildable, HFUserNotificationServiceSettingsProviding, HMFLogging, HMMutableApplicationData, HMObjectMerge, HRERecommendableObjectProtocol, NSSecureCoding> {
