...
- (id)initWithVersion:(id)arg1 displayableVersion:(id)arg2 downloadSize:(unsigned long long)arg3 state:(long long)arg4 installDuration:(double)arg5 documentationMetadata:(id)arg6 releaseDate:(id)arg7;
...
- (id)nextPermittedRequestDocumentationDate;
- (id)releaseDate;
...
- (void)setNextPermittedRequestDocumentationDate:(id)arg1;
