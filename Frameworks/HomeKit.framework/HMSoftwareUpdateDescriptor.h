...
- (id)initWithStatus:(long long)arg1 downloadSize:(id)arg2 humanReadableUpdateName:(id)arg3 rampEnabled:(id)arg4 errorCode:(id)arg5 serverAssetURL:(id)arg6 serverAssetAlgorithm:(id)arg7 serverAssetMeasurement:(id)arg8 majorVersion:(id)arg9 minorVersion:(id)arg10 updateVersion:(id)arg11 buildVersion:(id)arg12 softwareVersionRequiresMetadata:(bool)arg13;
