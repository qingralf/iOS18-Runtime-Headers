...
- (void)_handleRGAllowedPeriodEnded:(id)arg1;
- (void)_handleRGAllowedPeriodStarted:(id)arg1;
- (void)_handleSharedUserProfileMetadataUpdated;
- (void)_handleSharedUserProfileMetadataUpdatedMessage:(id)arg1;
...
- (void)fetchProfilePhoto:(id /* block */)arg1;
- (void)fetchProfilePhotoAndCropRect:(id /* block */)arg1;
...
- (id)photosPersonManagerZoneUUID;
- (id)privateSettings;
...
- (void)setPhotosPersonManagerZoneUUID:(id)arg1;
- (void)setPrivateSettingsAdapter:(id)arg1;
- (void)setRgAllowedPeriod:(bool)arg1;
