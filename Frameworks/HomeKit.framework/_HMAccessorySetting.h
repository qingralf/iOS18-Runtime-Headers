...
@interface _HMAccessorySetting : NSObject <HMFLogging, HMFMerging, HMFMessageReceiver, NSSecureCoding> {
    ...
    _HMContext * _context;
    <_HMAccessorySettingDelegate> * _delegate;
    NSUUID * _identifier;
...
@property <_HMAccessorySettingDelegate> *delegate;
...
+ (id)_replaceConstraintsPayloadWithAdditions:(id)arg1 removals:(id)arg2 keyPath:(id)arg3;
+ (id)logCategory;
+ (id)shortDescription;
...
- (void)configureWithAccessorySettings:(id)arg1 context:(id)arg2 shouldHandleUpdatedValue:(bool)arg3;
