...
- (unsigned long long)dirtySize;
- (unsigned long long)height;
- (id)initWithBasicInfo:(const struct { unsigned long long x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; unsigned int x8; unsigned int x9; unsigned long long x10; unsigned long long x11; unsigned char x12; unsigned char x13; unsigned char x14; unsigned char x15; unsigned int x16; unsigned long long x17; unsigned long long x18; unsigned long long x19; unsigned long long x20; unsigned long long x21; unsigned long long x22; unsigned long long x23; }*)arg1 layoutInfo:(const struct { unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned int x5; unsigned int x6; unsigned int x7; }*)arg2 name:(id)arg3;
- (id)name;
- (unsigned int)pixelFormat;
