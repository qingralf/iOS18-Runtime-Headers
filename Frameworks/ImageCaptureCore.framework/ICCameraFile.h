...
@property (getter=isHEIC, nonatomic, readonly) bool HEIC;
@property (getter=isJPEG, nonatomic, readonly) bool JPEG;
@property (getter=isAudio, nonatomic, readonly) bool audio;
@property (nonatomic) bool burstFavorite;
@property (nonatomic) bool burstPicked;
@property (nonatomic, copy) NSString *burstUUID;
@property (getter=isConverted, nonatomic, readonly) bool converted;
@property (nonatomic, readonly) bool convertedFamily;
@property (nonatomic, copy) NSString *createdFilename;
@property (getter=isData, nonatomic, readonly) bool data;
@property (getter=isDataUniversal, nonatomic, readonly) bool dataUniversal;
@property (nonatomic) double duration;
@property (getter=isEditedConverted, nonatomic, readonly) bool editedConverted;
@property (getter=isEditedOriginal, nonatomic, readonly) bool editedOriginal;
@property (getter=isEditedUniversal, nonatomic, readonly) bool editedUniversal;
...
@property (getter=isImage, nonatomic, readonly) bool image;
...
@property (getter=isMovie, nonatomic, readonly) bool movie;
@property (getter=isNonRawImage, nonatomic, readonly) bool nonRawImage;
...
@property (nonatomic, readonly) bool originalFamily;
...
@property (getter=isSidecar, nonatomic, readonly) bool sidecar;
...
@property (getter=isUniversal, nonatomic, readonly) bool universal;
@property (nonatomic, readonly) bool universalFamily;
...
+ (id)fingerprintForFileAtURL:(id)arg1;
...
- (void)requestFingerprintWithCompletion:(id /* block */)arg1;
