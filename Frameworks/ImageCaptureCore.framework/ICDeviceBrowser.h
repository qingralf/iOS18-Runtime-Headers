...
@property (nonatomic, readonly, copy) NSString *contentsAuthorizationStatus;
@property (nonatomic, readonly, copy) NSString *controlAuthorizationStatus;
...
@property (nonatomic, readonly) ICDevice *preferredDevice;
