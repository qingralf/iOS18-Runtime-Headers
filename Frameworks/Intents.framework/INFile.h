...
@property (nonatomic, readonly) NSItemProvider *_itemProvider;
@property (setter=_setItemProviderRequestMetadata:, nonatomic, copy) INItemProviderRequestMetadata *_itemProviderRequestMetadata;
...
- (id)itemProvider;
- (void)loadDataRepresentationWithType:(id)arg1 completion:(id /* block */)arg2;
- (void)loadFileRepresentationWithType:(id)arg1 completion:(id /* block */)arg2;
...
+ (id)wf_fileWithBookmarkData:(id)arg1 filename:(id)arg2;
