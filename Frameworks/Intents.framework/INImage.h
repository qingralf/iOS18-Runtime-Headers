...
- (void)_retrieveFilePathWithCompletion:(id /* block */)arg1;
- (void)_retrieveImageDataWithReply:(id /* block */)arg1;
- (void)_retrieveImageFilePathWithReply:(id /* block */)arg1;
...
- (void)retrieveImageDataWithCompletion:(id /* block */)arg1;
