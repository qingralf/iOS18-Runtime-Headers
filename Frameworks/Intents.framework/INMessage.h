...
@property (nonatomic, copy) INSticker *sticker;
...
- (id)initWithIdentifier:(id)arg1 conversationIdentifier:(id)arg2 content:(id)arg3 dateSent:(id)arg4 sender:(id)arg5 recipients:(id)arg6 groupName:(id)arg7 dateMessageWasLastRead:(id)arg8 numberOfAttachments:(id)arg9 messageType:(long long)arg10 messageEffectType:(long long)arg11 referencedMessage:(id)arg12 serviceName:(id)arg13 attachmentFiles:(id)arg14 location:(id)arg15 linkMetadata:(id)arg16 reaction:(id)arg17 sticker:(id)arg18;
...
- (id)initWithIdentifier:(id)arg1 conversationIdentifier:(id)arg2 content:(id)arg3 dateSent:(id)arg4 sender:(id)arg5 recipients:(id)arg6 groupName:(id)arg7 serviceName:(id)arg8 messageType:(long long)arg9 referencedMessage:(id)arg10 reaction:(id)arg11;
- (id)initWithIdentifier:(id)arg1 conversationIdentifier:(id)arg2 content:(id)arg3 dateSent:(id)arg4 sender:(id)arg5 recipients:(id)arg6 groupName:(id)arg7 serviceName:(id)arg8 messageType:(long long)arg9 referencedMessage:(id)arg10 sticker:(id)arg11 reaction:(id)arg12;
