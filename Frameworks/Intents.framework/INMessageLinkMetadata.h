...
- (id)initWithSiteName:(id)arg1 summary:(id)arg2 title:(id)arg3 openGraphType:(id)arg4 itemType:(id)arg5 linkURL:(id)arg6 originalURL:(id)arg7 imageURLs:(id)arg8 iconURLs:(id)arg9 creator:(id)arg10 linkMediaType:(long long)arg11 iTunesStoreIdentifier:(id)arg12 iTunesStoreFrontIdentifier:(id)arg13 songTitle:(id)arg14 songArtist:(id)arg15 songAlbum:(id)arg16 albumName:(id)arg17 albumArtist:(id)arg18 musicVideoName:(id)arg19 musicVideoArtist:(id)arg20 artistName:(id)arg21 artistGenre:(id)arg22 playlistName:(id)arg23 playlistCurator:(id)arg24 radioName:(id)arg25 radioCurator:(id)arg26 softwareName:(id)arg27 softwareGenre:(id)arg28 softwarePlatform:(id)arg29 bookName:(id)arg30 bookAuthor:(id)arg31 audioBookName:(id)arg32 audioBookAuthor:(id)arg33 audioBookNarrator:(id)arg34 podcastName:(id)arg35 podcastArtist:(id)arg36 podcastEpisodeName:(id)arg37 podcastEpisodePodcastName:(id)arg38 podcastEpisodeArtist:(id)arg39 podcastEpisodeReleaseDate:(id)arg40 tvEpisodeEpisodeName:(id)arg41 tvEpisodeSeasonName:(id)arg42 tvEpisodeGenre:(id)arg43 tvSeasonName:(id)arg44 tvSeasonGenre:(id)arg45 movieName:(id)arg46 movieGenre:(id)arg47 tvShowName:(id)arg48 movieBundleName:(id)arg49 movieBundleGenre:(id)arg50 appleTvTitle:(id)arg51 appleTvSubtitle:(id)arg52;
- (id)initWithSiteName:(id)arg1 summary:(id)arg2 title:(id)arg3 openGraphType:(id)arg4 linkURL:(id)arg5;
