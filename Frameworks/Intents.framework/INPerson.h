...
+ (id)tu_personMatchingHandle:(id)arg1 contactsDataSource:(id)arg2 isoCountryCodes:(id)arg3;

- (id)tu_allContactIdentifiers;
- (id)tu_contactsMatchingIdentifiers:(id)arg1 contactsDataSource:(id)arg2 identifierToContactCache:(id)arg3;
- (id)tu_handlesMatchingPersonWithContactsDataSource:(id)arg1 identifierToContactCache:(id)arg2;
- (id)tu_matchingINPersonHandlesByContactIdentifier;
- (id)tu_personWithFormattedHandleForISOCountryCodes:(id)arg1;
