...
@interface _INPBCreateEventIntentResponse : PBCodable <NSCopying, NSSecureCoding, _INPBCreateEventIntentResponse> {
...
@property (nonatomic, retain) _INPBCalendarEvent *createdEvent;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (readonly, copy) NSString *description;
@property (nonatomic) bool hasConfirmationReason;
@property (nonatomic, readonly) bool hasCreatedEvent;
