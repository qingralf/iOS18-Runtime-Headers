...
@interface _INPBIntentMetadata : PBCodable <INJSONSerializable, NSCopying, NSSecureCoding, _INPBIntentMetadata> {
    ...
    bool  _bypassAppProtectionAuthentication;
...
@property (nonatomic) bool bypassAppProtectionAuthentication;
...
@property (nonatomic, readonly) bool hasBypassAppProtectionAuthentication;
...
- (void)setBypassAppProtectionAuthentication:(bool)arg1;
...
- (void)setHasBypassAppProtectionAuthentication:(bool)arg1;
