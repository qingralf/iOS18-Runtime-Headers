...
@property (nonatomic, copy) NSArray *pairDataValues;
@property (nonatomic, readonly) unsigned long long pairDataValuesCount;
...
- (id)pairDataValues;
- (unsigned long long)pairDataValuesCount;
...
- (void)setPairDataValues:(id)arg1;
