...
@property (getter=_isDictionary, nonatomic, readonly) bool _dictionary;
...
+ (id)valueWithNewBigIntFromDouble:(double)arg1 inContext:(id)arg2;
+ (id)valueWithNewBigIntFromInt64:(long long)arg1 inContext:(id)arg2;
+ (id)valueWithNewBigIntFromString:(id)arg1 inContext:(id)arg2;
+ (id)valueWithNewBigIntFromUInt64:(unsigned long long)arg1 inContext:(id)arg2;
...
- (unsigned int)compareDouble:(double)arg1;
- (unsigned int)compareInt64:(long long)arg1;
- (unsigned int)compareJSValue:(id)arg1;
- (unsigned int)compareUInt64:(unsigned long long)arg1;
