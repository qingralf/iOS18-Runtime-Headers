...
@interface LPButtonStyle : NSObject {
    ...
    LPPadding * _padding;
    bool  _prefersBehavioralStylePad;
...
+ (id)systemPillButtonStyleForPlatform:(long long)arg1 sizeClass:(unsigned long long)arg2;
...
- (void)setPrefersBehavioralStylePad:(bool)arg1;
