...
@property (nonatomic, retain) LPCollaborationFooterPresentationProperties *collaborationFooter;
...
@property (nonatomic, retain) LPPlayButtonPresentationProperties *playButton;
@property (nonatomic) bool shouldHighlightIndependently;
@property (nonatomic, retain) LPIndeterminateProgressSpinnerPresentationProperties *spinner;
