...
@property (nonatomic, retain) LPPointUnit *trailingPaddingForPresenceOfLeadingIcon;
...
- (id)initWithPlatform:(long long)arg1 sizeClass:(unsigned long long)arg2 sizeClassParameters:(id)arg3 fontScalingFactor:(double)arg4;
- (id)leadingAccessory;
- (id)leadingIcon;
- (id)leadingIconBadge;
- (id)leftAccessory;
...
- (void)setTrailingPaddingForPresenceOfLeadingIcon:(id)arg1;
