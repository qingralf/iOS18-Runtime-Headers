...
- (void).cxx_destruct;
- (id)URL;
- (void)_addFinishedDeferringAsynchronousLoadHandler:(id /* block */)arg1;
...
- (id)dataRepresentationWithEncodingType:(unsigned long long)arg1 options:(unsigned long long)arg2;
