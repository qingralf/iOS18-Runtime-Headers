...
@property (nonatomic, retain) UITraitCollection *effectiveAppearance;
...
@property (nonatomic, retain) LPImage *mediaOverlayIcon;
...
- (id)_lastResortIcon;
- (void)_populateDominantBackgroundColorForPropertiesIfNeeded:(id)arg1;
...
- (void)_populatePropertiesForMediaOverlayIcon:(id)arg1;
- (id)_preferredBackgroundColorImageSourceForProperties:(id)arg1;
- (bool)_prefersIconAsImage;
- (bool)_prefersImageAsIconWithStyle:(long long)arg1;
- (bool)_prefersLeadingIconWithStyle:(long long)arg1;
- (void)_propagateDominantBackgroundColorToDependentPropertiesIfNeeded:(id)arg1;
- (unsigned long long)_rowConfigurationForStyle:(long long)arg1;
- (bool)_shouldUseMicroblogQuotedTextForStyle:(long long)arg1;
- (bool)_useVisualRefreshCaptionBarColorsForProperties:(id)arg1;
- (bool)allowsPlayback;
...
- (id)imageForStyle:(long long)arg1 imageMetadata:(id)arg2 icon:(id*)arg3 alternateImages:(id*)arg4;
- (id)init;
