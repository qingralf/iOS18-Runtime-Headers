...
+ (bool)isAppleBookSeriesURL:(id)arg1;
...
+ (bool)isFacebookURL:(id)arg1;
+ (bool)isGoogleMapsURL:(id)arg1;
...
+ (bool)shouldAllowHoistingContentImagesForURL:(id)arg1;
