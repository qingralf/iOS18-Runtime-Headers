...
+ (id)attributedString:(id)arg1 resolvedAgainstStyle:(id)arg2 withEmphasizedTextExpression:(id)arg3 tintColor:(id)arg4 lineBreakMode:(long long)arg5 usesVibrancy:(bool)arg6 forLTR:(bool)arg7 withFont:(id)arg8 userInterfaceStyle:(long long)arg9;
