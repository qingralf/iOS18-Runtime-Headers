...
@property (nonatomic, readonly) unsigned long long lastInteractionTimestamp; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) double unobscuredAreaFraction; /* unknown property attribute: ? */
