...
+ (id)extractApplicationNameFromURL:(id)arg1;
...
- (void).cxx_destruct;
- (id)_bottomLeadingCaptionStringWithApplicationName:(id)arg1 originalURL:(id)arg2;
- (void)_enumerateAsynchronousFields:(id /* block */)arg1;
- (id)_topLeadingCaptionStringWithApplicationName:(id)arg1 originalURL:(id)arg2;
- (id)application;
...
- (bool)isFreeformBoardLinkWithURL:(id)arg1;
- (bool)isSafariTabGroupLinkWithURL:(id)arg1;
- (id)kind;
