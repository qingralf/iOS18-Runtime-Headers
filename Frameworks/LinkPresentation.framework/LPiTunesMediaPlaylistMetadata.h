...
@interface LPiTunesMediaPlaylistMetadata : LPSpecializationMetadata <LPLinkMetadataBackwardCompatibility, LPLinkMetadataPresentationTransformer, LPLinkMetadataPreviewTransformer, LPLinkMetadataStatusTransformer, LPLinkMetadataStoreTransformer, LPiTunesMetadata> {
    LPImage * _artwork;
...
@property (nonatomic, copy) NSString *curatorHandle;
