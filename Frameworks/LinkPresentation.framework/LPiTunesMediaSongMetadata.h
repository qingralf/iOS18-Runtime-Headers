...
@interface LPiTunesMediaSongMetadata : LPSpecializationMetadata <LPLinkMetadataBackwardCompatibility, LPLinkMetadataPresentationTransformer, LPLinkMetadataPreviewTransformer, LPLinkMetadataSourceApplicationTransformer, LPLinkMetadataStatusTransformer, LPLinkMetadataStoreTransformer, LPiTunesMetadata> {
    NSString * _album;
    NSString * _artist;
    LPImage * _artwork;
