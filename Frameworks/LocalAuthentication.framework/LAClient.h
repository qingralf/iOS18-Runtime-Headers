...
@interface LAClient : NSObject <LAContextCallbackXPC, LAContextXPC> {
    ...
    NSUUID * _uuid;
    bool  _willRetryOnInterruptedConnection;
}
...
- (void)getDomainStateWithOptions:(id)arg1 reply:(id /* block */)arg2;
- (void)getDomainStateWithOptions:(id)arg1 synchronous:(bool)arg2 reply:(id /* block */)arg3;
...
- (void)setWillRetryOnInterruptedConnection:(bool)arg1;
