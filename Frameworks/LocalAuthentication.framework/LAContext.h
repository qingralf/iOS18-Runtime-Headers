...
- (id)_fetchDomainStateWithOptions:(id)arg1 error:(id*)arg2;
...
- (bool)canEvaluateCorePolicy:(long long)arg1 error:(id*)arg2;
...
- (id)client;
- (id)coreCredentialOfType:(long long)arg1 error:(id*)arg2;
- (void)coreCredentialOfType:(long long)arg1 reply:(id /* block */)arg2;
- (id)credentialOfType:(long long)arg1 error:(id*)arg2;
- (void)credentialOfType:(long long)arg1 reply:(id /* block */)arg2;
- (void)dealloc;
- (id)description;
- (id)domainState;
- (id)domainStateWithOptions:(id)arg1;
...
- (void)evaluateCorePolicy:(long long)arg1 options:(id)arg2 reply:(id /* block */)arg3;
...
- (bool)setCoreCredential:(id)arg1 type:(long long)arg2 error:(id*)arg3;
- (void)setCoreCredential:(id)arg1 type:(long long)arg2 reply:(id /* block */)arg3;
...
- (void)setOptionAllowEmptyPasscode:(id)arg1;
- (void)setOptionAllowEnablementGracePeriod:(id)arg1;
- (void)setOptionAllowUnapprovedSensor:(id)arg1;
- (void)setOptionAuthenticationCallbackReason:(id)arg1;
- (void)setOptionAuthenticationCallbackURL:(id)arg1;
- (void)setOptionAuthenticationIdentifier:(id)arg1;
- (void)setOptionAuthenticationReason:(id)arg1;
- (void)setOptionAuthenticationTitle:(id)arg1;
- (void)setOptionBeginRatchetLocalizedText:(id)arg1;
- (void)setOptionBeginRatchetLocalizedTitle:(id)arg1;
- (void)setOptionBeginRatchetShowsLocationWarning:(id)arg1;
- (void)setOptionBeginSecurityDelayImmediately:(id)arg1;
- (void)setOptionBiometryLockoutRecovery:(id)arg1;
- (void)setOptionBiometryLockoutRecoveryRetries:(id)arg1;
- (void)setOptionBodyText:(id)arg1;
- (void)setOptionCallerAuditToken:(id)arg1;
- (void)setOptionCallerAuditTokenUsage:(id)arg1;
- (void)setOptionCallerIconBundlePath:(id)arg1;
- (void)setOptionCallerIconPath:(id)arg1;
...
- (void)setOptionCountdownLocalizedText:(id)arg1;
- (void)setOptionDTO:(id)arg1;
- (void)setOptionDisableMacCompanion:(id)arg1;
- (void)setOptionEventProcessing:(id)arg1;
- (void)setOptionFaceDetectLength:(id)arg1;
- (void)setOptionFallbackToNoAuthentication:(id)arg1;
- (void)setOptionFallbackVisible:(id)arg1;
- (void)setOptionFingerMustBeOff:(id)arg1;
- (void)setOptionLightweightUI:(id)arg1;
- (void)setOptionLightweightUIMode:(id)arg1;
- (void)setOptionMatchForUnlock:(id)arg1;
- (void)setOptionMaxBiometryFailures:(id)arg1;
- (void)setOptionMaxCredentialAge:(id)arg1;
- (void)setOptionNoCountdownUI:(id)arg1;
- (void)setOptionNoFailureUI:(id)arg1;
- (void)setOptionNoGracePeriodUI:(id)arg1;
...
- (void)setOptionUseShortExpirationTimer:(id)arg1;
