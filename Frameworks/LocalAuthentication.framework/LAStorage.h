...
- (id)description;
- (long long)domain;
- (void)exchangeData:(id)arg1 forKey:(long long)arg2 completionHandler:(id /* block */)arg3;
- (id)exchangeData:(id)arg1 forKey:(long long)arg2 error:(id*)arg3;
- (id)initWithDomain:(long long)arg1 authenticationContext:(id)arg2;
- (unsigned int)instanceId;
- (id)numberForKey:(long long)arg1;
- (void)numberForKey:(long long)arg1 completionHandler:(id /* block */)arg2;
- (id)numberForKey:(long long)arg1 error:(id*)arg2;
