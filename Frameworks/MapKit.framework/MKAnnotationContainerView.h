...
- (bool)_view:(id)arg1 containsPoint:(struct CGPoint { double x1; double x2; })arg2;
...
- (bool)accessoryContainsPoint:(struct CGPoint { double x1; double x2; })arg1;
...
- (void)annotationViewDidChangeDisplayPriority:(id)arg1;
