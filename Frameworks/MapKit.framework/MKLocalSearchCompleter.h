...
@property (getter=_recentAutocompleteSessionData, nonatomic, readonly) GEOAutocompleteSessionData *recentAutocompleteSessionData;
...
- (void)setRegionPriority:(long long)arg1;
