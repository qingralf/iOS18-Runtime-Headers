...
+ (id)entryPointWithMapItem:(id)arg1 isMarkedLocation:(bool)arg2 wantsCloseUpView:(bool)arg3 cameraFrameOverride:(id)arg4 triggerAction:(int)arg5;
...
- (void)setIsMarkedLocation:(bool)arg1;
