...
@property (nonatomic) bool _showsHiking;
@property (nonatomic) bool _showsTopographicFeatures;
...
- (void)set_showsHiking:(bool)arg1;
- (void)set_showsTopographicFeatures:(bool)arg1;
