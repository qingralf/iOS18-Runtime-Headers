...
@interface MKMapItem : NSObject <GEOURLSerializable, MUOverallRatingPlatterViewModel, MUPlaceTileViewModel, MUTransitStationSummary, NSItemProviderReading, NSItemProviderWriting, NSSecureCoding> {
...
@property (nonatomic, readonly) NSSet *alternateIdentifiers;
...
@property (nonatomic, readonly) NSAttributedString *attributionText;
...
@property (getter=_businessAssets, nonatomic, readonly) GEOBusinessAssets *businessAssets;
@property (getter=_businessHours, nonatomic, readonly) NSArray *businessHours;
@property (getter=_canBeClaimed, nonatomic, readonly) bool canBeClaimed;
...
@property (getter=_encyclopedicInfoAttribution, nonatomic, readonly) _MKMapItemAttribution *encyclopedicInfoAttribution;
...
@property (getter=_hasHikeInfo, nonatomic, readonly) bool hasHikeInfo;
...
@property (getter=_hasLookAroundStorefront, nonatomic, readonly) bool hasLookAroundStorefront;
...
@property (getter=_hikeAssociatedInfo, nonatomic, readonly) GEOPDHikeAssociatedInfo *hikeAssociatedInfo;
@property (getter=_hikeGeometry, nonatomic, readonly) GEOPDHikeGeometry *hikeGeometry;
@property (getter=_hikeSummary, nonatomic, readonly) GEOHikeSummary *hikeSummary;
@property (getter=_hikingTrailDifficultyFactoid, nonatomic, readonly) GEOFactoid *hikingTrailDifficultyFactoid;
@property (getter=_hikingTrailLengthFactoid, nonatomic, readonly) GEOFactoid *hikingTrailLengthFactoid;
@property (getter=_hikingTrailPointToPointFactoid, nonatomic, readonly) GEOFactoid *hikingTrailPointToPointFactoid;
@property (nonatomic, readonly) MKMapItemIdentifier *identifier;
@property (getter=_isClaimed, nonatomic, readonly) bool isClaimed;
...
@property (getter=_isPartiallyClientized, nonatomic, readonly) bool isPartiallyClientized;
@property (nonatomic, readonly) bool isPlaceHolder;
@property (getter=_isStandAloneBrand, nonatomic, readonly) bool isStandAloneBrand;
@property (getter=_labelCoordinate, nonatomic, readonly) struct CLLocationCoordinate2D { double x1; double x2; } labelCoordinate;
...
@property (nonatomic, readonly) unsigned long long numberOfVotes;
...
@property (getter=_searchResultPhotoCarousel, nonatomic, readonly) NSArray *photoCarousel;
...
@property (getter=_presentCoordinate, nonatomic) struct CLLocationCoordinate2D { double x1; double x2; } presentCoordinate;
...
@property (getter=_realTimeAvailableEVCharger, nonatomic, readonly) GEOEVChargerAvailability *realTimeAvailableEVCharger;
...
@property (nonatomic, readonly) NSString *stationCategory;
@property (nonatomic, readonly) NSString *stationTitle;
...
+ (bool)_isDirectionsActionURL:(id)arg1;
...
+ (void)_mapItemsFromPunchInHintsURL:(id)arg1 maxResults:(unsigned int)arg2 completionHandler:(id /* block */)arg3;
...
+ (bool)_shouldUseUniversalLinkForMapItems:(id)arg1 options:(id)arg2;
+ (id)_sourceAppIdFromLaunchURL:(id)arg1;
+ (id)_sourceAppIdFromLaunchUserInfo:(id)arg1;
+ (id)_universalLinkForMapItems:(id)arg1 options:(id)arg2;
...
- (id)_bestWalletHeroImageForSize:(struct CGSize { double x1; double x2; })arg1 allowSmaller:(bool)arg2;
...
- (id)_factoidWithSemantic:(int)arg1;
...
- (id)_isolatedPlace;
- (struct CLLocationCoordinate2D { double x1; double x2; })_labelCoordinate;
- (id)_labelGeometry;
...
- (struct CLLocationCoordinate2D { double x1; double x2; })_presentCoordinate;
...
- (void)_updateRealTimeEVChargerAvailability:(id)arg1;
...
- (id)hoursBuilderForSearchResultCellForOptions:(unsigned long long)arg1 conciseStyle:(bool)arg2;
- (id)hoursBuilderForSearchResultCellForOptions:(unsigned long long)arg1 conciseStyle:(bool)arg2 openAt:(id)arg3;
- (id)identifier;
- (id)init;
...
- (id)searchResultsHoursWithConciseStyle:(bool)arg1 openAt:(id)arg2;
- (void)setIsCurrentLocation:(bool)arg1;
- (void)setIsMapItemTypeTransit:(bool)arg1;
- (void)setName:(id)arg1;
- (void)setPhoneNumber:(id)arg1;
- (void)setPointOfInterestCategory:(id)arg1;
- (void)setPresentCoordinate:(struct CLLocationCoordinate2D { double x1; double x2; })arg1;
