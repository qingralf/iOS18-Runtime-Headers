...
@property (getter=_labelSelectionFilter, setter=_setLabelSelectionFilter:, nonatomic, copy) MKLabelSelectionFilter *labelSelectionFilter;
...
@property (getter=_showsContourLabels, setter=_setShowsCountourLabels:, nonatomic) bool showsContourLabels;
...
@property (getter=_showsLabels, setter=_setShowsLabels:, nonatomic) bool showsLabels;
@property (getter=_showsNightMode, setter=_setShowsNightMode:, nonatomic) bool showsNightMode;
@property (getter=_showsPhysicalFeatureLabels, setter=_setShowsPhysicalFeatureLabels:, nonatomic) bool showsPhysicalFeatureLabels;
...
- (void)_deselectCurrentFeatureAnnotationIfNeededAnimated:(bool)arg1;
...
- (void)_offlineStateDidChange:(id)arg1;
...
- (void)_setLabelSelectionFilter:(id)arg1;
- (void)_setLabelSelectionFilter:(id)arg1 animated:(bool)arg2;
...
- (void)_setShowsCountourLabels:(bool)arg1;
- (void)_setShowsCurrentEnvironmentName:(bool)arg1;
- (void)_setShowsLabels:(bool)arg1;
- (void)_setShowsNightMode:(bool)arg1;
- (void)_setShowsPhysicalFeatureLabels:(bool)arg1;
...
- (bool)_shouldDeselectMapFeatureForNewPreferredConfiguration:(id)arg1;
...
- (void)_updateFramingUsingSetRegionBlock:(id /* block */)arg1;
...
- (bool)accessoryViewContainsPoint:(struct CGPoint { double x1; double x2; })arg1;
...
- (void)checkIfCoordinate:(struct CLLocationCoordinate2D { double x1; double x2; })arg1 isInHikingContextualRegionWithCompletionHandler:(id /* block */)arg2;
- (id)compassView;
...
- (void)mapLayer:(id)arg1 location:(struct { double x1; double x2; })arg2 isInHikingContextualRegion:(bool)arg3;
...
- (void)mapLayer:(id)arg1 selectedLabelMarkerDidCompleteLayout:(id)arg2;
