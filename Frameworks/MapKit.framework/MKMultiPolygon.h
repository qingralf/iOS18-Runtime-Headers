...
@interface MKMultiPolygon : MKShape <MKGeoJSONObject, MKOverlay, NSSecureCoding> {
    struct { 
        struct { 
            double x; 
            double y; 
...
- (void).cxx_destruct;
- (struct { struct { double x_1_1_1; double x_1_1_2; } x1; struct { double x_2_1_1; double x_2_1_2; } x2; })_boundingMapRectForPolygons:(id)arg1;
