...
@property (getter=_extendedBlendMode, setter=_setExtendedBlendMode:, nonatomic) long long extendedBlendMode;
@property (nonatomic, readonly) <MKOverlay> *overlay;

- (void).cxx_destruct;
- (void)_animateIfNecessaryForKey:(id)arg1 withStepHandler:(id /* block */)arg2;
...
- (id)_renderer;
- (void)_setExtendedBlendMode:(long long)arg1;
