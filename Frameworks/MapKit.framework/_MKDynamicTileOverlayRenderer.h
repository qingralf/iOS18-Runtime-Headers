...
@property (nonatomic) bool useNativeDisplayRate;
...
- (void)drawTileAtPath:(struct { long long x1; long long x2; long long x3; double x4; })arg1 withTile:(id)arg2 inIOSurface:(struct __IOSurface { }*)arg3 withTimestamp:(double)arg4 withTileScale:(float)arg5;
...
- (void)setUseNativeDisplayRate:(bool)arg1;
