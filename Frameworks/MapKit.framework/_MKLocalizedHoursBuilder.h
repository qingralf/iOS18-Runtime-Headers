...
- (id)AMPMSymbols;
- (void)_commonInit;
- (id)_findNextOperatingWeekday:(long long)arg1;
- (id)_formatedOperatingHourString:(id)arg1 timeZone:(id)arg2 weekday:(long long)arg3;
- (id)_formattedStringForHourRangesWithStartAndEndDates:(id)arg1 timeZone:(id)arg2;
- (bool)_isCurrentTimeSingular:(id)arg1;
- (bool)_isOpenAtClosingSoon;
- (id)_localizedTimeStringFromDate:(id)arg1 timezone:(id)arg2;
...
- (id)initWithBusinessHours:(id)arg1 timeZone:(id)arg2 localizedHoursStringOptions:(unsigned long long)arg3 conciseStyle:(bool)arg4 openAt:(id)arg5;
- (id)initWithMapItem:(id)arg1 localizedHoursStringOptions:(unsigned long long)arg2;
- (id)initWithMapItem:(id)arg1 localizedHoursStringOptions:(unsigned long long)arg2 conciseStyle:(bool)arg3 openAt:(id)arg4;
...
- (id)showClosingSoonHour:(id)arg1 timeZone:(id)arg2;
- (long long)state;
- (id)timeZone;
