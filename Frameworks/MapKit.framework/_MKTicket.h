...
@property (nonatomic, readonly) MKMapItemIdentifier *mapItemIdentifierForSpotlight;
...
@property (nonatomic, readonly) bool shouldAllowManualRedoButton;
...
- (int)mapDisplayType;
- (id)mapItemIdentifierForSpotlight;
