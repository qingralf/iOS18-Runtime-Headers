...
+ (void)readAttributeARLWithClusterStateCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;
...
+ (void)readAttributeCommissioningARLWithClusterStateCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;
...
- (void)readAttributeARLWithParams:(id)arg1 completion:(id /* block */)arg2;
...
- (void)readAttributeCommissioningARLWithCompletion:(id /* block */)arg1;
...
- (void)reviewFabricRestrictionsWithParams:(id)arg1 completion:(id /* block */)arg2;
- (void)subscribeAttributeACLWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
- (void)subscribeAttributeARLWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
...
- (void)subscribeAttributeCommissioningARLWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
