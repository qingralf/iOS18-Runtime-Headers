...
- (void)getSetupPINWithParams:(id)arg1 completion:(id /* block */)arg2;
- (void)getSetupPINWithParams:(id)arg1 completionHandler:(id /* block */)arg2;
- (id)initWithDevice:(id)arg1 endpoint:(unsigned short)arg2 queue:(id)arg3;
- (void)loginWithParams:(id)arg1 completion:(id /* block */)arg2;
- (void)loginWithParams:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)logoutWithCompletion:(id /* block */)arg1;
- (void)logoutWithCompletionHandler:(id /* block */)arg1;
- (void)logoutWithParams:(id)arg1 completion:(id /* block */)arg2;
- (void)logoutWithParams:(id)arg1 completionHandler:(id /* block */)arg2;
