...
+ (void)readAttributeAirQualityWithClusterStateCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;
...
- (void)readAttributeAirQualityWithCompletion:(id /* block */)arg1;
...
- (void)subscribeAttributeAirQualityWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
