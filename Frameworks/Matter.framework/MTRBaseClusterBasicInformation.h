...
+ (void)readAttributeMaxPathsPerInvokeWithClusterStateCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;
...
+ (void)readAttributeSpecificationVersionWithClusterStateCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;
...
- (void)readAttributeMaxPathsPerInvokeWithCompletion:(id /* block */)arg1;
...
- (void)readAttributeSpecificationVersionWithCompletion:(id /* block */)arg1;
...
- (void)subscribeAttributeMaxPathsPerInvokeWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
...
- (void)subscribeAttributeSpecificationVersionWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
