...
+ (void)readAttributeBindingWithClusterStateCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;
...
- (void)readAttributeBindingWithParams:(id)arg1 completion:(id /* block */)arg2;
...
- (void)subscribeAttributeBindingWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
...
- (void)writeAttributeBindingWithValue:(id)arg1 completion:(id /* block */)arg2;
- (void)writeAttributeBindingWithValue:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)writeAttributeBindingWithValue:(id)arg1 params:(id)arg2 completion:(id /* block */)arg3;
