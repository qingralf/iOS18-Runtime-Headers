...
+ (void)readAttributeChannelListWithAttributeCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completionHandler:(id /* block */)arg4;
+ (void)readAttributeChannelListWithClusterStateCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;
...
+ (void)readAttributeCurrentChannelWithAttributeCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completionHandler:(id /* block */)arg4;
+ (void)readAttributeCurrentChannelWithClusterStateCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;
...
+ (void)readAttributeLineupWithAttributeCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completionHandler:(id /* block */)arg4;
+ (void)readAttributeLineupWithClusterStateCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;

- (void)cancelRecordProgramWithParams:(id)arg1 completion:(id /* block */)arg2;
- (void)changeChannelByNumberWithParams:(id)arg1 completion:(id /* block */)arg2;
- (void)changeChannelByNumberWithParams:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)changeChannelWithParams:(id)arg1 completion:(id /* block */)arg2;
- (void)changeChannelWithParams:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)getProgramGuideWithCompletion:(id /* block */)arg1;
- (void)getProgramGuideWithParams:(id)arg1 completion:(id /* block */)arg2;
...
- (void)readAttributeChannelListWithCompletion:(id /* block */)arg1;
- (void)readAttributeChannelListWithCompletionHandler:(id /* block */)arg1;
...
- (void)readAttributeCurrentChannelWithCompletion:(id /* block */)arg1;
- (void)readAttributeCurrentChannelWithCompletionHandler:(id /* block */)arg1;
...
- (void)readAttributeLineupWithCompletion:(id /* block */)arg1;
- (void)readAttributeLineupWithCompletionHandler:(id /* block */)arg1;
- (void)recordProgramWithParams:(id)arg1 completion:(id /* block */)arg2;
- (void)skipChannelWithParams:(id)arg1 completion:(id /* block */)arg2;
- (void)skipChannelWithParams:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)subscribeAttributeChannelListWithMinInterval:(id)arg1 maxInterval:(id)arg2 params:(id)arg3 subscriptionEstablished:(id /* block */)arg4 reportHandler:(id /* block */)arg5;
- (void)subscribeAttributeChannelListWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
...
- (void)subscribeAttributeCurrentChannelWithMinInterval:(id)arg1 maxInterval:(id)arg2 params:(id)arg3 subscriptionEstablished:(id /* block */)arg4 reportHandler:(id /* block */)arg5;
- (void)subscribeAttributeCurrentChannelWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
...
- (void)subscribeAttributeLineupWithMinInterval:(id)arg1 maxInterval:(id)arg2 params:(id)arg3 subscriptionEstablished:(id /* block */)arg4 reportHandler:(id /* block */)arg5;
- (void)subscribeAttributeLineupWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
