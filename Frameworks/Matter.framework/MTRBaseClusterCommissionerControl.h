...
+ (void)readAttributeSupportedDeviceCategoriesWithClusterStateCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;

- (void)commissionNodeWithParams:(id)arg1 completion:(id /* block */)arg2;
...
- (void)readAttributeSupportedDeviceCategoriesWithCompletion:(id /* block */)arg1;
- (void)requestCommissioningApprovalWithParams:(id)arg1 completion:(id /* block */)arg2;
...
- (void)subscribeAttributeSupportedDeviceCategoriesWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
