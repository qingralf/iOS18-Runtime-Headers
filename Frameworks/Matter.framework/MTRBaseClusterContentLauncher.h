...
+ (void)readAttributeAcceptHeaderWithClusterStateCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;
...
+ (void)readAttributeSupportedStreamingProtocolsWithClusterStateCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;

- (id)initWithDevice:(id)arg1 endpoint:(unsigned short)arg2 queue:(id)arg3;
- (void)launchContentWithParams:(id)arg1 completion:(id /* block */)arg2;
- (void)launchContentWithParams:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)launchURLWithParams:(id)arg1 completion:(id /* block */)arg2;
- (void)launchURLWithParams:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)readAttributeAcceptHeaderWithCompletion:(id /* block */)arg1;
...
- (void)readAttributeSupportedStreamingProtocolsWithCompletion:(id /* block */)arg1;
...
- (void)subscribeAttributeAcceptHeaderWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
...
- (void)subscribeAttributeSupportedStreamingProtocolsWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
- (void)writeAttributeSupportedStreamingProtocolsWithValue:(id)arg1 completion:(id /* block */)arg2;
- (void)writeAttributeSupportedStreamingProtocolsWithValue:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)writeAttributeSupportedStreamingProtocolsWithValue:(id)arg1 params:(id)arg2 completion:(id /* block */)arg3;
