...
+ (void)readAttributeLatchWithClusterStateCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;
+ (void)readAttributeMaskWithClusterStateCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;
+ (void)readAttributeStateWithClusterStateCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;
+ (void)readAttributeSupportedWithClusterStateCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;

- (void)modifyEnabledAlarmsWithParams:(id)arg1 completion:(id /* block */)arg2;
...
- (void)readAttributeLatchWithCompletion:(id /* block */)arg1;
- (void)readAttributeMaskWithCompletion:(id /* block */)arg1;
- (void)readAttributeStateWithCompletion:(id /* block */)arg1;
- (void)readAttributeSupportedWithCompletion:(id /* block */)arg1;
- (void)resetWithParams:(id)arg1 completion:(id /* block */)arg2;
...
- (void)subscribeAttributeLatchWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
- (void)subscribeAttributeMaskWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
- (void)subscribeAttributeStateWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
- (void)subscribeAttributeSupportedWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
