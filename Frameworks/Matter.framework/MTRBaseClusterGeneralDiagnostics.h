...
- (void)payloadTestRequestWithParams:(id)arg1 completion:(id /* block */)arg2;
...
- (void)timeSnapshotWithCompletion:(id /* block */)arg1;
- (void)timeSnapshotWithParams:(id)arg1 completion:(id /* block */)arg2;
