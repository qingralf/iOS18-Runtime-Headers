...
+ (void)readAttributeLightSensorTypeWithAttributeCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completionHandler:(id /* block */)arg4;
+ (void)readAttributeLightSensorTypeWithClusterStateCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;
...
- (void)readAttributeLightSensorTypeWithCompletion:(id /* block */)arg1;
- (void)readAttributeLightSensorTypeWithCompletionHandler:(id /* block */)arg1;
...
- (void)subscribeAttributeLightSensorTypeWithMinInterval:(id)arg1 maxInterval:(id)arg2 params:(id)arg3 subscriptionEstablished:(id /* block */)arg4 reportHandler:(id /* block */)arg5;
- (void)subscribeAttributeLightSensorTypeWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
