...
+ (void)readAttributeActiveLocaleWithAttributeCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completionHandler:(id /* block */)arg4;
+ (void)readAttributeActiveLocaleWithClusterStateCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;
...
+ (void)readAttributeSupportedLocalesWithAttributeCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completionHandler:(id /* block */)arg4;
+ (void)readAttributeSupportedLocalesWithClusterStateCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;
...
- (void)readAttributeActiveLocaleWithCompletion:(id /* block */)arg1;
- (void)readAttributeActiveLocaleWithCompletionHandler:(id /* block */)arg1;
...
- (void)readAttributeSupportedLocalesWithCompletion:(id /* block */)arg1;
- (void)readAttributeSupportedLocalesWithCompletionHandler:(id /* block */)arg1;
...
- (void)subscribeAttributeActiveLocaleWithMinInterval:(id)arg1 maxInterval:(id)arg2 params:(id)arg3 subscriptionEstablished:(id /* block */)arg4 reportHandler:(id /* block */)arg5;
- (void)subscribeAttributeActiveLocaleWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
...
- (void)subscribeAttributeSupportedLocalesWithMinInterval:(id)arg1 maxInterval:(id)arg2 params:(id)arg3 subscriptionEstablished:(id /* block */)arg4 reportHandler:(id /* block */)arg5;
- (void)subscribeAttributeSupportedLocalesWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
- (void)writeAttributeActiveLocaleWithValue:(id)arg1 completion:(id /* block */)arg2;
- (void)writeAttributeActiveLocaleWithValue:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)writeAttributeActiveLocaleWithValue:(id)arg1 params:(id)arg2 completion:(id /* block */)arg3;
- (void)writeAttributeActiveLocaleWithValue:(id)arg1 params:(id)arg2 completionHandler:(id /* block */)arg3;
