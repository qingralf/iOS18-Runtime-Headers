...
+ (void)readAttributeActiveMessageIDsWithClusterStateCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;
...
+ (void)readAttributeMessagesWithClusterStateCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;

- (void)cancelMessagesRequestWithParams:(id)arg1 completion:(id /* block */)arg2;
- (void)presentMessagesRequestWithParams:(id)arg1 completion:(id /* block */)arg2;
- (void)readAttributeAcceptedCommandListWithCompletion:(id /* block */)arg1;
- (void)readAttributeActiveMessageIDsWithCompletion:(id /* block */)arg1;
...
- (void)readAttributeMessagesWithCompletion:(id /* block */)arg1;
...
- (void)subscribeAttributeActiveMessageIDsWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
...
- (void)subscribeAttributeMessagesWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
