...
- (void)applyUpdateRequestWithParams:(id)arg1 completionHandler:(id /* block */)arg2;
- (id)initWithDevice:(id)arg1 endpoint:(unsigned short)arg2 queue:(id)arg3;
- (void)notifyUpdateAppliedWithParams:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)queryImageWithParams:(id)arg1 completionHandler:(id /* block */)arg2;
