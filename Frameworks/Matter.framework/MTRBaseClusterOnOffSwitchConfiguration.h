...
+ (void)readAttributeSwitchActionsWithClusterStateCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;
+ (void)readAttributeSwitchTypeWithAttributeCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completionHandler:(id /* block */)arg4;
+ (void)readAttributeSwitchTypeWithClusterStateCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;
...
- (void)readAttributeSwitchActionsWithCompletion:(id /* block */)arg1;
- (void)readAttributeSwitchActionsWithCompletionHandler:(id /* block */)arg1;
- (void)readAttributeSwitchTypeWithCompletion:(id /* block */)arg1;
...
- (void)subscribeAttributeSwitchActionsWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
...
- (void)subscribeAttributeSwitchTypeWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
- (void)writeAttributeSwitchActionsWithValue:(id)arg1 completion:(id /* block */)arg2;
- (void)writeAttributeSwitchActionsWithValue:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)writeAttributeSwitchActionsWithValue:(id)arg1 params:(id)arg2 completion:(id /* block */)arg3;
