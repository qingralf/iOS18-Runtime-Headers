...
+ (void)readAttributeTemperatureUnitWithAttributeCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completionHandler:(id /* block */)arg4;
+ (void)readAttributeTemperatureUnitWithClusterStateCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;
...
- (void)readAttributeTemperatureUnitWithCompletion:(id /* block */)arg1;
- (void)readAttributeTemperatureUnitWithCompletionHandler:(id /* block */)arg1;
...
- (void)subscribeAttributeTemperatureUnitWithMinInterval:(id)arg1 maxInterval:(id)arg2 params:(id)arg3 subscriptionEstablished:(id /* block */)arg4 reportHandler:(id /* block */)arg5;
- (void)subscribeAttributeTemperatureUnitWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
- (void)writeAttributeTemperatureUnitWithValue:(id)arg1 completion:(id /* block */)arg2;
- (void)writeAttributeTemperatureUnitWithValue:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)writeAttributeTemperatureUnitWithValue:(id)arg1 params:(id)arg2 completion:(id /* block */)arg3;
- (void)writeAttributeTemperatureUnitWithValue:(id)arg1 params:(id)arg2 completionHandler:(id /* block */)arg3;
