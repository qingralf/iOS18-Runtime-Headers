...
+ (void)readAttributeMACAddressWithAttributeCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (void)readAttributeMACAddressWithCompletionHandler:(id /* block */)arg1;
...
- (void)subscribeAttributeMACAddressWithMinInterval:(id)arg1 maxInterval:(id)arg2 params:(id)arg3 subscriptionEstablished:(id /* block */)arg4 reportHandler:(id /* block */)arg5;
