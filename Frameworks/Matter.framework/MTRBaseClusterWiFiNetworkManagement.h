...
+ (void)readAttributePassphraseSurrogateWithClusterStateCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;
+ (void)readAttributeSSIDWithClusterStateCache:(id)arg1 endpoint:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;

- (void)networkPassphraseRequestWithCompletion:(id /* block */)arg1;
- (void)networkPassphraseRequestWithParams:(id)arg1 completion:(id /* block */)arg2;
...
- (void)readAttributePassphraseSurrogateWithCompletion:(id /* block */)arg1;
- (void)readAttributeSSIDWithCompletion:(id /* block */)arg1;
...
- (void)subscribeAttributePassphraseSurrogateWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
- (void)subscribeAttributeSSIDWithParams:(id)arg1 subscriptionEstablished:(id /* block */)arg2 reportHandler:(id /* block */)arg3;
