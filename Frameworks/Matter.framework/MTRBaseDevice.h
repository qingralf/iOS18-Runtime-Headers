...
@property (nonatomic, readonly) MTRDeviceController_Concrete *concreteController;
...
- (void).cxx_destruct;
- (void)_invokeCommandWithEndpointID:(id)arg1 clusterID:(id)arg2 commandID:(id)arg3 commandFields:(id)arg4 timedInvokeTimeout:(id)arg5 serverSideProcessingTimeout:(id)arg6 logCall:(bool)arg7 queue:(id)arg8 completion:(id /* block */)arg9;
- (void)_invokeKnownCommandWithEndpointID:(id)arg1 clusterID:(id)arg2 commandID:(id)arg3 commandPayload:(id)arg4 timedInvokeTimeout:(id)arg5 serverSideProcessingTimeout:(id)arg6 responseClass:(Class)arg7 queue:(id)arg8 completion:(id /* block */)arg9;
...
- (void)_readKnownAttributeWithEndpointID:(id)arg1 clusterID:(id)arg2 attributeID:(id)arg3 params:(id)arg4 queue:(id)arg5 completion:(id /* block */)arg6;
- (void)_subscribeToKnownAttributeWithEndpointID:(id)arg1 clusterID:(id)arg2 attributeID:(id)arg3 params:(id)arg4 queue:(id)arg5 reportHandler:(id /* block */)arg6 subscriptionEstablished:(id /* block */)arg7;
- (void)_writeAttributeWithEndpointID:(id)arg1 clusterID:(id)arg2 attributeID:(id)arg3 value:(id)arg4 timedWriteTimeout:(id)arg5 queue:(id)arg6 completion:(id /* block */)arg7;
- (id)concreteController;
...
- (void)readAttributePaths:(id)arg1 eventPaths:(id)arg2 params:(id)arg3 includeDataVersion:(bool)arg4 queue:(id)arg5 completion:(id /* block */)arg6;
