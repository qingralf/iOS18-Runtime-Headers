...
+ (id)describeMatterCertificate:(id)arg1;
+ (id)describeX509Certificate:(id)arg1;
+ (id)fabricIDFromCertificate:(id)arg1;
+ (void)printMatterCertificate:(id)arg1;
+ (void)printX509Certificate:(id)arg1;
+ (id)shortDescriptionForMatterCertificate:(id)arg1;
+ (id)shortDescriptionForX509Certificate:(id)arg1;
