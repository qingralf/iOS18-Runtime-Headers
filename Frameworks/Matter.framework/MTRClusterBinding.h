...
- (id)readAttributeBindingWithParams:(id)arg1;
...
- (void)writeAttributeBindingWithValue:(id)arg1 expectedValueInterval:(id)arg2;
- (void)writeAttributeBindingWithValue:(id)arg1 expectedValueInterval:(id)arg2 params:(id)arg3;
