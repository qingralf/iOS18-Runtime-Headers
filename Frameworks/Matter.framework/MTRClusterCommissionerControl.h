...
- (void)commissionNodeWithParams:(id)arg1 expectedValues:(id)arg2 expectedValueInterval:(id)arg3 completion:(id /* block */)arg4;
...
- (id)readAttributeSupportedDeviceCategoriesWithParams:(id)arg1;
- (void)requestCommissioningApprovalWithParams:(id)arg1 expectedValues:(id)arg2 expectedValueInterval:(id)arg3 completion:(id /* block */)arg4;
