...
- (id)readAttributeTCAcceptedVersionWithParams:(id)arg1;
- (id)readAttributeTCAcknowledgementsRequiredWithParams:(id)arg1;
- (id)readAttributeTCAcknowledgementsWithParams:(id)arg1;
- (id)readAttributeTCMinRequiredVersionWithParams:(id)arg1;
- (id)readAttributeTCUpdateDeadlineWithParams:(id)arg1;
...
- (void)setTCAcknowledgementsWithParams:(id)arg1 expectedValues:(id)arg2 expectedValueInterval:(id)arg3 completion:(id /* block */)arg4;
