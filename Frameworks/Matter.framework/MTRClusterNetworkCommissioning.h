...
- (void)queryIdentityWithParams:(id)arg1 expectedValues:(id)arg2 expectedValueInterval:(id)arg3 completion:(id /* block */)arg4;
...
- (id)readAttributeSupportedThreadFeaturesWithParams:(id)arg1;
- (id)readAttributeSupportedWiFiBandsWithParams:(id)arg1;
...
- (void)scanNetworksWithExpectedValues:(id)arg1 expectedValueInterval:(id)arg2 completion:(id /* block */)arg3;
