...
- (void).cxx_destruct;
- (void)_readKnownCachedAttributeWithEndpointID:(unsigned short)arg1 clusterID:(unsigned int)arg2 attributeID:(unsigned int)arg3 queue:(id)arg4 completion:(id /* block */)arg5;
- (id)baseDevice;
