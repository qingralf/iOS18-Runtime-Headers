...
- (id)readAttributeTemperatureUnitWithParams:(id)arg1;
- (void)writeAttributeTemperatureUnitWithValue:(id)arg1 expectedValueInterval:(id)arg2;
- (void)writeAttributeTemperatureUnitWithValue:(id)arg1 expectedValueInterval:(id)arg2 params:(id)arg3;
