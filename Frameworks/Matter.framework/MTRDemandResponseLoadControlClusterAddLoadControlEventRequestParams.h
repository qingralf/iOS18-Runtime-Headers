...
@interface MTRDemandResponseLoadControlClusterAddLoadControlEventRequestParams : NSObject <NSCopying> {
    MTRDemandResponseLoadControlClusterLoadControlEventStruct * _event;
    NSNumber * _serverSideProcessingTimeout;
    NSNumber * _timedInvokeTimeoutMs;
}

@property (nonatomic, copy) MTRDemandResponseLoadControlClusterLoadControlEventStruct *event;
