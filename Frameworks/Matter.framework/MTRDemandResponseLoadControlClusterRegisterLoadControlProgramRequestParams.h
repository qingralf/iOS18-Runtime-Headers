...
@interface MTRDemandResponseLoadControlClusterRegisterLoadControlProgramRequestParams : NSObject <NSCopying> {
    MTRDemandResponseLoadControlClusterLoadControlProgramStruct * _loadControlProgram;
    NSNumber * _serverSideProcessingTimeout;
    NSNumber * _timedInvokeTimeoutMs;
}

@property (nonatomic, copy) MTRDemandResponseLoadControlClusterLoadControlProgramStruct *loadControlProgram;
...
- (id)description;
- (id)init;
- (id)loadControlProgram;
- (id)serverSideProcessingTimeout;
- (void)setLoadControlProgram:(id)arg1;
