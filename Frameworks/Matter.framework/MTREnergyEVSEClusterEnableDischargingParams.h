...
@interface MTREnergyEVSEClusterEnableDischargingParams : NSObject <NSCopying> {
    NSNumber * _dischargingEnabledUntil;
    NSNumber * _maximumDischargeCurrent;
    NSNumber * _serverSideProcessingTimeout;
    NSNumber * _timedInvokeTimeoutMs;
}

@property (nonatomic, copy) NSNumber *dischargingEnabledUntil;
...
- (id)description;
- (id)dischargingEnabledUntil;
- (id)init;
- (id)maximumDischargeCurrent;
- (id)serverSideProcessingTimeout;
- (void)setDischargingEnabledUntil:(id)arg1;
