...
@interface MTRGeneralCommissioningClusterSetTCAcknowledgementsParams : NSObject <NSCopying> {
    ...
    NSNumber * _tcUserResponse;
    NSNumber * _tcVersion;
    NSNumber * _timedInvokeTimeoutMs;
}

@property (nonatomic, copy) NSNumber *serverSideProcessingTimeout;
@property (nonatomic, copy) NSNumber *tcUserResponse;
@property (nonatomic, copy) NSNumber *tcVersion;
...
- (void)setTcUserResponse:(id)arg1;
- (void)setTcVersion:(id)arg1;
