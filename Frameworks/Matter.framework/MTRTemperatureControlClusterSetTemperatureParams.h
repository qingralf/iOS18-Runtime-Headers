...
@interface MTRTemperatureControlClusterSetTemperatureParams : NSObject <NSCopying> {
    ...
    NSNumber * _targetTemperature;
    NSNumber * _targetTemperatureLevel;
    NSNumber * _timedInvokeTimeoutMs;
}

@property (nonatomic, copy) NSNumber *serverSideProcessingTimeout;
@property (nonatomic, copy) NSNumber *targetTemperature;
...
- (void)setTargetTemperatureLevel:(id)arg1;
- (void)setTimedInvokeTimeoutMs:(id)arg1;
- (id)targetTemperature;
- (id)targetTemperatureLevel;
