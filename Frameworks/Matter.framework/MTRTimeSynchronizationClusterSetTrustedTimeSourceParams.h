...
@interface MTRTimeSynchronizationClusterSetTrustedTimeSourceParams : NSObject <NSCopying> {
    ...
    MTRTimeSynchronizationClusterFabricScopedTrustedTimeSourceStruct * _trustedTimeSource;
}

@property (nonatomic, copy) NSNumber *serverSideProcessingTimeout;
@property (nonatomic, copy) NSNumber *timedInvokeTimeoutMs;
@property (nonatomic, copy) MTRTimeSynchronizationClusterFabricScopedTrustedTimeSourceStruct *trustedTimeSource;
...
- (void)setTrustedTimeSource:(id)arg1;
- (id)timedInvokeTimeoutMs;
- (id)trustedTimeSource;
