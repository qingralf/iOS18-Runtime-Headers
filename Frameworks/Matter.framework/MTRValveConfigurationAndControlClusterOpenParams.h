...
@interface MTRValveConfigurationAndControlClusterOpenParams : NSObject <NSCopying> {
    NSNumber * _openDuration;
    NSNumber * _serverSideProcessingTimeout;
    NSNumber * _targetLevel;
    NSNumber * _timedInvokeTimeoutMs;
}

@property (nonatomic, copy) NSNumber *openDuration;
@property (nonatomic, copy) NSNumber *serverSideProcessingTimeout;
@property (nonatomic, copy) NSNumber *targetLevel;
...
- (void)setOpenDuration:(id)arg1;
- (void)setServerSideProcessingTimeout:(id)arg1;
- (void)setTargetLevel:(id)arg1;
