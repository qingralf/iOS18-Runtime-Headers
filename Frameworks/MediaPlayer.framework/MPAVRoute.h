...
@property (getter=isB498Route, nonatomic, readonly) bool b498Route;
...
@property (getter=isB735ERoute, nonatomic, readonly) bool b735ERoute;
@property (getter=isB735MRoute, nonatomic, readonly) bool b735MRoute;
@property (getter=isB768CHERoute, nonatomic, readonly) bool b768CHERoute;
@property (getter=isB768CHMRoute, nonatomic, readonly) bool b768CHMRoute;
@property (getter=isB768ERoute, nonatomic, readonly) bool b768ERoute;
@property (getter=isB768MRoute, nonatomic, readonly) bool b768MRoute;
...
@property (getter=isVisionRoute, nonatomic, readonly) bool visionRoute;
