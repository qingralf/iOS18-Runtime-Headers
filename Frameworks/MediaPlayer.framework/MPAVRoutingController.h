...
+ (void)_getActiveRouteWithTimeout:(double)arg1 type:(long long)arg2 completion:(id /* block */)arg3;
...
+ (void)getProactiveRouteWithCompletion:(id /* block */)arg1;
+ (void)getProactiveRouteWithTimeout:(double)arg1 completion:(id /* block */)arg2;
