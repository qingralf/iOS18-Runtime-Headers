...
@property (nonatomic, readonly) MSVDistributedNotificationObserver *favoriteSongAddToLibraryBehaviorChangedObserver;
...
- (void).cxx_destruct;
- (void)_addItemWithAdamID:(long long)arg1 toCollaborationWithPersistentID:(long long)arg2 completionHandler:(id /* block */)arg3;
- (void)_addItemWithSagaID:(unsigned long long)arg1 toCollaborationWithPersistentID:(long long)arg2 completionHandler:(id /* block */)arg3;
...
- (bool)_isCollaborativePlaylist:(unsigned long long)arg1;
...
- (long long)_storeAdamIDForItemWithSagaID:(unsigned long long)arg1;
...
- (id)favoriteSongAddToLibraryBehaviorChangedObserver;
...
- (void)setLikedState:(long long)arg1 forAlbumWithStoreID:(long long)arg2 persistentID:(long long)arg3 timeStamp:(id)arg4 completion:(id /* block */)arg5;
- (void)setLikedState:(long long)arg1 forArtistWithStoreID:(long long)arg2 persistentID:(long long)arg3 timeStamp:(id)arg4 completion:(id /* block */)arg5;
- (void)setLikedState:(long long)arg1 forEntityWithStoreID:(long long)arg2 persistentID:(long long)arg3 timeStamp:(id)arg4 completion:(id /* block */)arg5;
...
- (void)setLikedState:(long long)arg1 forPlaylistWithGlobalID:(id)arg2 persistentID:(long long)arg3 timeStamp:(id)arg4 completion:(id /* block */)arg5;
