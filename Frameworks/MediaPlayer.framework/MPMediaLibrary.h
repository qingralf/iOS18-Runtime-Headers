...
+ (id)mediaLibraryWithUniqueIdentifier:(id)arg1 userDSID:(id)arg2;
...
- (id)_addPlaylistWithName:(id)arg1 activeGeniusPlaylist:(bool)arg2 externalVendorIdentifier:(id)arg3 properties:(id)arg4 trackList:(id)arg5 playlistEntryProperties:(id)arg6;
...
- (id)addPlaylistWithName:(id)arg1 properties:(id)arg2 trackList:(id)arg3 playlistEntryProperties:(id)arg4;
...
- (id)securityScopedFileURLForAssetURL:(id)arg1;
...
- (id)syncValidity;
- (id)uniqueIdentifier;
- (unsigned long long)usageForSyncedMediaOfType:(unsigned long long)arg1;
- (id)userIdentity;
