...
@property (nonatomic, retain) MPArtworkColorAnalysisUtility *artworkColorAnalysisUtility;
...
- (void)_createColorAnalysisForArtwork:(id)arg1 catalog:(id)arg2 withCompletion:(id /* block */)arg3;
...
- (id)artworkColorAnalysisUtility;
...
- (void)setArtworkColorAnalysisUtility:(id)arg1;
