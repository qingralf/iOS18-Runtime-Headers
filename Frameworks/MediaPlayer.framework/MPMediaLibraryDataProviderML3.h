...
@property (nonatomic, readonly, copy) NSString *accountDSID; /* unknown property attribute: ? */
@property (nonatomic, readonly) <MPArtworkDataSource> *artworkDataSource;
@property (nonatomic, readonly) NSString *databasePath; /* unknown property attribute: ? */
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (readonly, copy) NSString *description;
@property (nonatomic, readonly) MPMediaEntityCache *entityCache;
@property (nonatomic, readonly) long long favoriteSongsPlaylistPersistentID; /* unknown property attribute: ? */
@property (readonly) unsigned long long hash;
@property (nonatomic, readonly) bool isGeniusEnabled; /* unknown property attribute: ? */
@property (nonatomic, retain) ML3MusicLibrary *library;
@property (nonatomic, readonly) NSArray *localizedSectionIndexTitles; /* unknown property attribute: ? */
@property (nonatomic) MPMediaLibrary *mediaLibrary;
@property (nonatomic, readonly) NSString *name;
@property (nonatomic, readonly) long long photosMemoriesPlaylistPersistentID; /* unknown property attribute: ? */
@property (nonatomic, readonly) long long playbackHistoryPlaylistPersistentID; /* unknown property attribute: ? */
@property (nonatomic, readonly) NSArray *preferredAudioLanguages; /* unknown property attribute: ? */
@property (nonatomic, readonly) NSArray *preferredSubtitleLanguages; /* unknown property attribute: ? */
@property (nonatomic, readonly) NSSet *propertiesToCache; /* unknown property attribute: ? */
@property (nonatomic, readonly) bool requiresAuthentication; /* unknown property attribute: ? */
@property (readonly) Class superclass;
@property (nonatomic, readonly) NSString *syncValidity; /* unknown property attribute: ? */
...
- (id)_adjustedItemPropertyBookletsOfEntity:(id)arg1 withDefaultValue:(id)arg2;
...
- (void)_importStoreAlbumArtistElements:(id)arg1 withReferralObject:(id)arg2 withCompletion:(id /* block */)arg3;
- (void)_importStoreItemElements:(id)arg1 withReferralObject:(id)arg2 addTracksToDeviceLibraryOnly:(bool)arg3 andAddTracksToCloudLibrary:(bool)arg4 usingCloudAdamID:(long long)arg5 withCompletion:(id /* block */)arg6;
- (void)_invalidatePersistentKeysForIdentifiers:(long long*)arg1 count:(unsigned long long)arg2;
...
- (void)addItemsWithIdentifiers:(id)arg1 andEntryProperties:(id)arg2 toPlaylistWithIdentifier:(long long)arg3 completionBlock:(id /* block */)arg4;
...
- (long long)addPlaylistWithValuesForProperties:(id)arg1 trackList:(id)arg2 playlistEntryProperties:(id)arg3;
...
- (long long)favoriteSongsPlaylistPersistentID;
- (bool)hasGeniusMixes;
...
- (void)sdk_addItemWithSagaIdentifier:(long long)arg1 toPlaylistWithIdentifier:(long long)arg2 completionBlock:(id /* block */)arg3;
- (long long)sdk_addPlaylistWithValuesForProperties:(id)arg1;
- (void)setItemsWithIdentifiers:(id)arg1 andEntryProperties:(id)arg2 forPlaylistWithIdentifier:(long long)arg3 completionBlock:(id /* block */)arg4;
...
- (void)setReactionText:(id)arg1 onEntryAtPosition:(unsigned long long)arg2 inPlaylistWithIdentifier:(long long)arg3 completion:(id /* block */)arg4;
...
- (void)setValuesForProperties:(id)arg1 trackList:(id)arg2 andEntryProperties:(id)arg3 ofPlaylistWithIdentifier:(long long)arg4 completionBlock:(id /* block */)arg5;
