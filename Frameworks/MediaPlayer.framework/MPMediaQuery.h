...
+ (id)vui_GenresQueryWithMediaLibrary:(id)arg1;
+ (id)vui_episodesQueryWithMediaLibrary:(id)arg1;
+ (bool)vui_hasEpisodesInSeasonsQueryWithMediaLibrary:(id)arg1 seasonCanonicalIds:(id)arg2;
...
+ (id)vui_tvShowsQueryWithMediaLibrary:(id)arg1;
