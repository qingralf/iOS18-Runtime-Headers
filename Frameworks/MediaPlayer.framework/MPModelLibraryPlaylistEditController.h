...
- (id)_initWithLibrary:(id)arg1 playlist:(id)arg2 initialTrackList:(id)arg3 playlistEntryProperties:(id)arg4 authorProfile:(id)arg5;
- (id)_itemIdentifierForIndexPath:(id)arg1 usingExclusiveAccessToken:(id)arg2;
- (id)_newDataSourceForModelObjects:(id)arg1;
...
- (id)initWithLibrary:(id)arg1 playlist:(id)arg2 initialTrackList:(id)arg3 playlistEntryProperties:(id)arg4 authorProfile:(id)arg5;
- (id)initWithLibrary:(id)arg1 playlist:(id)arg2 playlistEntryProperties:(id)arg3;
- (id)initWithLibrary:(id)arg1 playlist:(id)arg2 playlistEntryProperties:(id)arg3 authorProfile:(id)arg4;
- (id)initWithLibrary:(id)arg1 playlistEntryProperties:(id)arg2;
- (id)initWithLibrary:(id)arg1 playlistEntryProperties:(id)arg2 authorProfile:(id)arg3;
...
- (void)insertItems:(id)arg1 afterEntry:(id)arg2 completion:(id /* block */)arg3;
- (void)insertItems:(id)arg1 atIndexPath:(id)arg2 completion:(id /* block */)arg3;
- (void)insertItemsAtStart:(id)arg1 completion:(id /* block */)arg2;
