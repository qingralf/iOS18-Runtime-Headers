...
@property (nonatomic) bool disableImplicitSectioning; /* unknown property attribute: ? */
...
@property (nonatomic) bool shouldBatchResultsWithPlaceholderObjects; /* unknown property attribute: ? */
...
- (void)setLegacyMediaQuery:(id)arg1 forTransport:(bool)arg2;
