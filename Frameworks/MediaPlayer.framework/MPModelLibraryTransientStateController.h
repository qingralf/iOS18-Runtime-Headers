...
- (void)performFavoriteStateChangeRequest:(id)arg1 withRelatedModelObjects:(id)arg2;
- (void)performFavoriteStateChangeRequest:(id)arg1 withRelatedModelObjects:(id)arg2 completion:(id /* block */)arg3;
...
- (id)registerTransientFavoriteState:(long long)arg1 forModelObjects:(id)arg2 relatedModelObjects:(id)arg3;
