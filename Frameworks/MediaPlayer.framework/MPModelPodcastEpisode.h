...
@property (nonatomic, readonly) bool shouldShowChapterArtwork;
...
@property (nonatomic, copy) NSString *transcriptIdentifier;
@property (nonatomic, copy) NSString *transcriptSource;
