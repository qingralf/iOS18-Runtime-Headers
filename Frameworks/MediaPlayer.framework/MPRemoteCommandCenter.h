...
@interface MPRemoteCommandCenter : NSObject {
    ...
    <MPRemoteCommandCenterDelegate> * _delegate;
...
@property (nonatomic, readonly) MPRemoteCommand *clearUpNextCommand;
...
@property (nonatomic) <MPRemoteCommandCenterDelegate> *delegate;
...
@property (nonatomic, readonly) MPRemoteCommand *performDialogActionCommand;
...
@property (nonatomic, readonly) MPSetSleepTimerCommand *setSleepTimerCommand;
