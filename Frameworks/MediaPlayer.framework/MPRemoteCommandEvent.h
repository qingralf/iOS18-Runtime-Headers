...
@property (nonatomic, readonly) NSString *associatedParticipantIdentifier;
...
@property (nonatomic, readonly) NSArray *mpc_clientPreferredLanguages;
@property (nonatomic, readonly) NSString *nowPlayingContentItemID;
