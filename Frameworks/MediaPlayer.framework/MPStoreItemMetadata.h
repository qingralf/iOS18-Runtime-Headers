...
@property (nonatomic, readonly, copy) NSDate *endingAirDate;
...
@property (getter=isOnboardedPerson, nonatomic, readonly) bool onboardedPerson;
...
@property (nonatomic, readonly) bool radioStationIsSubscriptionOnly;
...
@property (nonatomic, readonly, copy) NSDate *startingAirDate;
...
@property (nonatomic, readonly) bool supportsSing;
