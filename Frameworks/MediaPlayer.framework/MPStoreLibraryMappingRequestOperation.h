...
@interface MPStoreLibraryMappingRequestOperation : MPAsyncOperation {
    NSArray * _albumArtistNamesToIdentifierSets;
...
@property (nonatomic, copy) NSArray *albumArtistNamesToIdentifierSets;
...
- (void).cxx_destruct;
- (id)albumArtistNamesToIdentifierSets;
- (void)execute;
- (id)identifierSets;
- (id)libraryView;
- (Class)modelClass;
- (id /* block */)responseHandler;
- (void)setAlbumArtistNamesToIdentifierSets:(id)arg1;
