...
- (void)_executeURLLoadWithRequest:(id)arg1 storeURLBag:(id)arg2 requestContext:(id)arg3;
- (void)_executeURLLoadWithRequests:(id)arg1 storeURLBag:(id)arg2 requestContext:(id)arg3;
