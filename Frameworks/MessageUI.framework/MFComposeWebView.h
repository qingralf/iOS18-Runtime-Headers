...
@interface MFComposeWebView : WKWebView <MFComposeBodyFieldObserver, MFMailMenuCommandProvider, WKNavigationDelegate, WKUIDelegatePrivate, _WKInputDelegate> {
    ...
    UIBarButtonItemGroup * _appleIntelligenceGroup;
    ...
    UIBarButtonItem * _documentItem;
    unsigned long long  _imageCount;
    UIView * _inputViewForPreservingFocus;
    UIBarButtonItemGroup * _insertAttachmentGroup;
    bool  _isFinishing;
    bool  _isQuickReply;
    ...
    MSInputContextHistory * _previousInputContextHistory;
...
@property (nonatomic, retain) UIBarButtonItemGroup *appleIntelligenceGroup;
...
@property (nonatomic, retain) UIBarButtonItem *documentItem;
@property (readonly) unsigned long long hash;
@property (nonatomic, retain) UIView *inputViewForPreservingFocus;
@property (nonatomic, retain) UIBarButtonItemGroup *insertAttachmentGroup;
@property (nonatomic) bool isQuickReply;
@property (nonatomic) <MFMailComposeViewDelegate> *mailComposeViewDelegate;
@property (nonatomic, retain) MSInputContextHistory *previousInputContextHistory;
...
- (void)_didTapShowWritingTools:(id)arg1;
...
- (void)_insertMediaWithAssetIdentifier:(id)arg1 mediaURL:(id)arg2 mediaType:(id)arg3 mediaData:(id)arg4 isVideo:(bool)arg5 completion:(id /* block */)arg6;
...
- (void)_pasteAndMatchStyleKeyCommandInvoked:(id)arg1;
...
- (void)_updateAppearanceForWritingToolsSession:(bool)arg1;
...
- (void)composeBodyFieldSmartReplyAvailable:(id /* block */)arg1;
...
- (void)insertMediaWithPhotoPickerItem:(id)arg1 completion:(id /* block */)arg2;
...
- (id)previousInputContextHistory;
...
- (void)removeMediaWithContentIdentifier:(id)arg1;
...
- (void)setAppleIntelligenceGroup:(id)arg1;
...
- (void)setDocumentItem:(id)arg1;
- (void)setInputViewForPreservingFocus:(id)arg1;
- (void)setInsertAttachmentGroup:(id)arg1;
...
- (void)setPreviousInputContextHistory:(id)arg1;
