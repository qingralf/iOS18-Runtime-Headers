...
- (void)launchAssetViewerForItem:(id)arg1 editContent:(bool)arg2 requireCopy:(bool)arg3 completion:(id /* block */)arg4;
- (void)launchAssetViewerForURL:(id)arg1 editContent:(bool)arg2 requireCopy:(bool)arg3 completion:(id /* block */)arg4;
