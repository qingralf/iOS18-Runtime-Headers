...
@interface _MFMailCompositionContext : NSObject <EMCollectionChangeObserver, MFMailCompositionAdditionalDonating, MFMailCompositionShareSheetRecipients, MFMailCompositionValuesProtocol> {
    ...
    long long  _deferredAction;
    NSDictionary * _deferredActionUserInfo;
...
@property (nonatomic, retain) NSDictionary *deferredActionUserInfo;
...
@property (nonatomic, retain) FPSandboxingURLWrapper *sharingSandboxingURLWrapper;
...
- (void).cxx_destruct;
- (id)UTITypes;
- (void)_loadMessageWithAutosaveIdentifier:(id)arg1 messageRepository:(id)arg2 originalMessageObjectID:(id)arg3;
- (void)_loadMessageWithObjectID:(id)arg1 mailboxObjectID:(id)arg2 messageRepository:(id)arg3 mailboxProvider:(id)arg4;
- (void)_notifyDidFinishLoadingWithLegacyMessage:(id)arg1;
...
- (long long)deferredAction;
- (id)deferredActionUserInfo;
...
- (id)initDraftRestoreOfMessage:(id)arg1 legacyMessage:(id)arg2 draftSubject:(id)arg3;
...
- (id)initRecoveredAutosavedMessageWithIdentifier:(id)arg1 draftSubject:(id)arg2 composeType:(long long)arg3 messageRepository:(id)arg4 originalMessageObjectID:(id)arg5;
- (id)initRecoveredAutosavedMessageWithIdentifier:(id)arg1 draftSubject:(id)arg2 messageRepository:(id)arg3 originalMessageObjectID:(id)arg4;
...
- (void)setDeferredAction:(long long)arg1;
- (void)setDeferredActionUserInfo:(id)arg1;
...
- (void)setSharingSandboxingURLWrapper:(id)arg1;
...
- (id)sharingSandboxingURLWrapper;
