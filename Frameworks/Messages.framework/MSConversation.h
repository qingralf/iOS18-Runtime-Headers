...
@property (nonatomic, readonly) NSArray *contextItems;
...
@property (nonatomic, readonly) NSString *generatedSummary;
...
- (void)_insertAttachment:(id)arg1 withAlternateFilename:(id)arg2 skipShelf:(bool)arg3 generativePlaygroundRecipe:(id)arg4 completionHandler:(id /* block */)arg5;
- (void)_insertGenerativePlaygroundAsset:(id)arg1 recipeData:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (void)_insertSticker:(id)arg1 skipShelf:(bool)arg2 frameInWindowCoordinates:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg3 completionHandler:(id /* block */)arg4;
...
- (void)insertSticker:(id)arg1 withSourceFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 completionHandler:(id /* block */)arg3;
