...
- (void)_presentAlertSheetWithTitle:(id)arg1 message:(id)arg2 buttonTitles:(id)arg3 styles:(id)arg4 completion:(id /* block */)arg5;
...
- (void)_presentContextMenuWithButtonTitles:(id)arg1 imageNames:(id)arg2 buttonFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg3 completion:(id /* block */)arg4;
...
- (void)willPresentEditingViewWithAssetURL:(id)arg1 recipeData:(id)arg2 completion:(id /* block */)arg3;
- (void)willPresentEditingViewWithAssetURL:(id)arg1 sandboxExtension:(id)arg2 recipeData:(id)arg3 completion:(id /* block */)arg4;
