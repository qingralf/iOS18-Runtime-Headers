...
@interface MSSticker : NSObject <MSStickerPrivate> {
    <IMImageDataProtocol> * __imageData;
...
@property (nonatomic, retain) <IMImageDataProtocol> *_imageData;
...
+ (struct CGSize { double x1; double x2; })_frameSizeFromFrameProperties:(id)arg1;
+ (bool)_isHEICSupported;
+ (bool)_isImageSourceAdaptiveImageGlyph:(struct CGImageSource { }*)arg1;
+ (id)_stickerRepresentationRoleForAdaptiveImageGlyphFrameWithProperties:(id)arg1;
