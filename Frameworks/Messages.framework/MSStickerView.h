...
@interface MSStickerView : UIView <IMAnimationTimerObserver, UIDragInteractionDelegate_Private, UIGestureRecognizerDelegate> {
    bool  _animating;
    ...
    NSArray * _frames;
    <IMAnimatedImageProtocol> * _image;
...
@property (nonatomic, retain) <IMAnimatedImageProtocol> *image;
@property (nonatomic, retain) <IMImageDataProtocol> *imageData;
