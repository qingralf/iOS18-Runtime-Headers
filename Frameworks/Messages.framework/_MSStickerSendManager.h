...
- (id)delegate;
- (id)hostBundleID;
- (void)insertSticker:(id)arg1 forceStage:(bool)arg2 frameInRemoteView:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg3 completionHandler:(id /* block */)arg4;
