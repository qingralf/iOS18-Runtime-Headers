...
@interface MTLCompiler : NSObject {
    struct MTLCompilerConnectionManager { int (**x1)(); int x2; bool x3; int x4; } * _compilerConnectionManager;
...
@property (readonly) struct MTLCompilerConnectionManager { int (**x1)(); int x2; bool x3; int x4; }*compilerConnectionManager;
...
- (void)addLegacyCompiledOutput:(id)arg1 cachedCompiledOutput:(id)arg2 importedSymbols:(id)arg3 importedLibraries:(id)arg4 hashKey:(id)arg5 type:(BOOL)arg6 functionCache:(struct shared_ptr<MultiLevelBinaryCache> { struct MultiLevelBinaryCache {} *x1; struct __shared_weak_count {} *x2; })arg7;
- (void)addLegacyCompiledOutput:(id)arg1 importedSymbols:(id)arg2 importedLibraries:(id)arg3 hashKey:(id)arg4 type:(BOOL)arg5 functionCache:(struct shared_ptr<MultiLevelBinaryCache> { struct MultiLevelBinaryCache {} *x1; struct __shared_weak_count {} *x2; })arg6;
...
- (void)cacheLegacyCompilerData:(void*)arg1 cachedData:(void*)arg2 hashMap:(void*)arg3 libraryData:(void*)arg4 functionCache:(struct shared_ptr<MultiLevelBinaryCache> { struct MultiLevelBinaryCache {} *x1; struct __shared_weak_count {} *x2; })arg5;
...
- (void)compileRequest:(id)arg1 binaryArchives:(id)arg2 failOnBinaryArchiveMiss:(bool)arg3 pipelineCache:(id)arg4 sync:(bool)arg5 completionHandler:(id /* block */)arg6;
...
- (void)compileRequestInternal:(id)arg1 binaryArchives:(id)arg2 failOnBinaryArchiveMiss:(bool)arg3 pipelineCache:(id)arg4 sync:(bool)arg5 completionHandler:(id /* block */)arg6;
- (void)compileStatelessFunctionRequest:(id)arg1 reflectionOnly:(bool)arg2 completionHandler:(id /* block */)arg3;
- (struct MTLCompilerConnectionManager { int (**x1)(); int x2; bool x3; int x4; }*)compilerConnectionManager;
- (unsigned long long)compilerFlags;
- (unsigned int)compilerId;
- (id)compilerQueue;
- (struct VariantEntry { char *x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; struct os_unfair_lock_s { unsigned int x_5_1_1; } x5; id x6; id x7; unsigned long long x8; id x9; id x10; }*)computeVariantEntryWithDescriptor:(id)arg1 airDescriptor:(id)arg2 options:(unsigned long long)arg3 serializedComputeDataDescriptor:(id)arg4 asyncCompile:(bool)arg5 pipelineCache:(id)arg6 destinationBinaryArchive:(id)arg7 computeProgram:(struct MTLProgramObject {}**)arg8 kernelDriverCompileTimeData:(id*)arg9 compileTimeStatistics:(id)arg10;
- (bool)copyShaderCacheToPath:(id)arg1;
- (void)createBinaryArchiveAsRecompileTarget:(bool)arg1 completionHandler:(id /* block */)arg2;
- (void)createBinaryArchiveWithCompletionHanlder:(id /* block */)arg1;
- (id)createErrorMessageWithRequest:(id)arg1 key:(id)arg2 cacheType:(const char *)arg3 itemLookedFor:(const char *)arg4;
...
- (void)dealloc;
- (id)downgradeFunctionRequest:(const struct MTLCompilerFunctionRequest { int (**x1)(); int x2; id x3; unsigned int x4; id x5; id x6; unsigned int x7; unsigned int x8; unsigned int x9; id x10; id x11; unsigned long long x12; id x13; id x14; id x15; id x16; int x17; bool x18; unsigned int x19; bool x20; char *x21; void *x22; id x23; unsigned long long x24; id x25; id x26; }*)arg1 targetLLVMVersion:(unsigned int)arg2 frameworkData:(void*)arg3 error:(id*)arg4;
- (bool)downgradeRequest:(struct MTLCompilerFunctionRequest { int (**x1)(); int x2; id x3; unsigned int x4; id x5; id x6; unsigned int x7; unsigned int x8; unsigned int x9; id x10; id x11; unsigned long long x12; id x13; id x14; id x15; id x16; int x17; bool x18; unsigned int x19; bool x20; char *x21; void *x22; id x23; unsigned long long x24; id x25; id x26; }*)arg1 frameworkData:(void*)arg2 error:(id*)arg3;
- (void)generateMachOWithID:(const char *)arg1 binaryEntries:(struct shared_ptr<std::vector<machOEntry>> { void *x1; struct __shared_weak_count {} *x2; })arg2 machOSpecializedData:(const void*)arg3 machOType:(int)arg4 Path:(id)arg5 platform:(unsigned long long)arg6 bitcodeList:(struct shared_ptr<std::unordered_map<MTLUINT256_t, NSObject<OS_dispatch_data> *, UnorderedContainerHash, UnorderedContainerHash>> { void *x1; struct __shared_weak_count {} *x2; })arg7 completionHandler:(id /* block */)arg8;
- (struct MTLHashKey { struct MTLHashMask<4> { unsigned long long x_1_1_1; unsigned long long x_1_1_2; unsigned char x_1_1_3; } x1; struct { unsigned char x_2_1_1[32]; } x2; struct vector<MTLUINT256_t, std::allocator<MTLUINT256_t>> { struct { /* ? */ } *x_3_1_1; struct { /* ? */ } *x_3_1_2; struct __compressed_pair<MTLUINT256_t *, std::allocator<MTLUINT256_t>> { struct { /* ? */ } *x_3_2_1; } x_3_1_3; } x3; })getBuiltInFunctionId:(struct { unsigned char x1[32]; }*)arg1;
...
- (struct MTLHashKey { struct MTLHashMask<4> { unsigned long long x_1_1_1; unsigned long long x_1_1_2; unsigned char x_1_1_3; } x1; struct { unsigned char x_2_1_1[32]; } x2; struct vector<MTLUINT256_t, std::allocator<MTLUINT256_t>> { struct { /* ? */ } *x_3_1_1; struct { /* ? */ } *x_3_1_2; struct __compressed_pair<MTLUINT256_t *, std::allocator<MTLUINT256_t>> { struct { /* ? */ } *x_3_2_1; } x_3_1_3; } x3; })getFunctionId:(id)arg1;
- (struct MTLHashKey { struct MTLHashMask<4> { unsigned long long x_1_1_1; unsigned long long x_1_1_2; unsigned char x_1_1_3; } x1; struct { unsigned char x_2_1_1[32]; } x2; struct vector<MTLUINT256_t, std::allocator<MTLUINT256_t>> { struct { /* ? */ } *x_3_1_1; struct { /* ? */ } *x_3_1_2; struct __compressed_pair<MTLUINT256_t *, std::allocator<MTLUINT256_t>> { struct { /* ? */ } *x_3_2_1; } x_3_1_3; } x3; })getFunctionId:(id)arg1 airScript:(const void*)arg2 vendorPluginFunctionId:(struct { unsigned char x1[32]; }*)arg3;
- (struct MTLHashKey { struct MTLHashMask<4> { unsigned long long x_1_1_1; unsigned long long x_1_1_2; unsigned char x_1_1_3; } x1; struct { unsigned char x_2_1_1[32]; } x2; struct vector<MTLUINT256_t, std::allocator<MTLUINT256_t>> { struct { /* ? */ } *x_3_1_1; struct { /* ? */ } *x_3_1_2; struct __compressed_pair<MTLUINT256_t *, std::allocator<MTLUINT256_t>> { struct { /* ? */ } *x_3_2_1; } x_3_1_3; } x3; })getFunctionId:(id)arg1 airScript:(const void*)arg2 vendorPluginFunctionId:(struct { unsigned char x1[32]; }*)arg3 bitcodeHashList:(void*)arg4;
...
- (id)newLinkedFunctionsBitcodeFromRequest:(id)arg1 hashKey:(void*)arg2;
...
- (id)pipelineStateWithVariant:(struct VariantEntry { char *x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; struct os_unfair_lock_s { unsigned int x_5_1_1; } x5; id x6; id x7; unsigned long long x8; id x9; id x10; }*)arg1 descriptor:(id)arg2 options:(unsigned long long)arg3 computeProgram:(void*)arg4 kernelDriverCompileTimeData:(id)arg5 serializedComputeDataDescriptor:(id)arg6 compileTimeStatistics:(id)arg7 reflection:(id*)arg8 error:(id*)arg9 completionHandler:(id /* block */)arg10;
- (id)pluginPath;
...
- (id)renderPipelineStateWithTileVariant:(struct VariantEntry { char *x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; struct os_unfair_lock_s { unsigned int x_5_1_1; } x5; id x6; id x7; unsigned long long x8; id x9; id x10; }*)arg1 descriptor:(id)arg2 options:(unsigned long long)arg3 tileProgram:(void*)arg4 kernelDriverCompileTimeData:(id)arg5 serializedTileDataDescriptor:(id)arg6 compileTimeStatistics:(id)arg7 reflection:(id*)arg8 error:(id*)arg9 completionHandler:(id /* block */)arg10;
...
- (struct VariantEntry { char *x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; struct os_unfair_lock_s { unsigned int x_5_1_1; } x5; id x6; id x7; unsigned long long x8; id x9; id x10; }*)tileVariantEntryWithDescriptor:(id)arg1 airDescriptor:(id)arg2 options:(unsigned long long)arg3 serializedTileDataDescriptor:(id)arg4 asyncCompile:(bool)arg5 destinationBinaryArchive:(id)arg6 tileProgram:(struct MTLProgramObject {}**)arg7 kernelDriverCompileTimeData:(id*)arg8 compileTimeStatistics:(id)arg9;
