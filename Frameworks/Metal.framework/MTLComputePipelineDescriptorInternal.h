...
- (const struct MTLComputePipelineDescriptorPrivate { id x1; id x2; bool x3; unsigned short x4; id x5; id x6; id x7; id x8; id x9; union { id x_10_1_1; id x_10_1_2; } x10; id x11; bool x12; long long x13; long long x14; long long x15; bool x16; unsigned long long x17; id x18; bool x19; unsigned int x20 : 1; unsigned int x21 : 1; unsigned int x22 : 1; unsigned int x23 : 29; id x24; id x25; unsigned long long x26; bool x27; id x28; unsigned long long x29; }*)_descriptorPrivate;
- (id)binaryArchives;
- (id)binaryLibraries;
- (id)buffers;
- (id)computeFunction;
...
- (void)setInternalPipeline:(bool)arg1;
