...
- (id)initWithSerializedData:(id)arg1 dynamicLibraries:(id)arg2 serializedStageInputDescriptor:(id)arg3 device:(id)arg4 options:(unsigned long long)arg5 flags:(struct { unsigned int x1 : 1; unsigned int x2 : 1; unsigned int x3 : 1; unsigned int x4 : 1; unsigned int x5 : 1; unsigned int x6 : 59; })arg6;
