...
- (id)initWithObjectData:(id)arg1 objectDynamicLibraries:(id)arg2 meshData:(id)arg3 meshDynamicLibraries:(id)arg4 fragmentData:(id)arg5 fragmentDynamicLibraries:(id)arg6 device:(id)arg7 options:(unsigned long long)arg8 flags:(struct { unsigned int x1 : 1; unsigned int x2 : 1; unsigned int x3 : 1; unsigned int x4 : 1; unsigned int x5 : 1; unsigned int x6 : 1; unsigned int x7 : 1; unsigned int x8 : 1; unsigned int x9 : 1; unsigned int x10 : 1; unsigned int x11 : 1; unsigned int x12 : 53; })arg9;
...
- (id)initWithTileData:(id)arg1 tileDynamicLibraries:(id)arg2 functionType:(unsigned long long)arg3 device:(id)arg4 options:(unsigned long long)arg5 flags:(struct { unsigned int x1 : 1; unsigned int x2 : 1; unsigned int x3 : 1; unsigned int x4 : 1; unsigned int x5 : 1; unsigned int x6 : 1; unsigned int x7 : 1; unsigned int x8 : 1; unsigned int x9 : 1; unsigned int x10 : 1; unsigned int x11 : 1; unsigned int x12 : 53; })arg6;
...
- (id)initWithVertexData:(id)arg1 vertexDynamicLibraries:(id)arg2 fragmentData:(id)arg3 fragmentDynamicLibraries:(id)arg4 serializedVertexDescriptor:(id)arg5 device:(id)arg6 options:(unsigned long long)arg7 flags:(struct { unsigned int x1 : 1; unsigned int x2 : 1; unsigned int x3 : 1; unsigned int x4 : 1; unsigned int x5 : 1; unsigned int x6 : 1; unsigned int x7 : 1; unsigned int x8 : 1; unsigned int x9 : 1; unsigned int x10 : 1; unsigned int x11 : 1; unsigned int x12 : 53; })arg8;
- (id)meshArguments;
- (id)meshBindings;
