...
@interface _MTLBinaryArchive : _MTLObjectWithLabel <MTLBinaryArchiveSPI> {
    ...
    struct unordered_map<unsigned long long, std::vector<MTLHashKey>, std::hash<unsigned long long>, std::equal_to<unsigned long long>, std::allocator<std::pair<const unsigned long long, std::vector<MTLHashKey>>>> { 
        struct __hash_table<std::__hash_value_type<unsigned long long, std::vector<MTLHashKey>>, std::__unordered_map_hasher<unsigned long long, std::__hash_value_type<unsigned long long, std::vector<MTLHashKey>>, std::hash<unsigned long long>, std::equal_to<unsigned long long>>, std::__unordered_map_equal<unsigned long long, std::__hash_value_type<unsigned long long, std::vector<MTLHashKey>>, std::equal_to<unsigned long long>, std::hash<unsigned long long>>, std::allocator<std::__hash_value_type<unsigned long long, std::vector<MTLHashKey>>>> { 
            struct unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<unsigned long long, std::vector<MTLHashKey>>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<unsigned long long, std::vector<MTLHashKey>>, void *> *> *>>> { 
                struct __compressed_pair<std::__hash_node_base<std::__hash_node<std::__hash_value_type<unsigned long long, std::vector<MTLHashKey>>, void *> *> **, std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<unsigned long long, std::vector<MTLHashKey>>, void *> *> *>>> { 
                    void **__value_; 
                    struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<unsigned long long, std::vector<MTLHashKey>>, void *> *> *>> { 
                        struct __compressed_pair<unsigned long, std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<unsigned long long, std::vector<MTLHashKey>>, void *> *> *>> { 
                            unsigned long long __value_; 
                        } __data_; 
                    } __value_; 
                } __ptr_; 
            } __bucket_list_; 
            struct __compressed_pair<std::__hash_node_base<std::__hash_node<std::__hash_value_type<unsigned long long, std::vector<MTLHashKey>>, void *> *>, std::allocator<std::__hash_node<std::__hash_value_type<unsigned long long, std::vector<MTLHashKey>>, void *>>> { 
                struct __hash_node_base<std::__hash_node<std::__hash_value_type<unsigned long long, std::vector<MTLHashKey>>, void *> *> { 
                    void *__next_; 
                } __value_; 
            } __p1_; 
            struct __compressed_pair<unsigned long, std::__unordered_map_hasher<unsigned long long, std::__hash_value_type<unsigned long long, std::vector<MTLHashKey>>, std::hash<unsigned long long>, std::equal_to<unsigned long long>>> { 
                unsigned long long __value_; 
            } __p2_; 
            struct __compressed_pair<float, std::__unordered_map_equal<unsigned long long, std::__hash_value_type<unsigned long long, std::vector<MTLHashKey>>, std::equal_to<unsigned long long>, std::hash<unsigned long long>>> { 
                float __value_; 
            } __p3_; 
        } __table_; 
    }  _airntBinaryList;
    ...
    struct unordered_map<MTLHashKey, std::tuple<unsigned long long, unsigned long long, unsigned long long, unsigned long long>, CompareFunctionIdHash, CompareFunctionIdHash, std::allocator<std::pair<const MTLHashKey, std::tuple<unsigned long long, unsigned long long, unsigned long long, unsigned long long>>>> { 
        struct __hash_table<std::__hash_value_type<MTLHashKey, std::tuple<unsigned long long, unsigned long long, unsigned long long, unsigned long long>>, std::__unordered_map_hasher<MTLHashKey, std::__hash_value_type<MTLHashKey, std::tuple<unsigned long long, unsigned long long, unsigned long long, unsigned long long>>, CompareFunctionIdHash, CompareFunctionIdHash>, std::__unordered_map_equal<MTLHashKey, std::__hash_value_type<MTLHashKey, std::tuple<unsigned long long, unsigned long long, unsigned long long, unsigned long long>>, CompareFunctionIdHash, CompareFunctionIdHash>, std::allocator<std::__hash_value_type<MTLHashKey, std::tuple<unsigned long long, unsigned long long, unsigned long long, unsigned long long>>>> { 
            struct unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLHashKey, std::tuple<unsigned long long, unsigned long long, unsigned long long, unsigned long long>>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLHashKey, std::tuple<unsigned long long, unsigned long long, unsigned long long, unsigned long long>>, void *> *> *>>> { 
                struct __compressed_pair<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLHashKey, std::tuple<unsigned long long, unsigned long long, unsigned long long, unsigned long long>>, void *> *> **, std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLHashKey, std::tuple<unsigned long long, unsigned long long, unsigned long long, unsigned long long>>, void *> *> *>>> { 
                    ...
                    struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLHashKey, std::tuple<unsigned long long, unsigned long long, unsigned long long, unsigned long long>>, void *> *> *>> { 
                        struct __compressed_pair<unsigned long, std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLHashKey, std::tuple<unsigned long long, unsigned long long, unsigned long long, unsigned long long>>, void *> *> *>> { 
                            unsigned long long __value_; 
                        } __data_; 
                    } __value_; 
                } __ptr_; 
            ...
            struct __compressed_pair<unsigned long, std::__unordered_map_hasher<MTLHashKey, std::__hash_value_type<MTLHashKey, std::tuple<unsigned long long, unsigned long long, unsigned long long, unsigned long long>>, CompareFunctionIdHash, CompareFunctionIdHash>> { 
                unsigned long long __value_; 
            } __p2_; 
            struct __compressed_pair<float, std::__unordered_map_equal<MTLHashKey, std::__hash_value_type<MTLHashKey, std::tuple<unsigned long long, unsigned long long, unsigned long long, unsigned long long>>, CompareFunctionIdHash, CompareFunctionIdHash>> { 
                float __value_; 
            } __p3_; 
        } __table_; 
    ...
    struct unordered_map<MTLHashKey, MTLOpaqueGPUArchiverUnitId *, CompareFunctionIdHash, CompareFunctionIdHash, std::allocator<std::pair<const MTLHashKey, MTLOpaqueGPUArchiverUnitId *>>> { 
        struct __hash_table<std::__hash_value_type<MTLHashKey, MTLOpaqueGPUArchiverUnitId *>, std::__unordered_map_hasher<MTLHashKey, std::__hash_value_type<MTLHashKey, MTLOpaqueGPUArchiverUnitId *>, CompareFunctionIdHash, CompareFunctionIdHash>, std::__unordered_map_equal<MTLHashKey, std::__hash_value_type<MTLHashKey, MTLOpaqueGPUArchiverUnitId *>, CompareFunctionIdHash, CompareFunctionIdHash>, std::allocator<std::__hash_value_type<MTLHashKey, MTLOpaqueGPUArchiverUnitId *>>> { 
            struct unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLHashKey, MTLOpaqueGPUArchiverUnitId *>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLHashKey, MTLOpaqueGPUArchiverUnitId *>, void *> *> *>>> { 
                struct __compressed_pair<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLHashKey, MTLOpaqueGPUArchiverUnitId *>, void *> *> **, std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLHashKey, MTLOpaqueGPUArchiverUnitId *>, void *> *> *>>> { 
                    void **__value_; 
                    struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLHashKey, MTLOpaqueGPUArchiverUnitId *>, void *> *> *>> { 
                        struct __compressed_pair<unsigned long, std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLHashKey, MTLOpaqueGPUArchiverUnitId *>, void *> *> *>> { 
                            unsigned long long __value_; 
                        } __data_; 
                    } __value_; 
                } __ptr_; 
            } __bucket_list_; 
            struct __compressed_pair<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLHashKey, MTLOpaqueGPUArchiverUnitId *>, void *> *>, std::allocator<std::__hash_node<std::__hash_value_type<MTLHashKey, MTLOpaqueGPUArchiverUnitId *>, void *>>> { 
                struct __hash_node_base<std::__hash_node<std::__hash_value_type<MTLHashKey, MTLOpaqueGPUArchiverUnitId *>, void *> *> { 
                    void *__next_; 
                } __value_; 
            } __p1_; 
            struct __compressed_pair<unsigned long, std::__unordered_map_hasher<MTLHashKey, std::__hash_value_type<MTLHashKey, MTLOpaqueGPUArchiverUnitId *>, CompareFunctionIdHash, CompareFunctionIdHash>> { 
                unsigned long long __value_; 
            } __p2_; 
            struct __compressed_pair<float, std::__unordered_map_equal<MTLHashKey, std::__hash_value_type<MTLHashKey, MTLOpaqueGPUArchiverUnitId *>, CompareFunctionIdHash, CompareFunctionIdHash>> { 
                float __value_; 
            } __p3_; 
        } __table_; 
    }  _gpuArchiverIDMap;
    ...
    struct unordered_map<MTLUINT256_t, MTLAirEntry *, UnorderedContainerHash, UnorderedContainerHash, std::allocator<std::pair<const MTLUINT256_t, MTLAirEntry *>>> { 
        struct __hash_table<std::__hash_value_type<MTLUINT256_t, MTLAirEntry *>, std::__unordered_map_hasher<MTLUINT256_t, std::__hash_value_type<MTLUINT256_t, MTLAirEntry *>, UnorderedContainerHash, UnorderedContainerHash>, std::__unordered_map_equal<MTLUINT256_t, std::__hash_value_type<MTLUINT256_t, MTLAirEntry *>, UnorderedContainerHash, UnorderedContainerHash>, std::allocator<std::__hash_value_type<MTLUINT256_t, MTLAirEntry *>>> { 
            struct unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLUINT256_t, MTLAirEntry *>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLUINT256_t, MTLAirEntry *>, void *> *> *>>> { 
                struct __compressed_pair<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLUINT256_t, MTLAirEntry *>, void *> *> **, std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLUINT256_t, MTLAirEntry *>, void *> *> *>>> { 
                    void **__value_; 
                    struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLUINT256_t, MTLAirEntry *>, void *> *> *>> { 
                        struct __compressed_pair<unsigned long, std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLUINT256_t, MTLAirEntry *>, void *> *> *>> { 
                            unsigned long long __value_; 
                        } __data_; 
                    } __value_; 
                } __ptr_; 
            } __bucket_list_; 
            struct __compressed_pair<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLUINT256_t, MTLAirEntry *>, void *> *>, std::allocator<std::__hash_node<std::__hash_value_type<MTLUINT256_t, MTLAirEntry *>, void *>>> { 
                struct __hash_node_base<std::__hash_node<std::__hash_value_type<MTLUINT256_t, MTLAirEntry *>, void *> *> { 
                    void *__next_; 
                } __value_; 
            } __p1_; 
            struct __compressed_pair<unsigned long, std::__unordered_map_hasher<MTLUINT256_t, std::__hash_value_type<MTLUINT256_t, MTLAirEntry *>, UnorderedContainerHash, UnorderedContainerHash>> { 
                unsigned long long __value_; 
            } __p2_; 
            struct __compressed_pair<float, std::__unordered_map_equal<MTLUINT256_t, std::__hash_value_type<MTLUINT256_t, MTLAirEntry *>, UnorderedContainerHash, UnorderedContainerHash>> { 
                float __value_; 
            } __p3_; 
        } __table_; 
    }  _specializedFunctionByHash;
    struct unordered_map<MTLUINT256_t, id<MTLLibrarySPI>, UnorderedContainerHash, UnorderedContainerHash, std::allocator<std::pair<const MTLUINT256_t, id<MTLLibrarySPI>>>> { 
        struct __hash_table<std::__hash_value_type<MTLUINT256_t, id<MTLLibrarySPI>>, std::__unordered_map_hasher<MTLUINT256_t, std::__hash_value_type<MTLUINT256_t, id<MTLLibrarySPI>>, UnorderedContainerHash, UnorderedContainerHash>, std::__unordered_map_equal<MTLUINT256_t, std::__hash_value_type<MTLUINT256_t, id<MTLLibrarySPI>>, UnorderedContainerHash, UnorderedContainerHash>, std::allocator<std::__hash_value_type<MTLUINT256_t, id<MTLLibrarySPI>>>> { 
            struct unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLUINT256_t, id<MTLLibrarySPI>>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLUINT256_t, id<MTLLibrarySPI>>, void *> *> *>>> { 
                struct __compressed_pair<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLUINT256_t, id<MTLLibrarySPI>>, void *> *> **, std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLUINT256_t, id<MTLLibrarySPI>>, void *> *> *>>> { 
                    void **__value_; 
                    struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLUINT256_t, id<MTLLibrarySPI>>, void *> *> *>> { 
                        struct __compressed_pair<unsigned long, std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLUINT256_t, id<MTLLibrarySPI>>, void *> *> *>> { 
                            unsigned long long __value_; 
                        } __data_; 
                    } __value_; 
                } __ptr_; 
            } __bucket_list_; 
            struct __compressed_pair<std::__hash_node_base<std::__hash_node<std::__hash_value_type<MTLUINT256_t, id<MTLLibrarySPI>>, void *> *>, std::allocator<std::__hash_node<std::__hash_value_type<MTLUINT256_t, id<MTLLibrarySPI>>, void *>>> { 
                struct __hash_node_base<std::__hash_node<std::__hash_value_type<MTLUINT256_t, id<MTLLibrarySPI>>, void *> *> { 
                    void *__next_; 
                } __value_; 
            } __p1_; 
            struct __compressed_pair<unsigned long, std::__unordered_map_hasher<MTLUINT256_t, std::__hash_value_type<MTLUINT256_t, id<MTLLibrarySPI>>, UnorderedContainerHash, UnorderedContainerHash>> { 
                unsigned long long __value_; 
            } __p2_; 
            struct __compressed_pair<float, std::__unordered_map_equal<MTLUINT256_t, std::__hash_value_type<MTLUINT256_t, id<MTLLibrarySPI>>, UnorderedContainerHash, UnorderedContainerHash>> { 
                float __value_; 
            } __p3_; 
        } __table_; 
...
+ (struct MTLLoaderSliceIdentifier { int x1; int x2; })sliceIDForSpecializedFunctionsForLLVMVersion:(int)arg1;
...
- (void)addStitchedLibraryWithKey:(const struct { unsigned char x1[32]; }*)arg1 descriptors:(const void*)arg2 inputFunctions:(id)arg3 library:(id)arg4;
- (void)addStitchingInputsFunction:(id)arg1 toEntry:(id)arg2;
...
- (id)getFunctionNameFromAirDescriptor:(const struct stitchedAirDescriptor { id x1; struct { unsigned char x_2_1_1[32]; } x2; }*)arg1;
- (id)getLibraryDescriptorWithAirScrpt:(const struct StitchingScript { unsigned char x1[1]; }*)arg1;
...
- (bool)loadAirSliceAtOffset:(unsigned long long)arg1 sliceLength:(unsigned long long)arg2;
...
- (id)localStitchedFunctionLookupWithDescriptor:(const struct stitchedAirDescriptor { id x1; struct { unsigned char x_2_1_1[32]; } x2; }*)arg1;
...
- (void)materializeAirNTAllForSlice:(const struct MTLLoaderSliceIdentifier { int x1; int x2; }*)arg1 entryList:(struct shared_ptr<std::vector<machOEntry>> { void *x1; struct __shared_weak_count {} *x2; })arg2;
- (void)materializeAirNTFromOnlineForSlice:(const struct MTLLoaderSliceIdentifier { int x1; int x2; }*)arg1 entryList:(struct shared_ptr<std::vector<machOEntry>> { void *x1; struct __shared_weak_count {} *x2; })arg2;
- (void)materializeAirNTSpecializedFunctions:(struct shared_ptr<std::vector<machOEntry>> { void *x1; struct __shared_weak_count {} *x2; })arg1;
- (void)materializeAirNTStitchedFunctions:(struct shared_ptr<std::vector<machOEntry>> { void *x1; struct __shared_weak_count {} *x2; })arg1;
...
- (void)materializeLinkedBitcodes:(void*)arg1 hashList:(void*)arg2;
...
- (id)newComputePipelineDescriptorWithScript:(const struct PipelineScript { unsigned char x1[1]; }*)arg1 obj:(void*)arg2 destinationArchive:(id)arg3 error:(id*)arg4;
- (id)newFunctionDescriptorWithAirScript:(const struct ConstantsSpecializationScript { unsigned char x1[1]; }*)arg1;
- (id)newMeshRenderPipelineDescriptorWithScript:(const struct PipelineScript { unsigned char x1[1]; }*)arg1 obj:(void*)arg2 destinationArchive:(id)arg3 error:(id*)arg4;
- (id)newRecompiledFunctionWithAIRNTObject:(void*)arg1 destinationArchive:(id)arg2 error:(id*)arg3;
- (id)newRecompiledFunctionWithAIRNTObject:(void*)arg1 index:(unsigned long long)arg2 destinationArchive:(id)arg3 error:(id*)arg4;
- (id)newRenderPipelineDescriptorWithScript:(const struct PipelineScript { unsigned char x1[1]; }*)arg1 obj:(void*)arg2 destinationArchive:(id)arg3 error:(id*)arg4;
- (id)newSpecializedFunctionWithHash:(struct { unsigned char x1[32]; }*)arg1 libraryPath:(id)arg2;
- (id)newStitchedLibraryWithKey:(const struct { unsigned char x1[32]; }*)arg1 descriptors:(const void*)arg2;
- (id)newTileRenderPipelineDescriptorWithScript:(const struct PipelineScript { unsigned char x1[1]; }*)arg1 obj:(void*)arg2 destinationArchive:(id)arg3 error:(id*)arg4;
- (unsigned long long)options;
- (void*)pipelineCollection;
- (void)preloadLibrariesInAirntObject:(void*)arg1 error:(id*)arg2;
- (void*)programObjectForFunction:(const struct { unsigned char x1[32]; }*)arg1;
- (bool)recompilationTarget;
- (id)recompileFunction:(id)arg1 inLibrary:(id)arg2 toArchive:(id)arg3 toBinary:(bool)arg4 error:(id*)arg5;
...
- (struct { unsigned char x1[32]; })reflectionHashWithFunctionId:(const void*)arg1 binaryPos:(unsigned long long)arg2;
...
- (void)setMTLLinkedFunctions:(id)arg1 LFS:(const struct LinkedFunctions { unsigned char x1[1]; }*)arg2 obj:(void*)arg3 destinationArchive:(id)arg4 error:(id*)arg5;
