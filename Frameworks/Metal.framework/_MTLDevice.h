...
@property (nonatomic, readonly) <MTLLogState> *defaultLogState;
...
- (id)_newDescriptorForSharedTexture:(struct __IOSurface { }*)arg1;
...
- (struct MTLCompilerConnectionManager { int (**x1)(); int x2; bool x3; int x4; }*)getCompilerConnectionManager:(int)arg1;
...
- (id)newLibraryWithFunctionArray:(id)arg1 error:(id*)arg2;
