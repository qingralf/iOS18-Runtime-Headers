...
- (id)newSpecializedFunctionWithHash:(const struct { unsigned char x1[32]; }*)arg1 libraryPath:(id)arg2;
- (id)newStitchedFunctionWithHash:(const struct { unsigned char x1[32]; }*)arg1;
- (id)overrideTriple;
