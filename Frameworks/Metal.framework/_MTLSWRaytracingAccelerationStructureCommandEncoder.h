...
@interface _MTLSWRaytracingAccelerationStructureCommandEncoder : _MTLObjectWithLabel <MTLAccelerationStructureCommandEncoderSPI> {
    ...
    bool  _virtualSubstreamOpen;
    bool  _virtualSubstreamsEnabled;
}
...
- (void)substreamSynchronizeAccelerationStructures:(id)arg1 access:(unsigned long long)arg2;
- (void)substreamSynchronizeDescriptor:(id)arg1 access:(unsigned long long)arg2;
