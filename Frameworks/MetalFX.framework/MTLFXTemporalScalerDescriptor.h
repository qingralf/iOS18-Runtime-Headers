...
@interface MTLFXTemporalScalerDescriptor : NSObject <NSCopying> {
    ...
    bool  reactiveMaskTextureEnabled;
    unsigned long long  reactiveMaskTextureFormat;
...
@property (getter=isReactiveMaskTextureEnabled, nonatomic) bool reactiveMaskTextureEnabled;
...
- (void)setReactiveMaskTextureEnabled:(bool)arg1;
- (void)setReactiveMaskTextureFormat:(unsigned long long)arg1;
- (void)setRequiresSynchronousInitialization:(bool)arg1;
