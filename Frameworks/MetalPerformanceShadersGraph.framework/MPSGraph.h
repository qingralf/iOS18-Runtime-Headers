...
- (id)callSymbolName:(id)arg1 inputTensors:(id)arg2 outputTypes:(id)arg3 name:(id)arg4;
- (id)callWithInputTensors:(id)arg1 outputTypes:(id)arg2 symbolName:(id)arg3 inliningOption:(unsigned long long)arg4 name:(id)arg5;
- (id)callWithInputTensors:(id)arg1 outputTypes:(id)arg2 symbolName:(id)arg3 name:(id)arg4;
...
- (id)dequantizeTensor:(id)arg1 LUTTensor:(id)arg2 axis:(long long)arg3 name:(id)arg4;
- (id)dequantizeTensor:(id)arg1 LUTTensor:(id)arg2 name:(id)arg3;
...
- (id)dequantizeTensor:(id)arg1 scaleTensor:(id)arg2 dataType:(unsigned int)arg3 name:(id)arg4;
...
- (id)dequantizeTensor:(id)arg1 scaleTensor:(id)arg2 zeroPointTensor:(id)arg3 dataType:(unsigned int)arg4 name:(id)arg5;
...
- (id)dequantizeTensor:(id)arg1 scaleTensor:(id)arg2 zeroPointTensor:(id)arg3 minTensor:(id)arg4 dataType:(unsigned int)arg5 name:(id)arg6;
...
- (id)quantizedGatherWithUpdatesTensor:(id)arg1 indicesTensor:(id)arg2 scaleTensor:(id)arg3 zeroPointTensor:(id)arg4 minTensor:(id)arg5 dequantDataType:(unsigned int)arg6 axis:(unsigned long long)arg7 batchDimensions:(unsigned long long)arg8 name:(id)arg9;
...
- (id)reciprocalSquareRootWithTensor:(id)arg1 name:(id)arg2;
...
- (id)scaledDotProductAttentionWithQueryTensor:(id)arg1 keyTensor:(id)arg2 valueTensor:(id)arg3 maskTensor:(id)arg4 scale:(float)arg5 name:(id)arg6;
- (id)scaledDotProductAttentionWithQueryTensor:(id)arg1 keyTensor:(id)arg2 valueTensor:(id)arg3 scale:(float)arg4 name:(id)arg5;
...
- (id)sliceGradientTensor:(id)arg1 fwdInShapeTensor:(id)arg2 startTensor:(id)arg3 endTensor:(id)arg4 strideTensor:(id)arg5 startMask:(unsigned int)arg6 endMask:(unsigned int)arg7 squeezeMask:(unsigned int)arg8 name:(id)arg9;
- (id)sliceGradientTensor:(id)arg1 fwdInShapeTensor:(id)arg2 startTensor:(id)arg3 sizeTensor:(id)arg4 squeezeMask:(unsigned int)arg5 name:(id)arg6;
...
- (id)sliceTensor:(id)arg1 startTensor:(id)arg2 endTensor:(id)arg3 strideTensor:(id)arg4 startMask:(unsigned int)arg5 endMask:(unsigned int)arg6 squeezeMask:(unsigned int)arg7 name:(id)arg8;
- (id)sliceTensor:(id)arg1 startTensor:(id)arg2 sizeTensor:(id)arg3 squeezeMask:(unsigned int)arg4 name:(id)arg5;
...
- (id)sliceUpdateDataTensor:(id)arg1 updateTensor:(id)arg2 starts:(id)arg3 ends:(id)arg4 strides:(id)arg5 name:(id)arg6;
- (id)sliceUpdateDataTensor:(id)arg1 updateTensor:(id)arg2 starts:(id)arg3 ends:(id)arg4 strides:(id)arg5 startMask:(unsigned int)arg6 endMask:(unsigned int)arg7 squeezeMask:(unsigned int)arg8 name:(id)arg9;
- (id)sliceUpdateDataTensor:(id)arg1 updateTensor:(id)arg2 startsTensor:(id)arg3 endsTensor:(id)arg4 stridesTensor:(id)arg5 name:(id)arg6;
- (id)sliceUpdateDataTensor:(id)arg1 updateTensor:(id)arg2 startsTensor:(id)arg3 endsTensor:(id)arg4 stridesTensor:(id)arg5 startMask:(unsigned int)arg6 endMask:(unsigned int)arg7 squeezeMask:(unsigned int)arg8 name:(id)arg9;
...
- (id)varFromTensorWithTensor:(id)arg1 name:(id)arg2;
- (id)variableFromTensorWithTensor:(id)arg1 name:(id)arg2;
- (id)variableOps;
