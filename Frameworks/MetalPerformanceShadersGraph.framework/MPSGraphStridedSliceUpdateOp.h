...
- (id)initWithGraph:(id)arg1 inputTensors:(id)arg2 controlDependencies:(id)arg3 startMask:(unsigned int)arg4 endMask:(unsigned int)arg5 shrinkAxisMask:(unsigned int)arg6 name:(id)arg7;
