...
@property (nonatomic, retain) <MDLObjectContainerComponent> *originals;
...
- (id)init;
- (id)initThroughSCNKitBridgeWithURL:(id)arg1 options:(id)arg2 error:(id)arg3;
...
- (id)initWithURL:(id)arg1 bufferAllocator:(id)arg2 preserveIndexing:(bool)arg3 options:(id)arg4 error:(id*)arg5;
...
+ (id)assetWithVFXNode:(id)arg1;
+ (id)assetWithVFXNode:(id)arg1 bufferAllocator:(id)arg2;
+ (id)assetWithVFXWorld:(id)arg1;
+ (id)assetWithVFXWorld:(id)arg1 bufferAllocator:(id)arg2;
