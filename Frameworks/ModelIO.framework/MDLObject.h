...
@property (nonatomic, readonly, retain) <MDLObjectContainerComponent> *safe_children;
...
+ (id)objectWithVFXNode:(id)arg1;
+ (id)objectWithVFXNode:(id)arg1 bufferAllocator:(id)arg2;

- (void)_updateAssociatedVFXNodeWithGeometrySetter:(id /* block */)arg1 texturePathProvider:(id /* block */)arg2 vertexAttributeNamed:(id)arg3 materialPropertyNamed:(id)arg4;
- (id)safe_children;
