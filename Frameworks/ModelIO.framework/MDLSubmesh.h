...
+ (id)newSubmeshWithGeometryData:(id)arg1 indexBufferLength:(unsigned long long)arg2 interleaved:(bool)arg3 channelCount:(unsigned long long)arg4 channelIdx:(unsigned long long)arg5 bytesPerIndex:(unsigned long long)arg6 indexType:(unsigned long long)arg7 geometryType:(long long)arg8 allocator:(id)arg9 indexCount:(unsigned long long)arg10 topology:(id)arg11;
+ (id)newSubmeshWithUniquedIndexData:(id)arg1 andVFXModelElement:(id)arg2 bufferAllocator:(id)arg3;
+ (id)newSubmeshWithVFXModelElement:(id)arg1 bufferAllocator:(id)arg2;
+ (id)newSubmeshWithVFXModelElement:(id)arg1 bufferAllocator:(id)arg2 positionSourceChannel:(unsigned long long)arg3;
+ (id)submeshWithUniquedIndexData:(id)arg1 andVFXModelElement:(id)arg2 bufferAllocator:(id)arg3;
+ (id)submeshWithVFXModelElement:(id)arg1;
+ (id)submeshWithVFXModelElement:(id)arg1 bufferAllocator:(id)arg2;
+ (id)submeshWithVFXModelElement:(id)arg1 bufferAllocator:(id)arg2 positionSourceChannel:(unsigned long long)arg3;
