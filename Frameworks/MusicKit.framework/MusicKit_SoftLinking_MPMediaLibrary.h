...
@property (nonatomic, readonly) MPMediaLibrary *_underlyingMediaLibrary;
...
- (void)setUserRating:(double)arg1 forItemWithPersistentID:(id)arg2;
- (long long)status;
- (id)uniqueIdentifier;

// Image: /System/Library/PrivateFrameworks/MusicKitInternal.framework/MusicKitInternal

+ (unsigned long long)_softLinkingContentGroupsForUnderlyingContentGroups:(unsigned long long)arg1;
+ (unsigned long long)_underlyingContentGroupsForSoftLinkingContentGroups:(unsigned long long)arg1;
+ (unsigned long long)_underlyingFilteringOptionsForSoftLinkingFilteringOptions:(unsigned long long)arg1;
