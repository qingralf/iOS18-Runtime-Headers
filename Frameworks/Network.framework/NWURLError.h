...
@property (nonatomic, retain) NSNumber *blockedTrackerFailure;
@property (nonatomic, retain) NSData *downloadTaskResumeData;
...
- (void).cxx_destruct;
- (id)blockedTrackerFailure;
- (id)copyWithZone:(struct _NSZone { }*)arg1;
- (void)dealloc;
- (id)downloadTaskResumeData;
...
- (id)resolutionReport;
- (void)setBlockedTrackerFailure:(id)arg1;
- (void)setDownloadTaskResumeData:(id)arg1;
