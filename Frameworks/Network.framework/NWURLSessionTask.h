...
@interface NWURLSessionTask : NSObject <NSCopying, NSProgressReporting, NWRedactedDescription, NWURLLoaderClient> {
...
@property (nonatomic, readonly) struct { unsigned char x1[16]; unsigned int x2; } logDescription;
@property (nonatomic, readonly) NSObject<OS_nw_context> *networkContext;
@property (nonatomic, readonly, copy) NSURLRequest *originalRequest;
@property bool prefersIncrementalDelivery;
@property float priority;
@property (nonatomic, readonly) NSProgress *progress;
@property (readonly, copy) NSString *redactedDescription; /* unknown property attribute: ? */
...
- (void)loaderDidReceiveInformationalResponse:(id)arg1;
- (void)loaderDidReceiveServerTrustChallenge:(id)arg1 secProtocolMetadata:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (void)loaderFailedToConnect:(id)arg1;
