...
- (void)showLocalNetworkAlertForApp:(id)arg1 pid:(int)arg2 uuid:(id)arg3 query:(id)arg4 hasEntitlement:(bool)arg5 completionQueue:(id)arg6 handler:(id /* block */)arg7;
