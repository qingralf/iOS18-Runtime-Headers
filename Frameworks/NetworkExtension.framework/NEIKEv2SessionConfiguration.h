...
- (void)setPpk:(id)arg1;
- (void)setPpkID:(id)arg1;
- (void)setPpkIDType:(unsigned long long)arg1;
- (void)setPpkMandatory:(bool)arg1;
- (void)setPpkReference:(id)arg1;
