...
- (id)initAndShowAlertWithHeader:(id)arg1 message:(id)arg2 alternateMessage:(id)arg3 defaultMessage:(id)arg4 noBoldDefault:(bool)arg5 usePrivacyIcon:(bool)arg6 extensionItem:(id)arg7 callbackQueue:(id)arg8 callbackHandler:(id /* block */)arg9;
...
- (id)initAndShowLocalNetworkAlertWithAppName:(id)arg1 reasonString:(id)arg2 extensionItem:(id)arg3 callbackQueue:(id)arg4 callbackHandler:(id /* block */)arg5;
