...
+ (bool)compareAppRules:(id)arg1 newAppRules:(id)arg2 noExistingDomain:(bool*)arg3;
+ (id)findRuleWithSameDomains:(id)arg1 matchSigningIdentifier:(id)arg2 startIndex:(long long*)arg3;
