...
+ (id)annotationAdaptorWithPDFAnnotation:(id)arg1 andCGPDFAnnotation:(struct CGPDFAnnotation { }*)arg2 andPDFDictionary:(struct CGPDFDictionary { }*)arg3 updatePDFAnnotationIfNeeded:(bool)arg4;
+ (void)associatePDFAnnotation:(id)arg1 withAKAnnotation:(id)arg2;
+ (id)getPDFAnnotationAssociatedWith:(id)arg1;
