...
@interface PDFAnnotation : NSObject <CRFormFieldProviding, NSCoding, NSCopying> {
    ...
    <NSCopying> * _akAnnotationForCopying;
    ...
    bool  _isAutofillNewContextStart;
    bool  _isDetectedCheckbox;
    bool  _isDetectedSignature;
    ...
    bool  _shouldBurnIn;
    bool  _shouldExport;
    bool  _shouldHideInteractiveBackgroundColor;
    ...
    bool  _suppressAppearanceStreamText;
...
@property bool autofillNewContextStart; /* unknown property attribute: ? */
...
@property (readonly) bool hasBoundedHeight; /* unknown property attribute: ? */
@property (readonly) bool hasBoundedWidth; /* unknown property attribute: ? */
...
@property (readonly) unsigned long long maxCharacterCount; /* unknown property attribute: ? */
...
@property double suggestedLineHeight; /* unknown property attribute: ? */
@property (readonly) Class superclass;
@property unsigned long long textContentType; /* unknown property attribute: ? */
...
+ (id)createDetectedTextFieldWithBounds:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 font:(id)arg2 textContentType:(id)arg3 page:(id)arg4;
...
- (void)drawAppearance:(struct CGPDFForm { }*)arg1 withBox:(long long)arg2 inContext:(struct CGContext { }*)arg3 inRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg4 scaleProportional:(bool)arg5 suppressTextRendering:(bool)arg6;
...
- (void)setAutofillEntryType:(unsigned long long)arg1;
