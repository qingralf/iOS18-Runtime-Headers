...
+ (void)drawAppearance:(int)arg1 ofAnnotation:(id)arg2 withBox:(long long)arg3 inContext:(struct CGContext { }*)arg4 scaleProportional:(bool)arg5 suppressTextRendering:(bool)arg6;
...
+ (void)drawCommentIconInRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 withColor:(id)arg2 inContext:(struct CGContext { }*)arg3;
+ (void)drawCommonCommentNoteIconToContext:(struct CGContext { }*)arg1 colorComponents:(double*)arg2 rect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg3;
...
+ (void)drawHelpIconInRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 withColor:(id)arg2 inContext:(struct CGContext { }*)arg3;
...
+ (void)drawInsertIconInRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 withColor:(id)arg2 inContext:(struct CGContext { }*)arg3;
+ (void)drawKeyIconInRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 withColor:(id)arg2 inContext:(struct CGContext { }*)arg3;
...
+ (void)drawNewParagraphIconInRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 withColor:(id)arg2 inContext:(struct CGContext { }*)arg3;
+ (void)drawNoteAsSelected:(struct CGContext { }*)arg1 rect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2;
+ (void)drawNoteIconInRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 withColor:(id)arg2 inContext:(struct CGContext { }*)arg3;
+ (void)drawNoteInContext:(struct CGContext { }*)arg1 withParentAnnotation:(id)arg2;
+ (void)drawParagraphIconInRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 withColor:(id)arg2 inContext:(struct CGContext { }*)arg3;
