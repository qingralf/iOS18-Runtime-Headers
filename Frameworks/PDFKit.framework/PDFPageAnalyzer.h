...
+ (struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })_normalizedToPageTransformForPageWithBounds:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
+ (id)sharedInstance;
...
- (bool)_addTableFromAnalysis:(id)arg1 bounds:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 toPDFPage:(id)arg3;
- (void)_addTextFromAnalysis:(id)arg1 ofImage:(id)arg2 bounds:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg3 toPage:(id)arg4;
- (void)_callCompletionBlock:(id /* block */)arg1 onQueue:(id)arg2 analysis:(id)arg3 error:(id)arg4 foundTable:(bool)arg5;
...
- (id)init;
- (void)proposedFormFieldBoundsNearestPoint:(struct CGPoint { double x1; double x2; })arg1 onPage:(id)arg2 completionBlock:(id /* block */)arg3;
