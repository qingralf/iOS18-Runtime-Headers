...
- (bool)checkNodeForValidChannelLayouts:(id)arg1 assetRegistry:(id)arg2 outError:(id*)arg3;
...
- (id)init;
- (bool)processNode:(id)arg1 withArray:(id)arg2 assetRegistry:(id)arg3 outError:(id*)arg4;
