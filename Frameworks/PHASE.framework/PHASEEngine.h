...
@interface PHASEEngine : NSObject {
    ...
    bool  _enableRoomAcousticParametersTracking;
    ...
    double  _roomAcousticMaximumReverbTime;
    double  _roomAcousticSmoothing;
    bool  _roomAcousticSoftLimiting;
    PHASETargetRoomAcousticParameters * _roomAcousticTarget;
    long long  _roomAcousticTrackingMode;
    PHASEObject * _rootObject;
    double  _sampleRate;
    long long  _sceneClassification;
    NSUUID * _sceneRoomUUID;
    double  _spaceBlendLevel;
    long long  _spaceBlendTargetPreset;
    struct { 
        /* Warning: Unrecognized filer type: '}' using 'void*' */ void*vector; 
    }  _spaceBlendTargetPresetOrientation;
    long long  _spatialHint;
...
@property (nonatomic) bool enableRoomAcousticParametersTracking;
...
@property (nonatomic, copy) NSUUID *sceneRoomUUID;
...
- (void*)implementation;
- (id)init;
- (bool)initInternalWithUpdateMode:(long long)arg1 engineMode:(long long)arg2 platform:(id)arg3 spatialMode:(long long)arg4;
...
- (id)initWithUpdateMode:(long long)arg1 spatialMode:(long long)arg2;
...
- (id)roomAcousticTarget;
- (long long)roomAcousticTrackingMode;
- (id)rootObject;
- (double)sampleRate;
...
- (void)setEnableRoomAcousticParametersTracking:(bool)arg1;
...
- (void)setRoomAcousticMaximumReverbTime:(double)arg1;
- (void)setRoomAcousticSmoothing:(double)arg1;
- (void)setRoomAcousticSoftLimiting:(bool)arg1;
- (void)setRoomAcousticTarget:(id)arg1;
- (void)setRoomAcousticTrackingMode:(long long)arg1;
- (void)setSceneClassification:(long long)arg1;
- (void)setSceneRoomUUID:(id)arg1;
- (void)setSpaceBlendLevel:(double)arg1;
- (void)setSpaceBlendTargetPreset:(long long)arg1;
...
- (void)setSpatialHint:(long long)arg1;
- (void)setTargetRoomAcousticParameters:(id)arg1;
- (void)setUnitsPerMeter:(double)arg1;
- (void)setUnitsPerSecond:(double)arg1;
- (id)soundEvents;
- (double)spaceBlendLevel;
- (long long)spaceBlendTargetPreset;
- (struct { })spaceBlendTargetPresetOrientation;
- (long long)spatialHint;
