...
- (id)_copyAndAddStroke:(id)arg1 transform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg2 inkTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg3 ink:(id)arg4 newParent:(id*)arg5;
...
- (void)_copyAndAddStrokes:(id)arg1 transform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg2 inkTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg3;
...
- (id)_originalDataUUIDToTransformedStrokeDictFromStrokes:(id)arg1 pathDict:(id)arg2 maskDict:(id)arg3 shouldUseStrokeDataUUID:(bool)arg4;
- (id)_originalStrokeDataUUIDToTransformedStrokeDictFromStrokes:(id)arg1 pathDict:(id)arg2 maskDict:(id)arg3;
- (id)_originalStrokeUUIDToTransformedStrokeDictFromStrokes:(id)arg1 pathDict:(id)arg2 maskDict:(id)arg3;
...
- (id)drawingByApplyingTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg1 transformInk:(bool)arg2;
...
- (id)strokes;
- (id)strokesForCHStrokeIdentifiers:(id)arg1;
- (id)strokesForCHStrokeIdentifiers:(id)arg1 didFindAllStrokes:(bool*)arg2;
...
- (id)undoableAddNewStrokes:(id)arg1 replacingOldStrokes:(id)arg2;
- (id)undoableDeleteStrokes:(id)arg1;
- (id)undoableMergeWithDrawing:(id)arg1;
