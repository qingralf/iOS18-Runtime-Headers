...
@property (nonatomic) UIWindow *_hostingWindow;
@property (setter=_setPlusButton:, nonatomic, retain) PKPaletteButton *_plusButton;
...
@property (nonatomic, readonly) bool canShowResetHandwritingEducationPane;
...
- (id)_paletteToolViewAtIndex:(unsigned long long)arg1;
- (double)_paletteWidthForHorizontalOrientation;
- (void)_pencilInteraction:(id)arg1 didReceiveSqueeze:(id)arg2;
- (void)_performPencilInteraction:(id)arg1 preferredAction:(long long)arg2;
...
- (void)_reloadImageForToolItem:(id)arg1;
- (void)_replaceToolAtIndex:(unsigned long long)arg1 withTool:(id)arg2 notifyDelegate:(bool)arg3;
- (void)_scrollToolViewAtIndex:(unsigned long long)arg1 toVisibleAnimated:(bool)arg2;
...
- (void)_setSelectedColor:(id)arg1 isFromExtendedColorPicker:(bool)arg2 isContinuousColorSelection:(bool)arg3;
- (void)_setSelectedToolColor:(id)arg1 ignoreColorOpacity:(bool)arg2 isContinuousColorSelection:(bool)arg3;
...
- (void)colorPickerDidChangeSelectedColor:(id)arg1 isFromExtendedColorPicker:(bool)arg2 isContinuousColorSelection:(bool)arg3;
...
- (bool)toolPicker:(id)arg1 canSelectTool:(id)arg2 fromTap:(bool)arg3;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })toolPickerViewSourceRectForPopoverPresentation:(id)arg1 fromCorner:(unsigned long long)arg2;
- (id)toolPickerViewSourceViewForPopoverPresentation:(id)arg1 fromCorner:(unsigned long long)arg2;
- (void)toolPreviewDidChangeToolColor:(id)arg1 isContinuousColorSelection:(bool)arg2;
- (id)tools;
