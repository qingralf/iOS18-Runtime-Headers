...
@interface PKHoverSettings : NSObject {
    ...
    bool  _toolPreviewActiveForTesting;
    ...
    bool  _toolShadowActiveOnOldPencils;
    bool  _toolShadowActiveOutsideNotes;
    double  _toolShadowFadeInDistance;
    bool  _toolShadowLocationWorkaround;
...
@property (nonatomic) bool toolPreviewActiveForTesting;
...
@property (nonatomic) bool toolShadowActiveOnOldPencils;
@property (nonatomic) bool toolShadowActiveOutsideNotes;
@property (nonatomic) double toolShadowFadeInDistance;
@property (nonatomic) bool toolShadowLocationWorkaround;
...
+ (void)checkIfHoverIsEnabled:(id /* block */)arg1;
...
- (void)setToolPreviewActiveForTesting:(bool)arg1;
...
- (void)setToolShadowActiveOnOldPencils:(bool)arg1;
- (void)setToolShadowActiveOutsideNotes:(bool)arg1;
- (void)setToolShadowFadeInDistance:(double)arg1;
- (void)setToolShadowLocationWorkaround:(bool)arg1;
