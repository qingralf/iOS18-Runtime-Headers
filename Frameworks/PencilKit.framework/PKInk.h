...
@property (nonatomic, readonly) unsigned long long particleRotation;
...
- (long long)_requiredContentVersionOverride;
...
- (void)set_requiredContentVersionOverride:(long long)arg1;
- (void)set_sixChannelAddColor;
- (void)set_sixChannelMultiplyColor;
- (void)set_weightIsUndefined:(bool)arg1;
- (id)variant;
