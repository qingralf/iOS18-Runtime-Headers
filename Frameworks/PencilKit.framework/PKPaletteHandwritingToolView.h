...
@interface PKPaletteHandwritingToolView : PKPaletteToolView <PKPaletteHandwritingTool> {
    id /* block */  __overrideLabelCenterOffsetYHandler;
...
@property (setter=_setOverrideLabelCenterOffsetYHandler:, nonatomic, copy) id /* block */ _overrideLabelCenterOffsetYHandler;
...
- (void).cxx_destruct;
- (id /* block */)_overrideLabelCenterOffsetYHandler;
- (void)_setOverrideLabelCenterOffsetYHandler:(id /* block */)arg1;
