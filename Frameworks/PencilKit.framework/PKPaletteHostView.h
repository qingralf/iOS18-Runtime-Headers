...
- (void)_dockPaletteToAutoHideCornerAnimated:(bool)arg1;
...
- (double)_paletteEdgeMarginForTopEdge:(bool)arg1 isMinimized:(bool)arg2;
...
- (void)setPaletteViewBottomEdgeSpacing:(double)arg1;
