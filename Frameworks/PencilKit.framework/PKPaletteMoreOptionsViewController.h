...
@property (nonatomic, retain) PKPaletteOptionSwitchCell *autoRefineCell;
@property (nonatomic, retain) PKPaletteOptionInfoCell *autoRefineNotReadyCell;
...
@property (nonatomic) bool isAutoRefineOn;
@property (nonatomic) bool isFingerDrawsOn;
@property (nonatomic, retain) PKPaletteOptionTitleCell *openPencilSettingsCell;
@property (nonatomic, retain) PKPaletteOptionTitleCell *resetHandwritingEducationPaneCell;
@property (nonatomic, retain) PKPaletteOptionTitleCell *resetImageWandOnboardingPaneCell;
...
@property (nonatomic, retain) PKPaletteOptionTitleCell *tapToRadarCell;

- (void).cxx_destruct;
- (void)_autoMinimizeCellDidChangeValue:(id)arg1;
- (void)_autoRefineCellDidChangeValue:(id)arg1;
...
- (void)_handleResetImageWandOnboardingCellTapped:(id)arg1;
...
- (id)resetHandwritingEducationPaneCell;
- (id)resetImageWandOnboardingPaneCell;
- (void)setAutoHideOn:(bool)arg1;
- (void)setAutoMinimizeCell:(id)arg1;
- (void)setAutoRefineCell:(id)arg1;
- (void)setAutoRefineNotReadyCell:(id)arg1;
- (void)setDelegate:(id)arg1;
- (void)setExternalTraitCollection:(id)arg1;
- (void)setFingerDrawsCell:(id)arg1;
- (void)setIsAutoRefineOn:(bool)arg1;
- (void)setIsFingerDrawsOn:(bool)arg1;
- (void)setOpenPencilSettingsCell:(id)arg1;
- (void)setResetHandwritingEducationPaneCell:(id)arg1;
- (void)setResetImageWandOnboardingPaneCell:(id)arg1;
