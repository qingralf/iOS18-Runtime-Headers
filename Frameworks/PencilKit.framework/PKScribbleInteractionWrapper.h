...
@property (nonatomic, readonly) UIView *interactionView; /* unknown property attribute: ? */
@property (readonly) Class superclass;
@property (nonatomic, readonly) UIView *view; /* unknown property attribute: ? */
...
- (id)interaction;
- (id)interactionView;
- (bool)isEditableElement:(id)arg1;
