...
@property (nonatomic) struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; } selectionDrawingStrokeTransform;
...
- (void)_handleDoubleTapInputAtPoint:(struct CGPoint { double x1; double x2; })arg1;
...
- (void)didDoubleTap;
- (void)didEndGestureWithTranslation:(struct CGPoint { double x1; double x2; })arg1;
- (id)doubleTapGR;
- (void)dragEnded:(struct CGPoint { double x1; double x2; })arg1;
- (id)dragGR;
- (id)dragInteraction;
...
- (void)paste:(id)arg1;
- (void)performDidEndGestureWithTranslation:(struct CGPoint { double x1; double x2; })arg1;
- (void)refine:(id)arg1;
- (struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })selectionDrawingStrokeTransform;
...
- (void)setSelectionDrawingStrokeTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg1;
...
- (void)transformChanged:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg1;
- (void)transformEnded;
