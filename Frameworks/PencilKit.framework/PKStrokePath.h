...
@property (nonatomic, readonly) bool hasAzimuthAngles;
...
- (void)_scaleRadius:(double)arg1 isVector:(bool)arg2;
- (unsigned long long)_startIndex;
- (id)_strokeDataUUID;
- (double)_timestamp;
- (void)_transform:(id /* block */)arg1 existingTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg2;
- (bool)canApplyDelta:(id)arg1;
- (id)copyTransformed:(id /* block */)arg1 inCoordinateSpace:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg2;
- (id)copyWithScaledRadius:(double)arg1 isVector:(bool)arg2;
- (id)copyWithStrokeDataUUID:(id)arg1;
