...
@property (readonly, copy) NSOrderedSet *visibleStrokeEncodedIdentifiers; /* unknown property attribute: ? */
...
- (id)cachedTranscriptionsIntersectingStrokeGroup:(id)arg1;
...
- (id)initWithDrawing:(id)arg1 visibleOnscreenStrokes:(id)arg2 shouldProcessVisibleStrokes:(bool)arg3 transcriptionCache:(id)arg4;
- (bool)isStroke:(id)arg1 versionOfStrokeWithIdentifier:(id)arg2;
- (bool)isValidStrokeIdentifier:(id)arg1;
- (id)orderedStrokes;
...
- (void)updateTranscriptionCache:(id)arg1;
