...
- (struct CGPoint { double x1; double x2; })_interpolatedPointForSplineSegment:(long long)arg1 t:(double)arg2 transform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg3;
- (double)_interpolatedTimeForSplineSegment:(long long)arg1 t:(double)arg2;
- (long long)_lastPointIndex;
- (double)_lengthOfSplineSegment:(unsigned long long)arg1 transform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg2;
- (struct CGPoint { double x1; double x2; })_splineControlPoint:(long long)arg1 transform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg2;
...
- (double)endTimestamp;
- (void)enumeratePointsWithDataStep:(double)arg1 usingBlock:(id /* block */)arg2;
