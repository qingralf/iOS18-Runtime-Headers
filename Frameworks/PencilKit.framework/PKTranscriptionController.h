...
@property (nonatomic) <PKAttachment> *attachment;
...
- (void)_receiveTranscription:(id)arg1;
...
- (bool)didShowHUD;
- (void)findCompleteTranscriptionForNote:(id /* block */)arg1;
