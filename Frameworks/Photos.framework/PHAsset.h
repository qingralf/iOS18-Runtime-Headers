...
@property (nonatomic, readonly) unsigned short adjustmentsState;
...
@property (nonatomic, readonly) unsigned short avalancheKind;
...
@property (nonatomic, readonly) short currentSmartStyleCast;
...
@property (nonatomic, readonly) bool faceAnalysisVersionWasFetched;
...
@property (nonatomic, readonly) PHAssetPhotosSmartStyleExtendedProperties *fetchSmartStyleExtendedProperties;
@property (nonatomic, readonly) NSString *filename;
@property (nonatomic, readonly) short generativeMemoryCreationEligibilityState;
...
@property (nonatomic, readonly) bool is60PlusFPS;
...
@property (nonatomic, readonly) bool isRecoveredAsset;
...
@property (nonatomic, readonly) bool isSpatialPresentation;
@property (nonatomic, readonly) bool isStreamedVideo;
@property (nonatomic, readonly) bool isStyleable;
...
@property (nonatomic, readonly) struct CGSize { double x1; double x2; } originalUnorientedSize;
...
@property (nonatomic, readonly) bool px_isSpatialMedia;
...
@property (nonatomic, readonly) NSAttributedString *px_searchDebugString;
...
+ (id)fetchAnyCinematicVideosNeedingDeferredProcessingWithOtions:(id)arg1;
+ (id)fetchAssetsAssociatedWithMomentsOfMemory:(id)arg1 options:(id)arg2;
+ (id)fetchAssetsCapturedOrEdited:(bool)arg1 onThisCameraSinceDate:(id)arg2 options:(id)arg3;
+ (id)fetchAssetsContainingAllPersons:(id)arg1 options:(id)arg2;
+ (id)fetchAssetsForBehavioralCurationWithOptions:(id)arg1;
+ (id)fetchAssetsForComment:(id)arg1 options:(id)arg2;
...
+ (id)fetchAssetsForPTPWithOptions:(id)arg1;
...
+ (id)fetchAssetsForStyleablePhotoSuggestionsWithOptions:(id)arg1;
...
+ (id)fetchAssetsThroughGraphEdgesForPerson:(id)arg1 options:(id)arg2;
...
+ (id)fetchCollageAssetsForDayHighlight:(id)arg1 options:(id)arg2;
...
+ (id)fetchExclusiveAssetsForSocialGroup:(id)arg1 options:(id)arg2;
+ (id)fetchExclusiveSocialGroupAssetsForPersons:(id)arg1 options:(id)arg2 error:(id*)arg3;
...
+ (id)fetchInclusiveAssetsForSocialGroup:(id)arg1 options:(id)arg2;
...
+ (id)fetchKeyAssetForEachSuggestion:(id)arg1 options:(id)arg2 useSuggestionsSortOrder:(bool)arg3;
+ (id)fetchKeyAssetForExtendedSceneIdentifier:(unsigned long long)arg1 aboveConfidenceThreshold:(double)arg2 minimumSceneAnalysisVersion:(short)arg3 options:(id)arg4;
+ (id)fetchKeyAssetForPerson:(id)arg1 options:(id)arg2;
...
+ (id)fetchKeyAssetForSocialGroup:(id)arg1 createIfNeeded:(bool)arg2 options:(id)arg3;
+ (id)fetchKeyAssetForSocialGroup:(id)arg1 options:(id)arg2;
...
+ (id)fetchVisibleAssetsWithObjectIDs:(id)arg1 options:(id)arg2;
...
+ (id)internalSortDescriptorsWithCreationDateAscending:(bool)arg1;
...
- (void)_setupSmartStyleFromFetchDictionary:(id)arg1;
...
- (unsigned short)adjustmentsState;
...
- (double)faceAreaMinY;
- (id)faceRegions;
- (id)fetchSmartStyleExtendedProperties;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })suggestedCropForAspectRatio:(double)arg1 withFocusRegion:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 andOutputCropScore:(out double*)arg3;
...
+ (float)mad_sceneConfidenceThresholdForTask:(unsigned long long)arg1;
...
+ (id)vcp_requiredAnalysisForNextAnalysisStage:(short)arg1;
+ (unsigned long long)vcp_shortMovieDurationThreshold;
+ (bool)vcp_usePHFace;
+ (bool)vcp_usePHFaceExpression;

- (short)mad_analysisStageAfterCompletingAnalysis:(unsigned long long)arg1;
- (short)mad_analysisStageAfterDroppingAnalysis:(unsigned long long)arg1;
- (bool)mad_isEligibleForAnalysis:(unsigned long long)arg1;
- (bool)mad_isEligibleForComputeSync;
- (bool)mad_isEligibleForComputeSyncDownloadWithAnalysisTask:(unsigned long long)arg1;
- (bool)mad_isEligibleForComputeSyncIngestion;
- (bool)mad_isNonLivePhotoImage;
- (bool)mad_needsProcessingForComputeSyncWithAnalysis:(unsigned long long)arg1;
- (id)mad_nextAttemptDateForStatus:(unsigned long long)arg1 currentAttemptDate:(id)arg2 attemptCount:(unsigned long long)arg3;
- (id)mad_refetchAsset;
- (id)vcp_PHFaces:(id)arg1;
- (unsigned long long)vcp_abnormalImageDimensionForSceneNet;
- (id)vcp_animatedStickerScore;
- (id)vcp_confidenceForExtendedSceneIdentifier:(unsigned long long)arg1;
...
- (bool)vcp_needsFullAnalysisProcessing:(bool)arg1;
...
- (double)clsContentScoreRecomputingIfNeeded:(bool)arg1;
- (double)clsDuration;
...
- (id)_searchDebugStringWithPersons:(id)arg1;
- (id)_searchDebugStringWithScenes:(id)arg1;
- (id)_searchDebugStringWithValues:(id)arg1;
...
- (id)px_debugStringForValueList:(id)arg1;
