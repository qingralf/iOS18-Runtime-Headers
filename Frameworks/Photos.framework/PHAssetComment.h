...
+ (id)entityKeyMap;
+ (id)fetchCommentsForAsset:(id)arg1 options:(id)arg2;
+ (id)fetchLikesForAsset:(id)arg1 options:(id)arg2;
+ (id)fetchType;
+ (id)identifierCode;
...
- (void).cxx_destruct;
- (bool)_isInterestingToUser:(id)arg1 cloudSharedProperties:(id)arg2;
