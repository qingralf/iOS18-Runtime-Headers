...
+ (id)_cameraMetadataURLForPrimaryAssetURL:(id)arg1 photoLibrary:(id)arg2;
...
+ (long long)_originalResourceTypeFromAdjustedResourceType:(long long)arg1 sourceAssetIsLoopingVideo:(bool)arg2 sourceAssetIsVideo:(bool)arg3;
+ (id)_photoIrisIndicatorFilePathForPhotoAtPath:(id)arg1 UUID:(id)arg2;
+ (bool)_shouldGenerateThumbnailsDuringCreationForImageSource:(struct CGImageSource { }*)arg1 contentType:(id)arg2 timeZoneLookup:(id)arg3;
...
+ (id)creationRequestForAssetFromVideoPreviewJobDict:(id)arg1 withPreviewImageSurface:(struct __IOSurface { }*)arg2;
...
- (bool)_assetAlreadyExistsAsPlaceholder:(bool)arg1 mediaType:(long long)arg2 uuid:(id)arg3 photoLibrary:(id)arg4 fetchAsset:(id*)arg5;
- (id)_captureSessionIdentifier;
- (void)_checkAndGenerateThumbnailsForAsset:(id)arg1 imageSource:(struct CGImageSource { }*)arg2 imageData:(id)arg3 previewImage:(id)arg4 thumbnailImage:(id)arg5 timeZoneLookup:(id)arg6 resourceBag:(id)arg7;
- (void)_checkAndSetForSemanticEnhancementForAsset:(id)arg1 resourceBag:(id)arg2;
...
- (id)_createAdjustmentsFileFromJobDictionary:(id)arg1 cameraIngestOptions:(id)arg2;
- (id)_createAssetAdjustmentsFromBackupWithAsset:(id)arg1;
...
- (void)_removePhotoKitCameraIngestFiles:(id)arg1 originalFileURL:(id)arg2 resourceBag:(id)arg3;
...
- (void)_setCaptureSessionIdentifierOnAsset:(id)arg1;
...
- (void)_setModificationDateOnAsset:(id)arg1;
...
- (void)_setupIrisPairingTimeoutForAsset:(id)arg1 imageFile:(id)arg2 library:(id)arg3;
- (bool)_setupSemanticEnhanceMetadataIfNeededWithDestinationURL:(id)arg1 photoLibrary:(id)arg2 semanticEnhanceResult:(struct { long long x1; double x2; }*)arg3 ingestJobCameraMetadata:(id)arg4;
- (bool)_shouldCreateScreenshot;
- (bool)_shouldUseAutomaticallyGeneratedOriginalFilename;
- (void)_tracePhotoKitAssetCreationWithUUID:(id)arg1;
...
- (bool)_writeDataToDisk:(id)arg1 imageUTIType:(id)arg2 primaryImageProperties:(id)arg3 mainFileURL:(id)arg4 thumbnailData:(id)arg5;
