...
- (id)initWithLocalIdentifier:(id)arg1 libraryURL:(id)arg2 mediaType:(long long)arg3 subtypes:(unsigned long long)arg4 sourceType:(unsigned long long)arg5 isTrashed:(bool)arg6 isRecovered:(bool)arg7;
- (bool)isRecovered;
- (bool)isTrashed;
