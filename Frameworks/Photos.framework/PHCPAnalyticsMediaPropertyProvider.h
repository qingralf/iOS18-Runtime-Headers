...
- (bool)_isPeopleSceneIdentifier:(unsigned long long)arg1;
- (bool)_isSceneConfidenceAboveThresholdForSceneClassification:(id)arg1 sceneAnalysisVersion:(short)arg2;
- (id)_junkConfidenceThresholdForIdentifier:(unsigned long long)arg1 sceneAnalysisVersion:(short)arg2;
- (id)_junkConfidenceThresholdVersion40ForIdentifier:(unsigned long long)arg1;
- (id)_junkConfidenceThresholdVersion81ForIdentifier:(unsigned long long)arg1;
- (id)_junkConfidenceThresholdVersion86ForIdentifier:(unsigned long long)arg1;
...
- (id)_sceneConfidenceThresholdByClassificationIdentifier:(unsigned long long)arg1 sceneAnalysisVersion:(short)arg2;
- (id)_sceneForAsset:(id)arg1;
- (id)_sceneLabelByClassificationIdentifier:(unsigned long long)arg1;
- (id)_sceneNetLabelConfidenceForIdentifier:(unsigned long long)arg1 sceneAnalysisVersion:(short)arg2;
- (id)_sceneSubjectForAsset:(id)arg1;
- (id)_sdConfidenceThresholdForIdentifier:(unsigned long long)arg1 sceneAnalysisVersion:(short)arg2;
- (id)_sdConfidenceThresholdVersion33ForIdentifier:(unsigned long long)arg1;
- (id)_sdConfidenceThresholdVersion51ForIdentifier:(unsigned long long)arg1;
- (id)_sdConfidenceThresholdVersion85ForIdentifier:(unsigned long long)arg1;
