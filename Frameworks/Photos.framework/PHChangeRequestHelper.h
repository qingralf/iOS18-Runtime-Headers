...
@property (nonatomic, copy) PHCreationRequestOptions *creationOptions;
...
- (bool)getCloudGUIDIfReserved:(id*)arg1 entityName:(id)arg2 photoLibrary:(id)arg3 error:(id*)arg4;
- (id)init;
