...
@property (getter=isCloudNotificationsEnabled, nonatomic, readonly) bool cloudNotificationsEnabled;
...
@property (nonatomic, readonly, retain) NSNumber *cloudRelationshipState;
@property (nonatomic, readonly) NSArray *invitationRecords;
@property (getter=isOwned, nonatomic, readonly) bool owned;
@property (nonatomic, readonly, retain) NSString *publicURL;
...
+ (id)fetchCloudSharedAlbumsWithLocalIdentifiers:(id)arg1 options:(id)arg2;
