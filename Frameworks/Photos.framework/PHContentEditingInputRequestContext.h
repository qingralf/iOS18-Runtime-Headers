...
+ (id)contentEditingInputRequestContextForAsset:(id)arg1 requestID:(int)arg2 managerID:(unsigned long long)arg3 networkAccessAllowed:(bool)arg4 downloadIntent:(long long)arg5 progressHandler:(id /* block */)arg6 resultHandler:(id /* block */)arg7;
+ (bool)shouldUseRAWResourceAsUnadjustedBaseForAsset:(id)arg1 options:(id)arg2;
