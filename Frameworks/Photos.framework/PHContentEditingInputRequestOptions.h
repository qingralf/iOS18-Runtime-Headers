...
@interface PHContentEditingInputRequestOptions : NSObject <PHMediaRequestThreadingOptions> {
    ...
    bool  _disallowFallbackAdjustmentBase;
    bool  _dontAllowRAW;
    ...
    bool  _requireOriginalsDownloaded;
...
- (void)setDisallowFallbackAdjustmentBase:(bool)arg1;
...
- (void)setRequireOriginalsDownloaded:(bool)arg1;
