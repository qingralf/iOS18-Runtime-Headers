...
@property (nonatomic) bool excludeNonVisibleStackedAssets;
...
@property (nonatomic) bool includeLocalMemories;
...
@property (nonatomic) bool includeSourceMemories;
@property (nonatomic) bool includeStoryMemories;
...
@property (nonatomic, copy) NSString *relatedEntityName;
@property (nonatomic, copy) NSString *relatedRelationshipProperty;
@property (nonatomic) bool reverseDefaultSortDescriptors;
...
@property (nonatomic) bool useNoIndexOnSharingFilter;
...
- (id)relatedRelationshipProperty;
...
- (void)setExcludeNonVisibleStackedAssets:(bool)arg1;
...
- (void)setIncludeLocalMemories:(bool)arg1;
...
- (void)setIncludeSourceMemories:(bool)arg1;
- (void)setIncludeStoryMemories:(bool)arg1;
...
- (void)setRelatedEntityName:(id)arg1;
- (void)setRelatedRelationshipProperty:(id)arg1;
- (void)setReverseDefaultSortDescriptors:(bool)arg1;
...
- (void)setSocialGroupContext:(long long)arg1;
- (void)setSortDescriptors:(id)arg1;
- (void)setSuppressSlowFetchReports:(bool)arg1;
- (void)setTransientIdentifier:(id)arg1;
- (void)setUseNoIndexOnSharingFilter:(bool)arg1;
...
+ (id)px_placesFetchOptionsWith:(id)arg1;
