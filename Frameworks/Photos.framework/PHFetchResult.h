...
@interface PHFetchResult : NSObject <NSCopying, NSFastEnumeration, PNFetchResultProtocol, PXDisplayAssetFetchResult, PXFastEnumerationIndexed> {
...
- (id)initWithQuery:(id)arg1 registerIfNeeded:(bool)arg2;
...
- (bool)hasIdentifiersEqualTo:(id)arg1;
...
- (id)px_fetchedObjectIDsSortedByUUIDs:(id)arg1;
...
- (void)px_safelyPrefetchThumbnailAssetAtIndex:(long long)arg1;
- (Class)px_sortByDatePropertySetClass;
- (unsigned long long)px_sortOrder;
- (id)px_subfetchResultWithObjectsAtIndexes:(id)arg1 objectClass:(Class)arg2;
