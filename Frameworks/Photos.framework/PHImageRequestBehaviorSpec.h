...
+ (bool)_shouldDecodeAsHDRBasedOnChoosingPolicy:(long long)arg1 optionsPreferHDR:(bool)arg2 asset:(id)arg3;
...
+ (id)livePhotoRequestBestBehaviorSpecWithPreviousBehaviorSpec:(id)arg1 options:(id)arg2 asset:(id)arg3;
+ (id)livePhotoRequestInitialBehaviorSpecWithLivePhotoRequestOptions:(id)arg1 asset:(id)arg2;
