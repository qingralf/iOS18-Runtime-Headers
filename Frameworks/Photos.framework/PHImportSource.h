...
- (void).cxx_destruct;
- (bool)_addSidecarAsset:(id)arg1 toAsset:(id)arg2;
- (id)_adjustmentDataAssetFromAssets:(id)arg1;
- (id)_adjustmentSecondaryDataAssetFromAssets:(id)arg1;
- (id)_findDatAssetInProcessedAssets:(id)arg1 toPairWithMediaAsset:(id)arg2 ifAssetIsAdjustment:(id)arg3;
- (bool)_pairDatSidecar:(id)arg1 withMediaAssetIfHasAdjustments:(id)arg2 orAaeInProcessedAssets:(id)arg3;
