...
+ (id)_livePhotoWithResourceFileURLs:(id)arg1 pairingIdentifier:(id)arg2 videoDuration:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg3 photoTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg4 targetSize:(struct CGSize { double x1; double x2; })arg5 contentMode:(long long)arg6 skipValidation:(bool)arg7 isLooping:(bool)arg8 skipInstantiatingImageAndAVAsset:(bool)arg9 prefersHDR:(bool)arg10 error:(id*)arg11;
+ (id)_livePhotoWithResourceFileURLs:(id)arg1 targetSize:(struct CGSize { double x1; double x2; })arg2 contentMode:(long long)arg3 skipInstantiatingImageAndAVAsset:(bool)arg4 prefersHDR:(bool)arg5 error:(id*)arg6;
+ (id)_livePhotoWithResourceFileURLs:(id)arg1 targetSize:(struct CGSize { double x1; double x2; })arg2 contentMode:(long long)arg3 skipValidation:(bool)arg4 isLooping:(bool)arg5 skipInstantiatingImageAndAVAsset:(bool)arg6 prefersHDR:(bool)arg7 error:(id*)arg8;
...
+ (id)livePhotoWithResourceFileURLs:(id)arg1 prefersHDR:(bool)arg2 error:(id*)arg3;
...
+ (id)livePhotoWithResourceFileURLs:(id)arg1 targetSize:(struct CGSize { double x1; double x2; })arg2 contentMode:(long long)arg3 skipValidation:(bool)arg4 prefersHDR:(bool)arg5 error:(id*)arg6;
...
+ (int)requestLivePhotoWithResourceFileURLs:(id)arg1 placeholderImage:(id)arg2 targetSize:(struct CGSize { double x1; double x2; })arg3 contentMode:(long long)arg4 prefersHDR:(bool)arg5 resultHandler:(id /* block */)arg6;
...
- (id)_initWithImageURL:(id)arg1 videoURL:(id)arg2 videoComplementMetadata:(id)arg3 targetSize:(struct CGSize { double x1; double x2; })arg4 contentMode:(long long)arg5 prefersHDR:(bool)arg6;
- (id)_initWithImageURL:(id)arg1 videoURL:(id)arg2 videoComplementMetadata:(id)arg3 targetSize:(struct CGSize { double x1; double x2; })arg4 contentMode:(long long)arg5 skipInstantiatingImageAndAVAsset:(bool)arg6 prefersHDR:(bool)arg7;
...
- (id)initWithBundleAtURL:(id)arg1 prefersHDR:(bool)arg2;
