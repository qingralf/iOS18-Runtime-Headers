...
@property (nonatomic, readonly) unsigned short creationType;
...
@property (nonatomic, readonly) bool isGenerative;
...
@property (nonatomic, readonly) bool px_canEditFavoriteState;
@property (nonatomic, readonly) bool px_canPerformFeatureLessAction;
...
+ (id)fetchMemoriesWithLocalIdentifiers:(id)arg1 options:(id)arg2;
