...
@property (nonatomic, retain) NSManagedObjectID *sourceGeneratedMemoryID;
...
@property (nonatomic, readonly) PHRelationshipChangeRequestHelper *userRemovedAssetsHelper;
...
- (void)setCreationType:(unsigned short)arg1;
...
- (void)setSourceGeneratedMemoryID:(id)arg1;
...
- (void)setUserRemovedAssets:(id)arg1;
- (id)sourceGeneratedMemoryID;
...
- (id)subtitle;
- (id)title;
- (void)undoUserRemoveForAssets:(id)arg1;
- (id)userCuratedAssetsHelper;
- (bool)userEdited;
- (id)userFeedback;
- (id)userRemovedAssetsHelper;
- (bool)validateInsertIntoPhotoLibrary:(id)arg1 error:(id*)arg2;
- (bool)validateMutationsToManagedObject:(id)arg1 error:(id*)arg2;

// Image: /System/Library/PrivateFrameworks/PhotosUICore.framework/PhotosUICore

+ (id)_fetchCuratedAssetsForAssetCollection:(id)arg1 people:(id)arg2 includeGuestAssets:(bool)arg3;
