...
@interface PHObject : NSObject <NSCopying, PHObject, PHObjectFetchPropertySets, PLLocalUUIDConverter> {
    bool  _deleted;
...
+ (id)internalSortDescriptorForPropertyKey:(id)arg1 ascending:(bool)arg2;
...
- (id)_px_uniquedUserInterfaceIdentifier:(id)arg1;
