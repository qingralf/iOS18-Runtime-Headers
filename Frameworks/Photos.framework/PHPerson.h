...
@property (nonatomic, readonly) double isMeConfidence;
...
@property (readonly) NSDate *px_keyPhotoDate; /* unknown property attribute: ? */
...
+ (id)fetchMePersonWithOptions:(id)arg1;
...
+ (id)fetchPersonsInSocialGroup:(id)arg1 option:(id)arg2;
