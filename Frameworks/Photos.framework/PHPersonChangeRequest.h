...
- (void)addSearchEntityPersonRelationWithType:(short)arg1 label:(id)arg2 confidence:(double)arg3 toPerson:(id)arg4;
...
- (void)removeSearchEntityPersonRelationType:(short)arg1 toPerson:(id)arg2;
