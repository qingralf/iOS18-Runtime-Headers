...
@property (nonatomic, readonly) NSString *searchIndexLookupIdentifier;
...
+ (unsigned int)_excludeMaskForUserLibraryWithFetchOptions:(id)arg1;
...
+ (id)_queryForAssetsWithLocalIdentifiers:(id)arg1 options:(id)arg2;
...
+ (id)defaultSortDescriptorForFetchType:(id)arg1 predicate:(id)arg2 ascending:(bool)arg3;
...
+ (id)queryForAllTripHighlightsContainingAssetUUIDs:(id)arg1 options:(id)arg2;
+ (id)queryForAnsweredQuestionsWithOptions:(id)arg1;
+ (id)queryForAnsweredYesOrNoQuestionsWithOptions:(id)arg1;
+ (id)queryForAnyCinematicVideosNeedingDeferredProcessingWithOtions:(id)arg1;
...
+ (id)queryForAssetsAssociatedWithMomentsOfMemory:(id)arg1 options:(id)arg2;
+ (id)queryForAssetsCaptured:(bool)arg1 orEdited:(bool)arg2 onThisCameraSinceDate:(id)arg3 options:(id)arg4;
+ (id)queryForAssetsCapturedOnThisCameraSinceDate:(id)arg1 options:(id)arg2;
+ (id)queryForAssetsEditedOnThisCameraSinceDate:(id)arg1 options:(id)arg2;
+ (id)queryForAssetsForBehavioralCurationWithOptions:(id)arg1;
+ (id)queryForAssetsForComment:(id)arg1 options:(id)arg2;
...
+ (id)queryForAssetsForPTPWithOptions:(id)arg1;
...
+ (id)queryForAssetsInUtilityCollectionWithType:(unsigned short)arg1 options:(id)arg2;
+ (id)queryForAssetsUsingSearchIndexLookupIdentifier:(id)arg1 options:(id)arg2;
...
+ (id)queryForCloudSharedAlbumsWithLocalIdentifiers:(id)arg1 options:(id)arg2;
+ (id)queryForCollageAssetsInDayHighlight:(id)arg1 options:(id)arg2;
...
+ (id)queryForCommentsForAsset:(id)arg1 options:(id)arg2;
...
+ (id)queryForKeyAssetForPerson:(id)arg1 options:(id)arg2;
...
+ (id)queryForLikesForAsset:(id)arg1 options:(id)arg2;
+ (id)queryForMemoriesWithLocalIdentifiers:(id)arg1 options:(id)arg2;
...
+ (id)queryForSuggestionsWithState:(unsigned short)arg1 type:(unsigned short)arg2 subtype:(unsigned short)arg3 options:(id)arg4;
...
+ (id)queryForType:(id)arg1 withIdentifiers:(id)arg2 identifierKeyPath:(id)arg3 options:(id)arg4;
+ (id)queryForType:(id)arg1 withLocalIdentifiers:(id)arg2 options:(id)arg3;
+ (id)queryForUserCuratedAssetsInMemory:(id)arg1 options:(id)arg2;
+ (id)queryForVisibleAssetsWithObjectIDs:(id)arg1 options:(id)arg2;
...
- (id)_effectiveDefaultSortDescriptorReversingOrder:(bool)arg1;
...
- (id)searchIndexLookupIdentifier;
- (id)seedOIDs;
