...
+ (id)_originalsAndFullSizeResourcesToShareForAsset:(id)arg1 fromAvailableResources:(id)arg2 options:(id)arg3 error:(id*)arg4;
...
+ (id)_singularResourcesToShareForAsset:(id)arg1 fromAvailableResources:(id)arg2 options:(id)arg3 useOriginalResources:(bool)arg4 knownUnsupported:(bool)arg5 error:(id*)arg6;
...
+ (bool)isKnownUnsupportedFormatForAsset:(id)arg1;
