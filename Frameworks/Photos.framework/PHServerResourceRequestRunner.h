...
- (void).cxx_destruct;
- (id)_applyCorrectionsToAssetObjectIDURL:(id)arg1 resourceIdentity:(id)arg2 errorCodes:(id)arg3 clientBundleID:(id)arg4 library:(id)arg5 reply:(id /* block */)arg6;
...
- (void)addClientSystemInformationToMutableStreamingHints:(id)arg1;
- (id)applyAssetScopeCorrectionsWithRequest:(id)arg1 errorCodes:(id)arg2 clientBundleID:(id)arg3 library:(id)arg4 reply:(id /* block */)arg5;
- (id)applyResourceScopeCorrectionsWithRequest:(id)arg1 errorCodes:(id)arg2 clientBundleID:(id)arg3 library:(id)arg4 reply:(id /* block */)arg5;
...
- (id)startDownloadForRequest:(id)arg1 backingResource:(id)arg2 clientBundleID:(id)arg3 shouldReturnAdjustmentInfo:(bool)arg4 needsDownload:(bool)arg5 shouldApplyTimeRange:(bool)arg6 reply:(id /* block */)arg7;
- (void)startWalrusTimeRangeDownloadForRequest:(id)arg1 backingResource:(id)arg2 clientBundleID:(id)arg3 shouldReturnAdjustmentInfo:(bool)arg4 partialVideoURL:(id)arg5 reply:(id /* block */)arg6;
- (long long)state;
- (id)taskIdentifier;
