...
@property (nonatomic, readonly) bool isInvalid; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) bool px_isFeaturedPhoto;
@property (nonatomic, readonly, copy) NSArray *reasons; /* unknown property attribute: ? */
@property (nonatomic, readonly) id recipe;
@property (nonatomic, readonly) NSString *relatedCollectionUUID;
...
@property (nonatomic, readonly) double score; /* unknown property attribute: ? */
...
+ (id)fetchRecentInterestSuggestionsForAsset:(id)arg1;
+ (id)fetchSuggestionsWithOptions:(id)arg1;
+ (id)fetchSuggestionsWithState:(unsigned short)arg1 ofType:(unsigned short)arg2 subtype:(unsigned short)arg3 withOptions:(id)arg4;
