...
@interface PHLivePhotoView : UIView <ISChangeObserver, ISLivePhotoUIViewDelegate, PUPhotosAssetDebugOverlayViewDelegate, PXLivePhotoView> {
    ...
    struct { 
        bool respondsToCanBeginPlayback; 
        bool respondsToWillBeginPlaybackWithStyle; 
        bool respondsToDidEndPlayback; 
        bool respondsToExtraMinimumTouchDuration; 
    }  _delegateFlags;
    struct { 
...
@property (nonatomic, retain) NSNumber *overrideSRLCompensationAmount;
...
- (void)layoutSubviews;
- (id)livePhoto;
- (bool)livePhotoViewCanBeginInteractivePlayback:(id)arg1;
- (double)livePhotoViewExtraMinimumTouchDuration:(id)arg1 touch:(id)arg2;
...
- (void)setOverrideSRLCompensationAmount:(id)arg1;
...
- (void)setVideoFilterUpdateCounter:(long long)arg1;
