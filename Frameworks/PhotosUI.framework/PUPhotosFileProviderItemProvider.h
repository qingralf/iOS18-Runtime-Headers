...
@property (nonatomic, copy) NSDictionary *progressURLSandboxExtensionTokens;
@property (nonatomic, copy) NSDictionary *progressURLs;
...
- (void)dealloc;
- (id)initWithProgressURLs:(id)arg1 progressURLSandboxExtensionTokens:(id)arg2;
...
- (id)progressURLSandboxExtensionTokens;
- (id)progressURLs;
- (void)setProgressURLSandboxExtensionTokens:(id)arg1;
- (void)setProgressURLs:(id)arg1;
