...
- (void).cxx_destruct;
- (void)_appendPendingPushForUUID:(id)arg1 payload:(id)arg2 reply:(id /* block */)arg3 isServiceUpdateMessage:(bool)arg4 isHighPriority:(bool)arg5 remainingHighPriorityBudget:(long long)arg6;
...
- (void)provider:(id)arg1 didReceivePushPayload:(id)arg2 channelUUID:(id)arg3 reply:(id /* block */)arg4 isServiceUpdateMessage:(bool)arg5 isHighPriority:(bool)arg6 remainingHighPriorityBudget:(long long)arg7;
