...
+ (id)ck_opacityAnimationForRevealingSticker:(bool)arg1;
+ (id)ck_springAnimationForRevealingReactWithASticker;
+ (id)ck_springAnimationForRevealingSticker:(bool)arg1;
+ (id)ck_stickerFlyInBoundsAnimationFromSize:(struct CGSize { double x1; double x2; })arg1 toSize:(struct CGSize { double x1; double x2; })arg2;
+ (id)ck_stickerFlyInMoveAnimationFromRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 toRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2;
+ (id)ck_stickerFlyInScaleAnimation;
+ (id)ck_stickerFlyInSpringAnimation;
+ (id)ck_stickerFlyInTransformAnimationTo:(struct CATransform3D { double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; double x10; double x11; double x12; double x13; double x14; double x15; double x16; })arg1;
...
+ (id)animationWithVFXAnimation:(id)arg1;
