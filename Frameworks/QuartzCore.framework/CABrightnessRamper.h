...
@interface CABrightnessRamper : CAWindowServerRamper {
    ...
    double  _indicatorLimitBegin;
    double  _indicatorLimitEnd;
    double  _indicatorNitsBegin;
    double  _indicatorNitsEnd;
    double  _limitBegin;
    double  _limitEnd;
...
- (void)setIndicatorLimitBegin:(double)arg1;
- (void)setIndicatorLimitEnd:(double)arg1;
- (void)setIndicatorNitsBegin:(double)arg1;
- (void)setIndicatorNitsEnd:(double)arg1;
