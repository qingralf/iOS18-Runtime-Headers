...
+ (void)assertInactive;
+ (void)batch;
+ (bool)batchWithDefaultServerObserver:(id /* block */)arg1;
+ (void)begin;
+ (double)beginTime;
...
+ (void)setEmptyLowLatency:(bool)arg1;
...
+ (void)_pk_withDisabledActions:(bool)arg1 perform:(id /* block */)arg2;
...
+ (void)safari_performWithActionsDisabled:(id /* block */)arg1;
