...
@property (nonatomic, readonly) NSDictionary *clientPreviewOptions; /* unknown property attribute: ? */
...
- (void)updatePreferredDynamicRangeForced:(bool)arg1;
- (void)viewDidLoad;
