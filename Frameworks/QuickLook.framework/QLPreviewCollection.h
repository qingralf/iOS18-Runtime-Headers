...
@interface QLPreviewCollection : UIViewController <QLItemPresenterViewControllerDelegate, QLPageViewControllerDataSource, QLPageViewControllerDelegate, QLPreviewCollectionProtocol, QLPreviewItemViewControllerDelegate, QLTransitionControllerProtocol, QuickLook.QLPreviewCollectionRemoteProtocol, UIGestureRecognizerDelegatePrivate> {
    ...
    bool  _isDismissing;
    bool  _isEditing;
    NSNumber * _isNavigationBarChromeless;
    bool  _isPresenting;
    NSNumber * _isToolbarChromeless;
    ...
    bool  _previewItemControllerMissedTransitionStart;
    struct _NSRange { 
...
@property (nonatomic, readonly) bool allowInteractiveTransitions;
...
@property (nonatomic, retain) NSNumber *isNavigationBarChromeless;
@property (nonatomic) bool isPresenting;
@property (nonatomic, retain) NSNumber *isToolbarChromeless;
...
@property (nonatomic) bool shouldStartFullScreen;
...
+ (id)previewCollectionWithClassName:(id)arg1;
...
- (void)displayBarsIfNeededForDestinationViewController:(id)arg1;
...
- (id)isNavigationBarChromeless;
- (bool)isPresenting;
- (bool)isRemote;
- (id)isToolbarChromeless;
...
- (void)previewItemViewController:(id)arg1 wantsChromelessNavigationBar:(bool)arg2;
- (void)previewItemViewController:(id)arg1 wantsChromelessToolbar:(bool)arg2;
...
- (void)previewItemViewControllerDidUpdateContentFrame:(id)arg1;
...
- (void)setFullScreen:(bool)arg1 forceUpdate:(bool)arg2;
...
- (void)setIsNavigationBarChromeless:(id)arg1;
- (void)setIsPresenting:(bool)arg1;
- (void)setIsToolbarChromeless:(id)arg1;
- (void)setIsTransitioningPage:(bool)arg1;
- (void)setLoadingString:(id)arg1;
- (void)setNavigationBarShouldBeChromelessIfNeeded:(bool)arg1;
