...
@interface QLPreviewController : UIViewController <QLPreviewControllerStateProtocolHostOnly, QLPreviewItemProvider, QLPreviewItemStoreDelegate, UIAdaptivePresentationControllerDelegate, UIDocumentInteractionControllerDelegate, UIDocumentPickerDelegate, UIGestureRecognizerDelegate, UINavigationControllerDelegate, UIPageViewControllerDelegate, UIScreenshotServiceDelegate, UIScrollViewDelegate, UIViewControllerTransitioningDelegate> {
    ...
    bool  _didSetDefaultFullscreenState;
    ...
    bool  _navigationBarShouldBeChromeless;
    ...
    UIViewController<QLPreviewCollectionProtocol><QLPreviewCollectionRemoteProtocol> * _previewCollection;
    ...
    bool  _toolbarShouldBeChromeless;
    UIColor * _toolbarTintColor;
    UIView * _transitionSourceView;
    bool  _updatedWhileDisappearing;
...
@property (nonatomic, readonly) NSSet *_pdfItemAllowedOutputClasses;
...
@property (nonatomic) bool canDismissWithGesture;
...
@property (nonatomic) bool overlayFrozen;
...
@property (nonatomic, retain) UIView *transitionSourceView;
...
- (id)_pdfItemAllowedOutputClasses;
...
- (bool)itemStore:(id)arg1 canMachineReadableCodeBeDetectedInPreviewItem:(id)arg2;
...
- (void)setCanDismissWithGesture:(bool)arg1;
...
- (void)setNavigationBarGradientAlpha:(double)arg1;
- (void)setNavigationBarShouldBeChromeless:(bool)arg1;
...
- (void)setOverlayFrozen:(bool)arg1;
...
- (void)setToolbarGradientAlpha:(double)arg1;
- (void)setToolbarShouldBeChromeless:(bool)arg1;
- (void)setToolbarTintColor:(id)arg1;
- (void)setTransitionSourceView:(id)arg1;
...
- (void)updateContentFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
