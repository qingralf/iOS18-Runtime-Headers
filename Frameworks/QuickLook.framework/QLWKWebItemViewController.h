...
@interface QLWKWebItemViewController : QLItemViewController <QLPrintingProtocol, QLScrubViewDataSource, QLScrubViewDelegate, UIScrollViewDelegate, WKNavigationDelegate, WKURLSchemeHandler> {
...
- (void)setGeneratedDocument:(id)arg1;
- (void)setGeneratedDocumentURLSessionTask:(id)arg1;
