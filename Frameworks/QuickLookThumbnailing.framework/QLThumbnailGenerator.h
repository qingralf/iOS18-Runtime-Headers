...
- (bool)canGenerateThumbnailsForContentType:(id)arg1 atSize:(struct CGSize { double x1; double x2; })arg2;
...
- (id)requests;
- (void)saveBestRepresentationForRequest:(id)arg1 toFileAtURL:(id)arg2 asContentType:(id)arg3 allowingThumbnailDownloads:(bool)arg4 completionHandler:(id /* block */)arg5;
- (void)saveBestRepresentationForRequest:(id)arg1 toFileAtURL:(id)arg2 asContentType:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (void)saveBestRepresentationForRequest:(id)arg1 toFileHandle:(id)arg2 asContentType:(id)arg3 allowingThumbnailDownloads:(bool)arg4 completionHandler:(id /* block */)arg5;
