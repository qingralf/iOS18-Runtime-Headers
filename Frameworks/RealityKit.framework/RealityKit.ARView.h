...
@interface RealityKit.ARView : UIView <ARSessionProviding, UIGestureRecognizerDelegate> {
    ...
    void _enableGroundingShadowsByDefault;
    void _lastHitEntityForGestures;
    void _scene;
    union { in /* Warning: Unrecognized filer type: 'u' using 'void*' */ void*x1; long x2; long x3; }  antialiasingMode;
    void arSystem;
    void backingLayer;
    void currentIBL;
    void edrHeadroomPolicy;
