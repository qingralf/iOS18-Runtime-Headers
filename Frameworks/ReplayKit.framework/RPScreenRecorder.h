...
@interface RPScreenRecorder : NSObject <RPPreviewViewControllerDelegate, UINavigationControllerDelegate, UIPopoverPresentationControllerDelegate> {
    ...
    <RPScreenRecorderScreenCapureKitRecordingOutputDelegate> * _screenCaptureKitRecordingOutputDelegate;
...
@property (nonatomic, retain) <RPScreenRecorderScreenCapureKitRecordingOutputDelegate> *screenCaptureKitRecordingOutputDelegate;
...
- (id)screenCaptureKitRecordingOutputDelegate;
...
- (void)setScreenCaptureKitRecordingOutputDelegate:(id)arg1;
