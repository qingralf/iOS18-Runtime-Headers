...
@interface SFAccountTableViewCell : UITableViewCell <SFAccountTableViewCell> {
    ...
    UIImageView * _reusedPasswordWarningImageView;
...
- (void)setSavedAccount:(id)arg1 searchPattern:(id)arg2 emphasizeUserName:(bool)arg3 isReusedPassword:(bool)arg4;
- (void)setSavedAccount:(id)arg1 searchPattern:(id)arg2 emphasizeUserName:(bool)arg3 shouldDifferentiateWithGroupName:(bool)arg4;
