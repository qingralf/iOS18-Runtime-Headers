...
@interface SFAddSavedAccountViewController : UITableViewController <SFAccountHeaderViewCellDelegate, SFAccountNoteTableViewCellDelegate, UITextFieldDelegate> {
    ...
    bool  _shouldPopulatePasswordFieldWithNewGeneratedStrongPassword;
...
@property (nonatomic, retain) NSString *bundleIDForFallbackIcon;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (nonatomic) <SFAddSavedAccountViewControllerDelegate> *delegate;
@property (readonly, copy) NSString *description;
@property (readonly) unsigned long long hash;
@property (nonatomic) bool shouldPopulatePasswordFieldWithNewGeneratedStrongPassword;
...
- (void)setShouldPopulatePasswordFieldWithNewGeneratedStrongPassword:(bool)arg1;
