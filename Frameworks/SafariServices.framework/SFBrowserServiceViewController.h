...
@interface SFBrowserServiceViewController : _SFBrowserContentViewController <ASSafariViewServiceHostWindowSceneProviding, SFServiceViewControllerProtocol, _SFActivityDelegate, _SFLinkPreviewHeaderDelegate> {
    ...
    ASWebAuthenticationSessionCallback * _hostApplicationCallback;
...
@property (nonatomic, retain) ASWebAuthenticationSessionCallback *hostApplicationCallback;
@property (readonly) Class superclass;
@property (nonatomic, retain) SFSystemAlert *webAuthenticationDataSharingConfirmation;

+ (id)_exportedInterface;
+ (id)_remoteViewControllerInterface;
+ (id)hostWindowSceneIdentifierForServiceWindowSceneIdentifier:(id)arg1;
+ (void)setHostWindowSceneIdentifier:(id)arg1 forServiceViewController:(id)arg2;
...
- (void)dealloc;
- (void)decideCookieSharingForURL:(id)arg1 callback:(id)arg2 proxiedAssociatedDomains:(id)arg3;
...
- (void)setAdditionalHeaderFieldsForInitialLoad:(id)arg1;
- (void)setConfiguration:(id)arg1;
- (void)setDismissButtonStyle:(long long)arg1;
- (void)setDisplayMode:(long long)arg1;
- (void)setHostApplicationCallback:(id)arg1;
- (void)setHostWindowSceneIdentifier:(id)arg1;
