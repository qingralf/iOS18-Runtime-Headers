...
+ (void)_rememberStateForSystemAutoFillWithSearchQuery:(id)arg1 savedAccount:(id)arg2;
+ (id)_remoteViewControllerInterface;
+ (void)_restoreStateForSystemAutoFillToAccountPickerConfiguration:(id)arg1;
+ (bool)_shouldRestoreStateForSystemAutoFillForAppID:(id)arg1;
...
- (void)_sendCredentialToClient:(id)arg1 needsAuthentication:(bool)arg2;
...
- (void)credentialListViewController:(id)arg1 didFinishWithText:(id)arg2 completion:(id /* block */)arg3;
