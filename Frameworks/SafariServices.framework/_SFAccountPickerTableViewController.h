...
- (id)_detailViewControllerForSavedAccount:(id)arg1;
- (void)_didPickSavedAccountForPassword:(id)arg1;
- (void)_didPickSavedAccountForPasswordButPresentAlertToAddAdditionalSiteIfApplicable:(id)arg1;
...
- (id)_indexPathForSavedAccount:(id)arg1;
...
- (void)_showAccountDetailsForSavedAccount:(id)arg1;
