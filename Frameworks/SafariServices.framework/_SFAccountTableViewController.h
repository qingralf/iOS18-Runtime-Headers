...
@interface _SFAccountTableViewController : UITableViewController <SFAccountDetailViewControllerDelegate, UISearchBarDelegate, UISearchControllerDelegate, UISearchResultsUpdating, _ASPasswordManagerIconControllerDelegate, _SFAccountManagerLockableContentContainer> {
    _SFAccountTableConfiguration * _configuration;
    _ASPasswordManagerIconController * _iconController;
...
@property (nonatomic, retain) _ASPasswordManagerIconController *iconController;
@property (nonatomic, retain) WBSSavedAccount *savedAccountToRemoveAfterCompletedUpgradeInDetailView; /* unknown property attribute: ? */
@property (nonatomic, retain) UISearchController *searchController;
@property (nonatomic, readonly) NSString *searchPattern;
@property (nonatomic, retain) NSString *searchQuery;
@property (nonatomic, readonly) bool shouldSuppressAccountManagerLockedView; /* unknown property attribute: ? */
