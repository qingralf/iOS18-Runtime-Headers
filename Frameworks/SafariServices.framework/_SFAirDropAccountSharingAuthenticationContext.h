...
@property (nonatomic, readonly, copy) NSDictionary *customLocalAuthenticationOptions; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) bool shouldAuthenticateBeforeShowingSettings; /* unknown property attribute: ? */
