...
@interface _SFBookmarkInfoViewController : SFPopoverSizingTableViewController <UITableViewDataSource, UITableViewDelegate, _SFBookmarkInfoViewControllerDelegate, _SFBookmarkTextEntryTableViewControllerDelegate> {
...
- (bool)_bookmarkIsInFavoritesFolder:(id)arg1;
...
- (id)_cellForShowTitleSwitch:(id)arg1;
...
- (id)_iconForViewCellGivenBookmark:(id)arg1 syntheticFolder:(id)arg2;
...
- (void)_showTitleSwitchPressed:(id)arg1;
- (id)_titleCell;
...
- (void)setParent:(id)arg1 syntheticParentFolder:(id)arg2;
- (id)syntheticBookmarkProviderForBookmarkInfoViewController:(id)arg1;
