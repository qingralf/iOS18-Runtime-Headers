...
- (id)_homePageURLToUseAsFallbackWhenTryingToChangePassword:(id)arg1;
- (id)_hostAppBundleId;
...
- (bool)_redirectToHostAppForAuthenticationSession:(id)arg1;
...
- (void)_setShowingReader:(bool)arg1;
...
- (void)_setWebViewController:(id)arg1;
...
- (id)browserView;
- (void)browserViewFullscreenStateDidChange:(id)arg1;
...
- (bool)webViewControllerShouldAutofillESimInformation:(id)arg1;
