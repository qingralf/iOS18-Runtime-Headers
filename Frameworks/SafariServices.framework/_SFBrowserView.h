...
@interface _SFBrowserView : UIView {
    ...
    UIView * _currentWebViewContainerView;
...
@property (nonatomic, readonly) UIView *currentWebViewContainerView;
...
- (void).cxx_destruct;
- (void)_addWebView:(id)arg1 webViewContainerView:(id)arg2;
...
- (id)currentWebView;
- (id)currentWebViewContainerView;
- (void)dealloc;
- (id)delegate;
