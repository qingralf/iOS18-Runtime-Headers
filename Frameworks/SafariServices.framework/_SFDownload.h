...
@property (nonatomic, readonly) WKDownload *wkDownload;
...
- (void)download:(id)arg1 decideDestinationWithSuggestedFilename:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)download:(id)arg1 decidePlaceholderPolicy:(id /* block */)arg2;
- (void)download:(id)arg1 didFailWithError:(id)arg2 resumeData:(id)arg3;
- (void)download:(id)arg1 didReceiveFinalURL:(id)arg2;
- (void)download:(id)arg1 didReceivePlaceholderURL:(id)arg2 completionHandler:(id /* block */)arg3;
