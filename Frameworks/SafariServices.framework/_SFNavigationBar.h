...
@interface _SFNavigationBar : UIView <SFNavigationBarItemObserver, UIDragInteractionDelegate_Private, UIDropInteractionDelegate_Private, UIGestureRecognizerDelegate, WBSContentAvailabilityDisplayPresenting, _SFFluidProgressViewDelegate, _SFNavigationBarCommon, _SFNavigationBarURLButtonDelegate, _UIBasicAnimationFactory, _UIClickInteractionDelegate> {
