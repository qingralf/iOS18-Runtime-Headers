...
@property (nonatomic, retain) NSURLProtectionSpace *protectionSpaceForInvalidCertificateBypass;
...
- (void).cxx_destruct;
- (void)_cacheSecIdentityIfNeeded:(struct __SecIdentity { }*)arg1 forIdentityDomain:(id)arg2;
...
- (id)_errorMessageForNSURLErrorDomain:(id)arg1 url:(id)arg2;
- (void)_fetchSpecializedMessageForError:(id)arg1 URL:(id)arg2 completionHandler:(id /* block */)arg3;
- (id)_firstItemWithUniqueURLInBackListFromURL:(id)arg1;
