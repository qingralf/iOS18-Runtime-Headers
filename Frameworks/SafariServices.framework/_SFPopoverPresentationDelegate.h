...
@interface _SFPopoverPresentationDelegate : NSObject <UIPopoverPresentationControllerDelegate> {
    bool  _nestsAdaptiveSheetPresentationInNavigationController;
...
@property (nonatomic) bool nestsAdaptiveSheetPresentationInNavigationController;
...
- (void)setNestsAdaptiveSheetPresentationInNavigationController:(bool)arg1;
