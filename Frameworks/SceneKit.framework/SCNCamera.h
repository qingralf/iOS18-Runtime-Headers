...
@property (setter=avt_setSimdPostProjectionTransform:, nonatomic) struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[3]; } avt_simdPostProjectionTransform;
@property (setter=avt_setSimdProjectionTransform:, nonatomic) struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; } avt_simdProjectionTransform;
...
- (void)avt_setSimdPostProjectionTransform:(struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[3]; })arg1;
- (void)avt_setSimdProjectionTransform:(struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; })arg1;
- (struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[3]; })avt_simdPostProjectionTransform;
- (struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; })avt_simdProjectionTransform;
