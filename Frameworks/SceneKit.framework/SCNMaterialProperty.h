...
+ (struct __C3DImage { }*)_createC3DImageFromImage:(id)arg1;
...
- (void)avt_setSimdContentsTransform:(struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; })arg1;
- (struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; })avt_simdContentsTransform;
