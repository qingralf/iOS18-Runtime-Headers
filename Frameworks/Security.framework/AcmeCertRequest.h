...
@interface AcmeCertRequest : NSObject {
    ...
    struct __SecKey { struct __CFRuntimeBase { unsigned long long x_1_1_1; _Atomic unsigned long long x_1_1_2; } x1; struct __SecKeyDescriptor {} *x2; void *x3; } * _attestationCRKey;
...
@property struct __SecKey { struct __CFRuntimeBase { unsigned long long x_1_1_1; _Atomic unsigned long long x_1_1_2; } x1; struct __SecKeyDescriptor {} *x2; void *x3; }*attestationCRKey;
...
- (id)acmeRequest;
- (id)attestation;
- (id)attestationCRChain;
- (struct __SecKey { struct __CFRuntimeBase { unsigned long long x_1_1_1; _Atomic unsigned long long x_1_1_2; } x1; struct __SecKeyDescriptor {} *x2; void *x3; }*)attestationCRKey;
- (id)attestationChain;
...
- (id)executeRequest;
- (id)finalizeOrderURL;
- (id)hardwareAttestationWithError:(id*)arg1;
...
- (void)setAttestationCRChain:(id)arg1;
- (void)setAttestationCRKey:(struct __SecKey { struct __CFRuntimeBase { unsigned long long x_1_1_1; _Atomic unsigned long long x_1_1_2; } x1; struct __SecKeyDescriptor {} *x2; void *x3; }*)arg1;
