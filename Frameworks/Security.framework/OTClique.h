...
+ (bool)clearCliqueFromAccount:(id)arg1 error:(id*)arg2;
...
+ (bool)performCKServerUnreadableDataRemoval:(id)arg1 error:(id*)arg2;
...
- (id)cliqueMemberIdentifier:(id*)arg1;
...
- (void)fetchUserControllableViewsSyncingEnabledAsync:(id /* block */)arg1;
...
- (bool)resetAndEstablish:(long long)arg1 idmsTargetContext:(id)arg2 idmsCuttlefishPassword:(id)arg3 notifyIdMS:(bool)arg4 accountSettings:(id)arg5 isGuitarfish:(bool)arg6 error:(id*)arg7;
...
+ (bool)areRecoveryKeysDistrusted:(id)arg1 error:(id*)arg2;
+ (id)createAndSetRecoveryKeyWithContext:(id)arg1 error:(id*)arg2;
+ (long long)doesRecoveryKeyExistInOctagonAndIsCorrect:(id)arg1 recoveryKey:(id)arg2 error:(id*)arg3;
+ (long long)doesRecoveryKeyExistInSOSAndIsCorrect:(id)arg1 recoveryKey:(id)arg2 error:(id*)arg3;
+ (bool)ensureBackupKeyExistsinSOS:(id*)arg1;
...
+ (bool)registerRecoveryKeyInSOSAndBackup:(id)arg1 recoveryKey:(id)arg2 error:(id*)arg3;
...
- (bool)removeRecoveryKeyFromSOSWhenInCircle:(id)arg1 error:(id*)arg2;
- (bool)removeRecoveryKeyFromSOSWhenNOTInCircle:(id)arg1 error:(id*)arg2;
