...
+ (id)hwModelID;
+ (id)logger;
+ (id)parseAction:(id)arg1 error:(id*)arg2;
+ (bool)parseEventFilter:(id)arg1 format:(id)arg2 error:(id*)arg3;
+ (bool)parseRules:(id)arg1 format:(id)arg2 error:(id*)arg3;
+ (bool)parseVersions:(id)arg1 format:(id)arg2 error:(id*)arg3;
+ (void)removeLegacyDefaultAnalyticsDatabasePath:(id)arg1 usingDispatchToken:(long long*)arg2;
+ (id)treeOfUnderlyingErrors:(id)arg1 depth:(long long)arg2;
+ (id)underlyingErrors:(id)arg1;
