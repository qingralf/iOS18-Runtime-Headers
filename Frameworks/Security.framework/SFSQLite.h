...
- (id)select:(id)arg1 from:(id)arg2 mapEachRow:(id /* block */)arg3;
...
- (void)select:(id)arg1 from:(id)arg2 where:(id)arg3 bindings:(id)arg4 orderBy:(id)arg5 limit:(id)arg6 forEachRow:(id /* block */)arg7;
