...
- (void)analyzeFile:(id)arg1 options:(unsigned long long)arg2 progressHandler:(id /* block */)arg3 completionHandler:(id /* block */)arg4;
...
- (void)analyzePixelBuffer:(struct __CVBuffer { }*)arg1 orientation:(unsigned int)arg2 completionHandler:(id /* block */)arg3;
...
- (bool)shouldAnalyzeMedia:(id*)arg1;
- (bool)shouldAnalyzeMediaWithType:(id)arg1 error:(id)arg2;
