...
+ (id)applicationUsageWithBundleIdentifier:(id)arg1 reportApplicationIdentifier:(id)arg2 totalUsageTime:(double)arg3 relativeStartTime:(double)arg4 textInputSessions:(id)arg5 supplementalCategories:(id)arg6;
