...
@property (nonatomic, readonly, copy) NSString *requiredEntitlement; /* unknown property attribute: ? */
@property (getter=isRestricted, nonatomic, readonly) bool restricted; /* unknown property attribute: ? */
