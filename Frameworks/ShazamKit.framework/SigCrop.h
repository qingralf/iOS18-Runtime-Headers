...
+ (id)cropSignature:(id)arg1 atPosition:(double)arg2 withDuration:(double)arg3 error:(id*)arg4;
+ (bool)cropSignature:(id)arg1 toDuration:(double)arg2 stride:(double)arg3 error:(id*)arg4 callback:(id /* block */)arg5;
