...
@interface SNShazamSignatureResult : NSObject <NSCopying, NSSecureCoding, SNResult, SNTimeRangeProviding> {
    void impl;
}
...
- (id)initWithSignature:(id)arg1 sequenceNum:(unsigned long long)arg2;
- (bool)isEqual:(id)arg1;
- (unsigned long long)sequenceNum;
- (void)setSequenceNum:(unsigned long long)arg1;
