...
@property (nonatomic, readonly, copy) NSData *jitProfileData;
...
- (id)initWithLeftContext:(id)arg1 rightContext:(id)arg2 selectedText:(id)arg3 geoLMRegionID:(id)arg4 contextualStrings:(id)arg5 contextualNamedEntities:(id)arg6 profileData:(id)arg7 jitProfileData:(id)arg8;
- (id)jitProfileData;
- (id)leftContext;
- (id)profileData;
- (id)rightContext;
