...
@interface SKNode : UIResponder <NSCopying, NSSecureCoding, UICoordinateSpace, UIFocusItem, UIFocusItemContainer> {
...
@property (nonatomic, readonly) void*_backingNode;
...
- (void)_processSearchTokens:(struct vector<Token, std::allocator<Token>> { struct Token {} *x1; struct Token {} *x2; struct __compressed_pair<Token *, std::allocator<Token>> { struct Token {} *x_3_1_1; } x3; })arg1 visited:(void*)arg2 usingBlock:(id /* block */)arg3 stopPointer:(bool*)arg4;
