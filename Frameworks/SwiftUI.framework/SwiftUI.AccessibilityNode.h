...
@interface SwiftUI.AccessibilityNode : UIResponder <AXChart, UIAccessibilityContainerDataTable, UIAccessibilityContainerDataTableCell> {
...
- (bool)_accessibilityCanPerformAction:(unsigned int)arg1;
