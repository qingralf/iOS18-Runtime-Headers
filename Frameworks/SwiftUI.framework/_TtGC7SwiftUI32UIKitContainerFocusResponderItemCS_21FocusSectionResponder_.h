...
@interface _TtGC7SwiftUI32UIKitContainerFocusResponderItemCS_21FocusSectionResponder_ : UIKitContainerFocusResponderItemBase <UIFocusItem, UIFocusItemContainer, _UIFocusItemContainerPrivate> {
    void base;
