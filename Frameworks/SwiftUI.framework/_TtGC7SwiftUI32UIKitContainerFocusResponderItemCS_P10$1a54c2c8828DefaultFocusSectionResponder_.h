...
@interface _TtGC7SwiftUI32UIKitContainerFocusResponderItemCS_P10$1a54c2c8828DefaultFocusSectionResponder_ : UIKitContainerFocusResponderItemBase <UIFocusItem, UIFocusItemContainer, _UIFocusItemContainerPrivate> {
    void base;
    void cachedCoordinateSpace;
    void frame;
    void host;
    void isEnabled;
}
