...
+ (void)_mergeEffectOptions:(id)arg1 intoRBOptions:(id)arg2 forEffect:(long long)arg3;
...
- (id)ui_animationConfigurationWithOptions:(id)arg1 completion:(id /* block */)arg2 configuration:(id)arg3;
