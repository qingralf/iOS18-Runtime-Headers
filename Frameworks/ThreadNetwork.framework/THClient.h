...
- (void)ctcsDeletePreferredNetworkForNetworkSignatureInternallyWithCompletion:(id)arg1 ipv6NwSignature:(id)arg2 wifiSSID:(id)arg3 completion:(id /* block */)arg4;
...
- (void)retrievePreferredNetworkWithNoScan:(id /* block */)arg1;
- (void)setIsConnected:(bool)arg1;
- (void)setThreadSafePropertyQueue:(struct dispatch_queue_s { }*)arg1;
- (void)setXpcConnection:(id)arg1;
- (void)storeCachedAODasPreferredNetwork:(id)arg1 completion:(id /* block */)arg2;
...
- (void)validateAODInternally:(id)arg1 completion:(id /* block */)arg2;
- (id)xpcConnection;
