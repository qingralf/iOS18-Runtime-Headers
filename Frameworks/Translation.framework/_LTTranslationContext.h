...
@interface _LTTranslationContext : NSObject <NSSecureCoding> {
    ...
    bool  _cancelOnCleanup;
    bool  _censorSpeech;
    bool  _cleanUpExistingSpeechSession;
...
@property (nonatomic) bool cancelOnCleanup;
@property (nonatomic) bool censorSpeech;
@property (nonatomic) bool cleanUpExistingSpeechSession;
...
- (void)setCancelOnCleanup:(bool)arg1;
- (void)setCensorSpeech:(bool)arg1;
- (void)setCleanUpExistingSpeechSession:(bool)arg1;
