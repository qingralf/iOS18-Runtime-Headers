...
@property (nonatomic, readonly) bool itk_isGIF;
@property (nonatomic, readonly) bool itk_isHEIC;
@property (nonatomic, readonly) bool itk_isHEICS;
@property (nonatomic, readonly) bool itk_isJPEG;
@property (nonatomic, readonly) bool itk_isPNG;
@property (nonatomic, readonly) bool itk_isWebP;
...
+ (id)em_contentTypeForFilename:(id)arg1 fileURL:(id)arg2;
+ (id)log;
