...
+ (id)attachmentWithIdentifier:(id)arg1 URL:(id)arg2 options:(id)arg3 userInfo:(id)arg4 error:(id*)arg5;
...
- (id)initWithIdentifier:(id)arg1 URL:(id)arg2 type:(id)arg3 options:(id)arg4 userInfo:(id)arg5;
...
+ (unsigned long long)stagingActionForFileHandle:(id)arg1 fromLocalClientConnection:(id)arg2 orFromServiceExtensionOfBundleProxy:(id)arg3 servicingBundleIdentifier:(id)arg4 error:(id*)arg5;
