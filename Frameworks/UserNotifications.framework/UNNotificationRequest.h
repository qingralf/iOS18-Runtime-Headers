...
+ (bool)isNotMissedCategory:(id)arg1;
...
+ (id)_hkmobility_notificationRequestWithCategory:(id)arg1 shouldHidePregnancyContent:(bool)arg2 expirationDate:(id)arg3;
+ (id)_hkmobility_requestForCategory:(id)arg1 shouldHidePregnancyContent:(bool)arg2 startDate:(id)arg3;
+ (id)hkmobility_requestForCategory:(id)arg1 shouldHidePregnancyContent:(bool)arg2;

// Image: /System/Library/PrivateFrameworks/IMDPersistence.framework/IMDPersistence

- (id)requestWithCellularWaypointAvailableUserInfo;
...
- (unsigned long long)hksp_analyticsSleepNotificationType;
- (bool)hksp_shouldSubmitAnalytics;
