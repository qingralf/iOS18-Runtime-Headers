...
+ (id)settingsWithAuthorizationStatus:(long long)arg1 soundSetting:(long long)arg2 badgeSetting:(long long)arg3 alertSetting:(long long)arg4 notificationCenterSetting:(long long)arg5 lockScreenSetting:(long long)arg6 carPlaySetting:(long long)arg7 remoteNotificationsSetting:(long long)arg8 announcementSetting:(long long)arg9 criticalAlertSetting:(long long)arg10 timeSensitiveSetting:(long long)arg11 scheduledDeliverySetting:(long long)arg12 directMessagesSetting:(long long)arg13 alertStyle:(long long)arg14 showPreviewsSetting:(long long)arg15 groupingSetting:(long long)arg16 providesAppNotificationSettings:(bool)arg17;
+ (id)settingsWithAuthorizationStatus:(long long)arg1 soundSetting:(long long)arg2 badgeSetting:(long long)arg3 alertSetting:(long long)arg4 notificationCenterSetting:(long long)arg5 lockScreenSetting:(long long)arg6 carPlaySetting:(long long)arg7 remoteNotificationsSetting:(long long)arg8 announcementSetting:(long long)arg9 criticalAlertSetting:(long long)arg10 timeSensitiveSetting:(long long)arg11 scheduledDeliverySetting:(long long)arg12 directMessagesSetting:(long long)arg13 summarizationSetting:(long long)arg14 alertStyle:(long long)arg15 showPreviewsSetting:(long long)arg16 groupingSetting:(long long)arg17 providesAppNotificationSettings:(bool)arg18;
