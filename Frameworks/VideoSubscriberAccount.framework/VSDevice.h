...
@property (nonatomic, readonly) NSString *bincompatOS;
@property (nonatomic, readonly) NSString *bincompatPlatform;
...
@property (nonatomic, retain) NSOperationQueue *propertyFetchQueue;
...
- (void)setDeviceNameString:(id)arg1;
...
- (void)setPropertyFetchQueue:(id)arg1;
