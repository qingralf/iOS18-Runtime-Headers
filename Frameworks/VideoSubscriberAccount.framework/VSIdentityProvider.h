...
@interface VSIdentityProvider : NSObject <NSCopying, NSSecureCoding> {
    ...
    bool  _requireAuthenticationURLSystemTrust;
    bool  _requireXHRRequestSystemTrust;
...
@property (nonatomic) bool requireAuthenticationURLSystemTrust;
...
- (void)setRequireAuthenticationURLSystemTrust:(bool)arg1;
- (void)setRequireXHRRequestSystemTrust:(bool)arg1;
