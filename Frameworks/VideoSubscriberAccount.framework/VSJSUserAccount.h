...
@interface VSJSUserAccount : VSJSObject <VSJSUserAccount> {
    ...
    VSJSAppleSubscription * _appleSubscription;
...
@property (nonatomic, retain) VSJSAppleSubscription *appleSubscription;
...
+ (id)jsUserAccountsFromUserAccounts:(id)arg1;
+ (id)userAccountsFromJSUserAccounts:(id)arg1;
