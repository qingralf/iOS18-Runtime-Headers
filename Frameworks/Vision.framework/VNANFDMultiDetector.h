...
@property (nonatomic, readonly) VNShotflowDetector *VNShotflowDetector;
...
+ (id)defaultFilterThresholdsForOptions:(id)arg1 error:(id*)arg2;
...
- (id)applicableOptionKeyToShotflowKeyMappingsForOptions:(id)arg1 error:(id*)arg2;
...
- (id)filterThresholdsForOptions:(id)arg1 error:(id*)arg2;
