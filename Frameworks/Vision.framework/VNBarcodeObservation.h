...
- (id)initWithOriginatingRequestSpecifier:(id)arg1 symbology:(id)arg2 descriptor:(id)arg3 mrcDescriptor:(struct __MRCDescriptor { }*)arg4 topLeft:(struct CGPoint { double x1; double x2; })arg5 topRight:(struct CGPoint { double x1; double x2; })arg6 bottomRight:(struct CGPoint { double x1; double x2; })arg7 bottomLeft:(struct CGPoint { double x1; double x2; })arg8;
