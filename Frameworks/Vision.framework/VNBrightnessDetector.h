...
- (struct __CVBuffer { }*)_createPixelBufferFromImageBuffer:(id)arg1 regionOfInterest:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 maximumIntermediateSideLength:(unsigned long long)arg3 options:(id)arg4 error:(id*)arg5;
