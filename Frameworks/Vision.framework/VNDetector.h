...
+ (bool)areExistingInitializationOptions:(id)arg1 compatibleWithOptions:(id)arg2;
...
+ (Class)detectorClassAndConfigurationOptions:(id*)arg1 forDetectorType:(id)arg2 options:(id)arg3 error:(id*)arg4;
...
+ (bool)runSuccessReportingBlockSynchronously:(id /* block */)arg1 detector:(id)arg2 qosClass:(unsigned int)arg3 error:(id*)arg4;
