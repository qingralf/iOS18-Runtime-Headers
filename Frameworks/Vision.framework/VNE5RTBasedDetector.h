...
@property (nonatomic, readonly, copy) VisionCoreE5RTInferenceFunctionDescriptor *functionDescriptor;

+ (id)E5RTFunctionDescriptorForConfigurationOptions:(id)arg1 error:(id*)arg2;
+ (id)E5RTProgramLibraryCompilationOptionsForModelSource:(id)arg1 configurationOptions:(id)arg2 error:(id*)arg3;
+ (id)E5RTProgramLibraryCustomCompilationOptionsForModelSource:(id)arg1 configurationOptions:(id)arg2 error:(id*)arg3;
+ (id)E5RTProgramLibraryForConfigurationOptions:(id)arg1 error:(id*)arg2;
+ (unsigned long long)E5RTVisionCoreComputeDeviceForConfigurationOptions:(id)arg1 error:(id*)arg2;
