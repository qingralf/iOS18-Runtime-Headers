...
+ (id)JSONDataFromNetworkFilePath:(id)arg1 error:(id*)arg2;
...
+ (bool)createSingleNetworkPlanFromModelPath:(id)arg1 forComputeDevice:(id)arg2 lowPriorityMode:(bool)arg3 priority:(int)arg4 inputBlobNames:(id)arg5 outputBlobNames:(id)arg6 networkConfiguration:(id)arg7 explicitNetworkLayersStorageType:(int)arg8 memoryPoolId:(unsigned long long)arg9 espressoResources:(id*)arg10 error:(id*)arg11;
+ (bool)createSingleNetworkPlanFromModelPath:(id)arg1 forComputeDevice:(id)arg2 lowPriorityMode:(bool)arg3 priority:(int)arg4 inputBlobNames:(id)arg5 outputBlobNames:(id)arg6 networkConfiguration:(id)arg7 memoryPoolId:(unsigned long long)arg8 espressoResources:(id*)arg9 error:(id*)arg10;
...
+ (id)weightsFilePathForEspressoNetworkModelFilePath:(id)arg1 error:(id*)arg2;
