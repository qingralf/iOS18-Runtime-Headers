...
+ (int)_detectorConstellationForRequestConstellation:(unsigned long long)arg1;
...
- (bool)getLandmarkErrorEstimates:(void*)arg1 forRequestConstellation:(unsigned long long)arg2 error:(id*)arg3;
- (bool)getLandmarkPoints:(void*)arg1 forRequestConstellation:(unsigned long long)arg2 error:(id*)arg3;
...
- (bool)requestConstellation:(unsigned long long*)arg1 cvmlConstellation:(int*)arg2 fromOptions:(id)arg3 error:(id*)arg4;
