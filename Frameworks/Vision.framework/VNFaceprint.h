...
- (id)initWithRawData:(const void*)arg1 confidence:(float)arg2 requestRevision:(unsigned long long)arg3;
- (id)initWithRawData:(const void*)arg1 elementCount:(unsigned long long)arg2 elementType:(unsigned long long)arg3 lengthInBytes:(unsigned long long)arg4 confidence:(float)arg5 requestRevision:(unsigned long long)arg6;
