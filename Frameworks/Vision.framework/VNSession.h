...
- (id)_locateResourceObjectForIdentifier:(id)arg1 creationBlock:(id /* block */)arg2 error:(id*)arg3;
- (void)_releaseDetectorsThatCanBeReplacedByDetectorOfClass:(Class)arg1 withConfiguration:(id)arg2;
- (id)cachedResourceObjectForIdentifier:(id)arg1;
...
- (id)resourceObjectForIdentifier:(id)arg1 creationBlock:(id /* block */)arg2 error:(id*)arg3;
