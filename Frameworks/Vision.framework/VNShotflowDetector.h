...
+ (id)processingDeviceDetectorWithEspressoNetwork:(struct { void *x1; int x2; })arg1 espressoPlan:(void*)arg2 networkThreshold:(float)arg3;
+ (id)processingDeviceDetectorWithModelPath:(id)arg1 networkThreshold:(float)arg2 preferredDeviceID:(int)arg3 engineID:(int)arg4 storageType:(int)arg5;
...
- (id)detectAndProcessObjects:(const struct vImage_Buffer { void *x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; }*)arg1 filterThresholds:(id)arg2 inputIsBGR:(bool)arg3;
- (id)enforceSquareFaces:(id)arg1 withHeight:(float)arg2 andWidth:(float)arg3;
- (id)filterBoxes:(id)arg1 usingThresholds:(id)arg2;
