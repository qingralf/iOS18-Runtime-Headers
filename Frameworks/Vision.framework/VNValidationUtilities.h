...
+ (int)espressoPriorityForModelExecutionPriority:(unsigned long long)arg1;
...
+ (bool)getEspressoPriority:(int*)arg1 forKey:(id)arg2 inOptions:(id)arg3 withDefaultValue:(int)arg4 error:(id*)arg5;
...
+ (bool)getOptionalFaceObservation:(id*)arg1 inOptions:(id)arg2 error:(id*)arg3;
+ (bool)getOptionalFaceObservations:(id*)arg1 inOptions:(id)arg2 error:(id*)arg3;
...
+ (id)requiredFaceObservationInOptions:(id)arg1 error:(id*)arg2;
+ (id)requiredFaceObservationsInOptions:(id)arg1 error:(id*)arg2;
