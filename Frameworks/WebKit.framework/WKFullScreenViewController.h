...
@interface WKFullScreenViewController : UIViewController <UIGestureRecognizerDelegate, UIToolbarDelegate, WKExtrinsicButtonDelegate> {
    ...
    bool  _inWindowFullscreenActive;
    bool  _isShowingMenu;
    struct String { 
...
@property (getter=isinWindowFullscreenActive, nonatomic) bool inWindowFullscreenActive;
...
- (id).cxx_construct;
- (void).cxx_destruct;
- (void)_bannerDismissalRecognized:(id)arg1;
...
- (void)_enterVideoFullscreenAction:(id)arg1;
- (void*)_manager;
- (void)_pauseIfNeeded;
- (struct RefPtr<WebCore::PlaybackSessionInterfaceAVKit, WTF::RawPtrTraits<WebCore::PlaybackSessionInterfaceAVKit>, WTF::DefaultRefDerefTraits<WebCore::PlaybackSessionInterfaceAVKit>> { struct PlaybackSessionInterfaceAVKit {} *x1; })_playbackSessionInterface;
...
- (void)setInWindowFullscreenActive:(bool)arg1;
...
- (void)wkExtrinsicButtonWillDismissMenu:(id)arg1;
- (void)wkExtrinsicButtonWillDisplayMenu:(id)arg1;
