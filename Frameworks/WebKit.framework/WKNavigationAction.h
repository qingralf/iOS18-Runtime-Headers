...
@property (nonatomic, readonly) NSString *_targetFrameName;
...
@property (nonatomic, readonly) bool safari_shouldProhibitNavigationToSafariSpecificURL;
...
- (bool)safari_shouldProhibitNavigationToSafariSpecificURL;
