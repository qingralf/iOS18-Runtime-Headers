...
@property (setter=_setAllowPrivacySensitiveOperationsInNonPersistentDataStores:, nonatomic) bool _allowPrivacySensitiveOperationsInNonPersistentDataStores;
...
@property (setter=_setInactiveMediaCaptureStreamRepromptIntervalInMinutes:, nonatomic) double _inactiveMediaCaptureStreamRepromptIntervalInMinutes;
...
@property (setter=_setMediaCapabilityGrantsEnabled:, nonatomic) bool _mediaCapabilityGrantsEnabled;
...
@property (setter=_setSpatialVideoEnabled:, nonatomic) bool _spatialVideoEnabled;
...
@property (setter=_setTextExtractionEnabled:, nonatomic) bool _textExtractionEnabled;
...
@property (setter=_setVideoFullscreenRequiresElementFullscreen:, nonatomic) bool _videoFullscreenRequiresElementFullscreen;
...
- (void)_setAllowPrivacySensitiveOperationsInNonPersistentDataStores:(bool)arg1;
...
- (void)_setInactiveMediaCaptureStreamRepromptIntervalInMinutes:(double)arg1;
...
- (void)_setMediaCapabilityGrantsEnabled:(bool)arg1;
