...
@interface WKWebViewConfiguration : NSObject <NSCopying, NSSecureCoding, WKObject> {
    struct ObjectStorage<API::PageConfiguration> { 
        struct type { 
...
@property (setter=_setMultiRepresentationHEICInsertionEnabled:, nonatomic) bool _multiRepresentationHEICInsertionEnabled;
...
@property (setter=_setPortsForUpgradingInsecureSchemeForTesting:, nonatomic) NSArray *_portsForUpgradingInsecureSchemeForTesting;
...
@property (setter=_setRequiredWebExtensionBaseURL:, nonatomic, retain) NSURL *_requiredWebExtensionBaseURL;
...
@property (setter=_setScrollToTextFragmentIndicatorEnabled:, nonatomic) bool _scrollToTextFragmentIndicatorEnabled;
@property (setter=_setScrollToTextFragmentMarkingEnabled:, nonatomic) bool _scrollToTextFragmentMarkingEnabled;
...
@property (nonatomic, readonly) WKWebExtensionController *_strongWebExtensionController;
...
@property (setter=_setWeakWebExtensionController:, nonatomic) WKWebExtensionController *_weakWebExtensionController;
...
@property (nonatomic, retain) WKWebExtensionController *webExtensionController;
...
- (id)_portsForUpgradingInsecureSchemeForTesting;
...
- (void)_setScrollToTextFragmentIndicatorEnabled:(bool)arg1;
- (void)_setScrollToTextFragmentMarkingEnabled:(bool)arg1;
...
- (void)setWebExtensionController:(id)arg1;
