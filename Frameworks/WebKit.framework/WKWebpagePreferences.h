...
- (void)_setPushAndNotificationAPIEnabled:(bool)arg1;
- (void)_setUserContentController:(id)arg1;
- (void)_setVisibilityAdjustmentSelectors:(id)arg1;
- (void)_setVisibilityAdjustmentSelectorsIncludingShadowHosts:(id)arg1;
...
- (long long)preferredHTTPSNavigationPolicy;
...
- (void)setPreferredHTTPSNavigationPolicy:(long long)arg1;
