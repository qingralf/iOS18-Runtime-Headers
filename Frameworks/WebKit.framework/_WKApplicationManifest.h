...
@property (nonatomic, readonly) long long dir;
...
@property (nonatomic, readonly, copy) NSString *rawJSON;
@property (nonatomic, readonly) NSString *safari_applicationCategoryType;
...
@property (setter=safari_setIconKind:, nonatomic, retain) NSString *safari_iconKind;
...
@property (nonatomic, readonly) NSURL *safari_scope;
...
@property (nonatomic, readonly, copy) NSArray *shortcuts;
...
- (id)initWithJSONData:(id)arg1 manifestURL:(id)arg2 documentURL:(id)arg3;
- (bool)isDefaultScope;
- (id)manifestId;
- (id)manifestURL;
- (id)name;
...
+ (id)_manifestWithInfoDictionary:(id)arg1 withSynthesizedProperties:(bool)arg2;
+ (id)safari_manifestWithInfoDictionary:(id)arg1;
...
- (id)safari_scope;
- (void)safari_setIconKind:(id)arg1;
