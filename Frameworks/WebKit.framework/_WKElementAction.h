...
+ (id)_elementActionWithType:(long long)arg1 customTitle:(id)arg2 assistant:(id)arg3 disabled:(bool)arg4;
+ (id)_elementActionWithType:(long long)arg1 info:(id)arg2 assistant:(id)arg3;
+ (id)_elementActionWithType:(long long)arg1 info:(id)arg2 assistant:(id)arg3 disabled:(bool)arg4;
...
- (id)_initWithTitle:(id)arg1 actionHandler:(id /* block */)arg2 type:(long long)arg3 assistant:(id)arg4 disabled:(bool)arg5;
