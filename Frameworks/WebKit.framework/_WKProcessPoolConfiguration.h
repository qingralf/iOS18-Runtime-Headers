...
@property (nonatomic, copy) NSArray *memoryFootprintNotificationThresholds;
...
- (id)memoryFootprintNotificationThresholds;
...
- (void)setMemoryFootprintNotificationThresholds:(id)arg1;
- (void)setMemoryFootprintPollIntervalForTesting:(double)arg1;
