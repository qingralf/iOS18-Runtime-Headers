...
@property (nonatomic, copy) NSNumber *defaultTrackingPreventionEnabledOverride;
...
@property (nonatomic) bool isDeclarativeWebPushEnabled;
...
- (void)dealloc;
- (id)defaultTrackingPreventionEnabledOverride;
...
- (void)setDefaultTrackingPreventionEnabledOverride:(id)arg1;
...
- (void)setIsDeclarativeWebPushEnabled:(bool)arg1;
