...
@interface WidgetKit._WidgetExtensionSession : _TtCs12_SwiftObject <WidgetKit.WidgetExtensionSession> {
    ...
    union { in /* Warning: Unrecognized filer type: 'u' using 'void*' */ void*x1; long x2; long x3; }  _exExtensionIdentity;
    union { in /* Warning: Unrecognized filer type: 'u' using 'void*' */ void*x1; long x2; long x3; }  _exExtensionProcess;
    void connection;
    void lock;
...
- (void)getControlTemplatesWithRequests:(id)arg1 completion:(id /* block */)arg2;
...
- (void)getWidgetRelevancesWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (void)handleURLSessionEventsFor:(id)arg1 completion:(id /* block */)arg2;
- (void)invalidate;
- (int)pid;
- (void)pushTokensDidChange:(id)arg1 completion:(id /* block */)arg2;
