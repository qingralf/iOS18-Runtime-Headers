...
@property (nonatomic, copy) NSError *topLevelError;
...
- (void)updateTaskResultWithError:(id)arg1;

// Image: /System/Library/PrivateFrameworks/AppleIDSSOAuthentication.framework/AppleIDSSOAuthentication

+ (id)accountForAuthenticationResults:(id)arg1 accountManager:(id)arg2;
+ (id)aida_analyticsDurationEventForAIDAServiceType:(id)arg1 accountManager:(id)arg2 authenticationResults:(id)arg3;
+ (id)aida_analyticsEventWithEventName:(id)arg1;
+ (id)aida_analyticsEventWithEventName:(id)arg1 accountManager:(id)arg2 authenticationResults:(id)arg3;
+ (id)aida_analyticsFinishEventForAIDAServiceType:(id)arg1 accountManager:(id)arg2 authenticationResults:(id)arg3 success:(bool)arg4 error:(id)arg5;
+ (id)aida_analyticsStartEventForAIDAServiceType:(id)arg1 accountManager:(id)arg2 authenticationResults:(id)arg3;
+ (id)eventNameForService:(id)arg1;
+ (id)finishEventNameForService:(id)arg1;
+ (id)startEventNameForService:(id)arg1;

- (void)aida_updateEventWithSuccess:(bool)arg1 error:(id)arg2;
- (void)aida_updateTelemetryIdsWithAuthenticationResults:(id)arg1 accountManager:(id)arg2;

// Image: /System/Library/PrivateFrameworks/AuthKit.framework/AuthKit

+ (id)ak_analyticsEventWithContext:(id)arg1 client:(id)arg2 eventName:(id)arg3 error:(id)arg4;
+ (id)ak_analyticsEventWithContext:(id)arg1 eventName:(id)arg2 error:(id)arg3;
