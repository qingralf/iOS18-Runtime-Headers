...
- (id)initWithContext:(id)arg1 robustPanoParams:(struct { unsigned long long x1; unsigned long long x2; bool x3; int x4; int x5; float x6; float x7; float x8; int x9; bool x10; })arg2;
