...
- (void)cancel;
- (int)compleOOBBuffer:(unsigned long long)arg1;
- (void)dealloc;
- (void)dequeueDataMessage:(struct _IODataQueueMemory { unsigned int x1; unsigned int x2; unsigned int x3; struct _IODataQueueEntry { unsigned int x_4_1_1; unsigned char x_4_1_2[4]; } x4[1]; }*)arg1;
...
- (void)handleCommand:(char *)arg1 size:(unsigned int)arg2;
- (void)handleDescriptor:(char *)arg1 size:(unsigned int)arg2;
- (void)handleQueue:(char *)arg1 size:(unsigned int)arg2;
- (void)handleReport:(char *)arg1 size:(unsigned int)arg2;
- (void)handleResponse:(char *)arg1 size:(unsigned int)arg2;
