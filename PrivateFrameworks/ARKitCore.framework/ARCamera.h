...
@interface ARCamera : NSObject <NSCopying, NSSecureCoding, OUCamera, RSCamera> {
...
@property (nonatomic, readonly) long long trackingState;
...
- (id)initWithIntrinsics:(void *)arg1 imageResolution:(void *)arg2 devicePosition:(void *)arg3 lensType:(void *)arg4 radialDistortion:(void *)arg5 tangentialDistortion:(void *)arg6 exposureDuration:(void *)arg7 calibrationData:(void *)arg8 extrinsicsMap:(void *)arg9 captureLens:(void *)arg10; // needs 10 arg types, found 8: struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[3]; }, struct CGSize { double x1; double x2; }, long long, unsigned long long, double, id, id, unsigned long long
