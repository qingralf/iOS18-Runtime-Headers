...
@interface ARConfiguration : NSObject <NSCopying> {
    ...
    bool  _dropInitialFramesOutsideExposureTarget;
...
@property (nonatomic) bool dropInitialFramesOutsideExposureTarget;
...
- (void)setDropInitialFramesOutsideExposureTarget:(bool)arg1;
