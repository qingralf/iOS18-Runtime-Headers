...
- (id).cxx_construct;
- (void).cxx_destruct;
- (bool)_addProbeWithAnchor:(id)arg1 timestamp:(double)arg2 textureImmediately:(bool)arg3;
- (id)_fullDescription;
- (void)_insertIntoQueue:(id)arg1;
- (bool)_isBusy;
- (void)_requestTextureForProbe:(id)arg1;
- (bool)_textureDataIsBusy;
- (void)_updateProbesFromExistingAnchors:(id)arg1;
