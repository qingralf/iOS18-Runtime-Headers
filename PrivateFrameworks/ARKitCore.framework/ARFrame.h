...
@interface ARFrame : NSObject <NSCopying, NSSecureCoding, OUFrame> {
    NSArray * _anchors;
...
@property (nonatomic, readonly) <OUCamera> *camera;
...
@property (nonatomic, readonly) long long deviceOrientation; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) <OUCamera> *sceneCamera;
@property (nonatomic, readonly) struct __CVBuffer { }*sceneColorBuffer;
@property (nonatomic, retain) ARDepthData *sceneDepth;
@property (nonatomic, readonly) struct __CVBuffer { }*sceneDepthBuffer;
@property (nonatomic, readonly) struct __CVBuffer { }*sceneDepthConfidenceBuffer;
@property (nonatomic) struct __CVBuffer { }*segmentationBuffer;
@property (nonatomic, readonly) struct __CVBuffer { }*semanticConfidenceBuffer;
@property (nonatomic, readonly) struct __CVBuffer { }*semanticLabelBuffer;
