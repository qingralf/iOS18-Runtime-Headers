...
@interface ARParentImageSensor : NSObject <ARImageSensorDataSource, ARSensor, AVCaptureAudioDataOutputSampleBufferDelegate> {
    ...
    id /* block */  _beforeRunningAVCaptureSession;
...
@property (nonatomic, copy) id /* block */ beforeRunningAVCaptureSession;
...
- (id)audioInput;
- (id)audioOutput;
- (id /* block */)beforeRunningAVCaptureSession;
...
- (bool)running;
- (id)sensors;
- (void)setBeforeRunningAVCaptureSession:(id /* block */)arg1;
