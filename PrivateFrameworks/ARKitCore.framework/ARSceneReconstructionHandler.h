...
- (bool)_lockAndExecuteBlock:(id /* block */)arg1;
- (bool)_lockAndExecuteCFErrorBlockWithErrorMessage:(id)arg1 cfErrorBlock:(id /* block */)arg2;
- (bool)_lockAndExecuteCFErrorBlockWithErrorMessage:(id)arg1 cfErrorBlock:(id /* block */)arg2 failSession:(bool)arg3;
- (bool)_lockAndExecuteNSErrorBlock:(id /* block */)arg1;
...
- (long long)reconfigureSceneReconstruction:(unsigned long long)arg1 options:(id)arg2;
- (void)reset;
