...
+ (bool)isCaptureDeviceTypeAvailable:(id)arg1 position:(long long)arg2;
...
+ (id)supportedVideoFormatsForHiResOrX420ForDevicePosition:(long long)arg1 deviceType:(id)arg2;
+ (id)supportedVideoFormatsForStillImageCapture;
+ (id)supportedVideoFormatsForStillImageCaptureForDevicePosition:(long long)arg1 deviceType:(id)arg2;
