...
@interface ARWorldTrackingTechnique : ARImageBasedTechnique <ARSceneReconstructionDelegate> {
    ...
    bool  _shouldPushVisionDataIntrinsics;
    bool  _shouldUseFullResolutionVisionDataIntrinsics;
...
- (id).cxx_construct;
- (void).cxx_destruct;
- (unsigned char)CV3DSLAMJasperPointCloudProjectorModeFromAVTimeOfFlightProjectorMode:(long long)arg1;
