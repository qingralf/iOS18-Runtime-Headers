...
- (void)_reportCoreAnalyticsDaemonEventWithServiceName:(id)arg1 clientBundleIdentifier:(id)arg2 isServiceRemoved:(bool)arg3 isDisconnectingClient:(bool)arg4;
- (void)_reportDaemonHeartbeatForSessionUUID:(id)arg1 daemonUpTimeExcludingSleepMinutes:(unsigned long long)arg2 daemonUpTimeIncludingSleepMinutes:(unsigned long long)arg3 systemUpTimeMinutes:(unsigned long long)arg4 memoryFootprintInBytes:(unsigned long long)arg5;
- (id)init;
- (id)lastDonTime;
