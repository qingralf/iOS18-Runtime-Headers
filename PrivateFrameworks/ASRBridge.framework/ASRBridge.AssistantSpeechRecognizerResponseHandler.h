...
@interface ASRBridge.AssistantSpeechRecognizerResponseHandler : ASRBridge.SpeechRecognizerResponseHandler {
...
- (void)localSpeechRecognizerClient:(id)arg1 receivedMultiUserTRPCandidatePackage:(id)arg2;
