...
+ (int)setMuteStateChangedHandler:(id /* block */)arg1;
...
- (id)deviceList;
- (id)devices;
- (void)dispatchedHandleMuteStateChangedEventWithXPCArguments:(id)arg1;
...
- (void)setMicrophoneMuted:(bool)arg1;
- (void)setMixingVoiceWithMediaEnabled:(bool)arg1;
- (int)setMuteStateChangedEventHandler:(id /* block */)arg1;
- (bool)setOutputDevice:(id)arg1;
