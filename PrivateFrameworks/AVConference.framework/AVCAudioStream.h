...
@property (nonatomic) <HMDAVCAudioStreamDelegate> *delegate;
@property (nonatomic) <AVCAudioStreamDelegate> *delegate;
@property (readonly, copy) NSString *description;
@property (nonatomic) long long direction;
@property (nonatomic, readonly) long long downlinkToken;
...
@property (nonatomic, readonly) long long uplinkToken;
...
- (void)pause;
- (void)processDTMFEventWithDigit:(id)arg1;
