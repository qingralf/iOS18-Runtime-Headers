...
@property (nonatomic, readonly) AVCMediaStreamConfigRemoteDeviceInfo *remoteDeviceInfo;
...
+ (int)clientCodecCMRModeModeWithEVSCMRMode:(int)arg1;
...
+ (int)evsCMRModeForClientCodecCMRMode:(int)arg1;
