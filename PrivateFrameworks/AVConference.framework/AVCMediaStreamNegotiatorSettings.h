...
@property (nonatomic, readonly) NSString *audioDeviceUID;
@property (nonatomic, readonly) long long audioStreamMode;
@property (nonatomic, readonly) bool blackFrameOnClearScreenEnabled;
@property (nonatomic, readonly) bool blackFrameOnClearScreenEnabledDefault;
...
@property (nonatomic, readonly) bool foveationIsSupported;
