...
@interface AVCVideoStream : NSObject <HMDAVCVideoStream, VCMediaStreamDelegate> {
...
@property (nonatomic, readonly) AVCMediaStreamConfig *configuration;
@property (nonatomic, retain) AVCMediaStreamConfig *configuration;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (nonatomic) <HMDAVCVideoStreamDelegate> *delegate;
