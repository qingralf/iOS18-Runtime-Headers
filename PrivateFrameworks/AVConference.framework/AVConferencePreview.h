...
- (void)cleanupPreviewLayerHost:(id*)arg1;
- (void)clearAllStickers:(bool)arg1;
- (void)connectLayer:(id)arg1 layerHost:(id)arg2 withContextId:(unsigned int)arg3;
- (void)connectLayer:(id)arg1 withSlot:(unsigned int)arg2;
- (id)copyWithZone:(struct _NSZone { }*)arg1;
- (void)createPreviewCALayerHostForRootLayer:(id)arg1 withContextId:(unsigned int)arg2 front:(bool)arg3;
...
- (void)followSystemCameraDidChange:(bool)arg1;
- (void)getSnapshot;
- (id)init;
- (void)invalidate;
...
- (id)newXPCObjectForFenceHandle:(id*)arg1 forLayerHost:(id)arg2;
- (void)notifyCenterStageEnabled:(bool)arg1;
- (void)pausePreview;
...
- (void)setBounds:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 forLayerHost:(id)arg2;
...
- (void)setLocalVideoLayerHost:(id)arg1 front:(bool)arg2;
- (void)setMemoji:(id)arg1;
- (bool)setRootPreviewLayer:(id)arg1 front:(bool)arg2;
- (void)startPreview;
