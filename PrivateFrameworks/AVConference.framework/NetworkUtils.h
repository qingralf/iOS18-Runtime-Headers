...
+ (id)networkEmulationSettings:(id)arg1;
+ (id)networkEmulationSettings:(id)arg1 onUplink:(bool)arg2;
+ (id)newEncryptionInfoWithMediaKeyIndex:(id)arg1 participantID:(id)arg2;
...
+ (id)securityKeyMaterialWithMediaKeyIndex:(id)arg1 participantID:(id)arg2;
