...
+ (bool)captureDeviceformatSupportsVideoEffects:(id)arg1;
+ (bool)deviceInputSupportsCenterStage:(id)arg1;
+ (bool)deviceInputSupportsVideoEffects:(id)arg1;
...
- (void)applyBlockToAllAvailableCaptureFormats:(id /* block */)arg1;
...
- (void)collectCaptureFrameRateStats:(struct __CFDictionary { }*)arg1;
...
- (struct tagVCVideoCaptureFeatureStatus { BOOL x1; BOOL x2; BOOL x3; BOOL x4; BOOL x5; BOOL x6; BOOL x7; })currentVideoFeatureStatus;
- (void)dataOutputSynchronizer:(id)arg1 didOutputSynchronizedDataCollection:(id)arg2;
- (void)dealloc;
- (id)depthDataOutput;
- (void)dispatchedCurrentVideoFeatureStatus:(struct tagVCVideoCaptureFeatureStatus { BOOL x1; BOOL x2; BOOL x3; BOOL x4; BOOL x5; BOOL x6; BOOL x7; }*)arg1;
- (bool)effectsApplied;
...
- (BOOL)featureStatusForFeatureSupported:(bool)arg1 enabled:(bool)arg2;
...
- (void)reportStatus:(struct __CFDictionary { }*)arg1 forKey:(struct __CFString { }*)arg2 supported:(bool)arg3 enabled:(bool)arg4;
...
- (bool)setCaptureDeviceMinFrameRateIfNeeded:(int)arg1;
...
- (void)setUpBackgroundBlurDelegate:(bool)arg1;
- (void)setUpCaptureDeviceObserver:(bool)arg1 keyPath:(id)arg2;
- (void)setUpCaptureDevicePropertyObservers:(bool)arg1;
