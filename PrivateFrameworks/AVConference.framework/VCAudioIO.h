...
@interface VCAudioIO : NSObject <VCAudioIOControllerDelegate> {
    ...
    struct _VCAudioEndpointData { 
        ...
        struct tagVCAudioIODelegateContext { 
            ...
            bool captionsUseSecondaryThread; 
...
+ (id)controllerForDeviceRole:(int)arg1 audioType:(unsigned int)arg2 direction:(unsigned char)arg3 operatingMode:(int)arg4 streamInputID:(long long)arg5 streamToken:(long long)arg6 networkClockID:(unsigned long long)arg7 remoteDeviceInfo:(id)arg8;
+ (id)defaultControllerForAudioType:(unsigned int)arg1 forDirection:(unsigned char)arg2 forOperatingMode:(int)arg3 remoteDeviceInfo:(id)arg4;
+ (id)newSystemAudioCaptureControllerForAudioType:(unsigned int)arg1 forOperatingMode:(int)arg2 remoteDeviceInfo:(id)arg3;
...
- (void)setUpAndTransferDelegateContext:(const struct tagVCAudioIODelegateContext { id x1; int (*x2)(); void *x3; long long x4; id x5; bool x6; id x7; }*)arg1 toDestinationContext:(struct tagVCAudioIODelegateContext { id x1; int (*x2)(); void *x3; long long x4; id x5; bool x6; id x7; }*)arg2;
