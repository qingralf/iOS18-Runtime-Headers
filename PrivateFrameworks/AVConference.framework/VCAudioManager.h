...
+ (unsigned char)audioIOTypeWithAudioUnitProperties:(id)arg1 shouldEnableAudioInput:(bool)arg2;
...
- (void)disableSpatialStreamParametersForClient:(id)arg1;
- (void)enableSpatialStreamParametersForClient:(id)arg1;
...
- (void)setupSpatialContextWithAudioUnitProperties:(id)arg1 forceUpdate:(bool)arg2;
- (bool)setupVAD;
