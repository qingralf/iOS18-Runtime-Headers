...
@property (nonatomic, readonly) unsigned int shortREDBitrate;
...
- (void)dealloc;
- (id)description;
- (int)encodeAudio:(struct opaqueVCAudioBufferList { }*)arg1 numInputSamples:(int)arg2 outputBytes:(void*)arg3 numOutputBytes:(int)arg4 shortREDBytes:(unsigned int*)arg5;
- (bool)getMagicCookie:(char *)arg1 withLength:(unsigned int*)arg2;
- (id)initWithConfig:(id)arg1;
- (bool)isDTXEmptyPacket:(unsigned int)arg1;
- (bool)isSIDFrame:(const char *)arg1 encodedBytes:(int)arg2;
- (void)resetEncoder;
