...
@interface VCAudioSession : VCObject <VCServerDelegate> {
    ...
    bool  _deferredNetworkUplinkClockEnabled;
    ...
    int  _sessionPid;
    bool  _useOptimizedHandoversForTelephony;
...
@property (nonatomic, readonly) double externalInputAudioLatency;
@property (nonatomic, readonly) double externalOutputAudioLatency;
...
+ (bool)convertAudioSessionProperties:(id)arg1 operatingMode:(int*)arg2 deviceRole:(int*)arg3 enableAudioPreWarming:(bool*)arg4 audioClockDeviceEnabled:(bool*)arg5 networkUplinkClockUsesBaseband:(bool*)arg6;
