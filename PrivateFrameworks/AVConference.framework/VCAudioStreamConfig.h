...
@interface VCAudioStreamConfig : VCMediaStreamConfig {
    ...
    bool  _dtmfEventCallbacksEnabled;
...
@property (nonatomic, readonly) NSDictionary *allCodecConfigurations;
...
@property (nonatomic) bool dtmfEventCallbacksEnabled;
...
@property (nonatomic, readonly) VCMediaStreamConfigRemoteDeviceInfo *remoteDeviceInfo;
...
- (void)setDtmfEventCallbacksEnabled:(bool)arg1;
