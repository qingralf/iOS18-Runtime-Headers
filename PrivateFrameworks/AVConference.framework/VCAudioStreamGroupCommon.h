...
@interface VCAudioStreamGroupCommon : VCObject <VCAudioIODelegate, VCAudioPowerSpectrumSourceDelegate, VCAudioStreamGroup, VCMediaCaptureController> {
    ...
    struct tagVCAudioStreamGroupStream { struct tagVCAudioStreamGroupStream {} *x1; bool x2; bool x3; void *x4; int (*x5)(); unsigned short x6; unsigned short x7; id x8; unsigned int x9; unsigned int x10; struct __CFDictionary {} *x11; struct __CFDictionary {} *x12; bool x13; } * _audioStreams;
...
@property (readonly) struct tagVCAudioStreamGroupStream { struct tagVCAudioStreamGroupStream {} *x1; bool x2; bool x3; void *x4; int (*x5)(); unsigned short x6; unsigned short x7; id x8; unsigned int x9; unsigned int x10; struct __CFDictionary {} *x11; struct __CFDictionary {} *x12; bool x13; }*audioStreams;
...
- (struct tagVCAudioStreamGroupStream { struct tagVCAudioStreamGroupStream {} *x1; bool x2; bool x3; void *x4; int (*x5)(); unsigned short x6; unsigned short x7; id x8; unsigned int x9; unsigned int x10; struct __CFDictionary {} *x11; struct __CFDictionary {} *x12; bool x13; }*)audioStreams;
...
- (id)getAudioDumpName;
- (void)initCodecConfigurationsForStream:(struct tagVCAudioStreamGroupStream { struct tagVCAudioStreamGroupStream {} *x1; bool x2; bool x3; void *x4; int (*x5)(); unsigned short x6; unsigned short x7; id x8; unsigned int x9; unsigned int x10; struct __CFDictionary {} *x11; struct __CFDictionary {} *x12; bool x13; }*)arg1 withDefaultAudioConfig:(id)arg2;
- (id)initWithConfig:(id)arg1 audioCallback:(int (*)arg2 context:(void*)arg3 audioDirection:(unsigned char)arg4 stateQueue:(id)arg5;
- (bool)isMuted;
