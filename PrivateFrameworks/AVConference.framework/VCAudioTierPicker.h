...
@property (nonatomic, retain) BitrateLimits *bitrateLimits;
...
+ (bool)isAlwaysOnRedAudioTier:(unsigned int)arg1 redNumPayloads:(unsigned int)arg2 usingCellular:(bool)arg3;
+ (bool)isLowBitrateAudioTier:(unsigned int)arg1;
+ (bool)isModeAudioOnly:(unsigned char)arg1;
+ (bool)isModeAudioVideo:(unsigned char)arg1;
+ (bool)isModeLowLatency:(unsigned char)arg1;
+ (bool)isModePlistSupported:(unsigned char)arg1;
+ (bool)isModeV2:(unsigned char)arg1;
+ (bool)isU1ModeWithPlistSupport:(unsigned char)arg1;
+ (bool)loadVCAudioTierFromTierTable:(id)arg1 bitrate:(unsigned int)arg2 redNumPayloads:(unsigned int)arg3 outEntryArray:(id)arg4;
+ (bool)loadVCAudioTierFromTierTable:(id)arg1 config:(const struct { unsigned char x1; struct __CFArray {} *x2; struct __CFArray {} *x3; struct __CFArray {} *x4; unsigned int x5; bool x6; bool x7; unsigned int x8; bool x9; bool x10; bool x11; bool x12; }*)arg2 allowRedAtLowBitrate:(bool)arg3 alwaysOnAudioRedundancyDisabled:(bool)arg4 redNumPayloads:(unsigned int)arg5 tierBitrate:(unsigned int)arg6 outEntryArray:(id)arg7;
+ (unsigned char)operatingModeToTierPickerMode:(int)arg1 isLowLatency:(bool)arg2 preferPlistForTierTable:(bool)arg3;
...
- (bool)addEntryMatchingPayloadToAudioTierMap:(id)arg1 config:(const struct { unsigned char x1; struct __CFArray {} *x2; struct __CFArray {} *x3; struct __CFArray {} *x4; unsigned int x5; bool x6; bool x7; unsigned int x8; bool x9; bool x10; bool x11; bool x12; }*)arg2 entry:(id)arg3 bitrateTier:(id)arg4 forcedPayload:(int)arg5;
- (void)addPayloadFromTier:(id)arg1;
- (void)addPayloadsFromGFTPayloadsArray:(id)arg1;
- (void)addPayloadsFromGFTRedNumPayloadsDict:(id)arg1 isDeviceClassWolf:(bool)arg2;
- (void)addPayloadsFromU1IPVerDict:(id)arg1 config:(const struct { unsigned char x1; struct __CFArray {} *x2; struct __CFArray {} *x3; struct __CFArray {} *x4; unsigned int x5; bool x6; bool x7; unsigned int x8; bool x9; bool x10; bool x11; bool x12; }*)arg2 mode:(id)arg3;
- (void)addPayloadsFromU1RedNumPayloadsDict:(id)arg1 config:(const struct { unsigned char x1; struct __CFArray {} *x2; struct __CFArray {} *x3; struct __CFArray {} *x4; unsigned int x5; bool x6; bool x7; unsigned int x8; bool x9; bool x10; bool x11; bool x12; }*)arg2 mode:(id)arg3 isIPv4:(bool)arg4 isCellular:(bool)arg5;
- (unsigned long long)adjustedRedNumPayloadsForLowBitrateAudioTier:(id)arg1 redNumPayloads:(unsigned long long)arg2;
...
- (void)dealloc;
- (id)defaultTier;
- (void)generateAudioPayloadsFromConfig:(const struct { unsigned char x1; struct __CFArray {} *x2; struct __CFArray {} *x3; struct __CFArray {} *x4; unsigned int x5; bool x6; bool x7; unsigned int x8; bool x9; bool x10; bool x11; bool x12; }*)arg1;
- (id)generateAudioTiersDictFromPlistForBitrateLimits:(id)arg1 tierPickerConfig:(const struct { unsigned char x1; struct __CFArray {} *x2; struct __CFArray {} *x3; struct __CFArray {} *x4; unsigned int x5; bool x6; bool x7; unsigned int x8; bool x9; bool x10; bool x11; bool x12; }*)arg2 redNumPayloads:(unsigned int)arg3;
