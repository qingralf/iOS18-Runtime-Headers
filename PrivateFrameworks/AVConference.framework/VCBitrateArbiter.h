...
- (unsigned int)maxAllowedBitrateForConnectionType:(int)arg1 arbiterMode:(unsigned char)arg2;
- (unsigned int)maxAllowedBitrateForVCConnection:(id)arg1 forLocalInterface:(bool)arg2;
- (unsigned int)maxAllowedBitrateForVCConnection:(id)arg1 forLocalInterface:(bool)arg2 arbiterMode:(unsigned char)arg3 encodeRule:(id)arg4;
