...
@interface VCConnectionManager : NSObject <VCConnectionHealthMonitorDelegate, VCCoreMotionManagerDelegate, VCLinkProbingHandlerDelegate, VCWifiAssistManagerDelegate> {
    ...
    bool  _isFirstPacketReceivedCount;
    bool  _isFirstPacketSentCount;
    bool  _isInitialConnectionEstablished;
    bool  _isNWConnectionMonitorCellularEnabled;
    ...
    bool  _multipleInterfacesAvailable;
    ...
    struct tagVCOverlayInfoNetwork { 
        bool primaryLocalIsOnCell; 
        bool primaryRemoteIsOnCell; 
        bool primaryIsRelay; 
        bool isDuplicating; 
        bool duplicatingLocalIsOnCell; 
        bool duplicatingRemoteIsOnCell; 
        bool duplicatingIsRelay; 
    }  _overlayDetails;
    ...
    unsigned int  _persistentRecvPacketCount;
    unsigned int  _persistentSentPacketCount;
    ...
    bool  _shouldLimitMultiwayBandwidthWhenConstrained;
    ...
    struct tagVCConnectionManagerRealtimeInstanceVTable { 
        ...
        int (*updatePersistentPacketCounts)(); 
        int (*addLinkProbingTelemetry)(); 
        int (*addLinkSliceStatusTelemetry)(); 
    }  _vTable;
...
@property (getter=isGftTLEEnabled) bool gftTLEEnabled;
...
@property (nonatomic) bool shouldLimitMultiwayBandwidthWhenConstrained;
...
- (void)addDistinctConnectionInterfaceToSet:(id)arg1 withInterfaceType:(int)arg2;
...
- (void)copyPersistenPacketCounts:(unsigned int*)arg1 isOutgoing:(bool)arg2 size:(int)arg3;
...
- (struct { bool x1; bool x2; bool x3; bool x4; bool x5; bool x6; }*)getConnectionSelectionPolicy;
...
- (void)handleReportingSymptom:(unsigned int)arg1;
- (bool)hasSameReportingConfig:(id)arg1 oldPrimaryConnection:(id)arg2;
...
- (bool)localOrRemoteHasMultipleInterfaceAvailable:(id)arg1 remoteInterface:(id)arg2;
...
- (struct tagVCOverlaySource { struct __CFRuntimeBase { unsigned long long x_1_1_1; _Atomic unsigned long long x_1_1_2; } x1; long long x2; unsigned int x3; unsigned char x4; int x5; int x6; struct tagVCOverlaySourceInfo {} *x7; struct tagVCOverlaySourceInfo {} *x8; struct tagVCOverlaySourceInfo {} *x9; }*)overlaySource;
...
- (void)setShouldLimitMultiwayBandwidthWhenConstrained:(bool)arg1;
...
- (void)updateEncryptionConfig:(id)arg1;
