...
- (id)initWithHandler:(id /* block */)arg1 preferredFrameRate:(float)arg2;
- (id)initWithHandler:(id /* block */)arg1 threadPriority:(unsigned int)arg2 threadOptions:(unsigned int)arg3 threadIdentifier:(id)arg4 preferredFrameRate:(float)arg5;
