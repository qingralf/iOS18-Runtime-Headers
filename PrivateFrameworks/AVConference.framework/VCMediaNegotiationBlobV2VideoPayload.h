...
- (int)payload;
- (unsigned int)preferredDecodeFormat;
...
- (void)setHasPreferredDecodeFormat:(bool)arg1;
- (void)setHasVideoPayload:(bool)arg1;
- (void)setParameterSet:(unsigned int)arg1;
- (void)setPreferredDecodeFormat:(unsigned int)arg1;
...
- (id)videoRulesWithBitmap:(unsigned int)arg1 preferredBitmap:(unsigned int)arg2;
