...
- (id)initWithSSRC:(unsigned int)arg1 allowRTCPFB:(bool)arg2 videoRuleCollections:(id)arg3 featureStrings:(id)arg4 isCellular16x9Capable:(bool)arg5 tilesPerFrame:(unsigned int)arg6 ltrpEnabled:(bool)arg7 pixelFormats:(id)arg8 hdrModesSupported:(id)arg9;
- (id)initWithScreenSSRC:(unsigned int)arg1 allowRTCPFB:(bool)arg2 videoRuleCollections:(id)arg3 featureStrings:(id)arg4 isCellular16x9Capable:(bool)arg5 customVideoWidth:(unsigned int)arg6 customVideoHeight:(unsigned int)arg7 tilesPerFrame:(unsigned int)arg8 ltrpEnabled:(bool)arg9 pixelFormats:(id)arg10 hdrModesSupported:(id)arg11 fecEnabled:(bool)arg12 rtxEnabled:(bool)arg13 blackFrameOnClearScreenEnabled:(bool)arg14 foveationSupported:(bool)arg15;
...
- (void)setFoveationSupported:(bool)arg1;
- (void)setHasBlackFrameOnClearScreenEnabled:(bool)arg1;
- (void)setHasCustomVideoHeight:(bool)arg1;
- (void)setHasCustomVideoWidth:(bool)arg1;
- (void)setHasFecEnabled:(bool)arg1;
- (void)setHasFoveationSupported:(bool)arg1;
