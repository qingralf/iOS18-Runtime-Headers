...
+ (bool)addMediaConfigurationsToLocalConfiguration:(id)arg1 withBlob:(id)arg2;
...
- (bool)addBandwidthSettingsForMediaBlob:(id)arg1 arbiterMode:(unsigned char)arg2 connectionType:(int)arg3 maxBitrate:(unsigned int)arg4;
- (void)dealloc;
...
- (void)negotiateAudioAllowRecording:(id)arg1 microphoneConfiguration:(id)arg2;
- (bool)negotiateAudioDTXPayload:(id)arg1;
- (bool)negotiateAudioPrimaryPayload:(id)arg1 microphoneConfiguration:(id)arg2;
- (bool)negotiateAudioREDPayload:(id)arg1 microphoneConfiguration:(id)arg2;
- (void)negotiateAudioSecondaryPayloads:(id)arg1 microphoneConfiguration:(id)arg2;
...
- (void)negotiateRTCPFB:(id)arg1 negotiatedVideoSettings:(id)arg2;
...
- (id)selectVideoFeatureString:(id)arg1 selectedPayload:(int)arg2 videoConfiguration:(id)arg3;
