...
@interface VCMediaNegotiatorLocalConfiguration : NSObject <NSCopying> {
    ...
    bool  _blackFrameOnClearScreenEnabledDefault;
    void * _callLogFile;
...
@property (getter=isOneToOneAuthTagEnabled, nonatomic) bool oneToOneAuthTagEnabled;
...
@property (nonatomic, retain) NSDictionary *u1StreamConfigurations;
...
- (bool)ltrpEnabled;
- (id)mediaConfigurationForMediaType:(unsigned char)arg1;
...
- (void)setBlackFrameOnClearScreenEnabledDefault:(bool)arg1;
...
- (void)setMediaConfiguration:(id)arg1 forMediaType:(unsigned char)arg2;
...
- (void)setOneToOneAuthTagEnabled:(bool)arg1;
...
- (void)setU1StreamConfigurations:(id)arg1;
