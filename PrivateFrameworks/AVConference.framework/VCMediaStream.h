...
@interface VCMediaStream : VCObject <RTCPReportProvider, VCConnectionChangedHandler, VCMediaStreamProtocol, VCMediaTimeSync, VCSecurityEventHandler> {
...
@property (nonatomic, readonly) long long streamTokenDownlink;
@property (nonatomic, readonly) long long streamTokenUplink;
@property (readonly) Class superclass;
@property (nonatomic, readonly) NSArray *transportArray;

+ (bool)isSameSRTPKey:(id)arg1 newKey:(id)arg2;

- (void)applyClientSessionID:(int)arg1 clientUserInfo:(id)arg2;
...
- (id)initWithTransportSessionID:(unsigned int)arg1 localSSRC:(unsigned int)arg2 streamToken:(long long)arg3;
- (bool)initializeTransportSessionWithIDSDestination:(id)arg1 error:(id*)arg2;
- (bool)initializeTransportSessionWithRTPNWConnectionID:(id)arg1 rtcpNWConnectionID:(id)arg2 error:(id*)arg3 isConnectionStartDelayed:(bool)arg4;
...
- (long long)streamTokenDownlink;
- (long long)streamTokenUplink;
