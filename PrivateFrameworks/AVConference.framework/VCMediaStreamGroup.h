...
@property (getter=isEnabledAtStart, nonatomic) bool enabledAtStart;
...
@property (nonatomic, readonly) TimingCollection *perfTimers;
@property (nonatomic, readonly) struct tagVCSecurityKeyHolder { }*securityKeyHolder;
...
- (void)setEnabledAtStart:(bool)arg1;
- (void)setEncryptionInfoReceived:(bool)arg1;
- (void)setExternalRenderLatency:(double)arg1;
- (void)setFirstMKIToFirstMediaReceivedTimerForMKIReceivedTime;
- (void)setFirstMediaFrameReceivedTime:(double)arg1;
