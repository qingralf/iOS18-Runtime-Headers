...
@interface VCMockIDSDatagramChannel : IDSDatagramChannel {
    ...
    bool  _isECNEnabled;
    bool  _isNackEnabled;
    _Atomic bool  _isReceiveThreadTerminating;
    bool  _isServerStatsCached;
    bool  _isShortMKIEnabled;
    bool  _isSourceParticipantIDOnFanOutPacketsEnabled;
    bool  _isTestNetworkRouterEnabled;
    bool  _isTwoWayFaceTimeTestUsingSocketsEnabled;
    bool  _isValid;
    ...
    struct tagVCRealTimeThread { unsigned int x1; unsigned int x2; struct _opaque_pthread_mutex_t { long long x_3_1_1; BOOL x_3_1_2[56]; } x3; id x4; int (*x5)(); void *x6; struct OpaqueFigThread {} *x7; int x8; BOOL x9[60]; unsigned int x10; unsigned int x11; } * _packetReceiveThread;
...
- (bool)createSocketWithSourcePort:(short)arg1;
- (void)dealloc;
- (void)dequeueDatagramPacket:(id /* block */)arg1;
- (int)drainUnderlyingFileDescriptor;
- (id)encryptionInfoEventWithIsLocalKey:(bool)arg1;
...
- (id)initCreateSocketRequiresOptions:(bool)arg1 dataPath:(int)arg2 destination:(id)arg3;
...
- (bool)isVideoPacket:(char *)arg1 length:(unsigned long long)arg2;
...
- (bool)setupMockIDSDatagramChannelRequiresOptions:(bool)arg1 sourcePort:(short)arg2;
