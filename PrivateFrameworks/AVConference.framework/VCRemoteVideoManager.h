...
- (void)resetDidReceiveFirstFrameForStreamToken:(long long)arg1;
- (bool)setLayerBoundsForStreamTokenWithArguments:(id)arg1 error:(id*)arg2;
- (bool)setTransformForRemoteVideoOrientationEnabledWithArguments:(id)arg1 error:(id*)arg2;
