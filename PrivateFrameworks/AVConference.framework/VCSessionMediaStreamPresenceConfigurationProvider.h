...
+ (id)defaultOneToOneTierTable:(unsigned int)arg1 redundancyEnabled:(bool)arg2;
+ (unsigned int)defaultRemainingBitrateSplit:(unsigned int)arg1;
+ (id)fdatGroupDisabled;
+ (id)foregroundCameraOneToOneTierTable:(unsigned int)arg1 redundancyEnabled:(bool)arg2;
+ (unsigned int)foregroundCameraRemainingBitrateSplit:(unsigned int)arg1;
+ (id)ftxtGroupDisabled;
+ (id)oneToOneTierTableForStreamGroupID:(unsigned int)arg1 splitType:(unsigned int)arg2 redundancyEnabled:(bool)arg3;
...
- (void)dealloc;
- (id)defaultEndToEndStreamGroupConfigurationForStreamGroup:(unsigned int)arg1;
