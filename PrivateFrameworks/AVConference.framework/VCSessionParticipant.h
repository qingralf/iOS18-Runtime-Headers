...
@interface VCSessionParticipant : VCObject <VCAudioIODelegate, VCAudioIOSink, VCAudioIOSource, VCAudioPowerSpectrumSourceDelegate, VCConnectionChangedHandler, VCMediaStreamDelegate, VCMediaStreamGroupDelegate, VCRedundancyControllerDelegate, VCSecurityEventHandler> {
    ...
    bool  _isMuted;
    bool  _isParticipantIDBasedKeyLookupEnabled;
...
@property (nonatomic, readonly) bool isParticipantIDBasedKeyLookupEnabled;
...
- (void)configureOneToOneVideoSendingConfigs:(id)arg1 streamGroupID:(unsigned int)arg2;
...
- (unsigned char)mediaControlVersionForStreamGroup:(unsigned int)arg1;
- (id)mediaNegotiator;
- (struct tagVCMediaQueue { }*)mediaQueue;
- (id)mediaRecorder;
- (id)mediaTypeMixingList;
- (id)microphoneGroup;
- (long long)negotiatedCipherSuiteForStreamGroupID:(unsigned int)arg1;
...
- (void)setFECConfigurationOnStreamConfig:(id)arg1 withStreamGroupID:(unsigned int)arg2;
...
- (void)streamGroup:(id)arg1 didReceiveFlushRequestWithPayloads:(id)arg2;
