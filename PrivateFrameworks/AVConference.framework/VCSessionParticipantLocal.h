...
@interface VCSessionParticipantLocal : VCSessionParticipant <VCIDSStreamIDGenerator, VCSessionUplinkBandwidthAllocatorClient, VCVideoCaptureClient, VCVideoSink> {
    ...
    double  _initTime;
    bool  _isAudioPowerSpectrumEnabled;
    bool  _isHigherAudioREDCutoverU1Enabled;
    bool  _isMixingSystemAudio;
    bool  _isOneToOneAuthenticationTagEnabled;
...
+ (bool)isCameraEnabledWithMediaStates:(id)arg1;
...
- (bool)addFeatureListStringsForVideoConfiguration:(id)arg1 mediaType:(unsigned char)arg2;
- (bool)addMediaConfigurationsToLocalConfiguration:(id)arg1;
- (bool)addVideoConfigurationsToLocalConfiguration:(id)arg1;
...
- (void)checkAndReportThermalIncreaseAudioOnly:(int)arg1;
...
- (bool)completeStreamSetup:(id)arg1 rtpCipherSuite:(long long)arg2;
...
- (void)deregisterForVideoCaptureAndStopProcessingAllMediaRecorderRequests:(bool)arg1;
...
- (id)featureListString:(id)arg1 removingPayload:(int)arg2 andPayload:(int)arg3 mediaType:(unsigned char)arg4;
...
- (id)newStreamInfoWithAudioStreamWithConfiguration:(id)arg1 idsDestination:(id)arg2 isMultiway:(bool)arg3 streamGroupID:(unsigned int)arg4 streamToken:(long long)arg5;
...
- (id)newStreamInfoWithVideoStreamWithConfiguration:(id)arg1 streamGroupID:(unsigned int)arg2 rtpCipherSuite:(long long)arg3;
- (id)newUplinkBandwidthAllocators;
- (id)newVideoConfigurationForMediaType:(unsigned char)arg1;
...
- (id)u1VideoRuleCollectionsForMediaType:(unsigned char)arg1;
...
- (void)updateCaptureSourceVideoFeatureStatus:(struct tagVCVideoCaptureFeatureStatus { BOOL x1; BOOL x2; BOOL x3; BOOL x4; BOOL x5; BOOL x6; BOOL x7; })arg1;
