...
@interface VCSessionParticipantRemote : VCSessionParticipant <VCSessionDownlinkBandwidthAllocatorClient> {
    struct _VCSessionParticipantCapabilities { 
        ...
        bool supportsParticipantIDBasedKeyLookup; 
        bool isDawnburstOrLater; 
    }  _capabilities;
    bool  _enableMaxCameraBitrateVideoQualityNewTier;
    bool  _haveReportedPerfTimers;
    bool  _isCameraUsedForConnectionTiming;
    bool  _isConnectionTimingReported;
    bool  _isConnectionTimingSourceDetected;
    ...
    bool  _shouldDisableMiddleTierMLEnhance;
    int  _thermalLevel;
...
@property (nonatomic) struct _VCSessionParticipantCapabilities { bool x1; unsigned int x2; int x3; bool x4; bool x5; bool x6; } capabilities;
@property (nonatomic) bool enableMaxCameraBitrateVideoQualityNewTier;
...
+ (unsigned int)maxBdatQualityIndexForVideoQuality:(unsigned char)arg1 isLocalOnWiFi:(bool)arg2;
+ (unsigned int)maxCameraQualityIndexForVideoQuality:(unsigned char)arg1 isLocalOnWiFi:(bool)arg2 isRedundancyRequested:(bool)arg3 isSharingEnabled:(bool)arg4 enableNewTier:(bool)arg5;
+ (unsigned int)maxCameraQualityIndexForVideoQuality:(unsigned char)arg1 useWiFiTable:(bool)arg2 isSharingEnabled:(bool)arg3 enableNewTier:(bool)arg4;
+ (unsigned int)maxCameraQualityIndexWithRedundancyForVideoQuality:(unsigned char)arg1 useWiFiTable:(bool)arg2 enableNewTier:(bool)arg3;
+ (unsigned int)maxFdatQualityIndexForVideoQuality:(unsigned char)arg1 isLocalOnWiFi:(bool)arg2;
+ (unsigned int)maxFtxtQualityIndexForVideoQuality:(unsigned char)arg1 isLocalOnWiFi:(bool)arg2 isRedundancyRequested:(bool)arg3 isSharingEnabled:(bool)arg4;
+ (unsigned int)maxQualityIndexForStreamGroupID:(unsigned int)arg1 videoQuality:(unsigned char)arg2 isLocalOnWiFi:(bool)arg3 isRedundancyRequested:(bool)arg4 isSharingEnabled:(bool)arg5 enableNewTier:(bool)arg6;
+ (unsigned int)maxWebRTCCameraQualityIndexForVideoQuality:(unsigned char)arg1 isLocalOnWiFi:(bool)arg2 isSharingEnabled:(bool)arg3 enableNewTier:(bool)arg4;
...
- (void)appendStreamGroup:(id)arg1 maxQualityIndex:(unsigned int)arg2 mediaEntries:(id)arg3;
- (void)appendStreamGroupsMediaEntries:(id)arg1;
- (id)applyVideoEnabledSetting:(bool)arg1;
- (id)audioGroup;
- (id)cameraStreamInfo;
- (void)cancelAndReleaseFetchTimer;
- (struct _VCSessionParticipantCapabilities { bool x1; unsigned int x2; int x3; bool x4; bool x5; bool x6; })capabilities;
...
- (void)reportConnectionTimingWithStreamGroupDispatched:(id)arg1;
- (int)reportingResolutionForResolution:(long long)arg1;
- (id)screenGroup;
- (id)screenStreamInfo;
- (void)setActiveStreamIDs:(id)arg1;
- (void)setAudioPaused:(bool)arg1;
- (void)setCapabilities:(struct _VCSessionParticipantCapabilities { bool x1; unsigned int x2; int x3; bool x4; bool x5; bool x6; })arg1;
- (void)setEnableMaxCameraBitrateVideoQualityNewTier:(bool)arg1;
