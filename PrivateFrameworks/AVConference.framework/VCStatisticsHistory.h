...
@interface VCStatisticsHistory : NSObject {
    ...
    struct VCStatisticsSendHistoryElement { unsigned int x1; double x2; unsigned int x3; unsigned long long x4; bool x5; struct VCStatisticsSendHistoryElement {} *x6; struct VCStatisticsSendHistoryElement {} *x7; } * _sendHistory;
    struct VCStatisticsStatsHistoryElement { 
        unsigned char linkID; 
        double statsUpdateTime; 
        unsigned int statsTimestamp; 
