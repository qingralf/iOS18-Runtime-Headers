...
- (bool)start;
- (bool)startAudioHALPlugInSource:(unsigned int)arg1;
- (bool)startAudioQueue;
- (bool)stop;
- (bool)stopAudioHALPlugInSource:(unsigned int)arg1;
- (bool)stopAudioQueue;
