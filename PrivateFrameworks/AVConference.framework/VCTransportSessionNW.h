...
- (int)configureConnectionToReceiveHoplimit:(id)arg1;
...
- (id)initWithRTPNWConnectionID:(id)arg1 RTCPNWConnectionID:(id)arg2 handlerQueue:(id)arg3 context:(void*)arg4 notificationHandler:(int (*)arg5 eventHandler:(int (*)arg6 isConnectionStartDelayed:(bool)arg7;
