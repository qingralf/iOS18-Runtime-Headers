...
@property (nonatomic, readonly) int bestCameraCaptureFrameRate; /* unknown property attribute: ? */
...
@property (nonatomic) bool followSystemCamera; /* unknown property attribute: ? */
@property (readonly) unsigned long long hash;
@property (nonatomic, readonly) bool is1080pCameraAvailable; /* unknown property attribute: ? */
...
- (bool)isFaceTimeScreenSharingWithDict:(id)arg1;
...
- (void)notifyThermalPressureObservers:(int)arg1;
...
- (void)pausePreview;
- (void)populateThermalFrameRateThresholdsForCaptureSourceID:(long long)arg1 captureConfig:(id)arg2;
...
- (int)screenFrameRateForThermalLevel:(int)arg1 configuredFrameRate:(int)arg2 captureSourceID:(id)arg3;
- (void)sendBiomeEventIsStarting:(bool)arg1;
- (void)setAppDelegate:(id)arg1;
- (int)setBoundsForRemoteLayerWithFacing:(bool)arg1 frameRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 fenceHandle:(id)arg3;
...
- (unsigned int)setLocalVideoDestination:(struct { id x1; bool x2; bool *x3; struct CGRect { struct CGPoint { double x_1_2_1; double x_1_2_2; } x_4_1_1; struct CGSize { double x_2_2_1; double x_2_2_2; } x_4_1_2; } x4; bool x5; bool x6; }*)arg1;
...
- (void)setScreenCaptureFrameRate:(int)arg1 captureSourceID:(id)arg2;
...
- (void)startPreview;
- (void)startPreviewWithWidth:(int)arg1 height:(int)arg2 frameRate:(int)arg3;
...
- (void)updateCenterStageEnabled:(bool)arg1 requestCaptureChange:(bool)arg2;
