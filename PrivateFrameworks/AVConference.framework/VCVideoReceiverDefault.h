...
@interface VCVideoReceiverDefault : VCVideoReceiverBase {
    ...
    struct tagVCVideoReceiverConfig { 
        ...
        int audioTSRate; 
        int videoTSRate; 
        bool enableFrameDiscontinuityStatus; 
