...
- (void)checkForAndReportPoorConnectionDespiteVideoReceivedForVideoStream:(id)arg1 stallDuration:(double)arg2;
- (void)checkForExtendedPoorConnectionWithStallDuration:(double)arg1;
...
- (void)setIsRemoteMediaStalled:(bool)arg1 duration:(double)arg2;
...
- (void)setVideoDegraded:(bool)arg1 duration:(double)arg2;
