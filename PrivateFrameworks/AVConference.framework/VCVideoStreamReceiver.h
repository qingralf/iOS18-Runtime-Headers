...
- (int)createDecodeSession:(struct opaqueCMFormatDescription { }*)arg1;
- (void)dealloc;
...
- (int)processVideoRTP;
- (void)reportVideoStallStatus:(bool)arg1;
