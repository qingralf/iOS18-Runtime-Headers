...
@interface VCVirtualAVCaptureDeviceFormat : AVCaptureDeviceFormat {
    ...
    bool  _backgroundReplacementSupportedForContinuityCamera;
...
@property (getter=isBackgroundReplacementSupported, nonatomic) bool backgroundReplacementSupported;
@property (getter=isBackgroundReplacementSupportedForContinuityCamera, nonatomic) bool backgroundReplacementSupportedForContinuityCamera;
@property (getter=isCenterStageSupported, nonatomic) bool centerStageSupported;
...
@property (getter=isPortraitEffectSupported, nonatomic) bool portraitEffectSupported;
@property (nonatomic) bool reactionEffectsSupported;
@property (nonatomic, retain) NSArray *secondaryNativeResolutionZoomFactors;
@property (getter=isStudioLightSupported, nonatomic) bool studioLightSupported;
...
- (void)setBackgroundReplacementSupportedForContinuityCamera:(bool)arg1;
