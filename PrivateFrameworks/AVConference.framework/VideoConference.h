...
@interface VideoConference : VCObject <GKNATObserverDelegate, VCAudioIODelegate, VCAudioIOSink, VCAudioIOSource, VCAudioPowerLevelMonitorDelegate, VCCallSessionDelegate, VCMediaRecorderTransportDelegate, VCVideoCaptureClient, VCVideoSink> {
...
@property (nonatomic, retain) NSMutableDictionary *sessionDict;
...
@property (nonatomic, readonly) VCMediaRecorder *vcMediaRecorder;
...
- (void)session:(id)arg1 startAudioWithFarEndVersionInfo:(struct VoiceIOFarEndVersionInfo { unsigned char x1[64]; unsigned char x2[64]; unsigned int x3; }*)arg2 internalFrameFormat:(const struct tagVCAudioFrameFormat { struct AudioStreamBasicDescription { double x_1_1_1; unsigned int x_1_1_2; unsigned int x_1_1_3; unsigned int x_1_1_4; unsigned int x_1_1_5; unsigned int x_1_1_6; unsigned int x_1_1_7; unsigned int x_1_1_8; unsigned int x_1_1_9; } x1; unsigned int x2; }*)arg3 completionHandler:(id /* block */)arg4;
...
- (void)updateRelayedCallType:(unsigned char)arg1 forCallID:(unsigned int)arg2;
