...
@property (getter=isAutoVideoFrameRateEnabled, nonatomic) bool autoVideoFrameRateEnabled;
...
@property (nonatomic, readonly) float documentSceneConfidence;
...
@property (nonatomic, readonly) bool jfx_supportsDepth;
...
@property (getter=isSceneClassificationActive, nonatomic, readonly) bool sceneClassificationActive;
...
+ (void)_backgroundReplacementEnabledChanged:(id)arg1;
+ (void)_backgroundReplacementURLBookmarkChanged:(id)arg1;
+ (id)_centerStageAllowList;
+ (bool)_checkEligiblityForEffect:(id)arg1;
...
+ (void)_haveShownGesturesDefaultDisabledNotificationChanged:(id)arg1;
