...
@property (getter=isAutoVideoFrameRateSupported, nonatomic, readonly) bool autoVideoFrameRateSupported;
...
@property (nonatomic, readonly) AVExposureBiasRange *systemRecommendedExposureBiasRange;
@property (nonatomic, readonly) AVZoomRange *systemRecommendedVideoZoomRange;
...
- (double)focalLengthIn35mmFilmWithGeometricDistortionCorrection:(bool)arg1;
...
- (float)maxISO;
- (bool)maxPhotoDimensionsAreUltraHighResolution:(struct { int x1; int x2; })arg1 privateDimensionsEnabled:(bool)arg2;
