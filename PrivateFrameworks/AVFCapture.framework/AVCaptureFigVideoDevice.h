...
- (id)_initWithFigCaptureSource:(struct OpaqueFigCaptureSource { }*)arg1 isProxy:(bool)arg2;
- (void)_initializeContinuousZoomWithDepthActiveWithEnabled:(bool)arg1;
- (bool)_isBackgroundBlurActiveForEnabled:(bool)arg1;
- (bool)_isBackgroundReplacementActiveForEnabled:(bool)arg1;
...
- (void)_setBackgroundReplacementAllowed:(bool)arg1;
...
- (void)_setConstantColorEnabled:(bool)arg1;
- (bool)_setContinuousZoomWithDepthActiveWithEnabled:(bool)arg1 disallowed:(bool)arg2 isActiveDepthDataFormatChangingOut:(bool*)arg3;
- (void)_setContinuousZoomWithDepthDisallowed:(bool)arg1;
...
- (int)_setFigCaptureSourcePixelBufferProperty:(struct __CFString { }*)arg1 withValue:(struct __CVBuffer { }*)arg2;
...
- (void)_updateBackgroundReplacementActiveForEnabled:(bool)arg1;
- (void)_updateBackgroundReplacementPixelBuffer:(struct __CVBuffer { }*)arg1;
- (void)_updateCenterStageActiveForEnabled:(bool)arg1 updateDependentProperties:(bool)arg2;
- (bool)_updateContinuousZoomWithDepthActiveWithEnabled:(bool)arg1 disallowed:(bool)arg2 isActiveDepthDataFormatChangingOut:(bool*)arg3;
...
- (void)_updateSpatialCaptureStatus:(unsigned long long)arg1;
...
- (id)init;
- (id)initProxyDeviceWithUniqueID:(id)arg1 targetClientAuditToken:(struct { unsigned int x1[8]; })arg2;
...
- (void)setAutoVideoFrameRateEnabled:(bool)arg1;
...
- (void)setMaxAvailableVideoZoomFactorOverride:(double)arg1;
...
- (void)updateVideoZoomFactorForSpatialVideoEnabled:(bool)arg1;
