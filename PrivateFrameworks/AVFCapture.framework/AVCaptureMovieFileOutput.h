...
@property (getter=isSpatialVideoCaptureEnabled, nonatomic) bool spatialVideoCaptureEnabled;
@property (getter=isSpatialVideoCaptureSupported, nonatomic, readonly) bool spatialVideoCaptureSupported;
@property (getter=isTrueVideoCaptureEnabled, nonatomic) bool trueVideoCaptureEnabled;
@property (getter=isTrueVideoCaptureSupported, nonatomic, readonly) bool trueVideoCaptureSupported;
...
- (int)_stopRecording;
- (bool)_totalNANDBandwidthAllowed:(id)arg1 videoCodecType:(id)arg2;
...
- (void)_updateSpatialVideoCaptureSupportedForSourceDevice:(id)arg1;
...
- (void)handleDidDropFrameWhileRecordingNotificationForWrapper:(id)arg1 withPayload:(id)arg2;
...
- (void)handleVideoStabilizationModeChangedForConnection:(id)arg1;
- (id)init;
...
- (void)setSpatialVideoCaptureEnabled:(bool)arg1;
