...
@property (nonatomic, readonly) NSArray *availableRawPhotoCodecTypes;
...
@property (getter=isConstantColorEnabled, nonatomic) bool constantColorEnabled;
@property (getter=isConstantColorSupported, nonatomic, readonly) bool constantColorSupported;
...
@property (getter=isShutterSoundSuppressionSupported, nonatomic, readonly) bool shutterSoundSuppressionSupported;
...
- (void)_setUltraHighResolutionZeroShutterLagEnabled:(bool)arg1;
...
- (void)_updateConstantColorSupportedForSourceDevice:(id)arg1;
...
- (void)_updateSpatialPhotoCaptureSupportedForDevice:(id)arg1;
...
- (void)_updateVirtualDeviceConstituentPhotoDeliveryAndDualCameraDualPhotoDeliverySupportedForSourceDevice:(id)arg1;
...
- (id)availableRawPhotoCodecTypes;
...
- (void)handleBackgroundReplacementActiveChangedForDevice:(id)arg1;
...
- (void)setSpatialPhotoCaptureEnabled:(bool)arg1;
...
- (id)supportedRawPhotoCodecTypesForRawPhotoPixelFormatType:(unsigned int)arg1 fileType:(id)arg2;
