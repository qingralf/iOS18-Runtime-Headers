...
@property (getter=isConstantColorFallbackPhotoDeliveryEnabled, nonatomic) bool constantColorFallbackPhotoDeliveryEnabled;
...
@property (nonatomic, copy) NSDictionary *rawFileFormat;
@property (readonly) NSString *rawFileType;
@property (readonly) unsigned int rawPhotoPixelFormatType;
@property (getter=isShutterSoundSuppressionEnabled, nonatomic) bool shutterSoundSuppressionEnabled;
...
- (void)setAutoSpatialPhotoCaptureEnabled:(bool)arg1;
...
- (void)setRawFileFormat:(id)arg1;
- (void)setSemanticStyle:(id)arg1;
- (void)setShutterSound:(unsigned int)arg1;
- (void)setShutterSoundSuppressionEnabled:(bool)arg1;
