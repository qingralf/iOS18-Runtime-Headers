...
+ (struct __CVBuffer { }*)imageForKey:(id)arg1 fillWidth:(int)arg2 fillHeight:(int)arg3;
+ (void)initialize;
+ (id)objectForKey:(id)arg1;
+ (id)objectsForWildcardKey:(id)arg1;
...
+ (void)setObject:(id)arg1 forWildcardKey:(id)arg2;
...
- (void)_handleDefaultChangedNotificationForKey:(id)arg1 newValue:(id)arg2 handlersForKeyObservers:(id)arg3 callHandlersAsync:(bool)arg4;
- (void)_handleNotification:(id)arg1 payload:(id)arg2;
- (int)_registerWithServerToObserveKey:(id)arg1;
- (void)_runBlockOnProprietaryDefaultsSourceQueueSync:(id /* block */)arg1;
...
- (void)setObject:(id)arg1 forKey:(id)arg2;
- (void)setObject:(id)arg1 forWildcardKey:(id)arg2;
- (void)unobserveChangesForKey:(id)arg1;
- (void)updateCameraHistory:(id)arg1 withCameraInfo:(id)arg2 maxLength:(unsigned long long)arg3 updateCameraHistoryDownplayOverrideList:(bool)arg4 cameraCanBeInOverrideList:(bool)arg5;
- (void)updateCameraOverrideHistory:(id)arg1 withCameraInfo:(id)arg2 setOverride:(bool)arg3;
