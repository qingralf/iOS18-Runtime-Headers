...
- (bool)_updateVideoSettingsForConnection:(id)arg1 connectionBeingAdded:(bool)arg2;
...
- (void)setAllLossyVideoCVPixelFormatTypesEnabled:(bool)arg1;
...
- (void)setVideoSettingsAspectRatioOverrideEnabled:(bool)arg1;
