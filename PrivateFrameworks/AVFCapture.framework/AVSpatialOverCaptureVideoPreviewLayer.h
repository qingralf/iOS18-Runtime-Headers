...
- (void)_setPrimaryCaptureRectAspectRatio:(double)arg1 centerPoint:(struct CGPoint { double x1; double x2; })arg2 transitionPercentComplete:(double)arg3;
...
- (void)setPrimaryCaptureRectAspectRatio:(double)arg1 centerPoint:(struct CGPoint { double x1; double x2; })arg2 trueVideoTransitionPercentComplete:(double)arg3;
