...
@property (nonatomic) bool isExternalContent;
...
- (struct __CVBuffer { }*)vcp_frameAtTimeStamp:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg1 withMaxDimension:(unsigned long long)arg2;
- (bool)vcp_isMontage;
...
- (void)setIsExternalContent:(bool)arg1;
...
+ (bool)tvp_shouldIgnoreLoadFailureForKey:(id)arg1 error:(id)arg2 logObject:(id)arg3;
