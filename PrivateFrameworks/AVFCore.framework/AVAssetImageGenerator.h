...
@property (nonatomic, copy) NSString *dynamicRangePolicy;
...
- (void)_serverDied;
- (id)_videoSettingWithSize:(struct CGSize { double x1; double x2; })arg1 bitDepth:(unsigned int)arg2;
- (id)apertureMode;
...
- (void)setDynamicRangePolicy:(id)arg1;
