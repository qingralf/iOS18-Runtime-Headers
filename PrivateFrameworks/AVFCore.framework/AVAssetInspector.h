...
@property (getter=_localizedMediaSelectionOptionDisplayNames, nonatomic, readonly) NSDictionary *localizedMediaSelectionOptionDisplayNames;
...
@property (getter=_moovAtomSize, nonatomic, readonly) long long moovAtomSize;
