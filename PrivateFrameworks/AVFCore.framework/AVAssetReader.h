...
- (id)_commonInitWithAsset:(id)arg1 options:(id)arg2 error:(id*)arg3;
...
- (id)initWithAsset:(id)arg1 options:(id)arg2 error:(id*)arg3;
- (bool)isDefunct;
- (id)outputs;
- (bool)preparesMediaDataForRealTimeConsumption;
- (void)setPreparesMediaDataForRealTimeConsumption:(bool)arg1;
