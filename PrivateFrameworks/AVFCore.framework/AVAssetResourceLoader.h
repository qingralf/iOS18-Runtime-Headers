...
- (unsigned long long)allowedCommonMediaClientDataKeys;
- (id)asset;
...
- (void)setAllowedCommonMediaClientDataKeys:(unsigned long long)arg1;
- (void)setDelegate:(id)arg1 queue:(id)arg2;
- (void)setPreloadsEligibleContentKeys:(bool)arg1;
- (void)setSendsCommonMediaClientDataAsHTTPHeaders:(bool)arg1;
