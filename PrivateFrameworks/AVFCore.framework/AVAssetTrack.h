...
@interface AVAssetTrack : NSObject <AVAsynchronousKeyValueLoading, AVIntegrityChecking, NSCopying> {
...
@property (nonatomic, readonly) struct { double x1; double x2; } rc_timeRange;
...
- (struct { double x1; double x2; })rc_timeRange;
