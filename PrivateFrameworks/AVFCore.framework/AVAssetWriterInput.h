...
- (bool)_appendTaggedPixelBufferGroup:(struct OpaqueCMTaggedBufferGroup { }*)arg1 withPresentationTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2;
- (id)_attachedAdaptor;
