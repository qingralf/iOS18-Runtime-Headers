...
- (bool)areAllInputsPreferredMediaChunkAlignmentEqualTo:(long long)arg1;
- (void)cancelWriting;
- (bool)checkAVAssetWriterInputConfigurationToOutputSegmentDataForFragmentedMPEG4FileTypeProfile:(id)arg1 preferredOutputSegmentInterval:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2 returningDebugDescription:(id*)arg3;
...
- (void)setAllInputsFigPreferredChunkAlignmentTo:(long long)arg1;
...
- (id)writerInputForTrackID:(int)arg1;
