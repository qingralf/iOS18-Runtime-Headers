...
- (long long)numberOfSourceFramesInWindowForTrackID:(int)arg1;
- (long long)numberOfSourceSampleBuffersInWindowForTrackID:(int)arg1;
- (id)renderContext;
- (struct __CVBuffer { }*)sourceFrameByTrackID:(int)arg1;
- (struct __CVBuffer { }*)sourceFrameByTrackID:(int)arg1 atIndexInWindow:(long long)arg2 presentationTimeStamp:(struct { long long x1; int x2; unsigned int x3; long long x4; }*)arg3;
- (struct opaqueCMSampleBuffer { }*)sourceSampleBufferByTrackID:(int)arg1;
- (struct opaqueCMSampleBuffer { }*)sourceSampleBufferByTrackID:(int)arg1 atIndexInWindow:(long long)arg2 presentationTimeStamp:(struct { long long x1; int x2; unsigned int x3; long long x4; }*)arg3;
- (id)sourceSampleDataTrackIDs;
- (id)sourceTimedMetadataByTrackID:(int)arg1;
- (id)sourceTimedMetadataByTrackID:(int)arg1 atIndexInWindow:(long long)arg2 presentationTimeStamp:(struct { long long x1; int x2; unsigned int x3; long long x4; }*)arg3;
- (id)sourceTrackIDs;
