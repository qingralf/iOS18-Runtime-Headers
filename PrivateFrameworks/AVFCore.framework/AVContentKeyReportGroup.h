...
- (bool)hasProtector;
- (id)initWithKeySystem:(id)arg1 keySession:(id)arg2 contentKeyBoss:(struct OpaqueFigContentKeyBoss { }*)arg3 useContentKeyBoss:(bool)arg4 groupID:(unsigned long long)arg5 storageDirectoryAtURL:(id)arg6;
