...
- (bool)_processContentKeyResponse:(id)arg1 renewalDate:(id)arg2 initializationVector:(id)arg3 error:(id*)arg4;
...
- (id)identifier;
- (id)identifierString;
- (id)initWithContentKeySession:(id)arg1 contentKeyBoss:(struct OpaqueFigContentKeyBoss { }*)arg2 useContentKeyBoss:(bool)arg3 keySpecifier:(struct OpaqueFigContentKeySpecifier { }*)arg4 initializationData:(id)arg5 keyIDFromInitializationData:(id)arg6 contentIdentifier:(id)arg7 isRenewalRequest:(bool)arg8 requestID:(unsigned long long)arg9 providesPersistableKey:(bool)arg10 preloadingRequestOptions:(id)arg11 identifier:(id)arg12 supportsOfflineKey:(bool)arg13;
