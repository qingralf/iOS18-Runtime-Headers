...
- (unsigned long long)_processContentKeyRequestWithIdentifier:(id)arg1 encryptionMethod:(int)arg2 supportedProtocolVersions:(id)arg3 options:(id)arg4 groupID:(unsigned long long)arg5 error:(id*)arg6;
...
- (bool)_renewKeyWithIdentifier:(id)arg1 encryptionMethod:(int)arg2 initializationData:(id)arg3 contentIdentifier:(id)arg4 keyIDFromInitializationData:(id)arg5 options:(id)arg6 error:(id*)arg7;
...
- (void)contentKeyRequestDidSucceedWithBoss:(struct OpaqueFigContentKeyBoss { }*)arg1 keySpecifier:(struct OpaqueFigContentKeySpecifier { }*)arg2 requestID:(unsigned long long)arg3 cryptor:(struct OpaqueFigCPECryptor { }*)arg4;
...
- (int)createAndInstallCustomURLHandlerForAsset:(id)arg1 outHandler:(const struct OpaqueFigCustomURLHandler {}**)arg2;
...
- (id)delegateQueue;
- (id)description;
- (void)didProvideKeyRequestWithBoss:(struct OpaqueFigContentKeyBoss { }*)arg1 keySpecifier:(struct OpaqueFigContentKeySpecifier { }*)arg2 requestID:(unsigned long long)arg3 renewalRequest:(bool)arg4 supportsOfflineKey:(bool)arg5;
- (void)expire;
- (void)externalProtectionStateChangedCallbackWithBoss:(struct OpaqueFigContentKeyBoss { }*)arg1 keySpecifier:(struct OpaqueFigContentKeySpecifier { }*)arg2;
- (bool)hasProtector;
- (id)init;
...
- (void)issuePersistableContentKeyRequestForKeySpecifier:(struct OpaqueFigContentKeySpecifier { }*)arg1 initializationData:(id)arg2 keyIDFromInitializationData:(id)arg3 contentIdentifier:(id)arg4 requestID:(unsigned long long)arg5 preloadingRequestOptions:(id)arg6 identifier:(id)arg7;
