...
- (bool)addTaggedPixelBufferGroup:(struct OpaqueCMTaggedBufferGroup { }*)arg1 atPresentationTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2 error:(id*)arg3;
