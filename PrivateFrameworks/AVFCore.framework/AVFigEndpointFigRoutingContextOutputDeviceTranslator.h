...
- (id)predictedOutputDeviceFromRoutingContext:(struct OpaqueFigRoutingContext { }*)arg1;
- (void)removeOutputDevice:(id)arg1 withOptions:(struct __CFDictionary { }*)arg2 fromRoutingContext:(struct OpaqueFigRoutingContext { }*)arg3 completionHandler:(id /* block */)arg4;
