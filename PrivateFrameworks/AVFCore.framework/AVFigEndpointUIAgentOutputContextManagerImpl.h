...
- (void).cxx_destruct;
- (void)_showErrorPromptForRouteDescriptor:(struct __CFDictionary { }*)arg1 reason:(struct __CFString { }*)arg2 didFailToConnectToOutputDeviceDictionary:(struct __CFDictionary { }*)arg3;
- (void)dealloc;
