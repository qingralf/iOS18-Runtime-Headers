...
+ (id)outputDeviceWithRouteDescriptor:(struct __CFDictionary { }*)arg1 withRoutingContext:(struct OpaqueFigRoutingContext { }*)arg2;
...
- (void)postNotification:(id)arg1 fromImpl:(id)arg2;
- (void)postNotification:(id)arg1 withPayload:(id)arg2 fromImpl:(id)arg3;
