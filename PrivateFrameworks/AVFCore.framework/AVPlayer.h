...
@property (getter=supportsSpeedRamps, setter=setSupportsSpeedRamps:, nonatomic) bool supportsSpeedRamps;
...
- (struct __CVBuffer { }*)_copyDisplayedPixelBuffer:(id)arg1;
...
- (struct OpaqueFigPlayerInterstitialCoordinator { }*)_copyInterstitialEventCoordinatorEnsuringItIsRemote:(bool)arg1;
...
- (bool)_handleSetRate:(float)arg1 withVolumeRampDuration:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2 playImmediately:(bool)arg3 rateChangeReason:(int)arg4 affectsCoordinatedPlayback:(bool)arg5;
...
- (void)_setExternalPlaybackInterstitialSchedulingStrategyOnCoordinator_invokeOnIvarAccessQueue:(struct OpaqueFigPlayerInterstitialCoordinator { }*)arg1;
...
- (void)_setInterstitialEventCoordinatorOnItemsIntegratedTimeline_invokeOnIvarAccessQueue:(struct OpaqueFigPlayerInterstitialCoordinator { }*)arg1;
...
- (void)_setInterstitialPlayerOnItemsIntegratedTimeline_invokeOnIvarAccessQueue:(id)arg1;
...
- (void)setExternalPlaybackInterstitialSchedulingStrategy:(long long)arg1;
...
- (void)setSupportsSpeedRamps:(bool)arg1;
...
- (void)setVideoOutput:(id)arg1 withOwningTaggedBufferOutput:(id)arg2;
