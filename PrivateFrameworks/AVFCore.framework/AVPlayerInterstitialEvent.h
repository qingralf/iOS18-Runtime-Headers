...
@property (nonatomic, readonly) long long timelineOccupancy;
...
- (struct { long long x1; int x2; unsigned int x3; long long x4; })plannedDuration;
...
- (void)setContentMayVary:(bool)arg1;
- (void)setCue:(id)arg1;
- (void)setDate:(id)arg1;
- (void)setIdentifier:(id)arg1;
- (void)setImmutable;
- (void)setPlannedDuration:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg1;
