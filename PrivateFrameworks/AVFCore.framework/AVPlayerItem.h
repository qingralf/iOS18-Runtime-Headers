...
@interface AVPlayerItem : NSObject <AVIntegrityChecking, AVMetricEventStreamPublisherInternal, MFPlayerItem, NSCopying> {
...
@property (nonatomic, copy) NSArray *speedRamp;
@property (nonatomic, readonly) struct { long long x1; int x2; unsigned int x3; long long x4; } speedRampAdjustabilityMargin;
...
- (void)_addRenderedLegibleOutput:(id)arg1;
...
- (void)_figPlaybackItem:(struct OpaqueFigPlaybackItem { }*)arg1 didFlushRenderedLegibleOutputWithDictionaryKey:(id)arg2;
...
- (void)_figPlaybackItem:(struct OpaqueFigPlaybackItem { }*)arg1 didOutputRenderedCaptionImages:(id)arg2 atItemTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg3 withRenderedLegibleOutputsDictionaryKey:(id)arg4;
...
- (void)_removeRenderedLegibleOutput:(id)arg1;
- (void)_removeSyncLayer:(id)arg1;
- (void)_removeVideoOutput:(id)arg1;
- (id)_renderedLegibleOutputForKey:(id)arg1;
...
- (void)_setAudioEffectParameters:(id)arg1 previousEffects:(id)arg2 forTrackID:(int)arg3;
- (void)_setAudioProcessingEffectsAccordingToInputParameters:(id)arg1 forTrackID:(int)arg2;
...
- (void)_setCoordinatorIdentifier:(id)arg1;
...
- (void)_setParticipatesInCoordinatedPlayback:(bool)arg1;
...
- (void)_updateReportingValuesProperty:(id)arg1 forKey:(id)arg2;
...
- (id)gaplessInfo;
- (void)getEventTimelineWithCompletionHandler:(id /* block */)arg1;
...
- (id)outputs;
- (struct { long long x1; int x2; unsigned int x3; long long x4; })overlappedPlaybackEndTime;
...
- (void)setOverlappedPlaybackEndTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg1;
...
- (id)speedRamp;
- (struct { long long x1; int x2; unsigned int x3; long long x4; })speedRampAdjustabilityMargin;
...
- (void)setModelStringID:(id)arg1;
- (void)setModelTypeName:(id)arg1;
- (void)setPrefersSeekOverSkip:(bool)arg1;
- (void)setTitle:(id)arg1;
- (void)setTransitionPlaybackEndStateSourceTime:(double)arg1;
- (void)setTransitionPlaybackEndStateTargetTime:(double)arg1;
- (double)time;
- (id)title;
