...
@interface AVSampleBufferVideoRenderer : NSObject <AVFigVideoQueueFactory, AVMediaDataRequesterConsumer, AVQueuedSampleBufferRendering, AVQueuedSampleBufferRenderingInternal> {
    ...
    bool  _shouldWaitForVideoTarget;
    long long  _status;
...
- (void)_fireDisplayLayerNotificationNowThenReleaseOnMainThread:(id)arg1 userInfo:(id)arg2;
- (void)_flushComplete;
- (bool)_hasEverEnqueued;
...
- (int)attachToContentKeySession:(id)arg1 contentKeyBoss:(struct OpaqueFigContentKeyBoss { }*)arg2 failedSinceAlreadyAttachedToAnotherSession:(bool*)arg3;
...
- (void)loadVideoPerformanceMetricsWithCompletionHandler:(id /* block */)arg1;
...
- (void)setReadyForDisplayWithoutKVO:(bool)arg1;
