...
- (int)_attachToContentKeySession:(id)arg1 contentKeyBoss:(struct OpaqueFigContentKeyBoss { }*)arg2 failedSinceAlreadyAttachedToAnotherSession:(bool*)arg3;
...
+ (id)rc_transcriptionDataForURL:(id)arg1;
+ (bool)rc_updateFile:(id)arg1 withTranscriptionData:(id)arg2 error:(id*)arg3;
