...
@property (nonatomic, readonly) NSString *perFrameHDRDisplayMetadataPolicy;
...
- (id)_trackWithTrackID:(int)arg1 inTracks:(id)arg2;
- (id)animationTool;
...
- (void)dealloc;
- (void)determineValidityForAsset:(id)arg1 timeRange:(struct { struct { long long x_1_1_1; int x_1_1_2; unsigned int x_1_1_3; long long x_1_1_4; } x1; struct { long long x_2_1_1; int x_2_1_2; unsigned int x_2_1_3; long long x_2_1_4; } x2; })arg2 validationDelegate:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (bool)isValidForTracks:(id)arg1 assetDuration:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2 timeRange:(struct { struct { long long x_1_1_1; int x_1_1_2; unsigned int x_1_1_3; long long x_1_1_4; } x1; struct { long long x_2_1_1; int x_2_1_2; unsigned int x_2_1_3; long long x_2_1_4; } x2; })arg3 validationDelegate:(id)arg4;
...
- (void)setSourceSampleDataTrackWindowsForTrackIDs:(id)arg1;
- (void)setSourceTrackIDForFrameTiming:(int)arg1;
- (void)setSourceVideoTrackWindowsForTrackIDs:(id)arg1;
...
- (void)videoCompositionOutputColorPropertiesWithCustomCompositor:(id)arg1 formatDescriptions:(id)arg2 colorPrimaries:(id*)arg3 transferFunction:(id*)arg4 yCbCrMatrix:(id*)arg5 perFrameHDRDisplayMetadataPolicy:(id*)arg6;
