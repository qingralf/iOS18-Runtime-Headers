...
- (void)_registerUpdateBlock:(id /* block */)arg1 forPreferenceKey:(id)arg2 withListener:(id)arg3;
- (bool)_switchFromRootUserIfNecessary:(id /* block */)arg1;
- (void)_synchronizeIfNecessaryForPreferenceKey:(id)arg1 domainName:(id)arg2;
- (void)_unregisterUpdateBlockForPreferenceKey:(id)arg1 withListenerID:(id)arg2;
...
- (float)floatValueForPreferenceKey:(id)arg1 defaultValue:(float)arg2;
...
- (void)registerUpdateBlock:(id /* block */)arg1 forPreferenceKey:(id)arg2 withListener:(id)arg3;
...
- (id)targetForKVOKey:(id)arg1;
- (void)unregisterUpdateBlockForPreferenceKey:(id)arg1 withListenerID:(id)arg2;
