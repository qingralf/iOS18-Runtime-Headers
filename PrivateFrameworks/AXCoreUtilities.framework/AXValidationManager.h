...
@interface AXValidationManager : NSObject {
    ...
    bool  _installSafeCategoriesOffMainThread;
...
- (void)_printEncodedConsoleReportForValidationRunner:(bool)arg1 isDelayed:(bool)arg2;
- (void)_resetState;
...
- (void)setInstallSafeCategoriesOffMainThread:(bool)arg1;
