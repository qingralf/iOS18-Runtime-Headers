...
@interface AXElement : NSObject <AXElementNamesItem, AXGroupable> {
    ...
    bool  _hoverTypingShouldAdjustDockedMode;
...
@property (nonatomic, readonly) bool hoverTypingShouldAdjustDockedMode;
...
+ (id)_testCombinationsFromTitle:(id)arg1 isCarPlayConnected:(bool)arg2;
+ (bool)_trimMutableString:(id)arg1 toMaxWordCount:(long long)arg2;
+ (long long)doesArrayOfWords:(id)arg1 containArrayOfArrayWords:(id)arg2;
+ (id)wordsFromString:(id)arg1;

- (id)_combinationsFromTitle:(id)arg1 isCarPlayConnected:(bool)arg2;
...
- (id)objectForRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 withParameterizedAttribute:(long long)arg2;
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })rangeForTextMarker:(id)arg1;
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })rangeForTextMarkers:(id)arg1;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })textMarkerFrame:(id)arg1;
- (id)textMarkerRangeForSelection;
- (id)textMarkersForRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })visibleTextRange;
