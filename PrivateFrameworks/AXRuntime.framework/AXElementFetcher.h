...
@property (nonatomic, readonly) AXElementGroup *elementCommunityGroup;
@property (nonatomic, retain) AXElementGroup *elementCommunityGroupCache;
...
- (void)setElementCommunityGroupCache:(id)arg1;
