...
@property (nonatomic, readonly) NSDictionary *cachedAttributes;
@property (nonatomic, readonly) NSMutableDictionary *copyCachedAttributes;
...
+ (void)applyElementCustomAttributeCacheScheme:(id)arg1;
+ (void)initialize;
+ (id)proxiedMLElementsForApp:(id)arg1;
+ (id)scrollAncestorAtCoordinate:(struct CGPoint { double x1; double x2; })arg1;
...
+ (id)uiApplicationWithPid:(int)arg1;
+ (id)uiElementAtCoordinate:(struct CGPoint { double x1; double x2; })arg1;
+ (id)uiElementAtCoordinate:(struct CGPoint { double x1; double x2; })arg1 displayId:(unsigned int)arg2;
...
+ (id)uiElementAtCoordinate:(struct CGPoint { double x1; double x2; })arg1 forApplication:(struct __AXUIElement { }*)arg2 contextId:(unsigned int)arg3 displayId:(unsigned int)arg4;
...
- (id)_elementsWithParameter:(long long)arg1 parameters:(id)arg2 prefetchAttributes:(bool)arg3;
- (void)_invalidate;
...
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })_lineRangeWithFaultTolerance:(long long)arg1 forward:(bool)arg2;
