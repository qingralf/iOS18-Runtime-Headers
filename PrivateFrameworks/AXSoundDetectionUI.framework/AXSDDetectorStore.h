...
- (id)_detectorWithIdentifier:(id)arg1;
- (id)_detectorWithName:(id)arg1;
...
- (void)_notifyObserversDidFinishPurgingDetectors:(id)arg1 wasSuccessful:(bool)arg2 error:(id)arg3;
...
- (void)assetManager:(id)arg1 didFinishPurgingAssets:(id)arg2 wasSuccessful:(bool)arg3 error:(id)arg4;
