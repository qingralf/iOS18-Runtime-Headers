...
@interface AXSDKShotController : NSObject <AXSDDetectorManagerDelegate, AXSDDetectorQueueManagerDelegate, AXSDKShotRecordingManagerDelegate, AXSDListenEngineDelegate, AXSDUltronModelAssetManagerDelegate, HearingMLHelperServiceDelegate> {
    ...
    <_TtP18AXSoundDetectionUI32AXSDKShotRecordingImplementation_> * _trainingController;
