...
- (void)_interruptCarPlay:(id)arg1;
- (void)_mediaServicesWereReset:(id)arg1;
- (void)_micDisabledUpdated;
- (bool)_notListeningForAnyReason;
- (void)_notifyListeningStartedWithError:(id)arg1;
...
- (bool)containsListenDelegate:(id)arg1;
- (void)dealloc;
- (id)init;
- (bool)isListening;
- (void)notifyListeningEncounteredError:(id)arg1;
- (void)notifyListeningFinishedAudioFile:(id)arg1;
- (void)notifyListeningReceivedAudioFile:(id)arg1;
- (void)notifyListeningStartedWithError:(id)arg1;
- (void)pipeInFile:(id)arg1;
