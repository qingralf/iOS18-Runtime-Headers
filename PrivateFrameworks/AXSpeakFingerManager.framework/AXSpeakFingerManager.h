/* Generated by RuntimeBrowser
   Image: /System/Library/PrivateFrameworks/AXSpeakFingerManager.framework/AXSpeakFingerManager
 */
...
@interface AXSpeakFingerManager : NSObject <AXOratorDelegate, AXUIClientDelegate, AXUIService> {
    ...
    NSString * _lastSpeakUnderFingerPhrase;
    struct CGPoint { 
        double x; 
        double y; 
    }  _lastTouchPoint;
...
@property (nonatomic, retain) NSString *lastSpeakUnderFingerPhrase;
...
- (void)setLastSpeakUnderFingerPhrase:(id)arg1;
