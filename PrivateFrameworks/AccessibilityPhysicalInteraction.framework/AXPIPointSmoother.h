...
@property (nonatomic, retain) NSMutableArray *medianPointBuffer;
...
@property (nonatomic) bool useGaussianBlur;
@property (nonatomic) bool useMedianFilter;
...
- (id)_gaussianBlurredArrayFromArray:(id)arg1;
...
- (struct CGPoint { double x1; double x2; })medianFilterPointForPoint:(struct CGPoint { double x1; double x2; })arg1;
- (id)medianPointBuffer;
