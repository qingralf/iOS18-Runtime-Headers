...
@interface AXPTranslator_iOS : AXPTranslator {
    ...
    id /* block */  _axTreeDumpCompletionHandler;
    ...
    bool  _shouldHonorGroupsForElementTraversal;
    bool  _shouldStopGeneratingAXTree;
...
@property (nonatomic, copy) id /* block */ axTreeDumpCompletionHandler;
@property (nonatomic) long long axTreeDumpCurrentChildIndex;
@property (nonatomic, retain) NSMutableArray *axTreeDumpCurrentOutput;
@property (nonatomic, retain) NSString *axTreeDumpCurrentType;
@property (nonatomic, retain) NSMutableArray *axTreeDumpCurrentlyProcessingChildren;
@property (nonatomic, retain) NSLock *axTreeDumpLock;
@property (nonatomic, retain) AXUIElement *frontmostAppOnContinuityDisplay;
@property (nonatomic) bool shouldHonorGroupsForElementTraversal;
@property (nonatomic) bool shouldStopGeneratingAXTree;
...
- (id)_postProcessResultDataForSecureCoding:(id)arg1;
...
- (id)_processFrontMostAppForContinuity:(id)arg1;
...
- (void)_safelyAddAXTreeDumpResponseToCurrentOutput:(id)arg1;
...
- (id /* block */)axTreeDumpCompletionHandler;
- (long long)axTreeDumpCurrentChildIndex;
- (id)axTreeDumpCurrentOutput;
- (id)axTreeDumpCurrentType;
- (id)axTreeDumpCurrentlyProcessingChildren;
...
- (void)fetchNextSetOfElementAttrsOnBackgroundThreadWithEarlyTermination:(bool)arg1;
- (id)frontmostAppOnContinuityDisplay;
...
- (id)processFrontMostApp:(id)arg1 withiOSAttribute:(long long)arg2;
- (id)processHitTest:(id)arg1;
- (id)processMultipleAttributeRequest:(id)arg1;
- (id)processMultipleAttributeRequest:(id)arg1 removeEmptyValue:(bool)arg2;
...
- (void)setAxTreeDumpCompletionHandler:(id /* block */)arg1;
- (void)setAxTreeDumpCurrentChildIndex:(long long)arg1;
- (void)setAxTreeDumpCurrentOutput:(id)arg1;
- (void)setAxTreeDumpCurrentType:(id)arg1;
- (void)setAxTreeDumpCurrentlyProcessingChildren:(id)arg1;
- (void)setAxTreeDumpLock:(id)arg1;
- (void)setAxTreeDumpSharedBackgroundQueue:(id)arg1;
- (void)setFrontmostAppOnContinuityDisplay:(id)arg1;
- (void)setRequestResolvingBehavior:(unsigned long long)arg1;
- (void)setShouldHonorGroupsForElementTraversal:(bool)arg1;
- (void)setShouldStopGeneratingAXTree:(bool)arg1;
