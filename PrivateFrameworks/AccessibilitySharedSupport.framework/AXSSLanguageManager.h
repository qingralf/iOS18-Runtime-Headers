...
@property (nonatomic, retain) NSCharacterSet *commonGreekCharacters;
...
- (bool)isCommonGreekCharacter:(unsigned short)arg1;
- (bool)isStringComposedByCommonCharacters:(id)arg1;
- (id)languageMaps;
- (void)setCommonCharacters:(id)arg1;
- (void)setCommonGreekCharacters:(id)arg1;
