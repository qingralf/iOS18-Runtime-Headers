...
- (void).cxx_destruct;
- (void)_appendParagraphWithText:(id)arg1 withImage:(id)arg2 withTextColor:(id)arg3 font:(id)arg4 textAlignment:(long long)arg5 lineSpacing:(double)arg6 paragraphSpacingBefore:(double)arg7 toAttributedString:(id)arg8;
