...
- (bool)_isSafeToProcessMessageFromUnentitledProcessWithIdentifier:(unsigned long long)arg1;
...
- (bool)serviceCanProcessMessageWithIdentifier:(unsigned long long)arg1 fromClientWithConnection:(id)arg2 possibleRequiredEntitlements:(id*)arg3 needsToRequireEntitlements:(bool*)arg4;
- (Class)serviceClass;
