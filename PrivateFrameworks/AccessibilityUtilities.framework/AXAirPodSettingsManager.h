...
- (bool)caseTonesEnabledForDeviceAddress:(id)arg1;
- (void)dealloc;
...
- (id /* block */)readyBlock;
- (void)setCaseTonesEnabled:(bool)arg1 forDeviceAddress:(id)arg2;
...
- (bool)supportsCaseTonesForDeviceAddress:(id)arg1;
