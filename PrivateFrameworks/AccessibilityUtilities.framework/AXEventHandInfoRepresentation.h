...
@interface AXEventHandInfoRepresentation : NSObject <AXEventRepresentationDescription, NSCopying, NSSecureCoding> {
    ...
    bool  _encodePathsForCompatibility;
    ...
    NSArray * _paths;
    NSArray * _pathsIncludingMayBeginEvents;
...
@property (nonatomic) bool encodePathsForCompatibility;
...
@property (nonatomic, retain) NSArray *pathsIncludingMayBeginEvents;
...
- (void)setPathsIncludingMayBeginEvents:(id)arg1;
