...
@interface AXEventProcessor : NSObject {
    ...
    id /* block */  _failedToHandleEventInTime;
...
@property (nonatomic, copy) id /* block */ failedToHandleEventInTime;
...
- (id /* block */)failedToHandleEventInTime;
...
- (void)setFailedToHandleEventInTime:(id /* block */)arg1;
