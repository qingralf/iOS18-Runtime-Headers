...
@interface AXEventTapManager : NSObject {
    ...
    NSMutableDictionary * _disabledIDMappingRegistry;
    NSRecursiveLock * _eventTapLock;
    NSMutableArray * _eventTaps;
    bool  _ignoreEventsForContinuitySession;
...
@property (nonatomic, retain) NSMutableDictionary *disabledIDMappingRegistry;
...
- (void).cxx_destruct;
- (bool)_accessibilityShouldIgnoreHIDServiceForContinuity:(struct __IOHIDServiceClient { }*)arg1;
...
- (id)_hidFilterListForPair:(id)arg1 filterEvents:(id)arg2;
- (void)_installEventTap:(id)arg1 skipDeviceMatching:(bool)arg2 filterEvents:(id)arg3;
- (void)_installHIDFilter:(id)arg1 skipDeviceMatching:(bool)arg2 filterEvents:(id)arg3;
...
- (void)dealloc;
- (id)description;
- (id)disabledIDMappingRegistry;
- (bool)ignoreEventsForContinuitySession;
- (id)init;
- (id)installEventTap:(id /* block */)arg1 identifier:(id)arg2 type:(int)arg3;
- (id)installEventTap:(id /* block */)arg1 identifier:(id)arg2 type:(int)arg3 skipDeviceMatching:(bool)arg4 filterEvents:(id)arg5 matchingServiceHandler:(id /* block */)arg6;
