...
@property (nonatomic, retain) NSMutableArray *delayedMessages;
...
- (bool)_clientHasEntitlementWithPort:(unsigned int)arg1 auditToken:(struct { unsigned int x1[8]; })arg2 message:(id)arg3 completion:(id /* block */)arg4;
...
- (bool)_hasEntitlement:(id)arg1 entitlements:(id)arg2 clientPort:(unsigned int)arg3 auditToken:(struct { unsigned int x1[8]; })arg4 message:(id)arg5 completion:(id /* block */)arg6;
- (void)_processValidatedMessage:(id)arg1 completion:(id /* block */)arg2;
...
- (void)setDelayedMessages:(id)arg1;
