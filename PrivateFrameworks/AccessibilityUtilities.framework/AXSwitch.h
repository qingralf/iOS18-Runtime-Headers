...
@interface AXSwitch : NSObject <NSSecureCoding> {
    ...
    NSString * _longPressShortcutIdentifier;
...
@property (nonatomic, retain) NSString *longPressShortcutIdentifier;
...
- (id)longPressShortcutIdentifier;
- (id)manufacturerName;
- (id)midiEvent;
- (id)name;
- (id)productName;
...
- (void)setLongPressShortcutIdentifier:(id)arg1;
