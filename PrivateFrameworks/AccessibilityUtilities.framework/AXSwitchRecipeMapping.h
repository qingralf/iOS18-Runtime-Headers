...
@interface AXSwitchRecipeMapping : NSObject {
    NSString * _action;
    AXSwitchGameControlButtonPress * _gameControlButtonPress;
    ...
    AXSwitchGameControlButtonPress * _longPressGameControlButtonPress;
...
@property (nonatomic, retain) AXSwitchGameControlButtonPress *gameControlButtonPress;
...
@property (nonatomic, retain) AXSwitchGameControlButtonPress *longPressGameControlButtonPress;
