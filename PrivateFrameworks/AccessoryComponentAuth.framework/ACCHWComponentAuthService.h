/* Generated by RuntimeBrowser
   Image: /System/Library/PrivateFrameworks/AccessoryComponentAuth.framework/AccessoryComponentAuth
 */

@interface ACCHWComponentAuthService : NSObject <ACCHWComponentAuthServiceProtocol>

- (void)_authenticateModuleWithChallenge:(id)arg1 completionHandler:(id /* block */)arg2 moduleType:(int)arg3 updateRegistry:(bool)arg4 updateUIProperty:(bool)arg5 logToAnalytics:(bool)arg6;
...
- (void)_logToAnalytics:(int)arg1 authError:(int)arg2 fdrValidationStatus:(int)arg3 authDurationInMS:(unsigned long long)arg4;
...
- (void)authenticateVeridianWithChallenge:(id)arg1 completionHandler:(id /* block */)arg2 updateRegistry:(bool)arg3 updateUIProperty:(bool)arg4 logToAnalytics:(bool)arg5;
