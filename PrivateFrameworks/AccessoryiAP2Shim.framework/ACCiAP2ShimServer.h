...
+ (void)markClientAsInterestedInBleNotifications:(id)arg1;
+ (void)notifyInterestedClientsOfACCBLEAccessoryEvent:(id)arg1 withPayload:(id)arg2;
...
- (void)sendToClient:(id)arg1 notification:(const char *)arg2 withPayload:(id)arg3;
- (void)sendToInterestedClientsACCBLENotification:(id)arg1 withPayload:(id)arg2;
