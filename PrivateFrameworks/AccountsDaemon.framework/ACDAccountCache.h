...
- (void).cxx_destruct;
- (void)_caches_lock_cacheAccounts:(id)arg1 forType:(id)arg2 justActive:(bool)arg3;
- (id)_expirerIdentifierForAccountTypeID:(id)arg1;
- (void)_expirerScheduleForAccountIdentifier:(id)arg1;
- (id)_keyForType:(id)arg1 justActive:(bool)arg2;
- (void)_lock_cacheAccount:(id)arg1;
- (void)_lock_cacheAccountCopy:(id)arg1;
- (void)_lock_cacheGenerationForAccounts:(id)arg1 cacheSuffix:(id)arg2;
- (void)_lock_cacheParent:(id)arg1;
- (id)_lock_nonCopyOfAccountWithIdentifier:(id)arg1;
...
- (id)cachedAccountsOfType:(id)arg1 justActive:(bool)arg2 fetchBlock:(id /* block */)arg3;
- (void)clearCache;
- (id)expirersByID;
