...
- (id)_block_accountWithIdentifier:(id)arg1;
- (id)_block_accountsWithAccountType:(id)arg1 options:(unsigned long long)arg2 error:(id*)arg3;
- (id)_block_accountsWithAccountTypeIdentifiers:(id)arg1 preloadedProperties:(id)arg2;
...
- (void)uidOfAccountsd:(id /* block */)arg1;
...
- (void)gkSaveAccount:(id)arg1 verify:(bool)arg2 withCompletion:(id /* block */)arg3;
