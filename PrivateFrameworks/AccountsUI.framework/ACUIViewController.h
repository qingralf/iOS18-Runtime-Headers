...
+ (id)acuiAccountStore;
+ (id)guestUserModeContentUnavailableConfiguration:(id)arg1;
...
- (void)showConfirmationForDeletingAccount:(id)arg1 completion:(id /* block */)arg2;
...
- (void)showConfirmationWithButtons:(id)arg1 title:(id)arg2 message:(id)arg3 destructive:(bool)arg4 completion:(id /* block */)arg5;
- (id)specifiers;
