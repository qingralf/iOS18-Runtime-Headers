...
@interface ACHActivityAwardingSource : NSObject <ACHAchievementProgressProviding, ACHEarnedInstanceAwarding, HDCurrentActivitySummaryHelperObserver, HDHealthDaemonReadyObserver> {
    ...
    ACHDataStoreActivityProperties * _latestDataStoreProperties;
    NSNumber * _overrideIsAppleWatch;
    NSString * _overrideWatchCountryCode;
    FIPauseRingsCoordinator * _pauseRingsCoordinator;
    HDProfile * _profile;
...
@property (nonatomic, retain) ACHDataStoreActivityProperties *latestDataStoreProperties;
@property (nonatomic, retain) NSNumber *overrideIsAppleWatch;
@property (nonatomic, retain) NSString *overrideWatchCountryCode;
@property (nonatomic, retain) FIPauseRingsCoordinator *pauseRingsCoordinator;
...
- (id)healthStore;
- (id)initWithHealthStore:(id)arg1 dataStore:(id)arg2 templateStore:(id)arg3 pauseRingsCoordinator:(id)arg4 awardingEngine:(id)arg5 progressEngine:(id)arg6;
...
- (id)latestDataStoreProperties;
- (id)overrideIsAppleWatch;
- (id)overrideWatchCountryCode;
- (id)pauseRingsCoordinator;
- (id)profile;
...
- (void)setLatestDataStoreProperties:(id)arg1;
- (void)setOverrideIsAppleWatch:(id)arg1;
- (void)setOverrideWatchCountryCode:(id)arg1;
- (void)setPauseRingsCoordinator:(id)arg1;
