...
@interface ACHCompanionAwardingScheduler : NSObject <ACHAwardingScheduler, ACHDataStoreObserving, ACHTemplateStoreObserving, HDDiagnosticObject, HDHealthDaemonReadyObserver, HDPeriodicActivityDelegate> {
