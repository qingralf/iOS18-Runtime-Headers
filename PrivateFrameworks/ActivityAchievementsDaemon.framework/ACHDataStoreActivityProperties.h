...
@interface ACHDataStoreActivityProperties : NSObject {
    ...
    unsigned long long  _currentMonthMoveStreak;
    unsigned long long  _currentMoveStreak;
    unsigned long long  _currentStandStreak;
    unsigned long long  _currentWeekExerciseStreak;
    unsigned long long  _currentWeekMoveStreak;
    unsigned long long  _currentWeekStandStreak;
    unsigned long long  _lastStepCount;
    long long  _mostRecentAllGoalsMadeIndex;
    ACHDataStoreActivityProperties * _previousValues;
    long long  _storeValuesValidBeforeSummaryIndex;
    unsigned long long  _totalAllGoalsMade;
...
- (unsigned long long)currentMonthMoveStreak;
- (unsigned long long)currentMoveStreak;
- (unsigned long long)currentStandStreak;
- (unsigned long long)currentWeekExerciseStreak;
- (unsigned long long)currentWeekMoveStreak;
- (unsigned long long)currentWeekStandStreak;
- (id)dictionaryKeys;
- (id)dictionaryRepresentation;
- (unsigned long long)lastStepCount;
- (long long)mostRecentAllGoalsMadeIndex;
- (id)previousValues;
...
- (void)setCurrentMonthMoveStreak:(unsigned long long)arg1;
- (void)setCurrentMoveStreak:(unsigned long long)arg1;
- (void)setCurrentStandStreak:(unsigned long long)arg1;
- (void)setCurrentWeekExerciseStreak:(unsigned long long)arg1;
- (void)setCurrentWeekMoveStreak:(unsigned long long)arg1;
- (void)setCurrentWeekStandStreak:(unsigned long long)arg1;
- (void)setLastStepCount:(unsigned long long)arg1;
- (void)setMostRecentAllGoalsMadeIndex:(long long)arg1;
- (void)setPreviousValues:(id)arg1;
- (void)setStoreValuesValidBeforeSummaryIndex:(long long)arg1;
- (void)setTotalAllGoalsMade:(unsigned long long)arg1;
...
- (unsigned long long)totalAllGoalsMade;
