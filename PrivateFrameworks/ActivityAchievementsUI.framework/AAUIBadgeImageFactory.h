...
- (void)thumbnailImageForAchievement:(id)arg1 size:(struct CGSize { double x1; double x2; })arg2 completion:(id /* block */)arg3;
- (id)thumbnailImageForAchievements:(id)arg1 size:(struct CGSize { double x1; double x2; })arg2 alignment:(int)arg3;
- (void)thumbnailImageForAchievements:(id)arg1 size:(struct CGSize { double x1; double x2; })arg2 alignment:(int)arg3 completion:(id /* block */)arg4;
...
- (void)thumbnailImageForAchievements:(id)arg1 size:(struct CGSize { double x1; double x2; })arg2 alignment:(int)arg3 stackType:(int)arg4 completion:(id /* block */)arg5;
