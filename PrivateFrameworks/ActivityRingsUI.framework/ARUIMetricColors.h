...
@property (nonatomic, retain) UIColor *gradientContrastColor;
@property (nonatomic, retain) UIColor *gradientDarkColor;
@property (nonatomic, retain) UIColor *gradientLightColor;
@property (nonatomic, retain) UIColor *highContrastTextColor;
...
@property (nonatomic, retain) UIColor *textDisplayColor;
...
- (id)buttonTextColor;
- (id)gradientContrastColor;
- (id)gradientDarkColor;
- (id)gradientLightColor;
- (id)highContrastTextColor;
...
- (void)setGradientContrastColor:(id)arg1;
- (void)setGradientDarkColor:(id)arg1;
- (void)setGradientLightColor:(id)arg1;
- (void)setHighContrastTextColor:(id)arg1;
...
- (void)setTextDisplayColor:(id)arg1;
...
+ (id)lapColors;
+ (id)lapsColors;
+ (id)metricColorsForGoal:(id)arg1;
