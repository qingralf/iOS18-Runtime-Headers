...
+ (double)preferredActivityRingInterspacingForDiameter:(double)arg1;
+ (double)preferredActivityRingThicknessForDiameter:(double)arg1;
+ (double)preferredActivityRingThicknessForDiameter:(double)arg1 isStandaloneRing:(bool)arg2;
...
- (void)_setStandardColorsWithAnimated:(bool)arg1;
- (void)_setupColorAnimationForState:(id)arg1 startTopColor:(id)arg2 endTopColor:(id)arg3 startBottomColor:(id)arg4 endBottomColor:(id)arg5 key:(id)arg6 applier:(id /* block */)arg7;
...
- (void)setIsPaused:(bool)arg1 animated:(bool)arg2;
- (void)setIsPaused:(bool)arg1 animated:(bool)arg2 completion:(id /* block */)arg3;
- (void)setIsPaused:(bool)arg1 completion:(id /* block */)arg2;
...
- (void)setTopColor:(id)arg1 bottomColor:(id)arg2 ofRingAtIndex:(long long)arg3 animated:(bool)arg4;
...
- (void)hk_configureWithActivitySummary:(id)arg1 isStandaloneFallback:(bool)arg2 animated:(bool)arg3 completion:(id /* block */)arg4;
