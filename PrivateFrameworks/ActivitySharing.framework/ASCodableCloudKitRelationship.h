...
@interface ASCodableCloudKitRelationship : PBCodable <NSCopying> {
    ...
    NSData * _receivedInvitation;
    NSString * _secureCloudUpgradeToken;
    NSData * _sentInvitation;
...
@property (nonatomic, readonly) bool hasReceivedInvitation;
@property (nonatomic, readonly) bool hasSecureCloudUpgradeToken;
...
@property (nonatomic, retain) NSData *receivedInvitation;
@property (nonatomic, retain) NSString *secureCloudUpgradeToken;
@property (nonatomic, retain) NSData *sentInvitation;
...
- (void)setCloudType:(long long)arg1;
- (void)setEventCount:(long long)arg1;
- (void)setEvents:(id)arg1;
- (void)setHasCloudType:(bool)arg1;
