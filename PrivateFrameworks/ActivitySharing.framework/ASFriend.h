...
@property (nonatomic, readonly) bool needsDowngradeRequestAcknowledgment;
...
- (bool)estimatedIsStandaloneForSnapshotIndex:(id)arg1;
...
- (id)as_friendListNameStringWithDotPrefix:(id)arg1 keyColor:(id)arg2 showAwaitingCompetitionResponse:(bool)arg3;
