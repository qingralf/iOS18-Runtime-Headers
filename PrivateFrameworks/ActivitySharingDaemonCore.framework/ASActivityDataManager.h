...
@property (nonatomic, readonly) _HKFitnessFriendActivitySnapshot *yesterdayActivitySnapshot;
@property (nonatomic, readonly) HKActivitySummary *yesterdayActivitySummary;
@property (nonatomic, readonly) NSSet *yesterdayWorkouts;
...
- (void)_queue_saveFitnessFriendActivitySnapshots:(id)arg1 workouts:(id)arg2 achievements:(id)arg3 isInvitationData:(bool)arg4;
...
- (void)_queue_setSecureCloudGoalCompletionAnchor:(id)arg1;
...
- (void)findDeletedWorkoutEventsWithAnchor:(id)arg1 completion:(id /* block */)arg2;
...
- (id)recordsFromActivityDataCodables:(id)arg1 recordEncryptionType:(long long)arg2;
- (id)recordsToSave;
- (void)removeObserver:(id)arg1;
- (void)samplesAdded:(id)arg1 anchor:(id)arg2;
- (void)saveActivitySnapshots:(id)arg1 workouts:(id)arg2 achievements:(id)arg3 isInvitationData:(bool)arg4;
...
- (void)updateSecureCloudGoalCompletionAnchor:(id)arg1;
- (id)workoutsFromFitnessFriendSamples:(id)arg1;
- (id)yesterdayActivitySnapshot;
- (id)yesterdayActivitySummary;
- (id)yesterdayWorkouts;
