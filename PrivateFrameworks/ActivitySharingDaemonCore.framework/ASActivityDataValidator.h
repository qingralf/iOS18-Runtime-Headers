...
+ (id)_unhiddenSamplesInFilterableSamples:(id)arg1 friendTimeZones:(id)arg2 friendListManager:(id)arg3 isInvitationData:(bool)arg4;
+ (id)validatedSamplesFromAchievements:(id)arg1 workouts:(id)arg2 activitySnapshots:(id)arg3 friendListManager:(id)arg4 isInvitationData:(bool)arg5;
