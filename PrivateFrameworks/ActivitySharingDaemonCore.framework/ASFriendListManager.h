...
@interface ASFriendListManager : NSObject <ASActivitySharingManagerReadyObserver, ASCompetitionManagerObserver, ASContactsManagerObserver, CHFitnessAppBadgeCountProvider> {
    ...
    NSSet * _friends;
    bool  _hasLegacyFriendsToShareWith;
    bool  _hasSecureCloudFriendsToShareWith;
    bool  _isWatch;
...
@property (readonly) bool hasLegacyFriendsToShareWith;
@property (readonly) bool hasSecureCloudFriendsToShareWith;
