...
- (id)initWithWidth:(id)arg1 height:(id)arg2 cornerRadius:(double)arg3 edgeInsets:(id)arg4 clipMargin:(double)arg5 scaleFactor:(double)arg6 watchDisplayVariant:(id)arg7;
- (id)initWithWidth:(id)arg1 height:(id)arg2 cornerRadius:(double)arg3 watchDisplayVariant:(id)arg4;
...
- (void)setWatchDisplayVariant:(id)arg1;
- (void)setWidthRequest:(id)arg1;
- (id)watchDisplayVariant;
- (id)widthRequest;
