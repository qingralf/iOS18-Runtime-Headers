...
@interface ABNamePredicate : ABPredicate {
    ...
    bool  _matchSmartDialerFormatsExclusively;
...
@property (nonatomic) bool matchSmartDialerFormatsExclusively;
...
- (void)setMatchSmartDialerFormatsExclusively:(bool)arg1;
