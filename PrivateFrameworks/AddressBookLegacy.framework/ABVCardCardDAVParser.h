...
- (id)defaultURLLabel;
- (id)genericLabel;
- (bool)importToGroup:(void*)arg1;
- (bool)importToGroup:(void*)arg1 removeExistingProperties:(bool)arg2;
- (bool)importToPerson:(void*)arg1;
- (bool)importToPerson:(void*)arg1 removeExistingProperties:(bool)arg2;
- (id)initWithData:(id)arg1 importOptions:(unsigned long long)arg2;
- (id)initWithData:(id)arg1 watchdogTimer:(id)arg2;
- (id)initWithData:(id)arg1 watchdogTimer:(id)arg2 importOptions:(unsigned long long)arg3;
