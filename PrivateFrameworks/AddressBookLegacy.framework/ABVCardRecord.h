...
+ (void)setIncludeAddressingGrammarInVCards:(bool)arg1;
...
- (id)_copyVCardRepresentationAsStringIncludeExternalProperties:(bool)arg1 withPhoto:(id)arg2 extraPhotoParameters:(id)arg3 includePrivateData:(bool)arg4 includeWallpaper:(bool)arg5;
...
- (id)stringForAlternateBirthdayComponent:(id)arg1 key:(id)arg2 formatWidth:(int)arg3;
