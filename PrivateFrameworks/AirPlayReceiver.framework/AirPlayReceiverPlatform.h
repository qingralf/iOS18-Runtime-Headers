...
@interface AirPlayReceiverPlatform : NSObject {
    ...
    struct { 
        ...
        union { 
            ...
            struct { 
                unsigned char nowPlayingSessionStarted; 
                struct OpaqueAPReceiverRequestProcessor {} *mainMediaReceiverSession; 
            } multiPrimaries; 
        } nowPlaying; 
    }  _state;
...
- (void)setMainMediaReceiverSession:(struct OpaqueAPReceiverRequestProcessor { }*)arg1;
- (void)setReceiverSessionCountAndUpdateStateIfNeeded:(unsigned long long)arg1;
- (void)setShouldHandleMRCommands:(unsigned char)arg1;
