/* Generated by RuntimeBrowser
   Image: /System/Library/PrivateFrameworks/AirPlayReceiverKit.framework/AirPlayReceiverKit
 */
...
@property (nonatomic, readonly) int playerSessionID;
...
- (void)_ensureInterstitialPlayerFor:(int)arg1;
...
- (void)_handleCurrentItemFailedToPlayToEndNotification:(id)arg1;
...
- (void)dealloc;
- (id)initWithP2PWiFiSupport:(bool)arg1 isInterstitialPlayer:(bool)arg2 playerSessionID:(int)arg3;
- (void)invalidate;
...
- (int)playerSessionID;
- (void)processMessageWithIDAndDictionaryAsync:(id)arg1 messageSessionID:(int)arg2;
- (id)processMessageWithIDAndDictionarySync:(id)arg1 messageSessionID:(int)arg2;
...
- (bool)shouldDelegateToInterstitialPlayerForMessageAndID:(id)arg1 sessionID:(int)arg2;
