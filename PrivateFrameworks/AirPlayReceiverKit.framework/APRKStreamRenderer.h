...
@interface APRKStreamRenderer : NSObject <APRKMediaPlayerMessagingDelegate> {
    ...
    <NSObject> * _figVideoQueueNotifObserver;
...
- (void)_ensureInternalPlayerFor:(int)arg1;
...
- (bool)processStopAudioSessionRequestWithSessionID:(unsigned int)arg1;
- (bool)processStopScreenPresentationWithSessionID:(unsigned int)arg1;
- (bool)processStopVideoPlaybackRequestWithSessionID:(unsigned int)arg1;
