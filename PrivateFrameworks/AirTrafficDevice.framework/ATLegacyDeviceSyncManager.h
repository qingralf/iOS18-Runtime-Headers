...
@interface ATLegacyDeviceSyncManager : ATDeviceSyncManager <ATLegacyAssetLinkProgressDelegate, ATSessionObserver, ICEnvironmentMonitorObserver> {
...
- (void)_reset;
- (void)_sendDiskUsage;
- (void)_sendDiskUsageWithUpdatedDataClasses:(id)arg1;
