...
- (void)posterSwitcherViewController:(id)arg1 didSetBiometricAuthenticationDisabled:(bool)arg2;
...
- (id)posterSwitcherViewController:(id)arg1 requestsLastSelectedConfigurationUUIDForProviderBundleIdentifier:(id)arg2;
- (bool)posterSwitcherViewController:(id)arg1 wantsBiometricAuthenticationBlockedForDeepUserInteraction:(bool)arg2;
- (void)posterSwitcherViewController:(id)arg1 willSwitchFromConfiguration:(id)arg2 interactive:(bool)arg3;
...
- (bool)viewController:(id)arg1 isApplicationVisibleWithBundleIdentifier:(id)arg2;
