...
- (void)authenticationViewController:(id)arg1 didSetBiometricAuthenticationDisabled:(bool)arg2;
- (void)authenticationViewController:(id)arg1 setDidSetPasscodeVisible:(bool)arg2;
- (bool)authenticationViewControllerWantsBiometricAuthenticationBlocked:(id)arg1;
- (id)backgroundView;
