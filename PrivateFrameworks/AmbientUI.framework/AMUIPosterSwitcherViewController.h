...
- (void)posterCategoryViewController:(id)arg1 didSetBiometricAuthenticationDisabled:(bool)arg2;
...
- (bool)posterCategoryViewController:(id)arg1 wantsBiometricAuthenticationBlockedForDeepUserInteraction:(bool)arg2;
