...
@interface ANTrackPlayer : NSObject {
    ...
    bool  _someOtherSidekickSessionAudioIsPlaying;
...
@property (nonatomic) bool someOtherSidekickSessionAudioIsPlaying;
...
- (void)setSomeOtherSidekickSessionAudioIsPlaying:(bool)arg1;
