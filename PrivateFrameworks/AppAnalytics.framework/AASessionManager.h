...
- (id)initWithAccessQueue:(id)arg1 privacyValidationProvider:(id)arg2 diagnosticsConsentProvider:(id)arg3;
...
- (void)startSessionForKind:(long long)arg1 withName:(id)arg2 identifier:(id)arg3 startDate:(id)arg4 timestampJitter:(id)arg5 timeDurationGranularity:(long long)arg6;
