...
- (void).cxx_destruct;
- (bool)_companionAppWithoutCounterparts:(id)arg1;
...
- (id)applicationRemovabilityForPairedDevice:(id)arg1 error:(id*)arg2;
...
- (void)applictionRemovabilityForPairedDevice:(id)arg1 completion:(id /* block */)arg2;
...
- (void)removabilityDidChangeForApplications:(id)arg1 onDeviceWithPairingID:(id)arg2;
