...
@interface ATXPBAction : PBCodable <NSCopying> {
    ...
    NSMutableArray * _predictableParameterCombinations;
...
@property (nonatomic, retain) NSMutableArray *predictableParameterCombinations;
...
- (void)addPredictableParameterCombinations:(id)arg1;
- (id)bundleId;
...
- (id)predictableParameterCombinations;
- (id)predictableParameterCombinationsAtIndex:(unsigned long long)arg1;
...
- (void)setPredictableParameterCombinations:(id)arg1;
