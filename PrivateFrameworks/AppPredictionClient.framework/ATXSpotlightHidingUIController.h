...
- (void)_addHidingButtonToAutoShortcut:(id)arg1;
...
- (bool)_autoShortcutHasBeenHiddenForSearchResult:(id)arg1 withFeedbackManager:(id)arg2;
...
- (id)_makeClearButtonItemForAutoShortcutAndShouldClearWholeSection:(bool)arg1 ForResult:(id)arg2;
