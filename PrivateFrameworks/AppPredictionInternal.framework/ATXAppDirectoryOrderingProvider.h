...
@interface ATXAppDirectoryOrderingProvider : NSObject {
    ...
    <ATXAppProtectionInfoProvider> * _appProtectionInfoProvider;
...
- (id)_getInstallDateForUnhiddenApp:(id)arg1;
- (id)_getMDMOrgName;
...
- (void)_postHiddenAppsUpdateNotificationWithReason:(id)arg1;
...
- (void)_updateCategoriesForHiddenApps:(id)arg1;
- (void)_updateCategoriesForInstalledApps:(id)arg1;
- (void)_updateCategoriesForRemovedApps:(id)arg1 uninstalled:(bool)arg2 hidden:(bool)arg3;
- (void)_updateCategoriesForUnhiddenApps:(id)arg1;
- (void)_updateCategoriesForUninstalledApps:(id)arg1;
- (void)_updateCategoriesWithRetries:(unsigned long long)arg1;
- (void)_updateHiddenAppsPodWithNotification:(id)arg1;
...
- (void)dealloc;
- (id)description;
- (id)initWithAppInfoManager:(id)arg1 cache:(id)arg2 blacklist:(id)arg3 recentsCache:(id)arg4 hiddenAppsCache:(id)arg5 appClipDataProvider:(id)arg6 appIconState:(id)arg7 appClipChangeListener:(id)arg8 histogramManager:(id)arg9 appProtectionInfoProvider:(id)arg10;
- (bool)isMarketingDemoMode;
- (void)notifyBookmarksDidChange;
- (id)positionScreenTimeOtherAtTheEndOfCategories:(id)arg1;
