...
- (id)initWithFocusModeSignalsLogger:(id)arg1 contactStore:(id)arg2;
- (id)initWithModeConfigurationUIFlowLoggingBiomeStream:(id)arg1 focusModeSignalsLogger:(id)arg2 contactStore:(id)arg3;
