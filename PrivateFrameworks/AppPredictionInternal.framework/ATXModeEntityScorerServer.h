...
- (id)init;
- (id)initWithContactStoreProvider:(id /* block */)arg1;
...
- (id)rankedContactsForDenyListForMode:(unsigned long long)arg1 options:(unsigned long long)arg2;
- (void)rankedContactsForDenyListForMode:(unsigned long long)arg1 options:(unsigned long long)arg2 reply:(id /* block */)arg3;
...
- (id)rankedContactsForMode:(unsigned long long)arg1 options:(unsigned long long)arg2;
- (void)rankedContactsForMode:(unsigned long long)arg1 reply:(id /* block */)arg2;
- (void)rankedContactsForNotificationsForMode:(unsigned long long)arg1 options:(unsigned long long)arg2 reply:(id /* block */)arg3;
- (void)rankedContactsForNotificationsForMode:(unsigned long long)arg1 reply:(id /* block */)arg2;
- (id)rankedEntitiesForDenyListForMode:(unsigned long long)arg1 entityTypeIdentifier:(id)arg2 options:(unsigned long long)arg3;
- (id)rankedEntitiesForMode:(unsigned long long)arg1 entityTypeIdentifier:(id)arg2 modeConfigurationType:(long long)arg3 options:(unsigned long long)arg4;
- (id)rankedEntitiesForMode:(unsigned long long)arg1 entityTypeIdentifier:(id)arg2 options:(unsigned long long)arg3;
- (id)rankedNotificationsForMode:(unsigned long long)arg1;
- (id)rankedNotificationsForMode:(unsigned long long)arg1 options:(unsigned long long)arg2;
