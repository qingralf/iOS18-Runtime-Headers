...
- (id)_scoringWeights;
- (bool)_shouldSuggestOnLockScreenWithDefaults:(id)arg1;
- (id)initWithModeUUID:(id)arg1 modeType:(int)arg2 origin:(int)arg3 originBundleId:(id)arg4 originAnchorType:(id)arg5 confidenceScore:(double)arg6 secondsSinceSuggested:(double)arg7 serializedTriggers:(id)arg8;
- (id)initWithModeUUID:(id)arg1 modeType:(int)arg2 origin:(int)arg3 originBundleId:(id)arg4 originAnchorType:(id)arg5 confidenceScore:(double)arg6 secondsSinceSuggested:(double)arg7 serializedTriggers:(id)arg8 configuredModeService:(id)arg9 feedbackStream:(id)arg10 feedbackHistogramHelper:(id)arg11 appLaunchStream:(id)arg12 groundTruthModeStream:(id)arg13;
