...
- (void).cxx_destruct;
- (bool)_anyColumnWithNameFromColumnNames:(id)arg1 existsOnTable:(id)arg2;
- (id)_countNotificationsPerAppWithFilters:(id)arg1 stmtBinder:(id /* block */)arg2;
- (bool)_hasColumnOnTable:(id)arg1 named:(id)arg2;
- (bool)_hasIndexNamed:(id)arg1;
- (id)_makeNotificationTelemetryQueryResultFromDatabaseResult:(id)arg1;
