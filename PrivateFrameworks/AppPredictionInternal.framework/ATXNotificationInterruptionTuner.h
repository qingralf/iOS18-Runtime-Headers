...
- (bool)appWithBundleId:(id)arg1 isRecommendedByAllowListModel:(id)arg2;
- (bool)appWithBundleId:(id)arg1 isRecommendedByDenyListModel:(id)arg2;
- (bool)contactWithIdentifier:(id)arg1 isRecommendedByAllowListModel:(id)arg2;
- (bool)contactWithIdentifier:(id)arg1 isRecommendedByDenyListModel:(id)arg2;
