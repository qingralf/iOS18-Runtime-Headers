...
@interface ATXPredictionContext : NSObject <ATXProactiveSuggestionFeedbackContextProtocol, ATXProtoBufWrapper, BMStoreData, NSCopying, NSSecureCoding> {
    ...
    BMUserFocusInferredMode * _inferredModeEvent;
    bool  _isOverridden;
    ...
    BMUserFocusModeComputed * _userFocusComputedModeEvent;
}
...
@property (nonatomic, retain) BMUserFocusInferredMode *inferredModeEvent;
...
@property (nonatomic, retain) BMUserFocusModeComputed *userFocusComputedModeEvent;
