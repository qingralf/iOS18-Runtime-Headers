...
- (void)appLaunchesCalculations:(id)arg1;
...
- (void)computeAverageAndMedianSecondsBetweenAppActions:(id)arg1;
- (void)computeAverageAndMedianSecondsBetweenAppLaunches;
- (void)computeAverageAndMedianSecondsBetweenAppLaunches:(id)arg1;
- (void)dealloc;
