...
- (void)lockScreenBundleIdsWithReply:(id /* block */)arg1;
- (void)logNotificationMetricsFromStartTimestamp:(id)arg1 toEndTimestamp:(id)arg2 withCompletion:(id /* block */)arg3;
