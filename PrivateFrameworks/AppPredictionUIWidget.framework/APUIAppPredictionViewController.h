...
@property (nonatomic, readonly) bool supportsLargeIcons;
...
- (void)_updateEffectiveLargeIconLayoutAnimated:(bool)arg1;
- (void)_updateGridViewForBundleIds:(id)arg1;
- (void)_updateLayoutInGridView:(id)arg1;
- (void)_updateUserInteractingState;
- (id)additionalIconListLayoutObserversForAppIconGridView:(id)arg1;
