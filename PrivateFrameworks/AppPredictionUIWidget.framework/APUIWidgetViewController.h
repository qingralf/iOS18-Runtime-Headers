...
+ (id)imageForIconSize:(struct CGSize { double x1; double x2; })arg1 scale:(double)arg2 appearance:(long long)arg3 tintColor:(id)arg4;
+ (id)smartStackImageForIconSize:(struct CGSize { double x1; double x2; })arg1 scale:(double)arg2;
+ (id)smartStackImageForIconSize:(struct CGSize { double x1; double x2; })arg1 scale:(double)arg2 appearance:(long long)arg3 tintColor:(id)arg4;
