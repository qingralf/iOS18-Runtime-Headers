...
@property (nonatomic, readonly) bool xpcBundle;
...
- (id)endpoints;
- (int)hostPID;
- (id)initWithLabel:(id)arg1 instance:(id)arg2 requestedJetsamPriority:(int)arg3 additionalProperties:(id)arg4 program:(id)arg5 processType:(unsigned int)arg6 keepAlive:(bool)arg7 runAtLoad:(bool)arg8 enableTransactions:(bool)arg9 endpoints:(id)arg10 serviceType:(long long)arg11 path:(id)arg12 xpcBundle:(bool)arg13 hostPID:(int)arg14;
- (id)instance;
- (bool)keepAlive;
- (id)label;
- (id)path;
