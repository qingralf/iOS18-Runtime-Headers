...
- (void).cxx_destruct;
- (id)_initWithIDs:(id)arg1 kind:(id)arg2 context:(id)arg3 clientID:(id)arg4 enableAppDistribution:(bool)arg5 mediaQueryParams:(id)arg6 platformOverride:(id)arg7;
- (id)clientID;
- (id)context;
