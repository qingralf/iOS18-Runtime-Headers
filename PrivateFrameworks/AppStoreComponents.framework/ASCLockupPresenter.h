...
@property (nonatomic, readonly) ASCCustomLockupContentProvider *customContentProvider;
...
- (id)initWithView:(id)arg1 customContentProvider:(id)arg2 offerPresenter:(id)arg3 metricsPresenter:(id)arg4;
- (id)initWithView:(id)arg1 customContentProvider:(id)arg2 offerPresenter:(id)arg3 metricsPresenter:(id)arg4 context:(id)arg5;
- (id)initWithView:(id)arg1 metricsPresenter:(id)arg2;
...
- (void)retryRequestIfNeeded:(id /* block */)arg1;
