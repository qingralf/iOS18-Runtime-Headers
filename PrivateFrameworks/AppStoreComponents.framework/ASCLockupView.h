...
@interface ASCLockupView : UIView <ASCLockupPresenterObserver, ASCLockupProductDetailsObserver, ASCOfferPresenterObserver> {
...
@property (nonatomic, retain) ASCLockupProductDetails *lockupProductDetails;
@property (nonatomic, retain) NSString *lockupSize;
...
@property (nonatomic, retain) NSString *presentingSceneBundleIdentifier;
...
- (void)offerPresenterWillPerformActionOfOffer:(id)arg1 inState:(id)arg2 withActivity:(inout id*)arg3 inContext:(inout id*)arg4 withPaymentSheetView:(id)arg5;
- (id)offerTheme;
...
- (void)setLockupProductDetails:(id)arg1;
- (void)setLockupSize:(id)arg1;
