...
- (void)_lockupFromMediaAPIResponse:(id)arg1 withContext:(id)arg2 completionBlock:(id /* block */)arg3;
- (void)_lockupRequestForBundleID:(id)arg1 withContext:(id)arg2 completionBlock:(id /* block */)arg3;
- (void)_lockupRequestForBundleID:(id)arg1 withContext:(id)arg2 enableAppDistribution:(bool)arg3 completionBlock:(id /* block */)arg4;
