...
+ (id)lockupLayoutOfSize:(id)arg1 traitCollection:(id)arg2 artworkView:(id)arg3 headingText:(id)arg4 titleText:(id)arg5 subtitleText:(id)arg6 offerText:(id)arg7 offerButton:(id)arg8 badge:(id)arg9;
...
+ (id)miniProductPageLayoutWithTraitCollection:(id)arg1 iconArtwork:(id)arg2 title:(id)arg3 subtitle:(id)arg4 metadata:(id)arg5 description:(id)arg6 screenshots:(id)arg7;
+ (struct CGSize { double x1; double x2; })miniProductPagePreferredArtworkSize;
...
+ (id)offerIconLayoutForSize:(id)arg1 imageView:(id)arg2 titleView:(id)arg3 subtitleView:(id)arg4 hasTrailingSubtitle:(bool)arg5 shouldTopAlign:(bool)arg6 topPadding:(double)arg7 shouldTrailingAlign:(bool)arg8;
...
+ (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })rectWithLayoutDirectionForRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 layoutDirection:(long long)arg2 relativeTo:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg3;
