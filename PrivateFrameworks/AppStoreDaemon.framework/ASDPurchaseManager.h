...
- (void)processPurchases:(id)arg1 withResponseHandler:(id /* block */)arg2;
- (void)purchaseBatch:(id)arg1 additionalBuyParams:(id)arg2 withResultHandler:(id /* block */)arg3;
- (void)purchaseBatchWithItemMetadata:(id)arg1 additionalBuyParams:(id)arg2 withResultHandler:(id /* block */)arg3;
