...
- (void)getSubscriptionEntitlementsForSegment:(unsigned long long)arg1 ignoreCaches:(bool)arg2 isBackground:(bool)arg3 requestingBundleId:(id)arg4 withCacheInfoResultHandler:(id /* block */)arg5;
