...
@interface ASOOverlayViewController : UIApplicationRotationFollowingController <ASORemoteOverlayHost, ASORemoteViewControllerDelegate> {
...
- (id)viewServiceQueue;
- (void)willStartPresentingOverlay:(id)arg1 transitionContext:(id)arg2;
