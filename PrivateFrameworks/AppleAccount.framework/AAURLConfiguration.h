...
@property (nonatomic, readonly, copy) NSNumber *homepodSetupiCloudTerms;
...
@property (nonatomic, readonly) NSString *termsReportUserActionURL;
@property (nonatomic, readonly, copy) NSNumber *termsUIType;
...
@property (nonatomic, readonly) NSString *walrusWebAccessPCSAuthURL;
