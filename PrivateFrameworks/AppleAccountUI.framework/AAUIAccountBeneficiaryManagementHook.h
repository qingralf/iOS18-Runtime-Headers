...
- (void).cxx_destruct;
- (void)_showAccountBeneficiaryManagementWithServerAttributes:(id)arg1 completion:(id /* block */)arg2;
- (id)delegate;
- (id)initWithAccountManager:(id)arg1 legacyContactsViewModel:(id)arg2;
