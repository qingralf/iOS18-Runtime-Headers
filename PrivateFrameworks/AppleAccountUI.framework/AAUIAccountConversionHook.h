...
- (void).cxx_destruct;
- (void)_navigateBackToStartWithCompletion:(id /* block */)arg1;
- (void)_signOutAccountsWithAccount:(id)arg1 shouldRemoveAppleAccount:(bool)arg2 viewController:(id)arg3 completion:(id /* block */)arg4;
- (void)_signOutWithAttributes:(id)arg1 completion:(id /* block */)arg2;
- (id)delegate;
...
- (void)signOutPrimaryAccountWithShouldRetainTrust:(bool)arg1 viewController:(id)arg2 completion:(id /* block */)arg3;
