...
- (void)attachAllHandlersWithTelemetryFlowID:(id)arg1;
- (void)attachAuthHandler:(id /* block */)arg1;
- (void)attachBiometricRatchetHandler:(id /* block */)arg1;
- (void)attachDTOBiometryHandler:(id /* block */)arg1;
...
- (id)initWithRemoteUIController:(id)arg1 appleAccount:(id)arg2 hooks:(id)arg3;
