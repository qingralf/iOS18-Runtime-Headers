...
@interface AAUIEDPTokenSpyglassHook : NSObject <RUIServerHook> {
...
- (void).cxx_destruct;
- (void)_launchEDPTokenPane:(id)arg1 completion:(id /* block */)arg2;
- (void)_showEDPTokenPaneWithToken:(id)arg1 onViewController:(id)arg2 sender:(id)arg3 completion:(id /* block */)arg4;
- (id)delegate;
