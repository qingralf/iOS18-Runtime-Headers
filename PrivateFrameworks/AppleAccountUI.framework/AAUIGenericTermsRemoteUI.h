...
- (void)_agreeToTermsWithURLString:(id)arg1 serverInfo:(id)arg2 preferPassword:(bool)arg3 completion:(id /* block */)arg4;
- (id)_authContextForRenewCredentials;
- (void)_cleanUpAndDismissWithSuccess:(bool)arg1 agreeURL:(id)arg2 serverInfo:(id)arg3;
- (void)_cleanupRUILoader;
- (void)_disagreeToTermsWithURLString:(id)arg1 serverInfo:(id)arg2;
