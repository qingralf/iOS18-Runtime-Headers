...
- (bool)_isCachedProfilePictureUpdated:(id)arg1;
...
- (void)_saveProfilePictureToCache:(id)arg1;
- (void)_saveProfilePictureToCacheIfNeeded:(id)arg1;
...
- (void)fetchProfilePictureFromCacheForAccountOwner:(id /* block */)arg1;
...
- (void)updateCacheWithPhoto:(id)arg1 cropRect:(id)arg2 forPersonID:(id)arg3;
