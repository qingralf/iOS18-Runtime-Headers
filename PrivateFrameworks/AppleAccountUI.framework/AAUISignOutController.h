...
@interface AAUISignOutController : UINavigationController <AAUIDataclassPickerViewControllerDelegate> {
    ...
    NSObject<AAUIFinanceKitAdapterProtocol> * _walletOrderChecker;
}
...
@property (nonatomic, retain) NSObject<AAUIFinanceKitAdapterProtocol> *walletOrderChecker;
