...
- (id)grabNextFastPathControlData:(id)arg1;
- (id)grabNextFastPathData:(id)arg1;
- (id)grabNextFastPathMUData:(long long*)arg1;
- (id)grabNextFastPathMUData:(long long*)arg1 metadataID:(id)arg2;
...
- (id)resolvedIMUStreamName:(long long*)arg1 metadataID:(id)arg2;
