...
- (int)renderWithRequest:(id)arg1 requestTo:(id)arg2 mixValue:(float)arg3 destinationColorPixelBuffer:(struct __CVBuffer { }*)arg4 error:(id*)arg5 sceneMonitorUsesDisparityStatistics:(bool)arg6 disparityPostprocessingCompletionHandler:(id /* block */)arg7 mattingCompletionHandler:(id /* block */)arg8 portraitCompletionHandler:(id /* block */)arg9;
