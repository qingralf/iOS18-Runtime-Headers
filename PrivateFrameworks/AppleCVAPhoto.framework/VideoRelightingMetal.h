...
- (void)renderWithSrcImage:(struct __CVBuffer { }*)arg1 srcAlpha:(struct __CVBuffer { }*)arg2 trustAlpha:(bool)arg3 isAfterPreviewStitcher:(bool)arg4 yuvSourceDownsampled:(id)arg5 skinSegmentation:(struct __CVBuffer { }*)arg6 dstImage:(struct __CVBuffer { }*)arg7 faceKitProcessOutput:(id)arg8 portraitStyleStrength:(float)arg9 colorSim:(id)arg10 disparity:(id)arg11 focusDistance:(float)arg12 singleCubeData:(id)arg13 properties:(id)arg14 callbackQueue:(id)arg15 callback:(id /* block */)arg16;
