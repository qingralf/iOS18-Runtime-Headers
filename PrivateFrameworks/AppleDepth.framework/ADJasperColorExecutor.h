...
- (long long)executeWithColor:(struct __CVBuffer { }*)arg1 colorCameraCalibration:(id)arg2 colorWorldToPlatformTransform:(struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; })arg3 pointClouds:(id)arg4 lidarCameraCalibration:(id)arg5 pointCloudWorldToPlatformTransforms:(struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; }*)arg6 outDepthMap:(struct __CVBuffer {}**)arg7 outConfMap:(struct __CVBuffer {}**)arg8 outNormalsMap:(struct __CVBuffer {}**)arg9;
