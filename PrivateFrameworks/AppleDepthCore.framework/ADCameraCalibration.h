...
+ (struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[3]; })createIntrinsicsMatrixWithEflX:(float)arg1 eflY:(float)arg2 principalPointX:(float)arg3 principalPointY:(float)arg4;
