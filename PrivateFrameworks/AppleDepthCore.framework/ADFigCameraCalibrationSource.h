...
+ (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })calcSensorCrop:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 onImageWithDimensions:(struct CGSize { double x1; double x2; })arg2 metadataDictionary:(id)arg3 negativeCropHandling:(long long)arg4;
+ (struct float4x3 { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; })figExtrinsicsToTransform:(id)arg1;
+ (float)getAngularVelocityFromMetadataDictionary:(id)arg1 deviceClock:(double)arg2;
