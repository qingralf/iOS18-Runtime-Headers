...
@interface ADJasperPointCloudFilterParameters : NSObject {
    ...
    unsigned long long  _duplicateProjectedSpotsMode;
...
- (unsigned long long)duplicateProjectedSpotsMode;
...
- (void)setDuplicateProjectedSpotsMode:(unsigned long long)arg1;
