...
+ (id)aggregatePointClouds:(id)arg1 calibrations:(id)arg2 worldToPlatformTransforms:(struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; }*)arg3 projectingToCamera:(id)arg4 worldToPlatformAtProjectionTime:(struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; })arg5;
+ (id)aggregatePointClouds:(id)arg1 pointCloudToPlatformTransforms:(struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; }*)arg2 worldToPlatformTransforms:(struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; }*)arg3 projectingToCamera:(id)arg4 worldToPlatformAtProjectionTime:(struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; })arg5;
