...
+ (struct BaselineTestStats_s { float x1; float x2; float x3; float x4; })compareVImageBuffer:(struct vImage_Buffer { void *x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; })arg1 pixelTypeResult:(unsigned int)arg2 offset:(struct CGSize { double x1; double x2; })arg3 toRefBuffer:(struct vImage_Buffer { void *x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; })arg4 pixelTypeRef:(unsigned int)arg5 ignoreResultZeros:(bool)arg6 ignoreRefZeros:(bool)arg7 outlierPercentile:(float)arg8;
