...
+ (id)getPredictionForUseCase:(id)arg1 treatmentId:(id)arg2 UsingWorkflow:(id)arg3 domainName:(id)arg4 summary:(id)arg5 bigSummary:(id)arg6 errorKey:(id)arg7;
...
+ (id)persist:(id)arg1 withUsecase:(id)arg2 withConfig:(id)arg3 domainName:(id)arg4;
