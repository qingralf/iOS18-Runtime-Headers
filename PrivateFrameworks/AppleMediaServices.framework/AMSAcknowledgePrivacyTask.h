...
+ (bool)_coreAcknowledgementNeededForPrivacyIdentifier:(id)arg1 account:(id)arg2;
+ (bool)_existingAcknowledgements:(id)arg1 containsNewAcknowledgements:(id)arg2;
+ (bool)_isBundleHolderPerDeviceRequirementAppliedToAccount:(id)arg1;
