...
@property (nonatomic, retain) NSString *metricsIdentifier;
@property (nonatomic) unsigned long long multiUserAuthentication;
@property (nonatomic, readonly) NSDictionary *optionsDictionaryForLogging;
...
- (unsigned long long)multiUserAuthentication;
- (id)optionsDictionary;
- (id)optionsDictionaryForLogging;
...
- (void)setMultiUserAuthentication:(unsigned long long)arg1;
...
- (void)setServiceTokenOnly:(bool)arg1;
