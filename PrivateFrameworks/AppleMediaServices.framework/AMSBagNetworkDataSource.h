...
@property (nonatomic, copy) id /* block */ dataSourceChangedHandler; /* unknown property attribute: ? */
@property (nonatomic, copy) id /* block */ dataSourceDataInvalidatedHandler; /* unknown property attribute: ? */
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (nonatomic, retain) NSMutableDictionary *defaultValues;
@property (readonly, copy) NSString *description;
@property (nonatomic, retain) NSString *descriptionExtended; /* unknown property attribute: ? */
...
+ (void)valueForURLVariable:(id)arg1 account:(id)arg2 clientInfo:(id)arg3 completion:(id /* block */)arg4;
...
- (id)loadedValuesForKeys:(id)arg1 outExpirationDate:(id*)arg2;
