...
+ (id)handleResponse:(id)arg1 financeResponse:(id)arg2 session:(id)arg3 taskInfo:(id)arg4;
+ (bool)hasKeysForAccount:(id)arg1 forSignaturePurpose:(unsigned long long)arg2 withError:(id*)arg3;
