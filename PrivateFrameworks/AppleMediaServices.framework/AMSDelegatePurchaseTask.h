...
- (id)_fetchDelegateAuthResultWithRequest:(id)arg1 error:(id*)arg2;
- (id)_finishWithDelegateAuthenticateResult:(id)arg1 resultError:(id)arg2 outError:(id*)arg3;
...
- (void)_provisionWatchBiometricsError:(id*)arg1;
- (bool)_updateBiometricsTokenError:(id*)arg1;
- (id)_urlRequestForDelegateAuthError:(id*)arg1;
