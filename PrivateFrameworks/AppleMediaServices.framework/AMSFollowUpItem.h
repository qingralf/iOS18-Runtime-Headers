...
@property (getter=isExpirationDateHidden, nonatomic) bool expirationDateHidden;
...
@property (getter=isNewDeviceOutreach, nonatomic) bool newDeviceOutreach;
...
- (void)setExpirationDateHidden:(bool)arg1;
...
- (void)setNewDeviceOutreach:(bool)arg1;
