...
+ (bool)_matchSignSapURL:(id)arg1 bagDictionary:(id)arg2;
+ (id)_matchSignedActions:(id)arg1 withURL:(id)arg2;
...
+ (id)signaturePromiseFromData:(id)arg1 type:(long long)arg2 bag:(id)arg3;
+ (id)signaturePromiseFromRequest:(id)arg1 type:(long long)arg2 bag:(id)arg3;
...
+ (id)verificationPromiseForTask:(id)arg1 data:(id)arg2 type:(long long)arg3 bag:(id)arg4;
