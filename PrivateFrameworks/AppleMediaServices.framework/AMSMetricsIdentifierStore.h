...
+ (id)_database;
+ (id)_generateIdentifierKey:(id)arg1 storeInfo:(id)arg2 period:(long long)arg3 resetInterval:(double)arg4;
+ (id)_generateStoreKeyForAccount:(id)arg1 domain:(id)arg2 clientInfo:(id)arg3;
+ (id)_identifierStoreInfoForKeys:(id)arg1 inDatabase:(id)arg2 date:(id)arg3 needsToSync:(bool*)arg4 account:(id)arg5 clientInfo:(id)arg6 domain:(id)arg7 resetInterval:(double)arg8 error:(id*)arg9;
+ (id)_identifierStoreWithAccount:(id)arg1 parameters:(id)arg2;
+ (id)_parametersForBag:(id)arg1 bagNamespace:(id)arg2;
+ (long long)_periodFrom:(double)arg1 storeInfoStarted:(id)arg2 now:(id)arg3;
...
+ (void)removeIdentifiersForStore:(id)arg1;
