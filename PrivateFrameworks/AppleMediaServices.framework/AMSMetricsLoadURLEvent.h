...
@property (getter=isDNUSubmissionAllowed, nonatomic) bool DNUSubmissionAllowed;
...
@property (nonatomic, copy) NSNumber *edgeRelayWasUsed;
...
+ (id)_buildVariant;
+ (id)_edgeRelayWasUsedFor:(id)arg1 domains:(id)arg2;
+ (id)_fetchNetworkQualityReportsPromise;
+ (id)_hostnameFrom:(id)arg1;
+ (id)_isAnEdgeRelayServer:(id)arg1 domains:(id)arg2;
...
+ (id)loadURLEventPromiseWithContext:(id)arg1;
+ (id)loadURLEventWithTopic:(id)arg1 context:(id)arg2;
+ (id)loadURLTopicFromContext:(id)arg1;
+ (bool)shouldCollectMetricsForContext:(id)arg1;
+ (id)shouldCollectMetricsPromiseForContext:(id)arg1;
...
- (id)_prepareEventPromiseWithContext:(id)arg1;
- (id)appleTimingApp;
