...
- (id)_mutableBinaryPromiseWrappingBinaryPromise:(id)arg1;
- (id)_mutablePromiseWrappingPromise:(id)arg1;
- (bool)cancel;
...
- (bool)finishWithResult:(id)arg1 error:(id)arg2 logDuplicateFinishes:(bool)arg3;
