...
@property (nonatomic, readonly) bool asc_isCanceledOrPending;
@property (getter=isCancelled, nonatomic, readonly) bool cancelled;
@property (nonatomic, readonly) AMSPromiseCompletionBlocks *completionBlocks;
@property (nonatomic, readonly) NSCondition *condition;
@property (nonatomic) bool conditionHasSignaled;
@property (getter=isFinished, nonatomic, readonly) bool finished;
@property (nonatomic, readonly) bool isFinishedWithLock;
@property (nonatomic, retain) AMSPromiseResult *promiseResult;
@property (nonatomic, retain) AMSPromise *retainedSelf;
...
+ (id)promiseWithErrorCode:(long long)arg1 title:(id)arg2 message:(id)arg3;
+ (id)promiseWithErrorCode:(long long)arg1 title:(id)arg2 message:(id)arg3 underlyingError:(id)arg4;
...
- (bool)cancel;
- (id)catchWithBinaryPromiseBlock:(id /* block */)arg1;
- (id)catchWithBlock:(id /* block */)arg1;
- (id)completionBlocks;
- (id /* block */)completionHandlerAdapter;
- (id)condition;
- (bool)conditionHasSignaled;
- (id)continueWithBinaryPromiseBlock:(id /* block */)arg1;
...
- (id)init;
- (id)initWithPromiseResult:(id)arg1;
...
- (id)retainedSelf;
- (void)setConditionHasSignaled:(bool)arg1;
- (void)setPromiseResult:(id)arg1;
- (void)setRetainedSelf:(id)arg1;
- (void)stopRetainingSelf;
- (id)thenWithBinaryPromiseBlock:(id /* block */)arg1;
