...
@property (nonatomic) bool didShowPaymentSheet;
...
@property (nonatomic, retain) NSNumber *paymentMethodType;
...
- (void)setDidShowPaymentSheet:(bool)arg1;
...
- (void)setPaymentMethodType:(id)arg1;
