...
@interface AMSSQLiteConnectionOptions : NSObject <NSCopying, NSSecureCoding> {
    ...
    bool  _checkpointingOnCloseDisabled;
...
@property (getter=isCheckpointingOnCloseDisabled, nonatomic) bool checkpointingOnCloseDisabled;
...
- (void).cxx_destruct;
- (bool)applyToDatabase:(struct sqlite3 { }*)arg1 error:(id*)arg2;
- (long long)cacheSize;
...
- (void)setCheckpointingOnCloseDisabled:(bool)arg1;
