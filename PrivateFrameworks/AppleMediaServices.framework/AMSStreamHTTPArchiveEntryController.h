...
+ (id)_createNewFileNameForCombining:(bool)arg1 extension:(id)arg2;
+ (id)_createNewFileWithFileName:(id)arg1 outputDirectory:(id)arg2 error:(id*)arg3;
+ (id)_footerData;
+ (id)_harFileURLsInPath:(id)arg1;
+ (id)_headerData;
+ (void)_moveTemporaryFileURL:(id)arg1 toFinalFileURL:(id)arg2;
