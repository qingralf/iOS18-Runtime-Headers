...
@interface AMSURLRequestEncoder : NSObject <AMSBagConsumer, AMSRequestEncoding> {
    ...
    bool  _alwaysIncludeAuthKitHeaders;
    bool  _alwaysIncludeMMeClientInfoAndDeviceHeaders;
    ...
    bool  _excludeIdentifierHeadersForAccount;
    AMSFairPlayDeviceIdentity * _fairPlayDeviceIdentity;
    <AMSFairPlayDeviceIdentityNetworkProviderProtocol> * _fpdiNetworkProvider;
...
@property (nonatomic, retain) AMSFairPlayDeviceIdentity *fairPlayDeviceIdentity;
@property (nonatomic, retain) <AMSFairPlayDeviceIdentityNetworkProviderProtocol> *fpdiNetworkProvider;
...
- (void).cxx_destruct;
- (id)_addCookiesToRequest:(id)arg1 account:(id)arg2;
...
- (void)setAlwaysIncludeAuthKitHeaders:(bool)arg1;
- (void)setAlwaysIncludeMMeClientInfoAndDeviceHeaders:(bool)arg1;
...
- (void)setExcludeIdentifierHeadersForAccount:(bool)arg1;
- (void)setFairPlayDeviceIdentity:(id)arg1;
- (void)setFpdiNetworkProvider:(id)arg1;
...
- (void)setShouldSetCookieHeader:(bool)arg1;
