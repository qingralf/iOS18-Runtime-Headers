...
@property (nonatomic) bool reducedMemoryMode;
@property (nonatomic) bool signatureResumption;
@property (nonatomic, retain) AMSLRUCache *snapshotCache;
...
- (void)setReducedMemoryMode:(bool)arg1;
