...
- (void).cxx_destruct;
- (id /* block */)_actionBlockForWebButtonModel:(id)arg1;
- (void)_adjustWebViewScrollFor:(id)arg1 completion:(id /* block */)arg2;
- (void)_applyAppearance;
- (id)_buttonModelForBarButtonItemModel:(id)arg1;
- (id)_createBarButtonItemWithModel:(id)arg1 navigationBarModel:(id)arg2;
...
- (id)activeRefresh;
- (id)appearance;
- (void)applyNavigationBarModel:(id)arg1 toNavigationController:(id)arg2 animated:(bool)arg3;
