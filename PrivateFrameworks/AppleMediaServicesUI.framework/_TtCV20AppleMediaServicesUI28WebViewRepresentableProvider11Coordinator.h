...
@interface _TtCV20AppleMediaServicesUI28WebViewRepresentableProvider11Coordinator : NSObject <AMSUIWebDelegate> {
    void edgesPropagatingSafeAreaInsetsToSubviewsObservation;
    void parent;
}
