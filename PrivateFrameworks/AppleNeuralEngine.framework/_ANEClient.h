...
- (bool)doLoadModelNewInstance:(id)arg1 options:(id)arg2 modelInstParams:(id)arg3 qos:(unsigned int)arg4 error:(id*)arg5;
...
- (bool)loadModelNewInstance:(id)arg1 options:(id)arg2 modelInstParams:(id)arg3 qos:(unsigned int)arg4 error:(id*)arg5;
...
- (void)reportEvaluateFailure:(id)arg1 failureReason:(unsigned int)arg2 qIdx:(unsigned long long)arg3;
