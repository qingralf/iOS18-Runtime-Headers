...
+ (id)baseModelIdentifierNotFoundForNewInstanceMethod:(id)arg1;
...
+ (id)hostTooOld:(id)arg1;
+ (id)invalidModelErrorForMethod:(id)arg1;
+ (id)invalidModelInstanceErrorForMethod:(id)arg1;
+ (id)invalidModelKeyErrorForMethod:(id)arg1;
+ (id)missingCodeSigningErrorForMethod:(id)arg1;
+ (id)modelIdentifierNotFoundForMethod:(id)arg1;
+ (id)modelNewInstanceCacheIdentifierNotNilMethod:(id)arg1;
...
+ (id)programInferenceProgramNotFoundForMethod:(id)arg1;
+ (id)programLoadErrorForMethod:(id)arg1;
+ (id)programLoadErrorForMethod:(id)arg1 code:(long long)arg2;
+ (id)programLoadNewInstanceErrorForMethod:(id)arg1;
+ (id)programLoadNewInstanceErrorForMethod:(id)arg1 code:(long long)arg2;
