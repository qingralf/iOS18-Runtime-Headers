...
- (id)initWithModelAtURL:(id)arg1 sourceURL:(id)arg2 UUID:(id)arg3 key:(id)arg4 identifierSource:(long long)arg5 cacheURLIdentifier:(id)arg6 modelAttributes:(id)arg7 standardizeURL:(bool)arg8 string_id:(unsigned long long)arg9 generateNewStringId:(bool)arg10;
