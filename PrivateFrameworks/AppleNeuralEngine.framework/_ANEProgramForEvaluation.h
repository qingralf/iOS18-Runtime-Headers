...
- (bool)processRequest:(id)arg1 model:(id)arg2 qos:(unsigned int)arg3 qIndex:(unsigned long long)arg4 modelStringID:(unsigned long long)arg5 options:(id)arg6 returnValue:(unsigned int*)arg7 error:(id*)arg8;
