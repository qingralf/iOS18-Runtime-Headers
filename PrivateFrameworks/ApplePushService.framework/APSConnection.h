...
- (void)_addUltraConstrainedTopicsToXPCMessage:(id)arg1;
...
- (void)_onIvarQueue_setPushWakeTopics:(id)arg1;
- (void)_onIvarQueue_setUltraConstrainedTopics:(id)arg1;
...
- (void)rollBAACertsWithCompletion:(id /* block */)arg1;
...
- (void)setUltraConstrainedTopics:(id)arg1;
- (void)setUsesAppLaunchStats:(bool)arg1;
- (void)shutdown;
- (void)signDataWithDeviceIdentity:(id)arg1 withCompletion:(id /* block */)arg2;
