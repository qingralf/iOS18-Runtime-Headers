...
@interface ASTTestResult : ASTSealablePayload <NSSecureCoding> {
    ...
    NSNumber * _testId;
    ASTUploadFilesResult * _uploadFiles;
}
...
@property (nonatomic, retain) ASTUploadFilesResult *uploadFiles;
...
- (void)setUploadFiles:(id)arg1;
- (void)setUploadStatusFromSource:(id)arg1 withArray:(id)arg2;
- (id)statusCode;
- (double)testDuration;
- (id)testId;
- (id)uploadFiles;
