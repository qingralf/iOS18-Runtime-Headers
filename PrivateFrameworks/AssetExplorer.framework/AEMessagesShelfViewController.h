...
@interface AEMessagesShelfViewController : UIViewController <AEMessagesShelfLayoutDelegate, AEPluginEntryViewController, CKPluginEntryViewController, GPImageEditionViewControllerDelegate, PUAssetExplorerReviewScreenViewControllerDelegate, PXAssetsSceneDelegate, PXChangeObserver, PXReusableObjectPoolDelegate, PXScrollViewControllerObserver, PXTileSource, PXTilingControllerScrollDelegate, PXTilingControllerTransitionDelegate, UIGestureRecognizerDelegate> {
    ...
    NSString * _editingGeneratedPackageIdentifier;
...
@property (nonatomic, retain) NSString *editingGeneratedPackageIdentifier;
@property (nonatomic) <CKPluginEntryViewControllerDelegate> *entryViewDelegate; /* unknown property attribute: ? */
@property (readonly) unsigned long long hash;
@property (readonly) bool loadedContentView; /* unknown property attribute: ? */
@property (nonatomic, retain) PUAssetExplorerReviewScreenViewController *presentedReviewController;
@property (readonly) Class superclass;
@property (readonly) bool wantsClearButton; /* unknown property attribute: ? */
@property (readonly) bool wantsEdgeToEdgeLayout; /* unknown property attribute: ? */

- (void).cxx_destruct;
- (id)_currentAssetsDataSource;
- (id)_dataSource;
- (void)_didTapGenerationButton:(id)arg1;
...
- (void)dealloc;
- (id)editingGeneratedPackageIdentifier;
- (id)entryViewDelegate;
- (id)framesOfVisibleContentViewInCoordinateSpace:(id)arg1;
- (bool)gestureRecognizerShouldBegin:(id)arg1;
- (void)handleTap:(id)arg1;
- (void)imageEditionViewControllerDidCancel:(id)arg1 requiresShowingGrid:(bool)arg2;
- (void)imageEditionViewControllerDidFinishEditing:(id)arg1 error:(id)arg2;
...
- (long long)layout:(id)arg1 generationStateForItemAtIndexPath:(struct PXSimpleIndexPath { long long x1; long long x2; long long x3; long long x4; })arg2;
...
- (void)setEditingGeneratedPackageIdentifier:(id)arg1;
