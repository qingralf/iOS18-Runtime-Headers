...
- (void)_addItemsForAceViews:(id)arg1 withDialogPhase:(id)arg2 fromCommandWithIdentifier:(id)arg3 asChildrenOfItemWithIdentifier:(id)arg4 isSupplemental:(bool)arg5 isImmersiveExperience:(bool)arg6 isPersistentAcrossInvocations:(bool)arg7;
- (void)_addItemsForAceViews:(id)arg1 withDialogPhase:(id)arg2 fromCommandWithIdentifier:(id)arg3 atIndexPaths:(id)arg4;
- (void)_addItemsForAceViews:(id)arg1 withDialogPhase:(id)arg2 fromCommandWithIdentifier:(id)arg3 atIndexPaths:(id)arg4 isSupplemental:(bool)arg5 isImmersiveExperience:(bool)arg6 isPersistentAcrossInvocations:(bool)arg7;
