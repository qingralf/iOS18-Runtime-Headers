...
@property (getter=isPersistentAcrossInvocations, nonatomic) bool persistentAcrossInvocations;
...
- (id)initWithIdentifier:(id)arg1 type:(long long)arg2 aceObject:(id)arg3 dialogPhase:(id)arg4 presentationState:(long long)arg5 aceCommandIdentifier:(id)arg6 virgin:(bool)arg7 transient:(bool)arg8 supplemental:(bool)arg9 immersiveExperience:(bool)arg10 persistentAcrossInvocations:(bool)arg11 associatedDataStore:(id)arg12;
