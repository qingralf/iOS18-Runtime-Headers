...
- (bool)_defaultMultilingualResponseEnabledForLanguage:(id)arg1;
...
- (void)getConversationAwarenessForCurrentlyRoutedDeviceWithCompletion:(id /* block */)arg1;
- (void)getExperimentForConfigurationIdentifier:(id)arg1 completion:(id /* block */)arg2;
- (void)getHeadGesturesForCurrentlyRoutedDeviceWithCompletion:(id /* block */)arg1;
...
- (void)getPersonalVolumeForCurrentlyRoutedDeviceWithCompletion:(id /* block */)arg1;
...
- (id)languageCode;
- (bool)lastAnnouncementInThreadWasCancelledForApp:(id)arg1 threadID:(id)arg2;
...
- (void)markLastAnnouncementInThreadAsCancelledForApp:(id)arg1 threadID:(id)arg2;
- (bool)mediaPlaybackEnabled;
- (bool)multilingualResponseEnabledForLanguage:(id)arg1;
...
- (void)removeThreadCancellationForApp:(id)arg1 threadID:(id)arg2;
...
- (void)setBluetoothPreferredCarAudioRoute:(id)arg1;
...
- (void)setDeviceUnlockSignal:(bool)arg1;
...
- (void)setLongLivedIdentifierUploadingEnabled:(bool)arg1;
...
- (void)setMultilingualResponseEnabled:(bool)arg1 forLanguage:(id)arg2;
...
- (void)setShouldSkipIntelligenceVoiceSelectionUpsell:(bool)arg1;
...
- (void)setSiriAccessibilityBargeInEnabled:(bool)arg1;
...
- (void)setStoredHeadGestureConfigurationForDevice:(id)arg1;
...
- (void)setUseAtypicalSpeechModel:(bool)arg1;
