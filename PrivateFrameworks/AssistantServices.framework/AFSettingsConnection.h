...
- (void)_isInactiveDeviceSyncDisabled:(id /* block */)arg1;
- (void)_isInactiveDeviceSyncDisabledByTrial:(id /* block */)arg1;
...
- (void)areSiriSAEAssetsAvailable:(id /* block */)arg1;
- (void)areSiriUODAssetsAvailable:(id /* block */)arg1;
...
- (oneway void)fetchCurrentlyRoutedHeadphonesCBUUIDWithCompletion:(id /* block */)arg1;
...
- (void)fetchSharedUserIdentifier:(id /* block */)arg1;
...
- (oneway void)getAccessoryInfoForAccessoryWithUUID:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)getConversationAwarenessForCurrentlyRoutedDevice:(id /* block */)arg1;
...
- (void)getHeadGesturesForCurrentlyRoutedDevice:(id /* block */)arg1;
...
- (void)getMultiUserCompanionInfo:(id /* block */)arg1;
- (void)getODDDeviceProperties:(id /* block */)arg1;
...
- (void)getSidekickBoostsFileWithCompletion:(id /* block */)arg1;
...
- (void)getTrialEnables:(id)arg1 doubleFactors:(id)arg2 withCompletion:(id /* block */)arg3;
...
- (void)isSearchDataSharingStatusForced:(id /* block */)arg1;
- (void)isVoiceTriggerEnabled:(id /* block */)arg1;
- (void)killDaemon;
...
- (void)setConversationAwarenessForCurrentlyRoutedDevice:(bool)arg1 withCompletion:(id /* block */)arg2;
...
- (void)setHeadGesturesForCurrentlyRoutedDevice:(bool)arg1 withCompletion:(id /* block */)arg2;
...
- (void)setPersonalVolumeForCurrentlyRoutedDevice:(bool)arg1 withCompletion:(id /* block */)arg2;
- (void)setRecognizeMyVoiceEnabled:(bool)arg1;
- (void)setSearchQueriesDataSharingStatus:(long long)arg1 completion:(id /* block */)arg2;
...
- (void)setVoiceTriggerEnabled:(bool)arg1 withCompletion:(id /* block */)arg2;
