...
@property (nonatomic, retain) NSString *connectedBTProductID;
...
- (id)btAddress;
- (id)connectedBTProductID;
- (id)copyWithZone:(struct _NSZone { }*)arg1;
- (bool)hasAuthenticationCapability;
- (unsigned long long)hash;
- (id)initWithRouteDescription:(id)arg1 hearingAidsAnnounceEnabled:(bool)arg2 builtInSpeakerAnnounceEnabled:(bool)arg3 ringerSwitchState:(long long)arg4;
...
- (void)setConnectedBTProductID:(id)arg1;
