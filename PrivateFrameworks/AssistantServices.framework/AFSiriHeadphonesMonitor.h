...
@interface AFSiriHeadphonesMonitor : NSObject <AFDeviceRingerSwitchListening, AFNotifyObserverDelegate, AFSettingsDelegate> {
    NSString * _btAddress;
...
- (void)initializeAVSystemControllerSubscriptions:(id)arg1;
