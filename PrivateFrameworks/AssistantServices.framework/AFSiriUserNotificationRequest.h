...
- (void)deliverSummary:(id)arg1 completion:(id /* block */)arg2;
...
- (id)initWithUserNotification:(id)arg1 sourceAppId:(id)arg2 platform:(long long)arg3 summaryDecision:(long long)arg4;
- (id)initWithUserNotification:(id)arg1 sourceAppId:(id)arg2 platform:(long long)arg3 summaryDecision:(long long)arg4 summary:(id)arg5;
