...
@property (nonatomic, copy) NSDictionary *raiseToSpeakEventInfo;
...
@property (nonatomic, copy) SCDAContext *scdaContext;
...
- (void)setRaiseToSpeakEventInfo:(id)arg1;
