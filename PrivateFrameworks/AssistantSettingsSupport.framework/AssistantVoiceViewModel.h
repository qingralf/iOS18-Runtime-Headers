...
@interface AssistantVoiceViewModel : NSObject {
    ...
    NSString * _selectedLanguageBaseLocale;
...
@property (nonatomic, copy) NSString *selectedLanguageBaseLocale;
...
- (void)setSelectedLanguageBaseLocale:(id)arg1;
