...
@interface AFUISiriCompactView : UIView <AFUIPasscodeContainerViewDelegate, AFUISiriContent, AFUITouchInputViewDelegate, SUICEdgeLightController, SUICOrbViewControlling, SiriUIBackgroundBlurViewControllerDelegate, UIGestureRecognizerDelegate> {
...
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 compactViewDelegate:(id)arg2 edgeLightViewProvider:(id)arg3 showsSensitiveUI:(bool)arg4;
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 eyesFreeMode:(long long)arg2 edgeLightViewProvider:(id)arg3 showsSensitiveUI:(bool)arg4;
