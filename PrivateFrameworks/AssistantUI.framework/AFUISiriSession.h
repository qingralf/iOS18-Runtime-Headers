...
@interface AFUISiriSession : NSObject <AFAssistantUIService, AFSpeechDelegate, AFUISiriSession, SRUIFAudioPowerLevelUpdaterDelegate, SRUIFSiriSessionStateHandlerDelegate, SRUIFSpeechRequestHandlerDelegate, SRUIFStateFeedbackManagerDelegate, SRUIFUIBridgeClientDelegate> {
    ...
    <SRUIFSiriStateResponding> * _visualIntelligenceCameraDelegate;
...
@property (nonatomic) <SRUIFSiriStateResponding> *visualIntelligenceCameraDelegate;
...
- (id)_getMissingAssetTypes:(id)arg1;
...
- (void)_handleUnlockAppCommand:(id)arg1 completion:(id /* block */)arg2;
...
- (id)_processInstrumentationForFinalOptionsAndGenerateNewTurn:(id)arg1;
- (void)_requestDidFinishWithError:(id)arg1;
- (void)_requestStartedWithInfo:(id)arg1;
...
- (bool)_shouldRetainConnectionForRequestSource:(long long)arg1;
...
- (void)_startQuickTypeTamaleRequestWith:(id)arg1 completion:(id /* block */)arg2;
...
- (void)emitSiriWasUnavailableEventWithRequestOptions:(id)arg1;
- (void)end;
...
- (id)initWithConnection:(id)arg1 delegateQueue:(id)arg2 requestSource:(long long)arg3;
- (bool)isEyesFree;
- (bool)isListening;
...
- (void)orchestrationBeganTaskWithIdentifier:(id)arg1;
...
- (void)receivedLatencyInformation:(id)arg1;
...
- (void)requestPhotoSelectionWithSearchString:(id)arg1 completion:(id /* block */)arg2;
...
- (void)setVisualIntelligenceCameraDelegate:(id)arg1;
...
- (id)visualIntelligenceCameraDelegate;
