...
@interface AFUISiriViewController : UIViewController <AFUINetworkAvailabilityStateMachineDelegate, AFUISiriCompactViewDelegate, AFUISiriContentDelegate, AFUISiriRemoteSceneViewControllerDataSource, AFUISiriRemoteSceneViewControllerDelegate, AFUISiriSessionLocalDataSource, AFUISiriSessionLocalDelegate, AFUISiriTapPanDismissalPolicyManagerDelegate, AFUISiriViewDataSource, AFUISiriViewDelegate, SRUIFDelayedActionCommandCacheDelegate, SiriSharedUITamaleViewDelegate, SiriUIAudioRoutePickerControllerDelegate, SiriUIKeyboardViewDelegate, SiriUIPresentationRemoteControlling> {
    ...
    <AFUISiriEdgelightViewProvider> * _edgeLightViewProvider;
    bool  _eyesFree;
    ...
    bool  _isSceneHostingVisualIntelligence;
    struct { 
        bool enabled; 
        bool minimized; 
        bool hasBeenShown; 
    ...
    bool  _shouldPlaceEffectsWindowOnTopOfSiriWindow;
    ...
    bool  _tamaleLaunchAnimationDidFinish;
    SiriSharedUITamaleView * _tamaleView;
    bool  _tamaleViewWaitingForPresentation;
    ...
    bool  _visible;
    NSTimer * _visualIntelligenceAutolockTimer;
...
@property (nonatomic) <AFUISiriEdgelightViewProvider> *edgeLightViewProvider;
...
@property (nonatomic) bool isSceneHostingVisualIntelligence;
...
@property (nonatomic, readonly) bool shouldPlaceEffectsWindowOnTopOfSiriWindow;
...
@property (getter=supportsCarPlayVehicleData, setter=setSupportsCarPlayVehicleData:, nonatomic) bool supportsCarPlayVehicleData;
...
@property (nonatomic, retain) NSTimer *visualIntelligenceAutolockTimer;
...
- (void)_dismissWithReason:(long long)arg1;
...
- (void)_handlePasscodeUnlockAndCancelRequest:(bool)arg1 dismissOnFailure:(bool)arg2 passcodeUnlockClient:(unsigned long long)arg3 withCompletion:(id /* block */)arg4;
...
- (double)_homeGestureFractionCompleteFromCurrentYPosition:(double)arg1 yPositionAtCompletion:(double)arg2;
...
- (void)_performTamaleTransitionWithLayer:(id)arg1;
...
- (void)animateOrbViewToOffIfNecessaryWithCompletion:(id /* block */)arg1;
...
- (bool)compactViewShouldShowDebugButton:(id)arg1;
...
- (void)handleAppUnlockForAppId:(id)arg1 withCompletion:(id /* block */)arg2;
...
- (id)initWithConnection:(id)arg1 configuration:(id)arg2 requestSource:(long long)arg3 displayConfiguration:(id)arg4 edgeLightViewProvider:(id)arg5 instrumentationHandler:(id)arg6;
...
- (void)noteFluidDismissalCompletedWithSuccess:(bool)arg1;
...
- (void)setEdgeLightViewProvider:(id)arg1;
...
- (void)setIsSceneHostingVisualIntelligence:(bool)arg1;
...
- (void)setVisualIntelligenceAutolockTimer:(id)arg1;
...
- (void)showPasscodeUnlockScreenForRequest:(id)arg1 passcodeUnlockClient:(unsigned long long)arg2 unlockCompletion:(id /* block */)arg3;
...
- (void)siriRemoteViewController:(id)arg1 inputTypeDidChange:(long long)arg2;
...
- (void)siriRemoteViewController:(id)arg1 willChangeKeyboardVisibility:(bool)arg2;
...
- (void)siriSession:(id)arg1 didReceiveAppUnlockRequestForAppId:(id)arg2 withCompletion:(id /* block */)arg3;
...
- (void)siriWasPresented:(long long)arg1;
...
- (void)tamaleViewRequestsAuthenticationWithCompletion:(id /* block */)arg1;
- (void)tapPanDismissalPolicyManager:(id)arg1 dismissalPolicyDidChange:(bool)arg2;
- (void)telephonyRequestCompleted;
- (void)toggleHomeAffordanceHidden:(bool)arg1;
- (void)toggleSiriHomeAffordanceGestureControl:(bool)arg1;
...
- (void)updatePresentationVisualState:(unsigned long long)arg1;
...
- (void)visionIntelligenceDropletLaunchAnimationDidFinish:(bool)arg1 retargeted:(bool)arg2;
- (id)visualIntelligenceAutolockTimer;
