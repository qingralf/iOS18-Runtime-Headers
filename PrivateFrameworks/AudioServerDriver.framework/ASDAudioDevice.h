...
@property (nonatomic, copy) NSString *configurationBundleID;
...
- (void)abortConfigurationChange:(void*)arg1;
...
- (unsigned int)channelLayoutBitmapForScope:(unsigned int)arg1;
- (unsigned int)channelLayoutTagForScope:(unsigned int)arg1;
- (id)clientDescription;
- (unsigned int)clockAlgorithm;
- (unsigned int)clockDomain;
- (bool)clockIsStable;
- (id)configurationBundleID;
...
- (int)performStartIO;
- (int)performStopIO;
- (void)preferredChannelDescriptions:(struct AudioChannelDescription { unsigned int x1; unsigned int x2; float x3[3]; }*)arg1 numberOfChannels:(unsigned int)arg2 forScope:(unsigned int)arg3;
...
- (double)samplingRate;
- (id)samplingRates;
- (void)setAllowAutoRoute:(bool)arg1;
...
- (void)setConfigurationBundleID:(id)arg1;
...
- (void)setWantsDisplayRouting:(bool)arg1;
