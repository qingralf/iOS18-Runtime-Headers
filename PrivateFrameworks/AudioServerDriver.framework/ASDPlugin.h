...
@interface ASDPlugin : ASDObject <ASDDeviceConfigurationChangeDelegate, ASDPropertyChangedDelegate, ASDTDeviceManagerDelegate> {
...
- (unsigned int)addRef;
- (void)addStreamRealTimeOperations:(id)arg1;
...
- (id)init;
- (unsigned int)maximumNumberOfObjects;
...
- (void)removeStreamRealTimeOperations:(id)arg1;
- (bool)requestConfigurationChangeForDevice:(id)arg1 withBlock:(id /* block */)arg2;
- (void)setArray:(id)arg1 forKey:(id)arg2;
- (void)setDictionary:(id)arg1 forKey:(id)arg2;
- (void)setMaximumNumberOfObjects:(unsigned int)arg1;
...
- (id)objectIDsForDeviceUIDs:(id)arg1;
