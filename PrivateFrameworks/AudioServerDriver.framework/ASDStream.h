...
@interface ASDStream : ASDObject {
    ...
    id /* block */  _readIsolatedInputBlock;
...
@property (nonatomic, copy) id /* block */ readIsolatedInputBlock;
@property (nonatomic, readonly) id /* block */*readIsolatedInputBlockUnretainedPtr;
...
- (id)physicalFormat;
- (id)physicalFormats;
- (void)preferredChannelDescription:(struct AudioChannelDescription { unsigned int x1; unsigned int x2; float x3[3]; }*)arg1 forChannelIndex:(unsigned int)arg2;
...
- (id /* block */*)readIsolatedInputBlockUnretainedPtr;
...
- (void)setReadIsolatedInputBlock:(id /* block */)arg1;
