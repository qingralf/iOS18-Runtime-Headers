...
+ (bool)allowAppToInitiatePlaybackTemporarily:(id)arg1 error:(id*)arg2;
+ (bool)appleTVSupportsEnhanceDialogue;
+ (bool)currentRouteSupportsEnhanceDialogue:(id*)arg1;
+ (bool)getEnhanceDialogueLevel:(long long*)arg1 error:(id*)arg2;
+ (bool)iosDeviceSupportsEnhanceDialogue;
+ (id)muteRunningInputs:(id*)arg1;
+ (void)requestMicrophoneInjectionPermissionWithCompletionHandler:(id /* block */)arg1;
+ (void)requestRecordPermissionWithCompletionHandler:(id /* block */)arg1;
+ (bool)setEnhanceDialogueLevel:(long long)arg1 error:(id*)arg2;
+ (bool)setEnhanceDialoguePreference:(long long)arg1 error:(id*)arg2;
+ (id)sharedInstance;
...
- (bool)isInputMuted;
- (long long)microphoneInjectionPermission;
