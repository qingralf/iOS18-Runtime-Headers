...
@interface AVAudioSession : NSObject <PXAVAudioSession> {
    void * _impl;
}
...
@property (nonatomic, readonly) long long photosAudioSessionCategory;
...
- (id)IOController;
- (struct shared_ptr<const as::client::api_utils::ServerAccessor> { struct ServerAccessor {} *x1; struct __shared_weak_count {} *x2; })accessor;
...
- (void)addToCache:(id)arg1 value:(id)arg2;
...
- (struct AVAudioSessionImplAtomic { struct AVAudioSessionImpl {} *x1; })atomicImpl;
- (id)audioClockDevice;
...
- (id)availableModes;
- (id)availableOutputs;
- (unsigned long long)availableRouteControlOptions:(id*)arg1;
- (id)cachedPropertyValue:(id)arg1;
- (id)category;
...
- (long long)getCachedOrFromServerReporterID:(const void*)arg1;
...
- (void)handleDeferredMessage:(id)arg1 userInfo:(id)arg2;
...
- (id)initSiblingSession:(unsigned int)arg1 auditToken:(struct { unsigned int x1[8]; })arg2 clientIdentifier:(id)arg3 autoReconnect:(bool)arg4;
- (id)initWithIsolatedAudioUseCaseID:(unsigned int)arg1;
- (id)initWithSessionID:(unsigned int)arg1;
- (id)initWithSessionType:(unsigned long long)arg1;
- (id)initWithSiriEndpointIdentifier:(id)arg1;
- (id)initWithSpecification:(id)arg1;
- (void)initializeAVOutputContextObject:(id)arg1 updateCache:(bool)arg2;
- (id)inputDataSource;
- (id)inputDataSources;
- (float)inputGain;
...
- (bool)privateCreateSessionInServerUsingXPC:(void*)arg1;
- (void)privateDispatchPing:(const void*)arg1;
- (id)privateGetCategory:(const void*)arg1;
- (id)privateGetCurrentRoute:(const void*)arg1;
- (id)privateGetDataSources:(bool)arg1 accessor:(const void*)arg2;
- (struct sync_guard<AVAudioSessionImpl, caulk::mach::unfair_recursive_lock> { struct unfair_recursive_lock {} *x1; struct value_holder<AVAudioSessionImpl> { struct AVAudioSessionImpl {} *x_2_1_1; } x2; })privateGetGuardOfImplementation;
- (bool)privateGetInputAvailable:(const void*)arg1;
- (id)privateGetRouteControlConfigWithDictionaryKey:(id)arg1 withFeaturesKey:(id)arg2;
- (unsigned long long)privateGetRouteSharingPolicy:(const void*)arg1;
- (id)privateGetSelectedDataSource:(bool)arg1 accessor:(const void*)arg2;
- (unsigned int)privateGetSessionID;
- (void)privateHandleAVOutputContextOutputDeviceChange:(id)arg1;
- (void)privateHandleAVOutputContextOutputDevicesChange:(id)arg1;
- (void)privateHandleActiveNeroVisualStreamInfoDidChange;
- (void)privateHandleAudioHardwareFormatChange;
- (void)privateHandleAvailableSampleRatesChange:(const void*)arg1;
- (void)privateHandleBadgeTypeChange:(id)arg1;
- (void)privateHandleBeaconBudgetChange:(id)arg1 accessor:(const void*)arg2;
...
- (void)privateHandleMicrophoneInjectionCapabilityChange:(id)arg1 accessor:(const void*)arg2;
- (void)privateHandleOtherPrimaryAudioPlayStateChange:(const void*)arg1;
- (void)privateHandlePickableRoutesChange:(const void*)arg1;
- (void)privateHandlePing;
- (void)privateHandlePrefersConcurrentAirPlayAudioChange:(id)arg1 accessor:(const void*)arg2;
- (void)privateHandleRenderingCapabilitiesChange:(const void*)arg1;
- (void)privateHandleRouteControlFeaturesChange:(id)arg1 accessor:(const void*)arg2;
- (void)privateHandleRoutingContextChange:(const void*)arg1;
- (void)privateHandleSecondaryAudioHintChange:(id)arg1 accessor:(const void*)arg2;
- (bool)privateHandleWatchOSActivationAfterRoutePickerSelection:(unsigned long long)arg1 options:(unsigned long long)arg2 error:(id*)arg3 accessor:(const void*)arg4;
- (void)privateInputIsAvailableChanged:(bool)arg1;
- (void)privateInputMuteWithInfo:(id)arg1 accessor:(const void*)arg2;
- (void)privateInterruptionWithInfo:(id)arg1 accessor:(const void*)arg2;
- (bool)privateIsActive:(const void*)arg1;
- (id)privateMakePreferredPersistentRouteDictWithInputUIDs:(id)arg1 outputUIDs:(id)arg2;
- (bool)privateNeedsTranslationForNoSpeakerCategory:(id)arg1 accessor:(const void*)arg2;
- (void)privatePostNotificationForType:(unsigned long long)arg1 name:(id)arg2 userInfo:(id)arg3 accessor:(const void*)arg4;
...
- (bool)privateRequiresWatchOSRoutePicker:(unsigned long long)arg1 accessor:(const void*)arg2;
- (void)privateResetCachedPropertyValues:(const void*)arg1;
- (bool)privateSetActive:(bool)arg1 withOptions:(unsigned long long)arg2 error:(id*)arg3 accessor:(const void*)arg4;
- (int)privateSetCategoryWithOptions:(id)arg1 modes:(id)arg2 routeSharingPolicy:(unsigned long long)arg3 options:(unsigned long long)arg4 accessor:(const void*)arg5;
- (bool)privateSetPrefersInterruptionOnRouteDisconnect:(bool)arg1 accessor:(const void*)arg2;
- (bool)privateSetRouteSharingPolicy:(unsigned long long)arg1 error:(id*)arg2;
- (unsigned char)privateShouldSubscribeToMicrophoneInjectionCapabilityChangeNotification;
...
- (void)registerPublishingSessionNotifications:(id)arg1;
- (oneway void)release;
...
- (bool)setPreferredAudioFormat:(long long)arg1 error:(id*)arg2;
...
- (bool)setPreferredMicrophoneInjectionMode:(long long)arg1 error:(id*)arg2;
...
- (bool)setPreferredRouteControlConfig:(id)arg1 error:(id*)arg2;
- (bool)setPreferredSampleRate:(double)arg1 error:(id*)arg2;
- (bool)setPrefersAggressiveCaching:(bool)arg1 error:(id*)arg2;
- (bool)setPrefersConcurrentAirPlayAudio:(bool)arg1 error:(id*)arg2;
- (bool)setPrefersEchoCancelledInput:(bool)arg1 error:(id*)arg2;
...
- (bool)rc_configureSession:(struct _RCAudioSessionConfiguration { id x1; id x2; unsigned long long x3; unsigned long long x4; })arg1 error:(id*)arg2;
