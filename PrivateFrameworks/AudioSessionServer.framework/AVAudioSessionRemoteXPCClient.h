...
- (id).cxx_construct;
- (void).cxx_destruct;
- (void)activateSession:(unsigned int)arg1 options:(unsigned long long)arg2 deviceInfo:(id)arg3 requestID:(unsigned long long)arg4 reply:(id /* block */)arg5;
- (void)addMXNotificationListener:(unsigned int)arg1 notificationName:(id)arg2 reply:(id /* block */)arg3;
- (void)allowAppToInitiatePlaybackTemporarilyFromBackground:(id)arg1 reply:(id /* block */)arg2;
- (id)clientRelay;
...
- (void)createSession:(unsigned long long)arg1 sourceAuditToken:(struct { unsigned int x1[8]; })arg2 sourceSessionID:(unsigned int)arg3 nameOrDeviceUID:(id)arg4 clientProcessName:(id)arg5 useCaseIdentifier:(unsigned int)arg6 reply:(id /* block */)arg7;
- (void)deactivateSession:(unsigned int)arg1 options:(unsigned long long)arg2 priority:(id)arg3 requestID:(unsigned long long)arg4 reply:(id /* block */)arg5;
- (void)dealloc;
...
- (void)getEnhanceDialogueLevelWithReply:(id /* block */)arg1;
...
- (void)setEnhanceDialogueLevel:(id)arg1 reply:(id /* block */)arg2;
- (void)setEnhanceDialoguePreference:(id)arg1 reply:(id /* block */)arg2;
...
- (void)setProperties:(unsigned int)arg1 values:(id)arg2 MXProperties:(bool)arg3 batchStrategy:(int)arg4 genericMXPipe:(bool)arg5 reply:(id /* block */)arg6;
- (void)setSession:(unsigned int)arg1 decoupledInput:(bool)arg2 hasIOEventListeners:(bool)arg3 reply:(id /* block */)arg4;
- (void)setSessionPlayState:(unsigned int)arg1 playState:(unsigned int)arg2 playerType:(unsigned int)arg3 playerRef:(id)arg4 modes:(unsigned int)arg5 reply:(id /* block */)arg6;
...
- (void)updateMicrophonePermission:(long long)arg1 reply:(id /* block */)arg2;
