...
- (struct tuple<int, id<NSSecureCoding>> { struct __tuple_impl<std::__tuple_indices<0, 1>, int, id<NSSecureCoding>> { int x_1_1_1; id x_1_1_2; } x1; })getMXSessionProperty:(id)arg1 forSessionID:(unsigned int)arg2;
...
- (int)setMXSessionProperty:(id)arg1 forSessionID:(unsigned int)arg2 value:(id)arg3;
