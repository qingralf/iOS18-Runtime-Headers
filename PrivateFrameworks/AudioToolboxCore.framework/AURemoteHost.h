...
@interface AURemoteHost : NSObject <AUAudioUnitXPCProtocol> {
    ...
    struct unique_ptr<XOSTransactor, std::default_delete<XOSTransactor>> { 
        struct __compressed_pair<XOSTransactor *, std::default_delete<XOSTransactor>> { 
            struct XOSTransactor {} *__value_; 
        } __ptr_; 
    }  _transactorIO;
...
@property (nonatomic) bool localCachingDisabled;
...
- (id)initWithConnection:(id)arg1 config:(id)arg2;
- (id)initWithConnection:(id)arg1 config:(id)arg2 timeOutHandler:(struct function<void ()>={__value_func<void ()>={type=[24C] {})arg3;
- (void)initialize:(unsigned long long)arg1 reply:(id /* block */)arg2;
- (void)loadUserPresets:(id /* block */)arg1;
- (bool)localCachingDisabled;
- (void)localCachingDisabled:(bool)arg1 newValue:(bool)arg2 reply:(id /* block */)arg3;
...
- (void)retrieveInstanceUUID:(id /* block */)arg1;
...
- (void)setLocalCachingDisabled:(bool)arg1;
