...
- (id)_creationKeyForTokenWithName:(id)arg1;
- (id)_credentialForAccount:(id)arg1;
- (id)_defaultSecurityUpgradeServiceNames;
- (id)_fetchAllAccountsWithType:(id)arg1 error:(id*)arg2;
...
- (id)_isSilentBurnCDPRepairEnabledForAccount:(id)arg1;
- (id)_isSilentEscrowRecordRepairEnabledForAccount:(id)arg1;
- (id)_isSilentEscrowRecordRepairEnabledForAccountV2:(id)arg1;
...
- (void)_reportTokenWithName:(id)arg1 forAccount:(id)arg2 error:(id)arg3;
- (void)_reportTokenWithTelemetryID:(id)arg1 account:(id)arg2 telemetryFlowID:(id)arg3 error:(id)arg4;
...
- (void)_setTokenCreationTimeForToken:(id)arg1 tokenID:(id)arg2 account:(id)arg3 credential:(id)arg4;
...
- (id)activeiCloudPrivateEmailCountForAccount:(id)arg1;
- (id)additionalInfoForAccount:(id)arg1;
- (id)adpCohortForAccount:(id)arg1;
- (id)ageOfMajorityForAccount:(id)arg1;
- (id)aliasesForAccount:(id)arg1;
- (id)allAuthKitAccounts;
- (id)allAuthKitAccountsWithError:(id*)arg1;
...
- (id)authKitAccountTypeWithError:(id*)arg1;
- (id)authKitAccountWithAltDSID:(id)arg1;
- (id)authKitAccountWithAltDSID:(id)arg1 error:(id*)arg2;
- (id)authKitAccountWithAppleID:(id)arg1;
- (id)authKitAccountWithAppleID:(id)arg1 error:(id*)arg2;
...
- (id)beneficiaryInfoForAccount:(id)arg1;
...
- (id)canAttestAgeForAccount:(id)arg1;
...
- (void)clearDeviceRemovalReasonFromAccount:(id)arg1;
...
- (bool)dcrtRenewalAttempted:(id)arg1;
- (id)deletedDevicesCacheExpiryOffsetForAccount:(id)arg1;
- (bool)demoAccountForAccount:(id)arg1;
- (id)dependentAuthTokenForAccount:(id)arg1;
- (id)deviceListVersionForAccount:(id)arg1;
- (long long)deviceRemovalReasonForAccount:(id)arg1;
- (id)edpStateForAccount:(id)arg1;
- (unsigned long long)edpStateValueForAccount:(id)arg1;
- (id)familyNameForAccount:(id)arg1;
- (id)formattedUsernameForAccount:(id)arg1;
- (id)forwardingEmailForAccount:(id)arg1;
- (id)get3PRegulatoryOverride:(id)arg1;
...
- (id)idmsEDPTokenIdForAccount:(id)arg1;
- (id)inactiveiCloudPrivateEmailCount;
- (id)inactiveiCloudPrivateEmailCountForAccount:(id)arg1;
- (id)init;
...
- (id)isSilentBurnCDPRepairEnabledForAccount:(id)arg1;
- (id)isSilentEscrowRecordRepairEnabledForAccount:(id)arg1;
- (id)isSilentEscrowRecordRepairEnabledForAccountV2:(id)arg1;
- (bool)isSiwaEnabledForChildAccount:(id)arg1;
...
- (id)nextLivenessNonce:(id)arg1;
- (id)notificationEmailForAccount:(id)arg1;
- (unsigned long long)numberOfApprovedRecoveryContactsForAltDSID:(id)arg1;
...
- (id)passwordVersionForAccount:(id)arg1;
- (id)personaUniqueStringForAltDSID:(id)arg1;
- (bool)phoneAsAppleIDForAccount:(id)arg1;
- (bool)piggybackingApprovalEligible:(id)arg1;
- (id)previousAccountInfoRefreshDateForAccount:(id)arg1;
...
- (void)removeContinuationTokenForAccount:(id)arg1 telemetryFlowID:(id)arg2 error:(id)arg3;
- (void)removeMasterTokenForAccount:(id)arg1;
- (void)removePasswordResetTokenForAccount:(id)arg1 telemetryFlowID:(id)arg2 error:(id)arg3;
...
- (void)set3PRegulatoryOverride:(id)arg1 forAccount:(id)arg2;
- (void)setADPCohort:(id)arg1 forAccount:(id)arg2;
...
- (void)setActiveiCloudPrivateEmailCount:(id)arg1 forAccount:(id)arg2;
...
- (void)setBeneficiaryInfo:(id)arg1 forAccount:(id)arg2;
- (void)setBeneficiaryLastModified:(id)arg1 forAccount:(id)arg2;
- (void)setBeneficiaryListVersion:(id)arg1 forAccount:(id)arg2;
- (void)setBirthYear:(id)arg1 forAccount:(id)arg2;
- (void)setCanAttestAge:(id)arg1 forAccount:(id)arg2;
...
- (void)setCredentialStorageOption:(unsigned long long)arg1 forAccount:(id)arg2;
...
- (void)setDCRTRenewalAttempted:(bool)arg1 forAccount:(id)arg2;
- (void)setDSID:(id)arg1 forAccount:(id)arg2;
- (void)setDeletedDevicesCacheExpiryOffset:(id)arg1 forAccount:(id)arg2;
- (void)setDemoAccount:(bool)arg1 forAccount:(id)arg2;
- (void)setDeviceListVersion:(id)arg1 forAccount:(id)arg2;
- (void)setDeviceRemovalReason:(long long)arg1 onAccount:(id)arg2;
- (void)setEDPState:(id)arg1 forAccount:(id)arg2;
...
- (void)setIdMSEDPTokenId:(id)arg1 forAccount:(id)arg2;
- (void)setInactiveiCloudPrivateEmailCount:(id)arg1 forAccount:(id)arg2;
...
- (void)setIsSiwaEnabled:(bool)arg1 forChildAccount:(id)arg2;
...
- (void)setNextLivenessNonce:(id)arg1 nonce:(id)arg2;
...
- (void)setPasswordVersion:(id)arg1 forAccount:(id)arg2;
- (void)setPhoneAsAppleID:(bool)arg1 forAccount:(id)arg2;
- (void)setPiggybackingApprovalEligible:(bool)arg1 forAccount:(id)arg2;
- (void)setPreviousAccountInfoRefreshDate:(id)arg1 forAccount:(id)arg2;
...
- (void)setSRPProtocol:(id)arg1 forAccount:(id)arg2;
...
- (void)setSharingGroupLastNotificationDate:(id)arg1 forAccount:(id)arg2;
- (void)setSilentBurnCDPRepairEnabled:(id)arg1 forAccount:(id)arg2;
- (void)setSilentEscrowRecordRepairEnabled:(id)arg1 forAccount:(id)arg2;
- (void)setSilentEscrowRecordRepairEnabledV2:(id)arg1 forAccount:(id)arg2;
- (void)setStore:(id)arg1;
- (void)setTelemetryDeviceSessionID:(id)arg1 forAccount:(id)arg2;
- (void)setToken:(id)arg1 tokenID:(id)arg2 account:(id)arg3 credential:(id)arg4;
- (void)setTrustedPhoneNumbers:(id)arg1 forAccount:(id)arg2;
- (void)setUserAgeRange:(unsigned long long)arg1 forAccount:(id)arg2;
...
- (id)sharingGroupLastNotificationDateForAccount:(id)arg1;
...
- (id)srpProtocolForAccount:(id)arg1;
- (id)store;
- (id)telemetryDeviceSessionIDForAccount:(id)arg1;
- (id)tokenCreationDateWithIdentifier:(id)arg1 forAccount:(id)arg2 error:(id*)arg3;
...
- (unsigned long long)userAgeRangeForAccount:(id)arg1;
