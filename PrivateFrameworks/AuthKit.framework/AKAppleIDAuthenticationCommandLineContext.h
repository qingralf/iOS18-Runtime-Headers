...
@property (nonatomic, retain) AKChangePasswordController *changePasswordController;
@property (nonatomic, copy) NSString *countryCode;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (readonly, copy) NSString *description;
@property (nonatomic, copy) NSString *firstName;
@property (nonatomic, retain) AKForgotPasswordController *forgotPasswordController;
...
@property (nonatomic, retain) NSString *smsSecurityCode;
...
+ (id)_findMatchingElementWithName:(id)arg1 inElement:(id)arg2;
+ (id)ruiElementsAttributesWithName:(id)arg1 data:(id)arg2 error:(id*)arg3;
...
- (void)_presentServerUIWithConfiguration:(id)arg1 completion:(id /* block */)arg2;
...
- (void)setChangePasswordController:(id)arg1;
- (void)setCountryCode:(id)arg1;
- (void)setFirstName:(id)arg1;
- (void)setForgotPasswordController:(id)arg1;
...
- (void)setSmsSecurityCode:(id)arg1;
