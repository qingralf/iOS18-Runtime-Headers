...
@interface AKAppleIDAuthenticationContext : NSObject <AKAppleIDAuthenticationLimitedUIProvider, AKAuthenticationContext, AKAuthenticationContext_Internal, AKCommandLineSupporting, AKPasswordAuthenticationContext, NSSecureCoding> {
    NSString * _DSID;
    struct __CFUserNotification { } * _activeSecondFactoryEntryPrompt;
    bool  _allowAuthenticationBeforeFirstUnlock;
    NSString * _altDSID;
...
@property (nonatomic) bool _ignoreShouldContinueProxy;
...
@property (nonatomic) bool allowAuthenticationBeforeFirstUnlock;
...
@property (nonatomic, readonly) bool isConfiguredForTokenUpgrade;
@property (nonatomic, readonly) bool isContextEligibleForSilentAuth;
...
- (id)init;
- (id)initWithAuthenticatedServerRequestContext:(id)arg1;
...
- (void)setAllowAuthenticationBeforeFirstUnlock:(bool)arg1;
