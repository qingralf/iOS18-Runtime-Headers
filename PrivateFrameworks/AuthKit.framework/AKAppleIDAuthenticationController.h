...
+ (id)sensitiveTokenKeysForFullRedaction;
...
- (void)deleteTokensFromCacheWithAltDSID:(id)arg1 tokenIdentifiers:(id)arg2 completion:(id /* block */)arg3;
...
- (void)fetchBirthdayForAltDSID:(id)arg1 completion:(id /* block */)arg2;
...
- (void)fetchTokensWithAltDSID:(id)arg1 tokenIdentifiers:(id)arg2 completion:(id /* block */)arg3;
...
- (oneway void)performCheckInForAccountWithAltDSID:(id)arg1 event:(id)arg2 completion:(id /* block */)arg3;
- (oneway void)performCheckInForAccountWithAltDSID:(id)arg1 event:(id)arg2 reason:(unsigned long long)arg3 completion:(id /* block */)arg4;
- (void)performCircleRequestWithContext:(id)arg1 completion:(id /* block */)arg2;
- (bool)performEdpCompleteKeyDropWithAltDSID:(id)arg1 error:(id*)arg2;
- (bool)performEdpMigrationWithAltDSID:(id)arg1 error:(id*)arg2;
- (void)performPasswordResetWithContext:(id)arg1 completion:(id /* block */)arg2;
- (bool)performRemoveEdpTokenWithAltDSID:(id)arg1 error:(id*)arg2;
...
- (void)persistRecoveryKeyWithContext:(id)arg1 authContext:(id)arg2 completion:(id /* block */)arg3;
