...
- (void)_handleServerTimeAdjustmentWithTime:(id)arg1 completion:(id /* block */)arg2;
...
- (void)_reportOnRequest:(id)arg1 response:(id)arg2 attestationData:(id)arg3;
- (void)_resetDeviceIdentityWithCompletion:(id /* block */)arg1;
- (id)anisetteDataProvider;
- (id)appleIDHeadersForRequest:(id)arg1;
- (void)appleIDHeadersForRequest:(id)arg1 completion:(id /* block */)arg2;
- (void)appleIDHeadersUsingAnisetteWithCompletion:(id /* block */)arg1;
- (void)appleIDHeadersWithCompletion:(id /* block */)arg1;
