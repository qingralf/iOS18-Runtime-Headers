...
@property (nonatomic, retain) NSString *_callerSceneID;
...
@property (nonatomic) bool _shouldShowAdditionalCTA;
...
- (void)set_callerSceneID:(id)arg1;
...
- (void)set_shouldShowAdditionalCTA:(bool)arg1;
