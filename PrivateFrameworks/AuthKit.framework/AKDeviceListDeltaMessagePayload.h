...
@property (nonatomic, readonly) long long removalReason;
@property (nonatomic, readonly, copy) NSString *serialNumber;
@property (nonatomic, readonly, copy) NSDate *timestamp;

- (void).cxx_destruct;
- (unsigned long long)_operationFromPayloadValue:(id)arg1;
- (long long)_removalReasonFromPayloadValue:(id)arg1;
- (id)_timestampFromPayloadValue:(id)arg1;
- (id)altDSID;
