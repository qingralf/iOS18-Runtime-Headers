...
@property (nonatomic, retain) AKDeviceSafetyRestrictionState *deviceRestrictionState;
...
- (void)setDeletedDate:(id)arg1;
- (void)setDeviceRestrictionState:(id)arg1;
