...
- (void)_createAppIconViewWithIcon:(id)arg1;
...
- (id)_localizedAuthorizationPrefix:(bool)arg1;
- (id)_localizedAuthorizationString;
- (id)_localizedChoiceString;
- (id)_localizedEmailKey;
- (id)_localizedFirstPartyAuthorizationStringWithAppName:(id)arg1 accountName:(id)arg2;
...
- (id)_loginChoiceTableViewCellForRow:(unsigned long long)arg1;
...
- (void)_selectLoginChoiceCell:(id)arg1;
...
- (void)subPaneConfirmButtonPerformAccountCreation:(id)arg1;
