...
@interface ASCPlatformPublicKeyCredentialAssertion : NSObject <ASCCredentialProtocol> {
    ...
    _TtC26AuthenticationServicesCore47ASCPublicKeyCredentialAssertionExtensionOutputs * _extensions;
    bool  _isExternal;
...
@property (nonatomic, retain) _TtC26AuthenticationServicesCore47ASCPublicKeyCredentialAssertionExtensionOutputs *extensions;
...
- (id)initWithRelyingPartyIdentifier:(id)arg1 authenticatorData:(id)arg2 signature:(id)arg3 userHandle:(id)arg4 rawClientDataJSON:(id)arg5 credentialID:(id)arg6 extensions:(id)arg7 attachment:(id)arg8 isExternal:(bool)arg9;
- (bool)isExternal;
