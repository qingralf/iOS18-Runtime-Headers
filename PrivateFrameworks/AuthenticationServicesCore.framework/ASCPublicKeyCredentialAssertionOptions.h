...
@interface ASCPublicKeyCredentialAssertionOptions : NSObject <NSCopying, NSSecureCoding> {
    ...
    NSString * _appIDForSecurityKeys;
    NSData * _challenge;
    ...
    _TtC26AuthenticationServicesCore46ASCPublicKeyCredentialAssertionExtensionInputs * _extensions;
    NSString * _origin;
...
@property (nonatomic, copy) NSString *appIDForSecurityKeys;
...
@property (nonatomic, retain) _TtC26AuthenticationServicesCore46ASCPublicKeyCredentialAssertionExtensionInputs *extensions;
...
- (void).cxx_destruct;
- (id)_initWithKind:(unsigned long long)arg1 relyingPartyIdentifier:(id)arg2 challenge:(id)arg3 clientDataHash:(id)arg4 clientDataJSON:(id)arg5 userVerificationPreference:(id)arg6 allowedCredentials:(id)arg7 shouldHideHybrid:(bool)arg8 extensions:(id)arg9 origin:(id)arg10 appIDForSecurityKeys:(id)arg11;
- (id)allowedCredentials;
- (id)appIDForSecurityKeys;
- (id)challenge;
- (id)clientDataHash;
- (id)clientDataJSON;
...
- (id)initWithKind:(unsigned long long)arg1 relyingPartyIdentifier:(id)arg2 clientDataJSON:(id)arg3 userVerificationPreference:(id)arg4 allowedCredentials:(id)arg5 origin:(id)arg6;
- (void)logRequest;
- (id)origin;
- (id)relyingPartyIdentifier;
- (void)setAllowedCredentials:(id)arg1;
- (void)setAppIDForSecurityKeys:(id)arg1;
