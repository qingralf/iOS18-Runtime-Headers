...
- (id)initWithRelyingPartyIdentifier:(id)arg1 authenticatorData:(id)arg2 signature:(id)arg3 userHandle:(id)arg4 rawClientDataJSON:(id)arg5 credentialID:(id)arg6 extensionOutputsCBOR:(id)arg7 attachment:(id)arg8 appID:(bool)arg9;
- (id)rawClientDataJSON;
- (id)relyingPartyIdentifier;
- (void)setAppID:(bool)arg1;
- (id)signature;
- (id)userHandle;
