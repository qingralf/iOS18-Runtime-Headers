...
@property (nonatomic, readonly) bool has_apple_email;
@property (nonatomic) bool ignore_automated_device_group;
@property (nonatomic, readonly) bool is_automated_device_group;
@property (nonatomic, readonly) bool is_carry_device;
