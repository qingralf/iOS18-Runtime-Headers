...
@interface AnalyticsWorkspace : NSObject <NSCopying> {
    ...
    unsigned long long  _currentDBSizeInBytes;
    unsigned long long  _fileSystemSizeInBytes;
    ...
    double  _lastDBSizeUpdateTimestamp;
...
@property (nonatomic, readonly) unsigned long long currentDBSizeInBytes;
@property (nonatomic, readonly) unsigned long long fileSystemSizeInBytes;
...
- (id)createNewContext;
- (unsigned long long)currentDBSizeInBytes;
- (void)dealloc;
- (void)enumerateResidentObjectsOfType:(id)arg1 usingBlock:(id /* block */)arg2;
- (unsigned long long)fileSystemSizeInBytes;
