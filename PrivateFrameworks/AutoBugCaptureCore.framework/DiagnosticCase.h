...
@property (nonatomic, readonly) NSString *basebandFirmwareVersion;
...
@property (nonatomic, readonly) short dpSubmissionState;
@property (nonatomic, readonly) NSMutableArray *events;
@property (nonatomic, readonly) NSString *homeCarrier;
...
@property (nonatomic, readonly) NSString *regulatoryDomainCountry;
...
- (void)setDPSubmissionState:(short)arg1;
