...
@property (nonatomic, retain) NSString *basebandChipset;
@property (nonatomic, retain) NSString *basebandFirmwareVersion;
...
@property (nonatomic, retain) NSString *homeCarrier;
@property (nonatomic, retain) NSString *regulatoryDomainCountry;
