...
@interface AVTRenderer : SCNRenderer <AVTRendererTechniqueSupport, AVTSceneRenderer, SCNSceneRendererDelegate, _SCNSceneCommandBufferStatusMonitor, _SCNSceneRendererDelegateSPI, _SCNSceneRendererResourceManagerMonitor> {
    unsigned long long  _antialiasingMode;
    AVTARMaskRenderer * _arMaskRenderer;
    bool  _arMaskRendererHasFlippedDepth;
    AVTAvatar * _avatar;
    SCNNode * _avatarNode;
    <AVTRendererTechnique> * _avtRendererTechnique;
...
@property (nonatomic, retain) <AVTRendererTechnique> *avtRendererTechnique;
...
@property (nonatomic) bool enableFaceTrackingLossFeedback;
...
+ (id)_cek_renderer;
+ (id)_cek_rendererWithDevice:(id)arg1 options:(id)arg2;
+ (id)renderer;
...
- (void)_cek_applyBlendshapeWeightsInHierarchyUsingBlock:(id /* block */)arg1;
- (void)_cek_beginTransaction;
- (void)_cek_commitTransaction;
- (float)_cek_currentPointOfViewSensorHeight;
- (void)_cek_fetchBlendshapeWeightsInHierarchyUsingBlock:(id /* block */)arg1;
- (void)_cek_renderAtTime:(double)arg1 enableAntialiasing:(bool)arg2 viewport:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg3 commandBuffer:(id)arg4 passDescriptor:(id)arg5;
- (void)_cek_setCurrentPointOfViewFocalLength:(float)arg1;
...
- (void)deprecated_ntk_setPaused:(bool)arg1;
- (void)deprecated_ntk_setPhysicsWorldTimeStep:(float)arg1;
...
- (void)setAvtRendererTechnique:(id)arg1;
