...
+ (id)_availableStickerNamesForPuppetNamed:(id)arg1 inStickerPack:(id)arg2;
+ (id)_stickerConfigurationForPuppetNamed:(id)arg1 inStickerPack:(id)arg2 stickerName:(id)arg3;
+ (id)_stickerConfigurationsForPuppetNamed:(id)arg1 inStickerPack:(id)arg2;
