...
@interface AVTView : SCNView <AVTFaceTrackerDelegate, AVTRendererTechniqueSupport, AVTSceneRenderer, SCNSceneRendererDelegate, _SCNSceneCommandBufferStatusMonitor, _SCNSceneRendererResourceManagerMonitor> {
...
- (void)_transitionToCustomFaceTrackingWithDuration:(double)arg1 style:(unsigned long long)arg2 enableBakedAnimations:(bool)arg3 faceTrackingDidStartHandlerReceiverBlock:(id /* block */)arg4 completionHandler:(id /* block */)arg5;
...
- (void)setEnableFaceTracking:(bool)arg1 bySkippingARFramesInsteadOfStopping:(bool)arg2;
...
- (void)setFramingMode:(id)arg1 animationDuration:(double)arg2;
...
- (id)technique;
- (void)transitionToCustomFaceTrackingWithDuration:(double)arg1 style:(unsigned long long)arg2 enableBakedAnimations:(bool)arg3 faceTrackingDidStartHandlerReceiverBlock:(id /* block */)arg4 completionHandler:(id /* block */)arg5;
