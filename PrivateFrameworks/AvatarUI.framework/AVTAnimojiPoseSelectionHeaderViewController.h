...
@property (nonatomic, retain) UIColor *avtCaptureBackgroundColor;
...
- (void)setAvtCaptureBackgroundColor:(id)arg1;
- (void)setAvtView:(id)arg1;
- (void)setCaptureBackgroundColor:(id)arg1;
- (void)setDisplayedConfiguration:(id)arg1;
- (void)setViewUpdater:(id)arg1;
- (void)updateForAvatarRecord:(id)arg1 discardPose:(bool)arg2;
