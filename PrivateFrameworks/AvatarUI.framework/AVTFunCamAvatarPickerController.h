...
@property (nonatomic) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } lastUpdateViewBounds;
@property (nonatomic, retain) AVTFunCamAvatarPickerCollectionViewLayout *listLayout;
...
@property (nonatomic, copy) AVTFunCamAvatarPickerStyle *style;
@property (readonly) Class superclass;
@property (nonatomic, retain) UIView *titlesClippingView;
@property (nonatomic, retain) UICollectionView *titlesCollectionView;
@property (nonatomic, retain) UIView *titlesContainer;
...
+ (id)funCamAvatarPickerControllerForStore:(id)arg1 style:(id)arg2 allowsCreation:(bool)arg3;
...
- (id)initWithStore:(id)arg1 environment:(id)arg2 style:(id)arg3 allowsCreation:(bool)arg4;
- (bool)isDisplayingGridLayout;
- (id)items;
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })lastUpdateViewBounds;
- (id)listLayout;
- (void)loadView;
- (id)logger;
...
- (void)setLastUpdateViewBounds:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
...
- (void)setTitlesClippingView:(id)arg1;
- (void)setTitlesCollectionView:(id)arg1;
- (void)setTitlesContainer:(id)arg1;
- (void)startObservingChangesIfNeeded;
- (id)store;
- (id)style;
- (id)titlesClippingView;
- (id)titlesCollectionView;
- (id)titlesContainer;
