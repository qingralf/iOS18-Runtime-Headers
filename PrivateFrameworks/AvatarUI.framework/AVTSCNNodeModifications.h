...
- (unsigned long long)projectionDirection;
- (void)setFieldOfView:(double)arg1;
- (void)setFramingMode:(id)arg1;
- (void)setProjectionDirection:(unsigned long long)arg1;
