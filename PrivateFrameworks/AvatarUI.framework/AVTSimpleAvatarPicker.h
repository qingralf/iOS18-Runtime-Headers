...
@interface AVTSimpleAvatarPicker : NSObject <AVTAvatarActionsViewControllerDelegate, AVTAvatarEditorViewControllerDelegate, AVTAvatarPicker, AVTNotifyingContainerViewDelegate, AVTObjectViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout> {
    ...
    bool  _doesDisplayEditIconWhenAvailable;
    ...
    bool  _shouldReverseNaturalLayout;
...
@property (nonatomic) bool doesDisplayEditIconWhenAvailable;
...
@property (nonatomic) bool shouldReverseNaturalLayout;
...
- (id)initWithDataSource:(id)arg1 recordImageProvider:(id)arg2 avtViewSessionProvider:(id)arg3 taskScheduler:(id)arg4 allowEditing:(bool)arg5 interItemSpacing:(double)arg6 shouldReverseNaturalLayout:(bool)arg7;
...
- (id)initWithStore:(id)arg1 environment:(id)arg2 allowAddItem:(bool)arg3 interItemSpacing:(double)arg4 shouldReverseNaturalLayout:(bool)arg5;
...
- (void)setDoesDisplayEditIconWhenAvailable:(bool)arg1;
...
- (void)setShouldReverseNaturalLayout:(bool)arg1;
