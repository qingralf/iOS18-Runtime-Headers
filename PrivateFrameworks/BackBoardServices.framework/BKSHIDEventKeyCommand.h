...
@interface BKSHIDEventKeyCommand : NSObject <BSDescriptionStreaming, NSCopying, NSSecureCoding> {
...
+ (id)_descriptionForKeyCommandCollection:(id)arg1;
...
- (void).cxx_destruct;
- (void)_appendKeyWithoutModifiersToDescriptionTarget:(id)arg1 keyCodeString:(id)arg2;
