...
@interface BKSHIDUISensorCharacteristics : NSObject <BSDescriptionStreamable, BSProtobufSerializable, NSCopying, NSSecureCoding> {
    ...
    long long  _suggestedSystemApertureGracePeriodForScreenOff;
}
...
@property (nonatomic, readonly) long long suggestedSystemApertureGracePeriodForScreenOff;
...
- (id)mutableCopy;
- (long long)suggestedSystemApertureGracePeriodForScreenOff;
