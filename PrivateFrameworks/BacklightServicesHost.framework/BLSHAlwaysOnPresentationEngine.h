...
@interface BLSHAlwaysOnPresentationEngine : NSObject <BLSFlipbookDiagnosticsProviding, BLSHAlwaysFillFlipbookProvider, BLSHBacklightInactiveEnvironmentSessionObserving, BLSHBacklightSceneHostEnvironmentObserver, BLSHEngineRenderFlipbookSessionDelegate, BLSHEngineRequestDatesOperationDelegate, BLSHFlipbookPowerSavingProviding, BLSHGlobal1HzFlipbookProvider, BLSHOnSystemSleepActionDelegate, BLSHPseudoFlipbookProvider> {
    ...
    <BLSHRenderedFlipbookFrame> * _lock_frameOnGlassWhenFlipbookCancelled;
    <BLSHRenderedFlipbookFrame> * _lock_frameOnGlassWhenFlipbookLastCancelledAndReset;
    bool  _lock_global1HzFlipbook;
    ...
    <BLSHInactiveBudgetPolicing_Private> * _nullInactiveBudgetPolicy;
    <BLSHOSInterfaceProviding> * _osInterfaceProvider;
    <BLSHInactiveBudgetPolicing_Private> * _realInactiveBudgetPolicy;
...
@property (nonatomic) bool cacheFlipbook;
...
@property (getter=isGlobal1HzFlipbook, nonatomic) bool global1HzFlipbook;
@property (readonly) unsigned long long hash;
@property (nonatomic, retain) BLSHBacklightInactiveEnvironmentSession *inactiveSession;
@property (nonatomic, readonly) <BLSHRenderedFlipbookFrame> *onGlassFlipbookFrame;
...
- (void)hostEnvironment:(id)arg1 hostDidSet1HzFlipbook:(bool)arg2;
...
- (void)setCacheFlipbook:(bool)arg1;
