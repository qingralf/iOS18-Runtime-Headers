...
@interface BLSHGlobalCacheFlipbookOnDisplayWakeAttributeHandler : BLSHLocalCountingAssertionAttributeHandler {
    <BLSHGlobalCacheFlipbookOnDisplayWakeProvider> * _provider;
}
