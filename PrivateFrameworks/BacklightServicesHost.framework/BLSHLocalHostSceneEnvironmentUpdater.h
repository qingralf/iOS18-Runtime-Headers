...
@interface BLSHLocalHostSceneEnvironmentUpdater : NSObject <BLSBacklightSceneEnvironmentUpdating, BLSHBacklightEnvironmentStateMachineDelegate, BLSHBacklightInactiveEnvironmentSessionUpdating, BLSHBacklightSceneHostEnvironmentObserver> {
...
- (id)initWithSessionProvider:(id)arg1 localHostEnvironment:(id)arg2 osTimerProvider:(id)arg3;
