...
+ (id)operationForUpdateFromCurrentDisplayMode:(long long)arg1 toTargetDisplayMode:(long long)arg2 withPendingOperation:(id)arg3 abandonedInProgressOperation:(id)arg4 isNullOperationAllowed:(bool)arg5;
