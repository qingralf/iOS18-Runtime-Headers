...
@interface BNBannerController : NSObject <BNConsideringDelegate, BNPosting, BNPostingPrivate, BNSuspendable> {
    ...
    struct { 
        ...
        unsigned int implementsShouldMorph : 1; 
        unsigned int implementsShouldMorphOld : 1; 
...
- (bool)_shouldMorphToPresentable:(id)arg1 withPresentedPresentables:(id)arg2 responsiblePresentable:(out id*)arg3 stateChange:(out id*)arg4;
