...
- (void).cxx_destruct;
- (void)_addPresentable:(id)arg1 withTransitioningDelegate:(id)arg2 incrementingTier:(bool)arg3 addTierToTop:(bool)arg4;
...
- (void)_insertPresentable:(id)arg1 beneathPresentable:(id)arg2 withTransitioningDelegate:(id)arg3 incrementingTier:(bool)arg4 addTierToTop:(bool)arg5;
...
- (void)_morphFromPresentable:(id)arg1 toPresentable:(id)arg2 withOptions:(unsigned long long)arg3 userInfo:(id)arg4 stateChange:(bool)arg5;
- (id)_newBannerTransitionContextForMorphFromViewController:(id)arg1 toViewController:(id)arg2 animated:(bool)arg3;
...
- (id)layoutManager;
- (void)loadView;
- (void)morphFromPresentable:(id)arg1 toPresentable:(id)arg2 withOptions:(unsigned long long)arg3 userInfo:(id)arg4 stateChange:(bool)arg5;
- (id)poster;
...
- (bool)shouldNewTierBeAddedToTopForPresentable:(id)arg1 withPresentable:(id)arg2;
