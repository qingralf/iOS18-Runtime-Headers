...
@property (getter=isResizeAnimationCustomizationPermitted, nonatomic) bool resizeAnimationCustomizationPermitted; /* unknown property attribute: ? */
...
- (id)animationControllerMorphFromPresentedController:(id)arg1 presentingController:(id)arg2 sourceController:(id)arg3 userInfo:(id)arg4 stateChange:(bool)arg5;
- (id)init;
