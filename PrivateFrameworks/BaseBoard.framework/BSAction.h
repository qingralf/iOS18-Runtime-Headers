...
@interface BSAction : NSObject <BSDebugDescriptionProviding, BSInvalidatable, BSSettingDescriptionProvider, BSXPCCoding, BSXPCSecureCoding, NSSecureCoding> {
    BSSettings * _info;
...
+ (id)browserSupportKit_activationActionForWebClipWithUUID:(id)arg1;
