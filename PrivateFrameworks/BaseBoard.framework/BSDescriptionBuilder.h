...
@property (nonatomic, readonly) bool hasDebugStyle;
@property (nonatomic, readonly) bool hasSuccinctStyle;
...
- (void)appendCollectionSection:(id)arg1 withName:(id)arg2 multilinePrefix:(id)arg3 skipIfEmpty:(bool)arg4;
- (void)appendCollectionSection:(id)arg1 withName:(id)arg2 multilinePrefix:(id)arg3 skipIfEmpty:(bool)arg4 objectTransformer:(id /* block */)arg5;
- (void)appendCollectionSection:(id)arg1 withName:(id)arg2 skipIfEmpty:(bool)arg3;
- (void)appendCollectionSection:(id)arg1 withName:(id)arg2 skipIfEmpty:(bool)arg3 objectTransformer:(id /* block */)arg4;
- (void)appendCustomFormatWithName:(id)arg1 block:(id /* block */)arg2;
- (void)appendCustomFormatWithNameFromObjectDescription:(id)arg1 block:(id /* block */)arg2;
...
- (id)ui_appendPoint3D:(struct CAPoint3D { double x1; double x2; double x3; })arg1 withName:(id)arg2;
...
- (id)ui_appendVector:(struct CGVector { double x1; double x2; })arg1 withName:(id)arg2;
- (id)ui_appendVector:(struct CGVector { double x1; double x2; })arg1 withName:(id)arg2 decimalPrecision:(unsigned long long)arg3;
