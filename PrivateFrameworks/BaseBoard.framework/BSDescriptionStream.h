...
+ (id)descriptionForRootObject:(id)arg1 withStyle:(id)arg2;
...
- (void)appendCustomFormatForValue:(id /* block */)arg1 withCustomFormatForName:(id /* block */)arg2;
...
- (id)init;
- (id)initWithDescriptionStyle:(id)arg1;
- (void)overlayStyle:(id)arg1 block:(id /* block */)arg2;
