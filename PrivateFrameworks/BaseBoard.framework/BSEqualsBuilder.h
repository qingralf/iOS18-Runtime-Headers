...
- (id)appendCGAffineTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg1 counterpart:(id /* block */)arg2;
...
- (id)appendInt64:(long long)arg1 counterpart:(id /* block */)arg2;
