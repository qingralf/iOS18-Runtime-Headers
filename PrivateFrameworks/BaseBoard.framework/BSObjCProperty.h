...
+ (id)propertyWithBuilder:(id /* block */)arg1;
+ (id)propertyWithBuilder:(id /* block */)arg1 error:(out id*)arg2;
+ (id)propertyWithName:(id)arg1 attributes:(id)arg2 error:(out id*)arg3;
+ (id)propertyWithProperty:(struct objc_property { }*)arg1 error:(out id*)arg2;

- (void).cxx_destruct;
- (id)copyAddingCustomAttributes:(id)arg1;
- (id)copyAsReadWrite;
- (id)customAttributeForKey:(id)arg1;
- (id)description;
