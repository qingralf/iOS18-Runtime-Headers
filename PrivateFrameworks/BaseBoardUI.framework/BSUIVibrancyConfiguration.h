...
+ (id)vibrancyLUTFromPrivateContentStyle:(id)arg1 extensionBundleURL:(id)arg2 luminanceReduced:(bool)arg3;

// Image: /System/Library/PrivateFrameworks/PosterUIFoundation.framework/PosterUIFoundation

+ (long long)pui_vibrancyEffectTypeFromColor:(id)arg1;
+ (id)pui_vibrancyLUTFromColor:(id)arg1 extensionBundleURL:(id)arg2;
+ (id)pui_vibrancyLUTFromColor:(id)arg1 extensionBundleURL:(id)arg2 luminanceReduced:(bool)arg3;
+ (id)pui_vibrancyLUTFromPrivateStyle:(id)arg1 extensionBundleURL:(id)arg2 luminanceReduced:(bool)arg3;
