...
@property (getter=isEmpty, nonatomic) bool empty; /* unknown property attribute: ? */
...
@property (nonatomic, copy) NSString *name; /* unknown property attribute: ? */
...
@property (nonatomic) <UIViewControllerTransitionCoordinator> *transitionCoordinator; /* unknown property attribute: ? */
