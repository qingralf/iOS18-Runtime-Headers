...
+ (id)pathForResource:(id)arg1 inContainer:(id)arg2;
+ (id)pathForSetResource:(id)arg1 inContainer:(id)arg2;
+ (id)pathForSharedSyncWithAccount:(id)arg1 domain:(unsigned long long)arg2;
+ (id)pathForSharedSyncWithAccount:(id)arg1 streamType:(unsigned long long)arg2 domain:(unsigned long long)arg3;
...
+ (id)resourceFromDataResourcePath:(id)arg1 inContainer:(id)arg2;
+ (void)setBasePathForTestingWithPath:(id)arg1;
+ (id)setsDirectoryInContainer:(id)arg1;
