...
- (id)initWithAddress:(id)arg1 name:(id)arg2 productID:(id)arg3 starting:(id)arg4 deviceType:(int)arg5 batteryLevelHeadphoneCase:(id)arg6 batteryLevelHeadphoneRight:(id)arg7 batteryLevelHeadphoneLeft:(id)arg8 appleAudioDevice:(id)arg9 userWearing:(id)arg10 vendorID:(id)arg11;
