...
@interface BMFeedbackLearningUserInteraction : BMEventBase <BMStoreData> {
    ...
    BMFeedbackLearningTupleInteraction * _tupleInteraction;
}
...
@property (nonatomic, readonly) BMFeedbackLearningTupleInteraction *tupleInteraction;
...
- (id)initWithTupleInteraction:(id)arg1;
