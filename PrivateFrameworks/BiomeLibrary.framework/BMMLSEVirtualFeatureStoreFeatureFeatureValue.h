...
@property (nonatomic, readonly) int missingReason;
...
- (id)initWithIntValue:(id)arg1 doubleValue:(id)arg2 stringValue:(id)arg3 boolValue:(id)arg4 timeBucketValue:(int)arg5 missingReason:(int)arg6;
