...
@interface BMMomentsEngagementAppEntryEvent : BMEventBase <BMStoreData> {
    ...
    BMMomentsEngagementBundleSummary * _bundleSummary;
...
@property (nonatomic, readonly) BMMomentsEngagementBundleSummary *bundleSummary;
...
- (id)initWithType:(int)arg1 clientIdentifier:(id)arg2 timestamp:(id)arg3 identifier:(id)arg4 startTime:(id)arg5 endTime:(id)arg6 totalCharacters:(id)arg7 addedCharacters:(id)arg8 usedPhotoAssets:(id)arg9 appEntryEventType:(id)arg10 bundleInterfaceTypes:(id)arg11 bundleEvergreenTypes:(id)arg12 bundleSummary:(id)arg13 assets:(id)arg14;
