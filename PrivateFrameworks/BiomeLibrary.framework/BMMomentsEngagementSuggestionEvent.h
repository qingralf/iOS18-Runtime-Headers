...
@interface BMMomentsEngagementSuggestionEvent : BMEventBase <BMStoreData> {
    ...
    BMMomentsEngagementNotificationInfo * _notificationInfo;
...
@property (nonatomic, readonly) BMMomentsEngagementNotificationInfo *notificationInfo;
...
- (id)initWithType:(int)arg1 timestamp:(id)arg2 fullBundleOrderedSet:(id)arg3 clientIdentifier:(id)arg4 viewContainerName:(id)arg5 viewVisibleTime:(id)arg6 suggestionType:(id)arg7 viewVisibleSuggestionsCount:(id)arg8 viewTotalSuggestionsCount:(id)arg9 notificationInfo:(id)arg10;
