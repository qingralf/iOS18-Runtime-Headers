...
@property (nonatomic, readonly) int userDonatorType;
...
- (id)initWithIdentifier:(id)arg1 type:(id)arg2 domain:(id)arg3 appBundleId:(id)arg4 status:(int)arg5 direction:(int)arg6 isDonatedBySiri:(id)arg7 startDate:(id)arg8 durationInSeconds:(id)arg9 fields:(id)arg10 groupIdentifier:(id)arg11 appIntentInteractionIdentifier:(id)arg12 interactionSource:(int)arg13 contentHash:(id)arg14 userDonatorType:(int)arg15;
...
- (id)initWithIdentifier:(id)arg1 type:(id)arg2 domain:(id)arg3 appBundleId:(id)arg4 status:(int)arg5 direction:(int)arg6 isDonatedBySiri:(id)arg7 startDate:(id)arg8 durationInSeconds:(id)arg9 interactionFields:(id)arg10 fields:(id)arg11 groupIdentifier:(id)arg12 appIntentInteractionIdentifier:(id)arg13 interactionSource:(int)arg14 contentHash:(id)arg15 userDonatorType:(int)arg16;
