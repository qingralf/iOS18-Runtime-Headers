...
@interface BMSiriUserSamplingId : BMEventBase <BMStoreData> {
...
@property (nonatomic, readonly) NSUUID *samplingId;
...
- (id)initWithSamplingId:(id)arg1 effectiveFrom:(id)arg2 validityDays:(id)arg3 createdOn:(id)arg4 adoptedOn:(id)arg5 switchedCount:(id)arg6;
