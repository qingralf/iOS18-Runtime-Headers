...
@interface BMFrameStore : NSObject {
    ...
    bool  _isRemoteSegment;
    bool  _isTombstoneSegment;
...
@property (nonatomic, readonly) bool isRemoteSegment;
@property (nonatomic, readonly) bool isTombstoneSegment;
...
- (unsigned int)countFrameStateInOffsetTable:(unsigned int)arg1 startingFrame:(int)arg2 endingFrame:(int)arg3;
...
- (int)frameCount;
- (int)frameCountFromStartTime:(double)arg1 endTime:(double)arg2;
- (int)frameCountFromStartTimeV2:(double)arg1 endTime:(double)arg2;
- (int)frameCountV2;
