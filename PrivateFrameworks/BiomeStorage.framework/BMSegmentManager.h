...
+ (unsigned long long)sizeOfNewFrameStoreInBytesFromNonPagedSize:(unsigned long long)arg1 storeLocationOptions:(long long)arg2;
...
- (id)orderedSegmentsInDirectory:(id)arg1 error:(id*)arg2;
- (id)path;
