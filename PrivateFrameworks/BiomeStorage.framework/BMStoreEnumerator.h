...
@interface BMStoreEnumerator : NSObject {
    <BMStoreBookmarkEnumerator> * _bookmarkEnumerator;
...
@property (nonatomic, readonly) <BMStoreBookmarkEnumerator> *bookmarkEnumerator;
@property (nonatomic, readonly) BMFrameStore *currentFrameStore;
@property (nonatomic, readonly) BMStreamDatastore *ds;
...
- (id)initWithStreamDatastore:(id)arg1 bookmarkEnumerator:(id)arg2 error:(id*)arg3;
