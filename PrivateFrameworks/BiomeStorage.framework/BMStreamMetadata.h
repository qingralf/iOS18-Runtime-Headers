...
@property (nonatomic, retain) BMAccount *account;
...
- (id)initWithStreamId:(id)arg1 eventType:(Class)arg2 account:(id)arg3 remoteStreamName:(id)arg4 pruningPolicy:(id)arg5;
