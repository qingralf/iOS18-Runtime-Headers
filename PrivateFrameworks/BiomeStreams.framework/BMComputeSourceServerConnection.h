...
- (void)sendEventWithStreamIdentifier:(id)arg1 timestamp:(id)arg2 signpostID:(unsigned long long)arg3 eventData:(id)arg4 eventDataVersion:(unsigned int)arg5 account:(id)arg6 remoteName:(id)arg7;
- (id)server;
