...
- (id)identifier;
- (id)init;
- (id)initWithDKStreamIdentifier:(id)arg1;
- (id)initWithDKStreamIdentifier:(id)arg1 contentProtection:(id)arg2;
- (id)initWithStreamIdentifier:(id)arg1 contentProtection:(unsigned long long)arg2 pruningPolicy:(id)arg3 domain:(unsigned long long)arg4;
