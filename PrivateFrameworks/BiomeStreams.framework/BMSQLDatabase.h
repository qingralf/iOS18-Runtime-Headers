...
- (void).cxx_destruct;
- (id)SQLSchemaString;
- (bool)_attachDatabase:(id)arg1 name:(id)arg2 error:(id*)arg3;
- (id)_executeQuery:(id)arg1;
- (id)accessedColumns;
- (bool)attachDatabase:(id)arg1 name:(id)arg2 error:(id*)arg3;
- (bool)attachDatabaseWithResourceIdentifier:(id)arg1 useCase:(id)arg2 error:(id*)arg3;
- (struct sqlite3 { }*)db;
- (void)dealloc;
- (id)description;
...
- (bool)registerFunctionWithName:(id)arg1 numArgs:(int)arg2 function:(id /* block */)arg3 userData:(id)arg4 error:(id*)arg5;
