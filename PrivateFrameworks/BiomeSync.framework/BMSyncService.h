/* Generated by RuntimeBrowser
   Image: /System/Library/PrivateFrameworks/BiomeSync.framework/BiomeSync
 */

@interface BMSyncService : NSObject <BMSyncServiceClientProtocol>

- (id)cascadeRapportSyncWithErrors:(id*)arg1;
...
- (void)remoteDevicesForAccount:(id)arg1 reply:(id /* block */)arg2;
