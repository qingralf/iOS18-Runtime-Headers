...
@property (nonatomic, readonly) NSNumber *attentionScore;
@property (nonatomic, readonly) NSNumber *cameraObstructionScore;
...
@property (nonatomic, readonly) NSNumber *faceDetectionScore;
...
@property (nonatomic, readonly) NSNumber *isCameraObstructed;
...
- (void).cxx_destruct;
- (id)attentionScore;
- (id)cameraObstructionScore;
- (id)dictionary;
- (id)distance;
- (unsigned long long)eyeReliefStatus;
- (bool)faceDetected;
- (id)faceDetectionScore;
- (bool)flare;
- (id)frameNumber;
- (bool)glassesMismatch;
- (id)initFromDictionary:(id)arg1;
- (id)initFromFaceInfo:(const struct { unsigned char x1; unsigned short x2; unsigned short x3; unsigned short x4; unsigned short x5; unsigned int x6; float x7; float x8; float x9; unsigned int x10; float x11; float x12; bool x13; float x14; }*)arg1;
- (id)initWithPresenceState:(bool)arg1;
- (id)initWithPresenceState:(bool)arg1 details:(id)arg2;
- (id)isCameraObstructed;
- (bool)multipleFaces;
- (bool)occlusion;
