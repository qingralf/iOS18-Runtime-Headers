...
- (void)sendAutoBugCaptureEvent:(unsigned long long)arg1 withContext:(id)arg2 replyBlock:(id /* block */)arg3;
- (bool)sendSignature:(id)arg1 withDuration:(double)arg2;
- (void)sendSignature:(id)arg1 withDuration:(double)arg2 replyBlock:(id /* block */)arg3;
