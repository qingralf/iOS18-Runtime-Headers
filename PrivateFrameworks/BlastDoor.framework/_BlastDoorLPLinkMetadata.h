...
@property (nonatomic, copy) _BlastDoorLPPlatformColor *themeColor;
...
- (id)audioMetadata;
- (id)audios;
- (id)availableContentImages;
- (id)collaborationMetadata;
- (id)contentImages;
- (id)contentImagesMetadata;
...
- (void)setAvailableContentImages:(id)arg1;
- (void)setCollaborationMetadata:(id)arg1;
- (void)setContentImages:(id)arg1;
- (void)setContentImagesMetadata:(id)arg1;
