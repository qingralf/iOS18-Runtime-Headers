...
@property (nonatomic, readonly) <BSServiceConnectionMessageBatching> *activeMessageBatch;
...
- (bool)dnds_hasHearingTestEventUpdateEntitlementForClientIdentifier:(id)arg1;
