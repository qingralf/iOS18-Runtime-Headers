...
@interface BCCloudDataSource : NSObject <BDSCloudKitSupportSignOutDeleteWithoutInstance> {
    <BCCloudDataSourceDelegate> * _delegate;
    NSManagedObjectContext * _managedObjectContext;
    NSPersistentStoreCoordinator * _persistentStoreCoordinator;
}

@property (nonatomic) <BCCloudDataSourceDelegate> *delegate;
...
- (bool)_deleteDirectoryForStoreAtURL:(id)arg1;
...
- (id)initWithManagedObjectModel:(id)arg1 nameOnDisk:(id)arg2 delegate:(id)arg3;
- (id)initWithManagedObjectModel:(id)arg1 rootDirectoryURL:(id)arg2 legacyRootDirectoryURL:(id)arg3 nameOnDisk:(id)arg4;
- (id)initWithManagedObjectModel:(id)arg1 rootDirectoryURL:(id)arg2 legacyRootDirectoryURL:(id)arg3 nameOnDisk:(id)arg4 delegate:(id)arg5;
