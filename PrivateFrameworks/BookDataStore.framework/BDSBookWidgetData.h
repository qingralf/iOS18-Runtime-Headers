...
- (id)initWithAssetID:(id)arg1 title:(id)arg2 pageProgressionDirection:(id)arg3 coverURL:(id)arg4 readingProgress:(id)arg5 cloudAssetType:(id)arg6 libraryAssetType:(id)arg7;
- (id)initWithAssetID:(id)arg1 title:(id)arg2 pageProgressionDirection:(id)arg3 coverURL:(id)arg4 readingProgress:(id)arg5 totalDuration:(id)arg6 cloudAssetType:(id)arg7 libraryAssetType:(id)arg8;
