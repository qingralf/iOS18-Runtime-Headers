...
- (void)fetchAllHiddenItemStoreIDsWithCompletion:(id /* block */)arg1;
...
- (void)priceTrackingCtlAddTrackedItems:(id)arg1 completion:(id /* block */)arg2;
- (void)priceTrackingCtlGetStateWithCompletion:(id /* block */)arg1;
- (void)priceTrackingCtlOverrideReferencePrices:(id)arg1 completion:(id /* block */)arg2;
- (void)priceTrackingCtlRefreshTrackedPricesIgnoringSchedule:(bool)arg1 completion:(id /* block */)arg2;
- (void)priceTrackingSetConfiguration:(id)arg1 completion:(id /* block */)arg2;
