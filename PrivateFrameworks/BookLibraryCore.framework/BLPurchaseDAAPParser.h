...
- (id)parseFlavor:(const char *)arg1 size:(long long)arg2;
- (id)parseFlavorListing:(const char *)arg1 size:(long long)arg2;
...
- (id)parseXMLContent:(const char *)arg1 count:(long long)arg2;
...
- (void)unknownCode:(unsigned int)arg1 bytes:(const char *)arg2 size:(long long)arg3 context:(const char *)arg4;
