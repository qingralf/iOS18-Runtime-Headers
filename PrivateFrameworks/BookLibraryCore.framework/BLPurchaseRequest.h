...
@interface BLPurchaseRequest : BLRequest <NSCopying, NSSecureCoding> {
    ...
    NSString * _logUUID;
    NSXPCListenerEndpoint * _paymentSheetListenerEndpoint;
    NSURL * _permlink;
...
@property (nonatomic, retain) NSXPCListenerEndpoint *paymentSheetListenerEndpoint;
...
- (id)logUUID;
- (id)paymentSheetListenerEndpoint;
- (id)permlink;
- (id)permlinkTitle;
...
- (void)setPaymentSheetListenerEndpoint:(id)arg1;
