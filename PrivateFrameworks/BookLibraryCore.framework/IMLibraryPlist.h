...
+ (id)collectionIdFromPlistEntry:(id)arg1;
...
+ (bool)isPDFFromPlistEntry:(id)arg1;
+ (id)isProofedAssetFromPlistEntry:(id)arg1;
+ (id)isSampleFromPlistEntry:(id)arg1;
+ (bool)isSupplementalContentFromPlistEntry:(id)arg1;
...
+ (id)storePlaylistIdFromPlistEntry:(id)arg1;
