...
@property (nonatomic) bool migrationDeviceUnpairedByUserAction;
...
- (void)setLastActiveDate:(id)arg1;
...
- (void)setMigrationDeviceUnpairedByUserAction:(bool)arg1;
