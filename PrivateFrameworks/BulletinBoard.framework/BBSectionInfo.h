...
- (id)displayName;
- (id)effectiveSectionInfoWithDefaultContentPreviewSetting:(long long)arg1 globalAnnounceSetting:(long long)arg2 globalScheduledDeliverySetting:(long long)arg3 globalSummarizationSetting:(long long)arg4 hasPairedVehiclesForCarPlay:(bool)arg5 hasDestinationForRemoteNotifications:(bool)arg6;
- (id)effectiveSectionInfoWithFactoryInfo:(id)arg1 defaultContentPreviewSetting:(long long)arg2 globalAnnounceSetting:(long long)arg3 globalScheduledDeliverySetting:(long long)arg4 globalSummarizationSetting:(long long)arg5 hasPairedVehiclesForCarPlay:(bool)arg6 hasDestinationForRemoteNotifications:(bool)arg7;
...
- (id)initWithUNCSectionInfo:(id)arg1 parentSection:(id)arg2;
- (bool)isAppClip;
...
- (void)setSummarizationSetting:(long long)arg1;
...
- (id)toUNCSectionInfoWithParentSection:(id)arg1;
- (void)unmuteSection;
