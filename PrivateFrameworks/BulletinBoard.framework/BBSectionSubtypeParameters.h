...
@interface BBSectionSubtypeParameters : NSObject <NSSecureCoding> {
    ...
    NSNumber * _boxedSuppressPresentationInAmbient;
...
@property (nonatomic, retain) NSNumber *boxedAllowsPersistentBannersInCarPlay;
@property (nonatomic, retain) NSNumber *boxedAllowsSupplementaryActionsInCarPlay;
...
@property (nonatomic, retain) NSNumber *boxedHideDismissActionInCarPlay;
...
@property (nonatomic, retain) NSNumber *boxedPlaysMediaWhenRaised;
...
@property (nonatomic, retain) NSNumber *boxedSuppressDelayForForwardedBulletins;
@property (nonatomic, retain) NSNumber *boxedSuppressPresentationInAmbient;
...
- (id)boxedAllowsPersistentBannersInCarPlay;
- (id)boxedAllowsSupplementaryActionsInCarPlay;
- (id)boxedCanBeSilencedByMenuButtonPress;
- (id)boxedCoalescesWhenLocked;
- (id)boxedHideDismissActionInCarPlay;
- (id)boxedIPodOutAlertType;
- (id)boxedIgnoresQuietMode;
- (id)boxedInertWhenLocked;
- (id)boxedPlaysMediaWhenRaised;
...
- (id)boxedSuppressDelayForForwardedBulletins;
- (id)boxedSuppressPresentationInAmbient;
...
- (void)setBoxedSuppressDelayForForwardedBulletins:(id)arg1;
- (void)setBoxedSuppressPresentationInAmbient:(id)arg1;
