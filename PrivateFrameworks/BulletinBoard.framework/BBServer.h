...
@interface BBServer : NSObject <AFSiriAnnouncementRequestCapabilityObserving, BBAppProtectionMonitorDelegate, BBDataProviderManagerDelegate, BBEffectiveSettingsProvider, BBMuteExpirationManagerDelegate, BBSectionAuthorizationManagerDelegate, BBServerConduitServerInterface, BBSettingsGatewayServerInterface, BBSyncServiceDelegate, NSXPCListenerDelegate> {
...
@property (nonatomic, readonly) long long effectiveGlobalSummarizationSetting;
@property (nonatomic, readonly) bool hasDestinationForRemoteNotifications;
...
- (void)_logObserversBeforeAndAfterUpdateBlock:(id /* block */)arg1;
...
- (void)_setGlobalHighlightsSetting:(long long)arg1;
...
- (void)_setGlobalSummarizationSetting:(long long)arg1;
...
- (void)getEffectiveGlobalHighlightsSettingWithHandler:(id /* block */)arg1;
...
- (void)getEffectiveGlobalSummarizationSettingWithHandler:(id /* block */)arg1;
...
- (void)protectionStateChangedForBundleIdentifiers:(id)arg1;
...
- (void)refreshSectionInfoForID:(id)arg1;
...
- (void)setEffectiveGlobalHighlightsSetting:(long long)arg1 withHandler:(id /* block */)arg2;
...
- (void)setEffectiveGlobalSummarizationSetting:(long long)arg1 withHandler:(id /* block */)arg2;
...
- (void)withdrawBulletinID:(id)arg1 shouldSync:(bool)arg2;
- (void)withdrawBulletinRequestsWithPublisherBulletinID:(id)arg1 shouldSync:(bool)arg2 forSectionID:(id)arg3;
