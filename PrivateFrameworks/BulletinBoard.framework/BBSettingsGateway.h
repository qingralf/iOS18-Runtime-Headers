...
- (void)getEffectiveGlobalHighlightsSettingWithCompletion:(id /* block */)arg1;
...
- (void)getEffectiveGlobalSummarizationSettingWithCompletion:(id /* block */)arg1;
...
- (void)setEffectiveGlobalHighlightsSetting:(long long)arg1;
