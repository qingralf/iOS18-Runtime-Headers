...
@interface BLTPBBulletin : PBCodable <NSCopying> {
    ...
    NSData * _eventBehavior;
    unsigned int  _feed;
    NSString * _filterCriteria;
    BLTPBAction * _followActivityAction;
    struct { 
        unsigned int date : 1; 
        unsigned int priorityNotificationStatus : 1; 
        ...
        unsigned int hasSubordinateIcon : 1; 
    ...
    double  _priorityNotificationStatus;
...
@property (nonatomic, retain) NSData *attributedMessage;
@property (nonatomic, retain) NSString *bulletinID;
@property (nonatomic, retain) NSString *category;
@property (nonatomic, retain) NSString *categoryID;
@property (nonatomic, retain) BLTPBCommunicationContext *communicationContext;
...
@property (nonatomic, retain) NSData *eventBehavior;
@property (nonatomic) unsigned int feed;
@property (nonatomic, retain) NSString *filterCriteria;
@property (nonatomic, retain) BLTPBAction *followActivityAction;
...
@property (nonatomic, readonly) bool hasAttributedMessage;
@property (nonatomic, readonly) bool hasBulletinID;
@property (nonatomic, readonly) bool hasCategory;
@property (nonatomic, readonly) bool hasCategoryID;
@property (nonatomic, readonly) bool hasCommunicationContext;
...
@property (nonatomic, readonly) bool hasEventBehavior;
@property (nonatomic, readonly) bool hasFilterCriteria;
@property (nonatomic, readonly) bool hasFollowActivityAction;
...
@property (nonatomic) bool hasPriorityNotificationStatus;
...
@property (nonatomic, readonly) bool hasThreadSummary;
...
@property (nonatomic, retain) NSData *threadSummary;
...
+ (void)_attachmentFromBBAttachmentMetadata:(id)arg1 bulletin:(id)arg2 observer:(id)arg3 fileOption:(unsigned long long)arg4 attachOption:(unsigned long long)arg5 completion:(id /* block */)arg6;
+ (id)_handleThumbnailResponse:(id)arg1 attachmentMetadata:(id)arg2 transcodedAttachmentSaveURL:(id)arg3 wantsData:(bool)arg4 imageContentType:(id)arg5;
...
+ (void)bulletinWithBBBulletin:(id)arg1 sockPuppetAppBundleID:(id)arg2 observer:(id)arg3 feed:(unsigned long long)arg4 teamID:(id)arg5 universalSectionID:(id)arg6 shouldUseExpirationDate:(bool)arg7 replyToken:(id)arg8 gizmoLegacyPublisherBulletinID:(id)arg9 gizmoLegacyCategoryID:(id)arg10 gizmoSectionID:(id)arg11 gizmoSectionSubtype:(id)arg12 useUserInfoForContext:(bool)arg13 removeSubtitleForOlderWatches:(bool)arg14 attachOption:(unsigned long long)arg15 completion:(id /* block */)arg16;
+ (Class)peopleIDsType;
...
- (bool)includesSound;
- (unsigned int)interruptionLevel;
...
- (void)setInterruptionLevel:(unsigned int)arg1;
...
- (void)setPriorityNotificationStatus:(double)arg1;
