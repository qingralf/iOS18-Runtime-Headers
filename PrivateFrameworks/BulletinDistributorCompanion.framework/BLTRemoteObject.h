...
@property (nonatomic, retain) BLTSimpleCache *mruCacheOfReceives;
@property (nonatomic, retain) BLTSimpleCache *mruCacheOfSends;
...
- (void)_queuePerformSend:(id /* block */)arg1 responseToRequest:(id)arg2 withTimeout:(id)arg3 withDescription:(id)arg4 shortDescription:(id)arg5 onlyOneFor:(id)arg6 allowCloudDelivery:(bool)arg7 nonWaking:(bool)arg8 didSend:(id /* block */)arg9 andResponse:(id /* block */)arg10;
...
- (void)setMruCacheOfReceives:(id)arg1;
- (void)setMruCacheOfSends:(id)arg1;
