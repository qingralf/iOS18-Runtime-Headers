...
@interface BCSICloudServerEnvironment : NSObject <BCSICloudServerEnvironmentProtocol, BCSPIRServerEnvironmentProviding, BSDescriptionProviding> {
...
- (bool)isStagingMode;
- (id)pirEnvironmentForServerType:(long long)arg1;
