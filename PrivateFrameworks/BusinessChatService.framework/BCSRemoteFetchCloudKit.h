...
@interface BCSRemoteFetchCloudKit : NSObject <BCSConfigRemoteFetching, BCSItemRemoteFetching, BCSMegashardRemoteFetching, BCSShardItemInstantiating, BCSShardRemoteFetching, BSDescriptionProviding> {
    ...
    <BCSCloudKitContainerProtocol> * _databaseContainer;
    <BCSICloudServerEnvironmentProtocol><BCSPIRServerEnvironmentProviding> * _environment;
...
@property (nonatomic, readonly, retain) <BCSICloudServerEnvironmentProtocol><BCSPIRServerEnvironmentProviding> *environment;
...
- (void)fetchConfigItemWithType:(long long)arg1 clientBundleID:(id)arg2 systemTask:(id)arg3 completion:(id /* block */)arg4;
...
- (void)fetchMegashardItemWithType:(long long)arg1 clientBundleID:(id)arg2 systemTask:(id)arg3 completion:(id /* block */)arg4;
