...
@interface CAFCombine.CAFSoundDistributionObservable : NSObject <CAFSoundDistributionObserver> {
    void _balance;
    void _fade;
...
- (void)soundDistributionService:(id)arg1 didUpdateBalance:(BOOL)arg2;
- (void)soundDistributionService:(id)arg1 didUpdateFade:(BOOL)arg2;
