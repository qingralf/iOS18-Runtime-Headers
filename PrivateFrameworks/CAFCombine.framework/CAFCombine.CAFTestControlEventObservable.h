...
@interface CAFCombine.CAFTestControlEventObservable : NSObject <CAFTestControlEventObserver> {
...
- (void)testControlEventServiceDidUpdateTestDevEventNoParams:(id)arg1;
- (void)testControlEventServiceDidUpdateTestDevEventWithParams:(id)arg1;
