...
@interface CAFCombine.CAFZonesSyncedObservable : NSObject <CAFZonesSyncedObserver> {
    void _name;
    void _on;
...
- (void)zonesSyncedService:(id)arg1 didUpdateName:(id)arg2;
- (void)zonesSyncedService:(id)arg1 didUpdateOn:(bool)arg2;
- (void)zonesSyncedService:(id)arg1 didUpdateVehicleLayoutKey:(id)arg2;
