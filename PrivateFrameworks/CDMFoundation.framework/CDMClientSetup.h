...
@property (nonatomic, readonly) bool shouldPerformWarmup;
...
- (id)initWithLocaleIdentifier:(id)arg1 sandboxId:(id)arg2 activeServiceGraph:(id)arg3 assetDirPath:(id)arg4 overrideSiriVocabSpans:(id)arg5 serviceStateDirectory:(id)arg6 embeddingVersion:(id)arg7 nlSetupId:(id)arg8 invocationSource:(id)arg9 shouldPerformWarmup:(bool)arg10;
- (id)invocationSource;
- (id)localeIdentifier;
- (id)nlSetupId;
