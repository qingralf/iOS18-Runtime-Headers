...
+ (bool)cdmAllServicesWarmupEnded:(id)arg1 logMessage:(id)arg2 dataDispatcherContext:(id)arg3;
+ (bool)cdmAllServicesWarmupFailed:(id)arg1 logMessage:(id)arg2 dataDispatcherContext:(id)arg3;
+ (bool)cdmAllServicesWarmupStarted:(id)arg1 logMessage:(id)arg2 dataDispatcherContext:(id)arg3;
...
+ (bool)cdmClientWarmupEnded:(id)arg1 logMessage:(id)arg2 dataDispatcherContext:(id)arg3;
+ (bool)cdmClientWarmupFailed:(id)arg1 errorDomain:(int)arg2 errorCode:(unsigned int)arg3 logMessage:(id)arg4 dataDispatcherContext:(id)arg5;
+ (bool)cdmClientWarmupStarted:(id)arg1 logMessage:(id)arg2 currentServiceGraph:(int)arg3 dataDispatcherContext:(id)arg4;
...
+ (id)createSELFMetadataWithNlId:(id)arg1 andWithTrpId:(id)arg2 andWithRequestId:(id)arg3 andWithResultCandidateId:(id)arg4 andWithConnectionId:(id)arg5;
