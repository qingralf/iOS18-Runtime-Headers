...
+ (bool)isServiceRequiredForSetup:(id)arg1;
...
- (id)getGraphInput;
- (id)getGraphOutput;
- (id)getGraphServiceByClass:(Class)arg1;
- (id)getHandlerId;
- (id)getLanguage;
- (id)getNodes;
- (id)getNodesWithName;
...
- (id)initWithServices:(id)arg1 graphServices:(id)arg2 graphInput:(id)arg3 languageCode:(id)arg4 handlerId:(id)arg5 aneLock:(id)arg6 dataDispatcherContext:(id)arg7;
- (bool)isAcyclic;
