...
- (id)initWithTuningParametersByPortType:(id)arg1 videoStabilizationStrength:(int)arg2 bravoTelephotoEnabled:(bool)arg3 attachDebugFrameStatistics:(bool)arg4;
