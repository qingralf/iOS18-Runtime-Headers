...
@interface BWBravoPortraitSceneMonitorV3 : NSObject <BWPortraitSceneMonitor> {
    ...
    bool  _personSegmentationStatusEnabled;
    ...
    bool  _stageSegmentationMonitoringEnabled;
...
@property (nonatomic, readonly) float zoomFactorForTuningParameters;
...
- (id)initWithTuningParameters:(id)arg1 zoomFactor:(float)arg2 portraitAutoSuggestEnabled:(bool)arg3 shallowDepthOfFieldEnabled:(bool)arg4 attachDebugFrameStatistics:(bool)arg5;
...
- (void)setSDOFBackgroundShiftSum:(float)arg1 invalidShiftRatio:(float)arg2 closeCanonicalDisparityAverage:(float)arg3 faceCanonicalDisparityAverages:(id)arg4 erodedForegroundRatio:(float)arg5 foregroundRatio:(float)arg6 occluded:(bool)arg7 faces:(id)arg8 personSegmentationRatio:(float)arg9;
- (void)setShallowDepthOfFieldRenderingEnabled:(bool)arg1;
- (bool)shallowDepthOfFieldRenderingEnabled;
- (void)updateTuningParameters:(id)arg1 zoomFactor:(float)arg2;
