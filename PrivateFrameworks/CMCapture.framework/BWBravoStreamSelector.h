...
@interface BWBravoStreamSelector : NSObject {
    ...
    bool  _superWideAllowedInAutoFlashScenes;
    struct { 
        long long value; 
        int timescale; 
        unsigned int flags; 
...
- (id)recommendMasterStreamUsingCurrentMasterStream:(id)arg1 frameStatisticsByPortType:(id)arg2 zoomFactor:(float)arg3 isAutoFlashScene:(bool)arg4 digitalFlashMode:(int)arg5 detectedObjects:(id)arg6 cameraControlsStatisticsMasterStream:(id)arg7;
