...
- (void)setCameraAccess:(bool)arg1 deviceType:(int)arg2 clientAuditToken:(struct { unsigned int x1[8]; })arg3 tccIdentity:(id)arg4 mediaEnvironment:(id)arg5 completionHandler:(id /* block */)arg6;
- (void)setStreaming:(bool)arg1 deviceType:(int)arg2 streamUniqueID:(id)arg3 clientAuditToken:(struct { unsigned int x1[8]; })arg4 tccIdentity:(id)arg5 mediaEnvironment:(id)arg6 completionHandler:(id /* block */)arg7;
