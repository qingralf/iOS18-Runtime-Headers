...
- (int)commitInferenceBuffer:(struct __CVBuffer { }*)arg1 tag:(id)arg2 metadataTag:(id)arg3 inferenceAttachedMediaKey:(id)arg4 compressionProfile:(int)arg5 portType:(id)arg6;
...
- (int)waitForFlush;
- (int)waitForFlushWithTimeoutInSeconds:(int)arg1;
