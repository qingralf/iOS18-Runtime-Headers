...
- (id)initWithOutputDimensions:(struct { int x1; int x2; })arg1 cameraInfoByPortType:(id)arg2 horizontalSensorBinningFactor:(int)arg3 verticalSensorBinningFactor:(int)arg4 stillImageCaptureEnabled:(bool)arg5 objectMetadataIdentifiers:(id)arg6 maxLossyCompressionLevel:(int)arg7 portType:(id)arg8 overheadCameraMode:(int)arg9 captureDevice:(id)arg10;
- (id)nodeSubType;
- (id)nodeType;
