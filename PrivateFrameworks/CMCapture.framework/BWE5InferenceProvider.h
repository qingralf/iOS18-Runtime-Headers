...
@interface BWE5InferenceProvider : NSObject <BWEspressoInferenceBinding, BWEspressoInferencePropagatable, BWInferenceExecutable, BWInferenceProvider, BWInferenceSubmittable> {
...
- (int)executionTarget;
- (id)extractable;
- (id)initWithType:(int)arg1 networkURL:(id)arg2 networkConfiguration:(id)arg3 context:(id)arg4 executionTarget:(int)arg5 schedulerPriority:(unsigned int)arg6 preventionReasons:(id)arg7 resourceProvider:(id)arg8 allowedCompressionDirection:(unsigned int)arg9;
