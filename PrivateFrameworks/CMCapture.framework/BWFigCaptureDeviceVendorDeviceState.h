...
@property (nonatomic, readonly) NSMutableDictionary *tofAFEstimatorResultsStreamingTimeByPortType;
...
- (void)setInUseForVibeMitigation:(bool)arg1;
...
- (id)tofAFEstimatorResultsStreamingTimeByPortType;
