...
- (void)fileWriter:(id)arg1 frameDroppedForSettingsID:(unsigned long long)arg2 withError:(int)arg3;
...
- (void)fileWriter:(id)arg1 startedRecordingForSettings:(id)arg2 writerPipelineIndex:(unsigned long long)arg3 startPTS:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg4;
...
- (void)node:(id)arg1 format:(id)arg2 didBecomeLiveForInput:(id)arg3 configurationID:(long long)arg4;
...
- (void)previewStitcher:(id)arg1 didApplyWiderShift:(struct CGPoint { double x1; double x2; })arg2 widerScaleFactor:(float)arg3 forWiderPortType:(id)arg4 narrowerShift:(struct CGPoint { double x1; double x2; })arg5 narrowerScaleFactor:(float)arg6 forNarrowerPortType:(id)arg7 inSuperWideMacroMode:(bool)arg8 widerShiftAtBaseZoom:(struct CGPoint { double x1; double x2; })arg9;
- (void)previewStitcher:(id)arg1 overCaptureStatusDidChange:(int)arg2;
- (void)previewStitcherReadyForPrimaryCaptureRectUpdates:(id)arg1;
- (void)previewStitcherTrueVideoExitTransitionDidComplete:(id)arg1;
- (void)remoteQueueSinkNode:(id)arg1 dumpStateForReason:(id)arg2;
