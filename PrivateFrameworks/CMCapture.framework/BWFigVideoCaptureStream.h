...
@interface BWFigVideoCaptureStream : NSObject <BWFigCaptureStreamStartStopDelegate, BWPortraitEffectPropertiesDelegate> {
    ...
    bool  _blackenFramesForContinuityDisplayConnected;
    ...
    bool  _visionDataRequiredWhenConfiguredAsSlave;
...
@property (nonatomic, readonly) struct { int x1; int x2; } activeSensorDimensions;
...
@property (nonatomic) bool blackenFramesForContinuityDisplayConnected;
...
@property (nonatomic, readonly, retain) NSString *mediaEnvironment;
...
@property (getter=isMultipleSensorRawBufferPoolsSupported, nonatomic, readonly) bool multipleSensorRawBufferPoolsSupported;
@property (readonly) NSString *nonLocalizedName;
@property (getter=isNondisruptiveFastSwitchingSupported, nonatomic, readonly) bool nondisruptiveFastSwitchingSupported;
...
@property struct CGPoint { double x1; double x2; } previewShiftAtBaseZoom;
...
@property (nonatomic, readonly) BWSecureMetadataOutputConfigurator *secureMetadataOutputConfigurator;
...
- (struct { int x1; int x2; })activeSensorDimensions;
...
- (id)initWithCaptureStream:(id)arg1 parentDevice:(id)arg2 attributes:(id)arg3 sensorIDDictionary:(id)arg4 synchronizedStreamsGroup:(id)arg5 applicationID:(id)arg6 clientAuditToken:(struct { unsigned int x1[8]; })arg7 tccIdentity:(id)arg8 mediaEnvironment:(id)arg9 error:(int*)arg10;
...
- (id)noiseReductionAndSharpeningConfigurationForType:(int)arg1 gain:(float)arg2 qSub:(bool)arg3;
- (id)nonLocalizedName;
...
- (struct CGPoint { double x1; double x2; })previewShiftAtBaseZoom;
...
- (id)secureMetadataOutputConfigurator;
...
- (void)serviceNondisruptiveSwitchingFormatForZoomFactor:(float)arg1 frameStatistics:(id)arg2 imageControlMode:(int)arg3 stillImageDigitalFlashMode:(int)arg4 isStationary:(bool)arg5 binnedSIFROnSecondaryStreamAllowed:(bool)arg6 ignoreZoomFactorAndQuadraSubPixelSceneMonitoring:(bool)arg7 ultraHighResolutionZeroShutterLagEnabled:(bool)arg8;
- (int)setActiveFormatIndex:(int)arg1;
- (int)setActiveNondisruptiveSwitchingFormatIndex:(int)arg1;
- (int)setActiveNondisruptiveSwitchingFormatIndex:(int)arg1 maximumAllowedFrameRate:(int)arg2 minimumFrameRate:(int)arg3 maximumFrameRate:(int)arg4;
...
- (void)setBlackenFramesForContinuityDisplayConnected:(bool)arg1;
...
- (void)setCompletedNondisruptiveSwitchingCommandID:(int)arg1;
...
- (void)setFastSwitchingMainFormatIndex:(int)arg1;
...
- (void)setMaximumFrameRateForSensorRawOutputBufferPoolRequirements:(float)arg1;
...
- (void)setPreviewShiftAtBaseZoom:(struct CGPoint { double x1; double x2; })arg1;
...
- (void)setTemporalNoiseReductionConfigurationBand0Enabled:(bool)arg1 rawEnabled:(bool)arg2 modulation:(int)arg3 adaptiveOverscanEnabled:(bool)arg4 strengthHighEnabled:(bool)arg5;
...
- (void)setVisionDataRequiredWhenConfiguredAsSlave:(bool)arg1;
...
- (void)setZoomFactorToNondisruptiveSwitchingFormatIndexSIFRBinned:(id)arg1 zoomFactorToNondisruptiveSwitchingFormatIndexSIFRNonBinned:(id)arg2 ultraHighResolutionNondisruptiveStreamingFormatIndex:(int)arg3 mainFormatSIFRBinningFactor:(int)arg4 quadraSubPixelSwitchingParameters:(id)arg5;
...
- (void)sourceNodeDidStopStreaming:(bool)arg1;
...
- (int)synchronizedStreamsGroupDidUpdateActiveNondisruptiveSwitchingFormatIndex:(int)arg1 activeNondisruptiveSwitchingCommandID:(int)arg2 maximumAllowedFrameRate:(int)arg3 minimumFrameRate:(int)arg4 maximumFrameRate:(int)arg5;
- (id)tccIdentity;
