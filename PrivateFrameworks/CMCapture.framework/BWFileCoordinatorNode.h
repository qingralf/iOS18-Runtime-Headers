...
- (id)init;
- (id)initWithNumberOfVideoInputs:(unsigned long long)arg1 numberOfAudioInputs:(unsigned long long)arg2 numberOfMetadataInputs:(unsigned long long)arg3 numberOfActionOnlyOutputs:(unsigned long long)arg4 overCaptureEnabled:(bool)arg5 allowLowLatencyWhenPossible:(bool)arg6 useTrueVideoFileRecordingStaging:(bool)arg7 motionDataTimeMachine:(id)arg8;
- (id)nodeSubType;
- (id)nodeType;
- (void)pauseRecording;
...
- (void)stopRecordingWithErrorCode:(int)arg1 setupToAllowWaitingForRecordingToStop:(bool)arg2;
...
- (void)waitForRecordingToStopWithTimeout:(float)arg1;
