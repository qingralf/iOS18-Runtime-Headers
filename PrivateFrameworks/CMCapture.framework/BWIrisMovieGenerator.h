...
- (bool)flush;
- (bool)flushAsync;
- (id)initWithReadableByteStream:(struct OpaqueCMByteStream { }*)arg1 forFrontFacingCamera:(bool)arg2 forExternalCamera:(bool)arg3 clientExpectsCameraMountedInLandscapeOrientation:(bool)arg4 sampleReferenceMoviesEnabled:(bool)arg5 movieGenerationQueue:(id)arg6 irisStillImageMovieMetadataCache:(id)arg7 videoOrientationTimeMachine:(id)arg8;
