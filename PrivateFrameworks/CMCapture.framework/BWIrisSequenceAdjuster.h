...
@property (nonatomic, readonly) struct { long long x1; int x2; unsigned int x3; long long x4; } previewFrameDuration;
...
- (id)initWithMediaTypes:(id)arg1 visMotionMetadataPreloadingEnabled:(bool)arg2 generateIFrames:(bool)arg3 attachedMediaKeysToPreserve:(id)arg4;
...
- (struct { long long x1; int x2; unsigned int x3; long long x4; })previewFrameDuration;
