...
@interface BWIrisStagingNode : BWNode {
    ...
    bool  _firstIrisRequestRequiresSubjectRelightingHasBeenProcessed;
    struct { 
        long long value; 
        int timescale; 
        unsigned int flags; 
