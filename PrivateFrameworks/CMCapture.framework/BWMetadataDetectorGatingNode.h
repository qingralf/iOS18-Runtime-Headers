...
- (id)initWithMRCEnabled:(bool)arg1 appClipCodeEnabled:(bool)arg2 textLocalizationEnabled:(bool)arg3 lowPowerModeEnabled:(bool)arg4 compressed8BitInputEnabled:(bool)arg5;
- (id)initWithSceneClassifierVersion:(struct { unsigned short x1; unsigned short x2; unsigned short x3; })arg1 mrcEnabled:(bool)arg2 appClipCodeEnabled:(bool)arg3 textLocalizationEnabled:(bool)arg4 lowPowerModeEnabled:(bool)arg5 compressed8BitInputEnabled:(bool)arg6;
- (id)mrcOutput;
