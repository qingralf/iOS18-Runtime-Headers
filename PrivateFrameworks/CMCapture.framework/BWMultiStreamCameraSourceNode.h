...
@interface BWMultiStreamCameraSourceNode : BWSourceNode <BWFigVideoCaptureDeviceZoomFactorChangedDelegate, BWSecureMetadataOutputConfiguratorDelegate> {
    ...
    bool  _emitsFramesWhileStopping;
    ...
    struct BWStreamOutputStorage { 
        ...
        bool incrementalPrefetchEnabled; 
    ...
    bool  _updateMetadataOutputWithoutDisabling;
...
@property (nonatomic, readonly) struct { int x1; int x2; } zoomBasedQSubSensorRawStillImageOutputDimensions;
...
- (id)secureDetectedObjectsOutput;
- (int)secureMetadataOutputConfigurationDidChange:(id)arg1;
- (id)semanticMasksOutput;
- (void)setDetectedFacesFilterDelegate:(id)arg1;
- (void)setEmitsFramesWhileStopping:(bool)arg1;
- (void)setKeepISPStreamingWhenStopping:(bool)arg1;
- (void)setPowerOptimizedVISOverscanEnabled:(bool)arg1;
- (void)setPreviewShift:(struct CGPoint { double x1; double x2; })arg1 previewScaleFactor:(float)arg2 previewShiftAtBaseZoom:(struct CGPoint { double x1; double x2; })arg3;
- (bool)start:(id*)arg1;
- (void)startIncrementalPrefetchingOfSourcePoolsIfNecessary;
- (id)stillImageOutput;
- (id)stillImageSensorRawOutput;
- (bool)stop:(id*)arg1;
- (id)trackedFacesOutput;
...
- (struct { int x1; int x2; })zoomBasedQSubSensorRawStillImageOutputDimensions;
