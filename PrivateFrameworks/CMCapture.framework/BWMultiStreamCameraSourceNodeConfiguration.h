...
@interface BWMultiStreamCameraSourceNodeConfiguration : NSObject {
    ...
    bool  _colorPostProcessingSkyEnhancementEnabled;
    int  _colorSpace;
    ...
    int  _faceTrackingNumTrackedFaces;
    bool  _faceTrackingUseRecognition;
    ...
    bool  _multiIlluminantWhiteBalanceEnabled;
    ...
    bool  _postColorProcessingThumbnailOnPreviewOutputEnabled;
    bool  _postColorProcessingThumbnailOnVideoCaptureOutputEnabled;
    struct { 
        int width; 
        int height; 
    }  _postGDCCropDimensions;
    bool  _preLTMThumbnailOnPreviewOutputEnabled;
    bool  _preLTMThumbnailOnVideoCaptureOutputEnabled;
    bool  _preLTMThumbnailOutputEnabled;
    bool  _preLTMThumbnailThumbnailOnVideoCaptureOutputEnabled;
    struct { 
        int width; 
        int height; 
    ...
    bool  _videoCaptureDimensionsIncludeVISOverscan;
...
@property (nonatomic) bool colorPostProcessingSkyEnhancementEnabled;
...
@property (nonatomic) bool faceTrackingUseRecognition;
@property (nonatomic) unsigned int fastSwitchingMainFormatIndex;
@property (nonatomic) float fastSwitchingMainFormatMaxFrameRate;
@property (nonatomic, retain) NSArray *fastSwitchingNondisruptiveFormatIndices;
...
@property (nonatomic) bool multiIlluminantWhiteBalanceEnabled;
...
@property (nonatomic) bool postColorProcessingThumbnailOnPreviewOutputEnabled;
@property (nonatomic) bool postColorProcessingThumbnailOnVideoCaptureOutputEnabled;
@property (nonatomic) struct { int x1; int x2; } postGDCCropDimensions;
@property (nonatomic) bool preLTMThumbnailOnPreviewOutputEnabled;
@property (nonatomic) bool preLTMThumbnailOnVideoCaptureOutputEnabled;
@property (nonatomic) bool preLTMThumbnailOutputEnabled;
...
@property (nonatomic, retain) NSDictionary *quadraSubPixelSwitchingParameters;
...
@property (nonatomic, copy) BWSecureMetadataOutputConfiguration *secureMetadataOutputConfiguration;
...
@property (nonatomic) bool videoCaptureDimensionsIncludeVISOverscan;
...
- (unsigned int)fastSwitchingMainFormatIndex;
- (float)fastSwitchingMainFormatMaxFrameRate;
- (id)fastSwitchingNondisruptiveFormatIndices;
...
- (id)secureMetadataOutputConfiguration;
...
- (void)setColorPostProcessingSkyEnhancementEnabled:(bool)arg1;
...
- (void)setFaceTrackingNumTrackedFaces:(int)arg1;
- (void)setFaceTrackingUseRecognition:(bool)arg1;
- (void)setFastSwitchingMainFormatIndex:(unsigned int)arg1;
- (void)setFastSwitchingMainFormatMaxFrameRate:(float)arg1;
- (void)setFastSwitchingNondisruptiveFormatIndices:(id)arg1;
...
- (void)setMultiIlluminantWhiteBalanceEnabled:(bool)arg1;
...
- (void)setPostColorProcessingThumbnailOnPreviewOutputEnabled:(bool)arg1;
- (void)setPostColorProcessingThumbnailOnVideoCaptureOutputEnabled:(bool)arg1;
- (void)setPostGDCCropDimensions:(struct { int x1; int x2; })arg1;
- (void)setPreLTMThumbnailOnPreviewOutputEnabled:(bool)arg1;
- (void)setPreLTMThumbnailOnVideoCaptureOutputEnabled:(bool)arg1;
- (void)setPreLTMThumbnailOutputEnabled:(bool)arg1;
...
- (void)setQuadraSubPixelSwitchingParameters:(id)arg1;
...
- (void)setSecureMetadataOutputConfiguration:(id)arg1;
...
- (void)setVideoCaptureDimensionsIncludeVISOverscan:(bool)arg1;
