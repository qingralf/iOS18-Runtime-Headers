...
@interface BWNodeOutputMediaConfiguration : NSObject {
    ...
    bool  _pixelBufferPoolReportSlowBackPressureAllocations;
...
- (void)setOwningNodeIndefinitelyHeldBufferCount:(int)arg1;
...
- (void)setPixelBufferPoolReportSlowBackPressureAllocations:(bool)arg1;
