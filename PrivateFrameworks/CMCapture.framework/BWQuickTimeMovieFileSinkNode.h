...
@interface BWQuickTimeMovieFileSinkNode : BWFileSinkNode {
    ...
    bool  _collectedAnalyticsForModuleAndCalibrationValidationStatuses;
    struct { 
        long long value; 
        int timescale; 
        unsigned int flags; 
    ...
    BWStats * _irisVideoFrameDurationStats;
    ...
    struct { 
        ...
        unsigned int flags; 
        long long epoch; 
    }  _pendingMovieSegmentMetadataPTS;
...
@property (nonatomic, retain) NSArray *nonCriticalAudioVideoTrackInputIndices;
...
@property (nonatomic, copy) NSArray *trackReferenceListForAudioRemixInputs;
@property (nonatomic, copy) NSArray *trackReferenceListForMetadataInputs;
@property (nonatomic, copy) NSArray *trackReferenceListForRenderMetadataInputs;
...
- (id)nodeSubType;
- (id)nonCriticalAudioVideoTrackInputIndices;
- (int)pipelineTraceID;
...
- (void)setNonCriticalAudioVideoTrackInputIndices:(id)arg1;
...
- (void)setTrackReferenceListForAudioRemixInputs:(id)arg1;
- (void)setTrackReferenceListForMetadataInputs:(id)arg1;
- (void)setTrackReferenceListForRenderMetadataInputs:(id)arg1;
...
- (id)trackReferenceListForAudioRemixInputs;
- (id)trackReferenceListForMetadataInputs;
- (id)trackReferenceListForRenderMetadataInputs;
