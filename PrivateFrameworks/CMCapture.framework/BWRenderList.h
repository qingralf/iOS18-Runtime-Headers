...
@property (nonatomic, readonly) bool hasMetalColorCubeRenderer;
...
- (id)initWithResourceProvider:(id)arg1 originalFilters:(id)arg2 processedFilters:(id)arg3 optimizationStrategy:(short)arg4 stillImageSettings:(id)arg5;
- (bool)isPrepared;
- (id)originalFilterNames;
- (struct BWRenderListParameterList { struct BWRenderListParameterNode {} *x1; }*)parameterList;
- (void)prepareWithParameters:(id)arg1 forInputVideoFormat:(id)arg2 inputMediaPropertiesByAttachedMediaKey:(id)arg3;
