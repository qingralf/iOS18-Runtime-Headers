...
- (id)finalParameters;
- (id)finalRenderList;
- (id)initWithInitialParameters:(id)arg1 initialRenderList:(id)arg2 finalParameters:(id)arg3 finalRenderList:(id)arg4 animation:(long long)arg5;
...
- (bool)isPrepared;
- (id)parameters;
- (void)prepareWithInputVideoFormat:(id)arg1 inputMediaPropertiesByAttachedMediaKey:(id)arg2;
- (id)renderList;
