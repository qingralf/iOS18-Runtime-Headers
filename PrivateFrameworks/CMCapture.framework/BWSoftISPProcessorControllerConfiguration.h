...
@interface BWSoftISPProcessorControllerConfiguration : BWStillImageProcessorControllerConfiguration {
    bool  _auxiliaryTypesForFocusPixelDisparityEnabled;
    bool  _cmiResourceEnabled;
    bool  _deepFusionEnabled;
    bool  _documentScanningEnabled;
    bool  _gdcEnabled;
    struct { 
        int width; 
        int height; 
    }  _inputDimensions;
    NSDictionary * _inputDimensionsByQSubResolutionFlavorByPortType;
    bool  _learnedNREnabled;
    bool  _linearRGBForDisparityEnabled;
    int  _lossyCompressionLevel;
    bool  _lowlightSFHRSupportEnabled;
    bool  _ltmHDRCurvesEnabled;
    struct { 
        int width; 
        int height; 
    }  _outputDimensions;
    NSDictionary * _outputDimensionsByQSubResolutionFlavor;
...
@property (nonatomic) bool auxiliaryTypesForFocusPixelDisparityEnabled;
@property (nonatomic) bool cmiResourceEnabled;
@property (nonatomic) bool deepFusionEnabled;
@property (nonatomic) bool documentScanningEnabled;
@property (nonatomic) bool gdcEnabled;
@property (nonatomic) struct { int x1; int x2; } inputDimensions;
@property (nonatomic, retain) NSDictionary *inputDimensionsByQSubResolutionFlavorByPortType;
...
@property (nonatomic) bool lowlightSFHRSupportEnabled;
@property (nonatomic) bool ltmHDRCurvesEnabled;
@property (nonatomic) struct { int x1; int x2; } outputDimensions;
@property (nonatomic, retain) NSDictionary *outputDimensionsByQSubResolutionFlavor;
...
- (id)inputDimensionsByQSubResolutionFlavorByPortType;
...
- (id)outputDimensionsByQSubResolutionFlavor;
