...
@interface BWStillImageCaptureMetadata : NSObject <NSSecureCoding> {
    ...
    int  _devicePosition;
    int  _deviceType;
    NSDictionary * _exifFocalLengthMultiplierByPortType;
...
@property (nonatomic, retain) NSDictionary *exifFocalLengthMultiplierByPortType;
...
- (id)exifFocalLengthMultiplierByPortType;
...
- (void)setExifFocalLengthMultiplierByPortType:(id)arg1;
- (void)setExifFocalLengthOverride:(float)arg1;
