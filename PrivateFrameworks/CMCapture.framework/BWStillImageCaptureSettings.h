...
@property (nonatomic, readonly) NSArray *secondaryPortTypes;
...
- (unsigned long long)learnedNRStereoPhotoFrameFlag;
- (id)masterPortType;
- (id)metadata;
- (id)portTypes;
...
- (void)setLearnedNRStereoPhotoFrameFlag:(unsigned long long)arg1;
...
- (void)setStreamSelectorDebugInfo:(id)arg1;
