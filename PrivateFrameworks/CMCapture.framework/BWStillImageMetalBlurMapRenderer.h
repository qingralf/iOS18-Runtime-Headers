...
- (void)dealloc;
- (id)displayName;
- (id)initWithSDOFRenderingTuningParameters:(id)arg1 imageDimensions:(struct { int x1; int x2; })arg2 depthDataMapDimensions:(struct { int x1; int x2; })arg3 portraitRenderQuality:(int)arg4 metalCommandQueue:(id)arg5 backPressureDrivenPipelining:(bool)arg6;
