...
@interface BWStreamingCVAFilterRenderer : NSObject <BWFilterRenderer> {
    ...
    struct { 
        ...
        bool previousPortraitRequestFellbackToNonDepthRendering; 
...
- (void)dealloc;
- (id)displayName;
- (id)initWithCaptureDevice:(id)arg1 studioAndContourRenderingEnabled:(bool)arg2 stageRenderingEnabled:(bool)arg3 depthDataSource:(int)arg4 foregroundBlurEnabled:(bool)arg5 depthFilterRenderingIsAfterPreviewStitcher:(bool)arg6 commandQueue:(id)arg7 priority:(unsigned int)arg8 mirroredForMetadataAdjustment:(bool)arg9 rotationDegreesForMetadataAdjustment:(int)arg10 secondaryStreamingPersonSegmentationEnabled:(bool)arg11;
