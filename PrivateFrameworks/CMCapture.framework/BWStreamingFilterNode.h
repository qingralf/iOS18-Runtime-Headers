...
- (id)filters;
- (id)initWithCaptureDevice:(id)arg1 maxLossyCompressionLevel:(int)arg2 semanticStyleRenderingEnabled:(bool)arg3 cinematicVideoEnabled:(bool)arg4 smartStyleRenderingEnabled:(bool)arg5 portraitPreviewForegroundBlurEnabled:(bool)arg6 depthFilterRenderingIsAfterPreviewStitcher:(bool)arg7 metalCommandQueue:(id)arg8 priority:(unsigned int)arg9 mirroredForMetadataAdjustment:(bool)arg10 rotationDegreesForMetadataAdjustment:(int)arg11;
...
- (void)setPrimaryStreamingPersonSegmentationEnabled:(bool)arg1;
- (void)setSecondaryStreamingPersonSegmentationEnabled:(bool)arg1;
