...
@interface BWTiledInferenceProvider : NSObject <BWInferencePropagatable, BWInferenceProvider, BWInferenceSubmittable> {
...
- (int)createInputTileFor:(void *)arg1 to:(void *)arg2 withInputs:(void *)arg3 atPosition:(void *)arg4 encodeToCmdBuffer:(void *)arg5; // needs 5 arg types, found 4: id, id, id, id
- (void)dealloc;
- (id)executable;
- (int)executionTarget;
- (id)extractable;
...
- (int)preProcessOutputTexture:(id)arg1 forMediaKey:(id)arg2 encodeToCmdBuffer:(id)arg3;
...
- (id)submittable;
- (int)type;
- (int)writeOutputFor:(void *)arg1 to:(void *)arg2 fromNetworkOutputTiles:(void *)arg3 withAdditionalTextures:(void *)arg4 withInputTileTextures:(void *)arg5 withInputFullTextures:(void *)arg6 atPosition:(void *)arg7 encodeToCmdBuffer:(void *)arg8; // needs 8 arg types, found 7: id, id, id, id, id, id, id
