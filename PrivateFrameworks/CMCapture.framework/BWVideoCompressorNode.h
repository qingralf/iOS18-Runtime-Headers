...
- (id)initWithCompressionSettings:(id)arg1 overCaptureEnabled:(bool)arg2 stereoVideoCompressionEnabled:(bool)arg3 maxVideoFrameRate:(float)arg4 delayedCompressorCleanupEnabled:(bool)arg5 maxLossyCompressionLevel:(int)arg6;
- (void)insertKeyFrame;
...
- (void)setCompressionPropertiesOverrides:(id)arg1;
...
- (void)setStereoVideoBaseline:(float)arg1;
