...
- (float)removeFudgeFromZoomFactor:(float)arg1;
...
- (void)setTypicalISPZoomDelay:(unsigned int)arg1 maxISPZoomDelay:(unsigned int)arg2 clientCanCompensateForDelay:(bool)arg3;
...
- (void)updateISPZoomDelay:(unsigned int)arg1;
