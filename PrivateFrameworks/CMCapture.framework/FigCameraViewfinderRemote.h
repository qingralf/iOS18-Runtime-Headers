...
- (void)viewfinderSessionDidBegin:(id)arg1 withIdentifier:(long long)arg2 clientAuditTokenData:(id)arg3 usesPhotoOutput:(bool)arg4 usesMovieFileOutput:(bool)arg5;
...
- (void)viewfinderSessionWillBegin:(id)arg1 withIdentifier:(long long)arg2 clientAuditTokenData:(id)arg3 usesPhotoOutput:(bool)arg4 usesMovieFileOutput:(bool)arg5;
