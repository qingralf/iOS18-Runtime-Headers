...
@interface FigCameraViewfinderServer : NSObject <FigCameraViewfinderDelegate, FigCameraViewfinderSessionDelegate, FigCaptureOSStateDataProvider, NSXPCListenerDelegate> {
...
- (void)cameraViewfinder:(id)arg1 viewfinderSessionWillBegin:(id)arg2;
...
- (void)cameraViewfinderSessionDidFinishMovieRecording:(id)arg1;
- (void)cameraViewfinderSessionDidStartMovieRecording:(id)arg1;
