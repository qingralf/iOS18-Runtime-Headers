...
@property (nonatomic, readonly) NSObject<OS_tcc_identity> *mediaEnvironmentTCCIdentity;
...
- (id)initWithClientAuditToken:(struct { unsigned int x1[8]; })arg1 mediaEnvironment:(id)arg2 forThirdPartyTorch:(bool)arg3 applicationAndLayoutStateHandler:(id /* block */)arg4;
- (void)invalidate;
