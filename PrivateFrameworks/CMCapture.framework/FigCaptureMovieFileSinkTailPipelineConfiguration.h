...
@property (nonatomic, retain) BWNodeOutput *cinematicAudioSourceOutput;
...
- (void)setCinematicAudioSourceOutput:(id)arg1;
- (void)setDelayedCompressorCleanupEnabled:(bool)arg1;
- (void)setIndexOfAudioRemixInMetadataOutputs:(int)arg1;
