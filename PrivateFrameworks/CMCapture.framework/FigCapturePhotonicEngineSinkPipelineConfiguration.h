...
@interface FigCapturePhotonicEngineSinkPipelineConfiguration : FigCaptureBaseStillImageSinkPipelineConfiguration <NSSecureCoding> {
    ...
    int  _depthDataType;
    bool  _depthWithDeepFusionSupported;
...
@property (nonatomic) bool depthWithDeepFusionSupported;
...
@property (nonatomic, retain) NSDictionary *moduleCalibrationByPortType;
...
@property (nonatomic, retain) NSArray *portTypesWithRawNightModeEnabled;
...
- (id)portTypesWithRawNightModeEnabled;
...
- (void)setConstantColorVersion:(int)arg1;
...
- (void)setDepthWithDeepFusionSupported:(bool)arg1;
...
- (void)setPortTypesWithRawNightModeEnabled:(id)arg1;
