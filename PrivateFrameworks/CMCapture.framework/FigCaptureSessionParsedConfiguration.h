...
@property (nonatomic, readonly) bool clientIsVOIP;
...
@property (nonatomic, readonly) FigCaptureSmartStyle *smartStyle;
@property (nonatomic, readonly) long long smartStyleControlMode;
@property (nonatomic, readonly) bool smartStyleRenderingEnabled;
