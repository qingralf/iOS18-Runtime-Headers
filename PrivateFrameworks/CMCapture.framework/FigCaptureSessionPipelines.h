...
@property (nonatomic, readonly) FigCaptureCameraSourcePipeline *firstColorCameraSourcePipeline;
...
- (id)cameraSourcePipelineCompatibleWithCameraConfiguration:(id)arg1;
...
- (id)firstColorCameraSourcePipeline;
