...
@property (getter=isBackgroundReplacementProvidedBySource, readonly) bool backgroundReplacementProvidedBySource;
@property (getter=isBackgroundReplacementSupported, readonly) bool backgroundReplacementSupported;
@property (getter=isBackgroundReplacementSupportedForContinuityCapture, readonly) bool backgroundReplacementSupportedForContinuityCapture;
...
@property (getter=isConstantColorSupported, readonly) bool constantColorSupported;
...
@property (getter=isPocketDetectionSupported, nonatomic, readonly) bool pocketDetectionSupported;
...
@property (getter=isSmartStyleRenderingSupported, readonly) bool smartStyleRenderingSupported;
...
@property (getter=isStereoPhotoCaptureSupported, nonatomic, readonly) bool stereoPhotoCaptureSupported;
@property (getter=isStereoVideoCaptureSupported, nonatomic, readonly) bool stereoVideoCaptureSupported;
...
@property (getter=isUltraHighResolutionZeroShutterLagSupported, readonly) bool ultraHighResolutionZeroShutterLagSupported;
...
- (bool)shouldPreferSIFRFormatWithHighlightRecoveryEnabled:(bool)arg1;
