...
@interface FigCaptureStillImageSettings : NSObject <NSCopying, NSSecureCoding> {
    ...
    bool  _autoStereoPhotoCaptureEnabled;
    ...
    bool  _constantColorFallbackPhotoDeliveryEnabled;
...
- (void)setAutoStereoPhotoCaptureEnabled:(bool)arg1;
...
- (void)setConstantColorFallbackPhotoDeliveryEnabled:(bool)arg1;
...
- (void)setRawOutputFileBitDepth:(unsigned int)arg1;
- (void)setRawOutputFileCodec:(unsigned int)arg1;
- (void)setRawOutputFileCodecQuality:(float)arg1;
