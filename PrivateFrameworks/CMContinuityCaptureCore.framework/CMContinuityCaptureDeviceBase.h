...
@interface CMContinuityCaptureDeviceBase : NSObject <CMContinuityCaptureDevice> {
    ...
    bool  _dispatchingInvalidFrames;
    long long  _entity;
    _Atomic bool  _hasStreamIntent;
    bool  _ignoreSendingInvalidFrames;
    id /* block */  _invalidFrameBlock;
    bool  _invalidFrameNotificationScheduled;
...
- (void)postDeferredEvent:(id)arg1 data:(id)arg2;
...
- (void)scheduleInvalidFramesNotification:(bool)arg1;
- (void)scheduleSendingInvalidFramesAfterTimeout:(bool)arg1;
