...
+ (struct CMINoiseModel { int x1; float x2; float x3; float x4; float x5; })calculateBasicNoiseModelFromParams:(const struct CMIBasicNoiseModelParams { float x1; float x2; float x3; float x4; float x5; }*)arg1;
