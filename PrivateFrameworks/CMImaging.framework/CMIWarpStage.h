...
- (int)runGDC:(id)arg1 outputTex:(id)arg2 warpConfig:(struct CMIWarpConfig { }*)arg3 gdcParams:(struct { float x1; float x2; float x3[8]; float x4[8]; float x5; }*)arg4 inverseGDC:(bool)arg5;
- (int)runGDCWithInputLuma:(id)arg1 inputChromaTex:(id)arg2 outputLumaTex:(id)arg3 outputChromaTex:(id)arg4 warpConfig:(struct CMIWarpConfig { }*)arg5 gdcParams:(struct { float x1; float x2; float x3[8]; float x4[8]; float x5; }*)arg6 inverseGDC:(bool)arg7;
...
- (int)runWarpUsingTransform:(struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[3]; })arg1 inputTex:(id)arg2 outputTex:(id)arg3 inputFrameGDCParams:(struct { float x1; float x2; float x3[8]; float x4[8]; float x5; }*)arg4 outputFrameGDCParams:(struct { float x1; float x2; float x3[8]; float x4[8]; float x5; }*)arg5;
