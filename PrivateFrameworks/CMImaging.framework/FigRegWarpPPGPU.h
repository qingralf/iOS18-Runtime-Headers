...
@interface FigRegWarpPPGPU : NSObject <CMIRegWarp> {
    ...
    struct { 
        ...
        float minCornerResponseThreshold; 
        struct { 
    ...
    FigRegWarpPPGPUTuningParams * _tuningParams;
...
@property (nonatomic, retain) FigRegWarpPPGPUTuningParams *tuningParams;
...
- (int)processNonReference:(struct __CVBuffer { }*)arg1 gdcParams:(struct { float x1; float x2; float x3[8]; float x4[8]; float x5; }*)arg2 outputTransform:(struct { float x1[9]; }*)arg3;
- (int)processNonReference:(struct __CVBuffer { }*)arg1 outputTransform:(struct { float x1[9]; }*)arg2;
- (int)processNonReferenceTexture:(id)arg1 gdcParams:(struct { float x1; float x2; float x3[8]; float x4[8]; float x5; }*)arg2 outputTransform:(struct { float x1[9]; }*)arg3;
- (int)processNonReferenceTexture:(id)arg1 gdcParams:(struct { float x1; float x2; float x3[8]; float x4[8]; float x5; }*)arg2 outputTransform:(struct { float x1[9]; }*)arg3 mapping:(struct { unsigned char x1[256]; }*)arg4;
- (int)processNonReferenceTexture:(id)arg1 outputTransform:(struct { float x1[9]; }*)arg2;
- (int)processReference:(struct __CVBuffer { }*)arg1 gdcParams:(struct { float x1; float x2; float x3[8]; float x4[8]; float x5; }*)arg2 regionOfInterest:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; }*)arg3 numKeypoints:(unsigned int*)arg4;
...
- (int)processReferenceTexture:(id)arg1 gdcParams:(struct { float x1; float x2; float x3[8]; float x4[8]; float x5; }*)arg2 regionOfInterest:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; }*)arg3 numKeypoints:(unsigned int*)arg4;
- (int)processReferenceTexture:(id)arg1 gdcParams:(struct { float x1; float x2; float x3[8]; float x4[8]; float x5; }*)arg2 regionOfInterest:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; }*)arg3 numKeypoints:(unsigned int*)arg4 mapping:(struct { unsigned char x1[256]; }*)arg5;
