...
- (int)processNonReference:(struct __CVBuffer { }*)arg1 gdcParams:(struct { float x1; float x2; float x3[8]; float x4[8]; float x5; }*)arg2 seedTransform:(struct { float x1[9]; }*)arg3 outputTransform:(struct { float x1[9]; }*)arg4 mapping:(struct { unsigned char x1[256]; }*)arg5;
