...
+ (id)appCacheWithRecords:(id)arg1 identifier:(id)arg2 dataContainerURL:(id)arg3 userManagedAssetsURL:(id)arg4 personaUniqueString:(id)arg5 cacheDeleteVolume:(id)arg6 isDataseparated:(bool)arg7 isPlaceholder:(bool)arg8 isPlugin:(bool)arg9 telemetry:(id)arg10;
+ (id)appCacheWithRecords:(id)arg1 identifier:(id)arg2 dataContainerURL:(id)arg3 userManagedAssetsURL:(id)arg4 personaUniqueString:(id)arg5 isDataseparated:(bool)arg6 isPlaceholder:(bool)arg7 isPlugin:(bool)arg8 telemetry:(id)arg9;
+ (void)enumerateAppCachesOnVolume:(id)arg1 options:(int)arg2 telemetry:(id)arg3 block:(id /* block */)arg4;
+ (void)enumerateGroupCachesOnVolume:(id)arg1 block:(id /* block */)arg2;
+ (void)enumerateWithContainerQuery:(id)arg1 container_class:(unsigned long long)arg2 options:(int)arg3 telemetry:(id)arg4 block:(id /* block */)arg5;
...
- (id)identifier;
- (id)initWithBundleRecords:(id)arg1 identifier:(id)arg2 dataContainerURL:(id)arg3 userManagedAssetsURL:(id)arg4 personaUniqueString:(id)arg5 cacheDeleteVolume:(id)arg6 isDataseparated:(bool)arg7 isPlaceholder:(bool)arg8 isPlugin:(bool)arg9 telemetry:(id)arg10;
- (void)invalidate;
