...
- (void).cxx_destruct;
- (id)FSEventsUUID;
- (bool)amountIsRational:(id)arg1 freespace:(unsigned long long)arg2 effective_size:(unsigned long long)arg3 used:(unsigned long long)arg4 size:(unsigned long long)arg5;
