...
@property (readonly) bool allowsIntegrations;
...
@property (readonly) bool hasCalendarTCCBypassEntitlement;
...
@property (readonly) bool isCalendarWidgetExtension;
...
- (id)initWithClientIdentity:(id)arg1 tccPermissionChecker:(id)arg2;
