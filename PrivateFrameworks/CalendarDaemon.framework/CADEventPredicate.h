...
- (void)setExcludeSkippedReminders:(bool)arg1;
...
+ (void)_addEventOccurrenceAndProposedTimeOccurrenceFor:(id)arg1 withOccurrenceStartDate:(id)arg2 toResults:(id)arg3 excludeProposed:(bool)arg4 excludeDeclinedUnlessProposed:(bool)arg5 excludeSkippedReminders:(bool)arg6;
