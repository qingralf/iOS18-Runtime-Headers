...
@interface CADMockPermissionValidator : NSObject <CADPermissionValidator, NSSecureCoding> {
    ...
    bool  _hasCalendarTCCBypassEntitlement;
    ...
    bool  _isCalendarWidgetExtension;
...
@property (nonatomic) bool allowsIntegrations;
...
@property (nonatomic) bool hasCalendarTCCBypassEntitlement;
...
@property (nonatomic) bool isCalendarWidgetExtension;
...
- (void)setAllowsIntegrations:(bool)arg1;
...
- (void)setHasCalendarTCCBypassEntitlement:(bool)arg1;
...
- (void)setIsCalendarWidgetExtension:(bool)arg1;
