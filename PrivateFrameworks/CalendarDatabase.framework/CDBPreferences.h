...
@property (getter=get_DefaultAllDayAlarmOffset, setter=set_DefaultAllDayAlarmOffset:, nonatomic, copy) NSNumber *DefaultAllDayAlarmOffset;
@property (getter=get_DefaultTimedAlarmOffset, setter=set_DefaultTimedAlarmOffset:, nonatomic, copy) NSNumber *DefaultTimedAlarmOffset;
...
@property (readonly) bool has_DefaultAllDayAlarmOffset;
@property (readonly) bool has_DefaultTimedAlarmOffset;
...
- (id)preferences;
- (void)set_DefaultAllDayAlarmOffset:(id)arg1;
- (void)set_DefaultTimedAlarmOffset:(id)arg1;
