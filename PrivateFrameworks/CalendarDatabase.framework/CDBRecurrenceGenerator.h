...
- (id)copyOccurrenceDatesWithCalEvent:(void*)arg1 startDate:(id)arg2 endDate:(id)arg3 timeZone:(id)arg4 includeExtraOccurrencesPastEndDate:(bool)arg5 locked:(bool)arg6;
- (id)copyOccurrenceDatesWithCalEvent:(void*)arg1 startDate:(id)arg2 endDate:(id)arg3 timeZone:(id)arg4 limit:(long long)arg5 includeExtraOccurrencesPastEndDate:(bool)arg6 locked:(bool)arg7;
