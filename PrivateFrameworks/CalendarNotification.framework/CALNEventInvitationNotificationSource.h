...
@interface CALNEventInvitationNotificationSource : NSObject <CALNNotificationSource> {
    <CALNEventInvitationNotificationDataSource> * _dataSource;
...
@property (nonatomic, readonly) <CALNEventInvitationNotificationDataSource> *dataSource;
...
- (void).cxx_destruct;
- (id)_notificationBodyForNotificationInfo:(id)arg1 contactIdentifier:(id*)arg2;
- (id)categories;
