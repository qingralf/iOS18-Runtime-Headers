...
@interface CALNSharedCalendarInvitationResponseNotificationSource : NSObject <CALNNotificationSource> {
    <CALNSharedCalendarInvitationResponseNotificationDataSource> * _dataSource;
...
@property (nonatomic, readonly) <CALNSharedCalendarInvitationResponseNotificationDataSource> *dataSource;
