...
- (void)_updateTimeToLeaveRefreshTimerForSourceClientIdentifier:(id)arg1 hypothesis:(id)arg2 allowsLocationAlerts:(bool)arg3 travelAdvisoryDisabled:(bool)arg4;
