...
@property (nonatomic, copy) NSDate *lastTimeBulletinAdded;
...
@property (nonatomic, copy) NSString *organizerEmailAddress;
...
@property (nonatomic, copy) NSString *startLocationRouting;
...
- (id)initWithTitle:(id)arg1 location:(id)arg2 date:(id)arg3 endDate:(id)arg4 timeZone:(id)arg5 allDay:(bool)arg6 tentative:(bool)arg7 publisherBulletinID:(id)arg8 entityID:(id)arg9 appLink:(id)arg10 proximity:(long long)arg11 externalID:(id)arg12 databaseID:(int)arg13 acknowledged:(bool)arg14 dismissalID:(id)arg15 alarmID:(id)arg16 isOffsetFromTravelTimeStart:(bool)arg17 refiring:(bool)arg18 pseudoEvent:(bool)arg19;
