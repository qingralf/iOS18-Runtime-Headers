...
@property (nonatomic, retain) CUIKIPendingReminderTracker *pendingReminderTracker;
...
- (id)_calendarsExcludingLockedReminder:(id)arg1;
...
- (void)_deselectOccurrences:(id)arg1 notify:(bool)arg2;
...
- (long long)_sectionForCachedOccurrencesOnDate:(id)arg1 sectionExistsForDay:(bool*)arg2 usingFilter:(bool)arg3;
- (bool)_selectOccurrence:(id)arg1 notify:(bool)arg2;
...
- (id)cachedOccurrencesForSection:(long long)arg1;
...
- (id)dateForCachedOccurrencesInSection:(long long)arg1 usingFilter:(bool)arg2 holdingCachedFakeTodayIndexLock:(bool)arg3;
- (void)dealloc;
- (id)defaultCalendarForNewEvents;
- (void)deselectOccurrence:(id)arg1;
- (void)deselectOccurrences:(id)arg1;
...
- (void)selectOccurrences:(id)arg1;
...
- (void)setPendingReminderTracker:(id)arg1;
...
- (void)setSelectedOccurrences:(id)arg1 forceChange:(bool)arg2;
