...
+ (unsigned long long)overlayCalendarTypeForCalendarIdentifier:(id)arg1;
+ (id)overlayDayNumberStringForDate:(id)arg1 inCalendar:(id)arg2;
...
+ (id)stylizedTimelineHourStringForHourDate:(id)arg1 baseFontSize:(double)arg2;
