...
+ (void)postLiveEditNotificationForObject:(id)arg1;
...
- (bool)_requestSaveDecisionIfNeededForAction:(unsigned long long)arg1 diffSummary:(id)arg2 delegate:(id)arg3;
- (bool)_requestSpanDecisionIfNeededForAction:(unsigned long long)arg1 diffSummary:(id)arg2 delegate:(id)arg3;
- (void)_revert;
