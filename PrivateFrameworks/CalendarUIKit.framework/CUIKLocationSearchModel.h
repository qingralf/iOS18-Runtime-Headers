...
@interface CUIKLocationSearchModel : NSObject <CLLocationManagerDelegate, MKLocalSearchCompleterDelegatePrivate> {
    ...
    <CUIKLocationSearchModelDelegate> * _delegate;
    ...
    CUIKStructuredLocationWithImage * _locationFromMapsURL;
...
@property (nonatomic) <CUIKLocationSearchModelDelegate> *delegate;
...
@property (nonatomic, retain) <GEOMapServiceCompletionTicket> *lastTicket; /* unknown property attribute: ? */
@property (nonatomic, readonly) CUIKStructuredLocationWithImage *locationFromMapsURL;
...
- (id)_availabilityRequestForConferenceRooms:(id)arg1 eventID:(id)arg2 source:(id)arg3 dateRange:(id)arg4 resultsBlock:(id /* block */)arg5 completionBlock:(id /* block */)arg6;
- (void)_decrementPendingOperationsCountForDomain:(id)arg1;
- (void)_handleAvailabilityResults:(id)arg1 forOperation:(id)arg2;
- (id)_imageForAttributes:(id)arg1;
- (id)_imageForMapHandle:(id)arg1;
- (void)_incrementPendingOperationsCountForDomain:(id)arg1;
