...
+ (id)scaledCalendarColorChooserDotImageForColor:(id)arg1 font:(id)arg2;
+ (id)scaledCalendarColorDotImageForColor:(id)arg1 font:(id)arg2;
+ (id)scaledCalendarColorDotImageForColor_SuggestedEvent:(id)arg1 font:(id)arg2;
