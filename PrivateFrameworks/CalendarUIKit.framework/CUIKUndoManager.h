...
@interface CUIKUndoManager : NSUndoManager <CUIKUndoDelegate> {
    ...
    <CUIKEditorExtended> * _undoableEditor;
}
...
@property (nonatomic, readonly) NSUndoManager *systemUndoManager;
@property (nonatomic, retain) NSMutableDictionary *undeletedObjectMap;
@property (nonatomic, retain) <CUIKEditorExtended> *undoableEditor;
