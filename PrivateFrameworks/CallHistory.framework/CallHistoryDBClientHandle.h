...
@interface CallHistoryDBClientHandle : CHSynchronizedLoggable <CallHistoryDBClientHandleProtocol> {
    ...
    <NSObject> * _observerCallTimersRef;
    CallHistoryDBHandle * dbStoreHandle;
}

@property (nonatomic, readonly) CHNotifyObserver *callsDidChangeNotifyObserver;
...
@property (nonatomic, readonly) <NSObject> *observerCallTimersRef;
...
- (void).cxx_destruct;
- (id)callsDidChangeNotifyObserver;
...
- (bool)updateCallRecord_sync:(id)arg1 withCall:(id)arg2;
...
- (id)updateCallRecordsWithCalls:(id)arg1 error:(id*)arg2 save:(bool)arg3;
- (id)updateCallRecordsWithCalls_sync:(id)arg1 error:(id*)arg2 save:(bool)arg3;
