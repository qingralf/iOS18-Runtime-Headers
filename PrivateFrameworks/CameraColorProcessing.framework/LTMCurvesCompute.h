...
@interface LTMCurvesCompute : NSObject <LTMCurvesComputeBase> {
    bool  _LTMIsReady;
    ...
    unsigned int  _globalHistStat;
    bool  _isDigitalFlash;
    unsigned short  _localHistStat;
    LTMStats * _ltmStats;
    bool  _optimized;
