...
@interface CEKLightingControl : UIView <CAAnimationDelegate, CEKBadgeViewDelegate, UIGestureRecognizerDelegate> {
    ...
    UIImageView * __collapsedControlItemView;
    CEKMultiplyImageView * __collapsedControlSelectionOverlay;
    UIImageView * __collapsedControlSelectionUnderlay;
    UIImageView * __collapsedControlShadowView;
    ...
    unsigned long long  _collapsedControlLocation;
    struct { 
        unsigned long long leftRate; 
        unsigned long long rightRate; 
    }  _collapsedItemFading;
    double  _collapsedSelectionCenterPointEdgeInset;
...
@property (nonatomic, retain) UIImageView *_collapsedControlItemView;
@property (nonatomic, retain) CEKMultiplyImageView *_collapsedControlSelectionOverlay;
@property (nonatomic, retain) UIImageView *_collapsedControlSelectionUnderlay;
@property (nonatomic, retain) UIImageView *_collapsedControlShadowView;
...
- (id)_collapsedControlItemView;
- (id)_collapsedControlSelectionOverlay;
- (id)_collapsedControlSelectionUnderlay;
- (id)_collapsedControlShadowView;
...
- (unsigned long long)collapsedControlLocation;
...
- (void)setCollapsedControlLocation:(unsigned long long)arg1;
- (void)setCollapsedControlLocation:(unsigned long long)arg1 animated:(bool)arg2;
...
- (void)setCollapsedSelectionCenterPointEdgeInset:(double)arg1;
...
- (void)set_collapsedControlItemView:(id)arg1;
- (void)set_collapsedControlSelectionOverlay:(id)arg1;
- (void)set_collapsedControlSelectionUnderlay:(id)arg1;
- (void)set_collapsedControlShadowView:(id)arg1;
