...
- (struct CGPath { }*)centerPathWithSize:(struct CGSize { double x1; double x2; })arg1;
- (struct CGPath { }*)centerShadowPathWithSize:(struct CGSize { double x1; double x2; })arg1 width:(double)arg2;
- (id)initWithRotationAngle:(double)arg1;
- (double)intensityForPlane:(long long)arg1;
- (struct CGPath { }*)pathForOutlineWithSize:(struct CGSize { double x1; double x2; })arg1 cornerRadius:(double)arg2;
- (struct CGPath { }*)pathForPlane:(long long)arg1 size:(struct CGSize { double x1; double x2; })arg2;
