...
@property (nonatomic, readonly) bool expandedAppShouldDismissOnDragSuccess; /* unknown property attribute: ? */
@property (nonatomic, readonly) struct CGSize { double x1; double x2; } expandedAppViewControllerSize; /* unknown property attribute: ? */
