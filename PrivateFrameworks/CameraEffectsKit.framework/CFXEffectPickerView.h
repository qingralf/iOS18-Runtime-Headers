...
@interface CFXEffectPickerView : UIView <JFXEffectPreviewManagerDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout> {
    struct CGSize { 
        double width; 
        double height; 
    }  _cellSize;
...
@property (nonatomic, retain) JFXEffectPreviewManager *previewManager;
@property (nonatomic) bool previewingIsWaitingForConfiguration;
@property (nonatomic, retain) JFXEffectStaticPreviewOptions *staticPreviewOptions;
