...
@interface CAMBottomBar : UIView <CAMExpandableMenuButtonDelegate, CEKApertureButtonDelegate> {
    ...
    UIView * _imageAnalysisButtonBackgroundOverlay;
...
@property (nonatomic, retain) UIView *imageAnalysisButtonBackgroundOverlay;
...
+ (bool)shouldUseSafeAreaInsetForLayoutStyle:(long long)arg1 traitCollection:(id)arg2;
+ (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })shutterButtonAlignmentRectInBounds:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 forLayoutStyle:(long long)arg2 traitCollection:(id)arg3 safeAreaInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg4;
...
- (id)imageAnalysisButtonBackgroundOverlay;
- (id)imageWell;
...
- (void)setImageAnalysisButtonBackgroundOverlay:(id)arg1;
