...
@interface CAMCameraRollController : NSObject <LSApplicationWorkspaceObserverProtocol, PHPhotoLibraryChangeObserver, PLCameraPreviewWellImageChangeObserver, PUOneUpPresentationHelperAssetDisplayDelegate, PUOneUpPresentationHelperDelegate, PXPhotosDataSourceChangeObserver, UIInteractionProgressObserver, UIViewControllerPreviewingDelegate, UIViewControllerPreviewingDelegate_Private> {
    ...
    long long  _photosAppInstallationState;
...
@property (nonatomic, readonly) PUOneUpViewController *oneUpViewController;
...
- (void)_createUndoActionsInvalidatorAsynchronouslyIfNeededWithPhotoLibrary:(id)arg1;
...
- (unsigned long long)currentAssetIndexFromEnd;
- (void)dealloc;
...
- (bool)oneUpPresentationHelperPreventAlbumAttributionWidget:(id)arg1;
- (bool)oneUpPresentationHelperPreventHideAssetAction:(id)arg1;
- (bool)oneUpPresentationHelperPreventPeopleOrnament:(id)arg1;
...
- (long long)photosAppInstallationState;
...
- (void)setCurrentAssetIndexFromEnd:(unsigned long long)arg1;
- (void)setExternalStorage:(id)arg1;
- (void)setImageWellDelegate:(id)arg1;
- (void)setPhotosAppInstallationState:(long long)arg1;
