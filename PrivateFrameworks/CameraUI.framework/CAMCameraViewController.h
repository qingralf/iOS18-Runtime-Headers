...
- (id)_clientPropertiesForLivePhotoVideoURL:(id)arg1 duration:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2 stillDisplayTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg3 error:(id)arg4;
