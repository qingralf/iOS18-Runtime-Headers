...
@interface CAMCaptureCapabilities : NSObject {
    ...
    bool  __HDR10BitVideoSupports120FPS;
    bool  __actionModeAggregateDevice4k60Supported;
    bool  __allowSpatialOverCaptureInPortraitMode;
    bool  __allowZoomWithForcedBackCamera;
    ...
    bool  __backPhotoModeNightModeDepthSupported;
    double  __backPortraitModeMaximumZoomFactor;
    bool  __backStageLightPortaitEffectsSupported;
    bool  __backSuperWideTeleNightModeSupported;
    ...
    bool  __externalStorageSupportedForAllVideoFormats;
    ...
    bool  __smartStylesAdditionalSystemStyleSupport;
    NSSet * __supportedModesForPauseResumeVideo;
    ...
    long long  _backHighFrameRate4kMaxFPS;
    ...
    bool  _backQuadraSuperWideSupported;
    ...
    bool  _cameraButtonSupported;
    bool  _captureOnTouchDown;
    bool  _cinematic4KSupported;
    bool  _cinematicAudioSupported;
    ...
    bool  _disableAudio;
    float  _documentScanningMinimumConfidenceLevel;
    bool  _documentScanningSupported;
    bool  _enableSemanticDevelopmentFilterDebugging;
    NSArray * _expectedSupportedCameraModules;
    bool  _exposureSliderSupported;
    bool  _externalStorageSupported;
    NSArray * _fallbackCameraModules;
    bool  _fallbackCameraSupported;
    ...
    bool  _featureDevelopmentShowLockIndicator;
    ...
    bool  _halfPressOverlayInProcess;
    bool  _halfPressSupported;
    ...
    bool  _mixAudioWithOthersSupported;
    bool  _modernHDRSupported;
    bool  _multipleCaptureFeaturesSupported;
    ...
    unsigned long long  _portraitInPhotoModeBehavior;
    ...
    bool  _smartStylesShowExtraControls;
    bool  _smartStylesSupported;
    bool  _spatialModeSupported;
    bool  _spatialModeTrueVideoSupported;
    bool  _spatialVideoInVideoModeSupported;
...
@property (nonatomic, readonly) bool _HDR10BitVideoSupports120FPS;
...
@property (nonatomic, readonly) bool _allowSpatialOverCaptureInPortraitMode;
@property (nonatomic, readonly) bool _allowZoomWithForcedBackCamera;
...
@property (nonatomic, readonly) bool _backPhotoModeNightModeDepthSupported;
@property (nonatomic, readonly) double _backPortraitModeMaximumZoomFactor;
@property (nonatomic, readonly) bool _backStageLightPortaitEffectsSupported;
@property (nonatomic, readonly) bool _backSuperWideTeleNightModeSupported;
...
@property (nonatomic, readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } _cameraButtonFrame;
...
@property (getter=_isExternalStoreSupportedForAllVideoFormats, nonatomic, readonly) bool _externalStorageSupportedForAllVideoFormats;
...
@property (nonatomic, readonly) bool _photoModeLightingControlSupported;
...
@property (getter=_isProResCinematicVideoSupported, nonatomic, readonly) bool _proResCinematicVideoSupported;
...
@property (nonatomic, readonly) bool _smartStylesAdditionalSystemStyleSupport;
@property (nonatomic, readonly) NSSet *_supportedModesForPauseResumeVideo;
...
@property (nonatomic, readonly) bool allowHalfPressSimulation;
...
@property (nonatomic, readonly) bool allowSystemSmartStylesInPicker;
...
@property (getter=isBack4k120VideoSupported, nonatomic, readonly) bool back4k120VideoSupported;
...
@property (nonatomic, readonly) long long backHighFrameRate4kMaxFPS;
...
@property (getter=isBackQuadraSuperWideSupported, nonatomic, readonly) bool backQuadraSuperWideSupported;
...
@property (getter=isCameraButtonSupported, nonatomic, readonly) bool cameraButtonSupported;
@property (nonatomic, readonly) bool captureOnTouchDown;
@property (nonatomic, readonly) bool cinematic4KSupported;
@property (getter=isCinematicAudioSupported, nonatomic, readonly) bool cinematicAudioSupported;
...
@property (nonatomic, readonly) bool disableAudio;
@property (nonatomic, readonly) float documentScanningMinimumConfidenceLevel;
@property (getter=isDocumentScanningSupported, nonatomic, readonly) bool documentScanningSupported;
...
@property (getter=getSupportedCameraModules, nonatomic, readonly) NSArray *expectedSupportedCameraModules;
...
@property (getter=fallbackCameraEnabled, nonatomic, readonly) bool fallbackCameraEnabled;
@property (nonatomic, readonly) NSArray *fallbackCameraModules;
@property (nonatomic, readonly) bool fallbackCameraSupported;
...
@property (nonatomic, readonly) bool featureDevelopmentShowLockIndicator;
...
@property (getter=isFrontCameraOnRightEdge, nonatomic, readonly) bool frontCameraOnRightEdge;
...
@property (getter=isHalfPressOverlayInProcess, nonatomic, readonly) bool halfPressOverlayInProcess;
@property (getter=isHalfPressSupported, nonatomic, readonly) bool halfPressSupported;
...
@property (nonatomic, readonly) struct CGSize { double x1; double x2; } mainScreenSizePixels;
...
@property (getter=isMixAudioWithOthersSupported, nonatomic, readonly) bool mixAudioWithOthersSupported;
@property (getter=isModernHDRSupported, nonatomic, readonly) bool modernHDRSupported;
@property (nonatomic, readonly) bool multipleCaptureFeaturesSupported;
...
@property (nonatomic, readonly) unsigned long long portraitInPhotoModeBehavior;
...
@property (getter=isPreserveCreativeControlsSupported, nonatomic, readonly) bool preserveCreativeControlsSupported;
...
@property (getter=isProRawJpegXLSupported, nonatomic, readonly) bool proRawJpegXLSupported;
...
@property (getter=isRegionalShutterSoundEnabled, nonatomic, readonly) bool regionalShutterSoundEnabled;
...
@property (nonatomic, readonly) long long semanticStylesVersion;
...
@property (nonatomic, readonly) bool smartStylesShowExtraControls;
@property (nonatomic, readonly) bool smartStylesSupported;
@property (getter=isSpatialModeSupported, nonatomic, readonly) bool spatialModeSupported;
@property (getter=isSpatialModeTrueVideoSupported, nonatomic, readonly) bool spatialModeTrueVideoSupported;
@property (getter=isSpatialOverCaptureSupported, nonatomic, readonly) bool spatialOverCaptureSupported;
@property (getter=isSpatialVideoCaptureSupported, nonatomic, readonly) bool spatialVideoInVideoModeSupported;
...
@property (nonatomic, readonly) NSArray *supportedProResColorSpaces;
...
@property (getter=isTrueVideoSupported, nonatomic, readonly) bool trueVideoSupported;
...
@property (getter=isWindRemovalSupported, nonatomic, readonly) bool windRemovalSupported;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })_cameraButtonFrame;
- (unsigned long long)_desiredSemanticStyleSupportForMode:(long long)arg1 devicePosition:(long long)arg2;
- (unsigned long long)_desiredSmartStyleSupportForMode:(long long)arg1 devicePosition:(long long)arg2;
...
- (bool)_is1080p120SlomoSupportedForDevice:(long long)arg1;
...
- (bool)_isSpatialOverCaptureSupportedForDevice:(long long)arg1;
- (bool)_isSpatialPhotoModeSupportedForDevice:(long long)arg1;
- (bool)_isSpatialPhotoSupportedForDevicePosition:(long long)arg1;
- (bool)_isSpatialVideoModeSupportedForDevice:(long long)arg1;
- (bool)_isSpatialVideoSupportedForDevicePosition:(long long)arg1;
...
- (bool)_needsForcedSingleCameraEmulationForVideoStabilizationStrength:(long long)arg1 videoConfiguration:(long long)arg2 mode:(long long)arg3;
...
- (id)_supportedModesForPauseResumeVideo;
...
- (long long)backHighFrameRate4kMaxFPS;
...
- (id)captureStyleForCaptureWithSupport:(unsigned long long)arg1 styles:(id)arg2 selectedStyleIndex:(unsigned long long)arg3 smartStyleSystemStyleIndex:(unsigned long long)arg4;
- (id)captureStyleForPreviewWithSupport:(unsigned long long)arg1 styles:(id)arg2 selectedStyleIndex:(unsigned long long)arg3 smartStyleSystemStyleIndex:(unsigned long long)arg4;
...
- (double)defaultZoomFactorForMode:(long long)arg1 device:(long long)arg2 videoConfiguration:(long long)arg3 captureOrientation:(long long)arg4 videoStabilizationStrength:(long long)arg5 videoEncodingBehavior:(long long)arg6 customLens:(long long)arg7 outputToExternalStorage:(bool)arg8 spatialVideoEnabled:(bool)arg9 isTrueVideo:(bool)arg10 prefersHDR10BitVideo:(bool)arg11 overrodeWithForcedZoomValue:(bool*)arg12;
...
- (id)fallbackCameraModules;
- (bool)fallbackCameraSupported;
- (long long)fallbackPrimaryConstituentDeviceSelectionForMode:(long long)arg1 device:(long long)arg2 videoConfiguration:(long long)arg3 videoStabilizationStrength:(long long)arg4 macroMode:(long long)arg5 spatialVideoEnabled:(bool)arg6;
...
- (bool)is1080p120VideoSupportedForDevice:(long long)arg1;
- (bool)is1080p240SupportedForDevice:(long long)arg1;
- (bool)is1080p60VideoSupportedForDevice:(long long)arg1;
- (bool)is4K120VideoSupportedForDevice:(long long)arg1;
...
- (bool)isAutoFPSVideoSupportedForMode:(long long)arg1 videoConfiguration:(long long)arg2 videoEncodingBehavior:(long long)arg3 outputToExternalStorage:(bool)arg4 spatialVideoEnabled:(bool)arg5 prefersHDR10BitVideo:(bool)arg6;
...
- (bool)isCinematicAudioSupportedForMode:(long long)arg1;
...
- (bool)isCustomLensSupportedForMode:(long long)arg1 device:(long long)arg2 isTrueVideo:(bool)arg3;
...
- (bool)isHDR10BitSlomoSupportedForDevice:(long long)arg1;
...
- (bool)isLightingControlSupportedForMode:(long long)arg1;
...
- (bool)isNightModeWithDepthSupportedForMode:(long long)arg1 device:(long long)arg2;
- (bool)isPALVideoSupported;
- (bool)isPanoramaSupportedForDevice:(long long)arg1;
- (bool)isPauseVideoSupportedForMode:(long long)arg1;
...
- (bool)isQuadraWideBinningReconfigurationSupportedForMode:(long long)arg1 devicePosition:(long long)arg2 videoConfiguration:(long long)arg3;
- (bool)isQuadraWideSupported;
- (bool)isQuadraWideZoomButtonSupportedForMode:(long long)arg1 devicePosition:(long long)arg2 videoConfiguration:(long long)arg3;
...
- (bool)isSpatialVideoInVideoModeSupportedForMode:(long long)arg1 devicePosition:(long long)arg2;
...
- (bool)isSuperWideAutoMacroSupportedForMode:(long long)arg1 device:(long long)arg2 videoConfiguration:(long long)arg3 videoStabilizationStrength:(long long)arg4 spatialVideoEnabled:(bool)arg5;
...
- (bool)isSupportedVideoConfiguration:(long long)arg1 forMode:(long long)arg2 device:(long long)arg3 spatialVideoEnabled:(bool)arg4 trueVideoEnabled:(bool)arg5;
...
- (bool)isTrueVideoSupportedForMode:(long long)arg1;
- (bool)isVariableFramerateVideoSupported;
- (bool)isVariableFramerateVideoSupportedForMode:(long long)arg1 videoConfiguration:(long long)arg2 videoEncodingBehavior:(long long)arg3 outputToExternalStorage:(bool)arg4 spatialVideoEnabled:(bool)arg5 prefersHDR10BitVideo:(bool)arg6;
- (bool)isVideoStabilizationControlSupported;
- (bool)isVideoStabilizationControlSupportedForMode:(long long)arg1 device:(long long)arg2 videoConfiguration:(long long)arg3 videoEncodingBehavior:(long long)arg4 trueVideoEnabled:(bool)arg5 prefersHDR10BitVideo:(bool)arg6;
- (bool)isVideoStabilizationStrength:(long long)arg1 supportedForMode:(long long)arg2 device:(long long)arg3 videoConfiguration:(long long)arg4 videoEncodingBehavior:(long long)arg5 outputToExternalStorage:(bool)arg6 spatialVideoEnabled:(bool)arg7 trueVideoEnabled:(bool)arg8 prefersHDR10BitVideo:(bool)arg9;
- (bool)isVideoStabilizationStrength:(long long)arg1 supportedForMode:(long long)arg2 devicePosition:(long long)arg3 spatialVideoEnabled:(bool)arg4 trueVideoEnabled:(bool)arg5;
...
- (bool)isZoomPlatterSupportedForMode:(long long)arg1 devicePosition:(long long)arg2 videoConfiguration:(long long)arg3;
...
- (struct CGSize { double x1; double x2; })mainScreenSizePixels;
...
- (unsigned long long)portraitInPhotoModeBehavior;
- (bool)portraitModeOverlappingCapturesSupported;
- (bool)portraitZoomSupported;
- (long long)preferredDeviceForPosition:(long long)arg1 mode:(long long)arg2 videoConfiguration:(long long)arg3 videoStabilizationStrength:(long long)arg4 spatialVideoEnabled:(bool)arg5;
...
- (long long)resolvedDeviceForDesiredDevice:(long long)arg1 mode:(long long)arg2 videoConfiguration:(long long)arg3 videoStabilizationStrength:(long long)arg4 spatialVideoEnabled:(bool)arg5;
- (long long)resolvedVideoConfigurationForMode:(long long)arg1 device:(long long)arg2 videoEncodingBehavior:(long long)arg3 videoConfiguration:(long long)arg4 outputToExternalStorage:(bool)arg5 spatialVideoEnabled:(bool)arg6 prefersHDR10BitVideo:(bool)arg7;
...
- (long long)semanticStylesVersion;
...
- (bool)smartStylesSupportedForLightingType:(long long)arg1;
- (unsigned long long)spatialOverCaptureSupportForMode:(long long)arg1 device:(long long)arg2;
...
- (long long)validatedVideoConfigurationForVideoConfiguration:(long long)arg1 withBlock:(id /* block */)arg2;
