...
@interface CAMCaptureCommandContext : NSObject {
    ...
    AVCaptureSystemLensSelector * _lensSelector;
    AVCaptureSystemExposureBiasSlider * _systemExposureBiasSlider;
    AVCaptureSystemLensSelector * _systemLensSelector;
    AVCaptureSystemZoomSlider * _systemZoomSlider;
}

@property (nonatomic, readonly) CAMCaptureEngine *_captureEngine;
@property (nonatomic, retain) AVCaptureSlider *apertureSlider;
...
@property (nonatomic, retain) AVCaptureSlider *emulatedZoomSlider;
@property (nonatomic, readonly) AVCaptureSystemLensSelector *lensSelector;
@property (nonatomic, retain) AVCaptureSystemExposureBiasSlider *systemExposureBiasSlider;
@property (nonatomic, retain) AVCaptureSystemLensSelector *systemLensSelector;
@property (nonatomic, retain) AVCaptureSystemZoomSlider *systemZoomSlider;

- (void).cxx_destruct;
- (id)_captureEngine;
- (id)_captureEngineDeviceForMode:(long long)arg1 desiredDevice:(long long)arg2 videoConfiguration:(long long)arg3 videoStabilizationStrength:(long long)arg4 spatialVideoEnabled:(bool)arg5 resolvedDevice:(long long*)arg6;
- (id)_metadataOutputForMode:(long long)arg1;
- (bool)_shouldEnableApertureSliderForMode:(long long)arg1 devicePosition:(long long)arg2 recording:(bool)arg3;
- (bool)_shouldEnableCreativeStylePickerForMode:(long long)arg1 recording:(bool)arg2;
- (bool)_shouldEnableLensSelectorForMode:(long long)arg1 devicePosition:(long long)arg2 recording:(bool)arg3;
- (bool)_shouldEnableSystemExposureForRecording:(bool)arg1 mode:(long long)arg2;
- (bool)_shouldEnableSystemStylePickerForMode:(long long)arg1 recording:(bool)arg2;
- (bool)_shouldEnableSystemZoomSliderForMode:(long long)arg1 devicePosition:(long long)arg2;
- (bool)_shouldEnableToneBiasForMode:(long long)arg1 recording:(bool)arg2;
- (id)apertureSlider;
- (id)audioDeviceInput;
...
- (id)controlsForGraphConfiguration:(id)arg1 recording:(bool)arg2;
...
- (void)setEmulatedZoomSlider:(id)arg1;
- (void)setSystemExposureBiasSlider:(id)arg1;
- (void)setSystemLensSelector:(id)arg1;
- (void)setSystemZoomSlider:(id)arg1;
- (void)startPanoramaCaptureWithRequest:(id)arg1;
- (void)stopPanoramaCaptureInterrupted:(bool)arg1;
- (id)systemExposureBiasSlider;
- (id)systemLensSelector;
- (id)systemZoomSlider;
- (void)updateControlEnablementForFilters:(id)arg1 captureMode:(long long)arg2;
- (void)updateControlEnablementForRecording:(bool)arg1 mode:(long long)arg2 devicePosition:(long long)arg3;
- (void)updateLensSelectorForRecording:(bool)arg1 mode:(long long)arg2 devicePosition:(long long)arg3;
- (id)videoDeviceForMode:(long long)arg1 desiredDevice:(long long)arg2 videoConfiguration:(long long)arg3 videoStabilizationStrength:(long long)arg4 spatialVideoEnabled:(bool)arg5 resolvedDevice:(long long*)arg6;
