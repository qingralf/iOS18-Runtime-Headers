...
@interface CAMCaptureEngineDevice : NSObject {
    ...
    <CAMCaptureEngineDeviceSystemAction> * _systemDeviceActionDelegate;
    AVCaptureSystemExposureBiasSlider * _systemExposureSlider;
...
@property (nonatomic) <CAMCaptureEngineDeviceSystemAction> *systemDeviceActionDelegate;
@property (nonatomic, readonly) AVCaptureSystemExposureBiasSlider *systemExposureSlider;
@property (nonatomic, readonly) AVCaptureSystemLensSelector *systemLensSelector;
@property (nonatomic, readonly) AVCaptureSystemZoomSlider *systemZoomSlider;
...
- (void)setSystemDeviceActionDelegate:(id)arg1;
- (id)systemDeviceActionDelegate;
- (id)systemExposureSlider;
