...
@interface CAMCaptureMovieFileOutput : AVCaptureMovieFileOutput <AVCaptureFileOutputRecordingDelegate> {
    ...
    <AVCaptureFileOutputRecordingDelegate><AVCaptureFileOutputPauseResumeDelegate> * _wrappedDelegate;
}
...
@property (nonatomic) <AVCaptureFileOutputRecordingDelegate><AVCaptureFileOutputPauseResumeDelegate> *wrappedDelegate;
