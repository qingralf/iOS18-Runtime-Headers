...
@interface CAMControlStatusIndicator : UIControl <CAMControlStatusBarControl> {
    ...
    unsigned long long  _controlStatusType;
...
+ (id)_createStretchableCircleImageFilled:(bool)arg1 scale:(double)arg2;
+ (id)decimalFormatter;
+ (id)integerFormatter;
+ (id)stretchableCircleImageFilled:(bool)arg1 scale:(double)arg2;
