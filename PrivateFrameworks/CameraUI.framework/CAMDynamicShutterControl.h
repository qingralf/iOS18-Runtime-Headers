...
@interface CAMDynamicShutterControl : UIControl <CAMMetalViewDelegate, UIGestureRecognizerDelegate> {
    ...
    CAMSpring * __drawPauseResumeUISpring;
    CAMSpring * __expandLockRingSpring;
    bool  __externalLockButtonPressed;
    double  __externalLongPressVideoDuration;
    ...
    struct { 
        ...
        bool isWithinPauseResumeButton; 
    }  __firstTouch;
    ...
    double  __longPressVideoDuration;
    ...
    UIImageView * __pauseImageView;
    UIView * __pauseResumeButtonLegibilityView;
    UIView * __pauseResumeButtonOuterView;
    struct CAMShutterButtonSpec { 
        double outerRingDiameter; 
        double outerRingStrokeWidth; 
        double stopSquareSideLength; 
    ...
    CAMSpring * __pausedDuringVideoSpring;
    UIView * __resumeCircleView;
    ...
    struct { 
        ...
        bool respondsToDidPressPauseResumeButton; 
    ...
    double  _pauseResumeButtonCenterLeftInset;
    bool  _pausedDuringVideo;
    struct { 
...
@property (nonatomic, readonly) UIView *_centerOuterView;
...
@property (nonatomic) bool _didCancelZoomForCurrentGesture;
...
@property (nonatomic, readonly) CAMSpring *_drawPauseResumeUISpring;
...
@property (setter=_setFirstTouch:, nonatomic) struct { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; double x2; bool x3; bool x4; bool x5; } _firstTouch;
...
@property (setter=_setMostRecentTouch:, nonatomic) struct { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; double x2; bool x3; bool x4; bool x5; } _mostRecentTouch;
...
@property (nonatomic, readonly) UIImageView *_pauseImageView;
@property (nonatomic, readonly) struct CGPoint { double x1; double x2; } _pauseResumeButtonCenter;
@property (nonatomic, readonly) UIView *_pauseResumeButtonLegibilityView;
@property (nonatomic, readonly) UIView *_pauseResumeButtonOuterView;
@property (nonatomic, readonly) struct CAMShutterButtonSpec { double x1; double x2; double x3; double x4; double x5; } _pauseResumeButtonSpec;
@property (nonatomic, readonly) CAMSpring *_pausedDuringVideoSpring;
@property (nonatomic, readonly) UIView *_resumeCircleView;
...
@property (getter=isPausedDuringVideo, nonatomic) bool pausedDuringVideo;
@property (nonatomic, readonly) struct { bool x1; } privateSettings;
...
- (struct { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; double x2; bool x3; bool x4; bool x5; })_firstTouch;
...
- (bool)_isPointWithinPauseResumeRingTouchArea:(struct CGPoint { double x1; double x2; })arg1;
...
- (id)_metalView;
- (struct { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; double x2; bool x3; bool x4; bool x5; })_mostRecentTouch;
- (id)_outerImage;
- (id)_pauseImageView;
- (struct CGPoint { double x1; double x2; })_pauseResumeButtonCenter;
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })_pauseResumeButtonFrame;
- (id)_pauseResumeButtonLegibilityView;
- (id)_pauseResumeButtonOuterView;
- (struct CAMShutterButtonSpec { double x1; double x2; double x3; double x4; double x5; })_pauseResumeButtonSpec;
- (id)_pausedDuringVideoSpring;
- (void)_resetShutterState;
- (id)_resumeCircleView;
...
- (void)_setFirstTouch:(struct { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; double x2; bool x3; bool x4; bool x5; })arg1;
...
- (void)_setMostRecentTouch:(struct { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; double x2; bool x3; bool x4; bool x5; })arg1;
...
- (bool)_shouldReceiveTouch:(struct { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; double x2; bool x3; bool x4; bool x5; })arg1;
...
- (struct { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; double x2; bool x3; bool x4; bool x5; })_touchForPoint:(struct CGPoint { double x1; double x2; })arg1;
- (void)_touchSequenceBegan:(struct { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; double x2; bool x3; bool x4; bool x5; })arg1;
- (void)_touchSequenceCancelledForReset:(bool)arg1;
- (void)_touchSequenceChanged:(struct { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; double x2; bool x3; bool x4; bool x5; })arg1;
- (void)_touchSequenceEnded:(struct { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; double x2; bool x3; bool x4; bool x5; })arg1 forReset:(bool)arg2;
...
- (struct { bool x1; })privateSettings;
...
- (void)setPauseResumeButtonCenterLeftInset:(double)arg1;
- (void)setPausedDuringVideo:(bool)arg1;
- (void)setPausedDuringVideo:(bool)arg1 animated:(bool)arg2;
...
- (void)setSettings:(struct { long long x1; long long x2; long long x3; long long x4; bool x5; long long x6; long long x7; long long x8; long long x9; })arg1 privateSettings:(struct { bool x1; })arg2 animated:(bool)arg3;
...
- (void)set_didCancelZoomForCurrentGesture:(bool)arg1;
- (void)set_externalLongPressVideoDuration:(double)arg1;
- (void)set_externalShutterLongPressBehavior:(long long)arg1;
- (void)set_initalZoomGestureOffsetY:(double)arg1;
- (void)set_longPressVideoDuration:(double)arg1;
