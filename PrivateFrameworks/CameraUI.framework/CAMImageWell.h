...
@property (setter=_setCurrentPresentationStyle:, nonatomic) int _currentPresentationStyle;
...
@property (setter=_setThumbnailUpdateID:, nonatomic) unsigned long long _thumbnailUpdateID;
...
@property (nonatomic) <CAMImageWellPresentationDelegate> *presentationDelegate;
...
- (void)_setCurrentPresentationStyle:(int)arg1;
- (void)_setPlaceholderImage:(id)arg1;
- (void)_setThumbnailImage:(id)arg1;
- (void)_setThumbnailUpdateID:(unsigned long long)arg1;
- (void)_setUuid:(id)arg1;
- (id)_thumbnailImage;
- (id)_thumbnailImageView;
- (unsigned long long)_thumbnailUpdateID;
- (void)_updateForLayoutStyle;
- (void)_updatePresentationStyleAndImageViewAnimated:(bool)arg1;
