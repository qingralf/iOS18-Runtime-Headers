...
- (void)_deviceAngleForGravity:(struct { double x1; double x2; double x3; })arg1 captureOrientation:(long long)arg2 relativeRoll:(out double*)arg3 relativePitch:(out double*)arg4;
...
- (void)applyDeviceMotion:(id)arg1 captureOrientation:(long long)arg2;
