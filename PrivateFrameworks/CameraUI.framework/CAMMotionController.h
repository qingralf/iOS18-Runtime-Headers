...
@interface CAMMotionController : NSObject <BKSAccelerometerDelegate, CAMLevelViewModelChangeObserver> {
    ...
    long long  __orientationIfForcedToLandscape;
    ...
    bool  _forceLandscapeOrientation;
}
...
@property (setter=_setOrientationWhenForcedToLandscape:, nonatomic) long long _orientationIfForcedToLandscape;
...
@property (nonatomic) bool forceLandscapeOrientation;
...
- (long long)_orientationIfForcedToLandscape;
...
- (void)_setOrientationWhenForcedToLandscape:(long long)arg1;
...
- (void)setForceLandscapeOrientation:(bool)arg1;
