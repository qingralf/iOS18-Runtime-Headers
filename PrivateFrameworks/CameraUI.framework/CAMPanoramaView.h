...
@property (setter=_setFilteredNormalizedBaselineOffset:, nonatomic) double _filteredNormalizedBaselineOffset;
...
- (id)_moveDownString;
- (id)_moveUpString;
- (struct CGSize { double x1; double x2; })_previewSizeForBounds:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
...
- (void)_setFilteredNormalizedBaselineOffset:(double)arg1;
