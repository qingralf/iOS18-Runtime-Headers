...
+ (id)clientVideoMetadataForRequest:(id)arg1 withCreationDate:(id)arg2 isEV0ForHDR:(bool)arg3 livePhotoIdentifierOverride:(id)arg4 slomoPlayback:(bool)arg5;
...
- (void).cxx_destruct;
- (id)_adjustmentsDataForCinematicVideoRequest:(id)arg1 result:(id)arg2;
- (id)_adjustmentsDataForRequest:(id)arg1 captureDimensions:(struct { int x1; int x2; })arg2 portraitMetadata:(id)arg3;
- (id)_adjustmentsDataForSloMoVideoRequest:(id)arg1;
- (id)_adjustmentsDataForVideoRequest:(id)arg1;
...
- (id)_jobDictionaryForStillImageLocalResult:(id)arg1 filteredLocalResult:(id)arg2 fromRequest:(id)arg3 loggingIdentifier:(id)arg4;
- (id)_jobDictionaryForTimelapsePlaceholderResult:(id)arg1;
- (id)_jobDictionaryForVideoLocalResult:(id)arg1 fromRequest:(id)arg2 loggingIdentifier:(id)arg3;
