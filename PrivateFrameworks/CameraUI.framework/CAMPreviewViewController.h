...
@interface CAMPreviewViewController : UIViewController <CAMExposureDelegate, CAMFacesDelegate, CAMFocusDelegate, CAMFocusIndicatorViewDelegate, UIGestureRecognizerDelegate> {
    ...
    CAMFocusIndicatorView * __externalFocusLockIndicator;
    bool  __externalLockNeedsCurrentFacesToAppear;
...
@property (nonatomic, readonly) bool _disableAllIndicators;
...
@property (nonatomic, readonly) CAMFocusIndicatorView *_externalFocusLockIndicator;
@property (setter=_setExternalLockNeedsCurrentFacesToAppear:, nonatomic) bool _externalLockNeedsCurrentFacesToAppear;
...
- (id)_externalFocusLockIndicator;
...
- (void)_setExternalLockNeedsCurrentFacesToAppear:(bool)arg1;
