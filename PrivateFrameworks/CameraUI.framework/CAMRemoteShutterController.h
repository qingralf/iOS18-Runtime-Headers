...
@property (nonatomic) bool spatialEnabled;
...
- (long long)_convertPanoramaDirection:(long long)arg1;
...
- (bool)cameraConnectionIsSpatialCapture:(id)arg1;
...
- (bool)cameraConnectionPauseCapture:(id)arg1;
- (bool)cameraConnectionResumeCapture:(id)arg1;
...
- (void)setPanoramaDirection:(long long)arg1;
...
- (void)setSpatialEnabled:(bool)arg1;
