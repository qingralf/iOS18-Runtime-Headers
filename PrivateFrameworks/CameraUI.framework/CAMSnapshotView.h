...
- (bool)dimmed;
- (void)fadeOutAnimatedWithStyle:(long long)arg1 completion:(id /* block */)arg2;
- (id)initWithView:(id)arg1 desiredAspectRatio:(long long)arg2;
- (void)prepareForResumingUsingCrossfade;
- (void)removeAllAnimationsOnLayer:(id)arg1 recursively:(bool)arg2 shouldLog:(bool)arg3;
