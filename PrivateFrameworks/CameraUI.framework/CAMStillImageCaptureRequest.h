...
@interface CAMStillImageCaptureRequest : CAMCaptureRequest <CAMBurstIdentifierProvider, CAMBurstRequest, CAMCaptureAdjustmentProvider, CAMIrisRequest, CAMTimelapseRequest, NSCopying, NSMutableCopying> {
    ...
    <CEKCaptureStyle> * _semanticStyle;
...
@property (nonatomic, readonly) <CEKCaptureStyle> *semanticStyle;
@property (nonatomic, readonly) long long stereoCaptureStatus;
...
- (void)_configureRawFileFormat:(id)arg1 context:(id)arg2 rawPixelFormatType:(unsigned int)arg3;
