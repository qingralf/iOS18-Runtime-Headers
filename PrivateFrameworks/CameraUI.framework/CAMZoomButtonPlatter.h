...
@interface CAMZoomButtonPlatter : UIView {
    ...
    long long  _buttonAccessoryPosition;
...
- (long long)buttonAccessoryPosition;
...
- (void)setButtonAccessoryPosition:(long long)arg1;
- (void)setButtonAccessoryPosition:(long long)arg1 animated:(bool)arg2;
