...
@property (getter=isPlatterLayoutCompact, nonatomic) bool platterLayoutCompact;
...
- (void)configureForSingleCameraToggleOnlyWithZoomFactor:(double)arg1 minimumZoomFactor:(double)arg2 displayMinimumZoomFactor:(double)arg3 maximumZoomFactor:(double)arg4 displayMaximumZoomFactor:(double)arg5;
...
- (void)setEdgeMargin:(double)arg1 animated:(bool)arg2;
...
- (void)setPlatterLayoutCompact:(bool)arg1;
- (void)setPlatterLayoutCompact:(bool)arg1 animated:(bool)arg2;
