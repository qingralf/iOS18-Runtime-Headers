...
+ (id)exifFocalLengthsByZoomFactorForMode:(long long)arg1 device:(long long)arg2 videoConfiguration:(long long)arg3 videoStabilizationStrength:(long long)arg4 customLensGroup:(id)arg5 isTrueVideo:(bool)arg6;
