...
@interface CUCaptureController : NSObject <CAMCaptureRequestIntervalometerDelegate, CAMCaptureService> {
    ...
    bool  __waitingForRecordingToStart;
    ...
    <CAMStereoCaptureStatusDelegate> * _stereoCaptureStatusDelegate;
...
@property (getter=_isWaitingForRecordingToStart, setter=_setWaitingForRecordingToStart:, nonatomic) bool _waitingForRecordingToStart;
...
@property (nonatomic) <CAMControlsDelegate> *controlsDelegate;
...
@property (nonatomic) <CAMDocumentSceneResultDelegate> *documentSceneResultDelegate;
...
@property (nonatomic) <CAMStereoCaptureStatusDelegate> *stereoCaptureStatusDelegate;
...
@property (setter=_setVideoCapturePaused:, nonatomic) bool videoCapturePaused;
...
- (void)_documentScanningChangedForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3;
...
- (void)_setVideoCapturePaused:(bool)arg1;
- (void)_setWaitingForRecordingToStart:(bool)arg1;
...
- (void)_stereoCaptureStatusChangedForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3;
- (void)_stereoVideoCaptureStatusChangedForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3;
- (bool)_stopCapturingVideoAndDisableCaptureAvailabilityWhileStopping:(bool)arg1;
...
- (void)changeToPreviewFilters:(id)arg1 captureMode:(long long)arg2;
- (void)changeToSmartStyle:(id)arg1;
...
- (void)dealloc;
- (id)documentSceneResultDelegate;
...
- (void)preparePhotoOutputForExpectedPhotoResolution:(long long)arg1;
...
- (void)setDocumentSceneResultDelegate:(id)arg1;
...
- (void)setStereoCaptureStatusDelegate:(id)arg1;
...
- (id)stereoCaptureStatusDelegate;
...
- (void)updateCaptureButtonControlsForCaptureMode:(long long)arg1 devicePosition:(long long)arg2 isRecording:(bool)arg3;
