...
@interface CARDisplayInfo : NSObject {
    ...
    NSArray * _streams;
    bool  _supportsAdditionalContent;
    bool  _supportsCarPlayContent;
    bool  _supportsDDPContent;
...
@property (nonatomic, readonly) bool supportsAdditionalContent;
@property (nonatomic, readonly) bool supportsCarPlayContent;
@property (nonatomic, readonly) bool supportsDDPContent;
