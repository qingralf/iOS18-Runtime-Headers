...
@interface CARSession : NSObject <CARAppearanceManagerDelegate> {
    ...
    unsigned long long  _sessionStatusOptions;
...
@property (nonatomic, readonly) unsigned long long sessionStatusOptions;
...
- (id)initWithFigEndpoint:(struct OpaqueFigEndpoint { }*)arg1 sessionStatusOptions:(unsigned long long)arg2;
...
- (unsigned long long)sessionStatusOptions;
