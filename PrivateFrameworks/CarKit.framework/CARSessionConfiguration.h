...
@interface CARSessionConfiguration : NSObject {
    ...
    bool  _supportsLogTransfer;
    bool  _supportsSiriMixable;
    bool  _supportsSiriZLL;
    bool  _supportsSiriZLLButton;
    bool  _supportsVehicleData;
    unsigned long long  _transportType;
    long long  _userInterfaceStyle;
    NSArray * _vehicleButtons;
    unsigned long long  _vehicleDataPluginCount;
    NSString * _vehicleDataProtocolVersion;
...
@property (nonatomic, readonly) bool hasGaugeClusterScreen;
...
@property (nonatomic, readonly) bool supportsLogTransfer;
...
@property (nonatomic, readonly) bool supportsVehicleData;
...
@property (nonatomic, readonly) unsigned long long vehicleDataPluginCount;
@property (nonatomic, readonly) NSString *vehicleDataProtocolVersion;
...
- (id)infoResponse;
- (id)initWithSessionStatusOptions:(unsigned long long)arg1 propertySupplier:(id /* block */)arg2;
...
- (id)vehicleButtons;
- (unsigned long long)vehicleDataPluginCount;
- (id)vehicleDataProtocolVersion;
