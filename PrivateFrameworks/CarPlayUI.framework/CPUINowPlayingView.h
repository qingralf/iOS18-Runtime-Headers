...
@property (nonatomic, retain) UIView *badgeAnnotationView;
...
- (id)_equalHeightVerticalSpacers:(unsigned long long)arg1 minimumPadding:(double)arg2 maximumPadding:(double)arg3;
- (id)activeConstraints;
- (id)artworkViewBrick;
- (id)badgeAnnotationView;
...
- (void)setBadgeAnnotationView:(id)arg1;
