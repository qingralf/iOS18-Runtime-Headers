...
@interface CPUINowPlayingViewController : UIViewController <CPUIPlayModeControlViewDelegate, MRNowPlayingAudioFormatControllerDelegate> {
    ...
    UIStackView * _audioSessionRenderingModeView;
...
@property (nonatomic, retain) UIStackView *audioSessionRenderingModeView;
...
@property (nonatomic, retain) UIImage *finalArtworkImage;
...
@property (nonatomic, retain) UIImage *rawArtworkImage;
...
- (void)_setNowPlayingNavBarActive:(bool)arg1;
...
- (void)_updateAudioFormatContentInfo:(id)arg1;
- (void)_updateButtonAXLabelsForButtons:(id)arg1;
...
- (id)audioSessionRenderingModeView;
...
- (void)setAudioSessionRenderingModeView:(id)arg1;
- (void)setDataSource:(id)arg1;
- (void)setDelegate:(id)arg1;
- (void)setFastForwardButtonLongPressRecognizer:(id)arg1;
- (void)setFinalArtworkImage:(id)arg1;
...
- (void)setRawArtworkImage:(id)arg1;
