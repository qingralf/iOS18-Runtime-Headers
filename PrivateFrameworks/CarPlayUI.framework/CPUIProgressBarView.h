...
@interface CPUIProgressBarView : UIView {
    NSLayoutConstraint * _barWidthConstraint;
...
@property (nonatomic, retain) NSLayoutConstraint *barWidthConstraint;
...
- (void)setBarWidthConstraint:(id)arg1;
