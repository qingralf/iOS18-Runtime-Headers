...
@interface CPUISongDetailsView : UIView {
    ...
    CPUISongAttributionView * _attributionView;
...
@property (nonatomic, retain) UIImage *attributionArtwork;
@property (nonatomic, readonly) CPUIModernButton *attributionButton;
@property (nonatomic, retain) NSString *attributionName;
@property (nonatomic, retain) CPUISongAttributionView *attributionView;
...
- (void)setAttributionArtwork:(id)arg1;
