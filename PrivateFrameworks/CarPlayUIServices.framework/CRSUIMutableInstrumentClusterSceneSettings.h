...
@interface CRSUIMutableInstrumentClusterSceneSettings : UIMutableCarPlayApplicationSceneSettings <CRSUIInstrumentClusterSceneSettings, CRSUIMutableFrameRateLimitProviding, CRSUIMutableMapStyleProviding>

@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (readonly, copy) NSString *description;
@property (nonatomic, readonly) NSNumber *frameRateLimit;
@property (readonly) unsigned long long hash;
@property (nonatomic) unsigned long long hostedAltScreenPresentationType;
...
- (void)setHostedAltScreenPresentationType:(unsigned long long)arg1;
