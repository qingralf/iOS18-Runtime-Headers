...
@interface CSLPRFAppBacklightPrivacySettings : NSObject <CSLPRFAppBacklightPrivacyProperties, CSLPRFPerApplicationSettings> {
    ...
    bool  _lock_privacyDuringAlwaysOnForLiveActivities;
...
- (id)privacyDuringAlwaysOnForLiveActivitiesWithIgnoredSpecifier:(id)arg1;
...
- (void)setPrivacyDuringAlwaysOnForLiveActivities:(id)arg1 withIgnoredSpecifier:(id)arg2;
