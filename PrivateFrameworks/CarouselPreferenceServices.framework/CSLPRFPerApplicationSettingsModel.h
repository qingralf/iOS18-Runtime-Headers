...
@interface CSLPRFPerApplicationSettingsModel : NSObject <CSLPRFApplicationLibraryObserving, CSLPRFPerApplicationSettingsDelegate, CSLPRFTwoWaySyncSettingDelegate> {
    ...
    <CSLPRFPerApplicationSettingsCustomizationDelegate> * _customizationDelegate;
...
@property (nonatomic) <CSLPRFPerApplicationSettingsCustomizationDelegate> *customizationDelegate;
...
- (id)_lock_customizedSettingsForBundleIdentifier:(id)arg1;
...
- (id)settingsObjectForBundleId:(id)arg1 customizedSettings:(id)arg2 existingSettings:(id)arg3;
