...
@interface CSLPRFStingSettingsModelData : NSObject <NSCopying, NSSecureCoding> {
    NSArray * _accessibilityShortcutsArray;
...
@property (nonatomic, retain) NSArray *accessibilityShortcutsArray;
...
- (void).cxx_destruct;
- (id)accessibilityShortcutsArray;
...
- (void)setAccessibilityShortcutsArray:(id)arg1;
