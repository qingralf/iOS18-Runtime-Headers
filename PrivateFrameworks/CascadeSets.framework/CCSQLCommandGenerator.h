...
+ (id)_removeEndingSemicolonFromCommandString:(id)arg1;
...
+ (id)insertCommandStringWithTableName:(id)arg1 columnNames:(id)arg2 returningColumns:(id)arg3 onConflict:(id)arg4;
