...
@property (nonatomic, readonly) NSString *purchaseOption;
...
- (id)initWithName:(id)arg1 plan:(id)arg2 url:(id)arg3 applePaySupported:(bool)arg4 responseType:(id)arg5 warningText:(id)arg6 purchaseOption:(id)arg7;
- (id)name;
- (id)plan;
