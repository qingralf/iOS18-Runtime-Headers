...
+ (struct CGPoint { double x1; double x2; })locationForStickerReactionWithParentFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 reactionIndex:(long long)arg2 parentIsFromMe:(bool)arg3 insets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg4;
+ (double)rotationForGUIDHash:(long long)arg1;
