...
@property (nonatomic, readonly) NSURL *appendedBundleURL;
...
- (id)guid;
- (id)imageData;
- (id)initWithFileURL:(id)arg1 size:(struct CGSize { double x1; double x2; })arg2 transferGUID:(id)arg3 guid:(id)arg4 createdDate:(id)arg5 shareURL:(id)arg6;
- (id)irisVideoPath;
