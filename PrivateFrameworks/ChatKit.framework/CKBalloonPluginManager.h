...
@property (nonatomic, readonly) NSArray *allOrderedCombinedStickerApps;
...
@property (nonatomic, readonly) NSArray *combinedStickerApps;
@property (nonatomic, retain) NSDictionary *combinedStickersAppsIndexPathMap;
@property (nonatomic, retain) NSHashTable *currentExtensionConsumers;
...
@property (nonatomic, retain) UIViewController *lastUsedPhotoViewController;
@property (nonatomic) long long numberOfSectionsToKeep;
@property (nonatomic, retain) NSSet *oldVisibleSwitcherPluginIdentifiers;
@property (nonatomic, readonly) NSArray *orderedCombinedStickerApps;
...
@property (nonatomic, retain) NSMutableSet *prefetchIconKeys;
...
- (id)_decodeIndexPathMap:(id)arg1 allowMigration:(bool)arg2;
...
- (id)_pluginIndexPathForPluginWithIdentifier:(id)arg1 pluginMap:(id)arg2;
...
- (id)combinedStickerApps;
- (id)combinedStickersAppsIndexPathMap;
- (void)commitInteractionTimeOrderingChanges;
- (id)createFakeAppsForPPTTesting:(unsigned long long)arg1;
- (id)currentExtensionConsumers;
- (void)dealloc;
- (void)deleteAppWithIdentifier:(id)arg1 completion:(id /* block */)arg2;
...
- (bool)isBalloonPluginVisible:(id)arg1;
...
- (id)pluginForExtensionIdentifier:(id)arg1;
...
- (void)saveCombinedAppsWithNotification:(bool)arg1;
...
- (void)setCombinedStickersAppsIndexPathMap:(id)arg1;
- (void)setCurrentExtensionConsumers:(id)arg1;
...
- (void)setLastUsedPhotoViewController:(id)arg1;
...
- (void)setPlugin:(id)arg1 hiddenInSendMenuAndStickers:(bool)arg2;
...
- (void)setPrefetchIconKeys:(id)arg1;
...
- (void)updateIndexPath:(id)arg1 forCombinedStickerApp:(id)arg2;
