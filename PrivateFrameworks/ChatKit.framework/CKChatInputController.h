...
@property (nonatomic, retain) CKTranscriptPluginPresentationConfiguration *currentPresentationConfig;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (nonatomic, retain) CKComposition *deferredComposition;
...
@property (nonatomic) bool isAppCardDraggingBelowKeyboardDetent;
...
@property (nonatomic) bool isDisplayingReplaceCompositionAlert;
...
@property (nonatomic, retain) IMBalloonPlugin *pluginToResumeForStickerDrag;
...
@property (nonatomic, retain) CKMessagePartChatItem *stickerPickerMessagePartParentChatItem;
@property (nonatomic, retain) CKStickerReactionSession *stickerReactionSession;
@property (readonly) Class superclass;
@property (nonatomic, retain) CKKeyboardContentViewController *switcherInputViewController;
@property (nonatomic, readonly) CKConversation *targetConversation;
...
- (void)_beginPreviewCreationWithFileURL:(id)arg1;
...
- (void)_presentFullScreenModalBrowserForPlugin:(id)arg1 dataSource:(id)arg2;
- (bool)_presentPluginIfNecessaryWithPayload:(id)arg1 withPayloadID:(id)arg2;
...
- (void)_presentSendLaterUnsupportedAlertForIdentifier:(id)arg1 handler:(id /* block */)arg2;
- (void)_presentSendMenuForAppCardContentViewController:(id)arg1 appCardPresentationStyle:(unsigned long long)arg2 withCompletion:(id /* block */)arg3;
- (void)_reconfigurePluginDataSourceWithBalloonControllerIfNecessary;
- (void)_sendLaterSelectedFromSendMenuWithPresentation:(id)arg1;
...
- (unsigned long long)appPresentationStyleForShowingPluginID:(id)arg1;
- (void)appSelectionInterfaceSelectedItem:(id)arg1;
- (bool)appStoreIsDisplayed;
- (id)appTitleOverride;
- (void)appendMediaPayloadToText:(id)arg1;
- (void)applicationWillAddDeactivationReasonNotification:(id)arg1;
- (id)balloonPluginForIndexPath:(id)arg1;
- (void)beginStickerReactionSessionWithChatItem:(id)arg1 cell:(id)arg2;
...
- (id)configurePhotosDraftAssetArchivesWithConversationID:(id)arg1;
...
- (id)currentPresentationConfig;
- (void)dealloc;
- (void)deferredCommitPayload:(id)arg1;
- (id)deferredComposition;
...
- (void)dismissStickerPickerPreservingChatItem:(bool)arg1 completion:(id /* block */)arg2;
...
- (void)extensionRemoteConnectionWasInterrupted:(id)arg1;
- (id)externalPluginControllerProvider;
- (void)forceDismissBrowserWithoutAnimation;
- (void)generatePreviewAndStoreInCacheForSendingPhotoFromPayload:(id)arg1;
...
- (bool)isShowingAppCardForExtensionIdentifier:(id)arg1;
...
- (void)messageEntryView:(id)arg1 didSelectUIStickerInEmojiPicker:(id)arg2;
...
- (void)messageEntryViewDidClearAudioRecordingUI:(id)arg1;
- (void)messageEntryViewDidCollapse:(id)arg1;
- (void)messageEntryViewDidExpand:(id)arg1;
- (void)messageEntryViewDidStageAudioRecordingUI:(id)arg1;
...
- (void)notifyActiveBrowserAssetArchiveWasRemoved:(id)arg1;
...
- (id)pluginBundleID;
- (id)pluginContextForPlugin:(id)arg1;
- (id)pluginToResumeForStickerDrag;
...
- (void)presentSendMenuForAppCardOverseerWithAppCardViewController:(id)arg1 presentationStyle:(unsigned long long)arg2;
...
- (void)requestPhotoBrowserToPrepareForDraftClearingPhotoShelfViewController:(bool)arg1;
...
- (void)requestTransitionPluginFromFullScreen:(id)arg1 toExpanded:(bool)arg2;
...
- (void)setCurrentPresentationConfig:(id)arg1;
- (void)setDeferredComposition:(id)arg1;
...
- (void)setPluginToResumeForStickerDrag:(id)arg1;
...
- (void)setStickerPickerMessagePartParentChatItem:(id)arg1;
- (void)setStickerReactionSession:(id)arg1;
...
- (void)showBrowserPopoverForPlugin:(id)arg1 dataSource:(id)arg2 style:(unsigned long long)arg3 presentationConfiguration:(id)arg4;
- (void)showDTCompose;
- (void)showEntryViewPhotosShelf:(id)arg1 completion:(id /* block */)arg2;
- (void)showExpandedBrowserPopover:(id)arg1 presentationConfiguration:(id)arg2;
...
- (void)showPluginWithExtensionIdentifier:(id)arg1 sourceView:(id)arg2;
- (void)showSendLater;
...
- (id)stickerPickerMessagePartParentChatItem;
- (void)stickerPickerWasHidden;
- (void)stickerPickerWasHiddenPreservingChatItem:(bool)arg1;
- (id)stickerReactionSession;
- (void)swipeDismissBrowser;
- (id)switcherInputViewController;
- (bool)switcherPluginCanMessageAPIOnBehalfOfPlugin:(id)arg1;
...
- (void)switcherViewController:(id)arg1 willPresentBrowserModally:(id)arg2;
