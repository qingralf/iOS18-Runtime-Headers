...
+ (bool)layoutTypeIsMessageBalloonForChatItem:(id)arg1;
...
+ (double)transcriptTapbackMinSpacingForSenderChatItem:(id)arg1 withNextChatItem:(id)arg2 previousItem:(id)arg3 associatedChatItem:(id)arg4;
