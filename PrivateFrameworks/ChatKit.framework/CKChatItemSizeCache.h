...
- (void).cxx_destruct;
- (void)___invalidateSizeCacheMetricsForKeys:(id)arg1;
...
- (void)invalidateCachedSizeForChatItems:(id)arg1 reason:(id)arg2;
- (void)invalidateCachedSizeForGUIDPrefix:(id)arg1 reason:(id)arg2;
- (id)orderedKeys;
