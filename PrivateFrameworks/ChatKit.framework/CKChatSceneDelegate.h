...
@interface CKChatSceneDelegate : CKSceneDelegate <CKAlertSuppressionContextsProviding, CKChatControllerDelegate, CKChatControllerSendMenuDelegate, CKInteractionNotificationViewDelegate, CKSendMenuPresentationDelegate> {
