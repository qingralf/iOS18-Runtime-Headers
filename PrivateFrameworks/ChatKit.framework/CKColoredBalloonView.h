...
@interface CKColoredBalloonView : CKBalloonView {
    CKBalloonShapeView * _balloonShapeView;
...
@property (nonatomic, retain) CKBalloonShapeView *balloonShapeView;
...
- (void).cxx_destruct;
- (bool)_shouldApplySendLaterStyleForComposition:(id)arg1;
...
- (void)setBalloonShapeView:(id)arg1;
