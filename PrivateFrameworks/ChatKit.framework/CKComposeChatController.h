...
@interface CKComposeChatController : CKChatController <CKBusinessInfoViewDelegate, CKComposeNavbarManagerDelegate, CKComposeRecipientSelectionControllerDelegate, CKMacToolbarItemProvider, CNAutocompleteSuggestionsViewControllerDelegate> {
...
- (id)initWithRecipientAddresses:(id)arg1 composition:(id)arg2 chatIdentifier:(id)arg3 bizIntent:(id)arg4 simID:(id)arg5;
...
- (id)navbarManager;
- (void)navbarManagerIsAnimatingNavbarTransition:(id)arg1;
