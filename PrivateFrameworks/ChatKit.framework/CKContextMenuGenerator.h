...
+ (id)_menuActionToInviteHandleToShareTheirScreen:(id)arg1 conversation:(id)arg2 andContactsManager:(id)arg3;
+ (id)_menuActionToSendEmailForConversation:(id)arg1 andContactsManager:(id)arg2;
+ (id)_menuActionToShareMyScreenWithHandle:(id)arg1 conversation:(id)arg2 andContactsManager:(id)arg3;
...
+ (id)subMenuForScreenSharingOptionsWithHandle:(id)arg1 conversation:(id)arg2 andContactsManager:(id)arg3;
