...
@interface CKConversationConfirmationAlertsController : NSObject {
    ...
    bool  _shouldPromptBusinessChatSpamReason;
    bool  _shouldPromptStopBusinessChat;
}
...
@property (nonatomic) bool shouldPromptBusinessChatSpamReason;
@property (nonatomic) bool shouldPromptStopBusinessChat;

- (void).cxx_destruct;
- (void)_configureAppearanceForAlertController:(id)arg1;
- (id)_conversationDeletionAlertMessageForConversations:(id)arg1;
...
- (void)_presentReportSpamReasonWithConversations:(id)arg1 didReportBlock:(id /* block */)arg2;
- (id /* block */)_presentStopBusinessChatAlertIfNeededForConversations:(id)arg1;
...
- (void)setShouldPromptBusinessChatSpamReason:(bool)arg1;
- (void)setShouldPromptStopBusinessChat:(bool)arg1;
