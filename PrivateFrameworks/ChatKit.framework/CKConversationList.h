...
- (void)_deleteBrandLogosIfNeededForConversations:(id)arg1;
...
- (void)_handleUpdatedMessagesWithSummariesNotification:(id)arg1;
...
- (id)conversationForHandles:(id)arg1 displayName:(id)arg2 lastAddressedHandle:(id)arg3 lastAddressedSIMID:(id)arg4 joinedChatsOnly:(bool)arg5 findMatchingNamedGroups:(bool)arg6 create:(bool)arg7;
- (id)conversations;
- (id)conversationsDictionary;
- (id)conversationsForExistingChatsWithGUIDs:(id)arg1;
...
- (void)updatePinnedConversationsFromDataSourceWithConversationFetch:(bool)arg1;
