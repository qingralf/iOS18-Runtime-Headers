...
@interface CKConversationListCollectionViewController : UICollectionViewController <CKContainerSearchControllerDelegate, CKConversationListCollectionViewCellDelegate, CKConversationListControllerProtocol, CKConversationListEmbeddedCollectionViewCellDelegate, CKFocusFilterBannerDelegate, CKMacToolbarItemProvider, CKOnboardingControllerDelegate, CKPinnedConversationCollectionViewCellDelegate, CKPinnedConversationViewDelegate, CNContactViewControllerDelegate, CNMeCardSharingSettingsViewControllerDelegate, IMCloudKitEventHandler, IMFocusStateManagerDelegate, IMReasonTrackingUpdaterDelegate, UICollectionViewDelegate, UICollectionViewDelegate_Private, UICollectionViewDragDelegate, UICollectionViewDropDelegate, UIScrollViewDelegate, UISearchBarDelegate, UISearchControllerDelegate> {
    ...
    UIRefreshControl * _collectionViewRefreshControl;
    ...
    CKCloudSyncStatusView * _syncStatusView;
...
@property (nonatomic, retain) UIRefreshControl *collectionViewRefreshControl;
...
@property (nonatomic, retain) NSTimer *refreshControlTimer;
...
@property (nonatomic, retain) CKCloudSyncStatusView *syncStatusView;
...
@property (nonatomic, retain) IMReasonTrackingUpdater *updater;
...
- (void)_consumeSummaryForConversationAtIndexPathIfNeeded:(id)arg1;
- (void)_consumeSummaryOnUnreadCountChangeForChatIfNeeded:(id)arg1;
- (id)_contactStore;
...
- (void)_didPullToRefresh:(id)arg1;
- (void)_didReceiveSummaries:(id)arg1;
...
- (id)_internalMenuForSelectedConversation:(id)arg1;
- (id)_internalMenuForSelectedConversations:(id)arg1;
- (id)_internalMenuForSelectedConversations:(id)arg1 customMenuElements:(id)arg2;
...
- (id)_previewForHighlightingOrDismissingContextMenuWithConfiguration:(id)arg1 indexPath:(id)arg2 collectionView:(id)arg3;
...
- (void)_showConversation:(id)arg1 withComposition:(id)arg2;
...
- (void)_toggleUnreadStateForSelectedConversations:(id)arg1;
...
- (void)_updateSyncStatusViewWithSyncState:(id)arg1;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })collectionViewBoundsForPinnedConversationCollectionViewCell:(id)arg1;
- (id)collectionViewRefreshControl;
...
- (void)configureAppEntityForConversationCell:(id)arg1 forItemIdentifier:(id)arg2;
...
- (void)configureSearchBarEnabled:(bool)arg1;
...
- (bool)listCellIsBeingDisplayedAsGhostedCellInPinnedSection:(id)arg1;
- (void)loadView;
...
- (id)reportConcernForChat:(id)arg1;
...
- (void)setCollectionViewRefreshControl:(id)arg1;
...
- (void)setRefreshControlTimer:(id)arg1;
...
- (void)setSyncStatusView:(id)arg1;
