...
@interface CKConversationListEmbeddedCollectionViewCell : UICollectionViewListCell <CKConversationListCellLayoutConfigurable> {
    ...
    <CKConversationListEmbeddedCollectionViewCellDelegate> * _embeddedCellDelegate;
...
@property (nonatomic) <CKConversationListEmbeddedCollectionViewCellDelegate> *embeddedCellDelegate;
...
- (void).cxx_destruct;
- (id)_leadingEditingAccessoryConfigurationsForEditingMode:(unsigned long long)arg1 usingState:(id)arg2;
- (id)_multiselectCellAccessoryConfigurationUsingState:(id)arg1;
- (id)cellLayout;
