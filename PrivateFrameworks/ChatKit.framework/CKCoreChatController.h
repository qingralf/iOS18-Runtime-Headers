...
@interface CKCoreChatController : CKScrollViewController <CKFullScreenBalloonViewControllerDelegate, IMChatSendProgressDelegate, IMSystemMonitorListener> {
    ...
    id /* block */  _insertItemsEmojiTapbacksCallBack;
    ...
    id /* block */  _removeItemsEmojiTapbacksCallBack;
    NSTimer * _satelliteFetchTimer;
    UIView * _satelliteUnavailableLabel;
...
@property (nonatomic, retain) IMHandleStatusObserverAssertion *handleStatusAssertion;
...
@property (nonatomic, copy) id /* block */ insertItemsEmojiTapbacksCallBack;
...
@property (nonatomic, copy) id /* block */ removeItemsEmojiTapbacksCallBack;
@property (nonatomic, retain) NSTimer *satelliteFetchTimer;
@property (nonatomic, retain) UIView *satelliteUnavailableLabel;
...
- (id)_fullScreenBalloonViewControllerWithChatItem:(id)arg1 displayConfiguration:(id)arg2;
...
- (void)_handleStatusChangedNotification:(id)arg1;
- (void)_handleStatusInvitationReceivedNotification:(id)arg1;
- (void)_handleStatusStateChangedNotification:(id)arg1;
...
- (void)_registerCommSafetyReceivedEventForTransfer:(id)arg1 messageGUID:(id)arg2;
...
- (void)_serviceSwitchNotification:(id)arg1;
- (void)_setConversationDeferredSetup;
- (void)_setTitle:(id)arg1 animated:(bool)arg2;
- (void)_setTranscriptCustomScrollAnimationFromAnimationProperties:(id)arg1;
- (bool)_shouldAllowReply;
- (bool)_shouldAllowReplyFromLockScreen;
- (void)_startSatelliteFetchIfNecessary;
- (void)_statusDaemonDisconnectedNotification:(id)arg1;
...
- (void)_updateGradientReferenceViewForContentInset:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg1 withAnimationProperties:(id)arg2;
...
- (id)associatedTapbackPileViewForFullScreenBalloonViewController:(id)arg1;
...
- (struct CGPoint { double x1; double x2; })contentOffsetForIndexPath:(id)arg1 viewToAlignWith:(id)arg2 allowOverScroll:(bool)arg3;
- (struct CGPoint { double x1; double x2; })contentOffsetForIndexPath:(id)arg1 viewToAlignWith:(id)arg2 allowOverScroll:(bool)arg3 scrollPosition:(unsigned long long)arg4;
- (id)contextualChatItemsForFullScreenBalloonViewController:(id)arg1;
...
- (id)currentlyFocusedChatItemForTapbackInTranscriptCollectionViewController:(id)arg1;
- (void)dealloc;
- (id)delegate;
...
- (id)fullScreenBalloonViewController:(id)arg1 balloonViewForChatItem:(id)arg2;
- (void)fullScreenBalloonViewController:(id)arg1 didAppearAnimated:(bool)arg2;
- (void)fullScreenBalloonViewController:(id)arg1 didDeselectTapback:(id)arg2;
- (void)fullScreenBalloonViewController:(id)arg1 didSelectTapback:(id)arg2;
- (id)fullScreenBalloonViewController:(id)arg1 duplicatedViewForChatItem:(id)arg2;
- (void)fullScreenBalloonViewController:(id)arg1 requestedPresentPlugin:(id)arg2 withPayloadID:(id)arg3;
- (void)fullScreenBalloonViewController:(id)arg1 sendMessageHighlight:(bool)arg2 forChatItem:(id)arg3;
- (void)fullScreenBalloonViewController:(id)arg1 updateTapbackPileAppearanceAsHidden:(bool)arg2;
- (void)fullScreenBalloonViewController:(id)arg1 updateTranscriptBalloonViewAppearanceAsHidden:(bool)arg2;
...
- (id)fullScreenBalloonViewControllerGradientReferenceView:(id)arg1;
...
- (void)fullScreenBalloonViewControllerRequestedAppCardDismiss:(id)arg1;
...
- (bool)fullScreenBalloonViewControllerShouldEnableStickerTapbacks:(id)arg1;
...
- (id)fullScreenBalloonViewControllerSmartEmojiResponses:(id)arg1;
...
- (id)satelliteFetchTimer;
- (id)satelliteUnavailableLabel;
- (bool)saveContact:(id)arg1 shouldUpdate:(bool)arg2;
- (void)scrollToHighlightedMessageScrollContext:(id)arg1;
- (id)scrollView;
...
- (void)sendStickerTapback:(id)arg1 mediaObject:(id)arg2 parentMessagePartChatItem:(id)arg3;
- (void)sendTapback:(id)arg1 chatItem:(id)arg2 isRemoval:(bool)arg3;
...
- (void)setHandleStatusAssertion:(id)arg1;
...
- (void)setInsertItemsEmojiTapbacksCallBack:(id /* block */)arg1;
...
- (void)setRemoveItemsEmojiTapbacksCallBack:(id /* block */)arg1;
- (void)setSatelliteFetchTimer:(id)arg1;
- (void)setSatelliteUnavailableLabel:(id)arg1;
...
- (bool)shouldShowTapbackAttributionForChatItem:(id)arg1;
- (bool)shouldShowTapbackAttributionForFullScreenBalloonViewController:(id)arg1;
- (bool)shouldShowTapbackPickerForChatItem:(id)arg1;
- (bool)shouldShowTapbackPickerForFullScreenBalloonViewController:(id)arg1;
...
- (void)showFullScreenAcknowledgmentPickerForChatItem:(id)arg1 displayConfiguration:(id)arg2;
- (bool)showFullScreenAcknowledgmentPickerIfNeededForBalloonAtIndexPath:(id)arg1;
- (void)showFullScreenTapbackKeyboardInputForChatItem:(id)arg1;
...
- (void)transcriptCollectionViewController:(id)arg1 didRemoveChatItems:(id)arg2 associatedChatItems:(id)arg3;
...
- (void)transcriptCollectionViewController:(id)arg1 shouldScrollToHighlightedMessage:(id)arg2;
...
- (void)transcriptCollectionViewController:(id)arg1 viewedCommSafetyAssociatedItemsWithIndexPath:(id)arg2;
