...
@interface CKDefaultPluginEntryViewController : UIViewController <CKPluginEntryViewController, UIContextMenuInteractionDelegate> {
    ...
    <CKTranscriptBalloonPluginController> * _pluginBubbleViewController;
    bool  _showsBalloonTail;
}
...
@property (nonatomic, retain) <CKTranscriptBalloonPluginController> *pluginBubbleViewController;
@property (nonatomic) bool showsBalloonTail;
...
- (id)initWithDataSource:(id)arg1 entryViewDelegate:(id)arg2 andPlugin:(id)arg3 customizationPickerDelegate:(id)arg4;
- (void)loadView;
...
- (void)setShowsBalloonTail:(bool)arg1;
