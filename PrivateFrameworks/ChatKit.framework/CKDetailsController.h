...
@interface CKDetailsController : CKScrollViewController <CKBusinessInfoViewDelegate, CKDetailsAddGroupNameViewDelegate, CKDetailsContactsManagerDelegate, CKDetailsContactsTableViewCellDelegate, CKDetailsDownloadAttachmentsHeaderFooterViewDelegate, CKDetailsSearchControllerDelegate, CKKTEnhancedProtectionStatusCellDelegate, CNAvatarViewDelegate, CNGroupIdentityHeaderViewControllerDelegate, CNVisualIdentityPickerPresenterDelegate, CNVisualIdentityPickerViewControllerDelegate, FMFMapViewControllerDelegate, TUIKTConversationViewControllerDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITableViewDataSource, UITableViewDelegate, UITextViewDelegate, UIViewControllerPreviewingDelegate> {
    NSArray * _actions;
    ...
    bool  _wasShowingReadReceiptSwitch;
}
...
@property (nonatomic, retain) CKEnableEnhancedProtectionCell *ktEnableEnhancedProtectionCell;
@property (nonatomic, retain) CKKTEnhancedProtectionStatusCell *ktEnhancedProtectionStateCell;
@property (nonatomic) long long ktEnhancedProtectionStatusCellState;
@property (nonatomic, retain) NSArray *ktHandlesForKtChatStatus;
@property (nonatomic, retain) UITextView *ktSecurityFooterTextView;
@property (nonatomic, retain) CKKTVerifyConversationTableViewCell *ktVerifyConversationCell;
...
@property (nonatomic, readonly) bool shouldShowKeyTransparency;
...
@property (nonatomic) bool wasShowingReadReceiptSwitch;
...
- (unsigned long long)_optionRowForIndexPath:(id)arg1;
...
- (void)_reloadForReadReceiptVisibilityChangeIfNeeded:(id)arg1;
...
- (long long)_targetToggleIndexForOptionRow:(unsigned long long)arg1;
...
- (void)keyTransparencyDetailsStatusCellDidRequestReportToApple:(id)arg1;
- (void)keyTransparencyDetailsStatusCellDidRequestVerification:(id)arg1;
- (void)keyTransparencyDetailsStatusCellDidSelectIgnoreFailures:(id)arg1;
- (void)keyTransparencyDetailsStatusCellDidSelectLearnMore:(id)arg1;
- (id)ktCellForRow:(long long)arg1;
- (unsigned long long)ktChatState;
- (id)ktEnableEnhancedProtectionCell;
- (id)ktEnhancedProtectionStateCell;
- (long long)ktEnhancedProtectionStatusCellState;
- (id)ktHandlesForKtChatStatus;
- (id)ktSecurityFooterTextView;
- (id)ktSecurityFooterView;
- (id)ktVerifyConversationCell;
- (id)labelForChat;
...
- (void)setKtChatState:(unsigned long long)arg1;
- (void)setKtEnableEnhancedProtectionCell:(id)arg1;
- (void)setKtEnhancedProtectionStateCell:(id)arg1;
- (void)setKtEnhancedProtectionStatusCellState:(long long)arg1;
- (void)setKtHandlesForKtChatStatus:(id)arg1;
- (void)setKtSecurityFooterTextView:(id)arg1;
- (void)setKtVerifyConversationCell:(id)arg1;
...
- (void)setWasShowingReadReceiptSwitch:(bool)arg1;
- (id)setupAlternativeCommunicationActionsForChat:(id)arg1;
...
- (void)showContactCardForEntity:(id)arg1 fromView:(id)arg2;
