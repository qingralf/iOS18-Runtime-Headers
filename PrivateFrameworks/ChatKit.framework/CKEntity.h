...
@interface CKEntity : NSObject {
    ...
    bool  _cachedCNContactForNicknameIncludesImageData;
...
@property (nonatomic, retain) CNMutableContact *cachedCNContactForNickname;
@property (nonatomic) bool cachedCNContactForNicknameIncludesImageData;
@property (nonatomic, retain) IMNickname *cachedNicknameForCNContact;
...
- (id)_createNicknameContactForNickname:(id)arg1 emailAddresses:(id)arg2 phoneNumbers:(id)arg3 includeImageData:(bool)arg4;
...
- (id)_nicknameContactForNickname:(id)arg1 emailAddresses:(id)arg2 phoneNumbers:(id)arg3 includeImageData:(bool)arg4;
...
- (id)cachedCNContactForNickname;
- (bool)cachedCNContactForNicknameIncludesImageData;
- (id)cachedNicknameForCNContact;
- (id)chat;
- (id)chatAccount;
- (id)cnContact;
...
- (id)propertyType;
- (id)rawAddress;
- (void)setCachedCNContactForNickname:(id)arg1;
- (void)setCachedCNContactForNicknameIncludesImageData:(bool)arg1;
- (void)setCachedNicknameForCNContact:(id)arg1;
