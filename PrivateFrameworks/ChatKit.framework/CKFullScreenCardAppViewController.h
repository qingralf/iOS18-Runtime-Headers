...
@property (nonatomic, readonly) CKBrowserDragManager *browserDragManager; /* unknown property attribute: ? */
...
@property (nonatomic) UIView *dragTargetView; /* unknown property attribute: ? */
