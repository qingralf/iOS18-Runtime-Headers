...
@property (nonatomic, retain) CKInlineReplyTransparentBlurBackgroundView *blurParentView;
@property (nonatomic, retain) UIVisualEffectView *blurView;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (readonly, copy) NSString *description;
@property (nonatomic) bool hasCompletedAnimationIn;
...
- (void)_animateOut;
- (void)_animateOutWithCompletion:(id /* block */)arg1;
...
- (void)dismissControllerWithCompletion:(id /* block */)arg1;
...
- (void)setBlurParentView:(id)arg1;
- (void)setBlurView:(id)arg1;
- (void)setHasCompletedAnimationIn:(bool)arg1;
