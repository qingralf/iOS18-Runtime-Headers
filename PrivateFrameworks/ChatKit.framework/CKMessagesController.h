...
@interface CKMessagesController : UISplitViewController <CKAlertSuppressionContextsProviding, CKAlertUtilitiesProtocol, CKBrowserViewControllerStoreSendDelegate, CKChatControllerDelegate, CKChatControllerSendMenuDelegate, CKComposeChatControllerDelegate, CKConversationListControllerDelegate, CKCoreChatControllerDelegate, CKInboxViewControllerDelegate, CKInteractionNotificationViewDelegate, CKMacToolbarDelegate, CKMessagesNavigationProviding, CKOnboardingControllerDelegate, CKSelectionViewControllerDelegate, CKSendMenuPresentationDelegate, IMFocusStateManagerDelegate, UINavigationControllerDelegate, UIResponderStandardEditActions, UISplitViewControllerDelegate> {
    ...
    bool  hasBegunShowingConversationList;
...
- (void)_checkChatControllerLeaksForExistingController:(id)arg1 newController:(id)arg2;
...
- (void)_showChatControllerLeakAlertUI:(id)arg1;
- (void)_showNewComposeWithRecipients:(id)arg1 composition:(id)arg2 chatIdentifier:(id)arg3 bizIntent:(id)arg4 launchPluginWithBundleID:(id)arg5 pluginLaunchPayload:(id)arg6 animated:(bool)arg7 sendMessageHandler:(id /* block */)arg8;
- (void)_showNewComposeWithRecipients:(id)arg1 composition:(id)arg2 chatIdentifier:(id)arg3 bizIntent:(id)arg4 launchPluginWithBundleID:(id)arg5 pluginLaunchPayload:(id)arg6 animated:(bool)arg7 simID:(id)arg8 sendMessageHandler:(id /* block */)arg9;
- (void)_showNewComposeWithRecipients:(id)arg1 composition:(id)arg2 chatIdentifier:(id)arg3 bizIntent:(id)arg4 launchPluginWithBundleID:(id)arg5 pluginLaunchPayload:(id)arg6 startAudioRecording:(bool)arg7 animated:(bool)arg8 simID:(id)arg9 sendMessageHandler:(id /* block */)arg10;
...
- (id)_sourceViewForFluidTransitionWithConversation:(id)arg1;
...
- (void)chatController:(id)arg1 shouldComposeAudioMessageWithRecipientAddresses:(id)arg2;
- (void)chatController:(id)arg1 shouldComposeConversationWithRecipientAddresses:(id)arg2;
- (void)chatController:(id)arg1 shouldComposeConversationWithRecipientAddresses:(id)arg2 composition:(id)arg3;
- (void)chatController:(id)arg1 shouldComposeVideoMessageWithRecipientAddresses:(id)arg2;
...
- (void)chatControllerDidReselectConversation:(id)arg1;
...
- (void)notifyThatKeepMessagesSettingWasResetIfNeededWithCompletion:(id /* block */)arg1;
...
- (void)showConversationListWithAnimation:(bool)arg1 didDismissController:(bool*)arg2;
- (void)showDebugMenu;
...
- (void)showNewMessageCompositionPanelWithRecipients:(id)arg1 chatID:(id)arg2 composition:(id)arg3 appendToExistingDraft:(bool)arg4 suggestedReplies:(id)arg5 animated:(bool)arg6 bizIntent:(id)arg7 launchPluginWithBundleID:(id)arg8 pluginLaunchPayload:(id)arg9 startAudioRecording:(bool)arg10 simID:(id)arg11 sendMessageHandler:(id /* block */)arg12;
...
- (void)showNewMessageCompositionPanelWithRecipients:(id)arg1 composition:(id)arg2 chatID:(id)arg3 animated:(bool)arg4;
