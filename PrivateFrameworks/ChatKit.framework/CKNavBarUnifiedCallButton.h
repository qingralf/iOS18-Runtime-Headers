...
@property (nonatomic, retain) UIAction *faceTimeInviteToShareTheirScreenAction;
...
@property (nonatomic, retain) UIAction *faceTimeShareMyScreenAction;
...
- (id)faceTimeInviteToShareTheirScreenAction;
- (id)faceTimeJoinWithAudioAction;
- (id)faceTimeJoinWithVideoAction;
- (id)faceTimeShareMyScreenAction;
...
- (void)setFaceTimeInviteToShareTheirScreenAction:(id)arg1;
- (void)setFaceTimeJoinWithAudioAction:(id)arg1;
- (void)setFaceTimeJoinWithVideoAction:(id)arg1;
- (void)setFaceTimeShareMyScreenAction:(id)arg1;
...
- (void)updateWithStyle:(long long)arg1 availabilityForVideo:(bool)arg2 audio:(bool)arg3 telephony:(bool)arg4 screenSharing:(bool)arg5;
