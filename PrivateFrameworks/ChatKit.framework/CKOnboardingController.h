...
@property (getter=_appleIntelligenceOnboardingController, nonatomic, retain) OBWelcomeController *appleIntelligenceOnboardingController;
...
- (void)setAppleIntelligenceOnboardingController:(id)arg1;
