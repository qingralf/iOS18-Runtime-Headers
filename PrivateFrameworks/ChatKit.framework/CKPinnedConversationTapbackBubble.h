...
@property (nonatomic, retain) IMTapback *displayedTapback;
...
@property (nonatomic, retain) UIView *tapbackContainerView;
@property (nonatomic, retain) CKAcknowledgmentGlyphView *tapbackGlyph;
@property (nonatomic, retain) UIView *tapbackView;
...
- (id)broadShadowLayer;
- (void)configureWithTapback:(id)arg1;
- (id)displayedTapback;
...
- (void)setDisplayedTapback:(id)arg1;
...
- (void)setTapbackContainerView:(id)arg1;
- (void)setTapbackGlyph:(id)arg1;
- (void)setTapbackView:(id)arg1;
