...
- (void)_sendTapback:(id)arg1 targetChatItem:(id)arg2 isRemoval:(bool)arg3;
...
- (bool)fullScreenBalloonViewControllerPickerViewUsesBottomTail:(id)arg1;
...
- (id)tapbackButton;
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })tapbackButtonFrameForFullScreenBalloonViewController:(id)arg1;
