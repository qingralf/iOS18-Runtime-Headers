...
@interface CKRecentsViewController : CKBrowserViewController <CKBrowserDragControllerDelegate, MSStickerBrowserViewDataSource> {
...
- (void)insertSticker:(id)arg1 forceStage:(bool)arg2 completionHandler:(id /* block */)arg3;
...
- (void)insertSticker:(id)arg1 representations:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)insertSticker:(id)arg1 representations:(id)arg2 forceStage:(bool)arg3 frameInScreenCoordinates:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg4 completionHandler:(id /* block */)arg5;
- (bool)isLoaded;
