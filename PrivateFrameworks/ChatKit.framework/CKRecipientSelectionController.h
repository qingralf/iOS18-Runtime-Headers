...
@property (nonatomic, retain) CKRecipientAvailabilities *expandedRecipientAvailabilities;
...
- (id)_expandedRecipientsForGroupRecipient:(id)arg1;
...
- (bool)_recipientIsGroup:(id)arg1;
- (void)_refreshActionSheet;
- (void)_removeAvailabilityTimeoutTimerForRecipient:(id)arg1;
- (void)_removeRecent;
- (void)_resetSearchResultsInsets;
- (BOOL)_satelliteConnectedColorOverrideForRecipient:(id)arg1 inConversation:(id)arg2;
...
- (void)_showOneTimeErrorAlertForAddedRecipient:(id)arg1 service:(id)arg2 withError:(long long)arg3;
...
- (id)expandedRecipientAvailabilities;
...
- (id)preferredRecipientForRecipients:(id)arg1;
...
- (id)recipients;
- (void)refreshAvailabilityForRecipients:(id)arg1 context:(id)arg2;
...
- (void)setExpandedRecipientAvailabilities:(id)arg1;
...
- (void)tintColorForRecipient:(id)arg1 completion:(id /* block */)arg2;
- (id)toField;
- (id)toFieldAsUIView;
