...
- (id)_canonicalPathForFileURL:(id)arg1;
- (void)_forceMMSIfNecessary;
- (bool)_hostSandboxAllowsFileReadAtFileURL:(id)arg1 isResolved:(bool)arg2;
...
- (void)insertRemoteItemForSending:(id)arg1 extensionBundleIdentifier:(id)arg2;
