...
@property (nonatomic, copy) NSDictionary *recipientReasonMessages;
...
- (id)locationURL;
- (id)message;
- (id)messageForReasons:(unsigned long long)arg1;
- (id)mmsMessage;
- (id)recipientReasonMessages;
- (id)recipientReasons;
- (id)recipients;
...
- (void)setRecipientReasonMessages:(id)arg1;
