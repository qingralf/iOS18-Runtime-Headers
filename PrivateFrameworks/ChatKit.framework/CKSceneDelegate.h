...
- (void)showDebugMenu;
- (void)showInspectorViewForChatItems:(id)arg1 parallelIndexes:(id)arg2;
- (void)showInspectorViewForConversations:(id)arg1;
- (void)showInspectorViewForMessage:(id)arg1;
