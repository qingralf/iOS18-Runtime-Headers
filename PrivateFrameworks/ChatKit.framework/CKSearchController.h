...
- (void)didSelectResult:(id)arg1 visibleResults:(id)arg2;
- (id)fetchAttributes;
- (id)filterQueries;
- (Class)footerClass;
...
- (id)menuElementsForResult:(id)arg1 atIndexPath:(id)arg2 sourceRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg3;
