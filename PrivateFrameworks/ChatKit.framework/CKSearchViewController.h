...
@property (nonatomic, retain) NSDictionary *_searchControllerMap;
@property (nonatomic) bool canShowTokenSuggestions;
@property (nonatomic, retain) CKConversationListCellLayout *cellLayout;
@property (nonatomic, retain) IMSpotlightClientStateMonitor *clientStateMonitor;
...
- (void)setClientStateMonitor:(id)arg1;
...
- (void)set_searchControllerMap:(id)arg1;
