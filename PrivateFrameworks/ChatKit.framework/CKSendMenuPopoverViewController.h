...
@interface CKSendMenuPopoverViewController : UIViewController {
    ...
    <CKSendMenuPopoverViewControllerDelegate> * _delegate;
    UIViewController * _sendMenuViewController;
}

@property (nonatomic, retain) UIViewController *appContainerViewController;
@property (nonatomic) <CKSendMenuPopoverViewControllerDelegate> *delegate;
...
- (id)animationForPresentingInitialViewControllerWithFinalBounds:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 finalCenter:(struct CGPoint { double x1; double x2; })arg2;
