...
@interface CKSendMenuPresentation : NSObject <CKSendMenuPopoverPresentationControllerDelegate, CKSendMenuPopoverViewControllerDelegate> {
...
- (void)appCardDidAppearInSendMenuPopoverViewController:(id)arg1;
...
- (id)initWithOverlayPresentationContext:(id)arg1 presentingViewController:(id)arg2 appCardContentViewController:(id)arg3 appCardPresentationStyle:(unsigned long long)arg4 delegate:(id)arg5;
