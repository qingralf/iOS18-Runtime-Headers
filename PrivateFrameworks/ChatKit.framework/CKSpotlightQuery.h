...
@property (nonatomic, retain) NSMutableDictionary *chatGUIDToLatestSearchResult;
...
@property (nonatomic, retain) NSObject<OS_dispatch_group> *searchResultLoadingGroup;
...
- (void)cancel;
- (bool)cancelled;
- (id)chatGUIDToLatestSearchResult;
...
- (id)searchResultLoadingGroup;
- (id)searchResults;
- (void)setCancelled:(bool)arg1;
- (void)setChatGUIDToLatestSearchResult:(id)arg1;
- (void)setChatRegisteryOverride:(id)arg1;
- (void)setCompletion:(id /* block */)arg1;
- (void)setResultIndex:(unsigned long long)arg1;
- (void)setSearchResultLoadingGroup:(id)arg1;
