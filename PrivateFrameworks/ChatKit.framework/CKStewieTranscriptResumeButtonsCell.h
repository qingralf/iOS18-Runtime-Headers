...
@interface CKStewieTranscriptResumeButtonsCell : CKTranscriptLabelCell {
    UIButton * _callEmergencyServicesButton;
    bool  _showStewieTextButton;
    UIButton * _textViaStewieButton;
}

@property (nonatomic, retain) UIButton *callEmergencyServicesButton;
...
- (id)callEmergencyServicesButton;
...
- (void)setCallEmergencyServicesButton:(id)arg1;
- (void)setShowStewieTextButton:(bool)arg1;
- (void)setTextViaStewieButton:(id)arg1;
- (id)textViaStewieButton;
- (void)touchUpInsideCallEmergencyServicesButton:(id)arg1;
