...
@interface CKStoragePlugin : STStoragePlugin <STStorageOptionTipDelegate> {
    ...
    STStorageOptionTip * _cachedMessagesIniCloudTip;
    ...
    _TtC7ChatKit20CKCloudTipDescriptor * _cloudTipDescriptor;
...
@property (nonatomic, retain) STStorageOptionTip *cachedMessagesIniCloudTip;
...
@property (nonatomic, retain) _TtC7ChatKit20CKCloudTipDescriptor *cloudTipDescriptor;
...
- (void)setCachedMessagesIniCloudTip:(id)arg1;
...
- (void)setCloudTipDescriptor:(id)arg1;
