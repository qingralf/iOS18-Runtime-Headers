...
@interface CKTextBalloonView : CKColoredBalloonView <CKBalloonTextViewInteractionDelegate, CKBalloonVibrancy, UITextViewDelegate> {
    ...
    <CKTextBalloonViewTextEffectsDelegate> * _textEffectsDelegate;
    UITextView<CKBalloonTextViewProtocol> * _textView;
}

@property (nonatomic, copy) NSAttributedString *attributedText;
@property (getter=isCandidateForTextEffectPlayback, nonatomic, readonly) bool candidateForTextEffectPlayback;
...
@property (nonatomic) <CKTextBalloonViewTextEffectsDelegate> *textEffectsDelegate;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })_computedTextViewFrameForBoundsSize:(struct CGSize { double x1; double x2; })arg1;
- (struct CGSize { double x1; double x2; })_minimumFittingSize;
- (struct CGSize { double x1; double x2; })_textSizeThatFits:(struct CGSize { double x1; double x2; })arg1 textAlignmentInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; }*)arg2 isSingleLine:(bool*)arg3;
- (void)_textViewDidChangeCustomRenderBounds:(id)arg1;
