...
@property (nonatomic, retain) CKTranscriptLabelCell *fakeKeyTransparencyCell;
...
- (struct CGPoint { double x1; double x2; })_sendMessageAndCalculateDesiredTranscriptOffset;
...
- (void)setFakeKeyTransparencyCell:(id)arg1;
