...
@interface CKTranscriptBalloonCell : CKTranscriptMessageContentCell <CKQuickActionButtonAnimationDelegate, CKQuickActionButtonDelegate, CKTextBalloonViewTextEffectsDelegate, IMPhotoLibraryPersistenceManagerListener> {
    ...
    <CKTranscriptBalloonCellTextEffectsDelegate> * _textEffectsDelegate;
...
@property (nonatomic) <CKTranscriptBalloonCellTextEffectsDelegate> *textEffectsDelegate;
...
- (void)_drawStraightLineForPath:(id*)arg1 withLayout:(id)arg2 lineViewMaxY:(double)arg3 isTerminal:(bool)arg4 prevLineSegmentType:(unsigned long long)arg5;
...
- (void)clearFilters;
- (void)configureAppEntityForMessage:(id)arg1;
...
- (id)customTextRenderingDisplayLinkForTextBalloonViewTextView:(id)arg1;
- (void)dealloc;
- (id)description;
...
- (id)messageDisplayViewLayoutAttributesForMessageDisplayViewFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 inContainerFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2;
...
- (unsigned long long)textBalloonViewAllowedLayoutActionForTextBalloonView:(id)arg1;
- (void)textBalloonViewDidLayoutSubviews:(id)arg1;
- (void)textBalloonViewTextView:(id)arg1 didChangeTextEffectPlaybackCandidateStatus:(bool)arg2;
- (void)textBalloonViewTextViewDidChangeRenderBounds:(id)arg1;
- (void)textBalloonViewWillLayoutSubviews:(id)arg1;
