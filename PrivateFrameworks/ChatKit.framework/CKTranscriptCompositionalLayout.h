...
@interface CKTranscriptCompositionalLayout : UICollectionViewCompositionalLayout {
    ...
    struct _UIUpdateSequenceItemInternal { } * _dynamicsUpdateSequenceItem;
...
- (void)_applyHorizontalOffsetFromMapping:(id)arg1 toLayoutAttributes:(id)arg2;
...
- (void)_resetHorizontalBalloonOffsetsForLayoutAttributes:(id)arg1 includeAssociatedAttributes:(bool)arg2;
- (void)_sceneActivationStateDidChange:(id)arg1;
- (void)_updateAssociatedAttributeFramesForPrimaryAttribute:(id)arg1;
- (void)_updateAttributeZIndex:(id)arg1 forEffect:(id)arg2;
- (void)_updateCurrentBalloonOffsetForLayoutAttributes:(id)arg1;
...
- (void)applyDynamicScrollResistanceToItemsForScrollDeltaY:(double)arg1;
...
- (struct _UIUpdateSequenceItemInternal { }*)dynamicsUpdateSequenceItem;
- (id)dynamicsUpdater;
...
- (void)setDynamicsUpdateSequenceItem:(struct _UIUpdateSequenceItemInternal { }*)arg1;
...
- (void)updateDynamicsWatchdogForRenderedFrameWithDuration:(double)arg1;
