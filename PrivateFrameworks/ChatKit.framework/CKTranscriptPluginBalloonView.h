...
@interface CKTranscriptPluginBalloonView : CKBalloonView <CKCustomMaskDuringPrint, CKTranscriptPluginViewDelegate> {
    ...
    CKBalloonImageView * _pluginInsetMask;
...
@property (nonatomic, retain) CKBalloonImageView *pluginInsetMask;
@property (nonatomic, readonly) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } pluginInsets;
...
@property (nonatomic, retain) UIView *suggestedActionsBackgroundView;
@property (readonly) Class superclass;
@property (nonatomic) bool suppressMask;
@property (nonatomic, retain) CKBalloonShapeView *tailMask;
...
- (id)overlayColor;
- (id)pluginInsetMask;
- (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })pluginInsets;
...
- (void)setPluginInsetMask:(id)arg1;
...
- (void)setSuggestedActionsBackgroundColor:(id)arg1;
- (void)setSuggestedActionsBackgroundView:(id)arg1;
