...
@property (nonatomic, retain) CKChatBotActionButton *cachedChatBotActionButton;
...
@property (nonatomic, readonly) bool wantsPendingMessageStyle;
...
- (id)sender;
- (void)setCachedChatBotActionButton:(id)arg1;
