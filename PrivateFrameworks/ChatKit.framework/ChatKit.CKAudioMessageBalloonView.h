...
@property (nonatomic) bool serviceIsRCS;
...
- (void)setServiceIsRCS:(bool)arg1;
...
- (id)speedLabelColorFor:(BOOL)arg1 idiom:(long long)arg2;
- (void)tapGestureRecognized:(id)arg1;
- (double)time;
- (id)timeLabelColorFor:(BOOL)arg1 idiom:(long long)arg2;
- (id)transcriptionButtonColorWithIsFromMe:(bool)arg1 idiom:(long long)arg2;
- (id)transcriptionLabelColorFor:(BOOL)arg1 idiom:(long long)arg2;
- (void)vibrantContainerWillReparentNonVibrantSubviews:(id)arg1;
- (id)waveformColorWithIsFromMe:(bool)arg1 isPlayed:(bool)arg2 idiom:(long long)arg3;
