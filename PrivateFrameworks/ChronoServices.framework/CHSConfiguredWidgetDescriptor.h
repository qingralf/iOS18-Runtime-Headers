...
@interface CHSConfiguredWidgetDescriptor : NSObject <BSDescriptionProviding, CHSWidgetConfigurationReference, CHSWidgetIdentifiable, NSCopying, NSMutableCopying, NSSecureCoding> {
