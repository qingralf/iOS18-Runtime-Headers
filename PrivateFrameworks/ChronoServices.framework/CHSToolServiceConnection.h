...
- (oneway void)fetchWidgetSceneInfoWithCompletion:(id /* block */)arg1;
- (id)init;
- (oneway void)listStateCaptureIdentifiersWithCompletion:(id /* block */)arg1;
- (oneway void)refreshDescriptorsForExtensionBundleIdentifier:(id)arg1 completion:(id /* block */)arg2;
- (oneway void)reloadControlsOfKind:(id)arg1 containedIn:(id)arg2 reason:(id)arg3 completion:(id /* block */)arg4;
