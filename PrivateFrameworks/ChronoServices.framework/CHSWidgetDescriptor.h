...
@interface CHSWidgetDescriptor : CHSBaseDescriptor <CHSConfigurableDescriptor, CHSWidgetIdentifiable, CHSWidgetPersonality, NSMutableCopying, NSSecureCoding, SBHAddWidgetSheetGalleryItem> {
...
@property (nonatomic, readonly) bool supportsAccentedContent;
...
- (id)sbh_iconDataSourceInDomain:(id)arg1;
