...
@property (nonatomic, readonly, copy) CHSWidgetMargins *groupMargins;
@property (readonly) unsigned long long hash;
@property (nonatomic, readonly, copy) CHSWidgetMargins *margins;
@property (nonatomic, readonly) NSDictionary *nestedContentMetrics;
...
- (id)filenameSafeSHAFrom:(id)arg1;
- (long long)fontStyle;
- (id)groupMargins;
...
- (id)initWithSize:(struct CGSize { double x1; double x2; })arg1 cornerRadius:(double)arg2 scaleFactor:(double)arg3 fontStyle:(long long)arg4 margins:(id)arg5 supportsDynamicText:(unsigned long long)arg6 widgetGroupMargins:(id)arg7 nestedContentMetrics:(id)arg8;
...
- (id)initWithSize:(struct CGSize { double x1; double x2; })arg1 cornerRadius:(double)arg2 scaleFactor:(double)arg3 fontStyle:(long long)arg4 safeAreaInsets:(struct CHSEdgeInsets { double x1; double x2; double x3; double x4; })arg5 widgetGroupMargins:(id)arg6 nestedContentMetrics:(id)arg7;
...
- (struct CHSEdgeInsets { double x1; double x2; double x3; double x4; })widgetGroupContentMargins;
- (struct CHSEdgeInsets { double x1; double x2; double x3; double x4; })widgetGroupLayoutInsets;
- (id)widgetGroupMargins;
- (struct CHSEdgeInsets { double x1; double x2; double x3; double x4; })widgetGroupSafeAreaInsets;
