...
@interface CHUISWidgetHostViewController : UIViewController <BSDescriptionProviding, BSInvalidatable, CHSWidgetExtensionProviderObserver, CHUISKeybagObserver, FBSceneDelegate, FBSceneLayerManagerObserver, LSApplicationWorkspaceObserverProtocol> {
    ...
    bool  _wantsBaseContentTouchEvents;
    CHSWidget * _widget;
...
@property (nonatomic) bool wantsBaseContentTouchEvents;
...
- (void)_evaluateEffectiveInSecureEnvironmentForReason:(id)arg1;
...
- (id)initWithWidget:(id)arg1 metrics:(id)arg2 widgetConfigurationIdentifier:(id)arg3 extensionProvider:(id)arg4 sceneWorkspace:(id)arg5 screenshotManager:(id)arg6 preferences:(id)arg7 keybag:(id)arg8;
...
- (void)setDisableViewTransitionAnimations:(bool)arg1;
...
- (void)setTintParameters:(id)arg1 fencingAnimations:(bool)arg2;
...
- (void)setWantsBaseContentTouchEvents:(bool)arg1;
...
- (void)pr_ensureContentWithTimeout:(double)arg1 completion:(id /* block */)arg2;
