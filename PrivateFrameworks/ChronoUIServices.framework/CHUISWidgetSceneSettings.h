...
@property (nonatomic, readonly) long long keybagLockPolicy;
...
@property (nonatomic, readonly) bool wantsBaseContentTouchEvents;
...
+ (id)_renderSchemeFromSettings:(id)arg1;
