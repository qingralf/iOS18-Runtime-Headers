...
@interface VCProcessor : NSObject <MetalImageBufferProcessor> {
    ...
    void _outputCameraDefaultRotation;
...
@property (nonatomic) void outputCameraDefaultRotation;
...
- (id)framingSession;
- (struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; })getPhysicalCameraToVirtualCameraTransform;
- (id)init;
- (id)inputCamera;
- (id)inputMetadata;
...
- (id)outputCamera;
- (void)outputCameraDefaultRotation;
...
- (void)setOutputCameraDefaultRotation;
