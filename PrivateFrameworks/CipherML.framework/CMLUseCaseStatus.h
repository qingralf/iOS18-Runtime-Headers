...
+ (void)requestStatusForClientConfig:(id)arg1 options:(unsigned long long)arg2 completionHandler:(id /* block */)arg3;
+ (void)requestStatusForClientConfig:(id)arg1 options:(unsigned long long)arg2 dispatchQueue:(id)arg3 completionHandler:(id /* block */)arg4;
+ (id)statusForClientConfig:(id)arg1 options:(unsigned long long)arg2 error:(id*)arg3;
