...
@property (nonatomic, readonly, copy) NSAttributedString *attributedFullName;
...
+ (id)annotatedStringFromNameComponents:(id)arg1 configurationBlock:(id /* block */)arg2 cleanupBlock:(id /* block */)arg3;
+ (id)makeFamilyNameGivenNameWithComponents:(id)arg1;
