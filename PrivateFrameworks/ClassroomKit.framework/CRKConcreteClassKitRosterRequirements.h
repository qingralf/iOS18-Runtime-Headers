...
@interface CRKConcreteClassKitRosterRequirements : NSObject <CRKClassKitRosterRequirements> {
    ...
    bool  _forInstructor;
    bool  _generalObserverConstituentsRegistered;
...
@property (nonatomic) bool generalObserverConstituentsRegistered;
...
- (id)makeQueryForLocationsAllowingEasyStudentSignInForPersonID:(id)arg1;
...
- (void)setGeneralObserverConstituentsRegistered:(bool)arg1;
...
- (void)syncServerConfigWithCompletion:(id /* block */)arg1;
