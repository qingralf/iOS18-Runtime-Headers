...
@property (nonatomic, retain) NSNumber *settingsUIVisible;
...
- (void)notifyDaemonOfSettingsPaneActivationOperationDidFail:(id)arg1;
- (id)observers;
...
- (void)setSettingsUIVisible:(id)arg1;
- (void)setSignedInToStudentMAID:(bool)arg1;
- (id)settingsUIVisible;
