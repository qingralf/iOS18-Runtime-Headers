...
@interface CRKFeatureDataStore_iOS : NSObject <CRKFeatureDataStoreProtocol, CRKSharedFeatureDataStoreProviding>

@property (nonatomic, readonly, copy) NSSet *activeClassroomRoles;
