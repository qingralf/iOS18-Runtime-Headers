...
- (void)fetchWebClipsURLStringForClientBundleID:(id)arg1 completion:(id /* block */)arg2;
- (void)fetchWebClipsUUIDStringForClientBundleID:(id)arg1 completion:(id /* block */)arg2;
