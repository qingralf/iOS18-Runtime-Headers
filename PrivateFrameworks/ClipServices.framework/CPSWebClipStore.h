...
- (id)_enumerateAndMapClipsWithBlock:(id /* block */)arg1;
...
- (void)fetchWebClipsURLStringForClientBundleID:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)fetchWebClipsUUIDStringForClientBundleID:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)getWebClipDictionaryWithIdentifier:(id)arg1 completionHandler:(id /* block */)arg2;
