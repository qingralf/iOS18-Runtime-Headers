...
- (void).cxx_destruct;
- (void)_async_prepareAndRenderForTime:(double)arg1 inGroup:(id)arg2 checkForDrawable:(bool)arg3 completion:(id /* block */)arg4;
- (bool)_displayAndCheckForDrawable:(bool)arg1 withCompletion:(id /* block */)arg2;
- (void)_handleQuadArrayChange:(id)arg1;
- (void)_prepareAndRenderForTime:(double)arg1 inGroup:(id)arg2 checkForDrawable:(bool)arg3 completion:(id /* block */)arg4;
- (void)_prerenderForTime:(double)arg1;
- (void)_runOnRenderQueueIfNeeded:(id /* block */)arg1;
- (bool)_sync_prepareAndRenderForTime:(double)arg1 inGroup:(id)arg2 checkForDrawable:(bool)arg3 completion:(id /* block */)arg4;
