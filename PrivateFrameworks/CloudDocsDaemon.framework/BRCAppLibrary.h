...
@property (nonatomic, readonly) bool rootRecordCreated;
...
- (id)init;
- (id)initWithMangledID:(id)arg1 dbRowID:(id)arg2 zoneRowID:(id)arg3 db:(id)arg4 plist:(id)arg5 session:(id)arg6 initialCreation:(bool)arg7 createdRootOnDisk:(bool)arg8 createdCZMMoved:(bool)arg9 rootFileID:(id)arg10 childBasehashSalt:(id)arg11 saltingState:(unsigned int)arg12;
