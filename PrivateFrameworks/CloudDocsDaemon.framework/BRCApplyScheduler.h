...
- (void)deleteNonRejectionJobsForZone:(id)arg1;
...
- (void)generatedRanksForZone:(id)arg1 upToRank:(long long)arg2;
- (id)initWithAccountSession:(id)arg1;
- (void)monitorFaultingForZone:(id)arg1;
- (unsigned long long)recoverAndReportMissingJobs;
- (unsigned int)recoverMissingJobsAndReport:(bool)arg1;
