...
@interface BRCClientPrivilegesDescriptor : NSObject {
    ...
    bool  _isSyncBubbleClientEntitled;
}
...
@property (nonatomic, readonly) bool isBRCTL;
...
@property (nonatomic, readonly) bool isSyncBubbleClientEntitled;
...
- (BOOL)cloudEnabledStatusWithHasSession:(bool)arg1;
