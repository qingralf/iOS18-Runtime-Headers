...
@property (nonatomic, readonly) bool enhancedDrivePrivacyEnabled;
...
- (bool)_blockExistingOperationIfNecessary:(id)arg1 onNewOperation:(id)arg2 considerPriority:(bool)arg3;
...
- (bool)_checkIfEnumeratorContainsNonDiscretionaryOp:(id)arg1;
- (bool)_crossZoneMoveDocumentsToZone:(id)arg1;
- (void)_decreaseSyncUpBatchSizeAfterError;
- (void)_deleteJobsMatchingServerZone;
- (bool)_deleteRelevantPackageItemsWithDB:(id)arg1 error:(id*)arg2;
...
- (void)_enumerateAndClearLocateBlocksForRecordID:(id)arg1 exists:(bool)arg2;
...
- (void)_handleSoftResetOfLocalItem:(id)arg1 wantsUnlink:(bool)arg2;
...
- (bool)_isSideSyncOperationBlockedWithName:(id)arg1 isWaitingOnShareAccept:(bool)arg2;
...
- (bool)_performHardResetOnClientItemsAndWantsUnlink:(bool)arg1 db:(id)arg2 error:(id*)arg3;
- (void)_performResetAndWantsUnlink:(bool)arg1 clientTruthBlock:(id /* block */)arg2 completionBlock:(id /* block */)arg3;
- (void)_performSoftResetOnItems:(id)arg1 wantsUnlink:(bool)arg2;
- (bool)_postHardResetHandlingWithDB:(id)arg1 completionBlock:(id /* block */)arg2 error:(id*)arg3;
- (void)_postSoftResetHandlingAndWantsUnlink:(bool)arg1 completionBlock:(id /* block */)arg2;
...
- (void)_registerListOperation:(id)arg1 shareAcceptOperation:(id)arg2;
- (void)_registerLocateRecordOperation:(id)arg1;
- (void)_registerOperation:(id)arg1 throttler:(id)arg2;
...
- (void)_startSync;
- (void)_syncUpOfRecords:(id)arg1 createdAppLibraryNames:(id)arg2 didFinishWithError:(id)arg3 errorWasOnPCSChainedItem:(bool)arg4 throttledItemInBatch:(bool)arg5;
- (bool)activated;
- (void)addOutOfBandOperation:(id)arg1;
- (void)addSyncDownDependency:(id)arg1;
- (id)allItems;
- (id)allItemsSortedByDepthDescending:(bool)arg1;
...
- (void)cancelReset;
- (id)childBaseSaltForItemID:(id)arg1;
...
- (void)close;
- (bool)containsNonRejectedChildWithParentID:(id)arg1 db:(id)arg2;
...
- (id)directUnsaltedNonAliasItemsInServerTruthEnumeratorParentedTo:(id)arg1;
...
- (id)documentsNotIdleEnumeratorWithStartingRowID:(unsigned long long)arg1 batchSize:(unsigned long long)arg2;
...
- (bool)existsByParentID:(id)arg1 andLogicalName:(id)arg2 excludingItemID:(id)arg3;
- (bool)existsByParentID:(id)arg1 andLogicalName:(id)arg2 excludingItemID:(id)arg3 db:(id)arg4;
...
- (void)fetchRecentAndFavoriteDocuments:(bool)arg1;
...
- (bool)handleSaltingErrorIfNeeded:(id)arg1 record:(id)arg2;
- (bool)handleZoneLevelErrorIfNeeded:(id)arg1 forItemCreation:(bool)arg2;
...
- (id)init;
- (id)initWithMangledID:(id)arg1 dbRowID:(id)arg2 plist:(id)arg3 session:(id)arg4 initialCreation:(bool)arg5;
- (bool)isBusy;
...
- (id)locateRecordIfNecessaryForRecordID:(id)arg1 isUserWaiting:(bool)arg2;
- (id)locateRecordIfNecessaryForRecordID:(id)arg1 isUserWaiting:(bool)arg2 maxOperationBackoff:(double)arg3;
- (id)mangledID;
- (bool)needsSave;
...
- (void)performBlock:(id /* block */)arg1 whenItemWithRecordIDIsOnDisk:(id)arg2;
- (void)performBlock:(id /* block */)arg1 whenLocatingCompletesForItemWithRecordID:(id)arg2;
...
- (void)removeOutOfBandOperation:(id)arg1;
...
- (void)resume;
- (id)rootItemID;
- (unsigned int)saltingStateForItemID:(id)arg1;
...
- (void)scheduleResetServerAndClientTruthsForReason:(id)arg1 completionHandler:(id /* block */)arg2;
