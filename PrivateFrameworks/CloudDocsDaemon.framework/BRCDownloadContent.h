...
@interface BRCDownloadContent : BRCDownload {
    ...
    bool  _isDocumentModifiedByOtherUser;
...
@property (nonatomic, readonly) bool isDocumentModifiedByOtherUser;
...
- (id)desiredIndices;
- (id)etagIfLoser;
- (id)initWithDocument:(id)arg1 stageID:(id)arg2 etagIfLoser:(id)arg3 downloadKind:(int)arg4;
