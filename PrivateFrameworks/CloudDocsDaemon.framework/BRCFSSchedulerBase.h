...
- (bool)hasActiveWork;
- (id)hasActiveWorkGroup;
- (bool)hasWork;
- (id)hasWorkGroup;
- (bool)haveActiveJobsMatching:(id)arg1;
- (id)initWithSession:(id)arg1 name:(id)arg2 tableName:(id)arg3;
- (struct brc_job_update { int x1; long long x2; })insertOrUpdateJobID:(id)arg1 throttle:(id)arg2 withState:(int)arg3 insertedSQLColumn:(id)arg4 insertedSQLValues:(id)arg5 updatedSQLValues:(id)arg6 error:(id*)arg7;
- (bool)isCancelled;
...
- (void)resume;
- (void)schedule;
- (void)scheduleWithBatchSize:(int)arg1 whereSQLClause:(id)arg2 columns:(id)arg3 actionHandler:(id /* block */)arg4;
- (void)setHasActiveWork:(bool)arg1;
- (void)setHasActiveWorkGroup:(id)arg1;
