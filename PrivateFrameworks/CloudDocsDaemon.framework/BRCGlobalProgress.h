...
- (void).cxx_destruct;
- (id)_buildGlobalProgressObjectsWihCompletedUnitCount:(long long)arg1 totalUnitCount:(long long)arg2;
- (void)_cancelDownloadForObjectID:(id)arg1;
- (void)_cancelDownloadForObjectID:(id)arg1 destroyIfLast:(bool)arg2 willRetryTransfer:(bool)arg3;
- (void)_cancelUploadForObjectID:(id)arg1 inState:(unsigned int)arg2;
- (void)_cancelUploadForObjectID:(id)arg1 inState:(unsigned int)arg2 willRetryTransfer:(bool)arg3;
- (void)_cancelUploadForObjectID:(id)arg1 inState:(unsigned int)arg2 willRetryTransfer:(bool)arg3 pendingQuota:(bool)arg4;
...
- (void)_deleteDocument:(id)arg1 reason:(BOOL)arg2 sync:(bool)arg3;
...
- (void)_resumeProgressForZone:(id)arg1 startingRowID:(unsigned long long)arg2 whenDone:(id /* block */)arg3;
