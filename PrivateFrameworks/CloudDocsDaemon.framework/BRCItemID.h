...
+ (id)appLibraryRowIDFromRootOrDocumentsSQLiteValue:(struct sqlite3_value { }*)arg1;
+ (id)defaultDesktopItemID;
+ (id)defaultDocumentsItemID;
+ (id)documentsItemIDWithAppLibraryRowID:(id)arg1;
+ (bool)isAppLibraryRootItemIDWithSQLiteValue:(struct sqlite3_value { }*)arg1;
...
- (id)debugItemIDStringWithVerbose:(bool)arg1;
