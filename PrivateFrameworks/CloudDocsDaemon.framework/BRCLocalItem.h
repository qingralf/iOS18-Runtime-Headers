...
- (bool)shouldUseEnhancedDrivePrivacyWhenNeedsPreserving:(bool)arg1;
- (id)sideCarInfo;
- (id)sideCarRecordID;
- (id)st;
...
- (id)structureRecordBeingDeadInServerTruth:(bool)arg1 stageID:(id)arg2 shouldPCSChainStatus:(unsigned char)arg3 saltGetter:(id /* block */)arg4 childBasehashSaltGetter:(id /* block */)arg5;
