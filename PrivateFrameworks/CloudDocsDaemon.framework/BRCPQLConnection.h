...
- (void).cxx_destruct;
- (bool)_registerStaticDBFunctionsWithError:(id*)arg1;
...
- (void)scheduleFlushWithCheckpoint:(bool)arg1 whenFlushed:(id /* block */)arg2;
- (void)setAssertionPersonaIdentifier:(id)arg1;
- (void)setProfilingEnabled:(bool)arg1;
- (void)setProfilingHook:(id /* block */)arg1;
- (void)setVerboseProfilingEnabled:(bool)arg1;
