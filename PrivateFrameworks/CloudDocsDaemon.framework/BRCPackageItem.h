...
@property (nonatomic, readonly) NSData *xattrSignature;
...
+ (id)packageItemsForFileObjectID:(id)arg1 order:(unsigned long long)arg2 db:(id)arg3;
...
- (void).cxx_destruct;
- (void)_setXattrs:(id)arg1 stageRegistry:(id)arg2;
- (long long)assetRank;
