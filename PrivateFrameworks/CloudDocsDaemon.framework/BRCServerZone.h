...
- (bool)_saveItemID:(id)arg1 version:(id)arg2 record:(id)arg3 contentBoundaryKey:(id)arg4 iWorkSharingOptions:(unsigned long long)arg5;
...
- (bool)_verifyChildbasehashSaltKeysForItemID:(id)arg1 saltInfo:(id)arg2 record:(id)arg3;
