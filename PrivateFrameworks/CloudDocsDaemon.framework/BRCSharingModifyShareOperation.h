...
- (void)_performAfterFetchingSharingIdentityOnDirectoryItem:(id)arg1 wantRoutingKey:(bool)arg2 completion:(id /* block */)arg3;
- (void)_performAfterFetchingSharingIdentityOnDocumentItem:(id)arg1 wantRoutingKey:(bool)arg2 completion:(id /* block */)arg3;
...
- (id)createActivity;
- (id)initWithName:(id)arg1 zone:(id)arg2 share:(id)arg3 sessionContext:(id)arg4;
