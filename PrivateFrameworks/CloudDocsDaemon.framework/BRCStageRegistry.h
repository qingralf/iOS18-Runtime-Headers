...
@interface BRCStageRegistry : NSObject <BRCDownloadStagingProtocol, BRCLowDiskDelegate, BRCModule, BRCSyncUpStagingProtocol> {
...
- (long long)_garbageCollectUploadThumbnailsIncludingActiveUploads:(bool)arg1;
- (long long)_garbageCollectUploads;
- (long long)_garbageCollectUploadsIncludingActiveUploads:(bool)arg1;
- (bool)_graveyardAt:(int)arg1 path:(id)arg2 forItemID:(id)arg3;
- (bool)_hasActiveUploadWithStageID:(id)arg1;
