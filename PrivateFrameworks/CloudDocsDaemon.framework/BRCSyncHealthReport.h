...
@interface BRCSyncHealthReport : NSObject {
    NSMutableArray * _aggregatedEvents;
...
@property (nonatomic, readonly) NSArray *aggregatedEvents;
...
- (void).cxx_destruct;
- (void)_collectAggregatedTelemetryForSession:(id)arg1;
...
- (id)downloadFailures;
- (id)dsid;
- (void)dumpAggregatedEvents:(id /* block */)arg1;
