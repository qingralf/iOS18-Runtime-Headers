...
@property (nonatomic, readonly) bool encounteredErrorOnPCSChainedItem;
@property (readonly) unsigned long long hash;
@property (nonatomic, retain) BRCDirectoryItem *itemNeedingBasehashSalting;
...
@property (nonatomic, readonly) <BRCSyncUpCallbackProtocol> *syncUpCallback;
@property (nonatomic, copy) id /* block */ syncUpCompletionBlock;
@property (nonatomic) bool throttledItemInBatch;

+ (id)syncUpOperationForZone:(id)arg1 sessionContext:(id)arg2 syncUpCallback:(id)arg3 maxCost:(float)arg4 retryAfter:(unsigned long long*)arg5;

- (void).cxx_destruct;
- (bool)_performMetadataSaltingOperationIfNecessaryWithCompletion:(id /* block */)arg1;
- (void)_performModifyRecordsOrBatchOperationWithCompletion:(id /* block */)arg1;
...
- (id)initWithZone:(id)arg1 sessionContext:(id)arg2 syncUpCallback:(id)arg3;
...
- (void)setItemNeedingBasehashSalting:(id)arg1;
...
- (void)setThrottledItemInBatch:(bool)arg1;
