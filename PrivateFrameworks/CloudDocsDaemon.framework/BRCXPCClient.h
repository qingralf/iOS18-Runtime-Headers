...
- (void)_waitForContainerToBeForcedIngestWithContainerID:(id)arg1 containerURL:(id)arg2 sandboxExtension:(id)arg3 bundleVersion:(id)arg4 error:(id)arg5 reply:(id /* block */)arg6;
...
- (bool)checkTCCAccess;
- (bool)checkTCCAccessForSession:(id)arg1;
