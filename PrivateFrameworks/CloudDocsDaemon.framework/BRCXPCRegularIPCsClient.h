...
- (bool)_saveOrDeleteContainerMetadataRecordName:(id)arg1 saveRecord:(bool)arg2 error:(id*)arg3;
...
- (void)backupDatabaseWithURLWrapper:(id)arg1 reply:(id /* block */)arg2;
...
- (void)dumpDatabaseTo:(id)arg1 containerID:(id)arg2 personaID:(id)arg3 includeAllItems:(bool)arg4 verbose:(bool)arg5 reply:(id /* block */)arg6;
...
- (void)setEnhancedDrivePrivacyEnabled:(bool)arg1 forContainer:(id)arg2 onServer:(bool)arg3 onClient:(bool)arg4 reply:(id /* block */)arg5;
...
- (void)userVerifiedTermsWithReply:(id /* block */)arg1;
- (void)validateCloudDocsSupported:(bool)arg1 withReply:(id /* block */)arg2;
- (void)verifyAccountLoaded:(id /* block */)arg1;
