...
@property (nonatomic, readonly) CKDAssetCacheTableGroup *assetCacheTableGroup;
...
- (id)_evictAllFilesForced:(bool)arg1;
- (id)_evictWithEvictionInfo:(id)arg1;
...
- (id)evictAllFilesForced:(bool)arg1;
...
- (id)registeredMMCSItemForRereferencedAsset:(id)arg1 copyBlock:(id /* block */)arg2;
