...
@property (nonatomic, retain) NSData *boundaryKeyHash;
...
- (bool)isEqualToAssetHandle:(id)arg1 keys:(id)arg2 optionalKeys:(id)arg3 differencesDescription:(id*)arg4;
- (id)itemID;
- (id)lastUsedTime;
- (bool)mayBeEvicted;
...
- (id)modTime;
- (id)path;
- (void)setBoundaryKeyHash:(id)arg1;
- (void)setBoundaryKeyHashUsingBoundaryKey:(id)arg1;
