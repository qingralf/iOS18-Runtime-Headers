...
@interface CKDContainer : NSObject <CKDContainerScopedUserIDProvider, CKXPCContainerScopedDaemonAPI, NSDiscardableContent> {
    CKDMMCS * _MMCS;
    ...
    <NSObject> * _authorizationChangedRegistration;
...
@property (nonatomic, readonly) <NSObject> *authorizationChangedRegistration;
...
@property (nonatomic, retain) NSHashTable *clientContainers;
...
@property (getter=isContentDiscarded, nonatomic, readonly) bool contentDiscarded;
...
@property (nonatomic, retain) NSRecursiveLock *pcsManagerLock;
...
- (void)_enumerateEligibleConnectedContainersForOOPUIContainer:(id /* block */)arg1;
...
- (void)_lockedHandleTCCAuthorizationChangedEvent:(long long)arg1;
- (long long)_lockedHasTCCAuthorization:(bool)arg1;
- (void)_lockedSetHasTCCAuthorizationTernary:(long long)arg1;
- (void)_performCodeFunctionInvokeOperation:(id)arg1 block:(id /* block */)arg2;
...
- (void)_writeAdopterMetadataToCache:(id)arg1;
- (unsigned long long)accessCount;
- (id)account;
- (void)accountAccessAuthorizationWithCompletionHandler:(id /* block */)arg1;
...
- (id)authorizationChangedRegistration;
...
- (long long)hasTCCAuthorization:(bool)arg1;
...
- (void)performCheckSupportedDeviceCapabilitiesOperation:(id)arg1 withBlock:(id /* block */)arg2;
- (void)performCodeFunctionInvokeOperation:(id)arg1 withBlock:(id /* block */)arg2;
- (void)performCodeOperation:(id)arg1 withBlock:(id /* block */)arg2;
- (void)performDeclineSharesOperation:(id)arg1 withBlock:(id /* block */)arg2;
- (void)performDiscoverAllUserIdentitiesOperation:(id)arg1 withBlock:(id /* block */)arg2;
...
- (void)performMapShareURLsToInstalledBundleIDsOperation:(id)arg1 withBlock:(id /* block */)arg2;
...
- (void)performMovePhotosOperation:(id)arg1 withBlock:(id /* block */)arg2;
- (void)performOperation:(id)arg1 initialMessageReplyBlock:(id /* block */)arg2;
- (void)performOperation:(id)arg1 initialMessageReplyBlock:(id /* block */)arg2 customCompletionBlock:(id /* block */)arg3;
- (void)performQueryOperation:(id)arg1 withBlock:(id /* block */)arg2;
- (void)performRequest:(id)arg1;
- (void)performShareAccessRequestOperation:(id)arg1 withBlock:(id /* block */)arg2;
- (id)personaID;
...
- (void)setPcsCacheAssertion:(id)arg1;
- (void)setPcsManager:(id)arg1;
- (void)setPcsManagerLock:(id)arg1;
