...
@property (nonatomic, retain) NSArray *MMCSItemsToDownload;
@property (nonatomic, retain) NSArray *MMCSItemsToDownloadInMemory;
@property (nonatomic, retain) NSArray *assetURLInfosToFillOut;
@property (nonatomic, retain) NSArray *assetsToDownload;
@property (nonatomic, retain) NSMutableArray *assetsToDownloadFromTranscoder;
@property (nonatomic, retain) NSMutableArray *assetsToDownloadFromTranscoderInMemory;
...
- (bool)_postProcess;
- (void)_prepareAssetForDownload:(id)arg1;
- (bool)_prepareForDownload;
- (void)_preparePackageForDataDownload:(id)arg1;
- (void)_preparePackageForDownload:(id)arg1;
- (void)_preparePackageForMetadataDownload:(id)arg1;
- (void)_removeUntrackedMMCSItems:(id)arg1;
- (id)_tryToFillInTheDerivativeTemplateWithAsset:(id)arg1;
- (id)activityCreate;
- (id)assetURLInfosToFillOut;
- (id)assetsToDownload;
- (id)assetsToDownloadFromTranscoder;
- (id)assetsToDownloadFromTranscoderInMemory;
...
- (void)setAssetsToDownloadFromTranscoder:(id)arg1;
- (void)setAssetsToDownloadFromTranscoderInMemory:(id)arg1;
