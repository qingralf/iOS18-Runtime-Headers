...
@property (nonatomic, retain) <CKFetchArchivedRecordsOperationCallbacks><CKDOperationCallbackProxy> *clientOperationCallbackProxy;
...
- (void)_noteAttributesChangedForZone:(id)arg1;
