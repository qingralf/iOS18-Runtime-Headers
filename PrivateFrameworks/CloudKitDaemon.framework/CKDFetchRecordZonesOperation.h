...
@property (nonatomic, retain) <CKFetchRecordZonesOperationCallbacks><CKDOperationCallbackProxy> *clientOperationCallbackProxy;
...
- (void)_handleRecordZoneFetch:(id)arg1 zoneID:(id)arg2 responseCode:(id)arg3 error:(id)arg4;
