...
@property (nonatomic, retain) <CKFetchShareParticipantKeyOperationCallbacks><CKDOperationCallbackProxy> *clientOperationCallbackProxy;
...
- (void)_participantKeyFromShare:(id)arg1 completionHandler:(id /* block */)arg2;
