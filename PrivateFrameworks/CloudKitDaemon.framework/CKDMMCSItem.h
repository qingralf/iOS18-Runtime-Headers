...
@property (nonatomic, readonly) unsigned long long MMCSEncoding;
...
- (unsigned long long)MMCSEncoding;
- (id)_openInfo;
- (id)asset;
...
- (void)setIsPackageManifest:(bool)arg1;
...
- (void)setupForReReferenceWithAsset:(id)arg1 destinationDatabaseScope:(long long)arg2;
