...
+ (struct MMCSItemReaderWriter { }*)getMMCSItemReaderForItemID:(unsigned long long)arg1 MMCS:(id)arg2 itemGroupContext:(id)arg3 downloadChunkContext:(id)arg4 error:(id*)arg5;
...
- (id)initWithMMCS:(id)arg1 itemGroup:(id)arg2 operation:(id)arg3 progress:(id /* block */)arg4 command:(id /* block */)arg5 start:(id /* block */)arg6 groupCompletion:(id /* block */)arg7;
- (id)itemGroup;
