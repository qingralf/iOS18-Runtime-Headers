...
@property (nonatomic, retain) NSString *topmostParentOperationGroupName;
@property (nonatomic, retain) NSString *topmostParentOperationID;
@property (nonatomic) bool useFORD;
