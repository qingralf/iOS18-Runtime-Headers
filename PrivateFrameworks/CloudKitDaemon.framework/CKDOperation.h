...
@interface CKDOperation : NSOperation <CKThrottlingCriteria> {
    ...
    bool  _skipSettingUnitTestOverrides;
    NSDate * _startDate;
...
@property (nonatomic, retain) <CKDOperationCallbackProxy> *clientOperationCallbackProxy;
...
@property (nonatomic, readonly) NSNumber *privacyProxyFailClosedOverride;
...
- (void)fetchContainerScopedUserID:(id /* block */)arg1;
...
- (void)setEndContainerAccess:(bool)arg1;
...
- (void)setSkipSettingUnitTestOverrides:(bool)arg1;
