...
- (void)setKeyRollsSkippedBySizeCheck:(unsigned long long)arg1;
- (void)setKeysNotRemoved:(unsigned long long)arg1;
- (void)setPerRecordKeysRolled:(unsigned long long)arg1;
- (void)setQueueing:(double)arg1;
- (void)setRanges:(id)arg1;
- (void)setRecordKeysRemoved:(unsigned long long)arg1;
...
- (void)setZoneKeysRemoved:(unsigned long long)arg1;
- (void)setZoneKeysRolled:(unsigned long long)arg1;
- (void)setZoneishKeysRemoved:(unsigned long long)arg1;
