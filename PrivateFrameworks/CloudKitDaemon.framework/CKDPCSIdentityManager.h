...
+ (bool)_rollTestAccountIdentitySetForService:(id)arg1 forBackingExplicitCredentialsAccount:(id)arg2 oldIdentityID:(id*)arg3 newIdentityID:(id*)arg4 withError:(id*)arg5;
...
+ (struct _PCSIdentitySetData { }*)copyTestAccountIdentitySetForService:(id)arg1 forBackingExplicitCredentialsAccount:(id)arg2 withError:(id*)arg3;
+ (struct _PCSIdentitySetData { }*)copyTestAccountIdentitySetForService:(id)arg1 forBackingMockAccount:(id)arg2 withError:(id*)arg3;
+ (struct _PCSIdentitySetData { }*)createFullKeychainIdentitySetForAccount:(id)arg1 serviceName:(id)arg2 error:(id*)arg3;
...
- (struct _PCSIdentitySetData { }*)createTemporaryCloudKitFeaturesSigningIdentitySetForServiceName:(id)arg1 withError:(id*)arg2;
