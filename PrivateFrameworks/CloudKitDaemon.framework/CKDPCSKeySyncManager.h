...
- (void).cxx_destruct;
- (id)_on_queue_createSyncTrackerForAccount:(id)arg1 requestorOperationID:(id)arg2 service:(id)arg3 manatee:(bool)arg4 testOverrideProvider:(id)arg5;
...
- (id)_on_queue_syncTrackerForAccount:(id)arg1 requestorOperationID:(id)arg2 service:(id)arg3 manatee:(bool)arg4 testOverrideProvider:(id)arg5;
- (id)createSyncTrackerForAccount:(id)arg1 requestorOperationID:(id)arg2 service:(id)arg3 manatee:(bool)arg4 testOverrideProvider:(id)arg5;
...
- (void)setRacedWithGuitarfishRepairCallbackOnAllOutstandingHandlersWithCompletion:(id /* block */)arg1;
- (id)syncTrackerForAccount:(id)arg1 requestorOperationID:(id)arg2 service:(id)arg3 manatee:(bool)arg4 testOverrideProvider:(id)arg5;
