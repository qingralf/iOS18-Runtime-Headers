...
@property (nonatomic, retain) NSData *encryptedContactInformation;
...
@property (nonatomic, readonly) bool hasEncryptedContactInformation;
...
@property (nonatomic) bool hasIsApprovedRequester;
...
- (id)encryptedContactInformation;
...
- (void)setEncryptedContactInformation:(id)arg1;
...
- (void)setHasIsApprovedRequester:(bool)arg1;
...
- (void)setIsApprovedRequester:(bool)arg1;
