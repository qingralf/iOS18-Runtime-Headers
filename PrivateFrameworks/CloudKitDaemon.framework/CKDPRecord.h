...
@property (nonatomic, retain) CKDPRecordCryptoFeatureSet *appliedCryptoFeatures;
...
@property (nonatomic, retain) CKDPProtectionInfoKeysToRemove *chainProtectionInfoKeysToRemove;
...
@property (nonatomic, readonly) bool hasChainProtectionInfoKeysToRemove;
...
@property (nonatomic, readonly) bool hasOneTimeStableUrlInfo;
@property (nonatomic) bool hasPermission;
@property (nonatomic, readonly) bool hasProtectionInfo;
@property (nonatomic, readonly) bool hasProtectionInfoKeysToRemove;
...
@property (nonatomic, retain) CKDPRecordOneTimeStableUrlInfo *oneTimeStableUrlInfo;
...
@property (nonatomic, retain) CKDPProtectionInfoKeysToRemove *protectionInfoKeysToRemove;
...
- (id)chainProtectionInfoKeysToRemove;
...
- (void)setChainProtectionInfoKeysToRemove:(id)arg1;
