...
@property (nonatomic, retain) NSMutableArray *changedDeltas;
...
@property (nonatomic, readonly) bool hasZoneAttributesChange;
@property (nonatomic) bool pendingArchivedRecords;
@property (nonatomic) int status;
@property (nonatomic, retain) NSData *syncContinuationToken;
@property (nonatomic, retain) NSMutableArray *syncObligations;
@property (nonatomic, retain) CKDPRecordRetrieveChangesResponseZoneAttributesChange *zoneAttributesChange;
...
- (void)setSyncObligations:(id)arg1;
- (void)setZoneAttributesChange:(id)arg1;
- (int)status;
