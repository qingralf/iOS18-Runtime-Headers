...
@interface CKDPRecordRetrieveRequest : PBRequest <NSCopying> {
    ...
    bool  _requestEncryptedAssetUserIdentifiers;
...
- (void)setHasRequestEncryptedAssetUserIdentifiers:(bool)arg1;
- (void)setHasShouldFailBatch:(bool)arg1;
- (void)setRecordIdentifier:(id)arg1;
- (void)setRequestEncryptedAssetUserIdentifiers:(bool)arg1;
