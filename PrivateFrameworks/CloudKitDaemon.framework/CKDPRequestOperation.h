...
@property (nonatomic, retain) CKDPAdopterCapabilitiesCheckRequest *adopterCapabilitiesCheckRequest;
@property (nonatomic, retain) CKDPAdopterCapabilitiesSaveRequest *adopterCapabilitiesSaveRequest;
...
@property (nonatomic, readonly) bool hasAdopterCapabilitiesCheckRequest;
@property (nonatomic, readonly) bool hasAdopterCapabilitiesSaveRequest;
...
@property (nonatomic, readonly) bool hasShareUsageSaveRequest;
...
@property (nonatomic, readonly) bool hasZoneUsageSaveRequest;
...
@property (nonatomic, retain) CKDPShareUsageSaveRequest *shareUsageSaveRequest;
...
@property (nonatomic, retain) CKDPZoneUsageSaveRequest *zoneUsageSaveRequest;

- (void).cxx_destruct;
- (id)adopterCapabilitiesCheckRequest;
- (id)adopterCapabilitiesSaveRequest;
...
- (id)request;
- (void)setAdopterCapabilitiesCheckRequest:(id)arg1;
- (void)setAdopterCapabilitiesSaveRequest:(id)arg1;
