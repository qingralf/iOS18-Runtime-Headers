...
@property (nonatomic, retain) CKDPAdopterCapabilitiesCheckResponse *adopterCapabilitiesCheckResponse;
@property (nonatomic, retain) CKDPAdopterCapabilitiesSaveResponse *adopterCapabilitiesSaveResponse;
...
@property (nonatomic, readonly) bool hasAdopterCapabilitiesCheckResponse;
@property (nonatomic, readonly) bool hasAdopterCapabilitiesSaveResponse;
...
@property (nonatomic, readonly) bool hasShareUsageSaveResponse;
...
@property (nonatomic, readonly) bool hasZoneUsageSaveResponse;
...
@property (nonatomic, retain) CKDPShareUsageSaveResponse *shareUsageSaveResponse;
...
@property (nonatomic, retain) CKDPZoneUsageSaveResponse *zoneUsageSaveResponse;

- (void).cxx_destruct;
- (id)adopterCapabilitiesCheckResponse;
- (id)adopterCapabilitiesSaveResponse;
...
- (id)response;
- (id)result;
- (void)setAdopterCapabilitiesCheckResponse:(id)arg1;
- (void)setAdopterCapabilitiesSaveResponse:(id)arg1;
...
- (void)setShareUsageSaveResponse:(id)arg1;
