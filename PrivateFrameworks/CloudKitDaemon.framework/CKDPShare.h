...
@interface CKDPShare : PBCodable <NSCopying> {
    ...
    CKDPShareAccessBlockedRequesters * _blockedRequestingAccess;
    bool  _denyAccessRequests;
...
@property (nonatomic, retain) CKDPShareAccessBlockedRequesters *blockedRequestingAccess;
...
@property (nonatomic, readonly) bool hasBlockedRequestingAccess;
...
@property (nonatomic, readonly) bool hasRequestingAccess;
...
@property (nonatomic, retain) CKDPShareAccessRequesters *requestingAccess;
...
- (void)setBlockedRequestingAccess:(id)arg1;
- (void)setDenyAccessRequests:(bool)arg1;
- (void)setDisplayedHostname:(id)arg1;
- (void)setEtag:(id)arg1;
- (void)setHasAnonymousPublicAccess:(bool)arg1;
- (void)setHasDenyAccessRequests:(bool)arg1;
- (void)setHasParticipantSelfRemovalBehavior:(bool)arg1;
...
- (void)setParticipantSelfRemovalBehavior:(int)arg1;
...
- (void)setRequestingAccess:(id)arg1;
