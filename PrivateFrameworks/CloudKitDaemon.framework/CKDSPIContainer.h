...
- (void)fetchPCSFromCacheForZoneWithZoneID:(id)arg1 databaseScope:(long long)arg2 localCacheOnly:(bool)arg3 completionHandler:(id /* block */)arg4;
...
- (void)globalPerUserBoundaryKeyWithCompletionHandler:(id /* block */)arg1;
...
- (void)performDeserializeRecordModificationsOperation:(id)arg1 withBlock:(id /* block */)arg2;
- (void)performFetchArchivedRecordsOperation:(id)arg1 withBlock:(id /* block */)arg2;
- (void)performFetchMergeableDeltaMetadataOperation:(id)arg1 withBlock:(id /* block */)arg2;
- (void)performFetchMergeableDeltasOperation:(id)arg1 withBlock:(id /* block */)arg2;
- (void)performFetchRecordVersionsOperation:(id)arg1 withBlock:(id /* block */)arg2;
- (void)performFetchRegisteredBundleIDsOperation:(id)arg1 withBlock:(id /* block */)arg2;
...
- (void)performReplaceMergeableDeltasOperation:(id)arg1 withBlock:(id /* block */)arg2;
- (void)performSerializeRecordModificationsOperation:(id)arg1 withBlock:(id /* block */)arg2;
- (void)performUploadMergeableDeltasOperation:(id)arg1 withBlock:(id /* block */)arg2;
...
- (void)setFakeError:(id)arg1 forNextRequestOfClassName:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)setFakeResponseOperationResult:(id)arg1 forNextRequestOfClassName:(id)arg2 forItemID:(id)arg3 withLifetime:(int)arg4 completionHandler:(id /* block */)arg5;
