...
- (void)_handlePlistResult:(id)arg1;
- (void)_handleServerJSONResult:(id)arg1;
...
- (id)recordIDs:(id)arg1 filteredByZones:(id)arg2;
...
- (void)requestDidParseProtobufObject:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)updateShareIDCacheWithDeletedRecordID:(id)arg1;
- (void)updateShareIDCacheWithDeletedZoneID:(id)arg1;
- (void)updateShareIDCacheWithRecord:(id)arg1;
- (id)url;
- (id)urlSession;
- (id)urlSessionTask;
