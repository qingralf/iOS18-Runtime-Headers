...
- (id)_openPackage:(id)arg1;
- (bool)_planPackageSectionItemsForMMCSItems:(id)arg1;
- (bool)_planSectionsForPackage:(id)arg1 error:(id*)arg2;
- (id)_prepareAssetForUpload:(id)arg1;
- (bool)_prepareForUpload;
- (id)_preparePackageForUpload:(id)arg1;
- (id)_prepareReferenceAssetForUpload:(id)arg1;
- (id)_prepareReferencePackageForUpload:(id)arg1;
