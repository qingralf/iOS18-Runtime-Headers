...
- (id)initWriterWithMergeableValueID:(id)arg1 metadata:(id)arg2 formatVersion:(unsigned char)arg3 fileURL:(id)arg4 error:(id*)arg5;
...
- (id)initWriterWithMergeableValueID:(id)arg1 vectors:(id)arg2 formatVersion:(unsigned char)arg3 fileURL:(id)arg4 error:(id*)arg5;
