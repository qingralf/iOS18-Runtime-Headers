...
@property (nonatomic, retain) NSString *computeStateAdjustmentFingerprint;
@property (nonatomic, retain) NSDate *computeStateLastUpdatedDate;
@property (nonatomic, retain) NSString *computeStateVersion;
@property (nonatomic) long long customRenderedValue;
@property (nonatomic, copy) NSString *deletedByUserIdentifier;
...
+ (bool)requiresStableHashForResourceType:(unsigned long long)arg1;
...
- (id)computeStateAdjustmentFingerprint;
- (id)computeStateLastUpdatedDate;
- (id)computeStateVersion;
...
- (id)fingerprintSchemeWithContext:(id)arg1;
...
- (void)setComputeStateAdjustmentFingerprint:(id)arg1;
- (void)setComputeStateLastUpdatedDate:(id)arg1;
- (void)setComputeStateVersion:(id)arg1;
- (void)setCustomRenderedValue:(long long)arg1;
- (void)setDeletedByUserIdentifier:(id)arg1;
...
- (bool)qualifiesForDeviceLibraryConfiguration:(long long)arg1 sharingScopeIdentifier:(id)arg2 mainScopeIdentifier:(id)arg3;
