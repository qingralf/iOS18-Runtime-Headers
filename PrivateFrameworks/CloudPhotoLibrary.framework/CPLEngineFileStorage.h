...
- (id)_identityForIdentifier:(id)arg1;
...
- (bool)addDeleteFlagToFileAtURL:(id)arg1 error:(id*)arg2;
- (id)baseURL;
- (void)checkFileSizeForIdentity:(id)arg1;
- (bool)checkIsEmpty;
- (bool)closeWithError:(id*)arg1;
- (bool)commitFileWithIdentifier:(id)arg1 error:(id*)arg2;
...
- (bool)deleteFileWithIdentifier:(id)arg1 error:(id*)arg2;
...
- (bool)discardUncommittedFileWithIdentifier:(id)arg1 error:(id*)arg2;
...
- (bool)hasCrashMarker;
- (bool)hasFileWithIdentifier:(id)arg1;
- (bool)hasFileWithIdentity:(id)arg1;
- (id)initWithBaseURL:(id)arg1;
- (bool)keepOriginals;
- (bool)openWithFileRecoveryHandler:(id /* block */)arg1 error:(id*)arg2;
- (bool)openWithRecoveryHandler:(id /* block */)arg1 error:(id*)arg2;
- (id)platformObject;
- (bool)releaseFileURL:(id)arg1 error:(id*)arg2;
- (bool)resetWithError:(id*)arg1;
- (id)retainFileURLForIdentifier:(id)arg1 error:(id*)arg2;
...
- (void)setTrackAllStoresAndDeletesUntilEndOfTransaction:(bool)arg1;
- (bool)storeData:(id)arg1 identifier:(id)arg2 needsCommit:(bool*)arg3 error:(id*)arg4;
- (bool)storeData:(id)arg1 identity:(id)arg2 isOriginal:(bool)arg3 needsCommit:(bool*)arg4 error:(id*)arg5;
- (bool)storeFileAtURL:(id)arg1 identifier:(id)arg2 moveIfPossible:(bool)arg3 needsCommit:(bool*)arg4 error:(id*)arg5;
...
- (bool)storeUnretainedData:(id)arg1 identifier:(id)arg2 error:(id*)arg3;
- (bool)storeUnretainedData:(id)arg1 identity:(id)arg2 isOriginal:(bool)arg3 error:(id*)arg4;
- (bool)storeUnretainedFileAtURL:(id)arg1 identifier:(id)arg2 error:(id*)arg3;
