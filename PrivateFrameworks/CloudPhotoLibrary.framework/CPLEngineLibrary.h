...
@property (nonatomic, readonly) NSString *clientAppBundleIdentifier;
...
@property (nonatomic, readonly) NSDate *initialDownloadDate;
...
@property (getter=isKeychainCDPEnabled, nonatomic) bool keychainCDPEnabled;
...
@property (nonatomic, readonly) NSArray *processesInvolvedInSyncSessions;
...
+ (void)setFailOnPushingChangesTimeout:(bool)arg1;
+ (void)setTimeToWaitForClientToActivateScopes:(double)arg1;
+ (void)setTimeToWaitForClientToPullChanges:(double)arg1;
+ (void)setTimeToWaitForClientToPushChanges:(double)arg1;
+ (void)setTimeToWaitForLibrary:(double)arg1;
...
- (void)_didOpenComponent:(id)arg1 error:(id)arg2;
...
- (void)_willOpenComponent:(id)arg1;
...
- (void)forceInitialDownloadWithActivity:(id)arg1 scopeIdentifiers:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (id)initWithClientLibraryBaseURL:(id)arg1 cloudLibraryStateStorageURL:(id)arg2 cloudLibraryResourceStorageURL:(id)arg3 libraryIdentifier:(id)arg4 mainScopeIdentifier:(id)arg5 options:(unsigned long long)arg6;
- (id)initialDownloadDate;
- (id)initialSyncDate;
- (bool)isAppLibrary;
...
- (id)platformObject;
- (id)processesInvolvedInSyncSessions;
- (void)provideCloudResource:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)providePayloadForComputeStates:(id)arg1 inFolderWithURL:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (void)requestClientToPullAllChangesWithScopeIdentifiers:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)requestClientToPushAllChangesWithCompletionHandler:(id /* block */)arg1;
- (void)requestScopesWithIdentifiersToBeActivated:(id)arg1 completionHandler:(id /* block */)arg2;
- (id)scheduler;
...
- (void)setKeychainCDPEnabled:(bool)arg1;
...
- (void)updateComputeSyncMetrics:(long long)arg1 silentDecryptionFailed:(bool)arg2 error:(id)arg3;
- (void)updateDisabledFeatures:(id)arg1;
- (void)updateInitialDownloadDate:(id)arg1;
