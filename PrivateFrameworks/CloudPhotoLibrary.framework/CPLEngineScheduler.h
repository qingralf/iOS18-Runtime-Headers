...
@property (nonatomic, readonly) <CPLSyncSessionConfiguration> *configuration;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (readonly, copy) NSString *description;
@property (nonatomic, readonly) CPLEngineLibrary *engineLibrary;
@property (nonatomic, readonly) bool hasAScheduledSyncSession;
...
- (void)_noteSyncSession:(id)arg1 failedDuringPhase:(unsigned long long)arg2 withError:(id)arg3;
- (void)_noteSyncSessionNeededFromState:(unsigned long long)arg1 minimumDelay:(double)arg2;
...
- (void)noteScopeNeedsToPushToTransportWithChangeTypes:(unsigned long long)arg1;
