...
@property (nonatomic, readonly) CPLEngineRecordComputeStatePushQueue *recordComputeStatePushQueue;
...
@property (nonatomic, readonly) bool syncSessionShouldRequestMoreTime;
...
- (bool)_canRead;
- (bool)_canWrite;
- (void)_closeAndDeactivate:(bool)arg1 completionHandler:(id /* block */)arg2;
...
- (bool)mainScopeSupportsSharingScopeWithIdentifier:(id)arg1;
...
- (id)recordComputeStatePushQueue;
...
- (void)startVacuumWithCompletionHandler:(id /* block */)arg1;
...
- (bool)supportsSharingScopeWithIdentifier:(id)arg1 forScopeWithIdentifier:(id)arg2;
