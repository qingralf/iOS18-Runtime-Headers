...
@interface CPLLibraryManager : NSObject <CPLAbstractObject> {
    ...
    <CPLRecordComputeStateDelegate> * _recordComputeStateDelegate;
...
@property (nonatomic, readonly, copy) NSString *mainScopeIdentifier;
...
@property (nonatomic) <CPLRecordComputeStateDelegate> *recordComputeStateDelegate;
...
- (void)attachComputeStates:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)barrier;
...
- (void)beginInMemoryDownloadOfResource:(id)arg1 clientBundleID:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (void)fetchComputeStatesForRecordsWithScopedIdentifiers:(id)arg1 validator:(id)arg2 onDemand:(bool)arg3 completionHandler:(id /* block */)arg4;
- (void)fetchComputeStatesForRecordsWithScopedIdentifiers:(id)arg1 validator:(id)arg2 shouldDecrypt:(bool)arg3 onDemand:(bool)arg4 completionHandler:(id /* block */)arg5;
...
- (void)requestClientToPullAllChangesInScopeIdentifier:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)setRecordComputeStateDelegate:(id)arg1;
