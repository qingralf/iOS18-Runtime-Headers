...
+ (void)_updateScopeWithNewScopeType:(long long)arg1 scope:(id)arg2 updatedScopeChange:(id)arg3 updatedFlags:(id)arg4 oldTransportScope:(id)arg5 updatedTransportScope:(id)arg6 shouldUpdateTransportScope:(id /* block */)arg7 store:(id)arg8 transport:(id)arg9 session:(id)arg10 inTransaction:(id)arg11;
+ (void)updateScopeWithNewScopeType:(long long)arg1 scope:(id)arg2 updatedScopeChange:(id)arg3 updatedFlags:(id)arg4 oldTransportScope:(id)arg5 updatedTransportScope:(id)arg6 shouldUpdateTransportScope:(id /* block */)arg7 store:(id)arg8 transport:(id)arg9 session:(id)arg10 inTransaction:(id)arg11;
...
- (void)_updateScopeWithNewScopeType:(long long)arg1 updatedScopeChange:(id)arg2 updatedFlags:(id)arg3 oldTransportScope:(id)arg4 session:(id)arg5 updatedTransportScope:(id)arg6;
- (void)cancel;
