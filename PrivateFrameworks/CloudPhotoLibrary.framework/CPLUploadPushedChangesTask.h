...
@interface CPLUploadPushedChangesTask : CPLEngineScopedTask <CPLBeforeUploadCheckItemsProvider> {
    <CPLEngineAcquireReschedulerTask> * _acquireReschedulerTask;
...
- (bool)_copyResourceChangeFromChange:(id)arg1 toChange:(id)arg2 fingerprintScheme:(id)arg3 error:(id*)arg4;
...
- (void)_generateDerivativesForNextRecord:(id)arg1 usingDerivativesCache:(id)arg2 fetchCache:(id)arg3 fingerprintContext:(id)arg4;
- (void)_generateNeededDerivativesWithFetchCache:(id)arg1 fingerprintContext:(id)arg2;
