...
- (void)sendRecommendationStatus:(id)arg1 configuration:(id)arg2 recommendationIdentifiers:(id)arg3 storageRecovered:(id)arg4 context:(id)arg5 completion:(id /* block */)arg6;
