...
@interface CSSESWrapper : NSObject {
    ...
    int  _reqVersion;
    bool  _useAppleIDPassword;
}

@property (nonatomic, retain) AppleIDPasswordMetadata *appleIDPasswordMetadata;
...
- (void)dealloc;
- (id)decodedEscrowRecordFromData:(id)arg1 stingray:(bool)arg2 env:(id)arg3 duplicate:(bool)arg4 error:(id*)arg5;
- (id)decodedLabel;
- (id)derivePassword;
...
- (id)encodedEscrowRecordWithPublicKeyBytes:(id)arg1 error:(id*)arg2;
- (id)escrowBlob;
- (id)escrowDate;
- (id)escrowRecord;
- (id)initWithDSID:(id)arg1 escrowRecordContents:(id)arg2 recoveryPassphrase:(id)arg3 recordID:(id)arg4 recordLabel:(id)arg5 useAppleIDPassword:(bool)arg6 appleIDPasswordMetadata:(id)arg7 reqVersion:(int)arg8;
- (id)initWithRequest:(id)arg1 reqVersion:(int)arg2;
- (id)initWithRequest:(id)arg1 validate:(bool)arg2 reqVersion:(int)arg3;
- (id)label;
- (id)recordID;
- (id)recoveryBlob;
...
- (int)reqVersion;
- (void)setAppleIDPasswordMetadata:(id)arg1;
...
- (id)srpResponseForEscrowBlob:(id)arg1 withFullCCKey:(struct ccrsa_full_ctx { unsigned long long x1; unsigned long long x2; struct cczp_funcs {} *x3; unsigned long long x4[1]; }*)arg2;
