...
@property (nonatomic) bool guitarfish;
@property (nonatomic) bool guitarfishToken;
...
@property (nonatomic, retain) CSSESWrapper *ses;
...
- (void)fetchStingrayAccountStatus:(id /* block */)arg1;
- (id)flowID;
- (bool)fmipRecovery;
- (id)fmipUUID;
...
- (bool)recoveryResult;
- (id)recoveryUUID;
- (bool)removeRecoveryKeyFromBackup:(id*)arg1;
...
- (void)setGuitarfish:(bool)arg1;
- (void)setGuitarfishToken:(bool)arg1;
