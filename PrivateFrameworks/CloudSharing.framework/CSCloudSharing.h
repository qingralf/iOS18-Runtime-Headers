...
+ (void)addParticipantsToShareWithURLWrapper:(id)arg1 share:(id)arg2 emailAddresses:(id)arg3 phoneNumbers:(id)arg4 permissionType:(long long)arg5 allowOthersToInvite:(bool)arg6 completionHandler:(id /* block */)arg7;
...
+ (void)removeFromShareFileURL:(id)arg1 completionHandler:(id /* block */)arg2;
