...
- (void)callForAddParticipantsToShareWithURLWrapper:(id)arg1 share:(id)arg2 emailAddresses:(id)arg3 phoneNumbers:(id)arg4 permissionType:(long long)arg5 allowOthersToInvite:(bool)arg6 reply:(id /* block */)arg7;
...
- (void)callForFileURLRemoveShare:(id)arg1 reply:(id /* block */)arg2;
