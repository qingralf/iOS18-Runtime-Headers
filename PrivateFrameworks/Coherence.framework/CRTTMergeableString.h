...
- (id).cxx_construct;
- (void).cxx_destruct;
- (void)_apply:(id)arg1 alwaysApply:(bool)arg2;
...
- (id)addedByReplica;
- (id)addedByVersion;
- (void)apply:(id)arg1 skipRetain:(bool)arg2 alwaysApply:(bool)arg3;
...
- (void)coalesce;
- (void)compareTo:(id)arg1 merge:(id /* block */)arg2 add:(id /* block */)arg3;
- (id)context;
...
- (id)undoCommandToChangeFrom:(id)arg1 unedited:(id /* block */)arg2;
