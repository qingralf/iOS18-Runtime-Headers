...
- (id)initWithSize:(id)arg1 contentInsets:(struct CVCDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })arg2 elementKind:(id)arg3 containerAnchor:(id)arg4 itemAnchor:(id)arg5 zIndex:(long long)arg6 alignment:(long long)arg7 offset:(struct CGPoint { double x1; double x2; })arg8 extendsBoundary:(bool)arg9 pinToVisibleBounds:(bool)arg10;
