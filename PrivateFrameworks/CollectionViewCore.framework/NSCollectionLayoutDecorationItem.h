...
@property (nonatomic, readonly) struct CVCDirectionalEdgeInsets { double x1; double x2; double x3; double x4; } _effectiveContentInsets;
...
@property (nonatomic, readonly) struct CVCDirectionalEdgeInsets { double x1; double x2; double x3; double x4; } contentInsets;
...
- (id)decorationItem;
- (id)elementKind;
- (id)initWithElementKind:(id)arg1 size:(id)arg2 contentInsets:(struct CVCDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })arg3 containerAnchor:(id)arg4 itemAnchor:(id)arg5 zIndex:(long long)arg6 registrationViewClass:(Class)arg7 isBackgroundDecoration:(bool)arg8;
