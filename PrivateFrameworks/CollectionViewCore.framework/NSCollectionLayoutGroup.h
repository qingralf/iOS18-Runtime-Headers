...
- (id)initWithSize:(id)arg1 subitems:(id)arg2 count:(long long)arg3 interItemSpacing:(id)arg4 contentInsets:(struct CVCDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })arg5 edgeSpacing:(id)arg6 layoutDirection:(long long)arg7 supplementaryItems:(id)arg8 customGroupItemProvider:(id /* block */)arg9 name:(id)arg10 identifier:(id)arg11;
- (id)initWithSize:(id)arg1 subitems:(id)arg2 count:(long long)arg3 interItemSpacing:(id)arg4 contentInsets:(struct CVCDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })arg5 edgeSpacing:(id)arg6 layoutDirection:(long long)arg7 supplementaryItems:(id)arg8 visualFormats:(id)arg9 itemsProvider:(id /* block */)arg10 visualFormatItemProvider:(id /* block */)arg11 customGroupItemProvider:(id /* block */)arg12 options:(long long)arg13 name:(id)arg14 identifier:(id)arg15;
- (id)interItemSpacing;
- (bool)isCustomGroup;
