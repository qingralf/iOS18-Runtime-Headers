...
- (void).cxx_destruct;
- (struct CVCDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })_effectiveContentInsets;
...
- (id)identifier;
- (bool)ignoresRTL;
- (id)initWithSize:(id)arg1 contentInsets:(struct CVCDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })arg2 edgeSpacing:(id)arg3 supplementaryItems:(id)arg4 decorationItems:(id)arg5 name:(id)arg6 identifier:(id)arg7;
- (bool)isAuxillary;
