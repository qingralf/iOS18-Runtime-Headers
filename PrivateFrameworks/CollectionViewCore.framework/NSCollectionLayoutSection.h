...
@interface NSCollectionLayoutSection : NSObject <NSCopying> {
    struct CVCDirectionalEdgeInsets { 
        double top; 
        double leading; 
        double bottom; 
        double trailing; 
...
@property (getter=_clippingInsets, setter=_setClippingInsets:, nonatomic) struct CVCDirectionalEdgeInsets { double x1; double x2; double x3; double x4; } _clippingInsets;
...
@property (nonatomic) struct CVCDirectionalEdgeInsets { double x1; double x2; double x3; double x4; } contentInsets;
...
- (struct CVCDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })_clippingInsets;
...
- (void)_setClippingInsets:(struct CVCDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })arg1;
...
- (struct CVCDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })contentInsets;
...
- (void)setContentInsets:(struct CVCDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })arg1;
