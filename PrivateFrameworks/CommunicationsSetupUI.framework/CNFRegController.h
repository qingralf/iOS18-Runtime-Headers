...
@property (nonatomic, retain) NSArray *_temporaryDeviceAliases;
...
- (bool)iMessageAccountMatchesiCloudAccount:(id)arg1;
- (id)init;
...
- (void)set_temporaryDeviceAliases:(id)arg1;
...
- (void)showSetupFaceTimeOverCellularAlertForServiceProviderName:(id)arg1 serviceProviderPhoneNumber:(id)arg2 serviceProviderURL:(id)arg3 completion:(id /* block */)arg4;
