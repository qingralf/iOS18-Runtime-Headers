...
@interface CCCameraConnection : NSObject <CCCameraConnectionProtocol, FigCameraViewfinderDelegate, FigCameraViewfinderSessionDelegate> {
    ...
    NSTimer * _captureStartTimer;
    bool  _capturing;
    bool  _capturingPaused;
    bool  _connectedToDockKitDevice;
    unsigned long long  _currentPreviewState;
    float  _currentZoomMagnification;
    ...
    DKSystemEventsAgent * _dockKitAgent;
    ...
    bool  _zoomMagnificationChanged;
...
- (void).cxx_destruct;
- (bool)_burstSupport;
- (void)_captureButtonDown;
- (void)_captureButtonUp;
- (long long)_captureDevice;
- (long long)_captureMode;
- (void)_checkin;
- (void)_connect;
- (unsigned char)_currentCameraAppOrientation;
- (long long)_currentOrientation;
- (double)_currentZoomMagnification;
- (void)_disconnect;
- (long long)_flashMode;
- (long long)_flashSupport;
- (void)_handleCaptureStartTimerFired:(id)arg1;
- (void)_handleDockKitConnectedEvent:(bool)arg1;
- (void)_handleDockKitSystemEvent:(id)arg1;
...
- (void)_reportToDockKitPanoramaDirectionChangedIfNeeded:(long long)arg1;
...
- (void)dealloc;
- (id)delegate;
- (void)didPauseCaptureTimerWithPauseTime:(id)arg1;
- (void)didResumeCaptureTimerWithNewStartTime:(id)arg1;
...
- (void)open;
- (void)openPreview;
- (void)panoramaDirectionDidChange:(long long)arg1;
...
- (oneway void)xpc_pauseCaptureWithReply:(id /* block */)arg1;
- (oneway void)xpc_resumeCaptureWithReply:(id /* block */)arg1;
