...
@property (nonatomic, readonly) bool isWebAuthRequest;
...
- (id)initWithAppleIDRequest:(id)arg1 passwordRequest:(id)arg2 platformKeyCredentialAssertionOptions:(id)arg3 platformKeyCredentialRegistrationOptions:(id)arg4;
