...
@interface CPSViewServicePresentationContext : NSObject <NSSecureCoding> {
    CPSDedicatedCameraRequest * _dedicatedCameraRequest;
...
@property (nonatomic, retain) CPSDedicatedCameraRequest *dedicatedCameraRequest;
...
@property (nonatomic, retain) NSArray *proxiedAppDomains;
...
- (id)paymentContext;
- (id)paymentRequest;
- (id)proxiedAppDomains;
- (id)restrictedAccessRequest;
- (void)setDedicatedCameraRequest:(id)arg1;
...
- (void)setProxiedAppDomains:(id)arg1;
