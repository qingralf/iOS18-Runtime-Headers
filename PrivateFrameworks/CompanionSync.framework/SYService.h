...
- (id)currentSession;
- (id)customIDSOptions;
- (void)dataStreamWithMetadata:(id)arg1 options:(id)arg2 completion:(id /* block */)arg3;
...
- (id)queue;
- (bool)resume:(id*)arg1;
- (void)sendData:(id)arg1 options:(id)arg2 completion:(id /* block */)arg3;
...
- (void)setEngineType:(unsigned int)arg1;
