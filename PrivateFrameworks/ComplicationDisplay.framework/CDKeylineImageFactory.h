...
+ (struct CGPath { }*)_cornerPathWithDevice:(id)arg1 size:(struct CGSize { double x1; double x2; })arg2 innerCircleRadius:(double)arg3 strokeWidth:(double)arg4;
...
+ (struct CGPath { }*)cornerPathWithDevice:(id)arg1 corner:(unsigned long long)arg2 size:(struct CGSize { double x1; double x2; })arg3 innerCircleRadius:(double)arg4;
