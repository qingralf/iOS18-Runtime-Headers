...
@property (nonatomic, copy) NSNumber *payloadAllowMarketplaceAppInstallation;
...
@property (nonatomic, copy) NSNumber *payloadAllowWebDistributionAppInstallation;
...
- (id)payloadAllowMarketplaceAppInstallation;
...
- (void)setPayloadAllowMarketplaceAppInstallation:(id)arg1;
- (void)setPayloadAllowSystemAppRemoval:(id)arg1;
- (void)setPayloadAllowUIAppInstallation:(id)arg1;
- (void)setPayloadAllowWebDistributionAppInstallation:(id)arg1;
