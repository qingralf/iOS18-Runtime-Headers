...
@property (nonatomic, copy) NSNumber *payloadAllowSpeakerVolumeLimitModification;
...
+ (id)buildWithIdentifier:(id)arg1 withAllowMusicService:(id)arg2 withAllowRadioService:(id)arg3 withAllowMusicArtistActivity:(id)arg4 withAllowMusicVideos:(id)arg5 withAllowSharedLibraries:(id)arg6 withAllowSpeakerVolumeLimitModification:(id)arg7;
+ (id)profileType;
...
- (id)payloadAllowSpeakerVolumeLimitModification;
...
- (void)setPayloadAllowSpeakerVolumeLimitModification:(id)arg1;
