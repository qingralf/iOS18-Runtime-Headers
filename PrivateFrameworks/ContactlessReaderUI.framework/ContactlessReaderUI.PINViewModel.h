...
@interface ContactlessReaderUI.PINViewModel : _TtCs12_SwiftObject <ProximityReader.PINUI> {
    ...
    void $__lazy_storage_$_pinButtonModels;
    void $__lazy_storage_$_pinKeyboardConfig;
    union { in /* Warning: Unrecognized filer type: 'u' using 'void*' */ void*x1; long x2; long x3; }  _authModel;
    union { in /* Warning: Unrecognized filer type: 'u' using 'void*' */ void*x1; long x2; long x3; }  _authWrapper;
    ...
    union { in /* Warning: Unrecognized filer type: 'u' using 'void*' */ void*x1; long x2; long x3; }  _presentingPasscode;
    ...
    void audioManager;
    void audioMode;
    union { in /* Warning: Unrecognized filer type: 'u' using 'void*' */ void*x1; long x2; long x3; }  bsActionContinuity;
    void context;
