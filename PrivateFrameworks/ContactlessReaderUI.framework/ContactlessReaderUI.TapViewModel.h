...
@interface ContactlessReaderUI.TapViewModel : _TtCs12_SwiftObject <ProximityReader.TapUI> {
    union { in /* Warning: Unrecognized filer type: 'u' using 'void*' */ void*x1; long x2; long x3; }  _additionalDetailsText;
    ...
    void cleanupShowGuidanceTimer;
    void closeAfterAXAnnouncement;
    void delayedAXLabelUpdate;
    void ignoreProxUpdates;
    ...
    void sensorObscured;
    void showGuidanceTimer;
    void showGuidanceTimerStarted;
