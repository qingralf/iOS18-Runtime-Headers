...
- (void).cxx_destruct;
- (id)MAIDGroupResultWithDisplayName:(id)arg1 groupIdentifier:(id)arg2 membersProvider:(id /* block */)arg3;
- (id)MAIDResultWithDisplayName:(id)arg1 value:(id)arg2 nameComponents:(id)arg3 userInfo:(id)arg4;
...
- (id)duetGroupResultWithDisplayName:(id)arg1 groupIdentifier:(id)arg2 membersProvider:(id /* block */)arg3;
