...
@property (nonatomic) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } overrideContentMargins;
...
- (void)layoutSubviews;
- (id)navTitle;
- (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })overrideContentMargins;
...
- (void)setOverrideContentMargins:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg1;
