...
@interface CNDonationLoggerProvider : NSObject <CNDonationLoggerProvider> {
    ...
    <CNDonationManagedDuplicatesLogger> * _duplicatesLoggerImpl;
...
@property (readonly) <CNDonationManagedDuplicatesLogger> *duplicatesLogger;
@property (nonatomic, readonly) <CNDonationManagedDuplicatesLogger> *duplicatesLoggerImpl;
