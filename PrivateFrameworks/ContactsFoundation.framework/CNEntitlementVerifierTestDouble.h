...
- (void).cxx_destruct;
- (bool)auditToken:(struct { unsigned int x1[8]; })arg1 allowsHighPriorityWithError:(id*)arg2;
...
- (id)init;
- (void)setAuditToken:(struct { unsigned int x1[8]; })arg1 allowsHighPriority:(bool)arg2;
- (void)setAuditToken:(struct { unsigned int x1[8]; })arg1 allowsHighPriorityError:(id)arg2;
