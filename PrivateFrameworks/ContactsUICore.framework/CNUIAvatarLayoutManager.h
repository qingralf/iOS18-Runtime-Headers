...
+ (id)avatarViewLayoutConfigurationsForType:(unsigned long long)arg1 withLayoutDelegate:(id)arg2;
+ (id)avatarViewLayoutItemConfigurations:(id)arg1;
+ (id)avatarViewLayoutItemConfigurations:(id)arg1 withLayoutDelegate:(id)arg2;
...
+ (id)layoutConfigurationsForType:(unsigned long long)arg1 withItemCount:(long long)arg2 withLayoutDelegate:(id)arg3;
