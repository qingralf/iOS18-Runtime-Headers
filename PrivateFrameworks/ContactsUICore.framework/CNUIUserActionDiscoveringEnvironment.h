...
- (id)capabilities;
- (id)contactStore;
- (id)copyWithContactStore:(id)arg1 schedulerProvider:(id)arg2;
...
- (id)initWithIDSAvailabilityProvider:(id)arg1 schedulerProvider:(id)arg2 capabilities:(id)arg3 defaultUserActionFetcher:(id)arg4 applicationWorkspace:(id)arg5;
