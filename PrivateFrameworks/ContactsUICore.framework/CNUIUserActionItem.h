...
@property (nonatomic, readonly) bool shouldOpenToBundleIdentifier;
@property (nonatomic, readonly) bool shouldPromoteLoneActionToBeDefault;
...
+ (id)itemWithType:(id)arg1 contactProperty:(id)arg2 bundleIdentifier:(id)arg3 dialRequest:(id)arg4 isSuggested:(bool)arg5 options:(unsigned long long)arg6 isEligibleDefaultApp:(bool)arg7;
...
+ (id)itemWithType:(id)arg1 contactProperty:(id)arg2 bundleIdentifier:(id)arg3 userActivity:(id)arg4 isSuggested:(bool)arg5 options:(unsigned long long)arg6;
...
- (id)bundleIdentifier;
- (id)contactProperty;
- (id)curateActionWithContext:(id)arg1 withKeysToFetch:(id)arg2;
- (id)description;
- (long long)group;
