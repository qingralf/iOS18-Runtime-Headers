...
@property (nonatomic, retain) NSDictionary *defaultMessagingAppsBundleIdentifierScorerCache;
...
- (id)capabilities;
- (void)createDefaultMessagingAppsBundleIdentifierScorer:(id)arg1;
- (void)dealloc;
- (id)defaultMessagingAppsBundleIdentifierScorer;
- (id)defaultMessagingAppsBundleIdentifierScorerCache;
...
- (void)setDefaultMessagingAppsBundleIdentifierScorerCache:(id)arg1;
