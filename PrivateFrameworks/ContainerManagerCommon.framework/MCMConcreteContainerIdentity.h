...
+ (id)containerIdentityWithUUID:(id)arg1 userIdentity:(id)arg2 identifier:(id)arg3 containerConfig:(id)arg4 platform:(unsigned int)arg5 transient:(bool)arg6 userIdentityCache:(id)arg7 error:(unsigned long long*)arg8;
+ (id)containerIdentityWithUUID:(id)arg1 userIdentity:(id)arg2 identifier:(id)arg3 containerConfig:(id)arg4 platform:(unsigned int)arg5 userIdentityCache:(id)arg6 error:(unsigned long long*)arg7;
...
- (id)initWithUUID:(id)arg1 userIdentity:(id)arg2 identifier:(id)arg3 containerConfig:(id)arg4 platform:(unsigned int)arg5 transient:(bool)arg6 userIdentityCache:(id)arg7 error:(unsigned long long*)arg8;
