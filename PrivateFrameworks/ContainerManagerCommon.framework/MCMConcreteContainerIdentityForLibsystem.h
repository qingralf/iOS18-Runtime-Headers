...
+ (id)containerIdentityWithUUID:(id)arg1 userIdentity:(id)arg2 identifier:(id)arg3 containerConfig:(id)arg4 platform:(unsigned int)arg5 containerPathIdentifier:(id)arg6 existed:(bool)arg7 transient:(bool)arg8 userIdentityCache:(id)arg9 error:(unsigned long long*)arg10;
...
- (id)identityByChangingIdentifier:(id)arg1;
...
- (id)initWithUUID:(id)arg1 userIdentity:(id)arg2 identifier:(id)arg3 containerConfig:(id)arg4 platform:(unsigned int)arg5 containerPathIdentifier:(id)arg6 existed:(bool)arg7 transient:(bool)arg8 userIdentityCache:(id)arg9 error:(unsigned long long*)arg10;
