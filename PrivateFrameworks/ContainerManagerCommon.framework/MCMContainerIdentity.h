...
+ (id)containerIdentityWithIdentifier:(id)arg1 containerConfig:(id)arg2 platform:(unsigned int)arg3 userIdentityCache:(id)arg4 error:(unsigned long long*)arg5;
+ (id)containerIdentityWithMinimalContainerIdentity:(id)arg1 transient:(bool)arg2;
+ (id)containerIdentityWithUserIdentity:(id)arg1 identifier:(id)arg2 containerConfig:(id)arg3 platform:(unsigned int)arg4 transient:(bool)arg5 userIdentityCache:(id)arg6 error:(unsigned long long*)arg7;
+ (id)containerIdentityWithUserIdentity:(id)arg1 identifier:(id)arg2 containerConfig:(id)arg3 platform:(unsigned int)arg4 userIdentityCache:(id)arg5 error:(unsigned long long*)arg6;
...
- (id)initWithUserIdentity:(id)arg1 identifier:(id)arg2 containerConfig:(id)arg3 platform:(unsigned int)arg4 transient:(bool)arg5 userIdentityCache:(id)arg6 error:(unsigned long long*)arg7;
