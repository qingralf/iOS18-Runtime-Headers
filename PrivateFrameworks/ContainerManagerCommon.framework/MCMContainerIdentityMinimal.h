...
- (id)initWithUserIdentity:(id)arg1 identifier:(id)arg2 containerConfig:(id)arg3 platform:(unsigned int)arg4 userIdentityCache:(id)arg5 error:(unsigned long long*)arg6;
