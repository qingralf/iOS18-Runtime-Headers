...
+ (id)containerSchemaWithMetadata:(id)arg1 finalContainerPath:(id)arg2 dataProtectionClass:(int)arg3 libraryRepair:(id)arg4;
...
- (id)context;
- (id)initWithMetadata:(id)arg1 finalContainerPath:(id)arg2 dataProtectionClass:(int)arg3 libraryRepair:(id)arg4;
