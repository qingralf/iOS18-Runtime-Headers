...
+ (id)noReferenceAppGroupIdentifiersForIdentifier:(id)arg1 entitlements:(id)arg2;
...
- (void).cxx_destruct;
- (id)_arrayOfStringsFromArray:(id)arg1;
- (int)_dataProtectionClassFromString:(id)arg1;
...
- (id)initWithEntitlements:(id)arg1 clientIdentifier:(id)arg2 classIterator:(id)arg3;
...
- (bool)negatesReferenceToAppGroupIdentifier:(id)arg1;
