...
+ (long long)compareDataProtectionClassTarget:(id)arg1 withExisting:(id)arg2;
...
- (int)_openAbsolute;
- (int)_openRelative;
- (bool)checkAppContainerProtection:(bool*)arg1 error:(id*)arg2;
- (void)close;
...
- (id)path;
- (bool)registerAppContainerForProtectionWithError:(id*)arg1;
