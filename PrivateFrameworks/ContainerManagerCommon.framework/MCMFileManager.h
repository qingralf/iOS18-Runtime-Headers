...
- (id)fsSanitizedStringFromString:(id)arg1 allowSpaces:(bool)arg2;
...
- (bool)setDataProtectionAtURL:(id)arg1 toDataProtectionClass:(int)arg2 directoriesOnly:(bool)arg3 recursive:(bool)arg4 error:(id*)arg5;
