...
@interface MCMGlobalConfiguration : NSObject <MCMGlobalConfiguration> {
    ...
    NSArray * _excludedFromAppUserData;
...
- (id)initWithStaticConfig:(id)arg1 runMode:(unsigned int)arg2 userContainerMode:(unsigned int)arg3 bundleContainerMode:(unsigned int)arg4 bundleContainerOwner:(id)arg5 systemContainerMode:(unsigned int)arg6 systemContainerOwner:(id)arg7 kernelUpcallEnabled:(bool)arg8;
