...
- (id)initWithContainerIdentity:(id)arg1 info:(id)arg2 containerPath:(id)arg3 userManagedAssetsDirName:(id)arg4 schemaVersion:(id)arg5 dataProtectionClass:(int)arg6 creator:(id)arg7 userIdentityCache:(id)arg8;
- (id)initWithContainerIdentity:(id)arg1 info:(id)arg2 containerPath:(id)arg3 userManagedAssetsDirName:(id)arg4 schemaVersion:(id)arg5 dataProtectionClass:(int)arg6 fsNode:(id)arg7 creator:(id)arg8 userIdentityCache:(id)arg9;
- (id)metadataByChangingDataProtectionClass:(int)arg1;
- (id)metadataBySettingCreator:(id)arg1;
