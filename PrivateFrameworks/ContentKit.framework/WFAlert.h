...
@property (nonatomic, copy) NSString *associatedParameterKey;
...
@property (nonatomic, copy) WFImage *icon;
...
- (id)presenter;
- (void)setAssociatedParameterKey:(id)arg1;
