...
@property (nonatomic, readonly) long long userInterfaceStyle; /* unknown property attribute: ? */
@property (nonatomic, readonly) NSString *userInterfaceType;
@property (nonatomic) bool wfIdleTimerDisabled; /* unknown property attribute: ? */
