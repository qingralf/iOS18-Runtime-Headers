...
@property (nonatomic, readonly) long long initialRepresentationType;
@property (nonatomic, readonly) bool isTemporaryFile;
@property (nonatomic, retain) WFItemProviderRequestMetadata *metadata;
...
- (long long)initialRepresentationType;
- (id)inputStream;
- (bool)isEncodable;
