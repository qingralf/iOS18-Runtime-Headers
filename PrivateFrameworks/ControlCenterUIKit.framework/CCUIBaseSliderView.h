...
@property (nonatomic, readonly) bool hasInoperativeAppearance;
...
@property (nonatomic, readonly) double presentationLayoutValue;
...
@property (nonatomic, readonly) NSArray *topLevelBlockingGestureRecognizers; /* unknown property attribute: ? */
...
- (void)applyInoperativeAppearance:(bool)arg1;
- (id)backgroundView;
- (unsigned long long)behaviorIdentifier;
- (unsigned long long)buttonInputStepCount;
...
- (void)setButtonInputStepCount:(unsigned long long)arg1;
