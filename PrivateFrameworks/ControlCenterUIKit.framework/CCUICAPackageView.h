...
@interface CCUICAPackageView : UIView <CCUIGlyphTinting, CCUIPunchOutCompensating, CCUIPunchOutRendering, NSCopying> {
    CAPackage * _package;
...
- (void)_ccui_setColorAppearanceTraitRegistration:(id)arg1;
