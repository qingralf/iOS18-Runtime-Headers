...
@interface CCUIMenuModuleViewController : CCUIButtonModuleViewController <CCUIControlTemplateViewContextMenuDelegate, UIGestureRecognizerDelegate> {
    ...
    <CCUIMenuItemsUpdating> * _menuUpdatingDelegate;
...
@property (nonatomic, readonly, copy) NSString *menuDisplayName;
@property (nonatomic, readonly) unsigned long long menuItemCount;
@property (nonatomic) <CCUIMenuItemsUpdating> *menuUpdatingDelegate;
@property (nonatomic) unsigned long long minimumMenuItems;
@property (nonatomic, readonly) bool prefersContextMenuDisplayStyle;
...
- (bool)_forceLimitContentSizeCategoryFromContentHeightIfNecessary:(double)arg1 expanded:(bool)arg2;
...
- (bool)_setForceLimitContentSizeCategory:(bool)arg1;
...
- (id)initWithContentModuleContext:(id)arg1;
...
- (void)setMenuUpdatingDelegate:(id)arg1;
