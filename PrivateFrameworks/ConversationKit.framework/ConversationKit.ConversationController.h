...
@interface ConversationKit.ConversationController : NSObject <AVCRemoteVideoClientDelegate, TUAudioFrequencyControllerDelegate, TUMomentsControllerDelegate> {
    ...
    void callUUIDsThatHaveReceivedFirstVideoFrame;
    ...
    void cameraOrientationUpdateDidGetSnapshot;
    ...
    void featureFlags;
    void greenTea3PCallStatusChanged;
    ...
    union { in /* Warning: Unrecognized filer type: 'u' using 'void*' */ void*x1; long x2; long x3; }  pendingNoticeWaitingForRemoteScreenShareAttributes;
    ...
    void waitForModeSwitchDuringUPlusOneHandoff;
    void willTakeMoment;
}
