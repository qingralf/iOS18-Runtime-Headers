...
@interface ConversationKit.MultiwayViewController : UIViewController <AVCEffectsDelegate, CFXCameraViewControllerDelegate, CFXEffectBrowserContentPresenterDelegate, CNKAudioRoutingDelegate, CNKCallDetailsDeferredPresentationManager, CNKFaceTimeInCallControlsEffectsPresentingProtocol, CNKFaceTimePiPSourceProviding, CNKMultiwayViewControllerProtocol, CNKMutedTalkerBannerViewControllerDelegate, CNKScreenSharingInteractionControllerDelegate, SCUIInterventionViewControllerDelegate> {
    ...
    void captionsLayoutChangeHandler;
    void captionsPausedState;
    void conversationController;
    void defaults;
    void delegate;
    void deskViewTapHandler;
    ...
    void isFullScreen;
    void isInCallEndedBlockAndReportFlow;
    void isLocalReactionActive;
    void isPipStashed;
    void isScreenSharingFullScreen;
    void isSplitViewActive;
    ...
    void mostRecentFullScreenFocusedAspectRatio;
    void mostRecentGridIsFullScreen;
    ...
    void pipState;
    void pipZoomControl;
    union { in /* Warning: Unrecognized filer type: 'u' using 'void*' */ void*x1; long x2; long x3; }  queryForSuggestedBannerStartTime;
    ...
    void reactionsState;
    void remoteControlAccessoryEventsAgent;
    ...
    void tonePlayer;
    void unansweredCallDismissalHandler;
    void viewContent;
    void windowAspectRatioHandler;
}
...
@property (nonatomic) bool isInCallEndedBlockAndReportFlow;
...
- (void)setIsInCallEndedBlockAndReportFlow:(bool)arg1;
