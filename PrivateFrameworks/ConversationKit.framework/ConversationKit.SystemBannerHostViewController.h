...
@interface ConversationKit.SystemBannerHostViewController : UIViewController <BNPresentable, SBUISystemApertureElement, SBUISystemApertureElementProviding> {
    ...
    union { in /* Warning: Unrecognized filer type: 'u' using 'void*' */ void*x1; long x2; long x3; }  activityUUID;
    ...
    void features;
    void forceSuppressSystemApertureOverAssociatedScene;
    void gesturePriorityAssertion;
    void invalidationCancellable;
    void invalidationTaskSubject;
    void isPresentingMenu;
    ...
    void nextSystemApertureLayoutMode;
    void notice;
...
- (void)callDisplayContextChanged:(id)arg1;
