...
@interface COMessageChannel : NSObject <COMessageChannelClientInterface> {
    ...
    NSSet * _groupedHomeKitIdentifiers;
...
@property (nonatomic, readonly) NSSet *groupedHomeKitIdentifiers;
...
+ (id)messageChannelWithTopic:(id)arg1 cluster:(id)arg2 manualGrouping:(bool)arg3;
...
- (void)setBaseRequestID:(unsigned int)arg1;
