...
- (void)_postCanDispatchChanged:(bool)arg1 forAccessory:(id)arg2 toObserver:(id)arg3;
- (void)_postCanDispatchChangedAddOn:(id)arg1;
- (void)_postNotificationName:(id)arg1 connection:(id)arg2 userInfo:(id)arg3;
- (void)_postNotificationName:(id)arg1 forAccessory:(id)arg2 toAddOn:(id)arg3;
...
- (void)alarmAddOn:(id)arg1 resetAccesory:(id)arg2;
