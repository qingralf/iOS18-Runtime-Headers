...
@interface COCoordinationService : NSObject <COClusterAliasManagerDelegate, COClusterAliasManagerMeshProvider, COClusterAssertionDelegate, COIDSServerBagDelegate, COServiceDelegate> {
    COClusterAliasManager * _aliasManager;
    NSArray * _alwaysAssert;
    NSMapTable * _assertions;
    NSObject<OS_dispatch_queue> * _dispatchQueue;
    COHomeKitAdapter * _hkAdapter;
    COIDSServerBag * _idsServerBag;
    bool  _isMigrating;
...
@property (nonatomic, retain) COIDSServerBag *idsServerBag;
