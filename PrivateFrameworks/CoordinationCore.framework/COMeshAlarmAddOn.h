...
@interface COMeshAlarmAddOn : COMeshAddOn <COInterestTrackerDelegate, COMTActionRequestHandlerDelegate> {
    ...
    NSMutableDictionary * _alarmIndex;
...
@property (nonatomic, retain) NSMutableDictionary *alarmIndex;
...
@property (nonatomic, retain) NSArray *mergeAlarms;
