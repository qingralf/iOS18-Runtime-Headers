...
@property (nonatomic, retain) NSArray *mergeTimers;
...
@property (nonatomic, retain) NSMutableDictionary *timerIndex;
...
- (void)_broadcastMerge:(id)arg1 withTruth:(id)arg2;
...
- (void)_reloadIndexWithCompletion:(id /* block */)arg1;
...
- (void)interestTracker:(id)arg1 setInterests:(id)arg2 forMember:(id)arg3 callback:(id /* block */)arg4;
- (void)interestTrackerTriggerReset:(id)arg1;
- (id)interests;
- (id)members;
- (id)mergeRequest;
- (id)mergeResponses;
