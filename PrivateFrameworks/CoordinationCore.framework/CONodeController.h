...
@interface CONodeController : NSObject <CONodeDelegate, COTransportDelegate> {
    ...
    NSMutableDictionary * _knownDiscoveryRecords;
...
@property (nonatomic, retain) NSMutableDictionary *knownDiscoveryRecords;
...
- (id)_electionInfoByDiffingCurrentElectionInfo:(id)arg1;
...
- (void)_updateKnownDiscovery:(id)arg1;
...
- (void)setKnownDiscoveryRecords:(id)arg1;
