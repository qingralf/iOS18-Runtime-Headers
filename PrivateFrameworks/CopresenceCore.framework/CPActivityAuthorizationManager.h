...
- (void)requestAuthorizationForApplicationWithBundleIdentifier:(id)arg1 preparing:(bool)arg2 overrides:(id)arg3 currentScreenShareAttributes:(id)arg4 completionHandler:(id /* block */)arg5;
