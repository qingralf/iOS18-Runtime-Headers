...
@interface CPActivitySession : NSObject <CPLaunchableActivitySession, NSXPCListenerDelegate, RBSAssertionObserving> {
    ...
    void invalidateAssertionsWorkItem;
    void isFirstJoin;
    void isLightweightPrimaryInitiated;
    void isLocalParticipantActive;
    ...
    void persistentSceneIdentifiers;
    void persistentSceneIsEligibleForAutoClose;
    void queue;
    void rtcReporter;
    void sessionManager;
...
- (void)updateApplicationState:(unsigned long long)arg1;
