...
- (void)enqueueLocationNMEASentence:(id)arg1 forUUID:(id)arg2 withTimestamps:(id)arg3;
- (void)handleIncomingExternalAccessoryData:(id)arg1 forEASessionIdentifier:(id)arg2 withReply:(id /* block */)arg3;
- (void)handleIncomingNotification:(id)arg1 withPayload:(id)arg2 aboutAccessory:(id)arg3;
...
- (void)sendWiredCarPlayAvailable:(id)arg1 usbIdentifier:(id)arg2 wirelessAvailable:(id)arg3 bluetoothIdentifier:(id)arg4 themeAssetsAvailable:(id)arg5 forUUID:(id)arg6;
- (id)serverConnection;
