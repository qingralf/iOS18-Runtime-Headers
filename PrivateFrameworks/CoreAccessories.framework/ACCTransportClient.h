...
@property (nonatomic, retain) NSObject<OS_dispatch_queue> *endpointEventHandlerQueue;
@property (nonatomic, retain) NSMutableDictionary *endpointPropertyChangeHandlers;
@property (nonatomic, retain) NSMutableDictionary *endpointSecureTunnelDataHandlers;
...
- (id)endpointSecureTunnelDataHandlers;
...
- (bool)processOutgoingSecureTunnelData:(id)arg1 forEndpoint:(id)arg2 forType:(unsigned char)arg3;
...
- (void)receivedSecureTunnelData:(id)arg1 forEndpoint:(id)arg2;
...
- (void)setEndpointEventHandlerQueue:(id)arg1;
- (void)setEndpointPropertyChangeHandlers:(id)arg1;
- (void)setEndpointSecureTunnelDataHandlers:(id)arg1;
...
- (void)setSecureTunnelDataReceiveHandler:(id /* block */)arg1 forEndpoint:(id)arg2;
