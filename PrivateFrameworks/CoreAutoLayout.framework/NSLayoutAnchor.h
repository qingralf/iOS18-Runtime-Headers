...
- (id)itk_constraintEqualToAnchor:(id)arg1 constant:(double)arg2 priority:(float)arg3;
- (id)itk_constraintEqualToAnchor:(id)arg1 priority:(float)arg2;
- (id)itk_constraintGreaterThanOrEqualToAnchor:(id)arg1 constant:(double)arg2 priority:(float)arg3;
- (id)itk_constraintGreaterThanOrEqualToAnchor:(id)arg1 priority:(float)arg2;
- (id)itk_constraintLessThanOrEqualToAnchor:(id)arg1 constant:(double)arg2 priority:(float)arg3;
- (id)itk_constraintLessThanOrEqualToAnchor:(id)arg1 priority:(float)arg2;

// Image: /System/Library/PrivateFrameworks/PodcastsUI.framework/PodcastsUI

- (id)constraintWithEqualTo:(id)arg1 constant:(double)arg2 priority:(float)arg3;
