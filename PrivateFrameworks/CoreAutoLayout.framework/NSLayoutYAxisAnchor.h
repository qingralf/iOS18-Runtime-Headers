...
- (id)itk_constraintEqualToSystemSpacingBelowAnchor:(id)arg1 multiplier:(double)arg2 priority:(float)arg3;
- (id)itk_constraintGreaterThanOrEqualToSystemSpacingBelowAnchor:(id)arg1 multiplier:(double)arg2 priority:(float)arg3;
- (id)itk_constraintLessThanOrEqualToSystemSpacingBelowAnchor:(id)arg1 multiplier:(double)arg2 priority:(float)arg3;
