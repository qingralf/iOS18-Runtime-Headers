...
+ (void)autoDimLeave:(double)arg1;
+ (void)cltmBudgetUpdated:(float)arg1 currentSDRBrightness:(float)arg2;
...
+ (void)rtplcTriggeredWithLength:(unsigned long long)arg1 maxAPCE:(float)arg2 durationInSeconds:(float)arg3 sdrBrightness:(float)arg4 referenceModeEnabled:(bool)arg5;
+ (void)sbimMitigationTriggeredWithBrightness:(float)arg1;
