...
@interface CBAurora : NSObject {
    ...
    bool  _autoBrightnessIsAvailable;
    bool  _autoBrightnessIsEnabled;
    bool  _autoDimIsEnabled;
...
@property (nonatomic) bool autoBrightnessIsAvailable;
@property (nonatomic) bool autoBrightnessIsEnabled;
@property (nonatomic) bool autoDimIsEnabled;
...
- (void)setAutoBrightnessIsAvailable:(bool)arg1;
- (void)setAutoBrightnessIsEnabled:(bool)arg1;
- (void)setAutoDimIsEnabled:(bool)arg1;
- (void)setAutoDimRampLength:(float)arg1;
