...
- (void)setHeadroomModulator:(id)arg1;
...
- (void)setSecondsPerStopExit:(float)arg1;
- (bool)shouldUpdateEDRForRequestedHeadroom:(float)arg1 targetHeadroom:(float*)arg2 rampTime:(double*)arg3;
- (bool)shouldUpdateEDRForRequestedHeadroom:(float)arg1 targetHeadroom:(float*)arg2 rampTime:(double*)arg3 durationPerStop:(float)arg4;
