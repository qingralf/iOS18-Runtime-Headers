...
- (void)edpPCSGuitarfishChangePassword:(id)arg1 completion:(id /* block */)arg2;
- (void)edpPCSGuitarfishGetRecoveryTokenInfo:(id)arg1 completion:(id /* block */)arg2;
- (void)edpPCSGuitarfishRepairIdentities:(id)arg1 completion:(id /* block */)arg2;
- (void)edpPCSGuitarfishSetupIdentities:(id)arg1 completion:(id /* block */)arg2;
- (void)edpPCSGuitarfishValidateIdentities:(id)arg1 completion:(id /* block */)arg2;
- (void)edpPCSResetProtectedData:(id)arg1 completion:(id /* block */)arg2;
