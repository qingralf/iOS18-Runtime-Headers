...
@property (nonatomic, copy) NSString *recoveryToken;
...
- (void)setRecoveryToken:(id)arg1;
- (void)setRemoteSecret:(id)arg1;
- (void)showCustodianProvidedCodeEntryScreen:(id)arg1 controller:(id)arg2 validator:(id)arg3;
- (void)startCustodianRecoveryWithContext:(id)arg1 validator:(id)arg2;
- (void)validateCode:(id)arg1 controller:(id)arg2 completion:(id /* block */)arg3;
