...
- (bool)_shouldForceUseSecureBackupCachedPassphraseWithContext:(id)arg1 clientType:(unsigned long long)arg2;
...
- (oneway void)circleStatusForContext:(id)arg1 completion:(id /* block */)arg2;
- (void)clearFollowUpWithContext:(id)arg1 completion:(id /* block */)arg2;
- (oneway void)cliqueStatusForContext:(id)arg1 completion:(id /* block */)arg2;
- (oneway void)combinedWalrusStatusWithContext:(id)arg1 completion:(id /* block */)arg2;
- (void)createEDPLivenessDictionaryWithContext:(id)arg1 completion:(id /* block */)arg2;
- (void)dealloc;
...
- (void)fetchEDPTokenForContext:(id)arg1 completion:(id /* block */)arg2;
...
- (void)repairEDPStateWithContext:(id)arg1 uiProvider:(id)arg2 completion:(id /* block */)arg3;
...
- (void)validateEDPIdentitiesWithContext:(id)arg1 uiProvider:(id)arg2 completion:(id /* block */)arg3;
