...
- (void)_checkFirstUsableRecordForDeviceFromSource:(long long)arg1 completion:(id /* block */)arg2;
...
- (void)_deviceEscrowRecordStateUsingAccountsHealthCheckCache:(id /* block */)arg1;
- (void)_deviceEscrowRecordStateUsingCache:(bool)arg1 completion:(id /* block */)arg2;
- (id)_escrowRecordHealthCheckFailureCountForAccount:(id)arg1;
...
- (id)_getAccountRepresentationForAltDSID:(id)arg1;
