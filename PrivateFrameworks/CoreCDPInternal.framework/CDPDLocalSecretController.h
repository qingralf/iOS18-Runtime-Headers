...
- (void)_sendiCSCUpdateFinishEvent:(id)arg1 didUpdate:(bool)arg2 error:(id)arg3;
- (void)_sendiCSCUpdateStartEvent;
- (void)_setContextWithAuthResults:(id)arg1;
- (void)_wrappedLocalSecretChangedTo:(id)arg1 secretType:(unsigned long long)arg2 completion:(id /* block */)arg3;
