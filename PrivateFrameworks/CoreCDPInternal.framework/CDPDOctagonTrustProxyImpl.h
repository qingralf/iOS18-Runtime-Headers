...
- (void)fetchAllEscrowRecords:(id)arg1 forceFetch:(bool)arg2 completion:(id /* block */)arg3;
- (void)fetchAllEscrowRecords:(id)arg1 source:(long long)arg2 completion:(id /* block */)arg3;
- (void)fetchEscrowRecords:(id)arg1 forceFetch:(bool)arg2 completion:(id /* block */)arg3;
- (void)fetchEscrowRecords:(id)arg1 source:(long long)arg2 completion:(id /* block */)arg3;
