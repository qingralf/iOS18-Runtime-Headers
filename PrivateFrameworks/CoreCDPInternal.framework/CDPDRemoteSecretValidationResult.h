...
- (id)device;
- (unsigned long long)escapeOffersPresentedMask;
- (id)recoveredClique;
- (id)recoveredInfo;
- (unsigned long long)requiredEscapeOffers;
- (unsigned long long)secretType;
- (void)setCachedSecretForReenrollment:(id)arg1;
- (void)setDevice:(id)arg1;
- (void)setEscapeOffersPresentedMask:(unsigned long long)arg1;
- (void)setRecoveredClique:(id)arg1;
- (void)setRecoveredInfo:(id)arg1;
- (void)setRequiredEscapeOffers:(unsigned long long)arg1;
