...
- (void)_authenticatedEnableSecureBackupIncludingFallbackWithContext:(id)arg1 completion:(id /* block */)arg2;
- (void)_authenticatedEnableSecureBackupWithContext:(id)arg1 fallbackState:(unsigned long long)arg2 completion:(id /* block */)arg3;
...
- (void)_handleSecureBackupEnablementError:(id)arg1 fallbackState:(unsigned long long)arg2 context:(id)arg3 delegate:(id)arg4 completion:(id /* block */)arg5;
- (bool)_isInSOSCircle;
...
- (id)_performEscrowRecoveryWithRecoveryContext:(id)arg1 fallbackState:(unsigned long long)arg2 error:(id*)arg3;
- (void)_postICSCCreationFailedEventWithError:(id)arg1;
- (id)_recoverBackupDictionaryWithContext:(id)arg1 fallbackState:(unsigned long long)arg2 error:(id*)arg3;
- (id)_recoveryInfoDictionaryFromContext:(id)arg1 usePreviouslyCachedSecret:(bool)arg2;
...
- (bool)_shouldUseSBDCacheWithSecureBackupContext:(id)arg1 fallbackState:(unsigned long long)arg2;
