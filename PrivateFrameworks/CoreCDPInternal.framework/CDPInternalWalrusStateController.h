...
- (void).cxx_destruct;
- (id)_combinedWalrusStatusForPrimaryAccountWithError:(id*)arg1;
- (id)_combinedWalrusStatusWithContext:(id)arg1 error:(id*)arg2;
- (id)_combinedWalrusStatusWithOptions:(id)arg1 context:(id)arg2 error:(id*)arg3;
...
- (unsigned long long)_walrusStatusWithContext:(id)arg1 error:(id*)arg2;
- (unsigned long long)_walrusStatusWithOptions:(id)arg1 withError:(id*)arg2;
- (id)combinedWalrusStatusWithContext:(id)arg1 error:(id*)arg2;
...
- (void)setWalrusStatusEnabled:(bool)arg1 password:(id)arg2 completion:(id /* block */)arg3;
- (void)setWebAccessStatusEnabled:(bool)arg1 completion:(id /* block */)arg2;
- (void)walrusStatusWithContext:(id)arg1 completion:(id /* block */)arg2;
