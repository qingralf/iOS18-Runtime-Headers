...
@interface CDPRecoveryKeyEntryViewModel : NSObject {
    ...
    CDPEscapeOption * _edpRecoveryTokenEscapeOption;
...
@property (nonatomic, retain) CDPEscapeOption *edpRecoveryTokenEscapeOption;
...
- (id)edpRecoveryTokenEscapeOption;
...
- (void)setEdpRecoveryTokenEscapeOption:(id)arg1;
