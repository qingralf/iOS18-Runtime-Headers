...
@interface SettingsController : PSListController <CDPAuthProvider, CDPUIADPUpsellViewModelDelegate, CDPUIAdvancedDataProtectionViewModelDelegate> {
    bool  _didUseSMS;
...
- (bool)_rkMandate;
- (void)_showStatusChangeUIFor:(id)arg1;
- (void)_showWalrusChangeUI:(unsigned long long)arg1;
- (void)_showWebAccessChangeUI:(unsigned long long)arg1;
...
- (void)beginIDMSRecoveryWithRKSkip:(id)arg1;
- (void)cdpContext:(id)arg1 verifyMasterKey:(id)arg2 completion:(id /* block */)arg3;
- (void)deviceToDeviceAccountUpgradeCardUI:(id)arg1;
...
- (void)setWalrusStatus:(bool)arg1;
- (void)setWebAccessStatus:(bool)arg1;
- (bool)shouldAllowCDPEnrollment;
- (void)showADPLandingPage:(id)arg1;
- (void)showDisableWalrusUI:(id)arg1;
- (void)showDisableWebAccessUI:(id)arg1;
- (void)showEnableWalrusUI:(id)arg1;
- (void)showEnableWebAccessUI:(id)arg1;
- (void)simulateADPUpsell:(id)arg1;
- (id)specifiers;
- (void)startBeneficiaryFlow:(id)arg1;
- (void)startSpinnerForSpecifier:(id)arg1;
- (void)upsellViewModelDidRequestBeginEnablementFlowWithContext:(id)arg1;
- (void)upsellViewModelDidRequestCFUDismissalWithContext:(id)arg1;
- (void)upsellViewModelDidRequestFlowCancellationWithContext:(id)arg1;
- (void)viewDidLoad;
- (id)walrusEnabled;
- (id)webAccessEnabled;
