...
+ (id)predicateForContactWithContactIdType:(long long*)arg1;
...
- (id)initWithIdentifier:(id)arg1 type:(unsigned long long)arg2 customIdentifier:(id)arg3 displayName:(id)arg4 displayType:(unsigned long long)arg5 personId:(id)arg6 personIdType:(unsigned long long)arg7 displayImageURL:(id)arg8 participantStatus:(long long)arg9 contactIdType:(long long)arg10;
...
- (void)setContactIdType:(long long)arg1;
