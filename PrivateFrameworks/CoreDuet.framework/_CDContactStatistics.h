...
@property (nonatomic, copy) NSDate *firstIncomingRecipientDate;
@property (nonatomic, copy) NSDate *firstIncomingSenderDate;
@property (nonatomic, copy) NSDate *firstOutgoingRecipientDate;
@property unsigned long long incomingRecipientCount;
@property unsigned long long incomingSenderCount;
@property (nonatomic, copy) NSDate *lastIncomingRecipientDate;
@property (nonatomic, copy) NSDate *lastIncomingSenderDate;
@property (nonatomic, copy) NSDate *lastOutgoingRecipientDate;
