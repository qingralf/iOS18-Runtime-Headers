...
+ (id)generateConversationIdFromInteractionRecipientRecords:(id)arg1;
+ (id)generateConversationIdFromInteractionRecipients:(id)arg1;
+ (id)generateConversationIdFromObjectsWithIdentifiers:(id)arg1;
...
- (long long)mechanism;
- (id)metadataFromFeedbackEvent:(id)arg1;
- (id)nsUserName;
