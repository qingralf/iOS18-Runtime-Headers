...
- (void)deleteInteractionsMatchingPredicate:(id)arg1 synchronous:(bool)arg2 sortDescriptors:(id)arg3 limit:(unsigned long long)arg4 debuggingReason:(id)arg5 completionHandler:(id /* block */)arg6;
...
- (void)deleteInteractionsWithBundleId:(id)arg1 synchronous:(bool)arg2 domainIdentifiers:(id)arg3 completionHandler:(id /* block */)arg4;
