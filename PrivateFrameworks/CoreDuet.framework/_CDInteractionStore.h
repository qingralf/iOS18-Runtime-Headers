...
- (id)appendMissingInformationForRecord:(id)arg1 fromContact:(id)arg2 cacheUpdateRequired:(bool*)arg3;
...
- (void)deleteInteractionsMatchingPredicate:(id)arg1 sortDescriptors:(id)arg2 limit:(unsigned long long)arg3 debuggingReason:(id)arg4 completionHandler:(id /* block */)arg5;
- (unsigned long long)deleteInteractionsMatchingPredicate:(id)arg1 sortDescriptors:(id)arg2 limit:(unsigned long long)arg3 debuggingReason:(id)arg4 error:(id*)arg5;
...
- (unsigned long long)deleteInteractionsOlderThanDate:(id)arg1 debuggingReason:(id)arg2 limit:(unsigned long long)arg3;
...
- (id)getInteractionsStatisticsForConfig:(id)arg1;
...
- (id)predicateForInteractions:(id)arg1;
...
- (id)storage;
- (void)truncateInteractionsToCount:(unsigned long long)arg1;
- (void)updateCachedStatsForContactRecord:(id)arg1 isSender:(bool)arg2 withInteraction:(id)arg3;
- (bool)updateInteractions:(id)arg1 error:(id*)arg2;
- (bool)updateInteractionsBatch:(id)arg1 error:(id*)arg2;
