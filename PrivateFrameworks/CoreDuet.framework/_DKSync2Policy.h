...
+ (void)disableSyncPolicyForFeature:(unsigned long long)arg1 transportType:(long long)arg2 disabled:(bool)arg3;
+ (id)disabledFeaturesForSyncType:(id)arg1 transports:(long long)arg2;
+ (id)featureNameFromFeatureType:(unsigned long long)arg1;
+ (id)internalFeatureNameFromFeatureName:(id)arg1;
+ (bool)isSyncPolicyDisabledForFeature:(unsigned long long)arg1 transportType:(long long)arg2;
