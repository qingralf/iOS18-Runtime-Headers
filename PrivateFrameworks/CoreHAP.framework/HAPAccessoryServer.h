...
@property (nonatomic, retain) NSString *metric_pairVerifyConnectionEstablishedBy;
...
- (id)metric_pairVerifyConnectionEstablishedBy;
...
- (id)rootPublicKey;
- (bool)securitySessionWillCloseWithResponseData:(id)arg1 error:(id*)arg2;
...
- (void)setMetric_pairVerifyConnectionEstablishedBy:(id)arg1;
