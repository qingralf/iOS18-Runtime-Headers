...
@property (nonatomic, readonly) HAPSocketInfo *peerSocketInfo;
@property (nonatomic, readonly) HAPSocketInfo *pendingConnectionSocketInfo;
...
- (int)getHttpClientPeerAddress:(struct sockaddr_storage { unsigned char x1; unsigned char x2; BOOL x3[6]; long long x4; BOOL x5[112]; }*)arg1;
...
- (id)initWithSocketInfo:(id)arg1 dnsName:(id)arg2 eventsEnabled:(bool)arg3 queue:(id)arg4 wakeAddress:(id)arg5;
- (id)initWithSocketInfo:(id)arg1 dnsName:(id)arg2 eventsEnabled:(bool)arg3 queue:(id)arg4 wakeAddress:(id)arg5 dependencyFactory:(id)arg6;
- (void)invalidate;
- (id)invalidateReason;
...
- (id)peerSocketInfo;
- (id)pendingConnectionSocketInfo;
- (long long)port;
- (id)queue;
