...
@property (nonatomic, readonly) NSString *connectionEstablishedUsing;
...
- (id)connectionEstablishedUsing;
- (id)coreAnalyticsEventDictionary;
- (id)coreAnalyticsEventName;
- (unsigned long long)coreAnalyticsEventOptions;
- (id)description;
- (unsigned long long)durationInMS;
- (id)initWithAccessory:(id)arg1 forLinkType:(id)arg2 durationInMS:(unsigned long long)arg3 reason:(id)arg4 connectionEstablishedUsing:(id)arg5 pvError:(id)arg6;
- (id)linkType;
- (id)reason;
