...
+ (id)deserializeCharacteristicReadData:(id)arg1 characteristicFormat:(unsigned long long)arg2 supportsAdditionalAuthentication:(bool)arg3 error:(id*)arg4;
+ (id)serializeCharacteristicWriteValue:(id)arg1 characteristicFormat:(unsigned long long)arg2 supportsAdditionalAuthentication:(bool)arg3 authenticationData:(id)arg4 error:(id*)arg5;
...
- (void)_handleDisconnectionWithCompletion:(id /* block */)arg1;
