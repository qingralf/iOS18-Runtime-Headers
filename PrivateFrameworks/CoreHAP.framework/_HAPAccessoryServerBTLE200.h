...
@property (nonatomic, retain) HAPBLEAccessoryCache *accessoryCache;
...
@property (nonatomic, retain) NSMutableSet *discoveredAccessoryCharacteristicsPendingRead;
...
@property (nonatomic, readonly) bool hasBeenDiscovered;
@property (nonatomic) bool hasValidCache;
@property (readonly) unsigned long long hash;
@property (nonatomic) HAPCharacteristic *identifyCharacteristic;
@property (nonatomic, retain) NSMutableArray *operationsReceivedDuringConnectionStateChange;
...
+ (bool)parseReadResponse:(id)arg1 value:(id*)arg2 notificationContext:(id*)arg3 error:(id*)arg4;
...
- (void)_disconnectWithDisconnectionError:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)_enqueueRequest:(id)arg1 shouldPrioritize:(bool)arg2;
...
- (void)_handleDiscoveredCharacteristic:(id)arg1 error:(id)arg2;
...
- (void)_performTimedWritePrepareWithValue:(id)arg1 toCharacteristic:(id)arg2 authorizationData:(id)arg3 contextData:(id)arg4 options:(long long)arg5 completionHandler:(id /* block */)arg6;
- (void)_performTimedWriteValue:(id)arg1 toCharacteristic:(id)arg2 authorizationData:(id)arg3 contextData:(id)arg4 options:(long long)arg5 completionHandler:(id /* block */)arg6;
- (void)_performWriteValue:(id)arg1 toCharacteristic:(id)arg2 authorizationData:(id)arg3 contextData:(id)arg4 options:(long long)arg5 completionHandler:(id /* block */)arg6;
...
- (void)_readPendingDiscoveredCharacteristicTypesWithCompletion:(id /* block */)arg1;
...
- (void)_sendRequest:(id)arg1 shouldPrioritize:(bool)arg2 responseHandler:(id /* block */)arg3;
- (id)_serviceCacheFromHAPService:(id)arg1 serviceOrder:(unsigned long long)arg2;
- (id)_serviceForCBService:(id)arg1;
- (bool)_shouldIgnoreRetryDiscoveryError:(id)arg1;
- (void)_suspendAllOperations;
- (void)_suspendConnectionIdleTimer;
- (void)_updateConnectionIdleTime:(unsigned char)arg1;
- (void)_updateLastKeyBagIdentityIndexFailingPVWithError:(id)arg1;
- (void)_updatePropertiesFromCharacteristic:(id)arg1;
- (bool)_validateGeneratedBroadcastKey:(id)arg1;
- (bool)_validateProtocolInfo:(id)arg1;
- (void)_writeValue:(id)arg1 toCharacteristic:(id)arg2 authorizationData:(id)arg3 contextData:(id)arg4 options:(long long)arg5 completionHandler:(id /* block */)arg6;
- (id)accessoryCache;
...
- (id)discoveredAccessoryCharacteristicsPendingRead;
- (id)discoveryContext;
- (long long)discoveryRetries;
...
- (void)evaluateConnectionStateForOperation:(long long)arg1 block:(id /* block */)arg2;
...
- (id)operationsReceivedDuringConnectionStateChange;
...
- (void)setDiscoveredAccessoryCharacteristicsPendingRead:(id)arg1;
- (void)setDiscoveryContext:(id)arg1;
- (void)setDiscoveryRetries:(long long)arg1;
- (void)setFeatureFlags:(unsigned char)arg1;
- (void)setHasBeenDiscovered:(bool)arg1;
- (void)setHasValidCache:(bool)arg1;
- (void)setIdentifyCharacteristic:(id)arg1;
- (void)setOperationsReceivedDuringConnectionStateChange:(id)arg1;
