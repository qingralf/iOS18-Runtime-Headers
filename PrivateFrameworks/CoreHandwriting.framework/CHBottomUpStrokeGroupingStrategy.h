...
- (void)mergeGroupsPostProcessing:(id)arg1 createdGroups:(id)arg2 deletedGroups:(id)arg3 availableGroupingStrategies:(id)arg4 allowOppositeOrientations:(bool)arg5 groupStatistics:(id)arg6;
...
- (id)strokeGroupFromStrokes:(id)arg1 ancestorIdentifier:(long long)arg2;
