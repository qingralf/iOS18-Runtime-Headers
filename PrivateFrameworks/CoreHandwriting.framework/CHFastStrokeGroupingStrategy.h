...
- (void).cxx_destruct;
- (struct vector<CHFastGroupingCluster, std::allocator<CHFastGroupingCluster>> { struct CHFastGroupingCluster {} *x1; struct CHFastGroupingCluster {} *x2; struct __compressed_pair<CHFastGroupingCluster *, std::allocator<CHFastGroupingCluster>> { struct CHFastGroupingCluster {} *x_3_1_1; } x3; })clustersForStrokes:(id)arg1 shouldMakeSingleCluster:(bool)arg2 anchorPoints:(unsigned long long)arg3;
...
- (id)groupingResultUsingStrokes:(id)arg1 distanceMetric:(int)arg2 mergingDistanceThreshold:(double)arg3 clusteringLinkage:(int)arg4 anchorPoints:(unsigned long long)arg5 shouldCancel:(id /* block */)arg6;
