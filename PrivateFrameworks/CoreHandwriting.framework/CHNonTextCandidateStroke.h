...
@property (nonatomic, readonly) bool isLongHorizontalNonTextLine;
@property (nonatomic, readonly) bool isVerticalMathHorizontalLine;
@property (nonatomic, readonly) long long nonTextClassification;
@property (nonatomic, readonly) NSDictionary *sizeRatioByStrokeIdentifier;
...
@property (nonatomic, readonly) NSArray *supportingStrokeIdentifiers;

+ (bool)supportsSecureCoding;

- (void).cxx_destruct;
- (double)averageSupportFromStrokes:(id)arg1;
- (id)copyWithZone:(struct _NSZone { }*)arg1;
- (long long)effectiveClassification;
- (void)encodeWithCoder:(id)arg1;
- (bool)hasBoundingBoxOverlappingWithStroke:(id)arg1;
