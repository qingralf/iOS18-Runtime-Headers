...
+ (id)strokeGroupClosestToPoint:(struct CGPoint { double x1; double x2; })arg1 strokeGroups:(id)arg2;
...
+ (void)strokeGroupsContainingPoint:(struct CGPoint { double x1; double x2; })arg1 strokeGroups:(id)arg2 groupProcessingBlock:(id /* block */)arg3;
...
- (id)strokeGroupWithUpdatedStrategyIdentifier:(id)arg1 classification:(long long)arg2;
