...
@interface CIDCElement : NSObject {
    ...
    NSDictionary * _integerKeyedDictionaryValue;
...
@property (nonatomic, retain) NSDictionary *integerKeyedDictionaryValue;
...
- (id)initWithElementIdentifier:(id)arg1 integerKeyedDictionaryValue:(id)arg2;
- (id)initWithElementIdentifier:(id)arg1 numberValue:(id)arg2;
- (id)initWithElementIdentifier:(id)arg1 stringValue:(id)arg2;
- (id)initWithElementIdentifier:(id)arg1 stringValue:(id)arg2 dataValue:(id)arg3 dateValue:(id)arg4 numberValue:(id)arg5 arrayValue:(id)arg6 dictionaryValue:(id)arg7 integerKeyedDictionaryValue:(id)arg8;
- (id)integerKeyedDictionaryValue;
- (id)numberValue;
...
- (void)setIntegerKeyedDictionaryValue:(id)arg1;
