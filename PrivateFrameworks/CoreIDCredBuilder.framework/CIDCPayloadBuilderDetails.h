...
- (id)initWithFormat:(unsigned long long)arg1 docType:(id)arg2 elements:(id)arg3 validFrom:(id)arg4 validUntil:(id)arg5 deviceKey:(id)arg6 signingAlgorithm:(long long)arg7 timePolicy:(long long)arg8;
- (void)setDeviceKey:(id)arg1;
- (void)setDocType:(id)arg1;
- (void)setElements:(id)arg1;
- (void)setFormat:(unsigned long long)arg1;
- (void)setSigningAlgorithm:(long long)arg1;
- (void)setTimePolicy:(long long)arg1;
- (void)setValidFrom:(id)arg1;
- (void)setValidUntil:(id)arg1;
- (long long)signingAlgorithm;
- (long long)timePolicy;
- (id)validFrom;
- (id)validUntil;
