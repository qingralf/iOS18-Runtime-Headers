...
@property (nonatomic, readonly) bool hasProcessingMetadata;
...
@property (nonatomic, retain) CLPLocationProcessingMetadata *processingMetadata;
...
@property (nonatomic, retain) CLPVehicleType *vehicleType;
...
- (void)setHasIsProactiveLocation:(bool)arg1;
...
- (void)setIsProactiveLocation:(bool)arg1;
...
- (void)setProcessingMetadata:(id)arg1;
