...
- (void)_fetchClientOrgKeyAndPersistLocallyForResponseDict:(id)arg1 isOwned:(bool)arg2 completionHandler:(id /* block */)arg3;
- (id)_getAlbumURL;
...
- (void)_setClientOrgKeyForRequestBody:(id)arg1 clientOrgKey:(id)arg2;
...
- (void)getChangesRootCtag:(id)arg1 migrationCtag:(id)arg2 completionBlock:(id /* block */)arg3;
- (void)getCommentChanges:(id)arg1 inAlbumWithGUID:(id)arg2 withClientOrgKey:(id)arg3 albumURLString:(id)arg4 completionBlock:(id /* block */)arg5;
...
- (void)getVideoURL:(id)arg1 forAssetCollectionWithGUID:(id)arg2 inAlbumWithGUID:(id)arg3 albumURLString:(id)arg4 withClientOrgKey:(id)arg5 completionBlock:(id /* block */)arg6;
- (id)headerVersion;
...
- (void)validateInvitationForAlbum:(id)arg1 completionBlock:(id /* block */)arg2;
- (id)workQueue;
