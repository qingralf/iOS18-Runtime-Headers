...
- (bool)dbQueueAlbumWithGUID:(id)arg1 outObject:(id*)arg2 outName:(id*)arg3 outCtag:(id*)arg4 outForeignCtag:(id*)arg5 outURLString:(id*)arg6 outUserInfoData:(id*)arg7 outClientOrgKey:(id*)arg8;
...
- (void)setClientOrgKey:(id)arg1 forAlbumWithGUID:(id)arg2;
- (void)setClientOrgKey:(id)arg1 forAlbumWithGUID:(id)arg2 info:(id)arg3;
