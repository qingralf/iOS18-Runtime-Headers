...
- (void)_actionDidFinishWithError:(id)arg1 album:(id)arg2;
...
- (id)_albumForRequestFromParams:(id)arg1;
...
- (void)checkForCommentChanges:(id)arg1 inAlbumWithGUID:(id)arg2 withClientOrgKey:(id)arg3;
