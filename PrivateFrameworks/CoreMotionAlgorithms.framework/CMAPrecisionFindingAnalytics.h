...
@interface CMAPrecisionFindingAnalytics : NSObject {
    ...
    NSNumber * _maxEstimatedDeltaHeightOverSession;
    double  _maxEstimatedHeight;
    NSNumber * _maxPercentParticlesAboveHeightThreshold;
...
@property (nonatomic, retain) NSNumber *maxEstimatedDeltaHeightOverSession;
@property (nonatomic, retain) NSNumber *maxPercentParticlesAboveHeightThreshold;
...
- (void)feedEstimatedHeight:(double)arg1;
- (void)feedFractionAboveThreshold:(double)arg1;
...
- (id)init;
- (id)maxEstimatedDeltaHeightOverSession;
- (id)maxPercentParticlesAboveHeightThreshold;
...
- (void)setMaxEstimatedDeltaHeightOverSession:(id)arg1;
- (void)setMaxPercentParticlesAboveHeightThreshold:(id)arg1;
