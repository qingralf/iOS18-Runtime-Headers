...
@interface CoreOC.ObjectCaptureSession : NSObject <ARInternalSessionObserver, ARReplaySensorDelegate> {
    ...
    void _debugAdjustedCaptureCoolDown;
    ...
    void _debugSurfaceGeometryData;
    ...
    void frameIndex;
    void freeformBoundingBox;
    void freeformCanAutoCaptureStart;
    void freeformMeshHeapVertexCapacity;
    void freeformMeshRefinementInitialVoxelSize;
    void freeformMeshRefinementVoxelSizeIncrement;
    void freeformMeshRefinementVoxelSizeScanExtentThreshold;
    void freeformScanExtent;
    union { in /* Warning: Unrecognized filer type: 'u' using 'void*' */ void*x1; long x2; long x3; }  identifier;
    void imageHeightFromLastFrame;
    void imageScaler;
    void initialCameraTransform;
    void initialWorldToMobileSfMTransform;
    void internalMotionManager;
    void intrinsicsFromLastFrame;
    void isClosed;
    void isFreeformModeEnabled;
    ...
    void prevPlane;
    void proxySurface;
    void proxySurfaceConfig;
    void proxySurfaceDebugVoxelCloud;
    void proxySurfaceObjectOrigin;
    void referenceTimestamp;
    void scaleForFreeformReconstruction;
    void scaleForObjectCentricReconstruction;
    void sessionQueue;
    void shotFlippableMap;
    void shotIDToUUIDMap;
    void shotUUIDToIDMap;
    void shotsInCurrentSegment;
    void shouldCreateFreeformMeshBuffersFromHeap;
    void shouldRestartVoxelIntegration;
