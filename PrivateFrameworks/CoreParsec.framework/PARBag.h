...
@property (nonatomic, readonly) bool assumesHTTP3Capable;
@property (nonatomic, copy) NSData *bagData;
...
@property (nonatomic, readonly, copy) NSString *dpgDenyListBundleIDs;
...
@property (nonatomic, readonly) bool enablesL4S;
@property (nonatomic, readonly) bool engagementCardGrpcDisabled;
@property (nonatomic, readonly) bool exp;
@property (nonatomic, readonly) bool experimentsCustomFeedbackEnabled;
...
@property (nonatomic, readonly) bool rpcCompression;
@property (nonatomic, readonly) double safariAll;
@property (nonatomic, readonly) unsigned long long safariAssistantHashPrefixLength;
@property (nonatomic, readonly, copy) NSArray *safariAssistantSupportedCountries;
@property (nonatomic, readonly, copy) NSArray *safariAssistantSupportedPageLanguages;
@property (nonatomic, readonly, copy) NSArray *safariAssistantSupportedSystemLocales;
...
@property (nonatomic, readonly, copy) NSArray *sceneAwareLookupEnabledDomains;
@property (nonatomic, readonly, copy) NSString *sceneAwareLookupFirstUseDescriptionText;
@property (nonatomic, readonly) NSNumber *searchRenderTimeout;
@property (nonatomic, readonly) NSURL *searchURL;
@property (nonatomic, readonly) bool sessionExperimentMetadataEnabled;
...
@property (nonatomic, readonly) bool spotlightBiomeFBWritesEnabled;
@property (nonatomic, readonly) bool spotlightFeatureQualityAggregatesEnabled;
@property (nonatomic, readonly) bool spotlightFeatureQualityUploadsEnabled;
...
@property (nonatomic, readonly, copy) NSArray *supportedDomains;
...
@property (nonatomic, readonly) NSNumber *zkwRecentsExpiration;
@property (nonatomic, readonly) NSNumber *zkwSearchRenderTimeout;
...
- (unsigned long long)safariAssistantHashPrefixLength;
- (id)safariAssistantSupportedCountries;
- (id)safariAssistantSupportedPageLanguages;
- (id)safariAssistantSupportedSystemLocales;
- (double)safariDecay;
