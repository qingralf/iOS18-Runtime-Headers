...
@property (nonatomic, retain) _CPCommandEngagementFeedback *commandEngagementFeedback;
...
@property (nonatomic, retain) _CPDynamicButtonVisibilityFeedback *dynamicButtonVisibilityFeedback;
...
@property (nonatomic, retain) _CPExperimentTriggeredFeedback *experimentTriggeredFeedback;
...
- (void)setCommandEngagementFeedback:(id)arg1;
...
- (void)setDynamicButtonVisibilityFeedback:(id)arg1;
...
- (void)setExperimentTriggeredFeedback:(id)arg1;
...
- (void)updateResults:(id)arg1 withId:(unsigned long long)arg2;
