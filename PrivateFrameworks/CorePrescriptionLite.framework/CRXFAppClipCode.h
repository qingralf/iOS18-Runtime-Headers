...
@property (nonatomic, readonly) unsigned long long identifyingColor;
...
@property (nonatomic, readonly) unsigned long long leftClamping;
...
@property (nonatomic, readonly) unsigned long long randomBits;
...
@property (nonatomic, readonly) unsigned long long rightClamping;
...
+ (id)appClipCodeWithBlock:(id /* block */)arg1;
...
- (id)initWithVersion:(unsigned long long)arg1 lensType:(unsigned long long)arg2 cylLeftSignFlipped:(bool)arg3 cylRightSignFlipped:(bool)arg4 leftRXID:(unsigned long long)arg5 leftCalibrationRXID:(unsigned long long)arg6 leftDisplaySphere:(float)arg7 leftDisplayCylinder:(float)arg8 leftCalibrationSphere:(float)arg9 leftCalibrationCylinder:(float)arg10 leftAddVR:(float)arg11 leftAxisID:(unsigned long long)arg12 leftDisplayAxis:(unsigned long long)arg13 leftCalibrationAxis:(unsigned long long)arg14 leftClamping:(unsigned long long)arg15 rightRXID:(unsigned long long)arg16 rightCalibrationRXID:(unsigned long long)arg17 rightDisplaySphere:(float)arg18 rightDisplayCylinder:(float)arg19 rightCalibrationSphere:(float)arg20 rightCalibrationCylinder:(float)arg21 rightAddVR:(float)arg22 rightAxisID:(unsigned long long)arg23 rightDisplayAxis:(unsigned long long)arg24 rightCalibrationAxis:(unsigned long long)arg25 rightClamping:(unsigned long long)arg26 identifyingColor:(unsigned long long)arg27 secret:(id)arg28 randomBits:(unsigned long long)arg29;
