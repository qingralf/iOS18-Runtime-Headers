...
+ (id)reportAudioStatusWithVolume:(unsigned long long)arg1 mute:(bool)arg2 from:(unsigned char)arg3 to:(unsigned char)arg4;
+ (id)reportFeaturesWith:(unsigned char)arg1 deviceTypes:(unsigned char)arg2 rcProfile:(struct { unsigned char x1; union { unsigned char x_2_1_1; unsigned char x_2_1_2; unsigned char x_2_1_3; } x2; })arg3 deviceFeatures:(unsigned char)arg4 from:(unsigned char)arg5;
...
+ (id)setAudioVolumeLevel:(unsigned char)arg1 from:(unsigned char)arg2 to:(unsigned char)arg3;
...
+ (id)setSystemAudioMode:(bool)arg1 from:(unsigned char)arg2 to:(unsigned char)arg3;
...
- (bool)parseReportAudioStatus:(unsigned long long*)arg1 muteStatus:(bool*)arg2;
- (bool)parseReportFeatures:(unsigned char*)arg1 deviceTypes:(char *)arg2 rcProfile:(struct { unsigned char x1; union { unsigned char x_2_1_1; unsigned char x_2_1_2; unsigned char x_2_1_3; } x2; }*)arg3 features:(char *)arg4;
