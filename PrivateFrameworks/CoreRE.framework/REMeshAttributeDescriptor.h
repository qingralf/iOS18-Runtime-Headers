...
- (void)addBufferToArray:(void*)arg1 name:(const char *)arg2 payloadBuffer:(const void*)arg3;
...
- (id)initWithPayloadOffset:(unsigned int)arg1 count:(unsigned int)arg2 format:(unsigned long long)arg3 stepFunction:(unsigned long long)arg4 stride:(unsigned int)arg5;
