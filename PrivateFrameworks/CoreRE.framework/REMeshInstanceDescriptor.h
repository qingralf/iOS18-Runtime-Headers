...
@property (nonatomic, readonly) struct REMeshLodSelectOptions { struct MeshLodSelectOptions { unsigned char x_1_1_1; float x_1_1_2; } x1; } lodSelectOptions;
