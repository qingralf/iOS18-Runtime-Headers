...
- (struct CGPoint { double x1; double x2; })convertCameraPointOCR:(struct CGPoint { double x1; double x2; })arg1 toLayer:(id)arg2 flipped:(bool)arg3;
...
- (void)setTargetFocusDistance:(long long)arg1;
