...
@interface CRFDRBaseDeviceHandler : NSObject {
    ...
    NSData * _kbbSealingManifest;
    NSString * _previousCGSN;
    NSString * _sealDate;
    NSMutableDictionary * _updateProperties;
...
@property (nonatomic, retain) NSData *kbbSealingManifest;
@property (nonatomic, retain) NSString *previousCGSN;
@property (nonatomic, retain) NSString *sealDate;
@property (nonatomic, retain) NSMutableDictionary *updateProperties;
...
+ (bool)isFDRPrimaryDataClass:(id)arg1;
...
- (bool)_addDataClassAndInstancesToMutableArray:(id)arg1 dataClasses:(id)arg2 dataInstances:(id)arg3 withError:(id*)arg4;
...
- (void)setKbbSealingManifest:(id)arg1;
