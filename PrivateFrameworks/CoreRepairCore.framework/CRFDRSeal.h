...
@interface CRFDRSeal : NSObject <CRFDR> {
    ...
    NSString * SOCKSHost;
    NSNumber * SOCKSPort;
    bool  _allowSelfService;
    bool  _allowUsedPart;
    NSDictionary * _claimDict;
    ...
    bool  _skipStageEAN;
    NSDictionary * _updateClassDict;
    NSDictionary * _updateProperties;
    NSData * apTicketData;
...
@property (nonatomic, retain) NSDictionary *claimDict;
...
@property (nonatomic, retain) NSArray *patchItems;
...
@property (nonatomic, retain) NSDictionary *updateClassDict;
@property (nonatomic, retain) NSDictionary *updateProperties;
...
- (long long)CRFDRDataRepairRecover:(struct __AMFDR { }*)arg1 fdrRemote:(struct __AMFDR { }*)arg2 syncEAN:(bool)arg3 fdrError:(id*)arg4;
...
- (long long)CRFDRPostRecoverVerify:(struct __AMFDR { }*)arg1 fdrRemote:(struct __AMFDR { }*)arg2 syncEAN:(bool)arg3 fdrError:(id*)arg4;
- (long long)CRFDRRecoverMissingData:(id*)arg1 fdrLocal:(struct __AMFDR { }*)arg2 fdrRemote:(struct __AMFDR { }*)arg3;
- (long long)CRFDRVerifyLocal:(struct __AMFDR { }*)arg1 fdrRemote:(struct __AMFDR { }*)arg2 sealedData:(struct __AMFDRSealedData {}**)arg3 mergedDataClasses:(id)arg4 mergedDataInstances:(id)arg5 currentManifestProperties:(id)arg6 fdrError:(id*)arg7 syncEAN:(bool)arg8 postSeal:(bool)arg9 ignoreBenignError:(bool)arg10;
...
- (long long)_commitSealedData:(struct __AMFDR { }*)arg1 fdrRemote:(struct __AMFDR { }*)arg2 sealedData:(struct __AMFDRSealedData { }*)arg3 syncEAN:(bool)arg4 returnError:(id*)arg5;
...
- (long long)performStagedChallengeClaim:(struct __AMFDR { }*)arg1 fdrLocal:(struct __AMFDR { }*)arg2 fdrError:(id*)arg3 claimClassDict:(id)arg4;
...
- (long long)prefetchPermissionsForSealing:(id*)arg1 fdrRemote:(struct __AMFDR { }*)arg2 fdrLocal:(struct __AMFDR { }*)arg3 claimClassDict:(id)arg4 makeClasses:(id)arg5 makeInstances:(id)arg6 patchClasses:(id)arg7 patchInstances:(id)arg8;
- (long long)prefetchPermissionsForStagedSealing:(id*)arg1 fdrRemote:(struct __AMFDR { }*)arg2 fdrLocal:(struct __AMFDR { }*)arg3 claimClassDict:(id)arg4 makeClasses:(id)arg5 makeInstances:(id)arg6 patchClasses:(id)arg7 patchInstances:(id)arg8;
- (long long)prefetchPermissionsWith:(struct __AMFDR { }*)arg1 returnError:(id*)arg2;
...
- (void)setAllowSelfService:(bool)arg1;
- (void)setAllowUsedPart:(bool)arg1;
- (void)setApTicketData:(id)arg1;
- (void)setClaimDict:(id)arg1;
...
- (id)setLocalAndRemotePermission:(struct __AMFDR { }*)arg1 fdrRemote:(struct __AMFDR { }*)arg2;
...
- (void)setSkipStageEAN:(bool)arg1;
- (void)setUpdateClassDict:(id)arg1;
- (void)setUpdateProperties:(id)arg1;
- (bool)skipStageEAN;
- (bool)stageDataClasses:(id)arg1 dataInstances:(id)arg2 fdrRemote:(struct __AMFDR { }*)arg3 fdrLocal:(struct __AMFDR { }*)arg4 fdrError:(id*)arg5;
- (id)summarizePatchInputs;
- (id)updateClassDict;
- (id)updateProperties;
- (long long)verifyClaimCountAndSalesDistrictWithError:(id*)arg1;
