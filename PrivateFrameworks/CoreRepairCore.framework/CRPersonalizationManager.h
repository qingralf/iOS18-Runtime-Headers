...
+ (id)defaultManager;
+ (int)enableSSO:(struct __AMAuthInstall { }*)arg1;
...
- (bool)getApTicketForSeaCookiePairingWithOptions:(id)arg1 pairingTicket:(id*)arg2 error:(id*)arg3;
- (bool)getBMUTicketForVeridianFWUpdateWithOptions:(id)arg1 BMUTicket:(id*)arg2 error:(id*)arg3;
- (bool)getBrunorTicketForBrunorFWUpdateWithOptions:(id)arg1 BrunorTicket:(id*)arg2 auth:(bool)arg3 error:(id*)arg4;
...
- (bool)getRepairTicket:(id*)arg1 error:(id*)arg2;
- (bool)getSavageTicketForSavageFWUpdateWithOptions:(id)arg1 SavageTicket:(id*)arg2 error:(id*)arg3;
- (bool)getSavageTicketForZenithSavageFWUpdateWithOptions:(id)arg1 SavageTicket:(id*)arg2 error:(id*)arg3;
- (bool)getYonkersTicketForYonkersFWUpdateWithOptions:(id)arg1 YonkersTicket:(id*)arg2 error:(id*)arg3;
- (bool)getYonkersTicketForZenithYonkersFWUpdateWithOptions:(id)arg1 YonkersTicket:(id*)arg2 error:(id*)arg3;
- (id)init;
