...
@property (nonatomic, readonly) double lookbackInterval;
...
- (id)initWithDateInterval:(id)arg1 lookbackInterval:(double)arg2 spatialGranularity:(unsigned long long)arg3 referenceLocation:(id)arg4 referenceLocationSummary:(bool)arg5 distance:(double)arg6;
