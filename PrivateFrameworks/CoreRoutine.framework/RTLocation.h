...
@interface RTLocation : NSObject <HMDRTLocation, NSCopying, NSSecureCoding> {
    double  _altitude;
    NSDate * _date;
...
+ (double)distanceFromlat1:(double)arg1 lon1:(double)arg2 tolat2:(double)arg3 lon2:(double)arg4;
