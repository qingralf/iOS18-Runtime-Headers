...
@interface RTPredictedLocationOfInterest : NSObject <HMDRTPredictedLocationOfInterest, NSSecureCoding> {
    double  _confidence;
...
@property (nonatomic, readonly) <HMDRTLocationOfInterest> *locationOfInterest;
