...
@property (nonatomic, copy) id /* block */ peopleDiscoveryErrorHandler;
@property (nonatomic, retain) RTRoutineManagerRegistrantPeopleDiscovery *peopleDiscoveryRegistrant;
@property (nonatomic, retain) RTPlaceInferenceOptions *placeInferenceOptions;
@property (nonatomic, copy) id /* block */ placeInferencesHandler;
...
- (void)_launchTaskWithSelector:(SEL)arg1 remainingAttempts:(unsigned long long)arg2 proxyErrorHandler:(id /* block */)arg3 taskBlock:(id /* block */)arg4;
...
- (id)actionRegistrant;
- (void)addBackgroundInertialOdometrySamples:(id)arg1 handler:(id /* block */)arg2;
...
- (void)fetchAuthorizedLocationStatus:(id /* block */)arg1;
- (void)fetchAutomaticVehicleEventDetectionSupportedWithHandler:(id /* block */)arg1;
- (void)fetchBackgroundInertialOdometrySamplesWithOptions:(id)arg1 handler:(id /* block */)arg2;
...
- (void)fetchCurrentPeopleDensity:(id /* block */)arg1;
...
- (void)fetchRemoteStatusWithHandler:(id /* block */)arg1;
...
- (void)onPlaceInferences:(id)arg1 error:(id)arg2;
...
- (id /* block */)peopleDiscoveryErrorHandler;
- (id)peopleDiscoveryRegistrant;
- (void)performBluePOIQueryLookingBack:(double)arg1 lookingAhead:(double)arg2 handler:(id /* block */)arg3;
- (id)placeInferenceOptions;
- (id /* block */)placeInferencesHandler;
...
- (void)setPeopleDiscoveryErrorHandler:(id /* block */)arg1;
- (void)setPeopleDiscoveryRegistrant:(id)arg1;
- (void)setPlaceInferenceOptions:(id)arg1;
- (void)setPlaceInferencesHandler:(id /* block */)arg1;
...
- (void)startMonitoringForPeopleDiscovery:(id)arg1 handler:(id /* block */)arg2;
- (void)startMonitoringPlaceInferencesWithOptions:(id)arg1 handler:(id /* block */)arg2;
...
- (void)stopMonitoringForPeopleDiscoveryWithHandler:(id /* block */)arg1;
