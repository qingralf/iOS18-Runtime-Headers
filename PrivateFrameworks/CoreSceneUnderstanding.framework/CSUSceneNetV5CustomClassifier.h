...
- (id).cxx_construct;
- (void).cxx_destruct;
- (id)allClassificationLikelihoods:(id)arg1;
- (id)allClassificationLikelihoods:(id)arg1 error:(id*)arg2;
- (id)configuration;
- (bool)enumerateClassificationLikelihoods:(id)arg1 usingBlock:(id /* block */)arg2;
- (bool)enumerateClassificationLikelihoods:(id)arg1 usingBlock:(id /* block */)arg2 error:(id*)arg3;
