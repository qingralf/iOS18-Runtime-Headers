...
@interface CSAttSiriMitigationAssetHandler : NSObject <CSUAFDownloadMonitorDelegate, CSVoiceTriggerAssetHandlerDelegate, CSVoiceTriggerEnabledMonitorDelegate> {
...
- (void)_getPreinstalledMitigationAssetForCurrentLocale:(id /* block */)arg1;
...
- (id)initWithAssetManager:(id)arg1 withUAFAssetManager:(id)arg2 withUAFDownloadMonitor:(id)arg3 withLanguageCodeUpdateMonitor:(id)arg4 withAssetOverrideFlag:(bool)arg5 withOverrideAssetPath:(id)arg6 disableOnDeviceCompilation:(bool)arg7;
...
- (void)setCachedAssetWithOverride:(id)arg1;
