...
@interface CSBuiltInVoiceTrigger : NSObject <CSAttSiriStateMonitorDelegate, CSAudioRouteChangeMonitorDelegate, CSAudioServerCrashMonitorDelegate, CSAudioStreamProvidingDelegate, CSBluetoothWirelessSplitterMonitorDelegate, CSDeviceActivationEventNotificationHandlerDelegate, CSPhoneCallStateMonitorDelegate, CSSecondPassProgressProviding, CSSelfTriggerDetectorDelegate, CSSiriClientBehaviorMonitorDelegate, CSStateMachineDelegate, CSVoiceTriggerEnabledMonitorDelegate, CSVoiceTriggerXPCServiceProxyDelegate> {
    ...
    <CSExclaveAssetsControlling> * _exclaveAssetsController;
    <CSExclaveFirstPassVoiceTriggerAnalyzing> * _exclaveClient;
    ...
    bool  _isFirstExclaveAudioBuffer;
...
@property (nonatomic, retain) <CSExclaveAssetsControlling> *exclaveAssetsController;
@property (nonatomic, retain) <CSExclaveFirstPassVoiceTriggerAnalyzing> *exclaveClient;
...
@property (nonatomic, retain) CSPolicy *voiceTriggerAPModeSuspendPolicy;
...
- (void)_receivedHearstRoutedEvent:(long long)arg1;
- (void)_receivedJarvisConnectionEvent:(bool)arg1;
- (void)_reportVoiceTriggerFirstPassFireFromAPWithSource:(unsigned long long)arg1 voiceTriggerFirstPassInfo:(id)arg2;
...
- (void)_setAsset:(id)arg1 forceExclaveToUsePreInstalledAsset:(bool)arg2;
...
- (void)_transitAOPModeIfNeeded:(bool)arg1;
- (void)_transitAOPModeIfNeededAsync:(bool)arg1;
- (void)_transitAOPModeIfNeededSync:(bool)arg1;
...
- (unsigned char)jarvisTriggerModeLogHeartbeat;
...
- (void)setAsset:(id)arg1 forceExclaveToUsePreInstalledAsset:(bool)arg2;
...
- (void)setExclaveAssetsController:(id)arg1;
- (void)setExclaveClient:(id)arg1;
...
- (void)setHearstRouteStatus:(long long)arg1;
- (void)setHeartbeatFactor:(unsigned long long)arg1;
- (void)setIsFirstExclaveAudioBuffer:(bool)arg1;
...
- (void)setJarvisTriggerModeLogHeartbeat:(unsigned char)arg1;
...
- (void)setVoiceTriggerAPModeSuspendPolicy:(id)arg1;
...
- (id)stateMachine;
- (id)validationTimer;
- (id)voiceTriggerAPModeSuspendPolicy;
