...
@property (nonatomic, retain) NSDictionary *asrFeatureLatencyDistribution;
@property (nonatomic, retain) CSASRFeatures *asrFeaturesAtEndpoint;
...
- (id)initWithTotalAudioRecorded:(double)arg1 endpointBufferHostTime:(unsigned long long)arg2 featuresAtEndpoint:(id)arg3 endpointerType:(long long)arg4 asrFeatureLatencyDistribution:(id)arg5 additionalMetrics:(id)arg6 trailingSilenceDurationAtEndpoint:(double)arg7 requestId:(id)arg8;
- (id)initWithTotalAudioRecorded:(double)arg1 endpointBufferHostTime:(unsigned long long)arg2 featuresAtEndpoint:(id)arg3 endpointerType:(long long)arg4 asrFeatureLatencyDistribution:(id)arg5 additionalMetrics:(id)arg6 trailingSilenceDurationAtEndpoint:(double)arg7 requestId:(id)arg8 osdFeatures:(id)arg9 asrFeatures:(id)arg10 isRequestTimeOut:(bool)arg11 assetConfigVersion:(id)arg12 blkHepAudioOrigin:(double)arg13 vtExtraAudioAtStartInMs:(double)arg14 firstAudioSampleSensorTimestamp:(unsigned long long)arg15 isAnchorTimeBuffered:(bool)arg16 endpointHostTime:(unsigned long long)arg17 audioDeliveryHostTimeDelta:(unsigned long long)arg18;
...
- (void)setAsrFeaturesAtEndpoint:(id)arg1;
