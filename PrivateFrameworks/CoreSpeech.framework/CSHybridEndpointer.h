...
@interface CSHybridEndpointer : NSObject <CSEndpointAnalyzerImpl, CSEndpointerAssetManagerDelegate> {
    unsigned long long  _activeChannel;
    unsigned long long  _anchorMachAbsTime;
    NSMutableArray * _asrFeaturesLatencies;
    ...
    bool  _didReceiveRCFeatures;
    bool  _didTimestampFirstAudioPacket;
    bool  _disableRCSelection;
    double  _endWaitTime;
    ...
    bool  _enhancedEndpointerDefaultResult;
...
@property (nonatomic, retain) NSMutableArray *asrFeaturesLatencies;
...
@property (nonatomic, retain) CSEnhancedEndpointer *enhancedEndpointer;
@property (nonatomic) bool enhancedEndpointerDefaultResult;
@property (nonatomic, retain) NSDictionary *enhancedEndpointerTaskThresholdMap;
...
@property (nonatomic, retain) CSASRFeatures *lastKnownRCFeatures;
...
@property (nonatomic, retain) NSDictionary *taskEnhancedEndpointerMap;
@property (nonatomic, retain) NSDictionary *taskThresholdMap;
...
- (void).cxx_destruct;
- (void)_generateEndpointerFeaturesWithEffectiveClientProcessedAudioMs:(double)arg1 osdFeatures:(id)arg2 completion:(id /* block */)arg3;
...
- (void)_processEnhancedEndpointerTaskString:(id)arg1;
- (void)_readParametersFromHEPAsset:(id)arg1;
- (void)_shouldAcceptEagerResultForDuration:(double)arg1 asrFeatures:(id)arg2 lastReportedEndpointTimeMs:(double)arg3 osdFeatures:(id)arg4 resultsCompletionHandler:(id /* block */)arg5;
- (bool)_shouldProvideTwoShotFeedbackWithRecordContext;
- (void)_swapEnhancedEndpointerModelForTaskString:(id)arg1;
- (void)_updateCurrentAsset:(id)arg1;
- (void)_updateEndpointerDelayedTriggerByMhId:(id)arg1;
- (bool)_useEnhancedEndpointer;
- (unsigned long long)activeChannel;
- (unsigned long long)anchorMachAbsTime;
- (id)asrFeaturesLatencies;
- (id)asrFeaturesQueue;
- (double)asrFeaturesWarmupLatency;
- (unsigned long long)audioDeliveryHostTimeDelta;
...
- (id)lastKnownRCFeatures;
- (double)lastReportedEndpointTimeMs;
- (double)lastStartOfVoiceActivityTime;
- (void)logAnchorMachAbsTime:(unsigned long long)arg1 numSamplesProcessedBeforeAnchorTime:(unsigned long long)arg2 isAnchorTimeBuffered:(bool)arg3 audioDeliveryHostTimeDelta:(unsigned long long)arg4;
...
- (void)processOSDFeatures:(id)arg1 withFrameDurationMs:(double)arg2 withMHID:(id)arg3;
...
- (void)setAsrFeaturesLatencies:(id)arg1;
- (void)setAsrFeaturesQueue:(id)arg1;
- (void)setAsrFeaturesWarmupLatency:(double)arg1;
- (void)setAudioDeliveryHostTimeDelta:(unsigned long long)arg1;
...
- (void)setDidReceiveRCFeatures:(bool)arg1;
- (void)setDidTimestampFirstAudioPacket:(bool)arg1;
- (void)setDisableRCSelection:(bool)arg1;
...
- (void)setEnhancedEndpointer:(id)arg1;
- (void)setEnhancedEndpointerDefaultResult:(bool)arg1;
- (void)setEnhancedEndpointerTaskThresholdMap:(id)arg1;
- (void)setEpResult:(bool)arg1;
- (void)setExtraDelayFrequency:(unsigned long long)arg1;
- (void)setFirstAudioPacketTimestamp:(id)arg1;
- (void)setFirstAudioSampleSensorTimestamp:(double)arg1;
- (void)setHasAcceptedEagerResult:(bool)arg1;
...
- (void)setIsASRFeatureFromServer:(bool)arg1;
...
- (void)setLastKnownRCFeatureLatency:(double)arg1;
- (void)setLastKnownRCFeatures:(id)arg1;
...
- (void)setTaskEnhancedEndpointerMap:(id)arg1;
- (void)setTaskThresholdMap:(id)arg1;
...
- (id)stateSerialQueue;
- (void)stopEndpointer;
- (id)taskEnhancedEndpointerMap;
- (id)taskThresholdMap;
- (void)terminateProcessing;
- (double)twoShotSilenceThresholdInMs;
- (void)updateEndpointerDelayedTrigger:(bool)arg1;
- (void)updateEndpointerThreshold:(float)arg1;
- (void)updateEnhancedEndpointerDefaultThresholdPartial:(float)arg1 defaultThresholdRC:(float)arg2 relaxedThresholdPartial:(float)arg3 relaxedThresholdRC:(float)arg4;
