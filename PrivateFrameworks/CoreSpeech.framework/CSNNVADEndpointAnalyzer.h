...
@property (nonatomic, readonly) NSString *endpointerModelVersion; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) double postVoiceTriggerSilence; /* unknown property attribute: ? */
