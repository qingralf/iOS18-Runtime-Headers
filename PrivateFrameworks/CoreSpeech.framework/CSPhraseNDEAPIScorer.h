...
- (unsigned long long)hearstNumberOfBytesPerChunk;
- (unsigned long long)hearstNumberOfSamplesPerChunk;
...
- (void)setHearstNumberOfBytesPerChunk:(unsigned long long)arg1;
- (void)setHearstNumberOfSamplesPerChunk:(unsigned long long)arg1;
