...
+ (id)_alertBehaviorForRecordRoute:(id)arg1 playbackRoute:(id)arg2 speechEvent:(long long)arg3 speechRecordingMode:(long long)arg4 ringerState:(long long)arg5 startingAlertBeepOverideID:(long long)arg6 presentationMode:(long long)arg7 usePrelistening:(bool)arg8 isOnPhoneCall:(bool)arg9 hasPlayedStartAlert:(bool)arg10 supportsEchoCancellation:(bool)arg11 isVoiceOverTouchEnabled:(bool)arg12 isVibrationEnabled:(bool)arg13 isVibrationSupported:(bool)arg14 suppressStartAlert:(bool)arg15 activationHostTime:(unsigned long long)arg16;
+ (id)_alertDictionaryForRecordRoute:(id)arg1 playbackRoute:(id)arg2 speechEvent:(long long)arg3 ringerState:(long long)arg4 startingAlertBeepOverideID:(long long)arg5 presentationMode:(long long)arg6 hasPlayedStartAlert:(bool)arg7 supportsEchoCancellation:(bool)arg8 isVoiceOverTouchEnabled:(bool)arg9 isVibrationEnabled:(bool)arg10 isVibrationSupported:(bool)arg11 activationHostTime:(unsigned long long)arg12;
+ (id)_dictationAlertBehaviorDictionaryForRecordRoute:(id)arg1 playbackRoute:(id)arg2 ringerState:(long long)arg3 usePrelistening:(bool)arg4 suppressStartAlert:(bool)arg5 supportsEchoCancellation:(bool)arg6 isVibrationEnabled:(bool)arg7 isVibrationSupported:(bool)arg8 isVoiceOverTouchEnabled:(bool)arg9;
+ (bool)_doesRecordRouteSupportZLL:(id)arg1;
+ (bool)_requestIsUsingHFPWithRecordRoute:(id)arg1 playbackRoute:(id)arg2;
+ (bool)_shouldAllowRecordWhileBeepWithRecordRoute:(id)arg1 playbackRoute:(id)arg2 supportsEchoCancellation:(bool)arg3 speechRecordingMode:(long long)arg4 recordingInfo:(id)arg5;
...
- (long long)saeToneIDWithCarPlayConnected:(bool)arg1;
