...
- (void)_notifyBuiltInVoiceTriggerPrewarm:(id)arg1 activationSource:(long long)arg2 completion:(id /* block */)arg3;
...
- (void)notifyBuiltInVoiceTriggerPrewarmExclave:(id)arg1 completion:(id /* block */)arg2;
