...
- (void)getConversationAwareness:(id /* block */)arg1;
...
- (void)getPersonalVolume:(id /* block */)arg1;
- (id)identifier;
...
- (void)setConversationAwareness:(bool)arg1 completion:(id /* block */)arg2;
- (void)setHeadphoneListeningMode:(long long)arg1 completion:(id /* block */)arg2;
- (void)setPersonalVolume:(bool)arg1 completion:(id /* block */)arg2;
