...
@interface CSSpeechController : NSObject <CSAudioAlertProvidingDelegate, CSAudioConverterDelegate, CSAudioDecoderDelegate, CSAudioSessionControllerDelegate, CSAudioSessionProvidingDelegate, CSAudioStreamProvidingDelegate, CSContinuousVoiceTriggerDelegate, CSEndpointAnalyzerImplDelegate, CSLanguageCodeUpdateMonitorDelegate, CSSmartSiriVolumeControllerDelegate, CSSpeakerRecognitionAssetDownloadMonitorDelegate, CSSpeakerRecognitionProxyProtocol, CSVoiceTriggerAssetHandlerDelegate, CSXPCClientDelegate, SOClockAlarmListening, SOClockTimerListening, SOMediaNowPlayingListening, SSRSpeakerRecognitionControllerDelegate> {
    ...
    id /* block */  _supportsDuckingOnSpeakerOutputEvaluator;
...
@property (nonatomic, retain) CSFAudioDeviceInfo *audioDeviceInfoImpl;
...
@property (nonatomic, copy) id /* block */ supportsDuckingOnSpeakerOutputEvaluator;
...
- (void)_audioStreamProvider:(id)arg1 audioBufferAvailable:(id)arg2;
...
- (void)_delayedStopRecordingWithOptions:(id)arg1;
...
- (id)initWithEndpointId:(id)arg1 xpcClientFactory:(id)arg2 endpointer:(id)arg3 continuousVoiceTrigger:(id)arg4 siriVolumeController:(id)arg5 mediaPlayingMonitor:(id)arg6 alarmMonitor:(id)arg7 timerMonitor:(id)arg8 audioSessionController:(id)arg9 supportPhatic:(bool)arg10 supportHearstVoiceTrigger:(bool)arg11 supportTriagleModeSessionActivationRetry:(bool)arg12 supportSessionActivateDelay:(bool)arg13 supportsDuckingOnSpeakerEvaluator:(id /* block */)arg14;
...
- (void)processASRFeatures:(id)arg1;
...
- (void)setAudioDeviceInfoImpl:(id)arg1;
...
- (void)setSupportsDuckingOnSpeakerOutputEvaluator:(id /* block */)arg1;
...
- (id /* block */)supportsDuckingOnSpeakerOutputEvaluator;
- (id)timerMonitor;
