...
@interface CSSpeechManager : NSObject <CSAudioProviderDelegate, CSAudioProviderSelecting, CSAudioRecorderDelegate, CSAudioServerCrashMonitorDelegate, CSDeviceActivationEventNotificationHandlerDelegate, CSOpportuneSpeakEventMonitorDelegate, CSVoiceTriggerAssetHandlerDelegate> {
...
@property (nonatomic) id clientController;
...
- (void)_setAssetForBuiltInVoiceTrigger:(id)arg1 completion:(id /* block */)arg2;
...
- (id)init;
- (id)initWithExclaveHardware:(bool)arg1 assetHandler:(id)arg2;
...
- (void)setIsExclaveHardware:(bool)arg1;
