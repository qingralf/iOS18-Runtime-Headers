...
@interface CSVoiceTriggerAPModeSuspendPolicyIOS : CSPolicy <CSIntuitiveConvAudioCaptureMonitorDelegate, CSSiriClientBehaviorMonitorDelegate> {
    bool  _isAssistantClientConsideredAsRecord;
...
- (void)setIsAssistantClientConsideredAsRecord:(bool)arg1;
