...
@interface CSVoiceTriggerFirstPassHearst : NSObject <CSDeviceActivationEventNotificationHandlerDelegate, CSPhoneCallStateMonitorDelegate, CSSiriClientBehaviorMonitorDelegate> {
