...
@interface CSVoiceTriggerFirstPassRemora : NSObject <CSAccessorySiriClientBehaviorMonitorDelegate, CSDeviceActivationEventNotificationHandlerDelegate, CSSecondPassProgressProviding> {
