...
@interface CSVoiceTriggerSecondPass : NSObject <CSAudioServerCrashMonitorDelegate, CSAudioStreamProvidingDelegate, CSMediaPlayingMonitorDelegate, CSPhraseNDEAPIScorerDelegate, CSSelfTriggerDetectorDelegate, CSVoiceTriggerAwareZeroFilterDelegate, CSVoiceTriggerEnabledMonitorDelegate, CSVolumeMonitorDelegate, SSRSpeakerRecognitionControllerDelegate> {
    ...
    <CSExclaveSecondPassVoiceTriggerAnalyzing> * _exclaveClient;
    ...
    bool  _isAdBlockerMatchedBeforeSetResultCompletion;
...
@property (nonatomic) bool cancelSecondPassTrigger;
...
@property (nonatomic, retain) CSAudioTimeConverter *exclaveAudioTimeConverter;
@property (nonatomic, retain) <CSExclaveSecondPassVoiceTriggerAnalyzing> *exclaveClient;
...
@property (nonatomic) bool isAdBlockerMatchedBeforeSetResultCompletion;
...
@property (nonatomic) struct os_unfair_lock_s { unsigned int x1; } secondpassTriggerCancellationLock;
...
- (void)_calculateRecordingTimeForAOPTriggerFromFirstPassInfo:(id)arg1 completion:(id /* block */)arg2;
...
- (void)_handleVoiceTriggerFirstPassFromExclave:(id)arg1 audioProviderUUID:(id)arg2 completion:(id /* block */)arg3;
...
- (bool)_isFirstPassSourceExclave:(unsigned long long)arg1;
...
- (void)_processSecondPassInExclave:(id /* block */)arg1;
- (void)_reportDiagnosticsForDelayedVTLaunchIfNeeded:(float)arg1;
...
- (unsigned long long)secondPassCheckerExecutionTime;
...
- (struct os_unfair_lock_s { unsigned int x1; })secondpassTriggerCancellationLock;
...
- (void)setCancelSecondPassTrigger:(bool)arg1;
...
- (void)setExclaveAudioTimeConverter:(id)arg1;
...
- (void)setFirstPassVoiceIsolationChannelScoreBoost:(float)arg1;
...
- (void)setIsAdBlockerMatchedBeforeSetResultCompletion:(bool)arg1;
...
- (void)setModelFileDescriptor:(int)arg1;
...
- (void)setSecondPassCheckerExecutionTime:(unsigned long long)arg1;
...
- (void)setSecondpassTriggerCancellationLock:(struct os_unfair_lock_s { unsigned int x1; })arg1;
