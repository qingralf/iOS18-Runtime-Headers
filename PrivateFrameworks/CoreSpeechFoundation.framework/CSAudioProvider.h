...
@interface CSAudioProvider : NSObject <CSAudioAlertProviding, CSAudioMeterProviding, CSAudioMetricProviding, CSAudioPreprocessorDelegate, CSAudioRecorderDelegate, CSAudioServerCrashMonitorDelegate, CSAudioSessionProviding, CSAudioStreamProviding, CSTriggerInfoProviding> {
    ...
    unsigned long long  _currentExclaveAudioSampleCount;
    ...
    bool  _isTransferringExclaveAudioSample;
    CSAudioRecordContext * _lastAudioRecorderContext;
    unsigned long long  _lastFetchedExclaveAudioSampleCount;
...
- (void)_releaseListeningMicIndicatorLockFrom:(unsigned long long)arg1;
...
- (void)audioRecorderExclaveBufferAvailable:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 hostTime:(unsigned long long)arg3 arrivalTimestampToAudioRecorder:(unsigned long long)arg4;
...
- (unsigned long long)currentExclaveAudioSampleCount;
...
- (unsigned long long)lastFetchedExclaveAudioSampleCount;
...
- (void)setCurrentExclaveAudioSampleCount:(unsigned long long)arg1;
...
- (void)setIsTransferringExclaveAudioSample:(bool)arg1;
- (void)setLastAudioRecorderContext:(id)arg1;
- (void)setLastFetchedExclaveAudioSampleCount:(unsigned long long)arg1;
