...
@interface CSAudioRecorder : NSObject <AVVoiceControllerRecordDelegate, CSAudioDecoderDelegate, CSAudioFileReaderDelegate, CSAudioSessionEventProviding, CSExclaveAudioProvidingDelegate, CSRemoteRecordClientDelegate, CSUserSessionActiveMonitorDelegate> {
    CSReusableBufferPool * _audioBufferPool;
    unsigned long long  _audioFilePathIndex;
    CSAudioFileReader * _audioFileReader;
    <CSExclaveAudioProviding> * _exclaveAudioClient;
    unsigned long long  _exclaveSampleCountForStream;
...
- (void)_processExclaveBufferCallbackFrom:(unsigned long long)arg1 hostTime:(unsigned long long)arg2;
...
- (void)exclaveRecordClientAudioBuffer:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 audioBuffer:(id)arg3 hostTime:(unsigned long long)arg4;
- (unsigned long long)exclaveSampleCountForStream;
- (id)fetchGibraltarVoiceTriggerInfoWithRecordDeviceIndicator:(id)arg1;
- (bool)fetchSecureAudioStreamWithRecordDeviceIndicator:(id)arg1 from:(unsigned long long)arg2 numSamples:(unsigned long long)arg3 hostTime:(unsigned long long)arg4 error:(id*)arg5;
...
- (bool)setEnableInterruptionByRecordingClientsForStream:(unsigned long long)arg1 enable:(bool)arg2;
- (void)setExclaveSampleCountForStream:(unsigned long long)arg1;
...
- (bool)stopDeliverSecureAudioStreamWithRecordDeviceIndicator:(id)arg1 from:(unsigned long long)arg2 error:(id*)arg3;
