...
- (id)initWithStopRecordingReason:(unsigned long long)arg1 expectedStopHostTime:(unsigned long long)arg2 trailingSilenceDurationAtEndpoint:(double)arg3 holdRequest:(id)arg4 supportsMagus:(bool)arg5 requestId:(id)arg6;
