...
- (int)_translateAudioSessionCategory:(id)arg1;
- (int)_translateAudioSessionMode:(id)arg1;
- (id)init;
...
- (void)logMHAssistantDaemonAudioRecordingInterruptionStartedTier1WithMHUUID:(id)arg1 withLinkID:(id)arg2 withActiveSessionDisplayIDs:(id)arg3 audioSessionCategory:(id)arg4 audioSessionMode:(id)arg5;
...
- (void)logMHAssistantDaemonAudioSessionActivationFailedWithInsufficientPriority:(id)arg1 activeSessionDisplayIDs:(id)arg2 audioSessionCategory:(id)arg3 audioSessionMode:(id)arg4;
