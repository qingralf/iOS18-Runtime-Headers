...
- (void)logSiriSetupPHSEnrollmentDigitalZeroDetectionCompletedWithSiriSetupID:(id)arg1 withPageNumber:(int)arg2 withPhId:(id)arg3 withMaxNumContinuousZeros:(int)arg4 withMaxNumAllowedContinuousZeros:(int)arg5 withIsMaxNumContinuousZerosOverThreshold:(bool)arg6 withLocale:(id)arg7 withVTAssetConfigVersion:(id)arg8 withStageStatus:(int)arg9;
