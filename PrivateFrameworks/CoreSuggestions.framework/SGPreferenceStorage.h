...
+ (void)setEnableEventsMLRegexEnsembleExtraction:(bool)arg1;
+ (void)setEventsMLRegexEnsembleExtractionEnabledForTests:(bool)arg1;
...
+ (void)setHideEventsExtractedFromOldDocumentsForTests:(bool)arg1;
