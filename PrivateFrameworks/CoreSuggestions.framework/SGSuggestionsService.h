...
- (id)extractAttributesAndDonate:(id)arg1 error:(id*)arg2;
...
- (id)suggestionsFromSearchableItem:(id)arg1 options:(unsigned long long)arg2 processingType:(unsigned long long)arg3 error:(id*)arg4;
