...
+ (id)extractAttributeSetsFromRealtimeEvents:(id)arg1;
+ (id)filterAttributesForDonation:(id)arg1;
+ (id)filterPseudoEvents:(id)arg1 keepPastEvents:(bool)arg2 keepPartialEvents:(bool)arg3;
+ (id)filterPseudoEvents:(id)arg1 keepPastEvents:(bool)arg2 keepPartialEvents:(bool)arg3 keepEventsFromOldDocuments:(bool)arg4;
+ (id)getAggregatedAttributeSet:(id)arg1;
+ (id)getProcessedItemFromEvents:(id)arg1 uniqueID:(id)arg2 bundleID:(id)arg3;
+ (id)preprocessSearchableItem:(id)arg1;
+ (id)requestCache;
+ (id /* block */)simpleWritebackHandler;
+ (bool)titleSuggestionForMessageFeatureEnabled;
+ (void)updateOriginalDocumentsWith:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)_suggestionsFromSearchableItem:(id)arg1 options:(unsigned long long)arg2 dissectIfNecessary:(bool)arg3 processingType:(unsigned long long)arg4 completionDelivery:(unsigned long long)arg5 withCompletion:(id /* block */)arg6;
...
- (void)_suggestionsFromSingleSearchableItem:(id)arg1 options:(unsigned long long)arg2 dissectIfNecessary:(bool)arg3 processingType:(unsigned long long)arg4 completionDelivery:(unsigned long long)arg5 withCompletion:(id /* block */)arg6;
...
- (void)batchSuggestionsFromMessages:(id)arg1 options:(unsigned long long)arg2 completionDelivery:(unsigned long long)arg3 batchCompletion:(id /* block */)arg4 writeBackCompletion:(id /* block */)arg5 shouldStopSignal:(id /* block */)arg6;
- (void)batchSuggestionsFromSearchableItems:(id)arg1 options:(unsigned long long)arg2 dissectIfNecessary:(bool)arg3 processingType:(unsigned long long)arg4 completionDelivery:(unsigned long long)arg5 batchCompletion:(id /* block */)arg6 writeBackCompletion:(id /* block */)arg7 shouldStopSignal:(id /* block */)arg8;
...
- (void)extractAttributesAndDonate:(id)arg1 withCompletion:(id /* block */)arg2;
...
- (void)realtimeSuggestionsForMailOrMessageWithHash:(id)arg1 options:(unsigned long long)arg2 completion:(id /* block */)arg3 completionDelivery:(unsigned long long)arg4 providedBy:(id /* block */)arg5 searchableItem:(id)arg6 dissectIfNecessary:(bool)arg7 processingType:(unsigned long long)arg8 isTextMessage:(bool)arg9;
...
- (id)shortNamesAndRealtimeEventsFromEntity:(id)arg1 message:(id)arg2 enrichments:(id)arg3 store:(id)arg4 keepPastEvents:(bool)arg5 keepPartialEvents:(bool)arg6 keepEventsFromOldDocuments:(bool)arg7;
...
- (void)suggestionsFromSearchableItem:(id)arg1 options:(unsigned long long)arg2 processingType:(unsigned long long)arg3 withCompletion:(id /* block */)arg4;
...
- (void)suggestionsFromSingleMessage:(id)arg1 options:(unsigned long long)arg2 completionDelivery:(unsigned long long)arg3 completionHandler:(id /* block */)arg4 fullCompletionHandler:(id /* block */)arg5;
