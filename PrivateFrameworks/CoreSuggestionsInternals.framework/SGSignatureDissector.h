...
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })rangeOfSenderName:(id)arg1 inRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 restrictLength:(bool)arg3 forMessage:(id)arg4;
...
- (bool)shouldIgnoreSignature:(id)arg1 signatureRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; }*)arg2 isInhuman:(bool*)arg3;
