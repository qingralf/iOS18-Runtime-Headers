...
- (void)createForwardstops:(id)arg1 withCompressionTypes:(id)arg2 withDeploymentTargets:(id)arg3;
...
- (bool)needToCreateForwardstopFor2018DeploymentVariant:(id)arg1 withCompressionTypes:(id)arg2;
- (bool)needToCreateForwardstopFor2019DeploymentVariant:(id)arg1 withCompressionTypes:(id)arg2;
...
- (bool)shouldGenerateDisplayGamut:(unsigned int)arg1;
- (bool)shouldGenerateScale:(unsigned int)arg1;
...
- (id)vectorGlyphRenderingModeWithIdentifier:(long long)arg1;
