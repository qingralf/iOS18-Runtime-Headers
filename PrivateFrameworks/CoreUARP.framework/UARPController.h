...
- (void)firmwareStagingProgress:(id)arg1 assetID:(id)arg2 bytesSent:(unsigned long long)arg3 bytesTotal:(unsigned long long)arg4 filterProgress:(bool)arg5;
...
- (bool)getBatchedSupportedAccessories:(id)arg1 assetLocationType:(long long)arg2;
- (bool)getSupportedAccessories:(id)arg1 assetLocationType:(long long)arg2;
- (bool)getSupportedAccessoriesInternal:(id)arg1 assetID:(id)arg2 batchRequest:(bool)arg3;
...
- (id)personalizationHelperQueryPendingTssRequests:(id)arg1;
- (void)personalizationHelperTssResponse:(id)arg1 updaterName:(id)arg2;
...
- (void)startPersonalizationHelperService:(id)arg1 entitlement:(id)arg2;
