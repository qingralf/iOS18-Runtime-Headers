...
- (id)_baseStackKeyForName:(id)arg1;
...
- (void)finalizeNamedVectorGlyphLookupWithResult:(id)arg1 name:(id)arg2 glyphContinuousSize:(double)arg3 glyphContinuousWeight:(double)arg4 pointSize:(double)arg5;
...
- (id)namedVectorGlyphWithName:(id)arg1 scaleFactor:(double)arg2 deviceIdiom:(long long)arg3 layoutDirection:(long long)arg4 glyphContinuousSize:(double)arg5 glyphContinuousWeight:(double)arg6 glyphPointSize:(double)arg7 appearanceName:(id)arg8 locale:(id)arg9;
...
+ (id)_IS_appearanceNameFromAppearance:(long long)arg1;
+ (id)_IS_appearanceStringFromAppearance:(long long)arg1;
...
- (id)_IS_multisizedImageWithName:(id)arg1 size:(struct CGSize { double x1; double x2; })arg2 scale:(double)arg3 layoutDirection:(long long)arg4 platform:(unsigned long long)arg5 appearance:(long long)arg6;
