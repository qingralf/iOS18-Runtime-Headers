...
- (void)_activate;
- (void)_applyChannelAssignments:(id)arg1;
...
- (void)_playURL:(id)arg1 loop:(bool)arg2 completion:(id /* block */)arg3;
...
- (void)playURL:(id)arg1 loop:(bool)arg2 completion:(id /* block */)arg3;
- (void)prepareURL:(id)arg1 identifier:(id*)arg2 completion:(id /* block */)arg3;
- (void)setDispatchQueue:(id)arg1;
- (void)setEnableSmartRouting:(unsigned int)arg1;
- (void)setFlags:(unsigned int)arg1;
- (void)setInvalidationHandler:(id /* block */)arg1;
- (void)setLabel:(id)arg1;
- (bool)setPortUID:(id)arg1 channelName:(id)arg2 error:(id*)arg3;
