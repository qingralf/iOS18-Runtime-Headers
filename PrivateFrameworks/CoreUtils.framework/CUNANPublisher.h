...
@property (nonatomic, retain) CUNANEndpoint *mockEndpoint;
@property (nonatomic, copy) NSString *mockID;
@property (nonatomic, copy) NSString *mockPeerEndpointString;
...
- (void)setMockEndpoint:(id)arg1;
- (void)setMockID:(id)arg1;
- (void)setMockPeerEndpointString:(id)arg1;
