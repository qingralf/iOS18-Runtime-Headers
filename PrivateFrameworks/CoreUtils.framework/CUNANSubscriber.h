...
- (void)_subscriber:(id)arg1 receivedDiscoveryResult:(id)arg2;
...
- (void)reportMockEndpointFound:(id)arg1;
- (void)reportMockEndpointLost:(id)arg1;
...
- (void)subscriber:(id)arg1 receivedDiscoveryResult:(id)arg2;
