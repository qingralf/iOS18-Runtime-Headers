...
@interface CUNetInterfaceMonitor : NSObject {
    ...
    NSArray * _interfaces;
    id /* block */  _interfacesChangedHandler;
...
@property (nonatomic, copy) id /* block */ interfacesChangedHandler;
...
- (void)_primaryIPChangedNW:(bool)arg1;
...
- (id)init;
- (id)interfaces;
- (id /* block */)interfacesChangedHandler;
- (void)invalidate;
...
- (void)setInterfacesChangedHandler:(id /* block */)arg1;
