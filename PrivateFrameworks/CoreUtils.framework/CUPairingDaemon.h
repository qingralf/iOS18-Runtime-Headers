...
- (id)_copyHomeKitLocalPairingIDWithOptions:(unsigned long long)arg1 error:(int*)arg2;
...
- (void)getIdentityWithOptions:(unsigned long long)arg1 completionHandler:(id /* block */)arg2;
- (id)init;
- (id)initStandalone;
- (void)invalidate;
