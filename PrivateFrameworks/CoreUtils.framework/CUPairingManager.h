...
+ (id)copySystemPairingIdentifierAndReturnError:(id*)arg1;
...
- (void)getPairedPeersWithGroupID:(id)arg1 options:(unsigned long long)arg2 completion:(id /* block */)arg3;
...
- (void)setTargetUserID:(unsigned int)arg1;
...
- (void)updatePairedPeersWithGroupID:(id)arg1 groupInfo:(id)arg2 options:(unsigned long long)arg3 completion:(id /* block */)arg4;

// Image: /System/Library/PrivateFrameworks/AirPlaySender.framework/AirPlaySender

- (id)pairingGroupInfoForPairingGroupID:(id)arg1;
- (id)peersMatchingPairingGroupID:(id)arg1;
- (int)savePairedPeer:(id)arg1;
- (int)updatePairingGroupInfo:(id)arg1 forPairingGroupID:(id)arg2;
