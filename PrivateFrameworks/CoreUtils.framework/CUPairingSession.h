...
@interface CUPairingSession : NSObject {
    ...
    id /* block */  _savePeerHandler;
    unsigned long long  _selfAppFlags;
    id /* block */  _sendDataHandler;
    id /* block */  _sendMessageDataHandler;
...
@property (nonatomic, copy) id /* block */ copyIdentityHandler;
@property (nonatomic, retain) NSObject<OS_dispatch_queue> *dispatchQueue;
@property (nonatomic, copy) id /* block */ findPeerHandler;
@property (nonatomic, copy) NSString *fixedPIN;
@property (nonatomic) unsigned int flags;
@property (nonatomic, readonly, copy) NSDictionary *groupInfoPeer;
@property (nonatomic, copy) NSDictionary *groupInfoSelf;
@property (nonatomic, copy) id /* block */ hidePINHandler;
@property (nonatomic, copy) NSString *label;
@property (nonatomic, copy) NSString *languageCode;
@property (nonatomic, copy) NSString *localeIdentifier;
@property (nonatomic) bool localize;
...
@property (nonatomic, copy) id /* block */ savePeerHandler;
@property (nonatomic) unsigned long long selfAppFlags;
@property (nonatomic, copy) id /* block */ sendDataHandler;
@property (nonatomic, copy) id /* block */ sendMessageDataHandler;
...
- (void)receivedMessageData:(id)arg1;
- (id /* block */)savePeerHandler;
- (unsigned long long)selfAppFlags;
- (id /* block */)sendDataHandler;
- (id /* block */)sendMessageDataHandler;
