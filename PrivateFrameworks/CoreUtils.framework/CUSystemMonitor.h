...
@interface CUSystemMonitor : NSObject {
    ...
    id /* block */  _screenStateChangedHandler;
...
@property bool meDeviceUseFindMyLocate;
...
- (int)screenState;
- (id /* block */)screenStateChangedHandler;
...
- (void)setMeDeviceUseFindMyLocate:(bool)arg1;
...
- (void)setScreenStateChangedHandler:(id /* block */)arg1;
