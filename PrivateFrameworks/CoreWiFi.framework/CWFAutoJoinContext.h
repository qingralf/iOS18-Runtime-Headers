...
@interface CWFAutoJoinContext : NSObject <NSCopying> {
    ...
    bool  _cacheOnly;
    bool  _didForceAllRemainingChannels;
    ...
    bool  _useCacheForPreviouslyScannedChannels;
}
...
- (void)setDidForceAllRemainingChannels:(bool)arg1;
...
- (void)setUseCacheForPreviouslyScannedChannels:(bool)arg1;
