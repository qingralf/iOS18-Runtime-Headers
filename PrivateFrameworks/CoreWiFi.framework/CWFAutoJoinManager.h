...
- (void)__addDisallowedKnownNetwork:(id)arg1;
...
- (bool)__allowJoinCandidate:(id)arg1 context:(id)arg2 defer:(bool*)arg3 error:(id*)arg4;
- (bool)__allowKnownNetwork:(id)arg1 context:(id)arg2 allowForSeamlessSSIDTransition:(id)arg3 defer:(bool*)arg4 targetQueue:(id)arg5 error:(id*)arg6;
- (bool)__allowOpportunisticNetworkTransitionWithTrigger:(long long)arg1;
- (id)__alreadyFoundFollowup6GHzBSSWithSignature:(id)arg1;
...
- (id)__cachedScanResultsWithChannelList:(id)arg1 context:(id)arg2;
...
- (bool)__calloutToAllowKnownNetwork:(id)arg1 trigger:(long long)arg2 allowForSeamlessSSIDTransition:(id)arg3 defer:(bool*)arg4 queue:(id)arg5 error:(id*)arg6;
...
- (bool)__does6GHzChannelOverlapWithUWB:(id)arg1;
- (bool)__forceNearbyNetworkRetrySchedule;
- (bool)__hasJoinedAnyKnownNetworkSinceBoot;
- (void)__invalidateAllowedKnownNetworksCacheForTrigger:(long long)arg1;
...
- (bool)__isNonPinnedEAPTLSCandidate:(id)arg1;
...
- (unsigned int)__qosForAutoJoinTrigger:(long long)arg1;
- (void)__removeDisallowedKnownNetwork:(id)arg1;
...
- (bool)__shouldBypassUnusedNetworkPeriodCheckForTrigger:(long long)arg1 knownNetwork:(id)arg2;
...
- (bool)isKnownNetworkDisallowed:(id)arg1;
