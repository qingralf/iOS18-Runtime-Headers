...
+ (void)setLogRedactionSetting:(unsigned char)arg1;
...
- (id)clearAutoJoinDenyListForNetwork:(id)arg1 reason:(unsigned long long)arg2;
...
- (bool)isQuickProbeRequiredForNetworkProfile:(id)arg1;
- (id)knownNetworkInfoForLocalNetworkPromptWithOptions:(id)arg1;
...
- (id)performNearbyDeviceDiscovery:(id)arg1;
...
- (bool)reportQuickProbeResult:(bool)arg1 networkProfile:(id)arg2 error:(id*)arg3;
...
- (id)setAutoJoinDenyListForNetwork:(id)arg1 reason:(unsigned long long)arg2;
- (void)setAwdlServiceManager:(id)arg1;
- (bool)setBackgroundScanConfiguration:(id)arg1 error:(id*)arg2;
...
- (bool)setLinkQualityMetricConfiguration:(id)arg1 error:(id*)arg2;
- (bool)setPassword:(id)arg1 knownNetworkProfile:(id)arg2 error:(id*)arg3;
- (bool)setPower:(bool)arg1 error:(id*)arg2;
- (bool)setPrivateMACAddressMode:(long long)arg1 networkProfile:(id)arg2 error:(id*)arg3;
- (bool)setPrivateMACAddressModeSystemSetting:(long long)arg1 error:(id*)arg2;
- (void)setPrivateMACAddressUserJoinFailureUIState:(bool)arg1 networkProfile:(id)arg2;
...
- (bool)startHostAPModeWithConfiguration:(id)arg1 error:(id*)arg2;
