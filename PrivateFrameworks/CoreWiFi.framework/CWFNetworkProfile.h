...
@property (nonatomic, copy) NSString *cachedPrivateMACAddress;
@property (nonatomic, copy) NSDate *cachedPrivateMACAddressUpdatedAt;
@property (nonatomic) unsigned long long cachedShortSSID;
@property (nonatomic, copy) NSDictionary *captiveProfile;
@property (nonatomic, readonly, copy) NSDate *captiveWebsheetLoginDate;
...
@property (nonatomic, copy) NSDictionary *discoveredDevices;
...
@property (nonatomic, readonly) bool isHotspot;
...
@property (nonatomic, copy) NSDate *privateMACAddressEvaluatedAt;
...
@property (nonatomic, copy) NSDate *privateMACAddressModeUserSettingUpdatedAt;
...
@property (nonatomic, copy) NSDate *wasHiddenBefore;
...
- (id)cachedPrivateMACAddressUpdatedAt;
- (unsigned long long)cachedShortSSID;
- (id)captiveProfile;
- (id)captiveWebsheetLoginDate;
- (id)carplayUUID;
- (id)cellularNetworkInfo;
- (id)changedOSSpecificKeysFromNetworkProfile:(id)arg1;
- (id)changedPropertiesFromNetworkProfile:(id)arg1;
...
- (void)setCachedPrivateMACAddress:(id)arg1;
- (void)setCachedPrivateMACAddressUpdatedAt:(id)arg1;
...
- (void)setLastDisconnectReason:(int)arg1;
...
- (void)setPrivateMACAddressEvaluatedAt:(id)arg1;
- (void)setPrivateMACAddressEvaluationState:(long long)arg1;
- (void)setPrivateMACAddressModeConfigurationProfileSetting:(long long)arg1;
- (void)setPrivateMACAddressModeUserSetting:(long long)arg1;
- (void)setPrivateMACAddressModeUserSettingUpdatedAt:(id)arg1;
...
- (void)setWasHiddenBefore:(id)arg1;
