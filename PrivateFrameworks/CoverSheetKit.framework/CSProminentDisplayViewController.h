...
@interface CSProminentDisplayViewController : UIViewController <PREditorTitleViewController> {
    ...
    CSVibrantContentStyleRenderer * _complicationRenderer;
    ...
    UIColor * _textColor;
    double  _timeAlpha;
    CSVibrantContentStyleRenderer * _timeRenderer;
...
@property (nonatomic) bool animatesTimeChanges;
...
@property (nonatomic, retain) CSVibrantContentStyleRenderer *complicationRenderer;
...
@property (nonatomic) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } previousTimeStyleBounds;
...
@property (nonatomic, retain) CSVibrantContentStyleRenderer *timeRenderer;
@property (nonatomic, retain) <PRPosterContentStyle> *titleContentStyle;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })_timeStyleBounds;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })previousTimeStyleBounds;
...
- (void)setPreviousTimeStyleBounds:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
