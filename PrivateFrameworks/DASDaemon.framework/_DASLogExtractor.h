...
- (id)copyApplicationSummary:(id)arg1 startDate:(id)arg2 endDate:(id)arg3 detail:(bool)arg4 error:(int*)arg5;
- (id)dateFormatter;
...
- (int)didActivityFinish:(id)arg1 forActivity:(id)arg2;
- (int)didActivityFinish:(id)arg1 forBARActivity:(id)arg2;
- (bool)didActivityRun:(id)arg1 forActivity:(id)arg2;
- (bool)didBARFinish:(id)arg1 forApplication:(id)arg2;
- (id)eventStream;
- (id)getActivityStartBeforeDate:(id)arg1 forActivity:(id)arg2;
- (id)getAllBARActivityNames:(id)arg1;
- (id)getAllPushLaunchActivityNames:(id)arg1;
- (id)getBARSummaryFromLogs:(id)arg1 forApplication:(id)arg2 detail:(bool)arg3;
...
- (id)getMessagesActivityFinish:(id)arg1 forActivity:(id)arg2 isCompleted:(bool)arg3;
- (id)getMessagesAfterRunning:(id)arg1 forActivity:(id)arg2;
- (id)getMessagesBeforeRunning:(id)arg1 forActivity:(id)arg2;
- (id)getMessagesForAllBARTasks:(id)arg1;
- (id)getMessagesForBARLifecycle:(id)arg1 forApplication:(id)arg2 queryStatus:(id)arg3 taskType:(id)arg4;
- (id)getMessagesWhenAppBackgroundSwitch:(id)arg1 forApplication:(id)arg2 switchTo:(id)arg3;
- (id)getPolicyDenialReasonsFromMessage:(id)arg1;
- (id)getScheduledBlocksOfBARMessages:(id)arg1 forApplication:(id)arg2;
...
- (int)summarizeApplication:(id)arg1 startDate:(id)arg2 endDate:(id)arg3 detail:(bool)arg4;
