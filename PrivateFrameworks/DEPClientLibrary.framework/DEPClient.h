...
- (id)pushToken;
- (id)pushTopic;
- (void)registerForDEPPushForceUpdate:(bool)arg1 completionBlock:(id /* block */)arg2;
...
- (void)syncDEPPushToken:(id)arg1 pushTopic:(id)arg2 completionBlock:(id /* block */)arg3;
