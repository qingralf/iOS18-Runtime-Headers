...
@interface DMCEnrollmentFlowController : DMCEnrollmentFlowControllerBase {
    ...
    <DMCEnrollmentFlowDelegate> * _delegate;
    ...
    NSString * _expectedBuildVersion;
    NSString * _expectedOSVersion;
    NSArray * _extensionIdentifiersFromConfig;
    ...
    NSURL * _serviceURL;
    NSString * _username;
    NSString * _wifiProfileIdentifier;
}
...
@property (nonatomic, retain) NSDictionary *cloudConfig;
@property <DMCEnrollmentFlowDelegate> *delegate;
...
@property (nonatomic, retain) NSString *expectedBuildVersion;
@property (nonatomic, retain) NSString *expectedOSVersion;
@property (nonatomic, retain) NSArray *extensionIdentifiersFromConfig;
...
@property (nonatomic, retain) NSString *wifiProfileIdentifier;

+ (id)_createEnrollmentNotAllowedDuringSDPError;
+ (id)_createEnterpriseApplicationExistsErrorWithAppName:(id)arg1;
...
- (void)_analyzeCloudConfig:(id)arg1 enrollmentType:(unsigned long long)arg2 isReturnToService:(bool)arg3 obliterationShelter:(id)arg4;
- (id)_appNameWithBundleID:(id)arg1;
...
- (void)_askForUserConsentWithProfileData:(id)arg1 managedAppleID:(id)arg2 cloudConfig:(id)arg3 isReturnToService:(bool)arg4;
...
- (void)_awaitESSOConfigActivationWithExtensionIdentifiers:(id)arg1;
- (void)_blockAppInstalls;
- (void)_blockAppInstallsIfNecessary;
- (id)_bundleIDsFromAppIDs:(id)arg1;
- (bool)_canSkipMDMEnrollmentWithEnrollmentType:(unsigned long long)arg1;
...
- (id)_commonStepsForEnrollmentType:(unsigned long long)arg1 isReturnToService:(bool)arg2;
...
- (void)_detectAuthTypeWithServiceURL:(id)arg1 enrollmentType:(unsigned long long)arg2 isPostBuddy:(bool)arg3 machineInfo:(id)arg4 anchorCertificateRefs:(id)arg5;
- (void)_displayManagementDetailsOverviewWithProfileData:(id)arg1 managedAppleID:(id)arg2;
- (void)_enrollmentTypeAuthorizedBySDP:(unsigned long long)arg1 completion:(id /* block */)arg2;
- (void)_ensureWiFiConnectionWithWiFiProfile:(id)arg1;
...
- (void)_fetchAppAttributesWithITunesItemID:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)_fetchBundleIDsWithiTunesItemID:(id)arg1 debuggingAppIDs:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)_fetchCloudConfigWithEnrollmentType:(unsigned long long)arg1 isReturnToService:(bool)arg2;
- (void)_fetchEnrollmentProfileFromServiceURL:(id)arg1 authTokens:(id)arg2 machineInfo:(id)arg3 anchorCertificateRefs:(id)arg4 enrollmentType:(unsigned long long)arg5 enrollmentMethod:(unsigned long long)arg6 isESSO:(bool)arg7 essoAppITunesStoreID:(id)arg8 isReturnToService:(bool)arg9;
- (void)_fetchEnrollmentProfileFromServiceURL:(id)arg1 username:(id)arg2 password:(id)arg3 machineInfo:(id)arg4 anchorCertificateRefs:(id)arg5;
- (void)_fetchEnrollmentProfileFromWebURL:(id)arg1 machineInfo:(id)arg2 anchorCertificateRefs:(id)arg3;
...
- (id)_guardAgainstConflictingAccountsWithUsername:(id)arg1 altDSID:(id)arg2;
- (bool)_handleNeedCredentialsError:(id)arg1;
- (bool)_handleSoftwareUpdateRequiredError:(id)arg1;
- (void)_installESSOConfigurationProfile:(id)arg1 devicePasscode:(id)arg2 personaID:(id)arg3;
- (void)_installEnrollmentProfile:(id)arg1 devicePasscode:(id)arg2 personaID:(id)arg3 rmAccountIdentifier:(id)arg4 isESSO:(bool)arg5 essoAppITunesStoreID:(id)arg6 essoConfigurationProfile:(id)arg7 wifiProfileIdentifier:(id)arg8 enrollmentType:(unsigned long long)arg9 isReturnToService:(bool)arg10;
...
- (void)_preflightEnrollmentWithEnrollmentType:(unsigned long long)arg1 isRenewalFlow:(bool)arg2 isPostRestoration:(bool)arg3 isPostBuddy:(bool)arg4;
...
- (void)_promptForSoftwareUpdateWithExpectedOSVersion:(id)arg1 expectedBuildVersion:(id)arg2;
...
- (id)_stepsWithUI;
- (void)_storeCloudConfig:(id)arg1;
- (void)_trackDirtyAppBundleIDs:(id)arg1;
...
- (bool)_validateBundleID:(id)arg1 personaID:(id)arg2 requiredEntitlements:(id)arg3 error:(id*)arg4;
- (bool)_verifyAccountsInformationWithAltDSID:(id)arg1 personaID:(id)arg2;
...
- (void)continueMacBuddyORGOEnrollmentFlowWithAuthenticationResults:(id)arg1 serviceURL:(id)arg2 bearerToken:(id)arg3 profileData:(id)arg4 completionHandler:(id /* block */)arg5;
- (void)dealloc;
- (id)delegate;
- (id)devicePasscode;
...
- (id)essoDetails;
- (id)expectedBuildVersion;
- (id)expectedOSVersion;
- (id)extensionIdentifiersFromConfig;
- (id)friendlyName;
...
- (void)setExpectedBuildVersion:(id)arg1;
- (void)setExpectedOSVersion:(id)arg1;
- (void)setExtensionIdentifiersFromConfig:(id)arg1;
- (void)setFriendlyName:(id)arg1;
- (void)setHasExecutedUIStep:(bool)arg1;
- (void)setIsPostBuddy:(bool)arg1;
- (void)setIsPostRestoration:(bool)arg1;
- (void)setIsProfileLocked:(bool)arg1;
- (void)setIsRenewalFlow:(bool)arg1;
- (void)setIsReturnToService:(bool)arg1;
...
- (void)setWifiProfileIdentifier:(id)arg1;
- (void)startBYODEnrollmentFlowRestartIfFail:(bool)arg1 completionHandler:(id /* block */)arg2;
- (void)startInBuddyEnrollmentFlowRestartIfFail:(bool)arg1 completionHandler:(id /* block */)arg2;
...
- (void)startPostBuddyORGOEnrollmentFlowWithServiceURL:(id)arg1 anchorCertificates:(id)arg2 restartIfFail:(bool)arg3 completionHandler:(id /* block */)arg4;
