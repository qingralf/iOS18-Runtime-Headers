...
- (void)_discoverServerURLForUserIdentifier:(id)arg1 anchorCertificateRefs:(id)arg2 completionHandler:(id /* block */)arg3;
- (id)_fallbackServer;
...
- (void)fetchEnrollmentProfileWithServiceURL:(id)arg1 username:(id)arg2 password:(id)arg3 authTokens:(id)arg4 enrollmentMethod:(unsigned long long)arg5 machineInfo:(id)arg6 anchorCertificateRefs:(id)arg7 completionHandler:(id /* block */)arg8;
