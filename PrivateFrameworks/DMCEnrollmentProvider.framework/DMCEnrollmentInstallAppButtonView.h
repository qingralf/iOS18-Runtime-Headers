...
@interface DMCEnrollmentInstallAppButtonView : UIView <ASCLockupViewDelegate_DSIDLessInstall> {
    id /* block */  _beginInstallationHandler;
    id /* block */  _completionHandler;
    ASCLockupView * _lockupView;
    double  _preferredHeight;
}

@property (nonatomic, copy) id /* block */ beginInstallationHandler;
...
- (void).cxx_destruct;
- (id /* block */)beginInstallationHandler;
- (id /* block */)completionHandler;
- (id)initWithLockupRequest:(id)arg1 lockupViewGroup:(id)arg2 beginInstallationHandler:(id /* block */)arg3 completionHandler:(id /* block */)arg4;
- (void)layoutSubviews;
- (id)lockupView;
...
- (void)setBeginInstallationHandler:(id /* block */)arg1;
