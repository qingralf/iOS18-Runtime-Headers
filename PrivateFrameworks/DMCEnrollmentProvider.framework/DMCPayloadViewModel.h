...
@interface DMCPayloadViewModel : NSObject <NSSecureCoding> {
    ...
    DMCApplicationProxy * _managedApp;
    MDMBook * _managedBook;
...
@property (nonatomic, retain) DMCApplicationProxy *managedApp;
@property (nonatomic, retain) MDMBook *managedBook;
...
+ (long long)payloadTypeForPayloadClass:(Class)arg1;
+ (id)payloadViewModelsFromPayload:(id)arg1;
+ (id)removeDuplicatesFromRestrictionPayloadViewModels:(id)arg1;
