...
@property (nonatomic, copy) NSSet *appsToRestore;
...
+ (id)_set:(id)arg1 subtracting:(id)arg2;
...
- (void)_startRestoreFromSnapshot:(id)arg1 skippingApps:(id)arg2;
- (id)appsToRestore;
- (id /* block */)completion;
