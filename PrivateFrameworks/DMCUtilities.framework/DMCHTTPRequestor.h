...
+ (bool)_parseWellKnownFailedErrorWithMessage:(id)arg1 details:(id)arg2 outError:(id*)arg3;
+ (id)jsonDictFromResponse:(id)arg1;
+ (bool)parse403ErrorWithResponseDictionary:(id)arg1 outError:(id*)arg2;
+ (bool)parsePredefined403ErrorWithResponseDictionary:(id)arg1 outError:(id*)arg2;
