...
@interface DMCHTTPTransaction : NSObject <NSURLSessionDataDelegate> {
    ...
    bool  _ignoreAuthenticatorError;
    NSString * _method;
    ...
    double  _timeout;
    id /* block */  _transactionCompletionBlock;
    NSString * _userAgent;
}
...
@property (nonatomic) bool ignoreAuthenticatorError;
...
@property (nonatomic, copy) id /* block */ transactionCompletionBlock;
...
- (void)setIgnoreAuthenticatorError:(bool)arg1;
...
- (void)setTransactionCompletionBlock:(id /* block */)arg1;
- (void)setUrl:(id)arg1;
- (void)setUserAgent:(id)arg1;
- (id /* block */)simulatedTransactionBlock;
- (long long)statusCode;
- (double)timeout;
- (id /* block */)transactionCompletionBlock;
- (id)url;
- (id)userAgent;
