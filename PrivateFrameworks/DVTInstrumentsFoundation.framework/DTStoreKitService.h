...
+ (void)syncConfigurationAssetData:(id)arg1 fileName:(id)arg2 forBundleID:(id)arg3 connection:(id)arg4 completion:(id /* block */)arg5;
...
- (bool)_handleSendPurchaseIntentMessage:(id)arg1 forBundleID:(id)arg2 error:(id*)arg3;
- (bool)_handleSyncConfigurationAssetMessage:(id)arg1 forBundleID:(id)arg2 error:(id*)arg3;
