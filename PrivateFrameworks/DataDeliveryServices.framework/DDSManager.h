...
- (id)autoAssetManager;
- (id)autoAssetQueryForAssertion:(id)arg1;
...
- (void)fetchCatalogBasedAssetUpdateStatusForAssertion:(id)arg1 callback:(id /* block */)arg2;
...
- (long long)modifyAssetUpdateStatusForAssertion:(id)arg1 status:(long long)arg2;
...
- (void)updateAutoAssetForAssetType:(id)arg1;
- (void)updateCatalogBasedAssetForAssertion:(id)arg1 callback:(id /* block */)arg2;
