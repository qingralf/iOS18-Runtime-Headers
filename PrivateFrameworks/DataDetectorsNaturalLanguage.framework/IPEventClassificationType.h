...
+ (id)titleGenerationModelPredictionForMessageUnits:(id)arg1;
...
- (id)adjustedEventTitleForMessageUnits:(id)arg1 subject:(id)arg2 dateInSubject:(id)arg3 eventStartDate:(id)arg4 useTitleGenerationModel:(bool)arg5 isGeneratedFromSubject:(bool*)arg6;
- (id)adjustedEventTitleForMessageUnits:(id)arg1 subject:(id)arg2 dateInSubject:(id)arg3 eventStartDate:(id)arg4 useTitleGenerationModel:(bool)arg5 isGeneratedFromSubject:(bool*)arg6 isGeneratedFromTitleGenerationModel:(bool*)arg7;
...
- (id)decoratedTitleFromTitle:(id)arg1 participantName:(id)arg2 isTitleSenderDecorated:(bool*)arg3;
