...
+ (id)identificationStringsForMenuElement:(id)arg1 useDefault:(bool)arg2;
...
- (id)_updateMenuElementItems:(id)arg1 withActions:(id)arg2 view:(id)arg3 interactionDelegate:(id)arg4 options:(long long)arg5 level:(unsigned long long)arg6 parent:(id)arg7;
