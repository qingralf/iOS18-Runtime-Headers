...
@interface DebugHierarchyTargetHub : NSObject {
    NSMutableDictionary * _additionalKnownObjects;
...
@property (nonatomic, retain) NSMutableDictionary *additionalKnownObjects;
...
- (id)response;
- (id)runtimeInfo;
- (void)setAdditionalKnownObjects:(id)arg1;
