...
@interface DeviceTypeDeviceIdentity : NSObject {
    ...
    bool  _device_supports_eda_certificates;
    bool  _device_supports_mfi_certificates;
...
@property (nonatomic, readonly) bool device_supports_eda_certificates;
@property (nonatomic, readonly) bool device_supports_mfi_certificates;
