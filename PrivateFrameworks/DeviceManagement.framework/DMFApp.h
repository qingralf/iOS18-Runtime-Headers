...
@property (nonatomic, copy) NSString *distributorIdentifier;
...
+ (id)descriptionForBool:(id)arg1 showWhenUnassigned:(bool)arg2 valueWhenUnassigned:(bool)arg3;
...
- (void)setDistributorIdentifier:(id)arg1;
