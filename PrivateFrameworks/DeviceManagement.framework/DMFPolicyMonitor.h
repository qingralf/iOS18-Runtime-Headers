...
- (void)requestCommunicationPoliciesForBundleIdentifiers:(id)arg1 completionHandler:(id /* block */)arg2;
- (id)requestCommunicationPoliciesForBundleIdentifiers:(id)arg1 withError:(id*)arg2;
...
- (void)requestPoliciesForWebsiteURLs:(id)arg1 completionHandler:(id /* block */)arg2;
- (id)xpcConnection;
