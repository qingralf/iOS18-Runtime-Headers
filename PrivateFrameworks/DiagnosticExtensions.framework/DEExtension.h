...
- (id)_localizedStringFromPlistWithKey:(id)arg1 localization:(id)arg2;
- (id)_localizedTextFromLocalizedStringKey:(id)arg1 fallbackFileContentsKey:(id)arg2 localization:(id)arg3;
- (void)accessBundleWithSynchronousHandler:(id /* block */)arg1;
- (bool)adoptsExtensionTrackerFlow;
- (bool)allowUserAttachmentSelection;
- (void)annotatedAttachmentsForParameters:(id)arg1 andHandler:(id /* block */)arg2;
