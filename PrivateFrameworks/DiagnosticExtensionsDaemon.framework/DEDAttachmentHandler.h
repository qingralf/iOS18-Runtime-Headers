...
- (id)_processAttachments:(id)arg1 withSessionIdentifier:(id)arg2 extension:(id)arg3 shouldAddClassBDataProtection:(bool)arg4 rootDir:(id)arg5 annotatedGroup:(id)arg6;
...
- (id)init;
- (id)log;
- (id)processAttachments:(id)arg1 withSessionIdentifier:(id)arg2 extension:(id)arg3 shouldAddClassBDataProtection:(bool)arg4 annotatedGroup:(id)arg5;
