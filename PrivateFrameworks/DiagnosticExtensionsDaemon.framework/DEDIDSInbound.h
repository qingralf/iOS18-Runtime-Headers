...
@interface DEDIDSInbound : NSObject <DEDSecureArchiving, IDSServiceDelegate> {
    ...
    <DEDIDSInboundDelegate> * _delegate;
}

@property DEDIDSConnection *connection;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property <DEDIDSInboundDelegate> *delegate;
...
- (void).cxx_destruct;
- (void)add_session_data:(id)arg1 service:(id)arg2 account:(id)arg3 fromID:(id)arg4 context:(id)arg5;
...
- (void)compression_progress:(id)arg1 service:(id)arg2 account:(id)arg3 fromID:(id)arg4 context:(id)arg5;
- (id)connection;
- (id)delegate;
...
- (void)did_load_extension_text_data:(id)arg1 service:(id)arg2 account:(id)arg3 fromID:(id)arg4 context:(id)arg5;
- (void)did_present_notification_on_passthrough_daemon:(id)arg1 service:(id)arg2 account:(id)arg3 fromID:(id)arg4 context:(id)arg5;
- (void)did_remove_notification_on_passthrough_daemon:(id)arg1 service:(id)arg2 account:(id)arg3 fromID:(id)arg4 context:(id)arg5;
...
- (void)load_extension_text_data:(id)arg1 service:(id)arg2 account:(id)arg3 fromID:(id)arg4 context:(id)arg5;
...
- (void)present_notification_on_passthrough_daemon:(id)arg1 service:(id)arg2 account:(id)arg3 fromID:(id)arg4 context:(id)arg5;
...
- (void)remove_notification_on_passthrough_daemon:(id)arg1 service:(id)arg2 account:(id)arg3 fromID:(id)arg4 context:(id)arg5;
- (void)schedule_notification:(id)arg1 service:(id)arg2 account:(id)arg3 fromID:(id)arg4 context:(id)arg5;
...
- (void)unschedule_notification:(id)arg1 service:(id)arg2 account:(id)arg3 fromID:(id)arg4 context:(id)arg5;
