...
- (id)followupNotificationBundleIconName;
- (id)followupNotificationBundlePath;
...
- (void)setFollowupNotificationBundleIconName:(id)arg1;
- (void)setFollowupNotificationBundlePath:(id)arg1;
