...
- (void)makePromiseWithUUID:(id)arg1 extensionID:(id)arg2 success:(id /* block */)arg3 error:(id /* block */)arg4;
...
- (void)updatePromise:(id)arg1 withFilename:(id)arg2 size:(long long)arg3 extensionID:(id)arg4 status:(long long)arg5 success:(id /* block */)arg6 error:(id /* block */)arg7;
