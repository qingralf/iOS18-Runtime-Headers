...
- (void)uploadRequests:(id)arg1 contactDecisionServer:(bool)arg2 xpcActivity:(id)arg3 remainingUploadQuota:(unsigned long long)arg4 backingPersistentContainer:(id)arg5 completionHandler:(id /* block */)arg6;
