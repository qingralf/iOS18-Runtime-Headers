...
+ (id)_appIntentsServicesTeamConfiguration:(bool)arg1 isSeed:(bool)arg2 isCarrier:(bool)arg3 platform:(unsigned char)arg4;
...
+ (id)_libtraceTeamConfiguration:(bool)arg1 isSeed:(bool)arg2 isCarrier:(bool)arg3 platform:(unsigned char)arg4;
...
+ (id)_newsTeamConfiguration:(bool)arg1 isSeed:(bool)arg2 isCarrier:(bool)arg3 platform:(unsigned char)arg4;
...
+ (id)_skylightTeamConfiguration:(bool)arg1 isSeed:(bool)arg2 isCarrier:(bool)arg3 platform:(unsigned char)arg4;
+ (id)_softwareUpdateTeamConfiguration:(bool)arg1 isSeed:(bool)arg2 isCarrier:(bool)arg3 platform:(unsigned char)arg4;
+ (id)_spindumpTeamConfiguration:(bool)arg1 isSeed:(bool)arg2 isCarrier:(bool)arg3 platform:(unsigned char)arg4;
+ (id)_spotlightTeamConfiguration:(bool)arg1 isSeed:(bool)arg2 isCarrier:(bool)arg3 platform:(unsigned char)arg4;
