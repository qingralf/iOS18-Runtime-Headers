...
@property (nonatomic, readonly) NSObject<OS_dispatch_queue> *configurationSyncQueue;
...
@property (nonatomic, retain) NSNumber *ignoreAutomatedDeviceGroup;
...
@property (nonatomic, readonly) NSObject<OS_dispatch_queue> *uploadRequestLookupQueue;
...
- (void)_handleGetIgnoreADG:(id)arg1 state:(id)arg2;
...
- (void)_handleSetIgnoreADG:(id)arg1 state:(id)arg2;
