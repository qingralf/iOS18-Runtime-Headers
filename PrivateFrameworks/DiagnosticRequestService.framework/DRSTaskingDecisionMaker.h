...
@interface DRSTaskingDecisionMaker : NSObject {
    bool  _allowRefreshLimitingParameters;
...
@property (nonatomic, readonly) bool allowRefreshLimitingParameters;
...
- (id)initWithTimezone:(id)arg1 limitingParameters:(id)arg2 dbWorkingDirectoryPath:(id)arg3 cloudKitHelper:(id)arg4 enforceDate:(bool)arg5 enforceBuild:(bool)arg6 enforceSampling:(bool)arg7 enforceTeamHysteresis:(bool)arg8 enforceGlobalHysteresisAndCap:(bool)arg9 allowRefereshLimitingParameters:(bool)arg10 errorOut:(id*)arg11;
