...
@interface DKDiagnosticManager : NSObject <DKAccessoryResponder, DKAssetResponder, DKBrightnessResponder, DKPluginReloadResponder, DKProgressResponder, DKRequestViewControllerDelegate, DKStatusBarResponder, DKUserAlertResponder, DKVolumeHUDResponder> {
    ...
    <DKStatusBarResponder> * _statusBarResponder;
...
@property (nonatomic) <DKStatusBarResponder> *statusBarResponder;
