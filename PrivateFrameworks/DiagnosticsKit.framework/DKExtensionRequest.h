...
@interface DKExtensionRequest : NSObject <DKExtensionHostAdapterDelegate, DKRequest> {
    NSString * _allowListContactMessage;
    bool  _canceled;
    bool  _completed;
    ...
    bool  _isAllowListed;
    id  _payload;
    RBSAssertion * _rbprocessAssertion;
    UIViewController * _remoteViewController;
    <NSCopying> * _requestIdentifier;
}

@property (nonatomic, retain) NSString *allowListContactMessage;
...
@property (nonatomic, retain) RBSAssertion *rbprocessAssertion;
...
- (bool)isInterrupted;
- (id)payload;
- (id)rbprocessAssertion;
- (id)remoteViewController;
- (id)requestIdentifier;
- (void)setAllowListContactMessage:(id)arg1;
...
- (void)setIsAllowListed:(bool)arg1;
- (void)setNotAllowListedWithContactMessage:(id)arg1;
- (void)setPayload:(id)arg1;
- (void)setRbprocessAssertion:(id)arg1;
