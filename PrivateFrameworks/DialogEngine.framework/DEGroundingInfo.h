...
@property /* Warning: unhandled struct encoding: '{GroundingInfo=Q{vector<double' */ struct  This; /* unknown property attribute:  std::allocator<char>>={__rep=(?={__short=[23c][0C]b7b1}{__long=*Qb63b1}{__raw=[3Q]})}}}} */

- (id).cxx_construct;
- (void).cxx_destruct;
- (struct GroundingInfo { unsigned long long x1; struct vector<double, std::allocator<double>> { double *x_2_1_1; double *x_2_1_2; struct __compressed_pair<double *, std::allocator<double>> { double *x_3_2_1; } x_2_1_3; } x2; struct basic_string<char, std::char_traits<char>, std::allocator<char>> { struct __compressed_pair<std::basic_string<char>::__rep, std::allocator<char>> { struct __rep { union { struct __short { BOOL x_1_5_1[23]; unsigned char x_1_5_2[0]; unsigned int x_1_5_3 : 7; unsigned int x_1_5_4 : 1; } x_1_4_1; struct __long { char *x_2_5_1; unsigned long long x_2_5_2; unsigned int x_2_5_3 : 63; unsigned int x_2_5_4 : 1; } x_1_4_2; struct __raw { unsigned long long x_3_5_1[3]; } x_1_4_3; } x_1_3_1; } x_1_2_1; } x_3_1_1; } x3; })This;
- (int)count;
- (id)init:(int)arg1 timeStamps:(id)arg2 text:(id)arg3;
- (void)setThis:(struct GroundingInfo { unsigned long long x1; struct vector<double, std::allocator<double>> { double *x_2_1_1; double *x_2_1_2; struct __compressed_pair<double *, std::allocator<double>> { double *x_3_2_1; } x_2_1_3; } x2; struct basic_string<char, std::char_traits<char>, std::allocator<char>> { struct __compressed_pair<std::basic_string<char>::__rep, std::allocator<char>> { struct __rep { union { struct __short { BOOL x_1_5_1[23]; unsigned char x_1_5_2[0]; unsigned int x_1_5_3 : 7; unsigned int x_1_5_4 : 1; } x_1_4_1; struct __long { char *x_2_5_1; unsigned long long x_2_5_2; unsigned int x_2_5_3 : 63; unsigned int x_2_5_4 : 1; } x_1_4_2; struct __raw { unsigned long long x_3_5_1[3]; } x_1_4_3; } x_1_3_1; } x_1_2_1; } x_3_1_1; } x3; })arg1;
- (id)text;
- (id)timestamps;
