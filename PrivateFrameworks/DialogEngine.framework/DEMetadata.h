...
@property /* Warning: unhandled struct encoding: '{optional<siri::dialogengine::ObjectInput>=(?=c{ObjectInput=^^?{basic_string<char' */ struct  Obj; /* unknown property attribute:  std::allocator<char>>={__rep=(?={__short=[23c][0C]b7b1}{__long=*Qb63b1}{__raw=[3Q]})}}}BBBi})B} */
