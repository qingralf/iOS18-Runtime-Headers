...
@property /* Warning: unhandled struct encoding: '{optional<siri::dialogengine::ObjectProperty>=(?=c{ObjectProperty=^^?{basic_string<char' */ struct  This; /* unknown property attribute:  std::allocator<char>>={__rep=(?={__short=[23c][0C]b7b1}{__long=*Qb63b1}{__raw=[3Q]})}}}BB})B} */
