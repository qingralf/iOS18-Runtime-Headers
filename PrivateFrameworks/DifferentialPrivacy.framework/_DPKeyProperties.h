...
@property (nonatomic, readonly) unsigned long long transparencyLogLifetime;
...
+ (id)parametersForAlgorithm:(id)arg1 properties:(id)arg2 epsilon:(id)arg3 fragmentWidth:(unsigned long long)arg4;
...
- (unsigned long long)transparencyLogLifetime;
