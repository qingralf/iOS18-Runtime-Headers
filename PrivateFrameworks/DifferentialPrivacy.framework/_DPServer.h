...
+ (bool)shouldNotRecord:(id)arg1 forKey:(id)arg2 count:(unsigned long long)arg3;

- (void).cxx_destruct;
- (id)db;
- (void)donateDonationReceivedEventToBitacoraForKey:(id)arg1 succeeded:(bool)arg2 count:(int)arg3;
- (id)init;
