...
- (void)acceptInvitationWithIdentifier:(id)arg1 passcode:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (void)createSharingInvitationsForKeyIdentifier:(id)arg1 friendIdentifier:(id)arg2 auth:(id)arg3 ourBindingAttestation:(id)arg4 config:(id)arg5 completionHandler:(id /* block */)arg6;
- (void)createSilentSharingInvitationWithGroupIdentifier:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)didEnd:(id)arg1;
...
- (void)handleInitiatorMessage:(id)arg1 forInvitationIdentifier:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)handleRecipientMessage:(id)arg1 forInvitationIdentifier:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (void)retryPasscode:(id)arg1 forInvitationIdentifier:(id)arg2 completionHandler:(id /* block */)arg3;
