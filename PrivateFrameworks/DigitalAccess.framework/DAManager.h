...
+ (id)createAliroHomeKey:(id)arg1 seid:(id)arg2 readerIdentifier:(id)arg3 readerPublicKey:(id)arg4 homeUUID:(id)arg5 outError:(id*)arg6;
+ (id)createAliroHydraKey:(id)arg1 seid:(id)arg2 serverParameters:(id)arg3 outError:(id*)arg4;
...
+ (id)getAliroSupportedProtocolVersions:(id*)arg1;
...
+ (id)sharedManager;
+ (id)updateAliroCredentialDocumentStatus:(id)arg1 seid:(id)arg2 keyIdentifier:(id)arg3 accessDocumentPresent:(unsigned char)arg4 accessDocumentSignedTimestamp:(id)arg5 revocationDocumentPresent:(unsigned char)arg6 revocationDocumentSignedTimestamp:(id)arg7;
