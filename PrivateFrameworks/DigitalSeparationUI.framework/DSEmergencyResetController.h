...
@property (nonatomic, retain) NSArray *emergencyResetSteps;
...
- (void)resetAppDistribution:(id /* block */)arg1;
- (id)resetError;
- (void)resetIDFA:(id /* block */)arg1;
...
- (void)setEmergencyResetSteps:(id)arg1;
...
- (void)unpairContinuityDevices:(id /* block */)arg1;
