...
+ (id)iconTableViewCellFromTableView:(id)arg1 withContentConfigurationText:(id)arg2 detail:(id)arg3 icon:(id)arg4;
...
- (id)contentConfigurationWithText:(id)arg1 secondaryText:(id)arg2 icon:(id)arg3;
- (void)customizeProperties;
- (id)initWithContentConfigurationForText:(id)arg1 detail:(id)arg2 icon:(id)arg3;
