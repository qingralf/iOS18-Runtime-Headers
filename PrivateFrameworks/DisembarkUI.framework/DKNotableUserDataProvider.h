...
@interface DKNotableUserDataProvider : NSObject <DKNotableUserDataProvider> {
    ...
    <DKRestrictionsProvider> * _restrictionsProvider;
...
@property (nonatomic, retain) <DKRestrictionsProvider> *restrictionsProvider;
