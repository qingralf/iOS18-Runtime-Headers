...
+ (id)getAuthValueWithBackend:(struct shared_ptr<Backend> { struct Backend {} *x1; struct __shared_weak_count {} *x2; })arg1 authTableNumEntries:(int)arg2 mechanism:(int)arg3 error:(id*)arg4;
