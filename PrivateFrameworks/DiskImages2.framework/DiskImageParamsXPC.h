...
+ (id)createAEABackendWithBackendXPC:(id)arg1 error:(id*)arg2;
+ (bool)getAEAKeyFromSAKSWithMetadata:(id)arg1 key:(char *)arg2 error:(id*)arg3;
+ (bool)getAEAKeyWithHelper:(void*)arg1 keyBuffer:(char *)arg2 bufferSize:(unsigned long long)arg3 error:(id*)arg4;
+ (id)newWithURL:(id)arg1 fileOpenFlags:(int)arg2 error:(id*)arg3;
+ (id)newWithUnlockedBackendXPC:(id)arg1 error:(id*)arg2;
+ (bool)supportsSecureCoding;
+ (id)tryCreateAEABackendWithBackendXPC:(id)arg1 error:(id*)arg2;
...
- (struct shared_ptr<DiskImage> { struct DiskImage {} *x1; struct __shared_weak_count {} *x2; })createShadowDiskImageWithBackend:(struct shared_ptr<Backend> { struct Backend {} *x1; struct __shared_weak_count {} *x2; })arg1 numBlocks:(unsigned long long)arg2 sinkDiskImage:(const void*)arg3 cache_only:(bool)arg4 stack_size:(unsigned long long)arg5;
...
- (bool)lockBackendsWithWritableOnly:(bool)arg1 error:(id*)arg2;
- (bool)lockWritableBackendsWithError:(id*)arg1;
