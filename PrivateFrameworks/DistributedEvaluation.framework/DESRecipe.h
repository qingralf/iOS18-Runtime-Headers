...
@property (nonatomic, readonly) NSNumber *approximateStaleness;
...
@property (nonatomic, readonly) NSNumber *federatedBufferDownScalingFactor;
@property (nonatomic, readonly) bool isFederatedBufferStaled;
...
@property (nonatomic, readonly) bool useFederatedBuffer;
...
- (id)federatedBufferDownScalingFactor;
- (id)haruspexKeyWithError:(id*)arg1;
- (id)initWithCoder:(id)arg1;
- (bool)isFederatedBufferStaled;
- (bool)isFederatedBufferStaled:(id)arg1;
- (id)maxNorm;
- (id)normBinCount;
- (id)parametersUsed;
