...
@interface DNDConfiguration : NSObject <NSCopying, NSMutableCopying, NSSecureCoding> {
    unsigned long long  _allowIntelligentManagement;
...
@property (nonatomic, readonly) unsigned long long allowIntelligentManagement;
...
- (id)_initWithSuppressionType:(unsigned long long)arg1 suppressionMode:(unsigned long long)arg2 allowedApplicationIdentifiers:(id)arg3 deniedApplicationIdentifiers:(id)arg4 allowedWebApplicationIdentifiers:(id)arg5 deniedWebApplicationIdentifiers:(id)arg6 senderConfiguration:(id)arg7 minimumBreakthroughUrgency:(unsigned long long)arg8 hideApplicationBadges:(unsigned long long)arg9 allowIntelligentManagement:(unsigned long long)arg10 compatibilityVersion:(long long)arg11 applicationConfigurationType:(unsigned long long)arg12 senderConfigurationType:(unsigned long long)arg13;
- (unsigned long long)allowIntelligentManagement;
