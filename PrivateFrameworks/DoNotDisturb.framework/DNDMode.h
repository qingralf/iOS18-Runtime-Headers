...
@interface DNDMode : NSObject <NSCopying, NSMutableCopying, NSSecureCoding> {
    ...
    DNDModeSymbolDescriptor * _symbolDescriptor;
...
@property (nonatomic, readonly, copy) DNDModeSymbolDescriptor *symbolDescriptor;
...
- (id)initWithName:(id)arg1 modeIdentifier:(id)arg2 symbolImageName:(id)arg3 tintColorName:(id)arg4 symbolDescriptor:(id)arg5 semanticType:(long long)arg6 visibility:(unsigned long long)arg7 identifier:(id)arg8;
