...
- (id)_createModeSpecificConfigurationForModeSemanticType:(long long)arg1 withIdentifier:(id)arg2;
- (id)_createTriggersForFocusWithIdentifier:(id)arg1;
...
- (id)_setModeConfigurationDefaultsForModeConfiguration:(id)arg1 withIdentifier:(id)arg2;
