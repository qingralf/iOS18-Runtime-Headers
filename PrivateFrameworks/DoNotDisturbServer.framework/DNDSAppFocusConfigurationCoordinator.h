...
- (void)_executeAction:(id)arg1 orActionIdentifier:(id)arg2 withBundleIdentifier:(id)arg3 modeIdentifier:(id)arg4 groupIdentifier:(id)arg5 exiting:(bool)arg6 metadata:(id)arg7;
