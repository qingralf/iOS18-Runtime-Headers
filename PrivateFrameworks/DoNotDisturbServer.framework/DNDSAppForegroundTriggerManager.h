...
@interface DNDSAppForegroundTriggerManager : NSObject <DNDSAutomationManager> {
    ...
    <DNDSAppForegroundTriggerManagerDataSource><DNDSAutomationManagerDataSource> * _dataSource;
    NSObject<OS_os_transaction> * _eventCoalescingTransaction;
    BMStoreEvent * _latestEvent;
    NSMutableDictionary * _sinks;
}

@property (nonatomic) <DNDSAppForegroundTriggerManagerDataSource><DNDSAutomationManagerDataSource> *dataSource;
