...
@interface DNDSConfigurationRecord : NSObject <DNDSBackingStoreRecord, NSCopying, NSMutableCopying> {
    NSNumber * _allowIntelligentManagement;
...
@property (nonatomic, readonly, copy) NSNumber *allowIntelligentManagement;
...
- (void).cxx_destruct;
- (id)_initWithApplicationConfigurationType:(id)arg1 senderConfigurationType:(id)arg2 suppressionType:(id)arg3 suppressionMode:(id)arg4 minimumBreakthroughUrgency:(id)arg5 hideApplicationBadges:(id)arg6 allowIntelligentManagement:(id)arg7 compatibilityVersion:(id)arg8;
- (id)_initWithRecord:(id)arg1;
- (id)allowIntelligentManagement;
