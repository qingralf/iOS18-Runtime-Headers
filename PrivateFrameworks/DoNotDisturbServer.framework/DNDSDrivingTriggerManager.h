...
@interface DNDSDrivingTriggerManager : NSObject <DNDSAutomationManager> {
    ...
    <DNDSDrivingTriggerManagerDataSource><DNDSAutomationManagerDataSource> * _dataSource;
...
@property (nonatomic) <DNDSDrivingTriggerManagerDataSource><DNDSAutomationManagerDataSource> *dataSource;
