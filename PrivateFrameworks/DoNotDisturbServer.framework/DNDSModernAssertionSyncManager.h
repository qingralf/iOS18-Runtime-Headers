...
@interface DNDSModernAssertionSyncManager : NSObject <DNDSAssertionSyncManager, DNDSKeybagStateObserver, DNDSSyncServiceDelegate, DNDSSysdiagnoseDataProvider> {
...
- (id)initWithClientDetailsProvider:(id)arg1 localSyncService:(id)arg2 cloudSyncService:(id)arg3 keybag:(id)arg4;
