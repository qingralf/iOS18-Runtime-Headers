...
@interface DNDSSmartTriggerManager : NSObject <DNDSAutomationManager> {
    ...
    <DNDSSmartTriggerManagerDataSource><DNDSAutomationManagerDataSource> * _dataSource;
    NSMutableDictionary * _sinks;
}

@property (nonatomic) <DNDSSmartTriggerManagerDataSource><DNDSAutomationManagerDataSource> *dataSource;
