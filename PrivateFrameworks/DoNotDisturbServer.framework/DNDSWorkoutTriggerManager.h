...
@interface DNDSWorkoutTriggerManager : NSObject <DNDSAutomationManager> {
    ...
    <DNDSWorkoutTriggerManagerDataSource><DNDSAutomationManagerDataSource> * _dataSource;
...
@property (nonatomic) <DNDSWorkoutTriggerManagerDataSource><DNDSAutomationManagerDataSource> *dataSource;
