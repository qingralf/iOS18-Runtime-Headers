...
@interface DockKitCore.DockCoreAccessory : NSObject <DockKitCore.XPCActuatorClientProtocol, DockKitCore.XPCBatteryClientProtocol, DockKitCore.XPCSensorClientProtocol, DockKitCore.XPCSystemEventClientProtocol, DockKitCore.XPCTrackingSummaryClientProtocol, NSSecureCoding> {
    void XPCTIMEOUT;
    void _xpcAllowed;
    void _xpcConnection;
    void _xpcConnectionError;
    void _xpcConnectionLock;
    void _xpcConnection_CameraCapture;
    void batteryDelegates;
    void certified;
...
- (void)updateFromAccessory:(id)arg1;
