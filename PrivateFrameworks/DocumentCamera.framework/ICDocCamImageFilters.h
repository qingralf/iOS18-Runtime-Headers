...
+ (id)colorDocument:(id)arg1 orientation:(long long)arg2 constantColor:(bool)arg3;
+ (id)colorDocument:(id)arg1 orientation:(long long)arg2 filterName:(id)arg3 filterAmount:(float)arg4 filterKey:(id)arg5;
+ (id)convertImageToGrayScale:(id)arg1;
+ (id)filteredImage:(id)arg1 imageFilterType:(short)arg2;
+ (id)filteredImage:(id)arg1 imageFilterType:(short)arg2 constantColor:(bool)arg3;
+ (id)filteredImage:(id)arg1 orientation:(long long)arg2 imageFilterType:(short)arg3;
+ (id)filteredImage:(id)arg1 orientation:(long long)arg2 imageFilterType:(short)arg3 constantColor:(bool)arg4;
