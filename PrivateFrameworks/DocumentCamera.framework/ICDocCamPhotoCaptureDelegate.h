...
@interface ICDocCamPhotoCaptureDelegate : NSObject <AVCapturePhotoCaptureDelegate> {
    ...
    bool  _constantColorDeliveredFallBackPhoto;
    bool  _constantColorDeliveredOriginalPhoto;
...
@property (nonatomic) bool constantColorDeliveredFallBackPhoto;
@property (nonatomic) bool constantColorDeliveredOriginalPhoto;
...
- (void)setConstantColorDeliveredFallBackPhoto:(bool)arg1;
- (void)setConstantColorDeliveredOriginalPhoto:(bool)arg1;
- (void)setHighestSharpness:(float)arg1;
- (void)setImageAttributes:(id)arg1;
