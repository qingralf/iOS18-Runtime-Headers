...
+ (id)instantiateRemoteDocumentBrowserViewControllerWithHostProxy:(id)arg1 configuration:(id)arg2 initialUIPBrowserState:(id)arg3 completionBlock:(id /* block */)arg4;
...
- (void)updateAppearance:(id)arg1 shouldFlushCA:(bool)arg2 requiresAck:(bool)arg3 completionBlock:(id /* block */)arg4;
