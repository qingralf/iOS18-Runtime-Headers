...
@interface UIDocumentBrowserAction : NSObject <NSCopying, NSSecureCoding> {
    ...
    bool  _requiresFullyFormedItems;
...
@property (nonatomic, copy) NSString *localizedCompactTitle;
...
@property (nonatomic) bool requiresFullyFormedItems;
...
- (void)setLocalizedCompactTitle:(id)arg1;
...
- (void)setRequiresFullyFormedItems:(bool)arg1;
