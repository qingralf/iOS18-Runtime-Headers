...
@interface UIDocumentBrowserTransitionController : NSObject <UIViewControllerAnimatedTransitioning> {
    ...
    bool  _shouldStopObservingProgress;
    UIView * _targetView;
...
@property bool shouldStopObservingProgress;
...
- (bool)isCoordinatingForURL:(id)arg1;
- (id)itemURL;
- (id)loadingProgress;
...
- (void)setShouldStopObservingProgress:(bool)arg1;
