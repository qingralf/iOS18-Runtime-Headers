...
- (void)extractEventWithSerializedDocument:(id)arg1 documentType:(long long)arg2 pid:(long long)arg3 completion:(id /* block */)arg4;
- (void)extractPersonalIDWithLines:(id)arg1 pid:(long long)arg2 completion:(id /* block */)arg3;
- (void)foundInEventResultWithSerializedDocument:(id)arg1 documentType:(long long)arg2 completion:(id /* block */)arg3;
- (long long)getExtractionCategoryFrom:(id)arg1;
