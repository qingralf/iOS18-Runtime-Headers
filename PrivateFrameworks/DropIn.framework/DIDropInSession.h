...
@interface DIDropInSession : NSObject <NSSecureCoding> {
    ...
    NSDate * _sessionStartTimeoutDate;
...
@property (nonatomic, readonly) NSDate *sessionStartTimeoutDate;
...
- (void)setSessionStartTimeoutDate:(id)arg1;
