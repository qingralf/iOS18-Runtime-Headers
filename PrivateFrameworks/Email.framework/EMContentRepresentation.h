...
@interface EMContentRepresentation : NSObject <EFPubliclyDescribable, EMMessageContentCachedMetadataDelegate, NSSecureCoding, _EMDistantContentRepresentation> {
    ...
    id /* block */  _requestOriginalContentMessagesInReplyToContentItemBlock;
...
@property (nonatomic, copy) id /* block */ requestOriginalContentMessagesInReplyToContentItemBlock;
...
- (id /* block */)requestOriginalContentMessagesInReplyToContentItemBlock;
- (void)requestOriginalContentMessagesInReplyToContentItemWithCompletion:(id /* block */)arg1;
- (id)requestedHeaders;
- (id)searchableItem;
...
- (void)setRequestOriginalContentMessagesInReplyToContentItemBlock:(id /* block */)arg1;
