...
- (void)recordFrecencyEventWithMailboxIDs:(id)arg1;
- (void)recordFrecencyEventWithMailboxURLString:(id)arg1;
- (void)recordFrecencyEventWithMailboxesOfMessage:(id)arg1;
...
- (id)mui_inboxExternalURLsFromMailboxes:(id)arg1;
