...
@interface EMMessageRepository : EMRepository <EFFutureDelegate, EFLoggable, EMInMemoryThreadQueryHandlerStorable> {
...
- (void).cxx_destruct;
- (void)_addPrecachedItems:(id)arg1;
...
- (void)_broadcastMessageListItemChangesToObservers:(id /* block */)arg1 forObjectIDs:(id)arg2;
...
- (id)_localInMemoryMessageListItemsForObjectIDs:(id)arg1 observationIdentifier:(id)arg2;
- (id)_localInMemoryMessageObjectIDsForObjectIDs:(id)arg1;
...
- (id)_threadCollectionForIdentifier:(id)arg1 threadScope:(id)arg2;
- (void)_unsubscribeTypeDidChangeForUnsubscribeChangeAction:(id)arg1;
...
- (id)_updateToMessageObjectIDsIfNeeded:(id)arg1;
- (void)_vipsDidChange:(id)arg1;
- (void)addQueryHandler:(id)arg1;
...
- (id)messagesInConversationIDs:(id)arg1 limit:(long long)arg2 observationIdentifier:(id)arg3;
...
- (void)removeQueryHandler:(id)arg1;
- (void)requestAttachmentURLsForMessageIDs:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)requestSummaryForObjectIDs:(id)arg1;
