...
- (id)initWithQuery:(id)arg1 origin:(long long)arg2 actor:(long long)arg3 specialDestinationMailboxType:(long long)arg4 flagChange:(id)arg5 copyMessages:(bool)arg6;
