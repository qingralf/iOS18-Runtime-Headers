...
+ (unsigned long long)_fastPrefixLengthForSubject:(id)arg1 includingPrefix:(long long)arg2;
+ (unsigned long long)_lastPrefixDelimiterLocationForSubject:(id)arg1;
+ (unsigned long long)_prefixLengthForSubject:(id)arg1 forPrefix:(long long)arg2;
+ (unsigned long long)prefixLengthForSubject:(id)arg1;
+ (unsigned long long)prefixLengthForSubject:(id)arg1 includingPrefix:(long long)arg2;
+ (bool)subjectHasForwardPrefix:(id)arg1;
