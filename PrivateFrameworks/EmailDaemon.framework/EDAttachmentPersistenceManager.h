...
@interface EDAttachmentPersistenceManager : NSObject <EDMessageChangeHookResponder, EFLoggable> {
    ...
    <EFScheduler> * _synapseAttributesScheduler;
...
- (void).cxx_destruct;
- (id)addSynapseAttributesToAttachmentWithURL:(id)arg1 contentType:(id)arg2 usingGenerator:(id /* block */)arg3;
...
- (id)attachmentURLForMessageAttachmentID:(id)arg1 basePath:(id)arg2;
- (id)attachmentURLsForGlobalMessageIDs:(id)arg1;
