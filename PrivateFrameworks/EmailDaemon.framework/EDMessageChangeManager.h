...
@property (nonatomic) EDMessageAuthenticator *messageAuthenticator;
@property (nonatomic) EDMessageCategorizer *messageCategorizer;
...
- (id)_applyReadLaterDate:(id)arg1 displayDate:(id)arg2 toMessages:(id)arg3 changeIsRemote:(bool)arg4;
...
- (id)applyReadLaterDate:(id)arg1 displayDate:(id)arg2 toMessages:(id)arg3;
...
- (id)hookResponder;
- (id)init;
- (id)initWithDatabase:(id)arg1 localActionPersistence:(id)arg2 messagePersistence:(id)arg3 serverMessagePersistenceFactory:(id)arg4 readLaterPersistence:(id)arg5 categoryPersistence:(id)arg6 bimiManager:(id)arg7 hookResponder:(id)arg8 hookRegistry:(id)arg9;
...
- (void)setMessageAuthenticator:(id)arg1;
- (void)setMessageCategorizer:(id)arg1;
