...
@interface EDMessageQueryParser : NSObject {
    ...
    <EFSQLValueExpressable> * _additionalSQLClauseForGlobalMessageCountQuery;
...
@property (nonatomic, readonly) <EFSQLValueExpressable> *additionalSQLClauseForGlobalMessageCountQuery;
...
- (id)additionalSQLClauseForGlobalMessageCountQuery;
...
- (id)sqlCountQueryByMailboxForQuery:(id)arg1;
