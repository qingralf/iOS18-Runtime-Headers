...
- (void).cxx_destruct;
- (id)_transformBaseMessage:(id)arg1 messageObjectID:(id)arg2 duplicateInfo:(id)arg3 additionalBuilder:(id /* block */)arg4;
- (id)_transformPersistedMessage:(id)arg1 mailboxScope:(id)arg2 duplicateInfo:(id)arg3 additionalBuilder:(id /* block */)arg4;
