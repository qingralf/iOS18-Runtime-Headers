...
@property (nonatomic, readonly) EDBusinessCloudStorage *businessCloudStorage;
...
@property (nonatomic, readonly) EDSearchableIndexDiagnosticsController *diagnosticsController;
