...
@interface EDPrecomputedThreadQueryHandler : EDMessageRepositoryQueryHandler <EDBusinessChangeHookResponder, EDMessageChangeHookResponder, EDRemindMeNotificationControllerObserver, EDThreadChangeHookResponder, EFLoggable, EMCollectionItemIDStateCapturerDelegate> {
