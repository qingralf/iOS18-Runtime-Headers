...
- (bool)_addThreadScopeToDatabase:(id)arg1 withMailboxDatabaseID:(long long)arg2 filterPredicate:(unsigned long long)arg3 needsUpdate:(bool)arg4 lastViewedDate:(id)arg5 updateThreadScopeManager:(bool)arg6 connection:(id)arg7;
- (bool)_addThreadScopeToDatabaseWithMailboxType:(id)arg1 filterPredicate:(unsigned long long)arg2 needsUpdate:(bool)arg3 lastViewedDate:(id)arg4 connection:(id)arg5;
...
- (id)_expressionForCategoryType:(unsigned long long)arg1;
- (id)_expressionForPredicateForPrimaryMessages;
- (id)_expressionForThreadScope:(id)arg1;
- (id)_expressionFromSelect:(id)arg1 equalTo:(id)arg2;
...
- (id)_mailboxScopeForThreadScope:(id)arg1 andFilterPredicate:(unsigned long long*)arg2;
...
- (void)_persistenceDidUpdateMessages:(id)arg1 forFilterPredicate:(unsigned long long)arg2 changedKeyPaths:(id)arg3 predicateToIgnore:(id)arg4 loggingString:(id)arg5 generationWindow:(id)arg6 messageTest:(id /* block */)arg7;
- (void)_persistenceDidUpdateReadLaterForMessages:(id)arg1 generationWindow:(id)arg2;
...
- (bool)_recalculateNewestMessageForThreadObjectID:(id)arg1 threadScopeDatabaseID:(long long)arg2;
...
- (id)_selectFromMessageGlobalDataColumn:(id)arg1;
...
- (id)_updateForThreadsWithThreadScopeDatabaseID:(long long)arg1 conversation:(long long)arg2;
...
- (id)beginMigratingThreadScope:(id)arg1;
...
- (id)hookRegistry;
- (id)initWithMessagePersistence:(id)arg1 categoryPersistence:(id)arg2 database:(id)arg3 hookRegistry:(id)arg4 vipManager:(id)arg5 blockedSenderManager:(id)arg6;
- (id)messagePersistence;
- (id)newestMessageItemIDForThreadWithObjectID:(id)arg1;
...
- (unsigned long long)persistenceStateForThreadScope:(id)arg1 wantsPrecomputed:(bool)arg2;
