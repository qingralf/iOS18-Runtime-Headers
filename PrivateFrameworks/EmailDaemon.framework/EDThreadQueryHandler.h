...
@interface EDThreadQueryHandler : NSObject <EDThreadChangeHookResponder, EDThreadMigratorDelegate, EDThreadQueryHandler, EFLoggable, EMMessageListItemQueryResultsObserver> {
    ...
    <EMMessageQueryHelperObserver_xpc> * _helperObserver;
...
@property (nonatomic, readonly) <EMMessageQueryHelperObserver_xpc> *helperObserver;
...
- (id)initWithQuery:(id)arg1 messagePersistence:(id)arg2 threadPersistence:(id)arg3 hookRegistry:(id)arg4 vipManager:(id)arg5 searchProvider:(id)arg6 remindMeNotificationController:(id)arg7 observer:(id)arg8 observationIdentifier:(id)arg9 helperObserver:(id)arg10 delegate:(id)arg11 observationResumer:(id)arg12;
- (bool)isStarted;
