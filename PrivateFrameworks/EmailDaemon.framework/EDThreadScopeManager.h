...
- (unsigned long long)_findPredicateTypeWithCompoundPredicate:(id)arg1 mailboxTypeResolver:(id)arg2 outMailboxScope:(id*)arg3;
- (void)_initializeThreadScopesIfNeeded;
- (bool)_isBlackPearlPredicate:(id*)arg1;
...
- (id)_precomputedMailboxScopeForFilterPredicate:(id)arg1 mailboxTypeResolver:(id)arg2 foundPredicates:(unsigned long long*)arg3;
...
- (id)precomputedMailboxScopeForThreadScope:(id)arg1 mailboxTypeResolver:(id)arg2 foundPredicates:(unsigned long long*)arg3;
