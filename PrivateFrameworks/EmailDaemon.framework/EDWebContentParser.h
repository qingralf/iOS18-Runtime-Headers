...
- (id)_extractOneTimeCodeFromHTMLString:(id)arg1 orWithData:(id)arg2 characterEncodingName:(id)arg3 withSubject:(id)arg4;
- (id)_extractPlainTextFromHTMLString:(id)arg1 orWithData:(id)arg2 characterEncodingName:(id)arg3;
- (id)_getDataDetectionCategoryString:(int)arg1;
- (id)_parseHTMLString:(id)arg1 orWithData:(id)arg2 characterEncodingName:(id)arg3 withOptions:(unsigned long long)arg4 messageID:(id)arg5;
...
- (void)parseHTMLData:(id)arg1 characterEncodingName:(id)arg2 withOptions:(unsigned long long)arg3 forMessage:(id)arg4 withSubject:(id)arg5 completionHandler:(id /* block */)arg6;
- (void)parseHTMLString:(id)arg1 withOptions:(unsigned long long)arg2 forMessage:(id)arg3 withSubject:(id)arg4 completionHandler:(id /* block */)arg5;
