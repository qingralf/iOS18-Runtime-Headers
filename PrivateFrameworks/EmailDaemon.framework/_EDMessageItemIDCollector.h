...
- (void).cxx_destruct;
- (id)collectItemIDsWithQuery:(id)arg1 messagePersistence:(id)arg2 hookRegistry:(id)arg3 remindMeNotificationController:(id)arg4 searchProvider:(id)arg5 errorString:(id*)arg6;
- (id)init;
