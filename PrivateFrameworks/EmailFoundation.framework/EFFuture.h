...
@interface EFFuture : NSObject <EFFuture, EFPromisePrivate> {
    NSMutableArray * _completionBlocks;
    <EFFutureDelegate> * _delegate;
    NSError * _error;
    id  _result;
...
@property <EFFutureDelegate> *delegate;
@property (readonly, copy) NSString *description;
@property (readonly) id /* block */ errorOnlyCompletionHandlerAdapter;
@property (getter=isFinished, readonly) bool finished;
@property (readonly) <EFObserver> *firstResultObserverAdapter;
@property (readonly) unsigned long long hash;
@property (nonatomic, readonly) id result;
@property (nonatomic, readonly) id resultIfAvailable;
@property (readonly) <EFObserver> *resultsObserverAdapter;
