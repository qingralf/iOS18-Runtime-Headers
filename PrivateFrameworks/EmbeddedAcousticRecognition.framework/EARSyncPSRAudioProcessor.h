...
- (id)delegate;
- (void)endAudio;
- (unsigned long long)getAccmulatedProcessingTime;
...
- (id)initWithConfigFile:(id)arg1 configRoot:(id)arg2 sampleRate:(unsigned long long)arg3 delegate:(id)arg4 queue:(id)arg5 maxBufferSizeSeconds:(long long)arg6 memoryLock:(bool)arg7 outputLastRowOnly:(bool)arg8;
- (id)initWithConfigFile:(id)arg1 configRoot:(id)arg2 sampleRate:(unsigned long long)arg3 delegate:(id)arg4 queue:(id)arg5 outputLastRowOnly:(bool)arg6;
- (id)queue;
