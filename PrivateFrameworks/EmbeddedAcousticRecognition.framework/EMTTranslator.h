...
@interface EMTTranslator : NSObject {
    ...
    bool  _useGlobalTranslationQueue;
}
...
- (id)initWithModelURL:(id)arg1 task:(id)arg2 skipNonFinalToCatchup:(bool)arg3 translatorCacheSize:(long long)arg4 useGlobalTranslationQueue:(bool)arg5;
...
- (id)initWithModelURLs:(id)arg1 task:(id)arg2 skipNonFinalToCatchup:(bool)arg3 translatorCacheSize:(long long)arg4 useGlobalTranslationQueue:(bool)arg5;
- (bool)isCompileRequiredFrom:(id)arg1 to:(id)arg2;
