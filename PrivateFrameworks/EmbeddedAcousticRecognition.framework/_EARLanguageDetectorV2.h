...
@interface _EARLanguageDetectorV2 : NSObject {
    ...
    <_EARLanguageDetectorV2Delegate> * _lidDelegate;
...
@property (nonatomic) <_EARLanguageDetectorV2Delegate> *lidDelegate;
...
- (void)dealloc;
- (id)earLIDScores:(void*)arg1;
- (id)initWithConfigFile:(id)arg1;
- (id)languageDetectorV2Result:(id)arg1;
- (id)lidDelegate;
- (void)setLidDelegate:(id)arg1;
- (bool)shouldReportResults:(unsigned long long)arg1 reportingFrequency:(BOOL)arg2;
- (id)startRequestWithSamplingRate:(unsigned long long)arg1 context:(id)arg2 delegate:(id)arg3;
- (id)startRequestWithSamplingRate:(unsigned long long)arg1 requestOptions:(id)arg2 delegate:(id)arg3;
- (id)supportedLocales;
