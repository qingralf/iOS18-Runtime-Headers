...
@interface _EARSpeechRecognizer : NSObject {
    ...
    bool  _disableContextualBiasing;
...
@property (nonatomic) bool atypicalSpeech;
...
@property (nonatomic) bool disableContextualBiasing;
...
@property (nonatomic, readonly) bool isLegacyVoiceCommandRequest;
...
@property (nonatomic, copy) _EARRelevantTextContext *relevantTextContext;
...
+ (bool)ConvertCXXExceptionToNSError:(id /* block */)arg1 error:(id*)arg2;
+ (void)ConvertCXXExceptionToNSException:(id /* block */)arg1;
+ (long long)EARErrorCodeForExceptionMessage:(id)arg1;
+ (id)EARErrorWithCode:(long long)arg1 localizedDescription:(id)arg2;
+ (void)EARSetError:(id*)arg1 error:(id)arg2;
+ (bool)compileRecognizerModels2WithConfiguration:(id)arg1 error:(id*)arg2;
...
- (struct shared_ptr<quasar::corrective_reranking::Parser> { struct Parser {} *x1; struct __shared_weak_count {} *x2; })getParser;
...
- (void)setAtypicalSpeech:(bool)arg1;
...
- (void)setDisableContextualBiasing:(bool)arg1;
...
- (void)setRelevantTextContext:(id)arg1;
...
- (void)updateVoiceCommandContextWithPrefixText:(id)arg1 postfixText:(id)arg2 selectedText:(id)arg3 disambiguationActive:(id)arg4 cursorInVisibleText:(id)arg5 favorCommandSuppression:(id)arg6 abortCommandSuppression:(id)arg7;
