...
- (void)resetWithSamplingRate:(unsigned int)arg1 language:(id)arg2 taskType:(id)arg3 userId:(id)arg4 sessionId:(id)arg5 deviceId:(id)arg6 farField:(bool)arg7 atypicalSpeech:(bool)arg8 maxAudioBufferSizeSeconds:(unsigned int)arg9;
