...
@interface Backwarp : NSObject {
    <MTLComputePipelineState> * _backwarpInterleavedKernel;
    <MTLComputePipelineState> * _backwarpInterleavedWithInterleavedFlowOutputKernel;
    ...
    <MTLComputePipelineState> * _flowReshuffleTo2CKernel;
    <MTLComputePipelineState> * _flowSplattingWarpKernel;
    <MTLComputePipelineState> * _flowUpscale2CTo1CKernel;
    <MTLComputePipelineState> * _flowUpscale2CTo2CKernel;
    <MTLComputePipelineState> * _flowUpscaleKernel;
    bool  _interleaved;
    <MTLLibrary> * _mtlLibrary;
    <MTLComputePipelineState> * _padTexture2CTO1CKernel;
...
- (void)copyTextureWithPaddingSource:(id)arg1 destination:(id)arg2 callback:(id /* block */)arg3;
- (void)dealloc;
...
- (void)encodeUpscaleFlowToCommandBuffer:(id)arg1 source:(id)arg2 destination:(id)arg3 scaleFactor:(float)arg4 rotation:(bool)arg5;
...
- (void)upscaleFlow:(id)arg1 destination:(id)arg2 callback:(id /* block */)arg3;
