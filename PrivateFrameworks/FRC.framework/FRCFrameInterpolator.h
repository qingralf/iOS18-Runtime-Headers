...
@interface FRCFrameInterpolator : NSObject {
    ...
    long long  _opticalFlowRevision;
    ...
    bool  _twoLayerSynthesis;
    bool  _twoLayerSynthesisQuarterSizeDC;
    bool  _twoStageFlow;
    long long  _usage;
...
@property (nonatomic, retain) id synthesis;
...
- (bool)checkFrameFormatConsistencyFirstFrame:(id)arg1 secondFrame:(id)arg2 outputFrames:(id)arg3;
- (bool)checkStreamingBufferConsistencyFirstFrame:(id)arg1 secondFrame:(id)arg2;
...
- (bool)interpolateBetweenFirstFrame:(id)arg1 secondFrame:(id)arg2 timeScales:(id)arg3 outputFrames:(id)arg4 withError:(id*)arg5;
...
- (void)setLegacyNormalizationMode:(bool)arg1;
...
- (void)setOpticalFlowRevision:(long long)arg1;
...
- (void)setTwoLayerSynthesis:(bool)arg1;
- (void)setTwoLayerSynthesisQuarterSizeDC:(bool)arg1;
