...
@interface Forwarp : FRCMetalBase {
    ...
    <MTLComputePipelineState> * _blendWarpedImagesWithMaskAndFlowConsistency;
    ...
    <MTLComputePipelineState> * _warpAndBlendTextures;
    <MTLComputePipelineState> * _warpAndBlendTexturesWithConsistency;
}
...
- (void)encodeBlendWarpedFeaturesWithErrorMaskToCommandBuffer:(id)arg1 first:(id)arg2 second:(id)arg3 forwardErrorMap:(id)arg4 backwardErrorMap:(id)arg5 forwarpConsistency:(id)arg6 backwardConsistency:(id)arg7 timeScale:(float)arg8 destination:(id)arg9;
...
- (void)encodeWarpAndBlendFeaturesWithErrorMaskToCommandBuffer:(id)arg1 first:(id)arg2 second:(id)arg3 forwardFlow:(id)arg4 backwardFlow:(id)arg5 forwardErrorMap:(id)arg6 backwardErrorMap:(id)arg7 forwarpConsistency:(id)arg8 backwardConsistency:(id)arg9 timeScale:(float)arg10 destination:(id)arg11;
- (float)errorTolerance;
- (bool)filterErrorMapByGaussian;
- (id)initWithDevice:(id)arg1 commmandQueue:(id)arg2 mode:(unsigned long long)arg3;
