...
@property (nonatomic) int flowLevel; /* unknown property attribute: ? */
...
@property (nonatomic) unsigned long long synthesisMode; /* unknown property attribute: ? */
@property (nonatomic) bool temporalFiltering;
@property (nonatomic) bool textureFromCVPixelBuffer;
@property (nonatomic) bool twoLayerFlowSplatting; /* unknown property attribute: ? */
@property (nonatomic) bool twoLayerQuarterSizeDC; /* unknown property attribute: ? */
@property (nonatomic) long long usage;
@property (nonatomic) bool useFlowConsistencyMap; /* unknown property attribute: ? */
