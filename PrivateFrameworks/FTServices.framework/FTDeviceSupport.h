...
@property (nonatomic, readonly) bool supportsEmojiImages;
...
@property (nonatomic, readonly) bool supportsManateeActivitySharing;
...
@property (nonatomic, readonly) bool supportsStewie;
...
- (bool)supportsStewie;
- (void)supportsStewieWithCompletion:(id /* block */)arg1;
