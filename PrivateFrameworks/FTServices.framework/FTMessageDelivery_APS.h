...
- (void).cxx_destruct;
- (void)_apsMessageBodyForMessage:(id)arg1 completion:(id /* block */)arg2;
- (void)_apsMessageForMessage:(id)arg1 body:(id)arg2 completion:(id /* block */)arg3;
...
- (id)_requiredTopicsWithUltraConstrainedTopics:(id*)arg1;
...
- (void)_setMapForMessage:(id)arg1 apsMessage:(id)arg2 messageBody:(id)arg3 timeoutTime:(double)arg4 timeoutSelector:(SEL)arg5 handlerBlock:(id /* block */)arg6 retries:(id)arg7;
