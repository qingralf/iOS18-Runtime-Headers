...
- (id)initWithIDSServerBag:(id)arg1 apsConnection:(id)arg2;
- (id)initWithIDSServerBag:(id)arg1 iMessageServerBag:(id)arg2 remoteConnectionFactory:(id)arg3 mobileNetworkManager:(id)arg4 apsConnection:(id)arg5 retryBackoffProvider:(id /* block */)arg6 timeoutBackoffProvider:(id /* block */)arg7;
- (id)initWithIDSServerBag:(id)arg1 iMessageServerBag:(id)arg2 remoteConnectionFactory:(id)arg3 mobileNetworkManager:(id)arg4 retryBackoffProvider:(id /* block */)arg5 timeoutBackoffProvider:(id /* block */)arg6;
- (void)invalidate;
- (void)networkStateChanged;
- (void)queue:(id)arg1 hitTimeoutForMessage:(id)arg2;
- (bool)sendMessage:(id)arg1;
- (bool)sendMessageAtTopOfTheQueue:(id)arg1;
- (bool)shouldFailFastForMessage:(id)arg1;
