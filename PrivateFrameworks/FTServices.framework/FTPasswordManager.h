...
- (id)_findAccountOfType:(id)arg1 InStore:(id)arg2 withCriteria:(id /* block */)arg3;
- (id)_findGameCenterAccountInStore:(id)arg1 withCriteria:(id /* block */)arg2;
...
- (id)_gameCenterAccountWithUsername:(id)arg1;
...
- (void)cleanUpAccountsBasedOnInUseUsernamesBlock:(id /* block */)arg1 profileIDBlock:(id /* block */)arg2 completionBlock:(id /* block */)arg3;
...
- (id)gameCenterPropertiesFromAccountWithUsername:(id)arg1;
- (id)init;
...
- (void)requestAuthTokenForProfileID:(id)arg1 username:(id)arg2 service:(id)arg3 badPassword:(bool)arg4 showForgotPassword:(bool)arg5 forceRenewal:(bool)arg6 failIfNotSilent:(bool)arg7 outRequestID:(id*)arg8 completionBlock:(id /* block */)arg9;
