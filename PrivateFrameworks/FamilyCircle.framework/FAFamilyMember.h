...
@property (nonatomic, readonly, copy) NSArray *appleIDAliases;
...
@property (nonatomic, readonly, copy) NSString *inviteType;
...
@property (nonatomic, readonly) bool purchaseSharingEnabled;
