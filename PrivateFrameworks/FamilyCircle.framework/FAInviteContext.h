...
@property (nonatomic, readonly) unsigned long long maxFamilySuggestions;
...
@property (nonatomic, copy) NSString *messageBubbleInviteDeclineAlertSheetMessage;
@property (nonatomic, copy) NSString *messageBubbleInviteDeclineAlertSheetTitle;
...
- (unsigned long long)maxFamilySuggestions;
...
- (id)messageBubbleInviteDeclineAlertSheetMessage;
- (id)messageBubbleInviteDeclineAlertSheetTitle;
...
- (void)setMessageBubbleInviteDeclineAlertSheetMessage:(id)arg1;
- (void)setMessageBubbleInviteDeclineAlertSheetTitle:(id)arg1;
