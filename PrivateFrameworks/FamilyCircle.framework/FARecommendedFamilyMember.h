...
- (id)initWithDisplayName:(id)arg1 handle:(id)arg2 iMessageHandle:(id)arg3 contact:(id)arg4;
- (id)initWithMegadomeRecommendation:(id)arg1;
- (id)initWithPeopleSuggesterRecommendation:(id)arg1;
