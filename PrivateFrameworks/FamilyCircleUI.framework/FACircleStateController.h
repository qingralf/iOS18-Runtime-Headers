...
@interface FACircleStateController : NSObject <FACirclePresenterDelegate, FARemoteViewControllerDelegate> {
    FACirclePresenter * _circlePresenter;
...
@property (nonatomic, retain) FACirclePresenter *circlePresenter;
@property (nonatomic, copy) id /* block */ circlePresenterFactory;
...
@property (nonatomic, retain) FARequestConfigurator *requestConfigurator;
...
- (id /* block */)circlePresenterFactory;
- (id /* block */)completion;
- (id)customRUIStyle;
- (void)dealloc;
- (id)init;
...
- (void)setCirclePresenter:(id)arg1;
- (void)setCirclePresenterFactory:(id /* block */)arg1;
...
- (void)setRequestConfigurator:(id)arg1;
