...
@interface FALaunchScreenTimeSetupHook : NSObject <RUIServerHook> {
    ...
    <FAFamilyCircleFetcherProtocol> * _familyFetcher;
    bool  _isChildDevice;
...
@property (nonatomic, retain) <FAFamilyCircleFetcherProtocol> *familyFetcher;
...
- (void)_launchScreenTimeSetupAndRefreshFamilyIfNeededForDSID:(id)arg1 inObjectModel:(id)arg2 withCompletion:(id /* block */)arg3;
- (void)_launchScreenTimeSetupForUser:(id)arg1 inObjectModel:(id)arg2 withCompletion:(id /* block */)arg3;
- (void)_refreshFamilyCircleIfNeededForMemberDSID:(id)arg1 completionHandler:(id /* block */)arg2;
- (id)accountStore;
- (id)childSetupControllerProvider;
- (id /* block */)completionAction;
- (id)delegate;
- (id)ephemeralAuthResults;
- (id)extractDSIDFromObjectModel:(id)arg1;
- (id)familyFetcher;
- (id)init;
- (id)initWithAccountStore:(id)arg1 screenTimeRequestProvider:(id)arg2 childSetupControllerProvider:(id)arg3 familyFetcher:(id)arg4;
- (bool)isChildDevice;
