...
@interface FASettingsSpecifierProvider : NSObject <AAUISpecifierProvider, FASetupDelegate, FamilyCircleUI.FAFamilySettingsViewControllerV2Delegate, RemoteUIControllerDelegate> {
...
- (id)_grandSlamSigner;
- (void)_handleFamilyChanged:(id)arg1;
- (void)_handleFamilyDetailsResponse:(id)arg1 error:(id)arg2 completion:(id /* block */)arg3;
...
- (void)_handleShowFamilySettingsV2WithResourceDictionary:(id)arg1;
...
- (void)_presentFlowWithEventType:(id)arg1 completion:(id /* block */)arg2;
...
- (void)dealloc;
- (id)delegate;
- (void)familySettingsViewController2StopFamilySharing:(id)arg1;
...
- (void)presentFamilySettingsFromPresenter:(id)arg1;
...
- (bool)shouldUseModernNavigationForPresenter:(id)arg1;
- (id)specifiers;
