...
- (id)initWithTableView:(id)arg1 ruiTableView:(id)arg2 pictureStore:(id)arg3 recommendations:(id)arg4 proactiveModelUsed:(long long)arg5 emergencyContacts:(id)arg6 context:(id)arg7 viewController:(id)arg8 suggester:(id)arg9 objectModel:(id)arg10;
