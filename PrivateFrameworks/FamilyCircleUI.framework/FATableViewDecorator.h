...
@interface FATableViewDecorator : NSObject <FATableViewProtocol, UITableViewDataSource, UITableViewDelegate> {
    <UITableViewDataSource> * _dataSource;
    <UITableViewDelegate> * _delegate;
    <FATableViewProtocol> * _tableView;
}
...
@property (nonatomic, retain) <FATableViewProtocol> *tableView;
