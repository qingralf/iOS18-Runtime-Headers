...
@interface FFConfiguration : NSObject {
    <FFBuildVersionGetter> * _buildVersionGetter;
...
@property (nonatomic, retain) <FFBuildVersionGetter> *buildVersionGetter;
...
+ (id)_configurationForTestingWithFileReader:(id)arg1 fileWriter:(id)arg2 buildVersionGetter:(id)arg3 parseErrorReporter:(id)arg4 safeModeChecker:(id)arg5;
...
+ (id)configurationForTestingWithFileReader:(id)arg1 fileWriter:(id)arg2 buildVersionGetter:(id)arg3;
...
- (void)disableFeature:(id)arg1 domain:(id)arg2 level:(long long)arg3 transient:(bool)arg4;
- (void)disableFeature:(id)arg1 domain:(id)arg2 levelIndex:(unsigned long long)arg3;
- (void)disableFeature:(id)arg1 domain:(id)arg2 levelIndex:(unsigned long long)arg3 transient:(bool)arg4;
...
- (void)enableFeature:(id)arg1 domain:(id)arg2 level:(long long)arg3 transient:(bool)arg4;
- (void)enableFeature:(id)arg1 domain:(id)arg2 levelIndex:(unsigned long long)arg3;
- (void)enableFeature:(id)arg1 domain:(id)arg2 levelIndex:(unsigned long long)arg3 transient:(bool)arg4;
...
- (id)safemodechecker;
- (void)setBuildVersionGetter:(id)arg1;
...
- (void)setValue:(long long)arg1 feature:(id)arg2 domain:(id)arg3 levelIndex:(unsigned long long)arg4 buildVersion:(id)arg5;
...
- (id)ams_safeStateForFeature:(id)arg1 domain:(id)arg2;
- (id)ams_safeStateForFeature:(id)arg1 domain:(id)arg2 level:(long long)arg3;
