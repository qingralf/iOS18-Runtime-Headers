...
- (id)initWithDomain:(id)arg1 feature:(id)arg2 value:(long long)arg3 buildVersion:(id)arg4;
...
- (id)initWithDomain:(id)arg1 feature:(id)arg2 value:(long long)arg3 phase:(id)arg4 disclosureRequired:(id)arg5 attributes:(id)arg6 buildVersion:(id)arg7;
- (id)phase;
