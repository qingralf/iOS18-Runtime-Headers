...
@property (nonatomic, retain) NSString *attachmentsSectionTitleFromBugForm;
...
- (id)attachmentsSectionTitleFromBugForm;
...
- (id)questionChoiceForSectionIdentifier:(id)arg1 itemIdentifier:(id)arg2;
- (id)questionForVisibleChoice:(id)arg1 sectionIdentifier:(id)arg2;
...
- (void)setAttachmentsSectionTitleFromBugForm:(id)arg1;
