...
@property (readonly) NSHTTPCookie *seedPortalSession; /* unknown property attribute: ? */
...
- (bool)_shouldSimulateInvalidSessionWithRequestAndHalt:(id)arg1 successHandler:(id /* block */)arg2 errorHandler:(id /* block */)arg3;
