...
- (void).cxx_destruct;
- (id)FBKData;
- (void)_completeAuthenticationWith:(id)arg1 credentialToken:(id)arg2 completion:(id /* block */)arg3;
...
- (void)interactiveStartupUsingAppleConnect:(id /* block */)arg1;
...
- (void)loginWithAppleConnectToken:(id)arg1 completion:(id /* block */)arg2;
