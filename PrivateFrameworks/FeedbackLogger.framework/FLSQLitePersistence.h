...
- (unsigned long long)currentBatchEventCount;
...
- (bool)deleteAllUploadsQueuedBefore:(id)arg1;
- (bool)deleteDatabase;
...
- (id)metadataForBatch:(id)arg1 bundleID:(id)arg2;
- (void)observeInsertionAtRow:(long long)arg1 observer:(id /* block */)arg2;
- (bool)open;
- (id)persist:(id)arg1;
- (id)persist:(id)arg1 preferredBatchSize:(unsigned long long)arg2;
...
- (void)setCurrentBatchEventCount:(unsigned long long)arg1;
...
- (bool)tryRolloverBatchIfNecessary:(unsigned long long)arg1 preferredBatchSize:(unsigned long long)arg2;
- (bool)updateSchema;
