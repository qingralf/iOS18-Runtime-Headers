...
@property (nonatomic, readonly, copy) NSError *errorReflectingDisconnectionState;
...
- (void)_checkDomainConnectionPermittedWithCompletionHandler:(id /* block */)arg1;
- (id)_fileReactorID;
...
- (void)_providedItemAtURL:(id)arg1 didGainPresenterWithInfo:(id)arg2;
...
- (void)_startObservingRootAndResumeIndexerWithReason:(id)arg1 userAllowedDBDrop:(bool)arg2 completion:(id /* block */)arg3;
- (void)_startWithReason:(id)arg1 userAllowedDBDrop:(bool)arg2 completion:(id /* block */)arg3;
...
- (void)callExtensionForItemDidChange:(id)arg1 request:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)cancelPendingCoordinations;
- (id)checkableURLs;
- (id)cleanupDomainWithMode:(unsigned long long)arg1;
- (id)coordinationRootURLs;
- (void)createRootAndObserveIfNeededWithReason:(id)arg1 userAllowedDBDrop:(bool)arg2 completion:(id /* block */)arg3;
...
- (id)errorReflectingDisconnectionState;
- (id)extensionBackend;
...
- (id)identifier;
- (id)indexer;
- (id)initWithIdentifier:(id)arg1 nsDomain:(id)arg2 extensionStorageURLs:(id)arg3 purposeIdentifier:(id)arg4 fpfsClass:(Class)arg5 provider:(id)arg6 volume:(id)arg7;
...
- (void)startWithReason:(id)arg1 userAllowedDBDrop:(bool)arg2 completion:(id /* block */)arg3;
- (bool)started;
- (id)startupError;
- (id)stateURL;
- (void)stopIndexer;
