...
@property (nonatomic, readonly) bool backgroundActivityIsPaused; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) long long errorGenerationCount; /* unknown property attribute: ? */
...
- (id)initWithDomain:(id)arg1 materializationError:(id)arg2;
- (void)invalidate;
...
- (void)launchFeedbackForDomain:(id)arg1 itemIdentifier:(id)arg2 triggeringError:(id)arg3 completionHandler:(id /* block */)arg4;
