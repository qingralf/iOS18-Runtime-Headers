...
- (void).cxx_destruct;
- (void)addPresenter:(id)arg1 itemID:(id)arg2 urlHint:(id)arg3 auditToken:(struct { unsigned int x1[8]; })arg4 promiseID:(unsigned long long)arg5;
- (void)forgetPromiseForPresenterWithID:(id)arg1 promiseID:(unsigned long long)arg2;
- (id)initWithExtensionManager:(id)arg1;
- (id)presenterWithID:(id)arg1;
- (id)presenters;
