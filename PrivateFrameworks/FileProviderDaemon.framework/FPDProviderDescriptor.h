...
@interface FPDProviderDescriptor : NSObject <NSSecureCoding> {
    ...
    bool  _managedPersona;
    NSNumber * _metadataOnlyUploadPipelineDepth;
...
@property (nonatomic, retain) NSNumber *metadataOnlyUploadPipelineDepth;
...
+ (id)personaFromExtensionRecord:(id)arg1 managedPersona:(bool*)arg2;
...
- (id)localizedName;
- (bool)managedPersona;
- (id)metadataOnlyUploadPipelineDepth;
...
- (void)setDisallowedByMDM:(bool)arg1;
...
- (void)setManagedPersona:(bool)arg1;
- (void)setMetadataOnlyUploadPipelineDepth:(id)arg1;
