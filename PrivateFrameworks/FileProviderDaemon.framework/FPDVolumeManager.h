...
- (void).cxx_destruct;
- (id)createVolumeWithStatFS:(const struct statfs { unsigned int x1; int x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; struct fsid { int x_8_1_1[2]; } x8; unsigned int x9; unsigned int x10; unsigned int x11; unsigned int x12; BOOL x13[16]; BOOL x14[1024]; BOOL x15[1024]; unsigned int x16; unsigned int x17[7]; }*)arg1 role:(unsigned int)arg2;
...
- (id)getGenstoreVersionsRootURL:(id)arg1 volumeIgnoringOwnership:(bool)arg2;
- (id)init;
- (id)initWithServer:(id)arg1;
- (void)invalidateDevice:(int)arg1 reason:(id)arg2;
- (void)invalidateExternalVolumesAndStopMonitoring;
- (void)invalidateVolume:(id)arg1 reason:(id)arg2;
...
- (void)registerVersionsFileCoordinatorForVolume:(id)arg1 volumeIgnoringOwnership:(bool)arg2;
- (id)server;
