...
- (void)getTopTransactionCategoriesWithCountryCode:(id)arg1 timeWindow:(unsigned long long)arg2 minRegularTransactionRatio:(double)arg3 discretizedTimeOfDay:(unsigned long long)arg4 completion:(id /* block */)arg5;
- (void)getTopTransactionCategoriesWithTimeWindow:(unsigned long long)arg1 completion:(id /* block */)arg2;
- (id)init;
