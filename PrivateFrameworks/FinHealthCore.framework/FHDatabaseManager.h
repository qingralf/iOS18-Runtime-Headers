...
- (bool)_insertModelRecord:(id)arg1;
- (bool)_insertOrUpdateTransactionFeatures:(id)arg1 compoundFeatures:(id)arg2 transactionID:(id)arg3 financeTransactionID:(id)arg4;
...
- (void)_updateProcessingTimeForFeature:(id)arg1 processingDate:(unsigned long long)arg2 data:(id)arg3;
...
- (id)compoundFeaturesForTransaction:(id)arg1;
...
- (void)computeRecurringClassesWithMerchantCounts:(id)arg1 peerPaymentCounts:(id)arg2 merchantDetailedCategoryCounts:(id)arg3;
- (id)delegate;
...
- (bool)deleteBankConnectTransactionWithFinanceTransactionIdentifier:(id)arg1;
...
- (bool)deleteTransactionWithIdentifier:(id)arg1;
- (bool)deleteWithRollBack:(bool)arg1 SQL:(id)arg2 args:(char *)arg3;
- (bool)deleteWithSQL:(id)arg1;
- (bool)executeAsPreparedStatement:(id)arg1 values:(id)arg2;
...
- (id)getRecurringTransactionIdentifiersByClass:(unsigned long long)arg1;
- (id)getTaggedPastCalendarEvents;
- (id)getTransactionByFinanceTransactionIdentifier:(id)arg1;
...
- (bool)insertFeaturesGrouping:(id)arg1 realtimeFeatures:(id)arg2;
- (bool)insertFeaturesPredictedRealtime:(id)arg1 realtimeFeatures:(id)arg2;
- (bool)insertInstrumentationRecord:(id)arg1;
- (bool)insertOrUpdateBankConnectAccount:(id)arg1;
- (bool)insertReceiptData:(id)arg1 identifier:(id)arg2 title:(id)arg3 subtitle:(id)arg4 quantity:(unsigned long long)arg5 amount:(id)arg6 currencyCode:(id)arg7 adamIdentifier:(unsigned long long)arg8;
- (bool)insertTransactionInInternalStateDirty:(id)arg1;
- (long long)mostRecentTransactionDate;
- (void)populateMerchantRecurringClassHistograms:(id)arg1 transaction:(id)arg2;
- (void)populateRecurringClassHistogramsWithMerchantDetailedCategoryCounts:(id)arg1 histogram:(id)arg2 transaction:(id)arg3;
- (void)populateRecurringClassHistogramsWithPeerPaymentsCounts:(id)arg1 histogram:(id)arg2 transaction:(id)arg3;
- (void)predictAndPersistCashCardRecurringTransactions;
- (id)processingDataForFeature:(id)arg1;
...
- (bool)removeFinanceTransactionIdentifier:(id)arg1;
- (void)retrieveAll;
- (id)retrieveGroups;
...
- (int)streamTransactionsWithLimit:(unsigned long long)arg1 internalState:(unsigned long long)arg2 offSet:(unsigned long long)arg3 onTransaction:(id /* block */)arg4;
- (int)streamTransactionsWithLimit:(unsigned long long)arg1 internalState:(unsigned long long)arg2 onTransaction:(id /* block */)arg3;
- (bool)updateDeleteFlagInTransactionFeatures:(unsigned long long)arg1 forID:(id)arg2;
- (bool)updateFinanceTransactionIdentifier:(id)arg1;
...
- (void)updateProcessingTimeForFeature:(id)arg1 data:(id)arg2;
