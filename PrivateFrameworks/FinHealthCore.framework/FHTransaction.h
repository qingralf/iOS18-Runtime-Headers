...
@interface FHTransaction : NSObject <NSSecureCoding> {
    ...
    NSString * _associatedReceiptUniqueID;
    ...
    NSString * _financeTransactionIdentifier;
    bool  _hasLocation;
...
@property (nonatomic, copy) NSString *associatedReceiptUniqueID;
...
@property (nonatomic, copy) NSString *financeTransactionIdentifier;
...
- (id)financeTransactionIdentifier;
- (bool)hasLocation;
...
- (void)setAssociatedReceiptUniqueID:(id)arg1;
...
- (void)setFinanceTransactionIdentifier:(id)arg1;
