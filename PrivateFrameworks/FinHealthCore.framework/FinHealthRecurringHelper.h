...
+ (id)histogramKeysForCardPurchaseTransaction:(id)arg1 transactionAmount:(id)arg2 transactionType:(long long)arg3 amountFromDatabase:(long long)arg4 receiptIdentifier:(id)arg5;
+ (id)histogramKeysForMerchantDetailedCategoryTransaction:(id)arg1 transactionAmount:(id)arg2 transactionType:(long long)arg3 amountFromDatabase:(long long)arg4;
