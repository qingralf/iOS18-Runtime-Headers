...
@property (nonatomic, copy) NSDecimalNumber *spendingInsightAmount;
@property (nonatomic, copy) NSDecimalNumber *spendingInsightPercentageValue;
...
- (void)setSpendingInsightAmount:(id)arg1;
- (void)setSpendingInsightPercentageValue:(id)arg1;
- (void)setStartDate:(id)arg1;
- (void)setType:(id)arg1;
- (void)setWindow:(long long)arg1;
- (void)setWindowReference:(unsigned long long)arg1;
- (id)spendAmount;
- (id)spendingInsightAmount;
- (id)spendingInsightPercentageValue;
- (id)startDate;
- (id)type;
- (long long)window;
- (unsigned long long)windowReference;
