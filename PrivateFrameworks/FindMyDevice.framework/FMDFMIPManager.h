...
- (void)attemptUCRTHealing:(id)arg1 completion:(id /* block */)arg2;
...
- (void)deviceEligibleForRepairWithContext:(id)arg1 completion:(id /* block */)arg2;
- (void)didAddLocalFindableAccessory:(id)arg1 completion:(id /* block */)arg2;
- (void)didChangeFMIPAccountInfo:(id)arg1;
- (void)didReceiveLostModeExitAuthToken:(id)arg1;
- (void)didRemoveLocalFindableAccessory:(id)arg1 completion:(id /* block */)arg2;
...
- (void)disableLocationDisplayWithCompletion:(id /* block */)arg1;
...
- (void)enableRepairWithContext:(id)arg1 completion:(id /* block */)arg2;
...
- (void)requireDisableLocationWithCompletion:(id /* block */)arg1;
- (id)serialQueue;
