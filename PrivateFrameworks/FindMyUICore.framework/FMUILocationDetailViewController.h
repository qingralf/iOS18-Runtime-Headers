...
- (void)startObservingContacts:(id)arg1 fromCallerHandle:(id)arg2 groupName:(id)arg3;
- (void)startObservingHandles:(id)arg1 callerHandle:(id)arg2;
- (void)startObservingHandles:(id)arg1 callerHandle:(id)arg2 groupName:(id)arg3;
- (void)stopObserving;
