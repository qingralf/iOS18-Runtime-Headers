...
- (void)_firstAchievementMatchingLifetimeGoalsWithNames:(id)arg1 amongstAchievements:(id)arg2 experienceType:(unsigned long long)arg3 reachedMilestoneCompletion:(id /* block */)arg4;
- (id)dataSource;
