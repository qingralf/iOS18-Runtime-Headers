...
@interface FIUIHeartRateStatusView : UIView {
    ...
    UIImageView * _animationSuspendedMeasuringView;
...
@property (nonatomic, retain) UIImageView *animationSuspendedMeasuringView;
...
- (id)animationSuspendedMeasuringView;
- (bool)animationsSuspended;
- (id)fullHeartImageView;
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 heartFilledImageName:(id)arg2 heartSpriteImageName:(id)arg3 heartSuspendedSpriteImageName:(id)arg4 spriteFrameCount:(long long)arg5 spriteColumnCount:(long long)arg6 resourceBundle:(id)arg7;
...
- (void)setAnimationSuspendedMeasuringView:(id)arg1;
