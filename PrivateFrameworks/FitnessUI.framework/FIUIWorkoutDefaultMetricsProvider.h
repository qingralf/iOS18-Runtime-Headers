...
+ (void)initialize;
+ (long long)metricsVersionForWorkout:(id)arg1;
+ (bool)operatingSystemVersion:(struct { long long x1; long long x2; long long x3; })arg1 atLeastVersion:(struct { long long x1; long long x2; long long x3; })arg2;
...
- (id)_defaultMoonstoneIndoorEnabledMetricsForActivityType:(unsigned long long)arg1;
- (id)_defaultMoonstoneOutdoorEnabledMetricsForActivityType:(unsigned long long)arg1 supportsElevationMetrics:(bool)arg2;
...
- (void)_didUpdateBTSensorSeenStatus:(id)arg1;
...
- (id)_standardSupportedMetricsWithMetricsVersion:(long long)arg1;
