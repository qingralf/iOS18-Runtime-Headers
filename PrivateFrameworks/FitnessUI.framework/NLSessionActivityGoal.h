...
- (id)initWithGoalTypeIdentifier:(unsigned long long)arg1 value:(id)arg2 requiredDistance:(id)arg3;
- (bool)isEqual:(id)arg1;
- (bool)isEqualToNLSessionActivityGoal:(id)arg1;
- (id)requiredDistance;
- (void)setGoalTypeIdentifier:(unsigned long long)arg1;
- (void)setRequiredDistance:(id)arg1;
