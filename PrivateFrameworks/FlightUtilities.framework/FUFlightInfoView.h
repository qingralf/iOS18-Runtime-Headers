...
@property (nonatomic) <FUFlightInfoViewProtocol> *delegate;
...
@property (nonatomic) UIButton *flightButton;
@property (nonatomic) FULabel *labelAirlineName;
@property (nonatomic) FULabel *labelArrivalCity;
@property (nonatomic) FULabel *labelArrivalCode;
@property (nonatomic) FULabel *labelArrivalDate;
@property (nonatomic) FULabel *labelArrivalDelay;
@property (nonatomic) FULabel *labelArrivalInfo1;
@property (nonatomic) FULabel *labelArrivalInfo2;
@property (nonatomic) FULabel *labelArrivalTime;
@property (nonatomic) FULabel *labelArrivalTitle;
@property (nonatomic) FULabel *labelBaggageClaimTitle;
@property (nonatomic) FULabel *labelBaggageClaimValue;
@property (nonatomic) FULabel *labelDepartureCity;
@property (nonatomic) FULabel *labelDepartureCode;
@property (nonatomic) FULabel *labelDepartureDate;
@property (nonatomic) FULabel *labelDepartureDelay;
@property (nonatomic) FULabel *labelDepartureInfo1;
@property (nonatomic) FULabel *labelDepartureInfo2;
@property (nonatomic) FULabel *labelDepartureTime;
@property (nonatomic) FULabel *labelDepartureTitle;
@property (nonatomic) FULabel *labelDurationComplete;
@property (nonatomic) FULabel *labelDurationTitle;
@property (nonatomic) FULabel *labelDurationValue;
@property (nonatomic) FULabel *labelFlightCode;
@property (nonatomic) FULabel *labelStatus;
@property (nonatomic) FULabel *labelStatusTitle;
@property (nonatomic, retain) NSLayoutConstraint *leadingInset;
@property (nonatomic, readonly) FUFlightLeg *leg;
@property (nonatomic) FUSeparator *sep5;
@property (nonatomic) unsigned long long style;
@property (nonatomic, retain) NSLayoutConstraint *trailingInset;
@property (nonatomic, retain) NSLayoutConstraint *trailingSeparatorsInset;
