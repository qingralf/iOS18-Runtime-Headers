...
@interface _FEFocusGroup : NSObject {
    ...
    _FEFocusGroup * _parentGroup;
    <_FEFocusItem> * _primaryItem;
    struct CGRect { 
        struct CGPoint { 
            double x; 
            double y; 
...
@property (nonatomic, readonly) _FEFocusGroup *parentGroup;
@property (nonatomic, readonly) <_FEFocusItem> *primaryItem;
