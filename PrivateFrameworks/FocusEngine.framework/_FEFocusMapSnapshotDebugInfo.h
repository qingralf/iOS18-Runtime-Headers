...
@interface _FEFocusMapSnapshotDebugInfo : NSObject {
    ...
    _FEFocusMapSnapshot * _snapshot;
}

@property (nonatomic, readonly) _FEFocusMapSearchInfo *focusMapSearchInfo;
@property (nonatomic, readonly) UIImage *image;
@property (nonatomic, readonly) struct CGPoint { double x1; double x2; } imageAnchorPoint;
@property (nonatomic, readonly) _FEFocusMapSnapshot *snapshot;
