...
@property (nonatomic, readonly) UIGestureRecognizer *gestureRecognizerForExclusionRelationships; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) bool showsPersistentDetailText;
