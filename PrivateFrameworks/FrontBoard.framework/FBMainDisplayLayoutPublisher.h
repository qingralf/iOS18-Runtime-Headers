...
@interface FBMainDisplayLayoutPublisher : NSObject <BLSBacklightStateObserving, BLSHBacklightHostObserving, FBSDisplayLayoutPublisherObserving, FBSDisplayLayoutPublishing, FBSDisplayObserving> {
    <BSInvalidatable> * _backlightTransition;
...
- (void)_updateWithBacklightState:(long long)arg1;
