...
@interface FBScene : NSObject <BSDescriptionProviding, FBSSceneExtensible, FBSSceneObserver, FBSceneHost> {
...
@property (nonatomic, readonly) _UIApplicationSceneDisplayHostComponent *_displayHostComponent;
@property (nonatomic, readonly) _UIHomeAffordanceHostSceneComponent *_homeAffordanceHostSceneComponent;
@property (getter=_isInTransaction, nonatomic, readonly) bool _inTransaction;
@property (nonatomic, readonly) _UISceneInterfaceProtectionHostComponent *_interfaceProtectionHostComponent;
@property (nonatomic, readonly) _UIApplicationSceneKeyboardHostComponent *_keyboardHostComponent;
@property (nonatomic, readonly) _UISceneOcclusionHostComponent *_occlusionHostComponent;
@property (nonatomic, readonly) _UIPhysicalButtonConfigurationHostSceneComponent *_physicalButtonConfigurationHostSceneComponent;
@property (nonatomic, readonly) _UISceneRelationshipManagementHostComponent *_relationshipManagementHostComponent;
@property (getter=_sceneMaskingDelegate, setter=_setSceneMaskingDelegate:, nonatomic) <_UISceneMaskingDelegate> *_sceneMaskingDelegate;
...
@property (nonatomic) FBSScene *parentScene;
@property (nonatomic, readonly) bool pui_isLegacyProvider;
@property (setter=pui_setPosterComponent:, nonatomic, retain) PUIPosterSceneComponent *pui_posterComponent;
@property (setter=pui_setPosterPath:, nonatomic, retain) PFPosterPath *pui_posterPath;
@property (setter=pui_setShortDescription:, nonatomic, copy) NSString *pui_shortDescription;
...
- (id)clientProcess;
- (id)clientSettings;
- (void)clientToken:(id)arg1 didInvalidateWithError:(id)arg2;
- (void)clientToken:(id)arg1 didReceiveActions:(id)arg2 forExtension:(Class)arg3;
- (void)clientToken:(id)arg1 didUpdateClientSettings:(id)arg2 withDiff:(id)arg3 transitionContext:(id)arg4;
...
- (id)display;
- (bool)executeWhenMutable:(id /* block */)arg1;
- (id)identifier;
- (id)identity;
- (id)identityToken;
- (void)invalidate;
...
- (void)remove:(id)arg1;
- (void)removeExtension:(Class)arg1;
- (void)removeExtensions:(id)arg1;
...
- (bool)updateWhenMutable:(id /* block */)arg1;
...
- (id)pruis_createSnapshotWithContext:(id)arg1;
- (void)pruis_restoreSceneAfterSnapshottingWithCompletion:(id /* block */)arg1;
- (void)pruis_restoreSceneAfterSnapshottingWithUpdater:(id /* block */)arg1 completion:(id /* block */)arg2;
- (void)pruis_setupSceneForSnapshottingWithOptions:(long long)arg1 traitCollection:(id)arg2 completion:(id /* block */)arg3;
- (void)pruis_setupSceneForSnapshottingWithOptions:(long long)arg1 traitCollection:(id)arg2 updater:(id /* block */)arg3 completion:(id /* block */)arg4;
- (id)pruis_snapshotContextConfiguredWithOptions:(long long)arg1;
- (void)pruis_snapshotSceneWithOptions:(long long)arg1 traitCollection:(id)arg2 completion:(id /* block */)arg3;
...
+ (id)_pr_createPosterSceneWithRole:(id)arg1 path:(id)arg2 processIdentity:(id)arg3;
+ (id)pr_createPosterSceneWithRole:(id)arg1 path:(id)arg2;
+ (id)pr_createPosterSceneWithRole:(id)arg1 path:(id)arg2 instance:(id)arg3;
...
- (void)pr_setupSceneExtensionsForSceneRole:(id)arg1;
...
+ (id)pui_createPosterSceneWithRole:(id)arg1 processIdentity:(id)arg2 extensionRecord:(id)arg3 configureParameters:(id /* block */)arg4;

- (id)_emptySnapshotImage;
- (id)pui_buildSnapshotBundleForLevelSets:(id)arg1 determineColorStatistics:(bool)arg2 error:(out id*)arg3;
- (void)pui_executeSnapshotForLevelSets:(id)arg1 determineColorStatistics:(bool)arg2 onQueue:(id)arg3 completion:(id /* block */)arg4;
- (void)pui_invalidateWithCompletion:(id /* block */)arg1;
- (bool)pui_isLegacyProvider;
- (void)pui_postSignificantEvent:(unsigned long long)arg1;
- (void)pui_postUserTapEventWithLocation:(struct CGPoint { double x1; double x2; })arg1;
- (id)pui_posterComponent;
- (id)pui_posterPath;
- (bool)pui_sceneIsReadyToSnapshot:(out id*)arg1;
- (void)pui_setPosterComponent:(id)arg1;
- (void)pui_setPosterPath:(id)arg1;
- (void)pui_setShortDescription:(id)arg1;
- (id)pui_shortDescription;
- (id)pui_snapshotContextConfiguredForLevelSet:(id)arg1;
...
- (void)_performUpdateWithoutActivation:(id /* block */)arg1;
- (id)_physicalButtonConfigurationHostSceneComponent;
- (id)_relationshipManagementHostComponent;
- (id)_sceneMaskingDelegate;
- (id)_sceneMaskingHostProvider;
- (void)_setSceneMaskingDelegate:(id)arg1;
