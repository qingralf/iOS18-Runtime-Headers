...
- (void)scene:(id)arg1 deactivateAndInvalidate:(bool)arg2 withContext:(id)arg3 block:(id /* block */)arg4;
- (void)scene:(id)arg1 didReceiveActions:(id)arg2 forExtension:(Class)arg3;
- (void)scene:(id)arg1 didUpdateClientSettings:(id)arg2;
- (void)scene:(id)arg1 enqueueCalloutsToObserversWithEventName:(id)arg2 block:(id /* block */)arg3;
- (void)scene:(id)arg1 handleUpdate:(id)arg2 withCompletion:(id /* block */)arg3;
- (void)scene:(id)arg1 performCalloutsToObservers:(id /* block */)arg2;
