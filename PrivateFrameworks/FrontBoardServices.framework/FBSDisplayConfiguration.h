...
@property (nonatomic, readonly) NSString *pui_displayConfigurationIdentifier;
...
+ (id)pbf_displayConfigurationForDisplayContext:(id)arg1;
...
+ (id)pui_displayConfigurationForHardwareIdentifier:(id)arg1;
+ (id)pui_displayConfigurationForScreen:(id)arg1;
