...
+ (id)allSettings;
+ (id)allSettingsFromExtension:(Class)arg1;
+ (id)allSettingsFromProtocol:(id)arg1;
+ (Class)immutableSubclass;
+ (void)initialize;
+ (Class)mutableSubclass;
+ (id)settingForProperty:(SEL)arg1;
+ (id)settingForSubclassProperty:(SEL)arg1;
