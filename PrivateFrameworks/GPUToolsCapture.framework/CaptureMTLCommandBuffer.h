...
- (void)addRequestsToDownloadQueue:(id)arg1 withIndex:(unsigned long long)arg2;
...
- (void)configWithCommandBufferDescriptor:(id)arg1;
...
- (id)privateData;
- (unsigned long long)privateDataOffset;
- (id)privateLoggingBuffer;
- (id)profilingResults;
...
- (void)setPrivateDataOffset:(unsigned long long)arg1;
- (void)setPrivateLoggingBuffer:(id)arg1;
