...
@interface CaptureMTLIOScratchBufferAllocator : NSObject <CaptureMTLObject, MTLIOScratchBufferAllocator> {
    <MTLIOScratchBufferAllocator> * _baseObject;
    struct GTTraceContext { } * _traceContext;
    struct GTTraceStream { } * _traceStream;
}

@property (readonly) <MTLIOScratchBufferAllocator> *baseObject;
