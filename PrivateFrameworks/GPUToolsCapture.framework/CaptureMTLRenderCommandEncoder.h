...
@interface CaptureMTLRenderCommandEncoder : NSObject <CaptureMTLObject, MTLRenderCommandEncoderSPI> {
    <MTLRenderCommandEncoderSPI> * _baseObject;
...
@property (readonly) <MTLRenderCommandEncoder> *baseObject;
