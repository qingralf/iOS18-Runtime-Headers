...
@interface CaptureMTLRenderPipelineState : NSObject <CaptureMTLObject, MTLRenderPipelineStateSPI> {
    MTLRenderPipelineFunctionsDescriptor * _additionalBinaryFunctions;
    ...
    <MTLPipelineLibrary> * _retainedPipelineLibrary;
...
@property (nonatomic, readonly) unsigned int explicitVisibilityGroupID; /* unknown property attribute: ? */
...
- (id)baseObject;
- (void)commonInit:(id)arg1 captureDevice:(id)arg2;
...
- (id)initWithBaseObject:(id)arg1 capturePipelineLibrary:(id)arg2;
- (id)initWithBaseObject:(id)arg1 captureRenderPipelineState:(id)arg2 additionalBinaryFunctions:(id)arg3;
- (id)label;
