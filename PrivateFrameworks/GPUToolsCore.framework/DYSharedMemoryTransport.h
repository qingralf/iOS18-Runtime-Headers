...
@interface DYSharedMemoryTransport : DYBaseStreamTransport {
    ...
    struct sm_region_header { _Atomic unsigned int x1; _Atomic unsigned int x2; _Atomic unsigned int x3; _Atomic unsigned int x4; _Atomic unsigned int x5; _Atomic unsigned int x6; unsigned int x7; unsigned int x8; } * _incomingShmem;
    struct sm_region_header { _Atomic unsigned int x1; _Atomic unsigned int x2; _Atomic unsigned int x3; _Atomic unsigned int x4; _Atomic unsigned int x5; _Atomic unsigned int x6; unsigned int x7; unsigned int x8; } * _masterSMRegion;
    int  _mode;
    void * _outgoingBuffer;
    struct sm_region_header { _Atomic unsigned int x1; _Atomic unsigned int x2; _Atomic unsigned int x3; _Atomic unsigned int x4; _Atomic unsigned int x5; _Atomic unsigned int x6; unsigned int x7; unsigned int x8; } * _outgoingShmem;
    BOOL  _receiveName;
