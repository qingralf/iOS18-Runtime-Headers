...
@property (nonatomic, retain) NSArray *friendsWhoHaveThis;
...
+ (bool)shouldShowBannerOnReport:(id)arg1 achievementDescription:(id)arg2 reportedAchievements:(id)arg3;
+ (bool)shouldShowBannerOnReport:(id)arg1 achievementDescription:(id)arg2 reportedAchievements:(id)arg3 uiFrameworkMethodsRequired:(bool)arg4;
+ (bool)shouldShowBannerOnReport:(id)arg1 reportedAchievements:(id)arg2;
+ (bool)shouldShowBannerOnReport:(id)arg1 reportedAchievements:(id)arg2 uiFrameworkMethodsRequired:(bool)arg3;
