...
@interface GKAchievementInternal : GKInternalRepresentation {
    ...
    NSArray * _friendsWhoHaveThis;
    GKGameInternal * _gameHint;
...
@property (nonatomic, retain) GKGameInternal *gameHint;
...
@property (nonatomic, retain) NSNumber *rarityPercent;
...
- (void)setFriendsWhoHaveThis:(id)arg1;
- (void)setGameHint:(id)arg1;
