...
- (oneway void)authenticatedPlayersDidChange:(id)arg1 authenticatingBundleID:(id)arg2 reply:(id /* block */)arg3;
...
- (oneway void)presentBannerWithNotification:(id)arg1;
...
- (oneway void)setTestGame:(id)arg1 protocolVersion:(id)arg2 reply:(id /* block */)arg3;
