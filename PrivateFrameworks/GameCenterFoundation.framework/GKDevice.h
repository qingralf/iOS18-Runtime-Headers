...
@interface GKDevice : NSObject {
    ...
    NSString * _osVersion;
    NSString * _udid;
    NSString * _versionlessDeviceType;
}
...
@property (nonatomic, retain) NSString *versionlessDeviceType;

+ (id)currentDevice;
+ (id)zeroOutVersionWithDeviceType:(id)arg1;
...
- (void)setVersionlessDeviceType:(id)arg1;
- (id)udid;
- (id)userAgentWithProcessName:(id)arg1 protocolVersion:(id)arg2;
- (id)versionlessDeviceType;
