...
- (void)getGameMatchesForAchievement:(id)arg1 handler:(id /* block */)arg2;
- (void)getGameMatchesForLeaderboard:(id)arg1 handler:(id /* block */)arg2;
- (void)getGameMatchesIncludingCompatibleGames:(bool)arg1 handler:(id /* block */)arg2;
