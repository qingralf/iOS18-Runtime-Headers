...
@property (nonatomic, readonly) bool hasActiveChallenges;
@property (nonatomic, copy) NSString *identifier;
@property (retain) GKLeaderboardInternal *internal;
@property (nonatomic, readonly, copy) NSString *leaderboardDescription;
...
+ (id /* block */)leaderboardEntriesHandlerForGroup:(id)arg1 gameBundleID:(id)arg2 proxy:(id)arg3 done:(id /* block */)arg4;
...
- (void)loadPreviousOccurrenceWithGameDescriptor:(id)arg1 completionHandler:(id /* block */)arg2;
