...
@interface GKMatch : NSObject <GKTransportClientDelegate, GKTransportMatchDataDelegate, GKTransportMonitorDelegate, GameCenterFoundation.ExponentialBackoffTaskDelegate> {
...
@property (nonatomic, retain) GKTransportMonitor *healthMonitor;
...
@property (nonatomic) GKMatchmaker *matchmaker;
...
- (void)connectToPlayers:(id)arg1 version:(unsigned char)arg2 invitedByLocalPlayer:(bool)arg3 completionHandler:(id /* block */)arg4;
...
- (id)hostScores;
- (id)initWithMatchmaker:(id)arg1;
- (id)initWithTransport:(id)arg1 context:(id)arg2 reporter:(id)arg3 matchmaker:(id)arg4;
- (bool)initiallyStarted;
- (id)inviteDelegate;
- (void)localPlayerDidChange:(id)arg1;
- (id)makeInviteMessageDoneData;
- (id)matchPacketWithPacketType:(unsigned char)arg1 sequence:(long long)arg2;
- (id)matchmaker;
- (void)monitorStatsUpdated:(id)arg1;
...
- (void)reportInviteSentWithApproach:(unsigned long long)arg1 isHosted:(bool)arg2 recipients:(id)arg3;
- (void)retryLimitHit;
...
- (void)sendMeasurementData:(id)arg1 packetType:(unsigned char)arg2 toPlayerID:(id)arg3;
- (bool)sendPacketDataToAll:(id)arg1 packetType:(unsigned char)arg2 dataMode:(long long)arg3 error:(id*)arg4;
- (void)sendPingTo:(id)arg1 sequence:(long long)arg2;
- (void)sendPongTo:(id)arg1 sequence:(long long)arg2;
...
- (long long)sequenceFromPacket:(id)arg1;
...
- (void)setupWithTransport:(id)arg1 context:(id)arg2 reporter:(id)arg3 matchmaker:(id)arg4;
- (id)stateChangeQueue;
