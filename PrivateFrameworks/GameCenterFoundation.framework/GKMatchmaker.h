...
- (void)handleMatchRequest:(id)arg1 forCurrentMatch:(id)arg2 hostedCurrentPlayerCount:(long long)arg3 serverHosted:(bool)arg4 rematchID:(id)arg5 devicePushToken:(id)arg6 completionHandler:(id /* block */)arg7;
...
- (void)sendMatchmakingRequest:(id)arg1 forMatch:(id)arg2 rematchID:(id)arg3 serverHosted:(bool)arg4 playerCount:(long long)arg5 completionHandler:(id /* block */)arg6;
...
- (void)setShareInvitees:(id)arg1 forMatch:(id)arg2 propagateToDaemon:(bool)arg3;
- (void)setShareInvitees:(id)arg1 propagateToDaemon:(bool)arg2;
