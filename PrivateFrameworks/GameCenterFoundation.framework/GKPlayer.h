...
+ (void)loadScopedIDsForPlayerIDs:(id)arg1 gameBundleID:(id)arg2 handler:(id /* block */)arg3;
...
- (void)loadFriendsWithFilter:(id)arg1 withCompletionHandler:(id /* block */)arg2;
...
- (void)logAndReportIllegalArcadeAccessTo:(id)arg1;
- (void)logAndReportScopedIDsError:(id)arg1;
- (id)messagesID;
...
- (id)teamPlayerID;
- (void)updateScopedIDs:(id /* block */)arg1;
...
- (void)loadPlayerContactForAvatarControllerWithImageSize:(long long)arg1 completion:(id /* block */)arg2;
