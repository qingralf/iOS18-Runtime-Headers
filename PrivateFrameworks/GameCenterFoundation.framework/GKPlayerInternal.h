...
@interface GKPlayerInternal : GKInternalRepresentation {
    ...
    GKPlayerInternalOnboarding * _onboarding;
    NSDictionary * _photos;
    NSString * _playerID;
    id /* block */  _sanitizeBeforeEncoding;
    GKScopedIDs * _scopedIDs;
...
@property (getter=isFriendInvitationInContacts, nonatomic, readonly) bool friendInvitationInContacts;
...
@property (nonatomic, retain) NSDate *lastChallengedDate;
@property (nonatomic, retain) GKGameInternal *lastChallengedGame;
...
@property (nonatomic, copy) id /* block */ sanitizeBeforeEncoding;
...
- (id)inboxEntry;
- (id)initWithSanitizeBeforeEncodingBlock:(id /* block */)arg1;
...
- (id)playerID;
- (void)sanitize;
- (id /* block */)sanitizeBeforeEncoding;
- (id)scopedIDs;
...
- (void)setOnboarding:(id)arg1;
- (void)setPhotoPending:(bool)arg1;
- (void)setPhotos:(id)arg1;
- (void)setPlayerID:(id)arg1;
- (void)setPurpleBuddyAccount:(bool)arg1;
- (void)setSanitizeBeforeEncoding:(id /* block */)arg1;
- (void)setScopedIDs:(id)arg1;
