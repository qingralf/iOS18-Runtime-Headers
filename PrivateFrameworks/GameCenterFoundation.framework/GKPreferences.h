...
@property (nonatomic, readonly) bool easySignInSheetEnabled;
...
@property (getter=isGameCenterDisabled, nonatomic, readonly) bool gameCenterDisabled;
...
@property (nonatomic, retain) NSDictionary *recentPickerSortPreferencePerGame;
@property (nonatomic, readonly) bool requestHeadersPrivacyEnabled;
...
+ (long long)environmentForString:(id)arg1;
...
- (id)recentPickerSortPreferencePerGame;
- (long long)recentPlayerPickerSortPreferenceForBundleID:(id)arg1;
...
- (void)setAccessPointCustomTransition:(bool)arg1;
...
- (void)setMultiplayerHealthCheckEnabled:(bool)arg1;
- (void)setMultiplayerInGameOverlayEnabled:(bool)arg1;
...
- (void)setNotifyAboutScoreSubmissions:(bool)arg1;
...
- (void)setRecentPickerSortPreferencePerGame:(id)arg1;
- (void)setRecentPlayerPickerSortPreference:(long long)arg1 forBundleID:(id)arg2;
