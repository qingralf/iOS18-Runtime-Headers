...
@interface GKCollectionViewController : UICollectionViewController <GKCollectionViewDataSourceDelegate, UISearchBarDelegate, UITextFieldDelegate, _GKStateMachineDelegate> {
    bool  _active;
...
@property (nonatomic, retain) NSObject<OS_dispatch_queue> *batchUpdateQueue;
...
- (void)setBatchUpdateQueue:(id)arg1;
