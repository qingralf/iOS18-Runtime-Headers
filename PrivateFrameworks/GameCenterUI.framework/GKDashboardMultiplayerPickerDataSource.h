...
- (long long)defaultFilterScopeFromPickerOrigin:(long long)arg1;
- (id)delegate;
...
- (id)initWithMaxSelectable:(long long)arg1 previouslyInvitedPlayers:(id)arg2 nearbyOnly:(bool)arg3 pickerOrigin:(long long)arg4;
