...
@property (nonatomic) struct CGSize { double x1; double x2; } textInsets;
...
- (void)setTextInsets:(struct CGSize { double x1; double x2; })arg1;
- (struct CGSize { double x1; double x2; })textInsets;
