...
@interface GKMatchmakerViewController : UINavigationController <GKExtensionParentViewControllerProtocol, GKMatchDelegate, GKMatchDelegatePrivate> {
    ...
    <GKInternalPlayerPickerDelegate> * _internalPlayerPickerDelegate;
...
@property (nonatomic, readonly) <GKInternalPlayerPickerDelegate> *internalPlayerPickerDelegate;
...
@property (nonatomic, readonly) GKPlayerPickerContext *playerPickerContext;
...
- (void)handleRecipientPropertiesNeededForPlayer:(id)arg1 completionHandler:(id /* block */)arg2;
- (id)hostedPlayers;
- (id)init;
- (id)initWithInvite:(id)arg1;
- (id)initWithMatchRequest:(id)arg1;
- (id)initWithPlayerPickerDelegate:(id)arg1 andPlayerPickerContext:(id)arg2;
- (id)internalPlayerPickerDelegate;
- (id)invitationGroup;
- (id)invitationQueue;
...
- (id)playerPickerContext;
- (void)playerPickerDidCancel;
- (void)playerPickerDidPickPlayers:(id)arg1;
- (void)playersToInvite:(id)arg1;
- (void)presentSharePlaySharingController;
- (void)recipientPropertiesNeededForPlayer:(id)arg1;
