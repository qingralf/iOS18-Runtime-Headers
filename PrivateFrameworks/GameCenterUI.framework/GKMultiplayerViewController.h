...
@interface GKMultiplayerViewController : GKCollectionViewController <GKDashboardMultiplayerPickerDelegate, GKMultiplayerDataSourceDelegate, UIAdaptivePresentationControllerDelegate> {
    ...
    NSMutableSet * _participantsInvitedByLocalPlayer;
...
@property (nonatomic, retain) GKBoopHandler *boopHandler;
...
@property (nonatomic, retain) NSMutableSet *participantsInvitedByLocalPlayer;
...
- (void)didPickPlayers:(id)arg1 messageGroups:(id)arg2 source:(unsigned long long)arg3 completion:(id /* block */)arg4;
...
- (void)inviteContactPlayers:(id)arg1 source:(unsigned long long)arg2 completion:(id /* block */)arg3;
- (void)inviteFriendsButtonPressed;
- (void)invitePlayers:(id)arg1;
- (bool)isCanceling;
- (bool)isInSetupMode;
- (bool)isLoading;
- (bool)isParticipantInvitedByLocalPlayer:(id)arg1;
- (void)layoutSubviews;
...
- (id)pageId;
- (id)participantsInvitedByLocalPlayer;
...
- (void)setParticipantsInvitedByLocalPlayer:(id)arg1;
...
- (bool)setupInvitesForSource:(unsigned long long)arg1 completion:(id /* block */)arg2;
- (id)shareURL;
