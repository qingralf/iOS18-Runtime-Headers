...
@interface GKSignInViewController : GKViewController <AAUISignInControllerDelegate, AKAppleIDAuthenticationDelegate, AKInlineSignInViewControllerDelegate, GKAuthenticateViewController, RemoteUIControllerDelegate, UIScrollViewDelegate> {
...
@property (nonatomic, retain) GKSignInView *signInView;
