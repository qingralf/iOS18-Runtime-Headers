...
+ (bool)shouldDisableLoginConsideringSharePlayAvailabilityWithAuthenticateResponse:(id)arg1;
...
- (void)_handleEditedAuthResponse:(id)arg1 error:(id)arg2 handler:(id /* block */)arg3;
- (bool)_shouldDisableWithGlobalDisabled:(bool)arg1 appLevelDisabled:(bool)arg2 processLevelDisabled:(bool)arg3;
- (id)alertMessage;
- (id)alertTitle;
