...
@property (nonatomic, readonly) NSArray *connectedPeerIDs;
...
- (void)handleEvents;
- (void)handleNewGKOOBAudioMessage:(id)arg1 messageData:(id)arg2 remotePID:(unsigned int)arg3 callbackData:(id*)arg4 maxCallbackCount:(int)arg5 checkDelegateCallbackSelector:(bool*)arg6 tellDelegateSelector:(SEL*)arg7 callbackCount:(int*)arg8;
...
- (bool)sendVoiceChatData:(id)arg1 toPeers:(id)arg2 error:(id*)arg3;
- (id)serviceName;
- (id)serviceType;
- (id)sessionID;
...
- (void)tellDelegate_didReceiveDataFromPeerWithContext:(id)arg1;
