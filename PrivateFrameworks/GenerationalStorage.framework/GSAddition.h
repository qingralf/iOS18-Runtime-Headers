...
@property (nonatomic, readonly) NSString *fp_etag;
...
@property (nonatomic, readonly) bool isSavedConflictResolved;
...
- (bool)markSavedConflictAsResolved:(bool)arg1 error:(id*)arg2;
...
- (bool)fp_markResolvedWithError:(id*)arg1;
...
+ (bool)brc_isLegacyConflictAddition:(id)arg1;
