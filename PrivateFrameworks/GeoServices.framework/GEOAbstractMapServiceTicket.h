...
@interface GEOAbstractMapServiceTicket : GEOAbstractTicket <GEOMapServiceTicket> {
    ...
    bool  _shouldAllowManualRedoSearch;
...
@property (nonatomic, readonly) GEOMapItemIdentifier *geoMapItemIdentifierForSpotlight;
@property (nonatomic, readonly) GEOGuideSummaryLayoutMetadata *guideSummaryLayoutMetadata;
...
@property (nonatomic, readonly) GEOSearchRedoButtonThreshold *searchRedoButtonThreshold;
...
@property (nonatomic, readonly) GEOSearchSessionData *searchSessionData;
@property (nonatomic, readonly) bool shouldAllowManualRedoSearch;
