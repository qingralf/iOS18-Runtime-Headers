...
- (bool)containsCoordinate:(struct { double x1; double x2; double x3; })arg1 arrivalRegionType:(int)arg2;
- (bool)containsLocation:(id)arg1 arrivalRegionType:(int)arg2;
- (bool)containsLocation:(id)arg1 arrivalRegionType:(int)arg2 parameters:(id)arg3;
- (unsigned long long)regionContainmentTypeForLocation:(id)arg1 arrivalRegionType:(int)arg2 parameters:(id)arg3;
