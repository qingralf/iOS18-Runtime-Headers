...
@interface GEOBatchTileRequester : NSObject <GEOTileRequesterDelegate> {
    ...
    <GEOBatchTileRequesterDelegate> * _delegate;
...
- (id)init;
- (id)initWithCountryCode:(id)arg1 region:(id)arg2 auditToken:(id)arg3 requestOptions:(unsigned long long)arg4 log:(id)arg5 logPrefix:(id)arg6 tileRequesterCreationBlock:(id /* block */)arg7;
