...
@property (nonatomic, retain) GEOArtworkCapabilities *artworkCapabilities;
...
@property (nonatomic, retain) NSString *hardwareClass;
...
@property (nonatomic, readonly) bool hasArtworkCapabilities;
...
@property (nonatomic, readonly) bool hasHardwareClass;
...
@property (nonatomic, readonly) int*supportedElevationModels;
@property (nonatomic, readonly) unsigned long long supportedElevationModelsCount;
...
- (int)StringAsSupportedElevationModels:(id)arg1;
...
- (void)setArtworkCapabilities:(id)arg1;
...
- (void)setHasSupportEmissionsTagging:(bool)arg1;
...
- (void)setHasSupportsDodgeballCameraInput:(bool)arg1;
- (void)setHasSupportsElectricVehicleRoutes:(bool)arg1;
- (void)setHasSupportsEv2:(bool)arg1;
- (void)setHasSupportsGenericCombinationsInstructionsForAllModes:(bool)arg1;
...
- (void)setHasSupportsRouteCameraInputUpdates:(bool)arg1;
...
- (void)setSupportEmissionsTagging:(bool)arg1;
- (void)setSupportedElevationModels:(int*)arg1 count:(unsigned long long)arg2;
...
- (void)setSupportsDodgeballCameraInput:(bool)arg1;
- (void)setSupportsElectricVehicleRoutes:(bool)arg1;
- (void)setSupportsEv2:(bool)arg1;
- (void)setSupportsGenericCombinationsInstructionsForAllModes:(bool)arg1;
...
- (void)setSupportsRouteCameraInputUpdates:(bool)arg1;
...
- (int)supportedElevationModelAtIndex:(unsigned long long)arg1;
- (int*)supportedElevationModels;
- (id)supportedElevationModelsAsString:(int)arg1;
- (unsigned long long)supportedElevationModelsCount;
