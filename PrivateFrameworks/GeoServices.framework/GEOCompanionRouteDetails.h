...
@property (nonatomic, retain) NSData *anchorPointsData;
...
@property (nonatomic, readonly) bool hasAnchorPointsData;
...
@property (nonatomic, readonly) bool hasStorageID;
...
- (bool)_hasIncompatibleManeuverType:(unsigned long long)arg1;
...
- (void)setAnchorPointsData:(id)arg1;
