...
@property (nonatomic, readonly) GEOComposedString *navTrayDetailString;
@property (nonatomic, readonly) GEOComposedString *navTrayTitleString;
...
- (id)maneuverJunction;
- (int)maneuverType;
- (id)navTrayDetailString;
- (id)navTrayTitleString;
