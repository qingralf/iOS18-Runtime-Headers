...
- (id)initWithRawRouteGeometry:(id)arg1;
...
- (struct PolylineCoordinate { unsigned int x1; float x2; })routeCoordinateForDistance:(double)arg1 afterStartOfPathIndex:(unsigned long long)arg2;
- (struct PolylineCoordinate { unsigned int x1; float x2; })routeCoordinateForDistance:(double)arg1 beforeEndOfPathIndex:(unsigned long long)arg2;
