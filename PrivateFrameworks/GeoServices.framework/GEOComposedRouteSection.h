...
- (id)pathsForRenderRegion:(id)arg1 inOverlay:(id)arg2 elevationSource:(void*)arg3 elevationSourceContext:(void*)arg4;
- (id)pathsForRenderRegion:(id)arg1 inOverlay:(id)arg2 excludedSegments:(const void*)arg3 elevationSource:(void*)arg4 elevationSourceContext:(void*)arg5;
- (id)pathsForRenderRegion:(id)arg1 inOverlay:(id)arg2 shouldSnapToTransit:(bool)arg3 verifySnapping:(bool)arg4 elevationSource:(void*)arg5 elevationSourceContext:(void*)arg6;
