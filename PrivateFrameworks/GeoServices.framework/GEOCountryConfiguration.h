...
@property (nonatomic, readonly) bool currentCountrySupportsCuratedRoutes;
@property (nonatomic, readonly) bool currentCountrySupportsCustomRouteCreation;
...
@property (nonatomic, readonly) bool currentCountrySupportsTopographicMap;
