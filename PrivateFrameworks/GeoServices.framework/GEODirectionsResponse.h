...
@property (nonatomic, readonly) bool hasResponseAttributes;
...
@property (nonatomic, retain) GEOCommonResponseAttributes *responseAttributes;
...
@property (nonatomic, retain) GEOUUID *tripId;
...
- (void)setResponseAttributes:(id)arg1;
...
- (void)addFakeTrafficIncidentAlert:(unsigned long long)arg1 targetLegIndex:(unsigned long long)arg2 mainRouteInfo:(id)arg3 alternateRouteInfo:(id)arg4 currentDistance:(unsigned int)arg5;
