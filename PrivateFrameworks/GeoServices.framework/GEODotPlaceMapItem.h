...
@property (getter=_RAPFlowType, nonatomic, readonly) int RAPFlowType;
...
@property (getter=_alternateIdentifiers, nonatomic, readonly) NSSet *alternateIdentifiers;
@property (getter=_alternateMapsCategoryIDs, nonatomic, readonly) NSArray *alternateMapsCategoryIDs;
@property (getter=_alternateMapsCategoryMUIDs, nonatomic, readonly) NSArray *alternateMapsCategoryMUIDs;
...
@property (nonatomic, readonly) GEOLocalizedString *disclaimerText;
...
@property (nonatomic, retain) GEODotPlace *dotPlace;
...
@property (getter=_hikeGeometryElevationModel, nonatomic, readonly) int hikeGeometryElevationModel;
...
@property (getter=_mapsCategoryMUID, nonatomic, readonly) NSNumber *mapsCategoryMUID;
...
@property (nonatomic, readonly) GEOPDURLData *urlData;
