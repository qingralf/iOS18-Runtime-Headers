...
@property (nonatomic, retain) GEOFormattedString *elevationDescription;
@property (nonatomic, readonly) bool hasElevationDescription;
...
- (void)setElevationDescription:(id)arg1;
