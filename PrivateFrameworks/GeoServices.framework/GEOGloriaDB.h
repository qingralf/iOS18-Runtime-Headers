...
- (id)enumerateDataAtLocation:(struct { double x1; double x2; })arg1 radius:(double)arg2 zoom:(unsigned char)arg3 ifDifferentFrom:(id)arg4 visitor:(id /* block */)arg5;
...
- (id)unsafeEnumerateDataAtLocation:(struct { double x1; double x2; })arg1 radius:(double)arg2 zoom:(unsigned char)arg3 ifDifferentFrom:(id)arg4 visitor:(id /* block */)arg5;
