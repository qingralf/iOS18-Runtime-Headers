...
- (void)_fetchCachedShiftFunctionResponseForLocation:(id)arg1 callbackQueue:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)_fetchSerializedCachedShiftFunctionResponseForRequest:(id)arg1 callbackQueue:(id)arg2 completionHandler:(id /* block */)arg3;
