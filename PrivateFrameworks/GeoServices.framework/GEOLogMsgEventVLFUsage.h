...
@interface GEOLogMsgEventVLFUsage : PBCodable <NSCopying> {
    ...
    GEOVLFCrowdsourcingDetails * _crowdsourcingDetails;
    ...
    struct { 
        ...
        unsigned int read_crowdsourcingDetails : 1; 
...
@property (nonatomic, retain) GEOVLFCrowdsourcingDetails *crowdsourcingDetails;
...
@property (nonatomic, readonly) bool hasCrowdsourcingDetails;
...
- (void)setCrowdsourcingDetails:(id)arg1;
