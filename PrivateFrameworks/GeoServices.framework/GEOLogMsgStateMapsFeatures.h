...
- (void)setHasLibraryFavoritesGuideSavedPlacesCount:(bool)arg1;
- (void)setHasLibraryGuidesSavedPlacesCount:(bool)arg1;
- (void)setHasLibraryPlacesWithNoteCount:(bool)arg1;
- (void)setHasLibrarySavedPlacesCount:(bool)arg1;
...
- (void)setLibraryFavoritesGuideSavedPlacesCount:(int)arg1;
- (void)setLibraryGuidesSavedPlacesCount:(int)arg1;
- (void)setLibraryPlacesWithNoteCount:(int)arg1;
- (void)setLibrarySavedPlacesCount:(int)arg1;
