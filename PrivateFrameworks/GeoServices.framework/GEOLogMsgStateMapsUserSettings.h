...
@interface GEOLogMsgStateMapsUserSettings : PBCodable <NSCopying> {
    ...
    struct { 
        ...
        unsigned int has_isOptedInToVlCrowdsourcing : 1; 
    ...
    bool  _isOptedInToVlCrowdsourcing;
...
@property (nonatomic) bool hasIsOptedInToVlCrowdsourcing;
...
@property (nonatomic) bool isOptedInToVlCrowdsourcing;
...
- (void)setHasIsOptedInToVlCrowdsourcing:(bool)arg1;
...
- (void)setIsOptedInToVlCrowdsourcing:(bool)arg1;
