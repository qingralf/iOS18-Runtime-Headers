...
@property (nonatomic, readonly) NSNumber *regulatoryRegionID;
...
- (id)initWithIdentifier:(id)arg1 originatingBundleIdentifier:(id)arg2 dataTypes:(unsigned long long)arg3 policy:(long long)arg4 expirationDate:(id)arg5 region:(id)arg6 displayName:(id)arg7 regulatoryRegionID:(id)arg8;
- (bool)isEqual:(id)arg1;
- (long long)policy;
- (id)region;
- (id)regulatoryRegionID;
