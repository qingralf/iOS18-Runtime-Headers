...
- (id)initWithSubscription:(id)arg1 diskCache:(id)arg2 requiredOfflineLayers:(id)arg3 delegate:(id)arg4 delegateQueue:(id)arg5 reason:(unsigned char)arg6 requestOptions:(unsigned long long)arg7 auditToken:(id)arg8 manifestManager:(id)arg9 log:(id)arg10 logPrefix:(id)arg11 tileRequesterCreationBlock:(id /* block */)arg12 tileDownloader:(id)arg13 offlineDownloader:(id)arg14 updateType:(long long)arg15;
- (id)initWithSubscription:(id)arg1 diskCache:(id)arg2 requiredOfflineLayers:(id)arg3 delegate:(id)arg4 delegateQueue:(id)arg5 reason:(unsigned char)arg6 requestOptions:(unsigned long long)arg7 auditToken:(id)arg8 manifestManager:(id)arg9 log:(id)arg10 logPrefix:(id)arg11 tileRequesterCreationBlock:(id /* block */)arg12 tileDownloader:(id)arg13 offlineDownloader:(id)arg14 updateType:(long long)arg15 dataTypeMask:(unsigned long long)arg16;
