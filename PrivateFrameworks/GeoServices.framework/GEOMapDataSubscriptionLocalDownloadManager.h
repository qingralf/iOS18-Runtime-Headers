...
@interface GEOMapDataSubscriptionLocalDownloadManager : NSObject <GEOMapDataSubscriptionDownloadGroupDelegate, GEOMapDataSubscriptionDownloadManager, GEOMapDataSubscriptionDownloaderDelegate, GEOOfflineDataConfigurationObserver, GEOPListStateCapturing, GEOSystemMonitorBatteryLevelObserver, GEOSystemMonitorPowerAdapterObserver> {
...
- (void).cxx_destruct;
- (id)_createDownloaderForSubscription:(id)arg1 mode:(unsigned long long)arg2 auditToken:(id)arg3;
...
- (void)forceUpdateForUserInitiatedSubscriptionsForDataType:(unsigned long long)arg1 mode:(unsigned long long)arg2 auditToken:(id)arg3;
...
- (void)runAutomaticOfflineDataUpdateBackgroundTask:(id)arg1;
- (void)runRetryOfflineDownloadBackgroundTask:(id)arg1;
- (void)setDelegate:(id)arg1;
- (void)startDownloadForSubscriptionIdentifiers:(id)arg1 mode:(unsigned long long)arg2 auditToken:(id)arg3;
