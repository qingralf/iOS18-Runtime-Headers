...
@property (nonatomic, readonly) bool hasMapsSyncAttributes;
@property (nonatomic, readonly) bool hasRoutineAttributes;
@property (nonatomic, retain) GEOMapItemMapsSyncAttributes *mapsSyncAttributes;
...
- (void)setMapsSyncAttributes:(id)arg1;
