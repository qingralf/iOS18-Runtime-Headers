...
- (void)setDefaultTraitsHardwareIdentifier:(id)arg1;
...
- (id)ticketForSearchAlongRouteWithCategory:(id)arg1 searchQuery:(id)arg2 completionItem:(id)arg3 originalWaypointRouteData:(id)arg4 zilchData:(id)arg5 sessionState:(id)arg6 routeId:(id)arg7 routeAttributes:(id)arg8 maxResults:(unsigned int)arg9 traits:(id)arg10 searchSessionData:(id)arg11;
...
- (id)ticketForSearchQuery:(id)arg1 completionItem:(id)arg2 maxResults:(unsigned int)arg3 traits:(id)arg4 searchSessionData:(id)arg5;
...
- (id)ticketForSearchQuery:(id)arg1 completionItem:(id)arg2 relatedSearchSuggestion:(id)arg3 retainedSearch:(id)arg4 maxResults:(unsigned int)arg5 traits:(id)arg6 searchSessionData:(id)arg7;
...
- (id)ticketForSearchQuery:(id)arg1 completionItem:(id)arg2 retainedSearch:(id)arg3 maxResults:(unsigned int)arg4 suppressResultsRequiringAttribution:(bool)arg5 traits:(id)arg6 searchSessionData:(id)arg7;
...
- (id)ticketForSearchQuery:(id)arg1 completionItem:(id)arg2 retainedSearch:(id)arg3 maxResults:(unsigned int)arg4 traits:(id)arg5 searchSessionData:(id)arg6;
...
- (id)ticketForSearchQuery:(id)arg1 filters:(id)arg2 completionItem:(id)arg3 retainedSearch:(id)arg4 maxResults:(unsigned int)arg5 suppressResultsRequiringAttribution:(bool)arg6 traits:(id)arg7 searchSessionData:(id)arg8;
...
- (id)ticketForSearchQuery:(id)arg1 filters:(id)arg2 maxResults:(unsigned int)arg3 suppressResultsRequiringAttribution:(bool)arg4 traits:(id)arg5 searchSessionData:(id)arg6;
- (id)ticketForSearchQuery:(id)arg1 filters:(id)arg2 maxResults:(unsigned int)arg3 traits:(id)arg4;
- (id)ticketForSearchQuery:(id)arg1 filters:(id)arg2 maxResults:(unsigned int)arg3 traits:(id)arg4 searchSessionData:(id)arg5;
...
- (id)ticketforCategory:(id)arg1 maxResults:(unsigned int)arg2 traits:(id)arg3 searchSessionData:(id)arg4;
