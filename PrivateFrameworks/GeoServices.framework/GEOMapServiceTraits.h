...
@interface GEOMapServiceTraits : PBCodable <NSCopying> {
    ...
    struct { 
        ...
        unsigned int has_containsSensitiveData : 1; 
    ...
    bool  _optimizeSearchRequestComponents;
...
@property (nonatomic) bool containsSensitiveData;
...
@property (nonatomic) bool hasAnalyticsOptOut;
...
@property (nonatomic) bool hasContainsSensitiveData;
...
@property (nonatomic, readonly) bool hasRecentAutocompleteSessionData;
@property (nonatomic) bool hasRelatedPlaceItemCount;
@property (nonatomic) bool hasRequestMode;
@property (nonatomic) bool hasRequestPriority;
...
@property (nonatomic, readonly) bool hasSpotlightSearchPunchinEncodedString;
...
@property (nonatomic, readonly) bool hasUserActionMetadata;
...
@property (nonatomic) bool hasWantsRouteCreationTip;
...
@property (nonatomic, retain) GEOPDAutocompleteSessionData *recentAutocompleteSessionData;
...
@property (nonatomic, retain) NSString *spotlightSearchPunchinEncodedString;
...
@property (nonatomic, retain) GEOPDSSessionUserActionMetadata *userActionMetadata;
...
@property (nonatomic) bool wantsRouteCreationTip;
...
- (int)StringAsRequestPriority:(id)arg1;
...
- (int)requestPriority;
- (id)requestPriorityAsString:(int)arg1;
- (int)requestPurpose;
...
- (void)setAnalyticsOptOut:(bool)arg1;
...
- (void)setContainsSensitiveData:(bool)arg1;
...
- (void)setHasAnalyticsOptOut:(bool)arg1;
...
- (void)setHasContainsSensitiveData:(bool)arg1;
...
- (void)setHasOptimizeSearchRequestComponents:(bool)arg1;
...
- (void)setHasRequestPriority:(bool)arg1;
...
- (void)setHasWantsRouteCreationTip:(bool)arg1;
...
- (void)setOptimizeSearchRequestComponents:(bool)arg1;
...
- (void)setRecentAutocompleteSessionData:(id)arg1;
...
- (void)setSpotlightSearchPunchinEncodedString:(id)arg1;
...
- (void)setUserActionMetadata:(id)arg1;
- (void)setVenueIdentifier:(id)arg1;
- (void)setWalkingOptions:(id)arg1;
- (void)setWantsBrandIcon:(bool)arg1;
- (void)setWantsRouteCreationTip:(bool)arg1;
- (int)source;
- (id)sourceAsString:(int)arg1;
- (id)spotlightSearchPunchinEncodedString;
