...
- (id).cxx_construct;
- (void).cxx_destruct;
- (struct pair<GEOLocationCoordinate3D, geo::PolylineCoordinate> { struct { double x_1_1_1; double x_1_1_2; double x_1_1_3; } x1; struct PolylineCoordinate { unsigned int x_2_1_1; float x_2_1_2; } x2; })_interpolatedCoordinateFrom:(unsigned long long)arg1 routeCoordinate:(const struct PolylineCoordinate { unsigned int x1; float x2; }*)arg2;
