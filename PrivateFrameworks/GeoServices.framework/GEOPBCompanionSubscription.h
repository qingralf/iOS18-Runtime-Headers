...
@property (nonatomic, readonly) bool hasOriginatingBundleIdentifier;
...
- (id)displayName;
- (unsigned long long)downloadedDataBytes;
- (bool)hasDataType;
- (bool)hasDisplayName;
...
- (void)setDownloadedDataBytes:(unsigned long long)arg1;
- (void)setHasDataType:(bool)arg1;
- (void)setHasDownloadedDataBytes:(bool)arg1;
- (void)setHasPolicy:(bool)arg1;
- (void)setHasSyncToWatch:(bool)arg1;
