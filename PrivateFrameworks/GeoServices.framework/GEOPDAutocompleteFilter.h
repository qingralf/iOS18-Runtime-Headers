...
@property (nonatomic, retain) GEOPDAddressResultSubTypeFilter *addressResultSubTypeFilter;
@property (nonatomic, readonly) bool hasAddressResultSubTypeFilter;
...
@property (nonatomic, readonly) int*resultTypeFilters;
@property (nonatomic, readonly) unsigned long long resultTypeFiltersCount;
...
- (int)StringAsResultTypeFilters:(id)arg1;
- (void)addPlaceTypeFilter:(int)arg1;
- (void)addRequestedEntryType:(int)arg1;
- (void)addResultTypeFilter:(int)arg1;
...
- (int)resultTypeFilterAtIndex:(unsigned long long)arg1;
- (int*)resultTypeFilters;
- (id)resultTypeFiltersAsString:(int)arg1;
- (unsigned long long)resultTypeFiltersCount;
- (void)setAddressResultSubTypeFilter:(id)arg1;
...
- (void)setResultTypeFilters:(int*)arg1 count:(unsigned long long)arg2;
- (id)unknownFields;
