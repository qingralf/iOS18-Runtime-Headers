...
@property (nonatomic) bool hasPreferredDistanceUnit;
...
- (int)StringAsPreferredDistanceUnit:(id)arg1;
...
- (id)preferredDistanceUnitAsString:(int)arg1;
...
- (void)setHasPreferredDistanceUnit:(bool)arg1;
...
- (void)setPreferredDistanceUnit:(int)arg1;
