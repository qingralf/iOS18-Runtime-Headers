...
@property (nonatomic, retain) GEOLocalizedString *disclaimerText;
...
@property (nonatomic, readonly) bool hasDisclaimerText;
...
@property (nonatomic, readonly) unsigned long long*mapsAltCategoryMuids;
@property (nonatomic, readonly) unsigned long long mapsAltCategoryMuidsCount;
...
@property (nonatomic, retain) GEOPDURLData *urlData;
...
- (void)addMapsAltCategoryMuid:(unsigned long long)arg1;
...
- (unsigned long long)mapsAltCategoryMuidAtIndex:(unsigned long long)arg1;
- (unsigned long long*)mapsAltCategoryMuids;
- (unsigned long long)mapsAltCategoryMuidsCount;
- (id)mapsCategoryId;
- (unsigned long long)mapsCategoryMuid;
...
- (void)setHasMapsCategoryMuid:(bool)arg1;
...
- (void)setMapsAltCategoryMuids:(unsigned long long*)arg1 count:(unsigned long long)arg2;
- (void)setMapsCategoryId:(id)arg1;
- (void)setMapsCategoryMuid:(unsigned long long)arg1;
