...
@interface GEOPDMerchantLookupParameters : PBCodable <NSCopying> {
    ...
    GEOPDBankTransactionInformation * _bankTransactionInformation;
    ...
    struct { 
        ...
        unsigned int read_bankTransactionInformation : 1; 
...
@property (nonatomic, retain) GEOPDBankTransactionInformation *bankTransactionInformation;
...
@property (nonatomic, readonly) bool hasBankTransactionInformation;
...
- (void)setBankTransactionInformation:(id)arg1;
