...
@property (nonatomic, retain) NSMutableArray *partiallyComposedSearchResultRequestedComponents;
...
- (void)addPartiallyComposedSearchResultRequestedComponent:(id)arg1;
- (void)addPartiallyComposedSearchResultRequestedComponents:(id)arg1;
...
- (id)initWithCategory:(id)arg1 maxResults:(unsigned int)arg2 traits:(id)arg3 searchSessionData:(id)arg4;
- (id)initWithCategory:(id)arg1 routeInfo:(id)arg2 maxResults:(unsigned int)arg3 traits:(id)arg4 searchSessionData:(id)arg5;
...
- (id)initWithGeoMapItemIdentifier:(id)arg1 categoryID:(id)arg2 maxResults:(unsigned int)arg3 traits:(id)arg4 searchSessionData:(id)arg5;
...
- (id)initWithSearchQuery:(id)arg1 entryMetadata:(id)arg2 metadata:(id)arg3 autocompleteEntry:(id)arg4 retainedSearch:(id)arg5 maxResults:(unsigned int)arg6 filters:(id)arg7 suppressResultsRequiringAttribution:(bool)arg8 traits:(id)arg9 routeInfo:(id)arg10 error:(id*)arg11 searchSessionData:(id)arg12;
...
- (bool)needLatency;
- (id)partiallyComposedSearchResultRequestedComponentAtIndex:(unsigned long long)arg1;
- (id)partiallyComposedSearchResultRequestedComponents;
...
- (void)setPartiallyComposedSearchResultRequestedComponents:(id)arg1;
