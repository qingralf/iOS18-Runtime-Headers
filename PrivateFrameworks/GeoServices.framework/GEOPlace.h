...
+ (id)_placesFromDirectionsAction:(id)arg1 currentLocationIndices:(id*)arg2 options:(id*)arg3;
...
+ (id)_placesFromShowAction:(id)arg1 currentLocationIndices:(id*)arg2 options:(id*)arg3;
...
+ (id)_placesFromURL:(id)arg1 currentLocationIndices:(id*)arg2 options:(id*)arg3;
...
+ (id)_urlForDirectionsWithWaypoints:(id)arg1 options:(id)arg2;
