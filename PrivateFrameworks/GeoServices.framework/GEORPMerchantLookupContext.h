...
@interface GEORPMerchantLookupContext : PBCodable <NSCopying> {
    ...
    struct { 
        ...
        unsigned int read_merchantBankTransactionInfo : 1; 
    ...
    GEOPDBankTransactionInformation * _merchantBankTransactionInfo;
...
@property (nonatomic, readonly) bool hasMerchantBankTransactionInfo;
...
@property (nonatomic, retain) GEOPDBankTransactionInformation *merchantBankTransactionInfo;
...
- (id)merchantAdamId;
- (id)merchantBankTransactionInfo;
...
- (void)setMerchantBankTransactionInfo:(id)arg1;
