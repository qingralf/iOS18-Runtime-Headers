...
@property (nonatomic, readonly) bool hasTdmUserMapsStatus;
@property (nonatomic, readonly) bool hasTransactionId;
@property (nonatomic, retain) NSString *keyId;
@property (nonatomic, retain) NSString *tdmNamespace;
@property (nonatomic, retain) GEORPTdmUserMapsStatus *tdmUserMapsStatus;
...
- (void)setTdmUserMapsStatus:(id)arg1;
- (void)setTransactionId:(id)arg1;
- (id)tdmNamespace;
- (id)tdmUserMapsStatus;
- (id)transactionId;
- (id)unknownFields;
