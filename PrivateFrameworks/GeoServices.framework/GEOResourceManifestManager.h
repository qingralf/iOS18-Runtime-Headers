...
@interface GEOResourceManifestManager : NSObject <GEOPListStateCapturing, GEOResourceManifestServerProxyDelegate> {
    ...
    GEOActiveTileGroup * _offlineActiveTileGroup;
    int  _offlineDataVersionChangeNotifyToken;
...
- (void).cxx_destruct;
- (unsigned int)_fromgeod_maximumZoomLevelForStyle:(int)arg1 scale:(int)arg2 outSize:(int*)arg3;
- (id)_generateOfflineActiveTileGroup:(union { unsigned int x1; struct { unsigned char x_2_1_1; unsigned char x_2_1_2; unsigned char x_2_1_3; unsigned char x_2_1_4; } x2; })arg1;
- (void)_localeChanged:(id)arg1;
- (void)_offlineStateChanged:(id)arg1;
- (void)activateResourceName:(id)arg1;
- (void)activateResourceScale:(int)arg1;
- (void)activateResourceScenario:(int)arg1;
- (id)activeTileGroup;
- (id)activeTileGroupForCurrentOfflineModeForAuditToken:(id)arg1;
...
- (void)deactivateResourceName:(id)arg1;
