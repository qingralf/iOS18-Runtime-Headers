...
@property (nonatomic) bool hasParkingDirection;
...
- (int)StringAsParkingDirection:(id)arg1;
...
- (id)parkingDirectionAsString:(int)arg1;
...
- (void)setHasParkingDirection:(bool)arg1;
...
- (void)setParkingDirection:(int)arg1;
