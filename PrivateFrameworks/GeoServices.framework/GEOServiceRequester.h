...
@interface GEOServiceRequester : NSObject {
    Class  _companionOfflineOperationClass;
...
@property (nonatomic, retain) Class companionOfflineOperationClass;
...
- (Class)_offlineOperationClassForState:(union { unsigned int x1; struct { unsigned char x_2_1_1; unsigned char x_2_1_2; unsigned char x_2_1_3; unsigned char x_2_1_4; } x2; })arg1;
...
- (bool)_shouldTryNextOperation:(id)arg1 forError:(id)arg2 fromOperation:(id)arg3;
...
- (void)setCompanionOfflineOperationClass:(Class)arg1;
