...
@property (nonatomic) bool hasArrivedTimestamp;
@property (nonatomic) bool hasClosed;
@property (nonatomic) bool hasClosedTimestamp;
...
@property (nonatomic, readonly) bool hasWaypointInfos;
...
- (void)setArrivedTimestamp:(double)arg1;
- (void)setClosed:(bool)arg1;
- (void)setClosedTimestamp:(double)arg1;
- (void)setClosureReason:(unsigned int)arg1;
...
- (void)setHasArrivedTimestamp:(bool)arg1;
- (void)setHasClosed:(bool)arg1;
- (void)setHasClosedTimestamp:(bool)arg1;
- (void)setHasClosureReason:(bool)arg1;
...
- (void)_createPlaceholderETAInfosForWaypoints:(id)arg1;
- (void)_msp_logWithCategory:(id)arg1 type:(unsigned char)arg2 object:(id)arg3 prefix:(id)arg4;
- (id)arrivalMessage;
