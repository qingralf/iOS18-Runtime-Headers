...
@property (nonatomic, retain) NSData *destinationPersistentData;
@property (nonatomic, readonly) bool hasAutomobileOptions;
@property (nonatomic, readonly) bool hasCyclingOptions;
@property (nonatomic, readonly) bool hasDestinationPersistentData;
...
- (void)setDestinationPersistentData:(id)arg1;
