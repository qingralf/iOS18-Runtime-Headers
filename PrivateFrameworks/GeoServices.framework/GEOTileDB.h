...
+ (void)migrateDBFrom:(id)arg1 to:(id)arg2;
+ (void)migrateFilesFrom:(id)arg1 to:(id)arg2;
...
- (bool)_cleanUpDataForRemovedOfflineSubscriptionsWithError:(id*)arg1;
...
- (bool)_prepareDataForPersistence:(id)arg1 isIdenticalToExistingStaleData:(bool)arg2 preferredExternalResourceUUID:(id)arg3 externalResourceUUID:(id*)arg4;
...
- (void)clearShouldSyncSubscriptionsForPairedDevice:(id)arg1;
...
- (void)fetchAllSubscriptionsToSyncToPairedDevice:(id)arg1 queue:(id)arg2 callback:(id /* block */)arg3;
...
- (void)fetchSubscriptionsMatchingIdentifiers:(id)arg1 toSyncToPairedDevice:(id)arg2 queue:(id)arg3 callback:(id /* block */)arg4;
- (void)findShiftResponseForCoordinate:(struct { double x1; double x2; })arg1 reduceRadius:(double)arg2 queue:(id)arg3 completion:(id /* block */)arg4;
- (void)findShiftResponseForCoordinate:(struct { double x1; double x2; })arg1 withinRadius:(double)arg2 queue:(id)arg3 completion:(id /* block */)arg4;
...
- (id)init;
- (id)initWithDBDirectory:(id)arg1 externalFilesDirectory:(id)arg2;
- (id)initWithDBDirectory:(id)arg1 externalFilesDirectory:(id)arg2 manifestManager:(id)arg3 countryConfiguration:(id)arg4 offlineDataConfiguration:(id)arg5 locale:(id)arg6 maximumDatabaseSize:(unsigned long long)arg7;
- (void)linkShiftResponse:(long long)arg1 toSubscription:(id)arg2;
...
- (void)pruneShiftEntriesOlderThan:(id)arg1 maximumEntriesToKeep:(int)arg2;
...
- (void)setSubscriptionWithIdentifier:(id)arg1 shouldSync:(bool)arg2 toPairedDevice:(id)arg3;
- (void)setSubscriptionWithIdentifier:(id)arg1 shouldSync:(bool)arg2 toPairedDevice:(id)arg3 shouldOverwriteExistingValue:(bool)arg4;
...
- (void)storeShiftResponse:(id)arg1;
- (void)storeShiftResponse:(id)arg1 forSubscription:(id)arg2;
- (void)tearDown;
