...
@interface GEOURLInfoSet : PBCodable <NSCopying> {
    ...
    struct { 
        ...
        unsigned int read_bcxDispatcherURL : 1; 
...
@property (nonatomic, retain) GEOURLInfo *bcxDispatcherURL;
...
@property (nonatomic, readonly) bool hasBcxDispatcherURL;
...
- (void)setBcxDispatcherURL:(id)arg1;
