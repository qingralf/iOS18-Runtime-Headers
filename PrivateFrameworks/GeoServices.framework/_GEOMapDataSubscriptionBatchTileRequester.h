...
- (id)init;
- (id)initWithSubscription:(id)arg1 diskCache:(id)arg2 reason:(unsigned char)arg3 auditToken:(id)arg4 requestOptions:(unsigned long long)arg5 manifestManager:(id)arg6 log:(id)arg7 logPrefix:(id)arg8 tileRequesterCreationBlock:(id /* block */)arg9;
