/* Generated by RuntimeBrowser
   Image: /System/Library/PrivateFrameworks/HIDPreferences.framework/HIDPreferences
 */
...
- (id)initWithConnection:(id)arg1 listener:(id)arg2 onQueue:(id)arg3;
...
- (bool)setupConnectionOnQueue:(id)arg1;
