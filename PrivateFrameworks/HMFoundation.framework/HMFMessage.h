...
@property (getter=hm_isXPCTimeoutDisabled, readonly) bool hm_xpcTimeoutDisabled;
...
@property (nonatomic, readonly) bool remoteDisallowsIDSRacing;
...
@property (nonatomic, readonly) NSString *untrustedClientIdentifier;
...
- (id)sendPolicy;
- (bool)shouldWeProcessRemoteMessageDespiteNoRemoteAccessAllowedForUser:(id)arg1;
