...
@property (getter=hm_isXPCTimeoutDisabled, setter=hm_setXPCTimeoutDisabled:) bool hm_xpcTimeoutDisabled;
...
@property (nonatomic) bool remoteDisallowsIDSRacing;
...
@property (nonatomic, retain) NSString *untrustedClientIdentifier;
...
- (void)hm_setXPCTimeoutDisabled:(bool)arg1;
...
- (void)setRemoteDisallowsIDSRacing:(bool)arg1;
