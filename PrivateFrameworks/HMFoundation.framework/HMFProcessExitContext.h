...
@property (nonatomic, readonly) unsigned long long OSReasonCode;
...
- (void).cxx_destruct;
- (unsigned long long)OSReasonCode;
...
- (id)initWithUserDefaultsStore:(id)arg1 processLastRecordedExitTimeKey:(id)arg2 resetStoreReadToken:(bool)arg3 timestamp:(id)arg4 osReasonDomain:(long long)arg5 osReasonCode:(unsigned long long)arg6 isCrash:(bool)arg7 isJetsam:(bool)arg8 errorRepresentation:(id)arg9;
- (bool)isCrash;
- (bool)isJetsam;
- (bool)isStale;
