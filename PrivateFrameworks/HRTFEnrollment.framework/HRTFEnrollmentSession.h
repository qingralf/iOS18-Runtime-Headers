...
- (void)downloadHRTFAsset:(unsigned long long)arg1 withCompletion:(id /* block */)arg2;
- (void)downloadHRTFAssetV2:(unsigned long long)arg1 withCompletion:(id /* block */)arg2;
- (id)getMovFileName;
- (id)getRecordingFolder;
- (id)getRecordingURL;
- (id)init;
- (id)initWithCameraSession:(bool)arg1;
...
- (void)startSession:(bool)arg1 withAssetPath:(id)arg2 then:(id /* block */)arg3;
- (id)stateInfo;
