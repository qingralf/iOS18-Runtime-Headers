...
@interface HDAlarmEvent : NSObject {
    ...
    unsigned long long  _clientOptions;
    NSDate * _dueDate;
...
@property (nonatomic, readonly) unsigned long long clientOptions;
...
- (void).cxx_destruct;
- (id)_initWithClientIdentifier:(id)arg1 eventIdentifier:(id)arg2 dueDate:(id)arg3 dueDateComponents:(id)arg4 eventOptions:(unsigned long long)arg5 clientOptions:(unsigned long long)arg6;
- (id)_unitTest_localTimeZoneOverride;
- (id)clientIdentifier;
- (unsigned long long)clientOptions;
- (id)currentDueDate;
- (id)description;
- (id)dueDate;
...
- (id)initWithClientIdentifier:(id)arg1 eventIdentifier:(id)arg2 dueDate:(id)arg3 eventOptions:(unsigned long long)arg4 clientOptions:(unsigned long long)arg5;
...
- (id)initWithClientIdentifier:(id)arg1 eventIdentifier:(id)arg2 dueDateComponents:(id)arg3 eventOptions:(unsigned long long)arg4 clientOptions:(unsigned long long)arg5;
