...
- (void)cloudSync_reportDailyAnalyticForProfileType:(long long)arg1 syncEnabled:(bool)arg2 syncDisabledError:(id)arg3 primaryContainer:(id)arg4 restoreComplete:(bool)arg5 timeSinceRestoreStart:(id)arg6 journalSize:(id)arg7 oldestJournalAge:(id)arg8 timeSinceLastSuccessfulPull:(id)arg9 timeSinceLastSuccessfulPush:(id)arg10 timeSinceLastSuccessfulLitePush:(id)arg11 timeSinceLastPushForwardProgress:(id)arg12 storeCount:(long long)arg13 zoneCount:(long long)arg14 hasUnifiedZone:(bool)arg15 hasMasterZone:(bool)arg16 hasMedicalID:(bool)arg17 errorRequiringUserAction:(id)arg18 childSyncIdentityCount:(long long)arg19 canUpgradeToSyncIdentity:(bool)arg20 startedUpgradeToSyncIdentity:(bool)arg21 completedUpgradeToSyncIdentity:(bool)arg22 iPhoneCount:(id)arg23 iPadCount:(id)arg24 watchCount:(id)arg25 visionProCount:(id)arg26 totalSyncsCount:(id)arg27 successfulSyncPercentageCount:(id)arg28;
- (void)cloudSync_reportFullSyncMetricsWithReason:(id)arg1 shard:(id)arg2 daysSincePreviousFullSync:(id)arg3 totalDuration:(double)arg4 activeDuration:(double)arg5 numberOfRuns:(id)arg6 incomplete:(bool)arg7;
...
- (void)database_reportJournalMergeActivityResult:(long long)arg1 duration:(double)arg2 interruptions:(id)arg3 error:(id)arg4;
...
- (void)workout_reportMirroringEventWithStartDuration:(double)arg1 stopDuration:(double)arg2 mirroringDuration:(double)arg3 numOfSendDataRequests:(long long)arg4 maxTimeToSendData:(double)arg5 minTimeToSendData:(double)arg6 avgTimeToSendData:(double)arg7 isFirstParty:(bool)arg8;
...
- (void)workout_reportWorkoutEventWithHeartBeatFailures:(long long)arg1 workoutDuration:(double)arg2 isFirstParty:(bool)arg3;
