...
@interface HDAppSubscription : NSObject {
    ...
    unsigned long long  _lastAssociationAnchor;
...
@property (nonatomic) unsigned long long lastAssociationAnchor;
