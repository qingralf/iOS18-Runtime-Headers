...
+ (unsigned long long)appSDKVersionTokenForBundleID:(id)arg1 profile:(id)arg2 error:(id*)arg3;
+ (const struct { id x1; id x2; unsigned char x3; }*)columnDefinitionsWithCount:(unsigned long long*)arg1;
+ (id)databaseTable;
+ (bool)insertOrUpdateAppSDKVersionToken:(unsigned long long)arg1 forBundleID:(id)arg2 profile:(id)arg3 error:(id*)arg4;
