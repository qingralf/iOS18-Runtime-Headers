...
@interface HDAppSubscriptionManager : NSObject <HDDatabaseProtectedDataObserver, HDProfileReadyObserver> {
    ...
    id /* block */  _unitTesting_didUpdateObservingDataTypeCode;
...
@property (nonatomic, copy) id /* block */ unitTesting_didUpdateObservingDataTypeCode;
...
- (void)setAnchor:(id)arg1 forDataCode:(long long)arg2 type:(long long)arg3;
- (void)setUnitTesting_backgroundAppRefreshStatusGenerator:(id /* block */)arg1;
- (void)setUnitTesting_didUpdateObservingDataTypeCode:(id /* block */)arg1;
- (void)setUnitTesting_launchEventHandler:(id /* block */)arg1;
- (void)subscribeForBundleID:(id)arg1 dataCode:(long long)arg2 frequencyInSeconds:(unsigned long long)arg3 appSDKVersionToken:(unsigned long long)arg4;
- (id /* block */)unitTesting_backgroundAppRefreshStatusGenerator;
- (id /* block */)unitTesting_didUpdateObservingDataTypeCode;
- (bool)unitTesting_isAwaitingLaunchForBundleID:(id)arg1 dataTypeCode:(long long)arg2;
