...
@interface HDAttachmentManager : NSObject <HDAnalyticsSubmissionCoordinatorDelegate, HDCloudSyncAttachmentManager, HDProfileReadyObserver> {
...
- (long long)supportedSchemaVersionForReference:(id)arg1;
