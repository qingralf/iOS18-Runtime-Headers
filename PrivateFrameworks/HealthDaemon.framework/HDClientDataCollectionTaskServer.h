...
- (id)remoteInterface;
- (void)remote_insertDatums:(id)arg1 device:(id)arg2 metadata:(id)arg3 options:(unsigned long long)arg4 batchUUID:(id)arg5 registrationUUID:(id)arg6 completion:(id /* block */)arg7;
- (void)remote_registerWithCompletion:(id /* block */)arg1;
- (void)remote_setCollectionState:(id)arg1 completion:(id /* block */)arg2;
