...
+ (id)databaseTable;
+ (bool)enumerateShardsForOwnerIdentifier:(id)arg1 containerIdentifier:(id)arg2 syncIdentity:(id)arg3 profile:(id)arg4 transaction:(id)arg5 error:(id*)arg6 handler:(id /* block */)arg7;
+ (id)foreignKeys;
