...
@interface HDCodableObjectCollection : PBCodable <NSCopying> {
    ...
    NSMutableArray * _activityGoalSchedules;
    ...
    NSMutableArray * _pauseRingsSchedules;
...
@property (nonatomic, retain) NSMutableArray *activityGoalSchedules;
...
@property (nonatomic, retain) NSMutableArray *pauseRingsSchedules;
...
- (id)activityGoalSchedules;
- (id)activityGoalSchedulesAtIndex:(unsigned long long)arg1;
- (unsigned long long)activityGoalSchedulesCount;
- (void)addActivityCaches:(id)arg1;
- (void)addActivityGoalSchedules:(id)arg1;
...
- (void)addPauseRingsSchedules:(id)arg1;
...
- (id)pauseRingsSchedules;
- (id)pauseRingsSchedulesAtIndex:(unsigned long long)arg1;
...
- (void)setActivityGoalSchedules:(id)arg1;
...
- (void)setPauseRingsSchedules:(id)arg1;
