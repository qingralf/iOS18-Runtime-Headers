...
@interface HDCodableWorkout : PBCodable <HDDecoding, NSCopying> {
    ...
    HDCodableWorkoutActivity * _primaryActivity;
...
@property (nonatomic, readonly) bool hasPrimaryActivity;
...
@property (nonatomic, retain) HDCodableWorkoutActivity *primaryActivity;
@property (nonatomic, retain) HDCodableSample *sample;
@property (nonatomic, retain) NSMutableArray *subActivities;
...
- (void)setPrimaryActivity:(id)arg1;
- (void)setSample:(id)arg1;
- (void)setSubActivities:(id)arg1;
...
- (id)subActivities;
- (id)subActivitiesAtIndex:(unsigned long long)arg1;
