...
+ (id)configurationWithLatency:(double)arg1 interval:(double)arg2 seriesDuration:(double)arg3 activeWorkout:(bool)arg4 foregroundObserver:(bool)arg5 backgroundObserver:(bool)arg6;
...
- (void)setHasBackgroundObserver:(bool)arg1;
