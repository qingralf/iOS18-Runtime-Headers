...
@interface HDDataCollectionManager : NSObject <HDAssertionObserver, HDDiagnosticObject, HDPeriodicActivityDelegate, HDProfileReadyObserver> {
    ...
    NSObject<OS_dispatch_queue> * _sharedDelayedAggregationQueue;
...
@property (nonatomic, readonly) NSObject<OS_dispatch_queue> *sharedDelayedAggregationQueue;
...
- (id)sharedDelayedAggregationQueue;
