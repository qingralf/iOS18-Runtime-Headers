...
@interface HDDataEntityDeletionContext : NSObject {
    bool  _callWillDeleteWithProfileTransaction;
...
@property (nonatomic) bool callWillDeleteWithProfileTransaction;
...
- (void)setCallWillDeleteWithProfileTransaction:(bool)arg1;
