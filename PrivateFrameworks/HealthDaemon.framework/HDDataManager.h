...
- (void)setBackgroundObserverFrequency:(id)arg1 forDataType:(id)arg2 frequency:(long long)arg3 appSDKVersionToken:(unsigned long long)arg4 completion:(id /* block */)arg5;
