...
@interface HDDatabase : NSObject <HDAssertionObserver, HDContentProtectionObserver, HDDatabaseConnectionPoolDelegate, HDDatabaseCorruptionEventStoreDelegate, HDDatabaseJournalDelegate, HDDatabaseMigrationTransactionDelegate, HDDiagnosticObject, HDHealthDatabase, HDSQLiteDatabaseDelegate, HDSQLiteDatabaseProvider> {
    ...
    HDDatabaseConfiguration * _configuration;
...
@property (nonatomic, readonly) HDDatabaseConfiguration *configuration;
...
@property (getter=isInSession, nonatomic, readonly) bool inSession;
...
- (void)addProtectedResourceStores:(id)arg1;
...
- (id)initWithConfiguration:(id)arg1 profile:(id)arg2;
...
- (void)unitTest_mergeSecondaryJournalsWithActivity:(id)arg1 completion:(id /* block */)arg2;
