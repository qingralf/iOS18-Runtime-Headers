...
@interface HDDemoDataGeneratorWorkoutConfiguration : NSObject <NSSecureCoding> {
    ...
    double  _distanceCrossCountrySkiingRateInMeters;
    double  _distanceCyclingRateInMiles;
    double  _distanceDownhillSnowSportsRateInMeters;
    double  _distancePaddleSportsRateInMeters;
    double  _distanceRowingRateInMeters;
    double  _distanceSkatingSportsRateInMeters;
...
- (void)setDistanceCrossCountrySkiingRateInMeters:(double)arg1;
- (void)setDistanceCyclingRateInMiles:(double)arg1;
- (void)setDistanceDownhillSnowSportsRateInMeters:(double)arg1;
- (void)setDistancePaddleSportsRateInMeters:(double)arg1;
- (void)setDistanceRowingRateInMeters:(double)arg1;
- (void)setDistanceSkatingSportsRateInMeters:(double)arg1;
