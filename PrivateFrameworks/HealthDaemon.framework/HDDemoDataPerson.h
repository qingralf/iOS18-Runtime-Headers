...
@interface HDDemoDataPerson : NSObject {
    ...
    double  _crossCountrySkiingSpeedMean;
...
@property (nonatomic) double crossCountrySkiingSpeedMean;
...
@property (nonatomic) double paddleSportsSpeedMean;
...
@property (nonatomic) double rowingSpeedMean;
...
@property (nonatomic) double speedMeanStdDev;
...
- (void)setCrossCountrySkiingSpeedMean:(double)arg1;
...
- (void)setPaddleSportsSpeedMean:(double)arg1;
...
- (void)setRowingSpeedMean:(double)arg1;
...
- (void)setSpeedMeanStdDev:(double)arg1;
