...
- (void)setTotalDistanceCrossCountrySkiingInMeters:(double)arg1;
- (void)setTotalDistanceCyclingInMiles:(double)arg1;
- (void)setTotalDistanceDownhillSnowSportsInMeters:(double)arg1;
- (void)setTotalDistancePaddleSportsInMeters:(double)arg1;
- (void)setTotalDistanceRowingInMeters:(double)arg1;
- (void)setTotalDistanceSkatingSportsInMeters:(double)arg1;
