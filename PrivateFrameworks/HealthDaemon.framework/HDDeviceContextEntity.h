...
+ (id)deviceContextForLocalSyncIdentityWithProfile:(id)arg1 transaction:(id)arg2 error:(id*)arg3;
...
+ (id)lookupOrCreateDeviceContextForLocalSyncIdentityWithProfile:(id)arg1 transaction:(id)arg2 error:(id*)arg3;
