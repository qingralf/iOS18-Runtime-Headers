...
+ (id)hearingAidFeatureAvailabilityManagerWithProfile:(id)arg1;
+ (id)hearingProtectionFeatureAvailabilityManagerWithProfile:(id)arg1;
+ (id)hearingTestFeatureAvailabilityManagerWithProfile:(id)arg1;
...
+ (id)_makeRegionAvailabilityProviderWithProfile:(id)arg1 syncManager:(id)arg2;
...
+ (id)hdhr_makeCardioFitnessFeatureAvailabilityManagerWithProfile:(id)arg1;
...
+ (id)hdsh_sleepApneaNotificationsAvailabilityManagerWithProfile:(id)arg1;
