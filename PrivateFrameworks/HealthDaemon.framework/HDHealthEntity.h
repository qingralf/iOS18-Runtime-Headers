...
+ (bool)enumerateEntitiesForSyncWithProperties:(id)arg1 predicate:(id)arg2 syncEntityClass:(Class)arg3 session:(id)arg4 syncAnchorRange:(struct HDSyncAnchorRange { long long x1; long long x2; })arg5 orderingTerms:(id)arg6 limit:(unsigned long long)arg7 lastSyncAnchor:(long long*)arg8 distinct:(bool)arg9 healthDatabase:(id)arg10 error:(id*)arg11 block:(id /* block */)arg12;
...
+ (bool)enumerateProperties:(id)arg1 withPredicate:(id)arg2 orderingTerms:(id)arg3 groupBy:(id)arg4 limit:(unsigned long long)arg5 healthDatabase:(id)arg6 error:(id*)arg7 enumerationHandler:(id /* block */)arg8;
...
- (bool)willDeleteWithProfile:(id)arg1 transaction:(id)arg2 error:(id*)arg3;
