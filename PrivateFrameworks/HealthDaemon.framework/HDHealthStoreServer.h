...
+ (void)_authenticateWithGuard:(id)arg1 completion:(id /* block */)arg2;
...
- (void)remote_isProtectedDataAvailable:(id /* block */)arg1;
...
- (void)remote_relateReplaceRatingOfExertionSample:(id)arg1 toWorkout:(id)arg2 workoutActivity:(id)arg3 samples:(id)arg4 completion:(id /* block */)arg5;
- (void)remote_relateSamples:(id)arg1 withObject:(id)arg2 subObject:(id)arg3 type:(unsigned long long)arg4 completion:(id /* block */)arg5;
...
- (void)remote_unrelateSamples:(id)arg1 withObject:(id)arg2 subObject:(id)arg3 type:(unsigned long long)arg4 completion:(id /* block */)arg5;
