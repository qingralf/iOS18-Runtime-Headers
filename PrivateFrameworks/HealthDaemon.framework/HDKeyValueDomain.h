...
+ (id)hdmd_timeZoneDomainWithProfile:(id)arg1;
...
+ (id)hdmc_menstrualCyclesOvulationConfirmationNotificationStateSyncedUnprotectedDomainWithProfile:(id)arg1;
+ (id)hdmc_menstrualCyclesUnconfirmedDeviationNotificationStateSyncedUnprotectedDomainWithProfile:(id)arg1;
...
- (bool)hdmh_setUpdatedPeriodicPromptedAssessmentNotificationFireDate:(id)arg1 error:(id*)arg2;
- (id)hdmh_updatedPeriodicPromptedAssessmentNotificationFireDateWithError:(id*)arg1;
