...
- (void)addMetadataToWorkoutActivity:(id)arg1 withSampleStartDate:(id)arg2 dataSource:(id)arg3;
...
- (void)workoutDataDestination:(id)arg1 didAttachDataSourceToSessionIdentifer:(id)arg2;
