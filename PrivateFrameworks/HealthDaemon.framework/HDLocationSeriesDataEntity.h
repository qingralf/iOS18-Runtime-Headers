...
+ (bool)copySeriesDataWithIdentifier:(long long)arg1 toSeriesIdentifier:(long long)arg2 database:(id)arg3 error:(id*)arg4;
...
+ (bool)enumerateSeries:(long long)arg1 database:(id)arg2 startDate:(id)arg3 endDate:(id)arg4 error:(id*)arg5 handler:(id /* block */)arg6;
