...
+ (bool)_rawEnumerateLocationDataInDatabase:(id)arg1 HFDKey:(id)arg2 startDate:(id)arg3 endDate:(id)arg4 error:(id*)arg5 handler:(id /* block */)arg6;
+ (bool)addCodableObject:(id)arg1 toCollection:(id)arg2;
+ (id)codableObjectsFromObjectCollection:(id)arg1;
+ (bool)copyLocationDataFromSeriesIdentifier:(id)arg1 toSeriesIdentifier:(id)arg2 transaction:(id)arg3 error:(id*)arg4;
+ (id)createTableSQL;
...
- (bool)enumerateLocationDataInTransaction:(id)arg1 startDate:(id)arg2 endDate:(id)arg3 error:(id*)arg4 handler:(id /* block */)arg5;
