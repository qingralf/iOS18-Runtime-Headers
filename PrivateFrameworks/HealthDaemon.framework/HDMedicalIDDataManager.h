...
@interface HDMedicalIDDataManager : NSObject <HDAnalyticsSubmissionCoordinatorDelegate, HDCloudSyncMedicalIDDataManager, HDProfileReadyObserver> {
    HDProfile * _profile;
}
...
- (void).cxx_destruct;
- (void)_runEmergencyContactConsolidationWithCompletion:(id /* block */)arg1;
- (void)_runEmergencyContactConsolidationWithSOSManager:(id)arg1 WithCompletion:(id /* block */)arg2;
- (void)dealloc;
...
- (void)runEmergencyContactConsolidationWithCompletion:(id /* block */)arg1;
