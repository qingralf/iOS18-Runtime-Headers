...
@property (nonatomic, readonly, copy) HDCodableNotificationInstructionMessage *codableMessage;
...
- (id)initWithCodableNotificationInstructionMessage:(id)arg1 criteriaClasses:(id)arg2;
