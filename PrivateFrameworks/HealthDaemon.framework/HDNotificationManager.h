...
+ (id)createNotificationContentWithTitle:(id)arg1 body:(id)arg2 categoryIdentifier:(id)arg3;
...
- (void)unitTest_deliveredNotificationsOverride:(id)arg1;
...
- (void)removeDeliveredNotificationsForScheduleItemIdentifiers:(id)arg1;
