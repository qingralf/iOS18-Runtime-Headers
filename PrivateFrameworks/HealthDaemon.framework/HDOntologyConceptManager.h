...
+ (id)predicateForConceptsWithoutAttributeType:(long long)arg1 attributeValue:(id)arg2;
...
+ (id)predicateMatchingConceptsWithAttributeType:(long long)arg1 beingsWithAttributeValue:(id)arg2;
