...
- (void)updateOntologyWithShardIdentifier:(id)arg1 schemaType:(id)arg2 schemaVersion:(long long)arg3 shardURL:(id)arg4 shardVersion:(long long)arg5 shouldPruneOldShard:(bool)arg6 reason:(long long)arg7 completion:(id /* block */)arg8;
