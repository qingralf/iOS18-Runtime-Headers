...
@interface HDProfile : NSObject <HDCloudSyncRepositoryProfile, HDHealthDaemonReadyObserver, HKAnalyticsHealthDataSource, HKFeatureAvailabilityHealthDataSource> {
    ...
    HDDaemon * _daemon;
    HDDatabaseDailyAnalytics * _dailyAnalytics;
    ...
    HDFeatureAvailabilityHealthDataRequirementEvaluationManager * _healthDataRequirementEvaluationManager;
    ...
    HKFeatureAvailabilityRequirementEvaluationDataSource * _requirementEvaluationDataSource;
...
@property (nonatomic, readonly) <HDActivityCacheManagerInterface> *activityCacheInterface;
...
@property (nonatomic, readonly) HDAssociationManager *associationManager;
...
@property (nonatomic, readonly) HDDatabaseDailyAnalytics *dailyAnalytics;
...
@property (nonatomic, readonly) HDFeatureAvailabilityHealthDataRequirementEvaluationManager *healthDataRequirementEvaluationManager;
...
@property (nonatomic, readonly) HDHeartProfileExtension *heartHealthProfileExtension;
@property (nonatomic, readonly) HDKeyValueDomainManager *keyValueDomainManager;
@property (nonatomic, readonly) HDProfile *legacyRepositoryProfile;
...
@property (nonatomic, readonly) HKFeatureAvailabilityRequirementEvaluationDataSource *requirementEvaluationDataSource;
...
- (id)healthDaemon;
- (id)healthDataRequirementEvaluationManager;
...
- (id)requirementEvaluationDataSource;
...
- (id)heartHealthProfileExtension;
