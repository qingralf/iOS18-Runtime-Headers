...
+ (id)clusterWorkoutWithWorkoutEntity:(id)arg1 transaction:(id)arg2 metadataManager:(id)arg3 error:(id*)arg4;
+ (id)clusterWorkoutWithWorkoutUUID:(id)arg1 transaction:(id)arg2 metadataManager:(id)arg3 error:(id*)arg4;
