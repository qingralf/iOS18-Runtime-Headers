...
@interface HDRestorableAlarmScheduler : NSObject <HDDatabaseProtectedDataObserver, HDDiagnosticObject, HDProfileReadyObserver, HDRestorableAlarmSchedulerProtocol> {
