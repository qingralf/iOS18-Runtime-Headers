...
- (id)fetchAllTransactionsWithError:(id*)arg1;
- (id)fetchCommittedTransactionsWithError:(id*)arg1;
- (id)initWithProfile:(id)arg1;
- (id)mostRecentTransactionCreationDateWithError:(id*)arg1;
- (bool)prepareAndCommitTransactionWithUUID:(id)arg1 sourceDeviceIdentifier:(id)arg2 metadata:(id)arg3 sharedSummaries:(id)arg4 error:(id*)arg5;
