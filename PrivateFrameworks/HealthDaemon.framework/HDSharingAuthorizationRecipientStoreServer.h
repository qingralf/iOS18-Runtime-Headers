...
@interface HDSharingAuthorizationRecipientStoreServer : HDStandardTaskServer <HDSharingAuthorizationManagerObserver, HKSharingAuthorizationRecipientStoreServerInterface> {
...
- (id)remoteInterface;
- (void)remote_fetchRecipientIdentifiersWithCompletion:(id /* block */)arg1;
