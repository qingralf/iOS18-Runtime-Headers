...
- (id)initWithProfile:(id)arg1 cachingSession:(id)arg2 gregorianCalendar:(id)arg3 morningIndexRange:(struct { long long x1; long long x2; })arg4 ascending:(bool)arg5 options:(unsigned long long)arg6 debugIdentifier:(id)arg7;
