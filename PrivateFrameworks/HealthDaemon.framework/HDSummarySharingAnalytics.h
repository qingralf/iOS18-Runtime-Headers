...
@interface HDSummarySharingAnalytics : NSObject {
    NSDate * _anySharingWithYouLastViewedDate;
...
@property (nonatomic, copy) NSDate *anySharingWithYouLastViewedDate;
...
- (void).cxx_destruct;
- (id)anySharingWithYouLastViewedDate;
...
- (void)setAnySharingWithYouLastViewedDate:(id)arg1;
