...
@interface HDSummarySharingEntryManager : NSObject <HDAnalyticsSubmissionCoordinatorDelegate, HDCloudSyncSummarySharingEntryManager, HDProfileReadyObserver> {
...
- (id)authorizationIdentifiersByContactIdentifiersForOutgoingPendingAndAcceptedParticipants:(id)arg1 error:(id*)arg2;
- (id)authorizationIdentifiersForEntriesNotPresentInSet:(id)arg1 error:(id*)arg2;
...
- (bool)lookupEntryWithPredicate:(id)arg1 wasFound:(bool*)arg2 error:(id*)arg3;
- (bool)pauseActiveEntriesWithError:(id*)arg1;
- (bool)pauseStatusForEntryWithUUID:(id)arg1 error:(id*)arg2;
- (void)pauseStatusesForUUIDS:(id)arg1 completion:(id /* block */)arg2;
- (id)profile;
