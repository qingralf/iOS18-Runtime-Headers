...
+ (bool)_determineIfEligibleForRefreshAndPerformRefreshOperationForConcept:(id)arg1 profile:(id)arg2 ontologyTransaction:(id)arg3 outRefreshedUserDomainConcept:(id*)arg4 error:(id*)arg5;
