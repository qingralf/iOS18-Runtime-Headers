...
+ (bool)enumerateCodableObjectsForPredicate:(id)arg1 limit:(long long)arg2 orderingTerms:(id)arg3 profile:(id)arg4 transaction:(id)arg5 error:(id*)arg6 handler:(id /* block */)arg7;
...
+ (bool)receiveSyncObjects:(id)arg1 version:(struct { int x1; int x2; })arg2 syncProvenance:(long long)arg3 profile:(id)arg4 error:(id*)arg5;
