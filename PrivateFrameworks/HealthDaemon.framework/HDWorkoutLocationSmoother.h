...
@interface HDWorkoutLocationSmoother : NSObject <CLLocationSmootherDelegate, HDDataObserver, HDDatabaseProtectedDataObserver, HDForegroundClientProcessObserver, HDProfileReadyObserver> {
