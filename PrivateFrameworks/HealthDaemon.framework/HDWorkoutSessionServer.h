...
@interface HDWorkoutSessionServer : NSObject <HDWorkoutDataSource, HDWorkoutSessionStateController, HKDataFlowLinkProcessor, HKStateMachineDelegate> {
    ...
    long long  _numberOfHeartbeatFailures;
...
@property (nonatomic, readonly) long long numberOfHeartbeatFailures;
...
- (bool)isMirroring;
- (bool)isPaused;
- (long long)numberOfHeartbeatFailures;
...
- (void)unitTest_setExtendedPauseInterval:(double)arg1;
