...
@interface _HDStatisticsSyntheticQuantityType : HKQuantityType <NSSecureCoding> {
    ...
    bool  _shouldUseUnderlyingTypeForStatistics;
...
+ (id)syntheticQuantityTypeWithUnderlyingSampleType:(id)arg1 aggregationStyle:(long long)arg2 canonicalUnit:(id)arg3 shouldUseUnderlyingTypeForStatistics:(bool)arg4;
...
- (void)setShouldUseUnderlyingTypeForStatistics:(bool)arg1;
