...
- (bool)_enumerateUDCTableInDatabase:(id)arg1 appendToFormatter:(id)arg2 error:(id*)arg3;
- (id)_expandResultsToIndividualSlots:(id)arg1;
- (void)_logAndAndAppendFormat:(id)arg1;
- (void)_reportBasicChecksForDatabase:(id)arg1;
- (void)_reportCountsForUDCTableRowsInDatabase:(id)arg1;
...
- (void)_reportUDCTableInDatabase:(id)arg1;
- (void)_reportUserDomainConcepts;
- (void)_reportUserDomainConceptsForDatabase:(id)arg1;
