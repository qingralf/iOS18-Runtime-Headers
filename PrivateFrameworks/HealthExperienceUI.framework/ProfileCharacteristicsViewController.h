...
@interface ProfileCharacteristicsViewController : UITableViewController <HKHealthSettingsNavigationDonaterConsuming, UINavigationControllerDelegate, UIPickerViewDataSource, UIPickerViewDelegate> {
...
+ (id)orderedRowIdentifiersBySectionIdentifierWithNameRowsHidden:(bool)arg1 pregnancySectionHidden:(bool)arg2 cardioFitnessMedicationsSectionHidden:(bool)arg3;
+ (id)orderedSectionIdentifiersWithPregnancySectionHidden:(bool)arg1 cardioFitnessMedicationsSectionHidden:(bool)arg2;
...
- (id)_meContact;
- (long long)_profileRowIdentifierForSection:(id)arg1;
- (void)_resetFirstAndLastNameValues;
- (void)_resetSelectedCell;
- (void)_setPregnancyCellDisplayValueForState:(bool)arg1;
