...
@interface WDPhysicalEffortAddDataViewController : WDAddDataViewController <WDAddDataManualEntryItemDelegate> {
    WDAddDataManualEntryItem * _dateRangeItem;
    WDAddDataManualEntryItem * _physicalEffortItem;
}
