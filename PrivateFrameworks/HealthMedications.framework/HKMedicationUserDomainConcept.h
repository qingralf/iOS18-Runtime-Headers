...
@interface HKMedicationUserDomainConcept : HKUserDomainConcept <NSCopying, NSSecureCoding> {
    ...
    NSDictionary * _localizedOntologyPregnancyTrimesterLactationRatings;
...
@property (nonatomic, readonly, copy) NSDictionary *localizedOntologyPregnancyTrimesterLactationRatings;
...
- (void).cxx_destruct;
- (id)_dataDescriptionAllowedForPublic:(bool)arg1;
- (id)_deepCopy;
...
- (id)localizedOntologyPregnancyTrimesterLactationRatings;
- (id)loggingUnit;
