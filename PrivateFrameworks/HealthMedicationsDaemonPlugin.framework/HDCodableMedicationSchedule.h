...
@property (nonatomic) bool hasDisplayOptions;
...
- (void)setDisplayOptions:(long long)arg1;
...
- (void)setHasDisplayOptions:(bool)arg1;
...
- (void)setScheduleType:(long long)arg1;
