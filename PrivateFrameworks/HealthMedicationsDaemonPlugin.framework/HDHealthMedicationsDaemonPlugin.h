...
@interface HDHealthMedicationsDaemonPlugin : NSObject <HDCloudSyncStateEntityProvider, HDDatabaseSchemaProvider, HDDemoDataGeneratorProvider, HDNotificationInstructionCriteriaProvider, HDOntologyFeatureEvaluatorProvider, HDOntologySchemaImporterProvider, HDPlugin, HDSyncEntityProvider, HDTaskServerClassProvider, HDUserDomainConceptEntityProvider>
...
- (id)createMedicationsDaemonExtensionForHealthDaemon:(id)arg1;
- (id)createMedicationsProfileExtensionForProfile:(id)arg1;
