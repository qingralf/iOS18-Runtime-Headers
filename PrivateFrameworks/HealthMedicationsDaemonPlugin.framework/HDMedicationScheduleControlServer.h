...
- (void)remote_logUnloggedMedicationsWithScheduledItemIdentifier:(id)arg1 status:(long long)arg2 logDate:(id)arg3 completion:(id /* block */)arg4;
...
- (void)remote_setTimeZoneTipAsDismissedWithCompletion:(id /* block */)arg1;
