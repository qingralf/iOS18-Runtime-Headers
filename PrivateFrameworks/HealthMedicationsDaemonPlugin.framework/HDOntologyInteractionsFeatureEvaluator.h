...
@interface HDOntologyInteractionsFeatureEvaluator : HDOntologyMedicationFeatureEvaluator <HDDrugInteractionFactorStateObserver, HDMedicationCountObserver, HDOntologyFeatureEvaluator> {
    <HDDrugInteractionFactorStateProvider> * _interactionFactorStateProvider;
...
- (void).cxx_destruct;
- (void)drugInteractionFactorStateProvider:(id)arg1 didObserveChangeForProfile:(id)arg2 hasDrugInteractionFactor:(long long)arg3;
- (id)featureIdentifier;
- (id)init;
- (id)initWithDaemon:(id)arg1;
- (id)initWithDaemon:(id)arg1 medicationCountProvider:(id)arg2 interactionFactorStateProvider:(id)arg3;
