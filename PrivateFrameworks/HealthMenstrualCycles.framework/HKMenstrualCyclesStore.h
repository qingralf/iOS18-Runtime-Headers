...
- (id)remoteInterface;
- (void)saveBleedingFlow:(long long)arg1 forBleedingType:(long long)arg2 dayIndex:(long long)arg3 completion:(id /* block */)arg4;
- (void)saveBleedingFlowByDayIndex:(id)arg1 forBleedingType:(long long)arg2 completion:(id /* block */)arg3;
