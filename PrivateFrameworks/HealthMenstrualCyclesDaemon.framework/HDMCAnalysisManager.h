...
@interface HDMCAnalysisManager : NSObject <HDDataObserver, HDDatabaseProtectedDataObserver, HDFeatureAvailabilityExtensionObserver, HKFeatureStatusProvidingObserver, HKMCAnalysisProviding, HKMCSettingsManagerObserver> {
...
- (id)_initWithProfile:(id)arg1 settingsManager:(id)arg2 featureAvailabilityManager:(id)arg3 heartRateAvailabilityManager:(id)arg4 wristTemperatureAvailabilityManager:(id)arg5 deviationsAvailabilityManager:(id)arg6 deviceScopedStorageManager:(id)arg7 calendarCache:(id)arg8 dayStreamProcessorProvider:(id /* block */)arg9 historicalAnalyzerProvider:(id /* block */)arg10;
...
- (id)profile;
- (id)queue;
- (void)registerObserver:(id)arg1 queue:(id)arg2 userInitiated:(bool)arg3;
