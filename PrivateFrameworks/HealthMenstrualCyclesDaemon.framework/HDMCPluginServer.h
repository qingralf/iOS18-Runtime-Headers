...
- (bool)_queue_saveBleedingFlowByDayIndex:(id)arg1 forBleedingType:(long long)arg2 calendarCache:(id)arg3 error:(id*)arg4;
- (bool)_queue_saveCategorySampleByDayIndex:(id)arg1 calendarCache:(id)arg2 readValueFromDaySummary:(id /* block */)arg3 categoryTypeIdentifier:(id)arg4 makeCategorySample:(id /* block */)arg5 error:(id*)arg6;
...
- (void)remote_saveBleedingFlow:(long long)arg1 forBleedingType:(long long)arg2 dayIndex:(long long)arg3 completion:(id /* block */)arg4;
- (void)remote_saveBleedingFlowByDayIndex:(id)arg1 forBleedingType:(long long)arg2 completion:(id /* block */)arg3;
