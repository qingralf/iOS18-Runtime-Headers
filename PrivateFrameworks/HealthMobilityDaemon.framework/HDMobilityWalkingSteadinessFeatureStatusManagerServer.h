...
- (id)initWithUUID:(id)arg1 configuration:(id)arg2 client:(id)arg3 delegate:(id)arg4 classificationsFeatureAvailabilityExtension:(id)arg5 mobilitySettingsDefaults:(id)arg6 featureStatusProvider:(id)arg7;
- (id)remoteInterface;
