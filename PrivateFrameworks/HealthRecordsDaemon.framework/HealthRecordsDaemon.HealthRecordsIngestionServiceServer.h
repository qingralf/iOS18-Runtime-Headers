...
- (void)remote_triggerDownloadIssuerRegistryWithOptions:(unsigned long long)arg1 completion:(id /* block */)arg2;
- (void)remote_triggerDownloadPublicKeysWithOptions:(unsigned long long)arg1 completion:(id /* block */)arg2;
