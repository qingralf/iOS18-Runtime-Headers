...
@interface HealthRecordsUI.RecordCategoryViewController : UIViewController <HKSidebarSelectionIdentifierProviding, UISearchControllerDelegate, UISearchResultsUpdating> {
