...
- (void).cxx_destruct;
- (id)_deepLinkOnboardingViewControllerWithOptions:(unsigned long long)arg1 sourceIdentifier:(id)arg2;
- (void)_didDismissLoginViewController:(id)arg1;
- (void)_dismissInFlightLoginViewControllerIfExistsWithCompletion:(id /* block */)arg1;
- (void)_onboardWithActivity:(id)arg1 gatewayProxy:(id)arg2 hasGatewayBackedAccounts:(bool)arg3 presentingViewController:(id)arg4;
- (void)_presentAccount:(id)arg1 presentingViewController:(id)arg2 sourceIdentifier:(id)arg3;
