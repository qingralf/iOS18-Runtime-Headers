...
@interface WDMedicalRecordTimelineContentSubtitleCell : WDMedicalRecordGroupableCell <WDAttributedSubtitleDisplayable> {
    NSUUID * _currentSignedClinicalDataRecordIdentifier;
...
@property (nonatomic, copy) NSUUID *currentSignedClinicalDataRecordIdentifier;
...
- (void).cxx_destruct;
- (id)currentSignedClinicalDataRecordIdentifier;
- (id)disclosureChevronView;
- (void)setAttributedSubtitleText:(id)arg1;
- (void)setCurrentSignedClinicalDataRecordIdentifier:(id)arg1;
