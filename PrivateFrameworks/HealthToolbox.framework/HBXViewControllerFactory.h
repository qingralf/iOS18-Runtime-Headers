...
@interface HBXViewControllerFactory : NSObject {
    <HKApplicationProviding> * _applicationProvider;
...
- (id)createClinicalDocumentOverviewViewControllerWithSidebarIdentifier:(id)arg1;
...
- (id)createDeviceStoredDataViewControllerForDevice:(id)arg1 displayName:(id)arg2 isBluetoothDevice:(bool)arg3 deviceIdentifier:(id)arg4 healthStore:(id)arg5 usingInsetStyling:(bool)arg6;
