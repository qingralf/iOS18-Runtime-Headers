...
@interface WDDocumentOverviewViewController : HKTableViewController <HKSidebarSelectionIdentifierProviding, WDUserActivityResponder> {
    UIFont * _bodyFont;
    ...
    NSString * _sidebarSelectionIdentifier;
...
@property (nonatomic, copy) NSString *sidebarSelectionIdentifier;
...
- (void)dealloc;
- (id)displayType;
- (id)initWithDisplayTypes:(id)arg1 profile:(id)arg2 title:(id)arg3 category:(id)arg4 sidebarIdentifier:(id)arg5;
...
- (void)setSidebarSelectionIdentifier:(id)arg1;
