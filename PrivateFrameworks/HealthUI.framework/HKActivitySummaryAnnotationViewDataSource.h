...
@interface HKActivitySummaryAnnotationViewDataSource : NSObject <HKInteractiveChartAnnotationViewDataSourceProtocol> {
    ...
    HKInteractiveChartAnnotationViewDataSource * _standardAnnotationDataSource;
    long long  _timeScope;
    HKUnitPreferenceController * _unitController;
    bool  _useStandardAnnotationDataSource;
...
@property (nonatomic, readonly) HKInteractiveChartAnnotationViewDataSource *standardAnnotationDataSource;
@property (readonly) Class superclass;
@property (nonatomic) long long timeScope;
@property (nonatomic, retain) HKUnitPreferenceController *unitController;
@property (nonatomic, readonly) bool useStandardAnnotationDataSource;
...
- (id)_pauseColumn;
- (id)_pauseTextColorForTimeScope:(long long)arg1;
- (id)_pauseTextForTimeScope:(long long)arg1;
...
- (id)initWithDisplayTypeController:(id)arg1 unitController:(id)arg2 wheelchairUseCharacteristicCache:(id)arg3 dateCache:(id)arg4 currentValueViewContext:(bool)arg5 activityOptions:(unsigned long long)arg6 firstWeekday:(long long)arg7 isChartSharingContext:(bool)arg8;
...
- (void)setStandardAnnotationViewDataSource:(id)arg1;
- (void)setTimeScope:(long long)arg1;
- (void)setUnitController:(id)arg1;
- (void)setWheelchairUseCharacteristicCache:(id)arg1;
- (bool)showSeparators;
- (id)standardAnnotationDataSource;
- (long long)timeScope;
- (id)unitController;
- (void)useActivityAnnotationViewDataSource;
- (bool)useStandardAnnotationDataSource;
- (void)useStandardAnnotationViewDataSourceForContext:(id)arg1 displayType:(id)arg2 timeScope:(long long)arg3 resolution:(long long)arg4 healthStore:(id)arg5 viewController:(id)arg6;
