...
- (id)_buildActivitySummaryFromAverages:(struct _WDActivitySummaryAverages { double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; })arg1 pausedAverages:(struct _WDActivitySummaryAverages { double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; })arg2 averagePeriod:(long long)arg3 startDate:(id)arg4 calendar:(id)arg5 energyUnit:(id)arg6 standHourUnit:(id)arg7;
