...
@interface HKAuthorizationSettingsViewController : HKTableViewController <HKHealthPrivacyServicePickerControllerDelegate, HKHealthPrivacyServicePromptController, HKSourceAuthorizationControllerDelegate, HKSwitchTableViewCellDelegate> {
...
- (void)_didFetchBackgroundAppRefreshStatus:(bool)arg1;
- (void)_displayGuestModeAlertWithCompletion:(id /* block */)arg1;
- (void)_done:(id)arg1;
- (void)_fetchBackgroundAppRefreshStatusWithHandler:(id /* block */)arg1;
- (void)_finishWithError:(id)arg1;
- (bool)_isTypeEnabledAtIndexPath:(id)arg1;
- (id)_localizedNameForSection:(long long)arg1 type:(id)arg2;
- (id)_localizedSourceExplanationWithDescription:(id)arg1 forReadingSection:(bool)arg2;
- (id)_openAppCell;
