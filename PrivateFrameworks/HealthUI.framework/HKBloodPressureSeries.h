...
@interface HKBloodPressureSeries : HKGraphSeries {
    HKBloodPressureSeriesPresentationStyle * _inactivePresentationStyleStorage;
    HKBloodPressureSeriesPresentationStyle * _selectedPresentationStyleStorage;
    <HKBloodPressureSeriesHighlightDelegate> * _seriesHighlightDelegateStorage;
    NSLock * _seriesMutableStateLock;
    HKBloodPressureSeriesPresentationStyle * _unselectedPresentationStyleStorage;
}

@property (nonatomic, retain) HKBloodPressureSeriesPresentationStyle *inactivePresentationStyle;
@property (nonatomic, retain) HKBloodPressureSeriesPresentationStyle *inactivePresentationStyleStorage;
...
@property (nonatomic) <HKBloodPressureSeriesHighlightDelegate> *seriesHighlightDelegate;
@property (nonatomic) <HKBloodPressureSeriesHighlightDelegate> *seriesHighlightDelegateStorage;
...
+ (id)_bloodPressurePresentationStyleWithSystolicColor:(id)arg1 diastolicColor:(id)arg2;
...
+ (id)defaultSeriesWithDiastolicColor:(id)arg1;
...
- (id)inactivePresentationStyleStorage;
- (id)init;
- (id)selectedPresentationStyle;
- (id)selectedPresentationStyleStorage;
- (id)seriesHighlightDelegate;
- (id)seriesHighlightDelegateStorage;
- (id)seriesMutableStateLock;
- (void)setInactivePresentationStyle:(id)arg1;
- (void)setInactivePresentationStyleStorage:(id)arg1;
- (void)setSelectedPresentationStyle:(id)arg1;
- (void)setSelectedPresentationStyleStorage:(id)arg1;
- (void)setSeriesHighlightDelegate:(id)arg1;
- (void)setSeriesHighlightDelegateStorage:(id)arg1;
