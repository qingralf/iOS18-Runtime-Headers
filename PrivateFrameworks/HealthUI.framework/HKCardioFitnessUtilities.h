...
+ (id)cardioFitnessInteractiveChartViewControllerWithDisplayDate:(id)arg1 applicationItems:(id)arg2 preferredOverlay:(long long)arg3 analyticsDelegate:(id)arg4 restorationUserActivity:(id)arg5 trendModel:(id)arg6 factorDisplayTypes:(id)arg7 additionalChartOptions:(unsigned long long)arg8;
...
+ (id)vo2MaxInteractiveChartViewControllerWithDisplayDate:(id)arg1 applicationItems:(id)arg2 restorationUserActivity:(id)arg3 trendModel:(id)arg4 factorDisplayTypes:(id)arg5 additionalChartOptions:(unsigned long long)arg6;
