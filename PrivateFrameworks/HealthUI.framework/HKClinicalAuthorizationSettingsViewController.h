...
@interface HKClinicalAuthorizationSettingsViewController : OBTableWelcomeController <HKHealthPrivacyServicePromptController, HKSwitchTableViewCellDelegate, UITableViewDataSource, UITableViewDelegate> {
...
- (id)footerStringforDate:(id)arg1 mode:(long long)arg2 source:(id)arg3;
- (id)init;
