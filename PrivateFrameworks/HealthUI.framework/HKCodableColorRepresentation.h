...
@interface HKCodableColorRepresentation : PBCodable <NSCopying> {
    ...
    HKCodableRGBConfiguration * _rgbConfiguration;
...
@property (nonatomic, readonly) bool hasRgbConfiguration;
@property (nonatomic, readonly) bool hasSemanticColorName;
@property (nonatomic, retain) NSString *objectTypeIdentifier;
@property (nonatomic, retain) HKCodableRGBConfiguration *rgbConfiguration;
...
- (void)setRgbConfiguration:(id)arg1;
