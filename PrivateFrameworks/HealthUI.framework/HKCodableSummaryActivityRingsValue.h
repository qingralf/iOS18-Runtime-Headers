...
@interface HKCodableSummaryActivityRingsValue : PBCodable <NSCopying> {
    ...
    struct APPLE_HKCodableSummaryActivityRingsValue_1 { 
        ...
        unsigned int activityResumeDate : 1; 
...
@property (nonatomic) bool hasActivityResumeDate;
...
- (void)setActivityResumeDate:(double)arg1;
...
- (void)setHasActivityResumeDate:(bool)arg1;
