...
- (void)_assignWalkingAsymmetryPercentageAxisForSeries:(id)arg1 standardAxisConfiguration:(id)arg2 externalAxisConfigurationOverrides:(id)arg3;
...
- (id)_generateAbnormalBreathingSeriesWithDisplayCategory:(id)arg1 timeScope:(long long)arg2;
...
- (id)_generateStandardSeriesForChartStyle:(long long)arg1 timeScope:(long long)arg2 chartSizeClass:(long long)arg3 axisConfiguration:(id)arg4 displayCategory:(id)arg5 unitController:(id)arg6;
