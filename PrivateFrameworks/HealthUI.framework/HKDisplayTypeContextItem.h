...
@interface HKDisplayTypeContextItem : NSObject {
    ...
    HKDisplayTypeContextItemAttributedLabelOverride * _attributedLabelTextOverride;
...
@property (nonatomic, copy) HKDisplayTypeContextItemAttributedLabelOverride *attributedLabelTextOverride;
