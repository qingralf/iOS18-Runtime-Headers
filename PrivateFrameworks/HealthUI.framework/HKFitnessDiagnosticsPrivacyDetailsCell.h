...
@interface HKFitnessDiagnosticsPrivacyDetailsCell : UITableViewCell {
    _HKFitnessDiagnosticsPrivacyBulletedListLayoutManager * _bulletLayoutManager;
...
@property (nonatomic, readonly) _HKFitnessDiagnosticsPrivacyBulletedListLayoutManager *bulletLayoutManager;
