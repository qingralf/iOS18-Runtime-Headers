...
@interface HKGraphSeries : NSObject <HKChartCachePriorityDelegate, HKGraphSeriesDataSourceDelegate> {
    ...
    bool  _drawSelectionLineBehindAllSeriesStorage;
...
@property (nonatomic) bool drawSelectionLineBehindAllSeries;
@property (nonatomic, readonly) bool drawSelectionLineBehindAllSeriesStorage;
...
- (void)setDrawSelectionLineBehindAllSeries:(bool)arg1;
