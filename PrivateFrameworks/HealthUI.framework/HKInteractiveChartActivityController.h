...
@interface HKInteractiveChartActivityController : HKInteractiveChartOverlayViewController <HKActivityBarSeriesDelegate, HKInteractiveChartViewObserver> {
...
+ (id)firstActivitySeriesForGraphView:(id)arg1;
...
- (id)_generateActivityBarSeriesWithColor:(id)arg1 legendTitle:(id)arg2 metGoalFillStyle:(id)arg3 missedGoalFillStyle:(id)arg4 pausedFillStyle:(id)arg5 activityValue:(long long)arg6 unitPreferenceController:(id)arg7 displayTypeController:(id)arg8 drawLegendsInsideSeries:(bool)arg9;
- (id)_generateActivityGoalLineSeriesWithColor:(id)arg1;
- (void)_handleAlternateAnnotationDataViewDataSource:(id)arg1;
...
- (id)_pausedFillStyleForActivityValue:(long long)arg1;
...
- (id)buildFactorContextForDisplayType:(id)arg1 factorDisplayType:(id)arg2 overlayChartController:(id)arg3 currentCalendarOverride:(id)arg4 applicationItems:(id)arg5 overlayMode:(long long)arg6;
