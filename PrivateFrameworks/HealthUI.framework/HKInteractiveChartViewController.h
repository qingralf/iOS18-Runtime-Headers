...
@interface HKInteractiveChartViewController : HKViewController <HKChartOverlayVersionProviding, HKCurrentTimeViewDelegate, HKCurrentValueViewDataSourceDelegate, HKGraphViewDelegate, HKInteractiveChartAnnotationViewDelegate, HKInteractiveChartCurrentValueViewCallbacks, HKInteractiveChartCurrentValueViewHandler, HKLollipopDelegate, HKMonthViewControllerDelegate, HKSampleTypeDateRangeControllerObserver, UIGestureRecognizerDelegate> {
    ...
    <HKInteractiveChartAnnotationViewDataSourceProtocol> * _annotationDataSource;
    ...
    bool  _firstSampleDateRangeUpdate;
    UIView * _graphBottomDividerView;
    UIView * _graphTopDividerView;
    bool  _hasInitialDateRangeAndTimeScope;
    ...
    NSArray * _stackedDisplayTypeHeights;
...
@property (nonatomic, retain) <HKInteractiveChartAnnotationViewDataSourceProtocol> *annotationDataSource;
...
@property (nonatomic) bool firstSampleDateRangeUpdate;
...
@property (nonatomic, retain) NSArray *stackedDisplayTypeHeights;
...
+ (void)_validateStackedHeights:(id)arg1;
...
- (id)_assembleValueViewString:(id)arg1;
...
- (id)primaryGraphSeriesForTimeScope:(long long)arg1;
...
- (void)removeStackedDisplayType:(id)arg1;
...
- (void)setFirstSampleDateRangeUpdate:(bool)arg1;
- (void)setHasInitialDateRangeAndTimeScope:(bool)arg1;
...
- (void)setStackedDisplayTypeHeights:(id)arg1;
...
- (id)stackedDisplayTypeHeights;
- (id)stackedSeriesGroupHeightsForGraphView:(id)arg1;
