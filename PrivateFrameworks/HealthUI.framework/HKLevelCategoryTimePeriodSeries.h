...
@property (nonatomic) bool roundDaySamples;
@property (nonatomic) bool roundDaySamplesStorage;
...
- (void).cxx_destruct;
- (double)_coordinateForNow:(id)arg1 pointTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg2;
...
- (void)setRoundDaySamples:(bool)arg1;
- (void)setRoundDaySamplesStorage:(bool)arg1;
