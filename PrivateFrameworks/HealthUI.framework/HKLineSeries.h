...
- (void).cxx_destruct;
- (id)_attributedAnnotationWithString:(id)arg1 labelStyle:(id)arg2;
...
- (void)_enumeratePathsFromBlockCoordinates:(id)arg1 axisRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 zoomLevelConfiguration:(id)arg3 transform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg4 presentationStyle:(id)arg5 caresAboutSelection:(bool)arg6 seriesRenderingDelegate:(id)arg7 forceGapBetweenUntransformedPoints:(id /* block */)arg8 handler:(id /* block */)arg9;
- (void)_enumerateSawToothPathsFromBlockCoordinates:(id)arg1 transform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg2 zoomLevelConfiguration:(id)arg3 presentationStyle:(id)arg4 caresAboutSelection:(bool)arg5 axisRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg6 seriesRenderingDelegate:(id)arg7 forceGapBetweenUntransformedPoints:(id /* block */)arg8 handler:(id /* block */)arg9;
...
- (void)_renderPointMarkersInContext:(struct CGContext { }*)arg1 blockCoordinates:(id)arg2 pointTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg3 presentationStyle:(id)arg4;
...
- (void)addAxisAnnotationForString:(id)arg1 modelCoordinate:(double)arg2 axisAnnotationDelegate:(id)arg3;
...
- (bool)connectPoint:(id)arg1 toPoint:(id)arg2;
