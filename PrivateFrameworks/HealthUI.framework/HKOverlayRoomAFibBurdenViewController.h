...
- (id)initWithDisplayDate:(id)arg1 applicationItems:(id)arg2 factorDisplayTypes:(id)arg3 mode:(long long)arg4 sleepDataSourceProvider:(id)arg5 sleepChartFormatter:(id)arg6 preferredOverlay:(long long)arg7 addDataViewControllerProvider:(id)arg8;
