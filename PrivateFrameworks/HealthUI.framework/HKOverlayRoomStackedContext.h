...
+ (id)generateDisplayTypeForTemplateDisplayType:(id)arg1 sampleType:(id)arg2 overlayChartController:(id)arg3 applicationItems:(id)arg4 currentTimeScope:(long long)arg5 currentCalendar:(id)arg6;

- (void).cxx_destruct;
- (id)_buildContextItemWithAttributedValue:(id)arg1 valueContext:(id)arg2 forTimeScope:(long long)arg3;
...
- (void)_setAccessibiltyIdentifier:(id)arg1 displayType:(id)arg2;
- (id)_setupContextItemForDisplayType:(id)arg1 timeScope:(long long)arg2 valueContext:(id)arg3;
- (id)applicationItems;
...
- (void)chartPointsForChartPointType:(unsigned long long)arg1 dateIntervals:(id)arg2 overlayChartController:(id)arg3 dateIntervalMustMatchView:(bool)arg4 timeScope:(long long)arg5 resolution:(long long)arg6 completion:(id /* block */)arg7;
...
- (void)setLastUpdatedItemFromPillValue:(id)arg1 timeScope:(long long)arg2 completion:(id /* block */)arg3;
