...
+ (id)attributedStringForSelectedRangeData:(id)arg1 font:(id)arg2 foregroundColor:(id)arg3 prefixColor:(id)arg4 prefersImageAffixes:(bool)arg5 embedded:(bool)arg6;
+ (void)clearCaches;
