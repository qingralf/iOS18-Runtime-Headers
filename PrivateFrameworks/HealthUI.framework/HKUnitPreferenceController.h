...
+ (void)unitPreferenceControllerWithHealthStore:(id)arg1 completion:(id /* block */)arg2;
...
- (void)_fetchHKUnitPreferencesWithAttempt:(long long)arg1 completion:(id /* block */)arg2;
- (id)_generateDefaultHKUnitPreferences;
- (void)_initHKUnitPreferencesWithCompletion:(id /* block */)arg1;
- (id)_initWithHealthStore:(id)arg1 completion:(id /* block */)arg2;
