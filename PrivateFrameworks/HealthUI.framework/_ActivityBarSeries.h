...
@interface _ActivityBarSeries : HKBarSeries {
    ...
    HKFillStyle * _pausedUnselectedFillStyle;
...
@property (nonatomic, retain) HKFillStyle *pausedUnselectedFillStyle;
...
- (void)setPausedUnselectedFillStyle:(id)arg1;
