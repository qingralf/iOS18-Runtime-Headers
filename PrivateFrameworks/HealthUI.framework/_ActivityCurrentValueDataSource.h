...
- (id)initWithDisplayTypeController:(id)arg1 unitController:(id)arg2 wheelchairUseCharacteristicCache:(id)arg3 currentValueViewContext:(bool)arg4 firstWeekday:(long long)arg5 activityOptions:(unsigned long long)arg6 currentValueViewCallbacks:(id)arg7 isChartSharingContext:(bool)arg8;
