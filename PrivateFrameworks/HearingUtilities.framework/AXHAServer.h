...
- (void)_registerUpdateBlock:(id)arg1 forIdentifier:(unsigned long long)arg2 listenerHash:(id)arg3;
...
- (void)registerUpdateBlock:(id)arg1 forIdentifier:(unsigned long long)arg2 withListener:(id)arg3;
- (void)registerUpdateBlock:(id)arg1 forIdentifier:(unsigned long long)arg2 withListener:(id)arg3 listenerHash:(id)arg4;
...
- (void)unregisterLiveListenLevelListener:(id)arg1;
