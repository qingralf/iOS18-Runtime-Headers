...
@interface AXHearingAidDevice : NSObject <AXHADeviceProtocol, CBPeripheralDelegate> {
    ...
    bool  _requiresBinauralStreaming;
    bool  _requiresCombinedPresets;
    bool  _requiresCombinedVolumes;
    BOOL  _rightBass;
...
@property (nonatomic, readonly) bool isAnyPeripheralInConnectingState;
...
- (id)description;
- (id)descriptionForCBPeripheralState:(long long)arg1;
...
- (void)setLeftLeaVersion:(unsigned long long)arg1;
...
- (void)setRequiresBinauralStreaming:(bool)arg1;
- (void)setRequiresCombinedPresets:(bool)arg1;
- (void)setRequiresCombinedVolumes:(bool)arg1;
...
- (void)setRightLeaVersion:(unsigned long long)arg1;
