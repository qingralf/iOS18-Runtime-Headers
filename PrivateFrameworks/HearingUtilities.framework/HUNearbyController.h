...
@property (nonatomic, readonly) NSArray *availableWatches;
...
@property (nonatomic, retain) AXDispatchTimer *startTimer;
...
- (id)descriptionForPriority:(unsigned long long)arg1;
...
- (void)logNearbyDevices:(id)arg1 withTitle:(id)arg2;
- (id)loggingUpdates;
- (id)messageUpdates;
...
- (void)processIDSDevices:(id)arg1;
...
- (void)sendMessage:(id)arg1 toDevicesWithDomain:(id)arg2 excludingState:(id)arg3 withPriority:(unsigned long long)arg4;
- (void)sendMessage:(id)arg1 toDevicesWithDomain:(id)arg2 withPriority:(unsigned long long)arg3;
- (void)sendMessage:(id)arg1 toWatchDevicesWithDomain:(id)arg2 excludingState:(id)arg3 withPriority:(unsigned long long)arg4;
- (void)sendMessage:(id)arg1 toWatchDevicesWithDomain:(id)arg2 withPriority:(unsigned long long)arg3;
