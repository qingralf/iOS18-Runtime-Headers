...
- (void)logNoiseBuffer:(id)arg1 calculatedLeq:(float)arg2;
- (void)logThresholdTransitionForSample:(id)arg1;
...
- (bool)shouldShowHearingProtectionSuggestionForAlertType:(unsigned long long)arg1;
