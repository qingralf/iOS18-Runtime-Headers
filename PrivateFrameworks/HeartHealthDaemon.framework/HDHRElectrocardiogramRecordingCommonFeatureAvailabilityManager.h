...
@interface HDHRElectrocardiogramRecordingCommonFeatureAvailabilityManager : NSObject <HDDatabaseProtectedDataObserver, HDFeatureAvailabilityExtension, HDHealthDaemonReadyObserver, HDPairedDeviceCapabilityProvidingObserver> {
    ...
    <HDHRElectrocardiogramDeviceSupportedStateProvider> * _deviceSupportedProvider;
...
- (id)_onboardedCountryCodeSupportedStateWithOnboardingCompletion:(id)arg1 error:(id*)arg2;
...
- (id)initWithProfile:(id)arg1 featureIdentifier:(id)arg2 onboardingVersion:(unsigned long long)arg3 pairedFeatureAttributesProvider:(id)arg4 disableAndExpiryProvider:(id)arg5 regionAvailabilityProvider:(id)arg6 deviceSupportedProvider:(id)arg7 availabilityRequirementSet:(id)arg8 cacheDefaults:(id)arg9 isStandalone:(bool)arg10;
