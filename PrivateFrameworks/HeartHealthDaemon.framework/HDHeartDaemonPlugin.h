...
@interface HDHeartDaemonPlugin : NSObject <HDCloudSyncStateEntityProvider, HDDatabaseSchemaProvider, HDDemoDataGeneratorProvider, HDPlugin, HDTaskServerClassProvider> {
