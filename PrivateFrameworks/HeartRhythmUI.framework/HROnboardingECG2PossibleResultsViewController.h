...
@interface HROnboardingECG2PossibleResultsViewController : HKOnboardingBaseViewController <HKAdaptiveModalPresented, HRLinkTextViewDelegate, HRStackedButtonViewDelegate> {
...
@property (nonatomic, retain) HROnboardingElectrocardiogramResultView *poorRecordingResultView;
...
- (void)setPoorRecordingResultView:(id)arg1;
