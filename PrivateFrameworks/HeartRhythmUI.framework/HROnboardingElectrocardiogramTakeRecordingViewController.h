...
@interface HROnboardingElectrocardiogramTakeRecordingViewController : HKOnboardingBaseViewController <HKAdaptiveModalPresented, HKHeartRhythmAvailabilityObserver> {
    UIView * _assetView;
