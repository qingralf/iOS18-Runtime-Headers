...
+ (id)_valuesAtTargetStateForCharacteristics:(id)arg1 targetValuesKeyedByCharacteristicIdentifier:(id)arg2 valueSource:(id)arg3 actionSet:(id)arg4 logger:(id)arg5;
+ (id)_valuesAtTargetStateForMatterActions:(id)arg1;
+ (id)_valuesAtTargetStateForMediaActions:(id)arg1 targetValuesKeyedByCharacteristicIdentifier:(id)arg2 valueSource:(id)arg3 actionSet:(id)arg4 logger:(id)arg5;
+ (id)_valuesAtTargetStateForNaturalLightActions:(id)arg1 valueSource:(id)arg2;
