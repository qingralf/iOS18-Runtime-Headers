...
@interface HFCameraPlaybackEngine : NSObject <HFCameraClipPlayerDelegate, HFCameraLiveStreamControllerDelegate, HMCameraRecordingEventManagerObserver> {
    NSSet * _batchedRecordingEvents;
    NSObject<OS_dispatch_source> * _batchedRecordingEventsTimer;
    ...
    <HFCameraClipPlaying> * _overrideClipPlayer;
    <HFCameraLiveStreamControlling> * _overrideLiveStreamController;
    ...
    bool  _shouldBatchRecordingEvents;
...
@property (nonatomic, retain) NSSet *batchedRecordingEvents;
@property (nonatomic, retain) NSObject<OS_dispatch_source> *batchedRecordingEventsTimer;
...
@property (nonatomic, readonly) HMCameraClip *clipWithLongestDuration;
...
@property (nonatomic, retain) <HFCameraClipPlaying> *overrideClipPlayer;
@property (nonatomic, retain) <HFCameraLiveStreamControlling> *overrideLiveStreamController;
...
- (void)_fetchCameraEventsWithCompletion:(id /* block */)arg1;
- (void)_recordingEventManager:(id)arg1 didUpdateRecordingEvents:(id)arg2;
...
- (id)batchedRecordingEvents;
- (id)batchedRecordingEventsTimer;
- (void)beginScrubbing;
- (id)cameraClips;
- (id)cameraEvents;
- (id)cameraProfile;
...
- (id)observerStates;
- (id)observers;
- (id)overrideClipPlayer;
- (id)overrideLiveStreamController;
- (void)pause;
- (void)play;
...
- (void)setBatchedRecordingEvents:(id)arg1;
- (void)setBatchedRecordingEventsTimer:(id)arg1;
...
- (void)setOverrideClipPlayer:(id)arg1;
- (void)setOverrideLiveStreamController:(id)arg1;
...
- (void)setShouldBatchRecordingEvents:(bool)arg1;
