...
- (void)_didGeneratePosterFrame:(id)arg1 forHighQualityClip:(id)arg2 atOffset:(double)arg3 withTimelapseOffset:(double)arg4;
- (void)_failedToDownloadVideoFileForClip:(id)arg1;
- (void)_failedToFindTimelapseClipForHighQualityClip:(id)arg1;
- (void)_failedToGeneratePosterFrameForHighQualityClip:(id)arg1 atOffset:(double)arg2;
