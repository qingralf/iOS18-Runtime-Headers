...
@property (nonatomic, readonly) <HFCharacteristicOperationContextProviding> *contextProvider; /* unknown property attribute: ? */
...
- (void)invalidateCachedErrorForCharacteristic:(id)arg1;
...
- (void)setCachedReadError:(id)arg1 forCharacteristic:(id)arg2;
- (void)setCachedReadErrorsKeyedByCharacteristicIdentifier:(id)arg1;
- (void)setCachedWriteError:(id)arg1 forCharacteristic:(id)arg2;
