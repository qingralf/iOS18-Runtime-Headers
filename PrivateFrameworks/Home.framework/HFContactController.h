...
@property (nonatomic, retain) NSMutableDictionary *recipientToRestrictedGuestIDSCapability;

+ (id)contactForAppleID:(id)arg1 keyDescriptors:(id)arg2;
...
- (bool)hasRestrictedGuestIDSCapabilityForDestination:(id)arg1;
- (id)init;
- (id)initWithKeyDescriptors:(id)arg1;
- (void)markDestinationsPending:(id)arg1;
- (id)pendingDestinations;
- (id)recipientAvailabilities;
- (id)recipientToRestrictedGuestIDSCapability;
- (void)restrictedGuestIDSCapabilityUpdated:(id)arg1;
...
- (void)setRecipientToRestrictedGuestIDSCapability:(id)arg1;
