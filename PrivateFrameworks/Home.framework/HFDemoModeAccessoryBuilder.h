...
@property (nonatomic, readonly) NSArray *availableIconDescriptors; /* unknown property attribute: ? */
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (readonly, copy) NSString *description;
@property (readonly) unsigned long long hash;
@property (nonatomic, retain) <HFIconDescriptor> *iconDescriptor; /* unknown property attribute: ? */
@property (nonatomic) bool isFavorite; /* unknown property attribute: ? */
...
@property (nonatomic) bool showInHomeDashboard; /* unknown property attribute: ? */
