...
@property (nonatomic, readonly) HFAccessoryDiagnosticInfoManager *diagnosticInfoManager;
...
+ (id)configuration;
+ (void)initialize;
+ (void)setAllowHomeSensingOverride:(bool)arg1;
+ (void)setAutomaticallySynchronizesHomeDataModel:(bool)arg1;
+ (void)setConfiguration:(id)arg1;
+ (void)setOverrideSynchronizesHomeDataModel:(bool)arg1;
...
- (void)_fetchSettingsForLightProfiles:(id)arg1;
...
- (void)addDiagnosticInfoObserver:(id)arg1;
...
- (void)dealloc;
- (id)diagnosticInfoManager;
- (void)disconnectDataModelDelegatesWithReason:(id)arg1;
...
- (void)reconnectDataModelDelegatesWithReason:(id)arg1;
...
- (void)removeDiagnosticInfoObserver:(id)arg1;
