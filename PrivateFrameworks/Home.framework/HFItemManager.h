...
@interface HFItemManager : NSObject <HFAccessoryObserver, HFAudioControlObserver, HFCameraObserver, HFExecutionEnvironmentObserver, HFHomeKitAccessorySettingsDataSourceDelegate, HFHomeKitSettingsObserver, HFHomeManagerObserver, HFHomeObserver, HFItemUpdating, HFLightObserver, HFMediaDestinationControllerObserver, HFMediaObjectObserver, HFMediaSessionObserver, HFNetworkConfigurationObserver, HFPersonManagerObserver, HFPinCodeManagerObserver, HFResidentDeviceObserver, HFSiriEndpointProfileObserver, HFSoftwareUpdateControllerObserver, HFSoftwareUpdateObserver, HFStateDumpBuildable, HFSymptomFixSessionObserver, HFSymptomsHandlerObserver, HFTelevisionObserver, HFTemperatureUnitObserver, HFUserObserver, HFWalletKeyDeviceStateObserver> {
...
@property (nonatomic, retain) id matterSnapshotObserverCancelable;
...
- (bool)disableExternalUpdatesWithReason:(id)arg1;
...
- (bool)endDisableExternalUpdatesWithReason:(id)arg1;
...
- (void)setMatterSnapshotObserverCancelable:(id)arg1;
