...
- (void).cxx_destruct;
- (id)_actionItemForAccessory:(id)arg1 addedActionsItems:(id)arg2 home:(id)arg3;
...
- (id)_addOrUpdateMatterActionItemForAction:(id)arg1 actionBuilder:(id)arg2 addedActionsItems:(id)arg3 home:(id)arg4;
- (id)_createActionItemForCharacteristic:(id)arg1 home:(id)arg2;
- (id)_createActionItemForMediaProfile:(id)arg1 home:(id)arg2;
- (id)_createMatterActionItemFor:(id)arg1 home:(id)arg2 actionSetBuilder:(id)arg3;
...
- (bool)isMatterServiceActionItem:(id)arg1 forAccessoryID:(id)arg2;
- (id)items;
- (id)reloadItems;
