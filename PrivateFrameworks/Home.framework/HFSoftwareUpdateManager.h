...
@interface HFSoftwareUpdateManager : NSObject <HFAccessoryDiagnosticInfoManagerDelegate, HFAccessoryObserver, HFAccessorySoftwareUpdateControllerV2Observer, HFExecutionEnvironmentObserver, HFHomeObserver, HFSoftwareUpdateObserver> {
...
- (void).cxx_destruct;
- (void)_didReceiveUpdateForAccessory:(id)arg1 update:(id)arg2;
...
- (void)dealloc;
- (void)didUpdateDiagnosticInfo:(id)arg1 forAccessory:(id)arg2;
- (id)dispatcher;
...
- (id)softwareUpdateDisplayableVersion:(id)arg1;
