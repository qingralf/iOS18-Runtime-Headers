...
- (id)_hasDismissedWalletKeyFeatureOnboardingForKeyPath:(id)arg1 onThisDeviceKeyPath:(id)arg2;
...
- (id)_setDismissWalletKeyFeatureOnboarding:(bool)arg1 forWalletKeyUUID:(id)arg2 featureDescription:(id)arg3 keyPath:(id)arg4 keyOnThisDevice:(id)arg5;
...
- (id)initWithHome:(id)arg1 user:(id)arg2 nameStyle:(unsigned long long)arg3 userDefaults:(id)arg4;
...
- (id)setDismissUtilityOnboarding:(bool)arg1;
