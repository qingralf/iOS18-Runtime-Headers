...
@interface HMIVideoAnalyzerState : HMFObject <HMFLogging> {
    unsigned long long  _activeAnalyzersCount;
    double  _analysisFPS;
    ...
    bool  _thermalAndSystemResourceUsageLevelIgnored;
...
@property (readonly) unsigned long long activeAnalyzersCount;
...
@property (getter=isThermalAndSystemResourceUsageLevelIgnored, readonly) bool thermalAndSystemResourceUsageLevelIgnored;
...
- (void).cxx_destruct;
- (id)JSONObject;
- (unsigned long long)activeAnalyzersCount;
- (double)analysisFPS;
