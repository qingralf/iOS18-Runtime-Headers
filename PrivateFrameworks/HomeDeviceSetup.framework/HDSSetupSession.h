...
@interface HDSSetupSession : NSObject <AVAudioPlayerDelegate, SignpostProviding> {
    ...
    bool  _canDoV2TermsAndConditions;
    ...
    unsigned long long  _delayForOdeonStereoPairSeconds;
    ...
    bool  _enablementProfileInstalled;
    ...
    bool  _homePodSysDropCapable;
    bool  _homePodSysDropCapableV2;
    ...
    id /* block */  _promptForLocationAlreadyEnabledHandler;
    id /* block */  _promptForLocationEnableHandler;
    id /* block */  _promptForLoggingProfileTransferAck;
    ...
    id /* block */  _promptForTermsAndConditionsV2Disagree;
    id /* block */  _promptForTermsHandler;
    id /* block */  _promptForVoiceRecognitionHandler;
    ...
    SysDropSession * _sysDropSession;
    bool  _termsAgreed;
    bool  _termsAndConditionsServersActive;
    bool  _termsAndConditionsV2Shown;
    int  _termsState;
...
@property (nonatomic, retain) NSError *mainError;
...
@property (nonatomic, copy) id /* block */ promptForLocationAlreadyEnabledHandler;
@property (nonatomic, copy) id /* block */ promptForLocationEnableHandler;
@property (nonatomic, copy) id /* block */ promptForLoggingProfileTransferAck;
...
@property (nonatomic, copy) id /* block */ promptForTermsAndConditionsV2Disagree;
@property (nonatomic, copy) id /* block */ promptForTermsHandler;
@property (nonatomic, copy) id /* block */ promptForVoiceRecognitionHandler;
...
@property (nonatomic, retain) SysDropSession *sysDropSession;
...
- (void)_invalidate;
- (bool)_isPreflightError:(id)arg1;
...
- (void)_logWiFiRetryMetrics:(id)arg1;
- (void)_logiTunesAuthRetryMetrics:(id)arg1 durationSeconds:(double)arg2 authType:(int)arg3 retryAttempt:(int)arg4;
...
- (void)_startSysDropMode:(id)arg1;
- (void)_startSysDropSysdiagnoseRequest:(id)arg1;
...
- (unsigned long long)delayForOdeonStereoPairSeconds;
...
- (void)homePodLoggingProfileSelected:(int)arg1;
...
- (id /* block */)promptForLocationAlreadyEnabledHandler;
- (id /* block */)promptForLocationEnableHandler;
- (id /* block */)promptForLoggingProfileTransferAck;
...
- (id /* block */)promptForTermsAndConditionsV2Disagree;
- (id /* block */)promptForTermsHandler;
- (id /* block */)promptForVoiceRecognitionHandler;
...
- (void)setDelayForOdeonStereoPairSeconds:(unsigned long long)arg1;
...
- (void)setPromptForLocationAlreadyEnabledHandler:(id /* block */)arg1;
- (void)setPromptForLocationEnableHandler:(id /* block */)arg1;
- (void)setPromptForLoggingProfileTransferAck:(id /* block */)arg1;
...
- (void)setPromptForTermsAndConditionsV2Disagree:(id /* block */)arg1;
- (void)setPromptForTermsHandler:(id /* block */)arg1;
- (void)setPromptForVoiceRecognitionHandler:(id /* block */)arg1;
...
- (void)setSysDropSession:(id)arg1;
...
- (bool)shouldDoSysDrop:(unsigned int)arg1;
