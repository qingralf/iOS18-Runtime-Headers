...
@interface HMBCloudZone : HMFObject <HMBMirrorProtocol, HMFLogging> {
    ...
    <NAScheduler> * _operationScheduler;
...
- (id)encodeRecordFromModel:(id)arg1 existingRecord:(id)arg2 error:(id*)arg3;
...
- (bool)populateV4CloudRecord:(id)arg1 withModel:(id)arg2 metadataFieldData:(id)arg3 startEncoding:(unsigned long long)arg4 endEncoding:(unsigned long long)arg5 encodingContext:(id)arg6 error:(id*)arg7;
