...
- (void)_updateCacheWithModificationResponses:(id)arg1;
...
- (id)addNewAccessCode:(id)arg1 forUserWithUUID:(id)arg2 toAccessoriesWithUUIDs:(id)arg3 withRetries:(bool)arg4;
...
- (id)removeAccessCode:(id)arg1 fromHAPAccessory:(id)arg2;
