...
@property (nonatomic, readonly, copy) NSString *displayableFirmwareVersion;
@property (readonly, copy) NSUUID *endpointIdentifier;
@property (retain) <HMDFeaturesDataSource> *featuresDataSource;
@property (nonatomic, copy) HMDAccessoryVersion *firmwareVersion;
...
- (void)setDisplayableFirmwareVersion:(id)arg1;
