...
@interface HMDAccessoryBrowser : HMFObject <HAPAccessoryServerBrowserDelegate, HAPAccessoryServerDelegate, HMDAccessoryBrowserHapProtocol, HMDAccessoryBrowserProtocol, HMDAuthServerDelegate, HMDMediaBrowserDelegate, HMDWACAccessoryConfigurationDelegate, HMDWACBrowserDelegate, HMDWatchSystemStateDelegate, HMFLogging, HMFMessageReceiver, HMFTimerDelegate, HMMTRHAPAccessoryServerBrowserPairingDelegate, HMMTRHAPAccessoryServerPairingDelegate> {
...
- (void)_accessoryServer:(id)arg1 didStopPairingWithError:(id)arg2 matterPairingEndContext:(id)arg3;
- (void)_accessoryServerBrowser:(id)arg1 didRemoveAccessoryServer:(id)arg2 error:(id)arg3 matterPairingEndContext:(id)arg4;
...
- (void)_cancelPairingWithAccessory:(id)arg1 error:(id)arg2 context:(id)arg3;
- (void)_cancelPairingWithAccessoryDescription:(id)arg1 error:(id)arg2 context:(id)arg3;
...
- (bool)_isHomeHubAvailableWithConfiguration:(id)arg1;
...
- (bool)_isPrimaryResidentReachableWithConfiguration:(id)arg1;
...
- (void)_removePairingInformation:(id)arg1 error:(id)arg2 context:(id)arg3;
...
- (void)_sendPairingCompletionStatusForServer:(id)arg1 error:(id)arg2 matterPairingEndContext:(id)arg3 completionHandler:(id /* block */)arg4;
- (void)_setBTLEPowerChangeCompletionHandler;
- (void)_setupHMMTRAccessoryServer:(id)arg1 pairingInfo:(id)arg2;
...
- (void)accessoryServer:(id)arg1 didStopPairingWithError:(id)arg2 matterPairingEndContext:(id)arg3;
- (void)accessoryServer:(id)arg1 didUpdateCategory:(id)arg2;
- (void)accessoryServer:(id)arg1 didUpdateConnectionState:(bool)arg2 linkLayerType:(long long)arg3 bookkeeping:(id)arg4 withError:(id)arg5;
...
- (void)accessoryServerBrowser:(id)arg1 cacheOperationalCertData:(id)arg2 forFabricID:(id)arg3;
...
- (void)accessoryServerBrowser:(id)arg1 didRemoveAccessoryServer:(id)arg2 error:(id)arg3 matterPairingEndContext:(id)arg4;
...
- (void)accessoryServerBrowser:(id)arg1 getCachedOperationalCertificateDataForFabricID:(id)arg2 completion:(id /* block */)arg3;
...
- (void)accessoryServerBrowser:(id)arg1 getLockedState:(bool*)arg2;
...
- (bool)btlePowerState;
- (void)cancelPairingWithAccessory:(id)arg1 error:(id)arg2 context:(id)arg3;
- (void)cancelPairingWithAccessoryDescription:(id)arg1 error:(id)arg2;
- (void)cancelPairingWithAccessoryDescription:(id)arg1 error:(id)arg2 context:(id)arg3;
