...
- (bool)isAccessoryVersionInSyncWithAssetVersion:(id)arg1 matterFirmwareRevisionNumber:(id)arg2 assetVersionString:(id)arg3 matterFirmwareRevisionString:(id)arg4;
...
- (id)logEventManager;
- (id)logIdentifier;
- (unsigned long long)matterFirmwareUpdateRetryCount;
...
- (void)setMatterFirmwareUpdateRetryCount:(unsigned long long)arg1;
