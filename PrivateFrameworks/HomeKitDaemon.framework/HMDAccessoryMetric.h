...
@property (nonatomic, readonly) NSArray *deltaCounters;
@property (readonly, copy) NSString *description;
@property (nonatomic, readonly) HMDAccessoryDiagnosticsMetric *diagnosticsMetric;
@property (readonly) unsigned long long hash;
@property (nonatomic, retain) NSDictionary *previousDiagnosticMetrics;
...
- (id)logIdentifier;
- (id)previousDiagnosticMetrics;
- (id)sessionMetric;
- (void)setAccessoryMetricTimer:(id)arg1;
- (void)setPreviousDiagnosticMetrics:(id)arg1;
