...
@interface HMDActionSet : HMFObject <HMDApplicationDataContainer, HMDBackingStoreObjectProtocol, HMDHomeMessageReceiver, HMFDumpState, HMFLogging, HMFTimerDelegate, NSSecureCoding> {
...
@property (nonatomic, retain) HMFTimer *executionTimeoutTimer;
...
- (id)executionMessage;
- (id)executionStart;
- (id)executionTimeoutTimer;
- (void)handleExecutionCompletionWithResponsePayload:(id)arg1 error:(id)arg2;
...
- (id)initWithName:(id)arg1 uuid:(id)arg2 type:(id)arg3 home:(id)arg4 queue:(id)arg5 notificationCenter:(id)arg6;
- (void)invalidate;
...
- (void)setExecutionTimeoutTimer:(id)arg1;
