...
- (void)setProcessAbnormalExitCount:(long long)arg1;
...
- (void)setV2ElectionPercentageDurationCurrentDeviceIsInPrimaryMesh:(long long)arg1;
...
- (long long)v2ElectionPercentageDurationCurrentDeviceIsInPrimaryMesh;
