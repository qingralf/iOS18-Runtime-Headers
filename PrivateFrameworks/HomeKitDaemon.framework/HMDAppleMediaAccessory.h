...
@interface HMDAppleMediaAccessory : HMDMediaAccessory <HMDAccessorySettingsControllerDataSource, HMDAccessorySettingsControllerDelegate, HMDAccessoryUserManagement, HMDAppleMediaAccessoryInfoControllerDataSource, HMDAppleMediaAccessoryInfoControllerDelegate, HMDAppleMediaAccessoryInfoSubscriberDataSource, HMDAppleMediaAccessoryInfoSubscriberDelegate, HMDAppleMediaAccessoryLocalMessageHandlerDataSource, HMDAppleMediaAccessoryMessageRouterDataSource, HMDAppleMediaAccessoryMessengerFactory, HMDAppleMediaAccessoryMetricsDispatcherDataSource, HMDAppleMediaAccessorySensorManagerDataSource, HMDAppleMediaAccessorySleepWakeStateControllerDataSource, HMDDeviceControllerDelegate, HMDFetchedAccessorySettingsControllerDataSource, HMDLanguageValueListSettingDataProvider, HMDMediaDestinationControllerDataSource, HMDMediaDestinationControllerDelegate, HMDMediaDestinationControllerFactory, HMDMediaDestinationManagerDataSource, HMDMediaDestinationManagerDelegate, HMDMediaDestinationManagerFactory, HMDPreferredMediaUserEventControllerDataSource, HMDRemoteDeviceMonitorDeviceRegistrationClient, HMFLogging> {
    ...
    NSPredicate * _audioAnalysisEventNotificationCondition;
    bool  _audioAnalysisEventNotificationEnabled;
    ...
    <HMDSoftwareUpdateInstallProvider> * _softwareUpdateInstallProvider;
    <HMDSoftwareUpdateEventProvider> * _softwareUpdateProvider;
...
@property (getter=isAudioAnalysisEventNotificationEnabled) bool audioAnalysisEventNotificationEnabled;
...
@property (nonatomic, retain) <HMDarwinNotificationProvider> *darwinNotificationProvider;
...
@property (nonatomic, readonly) HMDDoorbellChimeProfile *doorbellChimeProfile;
...
@property (nonatomic, readonly) bool isDoorbellChimeSettingEnabled;
...
@property (retain) <HMDSoftwareUpdateInstallProvider> *softwareUpdateInstallProvider;
@property (retain) <HMDSoftwareUpdateEventProvider> *softwareUpdateProvider;
...
- (void)_installManagedConfigurationProfileWithData:(id)arg1 completion:(id /* block */)arg2;
...
- (bool)_shouldFilterAccessoryProfileForEntitledClients:(id)arg1;
...
- (id)assistantObject;
- (id)audioAnalysisEventNotificationCondition;
...
- (void)handleInstallManagedConfigurationProfile:(id)arg1;
...
- (bool)hasValidHome:(id)arg1 backingStore:(id)arg2 messageDispatcher:(id)arg3;
...
- (id)initWithDependencyFactory:(id)arg1 deviceMediaRouteIdentifierFactory:(id /* block */)arg2;
...
- (void)setAudioAnalysisEventNotificationCondition:(id)arg1;
- (void)setAudioAnalysisEventNotificationEnabled:(bool)arg1;
...
- (void)setDarwinNotificationProvider:(id)arg1;
...
- (void)setSoftwareUpdateInstallProvider:(id)arg1;
...
- (id)softwareUpdateInstallProvider;
