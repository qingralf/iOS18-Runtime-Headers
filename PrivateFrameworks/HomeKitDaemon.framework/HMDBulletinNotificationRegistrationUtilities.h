...
+ (id)endpointRegistrationFromLocalRegistration:(id)arg1;
+ (id)matterRegistrationFromLocalRegistration:(id)arg1 home:(id)arg2;
+ (id)matterRegistrationFromMKFRegistration:(id)arg1 home:(id)arg2;
