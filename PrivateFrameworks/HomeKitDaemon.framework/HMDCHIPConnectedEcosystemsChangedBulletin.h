...
+ (id)localizedBodyForAccessoryName:(id)arg1;
+ (id)localizedBodyForAppleEcosystemWithAccessoryName:(id)arg1;
+ (id)localizedBodyForEcosystemName:(id)arg1 accessoryName:(id)arg2;
+ (id)localizedTitle;
