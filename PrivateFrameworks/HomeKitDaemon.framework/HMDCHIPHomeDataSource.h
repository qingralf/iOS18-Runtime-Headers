...
@interface HMDCHIPHomeDataSource : HMFObject <HMMTRFabricDataFetcherCHIPStorageDelegate, HMMTRFabricStorageDataSource> {
    NSNumber * _fabricID;
    HMDHome * _home;
...
- (id)allNodeIDs;
- (id)allStorageDataSourcesForDeviceWithNodeID:(id)arg1;
- (id)fabricID;
- (id)home;
- (id)identifier;
