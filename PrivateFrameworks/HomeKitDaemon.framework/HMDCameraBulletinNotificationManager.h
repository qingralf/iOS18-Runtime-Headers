...
- (void)_handleSignificantEvent:(id)arg1 cameraProfile:(id)arg2;
- (void)_handleSignificantEvent:(id)arg1 remoteRegistration:(id)arg2;
- (void)_handleSignificantEventWithUUID:(id)arg1 reason:(unsigned long long)arg2 dateOfOccurrence:(id)arg3 confidenceLevel:(unsigned long long)arg4 faceClassifications:(id)arg5 cameraProfile:(id)arg6;
...
- (void)handleSignificantEvent:(id)arg1 cameraProfile:(id)arg2;
- (id)home;
