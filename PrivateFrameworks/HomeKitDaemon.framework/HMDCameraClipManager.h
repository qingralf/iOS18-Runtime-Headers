...
@interface HMDCameraClipManager : HMFObject <HMBCloudZoneDelegate, HMBLocalZoneDelegate, HMBLocalZoneModelObserver, HMDActiveXPCClientConnectionsPeriodicTimerDelegate, HMDDatabaseZoneManagerDataSource, HMDDatabaseZoneManagerDelegate, HMFLogging, HMFMessageReceiver> {
...
- (id)cloudZone;
- (void)cloudZone:(id)arg1 didEncounterZoneDisabledError:(id)arg2;
- (void)configure;
- (id)delegate;
...
- (id)home;
- (id)initWithHome:(id)arg1 zoneName:(id)arg2 messageDispatcher:(id)arg3 workQueue:(id)arg4 cameraProfileUUID:(id)arg5;
