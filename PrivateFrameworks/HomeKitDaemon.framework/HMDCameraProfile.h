...
@interface HMDCameraProfile : HMDAccessoryProfile <HMDCameraClipManagerDelegate, HMDCameraSettingProactiveReaderDelegate, HMFNetMonitorDelegate, HMFTimerDelegate> {
...
- (void)_postLocalNotificationForUpdatedSignificantEvent:(id)arg1;
...
- (void)clipManagerDidEncounterDisabledCloudStorage:(id)arg1;
