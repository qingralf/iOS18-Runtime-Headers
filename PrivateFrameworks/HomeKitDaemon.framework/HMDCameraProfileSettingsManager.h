...
@interface HMDCameraProfileSettingsManager : HMFObject <HMBCloudZoneDelegate, HMBLocalZoneDelegate, HMBLocalZoneModelObserver, HMDCameraProfileSettingsQuotaCoordinatorDelegate, HMDCharacteristicsAvailabilityListenerDelegate, HMDDatabaseZoneManagerDataSource, HMDDatabaseZoneManagerDelegate, HMFLogging, HMFMessageReceiver> {
...
- (void)_handleSynchronizeCloudStorageWithRecordingAccessModesMessage:(id)arg1;
...
- (id)_processingOptionsForLabel:(id)arg1;
- (bool)_setAnyUserAtHomeFromPresenceMonitorWithHome:(id)arg1;
...
- (id)initWithUniqueIdentifier:(id)arg1 hapAccessory:(id)arg2 workQueue:(id)arg3 zoneManager:(id)arg4 notificationCenter:(id)arg5 bulletinBoard:(id)arg6 characteristicsAvailabilityListener:(id)arg7 quotaCoordinator:(id)arg8 featuresDataSource:(id)arg9;
- (id)isAnyUserAtHome;
...
- (id)uniqueIdentifier;
- (void)updateSettingsModelUsingBlock:(id /* block */)arg1 completion:(id /* block */)arg2;
- (id)workQueue;
- (id)zoneManager;
