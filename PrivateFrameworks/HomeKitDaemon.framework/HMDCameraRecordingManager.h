...
- (id)_createRecordingSessionWithSelectedConfiguration:(id)arg1 homePresenceByPairingIdentity:(id)arg2;
...
- (void)_submitRecordingSessionLogEventWithError:(id)arg1;
- (id)accessory;
- (id)activeRecordingSessions;
- (void)assignAccessoryConnectionInfoUsingMessagePayload:(id)arg1;
...
- (id)logIdentifier;
- (id)messagePayloadForStartRecordingSessionWithTriggerType:(unsigned long long)arg1;
...
- (void)setRecordingSessionLogEvent:(id)arg1;
