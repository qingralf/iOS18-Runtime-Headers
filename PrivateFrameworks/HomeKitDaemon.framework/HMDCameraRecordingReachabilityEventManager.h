...
- (id)currentSettings;
- (id)didHandleInitialReachabilityFuture;
...
- (void)setDidHandleInitialReachabilityFuture:(id)arg1;
...
- (bool)shouldAddInitialReachabilityEventForCurrentCameraReachability:(bool)arg1 mostRecentReachabilityEventModel:(id)arg2;
