...
@property (getter=isPrimaryResident, readonly) bool primaryResident;
...
- (bool)_shouldReconfigureForChangedCharacteristic:(id)arg1;
...
- (id)recordingService;
- (id)recordingSupportedAudioConfigurationCharacteristic;
- (id)recordingSupportedGeneralConfigurationCharacteristic;
- (id)recordingSupportedVideoConfigurationCharacteristic;
