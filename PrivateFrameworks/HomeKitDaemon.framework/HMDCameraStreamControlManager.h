...
- (id)accessory;
- (id)delegate;
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 streamSnapshotHandler:(id)arg3 delegate:(id)arg4 accessory:(id)arg5 streamManagementService:(id)arg6 isLocal:(bool)arg7;
- (id)logIdentifier;
- (id)managerProtocol;
- (id)sessionID;
