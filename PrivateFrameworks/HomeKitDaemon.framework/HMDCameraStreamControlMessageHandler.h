...
@property (readonly) bool hasStreamSession;
@property (readonly) bool hasStreamSessionShowingOnCurrentDevice;
...
+ (bool)_isUpdateMaximumVideoResolutionQualityMessage:(id)arg1;
+ (id)logCategory;
...
- (void)_handleUpdateMaximumVideoResolutionQualityMessage:(id)arg1;
...
- (void)setNegotiationMilestone:(id)arg1;
...
- (void)takeOwnershipOfStreamUsingMessage:(id)arg1;
