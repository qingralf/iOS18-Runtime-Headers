...
- (id)currentAccessoryCapabilitiesInternal;
- (void)currentAccessoryDidBecomeAvailable;
- (id)currentResidentCapabilities;
- (id)currentResidentCapabilitiesInternal;
...
- (id)logIdentifier;
- (void)setCurrentAccessoryCapabilitiesInternal:(id)arg1;
- (void)setCurrentResidentCapabilitiesInternal:(id)arg1;
