...
@property (nonatomic, readonly, copy) NSNumber *changeThresholdForEnabledNotifications;
@property (nonatomic, readonly, copy) NSNumber *changeThresholdForNonHomeClientEnabledNotifications;
...
- (id)bulletinContext;
- (id)changeThresholdForEnabledNotifications;
- (id)changeThresholdForNonHomeClientEnabledNotifications;
...
- (void)setNotificationEnabled:(bool)arg1 forClientIdentifier:(id)arg2 changeThreshold:(id)arg3;
- (bool)setNotificationEnabled:(bool)arg1 forClientIdentifier:(id)arg2 changeThreshold:(id)arg3 removeLast:(bool)arg4;
...
- (bool)shouldUpdateValueFromHAPCharacteristic:(id)arg1;
