...
- (id)_grantAccessForUserWithAccountHandle:(id)arg1 share:(id)arg2 logEventBuilder:(id)arg3;
...
- (id)grantAccessForUserWithAccountHandle:(id)arg1 share:(id)arg2 logEventBuilder:(id)arg3;
