...
- (id)delegate;
- (id)home;
- (id)initWithDatabase:(id)arg1 zoneName:(id)arg2 home:(id)arg3 messageTargetUUID:(id)arg4 workQueue:(id)arg5;
- (id)initWithDatabase:(id)arg1 zoneName:(id)arg2 home:(id)arg3 shareMessenger:(id)arg4 workQueue:(id)arg5;
- (id)localZone;
- (id)logIdentifier;
