...
@property (nonatomic, copy) NSNumber *supportsCompanionInitiatedObliterate;
...
@property (nonatomic, copy) NSNumber *supportsCoordinationFreeDoorbellChime;
...
@property (nonatomic, copy) NSNumber *supportsMatterOwnerCertFetch;
...
@property (nonatomic, copy) NSNumber *supportsTVOSUpdateManualUpdateAvailableNotification;
...
@property (nonatomic, copy) NSNumber *supportsThreadService;
