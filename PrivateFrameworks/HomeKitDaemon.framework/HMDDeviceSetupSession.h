...
- (id)initWithIdentifier:(id)arg1 role:(long long)arg2 homeManager:(id)arg3 upSecondsFactory:(id /* block */)arg4 userDefaults:(id)arg5;
- (id)internal;
...
- (void)updateAccessoryUUIDAndNotifyDelegate:(id)arg1 accessoryIDSIdentifier:(id)arg2 accessoryCategory:(id)arg3;
