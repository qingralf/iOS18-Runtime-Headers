...
- (id)logIdentifier;
- (void)notifyAccessoriesViaCoordinationFreePathWithDelay:(double)arg1 home:(id)arg2 shouldPlayChime:(bool)arg3 personIdentificationText:(id)arg4 accessoriesToNotify:(id)arg5 logEvent:(id)arg6 accessoryUUID:(id)arg7;
