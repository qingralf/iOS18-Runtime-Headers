...
- (id)createEventModel:(id)arg1 endEvent:(bool)arg2 message:(id)arg3 checkForSupport:(bool)arg4 transaction:(id)arg5 error:(id*)arg6;
- (id)currentEvents;
- (void)dealloc;
...
- (Class)eventTriggerTypeToEventClass:(id)arg1;
- (id)events;
- (bool)executeOnce;
