...
@interface HMDHAPAccessory : HMDAccessory <HAPAccessoryDelegate, HAPAccessoryServerNotification, HMDAccessoryMinimumUserPrivilegeCapable, HMDAccessoryUserManagement, HMDMatterAccessoryProtocol, HMDServiceOwner, HMDSiriEndpointProfileMetricsDispatcherDataSource, HMDSiriEndpointProfileMetricsDispatcherFactory, HMFTimerDelegate, HMMTRAccessoryServerDelegate> {
    ...
    HMMTRAccessoryServer * _chipAccessoryServer;
    NSString * _chipExtendedMACAddress;
    HMDCHIPAccessoryStorage * _chipStorage;
    NSNumber * _chipWEDSupport;
...
@property (nonatomic, readonly) NSMutableSet *activeSessionRestoreClients;
...
@property (nonatomic, retain) HMDMatterAccessoryDiagnosticsManager *matterDiagnosticManager;
...
@property (nonatomic, copy) NSNumber *supportedLinkLayerTypes;
...
- (void)_createDiagnosticManagerForMatterDevice:(id)arg1;
- (id)_createDiagnosticsManager:(id)arg1;
- (void)_deregisterAllClientsFromSessionRestore;
- (void)_deregisterFromSessionRestore:(id)arg1;
...
- (bool)_handleUpdatedServicesForNetworkRouterController:(id)arg1;
...
- (id)_notificationRegistrationsByClientIDForCharacteristics:(id)arg1;
...
- (void)_registerForSessionRestore:(id)arg1;
...
- (void)_setNotificationsEnabled:(bool)arg1 forCharacteristics:(id)arg2 notificationChangeThresholds:(id)arg3 clientIdentifier:(id)arg4 matchingHAPAccessory:(id)arg5;
- (void)_setTargetControllerSession;
- (bool)_shouldFilterAccessoryProfileForUnentitledClients:(id)arg1;
...
- (bool)_updateNetworkRouterControllerUsingRouterService:(id)arg1;
...
- (id)accessoryDiagnosticCounters;
- (id)accessoryDiagnosticEvents;
...
- (id)anyIPServer;
- (void)assignBonjourDeviceInfo:(id)arg1 socketInfo:(id)arg2;
- (id)assistantObject;
...
- (id)chipHomeDataSourceWithFabricID:(id)arg1 home:(id)arg2;
- (id)chipNodeId;
- (id)chipStorage;
...
- (bool)custom1WoBLE;
- (id)dataFromAttributeReport:(id)arg1;
...
- (void)didUpdateConnectionState:(bool)arg1 sessionInfo:(id)arg2 linkLayerType:(long long)arg3 bookkeeping:(id)arg4 withError:(id)arg5;
...
- (id)fabricDataFetcherWithCHIPStorageDelegate:(id)arg1 keychainDelegate:(id)arg2;
...
- (void)handleCHIPSendRemoteRequestMessage:(id)arg1 chipAccessoryServer:(id)arg2;
...
- (void)handleGetAccessoryDiagnosticCountersMessage:(id)arg1;
- (void)handleGetAccessoryDiagnosticEventsMessage:(id)arg1;
- (void)handleGetAllUsersMessage:(id)arg1;
- (void)handleGetStartUpColorTemperature:(id)arg1;
...
- (void)handleSetStartUpColorTemperature:(id)arg1;
...
- (void)handleUpdatedPairings:(id)arg1 previousPairings:(id)arg2;
...
- (id)lightProfileWithNaturalLighting;
- (id)lightProfiles;
...
- (id)matchingHAPAccessoryWithServerIdentifier:(id)arg1 instanceID:(id)arg2;
...
- (id)rootPublicKeysOfHomes:(id)arg1 keychainDelegate:(id)arg2;
...
- (void)setMatterDiagnosticManager:(id)arg1;
...
- (void)setNotificationsEnabled:(bool)arg1 forCharacteristics:(id)arg2 notificationChangeThresholds:(id)arg3 clientIdentifier:(id)arg4;
- (void)setNotificationsEnabled:(bool)arg1 forCharacteristics:(id)arg2 notificationChangeThresholds:(id)arg3 clientIdentifier:(id)arg4 matchingHAPAccessory:(id)arg5;
...
- (void)submitCharacteristicWriteErrorLogEvent:(id)arg1 startTime:(double)arg2 message:(id)arg3 error:(id)arg4;
...
- (void)unconfigureWithCompletion:(id /* block */)arg1;
- (id)uniqueIdentifier;
...
- (id)urlString;
- (id)valueFromAttribute:(id)arg1;
- (void)verifyPairingWithCompletionHandler:(id /* block */)arg1;
- (id)waitForChipAccessoryServerWithFlow:(id)arg1;
