...
- (void).cxx_destruct;
- (void)_sendCharacteristicNotificationsForTaskInProgress:(id)arg1 completion:(id /* block */)arg2;
- (void)_updateCharacteristicsWithResponses:(id)arg1 accessoryRequests:(id)arg2 completedGroup:(id)arg3;
- (id /* block */)_updatedCompletion:(id /* block */)arg1;
- (id)activity;
- (void)addCharacteristicResponses:(id)arg1 isRemote:(bool)arg2;
