...
@property (nonatomic, retain) NSString *chipExtendedMACAddress;
...
@property (nonatomic, retain) NSNumber *chipWEDSupport;
...
@property (nonatomic, retain) NSNumber *matterSoftwareVersionNumber;
