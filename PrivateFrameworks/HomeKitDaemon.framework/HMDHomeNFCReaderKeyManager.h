...
- (void)createReaderKeyKeychainItemForHome:(id)arg1 isForceUpdate:(bool)arg2 flow:(id)arg3 completion:(id /* block */)arg4;
- (id)dataSource;
- (void)deleteKeychainItemForNFCReaderKeyIsForceUpdate:(bool)arg1 withFlow:(id)arg2 completion:(id /* block */)arg3;
- (id)fetchOrCreateReaderKeyForPairingWithFlow:(id)arg1;
- (void)fetchOrCreateReaderKeyOnQueueWithRequiresPrivateKey:(bool)arg1 flow:(id)arg2 completion:(id /* block */)arg3;
...
- (id)requestPrimaryResidentToFetchOrCreateReaderKeyWithFlow:(id)arg1;
- (void)requestPrimaryResidentToFetchOrCreateReaderKeyWithFlow:(id)arg1 completion:(id /* block */)arg2;
- (void)rollReaderKeyWithFlow:(id)arg1 withCompletion:(id /* block */)arg2;
