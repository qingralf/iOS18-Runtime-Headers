...
- (id)_canonicalModelFromSharedHomes:(id)arg1;
...
- (id)_existingSharedHomeWithoutShareWithHomeModelID:(id)arg1 error:(id*)arg2;
...
- (id)grantAccessForUser:(id)arg1 home:(id)arg2 logEventBuilder:(id)arg3;
...
- (void)updateSharedOwnerAccountHandleForHome:(id)arg1;
