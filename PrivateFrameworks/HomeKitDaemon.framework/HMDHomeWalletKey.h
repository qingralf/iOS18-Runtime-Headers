...
- (id)homeName;
- (id)initWithPKPass:(id)arg1 flow:(id)arg2;
- (id)initWithTypeIdentifier:(id)arg1 serialNumber:(id)arg2 state:(long long)arg3 walletKeyDescription:(id)arg4 homeName:(id)arg5 color:(long long)arg6 nfcInfos:(id)arg7;
