...
@property (nonatomic, readonly) NSNumber *accessoryLinkType;
...
- (id)accessoryLinkType;
- (id)accessoryProductID;
- (id)accessoryVendorID;
- (id)coreAnalyticsEventDictionary;
- (id)coreAnalyticsEventName;
- (unsigned long long)coreAnalyticsEventOptions;
- (id)initWithAccessory:(id)arg1 linkType:(id)arg2 accessorySoftwareVersionNumber:(id)arg3 updateSoftwareVersionNumber:(id)arg4 error:(id)arg5;
