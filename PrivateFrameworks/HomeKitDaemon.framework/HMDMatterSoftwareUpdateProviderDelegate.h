...
- (bool)canEstablishConnectionForHMDHAPAccessory:(id)arg1;
...
- (void)notifyCheckFirmwareUpdateSessionWithPairing:(id)arg1 queue:(id)arg2 completionHandler:(id /* block */)arg3;
