...
+ (long long)_daysSinceSoftwareUpdateFrom:(id)arg1 dateProvider:(id)arg2;
+ (long long)internalDeviceDaysSinceSoftwareUpdate;
+ (id)lastUpdateForSoftwareVersion:(id)arg1 dateProvider:(id)arg2 userDefaults:(id)arg3 updateDefaultsIfNeeded:(bool)arg4;
