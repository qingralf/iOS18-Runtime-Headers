...
@interface HMDPredicateUtilities : HMFObject <HMFLogging> {
    ...
    HMDHome * _home;
    id /* block */  _homePresenceProvider;
...
@property (nonatomic, readonly) id /* block */ homePresenceProvider;
...
- (id)home;
- (id /* block */)homePresenceProvider;
- (id)initWithHome:(id)arg1 logIdentifier:(id)arg2;
- (id)initWithHome:(id)arg1 logIdentifier:(id)arg2 homePresenceProvider:(id /* block */)arg3;
- (id)logIdentifier;
