...
@interface HMDPrimaryElectionCoordinationAddOn : NSObject <HMDLocalElectionMeshControllerDelegate, HMDPrimaryResidentElectionAddOn, HMFLogging, HMFMessageReceiver, HMFTimerDelegate> {
    ...
    unsigned long long  _coordinationUpdateElectionTriggerReason;
...
- (id)context;
- (unsigned long long)coordinationUpdateElectionTriggerReason;
- (id)dataSource;
- (id)debounceTimer;
- (id)delegate;
- (id)dumpState;
...
- (void)handleSetPreferredPrimaryDebugRequest:(id)arg1;
...
- (void)selectPrimaryResidentWithReason:(unsigned long long)arg1;
- (id)selectedPrimaryResidentCandidate;
- (void)setActiveNodesUpdateDebounceTimer:(id)arg1;
- (void)setCoordinationUpdateElectionTriggerReason:(unsigned long long)arg1;
