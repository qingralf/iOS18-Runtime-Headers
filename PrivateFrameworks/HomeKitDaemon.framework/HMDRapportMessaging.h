...
- (bool)isRapportDeviceDiscoveredWithIdentifier:(id)arg1;
- (id)reachabilityDelegate;
- (void)registerRequestHandler:(id /* block */)arg1;
- (void)sendRequest:(id)arg1 requestID:(id)arg2 destinationID:(id)arg3 options:(id)arg4 responseHandler:(id /* block */)arg5;
