...
- (void)_handleMultiHopFetchResponse:(id)arg1 originalMessage:(id)arg2;
...
- (void)client:(id)arg1 fetchWithFilters:(id)arg2 isMultiHop:(bool)arg3 completion:(id /* block */)arg4;
...
- (id)client:(id)arg1 sendConnectWithAddedFilters:(id)arg2 completion:(id /* block */)arg3;
...
- (id)identifier;
- (id)initWithMessageTargetUUID:(id)arg1 queue:(id)arg2 dataSource:(id)arg3 messageDispatcher:(id)arg4 notificationCenter:(id)arg5 requestMessageName:(id)arg6 updateMessageName:(id)arg7 multiHopFetchResponseMessageName:(id)arg8 logCategory:(const char *)arg9 logEventSubmitter:(id)arg10 eventRouterClientFactory:(id /* block */)arg11;
- (id)initWithMessageTargetUUID:(id)arg1 queue:(id)arg2 dataSource:(id)arg3 messageDispatcher:(id)arg4 notificationCenter:(id)arg5 requestMessageName:(id)arg6 updateMessageName:(id)arg7 multiHopFetchResponseMessageName:(id)arg8 storeReadHandle:(id)arg9 storeWriteHandle:(id)arg10;
- (id)initWithMessageTargetUUID:(id)arg1 queue:(id)arg2 dataSource:(id)arg3 messageDispatcher:(id)arg4 notificationCenter:(id)arg5 requestMessageName:(id)arg6 updateMessageName:(id)arg7 multiHopFetchResponseMessageName:(id)arg8 storeReadHandle:(id)arg9 storeWriteHandle:(id)arg10 logCategory:(const char *)arg11;
- (id)initWithMessageTargetUUID:(id)arg1 queue:(id)arg2 dataSource:(id)arg3 messageDispatcher:(id)arg4 notificationCenter:(id)arg5 requestMessageName:(id)arg6 updateMessageName:(id)arg7 multiHopFetchResponseMessageName:(id)arg8 storeReadHandle:(id)arg9 storeWriteHandle:(id)arg10 retryIntervalProvider:(id)arg11 logCategory:(const char *)arg12;
- (bool)isConnected;
...
- (id)multiHopFetchResponseMessageName;
- (void)networkAvailabilityDidChange:(bool)arg1;
- (id)notificationCenter;
- (id)requestMessageName;
- (id /* block */)responseHandlerForMessageIdentifier:(id)arg1 serverIdentifier:(id)arg2 messageType:(long long)arg3 completion:(id /* block */)arg4;
...
- (id)sendMessageWithPayloadMessage:(id)arg1 client:(id)arg2 messageType:(long long)arg3 completion:(id /* block */)arg4;
