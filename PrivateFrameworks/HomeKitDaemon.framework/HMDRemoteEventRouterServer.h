...
@interface HMDRemoteEventRouterServer : NSObject <HMEMessageDatagramServerDataSource, HMEMessageDatagramServerDelegate, HMEThreadSafePendingEventsCollectionDelegate, HMFLogging, HMFMessageReceiver> {
...
- (void)_handleFetchEventsRequest:(id)arg1 originalMessage:(id)arg2 connectionMode:(long long)arg3;
...
- (id)initWithPrimaryModeUUID:(id)arg1 residentModeUUID:(id)arg2 queue:(id)arg3 messageDispatcher:(id)arg4 dataSource:(id)arg5 notificationCenter:(id)arg6 requestMessageName:(id)arg7 updateMessageName:(id)arg8 multiHopFetchResponseMessageName:(id)arg9 logCategory:(const char *)arg10 logEventSubmitter:(id)arg11 connectionServerFactory:(id /* block */)arg12;
- (id)initWithPrimaryModeUUID:(id)arg1 residentModeUUID:(id)arg2 queue:(id)arg3 messageDispatcher:(id)arg4 dataSource:(id)arg5 notificationCenter:(id)arg6 requestMessageName:(id)arg7 updateMessageName:(id)arg8 multiHopFetchResponseMessageName:(id)arg9 subscriptionProvider:(id)arg10 registrationEventRouter:(id)arg11 storeReadHandle:(id)arg12;
...
- (void)pendingEventCollectionDidComplete:(id)arg1;
- (void)pendingEventsCollectionDidAddItems:(id)arg1;
