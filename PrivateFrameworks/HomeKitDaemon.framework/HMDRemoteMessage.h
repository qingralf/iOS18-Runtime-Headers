...
@property (nonatomic) bool disallowsIDSRacing;
...
+ (id)secureMessageWithName:(id)arg1 qualityOfService:(long long)arg2 destination:(id)arg3 messagePayload:(id)arg4 timeout:(double)arg5 restriction:(unsigned long long)arg6;
...
- (void)setDisallowsIDSRacing:(bool)arg1;
