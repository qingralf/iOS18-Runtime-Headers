...
- (int)_serverHandleCommitRequest:(id)arg1 options:(id)arg2 responseHandler:(id /* block */)arg3;
- (int)_serverHandleDecryptedRequest:(id)arg1 options:(id)arg2 responseHandler:(id /* block */)arg3;
- (void)_serverHandleEncryptedRequest:(id)arg1 options:(id)arg2;
- (int)_serverHandlePrepareRequest:(id)arg1 options:(id)arg2 responseHandler:(id /* block */)arg3;
