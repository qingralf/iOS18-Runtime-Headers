...
@interface HMDServiceGroup : HMFObject <HMDApplicationDataContainer, HMDBackingStoreObjectProtocol, HMDHomeMessageReceiver, HMFDumpState, HMFLogging, NSSecureCoding> {
