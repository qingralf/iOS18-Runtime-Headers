...
- (void)_requestUserPermissionForBridgeAccessory:(id)arg1 withContext:(id)arg2 queue:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (void)_requestUserPermissionForUnauthenticatedAliroLockWithContext:(id)arg1 queue:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (void)displayInternalTTRErrorWithContext:(id)arg1 message:(id)arg2 waitForResponse:(bool)arg3 completionHandler:(id /* block */)arg4;
...
- (void)requestUserPermissionForUnauthenticatedAliroLockWithContext:(id)arg1 queue:(id)arg2 completionHandler:(id /* block */)arg3;
