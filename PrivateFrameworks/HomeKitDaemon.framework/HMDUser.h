...
@property (readonly) <HAPKeyStore> *keyStore;
...
+ (unsigned long long)hmdUserPrivilegeFromHMMTRUserPrivilege:(unsigned long long)arg1;
+ (unsigned long long)hmmtrUserPrivilegeFromHMDUserPrivilege:(unsigned long long)arg1;
+ (id)logCategory;
...
+ (id)userDictionaryWithUserID:(id)arg1 privilege:(unsigned long long)arg2 remoteAccessAllowed:(bool)arg3 cameraAccessLevel:(unsigned long long)arg4 announceAccessAllowed:(id)arg5 announceAccessLevel:(unsigned long long)arg6 audioAnalysisUserDropInAccessLevel:(unsigned long long)arg7;
...
- (void)fetchPairingIdentityForClientWithMessage:(id)arg1;
...
- (id)initWithAccountHandle:(id)arg1 homeUUID:(id)arg2 pairingIdentity:(id)arg3 privilege:(unsigned long long)arg4 keyStore:(id)arg5 dataSource:(id)arg6;
...
- (id)matterCASEAuthenticatedTagID;
...
- (id)newModelWithChangeType:(unsigned long long)arg1;
...
- (void)setMatterCASEAuthenticatedTagID:(id)arg1;
...
- (unsigned long long)userAccessPolicy;
