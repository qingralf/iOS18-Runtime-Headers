...
@interface HMDWakeConfiguration : NSObject <HAPTLVProtocol, NSCopying> {
    HMDWakeConfigurationParameters * _custom1;
    HMDWakeConfigurationParameters * _custom2;
    NSData * _reserved;
}

@property (nonatomic, retain) HMDWakeConfigurationParameters *custom1;
@property (nonatomic, retain) HMDWakeConfigurationParameters *custom2;
