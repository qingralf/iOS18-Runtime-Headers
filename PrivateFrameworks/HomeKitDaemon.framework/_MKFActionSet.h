...
- (id)createActionsRelationOfTypeMatterCommandActionWithModelID:(id)arg1;
...
- (id)findActionsRelationOfTypeMatterCommandActionWithModelID:(id)arg1;
...
- (id)materializeOrCreateActionsRelationOfTypeMatterCommandActionWithModelID:(id)arg1 createdNew:(bool*)arg2;
