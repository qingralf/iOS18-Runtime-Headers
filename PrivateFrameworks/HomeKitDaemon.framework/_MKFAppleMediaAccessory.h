...
@property (nonatomic, retain) NSData *accessoryCapabilities;
@property (nonatomic, copy) NSNumber *accessoryCategory;
@property (nonatomic, readonly, retain) NSArray *actionMediaPlaybacks;
@property (nonatomic, readonly, retain) NSArray *actionsAppleMediaAccessoryPower;
@property (nonatomic, retain) NSSet *actionsAppleMediaAccessoryPower_;
...
@property (nonatomic, readonly, copy) MKFAppleMediaAccessoryDatabaseID *databaseID;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (readonly, copy) NSString *description;
@property (nonatomic, retain) _MKFDevice *device;
@property (nonatomic, retain) <MKFDevice> *device;
@property (nonatomic, retain) NSData *deviceIRKData;
...
- (id)_analysisPredicateToFetchBulletinRegistrationOnDeviceIdsIdentifier:(id)arg1 user:(id)arg2;
- (id)actionsAppleMediaAccessoryPower;
- (id)analysisBulletinRegistrationWithDeviceIdsIdentifier:(id)arg1 user:(id)arg2 context:(id)arg3;
