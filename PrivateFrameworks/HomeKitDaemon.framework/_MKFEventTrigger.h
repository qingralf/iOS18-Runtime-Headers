...
- (id)createEventsRelationOfTypeMatterAttributeValueEventWithModelID:(id)arg1;
...
- (id)findEventsRelationOfTypeMatterAttributeValueEventWithModelID:(id)arg1;
...
- (id)materializeOrCreateEventsRelationOfTypeMatterAttributeValueEventWithModelID:(id)arg1 createdNew:(bool*)arg2;
