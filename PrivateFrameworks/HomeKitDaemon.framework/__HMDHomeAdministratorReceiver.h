...
@interface __HMDHomeAdministratorReceiver : HMFObject <HMDAdministratorMessageReceiver, HMFLogging, HMFMessageReceiver> {
...
- (void)dealloc;
- (void)handleAdministratorMessage:(id)arg1;
- (id)handler;
