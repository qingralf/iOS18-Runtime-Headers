...
@interface HMDCloudDataSyncStateFilter : HMDMessageFilter <HMFLogging, HMFMessageReceiver, HMFTimerDelegate> {
    ...
    bool  _hasHH2MigrationAlreadyRequested;
    bool  _hh1FirstCloudSyncComplete;
    HMDHomeManager * _homeManager;
    bool  _homeManagerFirstFetchFinished;
...
- (void)moveDirectlyToHH2IfAccountOnlyHasUpgradedSharedHomesAllowEmptyOwnedHomes:(bool)arg1;
- (id)msgDispatcher;
...
- (void)setHasHH2MigrationAlreadyRequested:(bool)arg1;
- (void)setHomeManager:(id)arg1;
- (void)setHomeManagerFirstFetchFinished:(bool)arg1;
...
- (void)totalHomesInCloudZones:(id /* block */)arg1;
...
- (void)updateiCloudAccountActive:(bool)arg1;
