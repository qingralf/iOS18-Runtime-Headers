...
@interface HMEMessageDatagramClient : HMERouterClient {
    ...
    NSUUID * _connectingServerIdentifier;
...
@property (nonatomic, retain) NSUUID *connectingServerIdentifier;
...
- (id)dataSource;
- (id)delegate;
- (id)didReceiveFetchResponseWithCachedEvents:(id)arg1;
...
- (void)setConnectingServerIdentifier:(id)arg1;
