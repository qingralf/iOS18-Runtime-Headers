...
- (void)_createHAPServicesFromServiceDescriptions:(id)arg1 topology:(id)arg2 nodeID:(id)arg3 accessoryEndpointID:(id)arg4 services:(out id)arg5 startingServiceInstanceID:(inout long long*)arg6 primaryAccessory:(id)arg7 standaloneServiceLabelIndexMap:(id)arg8;
- (id)_serviceLabelIndexMapForDescriptions:(id)arg1;
