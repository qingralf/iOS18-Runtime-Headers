...
- (id)initWithOperationOfType:(unsigned long long)arg1 characteristic:(id)arg2 matterDevice:(id)arg3 primaryArgument:(id)arg4 clusterIDCharacteristicMap:(id)arg5;
