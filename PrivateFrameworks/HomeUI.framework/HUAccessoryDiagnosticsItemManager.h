...
@property (nonatomic, readonly) HFStaticItem *fetchMatterSnapshotButtonItem;
@property (nonatomic, readonly) HFStaticItem *logCollectionFailedItem;
@property (nonatomic, retain) NSObject<OS_dispatch_queue> *matterDispatchQueue;
@property (nonatomic, readonly) HMAccessory *sourceAccessory;

- (void).cxx_destruct;
- (void)_beginHAPDiagnosticCollection:(id)arg1;
- (void)_beginMatterDiagnosticCollection;
- (id)_beginMatterDiagnosticCollectionForDevice:(id)arg1 type:(long long)arg2;
...
- (id)fetchMatterSnapshotButtonItem;
- (id)initWithDelegate:(id)arg1 sourceItem:(id)arg2;
- (id)logCollectionFailedItem;
- (id)matterDispatchQueue;
- (void)recordDownloadedLog:(id)arg1;
- (void)recordDownloadedMatterLog:(id)arg1;
...
- (void)setMatterDispatchQueue:(id)arg1;
