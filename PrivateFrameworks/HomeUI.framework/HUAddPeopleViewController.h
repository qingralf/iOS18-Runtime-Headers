...
@interface HUAddPeopleViewController : UIViewController <CNContactPickerDelegate, HFContactControllerDelegate, HUDetailsPresentationDelegateHost, IDSBatchIDQueryControllerDelegate, MFComposeRecipientTextViewDelegate, MFContactsSearchConsumer, UITableViewDataSource, UITableViewDelegate> {
...
@property (nonatomic, retain) NSArray *familyMembersNotInHome;
...
@property (nonatomic, readonly) unsigned long long viewContext;

+ (void)presentAddPersonOrAlertForHH2Upgrade:(id)arg1 withHome:(id)arg2 viewContext:(unsigned long long)arg3 delegate:(id)arg4 presentationDelegate:(id)arg5;
...
- (id)familyMembersNotInHome;
- (void)finishedSearchingForAutocompleteResults;
- (void)handleStatusQueryResults:(id)arg1;
- (id)home;
- (id)initWithCoder:(id)arg1;
- (id)initWithHome:(id)arg1;
- (id)initWithHome:(id)arg1 viewContext:(unsigned long long)arg2;
...
- (void)setFamilyMembersNotInHome:(id)arg1;
...
- (unsigned long long)viewContext;
