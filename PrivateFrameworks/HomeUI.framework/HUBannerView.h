...
@property (nonatomic, retain) UIImageView *supplementaryIconImageView;
@property (nonatomic, retain) HUIconView *supplementaryIconView;
...
- (void)setSupplementaryIconImageView:(id)arg1;
- (void)setSupplementaryIconView:(id)arg1;
- (void)setTitleLabel:(id)arg1;
- (id)supplementaryIconImageView;
- (id)supplementaryIconView;
