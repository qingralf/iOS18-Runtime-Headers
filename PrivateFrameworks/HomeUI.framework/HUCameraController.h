...
@property (nonatomic, retain) NAFuture *calendarScrubberDataSourceFuture;
...
- (id)calendarScrubberDataSourceFuture;
- (id)cameraDelegate;
- (id)cameraItem;
...
- (void)handleSceneDidActivate:(id)arg1;
- (void)handleSceneWillDeactivate:(id)arg1;
...
- (void)setCalendarScrubberDataSourceFuture:(id)arg1;
