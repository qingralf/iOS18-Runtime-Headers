...
@property (nonatomic) bool hasOpportunityBubble;
...
- (id)offerTitle;
- (id)planLimit;
- (void)savePlanLimit:(id)arg1 error:(id)arg2;
- (void)savePremiumOffer:(id)arg1 error:(id)arg2;
- (void)setHasFetchedOfferResults:(bool)arg1;
- (void)setHasOpportunityBubble:(bool)arg1;
