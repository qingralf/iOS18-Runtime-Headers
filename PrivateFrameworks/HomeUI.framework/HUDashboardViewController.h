...
@interface HUDashboardViewController : HUControllableItemCollectionViewController <HFAccessoryObserver, HFExecutionEnvironmentObserver, HFHomeManagerObserver, HFHomeObserver, HFUserObserver, HUAccessoryTileCellDelegate, HUBannerItemModuleControllerDelegate, HUCollectionLayoutManagerDelegate, HUDashboardItemManagerDelegate, HUEditActionDelegate, HUEditRoomViewControllerPresentationDelegate, HUEnergyDashboardItemModuleControllerDelegate, HUHomeKitObjectPresenting, HUNavigationBarButtonOwner, HUPerformanceTestableViewController, HUPreloadableViewController, HUPresentationDelegate, HURoomSettingsDelegate, UICollectionViewDropDelegate, UIPopoverPresentationControllerDelegate, UIViewControllerTransitioningDelegate> {
...
@property (nonatomic, retain) UIViewController *energyIndicatorViewController;
...
@property (nonatomic, retain) UIVisualEffectView *restrictedGuestBlockedBackdropView;
@property (nonatomic, retain) UIVisualEffectView *roarBackdropView;
@property (nonatomic, readonly) bool shouldIncludeRoomsInHomeMenu; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) NAFuture *viewFirstTimeFullyVisibleFuture;
...
- (void)changeHomeEnergyTipShouldDisplayTo:(bool)arg1;
...
- (id)energyIndicatorViewController;
...
- (bool)matterItemSupportsAccessoryDetails:(id)arg1;
...
- (bool)presentationCoordinator:(id)arg1 shouldAllowTapticFeedbackForItem:(id)arg2;
...
- (id)restrictedGuestBlockedBackdropView;
- (id)roarBackdropView;
...
- (void)setEnergyIndicatorViewController:(id)arg1;
...
- (void)setRestrictedGuestBlockedBackdropView:(id)arg1;
...
- (void)viewDidLoad;
- (id)viewFirstTimeFullyVisibleFuture;
