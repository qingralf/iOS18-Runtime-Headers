...
@interface HUGridServiceCell : HUGridCell <HUAccessoryViewCellProtocol, HUIconRenouncing, HUQuickControlPresentationTransitionDelegate> {
...
@property (nonatomic, retain) UIImageView *supplementaryImageView;
...
- (void)setSupplementaryImageView:(id)arg1;
