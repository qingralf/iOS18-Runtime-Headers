...
@interface HUHomeHubSharedUserWarningViewController : HUItemTableOBWelcomeController <HFItemManagerDelegate, HUConfigurationViewController, HUConfigurationViewControllerFlow> {
...
- (id)delegate;
- (id)initWithHomesToUsersMap:(id)arg1;
- (bool)isFinalStep;
