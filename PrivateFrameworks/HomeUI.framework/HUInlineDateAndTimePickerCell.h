...
@interface HUInlineDateAndTimePickerCell : UITableViewCell <HUDisableableCellProtocol> {
    ...
    <HUInlineDateAndTimePickerCellDelegate> * _delegate;
    bool  _disabled;
...
@property (nonatomic) <HUInlineDateAndTimePickerCellDelegate> *delegate;
...
- (void)setDateAndTimePickerDate:(id)arg1;
...
- (id)timeComponents;
- (id)title;
- (void)toggleTimePickerOptionVisibility:(bool)arg1;
