...
@interface HUItemTableViewController : HUTableViewController <HFDiffableDataItemManagerDelegate, HFExecutionEnvironmentObserver, HFItemManagerDelegate, HUExpandableTextViewCellDelegate, HUItemManagerContainer, HUItemPresentationContainer, HUPreloadableViewController, HUTableViewDiffableDataSourceDelegate, UITextViewDelegate> {
...
@property (nonatomic, readonly) NSMutableSet *recentlyRemovedItemModuleControllers;
...
- (id)recentlyRemovedItemModuleControllers;
- (void)recursivelyDisableItemUpdates:(bool)arg1 withReason:(id)arg2;
- (id)registeredCellClasses;
- (void)reloadCellForItems:(id)arg1 withDiffableDataSourceReload:(bool)arg2;
