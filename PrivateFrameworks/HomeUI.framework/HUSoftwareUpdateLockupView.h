...
- (void)clearAssociatedViewForGridViewController:(id)arg1;
- (void)dealloc;
- (id)getAssociatedViewForGridViewController:(id)arg1;
...
- (void)setAssociatedViewForGridViewController:(id)arg1;
