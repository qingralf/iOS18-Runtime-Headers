...
@interface HUStatusAndNotificationsItemManager : HFItemManager {
    ...
    bool  _showsDoorbellChimeSection;
...
@property (nonatomic) bool showsDoorbellChimeSection;
...
- (void)setShowsDoorbellChimeSection:(bool)arg1;
...
- (id)updateChimeOnAccessory:(bool)arg1;
