...
@interface HUTileCellBackgroundView : UIView {
    void $__lazy_storage_$_controlCenterMaterialView;
...
- (id)initWithEffectIdentifier:(id)arg1 effectGrouper:(id)arg2 materialStyle:(long long)arg3;
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
- (void)layoutSubviews;
- (void)prepareForReuse;
- (void)setEffectGrouper:(id)arg1;
- (void)updateWithEffectIdentifier:(id)arg1 materialStyle:(long long)arg2;
