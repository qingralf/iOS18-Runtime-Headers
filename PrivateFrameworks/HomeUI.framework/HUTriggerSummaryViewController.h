...
@interface HUTriggerSummaryViewController : HUItemTableViewController <HFHomeObserver, HUNameAndIconEditorCellDelegate, HUSwitchCellDelegate, HUTriggerActionSetsModuleControllerDelegate, HUTriggerConditionEditorItemModuleControllerDelegate, HUTriggerDurationModuleControllerDelegate, HUTriggerEditorDelegate, HUTriggerEventsModuleControllerDelegate, HUTriggerMediaModuleControllerDelegate, UITextViewDelegate, WFHomeWorkflowEditorViewControllerDelegate> {
