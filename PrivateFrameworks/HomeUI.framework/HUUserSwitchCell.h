...
@interface HUUserSwitchCell : HUAvatarTableViewCell <HUDisableableCellProtocol> {
    ...
    bool  _disabled;
    bool  _loading;
    bool  _overrideDefaultContentConfiguration;
...
@property (nonatomic) bool overrideDefaultContentConfiguration;
...
- (void)setOverrideDefaultContentConfiguration:(bool)arg1;
