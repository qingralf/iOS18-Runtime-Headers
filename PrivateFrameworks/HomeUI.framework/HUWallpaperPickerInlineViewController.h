...
@property (nonatomic, retain) NSArray *namedWallpaperThumbnails;
...
- (void)setNamedWallpaperThumbnails:(id)arg1;
...
- (id)thumbnailCache;
- (id)thumbnailWallpaperForIndexPath:(id)arg1;
