...
@interface IDSDaemonListener : NSObject <IDSDaemonListenerProtocol> {
    ...
    _IDSRegistrationAccountManager * _registrationAccountManager;
...
@property (nonatomic, retain) _IDSRegistrationAccountManager *registrationAccountManager;
...
- (void)familyDevicesForService:(id)arg1 listenerID:(id)arg2 withCompletion:(id /* block */)arg3;
...
- (id)registrationAccountManager;
- (void)registrationFailedForAccount:(id)arg1 needsDeletion:(id)arg2;
- (void)removeHandler:(id)arg1;
- (unsigned long long)restrictionReasonForService:(id)arg1;
...
- (void)setRegistrationAccountManager:(id)arg1;
