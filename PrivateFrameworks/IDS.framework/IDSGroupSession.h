...
- (id)initWithAccount:(id)arg1 destinations:(id)arg2 options:(id)arg3 delegate:(id)arg4 queue:(id)arg5;
- (id)initWithAccount:(id)arg1 options:(id)arg2;
- (id)initWithAccount:(id)arg1 options:(id)arg2 delegate:(id)arg3 queue:(id)arg4;
- (void)invalidate;
