...
- (id)_currentCachedRemoteDevicesForDestinations:(id)arg1 service:(id)arg2 preferredFromID:(id)arg3 listenerID:(id)arg4;
- (long long)_currentIDStatusForDestination:(id)arg1 service:(id)arg2 listenerID:(id)arg3;
- (long long)_currentIDStatusForDestination:(id)arg1 service:(id)arg2 preferredFromID:(id)arg3 listenerID:(id)arg4;
- (long long)_currentIDStatusForDestination:(id)arg1 service:(id)arg2 preferredFromID:(id)arg3 respectExpiry:(bool)arg4 listenerID:(id)arg5;
...
- (id)_currentIDStatusForDestinations:(id)arg1 service:(id)arg2 preferredFromID:(id)arg3 listenerID:(id)arg4;
- (id)_currentIDStatusForDestinations:(id)arg1 service:(id)arg2 preferredFromID:(id)arg3 respectExpiry:(bool)arg4 listenerID:(id)arg5;
...
- (long long)_refreshIDStatusForDestination:(id)arg1 service:(id)arg2 preferredFromID:(id)arg3 listenerID:(id)arg4;
- (id)_refreshIDStatusForDestinations:(id)arg1 service:(id)arg2 listenerID:(id)arg3;
- (id)_refreshIDStatusForDestinations:(id)arg1 service:(id)arg2 preferredFromID:(id)arg3 listenerID:(id)arg4;
...
- (bool)currentIDStatusForDestination:(id)arg1 service:(id)arg2 preferredFromID:(id)arg3 listenerID:(id)arg4 queue:(id)arg5 completionBlock:(id /* block */)arg6;
...
- (bool)forceRefreshIDStatusForDestinations:(id)arg1 service:(id)arg2 preferredFromID:(id)arg3 listenerID:(id)arg4 queue:(id)arg5 completionBlock:(id /* block */)arg6;
...
- (bool)participantsForDestinations:(id)arg1 service:(id)arg2 preferredFromID:(id)arg3 listenerID:(id)arg4 queue:(id)arg5 completionBlock:(id /* block */)arg6;
...
- (bool)refreshIDStatusForDestinations:(id)arg1 service:(id)arg2 preferredFromID:(id)arg3 listenerID:(id)arg4 queue:(id)arg5 errorCompletionBlock:(id /* block */)arg6;
...
- (bool)requestIDStatusForDestination:(id)arg1 service:(id)arg2 preferredFromID:(id)arg3 listenerID:(id)arg4 queue:(id)arg5 completionBlock:(id /* block */)arg6;
...
- (bool)requestIDStatusForDestinations:(id)arg1 service:(id)arg2 preferredFromID:(id)arg3 listenerID:(id)arg4 queue:(id)arg5 completionBlock:(id /* block */)arg6;
