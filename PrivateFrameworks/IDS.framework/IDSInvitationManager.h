...
- (void)cancelInvitation:(id)arg1 withContext:(id)arg2 options:(id)arg3 serverAcknowledgedBlock:(id /* block */)arg4;
...
- (void)declineInvitation:(id)arg1 withContext:(id)arg2 options:(id)arg3 serverAcknowledgedBlock:(id /* block */)arg4;
- (void)declineInvitation:(id)arg1 withContext:(id)arg2 serverAcknowledgedBlock:(id /* block */)arg3;
- (id)delegate;
