...
+ (void)asyncWeakSharedInstance:(id /* block */)arg1;
...
- (id)baaSignerCollaboratorForTopic:(id)arg1 withErrorHandler:(id /* block */)arg2;
- (id)collaboratorPromiseDictionary;
- (id)connection;
- (void)dealloc;
- (id)eventReportingCollaboratorWithErrorHandler:(id /* block */)arg1;
- (id)featureTogglerCollaboratorForService:(id)arg1 withErrorHandler:(id /* block */)arg2;
- (id)firewallCollaboratorForService:(id)arg1 withErrorHandler:(id /* block */)arg2;
...
- (id)offGridMessengerCollaboratorWithErrorHandler:(id /* block */)arg1;
- (id)offGridStateManagerCollaboratorWithErrorHandler:(id /* block */)arg1;
...
- (id)pinnedIdentityCollaboratorWithErrorHandler:(id /* block */)arg1;
- (id)queue;
