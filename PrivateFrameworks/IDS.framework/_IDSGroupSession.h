...
+ (void)keyValueDeliveryForSessionID:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)_setupSession:(id)arg1 destinations:(id)arg2 options:(id)arg3 delegateContext:(id)arg4;
- (id)boostContext;
...
- (void)groupSessionDidConnectUnderlyingLinks:(id)arg1;
- (void)groupSessionDidDisconnectUnderlyingLinks:(id)arg1;
- (void)groupSessionDidInitialize:(id)arg1 error:(id)arg2;
...
- (id)initWithAccount:(id)arg1 destinations:(id)arg2 options:(id)arg3 delegateContext:(id)arg4 delegate:(id)arg5 queue:(id)arg6;
- (void)invalidate;
...
- (void)session:(id)arg1 didReceiveJoinedParticipantID:(unsigned long long)arg2 withContext:(id)arg3;
- (void)session:(id)arg1 didReceiveKeyMaterial:(id)arg2;
- (void)session:(id)arg1 didReceiveLeftParticipantID:(unsigned long long)arg2 withContext:(id)arg3;
...
- (void)setForceTCPFallbackOnCellUsingReinitiate:(bool)arg1;
- (void)setForceTCPFallbackOnWiFiUsingReinitiate:(bool)arg1;
...
- (void)updateParticipantInfo:(id)arg1;
