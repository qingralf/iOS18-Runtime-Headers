...
@property (nonatomic, readonly) unsigned long long registrationRestrictionReason;
...
- (bool)cancelMessageWithOptions:(id)arg1 destinations:(id)arg2 identifier:(id*)arg3 error:(id*)arg4;
...
- (unsigned long long)registrationRestrictionReason;
...
- (void)service:(id)arg1 restrictionReasonChanged:(unsigned long long)arg2;
