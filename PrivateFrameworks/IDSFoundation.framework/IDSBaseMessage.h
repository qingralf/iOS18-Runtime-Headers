...
@property (nonatomic, retain) NSString *baaSigningDigest;
@property (nonatomic, retain) NSError *baaSigningError;
...
@property (nonatomic, readonly) bool ignorePushSigHeaders;
...
@property (nonatomic, retain) NSString *splunkHint;
...
- (id)service;
- (id)serviceData;
- (void)setBaaSigningDigest:(id)arg1;
- (void)setBaaSigningError:(id)arg1;
...
- (void)setWantsPushSignatures:(bool)arg1;
