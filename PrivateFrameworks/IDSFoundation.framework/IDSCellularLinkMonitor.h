...
- (bool)dataUsable;
- (void)dealloc;
- (bool)dropIPPackets:(id)arg1 localAddress:(struct sockaddr { unsigned char x1; unsigned char x2; BOOL x3[14]; }*)arg2 remoteAddress:(struct sockaddr { unsigned char x1; unsigned char x2; BOOL x3[14]; }*)arg3 isRelay:(bool)arg4 channelNumberMSB:(unsigned char)arg5 ifname:(id)arg6;
- (id)init;
- (bool)isSlicedCellularInterfaceActive:(id)arg1;
...
- (void)reset;
- (bool)setPacketNotificationFilter:(const struct sockaddr { unsigned char x1; unsigned char x2; BOOL x3[14]; }*)arg1 remote:(const struct sockaddr { unsigned char x1; unsigned char x2; BOOL x3[14]; }*)arg2 uniqueTag:(unsigned int)arg3 callType:(unsigned char)arg4 ifname:(id)arg5;
