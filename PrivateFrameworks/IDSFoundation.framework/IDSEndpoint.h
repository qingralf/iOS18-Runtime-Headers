...
@property (nonatomic, readonly) NSString *shortHandle;
...
- (id)initWithURI:(id)arg1 capabilities:(id)arg2 ngmVersion:(short)arg3 legacyVersion:(BOOL)arg4 KTLoggableData:(id)arg5 KTDeviceSignature:(id)arg6 mismatchedAccountFlag:(bool)arg7 ktCapableFlag:(bool)arg8 pushTokenObject:(id)arg9 sessionToken:(id)arg10 expireDate:(id)arg11 refreshDate:(id)arg12 anonymizedSenderID:(id)arg13 verifiedBusiness:(bool)arg14 serializedPublicMessageProtectionIdentity:(id)arg15 queryTimeInterval:(double)arg16 serializedNGMDeviceIdentity:(id)arg17 serializedNGMDevicePrekey:(id)arg18 serializedApplicationPublicKey:(id)arg19 endpointURIProperties:(id)arg20 familyEndpointData:(id)arg21 gameCenterData:(id)arg22;
- (id)initWithURI:(id)arg1 clientData:(id)arg2 KTLoggableData:(id)arg3 KTDeviceSignature:(id)arg4 mismatchedAccountFlag:(bool)arg5 ktCapableFlag:(bool)arg6 pushToken:(id)arg7 sessionToken:(id)arg8 expireDate:(id)arg9 refreshDate:(id)arg10 anonymizedSenderID:(id)arg11 verifiedBusiness:(bool)arg12 serializedPublicMessageProtectionIdentity:(id)arg13 queryTimeInterval:(double)arg14 serializedNGMDeviceIdentity:(id)arg15 serializedNGMDevicePrekey:(id)arg16 serializedApplicationPublicKey:(id)arg17 endpointURIProperties:(id)arg18 familyEndpointData:(id)arg19 gameCenterData:(id)arg20;
- (id)initWithURI:(id)arg1 clientData:(id)arg2 pushToken:(id)arg3 sessionToken:(id)arg4 expireDate:(id)arg5 refreshDate:(id)arg6;
- (id)initWithURI:(id)arg1 serviceIdentifier:(id)arg2 clientData:(id)arg3 KTLoggableData:(id)arg4 KTDeviceSignature:(id)arg5 mismatchedAccountFlag:(bool)arg6 ktCapableFlag:(bool)arg7 pushToken:(id)arg8 sessionToken:(id)arg9 expireDate:(id)arg10 refreshDate:(id)arg11 anonymizedSenderID:(id)arg12 verifiedBusiness:(bool)arg13 serializedPublicMessageProtectionIdentity:(id)arg14 queryTimeInterval:(double)arg15 serializedNGMDeviceIdentity:(id)arg16 serializedNGMDevicePrekey:(id)arg17 serializedApplicationPublicKey:(id)arg18 endpointURIProperties:(id)arg19 familyEndpointData:(id)arg20 gameCenterData:(id)arg21;
- (bool)isEqual:(id)arg1;
- (bool)isEqualToEndpoint:(id)arg1;
- (bool)isEqualToEndpoint:(id)arg1 withDateTolerance:(double)arg2;
- (bool)ktCapableFlag;
- (BOOL)legacyVersion;
