...
@property (nonatomic, readonly) bool clat46;
@property (getter=isCompanionLink, readonly) bool companionLink;
...
@property (getter=isWired, readonly) bool wired;

+ (id)addressesFromInterfaceAddresses:(id)arg1;
...
- (unsigned int)index;
- (id)initWithInterfaceAddress:(struct ifaddrs { struct ifaddrs {} *x1; char *x2; unsigned int x3; struct sockaddr {} *x4; struct sockaddr {} *x5; struct sockaddr {} *x6; void *x7; }*)arg1 bflags:(unsigned char)arg2;
- (bool)isAWDL;
- (bool)isCellular;
