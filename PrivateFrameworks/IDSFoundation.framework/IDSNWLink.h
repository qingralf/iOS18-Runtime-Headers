...
@property (nonatomic, retain) NSString *cellInterfaceName;
...
- (void)_addPendingTCPNWLinkConnection:(id)arg1 token:(id)arg2;
- (void)_addToRecentQRServerList:(id)arg1;
- (void)_addUDPConnectionInProgress:(id)arg1 token:(id)arg2;
...
- (unsigned short)_getConnectedLocalPortAndSetLocalEndpointForConnection:(id)arg1;
...
- (void)_removeChildConnectionEvaluatorFortoken:(id)arg1;
- (void)_removeExtraListener:(unsigned short)arg1;
- (void)_removeNWLinkConnection:(id)arg1 token:(id)arg2;
- (void)_removePendingTCPNWLinkConnectionForToken:(id)arg1;
