...
@interface IDSQuickRelaySessionInfo : NSObject {
    ...
    bool  _sessionIsUserParticipantInitiated;
...
@property (readonly) <IDSGroupQUICMaterialExchangeProvider> *quicMaterialExchangeProvider;
...
- (id)quicMaterialExchangeProvider;
