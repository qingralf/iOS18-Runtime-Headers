...
- (id)genericError;
- (id)guid;
- (id)initWithGuid:(id)arg1 success:(bool)arg2 connectionType:(unsigned int)arg3 resultCode:(unsigned int)arg4 registrationError:(unsigned int)arg5 genericError:(id)arg6 URLError:(id)arg7 POSIXError:(id)arg8;
- (id)name;
