...
@interface IDSServerBagConfig : NSObject {
    ...
    NSURL * _url;
    bool  _validateAgainstIDSPolicy;
}
...
@property (nonatomic, readonly) bool validateAgainstIDSPolicy;
...
- (id)description;
- (BOOL)hashAlgorithm;
- (id)initWithURL:(id)arg1 defaultsDomain:(id)arg2 defaultBag:(id)arg3 apsEnvironmentName:(id)arg4 sosDomain:(unsigned long long)arg5 hashAlgorithm:(BOOL)arg6 requiresIDSHost:(bool)arg7 validateAgainstIDSPolicy:(bool)arg8 bagType:(long long)arg9 bypassProcessChecks:(bool)arg10 logCategory:(id)arg11;
- (id)logCategory;
