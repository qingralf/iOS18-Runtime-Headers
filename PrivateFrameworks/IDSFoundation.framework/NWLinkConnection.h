...
@property (nonatomic, readonly, retain) NSObject<OS_nw_endpoint> *cachedH2LocalEndpoint;
...
@property (nonatomic, readonly, retain) NSObject<OS_nw_endpoint> *remoteEndpoint;
