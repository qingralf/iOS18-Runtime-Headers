...
+ (id)makeINMessage:(long long)arg1 message:(id)arg2 numberOfAttachments:(long long)arg3 personProvider:(id)arg4 referencedINMessage:(id)arg5 content:(id)arg6 reaction:(id)arg7;
