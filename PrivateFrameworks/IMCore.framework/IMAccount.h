...
@interface IMAccount : NSObject <IMAccount, IMSystemMonitorListener> {
    id  _accountImage;
...
@property (nonatomic, retain) id accountImage;
@property (nonatomic, retain) NSDictionary *accountPersistentProperties;
@property (nonatomic, retain) NSMutableDictionary *accountPersistentPropertiesChanges;
@property (nonatomic, retain) NSDictionary *accountPreferences;
@property (nonatomic, retain) NSMutableDictionary *accountPreferencesChanges;
@property (nonatomic, retain) NSDictionary *accountSubtypeInfo;
...
@property (nonatomic, readonly) unsigned int blockingMode;
@property (nonatomic, retain) IMPeople *buddyList;
@property (nonatomic, retain) NSArray *cachedAllowList;
@property (nonatomic, retain) NSArray *cachedBlockList;
...
@property (nonatomic, retain) NSMutableDictionary *coalescedChanges;
@property (nonatomic, retain) NSString *countryCode;
@property (nonatomic, retain) NSDictionary *data;
@property (nonatomic, retain) NSMutableDictionary *dataChanges;
...
@property (nonatomic, retain) NSMapTable *imHandles;
...
@property (nonatomic, retain) NSString *keyTransparencyIDQueryListenerID;
@property (nonatomic, retain) NSArray *lastReceivedGroupState;
@property (nonatomic, retain) NSMutableDictionary *localCache;
@property (nonatomic, retain) NSRecursiveLock *lock;
@property (nonatomic, retain) NSString *login;
@property (nonatomic, retain) NSString *loginID;
@property (nonatomic, retain) IMHandle *loginIMHandle;
...
@property (nonatomic, retain) NSDictionary *myNowPlaying;
@property (nonatomic, readonly) NSString *myNowPlayingString;
@property (nonatomic, retain) NSData *myPictureData;
@property (nonatomic, retain) NSAttributedString *myProfile;
@property (nonatomic) unsigned long long myStatus;
@property (nonatomic, retain) NSMutableDictionary *myStatusDictionary;
...
@property (nonatomic, retain) NSMutableDictionary *profileChanges;
...
@property (nonatomic, retain) NSDictionary *registrationAlertInfo;
...
@property (nonatomic, retain) id smallImage;
@property (nonatomic, retain) NSMutableDictionary *sortOrders;
@property (nonatomic, retain) NSString *strippedLogin;
...
@property (nonatomic, retain) NSArray *targetGroupState;
...
@property (nonatomic, retain) NSArray *vettedAliases;
...
- (bool)_hasSuppressionForCapability:(id)arg1;
...
- (void)idsKTVerifierResultsUpdatedForDestinations:(id)arg1 service:(id)arg2;
...
- (void)loginStatusChanged:(unsigned long long)arg1 message:(id)arg2 reason:(int)arg3 properties:(id)arg4;
...
- (void)setAccountPersistentProperties:(id)arg1;
- (void)setAccountPersistentPropertiesChanges:(id)arg1;
- (void)setAccountPreferences:(id)arg1;
- (void)setAccountPreferencesChanges:(id)arg1;
- (void)setAccountSubtypeInfo:(id)arg1;
- (void)setAccountType:(long long)arg1;
- (void)setAliases:(id)arg1;
- (void)setAllowList:(id)arg1;
- (void)setAllowsVCRelay:(bool)arg1;
- (void)setAsleep:(bool)arg1;
...
- (void)setCoalesceCount:(int)arg1;
- (void)setCoalescedChanges:(id)arg1;
- (void)setCountryCode:(id)arg1;
- (void)setCurrentAccountStatus:(id)arg1;
- (void)setData:(id)arg1;
- (void)setDataChanges:(id)arg1;
- (void)setDefaultHandleCapabilities:(unsigned long long)arg1;
...
- (void)setHasCheckedDefaultHandleCapabilities:(bool)arg1;
- (void)setHasPostedOfflineNotification:(bool)arg1;
- (void)setHasReceivedSync:(bool)arg1;
...
- (bool)supportsCapability:(id)arg1 forAlias:(id)arg2;
- (bool)supportsCapability:(id)arg1 forAlias:(id)arg2 simID:(id)arg3;
