...
@property (nonatomic, readonly) bool hasRelayApprovedAccount;
...
- (id)activeAccountsWithServiceCapability:(id)arg1;
...
- (id)connectedAccountsWithServiceCapability:(id)arg1;
...
- (id)init;
- (bool)isAccountKeyCDPSyncingOrWaitingForUser:(id)arg1;
- (id)jabberAccount;
...
- (id)fallbackServiceForAddresses:(id)arg1;
