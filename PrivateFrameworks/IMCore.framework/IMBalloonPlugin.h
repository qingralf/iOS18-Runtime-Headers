...
@property (nonatomic, readonly) bool allowsPresentationWithSendLater;
...
@property (nonatomic, readonly) bool shouldDelayViewControllerPresentation;
...
+ (id)__ck_appIconFromPayloadDictionary:(id)arg1 pluginBundleID:(id)arg2 withCompletionBlock:(id /* block */)arg3;
