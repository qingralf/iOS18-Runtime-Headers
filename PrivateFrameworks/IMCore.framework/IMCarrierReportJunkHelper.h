...
+ (void)collectReportJunkMetricsForChatbotJunkMessageItem:(id)arg1 totalMessagesInThread:(unsigned long long)arg2;
...
+ (id)createJunkReportMessageBodyTextForMessageItem:(id)arg1 junkChatStyle:(unsigned char)arg2 serviceName:(id)arg3;
+ (id)createJunkReportMessageItemBodyForMessageItem:(id)arg1 junkChatStyle:(unsigned char)arg2 serviceName:(id)arg3;
...
+ (bool)isRCSServiceName:(id)arg1;
+ (bool)isReportJunkServiceAllowedForMessageItem:(id)arg1 junkChatStyle:(unsigned char)arg2;
+ (id)jsonSerializeDictionary:(id)arg1;
+ (id)jsonSerializeDictionaryStrippingOutMessageContent:(id)arg1;
+ (id)junkReportMessageItemForMessageItem:(id)arg1 account:(id)arg2 junkChatStyle:(unsigned char)arg3 serviceName:(id)arg4;
