...
@property (nonatomic, retain) NSArray *serviceNamesForChatIdentifierSearch;
@property (nonatomic, readonly) NSArray *serviceNamesForChatIdentifierSearch;
...
- (void)_chat_fetchHistorySummary:(id)arg1 dateInterval:(id)arg2 synchronous:(bool)arg3 queryID:(id)arg4 completion:(id /* block */)arg5;
- (void)_chat_fetchIncomingPendingMessagesOverSatellite:(id)arg1;
- (void)_chat_fetchOldestMessageDateForChat:(id)arg1 synchronous:(bool)arg2 queryID:(id)arg3 completion:(id /* block */)arg4;
...
- (void)_completedMovingChatsToRecentlyDeleted:(id)arg1 deletionDate:(id)arg2;
...
- (void)_enumerateChatGUIDPermutationsForChatIdentifier:(id)arg1 includingInstantMessageStyle:(bool)arg2 includingGroupStyle:(bool)arg3 includingRoomStyle:(bool)arg4 usingBlock:(id /* block */)arg5;
...
- (id)_ck_chatForHandles:(id)arg1 displayName:(id)arg2 lastAddressedHandle:(id)arg3 lastAddressedSIMID:(id)arg4 joinedChatsOnly:(bool)arg5 findMatchingNamedGroups:(bool)arg6 createIfNecessary:(bool)arg7;
