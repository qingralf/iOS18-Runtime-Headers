...
@interface IMDaemonController : NSObject <IMDaemonControlling, IMDaemonControlling_Private> {
    ...
    <IMDaemonConnectionManaging> * _connection;
    id  _delegate;
...
@property (nonatomic, readonly) <IMDaemonConnectionManaging> *connection;
...
- (void)_handleDaemonLaunched:(id)arg1;
...
- (void)setProcessCapabilities:(unsigned long long)arg1;
