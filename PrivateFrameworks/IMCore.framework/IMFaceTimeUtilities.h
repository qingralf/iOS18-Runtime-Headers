...
+ (void)initiateTUConversationForParticipants:(id)arg1 senderAddress:(id)arg2 videoEnabled:(bool)arg3 groupID:(id)arg4 displayName:(id)arg5 screenShareType:(unsigned long long)arg6;
