...
- (void)_createNewOutgoingFileTransferWithTransferGUID:(id)arg1 localFileURL:(id)arg2;
...
- (void)_handleFileTransferFinishedRemoteIntentDownload:(id)arg1;
...
- (id)createNewOutgoingGroupPhotoTransferWithLocalFileURL:(id)arg1;
