...
@interface IMHandle : NSObject <IMHandle, NSSecureCoding> {
    long long  _IDStatus;
...
@property (nonatomic, readonly) bool isKTVerified;
...
- (void)_fetchBrandInfoForBrandWithURI:(id)arg1 forType:(unsigned long long)arg2;
- (void)_fetchBrandInfoForBusiness:(unsigned long long)arg1;
...
- (void)autoInviteToViewOffGridModeIfNeededFromHandleID:(id)arg1;
