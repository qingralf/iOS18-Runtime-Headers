...
@property (nonatomic, readonly) IMMessageItem *lastIncomingFinishedMessageItem;
...
- (id)_lastMessage;
- (id)_lastMessageItemMatchingCriteria:(id /* block */)arg1;
- (id)_lastMessageItemWithService:(id)arg1;
- (id)_lastMessageItemWithServiceCapability:(id)arg1;
- (id)_lastPendingSatelliteSendMessage;
- (id)_lastRelatedIncomingFinishedMessageTextContentWithLimit:(long long)arg1;
- (id)_lastSentMessage;
- (void)_mergeItems:(id)arg1;
- (void)_removeAllItems;
- (void)_removeItem:(id)arg1;
- (void)_replaceAndSortItemsWithUnsortedItems:(id)arg1;
- (void)_replaceItems:(id)arg1;
- (void)_replaceItems:(id)arg1 skipCallToItemsDidChange:(bool)arg2;
...
- (id)lastIncomingFinishedMessageItem;
