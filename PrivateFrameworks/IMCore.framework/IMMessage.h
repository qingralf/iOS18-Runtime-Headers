...
@property (nonatomic, readonly, copy) NSString *associatedMessageEmoji;
@property (setter=_associatedMessageEmoji:, nonatomic, copy) NSString *associatedMessageEmoji;
...
@property (nonatomic, readonly) bool needsRelay;
...
@property (nonatomic, readonly) bool sentOrReceivedOffGrid;
...
+ (id)instantMessageWithAssociatedMessageContent:(id)arg1 associatedMessageGUID:(id)arg2 associatedMessageType:(long long)arg3 associatedMessageRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg4 associatedMessageEmoji:(id)arg5 messageSummaryInfo:(id)arg6 threadIdentifier:(id)arg7;
...
+ (id)instantMessageWithText:(id)arg1 messageSubject:(id)arg2 flags:(unsigned long long)arg3 threadIdentifier:(id)arg4 associatedMessageGUID:(id)arg5 scheduledDate:(id)arg6;
...
- (void).cxx_destruct;
- (id)_account;
- (void)_associatedMessageEmoji:(id)arg1;
...
- (id)_imMessageItem;
- (id)_initWithSender:(id)arg1 time:(id)arg2 timeRead:(id)arg3 timeDelivered:(id)arg4 timePlayed:(id)arg5 plainText:(id)arg6 text:(id)arg7 messageSubject:(id)arg8 fileTransferGUIDs:(id)arg9 flags:(unsigned long long)arg10 error:(id)arg11 guid:(id)arg12 messageID:(long long)arg13 subject:(id)arg14 balloonBundleID:(id)arg15 payloadData:(id)arg16 expressiveSendStyleID:(id)arg17 timeExpressiveSendPlayed:(id)arg18 associatedMessageGUID:(id)arg19 associatedMessageType:(long long)arg20 associatedMessageRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg21 associatedMessageEmoji:(id)arg22 messageSummaryInfo:(id)arg23 threadIdentifier:(id)arg24 dateEdited:(id)arg25 scheduleType:(unsigned long long)arg26 scheduleState:(unsigned long long)arg27;
...
- (id)_transcriptPluginChatItemFromTypeErasedPartChatItems:(id)arg1;
...
- (id)tapback;
- (id)tapbackSummaryForConversationListUsingIsAdaptiveImageGlyphProvider:(id /* block */)arg1 isCommSafetySensitiveProvider:(id /* block */)arg2 adaptiveImageGlyphProvider:(id /* block */)arg3 effectString:(id)arg4;
- (id)text;
- (id)threadIdentifier;
- (id)threadOriginator;
- (id)time;
