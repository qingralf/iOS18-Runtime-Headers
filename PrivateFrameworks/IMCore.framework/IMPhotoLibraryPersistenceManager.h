...
@interface IMPhotoLibraryPersistenceManager : NSObject <PHPhotoLibraryChangeObserver> {
    ...
    CPLRUDictionary * _syndicationIdentifierFetchResultCache;
...
@property (nonatomic, retain) CPLRUDictionary *syndicationIdentifierFetchResultCache;
...
+ (id)photosSyndicationIdentifiersForMessage:(id)arg1 transcriptChatItem:(id)arg2;
+ (id)sharedInstance;

- (void).cxx_destruct;
- (id)_cachedSaveStateForIdentifier:(id)arg1;
- (bool)_invalidateCacheDueToChanges:(id)arg1;
...
- (void)setSyndicationIdentifierFetchResultCache:(id)arg1;
...
- (id)syndicationIdentifierFetchResultCache;
