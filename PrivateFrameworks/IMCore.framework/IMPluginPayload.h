...
@property (nonatomic, retain) NSData *generativePlaygroundRecipeData;
...
- (bool)isEqualAttachmentFileURLsToPluginPayload:(id)arg1;
...
- (id)__ck_photoCompositionMediaObjectsWithKeyToTrasferGUIDMap:(id)arg1;
