...
- (void)_insertOrMoveChatItemToEndOfChatItems:(id)arg1 chatItemClass:(Class)arg2 shouldInsert:(bool)arg3 chatItemCreationBlock:(id /* block */)arg4;
...
- (id)_items;
- (long long)_lastItemIndexExcludingScheduledSection:(id)arg1;
...
- (id)_newiMessageLiteSentItemWithStatusType:(long long)arg1 atIndex:(long long)arg2 chatItems:(id)arg3;
- (id)_nextStaleTime;
- (void)_processChatItemsForAttribution:(id)arg1;
- (void)_processChatItemsForBreadcrumbs:(id)arg1;
- (void)_processChatItemsForDownloadingPendingMessages:(id)arg1;
...
- (void)_processChatItemsForKeyTransparencyStatus:(id)arg1;
- (void)_processChatItemsForMessageStatusSequenceNumber:(id)arg1;
- (void)_processChatItemsForReplayButton:(id)arg1;
- (void)_processChatItemsForSMSFallbackStatusIndicator:(id)arg1;
- (void)_processChatItemsForSatelliteAvailabilityIndicator:(id)arg1;
- (void)_processChatItemsForSatelliteNoDeliveryStatusIndicator:(id)arg1;
- (void)_processChatItemsForStewieResumeButtons:(id)arg1 inChat:(id)arg2;
- (void)_processChatItemsForSuggestedReplies:(id)arg1 inChat:(id)arg2;
- (void)_processChatItemsForUnavailabilityIndicator:(id)arg1;
- (void)_processChatItemsForUnknownInternationalSender:(id)arg1;
- (void)_processChatItemsForWatchSatelliteDisclosure:(id)arg1;
- (void)_processSuggestedActionResponses:(id)arg1;
...
- (bool)_shouldAppendScheduledSectionDateForItem:(id)arg1 previousItem:(id)arg2;
- (bool)_shouldAppendScheduledSectionLabelForItem:(id)arg1 previousItem:(id)arg2;
- (bool)_shouldAppendSendViaSatelliteForChat:(id)arg1 item:(id)arg2 previousItem:(id)arg3;
- (bool)_shouldAppendSentViaSatelliteForChat:(id)arg1 message:(id)arg2;
- (bool)_shouldAppendServiceForChat:(id)arg1 item:(id)arg2 previousItem:(id)arg3 chatStyle:(unsigned char)arg4;
...
- (bool)_shouldReloadSatelliteChatItems:(id)arg1;
...
- (id)_updateOrRemoveiMessageLiteSentItemMovingFromOldIndex:(long long)arg1 chatItems:(id)arg2;
- (void)addChatItem:(id)arg1 toChatItemsAtEndButBeforeWatchReplyOrScheduledSendItems:(id)arg2;
- (id)chat;
...
- (id)items;
- (id)nextStaleTime;
- (id)serviceForChatItems:(id)arg1;
