...
@property (nonatomic, readonly, copy) NSString *destinationCallerID;
...
@property (nonatomic, readonly, copy) NSString *iMessageAppBundleID;
@property (nonatomic, readonly, copy) NSData *iMessageAppData;
@property (nonatomic, readonly) long long itemType;
@property (nonatomic, readonly, copy) NSDictionary *messageSummaryInfo;
@property (nonatomic, readonly, copy) NSData *messageSummaryInfoData;
@property (nonatomic, readonly) bool needsRelay;
@property (nonatomic, readonly) IMDHandleRecord *otherHandleRecord;
@property (nonatomic, readonly) long long partCount;
@property (getter=isPendingSatelliteSend, nonatomic, readonly) bool pendingSatelliteSend;
...
@property (nonatomic, readonly, copy) NSString *threadOriginatorPart;
...
- (id)iMessageAppBundleID;
- (id)iMessageAppData;
- (id)init;
- (id)initWithItemType:(long long)arg1 text:(id)arg2 date:(long long)arg3 dateRead:(long long)arg4 dateDelivered:(long long)arg5 datePlayed:(long long)arg6 error:(long long)arg7 type:(long long)arg8 replaceID:(long long)arg9 flags:(id)arg10 guid:(id)arg11 attributedBody:(id)arg12 service:(id)arg13 account:(id)arg14 accountGUID:(id)arg15 subject:(id)arg16 handleID:(id)arg17 countryCode:(id)arg18 unformattedID:(id)arg19 otherHandleID:(id)arg20 groupTitle:(id)arg21 groupActionType:(long long)arg22 shareStatus:(long long)arg23 shareDirection:(long long)arg24 expireState:(long long)arg25 messageActionType:(long long)arg26 associatedMessageGUID:(id)arg27 associatedMessageType:(long long)arg28 associatedMessageRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg29 associatedMessageEmoji:(id)arg30 balloonBundleID:(id)arg31 payloadData:(id)arg32 expressiveSendStyleID:(id)arg33 timeExpressiveSendPlayed:(long long)arg34 messageSummaryInfo:(id)arg35 cloudKitSyncState:(long long)arg36 cloudKitRecordID:(id)arg37 cloudKitServerChangeTokenBlob:(id)arg38 cloudKitRecordChangeTag:(id)arg39 dataDetectorsInfo:(id)arg40 destinationCallerID:(id)arg41 replyToGUID:(id)arg42 sortID:(long long)arg43 threadOriginatorGUID:(id)arg44 threadOriginatorPart:(id)arg45 syndicationRanges:(id)arg46 syncedSyndicationRanges:(id)arg47 partCount:(long long)arg48 dateEdited:(long long)arg49 biaReferenceID:(id)arg50 fallbackHash:(id)arg51 scheduleType:(long long)arg52 scheduleState:(long long)arg53;
- (id)initWithRecordRef:(struct _IMDMessageRecordStruct { }*)arg1;
- (bool)isArchived;
- (bool)isAssociatedMessage;
- (bool)isReply;
- (id)messageSummaryInfo;
- (id)messageSummaryInfoData;
- (id)otherHandleRecord;
