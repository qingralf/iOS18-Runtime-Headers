...
@property (nonatomic, retain) IMPurgedAttachmentHandler *purgedAttachmentHandler;
...
- (id)_cacheDeleteGuidanceDictionaryForRequestedSize:(unsigned long long)arg1;
...
- (void)batchCompletedWithTransfers:(id)arg1;
...
- (void)setPurgedAttachmentHandler:(id)arg1;
