...
@interface IMDCKSyncController : IMDCKAbstractSyncController <IMDCKAbstractSyncControllerDelegate, IMDMessageSyncCoordinatorDelegate, IMDXPCEventStreamHandlerDelegate, IMStateLoggable, IMUnlockMonitorListener> {
    long long  _initialSyncAttempts;
    bool  _isFetchingExitForEnablement;
...
- (void)_attemptToEnableMiCByDefaultOnceAttempt:(int)arg1;
...
- (id)_retryError;
- (double)_retryIntervalToEnableMicByDefaultForAttempt:(int)arg1;
...
- (id)_stringForDate:(id)arg1 withFormatter:(id)arg2;
...
- (void)setIsFetchingExitForEnablement:(bool)arg1;
