...
- (void)PCSKeyRollPendingAsync:(id /* block */)arg1 timeout:(double)arg2;
...
- (bool)_deviceActive;
- (void)_didAttemptToUpdateCloudKitEnablementTo:(bool)arg1 result:(bool)arg2;
...
- (void)clearLocalCloudKitSyncState:(unsigned long long)arg1;
...
- (void)estimateQuotaAvailability:(id /* block */)arg1;
