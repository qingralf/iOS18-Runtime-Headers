...
@interface IMDChat : NSObject <INSpeakable> {
    ...
    bool  _isDownloadingPendingSatelliteMessages;
    ...
    bool  _wasDowngradedToLiteMessage;
...
@property (nonatomic, retain) IMDHandle *recipient;
...
- (id)_chatRegistry;
- (id)_ckUniqueID;
- (void)_convergeGroupChatIfNeededWithServiceSession:(id)arg1 account:(id)arg2 replicationService:(id)arg3 groupID:(id)arg4 incomingParticipants:(id)arg5 fromIdentifier:(id)arg6 toIdentifier:(id)arg7 receivedGroupParticipantVersion:(id)arg8 receivedGroupProtocolVersion:(id)arg9 messageTimeStamp:(id)arg10 groupPhotoCreationTime:(id)arg11;
- (bool)_convergesGroupPhotosForReplicationService:(id)arg1;
- (bool)_convergesParticipantsForReplicationService:(id)arg1;
...
- (void)_indexChatAndMessagesToSpotlightWithReason:(long long)arg1;
...
- (id)account;
- (id)accountID;
- (void)addBIAContextWithUserID:(id)arg1 referenceID:(id)arg2;
...
- (id)groupID;
- (long long)groupParticipantVersion;
- (id)groupPhotoGuid;
...
- (bool)isUnnamedChat;
- (bool)isiMessageSpam;
- (id)keyTransparencyURIToUUIDMapping;
...
- (id)lastSentDowngradeRequestSinceLoadDate;
...
- (long long)pendingIncomingSatelliteMessageCount;
- (id)persistentID;
- (id)personCentricID;
...
- (void)setGroupParticipantVersion:(long long)arg1;
- (void)setGuid:(id)arg1;
- (void)setHasHadSuccessfulQuery:(bool)arg1;
- (void)setHasScheduledMessage:(bool)arg1;
- (void)setIsBlackholed:(bool)arg1;
- (void)setIsDownloadingPendingSatelliteMessages:(bool)arg1;
...
- (void)setLastSentDowngradeRequestSinceLoadDate:(id)arg1;
- (void)setLastSentDowngradeRequestSinceLoadSessionIndex:(long long)arg1;
...
- (void)setPendingIncomingSatelliteMessageCount:(long long)arg1;
- (void)setProperties:(id)arg1;
- (void)setRecipient:(id)arg1;
- (void)setRecovered:(bool)arg1;
- (void)setRepairHistory:(unsigned long long)arg1;
- (void)setReplySuggestions:(id)arg1;
- (void)setRequestedDowngradeExpirationDate:(id)arg1;
- (void)setRequestedDowngradeService:(id)arg1;
- (void)setRoomName:(id)arg1;
- (void)setServerChangeToken:(id)arg1;
- (void)setServiceName:(id)arg1;
- (void)setState:(long long)arg1;
- (void)setStyle:(unsigned char)arg1;
- (void)setWasDowngradedToLiteMessage:(bool)arg1;
...
- (void)updateHasCancellableScheduledMessage:(bool)arg1;
...
- (void)updateIsDownloadingPendingSatelliteMessages:(bool)arg1;
...
- (void)updateLastAddressedHandle:(id)arg1 forceUpdateHandle:(bool)arg2 lastAddressedSIMID:(id)arg3;
...
- (void)updatePendingIncomingSatelliteMessageCount:(long long)arg1;
- (bool)updateProperties:(id)arg1;
- (bool)updateProperties:(id)arg1 shouldBroadcast:(bool)arg2;
