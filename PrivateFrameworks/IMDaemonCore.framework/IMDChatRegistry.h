...
@property (nonatomic, retain) NSMutableDictionary *pendingChatBotHandleToAlternateID;
...
- (id)_allChatInfo;
- (id)_allHandles;
- (id)_bestServiceSessionForService:(id)arg1 accountID:(id)arg2;
...
- (id)_cnIDForHandle:(id)arg1;
- (long long)_compareDuplicateChatsWithFirstChat:(id)arg1 secondChat:(id)arg2;
- (bool)_contactsBasedMergingEnabled;
- (void)_contactsChanged:(id)arg1;
- (id)_conversationItemForChat:(id)arg1 conversation:(id)arg2;
- (id)_copyDuplicateChatsArrayWithLimit:(long long)arg1;
- (id)_copyGroupedDuplicateChatsSortedFromWinningToLosingWithLimit:(long long)arg1;
...
- (id)_exactGroupChatMatchOrNewestMatchingGroupID:(id)arg1 originalGroupID:(id)arg2 serviceName:(id)arg3 participants:(id)arg4 toIdentifier:(id)arg5 outNewestSiblingChat:(id*)arg6;
- (id)_existingChatForSyncData:(id)arg1 originalGUID:(id)arg2;
- (id)_existingChatsForIDs:(id)arg1 serviceName:(id)arg2 displayName:(id)arg3 groupID:(id)arg4 useOriginalGroupID:(bool)arg5 style:(unsigned char)arg6;
...
- (void)_fixSiblingChatsAndStoreIfNeeded:(id)arg1 iMessageChat:(id)arg2 chatsToRegenerate:(id)arg3;
...
- (id)_potentialGUIDsForIdentifier:(id)arg1;
...
- (id)_siblingChatsForChat:(id)arg1 usingChatGUIDToChatMap:(id)arg2 iMessageChat:(id*)arg3;
- (id)_spamMessageCreator;
- (void)_triggerRemergeForPersonCentricID:(id)arg1;
- (id)_tuConversationForChat:(id)arg1;
- (id)_uncachedNewestChatWithOriginalGroupID:(id)arg1 onService:(id)arg2;
...
- (id)alternateIDForHandle:(id)arg1;
- (id)bestCandidateGroupChatWithFromIdentifier:(id)arg1 toIdentifier:(id)arg2 displayName:(id)arg3 participants:(id)arg4 groupID:(id)arg5 originalGroupID:(id)arg6 serviceName:(id)arg7;
...
- (id)chatForHandles:(id)arg1 account:(id)arg2 chatIdentifier:(id)arg3 style:(unsigned char)arg4 groupID:(id)arg5 originalGroupID:(id)arg6 displayName:(id)arg7 guid:(id)arg8 lastAddressedHandle:(id)arg9 lastAddressedSIMID:(id)arg10 isBlackholed:(bool)arg11;
...
- (id)existingChatForIDs:(id)arg1 account:(id)arg2 displayName:(id)arg3 originalGroupID:(id)arg4 style:(unsigned char)arg5;
...
- (id)existingChatWithGroupID:(id)arg1 onService:(id)arg2;
...
- (id)existingChatsForIDs:(id)arg1 onService:(id)arg2 displayName:(id)arg3 originalGroupID:(id)arg4 style:(unsigned char)arg5;
...
- (bool)filteredChatsExistForServices:(id)arg1;
...
- (unsigned long long)markAsSpamForIDs:(id)arg1 style:(unsigned char)arg2 onServices:(id)arg3 chatID:(id)arg4 queryID:(id)arg5 autoReport:(bool)arg6 isJunkReportedToCarrier:(bool)arg7 reportReason:(unsigned long long)arg8;
...
- (id)newestExistingChatWithOriginalGroupID:(id)arg1 onService:(id)arg2;
- (void)pendingAlternateID:(id)arg1 forHandle:(id)arg2;
- (id)pendingChatBotHandleToAlternateID;
...
- (bool)removeIMDHandleFromRegistry:(id)arg1;
