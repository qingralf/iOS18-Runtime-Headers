...
@interface IMDChorosController : NSObject <CTStewieDataClientDelegate> {
    ...
    bool  _liteMessageActiveOverSatellite;
    NSMutableSet * _observers;
    bool  _satelliteConnectionActive;
    bool  _stewieActive;
    bool  _wasLastStateSatelliteConnectionActive;
}
...
@property (getter=isLiteMessageActiveOverSatellite, nonatomic) bool liteMessageActiveOverSatellite;
@property (nonatomic, retain) NSMutableSet *observers;
@property (getter=isSatelliteConnectionActive, nonatomic) bool satelliteConnectionActive;
@property (getter=isStewieActive, nonatomic) bool stewieActive;
@property (readonly) Class superclass;
@property (nonatomic) bool wasLastStateSatelliteConnectionActive;
...
- (void)setLiteMessageActiveOverSatellite:(bool)arg1;
- (void)setObservers:(id)arg1;
- (void)setSatelliteConnectionActive:(bool)arg1;
- (void)setStewieActive:(bool)arg1;
- (void)setWasLastStateSatelliteConnectionActive:(bool)arg1;
