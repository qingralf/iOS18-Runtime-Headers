...
@interface IMDeliveredQuietlyReceiptPipelineParameter : NSObject <IMDeliveredQuietlyReceiptProcessingParameter, IMFindAccountProcessingParameter, IMMessageFromStorageParameter> {
    NSString * _GUID;
    IMDAccount * _account;
    IMDChat * _chat;
