...
@interface IMDeliveryReceiptPipelineParameter : NSObject <IMDeliveryReceiptProcessingParameter, IMFindAccountProcessingParameter, IMMessageFromStorageParameter, IMSenderCapabilityParameter> {
    NSString * _GUID;
    IMDAccount * _account;
    IMDChat * _chat;
