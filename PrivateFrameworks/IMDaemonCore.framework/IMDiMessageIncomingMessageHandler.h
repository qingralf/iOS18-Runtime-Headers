...
- (void)handleCrossServiceAssociationCommandWithPipeline:(id)arg1 input:(id)arg2 completionBlock:(id /* block */)arg3;
...
- (void)handleRepositionStickerCommandWithPipeline:(id)arg1 input:(id)arg2 completionBlock:(id /* block */)arg3;
- (void)handleScheduledMessageUpdateCommandWithPipeline:(id)arg1 input:(id)arg2 completionBlock:(id /* block */)arg3;
