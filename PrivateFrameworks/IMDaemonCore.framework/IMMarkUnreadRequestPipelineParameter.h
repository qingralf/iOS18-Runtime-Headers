...
@interface IMMarkUnreadRequestPipelineParameter : NSObject <IMFindAccountProcessingParameter, IMMarkUnreadRequestProcessingParameter, IMMessageFromStorageParameter> {
    NSString * _GUID;
    IMDAccount * _account;
    IMDChat * _chat;
