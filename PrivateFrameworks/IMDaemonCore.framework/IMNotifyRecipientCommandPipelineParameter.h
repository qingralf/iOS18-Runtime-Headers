...
@interface IMNotifyRecipientCommandPipelineParameter : NSObject <IMFindAccountProcessingParameter, IMMessageFromStorageParameter, IMNotifyRecipientCommandProcessingParameter> {
    NSString * _GUID;
    IMDAccount * _account;
    IMDChat * _chat;
