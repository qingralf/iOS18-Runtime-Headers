...
@interface IMRepositionStickerCommandPipelineParameter : NSObject <IMFindAccountProcessingParameter, IMMessageFromStorageParameter, IMRepositionStickerCommandProcessingParameter> {
    NSString * _GUID;
    IMDAccount * _account;
    IMDChat * _chat;
...
@property (nonatomic, readonly, copy) BlastDoorStickerAttachmentInfo *stickerAttachmentInfo;
@property (nonatomic, readonly, copy) NSString *stickerEditedMessageGuid;
