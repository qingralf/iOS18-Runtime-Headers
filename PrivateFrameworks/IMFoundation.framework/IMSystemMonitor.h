...
@property (nonatomic, readonly) CUTDeferredTaskQueue *_postScreenLockedTask;
@property (nonatomic, readonly) CUTDeferredTaskQueue *_postScreenSaverStartedTask;
@property (nonatomic, retain) IMDispatchTimer *_timer;
