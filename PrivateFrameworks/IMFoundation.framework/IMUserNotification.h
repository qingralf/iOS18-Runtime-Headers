...
+ (id)userNotificationWithIdentifier:(id)arg1 title:(id)arg2 message:(id)arg3 defaultButton:(id)arg4 defaultButtonStyle:(unsigned long long)arg5 alternateButton:(id)arg6 alternateButtonStyle:(unsigned long long)arg7 otherButton:(id)arg8 otherButtonStyle:(unsigned long long)arg9;
