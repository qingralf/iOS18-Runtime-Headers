...
+ (void)generateAnimatedImagePreview:(id)arg1 senderContext:(id)arg2 destinationFileURL:(id)arg3 maxPixelDimension:(double)arg4 scale:(double)arg5 maxFrameCount:(long long)arg6 isSticker:(bool)arg7 withCompletionBlock:(id /* block */)arg8;
...
+ (void)generateEmojiImagePreview:(id)arg1 senderContext:(id)arg2 frameIndex:(long long)arg3 maxPixelDimension:(double)arg4 withCompletionBlock:(id /* block */)arg5;
...
+ (void)generateNickname:(id)arg1 senderContext:(id)arg2 forRecordID:(id)arg3 wallpaperDataTag:(id)arg4 wallpaperLowResDataTag:(id)arg5 wallpaperMetadataTag:(id)arg6 withKey:(id)arg7 processImageFields:(bool)arg8 completionBlock:(id /* block */)arg9;
...
+ (void)getMetadataForEmojiImageWithFileURL:(id)arg1 senderContext:(id)arg2 maxStrikeCount:(long long)arg3 withCompletionBlock:(id /* block */)arg4;
+ (id)logger;
