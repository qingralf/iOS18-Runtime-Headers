...
@interface IMContactStore : NSObject <IMStateLoggable> {
    ...
    bool  _shouldSkipMeContactLookup;
...
- (id)IDToCNContactMap;
- (void)_cacheBatchFetchResults:(id)arg1 handleIDsWithoutCNID:(id)arg2;
- (void)_fetchContactsWithIdentifiers:(id)arg1 usingCNID:(bool)arg2;
...
- (void)setShouldSkipMeContactLookup:(bool)arg1;
