...
- (id)fileInfoMap;
- (void)gather;
- (void)gatherLivePhotoBundleContentInfoAtPath:(id)arg1;
...
- (void)setSpaceSavedFromIgnoreLivePhotoBundles:(long long)arg1;
- (void)setSyncAssetPaths:(id)arg1;
- (void)setTopLevelPaths:(id)arg1;
- (id)sortedPaths;
- (long long)spaceSavedFromIgnoreLivePhotoBundles;
- (id)stickersPath;
- (id)syncAssetPaths;
- (id)syncAssetsPath;
- (id)topLevelPaths;
