...
@property (nonatomic, retain) NSString *adaptiveImageGlyphContentDescription;
@property (nonatomic, retain) NSString *adaptiveImageGlyphContentIdentifier;
...
@property (nonatomic, readonly) bool isDownloadExpired;
...
@property (nonatomic, readonly) bool isInThumbnailState;
...
@property (nonatomic, readonly, retain) NSString *originalFilename;
...
@property (nonatomic, readonly) NSString *serviceFromUserInfo;
...
@property (nonatomic, readonly) bool thumbnailExistsAtLocalPath;
...
@property (setter=setUpdateReason:, nonatomic) long long updateReason;
...
+ (long long)finalTransferStateForThumbnailMode:(long long)arg1 success:(bool)arg2;
+ (bool)genmojiFileTransferShouldDisplayAsPermanentlyFailed:(id)arg1;
+ (id)guidByStrippingAuxPrefix:(id)arg1;
+ (id)guidForFileTransferDictionary:(id)arg1;
+ (long long)thumbnailModeForMode:(long long)arg1 afterDownloadSuccess:(bool)arg2;
+ (id)whitelistedKeys;
...
- (id)filename;
- (long long)finalTransferStateForSuccess:(bool)arg1;
...
- (void)setPreviewGenerationVersion:(long long)arg1;
...
- (void)setThumbnailMode:(long long)arg1;
- (void)setTotalBytes:(unsigned long long)arg1;
- (void)setTranscoderUserInfo:(id)arg1;
- (void)setTranscoderUserInfoIsGenmoji:(bool)arg1;
...
- (long long)thumbnailModeAfterDownloadSuccess:(bool)arg1;
