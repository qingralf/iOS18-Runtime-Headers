...
@property (nonatomic, copy) NSString *criticalMessagingAppName;
...
+ (id)createCKRecordForUpdateT3:(id)arg1 zoneID:(id)arg2 salt:(id)arg3;
...
+ (id)messageSummaryInfoProtobufForCompressedData:(id)arg1;
...
+ (id)populateIMMessageItemWithProtobufFields:(id)arg1 withProtobufDataP4:(id)arg2;
+ (id)populateIMParticipantChangeItem:(id)arg1 withProtobufData:(id)arg2 protobuf2Data:(id)arg3;
+ (id)protobufForCompressedData:(id)arg1;
+ (id)protobufForCompressedDataP2:(id)arg1;
+ (id)protobufForCompressedDataP3:(id)arg1;
+ (id)protobufForCompressedDataP4:(id)arg1;
+ (id)protobufForUpdateT1:(id)arg1;
+ (id)protobufForUpdateT2:(id)arg1;
+ (id)protobufForUpdateT3:(id)arg1;
...
- (id)backCompatServiceFor:(id)arg1;
