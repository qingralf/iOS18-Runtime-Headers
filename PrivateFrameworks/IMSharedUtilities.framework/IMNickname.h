...
@property (nonatomic, retain) NSDictionary *preBlastDoorPayloadData;
...
@property (nonatomic, readonly) NSData *wallpaperImageHash;
@property (nonatomic, readonly) NSData *wallpaperLowResImageHash;

// Image: /System/Library/PrivateFrameworks/IMSharedUtilities.framework/IMSharedUtilities

+ (id)nameHashWithFirstName:(id)arg1 lastName:(id)arg2;
+ (id)processSetOfUnknownSenderRecords:(id)arg1;
...
- (void)setPreBlastDoorPayloadData:(id)arg1;
...
+ (id)_blastdoorNicknameFromPublicRecord:(id)arg1 wallpaperRecord:(id)arg2 preKey:(id)arg3 wallpaperDataTag:(id)arg4 wallpaperLowResDataTag:(id)arg5 wallpaperMetadataTag:(id)arg6 knownSender:(bool)arg7 shouldDecodeImageFields:(bool)arg8 error:(id*)arg9;
...
+ (id)nicknameFromPublicRecord:(id)arg1 wallpaperRecord:(id)arg2 preKey:(id)arg3 wallpaperDataTag:(id)arg4 wallpaperLowResDataTag:(id)arg5 wallpaperMetadataTag:(id)arg6 knownSender:(bool)arg7 shouldDecodeImageFields:(bool)arg8 error:(id*)arg9;
