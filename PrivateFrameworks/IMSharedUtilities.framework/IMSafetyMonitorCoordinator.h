...
@property (nonatomic, readonly, copy) NSDictionary *appPayload;
@property (nonatomic, readonly, copy) NSString *appPayloadID;
...
- (void)informOfChangedGroupDisplayName:(id)arg1;
- (void)informOfChangedGroupMembership:(id)arg1;
- (void)informOfChangedGroupPhoto:(id)arg1;
...
- (void)informOfKickFromGroup:(id)arg1;
- (void)informOfOutgoingMessageWithMessage:(id)arg1 sentSuccessfully:(bool)arg2 error:(id)arg3;
- (void)informOfScheduledMessage:(id)arg1 sentSuccessfully:(bool)arg2 error:(id)arg3;
- (void)informOfSentScheduledMessage:(id)arg1;
