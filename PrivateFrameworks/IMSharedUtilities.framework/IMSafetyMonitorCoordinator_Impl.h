...
- (void)informOfChangedGroupDisplayNameWithGroupID:(id)arg1;
- (void)informOfChangedGroupMembershipWithGroupID:(id)arg1;
- (void)informOfChangedGroupPhotoWithGroupID:(id)arg1;
...
- (void)informOfKickFromGroupWithGroupID:(id)arg1;
