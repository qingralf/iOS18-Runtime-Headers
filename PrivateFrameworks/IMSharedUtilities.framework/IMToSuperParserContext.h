...
- (void)appendInlineImageWithGUID:(id)arg1 filename:(id)arg2 width:(long long)arg3 height:(long long)arg4 isAnimoji:(long long)arg5 isAdaptiveImageGlyph:(bool)arg6;
- (void)appendRichCards:(id)arg1 transferGuids:(id)arg2;
