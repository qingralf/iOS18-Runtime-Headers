...
- (unsigned long long)_determineFrameIndexForDowngradeFromMultiFrameToSingleFrameWithMaxDimension:(unsigned long long)arg1 fromImageSource:(struct CGImageSource { }*)arg2;
...
- (id)_writeHEIFImage:(struct CGImageSource { }*)arg1 sourceURL:(id)arg2 inFormat:(struct __CFString { }*)arg3 withMaxByteSize:(unsigned long long)arg4 maxDimension:(unsigned long long)arg5 downgradingMultiFrameImageToSingleFrame:(bool)arg6 actualSize:(unsigned long long*)arg7 startingLengthIndex:(int)arg8 usedLengthIndex:(int*)arg9 telemetry:(id)arg10;
...
- (id)_writeRepresentationsForImage:(struct CGImageSource { }*)arg1 target:(long long)arg2 sourceURL:(id)arg3 sizes:(id)arg4 maxDimension:(unsigned long long)arg5 srcUTI:(struct __CFString { }*)arg6 inFormat:(struct __CFString { }*)arg7 downgradingMultiFrameImageToSingleFrame:(bool)arg8 estimator:(id)arg9 isLQMEnabled:(bool)arg10 telemetry:(id)arg11;
