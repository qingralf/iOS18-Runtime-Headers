...
- (void)_disconnected;
- (void)_generateMetadata:(id)arg1 metadataURL:(id)arg2 senderContext:(id)arg3 constraints:(struct IMPreviewConstraints { double x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; double x3; bool x4; bool x5; bool x6; })arg4 retries:(unsigned long long)arg5 completionBlock:(id /* block */)arg6 blockUntilReply:(bool)arg7;
- (void)_generatePreview:(id)arg1 previewURL:(id)arg2 senderContext:(id)arg3 constraints:(struct IMPreviewConstraints { double x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; double x3; bool x4; bool x5; bool x6; })arg4 retries:(unsigned long long)arg5 balloonBundleID:(id)arg6 transferGUID:(id)arg7 completionBlock:(id /* block */)arg8 blockUntilReply:(bool)arg9;
- (void)_generateSafeRender:(id)arg1 constraints:(struct IMPreviewConstraints { double x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; double x3; bool x4; bool x5; bool x6; })arg2 retries:(int)arg3 completionBlock:(id /* block */)arg4;
...
- (void)generateMetadata:(id)arg1 metadataURL:(id)arg2 senderContext:(id)arg3 constraints:(struct IMPreviewConstraints { double x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; double x3; bool x4; bool x5; bool x6; })arg4 completionBlock:(id /* block */)arg5;
- (void)generateMetadata:(id)arg1 metadataURL:(id)arg2 senderContext:(id)arg3 constraints:(struct IMPreviewConstraints { double x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; double x3; bool x4; bool x5; bool x6; })arg4 completionBlock:(id /* block */)arg5 blockUntilReply:(bool)arg6;
- (void)generatePreview:(id)arg1 previewURL:(id)arg2 senderContext:(id)arg3 constraints:(struct IMPreviewConstraints { double x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; double x3; bool x4; bool x5; bool x6; })arg4 balloonBundleID:(id)arg5 transferGUID:(id)arg6 completionBlock:(id /* block */)arg7 blockUntilReply:(bool)arg8;
...
- (id)init;
- (void)replaceTransferWithSafeTransfer:(id)arg1 constraints:(struct IMPreviewConstraints { double x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; double x3; bool x4; bool x5; bool x6; })arg2 completionBlock:(id /* block */)arg3;
