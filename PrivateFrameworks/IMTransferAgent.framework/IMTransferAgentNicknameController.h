...
- (void).cxx_destruct;
- (id)_errorWrappingError:(id)arg1;
...
- (void)getNicknameWithRecordID:(id)arg1 decryptionKey:(id)arg2 wallpaperDataTag:(id)arg3 wallpaperLowResDataTag:(id)arg4 wallpaperMetadataTag:(id)arg5 knownSender:(bool)arg6 shouldDecodeImageFields:(bool)arg7 queue:(id)arg8 completionBlock:(id /* block */)arg9;
- (id)lockdownManager;
