...
@property (nonatomic, readonly) NSArray *masterPrototypes; /* unknown property attribute: ? */
@property (nonatomic, retain) _IKDSEPrototypeBundle *prototypeBundle;
@property (nonatomic, readonly) NSArray *prototypes;
@property (nonatomic, readonly, copy) NSArray *proxiedItemElements; /* unknown property attribute: ? */
