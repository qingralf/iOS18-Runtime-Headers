...
@property (nonatomic, copy) NSArray *_processedEnclosureColors;
@property (nonatomic, copy) NSArray *_processedSymbolColors;
...
- (id)_processedEnclosureColors;
- (id)_processedSymbolColors;
...
- (void)setSymbolOverride:(id)arg1;
- (void)setTintColor:(id)arg1;
- (void)setVibrancy:(long long)arg1;
- (void)set_processedEnclosureColors:(id)arg1;
- (void)set_processedSymbolColors:(id)arg1;
- (long long)shape;
