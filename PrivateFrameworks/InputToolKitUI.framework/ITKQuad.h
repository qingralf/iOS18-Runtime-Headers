...
@interface ITKQuad : NSObject <NSCopying, NSSecureCoding> {
    struct CGPoint { 
        double x; 
        double y; 
    }  _bottomLeft;
...
@property (nonatomic, readonly) ITKQuad *quadByAdjustingOrientation;
@property (nonatomic, readonly) struct ITKQuadSideLength { double x1; double x2; double x3; double x4; } sideLength;
...
- (double)minimumDistanceToPoint:(struct CGPoint { double x1; double x2; })arg1;
...
- (struct ITKQuadSideLength { double x1; double x2; double x3; double x4; })sideLength;
