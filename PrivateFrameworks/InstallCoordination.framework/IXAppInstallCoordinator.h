...
+ (bool)addBundleIDs:(id)arg1 toMappingsForPersona:(id)arg2 error:(id*)arg3;
...
+ (id)removabilityDataWithChangeClock:(id*)arg1 error:(id*)arg2;
+ (void)removabilityDataWithCompletion:(id /* block */)arg1;
...
+ (void)removabilityForAppWithIdentity:(id)arg1 byClient:(unsigned long long)arg2 completion:(id /* block */)arg3;
+ (unsigned long long)removabilityForAppWithIdentity:(id)arg1 byClient:(unsigned long long)arg2 error:(id*)arg3;
...
+ (bool)removeBundleIDs:(id)arg1 fromMappingsForPersona:(id)arg2 error:(id*)arg3;
...
+ (bool)updateiTunesMetadata:(id)arg1 forAppWithIdentity:(id)arg2 error:(id*)arg3;
+ (bool)updateiTunesMetadata:(id)arg1 forAppWithIdentity:(id)arg2 wrapperURL:(id)arg3 error:(id*)arg4;
