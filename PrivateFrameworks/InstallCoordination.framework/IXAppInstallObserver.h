...
- (void).cxx_destruct;
- (oneway void)_client_coordinatorDidCompleteSuccessfullyWithSeed:(id)arg1 forRecordPromise:(id)arg2;
- (oneway void)_client_coordinatorDidInstallPlaceholderWithSeed:(id)arg1 forRecordPromise:(id)arg2;
- (oneway void)_client_coordinatorShouldBeginPostProcessingWithSeed:(id)arg1 forRecordPromise:(id)arg2;
...
- (oneway void)_client_shouldPrioritizeAppWithIdentity:(id)arg1;
- (void)_internalInit;
