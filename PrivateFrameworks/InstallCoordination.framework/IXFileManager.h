...
- (bool)_traverseDirectory:(id)arg1 ignoringFTSErrors:(bool)arg2 error:(id*)arg3 withBlock:(id /* block */)arg4;
- (bool)_validateSymlink:(id)arg1 withStartingDepth:(unsigned int)arg2 andEndingDepth:(unsigned int*)arg3;
- (bool)copyACLFrom:(id)arg1 toAllChildrenOfPath:(id)arg2 error:(id*)arg3;
- (bool)copyACLFrom:(id)arg1 toAllChildrenOfPath:(id)arg2 ignoringCopyErrors:(bool)arg3 error:(id*)arg4;
...
- (id)createTemporaryExtractionDirectoryWithError:(id*)arg1;
- (id)createTemporaryIconsDirectoryWithError:(id*)arg1;
...
- (bool)setPermissions:(unsigned short)arg1 onAllChildrenOfPath:(id)arg2 error:(id*)arg3;
