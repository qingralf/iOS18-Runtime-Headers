...
@property (nonatomic, readonly) bool hasIconResourcesPromise;
...
+ (id)_iconContentForBundleAtURL:(id)arg1 infoPlistIconContent:(id*)arg2 error:(id*)arg3;
+ (id)_iconDataForBundle:(struct __CFBundle { }*)arg1 atURL:(id)arg2 isFromSerializedPlaceholder:(bool)arg3 error:(id*)arg4;
+ (id)_infoPlistLocalizationDictionaryForBundleURL:(id)arg1 error:(id*)arg2;
+ (id)_placeholderForBundle:(id)arg1 client:(unsigned long long)arg2 withParent:(id)arg3 installType:(unsigned long long)arg4 metadata:(id)arg5 placeholderType:(unsigned long long)arg6 mayBeDeltaPackage:(bool)arg7 isFromSerializedPlaceholder:(bool)arg8 error:(id*)arg9;
+ (id)_placeholderForInstallable:(id)arg1 client:(unsigned long long)arg2 installType:(unsigned long long)arg3 metadata:(id)arg4 isFromSerializedPlaceholder:(bool)arg5 error:(id*)arg6;
...
- (id)iconResourcesPromiseWithInfoPlistContent:(id*)arg1 error:(id*)arg2;
...
- (bool)setIconResourcesPromise:(id)arg1 withInfoPlistContent:(id)arg2 error:(id*)arg3;
