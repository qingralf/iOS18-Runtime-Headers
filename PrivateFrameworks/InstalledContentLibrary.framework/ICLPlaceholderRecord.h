...
@interface ICLPlaceholderRecord : ICLBundleRecord <NSCopying, NSSecureCoding> {
    ...
    bool  _isBeta;
    bool  _isDeletable;
    bool  _isEligibleForWatchAppInstall;
    bool  _isMarketplace;
...
@property (nonatomic) bool isEligibleForWatchAppInstall;
...
- (void)setIsEligibleForWatchAppInstall:(bool)arg1;
- (void)setIsMarketplace:(bool)arg1;
