...
+ (bool)purgeTransientBundleContainersWithError:(id*)arg1;
...
+ (bool)updateiTunesMetadata:(id)arg1 forAppWithIdentifier:(id)arg2 error:(id*)arg3;
...
- (bool)_writeRawiTunesMetadataData:(id)arg1 error:(id*)arg2;
...
- (bool)captureStoreDataFromDirectory:(id)arg1 doCopy:(bool)arg2 failureIsFatal:(bool)arg3 includeiTunesMetadata:(bool)arg4 withError:(id*)arg5;
...
- (id)iTunesMetadataWithError:(id*)arg1;
