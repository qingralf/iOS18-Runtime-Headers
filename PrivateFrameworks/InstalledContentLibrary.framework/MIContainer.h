...
+ (id)containersForIdentifier:(id)arg1 groupContainerIdentifier:(id)arg2 ofContentClass:(unsigned long long)arg3 forPersona:(id)arg4 fetchTransient:(bool)arg5 createIfNeeded:(bool)arg6 error:(id*)arg7;
...
- (bool)clearStagedUpdateContainerStatusWithError:(id*)arg1;
...
- (bool)isNew;
- (bool)isStagedUpdateContainer:(bool*)arg1 withError:(id*)arg2;
- (bool)isTransient;
...
- (bool)markContainerAsStagedUpdateContainer:(id*)arg1;
