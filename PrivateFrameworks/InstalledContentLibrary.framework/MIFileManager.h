...
- (bool)captureStoreDataFromDirectory:(id)arg1 toDirectory:(id)arg2 doCopy:(bool)arg3 failureIsFatal:(bool)arg4 includeiTunesMetadata:(bool)arg5 withError:(id*)arg6;
...
- (bool)removeExtendedAttributeNamed:(id)arg1 fromURL:(id)arg2 error:(id*)arg3;
