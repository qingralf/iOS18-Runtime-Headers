...
+ (id)containersForBundleIdentifier:(id)arg1 contentClass:(unsigned long long)arg2 forPersona:(id)arg3 create:(bool)arg4 fetchTransient:(bool)arg5 error:(id*)arg6;
+ (id)containersForContentClass:(unsigned long long)arg1 forPersona:(id)arg2 fetchTransient:(bool)arg3 error:(id*)arg4;
+ (id)containersForGroupIdentifier:(id)arg1 forPersona:(id)arg2 create:(bool)arg3 fetchTransient:(bool)arg4 error:(id*)arg5;
