...
@property (nonatomic, copy) MIStoreMetadataDistributor *distributorInfo;
...
@property (nonatomic, readonly) bool isEligibleForWatchAppInstall;
...
@property (nonatomic, copy) NSString *shortItemName;
...
+ (id)metadataForBundleContainerURL:(id)arg1 error:(id*)arg2;
...
- (id)propertyListDataWithError:(id*)arg1;
...
- (void)setDistributorInfo:(id)arg1;
