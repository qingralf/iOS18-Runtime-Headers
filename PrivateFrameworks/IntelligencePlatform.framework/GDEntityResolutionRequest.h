...
@property (nonatomic, readonly) bool includeInferredNames;
...
- (id)initWithKgq:(id)arg1 text:(id)arg2 mode:(long long)arg3 includeFeatures:(bool)arg4 includeInferredNames:(bool)arg5;
...
- (id)initWithText:(id)arg1 entityClassFilter:(id)arg2 spans:(id)arg3 includeInferredNames:(bool)arg4;
- (id)initWithText:(id)arg1 entityClassFilter:(id)arg2 spans:(id)arg3 mode:(long long)arg4 constraint:(long long)arg5;
- (id)initWithText:(id)arg1 entityClassFilter:(id)arg2 spans:(id)arg3 mode:(long long)arg4 constraint:(long long)arg5 includeInferredNames:(bool)arg6;
...
- (id)initWithText:(id)arg1 entityClassFilter:(id)arg2 spans:(id)arg3 mode:(long long)arg4 constraint:(long long)arg5 sourceIDs:(id)arg6 kgq:(id)arg7 includeFeatures:(bool)arg8 includeInferredNames:(bool)arg9;
- (id)kgq;
- (long long)mode;
- (id)sourceIDs;
- (id)spans;
