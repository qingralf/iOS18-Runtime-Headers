...
@interface GDGraphActivityEventTypeEntityIdentifier : GDEntityIdentifier <GDGraphEntityIdentifier>
...
- (id)description;
- (id)graphActivityEventTypeFromContext:(id)arg1 error:(id*)arg2;
