...
@interface GDGraphAttendingAPerformanceActivityEvent : NSObject <GDGraphObject> {
    ...
    GDGraphAttendingAPerformanceActivityEventEntityIdentifier * _entityIdentifier;
    NSArray * _locations;
    NSString * _name;
...
@property (nonatomic, readonly, copy) GDGraphAttendingAPerformanceActivityEventEntityIdentifier *entityIdentifier;
