...
@interface GDGraphAttendingAPerformanceActivityEventEntityIdentifier : GDEntityIdentifier <GDGraphEntityIdentifier>
...
- (id)description;
- (id)graphAttendingAPerformanceActivityEventFromContext:(id)arg1 error:(id*)arg2;
