...
@interface GDGraphBicyclingActivityEvent : NSObject <GDGraphObject> {
    ...
    GDGraphBicyclingActivityEventEntityIdentifier * _entityIdentifier;
    NSArray * _locations;
    NSString * _name;
...
@property (nonatomic, readonly, copy) GDGraphBicyclingActivityEventEntityIdentifier *entityIdentifier;
