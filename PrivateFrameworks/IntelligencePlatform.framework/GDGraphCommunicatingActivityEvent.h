...
@interface GDGraphCommunicatingActivityEvent : NSObject <GDGraphObject> {
    ...
    GDGraphCommunicatingActivityEventEntityIdentifier * _entityIdentifier;
    NSArray * _locations;
    NSString * _name;
...
@property (nonatomic, readonly, copy) GDGraphCommunicatingActivityEventEntityIdentifier *entityIdentifier;
