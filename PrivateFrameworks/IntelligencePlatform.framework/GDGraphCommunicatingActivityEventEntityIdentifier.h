...
@interface GDGraphCommunicatingActivityEventEntityIdentifier : GDEntityIdentifier <GDGraphEntityIdentifier>
...
- (id)description;
- (id)graphCommunicatingActivityEventFromContext:(id)arg1 error:(id*)arg2;
