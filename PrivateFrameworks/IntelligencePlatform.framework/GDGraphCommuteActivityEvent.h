...
@interface GDGraphCommuteActivityEvent : NSObject <GDGraphObject> {
    ...
    GDGraphCommuteActivityEventEntityIdentifier * _entityIdentifier;
    NSArray * _locations;
    NSString * _name;
...
@property (nonatomic, readonly, copy) GDGraphCommuteActivityEventEntityIdentifier *entityIdentifier;
