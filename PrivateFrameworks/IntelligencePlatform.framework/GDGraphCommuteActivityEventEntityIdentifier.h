...
@interface GDGraphCommuteActivityEventEntityIdentifier : GDEntityIdentifier <GDGraphEntityIdentifier>
...
- (id)description;
- (id)graphCommuteActivityEventFromContext:(id)arg1 error:(id*)arg2;
