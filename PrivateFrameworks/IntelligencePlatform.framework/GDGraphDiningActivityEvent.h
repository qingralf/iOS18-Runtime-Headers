...
@interface GDGraphDiningActivityEvent : NSObject <GDGraphObject> {
    ...
    GDGraphDiningActivityEventEntityIdentifier * _entityIdentifier;
    NSArray * _locations;
    NSString * _name;
...
@property (nonatomic, readonly, copy) GDGraphDiningActivityEventEntityIdentifier *entityIdentifier;
