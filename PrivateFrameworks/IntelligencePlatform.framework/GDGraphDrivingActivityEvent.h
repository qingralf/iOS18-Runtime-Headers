...
@interface GDGraphDrivingActivityEvent : NSObject <GDGraphObject> {
    ...
    GDGraphDrivingActivityEventEntityIdentifier * _entityIdentifier;
    NSArray * _locations;
    NSString * _name;
...
@property (nonatomic, readonly, copy) GDGraphDrivingActivityEventEntityIdentifier *entityIdentifier;
