...
@interface GDGraphEatingActivityEvent : NSObject <GDGraphObject> {
    ...
    GDGraphEatingActivityEventEntityIdentifier * _entityIdentifier;
    NSArray * _locations;
    NSString * _name;
...
@property (nonatomic, readonly, copy) GDGraphEatingActivityEventEntityIdentifier *entityIdentifier;
