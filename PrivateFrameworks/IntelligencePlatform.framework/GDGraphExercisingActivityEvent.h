...
@interface GDGraphExercisingActivityEvent : NSObject <GDGraphObject> {
    ...
    GDGraphExercisingActivityEventEntityIdentifier * _entityIdentifier;
    NSArray * _locations;
    NSString * _name;
...
@property (nonatomic, readonly, copy) GDGraphExercisingActivityEventEntityIdentifier *entityIdentifier;
