...
@interface GDGraphFacetimeActivityEvent : NSObject <GDGraphObject> {
    ...
    GDGraphFacetimeActivityEventEntityIdentifier * _entityIdentifier;
    NSArray * _locations;
    NSString * _name;
...
@property (nonatomic, readonly, copy) GDGraphFacetimeActivityEventEntityIdentifier *entityIdentifier;
