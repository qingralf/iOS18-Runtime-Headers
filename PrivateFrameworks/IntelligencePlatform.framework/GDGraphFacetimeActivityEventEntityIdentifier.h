...
@interface GDGraphFacetimeActivityEventEntityIdentifier : GDEntityIdentifier <GDGraphEntityIdentifier>
...
- (id)description;
- (id)graphFacetimeActivityEventFromContext:(id)arg1 error:(id*)arg2;
