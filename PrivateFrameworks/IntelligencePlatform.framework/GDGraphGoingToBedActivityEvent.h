...
@interface GDGraphGoingToBedActivityEvent : NSObject <GDGraphObject> {
    ...
    GDGraphGoingToBedActivityEventEntityIdentifier * _entityIdentifier;
    NSArray * _locations;
    NSString * _name;
...
@property (nonatomic, readonly, copy) GDGraphGoingToBedActivityEventEntityIdentifier *entityIdentifier;
