...
@interface GDGraphGoingToBedActivityEventEntityIdentifier : GDEntityIdentifier <GDGraphEntityIdentifier>
...
- (id)description;
- (id)graphGoingToBedActivityEventFromContext:(id)arg1 error:(id*)arg2;
