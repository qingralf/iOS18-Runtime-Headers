...
@interface GDGraphLocationVisitActivityEvent : NSObject <GDGraphObject> {
    ...
    GDGraphLocationVisitActivityEventEntityIdentifier * _entityIdentifier;
    NSArray * _locations;
    NSString * _name;
...
@property (nonatomic, readonly, copy) GDGraphLocationVisitActivityEventEntityIdentifier *entityIdentifier;
