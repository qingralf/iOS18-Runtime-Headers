...
@interface GDGraphLocationVisitActivityEventEntityIdentifier : GDEntityIdentifier <GDGraphEntityIdentifier>
...
- (id)description;
- (id)graphLocationVisitActivityEventFromContext:(id)arg1 error:(id*)arg2;
