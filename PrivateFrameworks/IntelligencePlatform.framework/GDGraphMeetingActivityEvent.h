...
@interface GDGraphMeetingActivityEvent : NSObject <GDGraphObject> {
    ...
    GDGraphMeetingActivityEventEntityIdentifier * _entityIdentifier;
    NSArray * _locations;
    NSString * _name;
...
@property (nonatomic, readonly, copy) GDGraphMeetingActivityEventEntityIdentifier *entityIdentifier;
