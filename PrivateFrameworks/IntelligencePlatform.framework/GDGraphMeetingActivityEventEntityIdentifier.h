...
@interface GDGraphMeetingActivityEventEntityIdentifier : GDEntityIdentifier <GDGraphEntityIdentifier>
...
- (id)description;
- (id)graphMeetingActivityEventFromContext:(id)arg1 error:(id*)arg2;
