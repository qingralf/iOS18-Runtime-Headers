...
@interface GDGraphMindfulnessActivityEvent : NSObject <GDGraphObject> {
    ...
    GDGraphMindfulnessActivityEventEntityIdentifier * _entityIdentifier;
    NSArray * _locations;
    NSString * _name;
...
@property (nonatomic, readonly, copy) GDGraphMindfulnessActivityEventEntityIdentifier *entityIdentifier;
