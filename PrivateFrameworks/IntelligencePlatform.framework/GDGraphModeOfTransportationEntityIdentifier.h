...
@interface GDGraphModeOfTransportationEntityIdentifier : GDEntityIdentifier <GDGraphEntityIdentifier>
...
- (id)description;
- (id)graphModeOfTransportationFromContext:(id)arg1 error:(id*)arg2;
