...
@interface GDGraphOnThePhoneActivityEvent : NSObject <GDGraphObject> {
    ...
    GDGraphOnThePhoneActivityEventEntityIdentifier * _entityIdentifier;
    NSArray * _locations;
    NSString * _name;
...
@property (nonatomic, readonly, copy) GDGraphOnThePhoneActivityEventEntityIdentifier *entityIdentifier;
