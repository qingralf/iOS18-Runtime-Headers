...
@interface GDGraphReadingActivityEvent : NSObject <GDGraphObject> {
    ...
    GDGraphReadingActivityEventEntityIdentifier * _entityIdentifier;
    NSArray * _locations;
    NSString * _name;
...
@property (nonatomic, readonly, copy) GDGraphReadingActivityEventEntityIdentifier *entityIdentifier;
