...
@interface GDGraphReadingActivityEventEntityIdentifier : GDEntityIdentifier <GDGraphEntityIdentifier>
...
- (id)description;
- (id)graphReadingActivityEventFromContext:(id)arg1 error:(id*)arg2;
