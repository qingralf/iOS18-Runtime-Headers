...
@interface GDGraphRunningActivityEvent : NSObject <GDGraphObject> {
    ...
    GDGraphRunningActivityEventEntityIdentifier * _entityIdentifier;
    NSArray * _locations;
    NSString * _name;
...
@property (nonatomic, readonly, copy) GDGraphRunningActivityEventEntityIdentifier *entityIdentifier;
