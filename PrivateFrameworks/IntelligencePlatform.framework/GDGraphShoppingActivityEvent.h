...
@interface GDGraphShoppingActivityEvent : NSObject <GDGraphObject> {
    ...
    GDGraphShoppingActivityEventEntityIdentifier * _entityIdentifier;
    NSArray * _locations;
    NSString * _name;
...
@property (nonatomic, readonly, copy) GDGraphShoppingActivityEventEntityIdentifier *entityIdentifier;
