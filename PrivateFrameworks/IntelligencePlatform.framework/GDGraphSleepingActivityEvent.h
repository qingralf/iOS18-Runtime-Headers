...
@interface GDGraphSleepingActivityEvent : NSObject <GDGraphObject> {
    ...
    GDGraphSleepingActivityEventEntityIdentifier * _entityIdentifier;
    NSArray * _locations;
    NSString * _name;
...
@property (nonatomic, readonly, copy) GDGraphSleepingActivityEventEntityIdentifier *entityIdentifier;
