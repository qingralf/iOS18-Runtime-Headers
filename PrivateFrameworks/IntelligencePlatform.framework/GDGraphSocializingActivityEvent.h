...
@interface GDGraphSocializingActivityEvent : NSObject <GDGraphObject> {
    ...
    GDGraphSocializingActivityEventEntityIdentifier * _entityIdentifier;
    NSArray * _locations;
    NSString * _name;
...
@property (nonatomic, readonly, copy) GDGraphSocializingActivityEventEntityIdentifier *entityIdentifier;
