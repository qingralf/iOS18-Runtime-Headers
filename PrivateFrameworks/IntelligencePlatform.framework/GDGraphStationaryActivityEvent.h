...
@interface GDGraphStationaryActivityEvent : NSObject <GDGraphObject> {
    ...
    GDGraphStationaryActivityEventEntityIdentifier * _entityIdentifier;
    NSArray * _locations;
    NSString * _name;
...
@property (nonatomic, readonly, copy) GDGraphStationaryActivityEventEntityIdentifier *entityIdentifier;
