...
@interface GDGraphStationaryActivityEventEntityIdentifier : GDEntityIdentifier <GDGraphEntityIdentifier>
...
- (id)description;
- (id)graphStationaryActivityEventFromContext:(id)arg1 error:(id*)arg2;
