...
@interface GDGraphTravelingActivityEvent : NSObject <GDGraphObject> {
    ...
    GDGraphTravelingActivityEventEntityIdentifier * _entityIdentifier;
    NSArray * _locations;
    NSString * _name;
...
@property (nonatomic, readonly, copy) GDGraphTravelingActivityEventEntityIdentifier *entityIdentifier;
