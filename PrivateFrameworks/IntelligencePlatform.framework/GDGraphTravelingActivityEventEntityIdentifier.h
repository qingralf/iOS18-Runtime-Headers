...
@interface GDGraphTravelingActivityEventEntityIdentifier : GDEntityIdentifier <GDGraphEntityIdentifier>
...
- (id)description;
- (id)graphTravelingActivityEventFromContext:(id)arg1 error:(id*)arg2;
