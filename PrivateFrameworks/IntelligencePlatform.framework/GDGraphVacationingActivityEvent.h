...
@interface GDGraphVacationingActivityEvent : NSObject <GDGraphObject> {
    ...
    GDGraphVacationingActivityEventEntityIdentifier * _entityIdentifier;
    NSArray * _locations;
    NSString * _name;
...
@property (nonatomic, readonly, copy) GDGraphVacationingActivityEventEntityIdentifier *entityIdentifier;
