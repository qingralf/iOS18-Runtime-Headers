...
@interface GDGraphWakingUpActivityEvent : NSObject <GDGraphObject> {
    ...
    GDGraphWakingUpActivityEventEntityIdentifier * _entityIdentifier;
    NSArray * _locations;
    NSString * _name;
...
@property (nonatomic, readonly, copy) GDGraphWakingUpActivityEventEntityIdentifier *entityIdentifier;
