...
@interface GDGraphWalkingActivityEvent : NSObject <GDGraphObject> {
    ...
    GDGraphWalkingActivityEventEntityIdentifier * _entityIdentifier;
    NSArray * _locations;
    NSString * _name;
...
@property (nonatomic, readonly, copy) GDGraphWalkingActivityEventEntityIdentifier *entityIdentifier;
