...
@interface GDGraphWatchingTVActivityEvent : NSObject <GDGraphObject> {
    ...
    GDGraphWatchingTVActivityEventEntityIdentifier * _entityIdentifier;
    NSArray * _locations;
    NSString * _name;
...
@property (nonatomic, readonly, copy) GDGraphWatchingTVActivityEventEntityIdentifier *entityIdentifier;
