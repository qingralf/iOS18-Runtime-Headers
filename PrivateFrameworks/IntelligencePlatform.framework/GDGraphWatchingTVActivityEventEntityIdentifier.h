...
@interface GDGraphWatchingTVActivityEventEntityIdentifier : GDEntityIdentifier <GDGraphEntityIdentifier>
...
- (id)description;
- (id)graphWatchingTVActivityEventFromContext:(id)arg1 error:(id*)arg2;
