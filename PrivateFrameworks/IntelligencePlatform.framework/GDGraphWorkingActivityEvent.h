...
@interface GDGraphWorkingActivityEvent : NSObject <GDGraphObject> {
    ...
    GDGraphWorkingActivityEventEntityIdentifier * _entityIdentifier;
    NSArray * _locations;
    NSString * _name;
...
@property (nonatomic, readonly, copy) GDGraphWorkingActivityEventEntityIdentifier *entityIdentifier;
