...
@property (nonatomic, readonly) bool enableTextualization;
...
- (id)initWithKGQ:(id)arg1 query:(id)arg2 limit:(id)arg3 offset:(id)arg4 enableDebug:(bool)arg5 enableTextualization:(bool)arg6;
- (id)intentArgs;
- (id)kgq;
- (id)limit;
- (id)offset;
