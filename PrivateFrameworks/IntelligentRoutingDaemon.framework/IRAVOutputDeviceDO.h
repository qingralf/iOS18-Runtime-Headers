...
@property (nonatomic, readonly) bool discoveredWithBroker;
@property (nonatomic, readonly) bool hasAirplayProperties;
@property (nonatomic, readonly) NSString *modelID;

+ (id)AVOutputDeviceToDO:(id)arg1;
+ (id)aVOutputDeviceDOWithDeviceID:(id)arg1 modelID:(id)arg2 deviceName:(id)arg3 hasAirplayProperties:(bool)arg4 discoveredOverInfra:(bool)arg5 discoveredWithBroker:(bool)arg6 deviceType:(unsigned long long)arg7 deviceSubType:(unsigned long long)arg8;
...
- (id)copyWithReplacementDiscoveredWithBroker:(bool)arg1;
...
- (id)initWithDeviceID:(id)arg1 modelID:(id)arg2 deviceName:(id)arg3 hasAirplayProperties:(bool)arg4 discoveredOverInfra:(bool)arg5 discoveredWithBroker:(bool)arg6 deviceType:(unsigned long long)arg7 deviceSubType:(unsigned long long)arg8;
