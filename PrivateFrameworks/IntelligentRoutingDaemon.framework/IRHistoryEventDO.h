...
@property (nonatomic, readonly) NSString *sharingPolicy;
@property (nonatomic, readonly) IRSystemStateDO *systemState;

+ (id)historyEventDOWithDate:(id)arg1 candidateIdentifier:(id)arg2 event:(id)arg3 miloPredictionEvent:(id)arg4 systemState:(id)arg5 sharingPolicy:(id)arg6;
...
- (id)copyWithReplacementSharingPolicy:(id)arg1;
...
- (id)initWithDate:(id)arg1 candidateIdentifier:(id)arg2 event:(id)arg3 miloPredictionEvent:(id)arg4 systemState:(id)arg5 sharingPolicy:(id)arg6;
