...
+ (id)nodeDOWithAvOutpuDeviceIdentifier:(id)arg1 rapportIdentifier:(id)arg2 idsIdentifier:(id)arg3 avOutputDevice:(id)arg4 rapportDevice:(id)arg5 isLocal:(bool)arg6;
...
- (id)copyWithReplacementIsLocal:(bool)arg1;
...
- (id)idsIdentifier;
- (id)init;
- (id)initWithAvOutpuDeviceIdentifier:(id)arg1 rapportIdentifier:(id)arg2 idsIdentifier:(id)arg3 avOutputDevice:(id)arg4 rapportDevice:(id)arg5 isLocal:(bool)arg6;
