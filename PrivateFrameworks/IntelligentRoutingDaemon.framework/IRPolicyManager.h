...
@interface IRPolicyManager : NSObject <IRDeallocSync, IRPersistenceSynchronizable, IRPolicyManagerContextObserver, IRServiceHandling> {
    ...
    IRSessionAnalytics * _sessionAnalytics;
    NSMutableSet * _spotOnPendingClientIDs;
    IRTimer * _spotOnTimeout;
...
@property (nonatomic, retain) IRSessionAnalytics *sessionAnalytics;
@property (nonatomic, retain) NSMutableSet *spotOnPendingClientIDs;
@property (nonatomic, retain) IRTimer *spotOnTimeout;
...
- (void).cxx_destruct;
- (void)_checkAndStartLowLatencyMiLoIfNeededWithForce:(bool)arg1 historyEventsContainer:(id)arg2;
- (void)_checkAndUpdateBundlesForEventIfNeeded:(id)arg1;
- (id)_createContextOverrdiesForBundleIDIfNeeded:(id)arg1;
- (void)_sendSessionAnalyticsEvent:(id)arg1 forCandidate:(id)arg2;
...
- (void)didSpotOnLocationComplete:(id)arg1;
- (void)didUpdateContextWithReason:(id)arg1 andOverrides:(id)arg2;
- (id)getService;
- (id)getStatistics;
- (id)historyManager;
...
- (id)queue;
- (id)replayWriter;
- (id)requestCurrentContextWithBundleID:(id)arg1;
...
- (void)setSessionAnalytics:(id)arg1;
- (void)setSpotOnLocationWithParameters:(id)arg1 andClientID:(id)arg2;
- (void)setSpotOnPendingClientIDs:(id)arg1;
- (void)setSpotOnTimeout:(id)arg1;
- (void)setStatisticsManager:(id)arg1;
- (void)setSystemStateManager:(id)arg1;
- (void)setUpdateMode:(long long)arg1;
- (id)spotOnPendingClientIDs;
- (id)spotOnTimeout;
