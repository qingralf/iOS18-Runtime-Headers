...
+ (id)createServiceWithClientIdentifier:(id)arg1 serviceIdentifier:(id)arg2 parameters:(id)arg3 persistenceManager:(id)arg4;
...
- (id)policyManager;
- (void)policyManager:(id)arg1 didSpotOnLocationCompleteForClientIds:(id)arg2 withError:(id)arg3;
- (void)policyManager:(id)arg1 didUpdateBundlesWithSignificantInteractionPattern:(id)arg2;
