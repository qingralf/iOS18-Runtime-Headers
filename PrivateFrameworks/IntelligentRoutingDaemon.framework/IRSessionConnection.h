...
- (void).cxx_destruct;
- (void)_addEvent:(id)arg1 forCandidate:(id)arg2;
...
- (void)_invalidate;
- (void)_requestCurrentContextWithBundleID:(id)arg1;
- (void)_runWithConfiguration:(id)arg1;
- (void)_setSpotOnLocationWithParameters:(id)arg1;
- (void)_updateCandidates:(id)arg1;
- (id)client;
- (void)didSpotOnLocationComplete:(id)arg1;
- (void)didUpdateBundlesWithSignificantInteractionPattern:(id)arg1;
