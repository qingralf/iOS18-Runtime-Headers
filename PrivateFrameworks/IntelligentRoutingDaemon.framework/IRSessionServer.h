...
- (void).cxx_destruct;
- (void)_dispatchToConnectionsForServiceContainer:(id)arg1 usingBlock:(id /* block */)arg2;
...
- (void)serviceContainer:(id)arg1 didSpotOnLocationCompleteForClientIds:(id)arg2 withError:(id)arg3;
- (void)serviceContainer:(id)arg1 didUpdateBundlesWithSignificantInteractionPattern:(id)arg2;
