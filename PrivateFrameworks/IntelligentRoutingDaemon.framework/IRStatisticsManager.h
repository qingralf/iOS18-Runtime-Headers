...
- (void)_updateMiLoStatisticsIfNeededWithReason:(id)arg1 mode:(long long)arg2 miloPrediction:(id)arg3;
- (void)_updateModeStatisticsIfNeededWithReason:(id)arg1 mode:(long long)arg2 date:(id)arg3;
- (id)appLaunchDate;
