...
@interface IRSystemStateDO : NSObject <NSCopying, NSSecureCoding> {
    ...
    NSDate * _latestPickerChoiceDate;
...
@property (nonatomic, readonly) bool isContinuityDisplay;
@property (nonatomic, readonly) NSDate *latestPickerChoiceDate;
...
@property (nonatomic, readonly) bool pdrFenceActive;
...
- (id)copyWithReplacementDisplayOn:(bool)arg1;
- (id)copyWithReplacementICloudId:(id)arg1;
- (id)copyWithReplacementIsContinuityDisplay:(bool)arg1;
- (id)copyWithReplacementLatestPickerChoiceDate:(id)arg1;
...
- (id)copyWithReplacementPdrFenceActive:(bool)arg1;
...
- (id)overrideSystemStateIfNeeded:(id)arg1;
- (bool)pdrFenceActive;
