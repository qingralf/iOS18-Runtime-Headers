...
- (void).cxx_destruct;
- (id)_activeFocusedHostHandleForKeyboardFocusAndGetLeafHandle:(id*)arg1;
...
- (void)_focusSceneHandle:(id)arg1 previousHostFocusHandle:(id)arg2 previousLeafFocusHandle:(id)arg3 shouldStealKeyboardOnSuccess:(bool)arg4;
- (id)_handleForSceneIdentity:(id)arg1;
...
- (void)applySceneFocusChange:(id)arg1 forRequest:(id)arg2;
...
- (void)reevaluateFocusedSceneIdentityForKeyboardFocusStealingKeyboardOnSuccess:(bool)arg1;
...
- (void)updateKeyboardStatus:(id)arg1 fromHandler:(id)arg2 fromFocus:(bool)arg3;
