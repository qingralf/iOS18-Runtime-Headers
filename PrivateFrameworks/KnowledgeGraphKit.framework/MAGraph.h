...
- (void)enumerateUnsignedLongLongPropertyValuesForKey:(id)arg1 ofEdgesWithIdentifiers:(id)arg2 usingBlock:(id /* block */)arg3;
- (void)enumerateUnsignedLongLongPropertyValuesForKey:(id)arg1 ofNodesWithIdentifiers:(id)arg2 usingBlock:(id /* block */)arg3;
