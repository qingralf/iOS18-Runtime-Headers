...
+ (unsigned long long)numberOfNodesRelatedToNodes:(id)arg1 withRelation:(id)arg2;
...
- (void)enumerateUnsignedLongLongPropertyValuesForKey:(id)arg1 withBlock:(id /* block */)arg2;
- (id)firstNode;
