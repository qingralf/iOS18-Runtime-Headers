...
@property (nonatomic, retain) NSMutableDictionary *previousVendorIDs;
@property (nonatomic, retain) BMPruner *pruner;
@property (readonly) Class superclass;

+ (int)BMDeviceBluetoothDeviceTypeFromBTDeviceType:(int)arg1;
+ (id)_BMEventFromDKEvent:(id)arg1 starting:(bool)arg2 vendorID:(id)arg3;
...
- (void)setPreviousVendorIDs:(id)arg1;
