...
+ (id)_bmEventWithDKEvent:(id)arg1 outputDevices:(id)arg2 biomeEventMetadata:(id)arg3 excludeFromSuggestions:(bool)arg4;
...
- (void)saveBMEventWithCurrent:(id)arg1 outputDevices:(id)arg2 artistStoreIdentifier:(id)arg3 albumStoreIdentifier:(id)arg4 excludeFromSuggestions:(bool)arg5;
