...
@property (nonatomic, readonly) bool wf_isPersistentFileIdentifiableEntity;
...
@property (nonatomic, readonly) WFParameterDefinition *wf_parameterDictionaryRepresentation;
...
- (void).cxx_destruct;
- (id)actionParameterMetadataWithCapabilities:(unsigned long long)arg1;
- (id)actionParameterMetadataWithDescriptiveMetadataFromParameter:(id)arg1 usingLibraryKey:(id)arg2;
...
- (id)initWithName:(id)arg1 valueType:(id)arg2 optional:(bool)arg3 title:(id)arg4 description:(id)arg5 resolvableInputTypes:(id)arg6 typeSpecificMetadata:(id)arg7 dynamicOptionsSupport:(long long)arg8 inputConnectionBehavior:(long long)arg9 capabilities:(unsigned long long)arg10;
- (id)initWithName:(id)arg1 valueType:(id)arg2 optional:(bool)arg3 title:(id)arg4 description:(id)arg5 resolvableInputTypes:(id)arg6 typeSpecificMetadata:(id)arg7 dynamicOptionsSupport:(long long)arg8 inputConnectionBehavior:(long long)arg9 capabilities:(unsigned long long)arg10 queryIdentifier:(id)arg11;
...
- (bool)wf_isPersistentFileIdentifiableEntity;
