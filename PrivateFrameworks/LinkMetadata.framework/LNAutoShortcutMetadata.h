...
- (id)initWithActionIdentifier:(id)arg1 phraseTemplates:(id)arg2 shortTitle:(id)arg3 autoShortcutDescription:(id)arg4 systemImageName:(id)arg5 availabilityAnnotations:(id)arg6;
...
- (id)initWithActionIdentifier:(id)arg1 phraseTemplates:(id)arg2 shortTitle:(id)arg3 autoShortcutDescription:(id)arg4 systemImageName:(id)arg5 parameterPresentation:(id)arg6 availabilityAnnotations:(id)arg7;
