...
@interface LNBundleMetadata : NSObject <NSCopying, NSSecureCoding> {
    ...
    NSArray * _assistantEntities;
    NSArray * _assistantIntentNegativePhrases;
    NSArray * _assistantIntents;
    NSString * _autoShortcutProviderMangledName;
    NSArray * _autoShortcuts;
    NSDictionary * _entities;
    NSDictionary * _enums;
    NSArray * _examplePhrases;
...
@property (nonatomic, readonly, copy) NSArray *assistantEntities;
@property (nonatomic, readonly, copy) NSArray *assistantIntentNegativePhrases;
@property (nonatomic, readonly, copy) NSArray *assistantIntents;
...
@property (nonatomic, readonly, copy) NSArray *examplePhrases;
...
- (id)actions;
- (void)applyAttributionBundleIdentifier:(id)arg1 icon:(id)arg2;
- (id)assistantEntities;
- (id)assistantIntentNegativePhrases;
- (id)assistantIntents;
...
- (id)initWithActions:(id)arg1 entities:(id)arg2 queries:(id)arg3 enums:(id)arg4 autoShortcutProviderMangledName:(id)arg5 autoShortcuts:(id)arg6 shortcutTileColor:(long long)arg7 version:(long long)arg8 generator:(id)arg9 negativePhrases:(id)arg10 examplePhrases:(id)arg11;
- (id)initWithActions:(id)arg1 entities:(id)arg2 queries:(id)arg3 enums:(id)arg4 autoShortcutProviderMangledName:(id)arg5 autoShortcuts:(id)arg6 shortcutTileColor:(long long)arg7 version:(long long)arg8 generator:(id)arg9 negativePhrases:(id)arg10 examplePhrases:(id)arg11 assistantIntents:(id)arg12 assistantIntentNegativePhrases:(id)arg13;
- (id)initWithActions:(id)arg1 entities:(id)arg2 queries:(id)arg3 enums:(id)arg4 autoShortcutProviderMangledName:(id)arg5 autoShortcuts:(id)arg6 shortcutTileColor:(long long)arg7 version:(long long)arg8 generator:(id)arg9 negativePhrases:(id)arg10 examplePhrases:(id)arg11 assistantIntents:(id)arg12 assistantIntentNegativePhrases:(id)arg13 assistantEntities:(id)arg14;
