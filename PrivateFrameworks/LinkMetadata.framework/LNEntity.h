...
@interface LNEntity : NSObject <BSXPCSecureCoding, NSCopying, NSSecureCoding> {
    ...
    bool  _persistentFileIdentifiable;
    NSArray * _properties;
...
@property (getter=isPersistentFileIdentifiable, nonatomic, readonly) bool persistentFileIdentifiable;
...
- (id)initWithTransient:(bool)arg1 identifier:(id)arg2 persistentFileIdentifiable:(bool)arg3 properties:(id)arg4 managedAccountIdentifier:(id)arg5;
