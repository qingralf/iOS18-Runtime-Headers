...
@interface LNEntityMetadata : NSObject <LNEffectiveBundleIdentifierGrouping, LNVisibilityQuery, NSCopying, NSSecureCoding> {
    ...
    NSString * _defaultQueryIdentifier;
    ...
    LNContentTypeMetadata * _transferableContentTypes;
    bool  _transient;
...
@property (nonatomic, readonly, copy) NSString *defaultQueryIdentifier;
...
@property (nonatomic, readonly, copy) LNContentTypeMetadata *transferableContentTypes;
...
- (id)copyWithAdditionalTransferableContentTypes:(id)arg1;
- (id)copyWithDescriptiveMetadataFromEntity:(id)arg1 usingLibraryKey:(id)arg2;
- (id)copyWithZone:(struct _NSZone { }*)arg1;
- (id)customIntentTypeClassName;
- (id)defaultQueryIdentifier;
- (id)description;
- (id)displayRepresentation;
- (id)displayTypeName;
- (id)effectiveBundleIdentifiers;
- (void)encodeWithCoder:(id)arg1;
- (id)entityMetadataWithAttributionBundleIdentifier:(id)arg1;
...
- (id)initWithIdentifier:(id)arg1 transient:(bool)arg2 mangledTypeName:(id)arg3 mangledTypeNameByBundleIdentifier:(id)arg4 effectiveBundleIdentifiers:(id)arg5 displayRepresentation:(id)arg6 properties:(id)arg7 customIntentTypeClassName:(id)arg8 availabilityAnnotations:(id)arg9 requiredCapabilities:(id)arg10 systemProtocolMetadata:(id)arg11 attributionBundleIdentifier:(id)arg12;
- (id)initWithIdentifier:(id)arg1 transient:(bool)arg2 mangledTypeName:(id)arg3 mangledTypeNameByBundleIdentifier:(id)arg4 effectiveBundleIdentifiers:(id)arg5 displayRepresentation:(id)arg6 properties:(id)arg7 customIntentTypeClassName:(id)arg8 availabilityAnnotations:(id)arg9 requiredCapabilities:(id)arg10 systemProtocolMetadata:(id)arg11 attributionBundleIdentifier:(id)arg12 transferableContentTypes:(id)arg13;
- (id)initWithIdentifier:(id)arg1 transient:(bool)arg2 mangledTypeName:(id)arg3 mangledTypeNameByBundleIdentifier:(id)arg4 effectiveBundleIdentifiers:(id)arg5 displayRepresentation:(id)arg6 properties:(id)arg7 customIntentTypeClassName:(id)arg8 availabilityAnnotations:(id)arg9 requiredCapabilities:(id)arg10 systemProtocolMetadata:(id)arg11 attributionBundleIdentifier:(id)arg12 transferableContentTypes:(id)arg13 assistantDefinedSchemas:(id)arg14;
- (id)initWithIdentifier:(id)arg1 transient:(bool)arg2 mangledTypeName:(id)arg3 mangledTypeNameByBundleIdentifier:(id)arg4 effectiveBundleIdentifiers:(id)arg5 displayRepresentation:(id)arg6 properties:(id)arg7 customIntentTypeClassName:(id)arg8 availabilityAnnotations:(id)arg9 requiredCapabilities:(id)arg10 systemProtocolMetadata:(id)arg11 attributionBundleIdentifier:(id)arg12 transferableContentTypes:(id)arg13 assistantDefinedSchemas:(id)arg14 fullyQualifiedTypeName:(id)arg15;
- (id)initWithIdentifier:(id)arg1 transient:(bool)arg2 mangledTypeName:(id)arg3 mangledTypeNameByBundleIdentifier:(id)arg4 effectiveBundleIdentifiers:(id)arg5 displayRepresentation:(id)arg6 properties:(id)arg7 customIntentTypeClassName:(id)arg8 availabilityAnnotations:(id)arg9 requiredCapabilities:(id)arg10 systemProtocolMetadata:(id)arg11 attributionBundleIdentifier:(id)arg12 transferableContentTypes:(id)arg13 assistantDefinedSchemas:(id)arg14 fullyQualifiedTypeName:(id)arg15 visibilityMetadata:(id)arg16;
- (id)initWithIdentifier:(id)arg1 transient:(bool)arg2 mangledTypeName:(id)arg3 mangledTypeNameByBundleIdentifier:(id)arg4 effectiveBundleIdentifiers:(id)arg5 displayRepresentation:(id)arg6 properties:(id)arg7 customIntentTypeClassName:(id)arg8 availabilityAnnotations:(id)arg9 requiredCapabilities:(id)arg10 systemProtocolMetadata:(id)arg11 attributionBundleIdentifier:(id)arg12 transferableContentTypes:(id)arg13 assistantDefinedSchemas:(id)arg14 fullyQualifiedTypeName:(id)arg15 visibilityMetadata:(id)arg16 defaultQueryIdentifier:(id)arg17;
...
- (id)initWithIdentifier:(id)arg1 transient:(bool)arg2 mangledTypeName:(id)arg3 mangledTypeNameByBundleIdentifier:(id)arg4 effectiveBundleIdentifiers:(id)arg5 displayRepresentation:(id)arg6 properties:(id)arg7 customIntentTypeClassName:(id)arg8 availabilityAnnotations:(id)arg9 systemProtocolMetadata:(id)arg10 attributionBundleIdentifier:(id)arg11;
