...
@interface LNEnumMetadata : NSObject <LNEffectiveBundleIdentifierGrouping, LNVisibilityQuery, NSCopying, NSSecureCoding> {
...
- (id)cases;
- (id)copyWithDescriptiveMetadataFromEnum:(id)arg1 usingLibraryKey:(id)arg2;
...
- (id)initWithIdentifier:(id)arg1 mangledTypeName:(id)arg2 mangledTypeNameByBundleIdentifier:(id)arg3 effectiveBundleIdentifiers:(id)arg4 displayRepresentation:(id)arg5 cases:(id)arg6 customIntentEnumTypeName:(id)arg7 availabilityAnnotations:(id)arg8 system:(id)arg9 fullyQualifiedTypeName:(id)arg10;
- (id)initWithIdentifier:(id)arg1 mangledTypeName:(id)arg2 mangledTypeNameByBundleIdentifier:(id)arg3 effectiveBundleIdentifiers:(id)arg4 displayRepresentation:(id)arg5 cases:(id)arg6 customIntentEnumTypeName:(id)arg7 availabilityAnnotations:(id)arg8 system:(id)arg9 fullyQualifiedTypeName:(id)arg10 assistantDefinedSchemas:(id)arg11;
- (id)initWithIdentifier:(id)arg1 mangledTypeName:(id)arg2 mangledTypeNameByBundleIdentifier:(id)arg3 effectiveBundleIdentifiers:(id)arg4 displayRepresentation:(id)arg5 cases:(id)arg6 customIntentEnumTypeName:(id)arg7 availabilityAnnotations:(id)arg8 system:(id)arg9 fullyQualifiedTypeName:(id)arg10 assistantDefinedSchemas:(id)arg11 visibilityMetadata:(id)arg12;
...
- (id)wf_contentItemWithAppBundleIdentifier:(id)arg1 enumCaseIdentifier:(id)arg2;
