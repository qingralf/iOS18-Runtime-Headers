...
- (id)wf_parameterDefinitionWithParameterMetadata:(id)arg1 actionIdentifier:(id)arg2;
- (id)wf_parameterDefinitionWithParameterMetadata:(id)arg1 dynamicOptionsSupport:(bool)arg2;
- (id)wf_parameterDefinitionWithParameterMetadata:(id)arg1 dynamicOptionsSupport:(bool)arg2 actionIdentifier:(id)arg3;
