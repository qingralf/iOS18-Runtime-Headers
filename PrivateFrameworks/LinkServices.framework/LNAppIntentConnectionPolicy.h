...
- (id)initWithAppIntentMetadata:(id)arg1 effectiveBundleIdentifier:(id)arg2 appBundleIdentifier:(id)arg3 processInstanceIdentifier:(id)arg4;
- (bool)isEqual:(id)arg1;
- (id)metadata;
- (id)newConnectionForSpringBoardOnlyWithError:(id*)arg1;
- (bool)openAppWhenRun;
