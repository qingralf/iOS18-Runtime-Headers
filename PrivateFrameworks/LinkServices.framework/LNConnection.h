...
@property (nonatomic, readonly) LNUserIdentity *userIdentity;
...
- (void)connectUsingListenerEndpoint:(id)arg1 auditToken:(struct { unsigned int x1[8]; })arg2 setupWithAssertions:(bool)arg3;
- (bool)connectUsingProcessIdentifierWithOptions:(id)arg1 setupWithAssertions:(bool)arg2;
...
- (id)executors;
- (void)exportEntities:(id)arg1 metadata:(id)arg2 withConfiguration:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (void)fetchListenerEndpointFromApplicationServiceWithCompletionHandler:(id /* block */)arg1;
...
- (void)setUpConnectionContextWithAssertions:(bool)arg1 completionHandler:(id /* block */)arg2;
