...
@property (nonatomic, readonly) BMAppIntentInvocation *asBMAppIntentInvocation;
...
@property (nonatomic, readonly) bool hasNextAction;
...
- (id)initWithBundleIdentifier:(id)arg1 source:(unsigned short)arg2 clientLabel:(id)arg3 executionUUID:(id)arg4 executionDate:(id)arg5 actionData:(id)arg6 resolvedActionData:(id)arg7 actionOutputData:(id)arg8 predictionsData:(id)arg9 hasNextAction:(bool)arg10;
