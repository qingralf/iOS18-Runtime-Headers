...
- (void)lookupIn:(id)arg1 name:(id)arg2 usingFlags:(unsigned int)arg3 requestID:(unsigned long long)arg4 reply:(id /* block */)arg5;
...
- (void)readDirectory:(id)arg1 amount:(unsigned long long)arg2 requestedAttributes:(unsigned long long)arg3 cookie:(unsigned long long)arg4 verifier:(unsigned long long)arg5 requestID:(unsigned long long)arg6 reply:(id /* block */)arg7;
...
- (void)readDirectory:(id)arg1 intoBuffer:(id)arg2 requestedAttributes:(unsigned long long)arg3 cookie:(unsigned long long)arg4 verifier:(unsigned long long)arg5 requestID:(unsigned long long)arg6 reply:(id /* block */)arg7;
...
- (void)renameItemIn:(id)arg1 named:(id)arg2 item:(id)arg3 toDirectory:(id)arg4 newName:(id)arg5 toItem:(id)arg6 usingFlags:(unsigned int)arg7 requestID:(unsigned long long)arg8 reply:(id /* block */)arg9;
