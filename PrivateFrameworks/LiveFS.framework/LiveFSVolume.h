...
- (void)lookupin:(id)arg1 name:(id)arg2 forClient:(unsigned long long)arg3 usingFlags:(unsigned int)arg4 requestID:(unsigned long long)arg5 reply:(id /* block */)arg6;
