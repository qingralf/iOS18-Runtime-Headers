...
- (id)_stopStreamOptionWithReason:(unsigned long long)arg1 forRequestId:(id)arg2;
- (id)audioStream;
...
- (void)stopAudioCaptureWithReason:(unsigned long long)arg1 requestId:(id)arg2 completion:(id /* block */)arg3;
- (id)xpcClient;
