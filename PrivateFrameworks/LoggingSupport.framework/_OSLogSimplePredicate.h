...
- (void).cxx_destruct;
- (id)initWithPredicate:(id)arg1 supportedKeys:(id)arg2 supportedOperators:(id)arg3 supportedCompoundTypes:(id)arg4;
- (bool)isSupportedCompoundType:(unsigned long long)arg1;
