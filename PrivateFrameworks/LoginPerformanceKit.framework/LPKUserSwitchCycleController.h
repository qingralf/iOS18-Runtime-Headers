...
- (void)_setUserSwitchDestinationExpectation:(unsigned long long)arg1 retryIfFailed:(bool)arg2 completionHandler:(id /* block */)arg3;
...
- (bool)startUserSwitchWithType:(unsigned long long)arg1 count:(long long)arg2 username:(id)arg3 password:(id)arg4 loginDelay:(long long)arg5 logoutDelay:(long long)arg6;
