/* Generated by RuntimeBrowser
   Image: /System/Library/PrivateFrameworks/LowPowerMode.framework/LowPowerMode
 */

@interface _PMSmartPowerNap : NSObject <_PMSmartPowerNapCallbackProtocol, _PMSmartPowerNapProtocol> {
    id /* block */  _callback;
