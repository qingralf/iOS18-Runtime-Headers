...
- (id)_appAttributesWithRequestedAttributes:(id)arg1;
- (id)_appManagementFlagsWithRequestedFlags:(id)arg1;
...
- (bool)_isDDMProfileIdentifier:(id)arg1;
...
- (bool)_isPurchaseMethodAllowed:(int)arg1 onUserEnrollment:(bool)arg2;
...
- (id)_performSetDefaultApplications:(id)arg1;
- (void)_performSetDefaultBrowser:(id)arg1 completion:(id /* block */)arg2;
...
- (id)_setAppAnalyticsEnabled:(bool)arg1;
- (id)_setDiagnosticSubmissionEnabled:(bool)arg1;
...
- (void)willTerminateProcess:(id)arg1;
