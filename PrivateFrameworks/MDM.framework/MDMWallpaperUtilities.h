...
- (void)_updateWallpaperConfiguraitonWithUUID:(id)arg1 updates:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)_updateWallpaperConfiguraitonWithUUID:(id)arg1 updates:(id)arg2 retryCount:(unsigned long long)arg3 completionHandler:(id /* block */)arg4;
