...
@property (nonatomic, copy) NSString *contentTransferEncoding;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (readonly, copy) NSString *description;
@property (nonatomic, copy) NSString *disposition;
@property (nonatomic, readonly) bool hasSecureSubparts;
@property (readonly) unsigned long long hash;
@property (nonatomic, readonly) bool isDecodingComplete;
@property (nonatomic, readonly) bool isEncrypted;
@property (nonatomic, readonly) bool isSecurePart;
...
@property (nonatomic, readonly) ECSubject *wrappedSubject;
...
- (id)_objectInOtherIvarsForKey:(id)arg1;
...
- (id)_decodeEncodedData:(id)arg1 detachedContentData:(id)arg2 isEncrypted:(bool*)arg3 isSigned:(bool*)arg4 signers:(id)arg5 error:(id*)arg6;
- (id)_decodeMultipartSignedWithSecCMS;
- (id)_decodeWithBlock:(id /* block */)arg1;
