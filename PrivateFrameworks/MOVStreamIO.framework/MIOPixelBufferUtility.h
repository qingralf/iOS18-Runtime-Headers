...
+ (bool)bufferHasPadding:(struct __CVBuffer { }*)arg1;
+ (unsigned long long)bytesPerWidthOfBuffer:(struct __CVBuffer { }*)arg1;
+ (struct __CVBuffer { }*)combineLeftBuffer:(struct __CVBuffer { }*)arg1 rightBuffer:(struct __CVBuffer { }*)arg2;
...
+ (bool)copyPixelBuffer:(struct __CVBuffer { }*)arg1 toPixelBuffer:(struct __CVBuffer { }*)arg2;
+ (bool)copyPixelBuffer:(struct __CVBuffer { }*)arg1 toPixelBuffer:(struct __CVBuffer { }*)arg2 bytesPerPixel:(double)arg3;
...
+ (struct __CFDictionary { }*)createPixelBufferAttributesWithWidth:(unsigned int)arg1 height:(unsigned int)arg2 extendedPixelsPerRow:(unsigned int)arg3 pixelFormat:(int)arg4 bytesPerRowAlignment:(unsigned int)arg5 planeAlignment:(unsigned int)arg6 bufferCacheMode:(int)arg7;
...
+ (struct __CVPixelBufferPool { }*)createPixelBufferPoolWithWidth:(unsigned long long)arg1 height:(unsigned long long)arg2 format:(unsigned int)arg3 extendedPixelsPerRow:(unsigned long long)arg4 minBufferCount:(unsigned long long)arg5 bufferCacheMode:(int)arg6;
...
+ (struct __CVBuffer { }*)stripBufferPadding:(struct __CVBuffer { }*)arg1;
+ (void)transferAttachmentForKey:(struct __CFString { }*)arg1 fromBuffer:(struct __CVBuffer { }*)arg2 toBuffer:(struct __CVBuffer { }*)arg3;
+ (bool)transferL010PixelBuffer:(struct __CVBuffer { }*)arg1 toq8q2PixelBuffer:(struct __CVBuffer { }*)arg2;
+ (bool)transferq8q2PixelBuffer:(struct __CVBuffer { }*)arg1 toL010PixelBuffer:(struct __CVBuffer { }*)arg2;
