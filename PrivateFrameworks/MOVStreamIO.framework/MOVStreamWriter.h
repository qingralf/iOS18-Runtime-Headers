...
@interface MOVStreamWriter : NSObject <MOVStreamWriterDeprecated, MOVStreamWriterDeprecationNominates, MOVStreamWriterStateContext, VideoEncoderInterfaceDelegate> {
    ...
    unsigned long long  _writeThreadCount;
    ...
    bool  m_realtime;
    bool  m_shouldOptimizeForNetworkUse;
...
@property bool finalConsume;
@property bool finishingMode;
@property double finishingTimeout;
@property (readonly) unsigned long long hash;
@property bool inProcessRecording;
@property bool isOrWasCanceled;
...
@property bool multiplexWritingDisabled;
@property bool preserveSessionStartTime;
...
+ (id)getTimeRangeMetadataKeyHintMetadataItem:(id)arg1 error:(id*)arg2;
...
- (void)addMetadataTrack:(id)arg1 copyData:(bool)arg2;
...
- (void)addTimeRangeMetadataTrack:(id)arg1;
...
- (void)appendTimeCode:(struct CVSMPTETime { short x1; short x2; unsigned int x3; unsigned int x4; unsigned int x5; short x6; short x7; short x8; short x9; })arg1 startTime:(unsigned long long)arg2 endTime:(unsigned long long)arg3 withTimeStamp:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg4 toStream:(id)arg5;
...
- (int)getCountByPriorityForFifo:(unsigned long long)arg1 capacity:(unsigned long long)arg2;
...
- (id)getTrackMetadataForTimeRangeMetadata:(id)arg1 fromMap:(void*)arg2;
...
- (void)setCanWriteData:(bool)arg1;
...
- (void)setFinalConsume:(bool)arg1;
- (void)setFinishingMode:(bool)arg1;
- (void)setFinishingTimeout:(double)arg1;
- (void)setInProcessRecording:(bool)arg1;
- (void)setIsOrWasCanceled:(bool)arg1;
- (void)setLegacyKeysMode:(bool)arg1;
- (bool)setMediaTimeScale:(int)arg1 forMetadataStream:(id)arg2 error:(id*)arg3;
- (bool)setMediaTimeScale:(int)arg1 forStream:(id)arg2 error:(id*)arg3;
- (void)setMovMetadataItems:(id)arg1;
- (void)setMovieFragmentInterval:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg1;
- (void)setMultiplexWritingDisabled:(bool)arg1;
...
- (bool)setShouldOptimizeForNetworkUse:(bool)arg1;
...
- (bool)setTrackMetadataItems:(id)arg1 forStream:(id)arg2 error:(id*)arg3;
...
- (void)setWriteThreadCount:(unsigned long long)arg1;
...
- (bool)setWritingThreadPriority:(double)arg1 error:(id*)arg2;
...
- (bool)startSessionWithFallbackSampleTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg1 streamId:(id)arg2 mediaType:(long long)arg3 writerDelegate:(id)arg4 delegateCallbackQueue:(id)arg5 error:(id*)arg6;
- (void)startWritingThread;
- (id)startWritingThreadForMetadata;
- (id)startWritingThreadForNonMetadataOnlyThreadId:(unsigned char)arg1;
- (id)state;
- (long long)status;
...
- (void)writeSampleBuffer:(struct opaqueCMSampleBuffer { }*)arg1 andMetadata:(id)arg2 forStreamId:(id)arg3 signpost:(unsigned long long)arg4;
- (unsigned long long)writeThreadCount;
- (bool)writeVideoFrameStreamAttachmentsData:(id)arg1 toMetadataAdaptor:(id)arg2 ofStream:(id)arg3 signpost:(unsigned long long)arg4;
...
- (unsigned long long)writingThreadsCount;
