...
@interface MagnifierSupport.MultiControlButton : UIControl <_UIClickPresentationInteractionDelegate> {
    void $__lazy_storage_$_internalButton;
    void $__lazy_storage_$_keyboardButton;
...
- (void)didTap:(id)arg1;
- (void)handleLabelTapWithSender:(id)arg1;
