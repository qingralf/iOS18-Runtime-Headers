...
@interface MagnifierSupport.PointSpeakSettingsViewController : UIViewController <UIColorPickerViewControllerDelegate, UITableViewDataSource, UITableViewDelegate> {
