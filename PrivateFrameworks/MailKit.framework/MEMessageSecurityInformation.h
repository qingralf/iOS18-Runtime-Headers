...
@interface MEMessageSecurityInformation : NSObject <NSSecureCoding> {
    NSString * _decoderID;
    bool  _disallowUsersToLoadRemoteContent;
...
@property (nonatomic, readonly) bool disallowUsersToLoadRemoteContent;
...
- (id)initWithSigners:(id)arg1 isEncrypted:(bool)arg2 signingError:(id)arg3 encryptionError:(id)arg4 shouldBlockRemoteContent:(bool)arg5 disallowUsersToLoadRemoteContent:(bool)arg6 localizedRemoteContentBlockingReason:(id)arg7;
