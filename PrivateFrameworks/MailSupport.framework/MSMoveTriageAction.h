...
- (id)initWithQuery:(id)arg1 origin:(long long)arg2 actor:(long long)arg3 delegate:(id)arg4 destinationMailboxType:(long long)arg5 flagChange:(id)arg6 copyMessages:(bool)arg7;
