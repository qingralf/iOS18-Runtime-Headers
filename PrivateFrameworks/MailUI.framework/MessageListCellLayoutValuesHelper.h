...
@interface MessageListCellLayoutValuesHelper : NSObject {
    ...
    MessageListCellLayoutValues * _groupedSenderLayoutValues;
...
@property (nonatomic, retain) MessageListCellLayoutValues *groupedSenderLayoutValues;
...
- (void)setGroupedSenderLayoutValues:(id)arg1;
