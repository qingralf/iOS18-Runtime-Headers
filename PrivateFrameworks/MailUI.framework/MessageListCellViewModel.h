...
@property (nonatomic, retain) MUIAvatarImageContext *avatarContext;
...
@property (nonatomic, copy) NSString *categorizationState;
...
- (void)setAvatarContext:(id)arg1;
- (void)setAvatarGenerator:(id)arg1;
- (void)setCategorizationState:(id)arg1;
