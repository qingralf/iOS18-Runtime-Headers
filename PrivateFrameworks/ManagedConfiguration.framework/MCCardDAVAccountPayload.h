...
@property (nonatomic, readonly, retain) NSArray *calendarAccountIdentifiers; /* unknown property attribute: ? */
@property (nonatomic, readonly) NSDictionary *communicationServiceRules;
@property (nonatomic, readonly, retain) NSArray *contactsAccountIdentifiers; /* unknown property attribute: ? */
@property (nonatomic, readonly, retain) NSString *hostname;
@property (nonatomic, readonly, retain) NSArray *mailAccountIdentifiers; /* unknown property attribute: ? */
