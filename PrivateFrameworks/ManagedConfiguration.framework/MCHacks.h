...
- (void)_applyHeuristicsToRestrictions:(id)arg1 forProfile:(id)arg2 ignoresUnrestrictableApps:(bool)arg3;
- (void)_applyImpliedSettingsToSettingsDictionary:(id)arg1 currentSettings:(id)arg2 restrictions:(id)arg3;
- (void)_applyInternalDiagnosticEnforcementToSettings:(id)arg1;
