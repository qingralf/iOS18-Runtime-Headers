...
- (void).cxx_destruct;
- (bool)_adjustManifestForDevice:(unsigned long long)arg1 withIdentifier:(id)arg2 addingIdentifier:(bool)arg3 outError:(id*)arg4;
...
- (bool)addPurgatoryProfileData:(id)arg1 identifier:(id)arg2 targetDevice:(unsigned long long)arg3 outError:(id*)arg4;
- (void)dealloc;
- (id)init;
