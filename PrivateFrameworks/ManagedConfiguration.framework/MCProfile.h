...
@property (nonatomic, readonly) bool isSupervisionProfile;
...
@property (nonatomic, readonly) NSDictionary *localizedManagedProfileConsentTexts;
...
@property (nonatomic, readonly, retain) NSArray *payloadsContentInfo;
...
@property (nonatomic, readonly) NSArray *signerCertificatesData;
...
@property (nonatomic, readonly, retain) NSDate *unmodifiedExpiryDate;
