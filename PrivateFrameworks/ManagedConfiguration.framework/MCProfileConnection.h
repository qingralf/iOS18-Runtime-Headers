...
- (id)_restrictionEnforcedNotificationSettingsForBundleID:(id)arg1 settingsArray:(id)arg2;
...
- (bool)addTrustedCodeSigningIdentitiesForProvisioningProfileUUID:(id)arg1 outError:(id*)arg2;
...
- (bool)applyRestrictionDictionary:(id)arg1 overrideRestrictions:(bool)arg2 appsAndOptions:(id)arg3 clientType:(id)arg4 clientUUID:(id)arg5 localizedClientDescription:(id)arg6 localizedWarningMessage:(id)arg7 outRestrictionChanged:(bool*)arg8 outEffectiveSettingsChanged:(bool*)arg9 outError:(id*)arg10;
- (bool)applyRestrictionDictionary:(id)arg1 overrideRestrictions:(bool)arg2 clientType:(id)arg3 clientUUID:(id)arg4 localizedClientDescription:(id)arg5 localizedWarningMessage:(id)arg6 outRestrictionChanged:(bool*)arg7 outEffectiveSettingsChanged:(bool*)arg8 outError:(id*)arg9;
...
- (void)cloudConfigurationUIDidCompleteWasApplied:(bool)arg1 completionHandler:(id /* block */)arg2;
...
- (void)installStoredProfileDataWithCompletion:(id /* block */)arg1;
- (void)installStoredProfileDataWithExtraOptions:(id)arg1 completion:(id /* block */)arg2;
...
- (bool)isContactsReadAffectedByOpenInRestrictionsForTargetBundleID:(id)arg1;
...
- (bool)isProfileInstalledWithIdentifier:(id)arg1 outError:(id*)arg2;
...
- (id)provisiongProfileUUIDsForSignerIdentity:(id)arg1;
...
- (void)removePostSetupAutoInstallSetAsideProfileWithCompletion:(id /* block */)arg1;
...
- (void)removeSetAsideCloudConfigurationProfileWithCompletion:(id /* block */)arg1;
...
- (void)setExternalIntelligenceAllowed:(bool)arg1;
...
- (void)setMontaraAllowed:(bool)arg1;
...
- (void)storeProfileData:(id)arg1;
- (void)storeProfileData:(id)arg1 completion:(id /* block */)arg2;
...
- (void)storedProfileDataWithCompletion:(id /* block */)arg1;
...
- (int)unlockScreenTypeForUser:(id)arg1 outSimplePasscodeType:(int*)arg2;
...
- (void)updateCloudConfigurationWithLastPushTokenHash:(id)arg1;
