...
@property (nonatomic) bool hideDenyListURLs;
...
- (void).cxx_destruct;
- (bool)_boolFromDict:(id)arg1 key:(id)arg2 outError:(id*)arg3;
- (id)_dictsFromDict:(id)arg1 key:(id)arg2 outError:(id*)arg3;
- (id)_stringFromDict:(id)arg1 key:(id)arg2 outError:(id*)arg3;
- (id)_stringsFromDict:(id)arg1 key:(id)arg2 outError:(id*)arg3;
...
- (void)setHideDenyListURLs:(bool)arg1;
