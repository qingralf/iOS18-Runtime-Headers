...
@interface MCWiFiPayload : MCPayload {
    ...
    NSNumber * _disableAssociationMACRandomization;
...
@property (nonatomic, copy) NSNumber *disableAssociationMACRandomization;
...
@property (nonatomic, copy) NSNumber *isFirstAutoJoinRestricted;
...
- (void)setDisableAssociationMACRandomization:(id)arg1;
