...
@interface MCUIListController : MCURLListenerListController <DMCAccountSpecifierProviderDelegate, DMCEnrollmentDelegate, MCUISpecifierProviderDelegate, UITableViewDelegate> {
...
- (void)_mainQueue_setManagedSignInButtonEnabled:(bool)arg1;
- (void)_mcuiUpdated;
- (void)_setupDeviceExpert;
- (void)_showAccountDetailsPaneWithUsername:(id)arg1 completion:(id /* block */)arg2;
- (id)_specifiersForPhone;
- (void)_uprootDistributedNotificationReceived:(id)arg1;
- (void)_uprootNotificationReceived:(id)arg1;
...
- (void)enrollmentDidFailWithError:(id)arg1;
