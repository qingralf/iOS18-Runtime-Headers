...
@property (nonatomic, readonly) NSData *defaultValue;

- (id)_combine:(id)arg1 with:(id)arg2;
- (long long)combineOperator;
- (id)combinePersistableValue:(id)arg1 with:(id)arg2;
- (id)defaultValue;
- (id)initWithSettingName:(id)arg1 defaultData:(id)arg2 combineOperator:(long long)arg3 isPublic:(bool)arg4 scope:(id)arg5 isPrivacySensitive:(bool)arg6;
