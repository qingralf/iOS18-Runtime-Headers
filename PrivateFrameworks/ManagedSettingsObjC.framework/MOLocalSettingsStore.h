...
+ (void)deleteStoresWithStoreNames:(id)arg1;
+ (void)deleteStoresWithStoreNames:(id)arg1 sharedContainer:(id)arg2;
+ (void)deleteStoresWithStoreNames:(id)arg1 sharedContainer:(id)arg2 recordIdentifier:(id)arg3;
+ (id)new;
+ (id)stores;
+ (id)storesForSharedContainer:(id)arg1;

- (void).cxx_destruct;
- (bool)active;
- (void)batchUpdate:(id /* block */)arg1;
