...
- (id)initWithEngineBuilder:(id)arg1 name:(id)arg2 minRunTime:(double)arg3 maxRunTime:(double)arg4 minSleepTime:(double)arg5 runTimeLeeway:(double)arg6 sleepTimeLeeway:(double)arg7 maxEntries:(unsigned long long)arg8 nilledWhenAsleep:(bool)arg9;
