...
- (bool)entriesForEventsAtLocation:(id)arg1 period:(id)arg2 fetchMapItems:(bool)arg3 handler:(id /* block */)arg4;
...
- (void)interestingFlightEventsFrom:(id)arg1 to:(id)arg2 handler:(id /* block */)arg3;
