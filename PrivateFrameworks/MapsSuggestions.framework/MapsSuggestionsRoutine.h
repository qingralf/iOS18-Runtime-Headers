...
- (BOOL)fetchAllSuggestedLOIsExcludingTypes:(id)arg1 minVisits:(unsigned long long)arg2 maxAge:(double)arg3 maxResults:(unsigned long long)arg4 handler:(id /* block */)arg5;
- (BOOL)fetchEntriesForLocation:(id)arg1 period:(id)arg2 handler:(id /* block */)arg3;
- (BOOL)fetchLOIsSinceDate:(id)arg1 handler:(id /* block */)arg2;
...
- (BOOL)fetchSuggestedLOIsForTypes:(id)arg1 minVisits:(unsigned long long)arg2 maxAge:(double)arg3 maxResults:(unsigned long long)arg4 handler:(id /* block */)arg5;
