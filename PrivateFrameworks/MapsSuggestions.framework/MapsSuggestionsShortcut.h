...
@property (nonatomic, copy) NSDate *mapsSyncCreateTime;
...
@property (nonatomic, readonly, copy) NSArray *stringContacts;
...
- (void)setMapsSyncCreateTime:(id)arg1;
