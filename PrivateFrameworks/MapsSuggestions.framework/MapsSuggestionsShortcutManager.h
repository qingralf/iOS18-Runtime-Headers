...
@interface MapsSuggestionsShortcutManager : NSObject <MapsSuggestionsMapsSyncObserver, MapsSuggestionsMeCardObserver, MapsSuggestionsMeCardReader> {
...
- (id)initWithStorage:(id)arg1 suggestor:(id)arg2 contacts:(id)arg3 routine:(id)arg4 mapsSync:(id)arg5 usingMyPlaces:(bool)arg6;
