...
@property (nonatomic, retain) NSMutableArray *smsStrategyIdentifiers;
...
- (void)setSmsStrategyIdentifiers:(id)arg1;
- (void)setState:(id)arg1;
- (id)smsStrategyIdentifierAtIndex:(unsigned long long)arg1;
- (id)smsStrategyIdentifiers;
