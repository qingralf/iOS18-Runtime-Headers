...
- (id)image;
- (id)imageUrl;
- (id)initWithCollectionDescription:(id)arg1 curatedCollectionIdentifier:(unsigned long long)arg2 image:(id)arg3 imageUrl:(id)arg4 isTombstone:(bool)arg5 lastFetchedDate:(id)arg6 lastSignificantChangeDate:(id)arg7 placesCount:(int)arg8 positionIndex:(long long)arg9 publisherAttribution:(id)arg10 resultProviderIdentifier:(int)arg11 title:(id)arg12 titleLocale:(id)arg13;
