...
- (id)contentData;
- (id)countryCode;
- (id)initWithClientRevision:(short)arg1 contentData:(id)arg2 countryCode:(id)arg3 positionIndex:(long long)arg4 rapResponse:(id)arg5 reportId:(id)arg6 status:(short)arg7 statusLastUpdatedDate:(id)arg8 summary:(id)arg9 type:(short)arg10;
