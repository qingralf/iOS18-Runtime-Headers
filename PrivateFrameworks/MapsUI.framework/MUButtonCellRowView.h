...
@interface MUButtonCellRowView : MUPlaceSectionRowView <MUDynamicButtonCellModelChangeDelegate> {
    ...
    NSLayoutConstraint * _titleGuideToBottomConstraint;
    NSLayoutConstraint * _titleGuideToPlatterLeadingConstraint;
    NSLayoutConstraint * _titleGuideToSelfLeadingConstraint;
    NSLayoutConstraint * _titleGuideToTopConstraint;
    UILabel * _titleLabel;
