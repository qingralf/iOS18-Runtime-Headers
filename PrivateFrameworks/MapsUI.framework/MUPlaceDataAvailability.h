...
@property (nonatomic, readonly) bool isRouteCreationAvailable;
...
@property (nonatomic, readonly) bool supportsHikingTip;
...
@property (nonatomic, readonly) bool supportsPlaceNotes;
