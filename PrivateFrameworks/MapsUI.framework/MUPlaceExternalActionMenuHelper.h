...
- (id)_buildMenuItemViewModelWithCachedImageForViewModel:(id)arg1 isSingleProvider:(bool)arg2;
- (void)_downloadImageWithURL:(id)arg1 variant:(unsigned long long)arg2 uniqueIdentifier:(id)arg3 completion:(id /* block */)arg4;
- (unsigned long long)_imageVariantForViewModel:(id)arg1 isSingleProvider:(bool)arg2;
- (id)actionController;
- (id)actionName;
