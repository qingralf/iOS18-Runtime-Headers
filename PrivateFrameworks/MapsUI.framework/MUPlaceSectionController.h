...
@interface MUPlaceSectionController : NSObject <MUPlaceSectionControlling> {
    ...
    MKMapItem * _mapItem;
    <MUPersonalizedSuggestionSectionArbiterDelegate> * _personalizedSuggestionsArbiterDelegate;
    UIView * _sectionView;
...
@property (nonatomic) <MUPersonalizedSuggestionSectionArbiterDelegate> *personalizedSuggestionsArbiterDelegate;
...
- (id)mapItem;
- (id)personalizedSuggestionsArbiterDelegate;
...
- (void)setPersonalizedSuggestionsArbiterDelegate:(id)arg1;
