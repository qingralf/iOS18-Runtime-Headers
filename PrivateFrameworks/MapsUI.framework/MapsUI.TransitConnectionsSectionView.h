...
- (void)verticalCardContainerView:(id)arg1 didSelectRow:(id)arg2 atIndex:(long long)arg3;
- (bool)verticalCardContainerView:(id)arg1 shouldHighlightRowAtIndex:(long long)arg2;
