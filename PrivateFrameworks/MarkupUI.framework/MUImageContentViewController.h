...
@property (nonatomic) bool navigationModeHorizontal; /* unknown property attribute: ? */
@property (nonatomic, readonly, copy) NSString *originalImageDescription; /* unknown property attribute: ? */
...
@property (nonatomic) bool showsThumbnailView; /* unknown property attribute: ? */
@property (retain) id sourceContent;
@property (retain) NSArray *sourceContentReplacedAnnotationMaps; /* unknown property attribute: ? */
@property struct CGSize { double x1; double x2; } sourceImagePixelSize;
@property (readonly) Class superclass;
@property (nonatomic, readonly) bool supportsFormFill; /* unknown property attribute: ? */
@property (nonatomic, readonly) bool supportsImageDescriptionEditing; /* unknown property attribute: ? */
