...
@interface MarkupViewController : UIViewController <MUContentViewControllerDelegate, MarkupViewControllerPrivateProtocol, MarkupViewControllerProtocol, PKRulerHostingDelegate, UINavigationBarDelegate, UIToolbarDelegate> {
...
@property (nonatomic, copy) NSString *originalImageDescription;
...
- (void)_setThumbnailViewHidden:(bool)arg1;
...
- (bool)_writeToDataConsumer:(struct CGDataConsumer { }*)arg1 embedSourceImageAndEditModel:(bool)arg2 options:(id)arg3 error:(id*)arg4;
...
- (bool)writeToURL:(id)arg1 embeddingSourceImageAndEditModel:(bool)arg2 options:(id)arg3 error:(id*)arg4;
