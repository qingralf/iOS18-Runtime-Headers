...
@interface MTLumaDodgePillSettings : PTSettings {
    ...
    unsigned long long  _overrideDodgeMode;
...
@property (nonatomic) bool disableLumaTracking;
...
- (double)minWidth;
- (id)noneSettings;
- (unsigned long long)overrideDodgeMode;
...
- (void)setDisableLumaTracking:(bool)arg1;
...
- (void)setOverrideDodgeMode:(unsigned long long)arg1;
