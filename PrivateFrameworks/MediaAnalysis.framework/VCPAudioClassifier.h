...
+ (id)sharedFeaturePrintRequest:(id)arg1 version:(int)arg2;

- (void).cxx_destruct;
- (void)cacheModelsForClassifySoundRequest:(id)arg1 requestIdentifier:(id)arg2;
- (void)cacheModelsForDetectSoundRequest:(id)arg1 requestIdentifier:(id)arg2;
