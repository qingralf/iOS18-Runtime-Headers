...
+ (id)detector:(bool)arg1 sharedModel:(bool)arg2 modelName:(id)arg3 enableHandObject:(bool)arg4 options:(id)arg5;
...
- (int)generateHandKeypoints:(struct CGPoint { double x1; double x2; }*)arg1 keypointConfidence:(float*)arg2 offset:(float)arg3 handHoldsObjectConfidence:(float*)arg4;
- (float*)getInputBuffer:(int)arg1 srcWidth:(int)arg2 cnnInputHeight:(int*)arg3 cnnInputWidth:(int*)arg4 offset:(float*)arg5;
- (int)handKeypointsDetection:(struct __CVBuffer { }*)arg1 box:(id)arg2 keypoints:(struct CGPoint { double x1; double x2; })arg3 keypointConfidence:(float)arg4 handHoldsObjectConfidence:(float*)arg5;
