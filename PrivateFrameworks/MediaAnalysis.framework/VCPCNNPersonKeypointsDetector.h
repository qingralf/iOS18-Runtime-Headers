...
- (id).cxx_construct;
- (void).cxx_destruct;
- (int)analyzeFrame:(struct __CVBuffer { }*)arg1 withBox:(id)arg2 keypoints:(id)arg3 padX:(int*)arg4 padY:(int*)arg5;
- (int)copyImage:(struct __CVBuffer { }*)arg1 toData:(float*)arg2 cnnInputHeight:(int)arg3 cnnInputWidth:(int)arg4;
