...
+ (id)databaseForPhotoLibraryURL:(id)arg1;
...
- (int)queryProgressHistoryRecords:(id*)arg1 sinceDate:(id)arg2;
...
- (int)querySchedulingHistoryRecords:(id*)arg1 forActivityID:(unsigned long long)arg2 startDate:(id)arg3 endDate:(id)arg4;
- (int)querySchedulingHistoryRecords:(id*)arg1 startDate:(id)arg2 endDate:(id)arg3;
