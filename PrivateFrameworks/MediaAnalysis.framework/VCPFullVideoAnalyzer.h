...
- (int)analyzeFrame:(struct __CVBuffer { }*)arg1 timestamp:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2 duration:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg3 frameStats:(id)arg4 flags:(unsigned long long*)arg5 cancel:(id /* block */)arg6;
- (int)analyzeFrame:(struct __CVBuffer { }*)arg1 timestamp:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2 duration:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg3 properties:(id)arg4 frameStats:(id)arg5 flags:(unsigned long long*)arg6 cancel:(id /* block */)arg7;
...
- (id)initWithVideoOrientation:(int)arg1 preferredTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg2 metaOrientation:(id)arg3 privateResults:(id)arg4 embeddings:(id)arg5 isTimelapse:(bool)arg6 isIris:(bool)arg7 irisPhotoOffsetSec:(float)arg8 irisPhotoExposureSec:(float)arg9 slowMoRate:(float)arg10 faceDominated:(bool)arg11;
...
- (int)seedAnalyzersWithPixelBuffer:(struct __CVBuffer { }*)arg1 startTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2 frameStats:(id)arg3;
