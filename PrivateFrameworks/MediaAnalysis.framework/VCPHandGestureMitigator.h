...
- (void)adjustGestureForHand:(id)arg1 withFaceYaw:(id)arg2;
...
- (bool)checkHandHoldObject:(id)arg1 forHand:(id)arg2;
...
- (id)init;
- (float)minHandSize;
- (int)mitigate:(id)arg1 rightHand:(id)arg2 featureProvider:(id)arg3 faceRects:(id)arg4 faceYaws:(id)arg5;
- (int)mitigateHand:(id)arg1 handKey:(id)arg2 pairedHand:(id)arg3 featureProvider:(id)arg4 faceRects:(id)arg5 faceYaws:(id)arg6;
