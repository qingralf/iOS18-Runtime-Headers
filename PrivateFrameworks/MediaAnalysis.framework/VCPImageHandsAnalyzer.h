...
- (int)convertSingleResultToDict:(struct CGPoint { double x1; double x2; })arg1 keypointConfidence:(float*)arg2 box:(id)arg3 handHoldsObjectConfidence:(float)arg4 results:(id)arg5;
- (long long)getClosestAspectRatio:(id)arg1;
- (id)handObjects;
- (id)init;
- (id)initWithKeypointsOption:(int)arg1 forceCPU:(bool)arg2 sharedModel:(bool)arg3 enableHandDetection:(bool)arg4 enableANSTHandDetection:(bool)arg5 enableRejectHandsNearBoundaries:(bool)arg6 enableHandObject:(bool)arg7 sourceWidth:(int)arg8 sourceHeight:(int)arg9 modelName:(id)arg10 revision:(int)arg11 options:(id)arg12;
