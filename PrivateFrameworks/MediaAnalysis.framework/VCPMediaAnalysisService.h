...
- (int)requestDatabaseRestoreFastPassProcessingWithCompletionHandler:(id /* block */)arg1;
...
- (int)requestMediaAnalysisDatabaseBackupForPhotoLibraryURL:(id)arg1 withCompletionHandler:(id /* block */)arg2 forceBackup:(bool)arg3;
...
- (int)requestOTAMaintenanceWithOptions:(id)arg1 progessHandler:(id /* block */)arg2 completionHandler:(id /* block */)arg3;
...
- (int)requestPhotosFaceFastPassProcessingForPhotoLibraryURL:(id)arg1 withCompletionHandler:(id /* block */)arg2;
- (int)requestPhotosSceneFastPassProcessingForPhotoLibraryURL:(id)arg1 withCompletionHandler:(id /* block */)arg2;
