...
+ (void)getEmbeddingFormatForVersion:(unsigned long long)arg1 dimension:(int*)arg2 type:(unsigned long long*)arg3 error:(id*)arg4;
...
- (void).cxx_destruct;
- (id)_addCaptionToHighlightResults:(id)arg1;
...
- (id)_getCaptionFor:(struct { struct { long long x_1_1_1; int x_1_1_2; unsigned int x_1_1_3; long long x_1_1_4; } x1; struct { long long x_2_1_1; int x_2_1_2; unsigned int x_2_1_3; long long x_2_1_4; } x2; })arg1 withCaptions:(id)arg2 hasSegment:(bool)arg3;
...
- (void)addVideoRankingSignalsToDictionary:(id)arg1 fromPhotoLibraryURL:(id)arg2 amongAssets:(id)arg3;
...
- (id)findTimeRangesFor:(id)arg1 inAsset:(id)arg2 withOptions:(id)arg3 results:(id)arg4 andError:(id*)arg5;
...
- (id)getAnalysisResultsForURLAsset:(id)arg1;
...
- (id)getTimeRangesWithSearchResults:(id)arg1;
- (id)init;
- (id)loadAssetsFromPhotoLibrary:(id)arg1 withAssetIdentifiers:(id)arg2;
- (id)loadEmbeddingSearchResultWithContext:(id)arg1 forPhotoLibraryURL:(id)arg2 fromAssets:(id)arg3 withOptions:(id)arg4;
- (id)loadVideoAssetsFromPhotoLibraryURL:(id)arg1 withAssetIdentifiers:(id)arg2;
- (id)mergeTimeRanges:(id)arg1 mergeGap:(id)arg2;
...
- (id)postProcessTimeRanges:(id)arg1 options:(id)arg2;
- (id)prepareContextsQueryEmbedding:(id)arg1;
- (id)rankAssetsWithContext:(id)arg1 forAssetIdentifiers:(id)arg2 forPhotoLibraryURL:(id)arg3 withOptions:(id)arg4 error:(id*)arg5;
...
- (id)requestSearchResultsForAssets:(id)arg1 forPhotoLibraryURL:(id)arg2 withQueryEmbeddings:(id)arg3 matchingScoreOnly:(bool)arg4 options:(id)arg5;
- (id)requestSearchResultsForAssets:(id)arg1 forPhotoLibraryURL:(id)arg2 withQueryEmbeddings:(id)arg3 options:(id)arg4;
- (id)searchForQuery:(id)arg1 forAssets:(id)arg2 withOptions:(id)arg3 matchingScoreOnly:(bool)arg4 isURLAsset:(bool)arg5 analyses:(id)arg6;
