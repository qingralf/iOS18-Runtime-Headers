...
@interface VCPSettlingEffectAnalyzer : VCPVideoAnalyzer {
    ...
    bool  _minSettlingDurationThresholdFailure;
...
+ (id)getFramePTSList:(id)arg1 before:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2 withOptions:(id)arg3;
+ (id)getRetimingCurve;
