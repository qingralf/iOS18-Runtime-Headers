...
- (int)analyzeFrame:(struct __CVBuffer { }*)arg1 frameStats:(id)arg2 timestamp:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg3;
...
- (int)postProcess;
- (void)prepareFrameStats:(id)arg1 timeStamp:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2;
