...
- (id)initWithTimeOfInterest:(id)arg1;
...
- (int)processPets:(id)arg1 petsBounds:(id)arg2 dominantPetIdx:(int)arg3 frame:(struct __CVBuffer { }*)arg4 timestamp:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg5 duration:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg6 frameStats:(id)arg7;
- (id)results;
