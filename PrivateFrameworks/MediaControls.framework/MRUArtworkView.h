...
@interface MRUArtworkView : UIControl <MRUArtworkControllerDelegate, MRUArtworkViewObservable, MRUVisualStylingProviderObserver, UIPointerInteractionDelegate> {
