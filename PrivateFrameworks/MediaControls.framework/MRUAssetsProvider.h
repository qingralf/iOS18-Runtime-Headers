...
- (void).cxx_destruct;
- (id)applicationCache;
- (void)applicationIconForBundleIdentifier:(id)arg1 appearance:(long long)arg2 completion:(id /* block */)arg3;
- (void)applicationIconForBundleIdentifier:(id)arg1 size:(struct CGSize { double x1; double x2; })arg2 appearance:(long long)arg3 completion:(id /* block */)arg4;
- (void)applicationIconForBundleIdentifier:(id)arg1 size:(struct CGSize { double x1; double x2; })arg2 traitCollection:(id)arg3 completion:(id /* block */)arg4;
- (void)applicationIconForBundleIdentifier:(id)arg1 traitCollection:(id)arg2 completion:(id /* block */)arg3;
- (id)completionBlocks;
- (id)imageCache;
