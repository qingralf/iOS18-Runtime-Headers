...
@interface MRUAudioModuleController : NSObject <MRUConversationAwarenessControllerDelegate, MRUHearingServiceControllerObserver, MRUListeningModeControllerDelegate, MRUSpatialAudioControllerDelegate, MRUSystemOutputDeviceRouteControllerObserver, MRUSystemVolumeControllerDelegate> {
...
@property (nonatomic, readonly) MRUHearingServiceController *hearingServiceController;
...
- (void)hearingServiceController:(id)arg1 didChangePrimaryAmplification:(float)arg2;
- (void)hearingServiceController:(id)arg1 didChangePrimaryHearingAidEnabled:(bool)arg2;
- (void)hearingServiceController:(id)arg1 didChangePrimaryListeningModeOffAllowed:(bool)arg2;
- (void)hearingServiceController:(id)arg1 didChangeSecondaryAmplification:(float)arg2;
- (void)hearingServiceController:(id)arg1 didChangeSecondaryHearingAidEnabled:(bool)arg2;
