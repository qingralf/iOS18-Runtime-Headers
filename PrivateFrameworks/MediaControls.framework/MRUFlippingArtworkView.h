...
@interface MRUFlippingArtworkView : UIControl <MRUArtworkControllerDelegate, MRUArtworkViewObservable, MRUVisualStylingProviderObserver> {
    MRUArtwork * _artwork;
...
@property (nonatomic, retain) NSString *placeholderSymbolName;
...
- (void)setPlaceholderSymbolName:(id)arg1;
- (void)setPlaying:(bool)arg1;
- (void)setSetArtworkThrottleTimer:(id)arg1;
- (void)setStyle:(long long)arg1;
- (void)setStylingProvider:(id)arg1;
- (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })shadowViewInsets;
