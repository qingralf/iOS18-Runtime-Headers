...
@interface MRUMirroringController : NSObject <MRUDiscoverySessionControllerDelegate, MRUOutputContextControllerDelegate> {
    MRUOutputContextController * _audioContextController;
    MRUDiscoverySessionController * _audioDiscoverySessionController;
    ...
    MRUDiscoverySessionController * _outputDeviceDiscoverySessionController;
...
@property (nonatomic, retain) MRUDiscoverySessionController *audioDiscoverySessionController;
...
@property (nonatomic, retain) MRUDiscoverySessionController *outputDeviceDiscoverySessionController;
