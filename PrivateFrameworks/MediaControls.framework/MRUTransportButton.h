...
@property (nonatomic) bool isRunningSymbolEffect;
...
@property (nonatomic) bool scaleOnHighlight;
...
- (void)resetImageViewScaleWithSpeed:(double)arg1;
- (double)scale;
- (void)scaleDownImageView;
- (void)scaleDownImageViewWithSpeed:(double)arg1;
...
- (void)setIsRunningSymbolEffect:(bool)arg1;
...
- (void)setScaleOnHighlight:(bool)arg1;
