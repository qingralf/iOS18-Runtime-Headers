...
@interface MediaControlsExpandableButton : UIControl <MRUVisualStylingProviderObserver, UIPointerInteractionDelegate> {
    ...
    UIImageView * _subtitleIndicator;
...
@property (nonatomic, retain) UIImageView *subtitleIndicator;
...
- (void)resetMessage;
- (void)resetMessageAnimated:(bool)arg1;
- (id)selectedButton;
- (id)selectedOption;
...
- (void)setSelectedOptionIndexWithValueChanged:(unsigned long long)arg1;
- (void)setSelectionView:(id)arg1;
- (void)setStylingProvider:(id)arg1;
- (void)setSubtitleIndicator:(id)arg1;
