...
@property (nonatomic) bool didCheckForIsHDR;
...
- (void)markContainsVideoEligibleForTranscodingAsCheckedWithValue:(bool)arg1 codec:(unsigned int)arg2 isProRes:(bool)arg3;
- (void)markIsHDRAsCheckedWithValue:(bool)arg1;
...
- (void)setDidCheckForIsHDR:(bool)arg1;
