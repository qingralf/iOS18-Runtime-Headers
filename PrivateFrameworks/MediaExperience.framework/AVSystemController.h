...
- (bool)addRemoteDeviceID:(id)arg1;
...
- (int)getDuckScalarForVoiceOver:(float*)arg1;
...
- (bool)remoteDeviceControlIsAllowed:(unsigned int*)arg1;
- (bool)removeRemoteDeviceID:(id)arg1;
...
- (int)setDuckScalarForVoiceOver:(float)arg1;
