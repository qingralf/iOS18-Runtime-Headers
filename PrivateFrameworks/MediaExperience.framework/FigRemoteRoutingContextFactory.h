...
- (int)copySystemRemoteDisplayContextWithAllocator:(struct __CFAllocator { }*)arg1 options:(struct __CFDictionary { }*)arg2 context:(struct OpaqueFigRoutingContext {}**)arg3;
