...
@interface MXCoreSession : MXCoreSessionBase {
    ...
    bool  _doesGameAudioNeedToBeSpatialized;
    ...
    bool  _hasEntitlementToSetPreferredMinimumMicrophoneIndicatorLightOnTime;
    bool  _hasEntitlementToSetPrefersNoInterruptions;
    bool  _hasEntitlementToSetPrefersToOptOutOfHardwareSafetyInterruptions;
    ...
    bool  _isCameraRecordingExtension;
    bool  _isCarSession;
    bool  _isDucked;
    ...
    bool  _isInterruptionCalledOffAudioControlQueue;
    ...
    bool  _isRecordingMutedForRemoteDevice;
    ...
    int  _lastRouteSharingPolicySetByClient;
    ...
    NSSet * _notificationsSubscribedTo;
    ...
    bool  _prefersNoInterruptionsDuringRemoteDeviceControl;
    bool  _prefersSpeechDetectEnabled;
    bool  _prefersSuppressingRecordingState;
    bool  _prefersToInterruptActiveRecordingSessions;
    bool  _prefersToOptOutOfHardwareSafetyInterruptions;
    ...
    NSLock * _sessionPropertiesLock;
    unsigned int  _shadowingAudioSessionID;
    bool  _shouldMuteBeAppliedToRemoteDevice;
    bool  _silentMuted;
    ...
    NSArray * _supportedOutputChannelLayouts;
...
@property (nonatomic) bool bypassSystemSpatialAudioForGame;
...
@property (nonatomic) bool doesGameAudioNeedToBeSpatialized;
...
@property (nonatomic) bool hasEntitlementToSetPreferredMinimumMicrophoneIndicatorLightOnTime;
@property (nonatomic) bool hasEntitlementToSetPrefersNoInterruptions;
@property (nonatomic) bool hasEntitlementToSetPrefersToOptOutOfHardwareSafetyInterruptions;
...
@property (nonatomic) bool isCameraRecordingExtension;
...
@property (nonatomic) bool isInterruptionCalledOffAudioControlQueue;
...
@property (nonatomic) bool isRecordingMutedForRemoteDevice;
...
@property (nonatomic, retain) NSSet *notificationsSubscribedTo;
...
@property (nonatomic) bool preferredOutputSampleRateSetByClient;
...
@property (nonatomic) bool prefersBeingInterruptedByNextActiveRecordingClient;
@property (nonatomic) bool prefersBluetoothAccessoryMuting;
@property (nonatomic) bool prefersConcurrentAirPlayAudio;
...
@property (nonatomic) bool prefersNoInterruptionsDuringRemoteDeviceControl;
@property (nonatomic) bool prefersSpeechDetectEnabled;
@property (nonatomic) bool prefersSuppressingRecordingState;
@property (nonatomic) bool prefersToInterruptActiveRecordingSessions;
@property (nonatomic) bool prefersToOptOutOfHardwareSafetyInterruptions;
...
@property (nonatomic, retain) NSLock *sessionPropertiesLock;
@property (nonatomic) unsigned int shadowingAudioSessionID;
@property (nonatomic) bool shouldMuteBeAppliedToRemoteDevice;
...
- (id)copyDetailedRouteDescriptionForContinuityScreenOutput:(id)arg1;
...
- (id)preferredMinimumMicrophoneIndicatorLightOnTime;
...
- (id)preferredRouteControlFeatures;
...
- (void)setDoesGameAudioNeedToBeSpatialized:(bool)arg1;
...
- (void)setHasEntitlementToSetPreferredMinimumMicrophoneIndicatorLightOnTime:(bool)arg1;
- (void)setHasEntitlementToSetPrefersNoInterruptions:(bool)arg1;
- (void)setHasEntitlementToSetPrefersToOptOutOfHardwareSafetyInterruptions:(bool)arg1;
...
- (int)setInterruptionStyleAtClientRequest:(unsigned int)arg1;
...
- (void)setIsCameraRecordingExtension:(bool)arg1;
...
- (void)setIsInterruptionCalledOffAudioControlQueue:(bool)arg1;
...
- (void)setIsRecordingMutedForRemoteDevice:(bool)arg1;
...
- (void)setLastRouteSharingPolicySetByClient:(int)arg1;
...
- (void)setPreferredMinimumMicrophoneIndicatorLightOnTime:(id)arg1;
...
- (void)setPreferredOutputSampleRateSetByClient:(bool)arg1;
- (void)setPreferredPersistentRoute:(id)arg1;
- (void)setPreferredRouteControlFeatures:(id)arg1;
- (void)setPreferredStereoInputOrientation:(int)arg1;
- (void)setPrefersBeingInterruptedByNextActiveRecordingClient:(bool)arg1;
- (void)setPrefersBluetoothAccessoryMuting:(bool)arg1;
- (void)setPrefersConcurrentAirPlayAudio:(bool)arg1;
- (void)setPrefersEchoCancelledInput:(bool)arg1;
...
- (void)setPrefersNoInterruptionsDuringRemoteDeviceControl:(bool)arg1;
- (void)setPrefersSpeechDetectEnabled:(bool)arg1;
- (void)setPrefersSuppressingRecordingState:(bool)arg1;
- (void)setPrefersToInterruptActiveRecordingSessions:(bool)arg1;
- (void)setPrefersToOptOutOfHardwareSafetyInterruptions:(bool)arg1;
...
- (void)setSessionPropertiesLock:(id)arg1;
- (void)setShadowingAudioSessionID:(unsigned int)arg1;
- (void)setShouldMuteBeAppliedToRemoteDevice:(bool)arg1;
...
- (void)setSupportedOutputChannelLayouts:(id)arg1;
...
- (void)subscribeToNotifications:(id)arg1;
...
- (int)updateInterruptionStyle:(unsigned int)arg1;
- (void)updatePreferredIOBufferDuration:(float)arg1;
- (void)updatePreferredIOBufferFrames:(int)arg1;
- (void)updateRouteSharingPolicy:(int)arg1 setByClient:(bool)arg2;
- (bool)userMuted;
