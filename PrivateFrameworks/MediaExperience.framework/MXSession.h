...
- (void)_dealloc;
- (int)_endInterruptionWithSecTask:(struct __SecTask { }*)arg1 andStatus:(struct __CFString { }*)arg2;
...
- (int)setCurrentlyPlayingBufferedAudioFormatInfo:(id)arg1;
...
- (void)setInterruptionCalledOffAudioControlQueue:(bool)arg1;
