...
@interface MXSessionManager : MXSessionManagerBase {
    ...
    bool  _appendContextToMuteNotification;
    ...
    float  _mostRecentDuckFadeDuration;
    bool  _mostRecentDuckOperation;
    ...
    bool  _phoneCallBehaviorSessionShouldResumeForCarPlay;
...
@property (nonatomic) bool appendContextToMuteNotification;
...
@property (nonatomic, retain) NSDictionary *devicesSampleRates;
@property (nonatomic) float duckScalarForVoiceOver;
@property (nonatomic, readonly) float duckVolumeForSpeakerVolumeLimit;
...
@property (nonatomic) bool mostRecentDuckOperation;
...
@property (nonatomic) bool phoneCallBehaviorSessionShouldResumeForCarPlay;
...
- (bool)areDuckerAndDuckeePlayingOnDifferentVADs:(id)arg1 duckerSession:(id)arg2;
- (bool)areSessionsWithAudioModesActive:(id)arg1;
- (id)audioCategoriesWithInput;
- (id)audioDeviceInfo;
- (id)audioModesWithShortVoicePromptStyle;
- (int)blurOnHomePod:(id)arg1 duckerSession:(id)arg2 duckVolume:(float)arg3 duckFadeDuration:(float)arg4;
- (bool)canSessionsCoexistDueToIndependentRecording:(id)arg1 victim:(id)arg2;
...
- (bool)clientTypeOverridesHardwareSwitch:(unsigned int)arg1;
- (id)copyActiveSessionWithAudioCategory:(id)arg1 andAudioMode:(id)arg2;
- (id)copyActiveSessionsInfoForAdditiveRouting;
- (id)copyActiveVoiceOverSession;
- (id)copyAudioBehaviorForCategory:(id)arg1 mode:(id)arg2;
- (id)copyEvaluatedBadgeType:(id)arg1;
...
- (id)copySessionEligibleForNowPlayingAppConsideration:(int)arg1;
...
- (id)copySessionsWithAuditToken:(struct { unsigned int x1[8]; })arg1;
...
- (bool)duckSessionForVoiceOverIfNeeded:(id)arg1 voiceOverSession:(id)arg2;
...
- (void)endAsyncDuckingOperationForSession:(id)arg1;
...
- (void)getAndResetAsyncDuckingParameters:(bool*)arg1 mostRecentDuckFadeDuration:(float*)arg2;
- (id)getAvailableAudioDestination:(id)arg1;
...
- (id)getDisallowedRecordingReasonString:(unsigned long long)arg1;
...
- (id)getProjectedAudioDestinationForCategory:(id)arg1 mode:(id)arg2;
- (bool)getQuiesceableWiredPortAutoRouteOnConnectPreference:(unsigned int)arg1;
- (id)getRouteSharingPolicyAsString:(int)arg1;
- (float)getScalarVolume:(float)arg1;
- (int)getSessionPriority:(struct MXSessionPlayingInfo { id x1; id x2; unsigned int x3; unsigned int x4; id x5; id x6; })arg1 forTipi:(bool)arg2;
- (id)getSilentModeClientTypeAsString:(unsigned int)arg1;
- (float)getSleepDurationForDuckFadeDuration:(float)arg1;
...
- (void)interruptAllSessionsAndSystemSounds:(id)arg1;
...
- (bool)isAnySessionWithMappedVolumeCategoryPlaying:(id)arg1;
...
- (bool)isBTRouteSameDeviceWithDifferentProfile:(unsigned int)arg1 newNumRoutes:(unsigned int)arg2 oldRouteTypes:(id)arg3 newRouteTypes:(id)arg4 oldRouteIdentifiers:(id)arg5 newRouteIdentifiers:(id)arg6;
- (bool)isCurrentPortTypeMuteable:(unsigned int)arg1;
- (bool)isLongFormVideoApp:(id)arg1;
- (bool)isMixableSessionBeingInterruptedByNextRecordingClient:(id)arg1 victim:(id)arg2;
- (bool)isPIDAllowedToBeNowPlayingApp:(int)arg1;
...
- (bool)isSessionUsingBuiltInMic:(id)arg1;
...
- (bool)isSiriSessionActive:(bool*)arg1 andMixable:(bool*)arg2;
...
- (bool)isVADIDRoutedToOutputPortType:(unsigned int)arg1 portType:(unsigned int)arg2;
- (bool)isVoiceOverDuckingActive:(id)arg1 outDuckScalar:(float*)arg2 outDuckFadeDuration:(float*)arg3;
...
- (void)postDisallowedRecordingNotification:(unsigned long long)arg1;
- (void)postStopCommandToSessionsWithAudioMode:(id)arg1;
- (void)processContinuityScreenOutputPortAvailableDidChange:(bool)arg1;
- (id)propertiesLock;
- (void)pvmStateDidChangeCallback:(id)arg1;
- (id)quiesceableWiredPortsAutoRouteOnConnectPreference;
- (id)recordingClientPIDs;
- (void)refreshDeviceSampleRateCache;
- (void)remoteDeviceControlIsAllowed:(unsigned int*)arg1;
...
- (bool)sessionUtilizesIndependentRecordingOnly:(id)arg1;
...
- (void)setAppendContextToMuteNotification:(bool)arg1;
...
- (void)setDuckScalarForVoiceOver:(float)arg1;
...
- (void)setMostRecentDuckFadeDuration:(float)arg1;
- (void)setMostRecentDuckOperation:(bool)arg1;
...
- (void)setPhoneCallBehaviorSessionShouldResumeForCarPlay:(bool)arg1;
...
- (bool)shouldBlurOnHomePod:(id)arg1 duckerSession:(id)arg2;
- (bool)shouldDuckSessionForSpeakerVolumeLimit:(id)arg1;
- (bool)shouldDuckSessionForVoiceOver:(id)arg1;
- (bool)shouldResetWaitingToResume:(id)arg1 currentSession:(id)arg2;
- (bool)shouldSetDeviceFormatAndSampleRate:(id)arg1;
- (bool)shouldSkipDuckingForVoiceOver:(id)arg1 inActiveVoiceOverSession:(id)arg2;
- (unsigned int)silentModeClient;
- (bool)silentModeEnabled;
- (id)silentModeEnabledUntilTime;
- (id)silentModeReason;
- (unsigned int)siriOutputVADID;
- (void)sleepForAsyncDucking:(bool)arg1 duration:(float)arg2;
...
- (bool)unblurOnHomePod:(id)arg1 unduckDuration:(float)arg2;
...
- (void)updateBadgeType:(id)arg1 matchingPID:(int)arg2;
- (void)updateBluetoothFrameworkToPlayMuteChime:(id)arg1 playRejectTone:(bool)arg2;
...
- (void)updateDuckedSessionsForVoiceOver:(id)arg1;
...
- (void)updateMostRecentDuckFadeDuration:(float)arg1 duckOperation:(bool)arg2 duckerSession:(id)arg3 sessionToDuck:(id)arg4;
...
- (int)updateSecureSpeakerMuteState:(bool)arg1;
...
- (void)updateSupportedOutputChannelLayouts:(id)arg1 matchingPID:(int)arg2;
- (bool)updateUnduckVolume:(id)arg1 duckerSession:(id)arg2 unduckVolume:(float)arg3 unduckFadeDuration:(float)arg4;
...
- (bool)voiceOverSessionWantsRelativeDucking:(id)arg1;
