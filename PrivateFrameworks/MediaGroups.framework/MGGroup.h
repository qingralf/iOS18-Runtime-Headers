...
+ (id)predicateForGroupsConformingToProtocol:(id)arg1;
+ (id)predicateForGroupsContainingGroup:(id)arg1;
+ (id)predicateForType;
+ (bool)supportsSecureCoding;
+ (id)type;
+ (id)validateGroupSpecificationWithType:(id)arg1 identifier:(id)arg2 name:(id)arg3 properties:(id)arg4 members:(id)arg5;
