...
@interface MGDaemon : NSObject <MGGroupsQueryAgentDelegate, MGInternalQueryRunner, MGServiceInterfaceProtocol, NSXPCListenerDelegate> {
    ...
    MGGroupsMediator * _homekitGroupsMediator;
    NSDictionary * _internalQueries;
    NSXPCListener * _listener;
    MGServiceListenerProvider * _listenerProvider;
    MGGroupsMediator * _localGroupsMediator;
...
@property (nonatomic, readonly) MGGroupsMediator *homekitGroupsMediator;
...
@property (nonatomic, readonly) MGGroupsMediator *localGroupsMediator;
...
- (void)_fetchGroupInfo:(id)arg1 completion:(id /* block */)arg2;
...
- (id)dispatchQueue;
- (void)groupsQueryAgent:(id)arg1 didFindResults:(id)arg2 forQuery:(id)arg3;
- (id)homekitGroupsMediator;
- (id)init;
