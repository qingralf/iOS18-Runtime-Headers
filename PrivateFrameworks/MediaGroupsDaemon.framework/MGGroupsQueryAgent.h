...
@interface MGGroupsQueryAgent : NSObject {
    ...
    NSMapTable * _mediators;
    NSDictionary * _mediatorsByGroup;
...
@property (nonatomic, readonly) NSMapTable *mediators;
@property (nonatomic, copy) NSDictionary *mediatorsByGroup;
...
- (void)setMediatorsByGroup:(id)arg1;
