...
@property (nonatomic, readonly) CLSBusinessCategoryCache *businessCategoryCache;
...
- (void).cxx_destruct;
- (id)businessCategoryCache;
- (id)businessGenericTicket;
- (unsigned long long)cacheItems:(id)arg1;
- (void)cancel;
- (id)initWithBusinessCategoryCache:(id)arg1 locationCache:(id)arg2;
- (id)initWithRegions:(id)arg1 categories:(id)arg2 precision:(double)arg3 businessCategoryCache:(id)arg4 locationCache:(id)arg5;
- (bool)isCancelled;
- (id)locationCache;
