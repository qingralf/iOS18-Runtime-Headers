...
- (id)_prepareFeederWithServiceManager:(id)arg1 locationCache:(id)arg2 progressBlock:(id /* block */)arg3;
- (id)allItems;
...
- (id)prepareWithServiceManager:(id)arg1 locationCache:(id)arg2 progressBlock:(id /* block */)arg3;
- (id)privateItems;
