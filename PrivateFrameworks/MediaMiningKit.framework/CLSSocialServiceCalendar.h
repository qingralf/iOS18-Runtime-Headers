...
- (id)meContact;
- (id)personsFromEventParticipants:(id)arg1 excludeCurrentUser:(bool)arg2 serviceManager:(id)arg3;
...
- (id)workCalendarEventsMatchingContactIdentifiers:(id)arg1 fromUniversalDate:(id)arg2 toUniversalDate:(id)arg3 contactsService:(id)arg4;
