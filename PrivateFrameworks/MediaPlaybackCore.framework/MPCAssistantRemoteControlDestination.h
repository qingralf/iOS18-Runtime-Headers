...
- (void)_getCompanionOriginWithQueue:(id)arg1 completion:(id /* block */)arg2;
- (id)appBundleID;
...
- (id)outputGroups;
- (id)playerID;
- (void)resolveForWatchControlCommandWithRouteIdentifiers:(id)arg1 queue:(id)arg2 completion:(id /* block */)arg3;
