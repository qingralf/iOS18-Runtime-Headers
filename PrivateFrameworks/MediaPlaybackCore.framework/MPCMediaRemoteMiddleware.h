...
@property (nonatomic, retain) MPNowPlayingContentItem *lastSectionContentItem;
...
@property (nonatomic, retain) NSDictionary *queueParticipants;
@property (nonatomic, copy) NSDictionary *queueProperties;
...
- (id)lastSectionContentItem;
- (id)lastSectionModelObject:(id)arg1 propertySet:(id)arg2 chain:(id)arg3;
...
- (id)playerItemContentID:(id)arg1 atIndexPath:(id)arg2 chain:(id)arg3;
- (id)playerItemCurrentLanguageOptions:(id)arg1 atIndexPath:(id)arg2 chain:(id)arg3;
- (struct { double x1; double x2; double x3; double x4; double x5; float x6; float x7; bool x8; bool x9; bool x10; })playerItemDuration:(struct { double x1; double x2; double x3; double x4; double x5; float x6; float x7; bool x8; bool x9; bool x10; })arg1 atIndexPath:(id)arg2 chain:(id)arg3;
...
- (bool)playerItemIsFavoritable:(bool)arg1 atIndexPath:(id)arg2 chain:(id)arg3;
...
- (double)playerSleepTimerFireDate:(double)arg1 chain:(id)arg2;
- (long long)playerSleepTimerStopMode:(long long)arg1 chain:(id)arg2;
- (double)playerSleepTimerTime:(double)arg1 chain:(id)arg2;
...
- (id)queueIdentifier;
- (id)queueItemIdentifier:(id)arg1 atIndexPath:(id)arg2 chain:(id)arg3;
- (id)queueModelObjects;
- (id)queueParticipants;
- (id)queueProperties;
...
- (void)setLastSectionContentItem:(id)arg1;
...
- (void)setQueueParticipants:(id)arg1;
- (void)setQueueProperties:(id)arg1;
- (void)setSupportedCommands:(id)arg1;
- (bool)skippedMetadata;
- (id)supportedCommands;
- (id)tracklistProperties:(id)arg1 chain:(id)arg2;
