...
@property (nonatomic, retain) MPCFuture *playbackQueueFuture;
...
- (void)_loadPlaybackQueueWithCompletion:(id /* block */)arg1;
- (void)execute;
...
- (void)setPlaybackQueueFuture:(id)arg1;
