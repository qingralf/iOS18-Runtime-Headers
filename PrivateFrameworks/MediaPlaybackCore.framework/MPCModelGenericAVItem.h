...
- (void)_getSubscriptionStatusWithStoreRequestContext:(id)arg1 completion:(id /* block */)arg2;
...
- (void)_prepareAssetForHLSPlayback:(id)arg1 loadResult:(id)arg2 destinationURL:(id)arg3 storeRequestContext:(id)arg4 urlBag:(id)arg5 identityProperties:(id)arg6 isStoreKeyServer:(bool)arg7;
...
- (id)nextChapterAfter:(double)arg1;
...
- (id)previousChapterBefore:(double)arg1;
