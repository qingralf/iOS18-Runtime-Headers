...
@interface MPCMusicFavoritingMiddlewareOperation : MPAsyncOperation <MPMiddlewareAutomaticDependencyOperation> {
    NSMapTable * _inputOperations;
    id /* block */  _invalidationHandler;
    NSArray * _invalidationObservers;
    MPCMusicFavoritingMiddleware * _middleware;
...
@property (nonatomic, retain) MPCMusicFavoritingMiddleware *middleware;
