...
@property (getter=isRestoringPlaybackState, nonatomic) bool restoringPlaybackState;
...
@property (nonatomic, readonly) _MPCSleepTimerController *sleepTimerController;
...
@property (nonatomic, readonly) _MPCTranscriptAlignmentController *transcriptAlignmentController;
...
- (void)relativeVolumeDidUpdateToVolume:(float)arg1;
...
- (void)setRestoringPlaybackState:(bool)arg1;
...
- (id)sleepTimerController;
- (void)start;
- (id)swiftStorage;
- (id)targetContentItemID;
- (id)transcriptAlignmentController;
- (id)videoOutput;
