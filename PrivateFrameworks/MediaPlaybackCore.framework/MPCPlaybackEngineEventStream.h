...
- (void)performQuery:(id /* block */)arg1;
- (bool)performQueryReturningBOOL:(id /* block */)arg1;
- (id)performQueryReturningObject:(id /* block */)arg1;
...
- (void)setTransactionDebounceTime:(double)arg1;
- (id)testingDelegate;
