...
- (void)_setupPlayer;
- (bool)_setupQueueItemForEnhancedAudioHLSPlayback:(id)arg1 playerItem:(id)arg2 metadataWaitTime:(double*)arg3 error:(id*)arg4;
- (void)_setupQueueItemForHLSPlayback:(id)arg1 playerItem:(id)arg2;
- (void)_setupQueueItemForLossyAudioPlayback:(id)arg1 playerItem:(id)arg2;
...
- (bool)configureQueueItem:(id)arg1 playerItem:(id)arg2 error:(id*)arg3;
...
- (id)translator;
- (bool)updateCurrentAudioRouteWithPickedRouteIfNeeded:(id)arg1;
