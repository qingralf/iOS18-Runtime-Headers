...
@property (nonatomic, readonly) MRPlayerPath *mrPlayerPath;
@property (getter=isNativeBooksPath, nonatomic, readonly) bool nativeBooksPath;
@property (getter=isNativeMusicPath, nonatomic, readonly) bool nativeMusicPath;
@property (getter=isNativePodcastsPath, nonatomic, readonly) bool nativePodcastsPath;
...
+ (id)systemPodcastsPathWithRoute:(id)arg1 playerID:(id)arg2;
