...
- (void)_appendPlaybackContexts:(id)arg1 remoteCommandSenderID:(id)arg2 completion:(id /* block */)arg3;
- (void)_applyServerStateUpdateRecord:(id)arg1;
- (void)_handleCommandHandlersRegistered:(id)arg1;
- (void)_handleMPAVItemTitlesDidChange:(id)arg1;
- (void)_invokeServerCommandEvent:(id)arg1 remoteCommandSenderID:(id)arg2 completion:(id /* block */)arg3;
- (id)_nowPlayingWithItem:(id)arg1;
- (void)_onQueue_setNowPlayingItem:(id)arg1 itemIdentifier:(id)arg2 remoteCommandSenderID:(id)arg3 completion:(id /* block */)arg4;
- (void)_prependPlaybackContexts:(id)arg1 remoteCommandSenderID:(id)arg2 completion:(id /* block */)arg3;
