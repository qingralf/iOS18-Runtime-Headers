...
@interface _MPCPlayerInsertItemsCommand : _MPCPlayerCommand <MPCPlayerInsertAfterLastSectionCommand, MPCPlayerInsertItemsCommand> {
    NSArray * _devices;
...
@property (nonatomic, retain) MPCPlayerResponseSection *lastSection;
...
- (id)insertWithPlaybackIntent:(id)arg1;
- (id)lastSection;
- (id)section;
- (void)setDevices:(id)arg1;
- (void)setLastSection:(id)arg1;
