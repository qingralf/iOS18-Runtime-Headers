...
@property (nonatomic, copy) NSString *latestUpNextSectionID;
@property (nonatomic) <MPCQueueControllerBehaviorMusicDelegate> *musicBehaviorDelegate;
@property (nonatomic, copy) NSString *playNowInsertionContentItemID;
...
- (id)_autoPlayUpNextSectionIdentifierForItem:(id)arg1;
...
- (id)_idenitiferListForPosition:(long long)arg1 afterContentItemID:(id)arg2 existingUpNextSectionID:(id)arg3 createdUpNextSectionID:(id)arg4;
...
- (void)_playNowIfPossible:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)_playbackContextOptions;
- (long long)_privateListeningSourceForContext:(id)arg1;
- (void)_qfa_performInsertPlaybackContext:(id)arg1 atPosition:(long long)arg2 afterContentItemID:(id)arg3 sectionIdentifier:(id)arg4 actions:(unsigned long long)arg5 completion:(id /* block */)arg6;
...
- (id)_tailInsertionComponentsForUpNextSectionID:(id)arg1;
- (void)_transitionToAutoPlayState:(long long)arg1;
- (id)_upNextSectionIdentifierForItem:(id)arg1;
- (id)_upNextSectionIdentifierForItem:(id)arg1 shouldLookInBaseList:(bool)arg2;
...
- (id)lastSectionContentItemIDForTargetContentItemID:(id)arg1;
- (id)latestUpNextSectionID;
...
- (id)playNowInsertionContentItemID;
- (long long)playbackPositionRestorationPolicy;
- (long long)preferredUpcomingItemCount;
- (void)prepareForCreateStationAfterContentItemID:(id)arg1;
...
- (void)sectionedIdentifierList:(id)arg1 dataSourceDidEndTransactionForSection:(id)arg2;
...
- (void)setLatestUpNextSectionID:(id)arg1;
- (void)setMusicBehaviorDelegate:(id)arg1;
- (void)setPlayNowInsertionContentItemID:(id)arg1;
