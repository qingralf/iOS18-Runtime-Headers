...
@property (nonatomic, readonly) MRAVOutputDevice *designatedProxyGroupLeader;
@property (nonatomic, readonly) MRDeviceInfo *deviceInfo;
@property (nonatomic, readonly) NSArray *effectiveOutputDevices;
@property (nonatomic, retain) MRExternalDevice *externalDevice;
@property (nonatomic, readonly) bool groupContainsDiscoverableGroupLeader;
...
@property (nonatomic, readonly) bool isEligibleForHostingGroupSessionExcludingAcknowledgements;
...
@property (nonatomic, readonly) NSArray *predictedOutputDeviceUIDs;
...
+ (void)_notifyDeviceInfoDidChange:(id)arg1 previousDeviceInfo:(id)arg2 endpoint:(id)arg3;
...
+ (void)_notifyGroupSessionHostingEligibilityDidChangeForEndpoint:(id)arg1;
+ (void)_notifyGroupSessionInfoDidChange:(id)arg1 endpoint:(id)arg2;
...
+ (void)connectToEndpointContainingOutputDeviceUID:(id)arg1 options:(unsigned int)arg2 details:(id)arg3 completion:(id /* block */)arg4;
...
+ (void)findMyGroupLeaderWithTimeout:(double)arg1 details:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;
+ (void)hostedEndpointForOutputDeviceUIDs:(id)arg1 queue:(id)arg2 completion:(id /* block */)arg3;
+ (void)pauseOutputDeviceUIDs:(id)arg1 details:(id)arg2 queue:(id)arg3 completion:(id /* block */)arg4;
+ (void)sendCommand:(unsigned int)arg1 withOptions:(id)arg2 toEachEndpointContainingOutputDeviceUIDs:(id)arg3 timeout:(double)arg4 queue:(id)arg5 completion:(id /* block */)arg6;
+ (void)sendCommand:(unsigned int)arg1 withOptions:(id)arg2 toNewEndpointContainingOutputDeviceUIDs:(id)arg3 nowPlayingClient:(id)arg4 timeout:(double)arg5 queue:(id)arg6 completion:(id /* block */)arg7;
...
- (void)connectToExternalDeviceWithOptions:(unsigned int)arg1 details:(id)arg2 completion:(id /* block */)arg3;
...
- (id)designatedProxyGroupLeader;
- (id)deviceInfo;
- (id)discoverySessionWithConfiguration:(id)arg1;
- (id)effectiveOutputDevices;
...
- (void)migrateToEndpointOrModifyTopology:(id)arg1 migrationRequest:(id)arg2 topologyModificationRequest:(id)arg3 withReplyQueue:(id)arg4 completion:(id /* block */)arg5;
...
- (void)requestGroupSessionWithQueue:(id)arg1 completion:(id /* block */)arg2;
...
- (bool)volumeMutedForOutputDeviceUID:(id)arg1;
- (void)volumeMutedOnQueue:(id)arg1 completion:(id /* block */)arg2;
- (void)volumeOnQueue:(id)arg1 completion:(id /* block */)arg2;
- (void)waitForPlaybackWithTimeout:(double)arg1 queue:(id)arg2 completion:(id /* block */)arg3;
