...
+ (void)setSearchEndpointsForOutputDeviceUIDImplementation:(id /* block */)arg1;
...
- (void)searchEndpointsForOutputDeviceUID:(id)arg1 timeout:(double)arg2 details:(id)arg3 queue:(id)arg4 completion:(id /* block */)arg5;
- (void)searchEndpointsForOutputDeviceUID:(id)arg1 timeout:(double)arg2 reason:(id)arg3 queue:(id)arg4 completion:(id /* block */)arg5;
- (void)searchEndpointsForRoutingContextUID:(id)arg1 timeout:(double)arg2 details:(id)arg3 queue:(id)arg4 completion:(id /* block */)arg5;
