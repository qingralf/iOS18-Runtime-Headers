...
@interface MRContentItemMetadata : NSObject <NSCopying> {
    ...
    bool  _hasExcludeFromSuggestions;
    ...
    bool  _hasTranscriptAlignmentsAvailable;
    ...
    bool  _transcriptAlignmentsAvailable;
...
@property (nonatomic) bool excludeFromSuggestions;
...
@property (nonatomic, readonly) bool hasExcludeFromSuggestions;
...
@property (nonatomic) bool hasInTransition;
...
@property (nonatomic) bool hasTranscriptAlignmentsAvailable;
...
@property (getter=isInTransition, nonatomic) bool inTransition;
...
@property (nonatomic, copy) NSString *internationalStandardRecordingCode;
...
@property (nonatomic) bool transcriptAlignmentsAvailable;
...
- (void)setExcludeFromSuggestions:(bool)arg1;
...
- (void)setHasInTransition:(bool)arg1;
...
- (void)setHasTranscriptAlignmentsAvailable:(bool)arg1;
...
- (void)setInternationalStandardRecordingCode:(id)arg1;
...
- (void)setTranscriptAlignmentsAvailable:(bool)arg1;
