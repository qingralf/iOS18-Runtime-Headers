...
@interface MRDeviceInfo : NSObject <NSCopying, NSSecureCoding> {
    ...
    bool  _hasClusterType;
    bool  _hasConfiguredClusterSize;
    bool  _hasConnected;
    ...
    bool  _hasIsClusterAware;
    bool  _hasIsClusterLeader;
    bool  _hasIsEligibleForHostingGroupSessionExcludingAcknowledgements;
    bool  _hasLastSupportedClusterType;
    bool  _hasLastSupportedProtocolMessageType;
    ...
    bool  _hasSupportsOutputContextSync;
...
@property (nonatomic, copy) NSString *activeSystemEndpointUID;
...
@property (getter=isClusterLeader, nonatomic) bool clusterLeader;
...
@property (nonatomic, readonly) NSString *effectiveID;
@property (nonatomic, readonly) bool effectiveParentGroupContainsDiscoverableGroupLeader;
...
@property (nonatomic, copy) MRGroupSessionToken *groupSessionToken;
...
@property (nonatomic, readonly) bool hasPlaceholderGroupSession;
...
@property (nonatomic, readonly) bool isGizmo;
...
@property (nonatomic, copy) MRDeviceInfo *leaderDeviceInfo;
...
@property (nonatomic, readonly) bool supportsTwoHop;
...
- (unsigned int)lastSupportedClusterType;
...
- (void)setActiveSystemEndpointUID:(id)arg1;
...
- (void)setClusterLeader:(bool)arg1;
...
- (void)setGroupSessionToken:(id)arg1;
...
- (void)setHasIsEligibleForHostingGroupSessionExcludingAcknowledgements:(bool)arg1;
- (void)setHasLastSupportedClusterType:(bool)arg1;
- (void)setHasLastSupportedProtocolMessageType:(bool)arg1;
...
- (void)setLastSupportedClusterType:(unsigned int)arg1;
- (void)setLastSupportedProtocolMessageType:(unsigned long long)arg1;
- (void)setLeaderDeviceInfo:(id)arg1;
