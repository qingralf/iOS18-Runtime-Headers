...
@property (nonatomic, retain) MRGroupSessionEligibilityStatus *eligibilityStatus;
...
- (void)restoreState;
- (void)setEligibilityStatus:(id)arg1;
- (void)setHasPopulatedIdentity:(bool)arg1;
- (void)setLocalUserIdentity:(id)arg1;
- (bool)updateGroupSessionEligibility:(id)arg1;
