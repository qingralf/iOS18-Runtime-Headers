...
@interface MRNowPlayingControllerConfiguration : NSObject <NSCopying> {
    id /* block */  _customDescriptionForResponse;
...
@property (nonatomic, copy) id /* block */ customDescriptionForResponse;
...
- (id /* block */)customDescriptionForResponse;
- (id)debugDescription;
- (id)description;
- (id)destination;
...
- (void)setCustomDescriptionForResponse:(id /* block */)arg1;
