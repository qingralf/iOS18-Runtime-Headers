...
@property (nonatomic, readonly) MSVMultiCallback *availableArtworkFormatsCallbacks;
...
@property (nonatomic, readonly) MSVMultiCallback *formattedArtworkCallbacks;
...
@property (nonatomic, readonly) MSVMultiCallback *transcriptAlignmentsCallbacks;
...
- (id)availableArtworkFormatsCallbacks;
...
- (id)transcriptAlignmentsCallbacks;
