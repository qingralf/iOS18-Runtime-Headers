...
@property (nonatomic, retain) _MRDictionaryProtobuf *dialogOptions;
...
@property (nonatomic, readonly) bool hasDialogOptions;
@property (nonatomic) bool hasDisabledReason;
@property (nonatomic) bool hasEnabled;
@property (nonatomic, readonly) bool hasLastSectionContentItemID;
...
@property (nonatomic) bool hasSleepTimerFireDate;
@property (nonatomic) bool hasSleepTimerStopMode;
@property (nonatomic) bool hasSleepTimerTime;
@property (nonatomic) bool hasSupportsReferencePosition;
...
@property (nonatomic, retain) NSString *lastSectionContentItemID;
...
- (int)StringAsSleepTimerStopMode:(id)arg1;
...
- (void)setHasSleepTimerFireDate:(bool)arg1;
- (void)setHasSleepTimerStopMode:(bool)arg1;
- (void)setHasSleepTimerTime:(bool)arg1;
- (void)setHasSupportsReferencePosition:(bool)arg1;
...
- (void)setSleepTimerFireDate:(double)arg1;
- (void)setSleepTimerStopMode:(int)arg1;
- (void)setSleepTimerTime:(double)arg1;
...
- (id)sleepTimerStopModeAsString:(int)arg1;
