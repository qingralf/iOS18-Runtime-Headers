...
@property (nonatomic, retain) NSString *clientPreferredLanguages;
...
@property (nonatomic, readonly) bool hasClientPreferredLanguages;
...
@property (nonatomic) bool hasReferencePosition;
...
- (void)setClientPreferredLanguages:(id)arg1;
...
- (void)setHasReferencePosition:(bool)arg1;
...
- (void)setReferencePosition:(double)arg1;
