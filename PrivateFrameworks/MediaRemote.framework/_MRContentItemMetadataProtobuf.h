...
@property (nonatomic) bool hasExcludeFromSuggestions;
...
@property (nonatomic, readonly) bool hasInternationalStandardRecordingCode;
...
@property (nonatomic) bool hasIsInTransition;
...
@property (nonatomic, retain) NSString *internationalStandardRecordingCode;
...
- (void)setHasExcludeFromSuggestions:(bool)arg1;
...
- (void)setHasIsInTransition:(bool)arg1;
