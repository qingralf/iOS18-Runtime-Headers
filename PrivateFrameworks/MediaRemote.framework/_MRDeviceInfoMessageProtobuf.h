...
@property (nonatomic, retain) NSString *activeSystemEndpointUID;
...
@property (nonatomic, retain) _MRGroupSessionTokenProtobuf *groupSessionToken;
@property (nonatomic, retain) NSString *groupUID;
@property (nonatomic, retain) NSMutableArray *groupedDevices;
@property (nonatomic, readonly) bool hasActiveSystemEndpointUID;
...
@property (nonatomic, readonly) bool hasGroupSessionToken;
...
@property (nonatomic, readonly) bool hasLeaderDeviceInfo;
...
@property (nonatomic, retain) _MRDeviceInfoMessageProtobuf *leaderDeviceInfo;
