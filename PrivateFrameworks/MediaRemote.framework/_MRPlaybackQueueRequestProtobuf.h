...
@property (nonatomic, retain) NSMutableArray *requestedArtworkFormats;
@property (nonatomic, retain) NSMutableArray *requestedRemoteArtworkFormats;
...
- (void)addRequestedArtworkFormats:(id)arg1;
- (void)addRequestedRemoteArtworkFormats:(id)arg1;
...
- (id)requestedArtworkFormatsAtIndex:(unsigned long long)arg1;
- (unsigned long long)requestedArtworkFormatsCount;
- (id)requestedRemoteArtworkFormats;
- (id)requestedRemoteArtworkFormatsAtIndex:(unsigned long long)arg1;
