...
- (void)clientOrgKeyForRecordID:(id)arg1 zoneName:(id)arg2 ownerUserID:(id)arg3 personID:(id)arg4 completionBlock:(id /* block */)arg5;
...
- (void)setClientOrgKey:(id)arg1 forAlbumWithGUID:(id)arg2 personID:(id)arg3;
- (void)setClientOrgKey:(id)arg1 forAlbumWithGUID:(id)arg2 personID:(id)arg3 info:(id)arg4;
...
- (void)setMigrationMarker:(id)arg1 personID:(id)arg2;
