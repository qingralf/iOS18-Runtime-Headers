...
@property (nonatomic) bool periodicPromptedAssessmentNotificationsEnabled;
...
- (bool)hasAnyAssessmentNotificationsEnabled;
...
- (void)setPeriodicPromptedAssessmentNotificationTimeOfDay:(id)arg1;
- (void)setPeriodicPromptedAssessmentNotificationsEnabled:(bool)arg1;
