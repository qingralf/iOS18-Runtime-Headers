...
@interface HDMHPromptedAssessmentsManager : NSObject <HDMHLoggingPatternEscalationsManagerObserver, HDMHPeriodicPromptedAssessmentsManagerObserver, HDMHPromptedAssessmentsManaging, HKFeatureStatusProvidingObserver> {
