...
- (void)_fetchMessagesMatchingCriterion:(id)arg1 limit:(unsigned int)arg2 withOptions:(unsigned long long)arg3 handler:(id /* block */)arg4;
...
- (id)downloadSearchResults:(id)arg1;
...
- (bool)performOperationRequiringConnection:(bool)arg1 withOptions:(unsigned long long)arg2 failedToSelectMailbox:(bool*)arg3 operation:(id /* block */)arg4;
- (id)replayAction:(id)arg1;
- (void)reselectMailbox;
- (id)searchWithCriterion:(id)arg1 limit:(unsigned int)arg2;
