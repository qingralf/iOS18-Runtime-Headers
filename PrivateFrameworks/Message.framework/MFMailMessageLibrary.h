...
@interface MFMailMessageLibrary : NSObject <EDMessageChangeHookResponder, EDProtectedDataReconciliationHookResponder, EFContentProtectionObserver, EFLoggable, EFSignpostable> {
    ...
    MFSearchableIndex_iOS * _searchableIndex;
    struct os_unfair_lock_s { 
        unsigned int _os_unfair_lock_opaque; 
    ...
    <MFMailMessageLibrarySwiftPropertiesProtocol> * _swiftProperties;
...
@property (nonatomic, readonly) MFMailboxFrecencyController *mailboxFrecencyController;
...
@property (nonatomic, readonly) <MFMailMessageLibrarySwiftPropertiesProtocol> *swiftProperties;
...
- (void)_captureAnalyticsForMailDatabase:(long long)arg1 schema:(id)arg2;
...
- (long long)_findOrCreateDatabaseIDForAddress:(id)arg1 cache:(id)arg2 connection:(id)arg3 isNewAddress:(bool*)arg4;
- (long long)_findOrCreateDatabaseIDForAddress:(id)arg1 hmeSenderAddress:(id)arg2 cache:(id)arg3 outBusinessID:(long long*)arg4 connection:(id)arg5 isNewAddress:(bool*)arg6;
...
- (id)_getStringFromPlainTextData:(id)arg1 mimePart:(id)arg2;
...
- (void)_writeData:(id)arg1 forMessage:(id)arg2 isPartial:(bool)arg3;
- (bool)_writeEmlxData:(id)arg1 toFile:(id)arg2 protectionClass:(long long)arg3 purgeable:(bool)arg4;
- (bool)_writeEmlxFile:(id)arg1 withData:(id)arg2 protectionClass:(long long)arg3 purgeable:(bool)arg4;
- (bool)_writeEmlxFileOfType:(long long)arg1 forAccount:(id)arg2 toDirectory:(id)arg3 withData:(id)arg4 protectionClass:(long long)arg5;
...
- (void)compactMessages:(id)arg1 permanently:(bool)arg2 notifyPersistence:(bool)arg3;
...
- (void)notifyNewData:(id)arg1 availableForMessage:(id)arg2;
...
- (id)queryParser;
- (id)rangesOfIndexedUIDsInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 requiresBody:(bool)arg2 forMailbox:(id)arg3 limit:(long long)arg4;
...
- (id)searchResultsWithRemoteIDs:(id)arg1 requiresBody:(bool)arg2 inRemoteMailbox:(id)arg3;
- (id)searchableIndex;
...
- (id)senderForMessageWithLibraryID:(long long)arg1;
