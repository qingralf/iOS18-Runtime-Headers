...
- (void).cxx_destruct;
- (void)_recordFrecencyEventWithMailboxURL:(id)arg1;
...
- (id)initWithLibrary:(id)arg1 database:(id)arg2 localActionPersistence:(id)arg3 messagePersistence:(id)arg4 serverMessagePersistenceFactory:(id)arg5 readLaterPersistence:(id)arg6 categoryPersistence:(id)arg7 bimiManager:(id)arg8 hookResponder:(id)arg9 hookRegistry:(id)arg10;
