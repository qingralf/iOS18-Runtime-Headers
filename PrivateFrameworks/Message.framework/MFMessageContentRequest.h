...
- (id)_contentRepresentationForEvent:(id)arg1 contentURL:(id)arg2 relatedItems:(id)arg3 messageAndHTMLDataPair:(id)arg4 existingRepresentation:(id)arg5 invocable:(id)arg6;
...
- (id)_messageContentFromLoadingContext:(id)arg1 completion:(id /* block */)arg2;
- (id)_messageForLegacyMessage:(id)arg1;
- (void)_messageInReplyToMessage:(id)arg1 libraryStore:(id)arg2 completion:(id /* block */)arg3;
- (void)_originalContentMessagesInReplyToLegacyMessage:(id)arg1 withMessageAndHTMLDataPair:(id)arg2 maximumNumberOfMessages:(unsigned long long)arg3 completion:(id /* block */)arg4;
