...
@interface MFAttachment : NSObject <EFPubliclyDescribable, NSItemProviderWriting> {
    NSItemProvider * _attachmentDataProvider;
    MFAttachmentManager * _attachmentManager;
    <MFDataConsumer> * _customConsumer;
    NSString * _disposition;
    id /* block */  _fetchCompletionBlock;
    NSNumber * _fileHasSynapseAttributes;
    struct CGSize { 
        double width; 
        double height; 
    }  _imageDimensions;
...
@property (nonatomic, readonly) NSString *contentTypeIdentifier;
...
@property (nonatomic, retain) NSNumber *fileHasSynapseAttributes;
...
@property (nonatomic, copy) NSString *mimePartNumber;
...
@property bool shouldPreserveFidelity;
...
+ (id)fileTypeForFilename:(id)arg1 mimeType:(id)arg2;
...
- (void)setFileHasSynapseAttributes:(id)arg1;
...
- (void)setShouldPreserveFidelity:(bool)arg1;
- (void)setUrl:(id)arg1;
...
- (id)_contentTypeIdentifierByStrippingZipIfNeeded:(bool)arg1;
