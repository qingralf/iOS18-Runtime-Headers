...
- (id)_createSynapseAttributesForAttachment:(id)arg1;
...
- (id)prepareAttachmentForDisplay:(id)arg1 fileURL:(id)arg2;
...
- (void)attachmentForCID:(id)arg1 isBasicImage:(id /* block */)arg2;
- (void)attachmentForCID:(id)arg1 isDisplayableImage:(id /* block */)arg2;
- (void)filenameAndURLForAttachmentForCID:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)hasAttachmentForCID:(id)arg1 completionHandler:(id /* block */)arg2;
