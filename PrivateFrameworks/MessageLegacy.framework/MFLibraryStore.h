...
- (void)_calcAttachmentInfoForMessage:(id)arg1 body:(id)arg2;
...
- (void)addMessageDataToCaches:(id)arg1 forMessage:(id)arg2 isPartial:(bool)arg3;
...
- (id)searchResultsWithRemoteIDs:(id)arg1 requiresBody:(bool)arg2 inMailbox:(id)arg3;
...
- (void)setData:(id)arg1 summary:(id)arg2 forMessage:(id)arg3 isPartial:(bool)arg4;
...
- (id)storeSearchResultMatchingQuery:(id)arg1 criterion:(id)arg2 limit:(unsigned int)arg3 offset:(id)arg4 useLocalIndex:(bool)arg5;
