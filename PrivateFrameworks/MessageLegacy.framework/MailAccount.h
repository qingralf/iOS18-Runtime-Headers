...
@property (nonatomic, retain) NSDate *lastEmailAliasesSyncDate;
@property (nonatomic, retain) NSString *lastEmailAliasesSyncEntityTag;
...
@property (nonatomic, retain) MFLocalActionReplayHandler *replayHandler;
@property (nonatomic, readonly) MFMailboxUid *rootMailbox;
...
@property (nonatomic, readonly) <MFTaskManager> *taskManager;
...
+ (void)_postMailboxListNotificationAfterBlock:(id /* block */)arg1;
...
+ (id)accountIDFromMailboxURLString:(id)arg1 urlScheme:(id)arg2;
...
+ (void)performOnAccounts:(id)arg1 accountBlock:(id /* block */)arg2;
...
+ (void)updatePersonalStatusForAccounts:(id)arg1 forceUpdate:(bool)arg2;
...
- (id)_URLScheme;
- (bool)_assignSpecialMailboxToAppropriateIvar:(id)arg1 forType:(long long)arg2;
- (void)_asynchronouslyInvalidateAndDeleteAccountData:(bool)arg1;
- (id)_cachedSpecialMailboxOfType:(long long)arg1;
...
- (id)_defaultSpecialMailboxNameForType:(long long)arg1;
- (void)_deleteHook;
...
- (id)_localMailboxNameForType:(long long)arg1 usingDisplayName:(id)arg2;
- (id)_mailboxPathPrefix;
- (void)_mailboxesWereRemovedFromTree:(id)arg1 withFileSystemPaths:(id)arg2;
- (id)_newMailboxWithParent:(id)arg1 name:(id)arg2 attributes:(unsigned int)arg3 dictionary:(id)arg4 withCreationOption:(long long)arg5;
- (id)_pathComponentForUidName:(id)arg1;
- (bool)_readCustomInfoFromMailboxCache:(id)arg1;
...
- (bool)_resetSpecialMailboxesCanPost:(bool)arg1;
...
- (void)_setSpecialMailbox:(id)arg1 forType:(long long)arg2;
- (void)_setSpecialMailboxName:(id)arg1 forType:(long long)arg2;
...
- (id)_specialMailboxUidWithType:(long long)arg1 create:(bool)arg2;
- (void)_synchronizeMailboxListWithFileSystem;
- (void)_synchronouslyLoadListingForParent:(id)arg1;
- (id)_uidNameForPathComponent:(id)arg1;
- (bool)_writeCustomInfoToMailboxCache:(id)arg1;
...
- (id)allMailboxUids;
- (id)allMailboxesFilteringNotes:(bool)arg1;
- (long long)archiveDestinationForMailbox:(id)arg1;
...
- (bool)checkAndSetDefaultEmailAddress:(id)arg1;
- (bool)checkAndSetEmailAddresses:(id)arg1;
- (bool)checkAndSetReceiveEmailAliasAddresses:(id)arg1;
- (id)connectionError;
...
- (int)emptyFrequencyForMailboxType:(long long)arg1;
- (void)emptyTrash;
...
- (void)forceFetchMailboxListWithKind:(long long)arg1;
...
- (bool)isLocalAccount;
- (bool)isMailboxLocalForType:(long long)arg1;
...
- (id)mailboxUidForRelativePath:(id)arg1 create:(bool)arg2 withOption:(long long)arg3;
- (id)mailboxUidForURL:(id)arg1;
- (id)mailboxUidOfType:(long long)arg1 createIfNeeded:(bool)arg2;
...
- (bool)resetSpecialMailboxesCanPostNotifications:(bool)arg1;
...
- (id)saveSentFolder;
- (void)saveState;
- (long long)secureCompositionEncryptionPolicyForAddress:(id)arg1;
- (long long)secureCompositionSigningPolicyForAddress:(id)arg1;
...
- (void)setEmptyFrequency:(int)arg1 forMailboxType:(long long)arg2;
...
- (void)setLastEmailAliasesSyncEntityTag:(id)arg1;
- (void)setLibrary:(id)arg1;
- (void)setMailboxCachePath:(id)arg1;
- (void)setMailboxUid:(id)arg1 forMailboxType:(long long)arg2;
...
- (bool)shouldFetchRemoteLinksWithDateReceived:(id)arg1;
- (bool)shouldRestoreMessagesAfterFailedDelete;
- (id)signingIdentityPersistentReferenceForAddress:(id)arg1;
- (id)smtpIdentifier;
- (bool)sourceIsManaged;
- (id)specialMailboxNameForType:(long long)arg1;
...
- (id)taskManager;
- (void)test_setTaskManager:(id)arg1;
- (void)test_tearDown;
