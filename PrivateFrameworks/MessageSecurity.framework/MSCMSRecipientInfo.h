...
@interface MSCMSRecipientInfo : NSObject {
    ...
    struct __SecIdentity { } * _originatorIdentity;
...
@property (nonatomic) struct __SecIdentity { }*originatorIdentity;
...
- (struct __CFData { }*)createSecCMSSharedInfo:(id)arg1;
- (struct __CFData { }*)createSharedInfo:(id)arg1;
- (void)dealloc;
- (id)decryptWrappedKey:(id)arg1 kek:(id)arg2 iv:(struct heim_base_data { unsigned long long x1; void *x2; }*)arg3;
...
- (struct __CFData { }*)keyEncryptionKey:(id)arg1 forEncryption:(bool)arg2 secCMSCompatibility:(bool)arg3;
- (struct __SecCertificate { }*)originator;
- (struct __SecIdentity { }*)originatorIdentity;
- (id)originatorPubKey;
...
- (void)setOriginatorIdentity:(struct __SecIdentity { }*)arg1;
