...
- (void)validateAddressRanges:(id)arg1 expectedTotalSize:(unsigned long long)arg2 context:(struct _MTLMessageContext { long long x1; char *x2; unsigned int x3; id x4; long long x5; id x6; char *x7; }*)arg3;
