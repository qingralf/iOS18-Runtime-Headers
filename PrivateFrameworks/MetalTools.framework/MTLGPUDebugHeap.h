...
@interface MTLGPUDebugHeap : MTLToolsHeap {
    ...
    struct vector<std::pair<unsigned int, MTLTextureType>, std::allocator<std::pair<unsigned int, MTLTextureType>>> { 
        void *__begin_; 
        void *__end_; 
        struct __compressed_pair<std::pair<unsigned int, MTLTextureType> *, std::allocator<std::pair<unsigned int, MTLTextureType>>> { 
            void *__value_; 
        } __end_cap_; 
...
- (void)enumerateAccelerationStructureIndices:(id /* block */)arg1;
- (void)enumerateBufferIndices:(id /* block */)arg1;
- (void)enumerateTextureIndicesAndTypes:(id /* block */)arg1;
