...
@interface MTLGPUDebugRenderCommandEncoder : MTLToolsRenderCommandEncoder <MTLGPUDebugCommandEncoder> {
    ...
    <MTLBuffer> * _fragmentTextureTypeTable;
    ...
    <MTLBuffer> * _meshTextureTypeTable;
    ...
    <MTLBuffer> * _objectTextureTypeTable;
    ...
    <MTLBuffer> * _vertexTextureTypeTable;
...
- (void)prepareExecuteIndirect:(id)arg1 variant:(struct variant<std::pair<MTLGPUDebugBuffer *, unsigned long>, MTLIndirectCommandBufferExecutionRange> { struct __impl<std::pair<MTLGPUDebugBuffer *, unsigned long>, MTLIndirectCommandBufferExecutionRange> { union __union<std::__variant_detail::_Trait::_TriviallyAvailable, 0UL, std::pair<MTLGPUDebugBuffer *, unsigned long>, MTLIndirectCommandBufferExecutionRange> { BOOL x_1_2_1; struct __alt<0UL, std::pair<MTLGPUDebugBuffer *, unsigned long>> { struct pair<MTLGPUDebugBuffer *, unsigned long> { id x_1_4_1; unsigned long long x_1_4_2; } x_2_3_1; } x_1_2_2; union __union<std::__variant_detail::_Trait::_TriviallyAvailable, 1UL, MTLIndirectCommandBufferExecutionRange> { BOOL x_3_3_1; struct __alt<1UL, MTLIndirectCommandBufferExecutionRange> { struct { unsigned int x_1_5_1; unsigned int x_1_5_2; } x_2_4_1; } x_3_3_2; union __union<std::__variant_detail::_Trait::_TriviallyAvailable, 2UL> { } x_3_3_3; } x_1_2_3; } x_1_1_1; unsigned int x_1_1_2; } x1; })arg2;
- (void)restoreInternalState:(id)arg1;
- (void)setBufferUsageTable:(id)arg1 textureUsageTable:(id)arg2 textureTypeTable:(id)arg3 forStage:(unsigned long long)arg4;
