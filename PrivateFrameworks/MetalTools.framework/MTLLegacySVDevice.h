...
@interface MTLLegacySVDevice : MTLToolsDevice {
    ...
    struct LegacySVConstantBufferCache { 
        ...
        struct unordered_map<LegacySVConstantBufferCache::Key, LegacySVConstantBufferCache::Value, LegacySVConstantBufferCache::Key::Hash, std::equal_to<LegacySVConstantBufferCache::Key>, std::allocator<std::pair<const LegacySVConstantBufferCache::Key, LegacySVConstantBufferCache::Value>>> { 
            struct __hash_table<std::__hash_value_type<LegacySVConstantBufferCache::Key, LegacySVConstantBufferCache::Value>, std::__unordered_map_hasher<LegacySVConstantBufferCache::Key, std::__hash_value_type<LegacySVConstantBufferCache::Key, LegacySVConstantBufferCache::Value>, LegacySVConstantBufferCache::Key::Hash, std::equal_to<LegacySVConstantBufferCache::Key>>, std::__unordered_map_equal<LegacySVConstantBufferCache::Key, std::__hash_value_type<LegacySVConstantBufferCache::Key, LegacySVConstantBufferCache::Value>, std::equal_to<LegacySVConstantBufferCache::Key>, LegacySVConstantBufferCache::Key::Hash>, std::allocator<std::__hash_value_type<LegacySVConstantBufferCache::Key, LegacySVConstantBufferCache::Value>>> { 
                struct unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<LegacySVConstantBufferCache::Key, LegacySVConstantBufferCache::Value>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<LegacySVConstantBufferCache::Key, LegacySVConstantBufferCache::Value>, void *> *> *>>> { 
                    struct __compressed_pair<std::__hash_node_base<std::__hash_node<std::__hash_value_type<LegacySVConstantBufferCache::Key, LegacySVConstantBufferCache::Value>, void *> *> **, std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<LegacySVConstantBufferCache::Key, LegacySVConstantBufferCache::Value>, void *> *> *>>> { 
                        ...
                        struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<LegacySVConstantBufferCache::Key, LegacySVConstantBufferCache::Value>, void *> *> *>> { 
                            struct __compressed_pair<unsigned long, std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<LegacySVConstantBufferCache::Key, LegacySVConstantBufferCache::Value>, void *> *> *>> { 
                                unsigned long long __value_; 
                            } __data_; 
                        } __value_; 
                    } __ptr_; 
                } __bucket_list_; 
                struct __compressed_pair<std::__hash_node_base<std::__hash_node<std::__hash_value_type<LegacySVConstantBufferCache::Key, LegacySVConstantBufferCache::Value>, void *> *>, std::allocator<std::__hash_node<std::__hash_value_type<LegacySVConstantBufferCache::Key, LegacySVConstantBufferCache::Value>, void *>>> { 
                ...
                struct __compressed_pair<unsigned long, std::__unordered_map_hasher<LegacySVConstantBufferCache::Key, std::__hash_value_type<LegacySVConstantBufferCache::Key, LegacySVConstantBufferCache::Value>, LegacySVConstantBufferCache::Key::Hash, std::equal_to<LegacySVConstantBufferCache::Key>>> { 
                    unsigned long long __value_; 
                } __p2_; 
                struct __compressed_pair<float, std::__unordered_map_equal<LegacySVConstantBufferCache::Key, std::__hash_value_type<LegacySVConstantBufferCache::Key, LegacySVConstantBufferCache::Value>, std::equal_to<LegacySVConstantBufferCache::Key>, LegacySVConstantBufferCache::Key::Hash>> { 
                    float __value_; 
                } __p3_; 
            } __table_; 
        } _cache; 
    ...
    struct LegacySVBufferDescriptorHeap { 
        ...
        /* Warning: unhandled struct encoding: '{vector<MTLLegacySVBuffer *, std::allocator<MTLLegacySVBuffer *>>="__begin_"^@"__end_"^@"__end_cap_"{__compressed_pair<MTLLegacySVBuffer **, std::allocator<MTLLegacySVBuffer *>>="__value_"^@}}"_freeIndex"Q"_argumentEncoder"@"<MTLArgumentEncoder>""_descriptorHeap"@"<MTLBuffer>"}' */ struct vector<MTLLegacySVBuffer *, std::allocator<MTLLegacySVBuffer *>> { 
            __end_ **__begin_; 
        } _bufferList; 
    }  globalBufferHeap;
...
- (id)_modifyComputePipelineDescriptor:(id)arg1 options:(unsigned long long*)arg2;
- (void)_modifyMeshRenderPipelineDescriptor:(id)arg1 options:(unsigned long long*)arg2;
- (id)_modifyRenderPipelineDescriptor:(id)arg1 options:(unsigned long long*)arg2;
- (id)_modifyTilePipelineDescriptor:(id)arg1 options:(unsigned long long*)arg2;
...
- (id)newResidencySetWithDescriptor:(id)arg1 error:(id*)arg2;
...
- (id)setGpuCompilerSPIOptionShaderValidation:(id)arg1 options:(unsigned long long)arg2;
- (void)setWritableHeapsEnabled:(bool)arg1;
