...
@interface MTLLegacySVRenderCommandEncoder : MTLToolsRenderCommandEncoder <MTLLegacySVCommandEncoder> {
    ...
    struct MTLLegacySVStageBufferHandles { 
        ...
        <MTLLegacySVResource> *resources[31]; 
