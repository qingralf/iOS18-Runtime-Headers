...
@property <MTLBuffer> *privateData; /* unknown property attribute: ? */
@property unsigned long long privateDataOffset; /* unknown property attribute: ? */
@property <MTLBuffer> *privateLoggingBuffer; /* unknown property attribute: ? */
...
- (void)useInternalResidencySet:(id)arg1;
- (void)useInternalResidencySets:(const id*)arg1 count:(unsigned long long)arg2;
