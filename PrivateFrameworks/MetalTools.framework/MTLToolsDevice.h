...
@property (getter=isClampToHalfBorderSupported, readonly) bool ClampToHalfBorderSupported; /* unknown property attribute: ? */
@property (getter=isCustomBorderColorSupported, readonly) bool CustomBorderColorSupported; /* unknown property attribute: ? */
...
@property (getter=isRGB10A2GammaSupported, readonly) bool RGB10A2GammaSupported; /* unknown property attribute: ? */
...
@property (getter=isQuadDataSharingSupported, readonly) bool quadDataSharingSupported; /* unknown property attribute: ? */
...
@property bool shaderDebugInfoCaching; /* unknown property attribute: ? */
@property (readonly) unsigned long long sharedMemorySize;
@property (readonly) unsigned long long singleFPConfig;
@property (readonly) unsigned long long sparseTexturesSupport; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) bool supportsArgumentBuffers;
...
@property (nonatomic, readonly) bool supportsBufferWithAddressRanges;
...
@property (nonatomic, readonly) bool supportsDeviceCoherency;
...
@property (nonatomic, readonly) bool supportsExtendedSamplerLODBiasRange;
...
@property (nonatomic, readonly) bool supportsGlobalVariableBindingInDylibs;
@property (nonatomic, readonly) bool supportsGlobalVariableBindings;
...
@property (nonatomic, readonly) bool supportsHeapWithAddressRanges;
...
@property (nonatomic, readonly) bool supportsMeshRenderDynamicLibraries;
...
@property (nonatomic, readonly) bool supportsPartialRenderMemoryBarrier;
...
@property (nonatomic, readonly) bool supportsRayTracingDirectIntersectionResultAccess;
...
@property (nonatomic, readonly) bool supportsRayTracingMatrixLayout;
@property (nonatomic, readonly) bool supportsRayTracingMultiLevelInstancing;
@property (nonatomic, readonly) bool supportsRayTracingPerComponentMotionInterpolation;
...
@property (nonatomic, readonly) bool supportsResourceDetachBacking;
@property (nonatomic, readonly) bool supportsResourceHeaps;
...
- (unsigned long long)latestSupportedGenericBVHVersion;
...
- (id)newLogStateWithDescriptor:(id)arg1 error:(id*)arg2;
...
- (id)newSharedTextureWithHandle:(id)arg1 withResourceIndex:(unsigned long long)arg2;
