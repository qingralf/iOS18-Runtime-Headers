...
@property (nonatomic, retain) <MTLBuffer> *globalBuffer; /* unknown property attribute: ? */
@property (nonatomic) unsigned long long globalBufferOffset; /* unknown property attribute: ? */
