...
- (id)albumMigrator;
- (void)import;
- (void)import:(id)arg1 identifier:(id)arg2 offset:(unsigned long long)arg3 length:(unsigned long long)arg4 total:(unsigned long long)arg5 filename:(id)arg6 collection:(id)arg7 originalFilename:(id)arg8 complete:(bool)arg9;
- (bool)importAndWait;
- (bool)importAssetAndWait:(id)arg1 retryNeeded:(bool*)arg2;
- (void)importChunk:(id)arg1 identifier:(id)arg2 offset:(unsigned long long)arg3 length:(unsigned long long)arg4 total:(unsigned long long)arg5 filename:(id)arg6 collection:(id)arg7 originalFilename:(id)arg8 complete:(bool)arg9;
- (id)initWithType:(unsigned long long)arg1;
- (id)initWithType:(unsigned long long)arg1 reuseDatabase:(bool)arg2;
- (bool)isBusy;
- (id)path;
