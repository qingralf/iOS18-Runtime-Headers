...
@property (nonatomic, retain) NSString *clientProcessName;
...
- (void).cxx_destruct;
- (id)_initForClientLockReason:(id)arg1 forClientProcessName:(id)arg2 withClientProcessID:(long long)arg3 lockingWithUsagePolicy:(id)arg4;
...
- (id)initForClientLockReason:(id)arg1 forClientProcessName:(id)arg2 withClientProcessID:(long long)arg3 lockingWithUsagePolicy:(id)arg4;
...
- (void)setClientProcessID:(long long)arg1;
