...
@property (nonatomic, readonly) bool shortTermLocker;
@property (readonly) Class superclass;
@property (nonatomic, retain) NSString *updateCategoryDesiredByClient;

+ (id)defaultDispatchQueue;
+ (void)eliminateAtomic:(id)arg1 usingClientDomain:(id)arg2 forAssetSetIdentifier:(id)arg3 awaitingUnlocked:(bool)arg4 completion:(id /* block */)arg5;
...
+ (id)eliminateAtomicSync:(id)arg1 usingClientDomain:(id)arg2 forAssetSetIdentifier:(id)arg3 awaitingUnlocked:(bool)arg4;
...
- (void).cxx_destruct;
- (void)_closeAndRemoveShortTermLock:(id)arg1 forShortTermLock:(id)arg2;
- (void)_eliminateAtomic:(id)arg1 awaitingUnlocked:(bool)arg2 completion:(id /* block */)arg3;
- (id)_eliminateAtomicSync:(id)arg1 awaitingUnlocked:(bool)arg2;
...
- (void)_failedMapLockedAtomicEntry:(id)arg1 forAssetSetIdentifier:(id)arg2 withErrorCode:(long long)arg3 withResponseError:(id)arg4 description:(id)arg5 completion:(id /* block */)arg6;
...
- (void)_lockAtomicWithContentValidationOption:(id)arg1 forAtomicInstance:(id)arg2 performContentValidation:(bool)arg3 completion:(id /* block */)arg4;
- (id)_newProxyObjectForSetProgressBlock:(id /* block */)arg1;
- (id)_readLockedSetStatusFromSharedLockFile:(id)arg1 error:(id*)arg2;
- (void)_shortTermCurrentSetStatus:(id /* block */)arg1;
- (id)_shortTermCurrentSetStatusSync:(id*)arg1;
- (void)_shortTermEndAtomicLock:(id)arg1 ofAtomicInstance:(id)arg2 completion:(id /* block */)arg3;
- (id)_shortTermEndAtomicLockSync:(id)arg1 ofAtomicInstance:(id)arg2;
- (void)_shortTermLockAtomic:(id)arg1 forAtomicInstance:(id)arg2 completion:(id /* block */)arg3;
- (void)_shortTermLockAtomic:(id)arg1 forAtomicInstance:(id)arg2 performContentValidation:(bool)arg3 completion:(id /* block */)arg4;
- (id)_shortTermLockAtomicSync:(id)arg1 forAtomicInstance:(id)arg2 error:(id*)arg3;
- (id)_shortTermLockAtomicSync:(id)arg1 forAtomicInstance:(id)arg2 performContentValidation:(bool)arg3 error:(id*)arg4;
- (void)_shortTermLockAtomicWithContentValidationOption:(id)arg1 forAtomicInstance:(id)arg2 performContentValidation:(bool)arg3 completion:(id /* block */)arg4;
- (id)_shortTermLockForAtomicInstance:(id)arg1 locking:(bool)arg2 withLockedFileDescriptor:(int)arg3 forLockReason:(id)arg4 justCreated:(bool*)arg5 providingLockedSetStatus:(id*)arg6 error:(id*)arg7;
- (id)_shortTermLockForAtomicInstance:(id)arg1 locking:(bool)arg2 withLockedFileDescriptor:(int)arg3 forLockReason:(id)arg4 justCreated:(bool*)arg5 providingLockedSetStatus:(id*)arg6 shouldVerifyContent:(bool)arg7 error:(id*)arg8;
- (void)_shortTermLogResult:(id)arg1 forLockReason:(id)arg2 forAtomicInstance:(id)arg3 atomicInstanceFilename:(id)arg4 forShortTermLock:(id)arg5 withSetStatus:(id)arg6 returningError:(id)arg7;
- (int)_shortTermOpenSharedLockFile:(id)arg1 lockingAtomicInstance:(id)arg2 forLockReason:(id)arg3 verifyingLocalContentURLs:(bool)arg4 openingFilename:(id)arg5 providingLockedSetStatus:(id*)arg6 sharedLockError:(id*)arg7;
...
- (void)_successLockAtomic:(id)arg1 forAssetSetIdentifier:(id)arg2 lockedAtomicInstance:(id)arg3 lockedAtomicEntries:(id)arg4 sandboxExtension:(id)arg5 sandboxExtensionPath:(id)arg6 completion:(id /* block */)arg7;
- (void)_successMapLockedAtomicEntry:(id)arg1 forAtomicInstance:(id)arg2 forMappedSelector:(id)arg3 completion:(id /* block */)arg4;
...
- (id)initLockerUsingClientDomain:(id)arg1 forAssetSetIdentifier:(id)arg2 error:(id*)arg3;
- (id)initLockerUsingClientDomain:(id)arg1 forAssetSetIdentifier:(id)arg2 usingDesiredPolicyCategory:(id)arg3 completingFromQueue:(id)arg4 error:(id*)arg5;
- (id)initUsingClientDomain:(id)arg1 forClientName:(id)arg2 forAssetSetIdentifier:(id)arg3 asShortTermLocker:(bool)arg4 comprisedOfEntries:(id)arg5 usingDesiredPolicyCategory:(id)arg6 completingFromQueue:(id)arg7 error:(id*)arg8;
...
- (void)lockAtomic:(id)arg1 forAtomicInstance:(id)arg2 completion:(id /* block */)arg3;
- (void)lockAtomic:(id)arg1 forAtomicInstance:(id)arg2 performContentValidation:(bool)arg3 completion:(id /* block */)arg4;
...
- (id)lockAtomicSync:(id)arg1 forAtomicInstance:(id)arg2 error:(id*)arg3;
- (id)lockAtomicSync:(id)arg1 forAtomicInstance:(id)arg2 performContentValidation:(bool)arg3 error:(id*)arg4;
...
- (id)lockAtomicSyncWithContentValidationOption:(id)arg1 forAtomicInstance:(id)arg2 performContentValidation:(bool)arg3 error:(id*)arg4;
- (void)mapLockedAtomicEntry:(id)arg1 forAtomicInstance:(id)arg2 mappingSelector:(id)arg3 completion:(id /* block */)arg4;
- (id)mapLockedAtomicEntrySync:(id)arg1 forAtomicInstance:(id)arg2 mappingSelector:(id)arg3 mappedSelector:(id*)arg4;
