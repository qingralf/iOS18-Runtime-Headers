...
@interface MAAutoAssetSetStatus : NSObject <NSSecureCoding> {
    ...
    bool  _haveReceivedLookupResponse;
    ...
    bool  _vendingAtomicInstanceForConfiguredEntries;
}
...
+ (id)_shortTermLockFilenameNormalizedComponent:(id)arg1;
+ (id)newCurrentLockUsageDetailed:(id)arg1;
+ (id)newCurrentLockUsageSummary:(id)arg1;
+ (id)newSelectorsForStagingSummary:(id)arg1;
+ (id)shortTermLockFilename:(id)arg1 forAssetSetIdentifier:(id)arg2 forSetAtomicInstance:(id)arg3;
...
- (id)initStatusForClientDomain:(id)arg1 forAssetSetIdentifier:(id)arg2 withConfiguredAssetEntries:(id)arg3 withAtomicInstancesDownloaded:(id)arg4 withCatalogCachedAssetSetID:(id)arg5 withCatalogDownloadedFromLive:(id)arg6 withCatalogLastTimeChecked:(id)arg7 withCatalogPostedDate:(id)arg8 withNewerAtomicInstanceDiscovered:(id)arg9 withNewerDiscoveredAtomicEntries:(id)arg10 withLatestDownloadedAtomicInstance:(id)arg11 withLatestDowloadedAtomicInstanceEntries:(id)arg12 withDownloadedCatalogCachedAssetSetID:(id)arg13 withDownloadedCatalogDownloadedFromLive:(id)arg14 withDownloadedCatalogLastTimeChecked:(id)arg15 withDownloadedCatalogPostedDate:(id)arg16 withCurrentNotifications:(id)arg17 withCurrentNeedPolicy:(id)arg18 withSchedulerPolicy:(id)arg19 withStagerPolicy:(id)arg20 havingReceivedLookupResponse:(bool)arg21 vendingAtomicInstanceForConfiguredEntries:(bool)arg22 withDownloadUserInitiated:(bool)arg23 withDownloadProgress:(id)arg24 withDownloadedNetworkBytes:(long long)arg25 withDownloadedFilesystemBytes:(long long)arg26 withCurrentLockUsage:(id)arg27 withSelectorsForStaging:(id)arg28 withAvailableForUseError:(id)arg29 withNewerVersionError:(id)arg30;
- (id)initStatusForClientDomain:(id)arg1 forAssetSetIdentifier:(id)arg2 withConfiguredAssetEntries:(id)arg3 withAtomicInstancesDownloaded:(id)arg4 withCatalogCachedAssetSetID:(id)arg5 withCatalogDownloadedFromLive:(id)arg6 withCatalogLastTimeChecked:(id)arg7 withCatalogPostedDate:(id)arg8 withNewerAtomicInstanceDiscovered:(id)arg9 withNewerDiscoveredAtomicEntries:(id)arg10 withLatestDownloadedAtomicInstance:(id)arg11 withLatestDowloadedAtomicInstanceEntries:(id)arg12 withDownloadedCatalogCachedAssetSetID:(id)arg13 withDownloadedCatalogDownloadedFromLive:(id)arg14 withDownloadedCatalogLastTimeChecked:(id)arg15 withDownloadedCatalogPostedDate:(id)arg16 withCurrentNotifications:(id)arg17 withCurrentNeedPolicy:(id)arg18 withSchedulerPolicy:(id)arg19 withStagerPolicy:(id)arg20 havingReceivedLookupResponse:(bool)arg21 withDownloadUserInitiated:(bool)arg22 withDownloadProgress:(id)arg23 withDownloadedNetworkBytes:(long long)arg24 withDownloadedFilesystemBytes:(long long)arg25 withCurrentLockUsage:(id)arg26 withSelectorsForStaging:(id)arg27 withAvailableForUseError:(id)arg28 withNewerVersionError:(id)arg29;
...
- (void)setHaveReceivedLookupResponse:(bool)arg1;
...
- (void)setVendingAtomicInstanceForConfiguredEntries:(bool)arg1;
- (id)stagerPolicy;
- (id)summary;
