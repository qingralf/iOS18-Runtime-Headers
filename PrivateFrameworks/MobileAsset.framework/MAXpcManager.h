...
- (id)progressCallbacksForAssetType:(id)arg1 assetId:(id)arg2 withPurpose:(id)arg3;
- (void)restoreProgressCallbacks:(id)arg1 assetType:(id)arg2 assetId:(id)arg3 withPurpose:(id)arg4;
