...
@interface MBDomain : NSObject {
    ...
    NSSet * _relativePathsNotToBackupInMegaBackup;
    NSSet * _relativePathsNotToBackupToDrive;
    NSSet * _relativePathsNotToBackupToLocal;
    ...
    NSSet * _relativePathsNotToRestoreFromLocal;
    ...
    unsigned long long  _volumeType;
}

@property (getter=isAppDomain, nonatomic, readonly) bool appDomain;
@property (getter=isBackupDomain, nonatomic, readonly) bool backupDomain;
...
@property (getter=isContainerizedDomain, nonatomic, readonly) bool containerizedDomain;
...
@property (getter=isPlaceholderDomain, nonatomic, readonly) bool placeholderDomain;
...
@property (nonatomic, retain) NSSet *relativePathsNotToBackupInMegaBackup;
@property (nonatomic, retain) NSSet *relativePathsNotToBackupToDrive;
@property (nonatomic, retain) NSSet *relativePathsNotToBackupToLocal;
...
@property (nonatomic, retain) NSSet *relativePathsNotToRestoreFromLocal;
...
@property (nonatomic, readonly, copy) NSString *rootPathRelativeToVolumeMountPoint;
...
@property (nonatomic, readonly) bool supportsFSEventsForDetectingChanges;
...
@property (nonatomic, readonly) unsigned long long volumeType;

+ (bool)_boolFromValue:(id)arg1 forKey:(id)arg2;
+ (id)_dictionaryOfStringsToStringFromValue:(id)arg1 forKey:(id)arg2;
+ (id)_domainWithName:(id)arg1 volumeMountPoint:(id)arg2 rootPath:(id)arg3;
+ (id)_relativePathsByAddingSQLiteJournals:(id)arg1;
+ (id)_setOfStringsFromValue:(id)arg1 forKey:(id)arg2;
+ (bool)_shouldRestoreRelativeSymlinksForDomainName:(id)arg1;
+ (id)_stringByRemovingCommentsFromValue:(id)arg1 forKey:(id)arg2;
+ (id)appDomainWithIdentifier:(id)arg1 volumeMountPoint:(id)arg2 rootPath:(id)arg3;
+ (id)appGroupDomainWithIdentifier:(id)arg1 volumeMountPoint:(id)arg2 rootPath:(id)arg3;
+ (id)appPlaceholderDomainWithIdentifier:(id)arg1 volumeMountPoint:(id)arg2 rootPath:(id)arg3;
+ (id)appPluginDomainWithIdentifier:(id)arg1 volumeMountPoint:(id)arg2 rootPath:(id)arg3;
+ (id)containerIDWithName:(id)arg1;
+ (int)containerTypeWithName:(id)arg1;
+ (id)domainForTestingWithName:(id)arg1 plist:(id)arg2;
+ (id)domainForTestingWithName:(id)arg1 volumeMountPoint:(id)arg2 rootPath:(id)arg3;
+ (double)doubleFromStringValueForKey:(id)arg1 plist:(id)arg2;
+ (bool)isAppGroupName:(id)arg1;
+ (bool)isAppName:(id)arg1;
+ (bool)isAppPlaceholderName:(id)arg1;
+ (bool)isAppPluginName:(id)arg1;
+ (bool)isContainerizedName:(id)arg1;
+ (bool)isPlaceholderName:(id)arg1;
+ (bool)isSystemContainerName:(id)arg1;
+ (bool)isSystemSharedContainerName:(id)arg1;
+ (id)nameWithAppID:(id)arg1;
+ (id)nonContainerizedDomainWithName:(id)arg1 plist:(id)arg2 accountType:(long long)arg3 volumeMountPoint:(id)arg4;
+ (id)placeholderNameWithAppID:(id)arg1;
+ (id)skippedFilesDomainWithVolumeMountPoint:(id)arg1 rootPath:(id)arg2;
+ (id)systemContainerDomainWithIdentifier:(id)arg1 volumeMountPoint:(id)arg2 rootPath:(id)arg3;
+ (id)systemSharedContainerDomainWithIdentifier:(id)arg1 volumeMountPoint:(id)arg2 rootPath:(id)arg3;
+ (id)uninstalledDomainWithName:(id)arg1;

- (void).cxx_destruct;
- (int)_cachedFileDescriptorWithError:(id*)arg1;
- (int)_cachedFileDescriptorWithSnapshotPath:(id)arg1 error:(id*)arg2;
- (id)_initNonContainerizedDomainWithName:(id)arg1 plist:(id)arg2 accountType:(long long)arg3 volumeMountPoint:(id)arg4;
- (id)_initWithName:(id)arg1 volumeMountPoint:(id)arg2 volumeType:(unsigned long long)arg3 rootPath:(id)arg4;
- (bool)_loadDomainFromExternalPlist:(id)arg1;
- (bool)_loadSystemDomain:(id)arg1 plist:(id)arg2 volumeMountPoint:(id)arg3;
...
- (id)relativePathsNotToBackupToLocal;
...
- (id)relativePathsNotToRestoreFromLocal;
...
- (id)rootPath;
- (id)rootPathRelativeToVolumeMountPoint;
...
- (void)setRelativePathsNotToBackupInMegaBackup:(id)arg1;
- (void)setRelativePathsNotToBackupToDrive:(id)arg1;
- (void)setRelativePathsNotToBackupToLocal:(id)arg1;
...
- (void)setRelativePathsNotToRestoreFromLocal:(id)arg1;
...
- (bool)shouldBackUpAnyChildOfRelativePath:(id)arg1;
- (bool)shouldBackupRelativePathFromLiveFileSystem:(id)arg1;
- (bool)shouldBackupRelativePathIgnoringProtectionClass:(id)arg1;
- (bool)shouldDigest;
- (bool)shouldRestoreRelativeSymlinks;
- (bool)shouldRestoreToSharedVolume;
- (bool)supportsFSEventsForDetectingChanges;
- (id)volumeMountPoint;
- (unsigned long long)volumeType;
