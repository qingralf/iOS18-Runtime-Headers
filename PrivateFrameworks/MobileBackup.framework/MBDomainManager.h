...
+ (id)_readDomainsFromPlist:(id)arg1 accountType:(long long)arg2 volumeMountPoint:(id)arg3 error:(id*)arg4;

- (void).cxx_destruct;
- (id)_initWithAccountType:(long long)arg1 volumeMountPoint:(id)arg2 plistPath:(id)arg3 error:(id*)arg4;
- (id)_initWithSystemDomains:(id)arg1 versions:(id)arg2;
- (void)addDomain:(id)arg1;
- (void)addDomain:(id)arg1 forName:(id)arg2;
- (void)addDomainsToBackUpToiCloudWithAppManager:(id)arg1 manager:(id)arg2 account:(id)arg3;
- (id)allDomains;
...
- (void)removeDomains:(id)arg1;
- (void)removeDomainsNotMatchingRegex:(id)arg1;
