...
+ (id)_errorWithCode:(long long)arg1 URL:(id)arg2 format:(id)arg3;
+ (id)_errorWithErrno:(int)arg1 code:(long long)arg2 path:(id)arg3 format:(id)arg4 arguments:(char *)arg5;
+ (id)_formatErrors:(id)arg1 descriptionSelector:(SEL)arg2;
...
+ (id)dictionaryRepresentationForError:(id)arg1 withMultiErrors:(bool)arg2;
+ (int)errnoForError:(id)arg1;
+ (id)errorForHTTPURLResponse:(id)arg1 error:(id)arg2;
+ (id)errorForNSError:(id)arg1 path:(id)arg2 description:(id)arg3;
...
+ (id)errorWithCode:(long long)arg1 path:(id)arg2 description:(id)arg3;
+ (id)errorWithCode:(long long)arg1 path:(id)arg2 format:(id)arg3;
+ (id)errorWithDictionaryRepresentation:(id)arg1;
+ (id)errorWithDictionaryRepresentation:(id)arg1 withMultiErrors:(bool)arg2;
...
+ (bool)isCancelledXPCActivityDeferredError:(id)arg1;
