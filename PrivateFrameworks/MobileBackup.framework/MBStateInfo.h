...
@interface MBStateInfo : NSObject <NSCopying, NSSecureCoding> {
    unsigned long long  _backupAttemptCount;
    NSDate * _date;
    NSError * _error;
...
- (void).cxx_destruct;
- (unsigned long long)backupAttemptCount;
...
- (id)initWithState:(int)arg1 progress:(float)arg2 estimatedTimeRemaining:(unsigned long long)arg3 isCloud:(bool)arg4 isBackground:(bool)arg5 error:(id)arg6 errors:(id)arg7 backupAttemptCount:(unsigned long long)arg8;
- (bool)isBackground;
- (bool)isCloud;
- (float)progress;
- (id)restoredSnapshotBackupPolicy;
- (void)setBackupAttemptCount:(unsigned long long)arg1;
