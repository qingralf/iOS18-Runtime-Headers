...
@interface MBXPCClient : MBManager <MBConnectionDelegate> {
    MBCellularDataSubscriptionMonitor * _cellularDataSubscriptionMonitor;
...
@property (nonatomic, retain) MBCellularDataSubscriptionMonitor *cellularDataSubscriptionMonitor;
...
- (id)domainInfoList;
- (id)dryRestore:(id)arg1 snapshotUUID:(id)arg2 error:(id*)arg3;
...
- (id)fetchBackupCKRecordsIntoDB:(id*)arg1;
...
- (id)initWithAccount:(id)arg1 delegate:(id)arg2 eventQueue:(id)arg3 error:(id*)arg4;
...
- (id)pendingSnapshotForCurrentDeviceWithError:(id*)arg1;
...
- (bool)postFollowUpForRestoreFinishedWithError:(id*)arg1 skipiCloudQuotaOffer:(bool)arg2;
...
- (bool)restoreDomain:(id)arg1 deviceUUID:(id)arg2 snapshotUUID:(id)arg3 intoPath:(id)arg4 error:(id*)arg5;
...
- (id)scheduleActivities:(id)arg1 error:(id*)arg2;
...
- (void)setCellularDataSubscriptionMonitor:(id)arg1;
...
- (id)synchronizeFileListsWithDeviceUUID:(id)arg1 commitID:(id)arg2 error:(id*)arg3;
