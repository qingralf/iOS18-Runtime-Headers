...
@interface MIInstallOptions : NSObject <NSCopying, NSSecureCoding> {
    ...
    struct { unsigned int x1[8]; } * _installationRequestorAuditToken;
...
@property (nonatomic, readonly) NSString *installTypeSummaryString;
@property (nonatomic) struct { unsigned int x1[8]; }*installationRequestorAuditToken;
...
- (unsigned long long)installIntent;
- (unsigned long long)installLocation;
- (unsigned long long)installTargetType;
- (id)installTypeSummaryString;
- (struct { unsigned int x1[8]; }*)installationRequestorAuditToken;
...
- (void)setInstallIntent:(unsigned long long)arg1;
- (void)setInstallLocation:(unsigned long long)arg1;
- (void)setInstallTargetType:(unsigned long long)arg1;
- (void)setInstallationRequestorAuditToken:(struct { unsigned int x1[8]; }*)arg1;
