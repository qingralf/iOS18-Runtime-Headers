...
@interface MIInstallerClient : NSObject <MobileInstallerDelegateProtocol> {
    ...
    id /* block */  _releaseTerminationAssertBlock;
}
...
@property (nonatomic, copy) id /* block */ releaseTerminationAssertBlock;

+ (id)installerWithAppDictionaryEnumerator:(id /* block */)arg1;
+ (id)installerWithProgressBlock:(id /* block */)arg1;
+ (id)installerWithProgressBlock:(id /* block */)arg1 releaseTerminationAssertionBlock:(id /* block */)arg2;
...
- (void)cancelUpdateForStagedUUID:(id)arg1 completion:(id /* block */)arg2;
...
- (void)finalizeStagedInstallForUUID:(id)arg1 returningResultInfo:(bool)arg2 completion:(id /* block */)arg3;
...
- (void)linkedBundleIDsForAppIdentity:(id)arg1 withCompletion:(id /* block */)arg2;
...
- (id /* block */)releaseTerminationAssertBlock;
...
- (bool)setEligibilityTestOverrides:(id)arg1 withError:(id*)arg2;
- (void)setLaunchWarningForApp:(id)arg1 withUniqueInstallIdentifier:(id)arg2 warningData:(id)arg3 completion:(id /* block */)arg4;
- (void)setProgressBlock:(id /* block */)arg1;
- (void)setQueue:(id)arg1;
- (void)setReleaseTerminationAssertBlock:(id /* block */)arg1;
...
- (void)stageInstallURL:(id)arg1 identity:(id)arg2 targetingDomain:(unsigned long long)arg3 withOptions:(id)arg4 completion:(id /* block */)arg5;
...
- (void)updateiTunesMetadataForIXWithIdentifier:(id)arg1 metadata:(id)arg2 completion:(id /* block */)arg3;
