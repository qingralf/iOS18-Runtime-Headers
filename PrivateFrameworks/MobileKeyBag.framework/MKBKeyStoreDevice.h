...
- (int)SeshatUnlock:(id)arg1 withMemento:(bool)arg2 verifyOnly:(bool)arg3 withACMRef:(id)arg4;
...
- (id)getBackupkeyForVolume:(id)arg1 andCryptoID:(unsigned long long)arg2 withError:(id*)arg3;
