...
@interface MFMessageContentView : UIView <EFSignpostable, MFBlockedSenderBannerViewDelegate, MFHasMoreContentBannerViewDelegate, MFHideMyEmailBannerViewDelegate, MFLoadBlockedContentBannerViewDelegate, MFLoadFailedProxyContentBannerViewDelegate, MFMailDropBannerDelegate, MFMailWebProcessDelegate, MFMessageFooterViewDelegate, MFMessageHeaderViewDelegate, MUIPresentationSource, MUIReusable, MobileMailUI.MFNotAuthenticatedBannerViewDelegate, UIContextMenuInteractionDelegate_Private, UIPopoverPresentationControllerDelegate, UIScrollViewDelegate, WKNavigationDelegatePrivate, WKUIDelegatePrivate, _WKInputDelegate> {
    struct CGRect { 
        struct CGPoint { 
            double x; 
            double y; 
    ...
    bool  _allowNotAuthenticatedBanner;
    ...
    bool  _hideSenderSpecificBanners;
...
@property (nonatomic) bool allowNotAuthenticatedBanner;
...
@property (nonatomic) bool hideSenderSpecificBanners;
...
- (void)_clearNotAuthenticatedBannerAnimated:(bool)arg1;
- (void)_commonInit;
...
- (void)_updateHasMoreContentBannerWithRemainingBytes:(unsigned long long)arg1 error:(id)arg2;
- (void)_updateMinimumFontSize;
- (void)_updateWebViewPaddingConstants;
- (id)_updatedHeaderViewModelForMessage:(id)arg1 replyToList:(id)arg2;
...
- (void)didDismissNotAuthenticatedBannerView:(id)arg1;
...
- (void)setAllowNotAuthenticatedBanner:(bool)arg1;
...
- (void)setHideSenderSpecificBanners:(bool)arg1;
