...
@property (nonatomic, readonly, copy) NSArray *browserWindows;
@property (nonatomic, readonly, copy) NSArray *recentlyClosedWindows;
...
- (void)deleteTabStateWithBrowserWindowUUID:(id)arg1 andRemoveWindow:(bool)arg2;
- (id)init;
