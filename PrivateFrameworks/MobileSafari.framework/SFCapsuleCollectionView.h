...
@interface SFCapsuleCollectionView : UIView <SFBarAnimating, SFCapsuleCollectionViewToolbarContentProviding, SFCapsuleContentViewSizeUpdating, SFStartPageScrollObserver, UIGestureRecognizerDelegate, _SFFluidProgressViewDelegate> {
    ...
    bool  _ignoresKeyboardHideEvents;
    ...
    <SFCapsuleCollectionViewLinkablePageView> * _linkedPageView;
...
@property (nonatomic) bool alwaysShowTopBackdrop;
...
@property (getter=isForceHidden, nonatomic) bool forceHidden;
@property (nonatomic, readonly) bool hasTrailingAction;
@property (readonly) unsigned long long hash;
@property (nonatomic) bool ignoresKeyboardHideEvents;
...
@property (nonatomic, retain) <SFCapsuleCollectionViewLinkablePageView> *linkedPageView;
...
@property (nonatomic) bool shouldDismissContent;
...
@property (nonatomic, readonly) UIView *toolbarBackdropView;
...
- (void)_animateSwitchingLinkedPageViewToItemAtIndex:(long long)arg1;
...
- (id)_coordinatorForUpdatingSelectedItemFromState:(long long)arg1 toState:(long long)arg2;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })_detachedCapsuleSelectionRect;
...
- (long long)_insertionIndexForShadowInView:(id)arg1;
...
- (void)_layOutToolbar;
- (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })_layoutMarginsForState:(long long)arg1;
...
- (double)_offsetForMinimization;
- (struct CGPoint { double x1; double x2; })_offsetForPanFromLinkedPageView;
...
- (void)_updateSuperviewForCapsule:(id)arg1;
- (void)_updateToolbar;
...
- (void)setLinkedPageView:(id)arg1;
...
- (void)setShouldDismissContent:(bool)arg1;
- (void)setShouldDismissContent:(bool)arg1 withDelay:(double)arg2;
