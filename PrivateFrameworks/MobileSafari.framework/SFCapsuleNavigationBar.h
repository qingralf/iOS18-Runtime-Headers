...
@interface SFCapsuleNavigationBar : UIControl <PKScribbleInteractionDelegate, SFCapsuleContentView, SFNavigationBarItemObserver, WBSContentAvailabilityDisplayPresenting, _SFBarRegistrationObserving, _SFFluidProgressViewDelegate, _SFNavigationBarCommon> {
...
- (void)_initializeLayoutInfo:(id)arg1 forPrimaryLabel:(bool)arg2 addingConstraints:(id)arg3;
...
- (void)_updateLabelContentsAtIndexes:(id)arg1;
...
- (void)navigationBarItemDidUpdateFluidProgressController:(id)arg1;
...
- (void)navigationBarItemDidUpdateOverlayNarrowConfiguration:(id)arg1;
