...
@property (nonatomic, readonly) SFUnifiedTabBarItemTitleContainerViewTheme *activeTabTitleTheme; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) SFUnifiedTabBarItemTitleContainerViewTheme *tabTitleTheme; /* unknown property attribute: ? */
@property (nonatomic, readonly) SFUnifiedTabBarItemTitleContainerViewTheme *titleTheme; /* unknown property attribute: ? */
