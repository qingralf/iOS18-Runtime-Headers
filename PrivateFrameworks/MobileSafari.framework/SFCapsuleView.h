...
@property (nonatomic) struct NSDirectionalEdgeInsets { double x1; double x2; double x3; double x4; } accessoryViewInsets;
...
- (id)accessoryView;
- (struct NSDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })accessoryViewInsets;
...
- (void)setAccessoryViewInsets:(struct NSDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })arg1;
