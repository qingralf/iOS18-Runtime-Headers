...
+ (id)userMediaPermissionDialogWithHost:(id)arg1 permissions:(unsigned long long)arg2 completionHandler:(id /* block */)arg3;
...
+ (id)webExtensionPermissionDialogWithExtension:(id)arg1 domains:(id)arg2 showMoreOptionsForAlwaysAllow:(bool)arg3 includeDenyButton:(bool)arg4 completionHandler:(id /* block */)arg5;
+ (id)websiteLocationDialogForURL:(id)arg1 originUserVisibleName:(id)arg2 preciseLocation:(bool)arg3 browserPersona:(long long)arg4 completionHandler:(id /* block */)arg5;
...
- (id)responseForSelectionIndex:(unsigned long long)arg1;
