...
@property (nonatomic, readonly) UIView *tiplessPopoverSourceView;
@property (nonatomic) bool usesInsetFromBackground;

+ (id)extensionsImage;
+ (struct CGSize { double x1; double x2; })glyphSize;
+ (id)pageMenuImageWithIntelligence:(bool)arg1;
+ (id)pageMenuImageWithIntelligence:(bool)arg1 usingMulticolorSymbol:(bool)arg2;
+ (id)readerImageWithSummary:(bool)arg1;
+ (id)readerImageWithSummary:(bool)arg1 usingMulticolorSymbol:(bool)arg2;
