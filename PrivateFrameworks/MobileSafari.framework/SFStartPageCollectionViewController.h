...
@interface SFStartPageCollectionViewController : UIViewController <SFStartPageDataSourceObserving, UICollectionViewDelegate, UICollectionViewDragDelegate_Private, UICollectionViewDropDelegate_Private, UIGestureRecognizerDelegate> {
    ...
    bool  _shouldIgnoreLastLayoutSize;
...
- (void)_applyStylingToLayoutGroup:(id)arg1 withSectionItemType:(long long)arg2 defaultInterItemSpacing:(double)arg3;
- (id)_attributedRichLinkSectionLayoutForEnvironment:(id)arg1 maximumNumberOfPages:(long long)arg2 numberOfItems:(long long)arg3;
- (id)_bannerSectionLayoutForEnvironment:(id)arg1 includingHeader:(bool)arg2;
- (bool)_canDrop;
- (long long)_collapsedCapacityForSection:(id)arg1;
...
- (struct { long long x1; long long x2; })_gridLocationForIndexPath:(id)arg1 inSection:(id)arg2;
...
- (long long)_numberOfColumnsInSection:(id)arg1;
- (long long)_numberOfItemsPerPageInSection:(id)arg1;
...
- (id)_reuseIdentifierForCellWithIdentifier:(id)arg1 section:(id)arg2;
...
- (id)_siteCardSectionLayoutForEnvironment:(id)arg1 numberOfItems:(long long)arg2;
...
- (id)_squareRichLinkSectionLayoutForEnvironment:(id)arg1 numberOfItems:(long long)arg2;
