...
- (void).cxx_destruct;
- (id)_blankSnapshotKeyForPrivateBrowsing:(bool)arg1 syncableTabGroupUUID:(id)arg2;
...
- (id)blankSnapshotGroupIdentifierForPrivateBrowsing:(bool)arg1 syncableTabGroupUUID:(id)arg2 forWindowWithUUID:(id)arg3;
- (id)dataForKey:(id)arg1 forWindowWithUUID:(id)arg2;
...
- (void)setBlankSnapshotGroupIdentifier:(id)arg1 forPrivateBrowsing:(bool)arg2 syncableTabGroupUUID:(id)arg3 forWindowWithUUID:(id)arg4;
- (void)setData:(id)arg1 forKey:(id)arg2 forWindowWithUUID:(id)arg3;
...
- (void)setTabViewDismissesOnUnlock:(bool)arg1 forWindowWithUUID:(id)arg2;
- (void)synchronize;
- (bool)tabViewDismissesOnUnlockForWindowWithUUID:(id)arg1;
