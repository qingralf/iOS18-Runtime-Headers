...
@property (nonatomic, retain) TabDocument *usedTabDocument;
@property (nonatomic, readonly, copy) UIWebClip *webClip;

+ (long long)defaultTabOrder;
+ (long long)effectiveTabOrderWithPreferredTabOrder:(long long)arg1;
...
- (void)setUsedTabDocument:(id)arg1;
