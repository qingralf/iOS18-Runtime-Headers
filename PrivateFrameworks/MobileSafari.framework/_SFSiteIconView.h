...
- (void).cxx_destruct;
- (void)_applyBackgroundEffect:(id)arg1;
...
- (id)updateObserver;
- (void)updateSiteIconViewWithLinkMetadata:(id)arg1 requiredImageSize:(struct CGSize { double x1; double x2; })arg2 fallbackIcon:(id)arg3;
