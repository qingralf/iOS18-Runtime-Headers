...
@interface BrowserController : SFBrowserController <ActionPanelDelegate, AddBookmarkActivityDelegate, BookmarksBarViewDelegate, BookmarksNavigationControllerDelegate, BrowserRootViewControllerDelegate, CatalogViewControllerDelegate, CloudTabsViewControllerDelegate, CompletionDetailViewControllerDelegate, ContinuousReadingViewControllerDelegate, DownloadOpenHandler, LibraryItemOpenHandler, LinkPreviewProvider, QLPreviewControllerDelegate, SFAutoFillInternalFeedbackActivityNotificationViewControllerDelegate, SFBrowserControllerProxy, SFBrowserKeyCommandSafariMethods, SFMenuConfiguring, SFOverlayProviderDelegate, SFScreenTimeOverlayViewControllerDelegate, SFSiriLinkActionPerformer, SFSiriReaderPlaybackControllerDelegate, SFToastViewControllerDelegate, SidebarUIProxyDelegate, StartPageDataSource, TabBarManagerObserving, TabControllerDocumentObserving, TabDocumentDelegate, TabOverviewPresentationObserving, UIAdaptivePresentationControllerDelegate, UICloudSharingControllerDelegate, UIFocusEnvironment, UIGestureRecognizerDelegatePrivate, UIScreenshotServiceDelegate, UIScrollViewDelegate, UITextFieldDelegate, UIWindowSceneDelegate, WBProfileWindowDelegate, WBSAppReviewPromptPresenting, WBSDigitalHealthManagerDelegate, WBSUnifiedBarAnalyticsProviding, WBTabGroupManagerObserver, WBTabGroupManagerShareAcceptanceHandler, WBTabGroupSyncAgentSyncObserver, _SFBarManagerDelegate, _SFBrowserContentController, _SFDynamicBarAnimatorDelegate, _SFMailContentProviderDataSource, _SFNavigationBarDelegate, _SFNavigationIntentHandling, _SFSaveToFilesOperationDelegate, _SFSingleBookmarkNavigationControllerDelegate> {
    NSUUID * _UUID;
    ...
    NSUUID * _appIntentRequestIdentifier;
    ...
    bool  _stepperMovedToRootView;
    bool  _suppressWebExtensionEvents;
    bool  _suspendedOrSuspending;
    <TabCollectionViewProviding> * _tabCollectionViewProvider;
    ...
    UITextRange * _textRangeToRestoreAfterCompletionDetailIsDismissed;
...
@property (nonatomic, copy) NSUUID *appIntentRequestIdentifier;
...
@property (nonatomic, readonly) bool canAddToBookmarks;
@property (nonatomic, readonly) bool canAddToQuickNote;
@property (nonatomic, readonly) bool canAddToReadingList;
...
@property (nonatomic, readonly) bool canFindOnPage;
@property (nonatomic) bool canFocusNavigationBarURL;
@property (nonatomic, readonly) bool canMoveToTabGroup;
@property (nonatomic, readonly) bool canPerformPostLaunchActions;
@property (nonatomic, readonly) bool canPrintCurrentTab;
...
@property (nonatomic, readonly) bool canTogglePinningTab;
...
@property (nonatomic, readonly) bool currentTabIsPinned;
...
@property (nonatomic, readonly) _SFPageFormatMenuController *pageFormatMenuController;
...
@property (getter=isShowingPrivateTabs, nonatomic, readonly) bool showingPrivateTabs;
@property (getter=isShowingReader, nonatomic, readonly) bool showingReader;
@property (getter=isShowingStartPage, nonatomic, readonly) bool showingStartPage;
...
@property (nonatomic, readonly) bool supportsSiriReadThis;
...
@property (nonatomic, retain) UITextRange *textRangeToRestoreAfterCompletionDetailIsDismissed;
...
- (void)_debugAutoFillConsoleLoggingEnabledPreferenceDidChange:(id)arg1;
...
- (void)_trialABGroupIdentifierDidChange:(id)arg1;
...
- (void)actionPanelAddTabDocumentToReadingList:(id)arg1 activityDidFinish:(id /* block */)arg2;
- (void)activateWebClipWithID:(id)arg1;
- (id)activeDocument;
...
- (void)autoFillInternalFeedbackActivityNotice:(id)arg1 shouldPresentFeedbackForm:(bool)arg2;
...
- (id)borrowContentViewControllerForTab:(id)arg1;
...
- (bool)canFindOnPage;
- (bool)canFindOnTabWithUUID:(id)arg1;
...
- (void)catalogViewController:(id)arg1 loadURL:(id)arg2 inExternalApplication:(bool)arg3 forImageAttribution:(bool)arg4;
...
- (void)catalogViewControllerSuppressSelectedItemUnfocus:(id)arg1;
- (bool)catalogViewControllerUnifiedFieldCanBecomeFirstResponder:(id)arg1;
...
- (void)continuousReadingViewControllerDidObserveScrollToTopTap:(id)arg1;
...
- (void)createNewTabWithCompletionHandler:(id /* block */)arg1;
- (void)createNewTabWithURL:(id)arg1 isPrivate:(bool)arg2 completionHandler:(id /* block */)arg3;
...
- (void)dismissAutoFillInternalFeedbackToastImmediately:(bool)arg1;
...
- (id)existingUnnamedTabGroupForProfileWithIdentifier:(id)arg1;
...
- (id)loadURLInNewTab:(id)arg1 title:(id)arg2 UUID:(id)arg3 inBackground:(bool)arg4 animated:(bool)arg5 restoringCloudTab:(bool)arg6;
...
- (void)navigationBarMediaStateMuteButtonWasTapped:(id)arg1 forItem:(id)arg2;
...
- (void)openBookmarkWithUUIDString:(id)arg1 inTabWithUUID:(id)arg2;
- (void)openClearHistoryViewControllerFor:(id)arg1;
...
- (long long)orderIndexForTab:(id)arg1;
...
- (void)performTabSearchUsingQuery:(id)arg1;
...
- (void)presentAutoFillInternalFeedbackToastWithDiagnosticsDataWithoutPageContents:(id)arg1;
...
- (void)setAppIntentRequestIdentifier:(id)arg1;
...
- (void)setTextRangeToRestoreAfterCompletionDetailIsDismissed:(id)arg1;
...
- (void)shareCurrentTabURL:(id)arg1;
...
- (void)showPopupOrPerSitePermissionsForWebExtension:(id)arg1;
...
- (void)tabDocument:(id)arg1 didClearLibraryType:(id)arg2;
...
- (void)tabDocument:(id)arg1 didReceiveAssistantContentOptions:(unsigned long long)arg2;
...
- (void)tabDocumentDidOKSummarizationError:(id)arg1;
- (void)tabDocumentDidStartLoading:(id)arg1;
- (void)tabDocumentDidUpdateBackForward:(id)arg1;
- (void)tabDocumentDidUpdateIsScribbling:(id)arg1;
- (void)tabDocumentDidUpdateShowingContinuous:(id)arg1;
- (void)tabDocumentDidUpdateTabCollectionItem:(id)arg1;
...
- (void)takeOwnershipOfStepperContainer:(id)arg1;
- (id)textRangeToRestoreAfterCompletionDetailIsDismissed;
...
- (void)updateFocusForTab:(id)arg1 webViewCanTakeFocus:(bool)arg2;
...
- (id)webExtensionWindowForTab:(id)arg1;
