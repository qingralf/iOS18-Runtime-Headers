...
- (id)browserControllerFocusItemContainer:(id)arg1;
...
- (id)browserControllerParentFocusEnvironment:(id)arg1;
- (id)browserControllerPreferredFocusEnvironments:(id)arg1;
...
- (id)tabSnapshotGeneratorDelegateForBrowserController:(id)arg1;
