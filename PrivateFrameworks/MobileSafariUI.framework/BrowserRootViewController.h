...
@interface BrowserRootViewController : UIViewController <BannerControllerDelegate, BrowserToolbarDelegate, CapsuleNavigationBarViewControllerDelegate, SFCapsuleCollectionViewGestureObserving, SFOrderedContainerViewDelegate, SFScreenTimeOverlayHostingViewController, SFTipsObserver, SidebarContentDimmingViewDelegate, SidebarUIProxy, TabBarDropExpansionViewDelegate, TabDocumentViewGeometryProviding, TabOverviewThemeProviding, TabSnapshotGeneratorDelegate, TabSwitcherViewControllerContaining, UIGestureRecognizerDelegate, UISheetPresentationControllerDelegate, UIViewControllerStatusBarPartStyleProvider> {
    UIApplication * _app;
    ...
    UINavigationController * _defaultBrowserSheet;
    SFDefaultBrowserViewController * _defaultBrowserViewController;
...
@property (nonatomic, readonly) UIViewController *documentAndTopBarsContainerViewController;
...
@property (getter=isInYttriumMode, nonatomic) bool inYttriumMode;
@property (getter=isInYttriumState, nonatomic) bool inYttriumState;
...
@property (getter=isShowingDefaultBrowserSheet, nonatomic, readonly) bool showingDefaultBrowserSheet;
...
@property (nonatomic, readonly) UIView *transitionViewForReducedMotion;
...
@property (nonatomic, readonly) struct CGSize { double x1; double x2; } webViewMinimumUnobscuredLayoutSize;
...
- (void)_enterYttriumStateGestureRecognized:(id)arg1;
- (void)_exitYttriumStateGestureRecognized:(id)arg1;
...
- (void)_tabSwitcherVisibilityDidChange:(bool)arg1;
...
- (struct CGSize { double x1; double x2; })_webViewMinimumLayoutSizeWithBarVisibilitiesIgnored:(bool)arg1;
...
- (id)borrowCapsuleViewForTab:(id)arg1;
- (id)bottomToolbar;
...
- (bool)browserToolbarShouldHitTestAsOpaque:(id)arg1;
...
- (id)contentContainerViewController;
...
- (id)documentAndTopBarsContainerViewController;
...
- (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })maximumObscuredInsetsForRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 inCoordinateSpace:(id)arg2 ignoreBarsMinimized:(bool)arg3;
...
- (struct CGSize { double x1; double x2; })minimumUnobscuredWebViewLayoutSizeForTabDocumentView:(id)arg1;
...
- (id)refreshControl;
- (void)relinquishBorrowedCapsuleView:(id)arg1;
...
- (void)setInYttriumMode:(bool)arg1;
- (void)setInYttriumState:(bool)arg1;
...
- (void)showDefaultBrowserSheetWithDisplayHandler:(id /* block */)arg1;
...
- (struct CGSize { double x1; double x2; })webViewMinimumUnobscuredLayoutSize;
