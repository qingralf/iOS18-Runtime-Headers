...
- (id)initWithTabGroupManager:(id)arg1 browserState:(id)arg2 pinnedTabsManager:(id)arg3 perSitePreferencesVendor:(id)arg4 shouldMergeAllWindowsIfNeeded:(bool)arg5 browserControllerUIDelegateProvider:(id /* block */)arg6;
...
- (void)openNewWindowInFrontmostProfileWithPrivateBrowsingEnabled:(bool)arg1 fromWindow:(id)arg2;
