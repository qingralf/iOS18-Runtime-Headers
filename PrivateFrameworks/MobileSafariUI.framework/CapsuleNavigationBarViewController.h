...
@interface CapsuleNavigationBarViewController : UIViewController <CollectionViewTabIndexProviding, PKScribbleInteractionElementSource, SFCapsuleCollectionViewDataSource, SFCapsuleCollectionViewDelegate, SFCapsuleCollectionViewGestureObserving, TabControllerDocumentObserving, TabDocumentNavigationObserving, TabOverviewPresentationObserving, UIContextMenuInteractionDelegate, UIDragInteractionDelegate, UIDropInteractionDelegate, _UIScrollViewScrollObserver> {
    ...
    <CapsuleNavigationBarLinkablePageView> * _linkedPageView;
...
@property (readonly) UIResponder *customNextResponder;
@property (readonly) <UIFocusEnvironment> *customParentFocusEnvironment;
...
@property (nonatomic, retain) <CapsuleNavigationBarLinkablePageView> *linkedPageView;
...
- (long long)collectionViewIndexOfTab:(id)arg1;
...
- (id)tabAtCollectionViewIndex:(long long)arg1;
...
- (id)tabController;
- (void)tabController:(id)arg1 didCloseTabDocuments:(id)arg2;
