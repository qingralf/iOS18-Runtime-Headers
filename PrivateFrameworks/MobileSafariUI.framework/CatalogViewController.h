...
@interface CatalogViewController : AbstractCatalogViewController <CompletionItemActionHandler, CompletionListDelegate, SFStartPageDelegate, TabSnapshotContentProvider, UIPopoverPresentationControllerDelegate, UITableViewDataSource, UITableViewDelegate, UnifiedFieldDelegate, UniversalSearchFeedbackDelegate, UniversalSearchFirstTimeExperienceViewControllerDelegate> {
    ...
    bool  _hasScheduledCompletionListDismissal;
    bool  _isCachedCompletionList;
    struct CGRect { 
        struct CGPoint { 
            double x; 
            double y; 
    ...
    bool  _keyboardIsBeingDismissed;
...
@property (nonatomic) bool hasScheduledCompletionListDismissal;
...
- (id)_cellHeightCacheKeyForCompletionItem:(id)arg1 indexPath:(id)arg2;
...
- (void)_executeActionForParsecResultAtIndexPath:(id)arg1 tableView:(id)arg2;
- (void)_executeActionForParsecResultTableViewCell:(id)arg1 completionItem:(id)arg2;
...
- (void)_preselectCompletionItemIfNecessaryForQueryString:(id)arg1;
...
- (id)currentMetadataForUnifiedField:(id)arg1;
- (void)dealloc;
- (id)delegate;
...
- (void)horizontalSizeClassDidChange:(id)arg1 previousTraitCollection:(id)arg2;
...
- (void)resume;
- (void)resumeEditingIfNeeded:(bool)arg1;
...
- (void)setHasScheduledCompletionListDismissal:(bool)arg1;
...
- (bool)shouldPutMetadataOnPasteboardForUnifiedField:(id)arg1;
...
- (bool)unifiedFieldCanBecomeFirstResponder:(id)arg1;
- (void)unifiedFieldDidUpdateUserTypedText:(id)arg1 forQueryString:(id)arg2;
...
- (void)willGoToURLFromPegasusSearchResult:(id)arg1;
