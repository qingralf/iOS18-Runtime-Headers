...
@interface SearchStateItem : NSObject {
    ...
    bool  _didOriginateFromMultipartWebAnswer;
...
@property (nonatomic) bool didOriginateFromMultipartWebAnswer;
...
- (void)setDidOriginateFromMultipartWebAnswer:(bool)arg1;
