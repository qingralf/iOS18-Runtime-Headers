...
@interface TabDocument : NSObject <CollectionViewTab, LoadableResource, LoadingControllerDelegate, PKAddPassesViewControllerDelegate, QuickWebsiteSearchEventListener, ReadingListMetadataProvider, SFAppBannerMetaTagContentObserver, SFAppSuggestionBannerDelegate, SFDialogControllerDelegate, SFDialogPresenting, SFDialogViewControllerPresenting, SFFormAutoFillControllerDelegate, SFHighlightAttributionPresenter, SFMediaRecordingDocument, SFQuickLookDocumentSource, SFScribbleControllerDelegate, SFTabEntityInfoProviding, WBReusableTab, WBSBrowsingAssistantControllerDelegate, WBSFluidProgressControllerWindowDelegate, WBSFluidProgressStateSource, WBSPageContextDataFetcherDelegate, WBSQueryParameterFilteringDataQueueDelegate, WBSSiriIntelligenceDonorTabDataProviding, WBSTranslationConsentAlertHelperDelegate, WBSTranslationContextDelegate, WBTabGroupManagerObserver, WKNavigationDelegatePrivate, WKUIDelegatePrivate, _SFAutoFillContextProviding, _SFBrowserDocument, _SFDownloadDelegate, _SFLinkPreviewHandler, _SFNavigationIntentHandling, _SFPageLoadErrorControllerDelegate, _SFPrintControllerDelegate, _SFReaderControllerDelegate, _SFWebViewDelegate, _WKAppHighlightDelegate, _WKDiagnosticLoggingDelegate, _WKFullscreenDelegate, _WKIconLoadingDelegate, _WKInputDelegate> {
    ...
    bool  _allowsInspectionWhenUnlocked;
    ...
    bool  _canAttemptUpgradingRequestURLToHTTPS;
    ...
    struct { 
        ...
        bool shouldDisallowRedirectToExternalAppsForCurrentLoad; 
    }  _flags;
    ...
    bool  _needsUpdateGlobalAudioState;
    bool  _nextLoadComesFromSearchPage;
    NSURL * _originalURL;
    ...
    SFScribbleController * _sfScribbleController;
    ...
    bool  _shouldKeepIgnoredSiriSuggestedSitesOnLoad;
    ...
    bool  _wasPageLoadUserInitiated;
    UIWebClip * _webClip;
...
@property (nonatomic, readonly, copy) NSSet *allBrowserHistories; /* unknown property attribute: ? */
@property (nonatomic, readonly, copy) NSSet *allBrowserProfileIdentifiers; /* unknown property attribute: ? */
@property (nonatomic, readonly) bool allowsBrowsingAssistant;
...
@property (nonatomic, readonly) WBSBrowsingAssistantController *assistantController;
...
@property (nonatomic, readonly) _SFFormAutoFillController *autoFillController;
...
@property (nonatomic, readonly) bool canHibernate;
...
@property (nonatomic, readonly) bool hasEnteredScribbleMode;
...
@property (nonatomic, readonly) bool inWebClipScope;
...
@property (getter=isSearchPage, nonatomic, readonly) bool isSearchPage;
@property (nonatomic, readonly) bool isSecure;
@property (nonatomic, readonly) bool isShowingSearchQueryInNavigationBar;
@property (nonatomic, readonly) bool isShowingSystemStartPage;
...
@property (nonatomic, readonly) WBSUserDefinedContentBlockerManager *normalBrowsingUserDefinedContentBlockerManager;
@property (nonatomic, readonly) NSUUID *ownerUUID;
...
@property (getter=isPlayingAudio, nonatomic, readonly) bool playingAudio;
...
@property (nonatomic, readonly) WBSPrivateBrowsingUserDefinedContentBlockerManager *privateBrowsingUserDefinedContentBlockerManager;
...
@property (nonatomic, readonly) SFScribbleController *sfScribbleController;
@property (nonatomic, readonly) SFScribbleController *sfScribbleControllerIfLoaded;
...
@property (nonatomic) bool shouldKeepIgnoredSiriSuggestedSitesOnLoad;
...
@property (nonatomic, readonly) NSUUID *tabIDForAutoFill; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) SFBrowserDocumentTrackerInfo *trackerInfo; /* unknown property attribute: ? */
...
- (void)_webCryptoMasterKeyForWebView:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)_webView:(id)arg1 didAdjustVisibilityWithSelectors:(id)arg2;
...
- (void)_webView:(id)arg1 didGeneratePageLoadTiming:(id)arg2;
...
- (void)_webView:(id)arg1 requestWebAuthenticationConditionalMediationRegistrationForUser:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (void)browsingAssistantController:(id)arg1 didUpdateContentOptionsForURL:(id)arg2;
- (void)browsingAssistantControllerDidReset:(id)arg1;
- (void)browsingAssistantControllerDidUpdateUserConsentState:(id)arg1;
- (bool)browsingAssistantControllerShouldCheckRemoteContent:(id)arg1;
...
- (id)currentHostForScribbleController:(id)arg1;
...
- (void)didFindSummarizationRestrictionsForReaderController:(id)arg1;
...
- (void)dismissAutoFillInternalFeedbackActivityForFormAutoFillController:(id)arg1 immediately:(bool)arg2;
...
- (id)initWithHibernatedTab:(id)arg1;
...
- (void)loadTestURL:(id)arg1 withInjectedBundle:(bool)arg2 withCallback:(id /* block */)arg3;
- (void)loadTestURL:(id)arg1 withInjectedBundle:(bool)arg2 withCallback:(id /* block */)arg3 pagesNeedingMemoryWarningSent:(id)arg4;
...
- (id)overlayContainerViewForScribbleController:(id)arg1;
- (id)overrideUndoManagerForSFWebView:(id)arg1;
- (id)ownerUUID;
- (void)pageContextDataFetcher:(id)arg1 forURL:(id)arg2 didFetchMetadata:(id)arg3;
- (void)pageContextDataFetcherDidFinishFetching:(id)arg1 forURL:(id)arg2 withError:(id)arg3;
...
- (void)pageLoadErrorControllerReloadUsingHTTPSOnlyBypass:(id)arg1;
...
- (void)presentAutoFillInternalFeedbackToastForFormAutoFillController:(id)arg1 diagnosticsDataWithoutPageContents:(id)arg2;
...
- (id)privateBrowsingUserDefinedContentBlockerManager;
- (id)profile;
- (id)progressState;
...
- (void)readerController:(id)arg1 didEncounterErrorForSummarization:(id)arg2;
- (void)readerController:(id)arg1 didExtractArticleText:(id)arg2 withMetadata:(id)arg3;
- (void)readerController:(id)arg1 didFinishOnDemandSummarization:(id)arg2;
...
- (void)setNextLoadComesFromSearchPage:(bool)arg1;
...
- (void)setShouldKeepIgnoredSiriSuggestedSitesOnLoad:(bool)arg1;
...
- (id)sfScribbleController;
- (void)sfScribbleController:(id)arg1 presentAlert:(id)arg2;
- (void)sfScribbleControllerDidEndScribbling:(id)arg1;
- (void)sfScribbleControllerDidStartScribbling:(id)arg1;
- (void)sfScribbleControllerDidUpdateHiddenElementCount:(id)arg1;
- (id)sfScribbleControllerIfLoaded;
...
- (void)sfWebViewDidDismissFindOnPage:(id)arg1;
...
- (bool)shouldGrantPermissionsOnUserGestureForWebExtensionContext:(id)arg1;
