...
@interface TabDragDropInteractionController : NSObject <UIContextMenuInteractionDelegate, UIDragInteractionDelegate, UIDragInteractionDelegate_Private, UIDropInteractionDelegate, UIDropInteractionDelegate_Private> {
    <TabDragDropDataSource> * _dataSource;
...
@property (nonatomic, readonly) <TabDragDropDataSource> *dataSource;
...
- (id)_insertPlaceholderIfNeededForSession:(id)arg1 interaction:(id)arg2;
- (id)_newDragItemsAtPoint:(struct CGPoint { double x1; double x2; })arg1 excludingTabUUIDs:(id)arg2 interaction:(id)arg3 session:(id)arg4;
...
- (void)_unhideTabsForLocalDragSession:(id)arg1;
- (void)_updatePreviewsForInteraction:(id)arg1 session:(id)arg2 pinned:(bool)arg3;
