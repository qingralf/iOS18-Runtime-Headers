...
@interface MSDDemoManifestCheck : NSObject {
    ...
    NSMutableSet * _blocklistedItems;
    NSString * _checkType;
...
- (void)removeBlocklistedItemFromSection:(id)arg1 withName:(id)arg2;
- (bool)runAppLayoutSecurityCheck:(id)arg1;
- (bool)runFileSecurityChecksForSection:(id)arg1 dataType:(id)arg2;
- (bool)runFileSecurityChecksForSection:(id)arg1 dataType:(id)arg2 options:(id)arg3;
- (bool)runSecurityCheck:(id)arg1;
- (bool)runSecurityChecksForSection:(id)arg1 dataType:(id)arg2 componentName:(id)arg3 options:(id)arg4;
- (bool)runSettingsSecurityCheckForSection:(id)arg1 component:(id)arg2;
- (bool)secureManifestCheckForSegmentedManifest:(id)arg1;
- (bool)secureManifestCheckForSegmentedManifest:(id)arg1 options:(id)arg2;
- (id)segmentedManifestWithRigorousFlag;
- (void)setAllowedISTSignedComponents:(id)arg1;
- (void)setAllowedSymLinks:(id)arg1;
- (void)setBlocklistedItems:(id)arg1;
...
- (id)verifyFactoryManifestSignature:(id)arg1 forDataSectionKeys:(id)arg2;
- (id)verifyManifestSignature:(id)arg1 forDataSectionKeys:(id)arg2 withOptions:(id)arg3;
