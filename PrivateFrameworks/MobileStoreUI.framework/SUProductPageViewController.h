...
@interface SUProductPageViewController : SUViewController <SUClientInterfaceDelegatePrivate, SUPurchaseManagerDelegate, SUUIBannerViewDelegate, SUUIIPadProductPageDelegate, SUUIIPhoneProductPageDelegate, SUUIItemStateCenterObserver> {
    ...
    <SUProductPageViewControllerDelegatePrivate> * _delegate;
...
@property (nonatomic) <SUProductPageViewControllerDelegate> *delegate;
