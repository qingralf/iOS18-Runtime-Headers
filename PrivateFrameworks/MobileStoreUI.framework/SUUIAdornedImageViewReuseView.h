...
@interface SUUIAdornedImageViewReuseView : SUUIViewReuseView <SUUIMediaPlayerObserver, SUUIViewElementView> {
...
@property (nonatomic, readonly) SUUIPlayButton *playButton;
