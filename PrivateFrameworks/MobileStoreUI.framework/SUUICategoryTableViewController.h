...
@interface SUUICategoryTableViewController : UITableViewController <SUUICategoryArtworkLoaderObserver, SUUICategoryTableViewControllerDelegate> {
    ...
    SUUICategory * _category;
    bool  _childrenHaveArtwork;
    SUUIClientContext * _clientContext;
    NSURL * _defaultURL;
    <SUUICategoryTableViewControllerDelegate> * _delegate;
    bool  _isRoot;
...
@property (nonatomic, retain) SUUICategoryArtworkLoader *artworkLoader;
@property (nonatomic, retain) SUUICategory *category;
@property (nonatomic, retain) SUUIClientContext *clientContext;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (nonatomic, retain) NSURL *defaultURL;
@property (nonatomic) <SUUICategoryTableViewControllerDelegate> *delegate;
