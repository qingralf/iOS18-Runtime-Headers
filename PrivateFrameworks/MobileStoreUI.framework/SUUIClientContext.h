...
@property (getter=_applicationController, setter=_setApplicationController:, nonatomic) SUUIApplicationController *_applicationController;
@property (getter=_scriptAppContext, setter=_setScriptAppContext:, nonatomic, retain) IKAppContext *_scriptAppContext;
@property (getter=applicationController, nonatomic, readonly) SUUIApplicationController *applicationController;
...
@property (nonatomic, copy) SUUIURL *purchaseReferrerURL;
...
@property (nonatomic, readonly) SUUITrendingSearchProvider *trendingSearchProvider;
...
- (void)loadValueForConfigurationKeys:(id)arg1 completionBlock:(id /* block */)arg2;
