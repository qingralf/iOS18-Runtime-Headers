...
@interface SUUICommentDocumentViewController : SUUIViewController <SUUIArtworkRequestDelegate, SUUICommentDelegate, SUUIDocumentViewController, SUUILayoutCacheDelegate> {
