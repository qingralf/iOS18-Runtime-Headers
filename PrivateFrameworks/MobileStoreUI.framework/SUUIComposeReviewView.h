...
@interface SUUIComposeReviewView : UIView <SUUIComposeReviewHeaderDelegate, UITextContentViewDelegate, UITextViewDelegate> {
    long long  _currentBodyLength;
    <SUUIComposeReviewViewDelegate> * _delegate;
...
@property (nonatomic) <SUUIComposeReviewViewDelegate> *delegate;
...
- (void).cxx_destruct;
- (id)_body;
- (bool)_composeReviewTextViewShouldChangeTextInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 replacementText:(id)arg2;
