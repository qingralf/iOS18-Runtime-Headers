...
@interface SUUIComposeReviewViewController : SUNavigationController <SUUIComposeReviewFormDelegate, SUUIComposeReviewNicknameDelegate, UITextFieldDelegate> {
    ...
    SUUIWriteAReviewTemplateViewElement * _templateViewElement;
}

@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (nonatomic) <SUUIComposeReviewDelegate> *delegate;
...
@property (nonatomic, retain) SUUIWriteAReviewTemplateViewElement *templateViewElement;
