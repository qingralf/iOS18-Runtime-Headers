...
@interface SUUIContentUnavailableDocumentViewController : SUUIViewController <SUUIArtworkRequestDelegate, SUUIDocumentViewController, SUUILayoutCacheDelegate> {
