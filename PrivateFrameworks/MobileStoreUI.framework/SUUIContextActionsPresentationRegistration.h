...
@interface SUUIContextActionsPresentationRegistration : NSObject <UIGestureRecognizerDelegate, UIPreviewInteractionDelegate> {
    ...
    SUUIContextActionsViewController * _orbContextActionsViewController;
...
@property (nonatomic, retain) SUUIContextActionsViewController *orbContextActionsViewController;
