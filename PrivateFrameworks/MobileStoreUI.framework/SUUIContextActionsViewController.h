...
@interface SUUIContextActionsViewController : UIViewController <UIAdaptivePresentationControllerDelegate, UIInterfaceActionHandlerInvocationDelegate, UIPopoverPresentationControllerDelegate, UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate> {
    bool  _appliedSystemRecognizer;
    UIVisualEffectView * _backgroundView;
    SUUIContextActionsConfiguration * _configuration;
    ...
    SUUIContextActionsPresentationController * _transitionPresentationController;
}
...
@property (nonatomic, retain) SUUIContextActionsConfiguration *configuration;
...
@property (nonatomic, retain) SUUIContextActionsPresentationController *transitionPresentationController;
