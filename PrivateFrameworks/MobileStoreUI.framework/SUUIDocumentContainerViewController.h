...
@interface SUUIDocumentContainerViewController : SUUIViewController <IKAppDocumentDelegate, SUUIMediaQueryDelegate, SUUIModalSourceViewProvider, SUUINavigationBarControllerDelegate, SUUINavigationBarDisplayConfiguring, SUUINavigationPaletteProvider, SUUIResourceLoaderDelegate, SUUIScrollingTabAppearanceStatusObserver, SUUIScrollingTabNestedPagedScrolling, SUUIToolbarControllerDelegate, SUUIViewControllerTesting, UIViewControllerTransitioningDelegate> {
    ...
    SUUIMetricsPageRenderEvent * _pageRenderEvent;
...
@property (nonatomic, retain) SUUIMetricsDOMChangeQueue *domChangeTimingQueue;
@property (readonly) unsigned long long hash;
@property (nonatomic, readonly) UIView *navigationPaletteView;
@property (nonatomic, retain) SUUIMetricsPageRenderEvent *pageRenderEvent;
...
- (void).cxx_destruct;
- (void)_SUUI_applicationDidEnterBackground:(id)arg1;
- (void)_SUUI_applicationWillEnterForeground:(id)arg1;
