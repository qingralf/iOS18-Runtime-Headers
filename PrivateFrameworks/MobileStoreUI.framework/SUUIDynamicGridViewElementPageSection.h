...
@interface SUUIDynamicGridViewElementPageSection : SUUIStorePageSection <SUUIArtworkRequestDelegate, SUUICollectionDOMFeatureTargetting, SUUIGridViewElementPageSectionConfigurationDataSource> {
