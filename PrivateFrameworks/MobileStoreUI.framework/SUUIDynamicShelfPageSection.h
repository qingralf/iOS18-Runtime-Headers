...
@interface SUUIDynamicShelfPageSection : SUUIStorePageSection <SUUIArtworkRequestDelegate, SUUIItemStateCenterObserver, SUUIObservableScrollViewDelegate, SUUIShelfPageSection, SUUIShelfPageSectionConfigurationDataSource, UICollectionViewDataSource, UICollectionViewDelegate> {
    SUUIViewElementLayoutContext * _cellLayoutContext;
    SUUIShelfPageSectionConfiguration * _configuration;
    ...
    <SUUIScrollViewDelegateObserver> * _scrollViewDelegateObserver;
}

@property (nonatomic, readonly) SUUIShelfPageSectionConfiguration *configuration;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (readonly, copy) NSString *description;
@property (readonly) unsigned long long hash;
@property (nonatomic, readonly) SUUIShelfPageComponent *pageComponent;
@property (nonatomic) <SUUIScrollViewDelegateObserver> *scrollViewDelegateObserver;
