...
@interface SUUIEditProfileSettingDescription : SUUISettingDescription <SUUIProfileImagePickerDelegate, SUUISuggestedHandlesSettingsHeaderFooterDescriptionDelegate> {
