...
@interface SUUIEditorialCardCollectionViewCell : SUUIViewReuseCollectionViewCell <SUUIPerspectiveView, SUUIViewElementView> {
    NSMutableArray * _allLockupViews;
    struct CGSize { 
        double width; 
        double height; 
    }  _primaryLockupSize;
    SUUIVerticalLockupView * _primaryLockupView;
}
