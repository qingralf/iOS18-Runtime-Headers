...
@property (nonatomic, readonly) SUUILockupItemCellLayout *lockupCellLayout;
...
+ (double)editorialWidthForCellWidth:(double)arg1 lockupStyle:(struct SUUILockupStyle { long long x1; long long x2; unsigned long long x3; })arg2;
