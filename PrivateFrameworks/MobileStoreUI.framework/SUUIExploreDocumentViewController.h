...
@interface SUUIExploreDocumentViewController : SUUIViewController <CLLocationManagerDelegate, SUUIDocumentViewController, SUUINavigationBarDisplayConfiguring, SUUIStackedBarDelegate, UINavigationControllerDelegate, UISplitViewControllerDelegate> {
