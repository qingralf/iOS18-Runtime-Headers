...
@interface SUUIGalleryViewController : UIViewController <SUUIArtworkRequestDelegate, UIPageViewControllerDataSource, UIPageViewControllerDelegate, UIScrollViewDelegate> {
    ...
    <SUUIEmbeddedMediaViewDelegate> * _embeddedMediaDelegate;
    SUUIGalleryPageComponent * _galleryComponent;
...
@property (nonatomic) <SUUIEmbeddedMediaViewDelegate> *embeddedMediaDelegate;
@property (nonatomic, readonly) SUUIGalleryPageComponent *galleryComponent;
@property (readonly) unsigned long long hash;
@property (nonatomic, readonly) SUUIMediaComponent *selectedMediaComponent;
