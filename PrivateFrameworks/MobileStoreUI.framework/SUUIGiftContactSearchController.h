...
@interface SUUIGiftContactSearchController : NSObject <CNAutocompleteResultsTableViewControllerDelegate, CNAutocompleteSearchConsumer> {
    NSMutableArray * _autocompleteSearchResults;
    <SUUIGiftContactSearchDelegate> * _delegate;
    NSArray * _results;
...
@property (nonatomic) <SUUIGiftContactSearchDelegate> *delegate;
