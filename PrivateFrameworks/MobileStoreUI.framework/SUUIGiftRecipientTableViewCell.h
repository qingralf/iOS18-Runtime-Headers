...
@interface SUUIGiftRecipientTableViewCell : UITableViewCell <CNComposeRecipientTextViewDelegate, CNContactPickerDelegate, SUUIGiftContactSearchDelegate> {
    ...
    SUUIGiftContactSearchController * _searchController;
