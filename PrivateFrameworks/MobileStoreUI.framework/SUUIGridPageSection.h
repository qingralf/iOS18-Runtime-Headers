...
@interface SUUIGridPageSection : SUUIStorePageSection <SUUIArtworkRequestDelegate, SUUIEmbeddedMediaViewDelegate, SUUIItemStateCenterObserver, SUUIMissingItemDelegate, SUUIProductPageOverlayDelegate> {
    ...
    SUUIVideoImageDataConsumer * _videoImageDataConsumer;
