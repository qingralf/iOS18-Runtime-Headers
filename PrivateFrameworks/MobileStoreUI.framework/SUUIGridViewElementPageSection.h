...
@interface SUUIGridViewElementPageSection : SUUIStorePageSection <SUUIArtworkRequestDelegate, SUUICollectionDOMFeatureTargetting, SUUIGridViewElementPageSectionConfigurationDataSource> {
...
@property (nonatomic, readonly) SUUIGridComponent *pageComponent;
