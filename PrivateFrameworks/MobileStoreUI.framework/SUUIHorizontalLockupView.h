...
@interface SUUIHorizontalLockupView : SUUIViewReuseView <SUUIItemOfferButtonDelegate, SUUIMediaPlayerObserver, SUUIOfferViewDelegate, SUUIPerspectiveView, SUUIPreviewContainerView, SUUIToggleButtonDelegate, SUUIViewElementView, UIGestureRecognizerDelegate> {
