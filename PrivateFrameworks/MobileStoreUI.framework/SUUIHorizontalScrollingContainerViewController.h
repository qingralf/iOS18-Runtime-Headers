...
@interface SUUIHorizontalScrollingContainerViewController : SUUIViewController <SUUIProxyScrollViewDelegate, SUUIScrollViewDelegateObserver, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout> {
    UICollectionView * _contentCollectionView;
    struct CGSize { 
        double width; 
        double height; 
    }  _contentCollectionViewItemSize;
    <SUUIHorizontalScrollingContainerViewControllerDelegate> * _delegate;
...
@property (nonatomic) <SUUIHorizontalScrollingContainerViewControllerDelegate> *delegate;
