...
@interface SUUIIndexBarControl : UIControl {
    ...
    <SUUIIndexBarControlDataSource> * _dataSource;
    struct { 
    ...
    <SUUIIndexBarControlDelegate> * _delegate;
...
@property (nonatomic) <SUUIIndexBarControlDataSource> *dataSource;
@property (nonatomic, copy) NSDictionary *defaultTextAttributes;
@property (nonatomic) <SUUIIndexBarControlDelegate> *delegate;
