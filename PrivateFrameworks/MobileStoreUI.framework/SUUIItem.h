...
@interface SUUIItem : NSObject <SSMetricsEventFieldProvider, SUUICacheCoding> {
    struct _NSRange { 
        unsigned long long location; 
        unsigned long long length; 
    }  _ageBandRange;
    NSString * _artistName;
    <SUUIArtworkProviding> * _artworksProvider;
    NSString * _bundleID;
    ...
    bool  _newsstandApp;
    <SUUIArtworkProviding> * _newsstandArtworks;
...
@property (nonatomic, readonly) <SUUIArtworkProviding> *artworksProvider;
...
@property (nonatomic, readonly) <SUUIArtworkProviding> *newsstandArtworks;
...
@property (nonatomic, readonly) SUUIItemOffer *primaryItemOffer;
