...
@interface SUUIItemListTableViewController : UITableViewController <SUUIItemCollectionDelegate> {
    ...
    <SUUIItemListTableDelegate> * _delegate;
...
@property (nonatomic) <SUUIItemListTableDelegate> *delegate;
...
@property (nonatomic, retain) SUUIItemList *itemList;
