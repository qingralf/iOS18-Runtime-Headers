...
@interface SUUIItemOfferButton : UIControl <SUUIViewElementOfferButton> {
    ...
    SUUIBuyButtonDescriptor * _buttonDescriptor;
    NSString * _buyType;
    ...
    <SUUIItemOfferButtonDelegate> * _delegate;
    bool  _disabledButSelectable;
    bool  _downloadRestores;
    SUUIButtonViewElement * _element;
...
@property (nonatomic, retain) SUUIBuyButtonDescriptor *buttonDescriptor;
...
@property (nonatomic) <SUUIItemOfferButtonDelegate> *delegate;
@property (readonly, copy) NSString *description;
@property (getter=isDisabledButSelectable, nonatomic) bool disabledButSelectable;
@property (nonatomic, retain) SUUIButtonViewElement *element;
@property (nonatomic) long long fillStyle;
@property (readonly) unsigned long long hash;
@property (nonatomic, retain) UIImage *image;
@property (nonatomic) <SUUIItemOfferButtonDelegate> *itemOfferDelegate;
