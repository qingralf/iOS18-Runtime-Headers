...
@interface SUUIItemStateCenter : NSObject <ASDJobManagerObserver, BLDownloadQueueObserving, SSDownloadManagerObserver> {
    ...
    SUUIStoreItemRelationshipCounsellor * _relationshipCouncellor;
