...
+ (double)heightForLockupStyle:(struct SUUILockupStyle { long long x1; long long x2; unsigned long long x3; })arg1 item:(id)arg2 editorial:(id)arg3 clientContext:(id)arg4;
