...
@interface SUUIMenuBarViewElementConfiguration : NSObject <IKAppMenuBarDocumentDelegate> {
    <SUUIMenuBarViewElementConfigurationDelegate> * _delegate;
...
@property (nonatomic) <SUUIMenuBarViewElementConfigurationDelegate> *delegate;
...
@property (getter=_reloadDelegate, setter=_setReloadDelegate:, nonatomic) <_SUUIMenuBarViewElementConfigurationReloadDelegate> *reloadDelegate;
@property (nonatomic, readonly) bool scrollEnabled;
@property (nonatomic, readonly) SUUIMenuItemViewElement *selectedMenuItemViewElement;
