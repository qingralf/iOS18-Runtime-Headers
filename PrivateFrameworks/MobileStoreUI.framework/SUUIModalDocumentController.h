...
@interface SUUIModalDocumentController : NSObject <AAUIFamilySetupDelegate, SUUIComposeReviewDelegate, SUUIGiftViewControllerDelegate, SUUIModalDocumentController, SUUIOverlayContainerDelegate, UIPopoverControllerDelegate, UIPopoverPresentationControllerDelegate> {
    ...
    <SUUIModalDocumentDataSource> * _dataSource;
    <SUUIModalDocumentDelegate> * _delegate;
    SUUIStoreDialogController * _dialogController;
    NSMutableArray * _giftViewControllers;
    <SUUIModalSourceViewProvider> * _modalSourceViewProvider;
...
@property (nonatomic, readonly) SUUIOverlayContainerViewController *_overlayViewController;
@property (nonatomic, retain) SUUIClientContext *clientContext;
@property (nonatomic) <SUUIModalDocumentDataSource> *dataSource;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (nonatomic) <SUUIModalDocumentDelegate> *delegate;
@property (readonly, copy) NSString *description;
@property (nonatomic, readonly) NSArray *documents;
@property (readonly) unsigned long long hash;
@property (nonatomic) <SUUIModalSourceViewProvider> *modalSourceViewProvider;
