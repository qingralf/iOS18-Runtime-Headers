...
@interface SUUINavigationBarController : NSObject <SUUILayoutCacheDelegate> {
    ...
    <SUUINavigationBarControllerDelegate> * _delegate;
...
@property (nonatomic) <SUUINavigationBarControllerDelegate> *delegate;
@property (readonly, copy) NSString *description;
@property (nonatomic, readonly) NSArray *existingSearchBarControllers;
@property (readonly) unsigned long long hash;
@property (nonatomic, retain) SUUINavigationBarViewElement *navigationBarViewElement;
