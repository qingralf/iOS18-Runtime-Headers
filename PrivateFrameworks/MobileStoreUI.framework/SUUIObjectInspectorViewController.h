...
@interface SUUIObjectInspectorViewController : UIViewController <SUUIObjectInspector, UITableViewDataSource, UITableViewDelegate, UIViewControllerTransitioningDelegate> {
    UIVisualEffectView * _backgroundView;
    UIView * _contentView;
    _SUUIInspectablePropertySection * _currentSection;
    <SUUIInspectableObject> * _inspectableObject;
...
@property (nonatomic, retain) _SUUIInspectablePropertySection *currentSection;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (readonly, copy) NSString *description;
@property (nonatomic, copy) NSString *friendlyName;
@property (readonly) unsigned long long hash;
@property (nonatomic, copy) NSString *information;
@property (nonatomic, retain) <SUUIInspectableObject> *inspectableObject;
