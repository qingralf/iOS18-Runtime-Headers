...
@interface SUUIOnboardingAffiliationCirclesViewController : UIViewController <SUUIPhysicalCirclesDataSource, SUUIPhysicalCirclesDelegate> {
    ...
    <SUUIOnboardingAffiliationCirclesDelegate> * _delegate;
...
@property (nonatomic) <SUUIOnboardingAffiliationCirclesDelegate> *delegate;
@property (readonly, copy) NSString *description;
@property (nonatomic, retain) UIView *footerView;
@property (readonly) unsigned long long hash;
@property (nonatomic, readonly) SUUIOnboardingInstructionsView *instructionsView;
