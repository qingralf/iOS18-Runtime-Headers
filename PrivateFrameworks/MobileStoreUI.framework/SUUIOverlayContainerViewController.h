...
@interface SUUIOverlayContainerViewController : UIViewController <UIGestureRecognizerDelegate> {
    UIControl * _backstopView;
    <SUUIOverlayContainerDelegate> * _delegate;
...
@property (nonatomic) <SUUIOverlayContainerDelegate> *delegate;
