...
@interface SUUIProductPage : NSObject <NSCopying> {
    ...
    NSURL * _pageURL;
    SUUIProductPageProductInfo * _productInformation;
...
@property (nonatomic, retain) SUUIProductPageItem *item;
...
@property (nonatomic, retain) SUUIProductPageProductInfo *productInformation;
@property (nonatomic, copy) NSArray *relatedContentSwooshes;
@property (nonatomic, retain) SUUIReviewConfiguration *reviewConfiguration;
