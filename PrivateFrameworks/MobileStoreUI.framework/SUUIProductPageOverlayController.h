...
@interface SUUIProductPageOverlayController : NSObject <SKStoreProductViewControllerDelegate, SUUIIPadProductPageDelegate> {
    SUUIClientContext * _clientContext;
    <SUUIProductPageOverlayDelegate> * _delegate;
...
@property (nonatomic) <SUUIProductPageOverlayDelegate> *delegate;
