...
@interface SUUIProductPageReviewsViewController : UIViewController <SKComposeReviewDelegate, SUUILayoutCacheDelegate, SUUIProductPageChildViewController, SUUIReviewsFacebookViewControllerDelegate, UITableViewDataSource, UITableViewDelegate> {
    bool  _askPermission;
