...
@interface SUUIRedeemIdManager : NSObject <SUUIRedeemIdTableViewCellDelegate, UITableViewDataSource, UITableViewDelegate> {
    NSIndexPath * _activeIndexPath;
    SUUIClientContext * _clientContext;
    <SUUIRedeemIdManagerDelegate> * _delegate;
...
@property (nonatomic) <SUUIRedeemIdManagerDelegate> *delegate;
@property (readonly, copy) NSString *description;
@property (readonly) unsigned long long hash;
@property (nonatomic, retain) SUUIPinnedFooterView *pinnedFooterView;
