...
@property (nonatomic, retain) SUUITextLayout *extendedMessageTextLayout;
@property (nonatomic, retain) SUUITextBoxView *extendedMessageView;
@property (readonly) unsigned long long hash;
@property (nonatomic, retain) UIImageView *headerImageView;
@property (nonatomic, retain) UIImage *itemImage;
@property (nonatomic, retain) SUUIItemStateCenter *itemStateCenter;
@property (nonatomic, retain) SUUIGiftItemView *itemView;
@property (nonatomic, retain) SUUIRedeemResultMessageView *messageView;
@property (nonatomic, retain) NSOperationQueue *operationQueue;
@property (nonatomic, retain) SUUIRedeemITunesPassLockup *passbookLockup;
