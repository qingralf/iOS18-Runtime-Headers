...
@interface SUUIResponseView : SUUIViewReuseView <SUUIViewElementView> {
    ...
    SUUIAttributedStringView * _subtitleView;
}
...
@property (nonatomic, retain) SUUIAttributedStringView *subtitleView;
