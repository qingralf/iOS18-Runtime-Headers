...
@interface SUUIReviewListTitleView : SUUIViewReuseView <SUUIViewElementView> {
    struct UIEdgeInsets { 
        double top; 
        double left; 
        double bottom; 
    ...
    SUUIAttributedStringView * _dateView;
    SUUIAttributedStringView * _titleView;
}

@property (nonatomic) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } contentInset;
@property (nonatomic, retain) SUUIAttributedStringView *dateView;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (readonly, copy) NSString *description;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (nonatomic, retain) SUUIAttributedStringView *titleView;
