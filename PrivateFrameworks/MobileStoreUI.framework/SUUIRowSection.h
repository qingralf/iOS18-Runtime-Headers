...
@property (nonatomic, readonly) SUUIRowComponent *pageComponent;
...
- (struct SUUILockupStyle { long long x1; long long x2; unsigned long long x3; })_lockupStyleForComponent:(id)arg1 columnIndex:(long long)arg2;
