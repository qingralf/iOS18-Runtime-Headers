...
@interface SUUIScreenshotsViewController : UIViewController <SUUISlideshowViewControllerDataSource, SUUISlideshowViewControllerDelegate, UICollectionViewDataSource, UICollectionViewDelegate, UIScrollViewDelegate> {
    SUUIClientContext * _clientContext;
    UICollectionView * _collectionView;
    SUUIScreenshotDataConsumer * _dataConsumer;
    <SUUIScreenshotsDelegate> * _delegate;
...
@property (nonatomic) <SUUIScreenshotsDelegate> *delegate;
