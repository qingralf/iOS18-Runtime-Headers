...
@property (nonatomic) <SUUIScrollingSegmentedControllerDelegate> *delegate;
...
@property (nonatomic, readonly) SUUIScrollingSegmentedControllerNavigationBarTitleView *navigationBarTitleView;
...
@property (getter=_titlesSegmentedControl, nonatomic, readonly) SUUIInteractiveSegmentedControl *titlesSegmentedControl;
