...
@interface SUUIScrollingTabBarController : SUUIViewController <SUUIDynamicBarAnimatorDelegate, SUUIProxyScrollViewDelegate, SUUIScrollViewDelegateObserver, SUUIScrollingTabBarContentCollectionViewDelegate, SUUIScrollingTabBarControllerItemContextDelegate, SUUIScrollingTabBarPaletteDelegate, SUUITabBarController, UICollectionViewDataSource, UICollectionViewDelegate> {
    ...
    SUUIScrollingTabBarContentCollectionView * _contentCollectionView;
    struct CGSize { 
        double width; 
        double height; 
    }  _contentCollectionViewItemSize;
    <SUUITabBarControllerDelegate> * _delegate;
    SUUIDynamicBarAnimator * _dynamicBarAnimator;
    ...
    SUUIScrollingTabBarBackgroundView * _tabBarExtendedBackgroundView;
    ...
    SUUIScrollingTabBarControllerItemContext * _transientViewControllerItemContext;
...
@property (nonatomic) <SUUITabBarControllerDelegate> *delegate;
@property (readonly, copy) NSString *description;
@property (nonatomic, readonly) UIViewController *floatingOverlayViewController; /* unknown property attribute: ? */
@property (nonatomic) long long forcedUserInterfaceStyle;
@property (readonly) unsigned long long hash;
@property (nonatomic, readonly) UINavigationController *moreNavigationController; /* unknown property attribute: ? */
