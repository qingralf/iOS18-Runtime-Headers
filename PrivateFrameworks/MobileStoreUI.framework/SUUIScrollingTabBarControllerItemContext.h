...
@interface SUUIScrollingTabBarControllerItemContext : NSObject <SUUINavigationStackObserver> {
    ...
    SUUIViewControllerContainerCollectionViewCell * _collectionViewCell;
    <SUUIScrollingTabBarControllerItemContextDelegate> * _delegate;
    struct { 
        struct UIEdgeInsets { 
            double top; 
            double left; 
...
@property (nonatomic, retain) SUUIViewControllerContainerCollectionViewCell *collectionViewCell;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (nonatomic) <SUUIScrollingTabBarControllerItemContextDelegate> *delegate;
