...
@property (getter=_backgroundView, nonatomic, readonly) SUUIScrollingTabBarBackgroundView *backgroundView;
@property (nonatomic, readonly) UIView *contentView;
@property (getter=_delegate, setter=_setDelegate:, nonatomic) <SUUIScrollingTabBarPaletteDelegate> *delegate;
