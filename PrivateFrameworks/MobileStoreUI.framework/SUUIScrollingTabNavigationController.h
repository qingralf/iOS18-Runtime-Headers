...
@interface SUUIScrollingTabNavigationController : SUUINavigationController <SUUIObservableNavigationStack, SUUIScrollingTabBarBottomInsetAwareContent> {
    <SUUINavigationStackObserver> * _navigationStackObserver;
}

@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (readonly, copy) NSString *description;
@property (readonly) unsigned long long hash;
@property (nonatomic) <SUUINavigationStackObserver> *navigationStackObserver;
