...
@interface SUUISearchFieldController : NSObject <SUUISearchControllerDelegate, SUUITrendingSearchPageViewDelegate, UIPopoverPresentationControllerDelegate, UISearchBarDelegate, UISearchResultsUpdating, UITableViewDataSource, UITableViewDelegate> {
    SUUIClientContext * _clientContext;
    SUUICompletionList * _completionList;
    UIViewController * _contentsController;
    <SUUISearchFieldDelegate> * _delegate;
    struct { 
...
@property (nonatomic) <SUUISearchFieldDelegate> *delegate;
