...
@interface SUUISettingsDocumentViewController : SUUIViewController <SUUIArtworkRequestDelegate, SUUIDocumentViewController, SUUISettingsDocumentViewDelegate, SUUISettingsEditTransactionDelegate, SUUISettingsGroupsDescriptionDelegate, UITableViewDataSource, UITableViewDelegate> {
