...
@property (nonatomic) SUUISettingsGroupController *controller;
@property (nonatomic) SUUISettingsGroupsDescription *parent;
@property (nonatomic, retain) SUUIGroupViewElement *viewElement;
