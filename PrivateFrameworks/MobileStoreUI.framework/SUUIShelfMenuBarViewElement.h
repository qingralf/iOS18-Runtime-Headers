...
@interface SUUIShelfMenuBarViewElement : SUUIShelfViewElement <SUUIMenuBarViewElement, _SUUIMenuBarViewElementConfigurationReloadDelegate> {
    SUUIMenuBarViewElementConfiguration * _configuration;
    NSArray * _focusedViewElements;
    NSArray * _regularViewElements;
}

@property (nonatomic, retain) SUUIMenuBarViewElementConfiguration *configuration;
