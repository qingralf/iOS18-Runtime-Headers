...
@interface SUUIShelfPageSection : SUUIStorePageSection <SUUIArtworkRequestDelegate, SUUIObservableScrollViewDelegate, SUUIShelfPageSection, SUUIShelfPageSectionConfigurationDataSource, SUUIViewElementSlideshowDelegate, UICollectionViewDataSource, UICollectionViewDelegate> {
