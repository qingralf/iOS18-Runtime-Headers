...
@interface SUUIShelfPageSectionConfiguration : NSObject {
    ...
    <SUUIShelfPageSectionConfigurationDataSource> * _dataSource;
    long long  _lockupType;
    bool  _needsShelfCollectionViewLayout;
    bool  _needsShelfCollectionViewReload;
    SUUIStorePageSectionContext * _pageSectionContext;
    ...
    SUUIShelfLayoutData * _shelfLayoutData;
...
@property (nonatomic, retain) SUUIViewElementLayoutContext *cellLayoutContext;
@property (nonatomic) <SUUIShelfPageSectionConfigurationDataSource> *dataSource;
...
@property (nonatomic, retain) SUUIStorePageSectionContext *pageSectionContext;
...
@property (nonatomic, readonly) SUUIShelfLayoutData *shelfLayoutData;
