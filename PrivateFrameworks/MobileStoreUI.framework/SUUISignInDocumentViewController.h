...
@interface SUUISignInDocumentViewController : SUUIViewController <SUUIArtworkRequestDelegate, SUUIDocumentViewController, SUUILayoutCacheDelegate, SUUISignInViewDelegate> {
    struct CGRect { 
        struct CGPoint { 
            double x; 
            double y; 
