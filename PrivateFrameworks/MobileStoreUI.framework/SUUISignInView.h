...
@interface SUUISignInView : UIView <SUUIViewElementView, UITextFieldDelegate> {
    UIColor * _borderColor;
    SUUIShapeView * _borderView;
    <SUUISignInViewDelegate> * _delegate;
...
@property (nonatomic) <SUUISignInViewDelegate> *delegate;
