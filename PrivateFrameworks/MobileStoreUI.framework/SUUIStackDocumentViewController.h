...
@interface SUUIStackDocumentViewController : SUUIViewController <SUUICollectionViewPullToRefreshDelegate, SUUIDocumentViewController, SUUIIndexBarControlControllerDataSource, SUUIIndexBarControlControllerDelegate, SUUIIndexBarEntryListControllerDelegate, SUUIModalSourceViewProvider, SUUIResourceLoaderDelegate, SUUIStorePageSectionsDelegate, SUUIViewControllerTesting> {
...
@property (nonatomic, readonly) SUUIStorePageSectionsViewController *sectionsViewController;
...
- (void)sectionsViewController:(id)arg1 willScrollToOffset:(struct CGPoint { double x1; double x2; })arg2 visibleRange:(struct SUUIIndexPathRange { long long x1; long long x2; long long x3; long long x4; })arg3;
