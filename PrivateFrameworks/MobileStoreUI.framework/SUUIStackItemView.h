...
@interface SUUIStackItemView : SUUIViewReuseView <SUUIViewElementView> {
    ...
    NSArray * _imageViews;
    SUUIViewElementLayoutContext * _lastContext;
    SUUIAttributedStringView * _textView;
    SUUIStackItemViewElement * _viewElement;
}
...
@property (nonatomic, retain) SUUIViewElementLayoutContext *lastContext;
@property (nonatomic, readonly) unsigned long long numberOfLines;
@property (readonly) Class superclass;
@property (nonatomic, retain) SUUIAttributedStringView *textView;
@property (nonatomic, retain) SUUIStackItemViewElement *viewElement;
