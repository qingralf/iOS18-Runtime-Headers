...
@interface SUUIStorePageSection : NSObject <SUUIProductPageOverlayDelegate> {
    ...
    SUUIStorePageSectionContext * _context;
...
@property (nonatomic, readonly) SUUIStorePageSectionContext *context;
...
@property (nonatomic, readonly) SUUIPageComponent *pageComponent;
...
- (void)collectionViewWillScrollToOffset:(struct CGPoint { double x1; double x2; })arg1 visibleRange:(struct SUUIIndexPathRange { long long x1; long long x2; long long x3; long long x4; })arg2;
...
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })itemRangeForIndexPathRange:(struct SUUIIndexPathRange { long long x1; long long x2; long long x3; long long x4; })arg1;
