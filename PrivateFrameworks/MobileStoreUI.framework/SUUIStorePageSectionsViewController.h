...
@interface SUUIStorePageSectionsViewController : SUUIViewController <SUUIItemStateCenterObserver, SUUILayoutCacheDelegate, SUUIProductPageOverlayDelegate, SUUIStorePageCollectionViewDelegate, SUUIViewControllerTesting, UICollectionViewDataSource, UIGestureRecognizerDelegate, UIViewControllerPreviewingDelegate, UIViewControllerPreviewingDelegate_Private> {
    ...
    <SUUIStorePageSectionsDelegate> * _delegate;
    ...
    <SUUICollectionViewPullToRefreshDelegate> * _pullToRefreshDelegate;
...
- (void).cxx_destruct;
- (void)SUUICollectionViewWillLayoutSubviews:(id)arg1;
- (id)SUUIStackedBar;
...
- (void)setSUUIStackedBar:(id)arg1;
