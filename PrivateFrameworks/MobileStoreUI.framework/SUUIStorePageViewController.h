...
@interface SUUIStorePageViewController : UIViewController <SUUIMetricsViewController, SUUIStorePageSectionsDelegate, SUUIViewControllerTesting, UIViewControllerRestoration> {
    SUUIClientContext * _clientContext;
    <SUUIStorePageDelegate> * _delegate;
