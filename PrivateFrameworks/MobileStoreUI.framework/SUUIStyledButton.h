...
@interface SUUIStyledButton : UIControl <SUUIViewElementOfferButton> {
    ...
    SUUIButtonBorderStyle * _borderStyle;
    ...
    <SUUIItemOfferButtonDelegate> * _itemOfferDelegate;
...
@property (nonatomic, copy) SUUIButtonBorderStyle *borderStyle;
...
@property (nonatomic, readonly) SUUIImageView *imageView;
@property (nonatomic) double imageYAdjustment;
@property (nonatomic) <SUUIItemOfferButtonDelegate> *itemOfferDelegate;
@property (readonly) Class superclass;
@property (nonatomic, retain) SUUIAttributedStringLayout *titleLayout;
