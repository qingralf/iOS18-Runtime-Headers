...
@interface SUUIVerticalLockupView : SUUIViewReuseView <SUUIItemOfferButtonDelegate, SUUIPerspectiveView, SUUIViewElementView> {
    ...
    SUUISizeValue * _productImageBoundingSize;
