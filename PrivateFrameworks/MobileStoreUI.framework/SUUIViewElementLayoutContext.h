...
@interface SUUIViewElementLayoutContext : NSObject {
    ...
    <SUUIArtworkRequestDelegate> * _artworkRequestDelegate;
...
@property (nonatomic) <SUUIArtworkRequestDelegate> *artworkRequestDelegate;
@property (nonatomic, copy) NSString *backdropGroupName;
@property (nonatomic, readonly) SUUIBadgeTextAttachmentLoader *badgeImageLoader;
...
@property (nonatomic, retain) SUUIViewElementTextLayoutCache *labelLayoutCache;
