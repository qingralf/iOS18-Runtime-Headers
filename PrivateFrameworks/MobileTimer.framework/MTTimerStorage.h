...
@interface MTTimerStorage : NSObject <MTAgentDiagnosticDelegate, MTApplicationWorkspaceObserverProtocol, MTTimerSchedulerDelegate, MTTimerStorage> {
    id /* block */  _currentDateProvider;
    MTTimerDurationManager * _durationManager;
...
@property (nonatomic, retain) MTTimerDurationManager *durationManager;
...
- (void)_queue_notifyObserversForTimerUpdate:(id)arg1 fromTimers:(id)arg2 source:(id)arg3;
- (void)_queue_notifyObserversWithBlock:(id /* block */)arg1;
- (void)_queue_persistTimers;
- (void)_queue_removeAllTimersForSource:(id)arg1;
- (void)_queue_removeStaleTimers:(bool)arg1;
...
- (void)addFavoriteDuration:(id)arg1 withCompletion:(id /* block */)arg2 source:(id)arg3;
- (void)addRecentDuration:(id)arg1 withCompletion:(id /* block */)arg2 source:(id)arg3;
...
- (void)getDurationsWithCompletion:(id /* block */)arg1;
...
- (void)removeFavoriteDuration:(id)arg1 withCompletion:(id /* block */)arg2 source:(id)arg3;
- (void)removeRecentDuration:(id)arg1 withCompletion:(id /* block */)arg2 source:(id)arg3;
...
- (void)saveLatestDuration:(id)arg1 withCompletion:(id /* block */)arg2 source:(id)arg3;
- (id)scheduler;
...
- (void)setDurationManager:(id)arg1;
