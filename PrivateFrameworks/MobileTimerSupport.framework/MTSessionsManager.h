...
@interface MTSessionsManager : NSObject {
    ...
    _TtC18MobileTimerSupport22MTBaseSessionsProvider * _baseProvider;
...
@property (nonatomic, retain) _TtC18MobileTimerSupport22MTBaseSessionsProvider *baseProvider;
