...
@property (nonatomic, readonly) long long tonePickerCustomTableSeparatorBackdropOverlayBlendMode; /* unknown property attribute: ? */
@property (nonatomic, readonly) UIColor *tonePickerCustomTableSeparatorColor; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) bool tonePickerHeaderTextShouldBeUppercase; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) UIColor *vibrationPickerCustomBackgroundColor; /* unknown property attribute: ? */
@property (nonatomic, readonly) long long vibrationPickerCustomTableSeparatorBackdropOverlayBlendMode; /* unknown property attribute: ? */
@property (nonatomic, readonly) UIColor *vibrationPickerCustomTableSeparatorColor; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) bool vibrationPickerHeaderTextShouldBeUppercase; /* unknown property attribute: ? */
