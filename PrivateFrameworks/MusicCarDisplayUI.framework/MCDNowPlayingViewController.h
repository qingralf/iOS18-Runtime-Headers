...
@interface MCDNowPlayingViewController : CPUINowPlayingViewController <MCDNowPlayingContentManagerDelegate> {
    ...
    NSString * _appName;
    MCDNowPlayingBackdropView * _backdropView;
    NSObject<MCDNowPlayingContentManagerProtocol> * _contentManager;
...
@property (nonatomic, retain) MCDNowPlayingBackdropView *backdropView;
@property (nonatomic, retain) NSObject<MCDNowPlayingContentManagerProtocol> *contentManager;
