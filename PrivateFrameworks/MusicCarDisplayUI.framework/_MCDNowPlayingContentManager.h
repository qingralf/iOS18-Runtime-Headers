...
- (void)dealloc;
- (id)delegate;
- (struct { double x1; double x2; double x3; double x4; double x5; float x6; float x7; bool x8; bool x9; bool x10; })durationSnapshotForNowPlayingViewController:(id)arg1;
...
- (bool)nowPlayingViewControllerShouldHideBackButton:(id)arg1;
- (bool)nowPlayingViewControllerShouldOverrideRightBarButtons:(id)arg1;
...
- (void)setShouldHideBackButton:(bool)arg1;
