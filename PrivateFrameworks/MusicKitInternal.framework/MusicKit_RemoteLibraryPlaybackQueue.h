...
- (id)initWithContainer:(id)arg1 startItem:(id)arg2 replaceQueueIntent:(long long)arg3;
- (id)initWithItem:(id)arg1 replaceQueueIntent:(long long)arg2;
- (id)initWithRequest:(id)arg1 startItem:(id)arg2 replaceQueueIntent:(long long)arg3;
