...
@property (nonatomic, retain) MIPAudiobook *audiobook;
...
- (void)setAssetStoreItemId:(long long)arg1;
- (void)setAudiobook:(id)arg1;
...
- (void)setHasAssetStoreItemId:(bool)arg1;
...
- (void)setHasReportingStoreItemId:(bool)arg1;
...
- (void)setReportingStoreItemId:(long long)arg1;
