...
@property (nonatomic, retain) NSString *cloudLibraryId;
@property (nonatomic, retain) NSString *cloudUniversalLibraryId;
@property (nonatomic) bool hasAccountId;
@property (nonatomic, readonly) bool hasCloudLibraryId;
...
- (void)setCloudLibraryId:(id)arg1;
...
+ (id)midDataFromAlbumPID:(id)arg1;
