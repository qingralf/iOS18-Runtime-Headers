...
@interface MIPPlaylist : PBCodable <NSCopying> {
    ...
    bool  _collaborationJoinRequestPending;
...
@property (nonatomic, retain) NSString *collaborationInvitationURL;
@property (nonatomic) long long collaborationInvitationURLExpirationDate;
@property (nonatomic) bool collaborationJoinRequestPending;
...
@property (nonatomic, readonly) bool hasCollaborationInvitationURL;
@property (nonatomic) bool hasCollaborationInvitationURLExpirationDate;
@property (nonatomic) bool hasCollaborationJoinRequestPending;
@property (nonatomic) bool hasCollaborationMode;
@property (nonatomic) bool hasCollaboratorStatus;
@property (nonatomic, readonly) bool hasCoverArtworkRecipe;
...
@property (nonatomic) bool hasIsCollaborative;
...
@property (nonatomic, readonly) bool hasPlaylistGroupingSortKey;
...
@property (nonatomic, retain) NSString *playlistGroupingSortKey;
...
- (id)cloudVersionHash;
- (id)collaborationInvitationURL;
- (long long)collaborationInvitationURLExpirationDate;
...
- (void)setCollaborationInvitationURL:(id)arg1;
- (void)setCollaborationInvitationURLExpirationDate:(long long)arg1;
- (void)setCollaborationJoinRequestPending:(bool)arg1;
- (void)setCollaborationMode:(int)arg1;
- (void)setCollaboratorStatus:(int)arg1;
...
- (void)setHasCollaborationInvitationURLExpirationDate:(bool)arg1;
- (void)setHasCollaborationJoinRequestPending:(bool)arg1;
- (void)setHasCollaborationMode:(bool)arg1;
- (void)setHasCollaboratorStatus:(bool)arg1;
...
- (void)setHasIsCollaborative:(bool)arg1;
...
- (void)setHasPlaylistCategoryTypeMask:(bool)arg1;
...
- (void)setPlaylistGroupingSortKey:(id)arg1;
