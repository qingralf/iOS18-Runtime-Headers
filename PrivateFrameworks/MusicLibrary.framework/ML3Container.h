...
@property (nonatomic, readonly, copy) NSArray *cloudDisplayOrderingTerms;
@property (nonatomic, readonly, copy) NSArray *displayOrderingTerms;
@property (getter=isLimitOrderingDescending, nonatomic, readonly) bool limitOrderingDescending;
@property (nonatomic, readonly, copy) NSArray *limitOrderingTerms;
@property (nonatomic, readonly) long long limitValue;
@property (getter=isLimitedByCount, nonatomic, readonly) bool limitedByCount;
@property (nonatomic, readonly, copy) NSString *limitingProperty;
@property (nonatomic, readonly) ML3Predicate *smartCriteriaPredicate;
...
+ (bool)_reloadContainedMediaTypes:(bool)arg1 removedMediaTypes:(id)arg2 addedMediaTypes:(id)arg3 notify:(bool)arg4 incrementEntityRevision:(bool)arg5 usingLibrary:(id)arg6 connection:(id)arg7 forContainerPersistentID:(long long)arg8;
...
+ (id)currentDeviceFavoritesPlaylistInLibrary:(id)arg1 usingConnection:(id)arg2;
+ (id)databaseTable;
...
+ (bool)updateBuiltInSmartPlaylistNamesForCurrentLanguageInLibrary:(id)arg1;
...
- (bool)_setItemPersistentIDs:(id)arg1 andEntryProperties:(id)arg2 withAttributionIdentifier:(id)arg3 reloadContainedMediaTypes:(bool)arg4 removedMediaTypes:(id)arg5 addedMediaTypes:(id)arg6 notify:(bool)arg7 incrementEntityRevision:(bool)arg8 usingConnection:(id)arg9;
...
- (bool)appendTracksWithPersistentIDs:(id)arg1 andEntryProperties:(id)arg2 withAttributionIdentifier:(id)arg3 notify:(bool)arg4;
...
- (bool)setItemReactionText:(id)arg1 onEntryAtPosition:(unsigned long long)arg2 forUserIdentifier:(id)arg3 previousReactionText:(id*)arg4;
- (bool)setTracksWithPersistentIDs:(id)arg1 andEntryProperties:(id)arg2 withAttributionIdentifier:(id)arg3 notify:(bool)arg4;
