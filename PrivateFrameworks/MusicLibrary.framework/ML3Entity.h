...
@property (nonatomic, readonly) bool existsInLibrary;
...
+ (id)_createDisambiguatedSQLForProperty:(id)arg1;
...
+ (id)_entityForURLComponents:(id)arg1 inLibrary:(id)arg2 verifyExistence:(bool)arg3 reason:(id*)arg4;
...
+ (bool)deleteFromLibrary:(id)arg1 deletionType:(int)arg2 canonicalizeCollections:(bool)arg3 persistentIDs:(const long long*)arg4 count:(unsigned long long)arg5 usingConnection:(id)arg6;
...
+ (id)entityFromURL:(id)arg1 reason:(id*)arg2;
+ (id)entityURLScheme;
...
+ (bool)setDifferentValues:(id)arg1 forProperties:(id)arg2 forEntityPersistentIDs:(id)arg3 inLibrary:(id)arg4 usingConnection:(id)arg5;
