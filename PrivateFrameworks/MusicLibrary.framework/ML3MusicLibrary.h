...
@interface ML3MusicLibrary : NSObject <ML3DatabaseConnectionDelegate, ML3DatabaseConnectionPoolDelegate, NSSecureCoding, _MSVAccountInformationProviding> {
    ...
    bool  _autoUpdatingSharedLibrary;
...
@property (getter=isAutoUpdatingSharedLibrary, nonatomic) bool autoUpdatingSharedLibrary;
...
@property (nonatomic, readonly) ML3Container *currentDeviceFavoriteSongsPlaylist;
...
@property (nonatomic, copy) NSString *sagaClientFeaturesVersion;
...
@property (nonatomic) bool sagaInitiateClientResetSync;
@property (nonatomic, copy) NSString *sagaLastCloudUpdateClientBuildVersion;
...
+ (id)_onGlobalQueue_shareableMusicLibraryWithResourcesManager:(id)arg1 libraryFilePath:(id)arg2;
+ (id)allLibraries;
...
- (bool)_removeSource:(int)arg1 fromPersistentIDS:(id)arg2 forImportOperation:(id)arg3 canonocalizeCollections:(bool)arg4 usingConnection:(id)arg5 postNotifications:(bool)arg6;
...
- (void)clearCachedCloudLibraryVersionsUsingConnection:(id)arg1;
- (void)clearCachedPurchaseHistoryVersionsUsingConnection:(id)arg1;
...
- (id)currentDeviceFavoriteSongsPlaylist;
...
- (void)enumerateArtworkRelativePathsWithConnection:(id)arg1 matchingRelativePathContainer:(id)arg2 block:(id /* block */)arg3;
...
- (void)generateArtworkForRelativePath:(id)arg1 sizes:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (bool)importOriginalArtworkFromFileURL:(id)arg1 withArtworkToken:(id)arg2 artworkType:(long long)arg3 sourceType:(long long)arg4 mediaType:(unsigned int)arg5 shouldPerformColorAnalysis:(bool)arg6;
- (void)importOriginalArtworkFromFileURL:(id)arg1 withArtworkToken:(id)arg2 artworkType:(long long)arg3 sourceType:(long long)arg4 mediaType:(unsigned int)arg5 shouldPerformColorAnalysis:(bool)arg6 completion:(id /* block */)arg7;
...
- (bool)importOriginalArtworkFromImageData:(id)arg1 withArtworkToken:(id)arg2 artworkType:(long long)arg3 sourceType:(long long)arg4 mediaType:(unsigned int)arg5 shouldPerformColorAnalysis:(bool)arg6;
- (void)importOriginalArtworkFromImageData:(id)arg1 withArtworkToken:(id)arg2 artworkType:(long long)arg3 sourceType:(long long)arg4 mediaType:(unsigned int)arg5 shouldPerformColorAnalysis:(bool)arg6 completion:(id /* block */)arg7;
...
- (bool)markSystemPurgeableMusicPath:(id)arg1 forUrgency:(unsigned long long)arg2;
- (id)mediaFolderPath;
- (id)mediaFolderPathByAppendingPathComponent:(id)arg1;
...
- (void)removeCloudSourcesWithAttributes:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (bool)removeSource:(int)arg1 forImportOperation:(id)arg2 usingConnection:(id)arg3 postNotifications:(bool)arg4;
- (bool)removeSource:(int)arg1 fromPersistentIDS:(id)arg2 forImportOperation:(id)arg3 canonocalizeCollections:(bool)arg4 usingConnection:(id)arg5 postNotifications:(bool)arg6;
- (bool)removeSource:(int)arg1 fromPersistentIDS:(id)arg2 forImportOperation:(id)arg3 usingConnection:(id)arg4 postNotifications:(bool)arg5;
...
- (void)sanitizeDatabaseContentsUsingConnection:(id)arg1 removeOrphanedAssets:(bool*)arg2;
- (bool)sanitizeSortMapContentsUsingConnection:(id)arg1 didSortMapEntries:(bool*)arg2;
- (void)savePlaylists;
...
- (id)securityScopedFileURLForItemPID:(unsigned long long)arg1;
- (id)serialQueue;
- (void)setAutoUpdatingSharedLibrary:(bool)arg1;
...
- (void)setSagaClientFeaturesVersion:(id)arg1;
- (void)setSagaCloudAddToPlaylistBehavior:(long long)arg1;
- (void)setSagaCloudFavoriteSongAddToLibraryBehavior:(long long)arg1;
...
- (void)setSagaInitiateClientResetSync:(bool)arg1;
- (void)setSagaLastCloudUpdateClientBuildVersion:(id)arg1;
...
- (void)setSagaNeedsFullUpdate:(bool)arg1;
...
- (void)updatePurgeabilityForCachedArtworkWithAbsolutePath:(id)arg1;
- (void)updatePurgeabilityForOriginalArtworkWithRelativePath:(id)arg1;
...
- (bool)validateItemTablesEntriesUsingConnection:(id)arg1;
