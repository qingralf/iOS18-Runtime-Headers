...
+ (bool)deleteFromLibrary:(id)arg1 deletionType:(int)arg2 canonicalizeCollections:(bool)arg3 persistentIDs:(const long long*)arg4 count:(unsigned long long)arg5;
