...
@interface MusicUI.JSRestrictionsController : NSObject <MusicUI.JSRestrictionsControllerExports> {
    ...
    void _isSubscriptionContentRestricted;
    void _isTVRestricted;
    void restrictionsController;
    void subscriptionContentRestrictionController;
}
...
- (id)isSocialDisabled;
- (id)isSubscriptionContentRestricted;
- (id)isTVRestricted;
...
- (void)setIsSubscriptionContentRestricted:(id)arg1;
