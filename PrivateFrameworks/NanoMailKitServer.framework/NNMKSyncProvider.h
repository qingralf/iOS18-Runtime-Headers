...
@interface NNMKSyncProvider : NNMKSyncEndpoint <NNMKAccountsSyncServiceServerDelegate, NNMKBatchRequestHandlerDelegate, NNMKDeviceRegistryHolder, NNMKFetchesSyncServiceServerDelegate, NNMKInitialSyncProgressTrackerDelegate, NNMKMessageContentSyncServiceServerDelegate, NNMKMessagesSyncServiceServerDelegate, NNMKResendSchedulerDelegate, NNMKSyncStateManagerDelegate> {
    ...
    NSMutableDictionary * _fullSyncTimeoutTimersByMailboxId;
...
@property (nonatomic, retain) NSMutableDictionary *fullSyncTimeoutTimersByMailboxId;
...
- (void).cxx_destruct;
- (void)_addAttachmentData:(id)arg1 forMessageId:(id)arg2 contentId:(id)arg3 loadedProtected:(bool)arg4 mailbox:(id)arg5;
...
- (void)_cancelFullSyncTimeoutTimerForMailboxId:(id)arg1;
...
- (void)_markConversationWithId:(id)arg1 forState:(unsigned long long)arg2 include:(bool)arg3 mailbox:(id)arg4;
...
- (void)_shouldHandleForwardForNotification:(id)arg1 withCompletion:(id /* block */)arg2;
- (void)_startFullSyncTimeoutForMailboxId:(id)arg1;
- (void)_stopTaks;
...
- (void)addAttachmentData:(id)arg1 forMessageId:(id)arg2 contentId:(id)arg3 loadedProtected:(bool)arg4;
...
- (id)fullSyncTimeoutTimersByMailboxId;
...
- (void)setFullSyncTimeoutTimersByMailboxId:(id)arg1;
...
- (id)syncStateManager;
- (void)syncStateManager:(id)arg1 handleForwardForNotification:(id)arg2 completion:(id /* block */)arg3;
...
- (void)updateConversationId:(id)arg1 mute:(bool)arg2;
- (void)updateConversationId:(id)arg1 notify:(bool)arg2 messages:(id)arg3;
