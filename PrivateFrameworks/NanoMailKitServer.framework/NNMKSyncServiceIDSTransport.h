...
@property (nonatomic) bool forceFailureForAllRequests; /* unknown property attribute: ? */
@property (readonly) unsigned long long hash;
@property (nonatomic, retain) IDSService *idsService;
@property (nonatomic, retain) NSString *serviceName;
@property (nonatomic) bool simulateCloudConnectedOnly; /* unknown property attribute: ? */
