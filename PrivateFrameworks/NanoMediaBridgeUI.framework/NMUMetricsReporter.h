...
+ (id)_stringFromSuggestionsContextType:(unsigned long long)arg1;
+ (id)_stringFromSuggestionsMediaType:(unsigned long long)arg1;
...
+ (void)incrementMediaSuggestionsTappedWithEndpointType:(unsigned long long)arg1 contextType:(unsigned long long)arg2 mediaType:(unsigned long long)arg3;
...
+ (void)incrementPlaybackStartCountFromViewType:(unsigned long long)arg1 index:(long long)arg2 endpointType:(unsigned long long)arg3 playerBundleID:(id)arg4;
+ (void)incrementPlaybackStartCountWithPath:(id)arg1 shuffled:(bool)arg2 endpointType:(unsigned long long)arg3;
+ (void)incrementPlaybackStartCountWithPath:(id)arg1 shuffled:(bool)arg2 endpointType:(unsigned long long)arg3 endpointPreviousPlayerState:(long long)arg4;
+ (void)incrementRepeatModeChangeCountWithEndpointType:(unsigned long long)arg1;
+ (void)incrementRouteAutoSelectionResult:(unsigned long long)arg1;
