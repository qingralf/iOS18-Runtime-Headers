...
@property (nonatomic, retain) NSObject<OS_dispatch_source> *sessionTimer;
...
- (void)_startSessionTimerWithReason:(unsigned long long)arg1;
...
- (void)handleStandaloneTransactionWithAction:(unsigned long long)arg1 forPass:(id)arg2 withAccessory:(id)arg3;
