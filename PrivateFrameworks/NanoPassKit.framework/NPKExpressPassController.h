...
@property (retain) NSSet *expressPassConfigurations;
...
- (void).cxx_destruct;
- (bool)_canProceedWithTransactionForPass:(id)arg1 selector:(SEL)arg2;
...
- (void)_handleHomeKeyLockConnectedNotification:(id)arg1;
- (void)_handleHomeKeyLockDisconnectedNotification:(id)arg1;
- (void)_handleHomeKeyLockStatusChangedNotification:(id)arg1;
...
- (unsigned long long)_operationSourceFromRawValue:(id)arg1;
- (void)_parseExpressNotificationObject:(id)arg1 outApplicationIdentifier:(id*)arg2 outApplicationKeyIdentifier:(id*)arg3;
- (void)_parseHomeKeyUWBExpressNotificationObject:(id)arg1 outApplicationIdentifier:(id*)arg2 outApplicationKeyIdentifier:(id*)arg3 outReaderIdentifier:(id*)arg4 outTimestamp:(id*)arg5 outTransactionLockStatus:(id*)arg6 outLockOperationSource:(id*)arg7;
...
- (unsigned long long)_transactionEventFromLockStatus:(id)arg1;
...
- (void)_transitionToStandaloneTransactionEvent:(unsigned long long)arg1 forExpressPass:(id)arg2 withExpressUWBInfo:(id)arg3;
