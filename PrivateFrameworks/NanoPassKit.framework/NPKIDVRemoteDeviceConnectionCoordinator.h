...
@interface NPKIDVRemoteDeviceConnectionCoordinator : NSObject <IDSServiceDelegate, NPKIDVRemoteDeviceCredentialStorageCoordinatorProtocol, NPKIDVRemoteDeviceNotificationManager, NPKIDVRemoteDeviceProofingManager> {
...
- (void)_sendRequest:(id)arg1 withType:(unsigned short)arg2 priority:(long long)arg3 queueIdentifier:(id)arg4 requestItem:(id)arg5 timeout:(double)arg6;
...
- (void)provisionCredentialWithType:(unsigned long long)arg1 metadata:(id)arg2 credentialIdentifier:(id)arg3 attestations:(id)arg4 supplementalData:(id)arg5 completion:(id /* block */)arg6;
...
- (void)updateProofingConfiguration:(id)arg1 completion:(id /* block */)arg2;
- (void)updateProofingConfigurationResponse:(id)arg1;
