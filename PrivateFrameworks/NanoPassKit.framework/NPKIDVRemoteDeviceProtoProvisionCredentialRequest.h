...
@property (nonatomic, readonly) bool hasSupplementalData;
@property (nonatomic, retain) NSData *metadataData;
@property (nonatomic, retain) NSData *supplementalData;
...
- (void)setSupplementalData:(id)arg1;
- (id)supplementalData;
