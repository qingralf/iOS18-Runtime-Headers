...
@interface NPKIDVRemoteDeviceSession : NSObject <NPKIDVRemoteDeviceNotificationManager, NPKIDVRemoteDeviceProofingManager, PKXPCServiceDelegate> {
    NSString * _deviceID;
...
- (void)fetchRemoteBiometricAuthenticationStatusForCredentialType:(unsigned long long)arg1 completion:(id /* block */)arg2;
...
- (void)provisionedCredentialCountForType:(unsigned long long)arg1 completion:(id /* block */)arg2;
