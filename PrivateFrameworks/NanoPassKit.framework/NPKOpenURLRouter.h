...
+ (bool)canOpenURLInSafariForURL:(id)arg1;
+ (void)openDeepLinkForURL:(id)arg1 isSensitive:(bool)arg2;
+ (void)openDeepLinkForURL:(id)arg1 isSensitive:(bool)arg2 completion:(id /* block */)arg3;
...
- (bool)_presentPassBalanceDetailsForPassWiithUniqueID:(id)arg1;
...
- (bool)_presentSavingsDetailsWithPassUniqueID:(id)arg1;
...
- (bool)_processDailyCashHostWithPathComponents:(id)arg1 queryItems:(id)arg2;
- (bool)_processListActionsMenuHostWithPathComponents:(id)arg1;
- (bool)_processPassUpdateHostWithPathComponents:(id)arg1;
- (bool)_processPassesHostWithPathComponents:(id)arg1 urlComponents:(id)arg2;
- (bool)_processProvisioningContinuityHostWithPathComponents:(id)arg1;
- (bool)_processSavingsHostWithPathComponents:(id)arg1;
