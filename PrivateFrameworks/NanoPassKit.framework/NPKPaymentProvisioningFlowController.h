...
- (void)_checkSpaceAvailableForAppletTypes:(id)arg1 triedCleanup:(bool)arg2 completion:(id /* block */)arg3;
...
- (void)_handleEligibiltySuccessWithContext:(id)arg1;
...
- (void)_performSEStorageCheck:(id /* block */)arg1;
