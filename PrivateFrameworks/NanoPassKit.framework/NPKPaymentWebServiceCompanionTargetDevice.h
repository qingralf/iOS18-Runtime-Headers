...
- (void)_addCompanionDevicePhoneNumberDataIfNeededWithFields:(unsigned long long)arg1 toDeviceMetadata:(id)arg2;
- (void)_canAddSecureElementPassWithConfiguration:(id)arg1 completion:(id /* block */)arg2;
- (id)_categoryIdentifierForPass:(id)arg1;
- (void)_checkConflictsForPass:(id)arg1 withConfiguration:(id)arg2 webService:(id)arg3 hasDisqualifyingConflicts:(id /* block */)arg4;
...
- (id)_eligibleExpressUpgradeRequestsForPass:(id)arg1;
- (id)_expressModesFromExpressPassConfigurations:(id)arg1;
- (id)_expressPassConfigurationForPaymentPass:(id)arg1;
- (id)_expressPassesConfigurationFromDataArray:(id)arg1;
...
- (void)_handleOpenLoopPassUpgradeWithPass:(id)arg1 webService:(id)arg2 completion:(id /* block */)arg3;
...
- (void)_multipleExpressTransitPassPaymentWebService:(id)arg1 handlePotentialExpressPassConfiguration:(id)arg2 pass:(id)arg3 withCompletionHandler:(id /* block */)arg4;
- (void)_paymentWebService:(id)arg1 presentStandaloneTransaction:(long long)arg2 forPassUniqueIdentifier:(id)arg3 terminalReaderIdentifier:(id)arg4 validUntilDate:(id)arg5 completion:(id /* block */)arg6;
...
- (void)_singleExpressTransitPassPaymentWebService:(id)arg1 handlePotentialExpressPassConfiguration:(id)arg2 withCompletionHandler:(id /* block */)arg3;
...
- (id)_synthesizedExpressPassStateForExpressPassConfiguration:(id)arg1 otherPaymentPasses:(id)arg2;
- (void)_trackOutstandingRequestWithMessageIdentifier:(id)arg1 completionHandler:(id)arg2 errorHandler:(id /* block */)arg3;
- (void)_updateDataAccessorForPass:(id)arg1;
...
- (void)addPendingProvisioningsRequest:(id)arg1;
- (void)addPendingProvisioningsResponse:(id)arg1;
- (void)addSecureElementPassWithPropertiesResponse:(id)arg1;
...
- (void)carKeyAcceptInvitationResponse:(id)arg1;
- (void)carKeyAcceptInvitationWithInvitationIdentifier:(id)arg1 activationCode:(id)arg2 completion:(id /* block */)arg3;
- (void)carKeyAccountAttestationRequestForCredential:(id)arg1 completion:(id /* block */)arg2;
- (void)carKeyAccountAttestationResponse:(id)arg1;
- (void)carKeyDecryptData:(id)arg1 credential:(id)arg2 ephemeralPublicKey:(id)arg3 completion:(id /* block */)arg4;
- (void)carKeyDecryptDataResponse:(id)arg1;
- (void)carKeyGetPretrackRequestForKeyWithInvitationIdentifier:(id)arg1 completion:(id /* block */)arg2;
- (void)carKeyGetPretrackResponse:(id)arg1;
- (void)carKeyGetProductPlanIdentifierRequestForInvitationWithIdentifier:(id)arg1 transportIdentifier:(id)arg2 completion:(id /* block */)arg3;
- (void)carKeyGetProductPlanIdentifierResponse:(id)arg1;
- (void)carKeyHandleRecipientMessage:(id)arg1 forInvitationIdentifier:(id)arg2 completion:(id /* block */)arg3;
- (void)carKeyHandleRecipientMessageResponse:(id)arg1;
- (void)carKeyRejectInvitation:(id)arg1 completion:(id /* block */)arg2;
- (void)carKeyRejectInvitationResponse:(id)arg1;
- (void)carKeyRetryActivationCodeResponse:(id)arg1;
- (void)carKeyRetryActivationCodeWithInvitationIdentifier:(id)arg1 activationCode:(id)arg2 completion:(id /* block */)arg3;
- (void)carKeyRoutingInformationForInvitationWithIdentifier:(id)arg1 transportIdentifier:(id)arg2 completion:(id /* block */)arg3;
- (void)carKeyRoutingInformationResponse:(id)arg1;
- (void)carKeySetAccountAttestation:(id)arg1 forCredential:(id)arg2 completion:(id /* block */)arg3;
- (void)carKeySetAccountAttestationResponse:(id)arg1;
- (void)carKeySetEncryptedProductPlanIdentifierContainer:(id)arg1 invitationIdentifier:(id)arg2 completion:(id /* block */)arg3;
- (void)carKeySetEncryptedProductPlanIdentifierContainerResponse:(id)arg1;
- (void)carKeyStartShareAcceptanceFlow:(id)arg1 transportIdentifier:(id)arg2 completion:(id /* block */)arg3;
- (void)carKeyStartShareAcceptanceFlowResponse:(id)arg1;
- (void)carKeyUpdateTrackingAttestation:(id)arg1 forCredential:(id)arg2 encryptedContainer:(id)arg3 completion:(id /* block */)arg4;
- (void)carKeyUpdateTrackingAttestationResponse:(id)arg1;
...
- (void)conflictingExpressPassIdentifiersForPassConfiguration:(id)arg1 completion:(id /* block */)arg2;
- (void)conflictingExpressPassIdentifiersForPassConfiguration:(id)arg1 withReferenceExpressState:(id)arg2 completion:(id /* block */)arg3;
...
- (void)generateAuxiliaryCapabilitiesResponse:(id)arg1;
...
- (void)paymentWebService:(id)arg1 presentStandaloneTransaction:(long long)arg2 forPassUniqueIdentifier:(id)arg3 terminalReaderIdentifier:(id)arg4 completion:(id /* block */)arg5;
...
- (void)serviceProviderDataForSecureElementPass:(id)arg1 encrypted:(bool)arg2 completion:(id /* block */)arg3;
...
- (void)setExpressWithPassConfiguration:(id)arg1 requestAuthorization:(bool)arg2 completion:(id /* block */)arg3;
