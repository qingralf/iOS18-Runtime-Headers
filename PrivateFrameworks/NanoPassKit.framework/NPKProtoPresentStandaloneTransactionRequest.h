...
@property (nonatomic, readonly) bool hasTerminalReaderIdentifier;
...
@property (nonatomic, retain) NSString *terminalReaderIdentifier;
...
- (void)setTerminalReaderIdentifier:(id)arg1;
