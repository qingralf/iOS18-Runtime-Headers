...
- (bool)_sessionQueue_updateContactlessSessionForPass:(id)arg1 paymentApplications:(id)arg2 vasPasses:(id)arg3 sessionConfirmed:(bool)arg4 deferAuthorization:(bool)arg5;
