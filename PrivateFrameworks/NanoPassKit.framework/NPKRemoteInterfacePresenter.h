...
- (void)presentProvisioningContinuityInterfaceForPassWithUniqueIdentifier:(id)arg1 continuityType:(id)arg2 transferToken:(id)arg3 completion:(id /* block */)arg4;
- (void)presentSetupApplePayAlert:(id)arg1;
- (void)presentTransitTopUpValueSelectionForPassWithUniqueIdentifier:(id)arg1 balanceField:(id)arg2 completion:(id /* block */)arg3;
