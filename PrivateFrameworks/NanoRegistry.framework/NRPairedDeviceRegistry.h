...
- (void)_pingActiveGizmoWithPriority:(long long)arg1 withMessageSize:(long long)arg2 withBlock:(id /* block */)arg3;
...
- (void)triggerTailspinFrom:(unsigned long long)arg1;
