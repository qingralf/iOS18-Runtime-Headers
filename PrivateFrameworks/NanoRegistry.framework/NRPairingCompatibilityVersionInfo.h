...
- (long long)maxPairingCompatibilityVersionForPhoneProductType:(id)arg1;
...
- (long long)minPairingCompatibilityVersionForWatchProductType:(id)arg1;
...
- (unsigned long long)pairingCompatibilitySupportStateForAdvertisingWatchVersion:(long long)arg1;
