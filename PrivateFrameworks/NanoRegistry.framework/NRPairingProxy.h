...
- (void)xpcPingActiveGizmoWithPriority:(int)arg1 withMessageSize:(long long)arg2 withBlock:(id /* block */)arg3;
...
- (void)xpcTriggerTailspinFrom:(unsigned long long)arg1 forApp:(id)arg2;
