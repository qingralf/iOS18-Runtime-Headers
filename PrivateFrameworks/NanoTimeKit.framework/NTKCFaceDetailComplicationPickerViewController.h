...
@interface NTKCFaceDetailComplicationPickerViewController : UITableViewController <NTKCFaceDetailComplicationPickerViewControllerDelegate, NTKHomeDetailPickerViewControllerDelegate, NTKHomeListPickerViewControllerDelegate, NTKPeopleComplicationPickerViewControllerDelegate> {
...
- (bool)_handleHomeItemSelection:(id)arg1;
- (bool)_handleWidgetItemSelection:(id)arg1;
- (void)_setCheckmarkForTableView:(id)arg1 atIndexPath:(id)arg2;
...
- (void)homeDetailPickerViewController:(id)arg1 didSelectItem:(id)arg2;
- (void)homeListPickerViewController:(id)arg1 didSelectItem:(id)arg2;
