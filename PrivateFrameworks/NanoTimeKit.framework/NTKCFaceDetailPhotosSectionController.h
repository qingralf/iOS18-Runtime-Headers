...
@interface NTKCFaceDetailPhotosSectionController : NTKCFaceDetailEditOptionVerticalSectionController <NTKCFaceDetailAlbumChooserViewControllerDelegate, NTKCFaceDetailCustomPhotosViewControllerDelegate> {
