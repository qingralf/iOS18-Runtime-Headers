...
@interface NTKCompanionWidgetComplicationManager : NSObject <CLKComplicationWidgetMigrationDataSource, NTKComplicationCollectionObserver, NTKWidgetComplicationProvider> {
    CLKDevice * _device;
    bool  _loaded;
...
- (void)_updateLoaded;
- (id)cachedWidgetMigrationForAppIdentifier:(id)arg1 descriptor:(id)arg2;
...
- (void)loadWidgetMigrationsForAppIdentifier:(id)arg1 descriptor:(id)arg2 completion:(id /* block */)arg3;
