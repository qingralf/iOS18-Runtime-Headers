...
@interface NTKComplicationDisplayWrapperView : UIControl <CDComplicationDisplayObserver, CLKSensitiveUIStateObserver, CLKUITimeTravel, NTKControl> {
    ...
    <NTKComplicationDisplayWrapperAppLaunchDelegate> * _appLaunchDelegate;
    ...
    bool  _tapAnimationEnabled;
    bool  _tapEnabled;
    bool  _tapInternalInputEnabled;
...
@property (nonatomic) <NTKComplicationDisplayWrapperAppLaunchDelegate> *appLaunchDelegate;
...
@property (nonatomic) bool tapAnimationEnabled;
@property (nonatomic) bool tapEnabled;
@property (nonatomic) bool tapInternalInputEnabled;
...
- (void)setAppLaunchDelegate:(id)arg1;
...
- (void)setTapAnimationEnabled:(bool)arg1;
- (void)setTapEnabled:(bool)arg1;
- (void)setTapInternalInputEnabled:(bool)arg1;
...
- (void)willPerformAppLaunchForComplication:(id)arg1;
