...
@property (nonatomic, copy) NSString *companionGalleryName;
...
@property (nonatomic, readonly, copy) NTKFaceView *faceView;
...
+ (id)sortableFaceWithAssets:(id)arg1 forDevice:(id)arg2;
+ (bool)supportsExternalAssets;
+ (bool)supportsSecureCoding;
+ (id)upgradeManagerWithFace:(id)arg1 forDevice:(id)arg2;
...
- (id)_editOptionsForEditMode:(long long)arg1 slot:(id)arg2;
- (id)_faceDescription;
...
- (id)_localizedNameForDynamicSectionCustomEditMode:(long long)arg1 slot:(id)arg2;
...
- (id)localizedExplanationMessageForDisabledEditMode:(long long)arg1;
- (id)localizedNameForDynamicSectionCustomEditMode:(long long)arg1 slot:(id)arg2;
...
- (void)setCompanionGalleryName:(id)arg1;
