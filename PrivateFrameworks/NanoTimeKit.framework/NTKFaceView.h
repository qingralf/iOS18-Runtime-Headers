...
- (bool)_allowsEditingSliderEditableColorsForSlot:(id)arg1;
...
- (unsigned long long)_layoutStyleForSlot:(id)arg1;
...
- (bool)allowsEditingSliderEditableColorsForSlot:(id)arg1;
...
- (unsigned long long)layoutStyleForSlot:(id)arg1;
- (void)layoutSubviews;
