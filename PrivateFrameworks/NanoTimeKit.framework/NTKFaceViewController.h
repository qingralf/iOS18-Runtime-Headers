...
@interface NTKFaceViewController : UIViewController <CLKSensitiveUIStateObserver, NTKClockHardwareInput, NTKClockIconZoomAnimator, NTKFaceObserver, NTKFaceViewDelegate> {
    ...
    NHSUISClockAppearance * _homeScreenAppearance;
    ...
    NSDate * _pauseDate;
    bool  _pausedForHomeScreen;
    bool  _pausedForObstruction;
...
@property (nonatomic, readonly) NHSUISClockAppearance *homeScreenAppearance;
...
@property (nonatomic) bool pausedForObstruction;
...
- (void)setPausedForHomeScreen:(bool)arg1;
- (void)setPausedForObstruction:(bool)arg1;
...
- (void)setWidgetsVisible:(bool)arg1;
