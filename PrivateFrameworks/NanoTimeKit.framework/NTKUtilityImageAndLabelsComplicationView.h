...
@interface NTKUtilityImageAndLabelsComplicationView : NTKUtilityComplicationView {
    CLKUIColoringLabel * _firstLabel;
    UIView<CDComplicationImageView> * _imageView;
    CLKUIColoringLabel * _secondLabel;
}

@property (nonatomic, retain) CLKUIColoringLabel *firstLabel;
@property (nonatomic, retain) UIView<CDComplicationImageView> *imageView;
@property (nonatomic, retain) CLKUIColoringLabel *secondLabel;
