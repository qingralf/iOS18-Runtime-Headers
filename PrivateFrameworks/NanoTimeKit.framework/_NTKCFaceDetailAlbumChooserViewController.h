...
@interface _NTKCFaceDetailAlbumChooserViewController : PUAlbumListViewController {
    ...
    NTKCompanionResourceDirectoryEditor<NTKCAlbumHandlingEditor> * _editor;
    NTKFace * _face;
    bool  _inGallery;
...
@property (nonatomic, retain) NTKCompanionResourceDirectoryEditor<NTKCAlbumHandlingEditor> *editor;
