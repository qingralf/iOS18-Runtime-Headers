...
@property (nonatomic, readonly) AegirCloudCoverService *cloudsService;
...
- (unsigned long long)pixelFormat0For:(id)arg1;
...
- (id)textureGroupWithSuffix:(id)arg1 device:(id)arg2;
