...
- (void)date:(id)arg1 toEquatorRotation:(float*)arg2 toAngle:(float*)arg3 toLight:(/* Warning: Unrecognized filer type: '4' using 'void*' */ void**)arg4 toDistance:(float*)arg5 toRadius:(float*)arg6;
- (float)distance;
- (float)distanceScale;
- (float)equatorRotation;
