...
- (unsigned long long)_announcementStageForEvent:(id)arg1;
...
- (void)_notifySpeechEvent:(id)arg1 waypointCategory:(int)arg2 startingVariantIndex:(unsigned long long)arg3;
...
- (id)_specialNavTrayEvents:(int)arg1 forLeg:(unsigned long long)arg2;
...
- (id)_spokenStringForEvent:(id)arg1 waypointCategory:(int)arg2;
