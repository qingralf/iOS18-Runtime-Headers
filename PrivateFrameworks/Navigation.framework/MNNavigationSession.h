...
@property (nonatomic, readonly) MNNavigationSessionState *navigationSessionState;
...
- (void)_startAudioSessionWithGuidanceLevelOverride:(unsigned long long)arg1;
...
- (void)audioManager:(id)arg1 didChangeVoiceGuidanceLevel:(unsigned long long)arg2;
...
- (void)forceReroute;
- (void)guidanceManager:(id)arg1 announce:(id)arg2 isImportant:(bool)arg3 shortPromptType:(unsigned long long)arg4 stage:(unsigned long long)arg5 completionBlock:(id /* block */)arg6;
- (void)guidanceManager:(id)arg1 didProcessSpeechEvent:(id)arg2;
- (void)guidanceManager:(id)arg1 didUpdateNavTrayGuidance:(id)arg2;
...
- (id)init;
- (id)initWithRouteManager:(id)arg1 auditToken:(id)arg2;
...
- (void)locationTracker:(id)arg1 didSwitchToNewTransportTypeWithRoute:(id)arg2 rerouteReason:(unsigned long long)arg3 request:(id)arg4 response:(id)arg5;
...
- (unsigned long long)navigationCapabilities;
...
- (id)routeInfoForUpdateManager:(id)arg1 reason:(unsigned long long)arg2;
- (id)routeManager;
...
- (void)setNavigationCapabilities:(unsigned long long)arg1;
