...
- (void)_handleETAResponse:(id)arg1 forRouteInfo:(id)arg2 etaRoute:(id)arg3 reason:(unsigned long long)arg4;
- (bool)_hasAtLeastOneActiveSubscriber;
- (int)_purposeForReason:(unsigned long long)arg1;
- (void)_scheduleETATimerWithInterval:(double)arg1;
- (void)_sendETARequestWithParameters:(id)arg1;
- (void)_sendETARequestWithReason:(unsigned long long)arg1;
...
- (void)requestImmediateUpdateWithReason:(unsigned long long)arg1;
- (void)requestUpdateForETAUPosition:(id)arg1;
- (id)requestingAppIdentifier;
- (void)restartUpdateTimer;
- (void)resumeUpdateRequestsForSubscriber:(id)arg1;
- (void)sendFinalETAURequestWithReason:(unsigned long long)arg1;
