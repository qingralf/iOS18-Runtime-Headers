...
- (void)recordRouteCreationAction:(unsigned long long)arg1 request:(id)arg2 response:(id)arg3 error:(id)arg4 anchorPoints:(id)arg5 requestDate:(id)arg6 responseDate:(id)arg7;
...
- (void)startWritingTraceToPath:(id)arg1 traceType:(long long)arg2 withErrorHandler:(id /* block */)arg3;
