...
@property (nonatomic, readonly) NSData *eventInfo;
...
+ (id)_validTrafficIncidentAlertsForBannerTexts:(id)arg1 mainRouteInfo:(id)arg2 alternateRouteInfo:(id)arg3;
...
+ (id)validTrafficIncidentAlertsForETAUpdate:(id)arg1 alternateRouteInfo:(id)arg2;
+ (id)validTrafficIncidentAlertsForNewRoute:(id)arg1 alternateRouteInfo:(id)arg2;
