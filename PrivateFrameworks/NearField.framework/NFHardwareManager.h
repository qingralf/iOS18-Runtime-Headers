...
@interface NFHardwareManager : NSObject <NFHardwareManagerCallbacks, NFXPCServiceClientDelegate> {
...
+ (id)_sharedHardwareManagerWithNoUIWaitOnHWInit:(bool)arg1;
+ (id)sharedHardwareManager;
+ (void)sharedHardwareManager:(id /* block */)arg1;
+ (id)sharedHardwareManagerWithNoUI;
+ (void)sharedHardwareManagerWithNoUI:(id /* block */)arg1;
+ (void)sharedHardwareManagerWithOptions:(id)arg1 readyCompletion:(id /* block */)arg2;

- (void).cxx_destruct;
- (void)_initSEDictionaryWithSEInfoList:(id)arg1;
- (bool)_isHWReadyAndIfNotQueueClient:(id /* block */)arg1;
...
- (bool)currentInMetroStatus:(id*)arg1;
...
- (id)expressPassConfigsWithError:(id*)arg1;
...
- (id)getReaderProhibitTimerInfoSERmRunning:(bool*)arg1 hostRmRunning:(bool*)arg2 remainingInMs:(unsigned int*)arg3;
...
- (id)startCredentialSession:(id /* block */)arg1;
...
- (id)startHandoverHybridSessionWithCompletion:(id /* block */)arg1;
...
- (id)startReaderSessionWithAttributes:(id)arg1 completion:(id /* block */)arg2;
- (id)startSecureElementAndHCESession:(id /* block */)arg1;
- (id)startSecureElementAndHCESessionWithConfiguration:(id)arg1 completion:(id /* block */)arg2;
...
- (bool)triggerCrash:(unsigned short)arg1;
...
- (id)validateExpressPassCompatibilityWithConfig:(id)arg1 outError:(id*)arg2;
