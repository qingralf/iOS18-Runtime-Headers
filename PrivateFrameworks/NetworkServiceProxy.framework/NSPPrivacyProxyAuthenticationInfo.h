...
@property (nonatomic, retain) NSMutableArray *nonDefaultAttesters;
...
- (void)addNonDefaultAttesters:(id)arg1;
- (int)authType;
...
- (id)nonDefaultAttesters;
- (id)nonDefaultAttestersAtIndex:(unsigned long long)arg1;
...
- (void)setNonDefaultAttesters:(id)arg1;
