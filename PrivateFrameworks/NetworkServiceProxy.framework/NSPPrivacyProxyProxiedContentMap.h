...
@interface NSPPrivacyProxyProxiedContentMap : PBCodable <NSCopying> {
    ...
    bool  _isPrivacyProxy;
    bool  _matchExactHostnames;
...
- (void)setHasIsPrivacyProxy:(bool)arg1;
- (void)setHasMatchExactHostnames:(bool)arg1;
...
- (void)setIsPrivacyProxy:(bool)arg1;
- (void)setMatchExactHostnames:(bool)arg1;
