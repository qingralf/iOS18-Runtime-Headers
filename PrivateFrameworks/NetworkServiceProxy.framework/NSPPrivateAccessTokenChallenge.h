...
- (void).cxx_destruct;
- (id)challengeData;
- (id)initRSABlindSignatureChallengeWithIssuerName:(id)arg1 redemptionNonce:(id)arg2 originNames:(id)arg3;
- (id)initRateLimitedRSABlindSignatureChallengeWithIssuerName:(id)arg1 redemptionNonce:(id)arg2 originNames:(id)arg3;
