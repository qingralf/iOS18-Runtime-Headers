...
- (void).cxx_destruct;
- (void)addAuxiliaryAuthenticationData:(id)arg1 type:(unsigned long long)arg2 label:(id)arg3 cacheKey:(id)arg4;
- (void)addToken:(id)arg1 toCacheForFetcher:(id)arg2;
...
- (void)fetchKnownPrivateAccessTokenKeyWithFetcher:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)fetchPrivateAccessTokenPairWithFetcher:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)getPreferredObliviousProxyWithCompletionHandler:(id /* block */)arg1;
...
- (void)overridePreferredObliviousProxy:(id)arg1 completionHandler:(id /* block */)arg2;
