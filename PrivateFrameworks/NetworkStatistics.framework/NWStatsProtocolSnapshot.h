...
@interface NWStatsProtocolSnapshot : NWStatsSnapshot {
    ...
    unsigned long long  _deltaAccountingRxCompanionLinkBluetoothBytes;
    unsigned long long  _deltaAccountingTxCompanionLinkBluetoothBytes;
    ...
    bool  _interfaceCompanionLinkBluetooth;
...
@property (nonatomic, readonly) bool changedLocalPort;
...
@property (nonatomic, readonly) bool changedRemotePort;
...
@property (nonatomic, readonly) unsigned long long deltaAccountingRxCompanionLinkBluetoothBytes;
...
@property (nonatomic, readonly) unsigned long long deltaAccountingTxCompanionLinkBluetoothBytes;
...
@property (nonatomic, readonly) unsigned long long deltaRxCompanionLinkBluetoothBytes;
...
@property (nonatomic, readonly) unsigned long long deltaTxCompanionLinkBluetoothBytes;
...
@property (nonatomic, readonly) unsigned int ifnet_properties;
...
@property (nonatomic, readonly) bool interfaceCompanionLinkBluetooth;
...
@property (nonatomic, readonly) bool isKnownVPNFromKernel;
...
@property (nonatomic, readonly) unsigned long long rawDeltaRxCompanionLinkBluetoothBytes;
...
@property (nonatomic, readonly) unsigned long long rawDeltaTxCompanionLinkBluetoothBytes;
...
@property (nonatomic, readonly) unsigned long long rawRxCompanionLinkBluetoothBytes;
...
@property (nonatomic, readonly) unsigned long long rawTxCompanionLinkBluetoothBytes;
...
@property (nonatomic, readonly) unsigned long long rxCompanionLinkBluetoothBytes;
...
@property (nonatomic, readonly) NSString *savedAccumulatorCountsDescription;
...
@property (nonatomic, readonly) unsigned long long txCompanionLinkBluetoothBytes;
...
+ (void)initialize;
+ (void)logFlowAnomaly:(id)arg1 anomaly:(id)arg2;
...
- (unsigned long long)deltaAccountingRxCompanionLinkBluetoothBytes;
...
- (unsigned long long)deltaAccountingTxCompanionLinkBluetoothBytes;
...
- (unsigned long long)deltaRxCompanionLinkBluetoothBytes;
...
- (unsigned long long)deltaTxCompanionLinkBluetoothBytes;
