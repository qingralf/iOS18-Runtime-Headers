...
@property int delegateAttributionReason;
...
- (bool)isSilent;
- (bool)isTracker;
- (void)logAddressChangeOn:(unsigned long long)arg1 procName:(char *)arg2 variant:(id)arg3 oldAddress:(struct sockaddr { unsigned char x1; unsigned char x2; BOOL x3[14]; }*)arg4 newAddress:(struct sockaddr { unsigned char x1; unsigned char x2; BOOL x3[14]; }*)arg5;
...
- (bool)processExtendedUpdate:(struct nstat_msg_src_extended_item_hdr { unsigned int x1; unsigned int x2; }*)arg1 length:(long long)arg2 bluetoothCounts:(struct nstat_interface_counts { unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; }*)arg3;
- (bool)removed;
- (bool)removing;
- (bool)saveOldBTCounts:(struct nstat_interface_counts { unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; }*)arg1;
...
- (void)setAttribution:(id)arg1 derivation:(int)arg2 delegateName:(id)arg3 delegateDerivation:(int)arg4 extensionName:(id)arg5;
- (void)setAttributionReason:(int)arg1;
- (void)setCreationTimestamp:(double)arg1;
- (void)setDelegateAttributionReason:(int)arg1;
