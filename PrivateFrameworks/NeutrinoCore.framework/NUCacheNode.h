...
@property (nonatomic, readonly) bool wantsDependentJob;
...
- (id)inputGeometryForPipelineState:(id)arg1 error:(out id*)arg2;
- (id)inputNode;
...
- (id)outputGeometryForPipelineState:(id)arg1 error:(out id*)arg2;
- (id)persistentURL;
...
- (id)setupDependentJobFromRequest:(id)arg1 originalRequest:(id)arg2 error:(out id*)arg3;
