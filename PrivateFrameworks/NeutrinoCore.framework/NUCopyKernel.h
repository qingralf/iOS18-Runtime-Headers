...
+ (void)copyFromTexture:(id)arg1 toTexture:(id)arg2 atPoint:(struct { unsigned long long x1; unsigned long long x2; unsigned long long x3; })arg3 withCommandBuffer:(id)arg4;
+ (void)copyFromTexture:(id)arg1 toTexture:(id)arg2 withCommandBuffer:(id)arg3;
