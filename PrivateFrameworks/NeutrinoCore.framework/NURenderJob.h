...
- (id)evaluateRenderDependencies:(out id*)arg1;
- (id)extentPolicy;
- (void)fail:(id)arg1;
- (bool)failed;
...
- (id)renderImage:(id)arg1 into:(id)arg2 colorSpace:(id)arg3 roi:(id)arg4 imageSize:(struct { long long x1; long long x2; })arg5 alpha:(const unsigned long long*)arg6 error:(out id*)arg7;
