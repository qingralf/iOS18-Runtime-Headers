...
+ (id)gainMapFromLightMap:(id)arg1 base:(id)arg2 settings:(id)arg3;
+ (id)lightMapFromGainMap:(id)arg1 settings:(id)arg2;
+ (id)styleTransferApplyNodeWithInput:(id)arg1 thumbnail:(id)arg2 target:(id)arg3 settings:(id)arg4;
+ (id)styleTransferInterpolationNodeWithInputs:(id)arg1 weights:(id)arg2 settings:(id)arg3;
+ (id)styleTransferLearnNodeWithInput:(id)arg1 target:(id)arg2 settings:(id)arg3;
+ (id)styleTransferNodeWithInput:(id)arg1 target:(id)arg2 settings:(id)arg3;
+ (id)styleTransferThumbnailNodeWithInput:(id)arg1 settings:(id)arg2;

- (void).cxx_destruct;
- (id)HDROpticalScaleNode:(id)arg1 scale:(double)arg2;
...
- (id)gainMapHeadroomNode:(id)arg1 headroomOffset:(double)arg2;
- (id)gainMapNode:(id)arg1 contentHeadroom:(double)arg2 displayHeadroom:(double)arg3;
