...
@property (nonatomic, readonly) NSString *auxiliaryImageTypeString;
...
- (id)_addStyleReverseNode:(id)arg1 pipelineState:(id)arg2 sourceSettings:(id)arg3;
