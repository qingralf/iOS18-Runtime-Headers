...
@interface NUVideoCompositionInstruction : NSObject <AVVideoCompositionInstruction, NSCopying> {
    ...
    bool  _requestedWindowOfSamples;
...
@property (nonatomic, copy) NSString *mainTrackSourceIdentifier;
...
@property (nonatomic) bool requestedWindowOfSamples;
@property (nonatomic, readonly) NSArray *requiredSourceSampleDataTrackIDs; /* unknown property attribute: ? */
...
- (void)setMainTrackSourceIdentifier:(id)arg1;
...
- (void)setRequestedWindowOfSamples:(bool)arg1;
