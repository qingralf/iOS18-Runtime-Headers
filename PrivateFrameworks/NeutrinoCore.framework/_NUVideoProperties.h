...
@property (nonatomic, copy) NSDictionary *auxiliaryVideoTrackProperties;
@property (nonatomic, copy) AVAudioMixInputParameters *cinematicAudioMixInputParameters;
...
@property (nonatomic, copy) NSDictionary *trackMetadata;
@property (nonatomic, retain) NSURL *url;
@property (nonatomic, copy) NSArray *videoCorruptionInfo;

- (void).cxx_destruct;
- (id)auxiliaryVideoTrackProperties;
- (id)cinematicAudioMixInputParameters;
...
- (void)setAuxiliaryVideoTrackProperties:(id)arg1;
- (void)setCinematicAudioMixInputParameters:(id)arg1;
...
- (void)setUrl:(id)arg1;
- (void)setVideoCorruptionInfo:(id)arg1;
- (struct { long long x1; long long x2; })size;
- (id)trackGroups;
- (id)trackMetadata;
- (id)url;
- (id)videoCorruptionInfo;
