...
@interface NUMediaView : UIView <NUAVPlayerControllerDelegate, NUAVPlayerViewDelegate> {
    ...
    struct { 
        ...
        bool hasWillBeginDragging; 
        bool hasDidEndDragging; 
        bool hasDidEndDecelerating; 
        bool hasIsReadyForVideoPlayback; 
        bool hasDidStartPreparingVideo; 
        bool hasDidFinishPreparingVideo; 
        bool hasDidPlayToEnd; 
    ...
    bool  _hdrEnabled;
    NSLayoutYAxisAnchor * _imageBottomAnchor;
    NSLayoutXAxisAnchor * _imageLeftAnchor;
    NSLayoutXAxisAnchor * _imageRightAnchor;
    NSLayoutYAxisAnchor * _imageTopAnchor;
...
@property (nonatomic, readonly) NSLayoutYAxisAnchor *imageBottomAnchor;
...
@property (nonatomic, readonly) NSLayoutXAxisAnchor *imageLeftAnchor;
@property (nonatomic, readonly) NSLayoutXAxisAnchor *imageRightAnchor;
@property (nonatomic, readonly) NSLayoutYAxisAnchor *imageTopAnchor;
...
+ (double)currentEDRHeadroomForScreen:(id)arg1;
+ (double)maximumEDRHeadroomForScreen:(id)arg1;
