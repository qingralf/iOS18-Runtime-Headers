...
@interface NUMediaViewRenderer : NSObject <NUMediaPlayer> {
    ...
    bool  _livePhotoViewIsScrubbing;
...
@property (nonatomic, readonly) bool canUpdateDisplayHeadroom;
...
- (void)_coalesceBackfillRenderForComposition:(id)arg1;
...
- (void)_updateCoalescedBackfillRenderWithComposition:(id)arg1;
...
- (void)setLivePhotoViewIsScrubbing:(bool)arg1;
