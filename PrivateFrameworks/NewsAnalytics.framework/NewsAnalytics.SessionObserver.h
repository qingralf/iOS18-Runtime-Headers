...
@interface NewsAnalytics.SessionObserver : NSObject <FCBundleSubscriptionChangeObserver, FCCoreConfigurationObserving, FCNetworkReachabilityObserving, FCNewsletterSubscriptionObserver, FCShortcutListObserving, FCSubscriptionObserving, FCUserInfoObserving, NSSNewsAnalyticsSessionManagerObserving> {
    void aggregateStateModeProvider;
    void appExtensionCommunicator;
    void client;
    void cloudContext;
    void fsidProvider;
    void kind;
    void liveActivityCountDataProvider;
