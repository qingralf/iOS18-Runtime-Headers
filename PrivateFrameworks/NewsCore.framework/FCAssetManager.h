...
@interface FCAssetManager : NSObject <FCAssetHandleDelegate, FCCacheCoordinatorDelegate, FCCacheFlushing> {
    ...
    <FCResourceURLGenerating> * _resourceURLGenerator;
...
- (id)init;
- (id)initWithName:(id)arg1 directory:(id)arg2 keyManager:(id)arg3 avAssetFactory:(id)arg4 resourceURLGenerator:(id)arg5 networkBehaviorMonitor:(id)arg6 networkReachability:(id)arg7;
