...
- (id)generateURLForResourceID:(id)arg1;
- (id)init;
- (id)initWithContainerIdentifier:(id)arg1 productionEnvironment:(bool)arg2 networkBehaviorMonitor:(id)arg3 networkReachability:(id)arg4 configurationManager:(id)arg5;
