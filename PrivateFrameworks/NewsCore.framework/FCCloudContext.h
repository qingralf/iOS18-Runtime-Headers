...
@interface FCCloudContext : NSObject <FCAssetKeyManagerDelegate, FCBundleSubscriptionChangeObserver, FCCKDatabaseEncryptionDelegate, FCCacheFlushing, FCContentContext, FCContentVariantProviding, FCPrivateDataContext, FCTestingContext> {
    ...
    <FCFeedItemInventoryType> * _peopleAlsoReadInventory;
...
@property (nonatomic, readonly) NSURL *contentHostDirectoryURL;
...
@property (nonatomic, readonly) FCESLInventory *eslInventory;
...
@property (nonatomic, readonly) <FCFeedItemInventoryType> *peopleAlsoReadInventory;
@property (nonatomic, readonly) FCPeopleAlsoReadInventoryManager *peopleAlsoReadInventoryManager;
@property (nonatomic, readonly) FCPersonalizationData *personalizationData;
@property (nonatomic, readonly) <FCPPTContext> *pptContext;
@property (nonatomic, readonly) long long preferredContentVariant;
...
@property (nonatomic, readonly) FCShortcutCategoryList *shortcutCategoryList;
...
@property (nonatomic, readonly, copy) NSString *tabiModelsContentDirectoryLegacy;
@property (nonatomic, readonly, copy) NSString *tabiRequestsContentDirectory;
@property (nonatomic, readonly, copy) NSString *tabiResourcesContentDirectory;
@property (nonatomic, readonly, copy) NSString *tabiResourcesContentDirectoryLegacy;
...
- (id)initWithConfiguration:(id)arg1 configurationManager:(id)arg2 contentHostDirectory:(id)arg3 privateDataHostDirectory:(id)arg4 privateDataActionProvider:(id)arg5 networkBehaviorMonitor:(id)arg6 networkReachability:(id)arg7 appActivityMonitor:(id)arg8 desiredHeadlineFieldOptions:(unsigned long long)arg9 feedUsage:(long long)arg10 deviceIsiPad:(bool)arg11 backgroundTaskable:(id)arg12 privateDataSyncAvailability:(id)arg13 pptContext:(id)arg14 options:(long long)arg15;
- (id)initWithContentContext:(id)arg1 privateDataContext:(id)arg2 networkBehaviorMonitor:(id)arg3 networkReachability:(id)arg4 options:(long long)arg5;
...
- (id)peopleAlsoReadInventoryManager;
...
- (void)setTabiBasedUserVectorAggregateVectorProvider:(id)arg1;
- (void)setTranslationManager:(id)arg1;
- (void)setUserVectorManager:(id)arg1;
- (id)shortcutCategoryList;
- (id)shortcutList;
...
- (id)tabiModelsContentDirectoryLegacy;
- (id)tabiRequestsContentDirectory;
- (id)tabiResourcesContentDirectory;
- (id)tabiResourcesContentDirectoryLegacy;
- (id)tagController;
- (id)tagSettings;
