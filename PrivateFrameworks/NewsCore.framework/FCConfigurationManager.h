...
@interface FCConfigurationManager : NSObject <FCAppActivityObserving, FCAudioFeedConfigManager, FCCoreConfigurationManager, FCFeldsparIDProviderObserving, FCMagazinesConfigurationManager, FCNewsAppConfigurationManager, FCTodayFeedConfigurationManager> {
...
@property (nonatomic, readonly) <FCNewsAppConfiguration> *fetchedAppConfiguration; /* unknown property attribute: ? */
...
- (void)fetchAppWidgetConfigurationWithTodayLiteConfig:(bool)arg1 additionalFields:(id)arg2 completion:(id /* block */)arg3;
...
- (void)fetchTodayFeedConfigurationIfNeededWithCompletionQueue:(id)arg1 feedType:(unsigned long long)arg2 formatVersion:(id)arg3 cachePolicy:(id)arg4 networkActivityBlock:(id /* block */)arg5 completion:(id /* block */)arg6;
...
- (id)initWithContextConfiguration:(id)arg1 contentHostDirectoryFileURL:(id)arg2 feldsparIDProvider:(id)arg3 appShortVersionString:(id)arg4 buildNumberString:(id)arg5 networkBehaviorMonitor:(id)arg6 appActivityMonitor:(id)arg7 applicationState:(unsigned long long)arg8;
