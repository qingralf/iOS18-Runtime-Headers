...
@property (nonatomic, retain) FCNotificationItemListRecordSource *notificationItemListRecordSource;
@property (nonatomic, retain) FCNotificationItemRecordSource *notificationItemRecordSource;
...
- (id)notificationItemListRecordSource;
- (id)notificationItemRecordSource;
...
- (void)setNotificationItemListRecordSource:(id)arg1;
- (void)setNotificationItemRecordSource:(id)arg1;
