...
- (id)initWithAVAssetIDs:(id)arg1;
- (id)initWithAVAssetIDs:(id)arg1 avAssetKeyIDs:(id)arg2;
- (id)initWithAVAssetKeyIDs:(id)arg1;
- (id)initWithAssetURLs:(id)arg1;
- (id)initWithAssetURLs:(id)arg1 assetWrappingKeyIDs:(id)arg2;
- (id)initWithAssetURLs:(id)arg1 assetWrappingKeyIDs:(id)arg2 recordIDs:(id)arg3 avAssetIDs:(id)arg4 avAssetKeyIDs:(id)arg5;
- (id)initWithAssetWrappingKeyIDs:(id)arg1;
