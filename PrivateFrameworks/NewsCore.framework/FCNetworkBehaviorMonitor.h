...
@interface FCNetworkBehaviorMonitor : NSObject <FCNetworkBehaviorMonitor, FCNetworkReachabilityObserving, FCOperationThrottlerDelegate> {
...
- (id)initWithOptions:(long long)arg1 cacheDirectory:(id)arg2;
