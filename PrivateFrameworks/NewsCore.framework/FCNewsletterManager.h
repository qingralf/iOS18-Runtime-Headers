...
@property (nonatomic, copy) NSString *activeiTunesAccountName;
...
@property (nonatomic, retain) NSArray *cachedNewsletters;
...
- (void)setActiveiTunesAccountName:(id)arg1;
- (void)setCacheExpiration:(id)arg1;
- (void)setCachedNewsletters:(id)arg1;
...
- (void)unsubscribe;
- (void)updateCacheWithNewsletterString:(id)arg1 includeArray:(id)arg2 newsletters:(id)arg3;
