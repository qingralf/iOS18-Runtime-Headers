...
@property (nonatomic, readonly) unsigned long long aLaCarteArticleSoftPaywallPosition;
@property (nonatomic, readonly) NSString *appLaunchUpsellArticleID;
@property (nonatomic, readonly) long long appLaunchUpsellBehaviorFlags;
@property (nonatomic, readonly) unsigned long long appLaunchUpsellBundleTrialVisibility;
@property (nonatomic, readonly) NSDate *appLaunchUpsellCampaignEndDate;
@property (nonatomic, readonly) NSString *appLaunchUpsellCampaignID;
@property (nonatomic, readonly) NSDate *appLaunchUpsellCampaignStartDate;
...
@property (nonatomic, readonly) long long appLaunchUpsellPresentationDelay;
...
@property (nonatomic, readonly) NSDictionary *offeredBundlePurchaseIDsMap;
@property (nonatomic, readonly) NSString *osloAbandonmentUpsellArticleID;
@property (nonatomic, readonly) NSString *osloAbandonmentUpsellInstanceID;
@property (nonatomic, readonly) long long osloAbandonmentUpsellMaxPresentationCount;
@property (nonatomic, readonly) long long osloAbandonmentUpsellQuiescenceInterval;
...
@property (nonatomic, readonly) NSString *todayMastheadPaywallConfiguration;
...
- (void).cxx_destruct;
- (unsigned long long)aLaCarteArticleSoftPaywallPosition;
- (id)appLaunchUpsellArticleID;
- (long long)appLaunchUpsellBehaviorFlags;
- (unsigned long long)appLaunchUpsellBundleTrialVisibility;
- (id)appLaunchUpsellCampaignEndDate;
- (id)appLaunchUpsellCampaignID;
- (id)appLaunchUpsellCampaignStartDate;
...
- (long long)appLaunchUpsellPresentationDelay;
...
- (id)offeredBundlePurchaseIDsMap;
- (id)osloAbandonmentUpsellArticleID;
- (id)osloAbandonmentUpsellInstanceID;
- (long long)osloAbandonmentUpsellMaxPresentationCount;
- (long long)osloAbandonmentUpsellQuiescenceInterval;
- (id)paidBadgeTitle;
...
- (id)todayMastheadPaywallConfiguration;
