...
@interface FCPersonalizationData : FCPrivateDataController <FCCoreConfigurationObserving, FCOperationThrottlerDelegate, FCPersonalizationDataGeneratorType, FCPersonalizationDataSource, FCReadonlyAggregateStoreProviderType> {
