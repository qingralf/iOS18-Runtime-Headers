...
- (void)setPeopleAlsoReadBaselineScore:(double)arg1;
- (void)setPeopleAlsoReadConditionalScoreCoefficient:(double)arg1;
- (void)setPeopleAlsoReadScoreCoefficient:(double)arg1;
