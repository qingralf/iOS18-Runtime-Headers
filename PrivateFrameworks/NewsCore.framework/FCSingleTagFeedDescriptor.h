...
- (id)initWithContext:(id)arg1 tag:(id)arg2 feedConfiguration:(unsigned long long)arg3 referringFeedItemIdentifier:(id)arg4;
...
- (id)initWithContext:(id)arg1 tag:(id)arg2 sortMethod:(long long)arg3 filterOptions:(unsigned long long)arg4 personalizationConfigurationSet:(long long)arg5 feedConfiguration:(unsigned long long)arg6 referringFeedItemIdentifier:(id)arg7;
...
- (void)setReferringFeedItemIdentifier:(id)arg1;
- (void)setTag:(id)arg1;
- (id)tag;
- (id)theme;
