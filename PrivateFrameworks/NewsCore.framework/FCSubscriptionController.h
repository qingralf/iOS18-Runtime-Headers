...
- (id)ignoredTagIDs;
- (id)init;
- (id)initWithSubscriptionList:(id)arg1 tagController:(id)arg2 puzzleTypeController:(id)arg3 notificationController:(id)arg4 purchaseProvider:(id)arg5 configurationManager:(id)arg6 appConfigurationManager:(id)arg7 appActivityMonitor:(id)arg8 userInfo:(id)arg9;
...
- (void)reorderSubscriptionOrderForOrderedIdentifiers:(id)arg1;
