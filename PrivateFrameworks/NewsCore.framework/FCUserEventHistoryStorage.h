...
@property (nonatomic, retain) <FCNewsAppConfigurationManager> *configurationManager;
...
- (id)initWithPrivateDataDirectory:(id)arg1 configurationManager:(id)arg2;
