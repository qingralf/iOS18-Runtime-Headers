...
@property (nonatomic, readonly) bool puzzleNotificationsEnabled;
@property (nonatomic, readonly, copy) NSDate *puzzleNotificationsLastChangedDate;
@property (nonatomic, copy) NSDate *puzzleStatsStartDate;
...
@property (nonatomic, retain) NSDate *sportsFavoritesLastModifiedDate;
...
- (void)setPuzzleNotificationsEnabled:(bool)arg1 userTriggered:(bool)arg2;
- (void)setPuzzleStatsStartDate:(id)arg1;
- (void)setPuzzleTypeSettings:(id)arg1;
- (void)setShortcutsOnboardingState:(long long)arg1;
- (void)setSportsFavoritesLastModifiedDate:(id)arg1;
...
- (id)sportsFavoritesLastModifiedDate;
