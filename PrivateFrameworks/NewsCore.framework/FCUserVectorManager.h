...
@interface FCUserVectorManager : NSObject <FCAppActivityObserving> {
    ...
    <FCUserVectorAggregateVectorProvider> * _tabiBasedAggregateVectorProvider;
...
@property (nonatomic, retain) <FCUserVectorAggregateVectorProvider> *tabiBasedAggregateVectorProvider;
...
- (void)setTabiBasedAggregateVectorProvider:(id)arg1;
- (void)setUserVector:(id)arg1;
- (id)tabiBasedAggregateVectorProvider;
- (id)userVector;
