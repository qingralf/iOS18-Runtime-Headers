...
@interface NTHeadline : NSObject <FCFeedTransformationItem, NTFeedTransformationItem, NTHeadlineProviding> {
    ...
    NSString * _storyType;
    NSString * _storyTypeColorDark;
    NSString * _storyTypeColorLight;
...
@property (nonatomic, copy) NSString *storyTypeColorDark;
@property (nonatomic, copy) NSString *storyTypeColorLight;
...
- (void)setStoryTypeColorDark:(id)arg1;
- (void)setStoryTypeColorLight:(id)arg1;
...
- (id)sourceTagID;
- (id)storyType;
- (id)storyTypeColorDark;
- (id)storyTypeColorLight;
