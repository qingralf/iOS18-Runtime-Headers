...
@property (nonatomic, readonly) <NTTodayBannerValidator> *todayBannerValidator;
...
- (void)_fetchTodayModuleDescriptorsWithContentRequest:(id)arg1 requireRefreshedAppConfig:(bool)arg2 qualityOfService:(long long)arg3 completion:(id /* block */)arg4;
- (id)contentContext;
...
- (id)init;
- (id)initWithFetchDescriptor:(id)arg1 feedPersonalizerFactory:(id)arg2 todayBannerValidator:(id)arg3 privateDataStorage:(id)arg4 contentContext:(id)arg5 fetchQueue:(id)arg6;
