...
@property (nonatomic, retain) COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleConversionStats *conversionStats;
@property (nonatomic, retain) NSString *coverAccentColor;
@property (nonatomic, retain) NSString *coverArticleID;
@property (nonatomic) double coverAspectRatio;
@property (nonatomic, retain) NSString *coverBackgroundColor;
@property (nonatomic, retain) NSString *coverImageURL;
@property (nonatomic, retain) NSString *coverPrimaryColor;
@property (nonatomic, retain) NSString *coverTextColor;
...
@property (nonatomic, retain) NTPBDate *sortDate;
...
- (void)setCoverAccentColor:(id)arg1;
...
- (void)setCoverTextColor:(id)arg1;
...
- (id)generateMetadataJSONAssetHandleWithAssetManager:(id)arg1;
