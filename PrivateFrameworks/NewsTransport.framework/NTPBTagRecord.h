...
@property (nonatomic, readonly) bool hasSportsLogoAltImageCompactURL;
@property (nonatomic, readonly) bool hasSportsLogoAltImageLargeURL;
@property (nonatomic, readonly) bool hasSportsLogoAltImageURL;
...
@property (nonatomic, retain) NSString *sportsLogoAltImageCompactURL;
@property (nonatomic, retain) NSString *sportsLogoAltImageLargeURL;
@property (nonatomic, retain) NSString *sportsLogoAltImageURL;
...
- (long long)propertyFlagsLocalized;
...
- (void)setHasPropertyFlagsLocalized:(bool)arg1;
...
- (void)setPropertyFlagsLocalized:(long long)arg1;
...
- (void)setSportsLogoAltImageCompactURL:(id)arg1;
- (void)setSportsLogoAltImageLargeURL:(id)arg1;
- (void)setSportsLogoAltImageURL:(id)arg1;
...
- (id)sportsData;
- (id)sportsLogoAltImageCompactURL;
- (id)sportsLogoAltImageLargeURL;
- (id)sportsLogoAltImageURL;
...
- (id)generateSportsLogoAltImageAssetHandleWithAssetManager:(id)arg1;
- (id)generateSportsLogoAltImageCompactAssetHandleWithAssetManager:(id)arg1;
- (id)generateSportsLogoAltImageLargeAssetHandleWithAssetManager:(id)arg1;
