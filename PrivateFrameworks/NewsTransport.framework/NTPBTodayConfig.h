...
@property (nonatomic, readonly) bool hasWidgetBannerConfig;
...
@property (nonatomic, retain) NTPBTodayBannerConfig *widgetBannerConfig;
...
- (void)setWidgetBannerConfig:(id)arg1;
