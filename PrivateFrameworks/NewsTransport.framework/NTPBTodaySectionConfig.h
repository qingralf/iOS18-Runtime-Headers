...
@property (nonatomic) bool hasPaywalledStoriesMaxCount;
...
- (id)nameColorDark;
- (id)nameColorLight;
- (unsigned long long)paywalledStoriesMaxCount;
...
- (void)setHasPaywalledStoriesMaxCount:(bool)arg1;
...
- (void)setPaywalledStoriesMaxCount:(unsigned long long)arg1;
