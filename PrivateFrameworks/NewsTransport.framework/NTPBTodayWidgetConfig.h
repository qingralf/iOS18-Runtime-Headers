...
@interface NTPBTodayWidgetConfig : PBCodable <NSCopying> {
    ...
    bool  _widgetBackgroundInteractionEnabled;
...
@property (nonatomic) bool hasWidgetBackgroundInteractionEnabled;
...
@property (nonatomic) bool widgetBackgroundInteractionEnabled;
...
- (void)setHasWidgetBackgroundInteractionEnabled:(bool)arg1;
...
- (void)setWidgetBackgroundInteractionEnabled:(bool)arg1;
