...
@interface NUArticleContainerViewController : UIViewController <NUArticleBarButtonItemManagerDelegate, NULoadingDelegate, NUNavigationControl, NUPageViewControllerDataSource, NUPageViewControllerDelegate, UIPageViewControllerDataSource, UIPageViewControllerDelegate> {
