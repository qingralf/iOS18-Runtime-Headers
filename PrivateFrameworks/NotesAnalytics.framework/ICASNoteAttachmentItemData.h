...
@interface ICASNoteAttachmentItemData : NSObject <AADataEventType> {
    NSNumber * _totalCountOfAudioAttachments;
    NSNumber * _totalCountOfAudioAttachmentsRecordedInNotes;
    NSNumber * _totalCountOfAudioAttachmentsWithAppendedAudio;
    NSNumber * _totalCountOfNotesWithAttachmentAudio;
    NSNumber * _totalCountOfNotesWithAttachmentAudioSummary;
    NSNumber * _totalCountOfNotesWithAttachmentAudioTranscript;
...
@property (nonatomic, readonly) NSNumber *totalCountOfAudioAttachments;
@property (nonatomic, readonly) NSNumber *totalCountOfAudioAttachmentsRecordedInNotes;
@property (nonatomic, readonly) NSNumber *totalCountOfAudioAttachmentsWithAppendedAudio;
@property (nonatomic, readonly) NSNumber *totalCountOfNotesWithAttachmentAudio;
@property (nonatomic, readonly) NSNumber *totalCountOfNotesWithAttachmentAudioSummary;
@property (nonatomic, readonly) NSNumber *totalCountOfNotesWithAttachmentAudioTranscript;
...
- (void).cxx_destruct;
- (id)initWithTotalCountOfNotesWithAttachmentDocScan:(id)arg1 totalCountOfNotesWithAttachmentInlineDrawingV1:(id)arg2 totalCountOfNotesWithAttachmentInlineDrawingV2:(id)arg3 totalCountOfNotesWithAttachmentPaperKit:(id)arg4 totalCountOfNotesWithAttachmentFullscreenDrawing:(id)arg5 totalCountOfNotesWithAttachmentTables:(id)arg6 totalCountOfNotesWithAttachmentOther:(id)arg7 totalCountOfNotesWithAttachmentRichUrl:(id)arg8 totalCountOfNotesWithAttachmentMapLink:(id)arg9 totalCountOfNotesWithAttachmentDeepLink:(id)arg10 totalCountOfNotesWithPaperDocument:(id)arg11 totalCountOfNotesWithPdfDocument:(id)arg12 totalCountOfNotesWithNoteLinks:(id)arg13 totalCountOfNotesWithFolderLinks:(id)arg14 totalCountOfNotesWithAttachmentAudio:(id)arg15 totalCountOfAudioAttachments:(id)arg16 totalCountOfAudioAttachmentsRecordedInNotes:(id)arg17 totalCountOfAudioAttachmentsWithAppendedAudio:(id)arg18 totalCountOfNotesWithAttachmentAudioTranscript:(id)arg19 totalCountOfNotesWithAttachmentAudioSummary:(id)arg20;
- (id)toDict;
- (id)totalCountOfAudioAttachments;
- (id)totalCountOfAudioAttachmentsRecordedInNotes;
- (id)totalCountOfAudioAttachmentsWithAppendedAudio;
- (id)totalCountOfNotesWithAttachmentAudio;
- (id)totalCountOfNotesWithAttachmentAudioSummary;
- (id)totalCountOfNotesWithAttachmentAudioTranscript;
