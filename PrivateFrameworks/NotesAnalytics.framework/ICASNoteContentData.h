...
@interface ICASNoteContentData : NSObject <AADataEventType> {
    ...
    NSNumber * _countOfAudioAttachments;
...
@property (nonatomic, readonly) NSNumber *countOfAudioAttachments;
