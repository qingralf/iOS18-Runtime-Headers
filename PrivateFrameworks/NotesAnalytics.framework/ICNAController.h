...
@interface ICNAController : ICNAOptedInObject <AAEndpointType> {
    ...
    NSMutableDictionary * _endSessionBackgroundTaskIdentifiersByWindowSceneIdentifier;
...
@property (nonatomic, retain) NSMutableDictionary *endSessionBackgroundTaskIdentifiersByWindowSceneIdentifier;
...
- (id)endSessionBackgroundTaskIdentifiersByWindowSceneIdentifier;
- (void)endSessionSynchronously:(bool)arg1 endReason:(long long)arg2;
- (void)endSessionSynchronously:(bool)arg1 forSessionType:(long long)arg2 endReason:(long long)arg3;
- (void)endSessionSynchronously:(bool)arg1 forSessionType:(long long)arg2 endReason:(long long)arg3 successHandler:(id /* block */)arg4;
- (void)endWindowSceneSessionSynchronously:(bool)arg1 forSessionType:(long long)arg2 endReason:(long long)arg3 windowScene:(id)arg4;
- (void)endWindowSceneSessionSynchronously:(bool)arg1 forSessionType:(long long)arg2 endReason:(long long)arg3 windowScene:(id)arg4 successHandler:(id /* block */)arg5;
- (void)enterGroupWithSubtracker:(id)arg1;
- (id)flushManager;
...
- (bool)killEndSessionBackgroundTaskIfNecessaryForWindowScene:(id)arg1;
- (void)leaveGroupWithSubtracker:(id)arg1;
- (void)leaveGroupWithSubtracker:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)pushSessionLevelDataIntoSessionManager:(id)arg1 withSessionType:(long long)arg2;
- (void)pushSessionLevelDataIntoSessionManager:(id)arg1 withSessionType:(long long)arg2 isGlobalSession:(bool)arg3;
...
- (id)sessionDataWithType:(long long)arg1 isGlobalSession:(bool)arg2;
...
- (void)setEndSessionBackgroundTaskIdentifiersByWindowSceneIdentifier:(id)arg1;
...
- (void)startSessionWithReferralURL:(id)arg1 referralApplication:(id)arg2 startingSessionType:(long long)arg3;
- (void)startSessionWithType:(long long)arg1;
- (void)startWindowSceneSessionWithType:(long long)arg1 windowScene:(id)arg2 successHandler:(id /* block */)arg3;
