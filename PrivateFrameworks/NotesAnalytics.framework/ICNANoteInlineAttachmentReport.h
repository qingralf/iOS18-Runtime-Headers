...
@interface ICNANoteInlineAttachmentReport : NSObject {
    unsigned long long  _countOfCalculateGraphExpressions;
    unsigned long long  _countOfCalculateResults;
...
- (unsigned long long)countOfCalculateGraphExpressions;
- (unsigned long long)countOfCalculateResults;
...
- (void)setCountOfCalculateGraphExpressions:(unsigned long long)arg1;
- (void)setCountOfCalculateResults:(unsigned long long)arg1;
