...
@interface ICNASnapshotReporter : ICNAEventReporter {
    ...
    NSNumber * _miniSnapshotBackgroundTaskIdentifier;
...
@property (nonatomic, retain) NSNumber *miniSnapshotBackgroundTaskIdentifier;
...
- (id)miniSnapshotBackgroundTaskIdentifier;
- (id)modernContext;
...
- (void)setMiniSnapshotBackgroundTaskIdentifier:(id)arg1;
