...
@interface ICAccessibilityCustomRotorController : NSObject {
    ...
    UIAccessibilityCustomRotor * _storedCalculationErrorsRotor;
    UIAccessibilityCustomRotor * _storedCalculationResultRotor;
...
@property (nonatomic, readonly) UIAccessibilityCustomRotor *calculationErrorsRotor;
@property (nonatomic, readonly) UIAccessibilityCustomRotor *calculationResultsRotor;
...
@property (nonatomic, retain) UIAccessibilityCustomRotor *storedCalculationErrorsRotor;
@property (nonatomic, retain) UIAccessibilityCustomRotor *storedCalculationResultRotor;
...
- (void).cxx_destruct;
- (id)attachmentsRotor;
- (id)calculationErrorsRotor;
- (id)calculationResultsRotor;
- (id)checklistRotor;
- (id)linksRotor;
- (id)mentionsRotor;
...
- (void)setStoredCalculationErrorsRotor:(id)arg1;
- (void)setStoredCalculationResultRotor:(id)arg1;
...
- (id)storedCalculationErrorsRotor;
- (id)storedCalculationResultRotor;
