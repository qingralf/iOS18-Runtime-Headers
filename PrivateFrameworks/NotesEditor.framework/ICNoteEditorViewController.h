...
@interface ICNoteEditorViewController : ICNoteEditorBaseViewController <ICAccessibilityChildReparentingController, ICAddCollaboratorsActivityDelegate, ICAttachmentInsertionDelegate, ICAttachmentViewDelegate, ICAudioBarViewControllerDelegate, ICAuxiliaryTextViewHosting, ICBaseTextViewDelegate, ICCalculateGraphingControllerInserting, ICDocCamViewControllerDelegate, ICHandwritingDebugDelegate, ICHashtagAnalyticsDelegate, ICHashtagViewControllerDelegate, ICInkPaletteControllerDelegate, ICInkToolPickerResponderDelegate, ICLinkAcceleratorControllerDelegate, ICLinkEditorDelegate, ICLinkMenuDelegate, ICManagedObjectContextChangeControllerDelegate, ICMentionsAnalyticsDelegate, ICNoteEditing, ICNoteEditorInputAccessoryViewDelegate, ICNoteEditorNavigationItemConfigurationDataSource, ICNoteEditorNavigationItemConfigurationDelegate, ICNoteFormattingViewControllerDataSource, ICNoteFormattingViewControllerDelegate, ICRemoteDocCamViewControllerDelegate, ICStyleSelectorDelegate, NSUserActivityDelegate, NotesQuickLookActivityItemDelegate, PKRulerHostingDelegate, PKScribbleInteractionDelegate, PTSettingsKeyObserver, UIDocumentPickerDelegate, UIGestureRecognizerDelegate, UINavigationControllerDelegate, UIPopoverPresentationControllerDelegate, UITextViewDelegate, UITextViewDrawingDelegate, _UIViewBoundingPathChangeObserver> {
    ...
    ICAudioAttachmentEditorCoordinator * _audioAttachmentEditorCoordinator;
    ICAudioBarViewController * _audioBarViewController;
    ICNAEventReporter * _audioEventReporter;
    ...
    ICCalculateGraphingController * _calculateGraphingController;
    ICCalculateRecognitionController * _calculateRecognitionController;
    ICCalculateScrubberController * _calculateScrubberController;
    ...
    ICNAFindResultExposureReporter * _findResultReporter;
    ICHandwritingDebugPresenter * _handwritingDebugPresenter;
    ...
    bool  _ignoresTaps;
    bool  _inStartEditingForWritingTools;
    ...
    ICManagedObjectContextChangeController * _inlineAttachmentChangeController;
    ...
    NSUndoManager * _magicGenerativePlaygroundUndoManager;
    ...
    ICNoteFormattingViewController * _noteFormattingController;
    ...
    ICPaperTextAttachmentManager * _paperTextAttachmentManager;
...
@property (nonatomic, retain) ICAudioAttachmentEditorCoordinator *audioAttachmentEditorCoordinator;
@property (nonatomic, retain) ICAudioBarViewController *audioBarViewController;
@property (nonatomic, retain) ICNAEventReporter *audioEventReporter;
...
@property (nonatomic, retain) ICCalculateGraphingController *calculateGraphingController;
@property (nonatomic, retain) ICCalculateRecognitionController *calculateRecognitionController;
@property (nonatomic, retain) ICCalculateScrubberController *calculateScrubberController;
...
@property (nonatomic, retain) ICNAFindResultExposureReporter *findResultReporter;
@property (nonatomic, retain) ICHandwritingDebugPresenter *handwritingDebugPresenter;
...
@property (nonatomic) bool inStartEditingForWritingTools;
...
@property (nonatomic, retain) ICManagedObjectContextChangeController *inlineAttachmentChangeController;
...
@property (nonatomic, readonly) bool isPasswordEntryShowing;
...
@property (nonatomic, readonly) bool isShowingAudioInspector;
@property (nonatomic, readonly) bool isShowingMiniPlayer;
...
@property (nonatomic, retain) NSUndoManager *magicGenerativePlaygroundUndoManager;
...
@property (nonatomic, retain) ICNoteFormattingViewController *noteFormattingController;
@property (nonatomic, readonly) ICNoteFormattingViewController *noteFormattingControllerCreateIfNecessary;
...
@property (nonatomic, retain) ICPaperTextAttachmentManager *paperTextAttachmentManager;
...
@property (nonatomic, readonly) long long uniqueCollapsibleSectionAffordanceExposures;
@property (nonatomic, readonly) long long uniqueCollapsibleSectionAffordanceUsages;
...
@property (nonatomic, readonly) bool usesCustomTransition;
...
- (void)_textViewDidEndUndoCoalescingForWritingTools:(id)arg1;
- (void)_textViewWillBeginUndoCoalescingForWritingTools:(id)arg1;
- (id)acceleratorHostingView;
- (id)acceleratorHostingViewController;
...
- (id)audioAttachmentEditorCoordinator;
- (id)audioBarViewController;
- (void)audioBarViewControllerDone:(id)arg1;
- (id)audioEventReporter;
- (void)audioEventReporterLostSession:(id)arg1;
- (void)audioFindInTranscript:(id)arg1;
- (void)audioPlaybackPlayNotification:(id)arg1;
- (void)audioRecordingStarted:(id)arg1;
- (void)audioRecordingStopped:(id)arg1;
- (void)audioTranscriptInteraction:(id)arg1;
...
- (void)calculateDocumentControllerDidUpdateHighlights:(id)arg1;
- (id)calculateGraphingController;
- (id)calculateRecognitionController;
- (id)calculateScrubberController;
- (bool)canAddToTags;
...
- (void)didUpdateSearchQueryInFindInteraction:(id)arg1;
...
- (id)inlineAttachmentChangeController;
...
- (id)magicGenerativePlaygroundUndoManager;
...
- (id)nibBundle;
- (void)noteAnalyticsAddAttachment:(id)arg1;
- (id)noteAndFolderChangeController;
- (id)noteContext;
- (void)noteDecryptedStatusDidChange:(id)arg1;
- (void)noteDidChangeCalculatePreviewBehaviorNotification:(id)arg1;
...
- (void)noteEditorNavigationItemConfiguration:(id)arg1 showWritingToolsFromBarButtonItem:(id)arg2;
...
- (void)noteEditorNavigationItemConfiguration:(id)arg1 toggleSidebarFromBarButtonItem:(id)arg2;
...
- (id)noteExporter;
- (id)noteFormattingController;
- (id)noteFormattingControllerCreateIfNecessary;
- (void)noteFormattingDidFinish:(id)arg1;
- (void)noteFormattingNeedsUpdate:(id)arg1;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })notesQuickLookActivityItem:(id)arg1 rectForPreviewItem:(id)arg2 inView:(id*)arg3 previewController:(id)arg4;
- (id)notesQuickLookActivityItem:(id)arg1 transitionViewForPreviewItem:(id)arg2 previewController:(id)arg3;
- (void)observeAttachmentDeleted:(id)arg1;
- (void)observeDrawingConverted:(id)arg1;
...
- (void)openLinkEditorForLinkTextItem:(id)arg1;
- (id)originalEndOfNote;
- (id)paletteResponder;
- (void)paperKitBundleDidMerge:(id)arg1;
- (id)paperLinkBarTopConstraint;
- (id)paperLinkBarViewController;
- (id)paperTextAttachmentManager;
- (void)paperTextAttachmentManager:(id)arg1 beginTrackingUndoManager:(id)arg2;
- (void)paperTextAttachmentManager:(id)arg1 endTrackingUndoManager:(id)arg2;
...
- (void)presentRecordingStoppedAlertForNoteIfNeeded:(id)arg1;
- (id)presentingViewControllerForStyleSelector:(id)arg1;
...
- (void)removeLinkForLinkTextItem:(id)arg1;
...
- (void)setAudioAttachmentEditorCoordinator:(id)arg1;
- (void)setAudioBarViewController:(id)arg1;
- (void)setAudioEventReporter:(id)arg1;
...
- (void)setCalculateGraphingController:(id)arg1;
- (void)setCalculateRecognitionController:(id)arg1;
- (void)setCalculateScrubberController:(id)arg1;
...
- (void)setFindResultReporter:(id)arg1;
- (void)setFixedWidthStyle:(id)arg1;
- (void)setHandwritingDebugPresenter:(id)arg1;
...
- (void)setInStartEditingForWritingTools:(bool)arg1;
...
- (void)setInlineAttachmentChangeController:(id)arg1;
...
- (void)setMagicGenerativePlaygroundUndoManager:(id)arg1;
...
- (void)setNoteFormattingController:(id)arg1;
...
- (void)setPaperTextAttachmentManager:(id)arg1;
...
- (void)showHandwritingDebug:(bool)arg1;
...
- (bool)styleSelectorSelectionHasBlockQuote:(id)arg1;
- (bool)styleSelectorShouldDisableTextStyles:(id)arg1;
- (bool)styleSelectorShouldUseCompactTopInset:(id)arg1;
- (void)styleSelectorToggleBlockQuote:(id)arg1;
- (void)styleSelectorWillShowInlineMenu:(id)arg1;
...
- (id)textView:(id)arg1 writingToolsIgnoredRangesInEnclosingRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2;
...
- (void)updateContentViewBezelsStandalone:(bool)arg1 needsAdditionalBottomMargin:(bool)arg2 needsAdditionalLeadingMargin:(bool)arg3 force:(bool)arg4;
