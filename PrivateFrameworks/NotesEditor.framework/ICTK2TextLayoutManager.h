...
- (id)newViewProviderForTextAttachment:(id)arg1 parentView:(id)arg2 location:(id)arg3;
...
- (Class)viewProviderClassForTextAttachment:(id)arg1;
- (id)viewProviderForTextAttachment:(id)arg1 parentView:(id)arg2 location:(id)arg3;
- (id)viewProviderForTextAttachment:(id)arg1 parentView:(id)arg2 location:(id)arg3 ignoreCache:(bool)arg4;
