...
@interface ICTextView : ICBaseTextView <ICNoteEditorUserTitleViewDelegate, ICTextControllerDelegate, ICTextFindingDataSource> {
    ...
    ICTextFindingCoordinator * _textFindingCoordinator;
...
@property (nonatomic, retain) ICTextFindingCoordinator *textFindingCoordinator;
...
- (void)dictationControllerDidPause:(id)arg1;
- (void)dictationControllerDidResume:(id)arg1;
...
- (void)keyboardDidBeginDictation:(id)arg1;
...
- (void)setInputAccessoryViewVisible:(bool)arg1;
...
- (void)setTextFindingCoordinator:(id)arg1;
