...
+ (id)NotesAppIDForNoteMentionedInURL:(id)arg1;
...
+ (id)appURLForTranscriptionDonationForAttachmentIdentifier:(id)arg1 isPositive:(bool)arg2;
+ (id)attachmentForTranscriptionDonationURL:(id)arg1 managedObjectContext:(id)arg2;
+ (id)attachmentIdentifierFromQuickNoteURL:(id)arg1;
+ (id)contentOffsetFromQuickNoteURL:(id)arg1;
+ (id)detectedURLInString:(id)arg1 allowNonLinkCharacters:(bool)arg2;
...
+ (bool)isTranscriptionDonationURL:(id)arg1;
+ (bool)isTranscriptionDonationURLPositive:(id)arg1;
