...
@interface ICAttachment : ICBaseAttachment <ICAttachmentObject, ICCloudObject, ICSearchIndexable, ICTableObject> {
    NSURL * _URL;
...
@property (nonatomic, readonly) NSString *accessibilityDescriptionForType;
...
@property (nonatomic, readonly) bool isVisibleTable;
...
@property (nonatomic, readonly) bool shouldShowInlineFormFillingBanner;
