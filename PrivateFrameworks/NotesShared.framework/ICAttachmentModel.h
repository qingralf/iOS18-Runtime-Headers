...
@property (nonatomic, readonly) bool tooLargeForPreviewGeneration;
...
- (void)replaceAllOccurrencesOfQueryString:(id)arg1 ignoreCase:(bool)arg2 wholeWords:(bool)arg3 withText:(id)arg4;
- (void)replaceTextFindingResult:(id)arg1 withReplacementString:(id)arg2;
