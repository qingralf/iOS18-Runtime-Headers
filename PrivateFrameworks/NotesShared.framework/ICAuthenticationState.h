...
@interface ICAuthenticationState : NSObject <NSCopying> {
    ...
    <NSObject> * _passphraseChangeObserver;
}

@property (getter=isAuthenticated, nonatomic, readonly) bool authenticated;
@property (getter=isAuthenticatedWithDevicePassword, nonatomic) bool authenticatedWithDevicePassword;
...
@property (nonatomic, retain) NSMutableDictionary *objectIDsToMainKey;
@property (nonatomic, retain) <NSObject> *passphraseChangeObserver;

+ (double)defaultDeauthenticationTimeInterval;
+ (void)setSharedState:(id)arg1;
+ (id)sharedState;
...
- (bool)biometricsEnabledForAccount:(id)arg1;
...
- (void)localAuthenticationDidChangeBiometricsPolicyState:(id)arg1;
...
- (id)mainKeyFromKeychainForObject:(id)arg1 cipherVersion:(long long)arg2;
- (id)mainKeyIdentifierForKeyObject:(id)arg1 cipherVersion:(long long)arg2;
- (id)objectIDsToMainKey;
- (id)passphraseChangeObserver;
...
- (void)setObjectIDsToMainKey:(id)arg1;
- (void)setPassphraseChangeObserver:(id)arg1;
