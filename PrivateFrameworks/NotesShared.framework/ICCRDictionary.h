...
@interface ICCRDictionary : NSObject <ICCRCoding, ICCRDataType, NSFastEnumeration> {
...
- (void)encodeWithICCRCoder:(id)arg1 dictionary:(void*)arg2;
- (void)encodeWithICCRCoder:(id)arg1 dictionary:(void*)arg2 elementValueCoder:(id /* block */)arg3;
- (void)enumerateKeysObjectsAndTimestampsUsingBlock:(id /* block */)arg1;
- (unsigned long long)hash;
- (id)init;
- (id)initWithDocument:(id)arg1;
- (id)initWithICCRCoder:(id)arg1;
- (id)initWithICCRCoder:(id)arg1 dictionary:(const void*)arg2;
- (id)initWithICCRCoder:(id)arg1 dictionary:(const void*)arg2 elementValueDecoder:(id /* block */)arg3;
