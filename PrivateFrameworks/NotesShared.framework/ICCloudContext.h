...
@property (getter=isEnqueueingLongLivedOperations, nonatomic) bool enqueueingLongLivedOperations;
...
@property (nonatomic, retain) NSMutableSet *operationIDsBeforeEnqueuingLongLivedOperations;
...
- (void)enqueueLongLivedOperationsIfNeededWithCompletionHandler:(id /* block */)arg1;
- (void)enqueueLongLivedOperationsWithIDsIfNeeded:(id)arg1 container:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (void)updateCloudContextStateWithCompletion:(id /* block */)arg1;
