...
@property (nonatomic, retain) ICAppContext *appContext;
...
@property (nonatomic, copy) NSString *lastUpdateChangeCountReason;
...
@property (nonatomic, retain) CKRecord *unappliedEncryptedRecord;
@property (nonatomic, retain) NSData *unappliedEncryptedRecordData;
...
- (bool)isValidObject;
- (bool)isVisible;
- (id)lastUpdateChangeCountReason;
...
- (void)setHasMissingKeychainItem:(bool)arg1;
- (void)setInCloud:(bool)arg1;
- (void)setLastUpdateChangeCountReason:(id)arg1;
...
- (id)unappliedEncryptedRecord;
- (void)unitTest_injectCryptoStrategy:(id)arg1;
- (void)unitTest_setMinimumSupportedNotesVersion:(long long)arg1;
- (void)unmarkForDeletion;
- (void)unsafelyClearChangeCountWithReason:(id)arg1;
- (void)unsafelyUpdateChangeCountWithReason:(id)arg1;
