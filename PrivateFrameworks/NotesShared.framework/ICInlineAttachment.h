...
@interface ICInlineAttachment : ICBaseAttachment <ICCloudObject> {
    ...
    bool  _didAddAttachmentDataChangedObservers;
    NSString * _displayText;
}

@property (nonatomic, copy) NSString *altText;
@property (nonatomic, readonly) struct _NSRange { unsigned long long x1; unsigned long long x2; } animatableRange;
@property (nonatomic) bool animateInsertion;
@property (nonatomic, readonly) short attachmentType;
@property (nonatomic, copy) NSString *calculateState;
...
@property (nonatomic, readonly) bool isCalculateGraphExpressionAttachment;
@property (nonatomic, readonly) bool isCalculateResultAttachment;
...
@property (getter=isRightToLeftCalculateAttachment, nonatomic, readonly) bool rightToLeftCalculateAttachment;
...
@property (getter=isValidCalculateAttachment, nonatomic, readonly) bool validCalculateAttachment;
...
+ (id)newCalculateGraphExpressionAttachmentWithIdentifier:(id)arg1 altText:(id)arg2 note:(id)arg3 parentAttachment:(id)arg4 rightToLeft:(bool)arg5;
+ (id)newCalculateGraphExpressionAttachmentWithIdentifier:(id)arg1 note:(id)arg2 parentAttachment:(id)arg3 rightToLeft:(bool)arg4;
+ (id)newCalculateResultAttachmentWithIdentifier:(id)arg1 note:(id)arg2 parentAttachment:(id)arg3 rightToLeft:(bool)arg4;
...
- (void).cxx_destruct;
- (id)altText;
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })animatableRange;
...
- (void)setCalculateState:(id)arg1;
- (void)setDidAddAttachmentDataChangedObservers:(bool)arg1;
...
- (bool)updateCalculateGraphExpressionText:(id)arg1;
- (bool)updateCalculateResult:(id)arg1 isRightToLeft:(bool)arg2;
- (bool)updateCalculateText:(id)arg1 isValid:(bool)arg2 isRightToLeft:(bool)arg3;
...
- (id)textFindingResultsMatchingExpression:(id)arg1 ignoreCase:(bool)arg2 wholeWords:(bool)arg3 startsWith:(bool)arg4;
