...
+ (void)fetchItemsWithCompletionHandler:(id /* block */)arg1;
...
+ (bool)shouldFetchItemsWithError:(id*)arg1;
+ (id)stringForIdentifier:(id)arg1 account:(id)arg2 isSynced:(bool)arg3;
+ (void)tests_setLastItemsError:(id)arg1 lastItemsErrorDate:(id)arg2 lastItemsFetchDate:(id)arg3;
