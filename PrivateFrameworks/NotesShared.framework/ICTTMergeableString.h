...
@interface ICTTMergeableString : NSObject <ICCRDataType, NSCopying> {
    unsigned long long  _addingAttributesForUniqueParagraphUUIDs;
...
@property (nonatomic) NSObject<ICTTMergeableStringDelegate> *delegate;
@property (readonly, copy) NSString *description;
@property (nonatomic) ICCRTTCompatibleDocument *document;
...
- (void)endEditing;
- (void*)endNodes;
- (void)enumerateHighlightableRangesModifiedAfter:(id)arg1 includingAttributes:(bool)arg2 usingBlock:(id /* block */)arg3;
...
- (id)initWithArchive:(const void*)arg1 replicaID:(id)arg2 orderedSubstrings:(void*)arg3;
- (id)initWithArchive:(const void*)arg1 replicaID:(id)arg2 orderedSubstrings:(void*)arg3 timestamp:(id)arg4 fragment:(bool)arg5;
- (id)initWithArchive:(const void*)arg1 replicaID:(id)arg2 timestamp:(id)arg3;
- (id)initWithData:(id)arg1 replicaID:(id)arg2;
- (id)initWithData:(id)arg1 replicaID:(id)arg2 fragment:(bool)arg3;
...
- (long long)substring:(void*)arg1 modifiedAfter:(id)arg2 includeAttributes:(bool)arg3 replicaID:(id*)arg4;
