...
+ (id)serverShareCheckingParent:(id)arg1 managedObjectContext:(id)arg2;
+ (id)serverShareIfRootObject:(id)arg1 managedObjectContext:(id)arg2;
...
+ (id)updatedShareForObject:(id)arg1 includeHierarchicalShare:(bool)arg2 managedObjectContext:(id)arg3;
...
- (void)removeShareIfNeededWithOwnedObjectID:(id)arg1 countParticipants:(bool)arg2 completionHandler:(id /* block */)arg3;
