...
@property (nonatomic, retain) NSMutableArray *callNotesInSource;
...
@property (nonatomic, retain) NSMutableArray *mathNotesNotesInSource;
...
@property (nonatomic, retain) NSArray *modernNotes;
@property (nonatomic, readonly) NSArray *modernSourceObjects;
@property (nonatomic, retain) NSMutableArray *nonCallNotesInSource;
@property (nonatomic, retain) NSMutableArray *nonMathNotesNotesInSource;
...
- (id)nonCallNotesInSource;
- (id)nonMathNotesNotesInSource;
...
- (void)setCallNotesInSource:(id)arg1;
...
- (void)setMathNotesNotesInSource:(id)arg1;
- (void)setModernFoldersInSource:(id)arg1;
- (void)setModernNotes:(id)arg1;
- (void)setNonCallNotesInSource:(id)arg1;
- (void)setNonMathNotesNotesInSource:(id)arg1;
