...
@interface ICRecentNotesCoreDataIndexer : ICCoreDataIndexer {
    ...
    bool  _passwordProtectedOnly;
    bool  _pinnedOnly;
    NSMutableDictionary * _sectionIdentifiersToManagedObjectIDs;
    long long  _sortType;
}

@property (nonatomic) bool checklistsOnly;
...
@property (nonatomic) bool nonPasswordProtectedOnly;
@property (nonatomic) bool passwordProtectedOnly;
...
- (void)setChecklistsOnly:(bool)arg1;
- (void)setMaximumNumberOfNotesPerAccount:(unsigned long long)arg1;
- (void)setNonPasswordProtectedOnly:(bool)arg1;
- (void)setPasswordProtectedOnly:(bool)arg1;
