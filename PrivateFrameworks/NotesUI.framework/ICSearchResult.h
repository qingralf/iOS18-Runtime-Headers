...
@property (nonatomic, retain) NSAttributedString *displayingAttributedSnippet;
@property (nonatomic, retain) NSAttributedString *displayingAttributedTitle;
...
@property (getter=isMathNote, nonatomic) bool mathNote;
...
+ (id)attributedStringWithMatchHighlighted:(id)arg1 optionalAttributedHighlightedString:(id)arg2 textCheckingResult:(id)arg3 highlightColor:(id)arg4 insideFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg5 finishingUpRegexMatchFinder:(id)arg6;
+ (id)attributedStringWithMatchHighlighted:(id)arg1 optionalAttributedHighlightedString:(id)arg2 textCheckingResult:(id)arg3 usingAttributes:(id)arg4 highlightColor:(id)arg5 insideFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg6 isSnippetForParticipantMatch:(bool)arg7 finishingUpRegexMatchFinder:(id)arg8;
+ (id)attributedStringWithMatchHighlighted:(id)arg1 textCheckingResult:(id)arg2 highlightColor:(id)arg3 insideFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg4 finishingUpRegexMatchFinder:(id)arg5;
...
- (id)description;
- (id)displayingAttributedSnippet;
- (id)displayingAttributedTitle;
...
- (void)setDisplayingAttributedTitle:(id)arg1;
