...
@property (nonatomic, readonly) NSURL *_nonEncryptedContentCRContextURL; /* unknown property attribute: ? */
...
- (id)printableTextContentForAppearanceType:(unsigned long long)arg1 traitCollection:(id)arg2 textContainer:(id)arg3;
- (void)resetZoom;
...
- (id)systemPaperViews;
- (void)updateAttachmentChangeCountAndSave:(id)arg1;
