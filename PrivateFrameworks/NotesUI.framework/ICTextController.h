...
- (id)emptyTextStorage;
- (void)ensureUniqueParagraphStyleUUIDsInTextStorage:(id)arg1 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2;
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })extendedSelectionRangeForCollapsedSectionHeadingWithRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 textView:(id)arg2;
- (void)filterAttachmentsForPrintingInAttributedString:(id)arg1 traitCollection:(id)arg2 textContainer:(id)arg3;
...
- (void)setNote:(id)arg1 stylingTextUsingSeparateTextStorageForRendering:(bool)arg2 withLayoutManager:(id)arg3 traitCollection:(id)arg4 firstVisibleCharLocation:(unsigned long long)arg5;
...
- (id)tabStopsForAttributedString:(id)arg1 inRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2;
