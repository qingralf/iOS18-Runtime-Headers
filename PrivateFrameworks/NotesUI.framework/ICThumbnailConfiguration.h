...
@property (nonatomic, readonly) bool prepareThumbnail;
...
- (id)initForLargeQuickNoteWidgetWithNote:(id)arg1 appearanceInfo:(id)arg2 traitCollection:(id)arg3;
- (id)initForNoteGalleryWithNote:(id)arg1 preferredSize:(struct CGSize { double x1; double x2; })arg2 traitCollection:(id)arg3 scale:(double)arg4 appearanceInfo:(id)arg5;
...
- (id)initForSmallQuickNoteWidgetWithNote:(id)arg1 appearanceInfo:(id)arg2 traitCollection:(id)arg3;
