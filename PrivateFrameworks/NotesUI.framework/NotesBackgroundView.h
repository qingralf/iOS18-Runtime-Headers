...
- (void)setContentView:(id)arg1 useSafeAreaLayoutGuide:(bool)arg2 standalone:(bool)arg3 needsAdditionalBottomMargin:(bool)arg4 needsAdditionalLeadingMargin:(bool)arg5 force:(bool)arg6;
- (void)setContentView:(id)arg1 useSafeAreaLayoutGuide:(bool)arg2 topMargin:(double)arg3 bottomMargin:(double)arg4 leadingMargin:(double)arg5 trailingMargin:(double)arg6 standalone:(bool)arg7 force:(bool)arg8;
