...
- (id)reportNamePrefix;
- (int)resampleTruncatedBacktracesForTask:(int)arg1 forThreads:(id)arg2 usingCatalog:(id)arg3 in:(id)arg4 usingSymbolicator:(struct _CSTypeRef { unsigned long long x1; unsigned long long x2; })arg5;
...
- (void)useStackshotBuffer:(const void*)arg1 size:(unsigned int)arg2 frontmostPids:(id)arg3 atTime:(double)arg4 machTime:(unsigned long long)arg5 sequence:(unsigned int)arg6 isSnapshotDead:(bool)arg7;
