...
- (id)initWithUUID:(id)arg1 claimTokenData:(id)arg2 wrappingKeyData:(id)arg3 error:(id*)arg4;
- (id)initWithUUID:(id)arg1 error:(id*)arg2;
- (id)initWithUUID:(id)arg1 oldIK:(id)arg2 error:(id*)arg3;
- (id)initWithWrappedKeyData:(id)arg1 wrappingKeyData:(id)arg2 claimTokenData:(id)arg3 uuid:(id)arg4 error:(id*)arg5;
...
- (bool)isKeyEquals:(id)arg1;
- (bool)isRecoveryKeyEqual:(id)arg1;
- (id)recoveryKeyData;
- (bool)unwrapWithError:(id*)arg1;
- (id)uuid;
- (bool)wrapWithWrappingKey:(id)arg1 error:(id*)arg2;
- (id)wrappedKeyData;
- (id)wrappedKeyString;
- (id)wrappingKeyData;
