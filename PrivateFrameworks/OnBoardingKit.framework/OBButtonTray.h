...
- (void)setCaptionText:(id)arg1 instructionsForUseAction:(id /* block */)arg2;
- (void)setCaptionText:(id)arg1 learnMoreURL:(id)arg2;
- (void)setCaptionText:(id)arg1 style:(long long)arg2;
- (void)setCaptionText:(id)arg1 style:(long long)arg2 instructionsForUseAction:(id /* block */)arg3;
