...
- (id)_stringKeyWithCapabilitiesFromPrefix:(id)arg1 withNetwork:(bool)arg2 withGenerative:(bool)arg3;
- (id)_textForConditionalItem:(id)arg1 language:(id)arg2 preferredDeviceType:(unsigned long long)arg3;
- (id)_verifiedSplashLocalizedStringForKey:(id)arg1 language:(id)arg2 preferredDeviceType:(unsigned long long)arg3;
- (id)bundle;
- (id)buttonIcon;
...
- (id)localizedCombinedFooterComponentsForLanguage:(id)arg1 preferredDeviceType:(unsigned long long)arg2;
