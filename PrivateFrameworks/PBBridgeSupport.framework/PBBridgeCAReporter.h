...
+ (id)_orientationHumanReadable:(long long)arg1;
+ (id)_pairingStyle:(long long)arg1;
+ (id)_reportingPlatform;
+ (id)_wristChoiceHumanReadable:(long long)arg1;
...
+ (void)recordMaterial:(unsigned long long)arg1 andSize:(unsigned long long)arg2;
+ (void)recordPairingInitiatedDeviceOrientationChoice:(long long)arg1 pairingSelectionType:(long long)arg2;
+ (void)recordPairingInitiatedDeviceWristChoice:(long long)arg1 pairingSelectionType:(long long)arg2;
...
+ (void)recordUserInitiatedDeviceOrientationChange:(long long)arg1;
+ (void)recordUserInitiatedDeviceWristChange:(long long)arg1;
