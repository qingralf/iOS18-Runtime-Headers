...
@interface PBBridgeCompanionController : PBBridgeIDSServiceDelegate <IDSServiceDelegate, NSURLConnectionDelegate, PBBridgeCompanionProtocol, RUILoaderDelegate> {
    ...
    id /* block */  _appViewListImageCompletion;
    id /* block */  _applicationInstallAllowedCompletion;
    ...
    id /* block */  _remoteAccountForDeviceCompletion;
    ...
    id /* block */  _setupDeviceManagementCompletion;
    NSObject<OS_dispatch_queue> * _timeoutTrackerQueue;
    id /* block */  _tinkerCredentialsIngestedCompletion;
    id /* block */  _tinkerWiFiCredentialsIngestedCompletion;
...
@property (nonatomic, retain) NSObject<OS_dispatch_source> *activationTimeout;
@property (nonatomic, retain) NSDictionary *allHeaders;
@property (nonatomic) bool allowAnyHTTPSCertificate;
@property (nonatomic, copy) id /* block */ appViewListImageCompletion;
@property (nonatomic, copy) id /* block */ applicationInstallAllowedCompletion;
...
@property (nonatomic, copy) id /* block */ remoteAccountForDeviceCompletion;
...
@property (nonatomic, copy) id /* block */ setupDeviceManagementCompletion;
@property (readonly) Class superclass;
@property (nonatomic, copy) id /* block */ tinkerCredentialsIngestedCompletion;
@property (nonatomic, copy) id /* block */ tinkerWiFiCredentialsIngestedCompletion;
...
- (id /* block */)appViewListImageCompletion;
- (id /* block */)applicationInstallAllowedCompletion;
...
- (void)checkApplicationInstallAllowedWithCompletion:(id /* block */)arg1;
...
- (void)handleApplicationInstallRestrictionResponse:(id)arg1;
- (void)handleDeviceManagementResponse:(id)arg1;
...
- (id /* block */)remoteAccountForDeviceCompletion;
- (id)remoteActivationUserAgent;
- (id)remoteUIStyle;
- (void)requestProxiedDeviceForWatchWithCompletion:(id /* block */)arg1;
- (void)retrieveAppViewListImageFromGizmo:(struct CGSize { double x1; double x2; })arg1 completion:(id /* block */)arg2;
- (void)returnedRemoteAccountForDevice:(id)arg1;
- (id)ruiDelegate;
- (id)ruiLoader;
- (bool)selectedPairedUnlock;
- (void)sendAllTinkerWirelessCredentials:(bool)arg1;
- (void)sendAllWirelessCredentials:(bool)arg1;
...
- (void)sendTinkerAccountCredentialsWithContext:(id)arg1 completion:(id /* block */)arg2;
...
- (void)setAppViewListImageCompletion:(id /* block */)arg1;
- (void)setApplicationInstallAllowedCompletion:(id /* block */)arg1;
...
- (void)setRemoteAccountForDeviceCompletion:(id /* block */)arg1;
...
- (void)setSetupDeviceManagementCompletion:(id /* block */)arg1;
- (void)setTinkerCredentialsIngestedCompletion:(id /* block */)arg1;
- (void)setTinkerWiFiCredentialsIngestedCompletion:(id /* block */)arg1;
- (id /* block */)setupDeviceManagementCompletion;
- (void)setupServiceMessageSelectorMappings;
- (bool)shouldHandleMessageType:(unsigned short)arg1 fromId:(id)arg2;
...
- (void)tellGizmoToSetCrownOrientationRight:(bool)arg1;
...
- (void)tellWatchLanguagesAndLocaleSupportingTermOfAddress:(bool)arg1 withCompletion:(id /* block */)arg2;
- (void)tellWatchToChangeDeviceNameFor:(id)arg1;
- (void)tellWatchToConfigureDeviceManagementWithData:(id)arg1 completion:(id /* block */)arg2;
...
- (id /* block */)tinkerCredentialsIngestedCompletion;
- (void)tinkerFinishedHealthSharingOptIn:(id)arg1;
- (void)tinkerWatchIngestedCredentials:(id)arg1;
- (id /* block */)tinkerWiFiCredentialsIngestedCompletion;
- (void)transportBecameReachable;
- (void)transportBecameUnreachable;
- (id)viewControllerForAlertPresentation;
- (void)watchDidApplyWirelessCredentials:(id)arg1;
