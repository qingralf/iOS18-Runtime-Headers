...
- (void)checkAppInstallationAllowed:(id)arg1;
- (void)companionBecameAvailableWantsConfirmation:(id)arg1;
- (void)companionDidSendDemoWirelessCredentials:(id)arg1;
...
- (void)parseNetworkRecordsAndApplyWirelessCredentialsFromData:(id)arg1;
- (void)popToControllerType:(id)arg1;
- (void)prepareForForcedWatchSU:(id)arg1;
- (void)processReceivedPairingWirelessCredentials:(id)arg1;
...
- (void)setupDeviceManagement:(id)arg1;
...
- (void)updateNanoRegistryToNormalState:(id)arg1;
