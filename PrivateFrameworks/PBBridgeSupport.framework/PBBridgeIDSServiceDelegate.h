...
@interface PBBridgeIDSServiceDelegate : NSObject <IDSServiceDelegate> {
    ...
    bool  _listeningForIDSSentMessages;
...
@property (setter=setTinkerPairing:, nonatomic) bool isTinkerPairing;
...
@property (nonatomic, readonly) bool setupTransactionActive;
...
- (void).cxx_destruct;
- (void)_postMessageSendFailureForErrorMessage:(id)arg1;
...
- (void)setListeningForIDSSentMessages:(bool)arg1;
