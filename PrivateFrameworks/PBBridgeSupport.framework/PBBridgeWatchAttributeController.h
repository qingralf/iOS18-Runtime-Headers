...
@property (nonatomic, readonly) PDRDevice *pdrDevice;
...
+ (unsigned long long)materialFromPdrDevice:(id)arg1;
+ (id)materialKeyColorForMaterial:(unsigned long long)arg1;
+ (long long)pdrSizeFromInternalSize:(unsigned long long)arg1;
...
+ (unsigned long long)sizeFromPdrDevice:(id)arg1;
