...
@interface PSYSyncCoordinator : NSObject <NSXPCListenerDelegate, PDRRegistryDelegate, PSYActivity, PSYServiceSyncSessionDelegate> {
...
- (void)registry:(id)arg1 added:(id)arg2;
