...
@interface PBUIPosterWallpaperWindowSceneStyleTransitionState : NSObject <BSXPCCoding, NSCopying> {
    struct { 
        bool valid; 
        struct { 
...
- (void)diffFromPosterWallpaperWindowSceneStyleTransitionState:(id)arg1 updateHandler:(id /* block */)arg2 removeHandler:(id /* block */)arg3;
