...
@interface PBUIScrollableIrisWallpaperView : PBUIScrollableStaticWallpaperView <PBUIIrisWallpaperPlaying, PBUILivePhotoPlayerViewDelegate, UIGestureRecognizerDelegate> {
