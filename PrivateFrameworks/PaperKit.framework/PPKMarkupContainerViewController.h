...
@interface PPKMarkupContainerViewController : UIViewController <UIScrollViewDelegate> {
    void allEditingDisabled;
    void analysisDelegate;
    ...
    void loadContentOperationQueue;
...
- (void)handleSqueezeInteractionDidChangePaletteViewVisibilityNotification:(id)arg1;
...
- (bool)viewAcceptSingleTouch:(id)arg1;
