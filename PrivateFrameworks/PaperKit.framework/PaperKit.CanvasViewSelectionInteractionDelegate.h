...
- (void)selectionInteraction:(id)arg1 clearSelectionInAttachment:(id)arg2;
...
- (void)selectionInteraction:(id)arg1 handleDeleteForTextStrokes:(id)arg2 inAttachment:(id)arg3;
- (void)selectionInteraction:(id)arg1 handleDeleteForTextStrokes:(id)arg2 nonTextStrokes:(id)arg3 inAttachment:(id)arg4;
- (void)selectionInteraction:(id)arg1 handleGenerationToolForSelectedStrokes:(id)arg2 inBounds:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg3 inAttachment:(id)arg4;
- (bool)selectionInteraction:(id)arg1 handleLassoSelection:(id)arg2 strokes:(id)arg3 inAttachment:(id)arg4;
...
- (void)selectionInteraction:(id)arg1 replaceStrokes:(id)arg2 withString:(id)arg3 proofreadingItem:(id)arg4 inBounds:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg5 inAttachment:(id)arg6;
