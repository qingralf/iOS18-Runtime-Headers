...
@interface PaperKit.PaperTextAttachmentView : _TtGC8PaperKit6CanvasVS_5Paper_ <PKTextAttachmentDrawingViewProviderView, PKTextAttachmentResizeViewDelegate, PKToolPickerObserver, PKToolPickerResponding, UIGestureRecognizerDelegate, UITextAttachmentContentView, _UIScrollViewScrollObserver> {
    void _viewControllerForPresentingUI;
    void bottomResizeView;
    void cachedDrawingTransform;
    void cachedDrawingTransformBoundsWidth;
    void cachedDrawingTransformShouldCrop;
    void calculateDocument;
    void calculateDocumentExpressionSolvingBehavior;
    void eatTapGestureRecognizer;
    void isCurrentToolGenerationTool;
    void linedPaper;
    void linedPaperView;
    void magicGenerativePlaygroundBoundsToInitialize;
    void magicGenerativePlaygroundContextToInitialize;
