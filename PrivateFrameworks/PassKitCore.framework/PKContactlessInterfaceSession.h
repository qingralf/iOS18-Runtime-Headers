...
@property <PKContactlessInterfaceSessionDelegate> *delegate;
...
+ (id)transitAppletStateFromPaymentSession:(id)arg1 forPaymentApplication:(id)arg2;

- (void).cxx_destruct;
- (bool)_activatePaymentApplications:(id)arg1 forPaymentPass:(id)arg2 forceReactivation:(bool)arg3;
- (id)_appletForPaymentApplication:(id)arg1 inInternalSession:(id)arg2;
- (id)_appletWithIdentifier:(id)arg1 inInternalSession:(id)arg2;
- (id)_createExpressTransactionForState:(id)arg1 pass:(id)arg2 paymentApplications:(id)arg3 date:(id)arg4 shouldGenerateTransaction:(bool*)arg5 withSession:(id)arg6;
- (void)_endLookup;
- (void)_endLookupAndNotify;
- (void)_endPersistentCardEmulationForPaymentPass:(id)arg1 paymentApplications:(id)arg2;
- (id)_filteredLoyaltyPassesFromVASTransactions:(id)arg1 activatedPasses:(id)arg2;
- (id)_paymentApplicationForEventAppletIdentifier:(id)arg1 inContext:(id)arg2 withSession:(id)arg3;
...
- (bool)activatePaymentApplications:(id)arg1 forPaymentPass:(id)arg2;
...
- (id)transitAppletStateForPaymentApplication:(id)arg1;
