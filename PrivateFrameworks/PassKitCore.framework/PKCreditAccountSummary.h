...
@interface PKCreditAccountSummary : NSObject <NSCopying, NSSecureCoding> {
    ...
    bool  _recoveryPaymentPlansSupported;
...
@property (nonatomic, copy) NSDecimalNumber *remainingStatementBalanceForInterestCalculation;
...
- (void)setRecoveryPaymentPlansSupported:(bool)arg1;
...
- (void)setRemainingStatementBalanceForInterestCalculation:(id)arg1;
