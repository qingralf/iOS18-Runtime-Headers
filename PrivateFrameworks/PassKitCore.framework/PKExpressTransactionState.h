...
@property (nonatomic, readonly, copy) NSString *terminalReaderIdentifier;
...
+ (id)createForStandaloneTransaction:(long long)arg1 applicationIdentifier:(id)arg2 keyIdentifier:(id)arg3 passUniqueIdentifier:(id)arg4 terminalReaderIdentifier:(id)arg5;
...
- (void)associateWithApplicationIdentifier:(id)arg1 keyIdentifier:(id)arg2 terminalReaderIdentifier:(id)arg3 passUniqueIdentifier:(id)arg4;
