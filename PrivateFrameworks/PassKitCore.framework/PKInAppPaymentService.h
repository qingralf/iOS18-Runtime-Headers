...
- (void)presentInAppPaymentInterfaceWithPaymentRequest:(id)arg1 awaitingRemoteNetworkPaymentRequest:(bool)arg2 forHostIdentifier:(id)arg3 hostSceneIdentifier:(id)arg4 hostSceneBundleIdentifier:(id)arg5 orientation:(id)arg6 omitPresentationTarget:(bool)arg7 analyticsSubject:(id)arg8 analyticsArchivedSessionToken:(id)arg9 completion:(id /* block */)arg10;
