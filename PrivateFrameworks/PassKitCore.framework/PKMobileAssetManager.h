...
- (void)_downloadAsset:(id)arg1 isDiscretionary:(bool)arg2 timeout:(long long)arg3 completion:(id /* block */)arg4;
- (void)_downloadAssetCatalogIfExpired:(unsigned long long)arg1 completion:(id /* block */)arg2;
- (id)_downloadOptionsWithTimeout:(long long)arg1 isDiscretionary:(bool)arg2;
...
- (id)_queryForStringsBundleWithIdentifier:(id)arg1;
- (void)_retrieveAssetWithQuery:(id)arg1 maxCompatibleVersion:(unsigned long long)arg2 isDiscretionary:(bool)arg3 sortDescriptors:(id)arg4 timeout:(unsigned long long)arg5 catalogExpirationDays:(unsigned long long)arg6 completion:(id /* block */)arg7;
- (id)cachedDynamicAssetWithIdentifier:(id)arg1 parameters:(id)arg2;
- (id)cachedDynamicAssetsIndex;
- (id)cachedStringsBundleWithIdentifier:(id)arg1;
...
- (void)fetchMarketNotificationAssetsForIdentifier:(id)arg1 isDiscretionary:(bool)arg2 completionHandler:(id /* block */)arg3;
- (void)fetchRPIdentifierMappingDiscretionary:(bool)arg1 localOnly:(bool)arg2 completionHandler:(id /* block */)arg3;
- (id)init;
...
- (void)stationCodeDataForStationCodeProvider:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)stringsBundleWithIdentifier:(id)arg1 timeout:(unsigned long long)arg2 completion:(id /* block */)arg3;
