...
- (void)quoteWithAmount:(id)arg1 source:(unsigned long long)arg2 requestToken:(id)arg3 alternateFundingSource:(id)arg4 recurringPaymentIdentifier:(id)arg5 frequency:(unsigned long long)arg6 startDate:(id)arg7 threshold:(id)arg8 completion:(id /* block */)arg9;
