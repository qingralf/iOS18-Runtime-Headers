...
@property (nonatomic, retain) NSNumber *activeCapabilityRole;
@property (nonatomic, retain) NSNumber *activeManageability;
@property (nonatomic, retain) NSNumber *activeShareability;
@property (nonatomic, retain) NSNumber *activeVisibility;
...
@property (nonatomic, readonly) bool intraAccountSharingEnabled;
...
- (void).cxx_destruct;
- (bool)active;
- (id)activeCapabilityRole;
- (id)activeManageability;
- (id)activeShareability;
- (id)activeVisibility;
...
- (id)identifier;
- (id)initWithCarKeyProfile:(id)arg1 roles:(id)arg2 active:(bool)arg3 subcredentialIdentifier:(id)arg4;
- (id)initWithCoder:(id)arg1;
- (id)initWithDictionary:(id)arg1;
- (id)initWithSubcredentialDictionary:(id)arg1 active:(bool)arg2 subcredentialIdentifier:(id)arg3;
- (bool)intraAccountSharingEnabled;
- (bool)isEqual:(id)arg1;
- (id)manageability;
- (void)setActive:(bool)arg1;
- (void)setActiveCapabilityRole:(id)arg1;
- (void)setActiveManageability:(id)arg1;
- (void)setActiveShareability:(id)arg1;
- (void)setActiveVisibility:(id)arg1;
