...
@property (nonatomic, retain) PKImage *altImage;
...
@property (nonatomic, retain) PKImage *compactBankLogoDarkImage;
@property (nonatomic, retain) PKImage *compactBankLogoLightImage;
...
@property (nonatomic, retain) PKImage *secondaryLogoImage;
...
- (void)setCompactBankLogoDarkImage:(id)arg1;
- (void)setCompactBankLogoLightImage:(id)arg1;
- (void)setFooterImage:(id)arg1;
- (void)setLogoImage:(id)arg1;
- (void)setNetworkLogoImage:(id)arg1;
- (void)setSecondaryLogoImage:(id)arg1;
...
- (void)resizeWithScreenSize:(struct CGSize { double x1; double x2; })arg1 pass:(id)arg2;
