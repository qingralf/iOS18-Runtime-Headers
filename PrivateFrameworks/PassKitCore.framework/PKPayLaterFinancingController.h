...
@interface PKPayLaterFinancingController : NSObject <PKAccountServiceObserver> {
    ...
    unsigned long long  _optionFetchIneligibleReason;
    PKPassLibrary * _passLibrary;
    PKAccount * _payLaterAccount;
    PKPaymentPass * _payLaterPass;
    unsigned long long  _payLaterPassEligibility;
...
@property (nonatomic) bool hasSeenLanguageNotice;
...
@property (nonatomic, readonly) unsigned long long payLaterPassEligibility;
...
- (id)payLaterAccount;
- (id)payLaterPass;
- (unsigned long long)payLaterPassEligibility;
...
- (void)setHasSeenLanguageNotice:(bool)arg1;
