...
+ (void)_processLoanAdjustmentWithPayment:(id)arg1 installmentIndex:(long long)arg2 installments:(id)arg3 disputes:(id)arg4 currency:(id)arg5;
...
+ (id)payLaterFinancingPlanFundingSourcesForOptions:(unsigned long long)arg1;
+ (id)payLaterMerchantForType:(unsigned long long)arg1;
+ (id)payLaterPaymentFundingSourcesForOptions:(unsigned long long)arg1;
