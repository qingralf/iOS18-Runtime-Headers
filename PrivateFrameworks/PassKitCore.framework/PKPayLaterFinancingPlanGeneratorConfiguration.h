...
+ (id)configurationWithProductType:(unsigned long long)arg1 apr:(id)arg2 totalPrincipal:(id)arg3 installmentCount:(long long)arg4 daysSinceTransactionStart:(long long)arg5 merchant:(unsigned long long)arg6 fundingSources:(unsigned long long)arg7 payments:(id)arg8;
