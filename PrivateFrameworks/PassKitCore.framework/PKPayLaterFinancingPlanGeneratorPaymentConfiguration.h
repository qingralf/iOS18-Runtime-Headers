...
@interface PKPayLaterFinancingPlanGeneratorPaymentConfiguration : NSObject {
    ...
    bool  _forDispute;
    unsigned long long  _fundingSources;
    long long  _installmentAmountMultiple;
    bool  _payOffRestOfLoanBalance;
    unsigned long long  _paymentSubtype;
...
@property (nonatomic) unsigned long long fundingSources;
@property (nonatomic) long long installmentAmountMultiple;
@property (nonatomic) bool payOffRestOfLoanBalance;
@property (nonatomic) unsigned long long paymentSubtype;
...
+ (id)paymentConfigurationWithPaymentType:(unsigned long long)arg1 amount:(id)arg2 relativeToInstallmentNumber:(long long)arg3 daysPriorToRelativeInstallmentNumber:(long long)arg4 fundingSources:(unsigned long long)arg5;
...
- (bool)forDispute;
- (unsigned long long)fundingSources;
- (long long)installmentAmountMultiple;
- (bool)payOffRestOfLoanBalance;
- (unsigned long long)paymentSubtype;
...
- (void)setFundingSources:(unsigned long long)arg1;
- (void)setInstallmentAmountMultiple:(long long)arg1;
- (void)setPayOffRestOfLoanBalance:(bool)arg1;
- (void)setPaymentSubtype:(unsigned long long)arg1;
