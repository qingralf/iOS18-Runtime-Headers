...
+ (id)_bnplFinancingOptionsDictionaryWithRelevantDates:(bool)arg1;
+ (id)_bnplFinancingPlan1WithRelevantDates:(bool)arg1;
+ (id)_bnplPreliminaryAssessmentDictionary;
+ (id)_bnplProductAssessmentDictionary;
+ (id)_bnplProductAssessmentDictionary2;
+ (id)_dateFormatter;
+ (id)_loanFinancingOptionDictionaryWithRelevantDates:(bool)arg1;
