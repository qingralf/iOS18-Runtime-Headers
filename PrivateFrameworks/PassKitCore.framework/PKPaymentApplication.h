...
+ (bool)paymentApplicationSupportsMerchantCapabilties:(unsigned long long)arg1 paymentType:(unsigned long long)arg2;
...
- (unsigned long long)fundingSourcePaymentType;
...
- (void)setFundingSourcePaymentType:(unsigned long long)arg1;
