...
@interface PKPaymentAuthorizationDataModel : NSObject <PKPaymentValidating> {
    ...
    NSMutableSet * _primaryAccountIdentifiersWithConnectedCardStateSet;
...
@property (nonatomic) bool hasAnyPayLaterOptions;
...
@property (nonatomic, readonly) NSDecimalNumber *initialTransactionAmount;
...
@property (nonatomic, readonly) bool isInlineSummaryItemsEligible;
...
@property (nonatomic, readonly) bool praguePolicyRequired;
@property (nonatomic, retain) PKPayLaterFinancingOption *previouslySelectedFinancingOption;
@property (nonatomic, readonly, copy) NSMutableSet *primaryAccountIdentifiersWithConnectedCardStateSet;
...
@property (nonatomic, retain) PKSelectedPaymentOffer *selectedPaymentOffer;
...
- (void).cxx_destruct;
- (id)_additionalEligiblePaymentPassesForPaymentRequest:(id)arg1;
...
- (id)_filterAndProcessPaymentPassesUsingConfiguration:(id)arg1 additionalPaymentPasses:(id)arg2;
...
- (void)_populateFinanceKitBalancesIfNecessaryForPasses:(id)arg1;
...
- (bool)canAddPasses;
- (bool)canSupportDisbursementsOnRemoteDevice:(id)arg1;
- (bool)canSupportMerchantCategoryCodeAccordingToWebService:(id)arg1 forPass:(id)arg2;
- (bool)canSupportMerchantCategoryCodeAccordingToWebService:(id)arg1 forPaymentInstrument:(id)arg2;
- (unsigned long long)connectedCardStateForPass:(id)arg1;
...
- (id)primaryAccountIdentifiersWithConnectedCardStateSet;
- (id)recents;
...
- (void)setHasAnyPayLaterOptions:(bool)arg1;
...
- (void)setIsHideMyEmailLoading:(bool)arg1;
...
- (void)setSelectedPaymentOffer:(id)arg1;
