...
- (void)_populateDeviceMetadata:(id)arg1 withFields:(unsigned long long)arg2 completion:(id /* block */)arg3;
...
- (void)provisioningDataIncludingDeviceMetadata:(bool)arg1 withCompletionHandler:(id /* block */)arg2;
