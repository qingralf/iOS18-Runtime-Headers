...
@property (nonatomic, copy) NSString *deviceMLBSerialNumber;
...
@property (nonatomic) bool walletDeleted;
...
- (void)setDeviceMLBSerialNumber:(id)arg1;
...
- (void)setWalletDeleted:(bool)arg1;
- (id)signedAuthToken;
- (bool)walletDeleted;
