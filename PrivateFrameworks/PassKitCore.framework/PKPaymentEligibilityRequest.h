...
@property (nonatomic, readonly) PKAddPaymentPassRequestConfiguration *addPaymentPassRequestConfiguration;
...
@property (nonatomic, copy) NSString *odiAssessmentVersion;
...
@property (nonatomic, retain) PKPaymentTapToProvisionData *tapToProvisionData;
...
- (id)addPaymentPassRequestConfiguration;
- (id)cardholderName;
...
- (void)setOdiAssessmentVersion:(id)arg1;
...
- (void)setTapToProvisionData:(id)arg1;
- (void)setWrappedKey:(id)arg1;
- (long long)source;
- (id)tapToProvisionData;
- (id)wrappedKey;
