...
@property (nonatomic, readonly) NSArray *auxiliaryCapabilityDecryptions;
@property (nonatomic, readonly) NSArray *auxiliaryCapabilitySignatures;
...
@property (nonatomic, readonly) bool shouldGenerateAuxiliaryCapabilities;
...
- (id)auxiliaryCapabilityDecryptions;
- (id)auxiliaryCapabilitySignatures;
- (long long)cardType;
