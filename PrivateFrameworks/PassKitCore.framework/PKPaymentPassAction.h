...
@property (nonatomic, copy) NSString *serviceProviderLocalizedDisplayName;
...
- (void).cxx_destruct;
- (id)_initWithContext:(long long)arg1;
- (id)_initWithExternalURL:(id)arg1;
- (id)_initWithImage:(id)arg1 title:(id)arg2;
- (id)_localizableKeys;
- (void)_processLocalizableStrings:(id /* block */)arg1;
- (id)actionDescription;
- (id)actionUpdatedWithDictionary:(id)arg1 localizations:(id)arg2;
- (id)appletData;
...
- (id)serviceProviderLocalizedDisplayName;
...
- (void)setServiceProviderLocalizedDisplayName:(id)arg1;
