...
@interface PKPaymentProvisioningController : NSObject <CIDVUIProofingFlowManagerDelegate, CLLocationManagerDelegate, PKAccountServiceObserver, PKPaymentServiceDelegate, PKPaymentWebServiceDelegate, PKProvisioningUtilityDataHelper> {
    ...
    NSArray * _accounts;
    bool  _allowProductsInUnsupportedRegion;
    ...
    bool  _fetchProductsFromStaticDataSource;
...
@property (nonatomic) bool allowProductsInUnsupportedRegion;
...
@property (nonatomic) bool fetchProductsFromStaticDataSource;
...
- (void)setAllowProductsInUnsupportedRegion:(bool)arg1;
...
- (void)setFetchProductsFromStaticDataSource:(bool)arg1;
