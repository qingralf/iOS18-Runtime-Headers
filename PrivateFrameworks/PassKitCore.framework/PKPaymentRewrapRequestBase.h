...
@property (nonatomic, copy) NSString *merchantTokenUseCase;
...
@property (nonatomic, copy) NSString *remoteDeviceModel;
@property (nonatomic, copy) NSString *remoteNetworkRequestInitiatingUserAgent;
@property (nonatomic, copy) NSString *remoteNetworkRequestPaymentTopicID;
...
- (id)merchantTokenUseCase;
- (id)multiTokenContexts;
- (id)pass;
- (id)paymentApplication;
- (id)paymentHash;
- (id)remoteDeviceModel;
- (id)remoteNetworkRequestInitiatingUserAgent;
- (id)remoteNetworkRequestPaymentTopicID;
...
- (void)setMerchantTokenUseCase:(id)arg1;
- (void)setMultiTokenContexts:(id)arg1;
- (void)setPass:(id)arg1;
- (void)setPaymentApplication:(id)arg1;
- (void)setPaymentHash:(id)arg1;
- (void)setRemoteDeviceModel:(id)arg1;
- (void)setRemoteNetworkRequestInitiatingUserAgent:(id)arg1;
- (void)setRemoteNetworkRequestPaymentTopicID:(id)arg1;
