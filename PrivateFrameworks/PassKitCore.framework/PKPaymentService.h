...
- (void)changePasscodeFrom:(id)arg1 toPasscode:(id)arg2 completion:(id /* block */)arg3;
...
- (void)clearProvisioningSupportDataOfType:(unsigned long long)arg1 completion:(id /* block */)arg2;
...
- (void)conflictingExpressPassIdentifiersForPassConfiguration:(id)arg1 withCompletion:(id /* block */)arg2;
...
- (void)createShareInvitationForPartialShareInvitation:(id)arg1 existingTransportIdentifier:(id)arg2 authorization:(id)arg3 completion:(id /* block */)arg4;
...
- (void)deleteIssuerInstallmentTransactionsForPassUniqueID:(id)arg1 completion:(id /* block */)arg2;
- (void)deleteMessagesForPaymentPassWithUniqueIdentifier:(id)arg1;
- (void)deletePaymentRewardsRedemptionsForPassUniqueIdentifier:(id)arg1;
...
- (void)eligiblePaymentOfferCriteriasForPassUniqueID:(id)arg1 completion:(id /* block */)arg2;
- (void)enforceUpgradedPasscodePolicyWithCompletion:(id /* block */)arg1;
- (id)entitlementsForPassIdentifier:(id)arg1;
- (id)expressPassConfigurationWithPassUniqueIdentifier:(id)arg1;
- (id)expressPassConfigurations;
- (id)expressPassConfigurationsWithCardType:(long long)arg1;
...
- (void)generateUnderlyingKeyReportWithCompletion:(id /* block */)arg1;
...
- (void)insertOrUpdatePaymentRewardsRedemption:(id)arg1 withPassUniqueIdentifier:(id)arg2;
...
- (void)issuerInstallmentTransactionsForPassUniqueID:(id)arg1 completion:(id /* block */)arg2;
- (void)issuerInstallmentTransactionsForTransactionSourceIdentifiers:(id)arg1 paymentHashes:(id)arg2 completion:(id /* block */)arg3;
...
- (id)paymentRewardsBalanceWithIdentifier:(id)arg1;
- (id)paymentRewardsBalancesWithPassUniqueIdentifier:(id)arg1;
- (id)paymentRewardsRedemptionForPaymentHash:(id)arg1;
- (id)paymentRewardsRedemptionsForPassUniqueIdentifier:(id)arg1 limit:(long long)arg2;
- (void)paymentRewardsRedemptionsForPassUniqueIdentifier:(id)arg1 paymentHashes:(id)arg2 completion:(id /* block */)arg3;
...
- (void)queueIdentityPassProvisioningWithPassMetadata:(id)arg1 targetDeviceIdentifier:(id)arg2 credentialIdentifier:(id)arg3 supplementalData:(id)arg4 completion:(id /* block */)arg5;
...
- (void)recordPaymentApplicationUsageForPassUniqueIdentifier:(id)arg1 paymentApplicationIdentifier:(id)arg2;
...
- (void)regionsMatchingName:(id)arg1 types:(id)arg2 completion:(id /* block */)arg3;
- (void)regionsWithIdentifiers:(id)arg1 completion:(id /* block */)arg2;
...
- (void)rejectShareForMailboxAddress:(id)arg1;
...
- (void)removeExpressPassWithUniqueIdentifierV2:(id)arg1 completion:(id /* block */)arg2;
...
- (void)revokeCredentialsWithReaderIdentifiers:(id)arg1 completion:(id /* block */)arg2;
...
- (void)saveProvisioningSupportData:(id)arg1 completion:(id /* block */)arg2;
...
- (void)setDoubleClickAllowed:(bool)arg1;
- (void)setExpressWithPassConfiguration:(id)arg1 credential:(id)arg2 handler:(id /* block */)arg3;
...
- (void)simulateSecureEvent:(id)arg1;
...
- (void)tilesForPassWithUniqueIdentifier:(id)arg1 context:(long long)arg2 completion:(id /* block */)arg3;
...
- (void)transactionsTotalAmountForRequest:(id)arg1 completion:(id /* block */)arg2;
- (void)transactionsWithFullPaymentHashes:(id)arg1 transactionSourceIdentifiers:(id)arg2 completion:(id /* block */)arg3;
- (void)transactionsWithTransactionIdentifiers:(id)arg1 completion:(id /* block */)arg2;
...
- (void)updatePaymentOffersCatalogWithCompletion:(id /* block */)arg1;
- (void)updatePaymentRewardsBalancesWithPassUniqueIdentifier:(id)arg1 completion:(id /* block */)arg2;
- (void)updatePaymentRewardsRedemptionsWithPassUniqueIdentifier:(id)arg1 limit:(long long)arg2 completion:(id /* block */)arg3;
...
- (void)userNotificationActionPerformed:(unsigned long long)arg1 notificationIdentifier:(id)arg2 completion:(id /* block */)arg3;
