...
@interface PKPaymentTransaction : NSObject <NSSecureCoding, PKCloudStoreCoding> {
    ...
    NSArray * _awards;
    long long  _bankConnectCreditDebitIndicator;
    NSURL * _bankConnectDigitalServicingURL;
    PKPaymentTransactionBankConnectMetadata * _bankConnectMetadata;
    NSURL * _bankConnectPayNowURL;
    NSURL * _bankConnectPostInstallmentURL;
    NSURL * _bankConnectRedeemRewardsURL;
    bool  _bankConnectRoundTransactionDate;
    bool  _bankConnectTransactionWasClassifiedByMaps;
    NSURL * _bankConnectTransferFundsURL;
    ...
    bool  _isIssuerInstallmentTransaction;
...
@property (nonatomic) long long bankConnectCreditDebitIndicator;
@property (nonatomic, retain) NSURL *bankConnectDigitalServicingURL;
@property (nonatomic, retain) PKPaymentTransactionBankConnectMetadata *bankConnectMetadata;
@property (nonatomic, retain) NSURL *bankConnectPayNowURL;
@property (nonatomic, retain) NSURL *bankConnectPostInstallmentURL;
@property (nonatomic, retain) NSURL *bankConnectRedeemRewardsURL;
@property (nonatomic) bool bankConnectRoundTransactionDate;
@property (nonatomic) bool bankConnectTransactionWasClassifiedByMaps;
@property (nonatomic, retain) NSURL *bankConnectTransferFundsURL;
...
@property (nonatomic) bool isBankConnectTransaction;
@property (nonatomic) bool isCloudKitArchived;
@property (nonatomic) bool isIssuerInstallmentTransaction;
...
@property (nonatomic, readonly) PKAccountServicingEvent *latestDisputeEvent;
...
@property (nonatomic) bool needsSyncWithFinance;
...
@property (nonatomic, retain) PKPaymentRewardsRedemption *paymentRewardsRedemption;
@property (nonatomic, retain) NSArray *payments;
@property (nonatomic, copy) NSString *peerPaymentCounterpartHandle;
@property (nonatomic, retain) NSString *peerPaymentCounterpartImageRecordIdentifier;
...
@property (getter=isUnknownNearbyPeerPayment, nonatomic, readonly) bool unknownNearbyPeerPayment;
...
+ (void)augmentTransactionsIfNeeded:(id)arg1 transactionSourceIdentifiers:(id)arg2 passUniqueID:(id)arg3 usingDataProvider:(id)arg4 completion:(id /* block */)arg5;
...
+ (id)formattedBalanceAdjustmentForCurrencyAmount:(id)arg1 transactionType:(long long)arg2 adjustmentType:(long long)arg3 peerPaymentType:(long long)arg4 featureIdentifier:(unsigned long long)arg5 isBankConnectTransaction:(bool)arg6 bankConnectCreditDebitIndicator:(long long)arg7 pending:(bool)arg8;
+ (id)formattedBalanceAdjustmentForTransactionAmount:(id)arg1 transactionType:(long long)arg2 adjustmentType:(long long)arg3 peerPaymentType:(long long)arg4 isBankConnectTransaction:(bool)arg5 bankConnectCreditDebitIndicator:(long long)arg6 featureIdentifier:(unsigned long long)arg7;
+ (bool)isPositiveBalanceAdjustmentForCurrencyAmount:(id)arg1 transactionType:(long long)arg2 adjustmentType:(long long)arg3 peerPaymentType:(long long)arg4 isBankConnectTransaction:(bool)arg5 bankConnectCreditDebitIndicator:(long long)arg6 featureIdentifier:(unsigned long long)arg7;
...
- (id)awards;
- (long long)bankConnectCreditDebitIndicator;
- (id)bankConnectDigitalServicingURL;
- (id)bankConnectMetadata;
- (id)bankConnectPayNowURL;
- (id)bankConnectPostInstallmentURL;
- (id)bankConnectRedeemRewardsURL;
- (bool)bankConnectRoundTransactionDate;
- (bool)bankConnectTransactionWasClassifiedByMaps;
- (id)bankConnectTransferFundsURL;
...
- (id)peerPaymentCounterpartImageRecordIdentifier;
- (id)peerPaymentMemo;
...
- (void)setBankConnectCreditDebitIndicator:(long long)arg1;
- (void)setBankConnectDigitalServicingURL:(id)arg1;
- (void)setBankConnectMetadata:(id)arg1;
- (void)setBankConnectPayNowURL:(id)arg1;
- (void)setBankConnectPostInstallmentURL:(id)arg1;
- (void)setBankConnectRedeemRewardsURL:(id)arg1;
- (void)setBankConnectRoundTransactionDate:(bool)arg1;
- (void)setBankConnectTransactionWasClassifiedByMaps:(bool)arg1;
- (void)setBankConnectTransferFundsURL:(id)arg1;
...
- (void)setIsBankConnectTransaction:(bool)arg1;
- (void)setIsCloudKitArchived:(bool)arg1;
- (void)setIsIssuerInstallmentTransaction:(bool)arg1;
- (void)setIsMerchantTokenTransaction:(id)arg1;
- (void)setIssueReportIdentifier:(id)arg1;
- (void)setIssuerInstallmentManagementURL:(id)arg1;
...
- (void)setNeedsSyncWithFinance:(bool)arg1;
...
- (void)setPaymentRewardsRedemption:(id)arg1;
- (void)setPayments:(id)arg1;
- (void)setPeerPaymentCounterpartHandle:(id)arg1;
- (void)setPeerPaymentCounterpartImageRecordIdentifier:(id)arg1;
...
- (void)setTopUpType:(long long)arg1;
...
- (void)setUpdateSequenceNumber:(long long)arg1;
...
- (id)initFromFKTransaction:(id)arg1 institution:(id)arg2;
