...
- (unsigned long long)_auxiliaryCapabilityRegisterResultForResponse:(id)arg1 error:(id)arg2 successHandler:(id /* block */)arg3;
- (void)_auxiliaryRegistrationServiceURLForRequest:(id)arg1 completion:(id /* block */)arg2;
- (void)_backgroundDownloadCloudStoreAssetsforItem:(id)arg1 cloudStoreCoordinatorDelegate:(id)arg2;
- (id)_brokerUrlForRegion:(id)arg1 regionOut:(id*)arg2;
...
- (void)_deviceDataIncludingMetadataFields:(unsigned long long)arg1 withCompletionHandler:(id /* block */)arg2;
...
- (id)_errorWithResult:(unsigned long long)arg1 response:(id)arg2 data:(id)arg3;
...
- (void)_handleRetryAfterRegisterWithRequest:(id)arg1 response:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (bool)_needsRegistrationForBrokerURL:(id)arg1 shouldCheckSecureElementOwnership:(bool)arg2;
...
- (unsigned long long)_passActionGroupIncludingAppletDataWithRemoteContentPassActionGroup:(id)arg1 forPass:(id)arg2 forDeviceIdentifier:(id)arg3 completion:(id /* block */)arg4;
- (unsigned long long)_passActionGroupWithRemoteContentPassActionGroup:(id)arg1 forPass:(id)arg2 forDeviceIdentifier:(id)arg3 completion:(id /* block */)arg4;
- (unsigned long long)_passActionIncludingAppletDataWithRemoteContentPassAction:(id)arg1 pass:(id)arg2 completion:(id /* block */)arg3;
- (unsigned long long)_passActionWithRemoteContentPassAction:(id)arg1 pass:(id)arg2 completion:(id /* block */)arg3;
- (unsigned long long)_passActionWithRemoteContentPassAction:(id)arg1 serviceProviderData:(id)arg2 pass:(id)arg3 completion:(id /* block */)arg4;
...
- (unsigned long long)_performAccountRequest:(id)arg1 account:(id)arg2 request:(id)arg3 taskID:(unsigned long long)arg4 responseClass:(Class)arg5 completion:(id /* block */)arg6;
- (unsigned long long)_performAccountRequest:(id)arg1 account:(id)arg2 responseClass:(Class)arg3 completion:(id /* block */)arg4;
- (unsigned long long)_performAccountRequest:(id)arg1 request:(id)arg2 responseClass:(Class)arg3 completion:(id /* block */)arg4;
...
- (unsigned long long)_performPaymentOfferRequest:(id)arg1 responseClass:(Class)arg2 completion:(id /* block */)arg3;
- (unsigned long long)_performRewrapRequest:(id)arg1 serviceURL:(id)arg2 responseHandler:(id /* block */)arg3 completion:(id /* block */)arg4;
...
- (void)_regionChanged;
- (void)_registerIfNeededWithResponse:(id)arg1 task:(id)arg2 isRedirect:(bool)arg3 completion:(id /* block */)arg4;
...
- (unsigned long long)_updateContextWithRegistrationType:(long long)arg1 response:(id)arg2;
- (void)_updateRequestWithCurrentTargetDevice:(id)arg1;
- (void)_updateSharedServiceWithContext:(id)arg1;
- (unsigned long long)accountActionWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)accountBalanceHistoryWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)accountBankLookupWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)accountDeleteBeneficiaryWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)accountDocumentActionWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)accountFinancingOptionsWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)accountFinancingPlanNonceWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)accountFinancingPlanPaymentIntentWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)accountFinancingPlansWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)accountPassDetailsRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)accountPayLaterChangeAutoPaymentWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)accountPayLaterContentWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)accountPayLaterDisputeSendEmailWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)accountPayLaterFinancingOptionCancellationWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)accountPayLaterFinancingPlanCancellationWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)accountReportFraudEventWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)accountSendReportWithRequest:(id)arg1 completion:(id /* block */)arg2;
...
- (unsigned long long)accountTaxFormsWithRequest:(id)arg1 completion:(id /* block */)arg2;
...
- (id)archiver;
- (unsigned long long)augmentSessionWithRequest:(id)arg1 serviceURL:(id)arg2 completion:(id /* block */)arg3;
- (unsigned long long)augmentedProductWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)auxiliaryCapabilityKeyCreationMetadataWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)availableCommonProductsWithRequest:(id)arg1 completion:(id /* block */)arg2;
...
- (unsigned long long)cancelPaymentOfferSessionWithRequest:(id)arg1 completion:(id /* block */)arg2;
...
- (unsigned long long)checkAuxiliaryCapabilityRegistrationStateWithRequest:(id)arg1 completion:(id /* block */)arg2;
...
- (unsigned long long)completeSessionWithRequest:(id)arg1 serviceURL:(id)arg2 completion:(id /* block */)arg3;
...
- (unsigned long long)creditRecoveryPaymentPlansWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)customizePhysicalCardWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)dailyCashEligibilityWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (void)dealloc;
- (id)delegates;
...
- (unsigned long long)deleteForRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)deleteFundingSourceWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)deleteMerchantTokenWithRequest:(id)arg1 completion:(id /* block */)arg2;
...
- (unsigned long long)enhancedMerchantsWithRequest:(id)arg1 completion:(id /* block */)arg2;
...
- (unsigned long long)generateTopUpTokenWithRequest:(id)arg1 forAccount:(id)arg2 completion:(id /* block */)arg3;
...
- (unsigned long long)inAppPaymentNonceWithRequest:(id)arg1 serviceURL:(id)arg2 completion:(id /* block */)arg3;
...
- (unsigned long long)initiateExternalProvisioningForRequest:(id)arg1 completion:(id /* block */)arg2;
...
- (bool)needsConfigurationWithSupportedRegionTimeInterval:(double)arg1 unsupportedRegionTimeInterval:(double)arg2;
- (bool)needsRegistration;
- (bool)needsRegistrationForBrokerURL:(id)arg1;
...
- (unsigned long long)passActionGroupWithRemoteContentPassActionGroup:(id)arg1 forPass:(id)arg2 completion:(id /* block */)arg3;
- (unsigned long long)passActionWithRemoteContentPassAction:(id)arg1 forDeviceIdentifier:(id)arg2 passTypeIdentifier:(id)arg3 passSerialNumber:(id)arg4 completion:(id /* block */)arg5;
- (unsigned long long)passActionWithRemoteContentPassAction:(id)arg1 forPass:(id)arg2 completion:(id /* block */)arg3;
- (unsigned long long)passActionWithRemoteContentPassAction:(id)arg1 serviceProviderData:(id)arg2 pass:(id)arg3 completion:(id /* block */)arg4;
...
- (unsigned long long)paymentOfferCatalogWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)paymentOffersDynamicContentWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)paymentOffersWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)paymentProvisioningNonceOfType:(unsigned long long)arg1 completion:(id /* block */)arg2;
- (unsigned long long)paymentRewardsBalancesWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)paymentRewardsRedemptionsWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)paymentSetupSupportedInRegion;
...
- (unsigned long long)prepareToProvisionForRequest:(id)arg1 completion:(id /* block */)arg2;
...
- (unsigned long long)promotionsWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)provideEncryptedPushProvisioningTargetWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)provisionPassesWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)provisionPrecursorPassForRequest:(id)arg1 completion:(id /* block */)arg2;
...
- (unsigned long long)regeneratePaymentCredentialsForPaymentPass:(id)arg1 vpanIdentifier:(id)arg2 nonce:(id)arg3 encryptionFields:(id)arg4 completion:(id /* block */)arg5;
...
- (void)removeVerificationRequestRecord:(id)arg1;
- (unsigned long long)repopulateZonesWithCloudStoreZoneNames:(id)arg1 completion:(id /* block */)arg2;
...
- (unsigned long long)resendVerificationRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)resolveStorefrontCountryMismatchWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)retrieveMerchantTokensWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)retrievePrivacyDeviceAssessmentStateWithRequest:(id)arg1 completion:(id /* block */)arg2;
...
- (unsigned long long)rewrapInAppPaymentWithRequest:(id)arg1 serviceURL:(id)arg2 completion:(id /* block */)arg3;
- (unsigned long long)savingsAccountStatementsWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)savingsAccountUserInfoWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)schedulePaymentWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)scheduleTransferWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)sendOwnershipTokensForReason:(unsigned long long)arg1 completion:(id /* block */)arg2;
- (unsigned long long)sendPrivacyDeviceAssessmentStateWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)serviceProviderAugmentSessionWithRequest:(id)arg1 serviceURL:(id)arg2 completion:(id /* block */)arg3;
- (unsigned long long)serviceProviderNonceWithRequest:(id)arg1 serviceURL:(id)arg2 completion:(id /* block */)arg3;
...
- (unsigned long long)submitVerificationWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)supportTopicsWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (id)supportedRegionFeatureOfType:(long long)arg1 didFailOSVersionRequirements:(bool*)arg2;
- (unsigned long long)tapToProvisionConfigurationForRequest:(id)arg1 completion:(id /* block */)arg2;
- (id)targetDevice;
...
- (unsigned long long)transferEligibilityWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)transfersWithRequest:(id)arg1 completion:(id /* block */)arg2;
...
- (void)updateContextAndNotifyIfNeeded:(id)arg1;
...
- (void)updateVerificationRecord:(id)arg1;
- (unsigned long long)vehicleManufacturerWithRequest:(id)arg1 withCompletion:(id /* block */)arg2;
...
- (unsigned long long)virtualCardPaymentSessionWithCompletion:(id /* block */)arg1;
- (unsigned long long)virtualCardSecurityCodeActivity:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)vpanNonceForPaymentPass:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)vpanPaymentCredentialsForPaymentPass:(id)arg1 vpanIdentifier:(id)arg2 nonce:(id)arg3 encryptionFields:(id)arg4 merchantHost:(id)arg5 completion:(id /* block */)arg6;
- (unsigned long long)vpanPaymentCredentialsForPaymentPass:(id)arg1 vpanIdentifier:(id)arg2 nonce:(id)arg3 encryptionFields:(id)arg4 merchantHost:(id)arg5 regenerate:(bool)arg6 completion:(id /* block */)arg7;
