...
- (id)_lock_regions;
- (bool)_lock_supportedForOSVersion:(id)arg1 inRegionDictionary:(id)arg2 deviceClass:(id)arg3 platform:(id)arg4;
...
- (id)paymentRelayServiceURLForRegion:(id)arg1;
...
- (bool)tapToProvisionEnabledForRegion:(id)arg1;
- (bool)tapToProvisionFirstProvisioningEnabledForRegion:(id)arg1;
