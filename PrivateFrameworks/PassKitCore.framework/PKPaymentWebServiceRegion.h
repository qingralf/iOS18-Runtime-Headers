...
@property (nonatomic, readonly) NSString *paymentOffersServicePushTopic;
@property (nonatomic, readonly) NSURL *paymentOffersServiceURL;
...
- (id)paymentOffersServicePushTopic;
- (id)paymentOffersServiceURL;
