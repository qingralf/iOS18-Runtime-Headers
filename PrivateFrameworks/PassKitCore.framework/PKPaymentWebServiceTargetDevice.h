...
- (void)_conflictingExpressPassIdentifiersForPassConfiguration:(id)arg1 withCompletion:(id /* block */)arg2;
- (void)_conflictingExpressPassIdentifiersForPassConfiguration:(id)arg1 withReferenceExpressState:(id)arg2 completion:(id /* block */)arg3;
...
- (void)_paymentWebService:(id)arg1 pass:(id)arg2 withExpressConfig:(id)arg3 hasDisqualifyingConflicts:(id /* block */)arg4;
...
- (void)_setExpressWithPassConfiguration:(id)arg1 credential:(id)arg2 handler:(id /* block */)arg3;
...
- (void)generateIdentityProvisioningAttestationsWithISOCredential:(id)arg1 pairingID:(id)arg2 completion:(id /* block */)arg3;
