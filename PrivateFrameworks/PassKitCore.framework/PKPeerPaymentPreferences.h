...
@property (nonatomic, copy) PKPeerPaymentPreferencesProfileAppearance *profileAppearance;
...
- (void).cxx_destruct;
- (void)addReceiveRestrictionType:(unsigned long long)arg1 altDSID:(id)arg2;
- (void)addSendRestrictionType:(unsigned long long)arg1 altDSID:(id)arg2;
...
- (id)restrictions;
- (id)restrictionsForAltDSID:(id)arg1;
- (id)sendRestrictionWithType:(unsigned long long)arg1 altDSID:(id)arg2;
...
- (void)setProfileAppearance:(id)arg1;
