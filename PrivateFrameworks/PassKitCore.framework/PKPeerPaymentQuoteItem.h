...
@property (nonatomic, readonly) bool preservesCurrentBalance;
...
@property (nonatomic, readonly, copy) NSSet *supportedFundingSourceCountryCodes;
...
- (id)supportedFundingSourceCountryCodes;
