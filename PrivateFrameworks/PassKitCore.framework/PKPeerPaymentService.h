...
- (void)counterpartImageDataForTransactionWithIdentifier:(id)arg1 completion:(id /* block */)arg2;
- (void)counterpartImageDataWithCompletion:(id /* block */)arg1;
- (void)counterpartImageDataWithIdentifier:(id)arg1 completion:(id /* block */)arg2;
- (void)dealloc;
- (void)deleteAccountWithCompletion:(id /* block */)arg1;
- (void)deleteAllCounterpartImageDataWithCompletion:(id /* block */)arg1;
...
- (void)encryptData:(id)arg1 usingCertificateWithDestination:(unsigned long long)arg2 completion:(id /* block */)arg3;
- (void)encryptionCertificateForDestination:(unsigned long long)arg1 forceUpdate:(bool)arg2 completion:(id /* block */)arg3;
- (bool)hasRecurringPayments;
- (id)init;
- (void)initalizeCloudStoreIfNecessaryWithHandler:(id /* block */)arg1;
- (void)insertOrUpdateDeviceOriginatedNearbyPeerPaymentTransactionWithIdentifier:(id)arg1 memo:(id)arg2 counterpartAppearanceData:(id)arg3 completion:(id /* block */)arg4;
- (void)insertOrUpdateNearbyPeerPaymentSetupNotificationWithTransactionIdentifier:(id)arg1 amount:(id)arg2 currency:(id)arg3 senderName:(id)arg4 completion:(id /* block */)arg5;
...
- (void)presentReceiverFlowWithOrientation:(id)arg1 host:(unsigned long long)arg2 completion:(id /* block */)arg3;
...
- (void)presentSenderFlowWithHost:(unsigned long long)arg1 userInfo:(id)arg2 completion:(id /* block */)arg3;
...
- (void)reportFailureDiagnostic:(id)arg1 completion:(id /* block */)arg2;
