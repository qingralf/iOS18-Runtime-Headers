...
- (unsigned long long)peerPaymentEncryptionCertificateForDestination:(unsigned long long)arg1 withCompletion:(id /* block */)arg2;
- (unsigned long long)peerPaymentFailureDiagnosticWithRequest:(id)arg1 withCompletion:(id /* block */)arg2;
