...
+ (bool)physicalCard:(id)arg1 matchesActivationCode:(id)arg2;
...
- (id)expirationDateInCalendar:(id)arg1;
- (unsigned long long)expirationMonth;
- (unsigned long long)expirationYear;
...
- (bool)isExpiredInCalendar:(id)arg1;
...
- (void)setExpirationMonth:(unsigned long long)arg1;
- (void)setExpirationYear:(unsigned long long)arg1;
