...
@property (nonatomic, retain) PKProtobufNSDecimalNumber *balanceInAppPINRequiredAmount;
...
@property (nonatomic, readonly) bool hasBalanceInAppPINRequiredAmount;
...
@property (nonatomic) bool hasSupportsInstantFundsIn;
...
- (id)balanceInAppPINRequiredAmount;
- (void)copyTo:(id)arg1;
...
- (void)setBalanceInAppPINRequiredAmount:(id)arg1;
...
- (void)setHasSupportsInstantFundsIn:(bool)arg1;
