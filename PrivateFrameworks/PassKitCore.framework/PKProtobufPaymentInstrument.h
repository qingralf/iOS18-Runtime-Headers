...
@property (nonatomic, retain) NSString *cobrandName;
@property (nonatomic) bool cobranded;
@property (nonatomic, retain) PKProtobufCustomPrecisionAmount *customPrecisionPeerPaymentAccountBalance;
@property (nonatomic, retain) PKProtobufNSDecimalNumber *decimalAccountBalance;
@property (nonatomic, retain) NSString *displayName;
@property (nonatomic) bool hasAssociatedAccountFeatureIdentifier;
@property (nonatomic) bool hasAssociatedPeerPaymentAccount;
@property (nonatomic, readonly) bool hasCobrandName;
@property (nonatomic) bool hasCobranded;
@property (nonatomic, readonly) bool hasCustomPrecisionPeerPaymentAccountBalance;
@property (nonatomic, readonly) bool hasDecimalAccountBalance;
...
- (unsigned int)associatedAccountFeatureIdentifier;
...
- (id)customPrecisionPeerPaymentAccountBalance;
- (id)decimalAccountBalance;
- (id)description;
...
- (void)setAssociatedAccountFeatureIdentifier:(unsigned int)arg1;
- (void)setAssociatedWebDomains:(id)arg1;
- (void)setCobrandName:(id)arg1;
- (void)setCobranded:(bool)arg1;
- (void)setCustomPrecisionPeerPaymentAccountBalance:(id)arg1;
- (void)setDecimalAccountBalance:(id)arg1;
- (void)setDisplayName:(id)arg1;
- (void)setHasAssociatedAccountFeatureIdentifier:(bool)arg1;
- (void)setHasAssociatedPeerPaymentAccount:(bool)arg1;
- (void)setHasCobranded:(bool)arg1;
