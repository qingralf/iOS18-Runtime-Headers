...
- (void)checkMultipleFidoKeyPresenceForFIDOProfiles:(id)arg1 completion:(id /* block */)arg2;
...
- (void)createAliroHomeKeyWithReaderIdentifier:(id)arg1 readerPublicKey:(id)arg2 homeIdentifier:(id)arg3 withCompletion:(id /* block */)arg4;
- (void)createAliroHydraKeyWithServerParameters:(id)arg1 withCompletion:(id /* block */)arg2;
...
- (void)hasLongTermPrivacyKeyForCredentialGroupIdentifier:(id)arg1 completion:(id /* block */)arg2;
...
- (void)markAllAppletsForDeletionWithExternalAuthorization:(id)arg1 obliterate:(bool)arg2 completion:(id /* block */)arg3;
