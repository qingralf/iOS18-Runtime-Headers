...
@property (nonatomic, readonly) NSArray *deviceUpgradeRequests;
@property (nonatomic) bool hasAssociatedPeerPaymentAccount;
@property (nonatomic, copy) NSString *identityAccountKeyIdentifier;
@property (nonatomic, readonly) long long identityType;
@property (nonatomic, readonly) bool isPaymentOptionSelectable;
...
- (long long)cardType;
- (id)cobrandName;
- (unsigned long long)contactlessActivationGroupingType;
...
- (id)devicePaymentApplicationForAID:(id)arg1;
...
- (id)precursorUpgradeRequestsForDeviceSEIDs:(id)arg1 deviceClass:(id)arg2 deviceVersion:(id)arg3;
...
- (void)setContactlessActivationGroupingType:(unsigned long long)arg1;
...
- (id)speakableMake;
- (id)speakableModel;
- (id)subcredentialConfigurationForSecureElementIdentifiers:(id)arg1;
