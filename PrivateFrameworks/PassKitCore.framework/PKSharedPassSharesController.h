...
@property (nonatomic) bool isOwnerSharing;
...
- (void).cxx_destruct;
- (id)_baseNewShareForPassIsTransfer:(bool)arg1;
- (id)_contactResolver;
- (id)_feature;
...
- (id)baseShareForPassTransferWithIsForCompanion:(bool)arg1;
- (id)blockedSharingChannels;
- (bool)canAllowResharing;
- (void)canSendInvitationWithCompletion:(id /* block */)arg1;
- (void)canSendInvitationWithIsTransfer:(bool)arg1 completion:(id /* block */)arg2;
- (void)canTransferWithCompletion:(id /* block */)arg1;
...
- (void)setIsOwnerSharing:(bool)arg1;
