...
@interface PKAddBankAccountInformationViewController : PKPaymentSetupTableViewController <PKPaymentSetupViewControllerDelegate, UITextFieldDelegate> {
    ...
    bool  _saveToBankCredentialCenter;
...
@property (nonatomic) bool saveToBankCredentialCenter;
...
- (void)_setContentHidden:(bool)arg1;
...
- (void)setSaveToBankCredentialCenter:(bool)arg1;
