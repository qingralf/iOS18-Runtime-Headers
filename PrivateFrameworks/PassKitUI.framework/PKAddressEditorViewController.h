...
@interface PKAddressEditorViewController : UITableViewController <MKLocalSearchCompleterDelegate, PKAddressTextFieldDelegate, PKCountryPickerViewControllerDelegate, UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate> {
    ...
    PKAddressTextField * _countryTextField;
    ...
    PKAddressTextField * _previouslySelectedField;
    bool  _readOnly;
...
@property (nonatomic) PKAddressTextField *countryTextField;
...
@property (nonatomic, retain) PKAddressTextField *previouslySelectedField;
...
@property (nonatomic) PKAddressTextField *street1TextField;
@property (nonatomic) PKAddressTextField *street2TextField;
...
- (void)_presentPickerForAddressTextField:(id)arg1;
...
- (void)setCountryTextField:(id)arg1;
...
- (void)setOriginalCountry:(id)arg1;
...
- (void)setPreviouslySelectedField:(id)arg1;
- (void)setReadOnly:(bool)arg1;
- (void)setRequiredFieldKeys:(id)arg1;
- (void)setRequirementsMet:(bool)arg1;
- (void)setSearchCompleter:(id)arg1;
- (void)setStreet1TextField:(id)arg1;
- (void)setStreet2TextField:(id)arg1;
