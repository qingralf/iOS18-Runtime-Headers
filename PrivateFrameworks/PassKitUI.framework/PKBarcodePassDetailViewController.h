...
@interface PKBarcodePassDetailViewController : PKSectionTableViewController <PKDeletePassIntentHandler, PKLinkedAppViewDelegate, PKPassHeaderViewDelegate, UITextViewDelegate> {
