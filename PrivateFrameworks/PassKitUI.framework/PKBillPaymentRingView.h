...
@interface PKBillPaymentRingView : UIView <PKRenderLoopDelegate, UIGestureRecognizerDelegate> {
    ...
    bool  _preparedForInitialDisplay;
...
- (struct CGPoint { double x1; double x2; })_centerPointAtAngle:(double)arg1 adjustToCover:(bool)arg2;
...
- (void)setAmount:(id)arg1 animated:(bool)arg2 userInitiatedWithKeypad:(bool)arg3;
- (void)setAngle:(double)arg1 animated:(bool)arg2 forExplicitAmount:(id)arg3 userInitiatedWithRing:(bool)arg4 userInitiatedWithKeypad:(bool)arg5;
