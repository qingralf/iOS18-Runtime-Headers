...
@interface PKCommutePlanDetailsViewController : PKSectionTableViewController <PKPaymentDataProviderDelegate, PKPerformActionViewControllerDelegate> {
    ...
    bool  _dataProviderImplementsBalanceReminderAPI;
    bool  _dataProviderImplementsCommutePlanReminderAPI;
    NSArray * _fields;
    PKPaymentPass * _pass;
...
- (void)_fetchRemindersWithCompletion:(id /* block */)arg1;
...
- (void)_reloadBalanceWithCompletion:(id /* block */)arg1;
...
- (void)_resetReminderIntervalsForCountPlans:(id)arg1;
- (void)_resetReminderIntervalsForTimedPlans:(id)arg1;
