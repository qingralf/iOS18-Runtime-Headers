...
- (void).cxx_destruct;
- (id)_initWithPaymentPass:(id)arg1 visibleSectionIdentifiers:(id)arg2 clientReservedIdentifiers:(id)arg3 renderUnclaimedFields:(bool)arg4;
- (bool)_validateField:(id)arg1;
- (id)allSectionIdentifiers;
- (id)delegate;
- (bool)hasArbitraryInfoField:(id)arg1;
- (id)init;
- (id)initWithPaymentPass:(id)arg1 clientReservedIdentifiers:(id)arg2;
