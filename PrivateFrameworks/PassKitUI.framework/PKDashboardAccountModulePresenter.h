...
- (id)accountViewControllerWithConfiguration:(id)arg1 presentationContext:(id)arg2;
...
- (id)init;
- (Class)itemClass;
- (void)pushAccountViewControllerForAccount:(id)arg1 presentingPass:(id)arg2 presentationContext:(id)arg3 onNavigationController:(id)arg4;
