...
@interface PKDashboardBankConnectPresenter : NSObject <PKDashboardItemPresenter> {
    long long  _cellStyle;
    _TtC9PassKitUI32PKDashboardBankConnectCreditCell * _sampleBankConnectCreditView;
    _TtC9PassKitUI31PKDashboardBankConnectDebitCell * _sampleBankConnectDebitView;
}
...
- (void).cxx_destruct;
- (void)_updateCreditView:(id)arg1 withItem:(id)arg2;
- (void)_updateDebitView:(id)arg1 withItem:(id)arg2;
