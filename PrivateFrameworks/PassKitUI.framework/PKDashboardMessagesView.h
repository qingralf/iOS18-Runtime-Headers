...
- (void)_configureEngagementCell:(id)arg1 withMessage:(id)arg2;
- (void)_configureMessageCell:(id)arg1 withMessage:(id)arg2 leftContentInset:(double)arg3;
...
- (bool)isActionPresentedAsButtonCellForMessage:(id)arg1;
- (void)layoutSubviews;
- (id)messages;
