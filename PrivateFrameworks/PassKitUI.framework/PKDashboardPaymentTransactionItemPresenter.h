...
- (void)_updatePrimaryLabelOnTransactionCell:(id)arg1 withPeerPaymentCounterpartHandle:(id)arg2 contact:(id)arg3 transaction:(id)arg4;
- (id)appleCardImage;
...
- (void)viewControllerForTransaction:(id)arg1 transactionSourceCollection:(id)arg2 familyCollection:(id)arg3 account:(id)arg4 accountUserCollection:(id)arg5 bankConnectInstitution:(id)arg6 physicalCards:(id)arg7 forcePreventHistory:(bool)arg8 completion:(id /* block */)arg9;
