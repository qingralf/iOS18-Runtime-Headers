...
@interface PKDashboardViewController : UICollectionViewController <PKDashboardDataSourceDelegate, PKDashboardItemPresenterDelegate, PKDashboardViewControllerDelegateFlowLayout, UICollectionViewDataSourcePrefetching> {
    ...
    bool  _freezeChromelessNavigationItem;
    ...
    bool  _trackingDismissInteraction;
    bool  _useChromelessNavigationItem;
...
@property (nonatomic) bool freezeChromelessNavigationItem;
@property (readonly) unsigned long long hash;
@property (nonatomic, readonly) bool shouldPresentAllContent;
@property (readonly) Class superclass;
@property (nonatomic) bool useChromelessNavigationItem;
...
- (void)_resolveDismissInteractionForScrollView:(id)arg1;
...
- (void)invalidateLayoutForCell:(id)arg1;
...
- (void)setFreezeChromelessNavigationItem:(bool)arg1;
- (void)setUseChromelessNavigationItem:(bool)arg1;
