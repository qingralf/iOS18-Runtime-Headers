...
@interface PKDiscoveryArticleViewController : UIViewController <PKDiscoveryCardViewDelegate, PKPaymentSetupDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UIGestureRecognizerDelegate, UIViewControllerTransitioningDelegate> {
    ...
    <PKProximityReaderDiscoveryDelegate> * _proximityReaderDelegate;
...
@property (nonatomic) <PKProximityReaderDiscoveryDelegate> *proximityReaderDelegate;
...
- (void)_loadMedia:(id)arg1 forShelfViewAtIndexPath:(id)arg2 withCellImageCacheKey:(id)arg3 completion:(id /* block */)arg4;
...
- (void)setProximityReaderDelegate:(id)arg1;
