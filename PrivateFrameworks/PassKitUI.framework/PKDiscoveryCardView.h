...
- (id)initWithArticleLayout:(id)arg1 dismissImage:(id)arg2 cardTemplateInformation:(id)arg3 callToActionTappedOverride:(id /* block */)arg4 isWelcomeCard:(bool)arg5;
- (id)initWithArticleLayout:(id)arg1 dismissImage:(id)arg2 cardTemplateInformation:(id)arg3 isWelcomeCard:(bool)arg4;
- (bool)isRemoving;
- (void)layoutSubviews;
