...
@interface PKEditGroupsViewController : PKEditTableViewController <PKEditGroupViewControllerDelegate, PKEditTableViewControllerCachingDelegate, PKGroupObserver, PKGroupsControllerDelegate> {
...
- (id)initInEditingMode:(bool)arg1 existingGroupsController:(id)arg2 isForWatch:(bool)arg3;
