...
@interface PKExplanationView : UIView <UIScrollViewDelegate, UITextViewDelegate, _PKVisibilityBackdropViewDelegate> {
    ...
    unsigned long long  _titleLineBreakStrategy;
    NSString * _titleText;
    long long  _titleTextAlignment;
    long long  _titleTextNumberOfLines;
...
- (void)setTitleLineBreakStrategy:(unsigned long long)arg1;
- (void)setTitleText:(id)arg1;
- (void)setTitleTextAlignment:(long long)arg1;
- (void)setTitleTextNumberOfLines:(long long)arg1;
...
- (id)titleImage;
- (unsigned long long)titleLineBreakStrategy;
- (id)titleText;
- (long long)titleTextAlignment;
- (long long)titleTextNumberOfLines;
