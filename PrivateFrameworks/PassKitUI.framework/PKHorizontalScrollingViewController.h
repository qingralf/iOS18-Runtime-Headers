...
@interface PKHorizontalScrollingViewController : UIViewController <PKHorizontalScrollingChildViewControllerDelegate, PKHorizontalScrollingViewControllerDataSource, UIScrollViewDelegate> {
    double  _childViewControllerVerticalOffset;
    struct CGSize { 
        double width; 
        double height; 
    }  _currentSize;
...
- (void)horizontalScrollingChildViewController:(id)arg1 scrollViewDidScroll:(id)arg2;
