...
- (id)initWithDelegate:(id)arg1 memo:(id)arg2 context:(long long)arg3;
- (id)initWithDelegate:(id)arg1 memo:(id)arg2 context:(long long)arg3 mode:(unsigned long long)arg4;
