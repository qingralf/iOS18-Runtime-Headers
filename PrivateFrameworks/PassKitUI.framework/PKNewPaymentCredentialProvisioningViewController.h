...
- (id)initWithProvisioningController:(id)arg1 webService:(id)arg2 context:(long long)arg3 paymentCredential:(id)arg4 setupProduct:(id)arg5 allowsManualEntry:(bool)arg6 reporter:(id)arg7;
- (bool)isComplete;
- (void)loadView;
