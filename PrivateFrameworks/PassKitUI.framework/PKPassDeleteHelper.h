...
+ (void)deletePaymentPassAlertCopyForPass:(id)arg1 withAccount:(id)arg2 paymentServiceDataProvider:(id)arg3 transitBalanceModel:(id)arg4 transitPassProperties:(id)arg5 merchantTokensResponse:(id)arg6 fkInstitution:(id)arg7 isBridge:(bool)arg8 completion:(id /* block */)arg9;
+ (bool)hasAppleCashMerchantTokenForMerchantTokensResponse:(id)arg1;
+ (bool)hasPositiveBalanceForTransitPassProperties:(id)arg1 transitBalanceModel:(id)arg2;
+ (void)presentDeleteBarcodePassAlertForPass:(id)arg1 withHandler:(id)arg2 presentingViewController:(id)arg3;
+ (void)presentDeletePaymentPassAlertForPass:(id)arg1 withAccount:(id)arg2 paymentServiceDataProvider:(id)arg3 transitBalanceModel:(id)arg4 transitPassProperties:(id)arg5 fkInstitution:(id)arg6 detailViewStyle:(long long)arg7 deleteHander:(id)arg8 passLibraryDataProvider:(id)arg9 presentingViewController:(id)arg10;
