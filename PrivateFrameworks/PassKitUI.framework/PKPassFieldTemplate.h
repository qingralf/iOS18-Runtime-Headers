...
@property (nonatomic, retain) NSString *automaticVibrantLabelBlendMode;
@property (nonatomic, retain) UIColor *automaticVibrantLabelColor;
@property (nonatomic, retain) NSString *automaticVibrantValueBlendMode;
@property (nonatomic, retain) UIColor *automaticVibrantValueColor;
@property (nonatomic, retain) NSNumber *boxedLabelCaseStyle;
@property (nonatomic, retain) NSNumber *boxedPreferredSingleStyle;
...
- (void).cxx_destruct;
- (id)automaticVibrantLabelBlendMode;
- (id)automaticVibrantLabelColor;
- (id)automaticVibrantValueBlendMode;
- (id)automaticVibrantValueColor;
- (id)boxedLabelCaseStyle;
- (id)boxedPreferredSingleStyle;
...
- (id)labelFont;
- (long long)preferredSingleStyle;
- (void)setAutomaticVibrantLabelBlendMode:(id)arg1;
- (void)setAutomaticVibrantLabelColor:(id)arg1;
- (void)setAutomaticVibrantValueBlendMode:(id)arg1;
- (void)setAutomaticVibrantValueColor:(id)arg1;
- (void)setBoxedLabelCaseStyle:(id)arg1;
- (void)setBoxedPreferredSingleStyle:(id)arg1;
...
- (void)setPreferredSingleStyle:(long long)arg1;
