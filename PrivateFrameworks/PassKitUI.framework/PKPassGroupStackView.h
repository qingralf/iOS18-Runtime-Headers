...
@interface PKPassGroupStackView : UIScrollView <PKDashboardPassViewControllerDelegate, PKInvalidatable, PKPassDeleteAnimationControllerDelegate, PKPassDeleteHandler, PKPassFooterViewDelegate, PKPassGroupViewDelegate, PKPassGroupViewObserver, PKPassGroupViewReceiver, PKPaymentServiceDelegate> {
    ...
    struct { 
        struct { 
            ...
            unsigned int separated : 1; 
            unsigned int hasPaymentPasses : 1; 
            unsigned int hasBarcodePasses : 1; 
        } groups; 
        unsigned int supportsExternalPresentation : 1; 
        ...
        unsigned int hasPaymentPassSection : 1; 
        unsigned int hasBarcodePassSection : 1; 
        unsigned int hasPaymentHeaderView : 1; 
        unsigned int hasPassHeaderView : 1; 
        unsigned int hasPaymentSubheaderViews : 1; 
        unsigned int hasPassSubheaderViews : 1; 
...
- (void).cxx_destruct;
- (bool)_acquireGroupView:(id)arg1 resetExternalVC:(bool)arg2;
...
- (void)_beginGroupPanWithAnimator:(id)arg1;
...
- (id)_createSortedGroupViewIndexesWithMap:(id*)arg1;
...
- (void)_endGroupPanWithAnimator:(id)arg1;
...
- (id)_groupViewWithGroupID:(id)arg1;
...
- (id)_layoutStateForHeaderContext:(id)arg1 inTableWithBounds:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2;
- (id)_layoutStateForHeaderContext:(id)arg1 offscreenWithBounds:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 offset:(double)arg3;
...
- (bool)_loadModalGroupViewIfNecessaryInInitialState:(long long)arg1;
...
- (double)_opacityForGroupAtIndex:(unsigned long long)arg1 withGroupView:(id)arg2 forState:(long long)arg3;
...
- (void)_removePanGestureRecognizerFromGroupView:(id)arg1;
...
- (bool)_updateContentSizeWithPriorBounds:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; }*)arg1 bounds:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; }*)arg2;
...
- (bool)_updateHeaderFooterStateAnimated:(bool)arg1 layout:(bool)arg2;
- (void)_updateModalGroupViewFromTableToExternalPresentationWithFactory:(id)arg1;
- (void)_updatePanGestureRecognizerForGroupView:(id)arg1;
...
- (bool)isViewCurrentlyPresentedFooterView:(id)arg1;
...
- (void)reloadData;
- (void)reloadSuppressedContentForGroupView:(id)arg1;
