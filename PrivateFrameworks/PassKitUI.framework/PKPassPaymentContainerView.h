...
@interface PKPassPaymentContainerView : PKPassFooterContentView <PKAuthenticatorDelegate, PKCompactNavigationContainerControllerDelegate, PKContactlessInterfaceSessionDelegate, PKDataReleaseViewControllerDelegate, PKForegroundActiveArbiterObserver, PKLinkedApplicationObserver, PKPassPaymentApplicationViewDelegate, PKPassPaymentPayStateViewDelegate, PKPassTileGroupViewDelegate, PKPaymentServiceDelegate, PKTransactionAuthenticationPasscodeViewControllerDelegate, PKUIForegroundActiveArbiterDeactivationObserver, UITextViewDelegate> {
    ...
    bool  _didReceiveISO18013Signal;
...
- (void)_activateForPaymentWithApplications:(id)arg1;
- (void)_activatePaymentApplications:(id)arg1 forPaymentPass:(id)arg2 withCompletion:(id /* block */)arg3;
...
- (void)contactlessInterfaceSessionDidFail:(id)arg1 forPaymentApplications:(id)arg2 paymentPass:(id)arg3 valueAddedServicePasses:(id)arg4;
...
- (void)contactlessInterfaceSessionDidStartTransaction:(id)arg1 withContext:(id)arg2;
...
- (void)contactlessInterfaceSessionDidTimeout:(id)arg1 forPaymentApplications:(id)arg2 paymentPass:(id)arg3 valueAddedServicePasses:(id)arg4;
...
- (id)initWithPass:(id)arg1 passView:(id)arg2 context:(id)arg3 paymentSession:(id)arg4 paymentService:(id)arg5;
...
- (void)payStateViewRevealingFailure:(id)arg1;
