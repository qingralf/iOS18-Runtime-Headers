...
+ (id)contextWithWasAutomaticallySelected:(bool)arg1 additionalPassUniqueIdentifiers:(id)arg2 userInfo:(id)arg3 terminalType:(long long)arg4;
...
- (void)setTerminalType:(long long)arg1;
