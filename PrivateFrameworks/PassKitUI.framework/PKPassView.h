...
@property (nonatomic, retain) PKAccount *associatedAccount;
@property (nonatomic) long long contentMode;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (nonatomic) <PKPassViewDelegate> *delegate;
...
@property (nonatomic, retain) PKPassDynamicState *passState;
...
- (void)addPassViewObserver:(id)arg1;
...
- (void)removePassViewObserver:(id)arg1;
- (id)rendererState;
