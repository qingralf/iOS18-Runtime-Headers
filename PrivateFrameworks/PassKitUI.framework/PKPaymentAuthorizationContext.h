...
@interface PKPaymentAuthorizationContext : NSObject {
    bool  _awaitingRemoteNetworkPaymentRequest;
...
@property (nonatomic, readonly) bool awaitingRemoteNetworkPaymentRequest;
...
- (void)fulfillPromisedRemoteNetworkPaymentRequest:(id)arg1;
