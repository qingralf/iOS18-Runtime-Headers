...
- (void)_presentAwaitingRemoteNetworkPaymentRequestWithRelevantUniqueID:(id)arg1;
...
- (void)authorizationDidFulfillPaymentRequest:(id)arg1 completion:(id /* block */)arg2;
