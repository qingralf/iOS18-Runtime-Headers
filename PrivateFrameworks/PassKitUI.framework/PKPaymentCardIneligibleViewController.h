...
@interface PKPaymentCardIneligibleViewController : UIViewController <WKNavigationDelegate> {
    ...
    long long  _reason;
    id /* block */  _terminateFlowHandler;
    WKWebView * _webView;
}
...
@property (nonatomic, copy) id /* block */ terminateFlowHandler;
...
- (id)initWithReason:(long long)arg1 context:(long long)arg2;
...
- (void)setTerminateFlowHandler:(id /* block */)arg1;
- (id /* block */)terminateFlowHandler;
- (void)viewDidLoad;
- (id)webView;
