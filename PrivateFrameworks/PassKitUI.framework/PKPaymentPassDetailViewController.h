...
@interface PKPaymentPassDetailViewController : PKDynamicTableViewController <CNAvatarViewDelegate, FKBankConnectTransactionsAndGroupsProviderDelegate, MFMailComposeViewControllerDelegate, PKAMPEnrollmentManagerObserver, PKAccountServiceAccountResolutionControllerDelegate, PKAccountServiceObserver, PKBalanceDetailsViewControllerDelegate, PKConfigurablePassDetailSectionsControllerDelegate, PKContactResolverDelegate, PKDeletePassIntentHandler, PKGroupObserver, PKLinkedAppViewDelegate, PKLinkedApplicationObserver, PKMerchantTokenDetailViewControllerDelegate, PKMerchantTokensViewControllerDelegate, PKPassDetailScheduledPaymentsSectionControllerDelegate, PKPassDetailSharesSectionControllerDelegate, PKPassDetailsIdentityBioBindingSectionControllerDelegate, PKPassDetailsPrecursorPassUpgradeSectionControllerDelegate, PKPassHeaderViewDelegate, PKPaymentDataProviderDelegate, PKPaymentPassActionWidgetViewDelegate, PKPaymentPassDetailAutoReloadActionSectionControllerDelegate, PKPaymentPassDetailContactSupportSectionControllerDelegate, PKPaymentPassDetailPassActionSectionControllerDelegate, PKPaymentPassDetailWrapperSectionControllerDelegate, PKPaymentSetupDelegate, PKPaymentVerificationControllerDelegate, PKPeerPaymentAccountResolutionControllerDelegate, PKPeerPaymentActionViewControllerDelegate, PKPerformActionViewControllerDelegate, PKPhysicalCardActionControllerDelegate, PKSecureElementPassContactIssuerHelperDelegate, PSStateRestoration, PassKitUI.PKPassDetailAccountCredentialsSectionControllerDelegate, PassKitUI.PKPassDetailBankConnectSectionControllerDelegate, UITableViewDataSource, UITableViewDelegate> {
    PKAccount * _account;
    ...
    PKSettingTableCell * _nfcExpressAccessSwitch;
    bool  _nfcExpressModeEnabled;
    bool  _nfcExpressModeSupported;
    ...
    PKSettingTableCell * _uwbExpressAccessSwitch;
    bool  _uwbExpressModeEnabled;
    bool  _uwbExpressModeSupported;
...
- (id)_barcodeCell;
- (void)_beginReportingForSubjectIfNecessary:(id)arg1;
- (id)_billingAddressCellShowingAddress:(bool)arg1 forTableView:(id)arg2;
- (void)_buildSections;
...
- (id)_configurableSectionForSectionType:(unsigned long long)arg1;
...
- (id)_expressAccessCellForIndexPath:(id)arg1 tableView:(id)arg2;
- (void)_expressAccessSwitchChanged:(id)arg1 isUWB:(bool)arg2;
...
- (id)_footerViewForPeerPaymentBalanceSectionWithTableView:(id)arg1;
...
- (id)_imageViewCellForImage:(id)arg1 forTableView:(id)arg2;
...
- (bool)_isBankConnectSupportedForPaymentPass:(id)arg1;
- (bool)_isDeletingPass;
- (bool)_isJapaneseRegion;
- (bool)_isShowingLostModeInterface;
- (id)_legalNoticesFooterWithAttributedString:(id)arg1 combineString:(id)arg2 outputURL:(id*)arg3;
...
- (id)_nfcExpressAccessCellForTableView:(id)arg1;
- (void)_nfcExpressAccessSwitchChanged:(id)arg1;
...
- (void)_setExpressAccessEnabled:(bool)arg1 isUWB:(bool)arg2 paymentSetupContext:(long long)arg3 authenticationCredential:(id)arg4;
...
- (id)_uwbExpressAccessCellForTableView:(id)arg1;
- (void)_uwbExpressAccessSwitchChanged:(id)arg1;
...
- (id)createPrivacyFooterViewForContext:(unsigned long long)arg1 tintColor:(id)arg2;
- (id)createPrivacyFooterViewWithText:(id)arg1 tintColor:(id)arg2 privacyContext:(unsigned long long)arg3;
- (void)dealloc;
- (id)deleteOverrider;
...
- (void)didEvaluatePolicyToOpenBankConnectAccountCredentials:(id)arg1 accountCredentialsTitle:(id)arg2;
...
- (void)didSelectDeleteReAddForSectionController:(id)arg1 completion:(id /* block */)arg2;
...
- (void)didSelectPrecursorPassRequestForDescription:(id)arg1 controller:(id)arg2 completion:(id /* block */)arg3;
...
- (void)didStartBankConnectAuthorizationForInstitution:(id)arg1 withCompletion:(id /* block */)arg2;
- (void)didUpdateBankConnectAccount:(id)arg1;
...
- (void)presentCombinedPassActionViewControllerFromBundle:(id)arg1;
...
- (id)primaryTextColor;
- (id)privacyFooterAttributedStringWithText:(id)arg1 privacyContext:(unsigned long long)arg2 outputURL:(id*)arg3;
