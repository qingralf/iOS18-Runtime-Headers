...
@interface PKPaymentPreferenceCardCell : PKPaymentPreferenceCell {
    ...
    UIColor * _disabledSubtitleLabelColor;
    ...
    NSString * _subtitleOverrideString;
...
@property (nonatomic, retain) UIColor *disabledSubtitleLabelColor;
...
@property (nonatomic, retain) UIColor *subtitleLabelColor;
@property (nonatomic, copy) NSString *subtitleOverrideString;
...
- (void)setDisabledSubtitleLabelColor:(id)arg1;
