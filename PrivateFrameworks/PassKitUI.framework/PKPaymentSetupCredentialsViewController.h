...
- (void)_reportSelectedCredentials:(id)arg1;
...
- (void)dealloc;
- (id)flowDelegate;
- (id)initWithProvisioningController:(id)arg1 context:(long long)arg2 credentials:(id)arg3 product:(id)arg4 allowsManualEntry:(bool)arg5 reporter:(id)arg6;
