...
- (struct CGSize { double x1; double x2; })_sizeThatFits:(struct CGSize { double x1; double x2; })arg1 includePrivacyLink:(bool)arg2;
...
- (struct CGSize { double x1; double x2; })sizeThatFitsWithoutPrivacyLink:(struct CGSize { double x1; double x2; })arg1;
