...
@interface PKPaymentSetupFieldCell : PKTableViewCell <PKDatePickerDelegate, UIPickerViewDataSource, UIPickerViewDelegate, UITextFieldDelegate> {
    ...
    bool  _shouldUpdateTextFieldStyling;
...
@property (nonatomic, readonly) bool isShowingError;
...
@property (nonatomic, readonly) bool usesCustomInputView;
...
- (void)_editableTextFieldDidEndEditing:(id)arg1;
- (void)_editableTextFieldValueChanged:(id)arg1;
- (void)_keyboardAccessoryButtonTapped:(id)arg1;
...
- (void)_updateTextFieldStylingWithForceUpdate:(bool)arg1;
