...
- (id)initWithRewardsValueUnit:(unsigned long long)arg1 eligibleValue:(id)arg2 isEligible:(bool)arg3 totalAmount:(id)arg4 hasPromotionalReward:(bool)arg5 promotionName:(id)arg6;
- (bool)isEmphasized;
- (id)label;
