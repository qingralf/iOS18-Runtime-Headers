...
- (id)_expiredPhysicalCardCellForTableView:(id)arg1 atIndexPath:(id)arg2;
...
- (id)_releasedDataCellForTableView:(id)arg1 atIndexPath:(id)arg2;
...
- (id)_tableViewCellPaymentRewardsRedemptionInfoForTableView:(id)arg1 atIndexPath:(id)arg2;
...
- (id)headerView;
- (bool)inBridge;
- (id)initWithTransaction:(id)arg1 transactionSourceCollection:(id)arg2 familyCollection:(id)arg3 account:(id)arg4 accountUserCollection:(id)arg5 bankConnectInstitution:(id)arg6 physicalCards:(id)arg7 contactResolver:(id)arg8 peerPaymentWebService:(id)arg9 paymentServiceDataProvider:(id)arg10 detailViewStyle:(long long)arg11 allowTransactionLinks:(bool)arg12;
