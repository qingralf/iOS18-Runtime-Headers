...
- (id)detailViewControllerForTransaction:(id)arg1 transactionSourceCollection:(id)arg2 familyCollection:(id)arg3 account:(id)arg4 accountUserCollection:(id)arg5 bankConnectInstitution:(id)arg6 physicalCards:(id)arg7;
