...
@interface PKPaymentTransactionView : UIView {
    ...
    bool  _hideSecondaryBadgeSymbolBackground;
    ...
    UIImageSymbolConfiguration * _secondaryBadgeSymbolConfiguration;
...
@property (nonatomic) bool hideSecondaryBadgeSymbolBackground;
...
@property (nonatomic, retain) UIImageSymbolConfiguration *secondaryBadgeSymbolConfiguration;
...
- (void)setSecondaryBadgeSymbolConfiguration:(id)arg1;
