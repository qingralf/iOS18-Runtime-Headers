...
@interface PKPaymentTransactionsInYearTableViewController : UITableViewController <CNAvatarViewDelegate, FKBankConnectAccountsProviderDelegate, FKBankConnectTransactionsListProviderDelegate, PKDashboardTransactionFetcherDelegate> {
    PKAccount * _account;
...
- (void)_loadBankConnectAccountWithCompletion:(id /* block */)arg1;
...
- (void)didUpdateTransactions:(id)arg1;
