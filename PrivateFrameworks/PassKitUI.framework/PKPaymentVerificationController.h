...
- (id)_bankAppName;
- (id)_bankAppStoreIDs;
- (void)_canPerformVerificationInlineForChannel:(id)arg1 completion:(id /* block */)arg2;
...
- (void)_requestDelegatePresentationOfViewController:(id)arg1 completion:(id /* block */)arg2;
- (void)_resetState;
...
- (id)bankAppStoreID;
- (void)canPerformAnyVerificationInline:(id /* block */)arg1;
