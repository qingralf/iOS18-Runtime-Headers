...
@interface PKPeerPaymentAccountResolutionController : NSObject <MFMailComposeViewControllerDelegate, PKPaymentSetupViewControllerDelegate, PKPeerPaymentAccountResolutionControllerDelegate, PKPeerPaymentActionViewControllerDelegate> {
...
- (void)_presentActivationFlowWithConfiguration:(id)arg1 completion:(id /* block */)arg2;
- (void)_presentContactAppleSupportAlertWithCompletion:(id /* block */)arg1;
- (void)_presentFlowForAccountResolution:(unsigned long long)arg1 configuration:(id)arg2 completion:(id /* block */)arg3;
- (void)_presentIdentityVerificationWithConfiguration:(id)arg1 completion:(id /* block */)arg2;
