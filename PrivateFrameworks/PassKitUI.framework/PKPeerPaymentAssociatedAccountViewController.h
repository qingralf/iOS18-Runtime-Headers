...
- (id)_receiveRestrictionAnyoneCellForTableView:(id)arg1 atIndexPath:(id)arg2;
- (id)_receiveRestrictionFamilyCellForTableView:(id)arg1 atIndexPath:(id)arg2;
- (id)_receiveRestrictionsCellForTableView:(id)arg1 atIndexPath:(id)arg2;
- (void)_receiveRestrictionsCellSelectedForTableView:(id)arg1 atIndexPath:(id)arg2;
- (bool)_receiveRestrictionsCellShouldHighlightForTableView:(id)arg1 atIndexPath:(id)arg2;
...
- (id)_sendRestrictionAnyoneCellForTableView:(id)arg1 atIndexPath:(id)arg2;
- (id)_sendRestrictionContactsCellForTableView:(id)arg1 atIndexPath:(id)arg2;
- (id)_sendRestrictionFamilyCellForTableView:(id)arg1 atIndexPath:(id)arg2;
- (id)_sendRestrictionScreenTimeSettingsCellForTableView:(id)arg1 atIndexPath:(id)arg2;
- (id)_sendRestrictionsCellForTableView:(id)arg1 atIndexPath:(id)arg2;
- (void)_sendRestrictionsCellSelectedForTableView:(id)arg1 atIndexPath:(id)arg2;
- (bool)_sendRestrictionsCellShouldHighlightForTableView:(id)arg1 atIndexPath:(id)arg2;
