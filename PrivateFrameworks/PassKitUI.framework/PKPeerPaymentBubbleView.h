...
@property (nonatomic) <CKTranscriptPluginViewDelegate> *pluginViewDelegate; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) bool wantsOutline; /* unknown property attribute: ? */
