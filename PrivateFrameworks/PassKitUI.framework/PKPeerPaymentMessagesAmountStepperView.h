...
+ (id)_amountLabelFontForSizeCategory:(unsigned long long)arg1;
+ (double)_amountLabelFontSizeForSizeCategory:(unsigned long long)arg1;
+ (struct CGSize { double x1; double x2; })referenceSizeForSizeCategory:(unsigned long long)arg1;
+ (struct CGSize { double x1; double x2; })sizeThatFits:(struct CGSize { double x1; double x2; })arg1 forSizeCategory:(unsigned long long)arg2;
