...
@interface PKPerformActionViewController : UIViewController <PKPaymentAuthorizationCoordinatorDelegate, PKPaymentAuthorizationCoordinatorPrivateDelegate, PKPaymentAutoReloadSetupControllerDelegate, PKPaymentSetupDelegate, PKPerformActionViewDelegate> {
...
- (id)_generateGenericAlertWithCompletion:(id /* block */)arg1;
- (id)_generateNoActionsAvailableDueToConflictErrorAlertWithCompletion:(id /* block */)arg1;
- (id)_generateNoActionsAvailableDueToRemoteActionFailureAlertWithCompletion:(id /* block */)arg1;
