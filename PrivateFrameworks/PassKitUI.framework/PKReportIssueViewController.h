...
+ (bool)canReportIssueForTransaction:(id)arg1 bankConnectInstitution:(id)arg2 paymentPass:(id)arg3;
...
- (id)_createPrivacyFooterViewForContext:(unsigned long long)arg1;
...
- (void)_submitBankConnectTicketToMaps:(id)arg1 withCorrelationId:(id)arg2;
...
- (id)initWithTransaction:(id)arg1 transactionSourceCollection:(id)arg2 paymentPass:(id)arg3 familyCollection:(id)arg4 account:(id)arg5 accountUserCollection:(id)arg6 bankConnectInstitution:(id)arg7 physicalCards:(id)arg8 detailViewStyle:(long long)arg9 context:(unsigned long long)arg10;
