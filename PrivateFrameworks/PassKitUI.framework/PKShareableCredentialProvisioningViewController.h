...
@interface PKShareableCredentialProvisioningViewController : PKPassShareRedemptionViewController <PKExplanationViewControllerDelegate, PKExplanationViewDelegate, PKPaymentServiceDelegate, PKPaymentSetupViewControllerDelegate, PKProvisioningFieldsUIRenderer, PKPushableCredentialProvisioningViewControllerProtocol, PKShareableCredentialsMessageComposeViewControllerDelegate> {
