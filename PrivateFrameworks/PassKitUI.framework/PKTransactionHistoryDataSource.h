...
@interface PKTransactionHistoryDataSource : NSObject <FKBankConnectAccountsProviderDelegate, FKBankConnectTransactionsListProviderDelegate, PKAccountServiceObserver, PKDashboardDataSource, PKDashboardTransactionFetcherDelegate, PKWorldRegionUpdaterObserver> {
    PKAccount * _account;
