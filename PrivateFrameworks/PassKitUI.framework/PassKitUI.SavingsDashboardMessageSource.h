...
@interface PassKitUI.SavingsDashboardMessageSource : NSObject <PKAccountServiceObserver, PKDiscoveryObserver, PKPaymentDataProviderDelegate> {
    ...
    void messageIdentifierAddBeneficiary;
    void messageIdentifierCompleteBankVerification;
    void messageIdentifierExpiredBankVerification;
    ...
    void messageIdentifierTriggerBankVerification;
    void presentActionSheet;
    void presentDestinationWithConfiguration;
