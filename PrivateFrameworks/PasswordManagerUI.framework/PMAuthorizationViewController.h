...
@interface PMAuthorizationViewController : UIViewController <ASCredentialRequestPaneViewControllerDelegate, ASPasswordAuthenticationPaneViewControllerDelegate> {
    ...
    <ASCredentialPickerViewControllerProtocol> * _conditionalRegistrationViewController;
    <ASAuthorizationViewControllerDelegate> * _delegate;
    bool  _forceLegacySignInSheet;
...
- (void)_replaceRequestPaneViewControllerWithExpandedLoginChoiceList:(bool)arg1;
...
- (bool)_shouldPresentCABLEAsInitialViewControllerForRequestTypes:(unsigned long long)arg1 shouldAllowSecurityKeysFromCABLEView:(bool)arg2;
...
- (void)pushOrUpdateBasicPaneViewControllerWithError:(long long)arg1 overrideUserVisibleErrorMessage:(id)arg2;
...
- (void)requestPaneViewControllerNeedsReload:(id)arg1;
