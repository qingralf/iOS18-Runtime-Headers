...
@interface PMSharedAccountsGroupMemberPickerViewController : UIViewController <CNAutocompleteResultsTableViewControllerDelegate, CNAutocompleteSearchConsumer, CNComposeRecipientTextViewDelegate> {
    ...
    <PMSharedAccountsGroupMemberPickerViewControllerDelegate> * _delegate;
...
@property (nonatomic) <PMSharedAccountsGroupMemberPickerViewControllerDelegate> *delegate;
