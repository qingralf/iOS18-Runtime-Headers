...
- (bool)_canInstantiateObjectOfClass:(Class)arg1 excludingCoercionsFromTypes:(id)arg2;
...
- (bool)itemQueue_canInstantiateObjectOfClass:(Class)arg1 excludingCoercionsFromTypes:(id)arg2;
...
- (bool)uikit_canInstantiateObjectOfClass:(Class)arg1 excludingCoercionsFromTypes:(id)arg2;
