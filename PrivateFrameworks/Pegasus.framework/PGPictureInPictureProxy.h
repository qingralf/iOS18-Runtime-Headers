...
@interface PGPictureInPictureProxy : NSObject <PGPictureInPictureExportedInterface> {
    ...
    struct { 
        ...
        unsigned int pictureInPictureProxy_pagingSkipByNumberOfPages : 1; 
    }  _delegateRespondsTo;
    struct CGRect { 
        struct CGPoint { 
            double x; 
...
- (void)_pipSceneComponentDidConnect:(id)arg1;
- (void)_pipSceneComponentDidDisconnect:(id)arg1;
...
- (void)_setRequestedWindowScene:(id)arg1;
...
- (void)setOverrideInterruptionExemptionIdentifier:(id)arg1;
