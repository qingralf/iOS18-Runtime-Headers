...
@property (nonatomic, readonly) long long sourceSceneSettingsInterfaceOrientation;
...
- (oneway void)initializePictureInPictureWithControlsStyle:(long long)arg1 preferredContentSize:(struct CGSize { double x1; double x2; })arg2 sceneIdentifier:(id)arg3 affectsAppLifeCycle:(bool)arg4 completionHandler:(id /* block */)arg5;
- (void)invalidate;
...
- (oneway void)setExemptAttributionOverride:(id)arg1;
...
- (long long)sourceSceneSettingsInterfaceOrientation;
