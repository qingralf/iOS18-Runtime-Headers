...
@interface PGPictureInPictureViewController : UIViewController <PGCommandHandler, PGPlaybackStateDiffConsumer, PTSettingsKeyPathObserver, UIPointerInteractionDelegate> {
    ...
    PGPictureInPicturePagingAccessoryViewController * _pagingAccessoryViewController;
...
@property (nonatomic, retain) PGPictureInPicturePagingAccessoryViewController *pagingAccessoryViewController;
...
- (id)pagingAccessoryViewController;
...
- (void)setPagingAccessoryViewController:(id)arg1;
