...
@interface PNPChargingStatusViewController : UIViewController <PNPDeviceStateConfigurable, PNPPlatterViewController, PNPViewController> {
...
@property (nonatomic, readonly) double preferredCornerRadius; /* unknown property attribute: ? */
