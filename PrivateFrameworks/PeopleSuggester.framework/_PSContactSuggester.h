...
+ (id)_cascadeContentForPriorsArchive:(id)arg1;
+ (id)_cascadeContentForPriorsArchive:(id)arg1 cascadeContactEnumerator:(id /* block */)arg2;
+ (id)_filteredContactDictionaryFromCascadeContent:(id)arg1 forContactIdentifiers:(id)arg2;
+ (void)_writeArchiveToCascade:(id)arg1;
