...
@interface _PSEnsembleModel : NSObject {
    ...
    AMLPipelineLogger * _amlPipelineLogger;
    ...
    bool  _enablePipelineCheckpointing;
...
@property bool enablePipelineCheckpointing;
...
+ (id)_suggestionInteractionPredicatesForFirstPartyMessages:(bool)arg1 bundleID:(id)arg2 interactionRecipients:(id)arg3;
+ (id)feedbackDictionary;
+ (void)forgetSession:(id)arg1;
+ (id)orderedSuggestionProxiesWithProxyOrder:(id)arg1 suggestionProxies:(id)arg2 suggestionsWithSharePlayAddedBlock:(id /* block */)arg3;
+ (void)saveFeedback:(id)arg1 forSessionId:(id)arg2 feedbackActionType:(long long)arg3 isFallbackFetch:(bool)arg4;
...
- (void)addAdditionalStatsSignalsToCandidates:(id)arg1 withTrialClient:(id)arg2;
- (void)addExtraInformationWithSuggestions:(id)arg1 modelSuggestionProxiesDict:(id)arg2;
- (void)addSuggestedRankFeature:(id)arg1 interactionsStatistics:(id)arg2;
- (void)addSupportedBundleIDs:(id)arg1;
- (void)addTrialInfoToPredictionContext:(id)arg1 withExperiment:(id)arg2;
...
- (id)amlPipelineLogger;
- (id)appExtensionSuggestionsFromContext:(id)arg1;
- (bool)areRecipientsBlockedForSuggestion:(id)arg1;
...
- (void)enrichConfig:(id)arg1 withInformationFromPredictionContext:(id)arg2;
- (void)evaluateCandidates:(id)arg1 psrMLModel:(id)arg2;
...
- (id)finalSuggestionProxiesForInteractionStatistics:(id)arg1 config:(id)arg2 trialClient:(id)arg3 context:(id)arg4;
- (void)freeCaches;
- (void)freeCachesIfNotCoreDuetDaemon;
- (void)getCoreMLSuggestionProxiesWithPredictionContext:(id)arg1 modelSuggestionProxiesDict:(id)arg2 candidateToFeatureVectorDictGetter:(id /* block */)arg3;
- (void)getHeuristicSuggestionProxies:(id)arg1 supportedBundleIDs:(id)arg2 modelSuggestionProxiesDict:(id)arg3;
...
- (id)getPETMessageFrom:(id)arg1 withConfig:(id)arg2 andContext:(id)arg3;
- (void)getPhotoBasedFeatures:(id)arg1;
- (id /* block */)getPhotoBasedFeaturesAsync:(id)arg1 withTimeout:(double)arg2;
- (void)getRuleMiningSuggestionProxies:(id)arg1 supportedBundleIDs:(id)arg2 modelSuggestionProxiesDict:(id)arg3;
- (id)getSuggestionsFromInteractionsStatistics:(id)arg1 withConfig:(id)arg2 trialClient:(id)arg3 andPredictionContext:(id)arg4;
- (id)heuristics;
- (id)init;
- (void)initializeEnsembleModelsWithInteractionStore:(id)arg1 knowledgeStore:(id)arg2;
- (id)interactionStore;
- (void)intializeKNNContactRankerModelWithInteractionStore:(id)arg1 knowledgeStore:(id)arg2;
- (id)knnMapsModel;
- (id)knnModel;
...
- (bool)loadPSConfigPath:(id)arg1;
- (void)logPipeline:(id)arg1 withPipelineStage:(id)arg2 andSessionID:(id)arg3 andCandidateNames:(id)arg4;
- (void)logPipelineWithSuggestions:(id)arg1 interactionsStatistics:(id)arg2 pipelineStage:(id)arg3 sessionID:(id)arg4;
...
- (long long)pruneCandidatesForRanking:(id)arg1;
- (id)psConfig;
- (id)psConfigForAdaptableModel;
- (void)psrDataCollectionForContext:(id)arg1 timeToWaitInSeconds:(int)arg2 maxComputationTime:(double)arg3 withConfigAndStatsBlock:(id /* block */)arg4;
- (id /* block */)psr_getPhotoBasedFeaturesAsync:(id)arg1 withTimeout:(double)arg2;
...
- (id)ruleMiningModel;
- (void)sendDataToPETAsync:(id)arg1 withConfig:(id)arg2 andContext:(id)arg3;
...
- (void)setAmlPipelineLogger:(id)arg1;
...
- (void)setEnablePipelineCheckpointing:(bool)arg1;
...
- (void)setupAeroMLPipelineLoggerWithModel:(id)arg1;
