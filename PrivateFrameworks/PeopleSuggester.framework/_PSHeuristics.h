...
- (void).cxx_destruct;
- (id)contactResolver;
- (id)heuristicsFromInteractionsStatistics:(id)arg1 forStatsNames:(id)arg2 threshold:(double)arg3 maxNumberOfSuggestions:(int)arg4 reason:(id)arg5;
- (id)hourOfDayProbabilitiesToInteractWithContacts:(id)arg1;
- (id)hyperRecentHeuristicIncomingSuggestionProxiesForInteractionStatistics:(id)arg1;
- (id)hyperRecentHeuristicSuggestionProxiesForInteractionStatistics:(id)arg1;
- (id)hyperRecentHeuristicSuggestionProxiesForInteractionStatistics:(id)arg1 forStatName:(id)arg2;
...
- (id)pastSharesAwareSuggestionProxiesForInteractionStatistics:(id)arg1;
- (id)pastSharesOfTopDomainURLAwareSuggestionProxiesForInteractionStatistics:(id)arg1;
- (id)pastSharesWithCurrentAppAwareSuggestionProxiesForInteractionStatistics:(id)arg1;
- (id)peopleAwareSuggestionProxiesForInteractionStatistics:(id)arg1;
