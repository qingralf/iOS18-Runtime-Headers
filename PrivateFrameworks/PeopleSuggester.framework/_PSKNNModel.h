...
- (id)rankedLabelsFromInteractionsForPhoneCallsWithInteractions:(id)arg1 andDistances:(id)arg2;
...
- (id)rankedNameSuggestionsWithPredictionContext:(id)arg1 forName:(id)arg2 contactsOnly:(bool)arg3;
...
- (id)rankedPhoneCallAutocompleteSuggestionsWithPredictionContext:(id)arg1 candidates:(id)arg2;
- (id)rankedSiriMLCRHandles:(id)arg1 context:(id)arg2;
- (id)rankedSuggestionsWithPredictionContext:(id)arg1 bundleId:(id)arg2 maxSuggestions:(unsigned long long)arg3 frequencyOnly:(bool)arg4 interactions:(id)arg5;
- (id)rankedZkwSuggestionsWithPredictionContext:(id)arg1 modelConfiguration:(id)arg2 maxSuggestions:(unsigned long long)arg3;
- (id)recipientsForChat:(id)arg1;
...
- (bool)suggestedRecipientHandles:(id)arg1 differFromFetchedRecipientHandles:(id)arg2;
...
- (id)suggestionsByUpdatingGroupNamesFromSuggestions:(id)arg1 imCoreTimeBudget:(double)arg2;
