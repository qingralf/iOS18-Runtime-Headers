...
- (void)generatePSRTelemetry:(id)arg1;
...
- (id)shareInformationForPhotoId:(id)arg1 dateInterval:(id)arg2;
- (id)shareInformationForPhotoId:(id)arg1 dateInterval:(id)arg2 interactionStoreDB:(id)arg3;
