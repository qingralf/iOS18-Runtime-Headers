...
@interface PPSMetricMonitor : NSObject <PPSMetricMonitorClientInterface> {
    ...
    NSArray * _currentProcessNames;
    NSArray * _currentProcessPIDs;
...
- (id)collectMetricsOnSnapshot:(id*)arg1;
- (id)config;
- (id)connection;
- (id)currentProcessNames;
- (id)currentProcessPIDs;
- (id)delegate;
- (id)delegateQueue;
...
- (void)setCurrentProcessNames:(id)arg1;
- (void)setCurrentProcessPIDs:(id)arg1;
- (void)setDelegate:(id)arg1;
- (void)setDelegateQueue:(id)arg1;
- (void)setIsInterrupted:(bool)arg1;
- (void)setMonitoringState:(long long)arg1;
- (void)setRemoteProxy:(id)arg1;
- (bool)setUpdateInterval:(double)arg1 error:(id*)arg2;
...
- (bool)startMonitoringProcessesWithName:(id)arg1 error:(id*)arg2;
- (bool)startMonitoringProcessesWithNames:(id)arg1 PIDs:(id)arg2 error:(id*)arg3;
- (bool)startMonitoringProcessesWithPID:(id)arg1 error:(id*)arg2;
