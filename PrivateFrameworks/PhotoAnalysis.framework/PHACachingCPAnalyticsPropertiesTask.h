...
+ (id)_fetchLibrarySummaryForPhotoLibrary:(id)arg1 loggingConnection:(id)arg2 progressReporter:(id)arg3;
...
- (id)_buildPropertyCacheForPhotoLibrary:(id)arg1 loggingConnection:(id)arg2 progressReporter:(id)arg3;
