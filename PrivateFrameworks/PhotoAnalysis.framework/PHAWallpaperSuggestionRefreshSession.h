...
+ (void)refreshPosterConfigurationWithPosterService:(id)arg1 retryCount:(long long)arg2 configuration:(id)arg3 sessionInfo:(id)arg4 log:(id)arg5 completion:(id /* block */)arg6;
...
- (void)dealloc;
- (void)enumerateRefreshableShufflePosterConfigurationsIn:(id)arg1 usingBlock:(id /* block */)arg2;
