...
- (void)setAgeType:(id)arg1;
- (void)setBaldType:(id)arg1;
...
- (void)setEyeMakeupType:(id)arg1;
- (void)setEyesState:(id)arg1;
- (void)setFaceAlgorithmVersion:(long long)arg1;
- (void)setFaceprint:(id)arg1;
- (void)setFacialHairType:(id)arg1;
- (void)setGenderType:(id)arg1;
- (void)setGlassesType:(id)arg1;
- (void)setGroupingIdentifier:(id)arg1;
- (void)setHairColorType:(id)arg1;
...
- (void)setSexType:(id)arg1;
- (void)setSize:(double)arg1;
- (void)setSmileType:(id)arg1;
