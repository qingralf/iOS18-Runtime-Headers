...
+ (id)_serializeComposition:(id)arg1 versionInfo:(id)arg2 skipMetadata:(bool)arg3 error:(out id*)arg4;
...
+ (id)adjustmentInformationForComposition:(id)arg1 skipMetadata:(bool)arg2 error:(out id*)arg3;
...
+ (id)deserializeCompositionFromAdjustments:(id)arg1 metadata:(id)arg2 formatIdentifier:(id)arg3 formatVersion:(id)arg4 sidecarData:(id)arg5 error:(out id*)arg6;
+ (id)deserializeCompositionFromData:(id)arg1 formatIdentifier:(id)arg2 formatVersion:(id)arg3 error:(out id*)arg4;
+ (id)deserializeCompositionFromData:(id)arg1 formatIdentifier:(id)arg2 formatVersion:(id)arg3 sidecarData:(id)arg4 error:(out id*)arg5;
