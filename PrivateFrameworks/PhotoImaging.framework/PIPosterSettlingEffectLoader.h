...
+ (bool)_canLoadVideoAtURL:(id)arg1;
+ (unsigned long long)_gatingFlagsFromMADStatus:(id)arg1;
+ (struct { long long x1; int x2; unsigned int x3; long long x4; })_livePhotoKeyFrameTimeForResource:(id)arg1;
+ (id)_resolveOptions:(id)arg1 forResource:(id)arg2;
...
+ (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })effectiveCropRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 forResource:(id)arg2 error:(out id*)arg3;
