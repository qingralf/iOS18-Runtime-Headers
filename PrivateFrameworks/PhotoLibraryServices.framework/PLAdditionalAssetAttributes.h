...
@property (nonatomic, copy) NSString *adjustedStableHash;
...
@property (nonatomic, readonly, copy) NSString *originalStableHash;
@property (nonatomic, copy) NSString *originalStableHash;
