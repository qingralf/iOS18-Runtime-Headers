...
+ (void)_configureEnumeratorForLibrarySummaryLogging:(id)arg1 cloudPhotoLibraryEnabled:(bool)arg2 dataForCA:(id)arg3 libraryServicesManager:(id)arg4;
...
+ (void)configureEnumeratorForLibrarySummaryForLibraryEnumerator:(id)arg1 withSyndicationLibraryEnumerator:(id)arg2 cloudPhotoLibraryEnabled:(bool)arg3 dataForCA:(id)arg4 libraryServicesManager:(id)arg5;
