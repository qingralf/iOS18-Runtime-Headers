...
- (void)getCPLSettingsWithReply:(id /* block */)arg1;
...
- (void)isComputeSyncEnabledForDirection:(long long)arg1 reply:(id /* block */)arg2;
- (void)isReadyForAnalysisCPLInitialDownloadCompletedWithReply:(id /* block */)arg1;
...
- (void)setPrefetchMode:(long long)arg1 reply:(id /* block */)arg2;
