...
- (void)assetContainmentLargeFaceThresholdUserDefault:(id /* block */)arg1;
- (void)assetContainmentSmallFaceThresholdUserDefault:(id /* block */)arg1;
- (void)assetContainmentSmallTorsoThresholdUserDefault:(id /* block */)arg1;
...
- (void)closeSearchIndexWithReply:(id /* block */)arg1;
...
- (void)indexAssetsWithUUIDs:(id)arg1 reply:(id /* block */)arg2;
...
- (void)locationOfInterestUpdateWithReply:(id /* block */)arg1;
...
- (void)resetBackgroundMigrationClassName:(id)arg1 reply:(id /* block */)arg2;
- (void)resetComputeCacheWithReply:(id /* block */)arg1;
- (void)resetDrawAssetPersonEdgesBackgroundMigrationActionWithReply:(id /* block */)arg1;
...
- (id)runAssetContainmentOnAllSocialGroups:(id /* block */)arg1;
- (id)runAssetContainmentOnSocialGroup:(id)arg1 reply:(id /* block */)arg2;
- (void)runMaintenanceTask:(id)arg1 reply:(id /* block */)arg2;
- (void)searchAttributesForAssetWithUUID:(id)arg1 reply:(id /* block */)arg2;
...
- (id)updateAndSaveAssetPersonEdgesWithReply:(id /* block */)arg1;
