...
- (void)availabilityStateShouldPersist:(bool)arg1 reply:(id /* block */)arg2;
- (void)backgroundJobServiceRemoveAllBundleRecordsFromProcessingSet;
- (void)clearAvailabilityWithReply:(id /* block */)arg1;
- (void)coreAnalyticsLibrarySummaryDataWithCompletionHandler:(id /* block */)arg1;
- (void)deleteEmbeddings:(id)arg1 assetUUID:(id)arg2 reply:(id /* block */)arg3;
- (void)deleteiTunesSyncedContentWithCompletionHandler:(id /* block */)arg1;
- (void)failAvailabilityWithReply:(id /* block */)arg1;
- (void)featureProcessingSnapshotWithReply:(id /* block */)arg1;
...
- (void)insertEmbeddings:(id)arg1 modelType:(unsigned long long)arg2 assetUUID:(id)arg3 reply:(id /* block */)arg4;
...
- (void)pauseSearchIndexingWithReply:(id /* block */)arg1;
...
- (void)resumeSearchIndexingWithReply:(id /* block */)arg1;
...
- (void)signalAvailabilityStateDidChangeWithReply:(id /* block */)arg1;
