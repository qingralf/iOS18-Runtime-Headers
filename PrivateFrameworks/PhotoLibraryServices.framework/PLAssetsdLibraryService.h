...
- (id)libraryBundle;
- (id)newLibraryOpener;
- (void)openApplicationOwnedFoldersWithReply:(id /* block */)arg1;
- (void)openPhotoLibraryDatabaseWithOptions:(id)arg1 reply:(id /* block */)arg2;
- (id)postOpenProgressWithReply:(id /* block */)arg1;
- (void)proxyLockFileWithDatabasePath:(id)arg1 reply:(id /* block */)arg2;
...
- (id)resetSocialGroupsWithReply:(id /* block */)arg1;
- (id)sandboxExtensionsByPathForLibraryAccessRole:(long long)arg1;
- (void)searchDonationProgressForTaskIDs:(id)arg1 reply:(id /* block */)arg2;
...
- (void)validateOrRebuildPhotoLibraryDatabaseWithReply:(id /* block */)arg1;
