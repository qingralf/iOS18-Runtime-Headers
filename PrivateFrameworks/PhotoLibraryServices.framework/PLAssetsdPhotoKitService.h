...
@interface PLAssetsdPhotoKitService : PLAbstractLibraryServicesManagerService <PLAssetsdPhotoKitServiceProtocol, PLPerformChangesRequestService, PLSyndicationSyncEngineDelegate> {
...
- (id)analyzeAssets:(id)arg1 forFeature:(unsigned long long)arg2 reply:(id /* block */)arg3;
- (id)analyzeLibraryForFeature:(unsigned long long)arg1 reply:(id /* block */)arg2;
- (void)applyChangesRequest:(id)arg1 reply:(id /* block */)arg2;
- (void)cancelReservedCloudIdentifiersWithEntityName:(id)arg1 reply:(id /* block */)arg2;
- (id)clientBundleID;
...
- (void)reserveCloudIdentifiersWithEntityName:(id)arg1 count:(unsigned long long)arg2 reply:(id /* block */)arg3;
- (void)reservedCloudIdentifiersWithEntityName:(id)arg1 reply:(id /* block */)arg2;
- (id)resetStateForMediaProcessingTaskID:(unsigned long long)arg1 assetUUIDs:(id)arg2 resetOptions:(unsigned long long)arg3 reply:(id /* block */)arg4;
