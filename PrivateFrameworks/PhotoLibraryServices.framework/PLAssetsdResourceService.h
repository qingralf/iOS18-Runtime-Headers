...
- (void).cxx_destruct;
- (bool)_allowSandboxExtensionForAsset:(id)arg1;
- (bool)_allowSandboxExtensionForSessionIdentifier:(id)arg1 captureSessionState:(id)arg2;
...
- (void)sandboxExtensionURLForPersistentURL:(id)arg1 withAdjustments:(bool)arg2 reply:(id /* block */)arg3;
