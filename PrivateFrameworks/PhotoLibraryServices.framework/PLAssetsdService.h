...
@property (nonatomic, readonly, copy) NSString *connectionDescription;
...
- (void)getNonBindingDebugServiceWithReply:(id /* block */)arg1;
...
- (id)initWithConnection:(id)arg1 libraryBundleController:(id)arg2 daemonServices:(id)arg3;
