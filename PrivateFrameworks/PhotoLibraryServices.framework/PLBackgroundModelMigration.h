...
@property (nonatomic, retain) PLFileBackedLogger *logger;
...
+ (bool)isBackgroundMigrationRegistrationAfterRebuildRequiredWithLibrary:(id)arg1;
...
+ (void)validateBackgroundActionClass:(Class)arg1;
