...
- (void)_handleRelationsForAlbumRecords:(id)arg1 orderKeyManager:(id)arg2 inLibrary:(id)arg3;
- (void)_handleRelationsForAssetRecords:(id)arg1 orderKeyManager:(id)arg2 inLibrary:(id)arg3;
- (void)_handleScopeChanges:(id)arg1 inLibrary:(id)arg2;
- (void)_handleSocialGroupRecords:(id)arg1 inLibrary:(id)arg2;
