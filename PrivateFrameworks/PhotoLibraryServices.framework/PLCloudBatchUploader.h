...
- (void)_processInvalidResourceCopySourceCommitError:(id)arg1 inUploadBatch:(id)arg2 forRecords:(id)arg3 orderKeyManager:(id)arg4 inLibrary:(id)arg5;
...
- (bool)_processRepushAlbumError:(id)arg1 inUploadBatch:(id)arg2 forRecords:(id)arg3 orderKeyManager:(id)arg4 inLibrary:(id)arg5;
...
- (void)_sendAlbums:(id)arg1 toBatchManager:(id)arg2 orderKeyManager:(id)arg3 inLibrary:(id)arg4;
- (void)_sendAssets:(id)arg1 toBatchManager:(id)arg2 orderKeyManager:(id)arg3 inLibrary:(id)arg4;
...
- (void)tryToFixCommitError:(id)arg1 inUploadBatch:(id)arg2 forRecords:(id)arg3 uploadTracker:(id)arg4 orderKeyManager:(id)arg5 inLibrary:(id)arg6;
