...
+ (id)_recentEntriesInLibrary:(id)arg1 forEntity:(id)arg2 usingPredicate:(id)arg3 earliestDate:(id)arg4 latestDate:(id)arg5 limit:(unsigned long long)arg6 sortDescriptors:(id)arg7;
...
+ (id)fetchesForFilter:(long long)arg1 inManagedObjectContext:(id)arg2;
+ (id)firstEntryWithType:(long long)arg1 albumGUID:(id)arg2 inLibrary:(id)arg3;
+ (id)notificationPredicateForFilter:(long long)arg1;
+ (id)predicateExcludingEntryTypes:(id)arg1;
+ (id)predicateIncludingOnlyAssetsAddedByOthers;
+ (id)predicateIncludingOnlyCommentsAndLikesFromOthers;
+ (id)predicateIncludingOnlyEntryTypes:(id)arg1;
+ (id)predicateIncludingOnlyEntryTypes:(id)arg1 noIndex:(bool)arg2;
+ (id)recentAssetsEntriesInLibrary:(id)arg1 limit:(long long)arg2;
+ (id)recentEntriesInLibrary:(id)arg1 earliestDate:(id)arg2 latestDate:(id)arg3 limit:(unsigned long long)arg4 filter:(long long)arg5 sortDescriptors:(id)arg6;
