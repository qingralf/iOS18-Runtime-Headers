...
@interface PLCloudPhotoLibraryManager : NSObject <CPLLibraryManagerDelegate, CPLRecordComputeStateDelegate, CPLResourceProgressDelegate, PLBackgroundJobWorkerCoordinatorDelegate, PLCloudPersistentHistoryChangeTrackerDelegate, PLCloudPersistentHistoryMigratorContext, PLCloudUserSessionHandling> {
...
+ (id)_lastKnownCloudVersionInLibrary:(id)arg1;
+ (id)descriptionForResourceType:(unsigned long long)arg1;
+ (bool)needResetSyncErrorType:(id)arg1;

- (void).cxx_destruct;
- (void)_appWithBundleIdentifier:(id)arg1 changedStateToForeground:(bool)arg2;
...
- (void)_cameraChangedStateToForeground:(bool)arg1;
- (bool)_canExternallyTransitionToNewLibraryStateIgnoringPause:(bool)arg1;
- (void)_checkAndMarkPurgeableResources:(id)arg1 checkIfSafe:(bool)arg2 checkServerIfNecessary:(bool)arg3 urgency:(long long)arg4 completionHandler:(id /* block */)arg5;
...
- (bool)_connectToCloudChangeTrackerWithContext:(id)arg1;
...
- (void)_disableiCPLSyncWithResetMode:(long long)arg1;
- (void)_disableiCPLWillBecomeNonSyncablePhotoLibrary:(bool)arg1 resetMode:(long long)arg2;
- (void)_doPause;
...
- (void)_markPurgeableNextBatchOfResources:(id)arg1 urgency:(long long)arg2 checkIfSafe:(bool)arg3 inLibrary:(id)arg4 completionHandler:(id /* block */)arg5;
...
- (void)_notifyCPLStatus:(id)arg1 didChange:(bool)arg2 andCPLConfiguration:(id)arg3;
...
- (void)_processUploadBatchWithStartupFailureCount:(unsigned long long)arg1 orderKeyManager:(id)arg2 inLibrary:(id)arg3;
...
- (void)_saveLastKnownCloudChangeTrackerTokenToDiskWithContext:(id)arg1;
...
- (void)downloadResourceInMemory:(id)arg1 clientBundleID:(id)arg2 proposedTaskIdentifier:(id)arg3 taskDidBeginHandler:(id /* block */)arg4 completionHandler:(id /* block */)arg5;
- (void)downloadResourceInMemoryForAsset:(id)arg1 resourceType:(unsigned long long)arg2 masterResourceOnly:(bool)arg3 clientBundleID:(id)arg4 proposedTaskIdentifier:(id)arg5 taskDidBeginHandler:(id /* block */)arg6 completionHandler:(id /* block */)arg7;
...
- (void)fetchComputeStatesForRecordsWithScopedIdentifiers:(id)arg1 onDemand:(bool)arg2 completionHandler:(id /* block */)arg3;
...
- (void)libraryManager:(id)arg1 providePayloadForComputeStates:(id)arg2 inFolderWithURL:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (void)markPurgeableResourcesMatchingPredicate:(id)arg1 urgency:(long long)arg2 checkIfSafe:(bool)arg3 inLibrary:(id)arg4 completionHandler:(id /* block */)arg5;
...
- (id)resourceManager;
- (void)saveCloudTrackerToken:(id)arg1 withContext:(id)arg2;
- (void)saveRulesTrackerToken:(id)arg1;
