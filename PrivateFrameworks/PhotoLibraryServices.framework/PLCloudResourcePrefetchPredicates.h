...
+ (id)predicateToPrefetchAdjustedMediaMetadataResourcesWithOptions:(id)arg1 photoLibrary:(id)arg2;
+ (id)predicateToPrefetchHighlightWithUUIDs:(id)arg1 photoLibrary:(id)arg2;
+ (id)predicateToPrefetchMediaMetadataResourcesWithOptions:(id)arg1 photoLibrary:(id)arg2;
+ (id)predicateToPrefetchMemories:(id)arg1 photoLibrary:(id)arg2 options:(id)arg3;
+ (id)predicatesForComputeSync:(id)arg1 photoLibrary:(id)arg2;
