...
+ (id)nextDCIMSaveFileURLForCloudPersonID:(id)arg1 cloudAlbumGUID:(id)arg2 pathManager:(id)arg3 fileExtension:(id)arg4 assetUUID:(id)arg5;
...
- (bool)_processSaveAssetWithPlaceholderKind:(short)arg1 inLibrary:(id)arg2 withAssetDataFilePath:(id)arg3;
