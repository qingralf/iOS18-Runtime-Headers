...
@interface PLCloudUploadChanges : NSObject {
    ...
    NSMutableSet * _computeSyncChangedAssets;
    ...
    NSMutableArray * _socialGroupChanges;
...
@property (nonatomic, retain) NSMutableSet *computeSyncChangedAssets;
...
@property (nonatomic, retain) NSMutableArray *socialGroupChanges;
...
- (void)setComputeSyncChangedAssets:(id)arg1;
...
- (void)setSocialGroupChanges:(id)arg1;
