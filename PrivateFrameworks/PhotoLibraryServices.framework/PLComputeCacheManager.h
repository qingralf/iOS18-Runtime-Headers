...
- (bool)_isInitialSyncWithInitialSyncDate:(id)arg1;
...
- (bool)_performSnapshotWithError:(id*)arg1;
- (void)_publish;
...
- (bool)_snapshotJournalsWithError:(id*)arg1;
- (id)_snapshotPolicy;
...
- (void)notifyReadyToRestoreWithInitialSyncDate:(id)arg1;
