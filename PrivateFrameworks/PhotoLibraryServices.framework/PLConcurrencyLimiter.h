...
+ (void)reportBlockEnqueued:(id /* block */)arg1 isNotifyBlock:(bool)arg2 onQueue:(id)arg3 forLibrary:(id)arg4;
+ (id)sharedLimiter;
...
- (id)debugDescription;
- (void)dispatchAfterTime:(unsigned long long)arg1 library:(id)arg2 block:(id /* block */)arg3;
- (void)dispatchAsync:(id)arg1 block:(id /* block */)arg2;
- (void)groupNotify:(id)arg1 queue:(id)arg2 block:(id /* block */)arg3;
- (id)init;
