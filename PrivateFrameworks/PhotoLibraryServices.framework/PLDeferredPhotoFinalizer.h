...
- (void).cxx_destruct;
- (void)_callCompletionHandlersForPhotoProxy:(id)arg1 success:(bool)arg2 error:(id)arg3;
...
- (void)_createTTRForNonRecoverableError:(id)arg1 assetDescription:(id)arg2 asset:(id)arg3;
...
- (void)deleteIntermediatesExcludingDeferredIdentifierRequestIdentifiers:(id)arg1 withCompletionHandler:(id /* block */)arg2;
