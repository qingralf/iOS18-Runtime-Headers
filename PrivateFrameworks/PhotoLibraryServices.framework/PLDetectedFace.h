...
+ (id)entityName;
+ (id)fetchDetectedFacesForAssetObjectID:(id)arg1 managedObjectContext:(id)arg2;
+ (id)findExistingFaceMatchingDimension:(id)arg1 inFaces:(id)arg2 ignoreSourceAssetDimensions:(bool)arg3;
+ (id)personIDsByAssetForPersonsVisibleWithPersonIDs:(id)arg1 inContext:(id)arg2;
...
- (bool)_hasPersonForFaceChangeWithoutCommittedPersonForFace:(id)arg1 oldAssociatedPerson:(id)arg2;
- (bool)_hasSizeChange;
...
- (void)_recordAssetPersonEdgeAndContainmentUpdateForAsset:(id)arg1 inContext:(id)arg2;
- (void)_recordAssetPersonEdgeUpdatesAndSocialGroupUpdatesIfNeededWithChangedValues:(id)arg1;
- (bool)_startTimeAndDurationAreValid;
- (void)_touchPersonForPersistenceIfNeeded;
- (void)_updateFaceGroupIfNeeded;
- (void)_updatePersonForFaceDetectionTypeIfNeededWithPossibleNewPerson:(id)arg1;
