...
@property (nonatomic, retain) NSNumber *generativeAIType;
...
@property (nonatomic, retain) NSNumber *sleetCast;
@property (nonatomic, retain) NSNumber *sleetColorBias;
@property (nonatomic, retain) NSNumber *sleetIntensity;
@property (nonatomic, retain) NSNumber *sleetRenderingVersion;
@property (nonatomic, retain) NSNumber *sleetToneBias;
...
- (id)payloadID;
- (void)setGenerativeAIType:(id)arg1;
- (void)willSave;
