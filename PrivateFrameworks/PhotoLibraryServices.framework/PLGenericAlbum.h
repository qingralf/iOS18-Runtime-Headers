...
@interface PLGenericAlbum : PLManagedObject <PLAlbumProtocol, PLDerivedAlbumOrigin, PLIndexMappersDataOrigin, PLSearchableManagedObject, PLSyncableObject> {
...
@property (nonatomic) unsigned long long batchSize; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) long long keyAssetsMaxCount;
...
@property (nonatomic, readonly, retain) NSMutableOrderedSet *mutableAssets; /* unknown property attribute: ? */
@property (nonatomic, readonly, copy) NSString *name; /* unknown property attribute: ? */
...
+ (bool)_validateCurrentKeyAssetIDs:(id)arg1 fetchedKeyAssetIDs:(id)arg2 customKeyAssetID:(id)arg3 maxCount:(long long)arg4;
...
+ (id)fetchAlbumsForAssetObjectID:(id)arg1 libraryIdentifier:(long long)arg2 managedObjectContext:(id)arg3;
+ (id)fetchAlbumsWithUUIDs:(id)arg1 managedObjectContext:(id)arg2;
...
+ (id)sortDescriptorsForAssetsInAlbumWithSortKey:(unsigned int)arg1 ascending:(bool)arg2;
+ (bool)supportsCachedKeyAssetsWithAlbumKind:(int)arg1;
+ (bool)supportsCustomKeyAssetWithAlbumKind:(int)arg1;
+ (id)syncProgressAlbumInLibrary:(id)arg1;
+ (id)trashBinAlbumInLibrary:(id)arg1;
+ (id)unableToUploadAlbumInLibrary:(id)arg1;
+ (void)updateKeyAssetsInAlbums:(id)arg1 photoLibrary:(id)arg2;
...
- (id)cplAlbumChangeInPhotoLibrary:(id)arg1 orderKeyManager:(id)arg2;
- (id)cplFullRecord;
- (void)dealloc;
- (void)delete;
- (id)description;
...
- (id)fetchKeyAssetCandidates:(id*)arg1;
- (id)groupURL;
...
- (void)updateAlbumFolderRelation:(id)arg1 orderKeyManager:(id)arg2 inLibrary:(id)arg3;
