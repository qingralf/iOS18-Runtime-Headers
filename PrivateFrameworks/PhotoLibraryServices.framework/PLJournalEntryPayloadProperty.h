...
@interface PLJournalEntryPayloadProperty : NSObject {
    id  _defaultValue;
    <PLJournalEntryPayloadPropertyInfo> * _info;
    bool  _isAdditionalEntityName;
...
@property (nonatomic, readonly) bool hasSourceObjectValue;
@property (nonatomic, readonly) <PLJournalEntryPayloadPropertyInfo> *info;
@property (nonatomic, readonly) bool isAdditionalEntityName;
...
+ (id)payloadPropertyWithKey:(id)arg1 andType:(unsigned long long)arg2 info:(id)arg3;
+ (id)payloadPropertyWithKey:(id)arg1 andType:(unsigned long long)arg2 requiresConversion:(bool)arg3 info:(id)arg4;
+ (id)payloadPropertyWithKey:(id)arg1 relatedEntityPropertyNames:(id)arg2 shouldPrefetchRelationship:(bool)arg3;
+ (id)payloadPropertyWithKey:(id)arg1 subRelationshipProperties:(id)arg2 subRelationshipEntityName:(id)arg3 isToMany:(bool)arg4 isAdditionalEntityName:(bool)arg5 info:(id)arg6;
...
- (id)info;
- (id)initWithKey:(id)arg1 andType:(unsigned long long)arg2 subRelationshipProperties:(id)arg3 subRelationshipEntityName:(id)arg4 requiresConversion:(bool)arg5 relatedEntityPropertyNames:(id)arg6 isUUIDKey:(bool)arg7 isToManySubRelationship:(bool)arg8 shouldPrefetchRelationship:(bool)arg9 isAdditionalEntityName:(bool)arg10 info:(id)arg11;
