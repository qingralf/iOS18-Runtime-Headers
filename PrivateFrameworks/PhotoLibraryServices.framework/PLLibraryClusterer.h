...
- (id)_eligibleClusterForMoment:(id)arg1 inMomentsByLocationType:(id)arg2;
...
- (id)momentClustersForMomentsSortedByDate:(id)arg1 allowLocationSplits:(bool)arg2 allowExternalSplits:(bool)arg3;
