...
@interface PLLibraryServicesManager : NSObject <PFStateCaptureProvider, PLSyndicationDeleteEngineDelegate> {
    bool  _active;
    ...
    PLLibraryOpenerCreationOptions * _openerCreationOptions;
...
@property (nonatomic, retain) PLLibraryOpenerCreationOptions *openerCreationOptions;
...
@property struct { _Atomic unsigned int x1; _Atomic unsigned int x2; _Atomic unsigned int x3; _Atomic unsigned int x4; } resourceCacheMetrics;
...
- (id)activeOperations;
- (id)analysisCoordinator;
- (id)availabilityComputer;
...
- (id)cloudIdentifierReservationSupport;
...
- (bool)disableiCPLForLibraryDeletionWithError:(id*)arg1;
...
- (id)searchDonationProgress;
- (id)searchIndexManager;
- (id)searchIndexingEngine;
...
- (void)setOpenerCreationOptions:(id)arg1;
...
- (bool)willBecomeNonSyncablePhotoLibrary:(id*)arg1;
