...
@interface PLManagedAlbum : PLGenericAlbum <PLCloudDeletable, PLDeletableManagedObject, PLFileSystemAlbumMetadataPersistence, PLUserEditableAlbumProtocol> {
...
- (void)_insertInternalUserEditableAssets:(id)arg1 atIndexes:(id)arg2 assetsSharingInfos:(id)arg3 customExportsInfo:(id)arg4 trimmedVideoPathInfo:(id)arg5 commentText:(id)arg6;
- (id)_keysToBeObserved;
- (id)_orderComparisonValueForAsset:(id)arg1 iTunesLookupOrder:(id)arg2;
- (void)_removeAssetFromUserAlbumSuggestionIfNeededWithManagedObjectContext:(id)arg1;
