...
@interface PLManagedAsset : PLManagedObject <PLAssetDateDescriptor, PLCloudDeletable, PLCreateFromSearchableItem, PLDeletableManagedObject, PLGraphEdgeReferenceRecipient, PLMomentAssetData, PLPTPTransferableAsset, PLSearchableManagedObject, PLSyncableAsset, PLValidatesResourceModel, _PLImageLoadingAsset, _PLThumbnailLoadingAsset> {
...
@property (nonatomic, retain) NSSet *albumsBeingCustomKeyAsset;
@property (nonatomic, retain) NSSet *albumsBeingKeyAssets;
...
@property (nonatomic, retain) NSString *captureSessionIdentifier;
@property (nonatomic, retain) NSString *cloudAssetGUID;
@property (nonatomic, readonly, retain) NSString *cloudAssetGUID; /* unknown property attribute: ? */
...
@property (nonatomic, retain) PLComputeSyncAttributes *computeSyncAttributes;
...
@property (nonatomic, retain) <PLPhotosHighlightData> *dayHighlightBeingCollageAssetsMixed;
@property (nonatomic, retain) <PLPhotosHighlightData> *dayHighlightBeingCollageAssetsPrivate;
@property (nonatomic, retain) <PLPhotosHighlightData> *dayHighlightBeingCollageAssetsShared;
...
@property (nonatomic, readonly) NSSet *generatedAssetDescriptionNodes;
...
@property (nonatomic, readonly) short hdrType;
...
@property (nonatomic, readonly) bool isVisibleForSocialGroupKeyAssetFetch;
...
@property (nonatomic, retain) NSSet *memoriesBeingUserRemovedAssets;
...
@property (nonatomic, readonly, copy) NSString *pathForAdjustmentSecondaryDataFile;
@property (nonatomic, readonly, copy) NSString *pathForComputeDirectory;
@property (nonatomic, readonly, copy) NSString *pathForComputeSyncMediaAnalysisPayloadFile;
@property (nonatomic, readonly, copy) NSString *pathForComputeSyncWrapperFile;
...
@property (nonatomic, readonly, retain) <PLPTPTransferableExtendedAssetAttributes> *ptpExtendedAttributes;
...
@property (nonatomic, readonly) unsigned short syndicationHistory;
...
+ (bool)_checkComputeSyncUploadPolicyWithCPLConfiguration:(id)arg1 library:(id)arg2 debugMode:(bool)arg3 debugLog:(id)arg4;
...
+ (id)_predicateForAvalancheKindAssetsWithUUID:(id)arg1 kind:(unsigned short)arg2;
...
+ (void)_runComputeSyncBackfillTaskOnProcessedAssets:(id)arg1;
+ (bool)_shouldPushComputeSyncWithLocalMajorVersion:(short)arg1 localAnalaysisStage:(short)arg2 cloudComputeStateVersionStr:(id)arg3 localAdjustmentFingerprint:(id)arg4 cloudAdjustmentFingerprint:(id)arg5 scopedIdentifier:(id)arg6;
...
+ (id)assetsWithValidatedSavedAssetTypeMask:(unsigned int)arg1 inManagedObjectContext:(id)arg2;
...
+ (id)createSparseComputeStateRecordsForAssets:(id)arg1 inPhotoLibrary:(id)arg2;
...
+ (id)fetchAssetsWithUUIDs:(id)arg1 managedObjectContext:(id)arg2;
+ (id)fetchPredicateForLegacyRequiredResourcesLocallyAvailable:(bool)arg1 photoLibrary:(id)arg2;
+ (id)fetchRequestForResourcesWithObjectID:(id)arg1 versions:(id)arg2 allowDerivatives:(bool)arg3 excludeDynamicCPLResources:(bool)arg4 additionalPredicate:(id)arg5 relationshipKeyPathsForPrefetching:(id)arg6;
...
+ (id)generateFullComputeStateRecordForRecord:(id)arg1 payloadHelper:(id)arg2 destinationDirectoryURL:(id)arg3 inPhotoLibrary:(id)arg4;
...
+ (unsigned long long)iCPLAssetCountInPhotoLibrary:(id)arg1;
...
+ (bool)isComputeSyncEnabledForDirection:(long long)arg1 library:(id)arg2;
+ (bool)isComputeSyncEnabledForDirection:(long long)arg1 library:(id)arg2 debugMode:(bool)arg3 debugLog:(id*)arg4;
...
+ (id)pathForAlchemistImageWithUUID:(id)arg1 bundleScope:(unsigned short)arg2 directory:(id)arg3 filename:(id)arg4 pathManager:(id)arg5;
...
+ (id)predicateForAdjustedAssetsWithKeyPathToAsset:(id)arg1;
...
+ (id)predicateForAvalancheKindAssetsWithKind:(unsigned short)arg1;
+ (id)predicateForBurstAssetsWithBurstUUID:(id)arg1;
...
+ (id)predicateToLimitToCaptureSessionIdentifier:(id)arg1;
+ (id)preferredFileExtensionForType:(id)arg1;
+ (void)processAdjustedMediaMetadataForAsset:(id)arg1;
...
+ (void)runComputeSyncBackfillTaskOnProcessedAssets:(id)arg1;
...
+ (bool)shouldSyncAssetToSPLWithSavedAssetType:(short)arg1 syndicationState:(unsigned short)arg2;
...
- (void)_applyPropertiesChangeToCPLAssetChange:(id)arg1 withMasterScopedIdentifier:(id)arg2 computeSyncUploadEnabled:(bool)arg3 inLibrary:(id)arg4;
...
- (unsigned short)_calculateRenderTypeAdditionalFlagCheckAndUpdateIfNeededUnmanagedAdjustment:(id)arg1 options:(id)arg2 hasAdjustments:(bool)arg3;
...
- (id)_cplRelationsForAssetInLibrary:(id)arg1 orderKeyManager:(id)arg2;
- (id)_createCPLResourceFromResourcePath:(id)arg1 withResourceType:(unsigned long long)arg2 uniformTypeIdentifier:(id)arg3 scopedIdentifier:(id)arg4 fingerprintScheme:(id)arg5;
- (id)_createImageResourceForResourceType:(unsigned long long)arg1 withPreviewImagePath:(id)arg2 scopedIdentifier:(id)arg3 forMaster:(bool)arg4 fingerprintScheme:(id)arg5;
- (id)_createJPEGResourcesFromFullSizePath:(id)arg1 withScopedIdentifier:(id)arg2 forMaster:(bool)arg3 fingerprintScheme:(id)arg4;
- (id)_createJPEGResourcesFromFullSizePath:(id)arg1 withScopedIdentifier:(id)arg2 forMaster:(bool)arg3 forResourceTypes:(id)arg4 fingerprintScheme:(id)arg5;
...
- (id)_createVideoResourceFromVideoURL:(id)arg1 withResourceType:(unsigned long long)arg2 scopedIdentifier:(id)arg3 applyVideoAdjustments:(bool)arg4 forMaster:(bool)arg5 forPhotoIris:(bool)arg6 fingerprintScheme:(id)arg7;
...
- (void)_dateCreatedDidChange:(id)arg1;
...
- (void)_fixDistantPastContentCreationDateWithItem:(id)arg1;
- (id)_generateDeferredAdjustmentWithImageConversionClient:(id)arg1 videoConversionClient:(id)arg2 reason:(id)arg3 retryNumber:(unsigned long long)arg4 canUseMegaMoc:(bool)arg5 allowCancellationByService:(bool)arg6 completion:(id /* block */)arg7;
- (id)_generatePosterFrameForVideoAtURL:(id)arg1 withResourceType:(unsigned long long)arg2 scopedIdentifier:(id)arg3 forMaster:(bool)arg4 fingerprintScheme:(id)arg5;
- (id)_generatePosterFrameResourcesFromVideoURL:(id)arg1 withScopedIdentifier:(id)arg2 forMaster:(bool)arg3 fingerprintScheme:(id)arg4;
...
- (bool)_ingestAndApplyMetadataChangesFromAdjustments:(id)arg1 updateAdjustmentDictionary:(id)arg2 options:(id)arg3 fullSizeRenderURL:(id)arg4 videoPosterRenderURL:(id)arg5 isRevertToOriginal:(bool)arg6 error:(id*)arg7;
- (bool)_installExistingPurgeableResourceAtPath:(id)arg1 dstPath:(id)arg2 error:(id*)arg3 installResourceHandler:(id /* block */)arg4;
- (id)_installOrUpdateExistingComputeSyncResourceToIndicateRemoteAvailabilityShouldRemoveLocalFile:(bool)arg1 error:(id*)arg2;
...
- (bool)_isPartOfAvalancheWithKind:(unsigned short)arg1;
...
- (id)_metadataFromMediaProperties:(id)arg1 uniformTypeIdentifier:(id)arg2 block:(id /* block */)arg3;
...
- (void)_processRenderTypeUpdateForCameraAutoWithUnmanagedAdjustment:(id)arg1 options:(id)arg2 hasAdjustments:(bool)arg3 updateRenderFlagsResult:(bool)arg4;
- (void)_processRenderTypeUpdateForGenerativeEditsWithUnmanagedAdjustment:(id)arg1 fullSizeRenderURL:(id)arg2 hasAdjustments:(bool)arg3;
- (void)_processRenderTypeUpdateForSleetCastWithUnmanagedAdjustment:(id)arg1 fullSizeRenderURL:(id)arg2 settingPayload:(id)arg3 hasAdjustments:(bool)arg4;
- (void)_promptForNilScopeIdentifierRadar;
- (void)_recordAssetPersonEdgeAndSocialGroupContainmentUpdateIfNeededWithChangedValues:(id)arg1 inContext:(id)arg2;
- (void)_reloadWidgetTimelineIfNeeded;
- (void)_removeAdjustmentDataResources;
- (void)_removeComputeResourceWithRecipeID:(unsigned int)arg1 atPath:(id)arg2;
- (void)_removeKeyAssetFromSuggestions:(id)arg1;
- (void)_resetAllMediaProcessingVersionsIncludingVideo:(bool)arg1;
- (void)_resetMediaAnalysisStateOnEditIncludingVideo:(bool)arg1;
...
- (bool)_shouldIngestComputeSyncFromCloudWithCloudVersion:(id)arg1 cloudAdjustmentFingerprint:(id)arg2 cloudLastUpdatedDate:(id)arg3;
- (bool)_shouldInstallComputeSyncResourceFromCloudWithCPLAssetChange:(id)arg1;
...
- (void)_updateAdjustmentFromAssetAdjustment:(id)arg1 unmanagedAdjustment:(id)arg2 fullSizeRenderURL:(id)arg3 options:(id)arg4;
...
- (void)_updateAvalanchePropertiesFromAssetChange:(id)arg1;
...
- (bool)applyComputeSyncPayloadWithComputeStateRecord:(id)arg1 originatedFromPrefetch:(bool)arg2 error:(id*)arg3;
- (void)applyComputeSyncPropertiesFromAssetChange:(id)arg1 inLibrary:(id)arg2 didInstallComputeSyncResource:(bool*)arg3 computeSyncDownloadEnabled:(bool)arg4;
...
- (bool)copyComputeSyncResourceFromCPLFilePath:(id)arg1 error:(id*)arg2;
- (bool)couldBeStoredInDCIM;
- (id)cplAssetChangeWithMasterScopedIdentifier:(id)arg1 withChangeType:(unsigned long long)arg2 shouldGenerateDerivatives:(bool)arg3 orderKeyManager:(id)arg4 computeSyncUploadEnabled:(bool)arg5 inLibrary:(id)arg6;
...
- (void)deleteAssetComment:(id)arg1;
...
- (id)fullSizeResourceMetadataFromMediaPropertiesOrFullSizeResourceOrOptionalURL:(id)arg1;
...
- (void)generateAndUpdateThumbnailsWithPreviewImage:(id)arg1 thumbnailImage:(id)arg2 fromImageSource:(struct CGImageSource { }*)arg3 imageData:(id)arg4 metadata:(id)arg5 forceSRGBConversion:(bool)arg6 forFinalCameraImage:(bool)arg7 saveCameraPreviewWellImage:(bool)arg8;
...
- (id)generateDeferredAdjustmentWithImageConversionClient:(id)arg1 videoConversionClient:(id)arg2 reason:(id)arg3 allowCancellationByService:(bool)arg4 completion:(id /* block */)arg5;
- (void)generateLargeThumbnailFileIfNecessary;
- (id)generatePortraitAdjustment:(id*)arg1;
- (void)generateThumbnailsWithImageSource:(struct CGImageSource { }*)arg1 imageData:(id)arg2 metadata:(id)arg3 allowMediumPreview:(bool)arg4 forceSRGBConversion:(bool)arg5 forFinalCameraImage:(bool)arg6 outSmallThumbnailData:(id*)arg7 isPreviewSource:(bool)arg8;
...
- (id)generatedAssetDescriptionNodes;
...
- (id)imageMediaMetadataForURL:(id)arg1;
- (id)imageProperties;
...
- (bool)installComputeSyncResourceAfterAttachtoCPLWithError:(id*)arg1;
- (bool)installExistingAlchemistImageAtPath:(id)arg1 error:(id*)arg2;
- (bool)installExistingGenerativePlaygroundFaceResourcesFileAtPath:(id)arg1 error:(id*)arg2;
...
- (id)pathForComputeSyncMediaAnalysisPayloadFile;
- (id)pathForComputeSyncWrapperFile;
...
- (void)removeAssetFromUserAlbumSuggestionIfNeededWithChangedValues:(id)arg1;
...
- (void)setAdjustments:(id)arg1 options:(id)arg2;
- (void)setAssetAdjustmentsStateFromAdjustmentRenderType:(unsigned int)arg1;
...
- (void)setCurrentSleetCastFromMetadata:(id)arg1;
...
- (void)setIsSmartStyleableWithMetadata:(id)arg1;
...
- (void)setPlaybackControlBadgeAttribute:(unsigned char)arg1;
- (void)setPlaybackControlBadgeAttributeFromMetadata:(id)arg1;
...
- (void)setSpatialAudioControlBadgeAttribute:(unsigned char)arg1;
- (void)setSpatialAudioControlBadgeAttributeFromMetadata:(id)arg1;
...
- (unsigned short)syndicationHistory;
...
- (unsigned int)updateAdjustmentRenderTypes:(unsigned int)arg1 withMetadata:(id)arg2;
...
- (void)updateComputeSyncResourceAfterDownloadWithResource:(id)arg1 onDemandDownload:(bool)arg2;
...
- (bool)updateExtendedAttributesWithMetadata:(id)arg1 error:(id*)arg2;
- (void)updateImageExtendedAttributesFromMetadata:(id)arg1;
- (void)updateImageExtendedGenerativeAttributesFromMetadata:(id)arg1;
...
- (void)updatePanoramosityWithMetadata:(id)arg1;
...
- (void)updateSmartStyleVideoCastFromMetadata:(id)arg1;
- (void)updateSpatialTypeFromAdjustmentRenderTypes:(unsigned int)arg1 hasAdjustment:(bool)arg2 adjustedMediaMetadata:(id)arg3;
- (void)updateSyndicationStateWithSavedToLibrary:(bool)arg1;
...
- (id)virtualResourcesThatReplaceMissingPersistedResources:(id)arg1;
