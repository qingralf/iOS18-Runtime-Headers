...
+ (bool)_populateObjectDictionary:(id)arg1 withObject:(id)arg2 currentKeyPath:(id)arg3 usingModelProperties:(id)arg4 payloadClass:(Class)arg5 info:(id)arg6;
...
+ (id)objectDictionariesByUUIDForPayloadClass:(Class)arg1 inManagedObjectContext:(id)arg2 fetchPredicate:(id)arg3 info:(id)arg4 error:(id*)arg5;
...
- (bool)_applyModelProperties:(id)arg1 toPayloadAttributes:(id)arg2 andNilAttributes:(id)arg3 fromSourceObject:(id)arg4 changedKeys:(id)arg5 info:(id)arg6;
- (void)_applyPayloadProperty:(id)arg1 toManagedObject:(id)arg2 key:(id)arg3 payloadAttributesToUpdate:(id)arg4 payloadDictionary:(id)arg5 info:(id)arg6;
- (void)_applyPayloadToManagedObject:(id)arg1 forModelProperties:(id)arg2 payloadAttributesToUpdate:(id)arg3 info:(id)arg4;
- (void)_applySubRelationshipPayloadProperty:(id)arg1 toManagedObject:(id)arg2 key:(id)arg3 payloadAttributesToUpdate:(id)arg4 payloadDictionary:(id)arg5 info:(id)arg6;
...
- (id)_payloadAttributesListForSubRelationshipProperty:(id)arg1 withManagedObjects:(id)arg2 info:(id)arg3;
...
- (void)applyPayloadToManagedObject:(id)arg1 payloadAttributesToUpdate:(id)arg2 info:(id)arg3;
...
- (id)initWithInsertAdapter:(id)arg1 changedKeys:(id)arg2 info:(id)arg3;
...
- (id)initWithPayloadID:(id)arg1 payloadVersion:(unsigned int)arg2 nilAttributes:(id)arg3 sourceObject:(id)arg4 changedKeys:(id)arg5 modelProperties:(id)arg6 info:(id)arg7;
