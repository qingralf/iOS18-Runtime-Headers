...
- (void)dealloc;
- (id)graphCache;
- (id)initWithPathManager:(id)arg1 coordinator:(id)arg2 onStore:(id)arg3 orStoreURL:(id)arg4 version:(unsigned short)arg5 options:(id)arg6 migrationPolicy:(unsigned int)arg7 analyticsEventManager:(id)arg8 graphCache:(id)arg9;
