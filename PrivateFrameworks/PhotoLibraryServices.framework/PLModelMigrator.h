...
@interface PLModelMigrator : NSObject <NSProgressReporting> {
    ...
    bool  _didRecordCurrentMigrationMetadata;
...
@property (nonatomic) struct os_unfair_lock_s { unsigned int x1; } recordMigrationMetadataLock;
...
+ (bool)shouldPromptUserForRebuildWithLibraryPathManager:(id)arg1;
...
- (bool)_fixAdjustedStableHashesInStore:(id)arg1;
...
- (id)_importFileSystemImportAssets:(id)arg1 intoLibrary:(id)arg2 type:(unsigned char)arg3 progress:(id)arg4;
...
- (bool)_isFileSystemImportRequiredForLibrary:(id)arg1;
...
- (void)_loadFileSystemDataIntoDatabaseIfNeededWithReason:(id)arg1 progress:(id)arg2 requestBackgroundMigrationRegistration:(bool*)arg3;
...
- (bool)_populateAdjustmentsStateForAssetsInStore:(id)arg1;
...
- (void)_recordCurrentVersionMetadataIfNeededForDataMigrationInPersistentStore:(id)arg1;
...
- (void)_updateImportedSavedAssetTypeForFileSystemImportedAsset:(id)arg1 type:(unsigned char)arg2 importAssetKind:(int)arg3 isCPLAssetsDirectory:(bool)arg4 destinationAlbum:(id)arg5;
...
- (struct os_unfair_lock_s { unsigned int x1; })recordMigrationMetadataLock;
...
- (void)setDidRecordCurrentMigrationMetadata:(bool)arg1;
...
- (void)setRecordMigrationMetadataLock:(struct os_unfair_lock_s { unsigned int x1; })arg1;
