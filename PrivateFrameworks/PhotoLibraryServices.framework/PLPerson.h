...
@interface PLPerson : PLManagedObject <PLCloudDeletable, PLFileSystemMetadataPersistence, PLGraphEdgeReferenceRecipient, PLSyncablePerson, PLUserFeedbackSupporting> {
    short  _deleteReason;
...
+ (id)_batchFetchPersonUUIDsByAssetUUIDWithAssetUUIDs:(id)arg1 predicate:(id)arg2 includedDetectionTypes:(id)arg3 inManagedObjectContext:(id)arg4 error:(id*)arg5;
...
+ (void)batchFetchPersonUUIDsByAssetUUIDWithAssetUUIDs:(id)arg1 predicate:(id)arg2 includedDetectionTypes:(id)arg3 inManagedObjectContext:(id)arg4 completion:(id /* block */)arg5;
+ (void)batchFetchPersonsByAssetUUIDWithAssetUUIDs:(id)arg1 predicate:(id)arg2 includedDetectionTypes:(id)arg3 library:(id)arg4 completion:(id /* block */)arg5;
...
+ (void)enumerateAssetUUIDsForSearchIndexingWithPersonUUID:(id)arg1 managedObjectContext:(id)arg2 libraryIdentifier:(long long)arg3 assetUUIDHandler:(id /* block */)arg4;
...
+ (id)fetchMePersonInManagedObjectContext:(id)arg1;
+ (id)fetchPersonCountByAssetUUIDForAssetUUIDs:(id)arg1 predicate:(id)arg2 includedDetectionTypes:(id)arg3 library:(id)arg4 error:(id*)arg5;
...
- (bool)_updateGroupMembershipFromEdges:(id)arg1 mergeTarget:(id)arg2 error:(id*)arg3;
- (void)_updateSharedLibraryPeopleRulesForTombstone;
- (bool)_updateSocialGroupMembershipWithPersonsToMerge:(id)arg1 mergeTarget:(id)arg2;
- (id)allDetectedFaces;
...
- (void)enumerateAssetSearchEntityPersonRelationsWithBlock:(id /* block */)arg1;
- (void)enumeratePersonRelationsWithBlock:(id /* block */)arg1;
...
- (void)setMeConfidence:(double)arg1;
