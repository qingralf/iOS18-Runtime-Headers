...
- (id)loadCompositionFrom:(id)arg1 formatIdentifier:(id)arg2 formatVersion:(id)arg3 sidecarData:(id)arg4 error:(id*)arg5;
...
+ (id)compositionControllerWithAdjustmentData:(id)arg1 asset:(id)arg2 imageOrientation:(long long)arg3 outMasterWidth:(long long*)arg4 outMasterHeight:(long long*)arg5;
