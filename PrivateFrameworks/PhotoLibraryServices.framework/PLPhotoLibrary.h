...
+ (id)stringFromLibraryRole:(unsigned long long)arg1;
...
- (id)_fetchCompleteAssetIDsWithValidatedSavedAssetTypeMask:(unsigned int)arg1 context:(id)arg2;
...
- (bool)_isUnknownAssetColumnError:(id)arg1;
...
- (void)_markForRebuildAndAbortWithReason:(long long)arg1 error:(id)arg2;
...
- (id)addDCIMEntryAtFileURL:(id)arg1 mainFileMetadata:(id)arg2 previewImage:(id)arg3 thumbnailImage:(id)arg4 savedAssetType:(short)arg5 replacementUUID:(id)arg6 publicGlobalUUID:(id)arg7 extendedInfo:(id)arg8 withUUID:(id)arg9 isPlaceholder:(bool)arg10 placeholderFileURL:(id)arg11 forFinalCameraImage:(bool)arg12;
...
- (void)deleteUnknownDeferredIntermediatesWithCompletionHandler:(id /* block */)arg1;
...
- (id)librarySizesFromDBForLibraryKindMask:(unsigned long long)arg1;
...
- (void)updateKeyAssetsInAlbums:(id)arg1;
