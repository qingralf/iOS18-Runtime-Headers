...
- (id)_pathKeyForLibraryURL:(id)arg1;
...
- (id)pauseUntilDateForShutdownReason:(id)arg1;
- (void)removeBundleForRebuildAtLibraryURL:(id)arg1;
- (void)removeManagedObjectModelIfNeededForShutdownReason:(id)arg1;
