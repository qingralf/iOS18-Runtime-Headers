...
@interface PLPhotosHighlight : PLManagedObject <PLPhotosHighlightData, PLSearchableManagedObject> {
...
@property (nonatomic, retain) NSOrderedSet *collageAssetsMixed;
@property (nonatomic, retain) NSOrderedSet *collageAssetsPrivate;
@property (nonatomic, retain) NSOrderedSet *collageAssetsShared;
...
+ (id)batchFetchTripHighlightUUIDsByAssetUUIDsWithAssetUUIDs:(id)arg1 library:(id)arg2 error:(id*)arg3;
+ (short)calculateSharingCompositionForPhotosHighlight:(id)arg1;
+ (id)defaultPropertiesToFetchForMomentList;
+ (id)entityName;
+ (id)fetchHighlightsWithUUIDs:(id)arg1 managedObjectContext:(id)arg2;
+ (id)fetchRequest;
...
- (id)_extendedAssetsForSharingConsideration:(long long)arg1;
- (id)_keyAssetForSharingConsideration:(long long)arg1;
...
- (void)_recalculateCollageAssetsForSharingConsideration:(long long)arg1;
- (int)assetsCount;
