...
- (id)_ongoingTripsInRecentMoments:(id)arg1;
...
- (id)_recentMoments;
- (id)_remainingHighlightClustersWithClusters:(id)arg1 intersectingMoments:(id)arg2 allowExternalSplits:(bool)arg3;
- (id)_remainingMomentsFromMoments:(id)arg1 includeAllTripHighlightClusters:(bool)arg2;
