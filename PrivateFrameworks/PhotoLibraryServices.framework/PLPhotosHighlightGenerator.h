...
+ (void)_updateTitlesForHighlight:(id)arg1 dateRangeTitleGenerator:(id)arg2 options:(unsigned long long)arg3 filter:(unsigned short)arg4;
...
+ (void)updateTitlesForHighlight:(id)arg1 dateRangeTitleGenerator:(id)arg2 options:(unsigned long long)arg3;
+ (id)userDefaults;
