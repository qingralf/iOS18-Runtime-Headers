...
@interface PLPrefetchConfiguration : NSObject {
    ...
    unsigned short  _cloudResourceComputeSyncMaxResourcesPerFetch;
    ...
    unsigned short  _cloudResourceMediaMetadataOverflowMaxResourcesPerFetch;
    ...
    long long  _optimizedNonThumbnailInitialPrefetchDateIntervalBeforeNow;
}
...
@property (nonatomic, readonly) unsigned short cloudResourceMediaMetadataOverflowMaxResourcesPerFetch;
...
@property (nonatomic, readonly) long long optimizedNonThumbnailInitialPrefetchDateIntervalBeforeNow;
...
- (unsigned short)cloudResourceComputeSyncMaxResourcesPerFetch;
...
- (unsigned short)cloudResourceMediaMetadataOverflowMaxResourcesPerFetch;
...
- (long long)optimizedNonThumbnailInitialPrefetchDateIntervalBeforeNow;
...
- (void)setCloudResourceComputeSyncMaxResourcesPerFetch:(unsigned short)arg1;
