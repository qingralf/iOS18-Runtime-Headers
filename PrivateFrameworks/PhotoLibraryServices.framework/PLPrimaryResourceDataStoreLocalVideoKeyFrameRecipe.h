...
- (void).cxx_destruct;
- (void)_generateAndStoreForAsset:(id)arg1 networkAccessAllowed:(bool)arg2 clientBundleID:(id)arg3 progress:(id*)arg4 completion:(id /* block */)arg5;
...
- (void)generateAndStoreForAsset:(id)arg1 networkAccessAllowed:(bool)arg2 clientBundleID:(id)arg3 progress:(id*)arg4 completion:(id /* block */)arg5;
