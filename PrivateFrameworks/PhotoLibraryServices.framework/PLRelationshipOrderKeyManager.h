...
- (id)_locked_spiSafeContextGivenPassedInContext:(id)arg1 andName:(const char *)arg2;
...
- (void)stashAlbumAssetsLocationValue:(long long)arg1 forAssetWithID:(id)arg2 inAlbumWithID:(id)arg3 atIndex:(unsigned long long)arg4 usingContext:(id)arg5;
- (void)stashFolderAlbumsLocationValue:(long long)arg1 forAlbumWithID:(id)arg2 inFolderWithID:(id)arg3 atIndex:(unsigned long long)arg4 usingContext:(id)arg5;
