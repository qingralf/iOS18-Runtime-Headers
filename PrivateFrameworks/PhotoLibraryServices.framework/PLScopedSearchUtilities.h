...
+ (void)intersectSortedArray:(const struct __CFArray {}**)arg1 withOtherSortedArray:(struct __CFArray { }*)arg2 intersectionLimit:(unsigned long long)arg3;
+ (id)removeGroupsWithNonExactMatchTextFromGroups:(id)arg1 searchText:(id)arg2;
+ (id)removeSynonymsOfOtherGroupsInGroups:(id)arg1;
+ (void)searchIndexIdsFromUUIDs:(id)arg1 searchResultTypes:(unsigned long long)arg2 psiDatabase:(id)arg3 completion:(id /* block */)arg4;
