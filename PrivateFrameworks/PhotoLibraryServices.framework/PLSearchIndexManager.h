...
+ (id)_keywordsByCategoryMaskByAssetUUIDFromAssetSearchKeywords:(id)arg1 andAssetUUIDsBySocialGroup:(id)arg2 photoLibrary:(id)arg3;
+ (id)_keywordsByCategoryMaskByAssetUUIDFromAssetSearchKeywords:(id)arg1 photoLibrary:(id)arg2;
+ (id)_keywordsByCategoryMaskByAssetUUIDFromAssetUUIDsBySocialGroup:(id)arg1;
+ (id)fetchAlbumUUIDsToPopulateSearchIndexWithManagedObjectContext:(id)arg1 libraryIdentifier:(long long)arg2 error:(id*)arg3;
+ (id)fetchAlbumsWithUUIDs:(id)arg1 managedObjectContext:(id)arg2 error:(id*)arg3;
+ (id)fetchAssetUUIDsToPopulateSearchIndexWithManagedObjectContext:(id)arg1 libraryIdentifier:(long long)arg2 error:(id*)arg3;
+ (id)fetchAssetsWithUUIDs:(id)arg1 managedObjectContext:(id)arg2 error:(id*)arg3;
+ (id)fetchHighlightUUIDsToPopulateSearchIndexWithManagedObjectContext:(id)arg1 libraryIdentifier:(long long)arg2 error:(id*)arg3;
...
+ (id)fetchMemoryUUIDsToPopulateSearchIndexWithManagedObjectContext:(id)arg1 libraryIdentifier:(long long)arg2 error:(id*)arg3;
...
- (void)dealloc;
- (void)deleteEmbeddings:(id)arg1 assetUUID:(id)arg2 completion:(id /* block */)arg3;
