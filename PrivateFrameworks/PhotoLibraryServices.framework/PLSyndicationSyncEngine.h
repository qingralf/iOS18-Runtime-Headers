...
@interface PLSyndicationSyncEngine : NSObject {
    <PLSyndicationSyncEngineDelegate> * _delegate;
    unsigned int  _savedAssetTypeMask;
    NSSet * _suppportedQueryTypes;
}

@property (nonatomic, readonly) <PLSyndicationSyncEngineDelegate> *delegate;
...
- (id)delegate;
- (id)initWithQueryTypes:(id)arg1 savedAssetTypeMask:(unsigned int)arg2 delegate:(id)arg3;
