...
- (id)_usedElsewhereWarningTextForAssetCount:(long long)arg1 inLibraryScopeCount:(long long)arg2 myAssets:(id)arg3 contributors:(id)arg4 inSomeAlbumCount:(long long)arg5 affectedLocalAlbumsCount:(long long)arg6 assetType:(short)arg7 actualDeletionCount:(long long)arg8 syndicationAssetCount:(long long)arg9;
- (id)_usedElsewhereWarningTextForAssets:(id)arg1 actualDeletionCount:(long long)arg2;
...
- (void)getDeletionWarningTitle:(id*)arg1 message:(id*)arg2 buttonTitle:(id*)arg3 forAssets:(id)arg4 syndicationAssetCount:(long long)arg5 clientName:(id)arg6 style:(long long)arg7;
