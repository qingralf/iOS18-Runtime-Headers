...
- (id)init;
- (id)initWithContentString:(id)arg1 lookupIdentifier:(id)arg2 category:(short)arg3 score:(double)arg4;
- (id)initWithContentString:(id)arg1 normalizedString:(id)arg2 lookupIdentifier:(id)arg3 category:(short)arg4 groupId:(unsigned long long)arg5 owningGroupId:(long long)arg6 score:(double)arg7;
