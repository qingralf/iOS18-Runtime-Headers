...
@property (nonatomic, readonly, copy) NSIndexSet *modelTypes;
...
@property (nonatomic, readonly, copy) NSString *queryAssetUUID;
...
- (id)initWithEmbeddingModelTypes:(id)arg1 assetUUID:(id)arg2 delegate:(id)arg3;
- (id)initWithQueryText:(id)arg1 suggestionType:(unsigned long long)arg2 suggestionLimit:(unsigned long long)arg3 resultTypes:(unsigned long long)arg4 delegate:(id)arg5 libraryScope:(unsigned long long)arg6;
...
- (void)runFetchEmbeddingQueryWitBatchHandler:(id /* block */)arg1;
