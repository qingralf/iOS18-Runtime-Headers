...
+ (void)writeableDataForImage:(id)arg1 previewImage:(id)arg2 imageData:(id)arg3 imageUTIType:(id)arg4 imageSource:(struct CGImageSource { }*)arg5 primaryImageProperties:(id)arg6 imageOrientation:(long long)arg7 thumbnailDataOut:(id*)arg8 imageUTITypeOut:(id*)arg9 primaryImagePropertiesOut:(id*)arg10 isJPEGOut:(bool*)arg11 imageDataOut:(id*)arg12;
+ (void)writeableDataForImageData:(id)arg1 imageUTIType:(id)arg2 imageSource:(struct CGImageSource { }*)arg3 thumbnailDataOut:(id*)arg4 imageUTITypeOut:(id*)arg5 primaryImagePropertiesOut:(id*)arg6 imageDataOut:(id*)arg7;
