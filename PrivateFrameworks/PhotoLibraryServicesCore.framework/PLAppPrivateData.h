...
+ (bool)_validateBundleRootWithPathManager:(id)arg1;
+ (bool)accessInstanceVariablesDirectly;
+ (id)appPrivateDataForLibraryURL:(id)arg1;

- (void).cxx_destruct;
- (id)_appPrivateDataFolderURLCreateIfNeeded:(bool)arg1;
- (id)_dictionaryStorageURL;
- (id)_dictionaryStorageURLPreparedForWriting:(bool)arg1;
