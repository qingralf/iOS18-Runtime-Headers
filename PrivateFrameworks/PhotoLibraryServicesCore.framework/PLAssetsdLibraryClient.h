...
- (bool)isOpened;
- (void)launchAssetsd;
- (bool)openApplicationOwnedFoldersWithError:(id*)arg1;
...
- (id)proxyLockFileWithDatabasePath:(id)arg1 error:(id*)arg2;
...
- (id)resetSocialGroupsWithCompletionHandler:(id /* block */)arg1;
- (void)searchDonationProgressForTaskIDs:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (bool)validateOrRebuildPhotoLibraryDatabaseWithError:(id*)arg1;
