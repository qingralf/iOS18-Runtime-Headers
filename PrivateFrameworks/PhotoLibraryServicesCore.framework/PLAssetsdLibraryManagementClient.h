...
- (id)createManagedPhotoLibraryWithOptions:(id)arg1 error:(id*)arg2;
- (void)filesystemSizeForLibraryURL:(id)arg1 result:(id /* block */)arg2;
- (id)findPhotoLibraryIdentifiersMatchingSearchCriteria:(id)arg1 error:(id*)arg2;
...
- (id)photoLibraryIdentifierForPhotoLibraryURL:(id)arg1 error:(id*)arg2;
