...
+ (id)accessibleURLOrParentForFileURL:(id)arg1;
...
+ (id)hasDiskSpaceToCopyFileAtURL:(id)arg1 toVolumeAtURL:(id)arg2 error:(id*)arg3;
...
+ (id)realURLForURL:(id)arg1 error:(id*)arg2;
