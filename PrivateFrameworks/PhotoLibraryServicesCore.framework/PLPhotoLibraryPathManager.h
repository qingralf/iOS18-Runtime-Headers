...
+ (id)rootURLForPhotoLibraryDomain:(long long)arg1;
...
- (void)resetBackupExclusionPathsForBackupType:(long long)arg1;
- (void)setBackupExclusionAttributesForWellKnownLibrariesOrWithCreateOptions:(unsigned long long)arg1 andBackupType:(long long)arg2;
- (void)setOrCompareLibraryURL:(id)arg1;
- (id)sqliteErrorIndicatorFilePath;
- (void)updateBackupExclusionPathsForBackupType:(long long)arg1;
