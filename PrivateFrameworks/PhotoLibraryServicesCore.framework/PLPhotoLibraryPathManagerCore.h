...
+ (bool)setICloudBackupExclusionAttribute:(bool)arg1 url:(id)arg2 error:(id*)arg3;
...
- (bool)internalValidateCreationRequestWithError:(id*)arg1;
...
- (bool)validateCreationRequestWithError:(id*)arg1;
