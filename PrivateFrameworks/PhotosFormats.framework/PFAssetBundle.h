...
@property (nonatomic, readonly) NSMutableDictionary *auxiliaryResourceURLsByKey;
...
- (void).cxx_destruct;
- (id)URLForAuxiliaryResourceWithKey:(id)arg1;
...
- (void)addAuxiliaryResourceAtURL:(id)arg1 resourceKey:(id)arg2;
...
- (id)initWithOriginalPhotoURL:(id)arg1 alternatePhotoURL:(id)arg2 fullSizePhotoURL:(id)arg3 adjustmentBaseFullSizePhotoURL:(id)arg4 spatialOvercapturePhotoURL:(id)arg5 originalPairedVideoURL:(id)arg6 fullSizePairedVideoURL:(id)arg7 adjustmentBaseFullSizePairedVideoURL:(id)arg8 spatialOvercapturePairedVideoURL:(id)arg9 fullSizeVideoURL:(id)arg10 adjustmentsURL:(id)arg11 originalAdjustmentsURL:(id)arg12 adjustmentsSecondaryDataURL:(id)arg13 mediaSubtypes:(unsigned long long)arg14 playbackStyle:(long long)arg15 playbackVariation:(unsigned long long)arg16 videoComplementVisibilityState:(unsigned short)arg17;
- (id)initWithOriginalVideoURL:(id)arg1 fullSizeRenderedVideoURL:(id)arg2 adjustmentBaseVideoURL:(id)arg3 spatialOvercaptureVideoURL:(id)arg4 adjustmentsURL:(id)arg5 originalAdjustmentsURL:(id)arg6 mediaSubtypes:(unsigned long long)arg7 playbackStyle:(long long)arg8 playbackVariation:(unsigned long long)arg9;
