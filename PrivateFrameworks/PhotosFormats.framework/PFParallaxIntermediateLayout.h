...
@property (nonatomic, readonly) bool hasTopEdgeContact;
...
- (id)initWithVisibleRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 inactiveRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 zoomStrategy:(unsigned long long)arg3 overlapStrategy:(unsigned long long)arg4 parallaxStrategy:(unsigned long long)arg5 inactiveStrategy:(unsigned long long)arg6 headroomStrategy:(unsigned long long)arg7 cropScore:(double)arg8 layoutScore:(double)arg9 timeBottomOverlap:(double)arg10 timeTopOverlap:(double)arg11 unsafeAreaOverlap:(double)arg12 uninflatedUnsafeAreaOverlap:(double)arg13 hasTopEdgeContact:(bool)arg14;
- (double)layoutScore;
...
- (id)initWithVisibleRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 cropScore:(double)arg2 layoutScore:(double)arg3;
