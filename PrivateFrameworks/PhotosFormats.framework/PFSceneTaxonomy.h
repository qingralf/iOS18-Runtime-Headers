...
- (id)description;
- (id)digest;
- (unsigned long long)extendedSceneClassIdForName:(id)arg1;
...
- (id)nodeForExtendedSceneClassId:(unsigned long long)arg1;
- (id)nodeForName:(id)arg1;
- (id)nodeForSceneClassId:(unsigned int)arg1;
- (void*)nodeRefForExtendedSceneClassId:(unsigned long long)arg1;
...
- (id)mad_extendedSceneIdFromSceneName:(id)arg1;
- (id)mad_sceneNameFromExtendedSceneId:(unsigned long long)arg1;
