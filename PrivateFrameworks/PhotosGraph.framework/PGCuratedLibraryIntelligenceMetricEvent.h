...
- (id)_assetsStatisticsInHighlights:(id)arg1 photoLibrary:(id)arg2 includeUtility:(bool)arg3 progressReporter:(id)arg4;
- (id)_dayHighlights;
- (id)_daysWithinAggregations;
- (id)_daysWithinTrips;
- (unsigned long long)_debugNumberOfAssets;
- (id)_defaultHighlights;
- (void)_fillAestheticAndBehavioralCurationStatisticsWithGraph:(id)arg1 progressReporter:(id)arg2;
- (void)_fillContentScoreStatisticsWithGraph:(id)arg1 progressReporter:(id)arg2;
- (void)_fillDayHighlightsStatisticsWithGraph:(id)arg1 progressReporter:(id)arg2;
- (void)_fillGenericStatisticsWithGraph:(id)arg1;
- (void)_fillHiddenHighlightsStatisticsWithGraph:(id)arg1;
- (void)_fillKeyAssetsStatisticsWithGraph:(id)arg1 progressReporter:(id)arg2;
- (void)_fillMomentsStatisticsWithGraph:(id)arg1;
- (void)_fillMonthHighlightsStatisticsWithGraph:(id)arg1 progressReporter:(id)arg2;
- (void)_fillOnesiesHighlightStatisticsWithGraph:(id)arg1 progressReporter:(id)arg2;
- (void)_fillProcessingLevelStatisticsWithGraph:(id)arg1 progressReporter:(id)arg2;
