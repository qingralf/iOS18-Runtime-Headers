...
- (id)bestAssetInAssets:(id)arg1 forReferencePersonLocalIdentifiers:(id)arg2 requiredMinimumNumberOfReferencePersons:(unsigned long long)arg3 forMemories:(bool)arg4 forSocialGroup:(bool)arg5 allowGuestAsset:(bool)arg6 wantsGoodSquareCropScore:(bool)arg7;
...
- (id)initWithPhotoLibrary:(id)arg1 cacheURL:(id)arg2;
