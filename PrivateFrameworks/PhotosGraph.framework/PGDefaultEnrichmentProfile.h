...
@property (nonatomic, readonly) unsigned short targetEnrichmentState; /* unknown property attribute: ? */
...
- (id)debugInfos;
- (unsigned short)enrichmentStateWithHighlightInfo:(id)arg1 highlightTailorContext:(id)arg2;
...
- (id)titleWithHighlightInfo:(id)arg1 sharingFilter:(unsigned short)arg2 curatedAssets:(id)arg3 keyAsset:(id)arg4 createVerboseTitle:(bool)arg5 error:(out id*)arg6;
