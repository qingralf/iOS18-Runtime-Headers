...
+ (id)socialGroupMemberSortDescriptorForSocialGroupNode:(id)arg1;
+ (id)stellarMeanings;
...
- (void)_reportDeviceOwnerWithAnalytics:(id)arg1 photoLibrary:(id)arg2 serviceManager:(id)arg3;
...
- (id)commonSocialGroupNodesForMemberNodes:(id)arg1;
- (id)commonSocialGroupNodesForMemberNodes:(id)arg1 withThreshold:(double)arg2;
...
- (void)enumerateSocialGroupsWithBlock:(id /* block */)arg1 includeInvalidGroups:(bool)arg2;
...
- (id)fetchMemberNodesBySocialGroupNodeForSocialGroupNodes:(id)arg1;
- (id)fetchMemberNodesBySocialGroupNodeForSocialGroups:(id)arg1;
- (id)friends;
- (id)graphQueue;
...
- (id)memberLocalIdentifiersBySocialGroupUUIDWithMemberNodesBySocialGroupNode:(id)arg1 shouldIncludeMeNode:(bool)arg2 simulateMeNodeNotSet:(bool)arg3;
...
- (void)reportMetricsLogsWithAnalytics:(id)arg1 photoLibrary:(id)arg2 serviceManager:(id)arg3;
...
- (id)socialGroupMemberNodesForMemberLocalIdentifiers:(id)arg1;
- (id)socialGroupNodeForMemberNodes:(id)arg1;
...
- (id)socialGroupsIdentifiersFromSocialGroupNodesWithMemberNodesBySocialGroupNode:(id)arg1 shouldIncludeMeNode:(bool)arg2 simulateMeNodeNotSet:(bool)arg3;
