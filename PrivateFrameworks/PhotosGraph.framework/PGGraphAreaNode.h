...
+ (id)nonBlockedFilter;
+ (void)setIsBlocked:(bool)arg1 onNodeForIdentifier:(unsigned long long)arg2 inGraph:(id)arg3;
+ (void)setPopularityScore:(double)arg1 onNodeForIdentifier:(unsigned long long)arg2 inGraph:(id)arg3;
+ (id)stateOfArea;
