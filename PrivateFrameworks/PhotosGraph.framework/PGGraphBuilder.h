...
+ (id)expandedRelationshipLabelsForRelationship:(unsigned long long)arg1;
...
+ (id)reducedRelationshipLabelForRelationshipLabels:(id)arg1;
...
- (void)_deleteSocialGroupsWithGraphUpdate:(id)arg1;
...
- (void)_insertEntityNetScene:(id)arg1 fromMomentNode:(id)arg2 withEntityNetSceneTaxonomy:(id)arg3 changeRequest:(id)arg4;
...
- (id)_insertScene:(id)arg1 fromMomentNode:(id)arg2 changeRequest:(id)arg3;
- (id)_momentNodesFromPersonNodes:(id)arg1;
- (void)_onGraphDidUpdate;
- (void)_persistCurationScores:(id)arg1;
- (void)_persistGenerativeMemoryCreationEligibilityState:(id)arg1;
...
- (void)_removeEdgesFromMomentNode:(id)arg1 forUpdateTypes:(unsigned long long)arg2;
...
- (void)addGenerativeMemoryCreationEligibilityState:(short)arg1 forAsset:(id)arg2;
...
- (void)addStorytellingRelationshipsToMeNode:(id)arg1 relationshipByPerson:(id)arg2;
- (id)aoiCache;
...
- (short)generativeMemoryCreationEligibleStateWithAsset:(id)arg1;
- (id)graph;
- (void)inferPersonNodeForMeNode:(id)arg1;
- (id)initWithGraph:(id)arg1;
- (id)initWithGraph:(id)arg1 locationCache:(id)arg2;
...
- (void)insertEntityNetScenesWithClueCollection:(id)arg1 fromMomentNode:(id)arg2;
...
- (void)insertStorytellingRelationshipsWithRelationshipsForPersonNodes:(id)arg1 meNode:(id)arg2;
...
- (id)updateMeNode:(id)arg1 withPropertiesFromPerson:(id)arg2;
