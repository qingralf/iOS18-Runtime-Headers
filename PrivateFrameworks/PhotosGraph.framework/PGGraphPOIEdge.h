...
+ (id)filterImproved;
+ (id)filterSpecial;
+ (void)setConfidence:(double)arg1 onEdgeForIdentifier:(unsigned long long)arg2 inGraph:(id)arg3;
+ (void)setPOIIsImproved:(bool)arg1 onEdgeForIdentifier:(unsigned long long)arg2 inGraph:(id)arg3;
