...
@interface PGGraphPersonNode : PGGraphOptimizedNode <PGAssetCollectionFeature, PGPersonResult, PGSocialGroupMember> {
...
@property (readonly) bool isMyInferredSister;
@property (readonly) bool isMyInferredSon;
...
@property (readonly) bool isMySister;
@property (readonly) bool isMySon;
...
- (bool)isMySister;
- (bool)isMySon;
- (bool)isTaggedWithRelationship:(unsigned long long)arg1 withConfidence:(double)arg2;
- (bool)isUserCreated;
- (bool)isVerified;
- (id)label;
- (id)localIdentifier;
