...
+ (id)filterWithSource:(unsigned char)arg1;
+ (id)friendFilter;
...
+ (id)parentFilter;
+ (id)partnerFilter;
+ (id)propertiesWithRelationshipSource:(unsigned char)arg1;
+ (id)relationshipSourceToString:(unsigned char)arg1;
+ (id)sisterFilter;
+ (id)sonFilter;
