...
- (void)enumerateHighRecallInferredRelationshipsExcludingPersonNodes:(id)arg1 usingBlock:(id /* block */)arg2;
...
- (id)graph;
- (id)initWithPersonNodes:(id)arg1 runOptions:(unsigned long long)arg2 serviceManager:(id)arg3;
- (id)momentNodes;
