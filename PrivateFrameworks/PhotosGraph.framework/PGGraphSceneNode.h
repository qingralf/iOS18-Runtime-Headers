...
- (id)initWithSceneName:(id)arg1 sceneIdentifier:(unsigned long long)arg2 level:(unsigned long long)arg3 isIndexed:(bool)arg4 localizedName:(id)arg5 localizedSynonyms:(id)arg6;
