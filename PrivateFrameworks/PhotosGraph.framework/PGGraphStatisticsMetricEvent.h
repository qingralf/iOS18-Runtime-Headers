...
- (void).cxx_destruct;
- (void)_fillBusinessStatisticsWithGraph:(id)arg1 progressReporter:(id)arg2;
- (void)_fillFrequentLocationsStatisticsWithGraph:(id)arg1 progressReporter:(id)arg2;
- (void)_fillGenericStatisticsWithGraph:(id)arg1;
- (void)_fillHolidaysStatisticsWithGraph:(id)arg1 progressReporter:(id)arg2;
- (void)_fillHomeWorkStatisticsWithGraph:(id)arg1;
- (void)_fillMeaningfulEventsStatisticsWithGraph:(id)arg1 progressReporter:(id)arg2;
- (void)_fillMomentStatisticsWithGraph:(id)arg1 progressReporter:(id)arg2;
- (void)_fillMusicStatisticsWithGraph:(id)arg1 progressReporter:(id)arg2;
- (void)_fillPeopleStatisticsWithGraph:(id)arg1 progressReporter:(id)arg2;
- (void)_fillPetStatisticsWithGraph:(id)arg1;
- (void)_fillPublicEventStatisticsWithGraph:(id)arg1 progressReporter:(id)arg2;
- (void)_fillTripStatisticsWithGraph:(id)arg1 progressReporter:(id)arg2;
