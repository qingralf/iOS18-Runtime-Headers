...
@interface PGGraphUpdate : NSObject <PGGraphUpdateInventory> {
    ...
    bool  _hasDeletedSocialGroupNodes;
    bool  _hasIncrementalChanges;
    bool  _hasInsertedSocialGroupNodes;
    bool  _hasUpdatedPersonNodes;
    bool  _hasUpdatedSocialGroupNodes;
...
@property (nonatomic, readonly) bool hasDeletedSocialGroupNodes;
...
@property (nonatomic, readonly) bool hasInsertedSocialGroupNodes;
...
@property (nonatomic, readonly) bool hasSocialGroupsToDelete;
@property (nonatomic, readonly) bool hasSocialGroupsToInsert;
@property (nonatomic, readonly) bool hasSocialGroupsToUpdate;
...
@property (nonatomic, readonly) bool hasUpdatedSocialGroupNodes;
...
@property (nonatomic, readonly) NSSet *uuidsOfSocialGroupsToDelete;
@property (nonatomic, readonly) NSSet *uuidsOfSocialGroupsToInsert;
@property (nonatomic, readonly) NSSet *uuidsOfSocialGroupsToUpdate;
...
- (id)uuidsOfSocialGroupsToDelete;
- (id)uuidsOfSocialGroupsToInsert;
- (id)uuidsOfSocialGroupsToUpdate;
