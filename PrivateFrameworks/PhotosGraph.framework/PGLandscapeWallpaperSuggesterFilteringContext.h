...
- (id)initForAmbient;
- (id)initForLandscapesInOrientation:(long long)arg1;
- (id)initForTopLandscapes:(bool)arg1 withDictionary:(id)arg2 orientation:(long long)arg3;
- (id)initForTopLandscapesInOrientation:(long long)arg1;
