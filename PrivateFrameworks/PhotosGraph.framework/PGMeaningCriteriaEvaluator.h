...
+ (id)meaningCriteriaEvaluatorsForMeaningLabel:(id)arg1 withDictionary:(id)arg2 serviceManager:(id)arg3;
...
- (id)description;
- (id)initWithDictionary:(id)arg1 meaningCriteriaInfo:(id)arg2 serviceManager:(id)arg3;
