...
- (id)initWithPhotoLibrary:(id)arg1 userFeedbackCalculator:(id)arg2 graph:(id)arg3 serviceManager:(id)arg4 loggingConnection:(id)arg5;
- (id)initWithProcessedScenesAndFacesCache:(id)arg1 momentNodesWithBlockedFeatureCache:(id)arg2 locationHelper:(id)arg3 serviceManager:(id)arg4 loggingConnection:(id)arg5;
