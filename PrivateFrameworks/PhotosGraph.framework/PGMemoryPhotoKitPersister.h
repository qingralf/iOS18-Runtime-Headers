...
- (bool)persistLocalMemoriesFromEnrichedMemories:(id)arg1 localMemoriesToDelete:(id)arg2 progressReporter:(id)arg3 error:(id*)arg4;
- (bool)updateExistingMemories:(id)arg1 localMemoryByUniqueIdentifier:(id)arg2 progressReporter:(id)arg3;
