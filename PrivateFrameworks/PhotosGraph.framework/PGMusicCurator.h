...
+ (void)inflateDisplayMetadataForMusicCuration:(id)arg1 inflationContext:(id)arg2 curatorContext:(id)arg3 progressReporter:(id)arg4 completionHandler:(id /* block */)arg5;
