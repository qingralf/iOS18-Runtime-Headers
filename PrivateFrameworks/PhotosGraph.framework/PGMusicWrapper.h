...
+ (id)appleMusicCurationWithOptions:(id)arg1 graphManager:(id)arg2 progressReporter:(id)arg3 error:(id*)arg4;
...
+ (id)flexMusicCurationWithOptions:(id)arg1 graphManager:(id)arg2 progressReporter:(id)arg3 error:(id*)arg4;
...
+ (void)requestFlexMusicCurationWithCurationOptions:(id)arg1 graphManager:(id)arg2 reply:(id /* block */)arg3;
...
+ (void)requestMusicCurationWithCurationOptions:(id)arg1 graphManager:(id)arg2 reply:(id /* block */)arg3;
+ (void)requestRecentlyUsedSongsWithOptions:(id)arg1 graphManager:(id)arg2 reply:(id /* block */)arg3;
