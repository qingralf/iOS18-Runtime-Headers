...
@property (nonatomic, readonly) bool isInferredHighRecallChild;
@property (nonatomic, readonly) bool isInferredHighRecallHouseholdMember;
...
@property (nonatomic) bool personInferredToBeChild;
