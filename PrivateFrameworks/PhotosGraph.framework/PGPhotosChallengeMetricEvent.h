...
- (void)_gatherMetricsForMemoryMusicQuestions:(id)arg1 progressBlock:(id /* block */)arg2;
...
- (void)_gatherMetricsForRelationshipQuestions:(id)arg1 questionMetricType:(unsigned short)arg2 progressBlock:(id /* block */)arg3 useGraphInference:(bool)arg4;
...
- (void)_gatherMetricsForStoryPromptSuggestionsQuestions:(id)arg1 progressBlock:(id /* block */)arg2;
...
- (id)_groundTruthForMusicQualityQuestions:(id)arg1;
- (id)_groundTruthForNamingFromQuestions:(id)arg1;
- (id)_groundTruthForPublicEventFromQuestions:(id)arg1;
- (id)_groundTruthForStoryPromptSuggestionsQuestions:(id)arg1;
...
- (id)_inferredResultsForEntityIdentifiers:(id)arg1 withDefaultBoolValue:(bool)arg2;
...
- (id)_reasonResultByAssetEntityIdentifierForMusicQualityQuestions:(id)arg1;
- (id)_reasonResultByAssetEntityIdentifierForStoryPromptSuggestionsQuestions:(id)arg1;
...
- (bool)_relationshipInferenceResultForPersonNode:(id)arg1 questionMetricType:(unsigned short)arg2 useGraphInference:(bool)arg3;
- (id)_relationshipInferenceResultsForQuestionMetricType:(unsigned short)arg1 personUUIDs:(id)arg2 useGraphInference:(bool)arg3;
- (unsigned long long)_relationshipTagFromQuestionMetricType:(unsigned short)arg1;
- (bool)_relationshipTagInferenceResultForPersonNode:(id)arg1 questionMetricType:(unsigned short)arg2;
- (bool)_relatonshipInferenceResultForPersonNode:(id)arg1 questionMetricType:(unsigned short)arg2;
...
- (id)preparePayloadForPrecisionRecallEval:(id)arg1 withEvaluations:(id)arg2;
