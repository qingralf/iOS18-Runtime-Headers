...
+ (id)shareBackSuggesterForExternalAssetProcessingWithLoggingConnection:(id)arg1 photoLibrary:(id)arg2 graph:(id)arg3 serviceManager:(id)arg4;
+ (id)shareBackSuggesterForSyndicationWithLoggingConnection:(id)arg1 syndicationPhotoLibrary:(id)arg2 systemPhotoLibrary:(id)arg3 graph:(id)arg4 faceIdentification:(id)arg5 serviceManager:(id)arg6;
+ (id)shareBackSuggesterForSyndicationWithLoggingConnection:(id)arg1 syndicationPhotoLibrary:(id)arg2 systemPhotoLibrary:(id)arg3 graph:(id)arg4 serviceManager:(id)arg5;
