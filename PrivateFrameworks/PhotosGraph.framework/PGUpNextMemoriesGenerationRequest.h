...
- (id)localMemoriesByUniqueMemoryIdentifiersWithWorkingContext:(id)arg1;
...
- (id)upNextMemoryLocalIdentifiersWithWorkingContext:(id)arg1 rootMemory:(id)arg2 localMemoriesByUniqueMemoryIdentifiers:(id)arg3 uniqueMemoryIdentifiersOfMemoriesToAvoid:(id)arg4 aggregator:(id)arg5 debugInfo:(out id*)arg6 error:(id*)arg7;
