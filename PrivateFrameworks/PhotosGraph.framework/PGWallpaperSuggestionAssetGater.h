...
@property (nonatomic, readonly) struct { int x1; int x2; int x3; int x4; int x5; int x6; int x7; int x8; int x9; int x10; } currentGatingStatistics;
...
- (void).cxx_destruct;
- (id)_gateAsset:(id)arg1 wallpaperProperties:(id*)arg2 progressBlock:(id /* block */)arg3;
...
- (id)_requestAnalysisTypes:(unsigned long long)arg1 asset:(id)arg2 options:(id)arg3 progressBlock:(id /* block */)arg4 error:(id*)arg5;
- (id)_requestWallpaperPropertiesForAsset:(id)arg1 progressBlock:(id /* block */)arg2 error:(id*)arg3;
- (bool)assetIsUsingHeadroom:(id)arg1;
- (bool)cacheExistsForAsset:(id)arg1;
- (void)clearCacheOfAsset:(id)arg1;
- (bool)coversTracks;
- (struct { int x1; int x2; int x3; int x4; int x5; int x6; int x7; int x8; int x9; int x10; })currentGatingStatistics;
...
- (id)gateAsset:(id)arg1 progressBlock:(id /* block */)arg2;
...
- (id)requestAndPersistWallpaperPropertiesForAsset:(id)arg1 progressBlock:(id /* block */)arg2;
- (id)requestWallpaperPropertiesForAsset:(id)arg1 progressBlock:(id /* block */)arg2 error:(id*)arg3;
