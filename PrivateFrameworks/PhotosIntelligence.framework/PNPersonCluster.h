...
@interface PNPersonCluster : NSObject <PNPersonProtocol> {
    ...
    <PNFaceGroupProtocol> * _sourceFaceGroup;
    <PNPersonProtocol> * _sourcePerson;
...
@property (nonatomic) <PNPhotoLibraryProtocol> *photoLibrary;
@property (nonatomic) bool quarantined;
@property (nonatomic, retain) NSMutableDictionary *representativeFaceByFaceIdentifiers;
@property (nonatomic, retain) <PNFaceGroupProtocol> *sourceFaceGroup;
@property (nonatomic, retain) <PNPersonProtocol> *sourcePerson;
