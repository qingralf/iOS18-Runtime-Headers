...
+ (bool)_updateAvailableFeatures:(unsigned long long)arg1 forSuggestions:(id)arg2 toClear:(bool)arg3;
...
+ (bool)clearAvailableFeatures:(unsigned long long)arg1 forSuggestions:(id)arg2;
...
+ (id)fetchLivePhotoTabHighlightCandidateAssetsWithOptions:(id)arg1 excludeExistingWallpapers:(bool)arg2 statistics:(struct { int x1; int x2; int x3; int x4; int x5; int x6; }*)arg3;
...
+ (id)randomNumberGeneratorForWallpaperDonationWithDate:(id)arg1;
...
+ (bool)setAvailableFeatures:(unsigned long long)arg1 forSuggestions:(id)arg2;
...
+ (id)wallpaperPeopleLocalIdentifiersInPhotoLibrary:(id)arg1 vipOnly:(bool)arg2;
