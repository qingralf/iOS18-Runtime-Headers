...
@interface ISBasePlayer : ISObservable <ISChangeObserver, ISWrappedAVPlayerDelegate, PXAVResourceReclamationObserver> {
    ...
    struct { 
        bool wrappedVideoPlayerForPlayer; 
        bool playerWillRelinquishVideoPlayer; 
        bool videoPlayerForPlayer; 
    }  _delegateRespondsTo;
    NSError * _error;
    struct { 
        bool videoPlayer; 
...
@property (nonatomic, retain) <PXAVResourceReclamationController> *resourceReclamationController;
...
- (void)setResourceReclamationController:(id)arg1;
