...
@interface ISBasePlayerUIView : UIView <ISBasePlayerOutput, ISChangeObserver, PXAVResourceReclamationObserver> {
...
@property (nonatomic, readonly) bool isVideoReadyForDisplay; /* unknown property attribute: ? */
...
+ (void)_handleAVResourceReclamationEvent:(id)arg1;
