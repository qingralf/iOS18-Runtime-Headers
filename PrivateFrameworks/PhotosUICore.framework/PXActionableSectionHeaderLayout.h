...
@interface PXActionableSectionHeaderLayout : PXGSingleViewLayout <PXActionableSectionHeaderViewDelegate, PXPhotosSectionedLayoutHeader> {
    ...
    <PXActionableSectionHeaderLayoutInteractionDelegate> * _interactionDelegate;
...
@property (nonatomic) <PXActionableSectionHeaderLayoutInteractionDelegate> *interactionDelegate;
@property (nonatomic) bool isInSelectMode;
@property (nonatomic, readonly) bool isTopHeader;
