...
@property (nonatomic, retain) NSNumber *customBackgroundStyle;
...
- (id)createFilterButtonControllerForLayout:(id)arg1;
...
- (id)createTopHeaderLayoutForSectionedLayout:(id)arg1 dataSource:(id)arg2 spec:(id)arg3 outShouldFloat:(bool*)arg4;
...
- (void)setCustomBackgroundStyle:(id)arg1;
