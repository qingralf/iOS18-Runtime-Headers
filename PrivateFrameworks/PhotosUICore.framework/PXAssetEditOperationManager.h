...
- (void)_enumeratePredicateRecordsWithBlock:(id /* block */)arg1;
...
- (id)performEditOperationWithType:(id)arg1 asset:(id)arg2 undoManager:(id)arg3 completionHandler:(id /* block */)arg4;
- (id)performEditOperationWithType:(id)arg1 asset:(id)arg2 undoManager:(id)arg3 delay:(double)arg4 completionHandler:(id /* block */)arg5;
