...
- (id)initWithExtendedTraitCollection:(id)arg1 options:(unsigned long long)arg2 variant:(long long)arg3 allowsBlur:(bool)arg4 itemCornerRadius:(double)arg5 zoomableSpec:(id)arg6;
