...
@property (nonatomic, copy) NSArray *additionalLeftBarButtonItems;
@property (nonatomic, copy) NSArray *additionalRightBarButtonItems;
...
- (bool)_isSpaceItem:(id)arg1;
- (id)_makeFixedInterButtonSpacingBarButtonItem;
- (bool)_needsUpdate;
- (void)_updateBarsIfNeeded;
- (void)_updateDynamicHitTestInsetsForBarWithItems:(id)arg1 placement:(unsigned long long)arg2;
...
- (void)updateBars;
- (void)updateDynamicHitTestInsetsForBarWithItems:(id)arg1 placement:(unsigned long long)arg2 layoutDirection:(long long)arg3 isSpaceItem:(id /* block */)arg4 dynamicHitTestInsetsViewProvider:(id /* block */)arg5;
- (void)updateIfNeeded;
- (id)viewController;
