...
@property (nonatomic) bool disableOneUp;
...
@property (nonatomic, retain) PXPeopleSuggestionsDataSourceManager *peopleSuggestionsPreviewDataSourceManager;
...
- (void)setDisableOneUp:(bool)arg1;
