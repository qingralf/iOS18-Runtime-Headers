...
@property (nonatomic) bool didSetUpNavigationItem;
...
- (id)_shareCMMMenuItemForMomentShareURL:(id)arg1 title:(id)arg2;
...
- (void)setDidSetUpNavigationItem:(bool)arg1;
