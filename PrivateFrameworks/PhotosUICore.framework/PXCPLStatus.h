...
@interface PXCPLStatus : NSObject <NSCopying> {
    NSString * _cloudQuotaCustomActionTitle;
    NSString * _cloudQuotaCustomMessage;
    NSString * _cloudQuotaCustomTitle;
...
@property (nonatomic, copy) NSString *cloudQuotaCustomActionTitle;
@property (nonatomic, copy) NSString *cloudQuotaCustomMessage;
@property (nonatomic, copy) NSString *cloudQuotaCustomTitle;
...
- (id)cloudQuotaCustomActionTitle;
- (id)cloudQuotaCustomMessage;
- (id)cloudQuotaCustomTitle;
...
- (void)setCloudQuotaCustomActionTitle:(id)arg1;
- (void)setCloudQuotaCustomMessage:(id)arg1;
- (void)setCloudQuotaCustomTitle:(id)arg1;
