...
- (void)setShareSheetLinkSpatialImageFileSizeThresholdMB:(unsigned long long)arg1;
- (void)setShareSheetLinkSpatialVideoFileSizeThresholdMB:(unsigned long long)arg1;
...
- (unsigned long long)shareSheetLinkSpatialImageFileSizeThresholdMB;
- (unsigned long long)shareSheetLinkSpatialVideoFileSizeThresholdMB;
