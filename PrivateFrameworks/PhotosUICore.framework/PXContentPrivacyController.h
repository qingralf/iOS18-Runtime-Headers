...
- (id)autolockTimer;
- (unsigned long long)automaticAuthenticationBehavior;
- (unsigned long long)cachedAuthenticationStackCount;
- (void)cancelAuthentication;
- (void)cancelDelayedLockIfNeeded;
- (void)clearAuthenticationStack;
- (void)commonInitWithLogIdentifier:(id)arg1 automaticAuthenticationBehavior:(unsigned long long)arg2;
...
- (id)initWithContentPrivacyEnabledForTesting:(id)arg1 availableAuthenticationTypeForTesting:(id)arg2 assetCollectionToObserveForTesting:(id)arg3 automaticAuthenticationBehaviorForTesting:(unsigned long long)arg4;
...
- (void)setAutomaticAuthenticationBehavior:(unsigned long long)arg1;
