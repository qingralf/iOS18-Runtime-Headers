...
@interface PXContentSyndicationConfigurationProvider : PXObservable <PXCollectionsDataSourceManagerObserver, PXContentSyndicationHighlightCenterObserver, PXSettingsKeyObserver> {
...
+ (void)preloadResourcesForPhotoLibrary:(id)arg1;
+ (id)sharedInstance;
