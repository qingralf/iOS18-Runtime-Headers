...
@property (nonatomic, readonly) NSArray *allPhotosSortDescriptors;
...
@property (nonatomic, readonly) bool enableDays;
...
- (void)setAllPhotosSortDescriptors:(id)arg1;
