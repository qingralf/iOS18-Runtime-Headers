...
@interface PXCuratedLibraryBarsController : PXBarsController <PXActionPerformerDelegate, PXChangeObserver> {
    ...
    <PXBarsControllerDelegate><PXCuratedLibraryBarsControllerDelegate> * delegate;
}
...
@property (nonatomic) <PXBarsControllerDelegate><PXCuratedLibraryBarsControllerDelegate> *delegate;
