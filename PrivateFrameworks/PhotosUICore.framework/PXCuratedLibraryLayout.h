...
@interface PXCuratedLibraryLayout : PXGSplitLayout <PXAssetsDataSourceManagerObserver, PXChangeObserver, PXCuratedLibraryLayoutAssetCollectionReferenceProvider, PXCuratedLibraryViewModelPresenter, PXGAnchorDelegate, PXGCaptureSpriteSource, PXGNamedImageSource, PXGSolidColorSource, PXLibrarySummaryDataSource, PXScrollablePageSource, PXSettingsKeyObserver> {
...
@property (nonatomic, readonly) <PXDisplayAssetCollection> *topMostAssetCollection; /* unknown property attribute: ? */
@property (nonatomic, readonly) PXCuratedLibraryViewModel *viewModel;
@property (nonatomic, readonly) <PXBrowserVisibleContentSnapshot> *visibleContentSnapshot; /* unknown property attribute: ? */
...
- (id)offscreenEffectForCapturedSnapshotAtIndex:(unsigned int)arg1 inLayout:(id)arg2;
...
- (void)update;
- (void)viewEnvironmentWillChange:(id)arg1;
- (id)viewModel;
