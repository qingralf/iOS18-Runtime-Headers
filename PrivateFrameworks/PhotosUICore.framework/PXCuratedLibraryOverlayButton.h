...
@interface PXCuratedLibraryOverlayButton : UIButton <PXDynamicHitTestInsetsView, PXGReusableView, UIPointerInteractionDelegate> {
    NSString * _axLabel;
    struct CGRect { 
        struct CGPoint { 
            double x; 
...
+ (id)defaultTitleFont;
+ (id)iconImageSymbolConfigurationFromConfiguration:(id)arg1;
