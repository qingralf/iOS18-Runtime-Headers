...
@property (nonatomic, copy) NSAttributedString *attributedTitle; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) NSDictionary *defaultAttributes; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) NSDictionary *emphasizedAttributes; /* unknown property attribute: ? */
...
@property (nonatomic, copy) NSString *subtitle; /* unknown property attribute: ? */
...
@property (nonatomic) bool wantsDisclosureIndicator; /* unknown property attribute: ? */
@property (nonatomic, readonly) bool wantsLocationNames; /* unknown property attribute: ? */
