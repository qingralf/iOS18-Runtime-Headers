...
@property (nonatomic) bool canShowEllipsisButton;
...
@property (nonatomic, readonly) UIColor *titleSubtitleColorOverBackground;
...
- (void)setCanShowEllipsisButton:(bool)arg1;
...
- (id)titleSubtitleColorOverBackground;
