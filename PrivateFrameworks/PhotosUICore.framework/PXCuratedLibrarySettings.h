...
- (bool)allowsModularLayoutForZoomLevel:(long long)arg1 sizeClass:(long long)arg2 orientation:(long long)arg3 layoutStyle:(unsigned long long)arg4;
...
- (void)setBlurredBackgroundFadeDuration:(double)arg1;
- (void)setBlurredBackgroundFinalOpacity:(double)arg1;
- (void)setBlurredBackgroundInitialOpacity:(double)arg1;
- (void)setBlurredBackgroundInitialOpacityMac:(double)arg1;
- (void)setBlurredBackgroundRadius:(double)arg1;
- (void)setBottomCenterSecondaryToolbarWidth:(double)arg1;
- (void)setCornerRadiusForDays:(double)arg1;
- (void)setCornerRadiusForMonths:(double)arg1;
- (void)setCornerRadiusForYears:(double)arg1;
...
- (void)setExternalSecondaryToolbarHeight:(double)arg1;
...
- (void)setLateralMarginDays:(double)arg1;
- (void)setLateralMarginMonths:(double)arg1;
- (void)setLateralMarginYears:(double)arg1;
