...
@interface PXDisplayAssetContentView : UIView <PXChangeObserver, PXReusableObject> {
    ...
    <PXDisplayAssetContentViewDelegate> * _delegate;
    bool  _disableImageRequestsOnResize;
    ...
    bool  _toneMapVideoToStandardDynamicRange;
    struct { 
...
@property (nonatomic) <PXDisplayAssetContentViewDelegate> *delegate;
...
@property (nonatomic, retain) PXDisplayScreenDynamicRangeMonitor *screenDynamicRangeMonitor;
...
- (long long)effectivePreferredImageDynamicRange;
...
- (void)setDisableImageRequestsOnResize:(bool)arg1;
- (void)setEffectivePreferredImageDynamicRange:(long long)arg1;
...
- (void)setScreenDynamicRangeMonitor:(id)arg1;
- (void)setTargetSize:(struct CGSize { double x1; double x2; })arg1;
- (void)setToneMapVideoToStandardDynamicRange:(bool)arg1;
