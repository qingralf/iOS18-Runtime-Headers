...
- (id)processDuplicateActionWithAssets:(id)arg1 assetCollection:(id)arg2 assetsInAssetCollection:(id)arg3;
- (void)processWithAssets:(id)arg1 assetCollection:(id)arg2 canDuplicate:(bool*)arg3 canExtractStill:(bool*)arg4;
