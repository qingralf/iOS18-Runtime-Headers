...
- (struct CGSize { double x1; double x2; })_estimatedSizeForSevenColumnLayoutWithOptions:(unsigned long long)arg1;
...
- (void)_parseSevenColumnHeroRowWithNumberOfItems:(long long)arg1 heroItemType:(long long)arg2 subsequentShortRowItems:(long long)arg3 options:(unsigned long long)arg4;
- (bool)_parseSevenColumnLayoutWithOptions:(unsigned long long)arg1;
- (void)_parseSevenColumnShortRowWithNumberOfItems:(long long)arg1;
...
- (bool)canUseSingleSevenColumnHeroRowForNumberOfRemainingItems:(long long)arg1;
...
- (long long)numberOfItemsInSevenColumnHeroRowForNumberOfRemainingItems:(long long)arg1;
- (long long)numberOfItemsInSevenColumnShortRowForNumberOfRemainingItems:(long long)arg1;
...
- (bool)parseSevenColumnRowWithType:(long long)arg1 numberOfItems:(long long)arg2 options:(unsigned long long)arg3;
- (bool)parseSevenColumnRowWithType:(long long)arg1 numberOfItems:(long long)arg2 subsequentShortRowItems:(long long)arg3 options:(unsigned long long)arg4;
