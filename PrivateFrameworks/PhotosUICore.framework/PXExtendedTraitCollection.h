...
@property (nonatomic, readonly) <PXStoryChromeLayoutSpec> *storyChromeLayoutSpec;
@property (nonatomic, retain) id swift_environmentStorage;
...
- (unsigned long long)curatedLibraryLayoutStyle;
- (void)dealloc;
...
- (void)setSwift_environmentStorage:(id)arg1;
- (id)snapshot;
- (id)storyChromeLayoutSpec;
