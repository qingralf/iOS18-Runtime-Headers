...
@property (getter=isCachingEnabled, nonatomic, readonly) bool cachingEnabled;

- (void).cxx_destruct;
- (id)_createImageForKey:(id)arg1 error:(id*)arg2;
- (void)_handleImageCreated:(id)arg1 imageKey:(id)arg2;
- (id)_resizeImageAtURL:(id)arg1 imageUTI:(id)arg2 targetSize:(struct CGSize { double x1; double x2; })arg3 preferHDR:(bool)arg4 bakeInOrientation:(bool)arg5 error:(id*)arg6;
