...
@property (nonatomic, readonly) unsigned long long selectionDecorationOptions;
@property (nonatomic, readonly) <PXGSelectionDecorationSource> *selectionDecorationSource;
@property (nonatomic, readonly) long long selectionDecorationStyle;
...
- (void)addActiveDecorations:(id)arg1;
...
- (unsigned long long)selectionDecorationOptions;
- (id)selectionDecorationSource;
- (long long)selectionDecorationStyle;
