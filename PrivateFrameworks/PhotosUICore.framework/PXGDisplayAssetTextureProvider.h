...
- (void)_handlePixelBufferChangedForTextureStreamingSession:(id)arg1 useLowMemoryMode:(bool)arg2;
...
- (void)_workQueue_provideVideoFrameForTextureStreamingSession:(id)arg1 useLowMemoryMode:(bool)arg2;
- (struct __CVBuffer { }*)_workQueue_renderCrossfadeIfNeededWithPixelBuffer:(struct __CVBuffer { }*)arg1 forVideoSession:(id)arg2 textureRequestID:(id)arg3 useLowMemoryMode:(bool)arg4;
- (void)_workQueue_requestVideoTexturesForSpriteAtIndex:(unsigned int)arg1 spriteReference:(id)arg2 displayAsset:(id)arg3 presentationController:(id)arg4 adjustment:(id)arg5 presentationType:(unsigned char)arg6 textureRequestID:(int)arg7 mediaProvider:(id)arg8 pixelBufferSourcesProvider:(id)arg9 useLowMemoryMode:(bool)arg10;
- (void)_workQueue_startRequestingVideoTexturesForDisplayAsset:(id)arg1 presentationController:(id)arg2 pixelBufferSource:(id)arg3 pixelBufferSourcesProvider:(id)arg4 adjustment:(id)arg5 textureRequestID:(int)arg6 useLowMemoryMode:(bool)arg7;
