...
@interface PXGEngine : NSObject <PXChangeObserver, PXGLayoutUpdateDelegate, PXGRendererDelegate, PXGTextureManagerDelegate, PXScrollControllerUpdateDelegate> {
    ...
    bool  _scrollStateIncludesScrollEvent;
    PXScrollViewController * _scrollViewController;
    PXScrollViewSpeedometer * _scrollViewSpeedometer;
    bool  _shouldReleaseResourcesWhenInvisible;
...
@property (nonatomic, readonly) PXGOverlayTextureManager *overlayTextureManager;
...
@property (nonatomic, retain) <PXScrollController> *scrollController;
...
- (id)_createDisplayLinkWithScreen:(id)arg1;
...
- (id)_mergeTexturesByPresentationType:(id)arg1 withOverlayTexturesByPresentationType:(id)arg2;
- (void)_notifyContentLoadedObserversIfNeeded;
- (void)_performOnLayoutQueue:(id /* block */)arg1;
- (void)_performRender;
- (void)_propagateTextureConverters;
- (void)_recursiveUpdateDetected;
- (void)_releaseResources;
- (id)_rendererForPresentationType:(unsigned char)arg1;
...
- (void)_windowSceneDidBeginLiveResize:(id)arg1;
- (void)_windowSceneDidEndLiveResize:(id)arg1;
...
- (id)initWithPixelBufferDestination:(id)arg1 layoutQueue:(id)arg2 displayLinkClass:(Class)arg3;
...
- (id)overlayTextureManager;
- (id)pendingContentLoadedNotificationBlocks;
- (id)ppt_animator;
- (void)px_scrollControllerDidScroll:(id)arg1;
...
- (void)setDidChangeWindow:(bool)arg1;
...
- (void)setScrollStateIncludesScrollEvent:(bool)arg1;
...
- (id)textureManager;
- (id)textureManager:(id)arg1 requestRenderSnapshot:(struct { unsigned char x1; struct CGRect { struct CGPoint { double x_1_2_1; double x_1_2_2; } x_2_1_1; struct CGSize { double x_2_2_1; double x_2_2_2; } x_2_1_2; } x2; })arg2 offscreenEffect:(id)arg3;
- (bool)textureManagerCanBlockMainThreadIfNeeded:(id)arg1;
