...
@interface PXGLayout : NSObject <PXGAXGroupSource, PXGAXInfoSource, PXGAXResponder, PXGDataSourceDrivenLayout, PXGDiagnosticsProvider, PXGSpriteIndexReferencing> {
    ...
    bool  _disableDebugAssertionForSublayoutUpdates;
...
@property (nonatomic, readonly) NSIndexSet *axBorderSpriteIndexes;
...
@property (nonatomic, readonly) bool disableDebugAssertionForSublayoutUpdates;
...
@property (nonatomic, readonly) PXGSpriteDataStore *modifiedSpriteDataStore;
...
@property (nonatomic, copy) PXGLayoutSpriteModifier *spriteModifier;
...
- (void)enumerateSublayoutsForCreatingPointReferenceUsingBlock:(id /* block */)arg1;
...
- (void)setDisplayMaximumHeadroom:(double)arg1;
...
- (void)setSpriteModifier:(id)arg1;
