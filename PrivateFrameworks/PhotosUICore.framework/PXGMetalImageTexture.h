...
- (id)init;
- (id)initWithTexture:(void *)arg1 chromaTexture:(void *)arg2 colorProgram:(void *)arg3 isOpaque:(void *)arg4 shaderFlags:(void *)arg5 orientationTransform:(void *)arg6 alpha:(void *)arg7 presentationType:(void *)arg8; // needs 8 arg types, found 7: id, id, id, bool, int, float, unsigned char
- (id)initWithTexture:(void *)arg1 colorProgram:(void *)arg2 isOpaque:(void *)arg3 shaderFlags:(void *)arg4 orientationTransform:(void *)arg5 alpha:(void *)arg6 presentationType:(void *)arg7; // needs 7 arg types, found 6: id, id, bool, int, float, unsigned char
- (bool)isAtlas;
