...
@interface PXGMetalRenderer : NSObject <PXGEffectComponentDelegate, PXGMetalRenderDestinationDelegate, PXGMetalTextureConverterDelegate, PXGRenderer> {
    ...
    <PXGMetalRenderState> * _lastFrameRenderState;
...
@property (nonatomic, retain) PXGTungstenRecordingSession *recordingSession;
@property (nonatomic, readonly) <PXGMetalRenderDestination> *renderDestination;
@property (nonatomic, readonly) struct CGPoint { double x1; double x2; } renderOrigin;
@property (nonatomic, retain) PXScrollViewController *scrollViewController; /* unknown property attribute: ? */
@property (readonly) Class superclass;
@property (nonatomic, copy) id /* block */ test_renderSnapshotHandler; /* unknown property attribute: ? */
...
+ (void)_configureUniformGeometries:(struct { struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x_1_1_1[4]; } x1; struct { void*x_2_1_1[4]; } x2; float x3; }*)arg1 renderRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 drawingScale:(double)arg3 renderOrigin:(struct CGPoint { double x1; double x2; })arg4;
...
- (long long)_drawRenderTexture:(struct { id x1; id x2; struct _NSRange { unsigned long long x_3_1_1; unsigned long long x_3_1_2; } x3; float x4; int x5; unsigned char x6; bool x7; bool x8; bool x9; }*)arg1 forRenderPass:(id)arg2 withCommandEncoder:(id)arg3;
- (long long)_drawSpritesWithRenderPass:(id)arg1 renderState:(id)arg2 commandEncoder:(id)arg3 passingTest:(id /* block */)arg4;
...
- (void)_parseAndSortRenderTextures:(id)arg1 willPerformOffscreenPass:(bool)arg2;
- (struct { int x1; unsigned long long x2; id x3; id x4; id x5; bool x6; })_pipelineForRenderTexture:(const struct { id x1; id x2; struct _NSRange { unsigned long long x_3_1_1; unsigned long long x_3_1_2; } x3; float x4; int x5; unsigned char x6; bool x7; bool x8; bool x9; }*)arg1 colorPixelFormat:(unsigned long long)arg2 waitForCompilation:(bool)arg3;
...
- (void)_prepare;
- (void)_renderToCommandBuffer:(id)arg1 renderState:(id)arg2 renderPassDescriptor:(id)arg3 withCompletionCompletion:(id /* block */)arg4;
- (void)_renderToMainDestination:(id)arg1 withCompletionCompletion:(id /* block */)arg2;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })converRectToRenderCoordinates:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
- (void)dealloc;
- (id)delegate;
...
- (id)renderSnapshotForRequest:(struct { unsigned char x1; struct CGRect { struct CGPoint { double x_1_2_1; double x_1_2_2; } x_2_1_1; struct CGSize { double x_2_2_1; double x_2_2_2; } x_2_1_2; } x2; })arg1 offscreenEffect:(id)arg2;
