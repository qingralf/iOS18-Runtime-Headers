...
@property (nonatomic, readonly) bool supportsMipmaps;
...
- (id)createTextureFromCGImage:(void *)arg1 transform:(void *)arg2 alpha:(void *)arg3 options:(void *)arg4 error:(void *)arg5; // needs 5 arg types, found 4: struct CGImage { }*, float, struct { unsigned int x1; bool x2; }, id*
...
- (id)init;
- (id)initWithContext:(id)arg1 presentationType:(unsigned char)arg2 destinationColorspaceName:(unsigned long long)arg3 layoutQueue:(id)arg4;
- (id)layoutQueue;
- (bool)lowMemoryMode;
