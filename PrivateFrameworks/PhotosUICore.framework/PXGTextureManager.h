...
@interface PXGTextureManager : NSObject <PXGTextureAtlasManagerDelegate, PXGTextureProviderDelegate> {
    ...
    struct { struct { unsigned int x_1_1_1; } x1; int x2; unsigned char x3; unsigned char x4; unsigned short x5; void *x6; unsigned int x7; void *x8; unsigned int x9; unsigned int x10; unsigned char x11; bool x12; } * _streamInfoBySpriteIndex;
...
- (void)dealloc;
- (unsigned long long)deferModifiedTextureRequestsDuringViewResizing;
- (id)delegate;
- (id)description;
- (id)entityManager;
...
- (void)setDeferModifiedTextureRequestsDuringViewResizing:(unsigned long long)arg1;
...
- (id)textureProvider:(id)arg1 requestRenderSnapshot:(struct { unsigned char x1; struct CGRect { struct CGPoint { double x_1_2_1; double x_1_2_2; } x_2_1_1; struct CGSize { double x_2_2_1; double x_2_2_2; } x_2_1_2; } x2; })arg2 offscreenEffect:(id)arg3;
