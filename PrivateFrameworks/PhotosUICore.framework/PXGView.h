...
@interface PXGView : UIView <PXDebugHierarchyProvider, PXDiagnosticsEnvironment, PXGAXResponder, PXGDiagnosticsProvider, PXGEngineDelegate, PXGHitTestEnvironment, PXGLayoutFocusDelegate, PXGLayoutScrollDelegate, PXGLayoutViewDelegate, PXScrollViewControllerObserver, PXTapToRadarDiagnosticProvider, UIGestureRecognizerDelegate> {
    ...
    bool  _canBlockMainThreadIfNeeded;
...
@property (nonatomic, readonly) struct { bool x1; unsigned long long x2; unsigned long long x3; } displayConfiguration;
@property (nonatomic, readonly) float displayScaleMultiplier;
@property (nonatomic) bool enableUnderlaySupport;
@property (nonatomic, readonly) PXGEngine *engine;
@property (nonatomic, readonly) UIView *entityHostingView;
...
@property (nonatomic) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } minimumSafeAreaInsets;
...
- (struct { bool x1; unsigned long long x2; unsigned long long x3; })displayConfiguration;
...
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 allowedPresentationTypes:(id)arg2 displayConfiguration:(struct { bool x1; unsigned long long x2; unsigned long long x3; })arg3;
...
- (id)metalRenderer;
- (id)metalView;
- (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })minimumSafeAreaInsets;
...
- (void)setCanBlockMainThreadIfNeeded:(bool)arg1;
...
- (void)setEnableUnderlaySupport:(bool)arg1;
- (void)setFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
- (void)setHidden:(bool)arg1;
- (void)setIsAccessibilityEnabled:(bool)arg1;
- (void)setIsAnimatingScrollTowardsEdge:(bool)arg1;
- (void)setIsBeingFullPageSnapshotted:(bool)arg1;
- (void)setIsFocusFastScrolling:(bool)arg1;
- (void)setIsSceneBackgrounded:(bool)arg1;
- (void)setIsSceneResumingFromBackground:(bool)arg1;
- (void)setIsScrolling:(bool)arg1;
- (void)setLowMemoryModeEnabled:(bool)arg1;
- (void)setManagesScrollableAxisExternally:(bool)arg1;
- (void)setMinimumSafeAreaInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg1;
...
- (void)setShouldReleaseResourcesWhenInvisible:(bool)arg1;
