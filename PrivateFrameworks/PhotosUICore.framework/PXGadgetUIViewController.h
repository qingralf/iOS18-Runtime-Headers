...
@interface PXGadgetUIViewController : UICollectionViewController <PXChangeObserver, PXGadgetCollectionViewLayoutDelegate, PXGadgetDelegate, PXSectionedDataSourceManagerObserver, PXSplitViewControllerChangeObserver, UICollectionViewDataSourcePrefetching, UICollectionViewDelegateFlowLayout, UICollectionViewDropDelegate, UIContextMenuInteractionDelegate> {
