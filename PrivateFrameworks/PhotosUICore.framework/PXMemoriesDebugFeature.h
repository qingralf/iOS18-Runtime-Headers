...
@property (nonatomic, readonly) NSString *featureLocalizedTitle; /* unknown property attribute: ? */
@property (nonatomic, readonly) NSArray *featurePeople; /* unknown property attribute: ? */
@property (nonatomic, readonly) double featureScore; /* unknown property attribute: ? */
@property (nonatomic, readonly) UIColor *featureSelectedTintColor; /* unknown property attribute: ? */
@property (nonatomic, readonly) UIColor *featureTintColor; /* unknown property attribute: ? */
