...
@interface PXOneUpPresentation : PXObservable <UIContextMenuInteractionDelegate> {
    ...
    long long  _state;
    <PXOneUpPresentationDelegate> * _strongDelegate;
}
...
@property (nonatomic, retain) <PXOneUpPresentationDelegate> *strongDelegate;
...
- (id)presentingScrollViewForAssetReference:(id)arg1;
...
- (id)strongDelegate;
- (void)waitForTransitionToFinishWithTimeout:(double)arg1 completionHandler:(id /* block */)arg2;
