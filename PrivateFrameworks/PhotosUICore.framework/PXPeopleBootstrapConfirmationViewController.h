...
@interface PXPeopleBootstrapConfirmationViewController : UICollectionViewController <PXPeopleFlowViewController, PXPeopleSuggestionManagerDelegate, UIContextMenuInteractionDelegate> {
...
@property (nonatomic) <PXPeopleFlowViewControllerActionDelegate> *actionDelegate; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) struct CGSize { double x1; double x2; } preferredSize; /* unknown property attribute: ? */
@property (nonatomic, readonly) NSArray *presentationStatuses;
@property (nonatomic, readonly) bool shouldConfirmAdvancement; /* unknown property attribute: ? */
...
- (id)_keyAssetForPersonAtIndex:(long long)arg1;
- (void)_markSkippedSuggestions;
- (void)_noSuggestionsFound;
- (id)_sortedIndexPathsForVisibleCells;
- (void)_startLoadingTimer;
- (id)_titleForHeaderView;
- (id)_titleForPreviewForAsset:(id)arg1;
- (void)_toggleConfirmedForCollectionViewCellAtIndexPath:(id)arg1;
...
- (void)setHasSelectionEverChanged:(bool)arg1;
