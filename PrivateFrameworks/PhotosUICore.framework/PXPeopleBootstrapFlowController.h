...
@property (nonatomic, readonly) UIBarButtonItem *leftBarButton; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) bool wantsCancelButton; /* unknown property attribute: ? */
...
- (bool)shouldPresentConfirmationForPerson:(id)arg1;
