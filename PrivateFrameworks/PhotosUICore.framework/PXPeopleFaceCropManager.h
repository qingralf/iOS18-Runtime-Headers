...
+ (id)_fetchQueue;
+ (bool)_isFinalForIsDegraded:(bool)arg1 isCropped:(bool)arg2;
+ (bool)_shouldCacheResultForOptions:(id)arg1 isDegraded:(bool)arg2 isCropped:(bool)arg3 isForCleanup:(bool)arg4;
