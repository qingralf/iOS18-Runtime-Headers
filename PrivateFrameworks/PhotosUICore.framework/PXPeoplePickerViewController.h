...
- (id)initWithPersonIdentifiers:(id)arg1 selectedLocalIdentifiers:(id)arg2 disabledLocalIdentifiers:(id)arg3 compactMode:(bool)arg4 transparentBackground:(bool)arg5 prompt:(id)arg6 selectionCoordinator:(id)arg7 library:(id)arg8 wantsPets:(bool)arg9;
- (id)library;
