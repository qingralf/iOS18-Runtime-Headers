...
@interface PXPhotoKitAssetsDataSourceManager : PXAssetsDataSourceManager <PXChangeObserver, PXMutableAssetsDataSourceManager, PXPhotosDataSourceChangeObserver> {
    ...
    NSObject<OS_dispatch_queue> * __utilityWorkQueue;
...
@property (nonatomic, retain) NSObject<OS_dispatch_queue> *_utilityWorkQueue;
...
+ (bool)_includeUnsavedSyndicatedAssetsForAssetCollection:(id)arg1 photoLibrary:(id)arg2;
+ (id)dataSourceManagerForAssetCollection:(id)arg1;
+ (id)dataSourceManagerForAssetCollection:(id)arg1 configuration:(id)arg2;
+ (id)dataSourceManagerForAssetCollection:(id)arg1 existingAssetsFetchResult:(id)arg2;
...
- (void).cxx_destruct;
- (id)_createAssetsDataSourceWithPhotosDataSource:(id)arg1 withChangeDetails:(id)arg2;
...
- (void)_markSharedAlbumAsViewed:(id)arg1;
- (void)_setLoadingInitialPhotosDataSource:(bool)arg1;
- (id)_utilityWorkQueue;
...
- (void)setPhotosDataSource:(id)arg1 changeDetails:(id)arg2;
...
- (void)set_utilityWorkQueue:(id)arg1;
...
- (void)updateWithPhotosDataSource:(id)arg1 sectionedDataSourceChangeDetails:(id)arg2;
