...
@property (nonatomic, copy) NSString *doneLabel;
...
+ (id)recipientPickerViewControllerWithTitle:(id)arg1 doneLabel:(id)arg2 toLabel:(id)arg3 usedAddresses:(id)arg4 maxRecipients:(long long)arg5 delegate:(id)arg6;
