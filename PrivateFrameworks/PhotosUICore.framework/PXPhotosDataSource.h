...
@property (nonatomic, readonly) id /* block */ assetContainerProvider;
...
@property (nonatomic, readonly) PHFetchResult *emptyAssetsFetchResult;
...
@property (nonatomic, readonly) PHSocialGroup *filterSocialGroup;
...
- (void)_adoptExistingAssetCollectionFetchResults:(id)arg1;
...
- (id)_assetContainerForAssetCollection:(id)arg1;
...
- (void)_commonInit;
- (id)_createDataSourceWithAssetsCollections:(id)arg1 existingAssetCollectionFetchResults:(id)arg2;
...
- (id)_fetcherConfigurationForAssetCollection:(id)arg1 useCase:(long long)arg2 isLimitedInitialFetch:(bool)arg3;
...
- (bool)_isFiltering;
- (bool)_isResultTupleApplicable:(id)arg1 forAssetCollection:(id)arg2;
...
- (id)createDataSourceWithAssetsInSectionOfAsset:(id)arg1 usingNewTransientAssetCollection:(bool)arg2;
...
- (bool)isEmpty;
- (bool)isImmutable;
- (bool)isSectionConsideredAccurate:(long long)arg1;
