...
@interface PXPhotosDetailsContext : PXObservable <PXChangeObserver, PXMutablePhotosDetailsContext, PXPhotosDataSourceChangeObserver> {
...
@property (nonatomic, readonly) PHAssetCollection *containingAlbum;
