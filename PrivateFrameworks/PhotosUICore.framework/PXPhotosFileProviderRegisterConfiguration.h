...
@interface PXPhotosFileProviderRegisterConfiguration : NSObject {
    ...
    union { in /* Warning: Unrecognized filer type: 'u' using 'void*' */ void*x1; long x2; long x3; }  mailMovieExportContentType;
    void shouldIncludeCaption;
    void shouldIncludeLocation;
    union { in /* Warning: Unrecognized filer type: 'u' using 'void*' */ void*x1; long x2; long x3; }  thumbnailLowContentType;
    union { in /* Warning: Unrecognized filer type: 'u' using 'void*' */ void*x1; long x2; long x3; }  thumbnailStandardContentType;
    void usage;
