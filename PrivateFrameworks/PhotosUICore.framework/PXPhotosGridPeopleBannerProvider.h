...
@property (nonatomic, readonly) bool namingSuggestionsOnly;
...
- (void).cxx_destruct;
- (void)_addLoadCompletionBlock:(id /* block */)arg1;
...
- (void)_dismissBannerNotifyDelegate:(bool)arg1;
- (id)_fetchAutonamingSuggestion;
- (void)_finishLoadWithGeneration:(unsigned long long)arg1 bannerView:(id)arg2;
...
- (id)initWithPerson:(id)arg1 namingSuggestionsOnly:(bool)arg2;
