...
@interface PXPhotosGridSettings : PXSettings {
    ...
    long long  _searchActionLocationOnPhone;
    double  _sectionHeaderGradientAlpha;
    double  _sectionHeaderGradientOverhang;
    bool  _shouldCurateEditorialLens;
    bool  _showCollectionKindInPreviewHeaderToggleAction;
    bool  _showLivePhotoFilter;
    bool  _showPortraitFilter;
...
- (long long)searchActionLocationOnPhone;
...
- (void)setEnablePreviewKeyAssetFetching:(bool)arg1;
...
- (void)setEnableStacksReviewUI:(bool)arg1;
...
- (void)setExposeMoviePresentationAction:(bool)arg1;
- (void)setForceFooterVisible:(bool)arg1;
...
- (void)setSearchActionLocationOnPhone:(long long)arg1;
...
- (void)setShowCollectionKindInPreviewHeaderToggleAction:(bool)arg1;
- (void)setShowLivePhotoFilter:(bool)arg1;
- (void)setShowPortraitFilter:(bool)arg1;
- (void)setSimulatedLoadDelay:(double)arg1;
