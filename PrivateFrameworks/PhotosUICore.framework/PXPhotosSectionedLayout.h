...
@interface PXPhotosSectionedLayout : PXGStackLayout <PXAssetsSectionLayoutDelegate, PXBlurrableSectionsSource, PXChangeObserver, PXGCaptureSpriteSource, PXGSublayoutFaultingDelegate, PXGSublayoutProvider, PXPhotosSectionBodyLayoutProviderInvalidationDelegate, PXPhotosSectionHeaderLayoutProviderInvalidationDelegate> {
