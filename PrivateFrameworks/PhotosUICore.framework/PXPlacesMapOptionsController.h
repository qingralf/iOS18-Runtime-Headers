...
- (id)init;
- (id)initWithMapModeController:(id)arg1 mapFetchResultController:(id)arg2 locationAuthorizationMonitor:(id)arg3;
- (void)mapOptionsViewDidTapMapModeSettingsButton:(id)arg1;
- (void)mapOptionsViewDidTapPerspectiveButton:(id)arg1;
