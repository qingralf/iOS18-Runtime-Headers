...
- (id)init;
- (id)initWithTraitCollection:(id)arg1 informationDelegate:(id)arg2 popoverImageType:(long long)arg3 popoverImageOptions:(unsigned long long)arg4 countLabelStyle:(long long)arg5 thumbnailCurationDelegate:(id)arg6;
