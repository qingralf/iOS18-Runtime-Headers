...
+ (id)_hashStringForBoundingRegion:(struct { struct CLLocationCoordinate2D { double x_1_1_1; double x_1_1_2; } x1; struct { double x_2_1_1; double x_2_1_2; } x2; })arg1 size:(struct CGSize { double x1; double x2; })arg2 interfaceStyle:(long long)arg3;
...
- (void)_fetchDiskOrMemoryPlacesThumbnailForHashString:(id)arg1 completion:(id /* block */)arg2;
- (void)_fetchDiskOrMemoryPlacesThumbnailForHashString:(id)arg1 synchronous:(bool)arg2 completion:(id /* block */)arg3;
...
- (id)cache;
- (void)cachePlacesThumbnailForBoundingRegion:(struct { struct CLLocationCoordinate2D { double x_1_1_1; double x_1_1_2; } x1; struct { double x_2_1_1; double x_2_1_2; } x2; })arg1 size:(struct CGSize { double x1; double x2; })arg2 snapshot:(id)arg3 interfaceStyle:(long long)arg4;
- (id)diskTimer;
...
- (id)fetchPlacesThumbnailForBoundingRegion:(struct { struct CLLocationCoordinate2D { double x_1_1_1; double x_1_1_2; } x1; struct { double x_2_1_1; double x_2_1_2; } x2; })arg1 size:(struct CGSize { double x1; double x2; })arg2 interfaceStyle:(long long)arg3;
