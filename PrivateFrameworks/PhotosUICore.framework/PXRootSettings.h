...
@interface PXRootSettings : PXSettings {
    ...
    PXMacSyncedAlbumsSettings * _macSyncedAlbumsSettings;
...
@property (nonatomic, retain) PXAssetsRecoverySettings *assetsRecoverySettings;
...
@property (nonatomic, retain) PXPhotosDetailsNavigationSettings *detailsNavigationSettings;
...
@property (nonatomic, retain) PXGenerativeStorySettings *generativeStorySettings;
...
@property (nonatomic, retain) PXLemonadeSettings *lemonadeSettings;
@property (nonatomic, retain) PXMacSyncedAlbumsSettings *macSyncedAlbumsSettings;
...
@property (nonatomic, retain) PXSharedAlbumsSettings *sharedAlbumsSettings;
...
- (void)setAssetsRecoverySettings:(id)arg1;
...
- (void)setDetailsNavigationSettings:(id)arg1;
...
- (void)setGenerativeStorySettings:(id)arg1;
...
- (void)setKit:(id)arg1;
- (void)setLemonadeSettings:(id)arg1;
- (void)setMacSyncedAlbumsSettings:(id)arg1;
...
- (void)setSharedAlbumsSettings:(id)arg1;
