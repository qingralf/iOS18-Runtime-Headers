...
@interface PXSearchResultsSectionedDataSource : NSObject <PXSearchResultsValueDelegate, PXSearchTopAssetsResultChangeDelegate> {
    ...
    <PXSearchResultsSectionedDataSourceChangeObserver> * _changeObserver;
...
@property (nonatomic) <PXSearchResultsSectionedDataSourceChangeObserver> *changeObserver;
...
- (void)_inqBackgroundProcessAssetResults:(id)arg1 assetResultsForCompletions:(id)arg2 collectionResults:(id)arg3 topAssetsResult:(id)arg4 topCollectionResults:(id)arg5 withTag:(unsigned long long)arg6 searchString:(id)arg7 representedObjects:(id)arg8 maxSuggestionCount:(unsigned long long)arg9 priorityAssetUUID:(id)arg10;
- (void)_inqCancel;
...
- (void)setSearchString:(id)arg1 representedObjects:(id)arg2 maxSuggestionCount:(unsigned long long)arg3 priorityAssetUUID:(id)arg4 libraryScope:(unsigned long long)arg5;
