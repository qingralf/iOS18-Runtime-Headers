...
- (id)init;
- (id)initWithAssetCollectionBySection:(id)arg1 assetsBySection:(id)arg2 curatedAssetsBySection:(id)arg3 keyAssetsBySection:(id)arg4 sectionContent:(long long)arg5;
