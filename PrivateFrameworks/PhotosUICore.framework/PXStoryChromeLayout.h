...
@interface PXStoryChromeLayout : PXGAbsoluteCompositeLayout <PXChangeObserver, PXGNamedImageSource, PXGStringSource, PXGViewSource> {
...
- (id)_configurationForLargeButtonWithAction:(SEL)arg1 systemImageName:(id)arg2 backgroundStyle:(long long)arg3 axLabelKey:(id)arg4;
...
- (void)_handleBrowserAddPhotosButton:(id)arg1;
- (void)_handleBrowserGridButton:(id)arg1;
- (void)_handleBrowserSelectButton:(id)arg1;
...
- (void)_handleFeedbackButton:(id)arg1;
