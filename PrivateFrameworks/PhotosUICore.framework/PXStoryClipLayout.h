...
@interface PXStoryClipLayout : PXGLayout <PXChangeObserver, PXGDisplayAssetSource, PXGSolidColorSource, PXGStringSource, PXStoryDiagnosticHUDContentProvider, PXStoryTitleInternationalStylePreferencesObserver> {
    ...
    <PXGDisplayAssetAdjustment> * _inactiveImageFilterAdjustment;
...
@property (nonatomic, retain) <PXGDisplayAssetAdjustment> *inactiveImageFilterAdjustment;
...
- (id)inactiveImageFilterAdjustment;
- (id)init;
...
- (void)setInactiveImageFilterAdjustment:(id)arg1;
