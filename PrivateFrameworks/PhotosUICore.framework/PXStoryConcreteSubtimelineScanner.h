...
- (void).cxx_destruct;
- (void)_addTitles:(unsigned long long)arg1 toTimeline:(id)arg2;
...
- (void)dealloc;
- (void)enumeratePossibleNextSubtimelinesAfterTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg1 loggingOptions:(unsigned long long)arg2 usingBlock:(id /* block */)arg3;
- (id)init;
...
- (bool)scanBestSubtimelineFollowingTimeline:(id)arg1 loggingOptions:(unsigned long long)arg2 resultHandler:(id /* block */)arg3;
