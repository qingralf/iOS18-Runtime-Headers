...
@interface PXStoryModel : PXObservable <PXChangeObserver, PXStoryDiagnosticHUDContentProviderSource, PXStoryMutableModel, PXStoryQueueParticipant, PXTapToRadarDiagnosticProvider> {
    ...
    bool  _shouldPauseTransitions;
    bool  _shouldUseInactiveImageFilter;
...
@property (nonatomic, readonly) double inactiveImageFilterIntensity;
...
@property (nonatomic, retain) NSDate *persistenceConfirmationPresentationDate;
...
@property (nonatomic, readonly) PXDisplayRect *presentedSubtitleFrame;
@property (nonatomic, readonly) PXDisplayRect *presentedTitleFrame;
...
@property (nonatomic, readonly) bool shouldPauseTransitions;
@property (nonatomic, readonly) bool shouldUseInactiveImageFilter;
...
@property (nonatomic, copy) NSString *windowSceneID;
...
- (id)persistenceConfirmationPresentationDate;
- (long long)persistencePermission;
- (id)photoKitAssetContainerWithAssetCollection:(id)arg1;
...
- (void)setInactiveImageFilterIntensity:(double)arg1;
...
- (void)setPersistenceConfirmationPresentationDate:(id)arg1;
...
- (void)setShouldPauseTransitions:(bool)arg1;
