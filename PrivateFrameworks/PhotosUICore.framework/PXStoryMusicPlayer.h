...
@interface PXStoryMusicPlayer : PXObservable <PXAudioPlayerDelegate, PXChangeObserver, PXMutableStoryMusicPlayer, PXSettingsKeyObserver, PXStoryDiagnosticHUDContentProvider, PXStoryPacingCueSource, PXStoryQueueParticipant> {
    ...
    bool  _targetDurationMatchesTimeline;
...
@property (nonatomic, readonly) bool targetDurationMatchesTimeline;
...
- (id)initWithModel:(id)arg1 targetDurationMatchesTimeline:(bool)arg2;
