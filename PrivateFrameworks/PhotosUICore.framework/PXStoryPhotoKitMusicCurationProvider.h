...
- (void).cxx_destruct;
- (id)_cachedResultForAssetContainer:(id)arg1 options:(id)arg2;
- (void)_handleMusicCurationResult:(id)arg1 forAssetContainer:(id)arg2 options:(id)arg3;
- (id)_performRequestForAssetContainer:(id)arg1 options:(id)arg2 resultHandler:(id /* block */)arg3;
- (void)_removeRejectedSong:(id)arg1 fromCachedResultForAssetContainer:(id)arg2;
- (void)_replaceSongWithSong:(id)arg1 inCachedResultForAssetContainer:(id)arg2;
- (void)_saveNegativeFeedbackForSongIdentifier:(id)arg1 assetContainer:(id)arg2;
