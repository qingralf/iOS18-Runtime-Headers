...
@property (nonatomic, readonly) PXStoryAutoEditMomentsProvider *diagnosticsMomentsProvider; /* unknown property attribute: ? */
...
+ (struct { long long x1; long long x2; })audioModeDecisionForAsset:(id)arg1 minimumAudioScore:(float)arg2 playbackStyle:(long long)arg3 movieHighlight:(id)arg4 storyConfiguration:(id)arg5;
...
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })_clipRangeForMoment:(id)arg1 inClips:(id)arg2;
