...
+ (long long)stylePairingFromTitleCategory:(id)arg1 string:(id)arg2 kind:(unsigned long long)arg3 layoutScheme:(long long)arg4;
...
+ (id)titleFontDescriptorForStylePairing:(long long)arg1 kind:(unsigned long long)arg2;
+ (bool)titleShouldBeUppercasedForStylePairing:(long long)arg1 kind:(unsigned long long)arg2;
