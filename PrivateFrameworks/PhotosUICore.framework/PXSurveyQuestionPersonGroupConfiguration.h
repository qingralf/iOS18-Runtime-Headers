...
@property (nonatomic, readonly) NSArray *personGroup;
...
- (id)contentView;
- (id)contentViewForDisplayScale:(double)arg1;
- (id)handlers;
- (id)init;
- (id)initWithTitle:(id)arg1 personGroup:(id)arg2;
- (bool)isStale;
