...
@property (setter=_setScrollInfo:, nonatomic, copy) PXScrollInfo *_scrollInfo;
...
@property (nonatomic) <PXScrollController> *scrollController;
@property (nonatomic) <PXTilingControllerScrollDelegate> *scrollDelegate;
@property (nonatomic, readonly) PXScrollInfo *scrollInfo;
...
- (id)titleSubtitleTileWithIdentifier:(struct PXTileIdentifier { unsigned long long x1; unsigned long long x2[10]; })arg1;
