...
@interface PXVideoSession : PXObservable <AVPlayerItemOutputPullDelegate, ISChangeObserver, ISWrappedAVAudioSessionVolumeObserver, ISWrappedAVPlayerDelegate, PXAVResourceReclamationObserver, PXChangeObserver> {
...
@property (nonatomic, readonly) double desiredPlaybackRate;
...
- (void)_videoQueue_updateTrackGeometryWithPlayerItem:(id)arg1;
...
- (id)init;
- (id)initWithContentProvider:(id)arg1 videoPlayer:(id)arg2 resourceReclamationController:(id)arg3;
- (id)initWithContentProvider:(id)arg1 videoPlayer:(id)arg2 resourceReclamationController:(id)arg3 playerCreationDelay:(double)arg4;
- (bool)isAtBeginning;
- (bool)isAtEnd;
- (bool)isBuffering;
...
- (void)setDesiredPlaybackRate:(double)arg1;
