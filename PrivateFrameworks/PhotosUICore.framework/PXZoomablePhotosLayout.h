...
@interface PXZoomablePhotosLayout : PXGSplitLayout <PXAssetsDataSourceManagerObserver, PXChangeObserver, PXCuratedLibraryBodyLayout, PXGDisplayAssetSource, PXGItemsLayoutDelegate, PXPhotosSectionedLayoutBody, PXZoomableInlineHeadersLayoutGeometrySource, PXZoomablePhotosViewModelGeometryDelegate> {
    ...
    bool  _miniModeIsAnchoringToBottom;
    ...
    bool  _visuallyStableAnchorLastRowFilled;
...
@property (nonatomic, retain) NSArray *miniModeFoldedRows;
@property (nonatomic) bool miniModeIsAnchoringToBottom;
...
- (void)_configureMiniModeSpriteModifierForLayout:(id)arg1;
...
- (bool)_getMiniModeInfo:(out struct { struct CGRect { struct CGPoint { double x_1_2_1; double x_1_2_2; } x_1_1_1; struct CGSize { double x_2_2_1; double x_2_2_2; } x_1_1_2; } x1; struct CGPoint { double x_2_1_1; double x_2_1_2; } x2; double x3; struct _NSRange { unsigned long long x_4_1_1; unsigned long long x_4_1_2; } x4; }*)arg1 forLayout:(id)arg2;
...
- (void)_modifyMiniModeSpritesForLayout:(id)arg1 spriteIndexRange:(struct _PXGSpriteIndexRange { unsigned int x1; unsigned int x2; })arg2 sprites:(struct { unsigned int x1; struct { /* ? */ } *x2; struct { /* ? */ } *x3; struct { /* ? */ } *x4; struct { /* ? */ } *x5; })arg3;
...
- (void)getLastItem:(long long*)arg1 lastColumn:(long long*)arg2 forBodyLayout:(id)arg3;
...
- (void)setMiniModeFoldedRows:(id)arg1;
- (void)setMiniModeIsAnchoringToBottom:(bool)arg1;
- (void)setMiniModeVerticalOffset:(double)arg1;
...
- (bool)wasTracking;
- (void)willUpdate;
- (bool)zoomablePhotosViewModelIsResetToInitialState:(id)arg1;
- (void)zoomablePhotosViewModelResetToInitialState:(id)arg1;
