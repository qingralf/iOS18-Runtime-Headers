...
@property (nonatomic, readonly) double aspectFitItemCornerRadius;
...
@property (nonatomic, readonly) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } miniModeEdgeMargins;
@property (nonatomic, readonly) double miniModeInteritemSpacing;
@property (nonatomic, readonly) double miniModeItemCornerRadius;
...
- (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })miniModeEdgeMargins;
