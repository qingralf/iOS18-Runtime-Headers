...
@interface PXZoomablePhotosViewModel : PXObservable <PXAssetsDataSourceManagerObserver, PXChangeObserver, PXMutableZoomablePhotosViewModel> {
    ...
    <PXZoomablePhotosViewModelGeometryDelegate> * _geometryDelegate;
    ...
    bool  _isDisplayingIndividualItems;
    bool  _isInSelectMode;
    bool  _isInteractiveZooming;
    bool  _isInteractiveZoomingAllowed;
...
@property (nonatomic, readonly) long long defaultColumnIndex;
@property (nonatomic, readonly) struct _NSRange { unsigned long long x1; unsigned long long x2; } denseColumnsIndexRange;
...
@property (nonatomic) <PXZoomablePhotosViewModelGeometryDelegate> *geometryDelegate;
...
@property (nonatomic, readonly) bool isInteractiveZoomingAllowed;
...
@property (nonatomic, readonly) PXAssetReference *miniModeAnchorAssetReference;
@property (nonatomic, readonly) PXZoomablePhotosMiniModeAnimator *miniModeAnimator;
...
@property (nonatomic, readonly) double viewModeInteractionProgress;
...
- (void)dealloc;
- (long long)defaultColumnIndex;
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })denseColumnsIndexRange;
...
- (bool)lowMemoryMode;
- (id)mediaProvider;
- (id)miniModeAnchorAssetReference;
- (id)miniModeAnimator;
...
- (void)setViewModeInteractionProgress:(double)arg1;
