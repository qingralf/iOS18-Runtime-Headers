...
- (void)_sendAnalyticsForCopyActionOnAsset:(id)arg1 copiedCompositionController:(id)arg2 configurationAnalyticsPayload:(id)arg3;
...
- (bool)assetHasCopyableAdjustments:(id)arg1 removeCrop:(bool)arg2;
...
- (void)copyPresetFromAsset:(id)arg1 removeCrop:(bool)arg2;
- (void)copyPresetFromCompositionController:(id)arg1 sourceAsset:(id)arg2 smartCopyEnabled:(bool)arg3;
- (void)copyPresetFromCompositionController:(id)arg1 sourceAsset:(id)arg2 smartCopyEnabled:(bool)arg3 configurationAnalyticsPayload:(id)arg4;
...
- (void)setAudioMixModeOnAssets:(id)arg1 audioMixMode:(id)arg2 async:(bool)arg3 progress:(id)arg4 completion:(id /* block */)arg5;
- (void)setEditActionEventBuilder:(id)arg1;
- (void)setPasteboard:(id)arg1;
- (void)setPlaybackRateOnAssets:(id)arg1 playbackRate:(float)arg2 async:(bool)arg3 progress:(id)arg4 completion:(id /* block */)arg5;
