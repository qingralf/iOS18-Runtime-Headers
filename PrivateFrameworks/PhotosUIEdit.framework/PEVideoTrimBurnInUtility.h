...
+ (id)_fileExtension;
+ (id)_fileType;
+ (id)_renderComposition:(id)arg1 toURL:(id)arg2 completion:(id /* block */)arg3;
+ (id)_renderURLForAssetFilename:(id)arg1 error:(id*)arg2;
+ (id)_trimOnlyCompositionControllerFor:(id)arg1;
+ (id)burnInTrimToNewAsset:(id)arg1 compositionController:(id)arg2 asShotCompositionController:(id)arg3 cinematographyScript:(id)arg4 queue:(id)arg5 completion:(id /* block */)arg6;
