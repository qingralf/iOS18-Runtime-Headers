...
- (void).cxx_destruct;
- (void)_configureDisplayLink:(id)arg1;
- (id)_createDisplayLinkDeferredStart:(bool)arg1;
...
- (void)advanceAnimationsToFractionComplete:(double)arg1;
...
- (void)performChangesUsingDefaultOpacityAnimation:(id /* block */)arg1;
...
- (void)setPrepareForAnimation:(bool)arg1;
- (void)setValue:(double)arg1;
- (void)setValue:(double)arg1 animateImmediately:(bool)arg2;
