...
@interface PXRegionOfInterest : PXDisplayRect {
    ...
    <PXRegionOfInterestImage> * _imageRequester;
...
@property (nonatomic, copy) NSArray *containingScrollViews;
...
@property (nonatomic, retain) <PXRegionOfInterestImage> *imageRequester;
...
- (id)copyWithRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 inCoordinateSpace:(id)arg2;
...
- (void)setContainingScrollViews:(id)arg1;
