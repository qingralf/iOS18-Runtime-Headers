...
- (id)init;
- (id)initWithSectionObject:(id)arg1 itemObject:(id)arg2 subitemObject:(id)arg3 indexPath:(struct PXSimpleIndexPath { long long x1; long long x2; long long x3; long long x4; })arg4;
