...
@property (nonatomic, readonly) long long routeUnavailableReason;
@property (nonatomic, readonly) unsigned long long screenAvailability;
@property (nonatomic, retain) id secondDisplayModeToken;
...
- (void)_switchModeForHighResolutionContent:(bool)arg1 completionHandler:(id /* block */)arg2;
...
- (long long)routeUnavailableReason;
