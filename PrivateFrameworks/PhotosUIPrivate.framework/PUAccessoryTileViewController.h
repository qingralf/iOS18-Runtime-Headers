...
@interface PUAccessoryTileViewController : PUTileViewController <PUAccessoryContentViewControllerDelegate> {
    ...
    struct { 
        ...
        bool respondsToWillHideNavigationBarWhenShowingAccessoryView; 
        bool respondsToShouldUseSquareImageWhenShowingAccessoryView; 
    }  _delegateFlags;
...
@property (setter=_setEditorHeightDelta:, nonatomic) double _editorHeightDelta;
