...
@interface PUAccessoryVisibilityInteractionController : NSObject <PUViewModelChangeObserver, PXChangeObserver, UIGestureRecognizerDelegate> {
...
@property (nonatomic, retain) id changesPauseToken;
...
@property (nonatomic) PHPhotoLibrary *pausedPhotoLibrary;
...
- (void)setChangesPauseToken:(id)arg1;
