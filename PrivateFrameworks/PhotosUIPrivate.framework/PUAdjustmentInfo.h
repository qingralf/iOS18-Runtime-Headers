...
@interface PUAdjustmentInfo : NSObject {
    ...
    NSString * _altIconName;
    id /* block */  _altImageTransformBlock;
...
@property (nonatomic, retain) NSString *altIconName;
@property (nonatomic, copy) id /* block */ altImageTransformBlock;
...
- (id)adjustmentKey;
- (id)altIconName;
- (id /* block */)altImageTransformBlock;
- (id)attributeKey;
- (double)baseLevel;
- (id)copy;
- (double)currentLevel;
...
- (void)setAltIconName:(id)arg1;
- (void)setAltImageTransformBlock:(id /* block */)arg1;
