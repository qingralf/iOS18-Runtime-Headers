...
@interface PUAlbumListViewController : UIViewController <PHPickerViewControllerDelegate, PLCloudFeedNavigating, PUAlbumListTableViewCellDelegate, PUCollectionViewReorderDelegate, PUCollectionsCollectionViewDropDataProvider, PUSectionedGridLayoutDelegate, PXAppIntentsViewAnnotationDelegate, PXChangeObserver, PXCollectionActionReceiver, PXCollectionsDataSourceManagerObserver, PXForcedDismissableViewController, PXNavigableCollectionContainer, PXPhotoLibraryUIChangeObserver, PXPlacesSnapshotFactoryDelegate, UIAdaptivePresentationControllerDelegate, UICollectionViewDataSource, UICollectionViewDelegate, UIGestureRecognizerDelegate, UIPopoverPresentationControllerDelegate, UITableViewDataSource, UITableViewDelegate> {
    ...
    id /* block */  _contextMenuInteractionEndBlock;
...
@property (nonatomic, retain) PUCollectionsCollectionViewDropDelegate *collectionViewDropDelegate;
@property (nonatomic, copy) id /* block */ contextMenuInteractionEndBlock;
...
@property (nonatomic, readonly) PUAlbumListCell *focusedListCell;
...
@property (nonatomic) PHPickerViewController *pickerViewController;
...
+ (id)newMyAlbumsViewControllerWithSpec:(id)arg1 sessionInfo:(id)arg2 dataSourceManager:(id)arg3 photoLibrary:(id)arg4;
+ (id)newMyAlbumsViewControllerWithSpec:(id)arg1 sessionInfo:(id)arg2 photoLibrary:(id)arg3;
...
- (void)_dismissPhotosPickerControllerAnimated:(bool)arg1;
- (id)_doneButtonItem;
- (unsigned long long)_editCapabilitiesForAlbum:(id)arg1;
- (void)_enumerateIndexPathsForPreparedItemsUsingBlock:(id /* block */)arg1;
- (id)_featureSpec;
...
- (void)_handleCollectionListActionType:(id)arg1;
- (void)_handleDeleteAlbumAtIndexPath:(id)arg1;
- (void)_handleDeleteCollection:(id)arg1 sourceView:(id)arg2;
...
- (id)_mainTableView;
- (void)_navigateToDestination:(id)arg1 provideViewControllers:(bool)arg2 options:(unsigned long long)arg3 completionHandler:(id /* block */)arg4;
...
- (void)_performOrScheduleScrollToCollection:(id)arg1 animated:(bool)arg2;
...
- (void)_scrollToCollection:(id)arg1 animated:(bool)arg2;
...
- (id /* block */)contextMenuInteractionEndBlock;
- (id)dataSource;
...
- (id)initWithSpec:(id)arg1 dataSourceManager:(id)arg2 photoLibrary:(id)arg3;
...
- (void)setCollectionViewDropDelegate:(id)arg1;
- (void)setContextMenuInteractionEndBlock:(id /* block */)arg1;
