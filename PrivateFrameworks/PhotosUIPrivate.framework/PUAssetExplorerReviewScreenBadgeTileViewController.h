...
@interface PUAssetExplorerReviewScreenBadgeTileViewController : PUTileViewController <PUViewModelChangeObserver, PXChangeObserver, PXUIAssetBadgeViewDelegate> {
