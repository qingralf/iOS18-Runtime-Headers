...
@interface PUAssetExplorerReviewScreenViewController : UIViewController <PUAssetExplorerReviewScreenActionManagerDelegate, PUReviewAssetProvider, PUViewModelChangeObserver, PXChangeObserver> {
    ...
    bool  _useSystemBackgroundColorBar;
}
...
@property (nonatomic) bool useSystemBackgroundColorBar;
...
- (void)setUseSystemBackgroundColorBar:(bool)arg1;
