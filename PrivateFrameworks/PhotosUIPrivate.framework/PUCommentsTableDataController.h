...
@interface PUCommentsTableDataController : NSObject <PLCloudCommentsChangeObserver, PUPhotoCommentEntryViewDelegate, UITableViewDataSource, UITableViewDelegate> {
    ...
    bool  _isPostingComment;
    NSString * _justInsertedCommentUUID;
    PLManagedAsset * _managedAsset;
    PHFetchResult * _orderedCommentsFetchResult;
    PHFetchResult * _orderedLikesFetchResult;
...
@property (nonatomic, retain) NSString *justInsertedCommentUUID;
@property (nonatomic, retain) PLManagedAsset *managedAsset;
@property (nonatomic, readonly) double minimumHeight;
@property (nonatomic, retain) PHFetchResult *orderedCommentsFetchResult;
@property (nonatomic, retain) PHFetchResult *orderedLikesFetchResult;
...
- (void)_postCommentWithText:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)_scrollToComment:(id)arg1 animated:(bool)arg2;
- (void)_setIsPostingComment:(bool)arg1 postButton:(id)arg2;
- (void)_setManagedAsset:(id)arg1;
...
- (bool)isEditing;
- (id)justInsertedCommentUUID;
- (id)managedAsset;
- (double)minimumHeight;
- (long long)numberOfSectionsInTableView:(id)arg1;
- (id)orderedCommentsFetchResult;
- (id)orderedLikesFetchResult;
...
- (void)setJustInsertedCommentUUID:(id)arg1;
- (void)setManagedAsset:(id)arg1;
- (void)setOrderedCommentsFetchResult:(id)arg1;
- (void)setOrderedLikesFetchResult:(id)arg1;
