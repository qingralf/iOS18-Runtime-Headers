...
@interface PUCropToolController : PUPhotoEditToolController <PUAdjustmentViewControllerDelegate, PUCropAspectViewControllerDelegate, PUCropPerspectiveAdjustmentsDataSourceDelegate, PUCropTransformedImageViewDelegate, PUMediaTimelineViewDelegate, UIGestureRecognizerDelegate, UIPopoverPresentationControllerDelegate> {
    ...
    id  _videoScrubberObservedPlayer;
...
@property (nonatomic, retain) id videoScrubberObservedPlayer;
@property (nonatomic, retain) id videoScrubberTimeObserver;
...
- (void)_userChangedAspectRatioLocked:(bool)arg1;
...
- (void)adjustmentsViewControllerSliderWillEndScrubbing:(id)arg1;
...
- (id)bestAspectRatioForWidth:(unsigned long long)arg1 height:(unsigned long long)arg2;
...
- (id)cropModel;
- (id)cropOverlayView;
- (void)cropTransformedImageView:(id)arg1 didChangeIsPerformingLiveInteraction:(bool)arg2;
...
- (void)cropTransformedImageViewWillEndTracking:(id)arg1;
- (id)cropView;
...
- (void)setVideoScrubberObservedPlayer:(id)arg1;
- (void)setVideoScrubberTimeObserver:(id)arg1;
