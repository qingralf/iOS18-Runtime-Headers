...
@property (setter=_setZoomedOut:, nonatomic) bool isZoomedOut;
...
- (id)newDisplayTileTransformWithUserAffineTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg1 userInputOriginIdentifier:(id)arg2 isZoomedOut:(bool)arg3;
