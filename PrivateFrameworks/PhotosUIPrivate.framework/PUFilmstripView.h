...
@property (nonatomic) bool preserveThumbnailsDuringReload; /* unknown property attribute: ? */
@property (nonatomic) bool preserveThumbnailsDuringReload;
@property (readonly) Class superclass;
@property (nonatomic) id thumbnailUpdatingDelegate; /* unknown property attribute: ? */
@property (nonatomic) bool useContentAspectRatio; /* unknown property attribute: ? */
