...
@interface PUImportViewController : PUPhotosGridViewController <PUCameraImportItemCellDelegate, PUImportActionCoordinatorDelegate, PUImportAddToAlbumsToolbarViewDelegate, PUImportOneUpTransitioning, PUImportSectionedGridLayoutDelegate, PUSectionedGridLayoutDelegate, PXActionableSectionHeaderViewDelegate, PXChangeObserver, PXImportAlbumPickerDelegate, PXImportAssetsDataSourceManagerObserver, PXImportControllerTopLevelCompletionDelegate, PXSettingsKeyObserver, PXSwipeSelectionManagerDelegate, UIGestureRecognizerDelegate, UIPopoverPresentationControllerDelegate> {
    ...
    PUImportAddToLibraryAndAlbumsPickerViewController * _destinationPickerViewController;
...
@property (nonatomic, retain) PUImportAddToLibraryAndAlbumsPickerViewController *destinationPickerViewController;
...
@property (nonatomic, retain) PXActionableSectionHeaderView *referenceHeaderView;
...
- (void)delete:(id)arg1;
- (id)deleteButtonItem;
- (id)destinationDescriptionForCollection:(id)arg1;
- (id)destinationPickerViewController;
...
- (void)headerViewDidPressActionButton:(id)arg1 inHeaderView:(id)arg2;
...
- (struct PXSimpleIndexPath { long long x1; long long x2; long long x3; long long x4; })selectionIndexPathForItem:(id)arg1;
