...
- (void)_saveAssetEditsWithContentEditingInput:(id)arg1 compositionController:(id)arg2 lastSavedCompositionController:(id)arg3 imageVersion:(long long)arg4 editOperationType:(id)arg5;
- (id)asset;
