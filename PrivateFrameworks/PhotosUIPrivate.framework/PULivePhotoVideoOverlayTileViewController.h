...
@interface PULivePhotoVideoOverlayTileViewController : PUTileViewController <ISChangeObserver, PHLivePhotoViewDelegate, PUViewModelChangeObserver, PXChangeObserver> {
