...
@interface PUOneUpAccessoryViewControllersManager : NSObject <PUViewModelChangeObserver, PXPhotosDetailsUIViewControllerDelegate> {
    ...
    struct { 
        ...
        bool invalidateAccessoryLayout; 
        bool preventInternalFileRadarActionForAssetReference; 
        bool preventAlbumAttributionWidget; 
    }  _delegateRespondsTo;
...
- (bool)shouldHideNavigationBarWhenShowingAccessoryViewControllerForAssetReference:(id)arg1;
- (bool)shouldHideStatusBarWhenShowingAccessoryViewControllerForAssetReference:(id)arg1;
