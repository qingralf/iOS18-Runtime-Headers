...
@interface PUOneUpEventTracker : PXMediaViewControllerEventTracker <PUOneUpEventTracker, PUViewModelChangeObserver, PXChangeObserver> {
...
- (void)_incrementAssetViewCountIfNeeded:(id)arg1;
