...
@interface PUOneUpSettings : PXSettings <PXPreferencesObserver> {
    ...
    bool  _enableHDRImages;
    bool  _enablePreferredImageDynamicRangeAnimation;
    ...
    bool  _userAllowsVisualIntelligence;
    bool  _userAllowsVisualIntelligenceInVideoFrame;
    bool  _userAllowsVisualIntelligenceRemoveBackground;
    bool  _userAllowsVisualIntelligenceV2;
    bool  _userAllowsVisualIntelligenceVisualLookupInfoPanelMode;
...
@property (nonatomic, readonly) bool allowVisualIntelligence;
@property (nonatomic) bool allowsDetailsToggleButtonInBars;
@property (nonatomic, readonly) bool allowsVisualIntelligenceInVideoFrame;
@property (nonatomic, readonly) bool allowsVisualIntelligenceRemoveBackground;
@property (nonatomic, readonly) bool allowsVisualIntelligenceV2;
@property (nonatomic, readonly) bool allowsVisualIntelligenceVisualLookupInfoPanelMode;
...
@property (nonatomic) bool enableHDRImages;
@property (nonatomic) bool enablePreferredImageDynamicRangeAnimation;
...
@property (nonatomic) bool userAllowsVisualIntelligence;
@property (nonatomic) bool userAllowsVisualIntelligenceInVideoFrame;
@property (nonatomic) bool userAllowsVisualIntelligenceRemoveBackground;
@property (nonatomic) bool userAllowsVisualIntelligenceV2;
@property (nonatomic) bool userAllowsVisualIntelligenceVisualLookupInfoPanelMode;
...
- (void)setEnableHDRImages:(bool)arg1;
- (void)setEnablePreferredImageDynamicRangeAnimation:(bool)arg1;
...
- (void)setHdrShareSheetCrossfadeAnimationDuration:(double)arg1;
- (void)setHdrSuppressionAnimationDuration:(double)arg1;
...
- (void)setMinimumDurationForIncrementingViewCount:(double)arg1;
...
- (void)setPreferredImageDynamicRangeAnimationDuration:(double)arg1;
...
- (void)setUserAllowsVisualIntelligence:(bool)arg1;
- (void)setUserAllowsVisualIntelligenceInVideoFrame:(bool)arg1;
- (void)setUserAllowsVisualIntelligenceRemoveBackground:(bool)arg1;
- (void)setUserAllowsVisualIntelligenceV2:(bool)arg1;
- (void)setUserAllowsVisualIntelligenceVisualLookupInfoPanelMode:(bool)arg1;
