...
@interface PUOverOneUpPresentationSession : NSObject <PUAvalancheReviewControllerDelegate, PUCollectionViewLayoutProvider, PUFunEffectsViewControllerObserver, PUOneUpPhotosSharingTransitionDelegate, PUOneUpSharingAnimationControllerDelegate, PUPhotoEditViewControllerPresentationDelegate, PUPhotoMarkupViewControllerObserver, PUSlideshowViewControllerDelegate, PXActivitySharingControllerDelegate, PXForcedDismissableViewController, UIViewControllerTransitioningDelegate> {
    ...
    PUOneUpActivitySharingActionPerformer * _sharingActionPerformer;
}
...
@property (nonatomic, retain) PUOneUpActivitySharingActionPerformer *sharingActionPerformer;
...
- (id)initWithActivitySharingActionPerformer:(id)arg1;
...
- (void)setSharingActionPerformer:(id)arg1;
- (id)sharingActionPerformer;
- (void)slideshowViewControllerDidFinish:(id)arg1 withVisibleAssets:(id)arg2;
- (id)viewController;
- (id)viewToHideWhilePresentingWithTransition:(id)arg1;
