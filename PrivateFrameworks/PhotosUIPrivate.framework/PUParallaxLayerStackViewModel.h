...
@property (nonatomic, readonly) bool canApplyHeadroom;
...
@property (nonatomic, readonly) bool headroomLayoutUsesHeadroomArea;
...
- (id)init;
- (id)initWithCompoundLayerStack:(id)arg1 style:(id)arg2 deviceOrientation:(long long)arg3;
- (id)initWithSegmentationItem:(id)arg1 compoundLayerStack:(id)arg2 style:(id)arg3 deviceOrientation:(long long)arg4;
- (id)initWithSegmentationItem:(id)arg1 initialStyle:(id)arg2 compoundLayerStack:(id)arg3 deviceOrientation:(long long)arg4;
