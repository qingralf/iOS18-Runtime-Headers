...
@interface PUPhotoEditPortraitToolController : PUPhotoEditToolController <CEKLightingControlDelegate, CEKSliderDelegate, PUPhotoEditApertureToolbarDelegate, PUPhotoEditPortraitFocusDelegate, PXNavigationActionReceiver> {
    ...
    unsigned long long  _depthInfoMajorVersion;
    unsigned long long  _depthInfoMinorVersion;
...
- (unsigned long long)depthInfoMajorVersion;
- (unsigned long long)depthInfoMinorVersion;
...
- (void)setDepthInfoMajorVersion:(unsigned long long)arg1;
- (void)setDepthInfoMinorVersion:(unsigned long long)arg1;
