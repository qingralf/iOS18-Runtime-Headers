...
@interface PUPhotoEditProtoSettings : PXSettings <PEValuesCalculatorSettings> {
    ...
    long long  _cleanupMaskDisplayMode;
    ...
    bool  _enableSelectiveCopyEdits;
    bool  _enableSemanticDevelopmentHUD;
    bool  _enableSemanticStyleInEdit;
    ...
    bool  _hideUIForInteractionEnabled;
    double  _hideUIForInteractionFadeInDuration;
    double  _hideUIForInteractionFadeOutDelay;
    double  _hideUIForInteractionFadeOutDuration;
    ...
    bool  _retouchEnablesSensitivityCheck;
    bool  _retouchPixellatesFaces;
    bool  _retouchShowVFXControls;
    bool  _retouchShowsBrushButton;
    bool  _retouchShowsFaceRects;
    bool  _retouchShowsIntersectedMasks;
    bool  _retouchShowsTargetPointBrushPoints;
    bool  _retouchStrokeDisableObjectStrokes;
    bool  _runNeutrinoSynchronously;
    double  _secondaryToolbarShadowLength;
    double  _selectionRingStrokeWidth;
    bool  _shouldConstraintDpadValuesToGrid;
    bool  _shouldMoveToolbarToRevealStylesDPadInLandscapeOrientation;
    ...
    long long  _simulatedModelCatalogDownload;
...
@property (nonatomic) bool allowDisabledTools;
...
@property (nonatomic) bool enableEnterEditSemanticStyleAutoCalc;
...
@property (nonatomic) bool enableFlexRange;
...
@property (nonatomic) bool enableSelectiveCopyEdits;
@property (nonatomic) bool enableSemanticDevelopmentHUD;
@property (nonatomic) bool enableSemanticStyleInEdit;
@property (nonatomic) bool enableSpatialMediaEditing;
@property (nonatomic) bool enableVideoStabilizion;
@property (nonatomic) bool feedbackUIFCS;
...
@property (nonatomic) bool hideUIForInteractionEnabled;
...
@property (nonatomic) bool overrideCleanupHardwareCheck;
@property (nonatomic) bool overrideSemanticStylesHardwareCheck;
...
@property (nonatomic) bool retouchDumpsCoreImageInputs;
@property (nonatomic) bool retouchEnablesSensitivityCheck;
@property (nonatomic) bool retouchPixellatesFaces;
@property (nonatomic) bool retouchShowVFXControls;
@property (nonatomic) bool retouchShowsBrushButton;
@property (nonatomic) bool retouchShowsFaceRects;
@property (nonatomic) bool retouchShowsIntersectedMasks;
@property (nonatomic) bool retouchShowsMaskBoundingBox;
@property (nonatomic) bool retouchShowsTargetPointBrushPoints;
@property (nonatomic) bool retouchStrokeDisableObjectStrokes;
...
@property (nonatomic) bool shouldConstraintDpadValuesToGrid;
@property (nonatomic) bool shouldEnableStylesForProRaw;
@property (nonatomic) bool shouldMoveToolbarToRevealStylesDPadInLandscapeOrientation;
...
@property (nonatomic) bool showHDRHeadroomControl;
...
@property (nonatomic) long long simulatedModelCatalogDownload;
...
- (long long)cleanupMaskDisplayMode;
...
- (void)setAllowDisabledTools:(bool)arg1;
...
- (void)setCleanupMaskDisplayMode:(long long)arg1;
...
- (void)setEnableEnterEditSemanticStyleAutoCalc:(bool)arg1;
...
- (void)setHideUIForInteractionEnabled:(bool)arg1;
- (void)setHideUIForInteractionFadeInDuration:(double)arg1;
- (void)setHideUIForInteractionFadeOutDelay:(double)arg1;
- (void)setHideUIForInteractionFadeOutDuration:(double)arg1;
...
- (void)setRetouchDumpsCoreImageInputs:(bool)arg1;
- (void)setRetouchEnablesSensitivityCheck:(bool)arg1;
- (void)setRetouchPixellatesFaces:(bool)arg1;
- (void)setRetouchShowVFXControls:(bool)arg1;
- (void)setRetouchShowsBrushButton:(bool)arg1;
- (void)setRetouchShowsFaceRects:(bool)arg1;
- (void)setRetouchShowsIntersectedMasks:(bool)arg1;
- (void)setRetouchShowsMaskBoundingBox:(bool)arg1;
- (void)setRetouchShowsTargetPointBrushPoints:(bool)arg1;
- (void)setRetouchStrokeDisableObjectStrokes:(bool)arg1;
...
- (void)setShouldConstraintDpadValuesToGrid:(bool)arg1;
- (void)setShouldEnableStylesForProRaw:(bool)arg1;
- (void)setShouldMoveToolbarToRevealStylesDPadInLandscapeOrientation:(bool)arg1;
...
- (void)setShowHDRHeadroomControl:(bool)arg1;
...
- (void)setSimulatedModelCatalogDownload:(long long)arg1;
...
- (long long)simulatedModelCatalogDownload;
