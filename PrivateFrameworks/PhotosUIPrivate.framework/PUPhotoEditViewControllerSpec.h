...
@property (nonatomic, readonly) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } scrubberViewMargin;
...
- (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })scrubberViewMargin;
