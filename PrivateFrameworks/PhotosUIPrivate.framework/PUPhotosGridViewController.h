...
@interface PUPhotosGridViewController : UICollectionViewController <PHAssetCollectionDataSource, PUCollectionViewSelectionDelegate, PUOneUpPresentationHelperDelegate, PUPhotosGridBarsHelperDelegate, PUScrollViewSpeedometerDelegate, PUSessionInfoObserver, PUSlideshowViewControllerDelegate, PUSwipeSelectionManagerDataSource, PUSwipeSelectionManagerDelegate, PXActivitySharingControllerDelegate, PXAutoScrollerDelegate, PXCMMActionPerformerDelegate, PXForcedDismissableViewController, PXNavigableAssetContainerViewController, PXPhotoKitDeletePhotosActionControllerDelegate, PXPhotosDataSourceChangeObserver, PXPhotosGlobalFooterViewDelegate, PXPhotosGlobalFooterViewLayoutDelegate, PXSettingsKeyObserver, UICollectionViewDragDestination, UICollectionViewDragSource, UIDropInteractionDelegate, UIGestureRecognizerDelegate, UIMultiSelectInteractionDelegate, UIPopoverPresentationControllerDelegate> {
    ...
    PXPhotoKitDeletePhotosActionController * __deleteActionController;
    bool  __didForceDataSource;
    PXPhotoKitDuplicateActionController * __duplicateActionController;
    ...
    <PUPhotosGridViewSupplementalToolbarProvider> * _supplementalToolbarProvider;
...
@property (setter=_setDeleteActionController:, nonatomic, retain) PXPhotoKitDeletePhotosActionController *_deleteActionController;
@property (setter=_setDidForceDataSource:, nonatomic) bool _didForceDataSource;
@property (setter=_setDuplicateActionController:, nonatomic, retain) PXPhotoKitDuplicateActionController *_duplicateActionController;
...
@property (nonatomic, retain) UIMultiSelectInteraction *_multiSelectInteraction;
...
@property (setter=_setMaximumThumbnailRequestSize:, nonatomic) struct CGSize { double x1; double x2; } maximumThumbnailRequestSize;
...
@property (nonatomic, retain) <PUPhotosGridViewSupplementalToolbarProvider> *supplementalToolbarProvider;
...
- (id)_performDuplicateActivityWithSelectionSnapshot:(id)arg1;
- (id)_performHideActivityWithSelectionManager:(id)arg1;
- (id)_photoBrowserOneUpPresentationAdaptor;
- (id)_pickerBannerView;
- (long long)_preferredWhitePointAdaptivityStyle;
- (void)_presentActivitySharingController:(id)arg1 completion:(id /* block */)arg2;
...
- (void)_setMaximumThumbnailRequestSize:(struct CGSize { double x1; double x2; })arg1;
...
- (struct CGSize { double x1; double x2; })imageRequestItemPixelSize;
...
- (id)initWithSpec:(id)arg1 photoLibrary:(id)arg2;
...
- (void)menuActionController:(id)arg1 didDismissWithActionIdentifier:(id)arg2;
...
- (id)oneUpPresentationHelper:(id)arg1 presentingScrollViewForAssetReference:(id)arg2;
...
- (void)setSupplementalToolbarProvider:(id)arg1;
- (void)set_multiSelectInteraction:(id)arg1;
...
- (id)supplementalToolbarProvider;
