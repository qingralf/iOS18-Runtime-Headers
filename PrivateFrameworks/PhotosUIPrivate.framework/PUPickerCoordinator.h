...
@interface PUPickerCoordinator : NSObject <PUPhotoPickerResizeTaskDescriptorViewModelDelegate, PUPhotosGridDownloadUpdateHandler, PUPickerContainerControllerActionHandler, PUUIImageViewControllerCancellationDelegate, PUUIImageViewControllerFileResizingDelegate, PXChangeObserver, PXSelectionCoordinatorDelegate> {
    ...
    <PUPickerCoordinatorActionHandler> * _coordinatorActionHandler;
...
@property (nonatomic, readonly) <PUPickerCoordinatorActionHandler> *coordinatorActionHandler;
...
@property (nonatomic, readonly) PUPickerManagedViewController *managedViewController;
@property (nonatomic, readonly) <PUPhotoPicker> *photoPicker;
@property (nonatomic, readonly) PUPickerActivityProgressController *progressController;
