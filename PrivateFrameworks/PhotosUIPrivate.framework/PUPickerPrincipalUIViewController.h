...
@interface PUPickerPrincipalUIViewController : UIViewController <NSExtensionRequestHandling, PUPickerCoordinatorActionHandler, PXChangeObserver, PXNavigationActionReceiver, _PUPickerExtensionContextVendorInterface, _PUPickerUnavailableViewControllerDelegate, _UIAppearanceRestriction> {
...
@property (nonatomic, retain) PUPickerCoordinator *coordinator;
...
- (void)_hostModalInPresentationDidChange:(bool)arg1;
