...
@property (nonatomic, retain) UIImage *_memory_creationStateImage;
@property (nonatomic, retain) NSString *_memory_creationStateTitle;
...
- (id)_memory_creationStateImage;
- (id)_memory_creationStateTitle;
...
- (void)set_memory_creationStateImage:(id)arg1;
- (void)set_memory_creationStateTitle:(id)arg1;
- (id)sharingSettings;
