...
- (void)setLemonadeInterItemSpacing:(double)arg1;
- (void)setLemonadeInterSectionSpacing:(double)arg1;
- (void)setLemonadeItemCornerRadius:(double)arg1;
- (void)setLemonadeSlitAspectRatio:(double)arg1;
