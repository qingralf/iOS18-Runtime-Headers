...
@interface PUSessionInfo : NSObject <PUPhotoSelectionManagerChangeObserver> {
    bool  _allowSelectingNonEditableAlbums;
    ...
    bool  _excludesNewAlbumCreation;
    ...
    bool  _scrollToSourceAlbumWhenPresented;
    bool  _selectingTargetAlbum;
    PXSelectionCoordinator * _selectionCoordinator;
    bool  _showCheckmarkOnSourceAlbum;
...
@property (nonatomic) bool allowSelectingNonEditableAlbums;
...
@property (nonatomic) bool excludesNewAlbumCreation;
...
@property (nonatomic) bool scrollToSourceAlbumWhenPresented;
...
@property (nonatomic) bool showCheckmarkOnSourceAlbum;
...
- (void)setAllowSelectingNonEditableAlbums:(bool)arg1;
...
- (void)setExcludesNewAlbumCreation:(bool)arg1;
...
- (void)setScrollToSourceAlbumWhenPresented:(bool)arg1;
- (void)setSelectingTargetAlbum:(bool)arg1;
- (void)setSelectionCoordinator:(id)arg1;
- (void)setShowCheckmarkOnSourceAlbum:(bool)arg1;
