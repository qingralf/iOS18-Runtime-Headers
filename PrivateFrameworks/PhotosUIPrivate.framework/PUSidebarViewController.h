...
@interface PUSidebarViewController : UIViewController <PUCollectionsCollectionViewDropDataProvider, PUOutlineCellDelegate, PXActionProvider, PXAssetCollectionActionPerformerDelegate, PXChangeObserver, PXCollectionActionReceiver, PXPagingViewControllerDelegate, PXSidebarOutlineSectionControllerDelegate, PXSplitViewControllerChangeObserver, UICollectionViewDelegate, UIPopoverPresentationControllerDelegate> {
    <PXActionProviderDelegate> * _actionProviderDelegate;
...
@property (nonatomic, readonly) <PXNavigationListItem> *fallbackNavigationItem;
...
- (bool)_hasSidebarItemForDestination:(id)arg1;
- (void)_highlightNavigationDestination:(id)arg1;
- (bool)_isPhotosPicker;
- (id)_itemIndexPathForDestination:(id)arg1;
...
- (void)pagingViewControllerDidUpdateItemList:(id)arg1;
- (id)photoLibrary;
