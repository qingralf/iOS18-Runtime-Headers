...
@property (nonatomic, readonly) bool disappearanceAssertionsEnabled;
@property (nonatomic, readonly, copy) id /* block */ dismissalProgressBlock;
...
@property (nonatomic, readonly, copy) id /* block */ presentationProgressBlock;
