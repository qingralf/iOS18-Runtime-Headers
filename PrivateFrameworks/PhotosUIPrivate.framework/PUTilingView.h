...
@interface PUTilingView : UIScrollView {
    ...
    bool  _allowEDRHeadroomMonitoring;
...
@property (nonatomic) bool allowEDRHeadroomMonitoring;
...
@property (nonatomic, readonly) PXDisplayScreenDynamicRangeMonitor *screenDynamicRangeMonitor;
...
- (id)scrollDelegate;
- (void)setAllowEDRHeadroomMonitoring:(bool)arg1;
