...
@interface PUTilingViewSettings : PXSettings {
    ...
    bool  _lemonadeUseOvershootingSpringAnimations;
    bool  _lemonadeUseSystemSpringAnimations;
...
@property (nonatomic) bool lemonadeUseOvershootingSpringAnimations;
@property (nonatomic) bool lemonadeUseSystemSpringAnimations;
...
- (void)setLemonadeUseOvershootingSpringAnimations:(bool)arg1;
- (void)setLemonadeUseSystemSpringAnimations:(bool)arg1;
