...
@interface PUTrimToolController : UIViewController <PULivePhotoKeyFrameSelectionViewControllerDelegate, PXFocusTimelineController, PXFocusTimelineViewDelegate, PXLivePhotoTrimScrubberDelegate, PXSlowMotionEditorDelegate, PXTrimToolPlayerObserver, UIPopoverPresentationControllerDelegate> {
    ...
    bool  _isActive;
    bool  _isPerformingLiveInteraction;
    ...
    NSLayoutConstraint * _scrubberContainerToSuperviewConstraint;
...
@property (nonatomic) bool isPerformingLiveInteraction;
...
@property (nonatomic, retain) NSLayoutConstraint *scrubberContainerToSuperviewConstraint;
...
@property (getter=isSlomoEnabled, nonatomic) bool slomoEnabled;
...
- (void)_updateSlomoViewAnimated:(bool)arg1;
...
- (id)scrubberContainerToSuperviewConstraint;
...
- (void)setIsPerformingLiveInteraction:(bool)arg1;
