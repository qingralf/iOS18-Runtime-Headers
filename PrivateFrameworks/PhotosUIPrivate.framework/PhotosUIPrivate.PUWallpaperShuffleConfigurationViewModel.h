...
@interface PhotosUIPrivate.PUWallpaperShuffleConfigurationViewModel : NSObject <PXPassiveContentDataSourceChangeObserver, PXPassiveContentPeoplePickerDataSourceChangeObserver> {
    ...
    union { in /* Warning: Unrecognized filer type: 'u' using 'void*' */ void*x1; long x2; long x3; }  _isUserAlbumSelected;
    ...
    union { in /* Warning: Unrecognized filer type: 'u' using 'void*' */ void*x1; long x2; long x3; }  _userAlbumAssetCollection;
    void albumPickerHandler;
