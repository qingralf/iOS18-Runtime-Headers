...
@interface POAuthenticationContext : NSObject {
    ...
    NSString * _userName;
    NSNumber * _userSepSigningAlgorithm;
...
@property (nonatomic, retain) NSNumber *userSepSigningAlgorithm;
