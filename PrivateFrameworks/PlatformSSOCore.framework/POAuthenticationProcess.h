...
@interface POAuthenticationProcess : NSObject <NSURLSessionDelegate, NSURLSessionTaskDelegate> {
    ...
    NSArray * _kSupportedLoginResponseAlgorithms;
...
- (void)_performNonceRequestWithContext:(id)arg1 request:(id)arg2 completion:(id /* block */)arg3;
...
- (void)addCryptoHeadersToJWTBody:(id)arg1 context:(id)arg2;
- (id)completionQueue;
...
- (id)init;
- (id)kSupportedLoginResponseAlgorithms;
