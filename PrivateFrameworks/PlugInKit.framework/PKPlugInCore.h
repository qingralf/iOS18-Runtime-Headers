...
@property (nonatomic, readonly) <PKExternalProviders> *external;
...
+ (id)readSDKDictionary:(id)arg1 forPlatform:(unsigned int)arg2 externalProviders:(id)arg3;
...
- (id)infoKey:(id)arg1;
- (id)init;
- (id)initWithExternalProviders:(id)arg1;
- (id)initWithForm:(id)arg1 externalProviders:(id)arg2;
- (id)initWithName:(id)arg1 extensionPointPlatform:(unsigned int)arg2 url:(id)arg3 bundleInfo:(id)arg4 uuid:(id)arg5 discoveryInstanceUUID:(id)arg6 extensionPointCache:(id)arg7 externalProviders:(id)arg8;
- (bool)isAppExtension;
- (bool)isData;
- (bool)isDedicated;
