...
- (id)entitledTranscriptIdentifier;
- (id)entitledTranscriptProvider;
- (id)entitledTranscriptSnippet;
- (long long)episodeNumber;
- (id)episodeStoreId;
- (id)episodeType;
- (id)firstTimeAvailableAsFree;
- (id)firstTimeAvailableAsPaid;
- (id)freeTranscriptIdentifier;
- (id)freeTranscriptProvider;
- (id)freeTranscriptSnippet;
- (id)guid;
...
- (void)setEntitledTranscriptIdentifier:(id)arg1;
- (void)setEntitledTranscriptProvider:(id)arg1;
- (void)setEntitledTranscriptSnippet:(id)arg1;
...
- (void)setFreeTranscriptProvider:(id)arg1;
- (void)setFreeTranscriptSnippet:(id)arg1;
