...
@property (nonatomic, retain) NSString *entitledTranscriptIdentifier;
@property (nonatomic, retain) NSString *entitledTranscriptProvider;
@property (nonatomic, retain) NSString *entitledTranscriptSnippet;
...
@property (nonatomic, retain) NSString *freeTranscriptIdentifier;
@property (nonatomic, retain) NSString *freeTranscriptProvider;
@property (nonatomic, retain) NSString *freeTranscriptSnippet;
...
@property (nonatomic, retain) NSDate *lastCacheDeletePurge;
...
+ (id)_predicateForPriceType:(long long)arg1 forPriceTypeKey:(id)arg2 excluding:(bool)arg3;
+ (id)assetURLIsPackagedMedia;
+ (double)endOfTrackForDuration:(double)arg1;
+ (void)episodeUuidForGUID:(id)arg1 feedURL:(id)arg2 completion:(id /* block */)arg3;
...
+ (id)insertNewEpisodeInManagedObjectContext:(id)arg1 canSendNotifications:(bool)arg2;
+ (id)insertNewEpisodeInManagedObjectContext:(id)arg1 title:(id)arg2 podcast:(id)arg3 pubDate:(id)arg4 byteSize:(long long)arg5 guid:(id)arg6 uti:(id)arg7 contentId:(long long)arg8 enclosureUrl:(id)arg9 playStateSource:(int)arg10 importSource:(int)arg11 canSendNotifications:(bool)arg12;
...
+ (id)predicateForCategoryPageFromYourShows:(id)arg1 ctx:(id)arg2;
...
+ (id)predicateForHiddenPodcastForEpisodeUuids:(id)arg1;
...
- (bool)allowsDurationUpdateFromSource:(int)arg1;
- (id)assetURL;
