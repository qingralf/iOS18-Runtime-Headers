...
@property (nonatomic) bool isTransitioningFromImplicit;
...
@property (nonatomic) double lastUnfollowedDate;
...
@property (nonatomic, retain) MTCategory *primaryCategory;
...
+ (id)importedShowArtworkURLFor:(id)arg1;
...
+ (id)predicateForHiddenPodcastUuids:(id)arg1;
...
+ (id)predicateForLastUnfollowedDateOlderThanDate:(id)arg1;
...
+ (id)storeCleanURLForAdamID:(long long)arg1;
...
- (void)resetGoDarkWithReason:(unsigned long long)arg1;
...
- (void)setIsTransitioningFromImplicit:(bool)arg1;
