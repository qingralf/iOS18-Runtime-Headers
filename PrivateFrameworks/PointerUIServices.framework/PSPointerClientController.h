...
@interface PSPointerClientController : NSObject <BSInvalidatable, PSPointerDefaultLaunchingServiceServerToClientInterface, PSPointerDefaultServiceServerToClientInterface> {
    ...
    NSMutableDictionary * _hoverRegionOverridingAssertions;
...
@property (nonatomic, retain) NSMutableDictionary *hoverRegionOverridingAssertions;
...
- (id)acquireOverridingHoverRegionAssertionForDisplay:(id)arg1;
...
- (id)delegate;
- (id)hoverRegionOverridingAssertions;
- (id)init;
- (void)invalidate;
...
- (void)setHoverRegionOverridingAssertions:(id)arg1;
