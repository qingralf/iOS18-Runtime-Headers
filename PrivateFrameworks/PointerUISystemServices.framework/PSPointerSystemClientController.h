...
- (void)_setRootWindowTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg1 sceneForIdentifierPrefix:(id)arg2 displayConfiguration:(id)arg3;
- (id)delegate;
- (id)init;
...
- (void)setRootWindowTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg1 forDisplayConfiguration:(id)arg2;
