...
- (void)reset;
- (int)temporalDisparityFilter:(id)arg1 inDisparity:(id)arg2 inDisplacement:(id)arg3 inDisparityFilteredPrev:(id)arg4 outDisparityFiltered:(id)arg5 disparityBias:(float)arg6;
...
- (int)temporalDisparityFilter:(id)arg1 inDisplacement:(id)arg2 inStatePrev:(id)arg3 inDisparity:(id)arg4 outDisparityFiltered:(id)arg5 outState:(id)arg6;
