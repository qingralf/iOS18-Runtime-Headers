...
- (void)updateWithFrame:(struct __CVBuffer { }*)arg1 withTimeStamp:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2 withRotationDegrees:(int)arg3 withDetectedHands:(id)arg4 withDetectedFaces:(id)arg5 asyncWork:(id)arg6;
