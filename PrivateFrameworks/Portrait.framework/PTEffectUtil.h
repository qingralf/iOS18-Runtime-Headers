...
+ (unsigned long long)closestAspectRatio:(struct CGSize { double x1; double x2; })arg1;
...
+ (void)inverseRectTransform;
+ (void)multiplyRectTransformwithRectTransform;
...
+ (void)transformRectintoCropCoordinates;
