...
- (id)initWithMetalContext:(id)arg1 url:(id)arg2 inputNames:(id)arg3 outputNames:(id)arg4 tensorSwapNames:(id)arg5 reshapeNetworkSize:(struct { unsigned long long x1; unsigned long long x2; unsigned long long x3; }*)arg6 configuration:(id)arg7 ANEConfig:(id)arg8;
- (id)networkVersion;
