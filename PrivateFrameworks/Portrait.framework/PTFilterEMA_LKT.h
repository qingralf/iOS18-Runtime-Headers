...
@interface PTFilterEMA_LKT : NSObject <PTAbstractDisparityFilter> {
    ...
    <MTLComputePipelineState> * _temporalFilterGaussEMA_LKT;
    <MTLComputePipelineState> * _temporalFilterGaussEMA_LKTNormal;
}
...
- (void).cxx_destruct;
- (int)emaFilter:(id)arg1 inDisplacement:(id)arg2 inTexPrev:(id)arg3 inTex:(id)arg4 outTex:(id)arg5 frameIndex:(int)arg6 scale:(float)arg7;
...
- (int)gaussEMAFilter:(id)arg1 inDisplacement:(id)arg2 inTexPrev:(id)arg3 inTex:(id)arg4 outTex:(id)arg5 frameIndex:(int)arg6;
