...
- (void)estimateLightIntensityWithFaceRects:(/* Warning: Unrecognized filer type: '1' using 'void*' */ void**)arg1 inTex:(id)arg2 numberOfFaceRects:(int)arg3 transform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg4 humanDetections:(id)arg5 asyncWork:(id)arg6;
- (id)faceObservations;
- (id)initWithMetalContext:(id)arg1 faceAttributesNetwork:(id)arg2 effectUtil:(id)arg3 msrColorPyramid:(id)arg4 colorSize:(struct { unsigned long long x1; unsigned long long x2; unsigned long long x3; })arg5 prewarmOnly:(bool)arg6 sharedResources:(id)arg7;
- (void)interpolateLightIntensity:(float)arg1;
- (id)lightEstimation;
- (void)reset;
- (id)srlV2CoeffsBuffer;
- (void)updateSubjectRelighting:(struct __CVBuffer { }*)arg1 inLuma:(id)arg2 inChroma:(id)arg3 inFaceRects:(struct FaceRectsWrapper { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; })arg4 runOnAsyncCommandQueue:(bool)arg5 transform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg6 dependentCommandBuffer:(id)arg7;
