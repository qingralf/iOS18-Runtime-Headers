...
- (int)renderDisparity:(id)arg1 inDisparity:(id)arg2 outYUV:(id)arg3 region:(struct PTRegion { struct PTSize { unsigned short x_1_1_1; unsigned short x_1_1_2; } x1; })arg4 drawLegend:(bool)arg5;
