...
@interface PBFAmbientEditingCollectionViewController : UICollectionViewController <BSInvalidatable, PBFDisplayConfigurationUpdatable, PBFPosterExtensionDataStoreObserver, PREditingSceneViewControllerDelegate, UICollectionViewDelegateFlowLayout> {
