...
@interface PBFGalleryController : NSObject <BSInvalidatable, PBFDataComponentRefreshStateProviding> {
    ...
    <PBFPosterGalleryLayoutProviding> * _galleryLayoutProvider;
...
@property (nonatomic, readonly) PRSPosterGalleryLayout *currentGalleryConfiguration;
...
@property (nonatomic, readonly) <PBFPosterGalleryLayoutProviding> *galleryLayoutProvider;
...
- (id)galleryCacheURL;
- (id)galleryLayoutProvider;
- (id)galleryLayoutProviderWithError:(out id*)arg1;
- (id)initWithGalleryCacheURL:(id)arg1 galleryLayoutProvider:(id)arg2 runtimeAssertionProvider:(id)arg3;
