...
@interface PBFModalRootViewController : UIViewController <BSDescriptionProviding, PBFAmbientEditingCollectionViewControllerDelegate, PBFFocusPosterSelectionViewControllerDelegate, PBFPosterEditingIngestionManagerDelegate, PBFPosterExtensionDataStoreObserver, PBFPosterGalleryPreviewViewControllerDelegate, PBFPosterRackCollectionViewControllerDelegate, PBFPosterSelectionViewControllerDelegate, PREditingSceneViewControllerDelegate, PREditingSceneViewControllerObserver, UISheetPresentationControllerDelegate, _UISceneBSActionHandler, _UISceneComponentProviding, _UISceneSettingsDiffAction> {
    ...
    bool  _didAppearOnce;
    <PBFDisplayConfigurationUpdatable> * _displayConfigurationObserver;
...
@property (nonatomic) PBFAmbientEditingCollectionViewController *ambientEditingController;
...
- (void)setAmbientEditingController:(id)arg1;
