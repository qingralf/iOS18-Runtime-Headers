...
- (id)_placeImageViewForSubtitleComplication:(id)arg1 withSuperview:(id)arg2 snapshotRequest:(id)arg3;
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })_scaledFrameForElements:(unsigned long long)arg1;
