...
@interface PBFPosterGalleryPreviewViewController : UIViewController <PREditingAppearanceNotificationForwarding, PREditingSceneViewControllerDelegate, PREditingSceneViewControllerObserver, UISheetPresentationControllerDelegate, UIViewControllerTransitioningDelegate, _PBFGalleryCollectionViewControllerDelegate> {
