...
@property (nonatomic, copy) NSAttributedString *attributedPosterTitle; /* unknown property attribute: ? */
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (readonly, copy) NSString *description;
@property (readonly) unsigned long long hash;
@property (nonatomic, copy) NSString *posterDescription; /* unknown property attribute: ? */
@property (nonatomic, readonly) PBFPosterGalleryPreviewView *posterPreviewView;
@property (nonatomic, copy) NSString *posterTitle; /* unknown property attribute: ? */
