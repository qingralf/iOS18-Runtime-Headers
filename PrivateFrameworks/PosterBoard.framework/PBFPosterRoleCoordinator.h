...
@property (nonatomic, readonly) NSSet *knownExtensionIdentifiers;
...
- (void).cxx_destruct;
- (id)_addChangesForInitialPostersTo:(id)arg1 modelCoordinatorProvider:(id)arg2 role:(id)arg3;
...
- (id)initWithRole:(id)arg1 storage:(id)arg2 modelCoordinatorProvider:(id)arg3 providers:(id)arg4;
- (void)invalidate;
- (id)knownExtensionIdentifiers;
...
- (bool)validateEventIsRelevant:(id)arg1;
