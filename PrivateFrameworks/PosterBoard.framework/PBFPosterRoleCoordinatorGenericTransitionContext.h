...
- (id)initWithActiveFocusMode:(id)arg1 activeChargerIdentifier:(id)arg2 extensionStoreCoordinators:(id)arg3 currentActivePosterForRole:(id)arg4 affectedRoles:(id)arg5;
