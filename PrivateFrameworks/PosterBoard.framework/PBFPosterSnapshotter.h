...
@interface PBFPosterSnapshotter : NSObject <BSInvalidatable, FBSceneDelegate> {
    ...
    RBSAssertion * _keepPosterBoardAliveUntilSnapshottingIsComplete;
...
@property (nonatomic, readonly) bool necessitatesExtensionInstance;
...
- (void)_cleanupWithCompletion:(id /* block */)arg1;
- (id)_encoderForDefinition:(id)arg1;
- (void)_enumerateObservers:(id /* block */)arg1;
- (id)_fetchExtensionInstanceWithError:(out id*)arg1;
...
- (id)extensionInstanceWithError:(out id*)arg1;
