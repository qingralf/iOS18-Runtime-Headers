...
@interface _PBFPosterExtensionDataStoreSQLiteDatabaseImpl : NSObject <BSCancellable, BSInvalidatable, PBFPosterExtensionDataStorageMutating, PBFPosterExtensionDataStorageRetrieving> {
    NSURL * _URL;
