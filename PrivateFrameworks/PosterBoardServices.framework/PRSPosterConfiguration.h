...
@property (nonatomic, readonly) bool pr_isHomeScreenDimmed;
@property (nonatomic, readonly) UIColor *pr_suggestedTintColor;
...
+ (id)decodeFromPersistableRepresentation:(id)arg1 expectedContainerIdentifier:(id)arg2 error:(out id*)arg3;
...
- (id)pr_loadQuickActionsConfigurationWithError:(out id*)arg1;
