...
+ (id)posterUpdateHomeScreenAppearanceDimWithValue:(bool)arg1;
+ (id)posterUpdateHomeScreenColor:(id)arg1;
+ (id)posterUpdateHomeScreenGradient:(id)arg1;
+ (id)posterUpdateHomeScreenIconUserInterfaceStyle:(id)arg1;
...
+ (id)posterUpdateHomeScreenSuggestedTintColor:(id)arg1;
+ (id)posterUpdateHomeScreenTintForColor:(id)arg1;
+ (id)posterUpdateHomeScreenTintWithVariation:(id)arg1 saturation:(id)arg2 luminance:(id)arg3;
...
+ (id)posterUpdateShouldUseLargeHomeScreenIcons:(id)arg1;
+ (id)posterUpdateSidebarComplications:(id)arg1;
+ (id)posterUpdateUserInfo:(id)arg1;
