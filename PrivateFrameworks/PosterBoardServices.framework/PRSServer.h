...
@interface PRSServer : NSObject <BSInvalidatable, BSServiceConnectionListenerDelegate, PRSClientToServerInterface> {
...
- (oneway void)runMigration:(id)arg1 migrationDescriptor:(id)arg2 completion:(id /* block */)arg3;
