...
@interface PRUISExternallyHostedPosterEditingServer : NSObject <BSServiceConnectionListenerDelegate, PRUISExternallyHostedPosterEditingClientToServerInterface> {
    BSServiceConnectionListener * _connectionListener;
    NSMutableArray * _connections;
    NSMapTable * _connectionsByEditingRequest;
    <PRUISExternallyHostedPosterEditingServerDelegate> * _delegate;
    NSObject<OS_dispatch_queue> * _queue;
}

@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (nonatomic) <PRUISExternallyHostedPosterEditingServerDelegate> *delegate;
