...
@interface PRUISModalRemoteViewController : UIViewController <BSDescriptionProviding, BSInvalidatable, FBSceneDelegate, FBSceneLayerManagerObserver> {
    <PRUISModalRemoteViewControllerDelegate> * _delegate;
...
@property (nonatomic) <PRUISModalRemoteViewControllerDelegate> *delegate;
...
- (id)_defaultDisplayConfigurationWithScreen:(id)arg1;
