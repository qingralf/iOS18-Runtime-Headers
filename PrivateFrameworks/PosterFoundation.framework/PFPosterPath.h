...
@interface PFPosterPath : NSObject <BSInvalidatable, BSXPCSecureCoding, NSSecureCoding> {
    ...
    PFServerPosterIdentity * _serverIdentity;
...
@property (nonatomic, readonly, copy) PFServerPosterIdentity *serverIdentity;
...
+ (id)temporaryPathForTask:(id)arg1 role:(id)arg2;
+ (id)temporaryPathForURL:(id)arg1 role:(id)arg2;
