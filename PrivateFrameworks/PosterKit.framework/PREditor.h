...
@interface PREditor : NSObject <PRAmbientEditingTitledViewControllerDelegate, PREditingAmbientContentStylePickerViewControllerDelegate, PREditingFontAndColorPickerViewControllerDelegate, PREditingFontAndContentStylePickerViewControllerDelegate, UIAdaptivePresentationControllerDelegate, UISceneDelegate, UIViewControllerTransitioningDelegate, _UISceneComponentProviding, _UISceneSettingsDiffAction> {
...
@property (nonatomic, readonly) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } editingChromeDodgingInsets;
...
@property (nonatomic, retain) PREditingFontAndContentStylePickerViewController *fontAndContentStylePickerViewController;
...
@property (nonatomic, retain) NSHashTable *modalPresentationAssertions;
@property (nonatomic, retain) NSMapTable *modalPresentationAssertionsByViewController;
...
- (void).cxx_destruct;
- (id)_acquireModalPresentationAssertionForReason:(id)arg1;
- (void)_acquireModalPresentationAssertionForViewController:(id)arg1;
...
- (void)_handleTitleStyleEditorChange:(id)arg1;
...
- (void)_presentFontAndContentStylePickerWithPrompt:(id)arg1 titleStyleConfiguration:(id)arg2 contentStylePickerConfiguration:(id)arg3 usingPopoverPresentation:(bool)arg4 popoverSourceItem:(id)arg5 popoverDirection:(unsigned long long)arg6 changeHandler:(id /* block */)arg7;
...
- (id)additionalFontConfigurationsForFontAndContentStylePickerViewController:(id)arg1;
...
- (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })editingChromeDodgingInsets;
...
- (long long)focusedQuickActionPosition;
...
- (id)fontAndContentStylePickerViewController;
- (void)fontAndContentStylePickerViewController:(id)arg1 didUpdateDesiredDetent:(double)arg2;
- (bool)fontAndContentStylePickerViewController:(id)arg1 shouldShowFontConfiguration:(id)arg2;
- (void)fontAndContentStylePickerViewControllerDidFinish:(id)arg1;
...
- (id)modalPresentationAssertions;
- (id)modalPresentationAssertionsByViewController;
...
- (void)setFocusedQuickActionPosition:(long long)arg1;
- (void)setFontAndColorPickerViewController:(id)arg1;
- (void)setFontAndContentStylePickerViewController:(id)arg1;
...
- (void)setModalPresentationAssertions:(id)arg1;
- (void)setModalPresentationAssertionsByViewController:(id)arg1;
