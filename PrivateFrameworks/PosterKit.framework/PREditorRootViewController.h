...
@interface PREditorRootViewController : UIViewController <BSInvalidatable, BSUIScrollViewDelegate, PRDateObserving> {
    ...
    BSUIVibrancyEffectView * _controlsDividerVibrancyView;
    ...
    NSArray * _looks;
    bool  _needsEditingElementsVisibilityUpdate;
    bool  _needsReticleVisibilityUpdate;
    UIPageControl * _pageControl;
    UIView * _presentationDismissalGestureView;
    bool  _presentedGalleryUpdatesLeadingControl;
...
@property (nonatomic, retain) BSUIVibrancyEffectView *controlsDividerVibrancyView;
@property (nonatomic, retain) UIView *controlsDividerView;
...
@property (nonatomic) bool needsEditingElementsVisibilityUpdate;
...
@property (nonatomic) bool presentedGalleryUpdatesLeadingControl;
@property (getter=isPresentingModalViewController, nonatomic) bool presentingModalViewController;
@property (nonatomic, retain) PRQuickActionsSceneHostViewController *quickActionsHostViewController;
...
- (id)controlsDividerVibrancyView;
- (id)controlsDividerView;
- (id)currentLook;
...
- (id)makeQuickActionsHostingSceneWithSpecification:(id)arg1;
...
- (id)quickActionsHostViewController;
- (void)reconnect;
...
- (void)setControlsDividerVibrancyView:(id)arg1;
- (void)setControlsDividerView:(id)arg1;
...
- (void)setNeedsEditingElementsVisibilityUpdate:(bool)arg1;
...
- (void)setPresentedGalleryUpdatesLeadingControl:(bool)arg1;
- (void)setPresentingModalViewController:(bool)arg1;
- (void)setQuickActionsHostViewController:(id)arg1;
