...
@interface PRInlineComplicationGalleryViewController : UIViewController <APSubjectMonitor, CHSWidgetExtensionProviderObserver, PRInlineComplicationGalleryViewDelegate, UICollectionViewDelegate> {
