...
@property (nonatomic, retain) BSUIVibrancyEffectView *vibrancyView;
@property (nonatomic, retain) PRPosterContentStyleVibrantContentRenderer *vibrantStyleRenderer;
...
- (void)setVibrantStyleRenderer:(id)arg1;
