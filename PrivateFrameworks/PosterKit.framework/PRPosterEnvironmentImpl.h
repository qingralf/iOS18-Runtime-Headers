...
@interface PRPosterEnvironmentImpl : NSObject <BSInvalidatable, NSCopying, PRPosterEditingEnvironment, PRPosterRenderingEnvironment_Private, UITraitEnvironment> {
...
- (id)initWithSceneSettings:(id)arg1 traitCollection:(id)arg2 targetConfig:(id)arg3 extensionBundleURL:(id)arg4;
- (void)invalidate;
