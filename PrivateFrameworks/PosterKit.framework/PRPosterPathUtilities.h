...
+ (id)loadQuickActionsConfigurationForPath:(id)arg1 error:(out id*)arg2;
...
+ (id)quickActionsConfigurationURLForInstanceURL:(id)arg1;
+ (id)quickActionsConfigurationURLForPath:(id)arg1;
...
+ (bool)removeQuickActionsConfigurationForPath:(id)arg1 error:(out id*)arg2;
...
+ (bool)storeQuickActionsConfigurationForPath:(id)arg1 quickActionsConfiguration:(id)arg2 error:(out id*)arg3;
