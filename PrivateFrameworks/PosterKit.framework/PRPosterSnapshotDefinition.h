...
- (id)initWithUniqueIdentifier:(id)arg1 includeHeaderElements:(bool)arg2 includesComplications:(bool)arg3 levelSets:(id)arg4 isUnlocked:(bool)arg5 renderingContent:(long long)arg6 renderingMode:(long long)arg7 previewContent:(unsigned long long)arg8 boundingShape:(long long)arg9;
