...
@property (nonatomic, readonly, copy) <PRPosterContentStyle> *effectiveTitleContentStyle;
...
@property (nonatomic, readonly, copy) <PRPosterContentStyle> *titleContentStyle;
...
- (id)initWithTimeFontConfiguration:(id)arg1 preferredTitleAlignment:(unsigned long long)arg2 preferredTitleLayout:(unsigned long long)arg3 titleContentStyle:(id)arg4 timeNumberingSystem:(id)arg5 userConfigured:(bool)arg6 contentsLuminance:(double)arg7 alternateDateEnabled:(bool)arg8 groupName:(id)arg9;
...
- (id)initWithTimeFontConfiguration:(id)arg1 titleContentStyle:(id)arg2;
- (id)initWithTimeFontConfiguration:(id)arg1 titleContentStyle:(id)arg2 timeNumberingSystem:(id)arg3;
