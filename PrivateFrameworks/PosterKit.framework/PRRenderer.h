...
@interface PRRenderer : NSObject <FBSceneDelegate, PRRenderingBackdropViewOwner, UISceneDelegate, _UISceneBSActionResponding, _UISceneComponentProviding, _UISceneSettingsDiffAction> {
    ...
    bool  _wasDepthEffectEffectivelyDisabled;
}
...
- (void)dealloc;
- (void)didInitializeWithEnvironment:(id)arg1;
- (void)didUpdateEnvironment:(id)arg1;
- (id)environment;
