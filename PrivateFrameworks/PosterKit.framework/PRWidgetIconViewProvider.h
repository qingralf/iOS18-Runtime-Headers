...
@interface PRWidgetIconViewProvider : NSObject <SBHReusableViewMapDelegate, SBIconViewDelegate, SBIconViewObserver, SBIconViewProviding> {
    ...
    <SBHRecycledViewsContainerProviding> * _recycledViewsContainerProvider;
...
@property (nonatomic) <SBHRecycledViewsContainerProviding> *recycledViewsContainerProvider;
