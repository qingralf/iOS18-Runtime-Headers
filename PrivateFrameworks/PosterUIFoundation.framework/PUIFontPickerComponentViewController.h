...
@interface PUIFontPickerComponentViewController : UIViewController {
    ...
    <PUIFontPickerComponentViewControllerDelegate> * _delegate;
    double  _fontSize;
    double  _fontWeight;
...
@property (nonatomic) <PUIFontPickerComponentViewControllerDelegate> *delegate;
...
@property (nonatomic, retain) PUIStyleFontPickerButton *selectedCellView;
@property (nonatomic, retain) PUIFontPickerItem *selectedItem;
...
+ (id)defaultItemsForRole:(id)arg1 text:(id)arg2;
