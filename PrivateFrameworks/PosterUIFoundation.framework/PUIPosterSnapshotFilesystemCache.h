...
+ (id)_snapshotURLForPosterPath:(id)arg1 snapshotCacheIdentifier:(id)arg2 interfaceOrientation:(long long)arg3 hardwareIdentifier:(id)arg4 userInterfaceStyle:(long long)arg5 relativeTo:(id)arg6;
...
- (void)invalidate;
- (id)latestSnapshotBundleForPoster:(id)arg1 snapshotCacheIdentifier:(id)arg2 interfaceOrientation:(long long)arg3 userInterfaceStyle:(long long)arg4 hardwareIdentifier:(id)arg5 error:(out id*)arg6;
