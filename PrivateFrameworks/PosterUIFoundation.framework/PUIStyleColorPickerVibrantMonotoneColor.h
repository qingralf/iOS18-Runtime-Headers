...
@interface PUIStyleColorPickerVibrantMonotoneColor : NSObject <BSDescriptionStreamable, BSXPCSecureCoding, NSSecureCoding, PUIStyleColorPickerColor> {
...
@property (nonatomic, copy) PUIStyleColor *activeDisplayColor;
@property (nonatomic, readonly, copy) PUIStyleColor *baseColor;
@property (nonatomic, readonly) PUIStyleColor *color;
...
@property (nonatomic, readonly) PUIStyleColor *leftSliderColor;
@property (nonatomic, readonly, copy) NSString *localizedName;
@property (nonatomic, readonly) PUIStyleColor *rightSliderColor;
