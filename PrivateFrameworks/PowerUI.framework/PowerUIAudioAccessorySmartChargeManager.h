...
- (id)accessoryLog;
- (id)accessoryStates;
- (void)addTimeSeriesDataToStream:(struct timeSeriesData { unsigned long long x1; unsigned char x2; bool x3; }*)arg1 withSide:(unsigned char)arg2 withFirmwareVersion:(unsigned short)arg3 withLog:(id)arg4;
