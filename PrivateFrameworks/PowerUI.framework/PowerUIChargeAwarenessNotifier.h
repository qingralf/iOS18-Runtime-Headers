...
@interface PowerUIChargeAwarenessNotifier : NSObject <UNUserNotificationCenterDelegatePrivate> {
    ...
    bool  _notificationPendingMCL;
    bool  _notificationPendingWireless;
...
@property (nonatomic) bool notificationPendingMCL;
@property (nonatomic) bool notificationPendingWireless;
...
- (void)setLog:(id)arg1;
- (void)setNotificationPendingMCL:(bool)arg1;
- (void)setNotificationPendingWireless:(bool)arg1;
