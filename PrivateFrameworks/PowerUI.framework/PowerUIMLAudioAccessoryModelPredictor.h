...
- (id)getBTConnectionEventsForPredictionUpTo:(id)arg1 forDevice:(id)arg2;
- (id)getBTConnectionEventsUpTo:(id)arg1 withMinimumDuration:(double)arg2 withLimit:(unsigned int)arg3 forDevice:(id)arg4;
- (id)getInputFeaturesForDate:(id)arg1 withEventsInDescendingOrder:(id)arg2 withLog:(id)arg3;
