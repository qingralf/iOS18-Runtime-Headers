...
- (void)getMCLLimitWithHandler:(id /* block */)arg1;
...
- (void)setMCLLimit:(unsigned char)arg1 withHandler:(id /* block */)arg2;
...
- (void)temporarilyDisableMCLWithHandler:(id /* block */)arg1;
