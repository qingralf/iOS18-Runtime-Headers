...
@interface PowerUISmartChargeManager : NSObject <ACCConnectionInfoDelegateProtocol, NSXPCListenerDelegate, PowerUINotificationManagerClient, PowerUISignalMonitorDelegate, PowerUISmartChargeManaging, PowerUISmartChargeManagingPrivate> {
    ...
    bool  _manualChargeLimitWasEverEnabled;
...
@property (nonatomic, retain) NSDate *potentialUnplugDate;
...
- (id)adjustedFullChargeDeadlineWithSignals:(id)arg1 withDesktopMode:(bool)arg2 withFullChargeDeadline:(id)arg3 withResult:(id)arg4;
...
- (struct __CFString { }*)chargeLimitToken;
...
- (void)checkWhetherMCLTempDisablementCanBeClearedOnPlugin:(bool)arg1;
...
- (void)evaluateChargeLimitRecommendationForced:(bool)arg1;
...
- (void)handleNewPluginWithBatteryLevel:(int)arg1 pluginDate:(id)arg2;
- (void)handleNotificationResponse:(id)arg1;
- (void)handleTopOffSupervisorEvent;
- (void)handleTopOffSupervisorEventInternal;
- (void)handleUnplugAtDate:(id)arg1 withBatteryLevel:(int)arg2;
...
- (id)initWithDefaultsDomain:(id)arg1 contextStore:(id)arg2 beforeHandlingBatteryChangeCallback:(id /* block */)arg3 afterHandlingBatteryChangeCallback:(id /* block */)arg4;
...
- (void)loadDefaults;
- (id)log;
- (unsigned long long)manualChargeLimitStatus;
- (bool)manualChargeLimitWasEverEnabled;
- (id)mclDisabledUntilDate;
...
- (unsigned long long)recommendedLimit;
...
- (void)requestPeriodicCheckWithDuration:(double)arg1 withAlarmKey:(const char *)arg2;
...
- (void)setChargeLimitToken:(struct __CFString { }*)arg1;
...
- (void)setCheckpoint:(unsigned long long)arg1 withSelector:(SEL)arg2 forceWrite:(bool)arg3;
...
- (void)setDebounceOverride:(double)arg1;
...
- (id)setFullChargeDeadline:(id)arg1;
...
- (void)setLog:(id)arg1;
- (void)setMCLLimit:(unsigned char)arg1;
- (void)setManualChargeLimitStatus:(unsigned long long)arg1;
- (void)setManualChargeLimitWasEverEnabled:(bool)arg1;
- (void)setMclDisabledUntilDate:(id)arg1;
...
- (void)setPotentialUnplugDate:(id)arg1;
...
- (void)setRecommendedLimit:(unsigned long long)arg1;
...
- (bool)shouldContinueAfterMCMCheckWithBatteryLevel:(int)arg1 withIsCharging:(bool)arg2 withIsExternalConnected:(bool)arg3 withIsPluggedIn:(bool)arg4;
...
- (void)updateTimeLineForCurrentBatteryLevel:(int)arg1 withIsExternalConnected:(bool)arg2 forDate:(id)arg3;
