...
- (id)fedStatsStringsFromManifestBundlesAtURLs:(id)arg1 withCompletion:(id /* block */)arg2;
- (id)hasItemsQuery;
...
- (void)indexManifestBundlesAtURLs:(id)arg1 skippingBundles:(id)arg2 skippingManifests:(id)arg3 withCompletion:(id /* block */)arg4;
...
- (id)readManifestBundlesAtURLs:(id)arg1 skippingBundles:(id)arg2 skippingManifests:(id)arg3;
...
- (id)searchableItemsFromManifest:(id)arg1 specifier:(id)arg2 bundle:(id)arg3 processCapabilities:(bool)arg4;
