...
@interface PSListController : PSViewController <PSSpecifierObserver, PSURLControllerHandlerDelegate, PSViewControllerOffsetProtocol, UIAlertViewDelegate, UIAppearance, UIPopoverPresentationControllerDelegate, UITableViewDataSource, UITableViewDataSourcePrefetching, UITableViewDelegate> {
    ...
    <PSListControllerAppearanceProvider> * _appearanceProvider;
    ...
    <PSListControllerNavigationCoordinator> * _navigationCoordinator;
...
@property (nonatomic, retain) <PSListControllerAppearanceProvider> *appearanceProvider;
...
@property (nonatomic, retain) <PSListControllerNavigationCoordinator> *navigationCoordinator;
...
@property (nonatomic, readonly) NSArray *unprotectedSpecifiers;
...
- (double)_tableView:(id)arg1 estimatedHeightForCustomInSection:(long long)arg2 isHeader:(bool)arg3;
...
- (void)handleScrollPPTTestName:(id)arg1;
...
- (void)st_devicePINController:(id)arg1 didAcceptChangedPIN:(id)arg2;
- (void)st_devicePINController:(id)arg1 didAcceptSetPIN:(id)arg2;
- (void)st_devicePINControllerDidDismissPINPane:(id)arg1;
- (void)st_didAcceptEnteredPIN:(id)arg1;
- (void)st_didAcceptRemovePIN;
- (void)st_didCancelEnteringPIN;
- (bool)st_shouldShowPINSheetForPINSpecifier;
- (bool)st_shouldShowPINSheetForSpecifier:(id)arg1;
- (void)st_showPINSheet:(id)arg1 completion:(id /* block */)arg2;
- (void)st_showPINSheetWithCompletion:(id /* block */)arg1;
- (bool)st_validatePIN:(id)arg1 forPINController:(id)arg2;

// Image: /System/Library/PrivateFrameworks/Settings/PrivacySettingsUI.framework/PrivacySettingsUI

- (id)pui_replaceRows:(id)arg1 withRows:(id)arg2 header:(id)arg3 insertPoint:(id)arg4;

// Image: /System/Library/PrivateFrameworks/SoftwareUpdateSettingsUI.framework/SoftwareUpdateSettingsUI

- (void)addNavigationEventForSystemSettings:(id)arg1;
- (void)addNavigationEventForSystemSettings:(id)arg1 andRelativeLinkToSoftwareUpdate:(id)arg2;
