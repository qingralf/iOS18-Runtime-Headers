...
+ (id)imageForApplicationBundleIdentifier:(id)arg1;
...
- (SEL)_ics_selectorForKey:(id)arg1;
- (void)ics_overrideAccessorsWithTarget:(id)arg1 getter:(SEL)arg2 setter:(SEL)arg3;
- (id)ics_performSuperGetter;
- (void)ics_performSuperSetterWithValue:(id)arg1;
