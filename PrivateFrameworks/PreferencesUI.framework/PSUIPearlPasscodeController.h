...
- (id)presenter;
- (void)proceedToEnrollGlassesForExistingAppearance:(id)arg1;
- (void)proceedToEnrollPeriocularForExistingAppearance:(id)arg1;
- (void)proceedToEnrollWithSpecifier:(id)arg1;
- (void)proceedWithChecksToDeleteFaceIDWithSpecifier:(id)arg1;
...
- (void)toggleToState:(bool)arg1 forIdentifier:(id)arg2;
