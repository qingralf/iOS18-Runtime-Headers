...
+ (id)paperListWithAttrs:(const struct GET_PRINTER_ATTRIBUTES_Response { id x1; }*)arg1 translations:(id)arg2;
...
- (id)initWithParams:(const struct GET_PRINTER_ATTRIBUTES_Response { id x1; }*)arg1 translations:(id)arg2;
