...
+ (void)printerWithiCloudPrinter:(id)arg1 discoveryTime:(double)arg2 completionHandler:(id /* block */)arg3;
...
- (void)printURL:(id)arg1 ofType:(id)arg2 printSettings:(id)arg3 completionHandlerWithLocalJobNumber:(id /* block */)arg4;
- (id)printerImageData;
- (id)printerURL;
