...
@interface PKPrinterDescription : NSObject <NSSecureCoding, PKPropertyVisitable, PKUserCodable> {
    ...
    bool  _wantsComprehensivePaperList;
}
...
@property (readonly) bool wantsComprehensivePaperList;
...
- (void).cxx_destruct;
- (id)_calcDeviceID:(const struct GET_PRINTER_ATTRIBUTES_Response { id x1; }*)arg1;
- (id)_calcFinishingTemplates:(const struct GET_PRINTER_ATTRIBUTES_Response { id x1; }*)arg1;
- (unsigned long long)_calcIdentifyActions:(const struct GET_PRINTER_ATTRIBUTES_Response { id x1; }*)arg1;
- (id)_calcInputSlots:(const struct GET_PRINTER_ATTRIBUTES_Response { id x1; }*)arg1;
- (long long)_calcJobAccountIDSupport:(const struct GET_PRINTER_ATTRIBUTES_Response { id x1; }*)arg1;
- (id)_calcJobPresets:(const struct GET_PRINTER_ATTRIBUTES_Response { id x1; }*)arg1;
- (id)_calcMediaTypes:(const struct GET_PRINTER_ATTRIBUTES_Response { id x1; }*)arg1;
- (id)_calcOutputBins:(const struct GET_PRINTER_ATTRIBUTES_Response { id x1; }*)arg1;
- (bool)_calcPrintScalingSupported:(const struct GET_PRINTER_ATTRIBUTES_Response { id x1; }*)arg1;
- (void)_calcPrinterDriverInfo:(const struct GET_PRINTER_ATTRIBUTES_Response { id x1; }*)arg1;
- (id)_calcSpecialFeedOrientation:(const struct GET_PRINTER_ATTRIBUTES_Response { id x1; }*)arg1;
- (id)_calculateFormats:(const struct GET_PRINTER_ATTRIBUTES_Response { id x1; }*)arg1;
- (id)_calculateMediaColSupportedArray:(const struct GET_PRINTER_ATTRIBUTES_Response { id x1; }*)arg1;
- (id)_calculateOutputModes:(const struct GET_PRINTER_ATTRIBUTES_Response { id x1; }*)arg1;
- (id)_calculatePaperList:(const struct GET_PRINTER_ATTRIBUTES_Response { id x1; }*)arg1;
- (id)_calculateQuality:(const struct GET_PRINTER_ATTRIBUTES_Response { id x1; }*)arg1;
- (id)_calculateSides:(const struct GET_PRINTER_ATTRIBUTES_Response { id x1; }*)arg1;
- (void)_ingestAttrs:(const struct GET_PRINTER_ATTRIBUTES_Response { id x1; }*)arg1;
...
- (id)formats;
- (int)identifyActions;
- (id)initWithAttributes:(const struct GET_PRINTER_ATTRIBUTES_Response { id x1; }*)arg1 translations:(id)arg2;
- (id)initWithAttributes:(const struct GET_PRINTER_ATTRIBUTES_Response { id x1; }*)arg1 txtRecord:(id)arg2 translations:(id)arg3;
...
- (id)jobPresets;
- (id)jpegFeatures;
- (id)makeTXTRecordWithURL:(id)arg1;
