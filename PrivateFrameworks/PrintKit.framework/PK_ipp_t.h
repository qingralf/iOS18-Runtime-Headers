...
- (void)_addRanges:(int)arg1 name:(id)arg2 values:(id)arg3;
...
- (id)addNewEmptyAttribute:(id)arg1 groupTag:(int)arg2 valueTag:(int)arg3;
- (id)attrs;
...
- (void)replaceOrAddAttribute:(id)arg1 withAttribute:(id)arg2 settingGroup:(int)arg3;
...
- (void)withNewAttr:(id)arg1 groupTag:(int)arg2 valueTag:(int)arg3 apply:(id /* block */)arg4;
