...
@property (nonatomic, readonly) bool supportsSameMinuteAccessCountLogging;
...
- (id)initWithAccessor:(id)arg1 identifier:(id)arg2 kind:(long long)arg3 assetIdentifiers:(id)arg4 visibilityState:(long long)arg5 accessEventCount:(unsigned long long)arg6 accessCount:(unsigned long long)arg7;
