...
- (void)dealloc;
- (id)delegate;
- (void)endIntervalWithSlot:(id)arg1 timestampAdjustment:(double)arg2 accessCount:(long long)arg3;
...
- (id)initWithConnection:(id)arg1 queue:(id)arg2 enablementChangedNotificationName:(id)arg3 options:(unsigned long long)arg4;
- (id)initWithConnection:(id)arg1 queue:(id)arg2 forcingOptions:(unsigned long long)arg3 error:(id*)arg4;
