...
- (struct PCColor { struct ColorComponents { int x_1_1_1; double x_1_1_2[5]; } x1; struct PCCFRef<CGColorSpace *> { struct CGColorSpace {} *x_2_1_1; } x2; })colorForIndex:(int)arg1;
- (int)colorIndex;
