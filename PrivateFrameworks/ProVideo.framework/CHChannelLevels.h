...
- (id)blackChannel;
- (double)blackValueAtTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg1;
- (id)gammaChannel;
- (double)gammaValueAtTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg1;
- (void*)ozChannel;
- (id)whiteChannel;
- (double)whiteValueAtTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg1;
