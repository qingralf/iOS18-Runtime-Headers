...
- (void)getPositionAtTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg1 curveX:(double*)arg2 curveY:(double*)arg3 curveZ:(double*)arg4;
- (void)getPositionAtTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg1 x:(double*)arg2 y:(double*)arg3 z:(double*)arg4;
- (void)offsetPositionAtTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg1 deltaX:(double)arg2 deltaY:(double)arg3 deltaZ:(double)arg4 options:(unsigned int)arg5;
- (void*)ozChannel;
- (void)setDefaultCurveX:(double)arg1 curveY:(double)arg2 curveZ:(double)arg3;
- (void)setDoubleValuesAtTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg1 curveX:(double)arg2 curveY:(double)arg3 curveZ:(double)arg4 options:(unsigned int)arg5;
