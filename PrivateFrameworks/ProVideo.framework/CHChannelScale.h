...
- (void)getScaleAtTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg1 curveX:(double*)arg2 curveY:(double*)arg3;
- (void)getScaleAtTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg1 x:(double*)arg2 y:(double*)arg3;
- (void*)ozChannel;
