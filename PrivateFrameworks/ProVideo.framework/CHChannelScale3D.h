...
- (void)getScaleAtTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg1 curveX:(double*)arg2 curveY:(double*)arg3 curveZ:(double*)arg4;
- (void)getScaleAtTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg1 x:(double*)arg2 y:(double*)arg3 z:(double*)arg4;
- (void*)ozChannel;
...
- (void)setScaleAtTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg1 curveX:(double)arg2 curveY:(double)arg3 curveZ:(double)arg4 options:(unsigned int)arg5;
- (id)zChannel;
