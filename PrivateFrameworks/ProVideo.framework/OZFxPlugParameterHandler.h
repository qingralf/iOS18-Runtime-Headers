...
- (void)callParameterChanged:(id)arg1 forParameterID:(unsigned int)arg2 modifiedParameterIDs:(void*)arg3 changedParameters:(id)arg4 supportsParametersChanged:(bool)arg5;
...
- (void*)contextManager;
- (double)convertFromFigTime:(const struct { long long x1; int x2; unsigned int x3; long long x4; }*)arg1 meOffset:(double)arg2 motionEffect:(id)arg3;
- (struct { long long x1; int x2; unsigned int x3; long long x4; })convertToFigTime:(double)arg1 meOffset:(double)arg2 motionEffect:(id)arg3;
...
- (bool)getAnalysisTexture:(id*)arg1 requestInfo:(struct { union { double x_1_1_1; struct { /* ? */ } *x_1_1_2; } x1; unsigned long long x2; unsigned long long x3; double x4; double x5; unsigned long long x6; })arg2 fromParm:(unsigned int)arg3 atFxTime:(union { double x1; struct { /* ? */ } *x2; })arg4;
...
- (struct OZFxPlugColorTransformInfo { struct FxColorDescription { struct PCColorDescription { struct PCCFRef<CGColorSpace *> { struct CGColorSpace {} *x_1_3_1; } x_1_2_1; int x_1_2_2; struct PCToneMapMethod { int x_3_3_1; float x_3_3_2; } x_1_2_3; } x_1_1_1; bool x_1_1_2; } x1; struct FxColorDescription { struct PCColorDescription { struct PCCFRef<CGColorSpace *> { struct CGColorSpace {} *x_1_3_1; } x_1_2_1; int x_1_2_2; struct PCToneMapMethod { int x_3_3_1; float x_3_3_2; } x_1_2_3; } x_2_1_1; bool x_2_1_2; } x2; })getColorTransformInfo;
...
- (struct PCNSRef<FFMotionEffect *> { struct PCNSRefImpl { id x_1_1_1; } x1; })motionEffectRef;
...
- (bool)retrieveImage:(id*)arg1 layerOffsetX:(double*)arg2 layerOffsetY:(double*)arg3 requestInfo:(struct { union { double x_1_1_1; struct { /* ? */ } *x_1_1_2; } x1; unsigned long long x2; unsigned long long x3; double x4; double x5; unsigned long long x6; })arg4 fromParm:(unsigned int)arg5 atTime:(union { double x1; struct { /* ? */ } *x2; })arg6 retriever:(SEL)arg7 ARGB:(bool)arg8 imageType:(unsigned long long)arg9 forAnalysis:(bool)arg10;
