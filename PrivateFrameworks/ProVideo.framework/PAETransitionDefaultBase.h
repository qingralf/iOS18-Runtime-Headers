...
- (bool)addParameters;
- (bool)applyHDRWhiteLevelForRGBComponents:(double*)arg1 inColorSpace:(struct CGColorSpace { }*)arg2;
- (bool)applyHDRWhiteLevelForRed:(double*)arg1 green:(double*)arg2 blue:(double*)arg3 inColorSpace:(struct CGColorSpace { }*)arg4;
...
- (bool)disableHDRWhiteLevelParameter:(bool)arg1;
...
- (bool)showHideHDRWhiteLevelParameterForColorModel:(id)arg1;
