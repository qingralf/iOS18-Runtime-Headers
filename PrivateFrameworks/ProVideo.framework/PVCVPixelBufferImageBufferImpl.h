...
@interface PVCVPixelBufferImageBufferImpl : NSObject <PVImageBufferImpl> {
    ...
    PVColorSpace * _sourceColorSpace;
}

@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (readonly, copy) NSString *description;
@property (readonly) unsigned long long hash;
@property (nonatomic, readonly) PVColorSpace *sourceColorSpace;
...
- (id)initWithCVPixelBuffer:(struct __CVBuffer { }*)arg1 withSourceColorSpace:(id)arg2;
