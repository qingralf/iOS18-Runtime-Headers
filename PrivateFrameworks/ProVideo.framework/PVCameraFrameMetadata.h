...
@property (nonatomic, readonly) double captureHorizonAngle;
...
+ (id)frameMetadataWithAngle:(long long)arg1 :(struct { double x1; double x2; double x3; double x4; })arg2 :(double)arg3 :(long long)arg4 :(double)arg5;
