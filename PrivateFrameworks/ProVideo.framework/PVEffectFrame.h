...
@interface PVEffectFrame : NSObject {
    ...
    double  _hitSizeThreshold;
    double  _minimumHitSize;
    struct CGRect { 
        struct CGPoint { 
            double x; 
            double y; 
...
+ (id)frameWithEffect:(id)arg1 atTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2 forcePosterFrame:(bool)arg3 includeDropShadow:(bool)arg4 includeTextFrames:(bool)arg5 minimumHitSize:(double)arg6 hitSizeThreshold:(double)arg7 viewSize:(struct CGSize { double x1; double x2; })arg8 viewOrigin:(int)arg9;
...
- (id)initWithEffect:(id)arg1 atTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2 forcePosterFrame:(bool)arg3 includeDropShadow:(bool)arg4 includeTextFrames:(bool)arg5 minimumHitSize:(double)arg6 hitSizeThreshold:(double)arg7 viewSize:(struct CGSize { double x1; double x2; })arg8 viewOrigin:(int)arg9;
...
- (void)setHitSizeThreshold:(double)arg1;
- (void)setMinimumHitSize:(double)arg1;
