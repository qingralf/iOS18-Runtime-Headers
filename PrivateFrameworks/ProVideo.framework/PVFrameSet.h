...
+ (id)frameSetWithARMetadata:(id)arg1 depthData:(id)arg2 depthFreshness:(int)arg3 matte:(id)arg4 dilatedDepth:(id)arg5 timestamp:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg6 frameDuration:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg7 metadata:(id)arg8;
