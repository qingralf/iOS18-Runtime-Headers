...
+ (id)imageWithCGImage:(struct CGImage { }*)arg1 withSourceColorSpace:(id)arg2 withDestColorSpace:(id)arg3;
...
+ (id)imageWithProResLogCGImage:(struct CGImage { }*)arg1 forColorSpace:(int)arg2;
+ (id)imageWithProResLogCVPixelBuffer:(struct __CVBuffer { }*)arg1 forColorSpace:(int)arg2;
+ (id)imageWithProResLogUIImage:(id)arg1 forColorSpace:(int)arg2;
