...
- (void).cxx_destruct;
- (void*)_textObjectIDs_NoLock:(const void*)arg1;
- (id)attributedStringAtIndex:(unsigned long long)arg1;
- (id)attributedStringAtIndex_NoLock:(unsigned long long)arg1 properties:(id)arg2;
- (void)beginEditingTextAtIndex:(unsigned int)arg1;
- (void)beginTextEditing;
- (void)dealloc;
- (id)defaultAttributedString:(unsigned long long)arg1;
- (id)defaultAttributedStringAtIndex_NoLock:(unsigned long long)arg1;
...
- (id)textObjectIDs_NoLock:(const void*)arg1;
- (unsigned long long)textObjectsCount_NoLock:(const void*)arg1;
