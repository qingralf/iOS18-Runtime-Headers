...
+ (id)defaultOutputColorSpaceWithRenderingIntent:(int)arg1;
+ (id)defaultWorkingColorSpaceWithOutputColorSpace:(id)arg1;
...
- (id)initWithDevice:(int)arg1 defaultColorSpace:(id)arg2;
- (id)initWithDevice:(int)arg1 workingColorSpace:(id)arg2 outputColorSpace:(id)arg3;
- (id)initWithDeviceForDisplay:(int)arg1;
- (id)initWithDeviceForExport:(int)arg1;
- (int)instructionGraphDotTreeLevel;
- (int)instructionGraphDumpLevel;
- (int)numCPUThreads;
- (id)outputColorSpace;
