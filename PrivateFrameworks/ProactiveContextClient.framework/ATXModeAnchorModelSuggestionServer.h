...
- (void)dealloc;
- (id)delegate;
- (void)fetchCombinedSuggestionScoreAndFlagsForModeWithUUID:(id)arg1 modeType:(int)arg2 origin:(int)arg3 originBundleId:(id)arg4 originAnchorType:(id)arg5 confidenceScore:(double)arg6 secondsSinceSuggested:(double)arg7 serializedTriggers:(id)arg8 completionHandler:(id /* block */)arg9;
- (void)fetchCombinedSuggestionScoreForModeEvent:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)fetchCombinedSuggestionScoreForModeWithUUID:(id)arg1 modeType:(int)arg2 origin:(int)arg3 originBundleId:(id)arg4 originAnchorType:(id)arg5 confidenceScore:(double)arg6 secondsSinceSuggested:(double)arg7 serializedTriggers:(id)arg8 completionHandler:(id /* block */)arg9;
- (id)init;
