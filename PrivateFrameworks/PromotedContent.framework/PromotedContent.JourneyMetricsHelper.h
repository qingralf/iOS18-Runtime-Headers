...
@interface PromotedContent.JourneyMetricsHelper : NSObject <APPCCarouselMetricsHelping, APPCJourneyMetricsHelping, APPCJourneyMetricsNotificationsHelping, APPCMetricRegister> {
    ...
    void newsSupplementalContext;
    void notificationOwner;
    void onPromotedContentComplete;
    void orderVendor;
    void originalContentIdentifier;
    void percentVisible;
...
- (void)interactedWithType:(long long)arg1;
- (void)interstitialOnScreenWithCollapsed:(bool)arg1;
...
- (void)ready;
- (id)registerForPCUsedEventWithAction:(id /* block */)arg1;
...
- (void)unregisterForPCUsedEventWithListenerID:(id)arg1;
