...
@interface APOdmlFeatureHandler : NSObject {
    ...
    MLFeatureValue * _userQueryVector;
}
...
@property (nonatomic, retain) MLFeatureValue *userQueryVector;
...
- (id)assetManager;
- (id)batchInput;
- (id)computeUserQueryVectorWithResponses:(id)arg1;
...
- (void)saveFeaturesFromResponse:(id)arg1;
...
- (void)setUserQueryVector:(id)arg1;
- (id)userQueryVector;
