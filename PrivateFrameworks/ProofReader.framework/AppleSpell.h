...
- (id)_lexiconsForLanguage:(id)arg1 loadType:(long long)arg2;
- (id)_lexiconsForLanguageObject:(id)arg1;
- (id)_loadLexiconsForLanguage:(id)arg1 localization:(id)arg2 cachedOnly:(bool)arg3 onQueue:(id)arg4;
- (id)_loadNERTaggerOnQueue:(id)arg1;
...
- (id)_taggerForOrthoIndex:(unsigned long long)arg1;
...
- (void)enumerateLexiconEntriesForWord:(id)arg1 language:(id)arg2 usingBlock:(id /* block */)arg3;
...
- (id)lexiconsForLanguageObject:(id)arg1;
...
- (id)nerTaggerWaitForResult:(bool)arg1;
...
- (id)regionalCorrectionsDictionaryForLanguageObject:(id)arg1;
...
- (id)spellServer:(id)arg1 regionalCorrectionForWord:(id)arg2 language:(id)arg3;
- (bool)spellServer:(id)arg1 shouldBlockWord:(id)arg2 language:(id)arg3 offensiveOnly:(bool)arg4;
...
- (id)transformerOrSiriLanguageModelForLanguageObject:(id)arg1 appIdentifier:(id)arg2 waitForResult:(bool)arg3;
