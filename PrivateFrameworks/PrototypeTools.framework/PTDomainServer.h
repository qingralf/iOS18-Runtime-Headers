...
@property (nonatomic, retain) PTParameterRecords *parameterRecordsOfTunedSettings;
@property (readonly) Class superclass;
@property (nonatomic, readonly) NSDictionary *testRecipeInfoByID;

- (void).cxx_destruct;
- (bool)_hasValueChangedFromDefault:(id)arg1 forKeypath:(id)arg2 settingsClassName:(id)arg3;
...
- (id)parameterRecordsOfTunedSettings;
- (void)persistChanges;
...
- (void)setParameterRecordsOfTunedSettings:(id)arg1;
