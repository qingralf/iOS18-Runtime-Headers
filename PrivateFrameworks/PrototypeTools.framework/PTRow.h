...
+ (id)px_rowWithTitle:(id)arg1 protoViewControllerFactoryClassName:(id)arg2;
+ (id)px_rowWithTitle:(id)arg1 protoViewControllerFactoryClassName:(id)arg2 options:(id)arg3;
