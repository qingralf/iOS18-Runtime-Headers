...
@interface PRXCardContentViewController : UIViewController <PRXCardContentProviding, PRXPullDismissalProvider, ProximityAppleIDSetupUI.PASUISourcePresentationViewController, UIScrollViewDelegate> {
    NSArray * _actions;
...
@property (nonatomic, readonly) bool allowsPullToDismiss; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) long long cardStyle; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) <_TtP23ProximityAppleIDSetupUI27PASUISourcePresentationView_> *mainView;
...
- (void)setAuxiliaryButtonWithSymbolName:(id)arg1 handler:(id /* block */)arg2;
...
- (void)carSetup_addMainContentCenteredView:(id)arg1 size:(struct CGSize { double x1; double x2; })arg2;
