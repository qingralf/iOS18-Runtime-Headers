...
@interface PASUIMicaPlayer : NSObject <NSCopying> {
    <PASUIMicaPlayerDelegate> * _delegate;
    double  _documentDuration;
    bool  _isNotifyingDelegate;
...
@property (nonatomic) <PASUIMicaPlayerDelegate> *delegate;
@property (nonatomic) double documentDuration;
@property (nonatomic) bool isNotifyingDelegate;
...
- (void)setIsNotifyingDelegate:(bool)arg1;
