...
@interface U2HeadOutput : NSObject <MLFeatureProvider> {
    ...
    MLMultiArray * _safety_head_scores;
...
@property (nonatomic, retain) MLMultiArray *safety_head_scores;
...
- (id)initWithTop_arg_ids:(id)arg1 arg_conf_scores:(id)arg2 intent_scores:(id)arg3 safety_head_scores:(id)arg4;
- (id)intent_scores;
- (id)safety_head_scores;
- (void)setArg_conf_scores:(id)arg1;
- (void)setIntent_scores:(id)arg1;
- (void)setSafety_head_scores:(id)arg1;
