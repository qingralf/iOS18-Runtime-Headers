...
- (id)getU2PredictionsForEmbedding:(id)arg1 queryString:(id)arg2 spans:(id)arg3 tokens:(id)arg4 tokenRanges:(id)arg5 subtokenLenForTokens:(id)arg6 subtokens:(id)arg7 error:(id*)arg8;
