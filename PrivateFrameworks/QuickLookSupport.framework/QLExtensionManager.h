...
- (void)extensionContextForContentType:(id)arg1 allowExtensionsForParentTypes:(bool)arg2 firstPartyExtensionOnly:(bool)arg3 appBundleIdentifier:(id)arg4 extensionPath:(id)arg5 extensionType:(unsigned long long)arg6 generationType:(unsigned long long)arg7 withCompletionHandler:(id /* block */)arg8;
