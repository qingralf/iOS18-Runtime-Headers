...
@property (nonatomic, readonly) struct os_unfair_lock_s { unsigned int x1; } cacheInitLock;
...
- (void)_addThumbnailRequestBatchToQueue:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)_cacheThumbnailData:(id)arg1 forRequest:(id)arg2 imageSource:(struct CGImageSource { }*)arg3 actualSize:(struct CGSize { double x1; double x2; })arg4 resultSize:(struct CGSize { double x1; double x2; })arg5 fromGenStore:(bool)arg6 completionHandler:(id /* block */)arg7;
...
- (void)_notifyGenerationHandlerOfThumbnailGenerationForRequest:(id)arg1 images:(id)arg2 metadata:(id)arg3 contentRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg4 iconFlavor:(int)arg5 thumbnailRepresentation:(long long)arg6 clientShouldTakeOwnership:(bool)arg7 error:(id)arg8;
...
- (bool)_saveResultForThumbnailRequest:(id)arg1 withImage:(id)arg2 error:(id*)arg3;
...
- (struct os_unfair_lock_s { unsigned int x1; })cacheInitLock;
- (id)cacheThread;
...
- (void)completeThumbnailRequest:(id)arg1 images:(id)arg2 metadata:(id)arg3 contentRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg4 thumbnailRepresentation:(long long)arg5 iconFlavor:(int)arg6 clientShouldTakeOwnership:(bool)arg7;
...
- (void)generateSuccessiveThumbnailRepresentationsForGeneratorRequests:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)processLargeThumbnailData:(id)arg1 withContentType:(id)arg2 isAppContainer:(bool)arg3 forRequest:(id)arg4 fromGenStore:(bool)arg5 completionHandler:(id /* block */)arg6;
...
- (void)reset;
- (void)sendResultForThumbnailRequest:(id)arg1 images:(id)arg2 metadata:(id)arg3 contentRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg4 iconFlavor:(int)arg5 thumbnailRepresentation:(long long)arg6 clientShouldTakeOwnership:(bool)arg7 reenqueueRequest:(bool)arg8 error:(id)arg9;
