...
@property (nonatomic) bool shouldPreventMachineReadableCodeDetection;
...
- (id)initWithURL:(id)arg1 previewTitle:(id)arg2 editingMode:(long long)arg3;
- (id)initWithURLSandboxWrapper:(id)arg1;
- (id)initWithURLSandboxWrapper:(id)arg1 previewTitle:(id)arg2 editingMode:(long long)arg3;
- (id)internalCopy;
