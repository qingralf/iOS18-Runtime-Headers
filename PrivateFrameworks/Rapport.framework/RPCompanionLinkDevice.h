...
@property (readonly) NSString *CC_companionLinkDeviceIdentifier;
...
@property (nonatomic) BOOL standaloneWatch;
...
- (bool)isEqualToDeviceBasic:(id)arg1;
- (bool)isPersonal;
- (id)launchInstanceID;
- (int)listeningPort;
...
- (void)setStandaloneWatch:(BOOL)arg1;
- (void)setUiTriggered:(bool)arg1;
- (id)siriInfo;
- (BOOL)standaloneWatch;
- (bool)uiTriggered;
