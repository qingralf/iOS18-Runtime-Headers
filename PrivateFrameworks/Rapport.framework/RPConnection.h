...
@property (nonatomic, retain) RPCloudDaemon *cloudDaemon;
...
@property (nonatomic, retain) NSMutableSet *inUseProcesses;
...
- (void)_clientStarted;
- (void)_configureForSessionPairing:(id)arg1;
...
- (void)_identityProofsAddWithHomeKitUUID:(id)arg1;
...
- (void)_invalidated;
- (void)_logConnectionInvalidatedWithError:(id)arg1;
...
- (bool)_receivedSystemInfo:(id)arg1 xid:(id)arg2;
- (void)_run;
...
- (void)_sendEncryptedResponse:(id)arg1 options:(id)arg2 error:(id)arg3 xid:(id)arg4 requestID:(id)arg5 highPriority:(bool)arg6 isChatty:(bool)arg7 replyStartTime:(id)arg8;
...
- (id)bleConnection;
- (unsigned short)bleConnectionPSM;
...
- (bool)containsInUseProcess:(int)arg1;
...
- (void)removeInUseProcess:(int)arg1;
...
- (void)setBleConnectionPSM:(unsigned short)arg1;
...
- (void)setInUseProcesses:(id)arg1;
...
- (unsigned long long)statusFlagsUsingIdentities:(id)arg1;
- (id)tcpConnection;
