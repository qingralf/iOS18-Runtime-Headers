...
@property (nonatomic, copy) NSData *encodedBLETargetData;
...
- (void)setEncodedBLETargetData:(id)arg1;
...
- (unsigned int)updateTrustStatusFlagsWithIdentity:(id)arg1;
