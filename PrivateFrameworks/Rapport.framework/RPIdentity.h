...
@property (nonatomic, copy) NSArray *allUsedSendersKnownAliases;
...
- (id)deviceIRKData;
- (bool)disabled;
- (unsigned long long)disabledUntilTicks;
- (id)edPKData;
- (id)edSKData;
...
- (void)setAcl:(id)arg1;
- (void)setAllUsedSendersKnownAliases:(id)arg1;
...
- (void)setDisabledUntilTicks:(unsigned long long)arg1;
