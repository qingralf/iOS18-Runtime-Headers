...
@property (nonatomic, retain) RPTransportServiceHandoverMessage *localAuthenticationMessage;
@property (nonatomic, retain) RPTransportServiceHandoverMessage *localValidationMessage;
...
- (bool)isConnected;
- (bool)isInitiator;
- (id)localAuthenticationMessage;
- (id)localValidationMessage;
...
- (void)setLocalAuthenticationMessage:(id)arg1;
- (void)setLocalValidationMessage:(id)arg1;
