...
@interface RPNearFieldTapEvent : NSObject <NSSecureCoding> {
    ...
    bool  _isSameAccount;
    bool  _isUnsupportedApplicationLabel;
    NSData * _pkData;
    bool  _shouldForceSingleBandAWDLMode;
}

@property (nonatomic, copy) NSString *accountID;
@property (nonatomic, readonly) NSString *applicationDomain;
...
@property (nonatomic, readonly) bool isUnsupportedApplicationLabel;
...
- (id)initWithIdentifier:(id)arg1 applicationLabel:(id)arg2 pkData:(id)arg3 bonjourListenerUUID:(id)arg4 isSameAccount:(bool)arg5 contactID:(id)arg6 accountID:(id)arg7 forceSingleBandAWDLMode:(bool)arg8 knownIdentity:(bool)arg9 isUnsupportedApplicationLabel:(bool)arg10 flags:(unsigned int)arg11;
