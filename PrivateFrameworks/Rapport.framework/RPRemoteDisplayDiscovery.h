...
- (bool)_checkRSSIThresholdForDevice:(id)arg1;
...
- (void)remoteDisplayDedicatedDeviceChanged:(id)arg1;
...
- (void)requestDedicatedDeviceConfirmationWithCompletion:(id /* block */)arg1;
- (long long)rssiThreshold;
- (void)saveDedicatedDevice:(id)arg1;
...
- (void)setPersonSelected:(id)arg1 forDedicatedPairing:(bool)arg2;
- (void)setRssiThreshold:(long long)arg1;
- (void)setTriggerEnhancedDiscovery:(bool)arg1;
