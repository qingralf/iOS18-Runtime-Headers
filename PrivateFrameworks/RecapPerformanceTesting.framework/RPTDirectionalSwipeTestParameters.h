...
- (id)initWithTestName:(id)arg1 scrollingBounds:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 swipeCount:(long long)arg3 reverse:(bool)arg4 direction:(long long)arg5 completionHandler:(id /* block */)arg6;
- (id)initWithTestName:(id)arg1 testType:(unsigned long long)arg2 scrollView:(id)arg3 completionHandler:(id /* block */)arg4;
- (void)prepareWithComposer:(id)arg1;
- (bool)reverse;
- (void)scrollWithComposer:(id)arg1 fromPoint:(struct CGPoint { double x1; double x2; })arg2 toPoint:(struct CGPoint { double x1; double x2; })arg3 swipeDuration:(double)arg4;
