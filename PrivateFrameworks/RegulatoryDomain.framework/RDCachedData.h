...
- (id)initWithCountryCodeFromLocation:(id)arg1 fromServingCell:(id)arg2 fromNearbyCell:(id)arg3 fromWiFi:(id)arg4 localEstimates:(id)arg5 combinedEstimate:(id)arg6 lastKnownCombinedEstimate:(id)arg7 locationLocalEstimateInDisputedArea:(bool)arg8 peerEstimates:(id)arg9;
...
- (void)setCountriesFromLocation:(id)arg1 forUnitTest:(bool)arg2 isDisputed:(bool)arg3;
- (void)setCountriesFromLocation:(id)arg1 isInDisputedArea:(bool)arg2;
- (void)setCountriesFromLocationForUnitTest:(id)arg1 isDisputed:(bool)arg2;
