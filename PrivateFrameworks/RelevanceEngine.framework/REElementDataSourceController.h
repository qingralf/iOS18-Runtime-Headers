...
- (void)_queue_invalidateSections:(id)arg1 completion:(id /* block */)arg2;
- (void)_queue_pause;
- (void)_queue_performContentInvalidateWithElement:(id)arg1 expectation:(id)arg2 sections:(id)arg3;
- (void)_queue_performUpdates;
- (void)_queue_processPendingUpdatesWhilePause:(id /* block */)arg1;
- (void)_queue_processUpdates:(id)arg1 forSection:(id)arg2;
- (void)_queue_purgeContentWithCompletion:(id /* block */)arg1;
- (void)_queue_reloadWithQOS:(unsigned int)arg1 qosOffset:(int)arg2 forceReload:(bool)arg3 completion:(id /* block */)arg4;
- (void)_queue_reloadWithQOS:(unsigned int)arg1 qosOffset:(int)arg2 forceReload:(bool)arg3 operations:(id /* block */)arg4 completion:(id /* block */)arg5;
- (void)_queue_reloadWithQOS:(unsigned int)arg1 qosOffset:(int)arg2 forceReload:(bool)arg3 sections:(id)arg4 completion:(id /* block */)arg5;
- (void)_queue_resume;
...
- (void)invalidateElementsInSections:(id)arg1 completion:(id /* block */)arg2;
- (id)name;
- (void)pause;
- (void)pauseIfNeeded;
- (void)prepareToUnload;
- (void)processPendingUpdatesWhilePause:(id /* block */)arg1;
