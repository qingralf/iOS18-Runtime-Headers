...
- (void)encodeWithCRCoder:(id)arg1 set:(void*)arg2 elementValueCoder:(id /* block */)arg3;
- (unsigned long long)hash;
- (id)init;
- (id)initWithCRCoder:(id)arg1;
- (id)initWithCRCoder:(id)arg1 set:(const void*)arg2;
- (id)initWithCRCoder:(id)arg1 set:(const void*)arg2 elementValueDecoder:(id /* block */)arg3;
