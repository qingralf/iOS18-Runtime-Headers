...
+ (id)cdEntityName;
+ (id)hourlyRecurrentDueDateAfter:(id)arg1 dueDate:(id)arg2 interval:(long long)arg3;
+ (id)hourlyRecurrentDueDateBefore:(id)arg1 dueDate:(id)arg2 interval:(long long)arg3;
+ (id)hourlyRecurrentDueDateToward:(id)arg1 dueDate:(id)arg2 interval:(long long)arg3 adjustingStepsBy:(id /* block */)arg4;
...
+ (id)previousRecurrentDueDateBefore:(id)arg1 dueDate:(id)arg2 timeZone:(id)arg3 allDay:(bool)arg4 recurrenceRules:(id)arg5;
+ (id)recurrenceGeneratorConfiguredForDueDate:(id)arg1 timeZone:(id)arg2 allDay:(bool)arg3 recurrenceRule:(id)arg4;
