...
@property (nonatomic, readonly) NSDate *alternativeDisplayDateDate_forCalendar;
...
@property (nonatomic, readonly) NSString *externalIdentifierForMarkedForDeletionObject; /* unknown property attribute: ? */
