...
@property (nonatomic, retain) NSDate *alternativeDisplayDateDate_forCalendar;
...
@property (nonatomic, readonly) NSDateComponents *effectiveDisplayDateComponents_forCalendar;
...
- (void)clearAlternativeDisplayDateDateForCalendarWithReason:(id)arg1;
...
- (void)setAlternativeDisplayDateDateForCalendarToPreviousRecurrentDateBefore:(id)arg1 recurrenceRules:(id)arg2;
- (void)setAlternativeDisplayDateDateForCalendarWithDateComponents:(id)arg1;
- (void)setAlternativeDisplayDateDateForCalendarWithNormalizedDate:(id)arg1;
