...
- (id)fetchRemindersWithParentReminderID:(id)arg1 accountID:(id)arg2 subtaskFetchOption:(long long)arg3 reminderFetchOptions:(id)arg4 error:(id*)arg5;
- (id)fetchRemindersWithParentReminderIDs:(id)arg1 error:(id*)arg2;
- (long long)fetchSubtasksMasksWithParentReminderID:(id)arg1 includingConcealed:(bool)arg2 error:(id*)arg3;
- (id)fetchSubtasksOfParentReminder:(id)arg1 subtaskFetchOption:(long long)arg2 reminderFetchOptions:(id)arg3 error:(id*)arg4;
- (id)fetchSubtasksOfParentReminderChangeItem:(id)arg1 subtaskFetchOption:(long long)arg2 reminderFetchOptions:(id)arg3 error:(id*)arg4;
