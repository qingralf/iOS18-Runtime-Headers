...
- (id)_endpointURLForEndpointConfig:(id)arg1;
...
- (void)_fetchMultiConfigurationFromEndpointURL:(id)arg1 settings:(id)arg2 networkActivityBlock:(id /* block */)arg3 changeTagsByRequestKey:(id)arg4 completion:(id /* block */)arg5;
- (bool)_isAllowedToReachEndpointWithSettings:(id)arg1 configurationResource:(id)arg2 endpointURL:(id)arg3;
- (bool)_isValidConfigurationResource:(id)arg1 allowedToReachEndpoint:(bool)arg2 useBackgroundRefreshRate:(bool)arg3 userID:(id)arg4 storefrontID:(id)arg5 cachePolicy:(id)arg6;
...
- (void)fetchMultiConfigurationWithSettings:(id)arg1 networkActivityBlock:(id /* block */)arg2 completionQueue:(id)arg3 completion:(id /* block */)arg4;
- (void)fetchSingleConfigurationWithSettings:(id)arg1 completionQueue:(id)arg2 completion:(id /* block */)arg3;
- (void)fetchSingleConfigurationWithSettings:(id)arg1 networkActivityBlock:(id /* block */)arg2 completionQueue:(id)arg3 completion:(id /* block */)arg4;
