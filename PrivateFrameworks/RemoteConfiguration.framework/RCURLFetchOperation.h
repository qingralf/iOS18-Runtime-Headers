...
@interface RCURLFetchOperation : RCOperation <NSURLSessionTaskDelegate> {
    ...
    id /* block */  _configurationDictionaryCompletionHandler;
    NSError * _error;
...
@property (nonatomic, copy) id /* block */ configurationDictionaryCompletionHandler;
...
@property (nonatomic, retain) RCNetworkActivity *networkActivity;
...
- (id /* block */)configurationDictionaryCompletionHandler;
- (id)error;
- (id)httpResponse;
- (id)loggingKey;
- (id)maxAge;
...
- (void)setConfigurationDictionaryCompletionHandler:(id /* block */)arg1;
