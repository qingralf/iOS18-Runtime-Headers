...
- (bool)loadObjectsFromDictionary:(id)arg1 forKeyPath:(id)arg2 classType:(Class)arg3 serializationType:(short)arg4 error:(id*)arg5;
...
- (void)serializeObjectsIntoDictionary:(id)arg1 value:(id)arg2 classType:(Class)arg3 serializationType:(short)arg4;
