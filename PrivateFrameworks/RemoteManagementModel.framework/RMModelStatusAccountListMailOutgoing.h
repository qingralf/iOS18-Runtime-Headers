...
@interface RMModelStatusAccountListMailOutgoing : RMModelStatusBase {
...
+ (id)buildWithIdentifier:(id)arg1 removed:(id)arg2 declarationIdentifier:(id)arg3 visibleName:(id)arg4 hostname:(id)arg5 port:(id)arg6 username:(id)arg7;
+ (id)statusItemType;
+ (id)supportedOS;
