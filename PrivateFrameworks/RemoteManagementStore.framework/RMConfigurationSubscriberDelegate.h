...
- (void)_sendConfigurationUIForConfigurationReference:(id)arg1 visible:(bool)arg2 configurationUI:(id)arg3 configurationUIGroup:(id)arg4;
...
- (void)didFetchConfigurationsWithVisibleUIByType:(id)arg1 storesByIdentifier:(id)arg2 scope:(long long)arg3 completionHandler:(id /* block */)arg4;
