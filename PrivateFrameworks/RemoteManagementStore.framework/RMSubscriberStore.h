...
+ (void)subscribedStoreConfigurationsVisibleUIWithScope:(long long)arg1 configurationTypes:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (id)_reasonsFromErrorWithFirstReason:(id)arg1 error:(id)arg2;
