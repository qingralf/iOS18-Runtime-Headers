...
- (id)description;
- (id)documentState;
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })documentStateRangeForSelectionRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
...
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })selectionRangeForDocumentStateRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
