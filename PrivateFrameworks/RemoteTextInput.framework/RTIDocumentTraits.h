...
@property (nonatomic, retain) RTITextInputKeyboardActionButtonConfiguration *keyboardActionButtonConfiguration;
...
@property (nonatomic) bool supportsEmojiImageTextAttachments;
...
- (id)keyboardActionButtonConfiguration;
...
- (void)setKeyboardActionButtonConfiguration:(id)arg1;
...
- (void)setSupportsEmojiImageTextAttachments:(bool)arg1;
...
+ (id)translateToRTITextInputKeyboardActionButtonConfiguration:(id)arg1;
