...
- (void)_flushOperationsImplWithResultHandler:(id /* block */)arg1;
...
- (id)documentStateAfterModifyAndFlushTextOperations:(id /* block */)arg1;
- (id)documentStateAfterModifyAndFlushTextOperations:(id /* block */)arg1 resultHandler:(id /* block */)arg2;
...
- (id)internalQueue;
- (bool)isPaused;
- (void)modifyAndFlushTextOperations:(id /* block */)arg1;
- (void)modifyAndFlushTextOperations:(id /* block */)arg1 resultHandler:(id /* block */)arg2;
