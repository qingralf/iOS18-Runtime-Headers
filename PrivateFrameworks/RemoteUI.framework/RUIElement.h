...
@interface RUIElement : NSObject {
    ...
    RUIElement * _parent;
    RUIXMLElement * _sourceXMLElement;
    RUIStyle * _style;
...
@property (nonatomic, readonly) bool isDeprecatedForInternalAnalytics;
@property (nonatomic, readonly, copy) NSString *name;
@property (nonatomic, readonly) RUIElement *parent;
@property (nonatomic, retain) RUIXMLElement *sourceXMLElement;
...
- (id)attributes;
- (id)body;
- (void)configureAccessiblityWithTarget:(id)arg1;
...
- (void)reportInternalRenderEventWithElementName:(id)arg1;
- (void)reportInternalRenderEventWithElementName:(id)arg1 deprecated:(bool)arg2;
...
- (void)setSourceXMLElement:(id)arg1;
