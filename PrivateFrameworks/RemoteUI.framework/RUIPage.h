...
@interface RUIPage : UIViewController <PSStateRestoration, RUITopLevelElementProviderDelegate, UIWebViewDelegate> {
...
@property (nonatomic, copy) NSString *navSubTitle;
...
@property (nonatomic, readonly) RUIElement<RUITopLevelPageElement> *primaryElement;
...
- (id)_childElements;
- (void)_handlePageUpdateRequestedNotification:(id)arg1;
...
- (void)addElementProvider:(id)arg1;
- (id)attributes;
- (id)backButtonTitle;
- (id)buttonItems;
- (id)buttons;
...
- (void)dealloc;
- (id)description;
- (void)dismissIfPresentedWithCompletion:(id /* block */)arg1;
- (id)elementProvider;
...
- (void)populatePostbackDictionary:(id)arg1 elementProvider:(id)arg2;
...
- (id)toolbar;
- (void)topLevelElementProvider:(id)arg1 didCreatePasscodeView:(id)arg2;
- (void)topLevelElementProvider:(id)arg1 didCreateSpinnerView:(id)arg2;
- (void)topLevelElementProvider:(id)arg1 didCreateTableView:(id)arg2;
- (void)topLevelElementProvider:(id)arg1 didCreateWebView:(id)arg2;
- (void)topLevelElementProvider:(id)arg1 didSetPrimaryElement:(id)arg2 previousElement:(id)arg3;
