...
@interface RUITableViewRow : RUIElement <RUIWebContainerViewDelegate, UIPickerViewDelegate, UITextFieldDelegate> {
    ...
    bool  _showAlternateDetailLabel;
...
@property (nonatomic) bool showAlternateDetailLabel;
...
- (void)setBadgeInTableCell:(id)arg1;
...
- (void)setShowAlternateDetailLabel:(bool)arg1;
