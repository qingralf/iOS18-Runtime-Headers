...
@interface RUITableViewSection : RUIElement <NSCopying, RUIHeaderDelegate, RUITableFooterDelegate> {
    bool  _configured;
...
@property (nonatomic, retain) RUIMultiChoiceElement *multiChoiceElement;
...
- (void)headerViewDidChange:(id)arg1;
...
- (void)setMultiChoiceElement:(id)arg1;
