...
- (void)loader:(id)arg1 receivedObjectModel:(id)arg2 topActionSignal:(id)arg3 completion:(id /* block */)arg4;
...
- (void)pushObjectModel:(id)arg1 animated:(bool)arg2 completion:(id /* block */)arg3;
...
- (void)addAccountUserInfoWithAccount:(id)arg1;
