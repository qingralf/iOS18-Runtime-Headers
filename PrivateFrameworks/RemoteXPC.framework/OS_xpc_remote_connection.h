...
@interface OS_xpc_remote_connection : NSObject <OS_xpc_object> {
    ...
    id /* block */  _tls_verify;
    NSObject<OS_dispatch_queue> * _tls_verify_queue;
    int  _type;
    bool  disable_adaptive_write_timeout;
    int  error;
...
@property (nonatomic, retain) NSObject<OS_sec_identity> *tls_identity;
@property (nonatomic, copy) id /* block */ tls_verify;
@property (nonatomic, retain) NSObject<OS_dispatch_queue> *tls_verify_queue;
...
- (void)setTls_identity:(id)arg1;
- (void)setTls_verify:(id /* block */)arg1;
- (void)setTls_verify_queue:(id)arg1;
