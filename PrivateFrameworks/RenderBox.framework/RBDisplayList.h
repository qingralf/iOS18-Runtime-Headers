...
@interface RBDisplayList : NSObject <RBDisplayListContents, _RBDisplayListContents> {
    ...
    struct Builder { 
        ...
        struct Pool<RB::DisplayList::Builder::LayerState, RB::Heap> { 
            struct Item {} *_freelist; 
        } _layer_state_pool; 
...
- (void)addAnimationStyle:(id)arg1 id:(struct { unsigned char x1[16]; })arg2 flags:(unsigned int)arg3;
...
- (void)addDistanceFilterWithMaxDistance:(double)arg1 scale:(double)arg2 flags:(unsigned int)arg3;
- (void)addFilterLayerWithShader:(id)arg1 border:(struct CGSize { double x1; double x2; })arg2 layerBorder:(struct CGSize { double x1; double x2; })arg3 bounds:(const struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; }*)arg4 flags:(unsigned int)arg5;
...
- (void)addShadowStyleWithRadius:(double)arg1 midpoint:(float)arg2 offset:(struct CGSize { double x1; double x2; })arg3 color:(struct { float x1; float x2; float x3; float x4; })arg4 colorSpace:(int)arg5 blendMode:(int)arg6 flags:(unsigned int)arg7;
