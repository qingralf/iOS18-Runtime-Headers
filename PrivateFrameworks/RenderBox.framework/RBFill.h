...
- (void)setMeshGradientType:(unsigned int)arg1 positions:(const float*)arg2 colors:(const struct { float x1; float x2; float x3; float x4; }*)arg3 count:(unsigned long long)arg4 width:(unsigned long long)arg5 background:(struct { float x1; float x2; float x3; float x4; })arg6 colorSpace:(int)arg7 flags:(unsigned int)arg8;
