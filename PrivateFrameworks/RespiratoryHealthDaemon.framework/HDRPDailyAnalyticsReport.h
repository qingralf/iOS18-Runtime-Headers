...
- (id)_gatherImproveHealthAndActivityReportFromBackgroundOxygenSaturationSamplesInPreviousDay:(id)arg1 oxygenSaturationSamplesInPreviousDay:(id)arg2 oxygenSaturationSamplesInPrevious30Days:(id)arg3 error:(id*)arg4;
...
- (id)_queryForOxygenSaturationSamplesInPreviousDays:(unsigned long long)arg1 error:(id*)arg2;
- (id)calendar;
