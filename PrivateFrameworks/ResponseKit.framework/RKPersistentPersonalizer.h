...
@property (nonatomic, copy) NSURL *dynamicDataURL;
@property (nonatomic, copy) NSString *languageID;
@property (nonatomic, copy) NSLocale *languageLocale;
@property (nonatomic) NSDate *lastDynamicDataCreationCheckDate;
@property (nonatomic) NSDate *lastObservedDynamicDataCreationDate;
@property (readonly) void*model;
@property (nonatomic, copy) NSMutableDictionary *synonyms;
