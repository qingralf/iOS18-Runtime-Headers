...
@property (nonatomic, readonly, copy) NSDictionary *managedEndpointByLaunchIdentifier;
...
+ (id)_instanceWithProperties:(id)arg1;
...
- (id)_configureXPCServiceWithProperties:(id)arg1;
- (id)_initWithProperties:(id)arg1;
- (void)_parseAdditionalProperties:(id)arg1;
- (void)_parseEndpoints:(id)arg1 withAdditionalProperties:(id)arg2;
