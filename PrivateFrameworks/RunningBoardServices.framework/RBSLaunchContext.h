...
@property (nonatomic, copy) NSSet *managedEndpointLaunchIdentifiers;
...
@property (nonatomic, copy) RBSProcessIdentifier *requiredExistingProcess;
...
- (id)machServices;
- (id)managedEndpointLaunchIdentifiers;
- (id)managedPersona;
- (id)oneShotUUID;
- (id)preventContainerization;
- (id)requestorHandle;
- (id)requiredCacheUUID;
- (id)requiredExistingProcess;
...
- (void)setRequiredExistingProcess:(id)arg1;
...
- (bool)_deviceIsEligibleForDomain:(id)arg1 bundleID:(id)arg2;
- (bool)_launchAllowedBySystemState:(id)arg1 error:(id*)arg2;
- (bool)_needsEligibilityCheck;
- (bool)_passesEligibilityCheck;
- (bool)_passesRegulatoryChecksWithError:(id*)arg1;
- (bool)_recordPassesEligibilityChecks:(id)arg1;
- (bool)_requiresPreflightCheck;
