...
@property (nonatomic, readonly) bool isMultiInstanceExtension;
...
+ (id)decodeFromJob:(id)arg1 uuid:(id)arg2;
...
+ (id)identityForLSApplicationIdentity:(id)arg1 LSApplicationRecord:(id)arg2 uuid:(id)arg3;
...
+ (id)identityForUnbundledMacApplicationJobLabel:(id)arg1;
+ (id)identityForUnknownServiceWithJobLabel:(id)arg1;
+ (id)identityForWrappedInfoProvider:(id)arg1;
+ (id)identityForWrappedInfoProvider:(id)arg1 uuid:(id)arg2;
