...
@interface AceObject : NSObject <AFAnalyticsContextVending, AFSecurityDigestibleChunksProviding, AceObject, SNSessionObject, SRUIFUUFRSayable, SiriCoreThunking> {
    NSString * _aceId;
