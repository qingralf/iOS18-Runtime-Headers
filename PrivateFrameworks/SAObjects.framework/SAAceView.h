...
@property (nonatomic, retain) SAVoice *preferredSpeakableTextVoice;
@property (nonatomic) bool preserveResultSpaceIfPossible;
@property (nonatomic, copy) NSString *redactedSpeakableText;
...
- (id)preferredSpeakableTextVoice;
- (bool)preserveResultSpaceIfPossible;
- (id)redactedSpeakableText;
...
- (void)setPreferredSpeakableTextVoice:(id)arg1;
- (void)setPreserveResultSpaceIfPossible:(bool)arg1;
- (void)setRedactedSpeakableText:(id)arg1;
