...
@property (nonatomic, copy) NSString *ephemeralUserId;
@property (nonatomic, copy) NSArray *experiments;
@property (nonatomic) bool gmDevice;
...
@property (nonatomic, copy) NSNumber *rpiEnabled;
@property (nonatomic, copy) NSString *selfClockId;
...
- (void)setEphemeralUserId:(id)arg1;
- (void)setExperiments:(id)arg1;
- (void)setGmDevice:(bool)arg1;
...
- (void)setRpiEnabled:(id)arg1;
- (void)setSelfClockId:(id)arg1;
