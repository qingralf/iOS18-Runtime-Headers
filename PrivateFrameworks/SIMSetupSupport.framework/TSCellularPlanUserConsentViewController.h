...
- (id)delegate;
- (id)initWithConfirmationCode:(id)arg1 consentType:(unsigned long long)arg2 requireAdditionalConsent:(bool)arg3 confirmationCode:(id)arg4 acceptButtonTapped:(bool)arg5;
