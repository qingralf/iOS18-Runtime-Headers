...
@interface TSSubFlowViewController : TSOBWelcomeController <TSSIMSetupDelegate, TSSetupFlowItem> {
    ...
    bool  _usingFirstViewControllerParadigm;
}
...
@property bool usingFirstViewControllerParadigm;
...
- (id)initWithFlow:(id)arg1 navigationController:(id)arg2;
...
- (void)setUsingFirstViewControllerParadigm:(bool)arg1;
