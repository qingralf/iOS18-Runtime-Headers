...
@interface SOSEngine : NSObject <LSApplicationWorkspaceObserverProtocol, NSXPCListenerDelegate, SOSInternalServerProtocol, SOSPersistentTimerLocationManagerDelegate, SOSServerProtocol> {
...
+ (void)_sendMessage:(id)arg1 location:(id)arg2 recipients:(id)arg3 recipientReasonMessages:(id)arg4 useStandalone:(bool)arg5 critical:(bool)arg6 failureBlock:(id /* block */)arg7;
...
+ (id)_sosMessageForLocation:(id)arg1 isFirstMessage:(bool)arg2 medicalIDName:(id)arg3 reason:(long long)arg4 recipientReason:(unsigned long long)arg5;
+ (id)_sosMessageForLocation:(id)arg1 isFirstMessage:(bool)arg2 myFullName:(id)arg3 myFirstName:(id)arg4 reason:(long long)arg5 recipientReason:(unsigned long long)arg6;
