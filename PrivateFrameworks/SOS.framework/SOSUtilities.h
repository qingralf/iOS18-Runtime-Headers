...
+ (id)_overrideForDefaultsKey:(id)arg1 expectedClass:(Class)arg2 defaultValue:(id)arg3;
...
+ (id)crashDetectionFeedbackAssistantLegalText;
...
+ (id)stewieGroupAsset;
+ (id)stewieGroupTitle;
+ (id)stringOverrideForDefaultsKey:(id)arg1 defaultValue:(id)arg2;
