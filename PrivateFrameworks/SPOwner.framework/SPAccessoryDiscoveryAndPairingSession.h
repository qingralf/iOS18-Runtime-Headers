...
- (id)callbackQueue;
- (void)disableFindMyPairingWithIdentifier:(id)arg1;
...
- (void)initiatePairingAndLocateAccessoryWith:(id)arg1 completion:(id /* block */)arg2;
- (void)initiatePairingForAccessoryWith:(id)arg1 completion:(id /* block */)arg2;
...
- (void)pairingStatus:(id)arg1 completion:(id /* block */)arg2;
- (void)pairingStatusWithRequest:(id)arg1 completion:(id /* block */)arg2;
- (id)proxy;
- (id)queue;
...
- (void)startLocalFindableAccessoryDiscoveryWithCompletion:(id /* block */)arg1;
- (id)state;
- (void)stop;
- (void)stopAccessoryDiscoveryWithCompletion:(id /* block */)arg1;
- (void)stopLocalFindableAccessoryDiscoveryWithCompletion:(id /* block */)arg1;
