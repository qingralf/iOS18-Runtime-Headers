...
- (void)startFastAdvertisingForBeacon:(id)arg1 completion:(id /* block */)arg2;
- (void)startFindingBeacon:(id)arg1 completion:(id /* block */)arg2;
- (void)stopFastAdvertisingForBeacon:(id)arg1 completion:(id /* block */)arg2;
- (void)stopFindingBeacon:(id)arg1 completion:(id /* block */)arg2;
