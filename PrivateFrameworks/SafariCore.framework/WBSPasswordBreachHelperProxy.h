...
- (void)dealloc;
- (void)getPasswordEvaluationsForPersistentIdentifiers:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)writePasswordEvaluationsToCache:(id)arg1 completionHandler:(id /* block */)arg2;
