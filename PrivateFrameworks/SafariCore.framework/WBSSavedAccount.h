...
@property (nonatomic, retain) NSArray *additionalSites;
...
@property (nonatomic, readonly) WBSFormerlySharedSavedAccountMarker *formerlySharedPasskeyMarker;
@property (nonatomic, readonly) WBSFormerlySharedSavedAccountMarker *formerlySharedPasswordMarker;
...
@property (nonatomic, readonly) bool hasValidWebsite;
...
@property (nonatomic, readonly, copy) NSArray *protectionSpacesForAdditionalSites;
...
@property (nonatomic, retain) AKSignInWithAppleAccount *signInWithAppleAccount;
@property (nonatomic, readonly) NSArray *sites;
@property (nonatomic, readonly, copy) NSData *stableID;
@property (nonatomic, readonly) NSArray *totpGenerators;
@property (nonatomic, readonly, copy) NSString *uniqueIdentifierForPasswordManagerLegacy;
...
- (void)_addPasswordCredentialCreationDate:(id)arg1;
...
- (void)_clearFormerlySharedSavedAccountMarkerForCredentialTypes:(long long)arg1;
- (void)_clearFormerlySharedSavedAccountMarkerForCredentialTypesIfNecessary:(long long)arg1;
...
- (id)_formerlySharedMarkerForCredentialType:(long long)arg1;
- (id)_highLevelDomainWithPortIncluded;
- (id)_initWithHighLevelDomain:(id)arg1 passkeyRelyingPartyID:(id)arg2 user:(id)arg3 password:(id)arg4 passkeyUserHandle:(id)arg5 passkeyCredentialID:(id)arg6 siteToProtectionSpaces:(id)arg7 sitesToSidecars:(id)arg8 serviceName:(id)arg9;
...
- (id)_initWithSignInWithAppleAccount:(id)arg1;
...
- (id)_quirksForServiceName:(id)arg1;
...
- (void)_writeFormerlySharedSavedAccountMarkerForCredentialTypes:(long long)arg1;
- (id)additionalSites;
...
- (long long)compare:(id)arg1 byType:(long long)arg2;
- (id)creationDate;
...
- (id)formerlySharedPasskeyMarker;
- (id)formerlySharedPasswordMarker;
...
- (id)highLevelDomain;
- (id)initWithPasskeyRelyingPartyID:(id)arg1 user:(id)arg2 passkeyUserHandle:(id)arg3 passkeyCredentialID:(id)arg4;
...
- (id)protectionSpaces;
- (id)protectionSpacesForAdditionalSites;
- (id)serviceName;
- (void)setAdditionalSites:(id)arg1;
...
- (id)totpGenerators;
- (id)uniqueIdentifierForPasswordManagerLegacy;
- (id)user;
