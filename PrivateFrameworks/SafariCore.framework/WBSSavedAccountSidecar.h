...
@property (nonatomic, copy) NSArray *additionalSites;
@property (nonatomic, readonly) NSDictionary *contextSpecificData;
@property (nonatomic, copy) NSString *customTitle;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (readonly, copy) NSString *description;
@property (nonatomic, readonly, copy) NSDictionary *dictionaryRepresentation;
@property (nonatomic, retain) WBSFormerlySharedSavedAccountMarker *formerlySharedSavedAccountMarker;
...
- (id)formerlySharedSavedAccountMarker;
...
- (void)setFormerlySharedSavedAccountMarker:(id)arg1;
