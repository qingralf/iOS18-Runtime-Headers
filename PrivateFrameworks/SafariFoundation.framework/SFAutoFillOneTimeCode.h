...
- (id)initWithTOTPGenerator:(id)arg1 user:(id)arg2 highLevelDomain:(id)arg3 lastUsedDateOfAssociatedSavedAccount:(id)arg4;
- (bool)isEqual:(id)arg1;
- (id)lastUseDateOfAssociatedSavedAccount;
