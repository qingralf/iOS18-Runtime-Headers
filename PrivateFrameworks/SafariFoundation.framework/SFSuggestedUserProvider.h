...
- (id)_cachedSuggestedUsersWithType:(long long)arg1 matchingText:(id)arg2 limit:(unsigned long long)arg3;
...
- (void)suggestedUsersOfType:(long long)arg1 matchingText:(id)arg2 limit:(unsigned long long)arg3 completionHandler:(id /* block */)arg4;
