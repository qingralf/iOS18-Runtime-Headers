...
@property (nonatomic, readonly) ProviderConfiguration *appleProviderConfiguration;
@property (nonatomic, copy) NSDictionary *currentConfiguration;
...
+ (id)convertDyldVersionToString:(unsigned long long)arg1;
+ (id)sharedController;
...
- (void)_setCurrentConfigurationOnInternalQueue:(id)arg1;
