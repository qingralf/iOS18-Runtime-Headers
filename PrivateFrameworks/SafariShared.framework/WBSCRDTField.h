...
- (id)initWithValue:(id)arg1 valueSource:(id)arg2 valueProvider:(id /* block */)arg3 valueUpdater:(id /* block */)arg4 generation:(id)arg5 deviceIdentifier:(id)arg6 metadata:(id)arg7;
