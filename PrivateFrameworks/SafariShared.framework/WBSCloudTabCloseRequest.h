...
+ (id)_dictionaryWithURL:(id)arg1 tabUUIDString:(id)arg2 lastModified:(id)arg3 sourceDeviceUUID:(id)arg4 destinationDeviceUUID:(id)arg5;
...
- (id)initWithURL:(id)arg1 tabUUIDString:(id)arg2 lastModified:(id)arg3 sourceDeviceUUID:(id)arg4 destinationDeviceUUID:(id)arg5 requestUUID:(id)arg6;
- (id)lastModified;
