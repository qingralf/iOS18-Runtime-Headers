...
@property (nonatomic, readonly) PKCurrencyAmount *balance;
...
@property (nonatomic, readonly) bool isCardBalanceZeroOrNegative;
@property (nonatomic, readonly) bool isVirtualCard;
...
- (bool)isEqualToImportedCard:(id)arg1;
- (bool)isVirtualCard;
...
- (bool)shouldHide;
- (void)test_setBalance:(id)arg1;
- (void)test_setLastUsedDate:(id)arg1;
- (id)virtualCard;
