...
+ (void)_updateWebpageUsage:(id)arg1 withDigitalHealthManagerUsageState:(unsigned long long)arg2 withCompletionHandler:(id /* block */)arg3;
+ (void)deleteAllUsageHistoryWithProfileIdentifier:(id)arg1;
+ (void)deleteUsageHistoryForURLs:(id)arg1 profileIdentifier:(id)arg2 completionHandler:(id /* block */)arg3;
