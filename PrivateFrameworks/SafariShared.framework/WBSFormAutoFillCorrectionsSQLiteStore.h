...
@interface WBSFormAutoFillCorrectionsSQLiteStore : NSObject <WBSCrowdsourcedFeedbackAllowList, WBSFormAutoFillCorrectionsStore> {
...
- (void)closeDatabase;
- (void)getAllowListStatusForDomain:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)getClassificationForFieldWithFingerprint:(id)arg1 onDomain:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)getLastAllowListRetrievalURLStringWithCompletionHandler:(id /* block */)arg1;
...
- (void)replaceDomainAllowListWithDomains:(id)arg1 retrievalURLString:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (void)setDomain:(id)arg1 isAllowListedForFeedback:(bool)arg2 completionHandler:(id /* block */)arg3;
- (void)setLastAllowListRetrievalURLString:(id)arg1 completionHandler:(id /* block */)arg2;
