...
@property (nonatomic, readonly, copy) NSArray *classificationHints;
@property (nonatomic, readonly) unsigned long long continuationID;
@property (nonatomic, readonly) unsigned long long continuationIndex;
...
@property (nonatomic, readonly) bool looksLikeEIDField;
@property (nonatomic, readonly) bool looksLikeIMEIField;
...
@property (nonatomic, readonly) bool oneTimeCodeIsEligibleForAutomaticLogin;
@property (nonatomic, readonly, copy) NSArray *orderedParts;
...
@property (getter=isVerticalWritingMode, nonatomic, readonly) bool verticalWritingMode;
@property (getter=isVisible, nonatomic, readonly) bool visible;

+ (id)formControlMetadataFromSerializedData:(id)arg1;
...
- (unsigned long long)continuationID;
- (unsigned long long)continuationIndex;
- (id)copyWithZone:(struct _NSZone { }*)arg1;
- (id)dictionaryRepresentation;
- (id)dictionaryRepresentationRedactingSensitiveValues:(bool)arg1;
