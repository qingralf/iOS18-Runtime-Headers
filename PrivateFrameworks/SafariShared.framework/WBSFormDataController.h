...
- (bool)_hasMatchingAutoFillEventForUsername:(id)arg1 withinTimeInterval:(double)arg2 inTabWithID:(id)arg3 currentURL:(id)arg4 shouldAllowPrivateTabs:(bool)arg5 shouldRemoveMatchingEvent:(bool)arg6 shouldIncludeExternalCredentialEvents:(bool)arg7;
...
- (void)_removeExpiredAutoFillEvents:(id)arg1;
...
- (bool)canApplyAutoFillGracePeriodForUsername:(id)arg1 inTabWithID:(id)arg2 currentURL:(id)arg3;
- (void)canAutomaticallyRegisterPasskeyForUsername:(id)arg1 inTabWithID:(id)arg2 currentURL:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (void)didFillPasswordForUsername:(id)arg1 fromProviderWithBundleIdentifier:(id)arg2 inTabWithID:(id)arg3 currentURL:(id)arg4 isPrivate:(bool)arg5;
- (id)domainsWithPreviousData;
- (void)domainsWithPreviousDataChanged;
- (id)encryptOrDecryptData:(id)arg1 encrypt:(bool)arg2;
- (id)exactFQDNAndOtherSavedAccountMatchesForForm:(id)arg1 atURL:(id)arg2 webFrameIdentifier:(id)arg3 savedAccountContext:(id)arg4;
- (bool)frameIsKnownToAskForCredentialsFromOtherServicesFromAncestorFrameURLs:(id)arg1;
...
- (void)willSubmitFormWithCredentials:(id)arg1 shouldPreferAnnotatedCredentials:(bool)arg2 atURL:(id)arg3 username:(id*)arg4 password:(id*)arg5 inContext:(id)arg6 shouldShowPasswordsAppOnboarding:(bool)arg7;
