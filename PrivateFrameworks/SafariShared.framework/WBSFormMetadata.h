...
@property (nonatomic, readonly) bool containsClassifications;
...
@property (nonatomic, readonly) NSString *passwordFieldValue;
...
@property (nonatomic, readonly) NSString *userNameFieldValue;
...
- (void).cxx_destruct;
- (id)_init;
- (id)_valueOfControlWithUniqueID:(id)arg1;
- (id)action;
...
- (id)dictionaryRepresentationRedactingSensitiveValues:(bool)arg1 withKnownSensitiveValues:(id)arg2;
