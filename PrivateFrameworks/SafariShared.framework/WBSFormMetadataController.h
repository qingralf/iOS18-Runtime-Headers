...
+ (id)classifyFormMetadata:(id)arg1;
...
- (bool)addressBookAutoFillableFieldFocused:(id)arg1 withAddressBookAutoFillableFieldMetadata:(id)arg2 formMetadata:(id)arg3 inFrame:(id)arg4;
...
- (void)autoFilledField:(id)arg1 inForm:(id)arg2 inFrame:(id)arg3;
- (void)autoFilledField:(id)arg1 inFrame:(id)arg2;
...
- (void)finishedAutoFillingOneTimeCode:(id)arg1 inFrame:(id)arg2 shouldSubmit:(bool)arg3;
...
- (void)oneTimeCodeFieldFocused:(id)arg1 withFieldMetadata:(id)arg2 formMetadata:(id)arg3 inFrame:(id)arg4;
...
- (void)passwordFieldFocused:(id)arg1 inFrame:(id)arg2 textFieldMetadata:(id)arg3 formMetadata:(id)arg4 isPasswordFieldForUserCredentials:(bool)arg5;
...
- (void)setStrongPasswordElementViewableIfAppropriate:(bool)arg1 frame:(id)arg2 passwordControlUniqueIDs:(id)arg3;
...
- (void)textFieldFocused:(id)arg1 inFrame:(id)arg2 textFieldMetadata:(id)arg3 formMetadata:(id)arg4;
