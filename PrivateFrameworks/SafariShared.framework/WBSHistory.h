...
- (void)exportHistoryToFileWithURL:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)getAllItemsWithCompletionHandler:(id /* block */)arg1;
...
- (void)removeItemsInResponseToUserAction:(id)arg1 completionHandler:(id /* block */)arg2;
