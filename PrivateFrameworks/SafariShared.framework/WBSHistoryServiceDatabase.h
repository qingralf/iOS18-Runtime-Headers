...
- (id)_clearAllHistoryInsertingTombstoneUpToDate:(id)arg1 clearAllSpotlightHistoryForProfile:(bool)arg2;
- (id)_clearHistoryItems:(id)arg1 afterDate:(id)arg2 beforeDate:(id)arg3 tombstoneMode:(unsigned long long)arg4;
- (id)_clearHistoryVisitsAddedAfterDate:(id)arg1 beforeDate:(id)arg2 tombstoneMode:(unsigned long long)arg3 clearAllSpotlightHistoryForProfile:(bool)arg4;
...
- (id)_executePlan:(void*)arg1 outDeletedItemCount:(unsigned long long*)arg2 outDeletedVisitCount:(unsigned long long*)arg3 clearAllSpotlightHistoryForProfile:(bool)arg4;
...
- (void)_removeSpotlightDonationsForItemURLs:(id)arg1;
...
- (void)clearAllHistoryInsertingTombstoneUpToDate:(id)arg1 clearAllSpotlightHistoryForProfile:(bool)arg2 completionHandler:(id /* block */)arg3;
...
- (void)clearHistoryVisitsAddedAfterDate:(id)arg1 beforeDate:(id)arg2 tombstoneMode:(unsigned long long)arg3 clearAllSpotlightHistoryForProfile:(bool)arg4 completionHandler:(id /* block */)arg5;
...
- (void)importVisits:(id)arg1 desiredVisitTimePrecision:(unsigned long long)arg2 completionHandler:(id /* block */)arg3;
- (id)init;
...
- (void)startImportHistorySessionWithVisitTimePrecision:(unsigned long long)arg1 completionHandler:(id /* block */)arg2;
...
- (void)visitIdentifiersMatchingExistingVisits:(id)arg1 desiredVisitTimePrecision:(unsigned long long)arg2 completionHandler:(id /* block */)arg3;
