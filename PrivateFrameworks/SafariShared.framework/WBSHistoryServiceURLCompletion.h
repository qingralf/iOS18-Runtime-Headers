...
- (void)recordVisit:(id)arg1 sourceVisit:(id)arg2 title:(id)arg3 loadSuccessful:(bool)arg4 origin:(long long)arg5 increaseVisitCount:(bool)arg6 score:(int)arg7 statusCode:(long long)arg8;
...
- (void)updateVisit:(id)arg1 title:(id)arg2 databaseID:(id)arg3;
