...
@property (nonatomic, readonly) bool hasDynamicPreferenceValues; /* unknown property attribute: ? */
@property (readonly) unsigned long long hash;
@property (nonatomic, readonly) bool shouldDeleteUnrecognizedPreference; /* unknown property attribute: ? */
