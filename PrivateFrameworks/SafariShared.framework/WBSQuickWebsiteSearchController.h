...
@property (nonatomic, readonly, copy) NSArray *quickWebsiteSearchHosts;
...
- (void)clearWithCompletionHandler:(id /* block */)arg1;
...
- (id)providersMatchingQueryString:(id)arg1 excludingSearchEngineHostSuffixes:(id)arg2;
- (id)providersMatchingString:(id)arg1 excludingSearchEngineHostSuffixes:(id)arg2;
...
- (void)removeProvidersWithHosts:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)savePendingChangesBeforeTermination;
- (void)savePendingChangesNowWithCompletionHandler:(id /* block */)arg1;
...
- (void)setSearchURLTemplateFromForm:(id)arg1 forSourcePageURLString:(id)arg2 completionHandler:(id /* block */)arg3;
