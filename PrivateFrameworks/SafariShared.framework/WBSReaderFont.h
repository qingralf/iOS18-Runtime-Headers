...
@property (getter=isReadyToUse, nonatomic, readonly) bool readyToUse;
...
- (void).cxx_destruct;
- (struct __CTFontDescriptor { }*)_createFontDescriptorRefForFontFamilyName:(id)arg1 restrictToEnabled:(bool)arg2;
