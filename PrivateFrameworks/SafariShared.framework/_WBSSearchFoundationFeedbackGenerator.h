...
@interface _WBSSearchFoundationFeedbackGenerator : NSObject <_CompletionListRankingObserverFeedbackGenerator> {
    ...
    SFSearchResult * _hiddenIgnoredSiriSuggestedWebsite;
...
@property (nonatomic) <_CompletionListRankingObserverFeedbackGeneratorDelegate> *delegate; /* unknown property attribute: ? */
...
- (void)didEncounterHiddenIgnoredSiriSuggestedSite:(id)arg1;
- (void)didEndRanking;
- (id)init;
- (id)rankingFeedback;
