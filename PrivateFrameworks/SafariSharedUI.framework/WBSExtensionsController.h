...
@interface WBSExtensionsController : NSObject <WBSCloudExtensionStateProvider, WBSExtensionsExportDataSource, _EXQueryControllerDelegate> {
...
- (void)_extensionDiscoveryHasNewResults:(id)arg1;
...
- (void)_loadExtensions:(id)arg1 skipEqualityCheck:(bool)arg2;
...
- (id)extensionsWithAdamID:(id)arg1;
- (void)findExtensions;
...
- (id)lastSeenBaseURIForExtension:(id)arg1;
