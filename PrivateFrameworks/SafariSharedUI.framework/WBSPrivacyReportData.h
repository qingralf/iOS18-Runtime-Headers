...
+ (id)cachedPrivacyReportDataOnStartPageForProfileWithIdentifier:(id)arg1;
...
+ (void)setCachedPrivacyReportDataOnStartPage:(id)arg1 forProfileWithIdentifier:(id)arg2;
