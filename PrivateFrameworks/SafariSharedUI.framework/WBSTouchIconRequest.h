...
+ (id)requestWithTitle:(id)arg1 url:(id)arg2 minimumIconSize:(struct CGSize { double x1; double x2; })arg3 maximumIconSize:(struct CGSize { double x1; double x2; })arg4 monogramConfiguration:(id)arg5 options:(unsigned long long)arg6;
...
- (id)initWithTitle:(id)arg1 url:(id)arg2 minimumIconSize:(struct CGSize { double x1; double x2; })arg3 maximumIconSize:(struct CGSize { double x1; double x2; })arg4 monogramConfiguration:(id)arg5 options:(unsigned long long)arg6;
