...
@property (nonatomic, readonly) WKWebExtensionMatchPattern *webKitMatchPattern;
...
+ (id)matchPatternForDomainWithoutSubdomains:(id)arg1;
+ (id)matchPatternWithString:(id)arg1;
+ (id)matchPatternWtihWebKitPattern:(id)arg1;
+ (id)matchPatternsWtihWebKitPatterns:(id)arg1;
...
- (id)initWithWebKitMatchPattern:(id)arg1;
