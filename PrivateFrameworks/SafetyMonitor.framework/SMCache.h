...
@interface SMCache : NSObject <NSCopying, NSSecureCoding> {
...
- (id)initWithIdentifier:(id)arg1 deviceStatus:(id)arg2 locationsDuringSession:(id)arg3 unlockLocation:(id)arg4 lockLocation:(id)arg5 mostRecentLocation:(id)arg6 startingLocation:(id)arg7 offWristLocation:(id)arg8 parkedCarLocation:(id)arg9 destinationMapItem:(id)arg10 workoutEvents:(id)arg11;
