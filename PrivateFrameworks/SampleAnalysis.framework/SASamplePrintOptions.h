...
@interface SASamplePrintOptions : NSObject <NSCopying> {
    ...
    bool  _displayBody;
    bool  _displayCPUClusterInfoForRunningThreads;
    ...
    bool  _omitStacksWithECore;
    bool  _omitStacksWithPCore;
    ...
    bool  _printJson;
    bool  _printProblematicProcessesAndThreads;
...
@property bool displayCPUClusterInfoForRunningThreads;
...
@property bool displayExclaveFrames;
...
@property bool displayTrialInformation;
...
@property bool omitStacksWithECore;
@property bool omitStacksWithPCore;
...
@property bool printProblematicProcessesAndThreads;
...
- (void)setDisplayCPUClusterInfoForRunningThreads:(bool)arg1;
...
- (void)setDisplayExclaveFrames:(bool)arg1;
...
- (void)setDisplayTrialInformation:(bool)arg1;
...
- (void)setOmitStacksWithECore:(bool)arg1;
- (void)setOmitStacksWithPCore:(bool)arg1;
...
- (void)setPrintProblematicProcessesAndThreads:(bool)arg1;
...
- (void)setTaskAggregation:(unsigned long long)arg1;
...
- (unsigned long long)taskAggregation;
- (id)tidsToPrint;
