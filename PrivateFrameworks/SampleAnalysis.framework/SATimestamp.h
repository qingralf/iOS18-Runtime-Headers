...
- (id)debugDescription;
- (long long)deltaMachTo:(id)arg1 timeDomainPriorityList:(id)arg2 timeDomainUsed:(unsigned long long*)arg3;
- (double)deltaSecondsTo:(id)arg1 timeDomainPriorityList:(id)arg2 timeDomainUsed:(unsigned long long*)arg3;
- (bool)eq:(id)arg1;
- (bool)ge:(id)arg1;
- (bool)gt:(id)arg1;
