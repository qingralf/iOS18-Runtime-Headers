...
@interface SIBaseNetworkE5RT : NSObject <SINetworkProtocol> {
    ...
    bool  _isModelCompiledInRuntime;
...
- (long long)_loadModel:(id)arg1 operation:(struct e5rt_execution_stream_operation {}**)arg2;
- (long long)_setupMetaDataFromLibrary;
- (long long)addPrewiringBuffersToStreamForFunctionName:(id)arg1 inputPools:(id)arg2 outputPools:(id)arg3 clearWiredBuffer:(bool)arg4;
- (void)dealloc;
...
- (struct __IOSurface { }*)getOutputSurface:(id)arg1;
...
- (long long)selectComputeOperationByFunctionName:(id)arg1;
- (long long)setInput:(id)arg1 fromCVPixelBuffer:(struct __CVBuffer { }*)arg2;
- (long long)setInput:(id)arg1 fromRawPointer:(const void*)arg2;
- (long long)setOutputBlob:(id)arg1 forOutputSurface:(struct __IOSurface { }*)arg2;
- (bool)supportFloat16IO;
- (bool)supportZeroCopyOutput;
- (long long)switchConfiguration:(id)arg1;
- (long long)unwirePrewiringBuffers;
- (long long)unwirePrewiringBuffersForFunctionName:(id)arg1;
