...
@interface SCRCGestureFactory : NSObject {
    ...
    <SCRCGestureFactoryCallback> * _didBeginSplitGestureDelegate;
    long long  _direction;
    double  _directionalSlope;
    long long  _directions;
    double  _distance;
    ...
    bool  _usesAbsoluteDistanceForPinch;
}

@property (nonatomic) bool splitFlickEnabled;
@property (nonatomic) bool thumbRejectionEnabled;
@property (nonatomic) bool usesAbsoluteDistanceForPinch;
...
- (void)setSplitFlickEnabled:(bool)arg1;
...
- (void)setUsesAbsoluteDistanceForPinch:(bool)arg1;
- (bool)splitFlickEnabled;
- (struct CGPoint { double x1; double x2; })splitTapPrimaryFingerPoint;
