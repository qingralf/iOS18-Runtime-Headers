...
@interface SCROBrailleDisplay : NSObject <BRLTBrailleStateManagerDelegate, SCROBrailleDisplayCommandDispatcherDelegate, SCROBrailleDriverDelegate> {
    ...
    bool  _isInputContracted;
    bool  _isInputEightDot;
    bool  _isValid;
...
@property (nonatomic, readonly) NSString *inputTableIdentifier;
@property (nonatomic, readonly) bool isInputContracted;
@property (nonatomic, readonly) bool isInputEightDot;
...
@property (nonatomic, readonly) NSString *outputTableIdentifier;
@property (nonatomic) unsigned int persistentKeyModifiers;
@property (nonatomic, retain) SCRO2DBrailleData *planarData;
...
- (void)_brailleDisplayStringDidChangeHandler:(id)arg1 brailleSelection:(id)arg2;
...
- (void)_setPlanarDataHandler:(id)arg1;
...
- (void)unsleep;
- (void)updateBlinkingCursorTimer:(bool)arg1;
- (id)virtualStatus;
