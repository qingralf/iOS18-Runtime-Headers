...
@interface SCROBrailleDisplayManager : NSObject <BRLTBrailleModelDelegate, SCROBrailleDisplayDelegate> {
    int  _alertPriority;
    ...
    unsigned long long  _systemVirtualDisplayToken;
...
- (void)_eventQueue_didChangeBrailleString:(id)arg1 brailleSelection:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2;
...
- (unsigned long long)_eventQueue_loadVirtualDisplay:(id)arg1;
- (id)_eventQueue_mainAttributedString;
- (id)_eventQueue_mainCellsForVirtualDisplay:(unsigned long long)arg1;
- (void)_eventQueue_panDisplay:(long long)arg1 token:(int)arg2;
- (void)_eventQueue_planarPanDisplay:(long long)arg1 token:(int)arg2;
...
- (void)_eventQueue_setInputTableWithIdentifier:(id)arg1;
...
- (void)_eventQueue_setPlanarData:(id)arg1;
...
- (void)_eventQueue_unloadVirtualDisplay:(unsigned long long)arg1;
- (void)_eventQueue_virtualDisplay:(unsigned long long)arg1 pressButton:(unsigned long long)arg2;
- (void)_eventQueue_virtualDisplay:(unsigned long long)arg1 pressKeyChord:(unsigned long long)arg2;
- (void)_eventQueue_virtualDisplay:(unsigned long long)arg1 pressRouterWithIndex:(unsigned long long)arg2;
- (bool)_isIOElementHID:(id)arg1;
...
- (void)configureInputTableWithIdentifier:(id)arg1;
...
- (unsigned long long)loadVirtualDisplayWithMainSize:(long long)arg1;
- (id)mainAttributedString;
- (id)mainCellsForVirtualDisplay:(unsigned long long)arg1;
...
- (void)planarPanDisplayLeft:(int)arg1;
- (void)planarPanDisplayRight:(int)arg1;
...
- (void)setBlinkingCursorEnabled:(bool)arg1;
...
- (void)setSystemVirtualDisplayToken:(unsigned long long)arg1;
...
- (void)systemVirtualDisplayPressKeyChord:(unsigned long long)arg1;
- (unsigned long long)systemVirtualDisplayToken;
...
- (void)unloadVirtualDisplay:(unsigned long long)arg1;
- (void)virtualDisplay:(unsigned long long)arg1 pressButton:(unsigned long long)arg2;
- (void)virtualDisplay:(unsigned long long)arg1 pressKeyChord:(unsigned long long)arg2;
- (void)virtualDisplay:(unsigned long long)arg1 pressRouterWithIndex:(unsigned long long)arg2;
