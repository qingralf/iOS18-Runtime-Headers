...
@property (nonatomic, readonly) BRLTEditString *editString;
...
@property (nonatomic, readonly) bool needsTechnicalMode;
...
- (void)addText:(id)arg1 overrideText:(id)arg2 language:(id)arg3 selection:(struct _NSRange { unsigned long long x1; unsigned long long x2; }*)arg4 token:(long long)arg5 focus:(struct _NSRange { unsigned long long x1; unsigned long long x2; }*)arg6 technical:(bool)arg7 isEditableText:(bool)arg8 paddingRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg9 suggestionRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg10 editingString:(id)arg11 textFormattingRanges:(id)arg12 selectionOnDifferentLine:(bool)arg13;
...
- (id)initWithOutputTableIdentifier:(id)arg1 inputTableIdentifier:(id)arg2 showDotsSevenAndEight:(bool)arg3;
