...
- (void)loadTranslatorWithServiceIdentifier:(id)arg1 forUnitTesting:(bool)arg2 input:(bool)arg3;
- (void)loadTranslatorWithServiceIdentifier:(id)arg1 input:(bool)arg2;
