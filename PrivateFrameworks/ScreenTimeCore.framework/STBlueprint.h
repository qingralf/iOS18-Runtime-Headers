...
+ (id)blueprintTypeForDeclarationType:(id)arg1;
...
+ (bool)disableRestrictionsBlueprintForUser:(id)arg1 error:(id*)arg2;
...
+ (id)fetchRequest;
+ (id)fetchRequestMatchingBlueprintsForUser:(id)arg1 fromOrganization:(id)arg2 includeTombstones:(bool)arg3;
+ (id)fetchRequestMatchingBlueprintsForUser:(id)arg1 ofType:(id)arg2 fromOrganization:(id)arg3 includeTombstones:(bool)arg4;
+ (id)fetchRequestMatchingBlueprintsForUser:(id)arg1 ofType:(id)arg2 withIdentifier:(id)arg3 fromOrganization:(id)arg4 includeTombstones:(bool)arg5;
...
- (bool)_validateBlueprintConfiguration:(id)arg1;
- (bool)_validateBlueprintIdentifier:(id)arg1;
- (bool)_validateNumberOfBlueprints:(id)arg1;
- (bool)_validateType:(id)arg1;
- (bool)_validateUsersOnBlueprint:(id)arg1;
