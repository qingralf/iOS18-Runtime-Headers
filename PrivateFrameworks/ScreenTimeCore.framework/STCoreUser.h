...
+ (id)localizedFullNameForAppleID:(id)arg1 givenName:(id)arg2 familyName:(id)arg3 systemFullUserName:(id)arg4;

- (void).cxx_destruct;
- (id)_contactStoreForUser;
- (id)_primaryContainerInContactStore:(id)arg1 withError:(id*)arg2;
- (bool)_validateAltDSID:(id)arg1;
- (bool)_validateAppleID:(id)arg1;
- (bool)_validateDSID:(id)arg1;
- (bool)_validateLocalUser:(id)arg1;
- (bool)_validateNumberOfLocalUsers:(id)arg1;
- (bool)_validateRemoteUser:(id)arg1;
