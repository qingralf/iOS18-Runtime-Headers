...
- (void)enableWebContentFilterWithCompletionHandler:(id /* block */)arg1;
- (id)init;
...
- (void)isWebContentRestricted:(id /* block */)arg1;
...
- (void)postNotificationForContext:(id)arg1;
...
- (bool)triggerDowngradeMigrationWithOutError:(id*)arg1;
