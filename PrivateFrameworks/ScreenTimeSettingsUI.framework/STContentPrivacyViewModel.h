...
@interface STContentPrivacyViewModel : NSObject {
    ...
    bool  _isLoaded;
    bool  _isLocalDevice;
    bool  _isSiriImageGenerationAllowed;
...
@property (nonatomic, readonly) bool isEligibleForAppDistribution;
@property (nonatomic) bool isLoaded;
@property (nonatomic) bool isLocalDevice;
@property (nonatomic) bool isSiriImageGenerationAllowed;
...
- (void)setIsSiriImageGenerationAllowed:(bool)arg1;
