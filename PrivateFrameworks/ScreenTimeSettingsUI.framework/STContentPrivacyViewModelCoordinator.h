...
@interface STContentPrivacyViewModelCoordinator : NSObject <NSFetchedResultsControllerDelegate, STContentPrivacyViewModelCoordinator> {
    ...
    bool  _isLocalDevice;
    NSNumber * _isRestrictAdultContentEnabledValue;
    unsigned long long  _numExpectedChanges;
    <STOrganizationSettingsRestrictionUtilityProtocol> * _organizationSettingsRestrictionUtility;
...
@property (nonatomic, retain) NSNumber *isRestrictAdultContentEnabledValue;
@property unsigned long long numExpectedChanges;
@property (nonatomic, readonly) <STOrganizationSettingsRestrictionUtilityProtocol> *organizationSettingsRestrictionUtility;
...
- (id)initWithPersistenceController:(id)arg1 organizationSettingsRestrictionUtility:(id)arg2 userDSID:(id)arg3 userName:(id)arg4;
- (id)initWithPersistenceController:(id)arg1 userDSID:(id)arg2 userName:(id)arg3;
- (bool)isLocalDevice;
- (id)isRestrictAdultContentEnabledValue;
...
- (id)organizationSettingsRestrictionUtility;
...
- (void)saveSiriImageGenerationIsAllowed:(bool)arg1 completionHandler:(id /* block */)arg2;
...
- (void)setIsRestrictAdultContentEnabledValue:(id)arg1;
