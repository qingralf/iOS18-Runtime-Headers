...
+ (void)loadRegionRatingsWithUnrated:(bool)arg1 completionHandler:(id /* block */)arg2;
+ (id)sharedRatings;
...
- (id)getClosestRestrictionMatch:(id)arg1 within:(id)arg2 forPayloadKey:(id)arg3;
- (id)getRatingSystemTypeFrom:(id)arg1;
- (void)loadRegionRatingsDataWithCompletionHandler:(id /* block */)arg1;
- (void)loadRegionRatingsDataWithUnrated:(bool)arg1 completionHandler:(id /* block */)arg2;
