...
@interface STRootViewModel : NSObject {
    ...
    NSArray * _children;
    NSArray * _devices;
    bool  _hasWatchOSDevicesInternal;
    bool  _hasWatchOSDevicesOnlyInternal;
...
@property (nonatomic) bool hasWatchOSDevicesInternal;
@property (readonly) bool hasWatchOSDevicesOnly;
@property (nonatomic) bool hasWatchOSDevicesOnlyInternal;
...
- (void)setHasWatchOSDevicesInternal:(bool)arg1;
- (void)setHasWatchOSDevicesOnlyInternal:(bool)arg1;
