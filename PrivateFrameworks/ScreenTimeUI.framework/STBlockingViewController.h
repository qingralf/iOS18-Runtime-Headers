...
@interface STBlockingViewController : UIViewController <CNContactViewControllerDelegate, STMenuButtonDelegate> {
    ...
    <MOCancellable> * _effectiveSettingsSubscription;
...
@property (retain) <MOCancellable> *effectiveSettingsSubscription;
...
- (long long)_dmfPolicyFromScreenTimeShieldPolicy:(id)arg1;
...
- (long long)_managedSettingsShieldPolicyForBundleIdentifier:(id)arg1 category:(id)arg2;
- (long long)_managedSettingsShieldPolicyForCategoryIdentifier:(id)arg1;
- (long long)_managedSettingsShieldPolicyForWebURL:(id)arg1 category:(id)arg2;
- (id)_newContact;
- (void)_ok:(id)arg1;
...
- (void)dealloc;
- (id)effectiveSettingsStore;
- (id)effectiveSettingsSubscription;
...
- (bool)isApplicationShieldedWithBundleIdentifier:(id)arg1;
- (bool)isCategoryShieldedWithIdentifier:(id)arg1;
- (bool)isChangePolicyButtonHidden;
- (bool)isShieldedThroughManagedSettings;
- (bool)isShowingPolicyOptions;
- (bool)isWebDomainShieldedWithWebURL:(id)arg1;
...
- (void)setEffectiveSettingsSubscription:(id)arg1;
