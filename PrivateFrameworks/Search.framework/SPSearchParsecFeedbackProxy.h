...
@interface SPSearchParsecFeedbackProxy : NSObject <SFFeedbackListener> {
    SPCoreParsecInterface * _interface;
    NSObject<SFFeedbackListener> * _listener;
}

@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (readonly, copy) NSString *description;
@property (readonly) unsigned long long hash;
@property SPCoreParsecInterface *interface;
@property (nonatomic, retain) NSObject<SFFeedbackListener> *listener;
