...
@interface RFBinaryButtonCardSection : SFCardSection <NSCopying, NSSecureCoding, RFBinaryButtonCardSection> {
...
@property (nonatomic, retain) SFButtonItem *primary_button;
...
@property (nonatomic, retain) SFButtonItem *secondary_button;
