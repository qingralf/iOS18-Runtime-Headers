...
@interface RFFactItemShortHeroNumberCardSection : SFCardSection <NSCopying, NSSecureCoding, RFFactItemShortHeroNumberCardSection> {
...
@property (nonatomic, retain) RFTextProperty *number;
...
@property (nonatomic, retain) RFTextProperty *unit;
