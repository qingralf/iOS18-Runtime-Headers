...
@interface RFSummaryItemAlignedTextCardSection : SFCardSection <NSCopying, NSSecureCoding, RFSummaryItemAlignedTextCardSection> {
...
@property (nonatomic, copy) NSArray *text_6;
