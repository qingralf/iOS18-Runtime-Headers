...
@interface RFSummaryItemPairNumberCardSection : SFCardSection <NSCopying, NSSecureCoding, RFSummaryItemPairNumberCardSection> {
...
@property (nonatomic, retain) SFButtonItem *button_1;
...
@property (nonatomic, retain) RFTextProperty *number_1;
@property (nonatomic, retain) RFTextProperty *number_2;
...
@property (nonatomic, retain) RFTextProperty *text_3;
@property (nonatomic, retain) RFTextProperty *text_4;
@property (nonatomic, copy) NSArray *text_5;
@property (nonatomic, retain) RFTextProperty *text_6;
@property (nonatomic, retain) RFTextProperty *text_7;
@property (nonatomic, retain) RFTextProperty *text_8;
@property (nonatomic, retain) RFTextProperty *text_9;
@property (nonatomic, retain) RFVisualProperty *thumbnail_1;
@property (nonatomic, retain) RFVisualProperty *thumbnail_2;
...
- (void)setNumber_1:(id)arg1;
- (void)setNumber_2:(id)arg1;
