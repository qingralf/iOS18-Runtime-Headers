...
@interface RFSummaryItemPlayerCardSection : SFCardSection <NSCopying, NSSecureCoding, RFSummaryItemPlayerCardSection> {
...
@property (nonatomic, retain) SFButtonItem *player;
