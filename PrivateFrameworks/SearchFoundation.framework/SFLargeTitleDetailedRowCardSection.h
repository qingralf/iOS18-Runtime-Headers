...
@interface SFLargeTitleDetailedRowCardSection : SFCardSection <NSCopying, NSSecureCoding, SFLargeTitleDetailedRowCardSection> {
...
@property (nonatomic, retain) SFButtonItem *subtitleButtonItem;
