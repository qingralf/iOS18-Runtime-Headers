...
@interface SFListenToCardSection : SFCardSection <NSCopying, NSSecureCoding, SFListenToCardSection> {
...
@property (nonatomic, retain) SFCardSection *fallbackCardSection;
