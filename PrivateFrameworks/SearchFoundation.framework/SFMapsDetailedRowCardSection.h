...
@property (nonatomic, retain) SFDetailedRowCardSection *internalDetailedRowCardSection;
...
- (id)internalDetailedRowCardSection;
- (bool)isEqual:(id)arg1;
- (id)jsonData;
- (id)mapsData;
- (id)pinText;
- (void)setInternalDetailedRowCardSection:(id)arg1;
