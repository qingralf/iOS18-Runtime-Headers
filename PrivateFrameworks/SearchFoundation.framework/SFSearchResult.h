...
@property (nonatomic, retain) NSNumber *indexOfResultInSectionWhenRanked;
@property (nonatomic, retain) NSNumber *indexOfSectionWhenRanked;
...
@property (nonatomic, copy) SFCommandButtonItem *moreResultsButton;
...
@property (nonatomic, retain) SFPhotosAggregatedInfo *photosAggregatedInfo;
...
@property (nonatomic, retain) SFSafariAttributes *safariAttributes;
@property (nonatomic, readonly) NSString *safari_identifierForCaching;
...
@property (nonatomic, retain) SFCard *tophitCard;
...
- (id)icon;
- (id)identifier;
- (id)indexOfResultInSectionWhenRanked;
- (id)indexOfSectionWhenRanked;
...
- (void)setHasAppTopHitShortcut:(bool)arg1;
- (void)setIcon:(id)arg1;
- (void)setIdentifier:(id)arg1;
- (void)setIndexOfResultInSectionWhenRanked:(id)arg1;
- (void)setIndexOfSectionWhenRanked:(id)arg1;
...
- (void)setMoreResultsButton:(id)arg1;
...
- (void)setPhotosAggregatedInfo:(id)arg1;
...
- (void)setSafariAttributes:(id)arg1;
...
- (bool)_sf_canOpenInBrowser;
- (bool)_sf_isMediaResult;
- (id)_sf_punchoutURL;
...
- (void)safari_configureBackgroundColorForCompletionList:(id)arg1;
...
- (id)_firstCardSectionOfClass:(Class)arg1 ofCard:(id)arg2;
