...
@interface SFSplitCardSection : SFCardSection <NSCopying, NSSecureCoding, SFSplitCardSection> {
    SFRichText * _body;
...
@property (nonatomic, retain) SFRichText *body;
@property (nonatomic, retain) SFRichText *bottomTitle;
