...
@property (nonatomic, retain) _SFPBDefaultPunchoutAppIconImage *defaultPunchoutAppIconImage;
...
@property (nonatomic, retain) _SFPBShortcutsImage *shortcutsImage;
...
- (id)defaultPunchoutAppIconImage;
...
- (void)setDefaultPunchoutAppIconImage:(id)arg1;
...
- (void)setShortcutsImage:(id)arg1;
