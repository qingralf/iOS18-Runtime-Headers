...
@interface _SFPBInfoCardSection : PBCodable <NSSecureCoding, _SFPBInfoCardSection> {
...
@property (nonatomic, copy) NSArray *infoTuples;
...
- (id)infoTuples;
- (id)infoTuplesAtIndex:(unsigned long long)arg1;
