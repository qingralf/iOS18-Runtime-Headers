...
@interface SearchUICollectionViewCell : UICollectionViewListCell <SearchUIBackgroundColorViewProtocol, SearchUIHighlightTarget> {
    ...
    _UIConstraintBasedLayoutHostingView * _hostedSnippetUIView;
...
@property (nonatomic, retain) _UIConstraintBasedLayoutHostingView *hostedSnippetUIView;
...
- (void)setHostedSnippetUIView:(id)arg1;
