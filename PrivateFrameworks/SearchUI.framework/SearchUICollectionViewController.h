...
@interface SearchUICollectionViewController : SearchUIKeyboardableCollectionViewController <EKEventEditViewDelegate, SearchUICollectionViewRestorationProtocol, SearchUICollectionViewSizingDelegate, SearchUIFeedbackDelegateInternal, SearchUIHeaderDelegate, SearchUIRowModelViewDelegate, SearchUIViewTesting, UICollectionViewDataSource, UICollectionViewDelegate> {
...
@property (nonatomic, readonly) SearchUICommandEnvironment *commandEnvironment;
...
- (bool)isEntitySearch;
- (bool)isExpandedForSectionModel:(id)arg1;
