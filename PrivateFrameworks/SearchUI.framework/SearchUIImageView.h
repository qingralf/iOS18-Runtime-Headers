...
- (void)updateWithImage:(id)arg1 animateTransition:(bool)arg2;
- (void)updateWithImage:(id)arg1 fallbackImage:(id)arg2 needsOverlayButton:(bool)arg3;
- (void)updateWithImage:(id)arg1 fallbackImage:(id)arg2 needsOverlayButton:(bool)arg3 animateTransition:(bool)arg4;
