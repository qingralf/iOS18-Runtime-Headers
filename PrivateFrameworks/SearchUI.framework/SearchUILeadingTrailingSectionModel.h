...
- (void).cxx_destruct;
- (id)buildGroupForFractionalWidth:(double)arg1 numberOfCards:(long long)arg2 isTopAligned:(bool)arg3 prefersSeparator:(bool)arg4 forView:(id)arg5;
- (id)cardSection;
...
- (void)setCustomSectionInsets:(bool)arg1;
