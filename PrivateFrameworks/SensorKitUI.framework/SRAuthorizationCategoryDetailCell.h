...
@interface SRAuthorizationCategoryDetailCell : UITableViewCell {
    ...
    long long  _numberOfWhatIsSharedLabels;
    long long  _numberOfWhenSharedLabels;
    bool  _showAppUsage;
    UIStackView * _stacks;
    UIFont * _titleFont;
    NSArray * _whatIsSharedLabels;
    UILabel * _whatIsSharedTitleLabel;
...
@property (nonatomic, retain) NSArray *whatIsSharedLabels;
@property (nonatomic, readonly) UILabel *whatIsSharedTitleLabel;
...
- (long long)numberOfWhatIsSharedLabels;
...
- (void)setNumberOfWhatIsSharedLabels:(long long)arg1;
