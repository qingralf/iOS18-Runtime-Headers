...
@interface SRSensorWriter : NSObject <SRAuthorizationClientDelegate, SRAuthorizationStoreReaderAuthorizationDelegate, SRDaemonNotificationDelegate> {
    ...
    NSDictionary * _lastConfiguration;
    unsigned long long  _lastConfigurationContinuousTime;
...
- (unsigned long long)lastConfigurationContinuousTime;
- (id)lastMetadata;
...
- (void)setLastConfigurationContinuousTime:(unsigned long long)arg1;
