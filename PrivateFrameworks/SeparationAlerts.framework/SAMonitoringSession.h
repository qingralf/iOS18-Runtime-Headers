...
@interface SAMonitoringSession : NSObject <NSSecureCoding> {
    ...
    NSDate * _lastAlertDateInCurrentTravelingSession;
...
@property (nonatomic, retain) NSDate *lastAlertDateInCurrentTravelingSession;
...
- (id)lastAlertDateInCurrentTravelingSession;
...
- (void)setLastAlertDateInCurrentTravelingSession:(id)arg1;
