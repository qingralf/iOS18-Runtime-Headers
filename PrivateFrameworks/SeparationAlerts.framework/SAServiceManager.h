...
@interface SAServiceManager : NSObject <SAServiceClientProtocol, SAServiceServiceProtocol> {
    ...
    bool  _beaconGroupComplete;
    bool  _beaconGroupSafeLocationsMatch;
    ...
    id /* block */  _scheduledMetricSubmissionBlock;
...
@property (nonatomic) bool beaconGroupComplete;
@property (nonatomic) bool beaconGroupSafeLocationsMatch;
...
@property (nonatomic, copy) id /* block */ scheduledMetricSubmissionBlock;
...
- (int)beaconGroupSizeForDeviceType:(unsigned long long)arg1 isAppleAudioAccessory:(bool)arg2;
- (id)clients;
- (void)dealloc;
...
- (id /* block */)scheduledMetricSubmissionBlock;
...
- (void)setBeaconGroupComplete:(bool)arg1;
- (void)setBeaconGroupSafeLocationsMatch:(bool)arg1;
...
- (void)setScheduledMetricSubmissionBlock:(id /* block */)arg1;
