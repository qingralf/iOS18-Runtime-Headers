...
@interface SASingleDeviceRecord : NSObject <NSSecureCoding> {
    ...
    CLCircularRegion * _lastWithYouLocation;
    TASPAdvertisement * _latestAdvertisement;
    NSDate * _latestCaseAdvertisementDate;
...
@property (nonatomic, copy) CLCircularRegion *lastWithYouLocation;
@property (nonatomic, readonly) TASPAdvertisement *latestAdvertisement;
@property (nonatomic, readonly) NSDate *latestCaseAdvertisementDate;
...
- (id)latestCaseAdvertisementDate;
...
- (void)updateLatestCaseAdvertisementDate:(id)arg1;
