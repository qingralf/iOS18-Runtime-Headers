...
- (void)_addOnPlanOptionPressed:(id)arg1;
- (void)_addWiFiOffFooter;
- (void)_handleAddRemotePlan:(id)arg1;
- (bool)_shouldShowWiFiOffFooter;
- (void)_turnOnWifiPressed:(id)arg1;
- (id)flow;
- (id)getLogger;
- (id)groupSpecifier;
- (id)init;
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2;
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2 planManager:(id)arg3 ctPlanManager:(id)arg4 showAddOnPlans:(bool)arg5;
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2 showAddOnPlans:(bool)arg3;
- (id)listController;
...
- (id)specifiers;
- (id)specifiersForRemotePlans:(bool)arg1;
