...
@interface PSUICellularPlanManagerCache : NSObject <CoreTelephonyClientCellularPlanManagementDelegate, Loggable> {
    ...
    CTDisplayPlanList * _cachedPendingInstallPlans;
    ...
    bool  _pendingInstallPlanFetchInProgress;
    NSArray * _planItems;
...
@property (nonatomic, readonly) bool isBootstrapRecommended;
@property (nonatomic, readonly) bool isCarrierItemBeingFetched;
...
@property bool pendingInstallPlanFetchInProgress;
@property (nonatomic, readonly) CTDisplayPlanList *pendingInstallPlans;
...
- (void)setCachedPendingInstallPlans:(id)arg1;
...
- (void)setPendingInstallPlanFetchInProgress:(bool)arg1;
