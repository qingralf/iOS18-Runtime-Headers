...
@interface PSUICellularUsageSchedulingGroup : NSObject <PSAppCellularUsageSpecifierDelegate, PSBillingPeriodSelectorSpecifierDelegate> {
...
- (void)calculateUsageWithForcedRefresh:(bool)arg1;
