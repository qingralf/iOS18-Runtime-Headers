...
@property (nonatomic, retain) PSUICoreTelephonyCapabilitiesCache *capabilitiesCache;
...
@property (nonatomic, retain) PSUISatelliteSubgroup *satelliteSubgroup;
...
- (void)setSatelliteSubgroup:(id)arg1;
