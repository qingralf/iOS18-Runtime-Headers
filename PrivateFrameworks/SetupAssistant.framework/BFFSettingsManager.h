...
@interface BFFSettingsManager : NSObject {
    ...
    NSNumber * _stashedWebContentFilteringEnabled;
}
...
- (void)_setCurrentActionButtonData:(id)arg1;
...
- (void)setWebContentFilteringEnabled:(bool)arg1;
- (void)stashAccessibilityData:(id)arg1;
- (void)stashActionButtonData:(id)arg1;
