...
- (id)initWithProductVersion:(id)arg1 buildVersion:(id)arg2 date:(id)arg3;
- (id)initWithProductVersion:(id)arg1 buildVersion:(id)arg2 date:(id)arg3 newUser:(bool)arg4 child:(bool)arg5;
- (id)isChild;
- (id)isNewUser;
