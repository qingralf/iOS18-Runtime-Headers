...
@interface SASExpressSettings : PBCodable <NSCopying> {
    ...
    struct { 
        ...
        unsigned int siriVoiceTriggerEnabled : 1; 
        unsigned int softwareUpdateAutoDownloadEnabled : 1; 
        unsigned int softwareUpdateAutoUpdateEnabled : 1; 
        unsigned int stolenDeviceProtectionEnabled : 1; 
        unsigned int stolenDeviceProtectionStrictModeEnabled : 1; 
    ...
    bool  _siriVoiceTriggerEnabled;
    bool  _softwareUpdateAutoDownloadEnabled;
    bool  _softwareUpdateAutoUpdateEnabled;
    bool  _stolenDeviceProtectionEnabled;
    bool  _stolenDeviceProtectionStrictModeEnabled;
...
@property (nonatomic) bool hasSiriVoiceTriggerEnabled;
@property (nonatomic) bool hasSoftwareUpdateAutoDownloadEnabled;
@property (nonatomic) bool hasSoftwareUpdateAutoUpdateEnabled;
@property (nonatomic) bool hasStolenDeviceProtectionEnabled;
@property (nonatomic) bool hasStolenDeviceProtectionStrictModeEnabled;
...
@property (nonatomic) bool siriVoiceTriggerEnabled;
@property (nonatomic) bool softwareUpdateAutoDownloadEnabled;
@property (nonatomic) bool softwareUpdateAutoUpdateEnabled;
@property (nonatomic) bool stolenDeviceProtectionEnabled;
@property (nonatomic) bool stolenDeviceProtectionStrictModeEnabled;
...
- (void)setHasSiriVoiceTriggerEnabled:(bool)arg1;
- (void)setHasSoftwareUpdateAutoDownloadEnabled:(bool)arg1;
- (void)setHasSoftwareUpdateAutoUpdateEnabled:(bool)arg1;
- (void)setHasStolenDeviceProtectionEnabled:(bool)arg1;
- (void)setHasStolenDeviceProtectionStrictModeEnabled:(bool)arg1;
...
- (void)setSiriVoiceTriggerEnabled:(bool)arg1;
- (void)setSoftwareUpdateAutoDownloadEnabled:(bool)arg1;
- (void)setSoftwareUpdateAutoUpdateEnabled:(bool)arg1;
- (void)setStolenDeviceProtectionEnabled:(bool)arg1;
- (void)setStolenDeviceProtectionStrictModeEnabled:(bool)arg1;
