...
@property (nonatomic, retain) NSNumber *allowMoreOn5G;
...
@property (nonatomic, retain) NSNumber *hasMegaBackup;
...
@property (nonatomic, retain) NSNumber *supportsCellularBackup;
...
- (void)setExpressSettings:(id)arg1;
- (void)setFindMyDeviceOptIn:(id)arg1;
- (void)setFirstName:(id)arg1;
- (void)setHasHomeButton:(bool)arg1;
- (void)setHasInexpensiveCellularNetwork:(id)arg1;
- (void)setHasMegaBackup:(id)arg1;
...
- (void)setSupportsCellularBackup:(id)arg1;
