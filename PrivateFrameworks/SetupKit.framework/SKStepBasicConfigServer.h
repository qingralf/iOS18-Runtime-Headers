...
@property (nonatomic, copy) NSDictionary *outClientConfig;
@property (nonatomic, copy) NSDictionary *serverConfig;
...
- (void)setOutClientConfig:(id)arg1;
