...
@interface SeymourUI.TVQueueListHeaderCell : UICollectionViewCell {
    void buttonFocusGuide;
    void delegate;
    void durationLabel;
    void ellipsisButton;
    void ellipsisButtonContentView;
    union { in /* Warning: Unrecognized filer type: 'u' using 'void*' */ void*x1; long x2; long x3; }  itemInfo;
    void layout;
    void mainButton;
    union { in /* Warning: Unrecognized filer type: 'u' using 'void*' */ void*x1; long x2; long x3; }  mainButtonAction;
    void mainButtonTextView;
    void overviewLabel;
    void titleLabel;
}
