...
- (void).cxx_destruct;
- (void)activate;
- (void)activityViewControllerDidAppearWithSessionID:(id)arg1;
- (void)activityViewControllerDidDisappearWithSessionID:(id)arg1;
...
- (void)activityViewControllerWithSessionID:(id)arg1 findSupportedActivitiesWithCompletionHandler:(id /* block */)arg2;
- (void)activityViewControllerWithSessionID:(id)arg1 performActivityWithType:(id)arg2 completionHandler:(id /* block */)arg3;
