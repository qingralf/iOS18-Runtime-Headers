...
- (void)_startPerformingActivity:(id)arg1 collaborationItem:(id)arg2 skipCollaborationPerformer:(bool)arg3;
...
- (void)findSupportedActivitiesWithCompletionHandler:(id /* block */)arg1;
