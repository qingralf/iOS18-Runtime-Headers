...
@interface SHSheetScene : NSObject <FBSceneDelegate, FBSceneObserver, _SHSheetScene, _UIRemoteSheet> {
    ...
    id /* block */  _fenceCompletionHandler;
    bool  _foreground;
    struct CGRect { 
        struct CGPoint { 
            double x; 
...
@property (nonatomic, copy) id /* block */ fenceCompletionHandler;
...
- (id /* block */)fenceCompletionHandler;
- (bool)foreground;
...
- (void)setFenceCompletionHandler:(id /* block */)arg1;
