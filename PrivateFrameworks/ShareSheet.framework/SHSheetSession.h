...
@interface SHSheetSession : NSObject <SFCollaborationItemChangeObserver, SFCollaborationItemsProviderDelegate, SFUILoadedMetadataCollectionDelegate, SHSheetActivitiesManagerDelegate, SHSheetActivityItemsManagerCollaborationDelegate, SHSheetActivityItemsManagerDelegate, SHSheetSession> {
    ...
    UIActivityCollaborationModeRestriction * _collaborationModeRestriction;
...
@property (nonatomic, retain) UIActivityCollaborationModeRestriction *collaborationModeRestriction;
...
@property (nonatomic, readonly) bool isModeSwitchDisabled;
...
@property (nonatomic, retain) <_SHSheetScene> *remoteScene;
...
@property (nonatomic, readonly) bool showHeaderSpecialization;
...
- (id)collaborationModeRestriction;
...
- (void)setCollaborationModeRestriction:(id)arg1;
