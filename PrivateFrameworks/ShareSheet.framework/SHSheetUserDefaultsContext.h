...
- (id)favoritesProxies;
- (id)initWithApplicationActivityTypes:(id)arg1 activitiesByUUID:(id)arg2 favoritesProxies:(id)arg3 suggestionProxies:(id)arg4 orderedUUIDs:(id)arg5 excludedActivityTypes:(id)arg6 activityCategory:(long long)arg7 isPresentedModally:(bool)arg8;
