...
+ (id)_activityImageForApplicationBundleIdentifier:(id)arg1 userInterfaceStyle:(long long)arg2;
+ (id)_activityImageForBundleImageConfiguration:(id)arg1;
+ (id)_activitySettingsImageForApplicationBundleIdentifier:(id)arg1 userInterfaceStyle:(long long)arg2;
