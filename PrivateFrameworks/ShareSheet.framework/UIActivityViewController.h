...
+ (id)collaborationModeRestrictionFromActivityItemsConfiguration:(id)arg1 collaborationMode:(long long)arg2;
...
- (void)_performActivityWithType:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (unsigned long long)excludedActivitySectionTypes;
...
- (void)performAddToAlbumExtensionWithCompletionHandler:(id /* block */)arg1;
...
- (void)setExcludedActivitySectionTypes:(unsigned long long)arg1;
