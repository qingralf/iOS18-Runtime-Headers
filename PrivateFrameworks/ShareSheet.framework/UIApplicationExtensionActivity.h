...
@interface UIApplicationExtensionActivity : UIActivity <UIActivityExtensionItemDataSource, UIActivityExtensionItemDataTarget> {
    ...
    NSNumber * _overrideActivityCategory;
...
@property (nonatomic, retain) NSNumber *overrideActivityCategory;
...
- (void)setOverrideActivityCategory:(id)arg1;
