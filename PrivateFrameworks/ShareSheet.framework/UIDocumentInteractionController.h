...
@interface UIDocumentInteractionController : NSObject <LSOpenResourceOperationDelegate, QLPreviewControllerDelegate, UIActionSheetDelegate, _UIDICActivityViewControllerDelegate> {
...
@property (getter=_customExtactionRootURL, setter=_setCustomExtactionRootURL:, nonatomic, copy) NSURL *_customExtactionRootURL;
