...
@interface UIMailActivity : UIActivity <UICollaborationActivity, UIManagedConfigurationRestrictableActivity, UIPeopleSuggestionRecipientActivity, UIRecipientsPassthroughActivity, UIStateRestoring> {
...
@property (nonatomic, readonly) Class objectRestorationClass; /* unknown property attribute: ? */
@property (nonatomic, readonly) <UIStateRestoring> *restorationParent; /* unknown property attribute: ? */
