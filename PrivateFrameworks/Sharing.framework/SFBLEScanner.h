...
- (bool)_watchSetupParseData:(id)arg1 fields:(id)arg2;
...
- (void)foundPairingDevice:(id)arg1 payload:(id)arg2 rssi:(id)arg3 peerInfo:(id)arg4 withTimeInMachContSeconds:(double)arg5;
...
- (void)pairingParseAccessoryStatusPayloadPtr:(const char *)arg1 end:(const char *)arg2 fields:(id)arg3;
- (id)pairingParsePayload:(id)arg1 identifier:(id)arg2 bleDevice:(id)arg3 peerInfo:(id)arg4;
...
- (void)parseStatus3:(unsigned char)arg1 productID:(unsigned int)arg2 caseLEDColor:(unsigned char*)arg3 caseLEDStatus:(char *)arg4;
