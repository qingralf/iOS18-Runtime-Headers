...
+ (void)_processRemainingActivityItems:(id)arg1 toFinalActivityItems:(id)arg2 onQueue:(id)arg3 completion:(id /* block */)arg4;
...
+ (id)createLinkMetadataWithCKShare:(id)arg1 containerSetupInfo:(id)arg2;
...
+ (bool)isOplockError:(id)arg1 updatedShare:(id*)arg2;
...
+ (id)optionsFromCKShare:(id)arg1 previousCKOptions:(id)arg2 newCKOptions:(id*)arg3;
...
+ (id)underlyingCKErrorForError:(id)arg1;
+ (id)urlFromActivityItem:(id)arg1 allowsLoading:(bool)arg2;
