...
- (void)_reportErrorMetrics:(id)arg1 errorLabel:(id)arg2 isFatal:(bool)arg3;
- (void)_reportMainMetrics:(id)arg1 errorLabel:(id)arg2 userWaitSeconds:(double)arg3;
- (void)_reportProgress:(unsigned int)arg1 info:(id)arg2;
- (void)_run;
- (int)_runAppleIDSetup;
- (void)_runAppleIDSetupRequest;
- (void)_runAppleIDSetupResponse:(id)arg1 error:(id)arg2;
- (int)_runBasicConfig;
...
- (int)_runWiFiSetup;
- (void)_setNumberOfDevicesOnAccount:(id)arg1;
