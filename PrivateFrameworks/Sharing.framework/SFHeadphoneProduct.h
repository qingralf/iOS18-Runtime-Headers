...
@property (nonatomic) bool hasCaseBT;
@property (nonatomic) bool hasCaseWithoutBattery;
...
- (void)setHasCaseBT:(bool)arg1;
- (void)setHasCaseWithoutBattery:(bool)arg1;
