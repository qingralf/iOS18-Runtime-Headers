...
@property (nonatomic, retain) NSData *targetAuthTag;
...
- (void)pairSetupTryPIN:(id)arg1 peer:(id)arg2;
- (void)pairSetupWithFlags:(unsigned int)arg1 peer:(id)arg2;
- (id)pairVerifyACL;
- (id)peerAppleID;
