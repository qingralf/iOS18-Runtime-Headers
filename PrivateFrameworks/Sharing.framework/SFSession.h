...
- (void)_pairSetupWithFlags:(unsigned int)arg1 completion:(id /* block */)arg2 isServer:(bool)arg3;
...
- (void)pairSetupWithFlags:(unsigned int)arg1 completion:(id /* block */)arg2 isServer:(bool)arg3;
- (id)pairVerifyACL;
...
- (void)registerForExternalIO:(id)arg1;
