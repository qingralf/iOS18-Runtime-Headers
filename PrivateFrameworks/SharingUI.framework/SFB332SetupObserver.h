...
- (void)updateDeviceInfoWithDeviceType:(unsigned long long)arg1 batteryLevel:(double)arg2 batteryLevelKnown:(bool)arg3 edge:(unsigned long long)arg4 orientation:(unsigned long long)arg5 isCharging:(bool)arg6 identifier:(id)arg7;
