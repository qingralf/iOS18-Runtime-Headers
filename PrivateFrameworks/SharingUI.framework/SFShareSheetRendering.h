...
+ (id)drawingCommandsForMoreListEntryTitle:(id)arg1 labelColor:(id)arg2 hostConfig:(id)arg3 activityCategory:(long long)arg4;
...
+ (double)morePlatterMaxWidthFromConfig:(id)arg1 activityCategory:(long long)arg2;
