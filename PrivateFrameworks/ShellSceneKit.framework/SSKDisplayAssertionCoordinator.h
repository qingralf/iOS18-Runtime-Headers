...
@interface SSKDisplayAssertionCoordinator : NSObject <SSKDisplayAssertionProviding, _SSKDisplayAssertionStackDelegate> {
    NSMutableDictionary * _assertionPreferencesMap;
    NSMutableDictionary * _assertionStackMap;
    <SSKDisplayAssertionCoordinatorDelegate> * _delegate;
}

@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (nonatomic) <SSKDisplayAssertionCoordinatorDelegate> *delegate;
