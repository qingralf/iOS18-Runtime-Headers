...
@interface SSKDisplayEndpointClientComponent : FBSSceneComponent <SSKDisplayEndpointProviding> {
    <SSKDisplayEndpointDelegate> * _delegate;
}

@property (nonatomic, readonly) unsigned long long currentDeactivationReasons;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (nonatomic) <SSKDisplayEndpointDelegate> *delegate;
