...
@interface SSKSeededDisplayConfigurationBuilder : NSObject <SSKDisplayConfigurationBuilding> {
    <SSKDisplayConfigurationBuilding> * _builder;
    unsigned long long  _seed;
}

- (void).cxx_destruct;
- (id)buildConfigurationWithError:(id*)arg1;
