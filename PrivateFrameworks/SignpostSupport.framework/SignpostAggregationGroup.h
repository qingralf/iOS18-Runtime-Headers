...
@property (nonatomic, retain) NSDictionary *measuredValueTypeToMeasuredValueDict;
@property (nonatomic, readonly) NSString *name;
@property (nonatomic) SignpostAggregation *parentAggregation;
@property (nonatomic, readonly) bool telemetryEnabled;

+ (id)_sumOfGroup0:(id)arg1 group1:(id)arg2 errorOut:(id*)arg3;
...
- (id)measuredValueTypeToMeasuredValueDict;
- (id)name;
- (id)parentAggregation;
- (void)setDurationTypeToDurationDict:(id)arg1;
- (void)setMeasuredValueTypeToMeasuredValueDict:(id)arg1;
