...
@property (nonatomic, readonly) double nonFirstFrameContributedGlitchTimeRatioAdjustedMsPerS;
...
+ (id)unionOfAnimationIntervals:(id)arg1;
...
- (id)initWithFirstAnimatonInterval:(id)arg1 secondAnimationInterval:(id)arg2;
...
- (id)overrunIntervalsOfType:(unsigned long long)arg1 class:(unsigned long long)arg2 contributingPID:(id)arg3;
- (void)setCompositeIntervals:(id)arg1;
- (double)timeRatioMSPerSForOverrunIntervals:(id)arg1 applyPerceptionAdjustments:(unsigned long long)arg2;
- (double)timeRatioMSPerSForOverrunIntervalsOfType:(unsigned long long)arg1 class:(unsigned long long)arg2 contributingPID:(id)arg3 applyPerceptionAdjustments:(unsigned long long)arg4;
