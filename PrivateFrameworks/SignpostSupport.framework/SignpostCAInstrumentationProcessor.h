...
@property (nonatomic, retain) SignpostFrameLifetimeInterval *previousFrameLifetime;
...
- (void)_handleFrameLifetimeInterval:(id)arg1;
...
- (void)setPreviousFrameLifetime:(id)arg1;
