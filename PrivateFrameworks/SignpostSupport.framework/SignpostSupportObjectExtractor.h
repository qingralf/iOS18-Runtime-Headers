...
- (void)setCachedTimebaseRatio:(double)arg1;
...
+ (bool)getDataSourceDateRange:(id)arg1 earliestDateOut:(id*)arg2 latestDateOut:(id*)arg3 errorsOut:(id*)arg4;
...
- (bool)_processTraceFileWithPath:(id)arg1 startDate:(id)arg2 endDate:(id)arg3 errorOut:(id*)arg4;
- (bool)_processTraceUsingKtraceLoggingDataSource:(id)arg1 startDate:(id)arg2 endDate:(id)arg3 errorOut:(id*)arg4;
- (bool)processFileWithPath:(id)arg1 startDate:(id)arg2 endDate:(id)arg3 errorsOut:(id*)arg4;
...
- (bool)processTraceFileWithPath:(id)arg1 startDate:(id)arg2 endDate:(id)arg3 errorOut:(id*)arg4;
