...
@interface SXActionManager : NSObject <SXActionManager> {
    ...
    <SXPostActionHandlerManager> * _postActionHandlerManager;
...
@property (nonatomic, readonly) <SXPostActionHandlerManager> *postActionHandlerManager;
...
- (id)contextMenuConfigurationForAction:(id)arg1 sourceView:(id)arg2 sourceRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg3;
- (id)currentPreview;
