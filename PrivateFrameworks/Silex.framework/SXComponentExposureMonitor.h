...
- (void)onExposureOf:(id)arg1 traits:(unsigned long long)arg2 then:(id /* block */)arg3;
- (void)onExposureOf:(id)arg1 traits:(unsigned long long)arg2 then:(id /* block */)arg3 when:(id /* block */)arg4;
