...
@interface SXDOMConditionResolverModifier : NSObject <SXDOMModifying> {
    ...
    <SXConditionalResolverModifierInstructions> * _instructions;
...
@property (nonatomic, readonly) bool hasCheckedInstructions;
@property (readonly) unsigned long long hash;
@property (nonatomic, readonly) <SXConditionalResolverModifierInstructions> *instructions;
...
@property (nonatomic, readonly) bool resolveDocumentStyle;
