...
@property (nonatomic, readonly) NSArray *orderedImageIdentifiers;
@property (nonatomic, readonly) NSArray *requiredNonImageResourceURLs;
...
- (id)allResourcesForImageIdentifier:(id)arg1;
...
- (id)metadata;
- (id)orderedImageIdentifiers;
- (id)requiredNonImageResourceURLs;
