...
@property (nonatomic, readonly) NSMutableOrderedSet *optimalImageResources;
@property (nonatomic, readonly) NSMutableDictionary *optimalImageResourcesByID;
