...
@interface SXScrollViewController : UIViewController <SXComponentHosting, SXDocumentSectionHosting, SXFormatInteractorDelegate, SXInteractionContextManagerDelegate, SXKeyboardSupport, SXPresentationDelegate, SXPresentationEnvironment, SXScrollPositionRestoring, SXScrollViewDelegate, SXTangierControllerDelegate, SXViewportChangeListener, UIGestureRecognizerDelegate> {
    ...
    <SXLinkHoverStylingManager> * _hoverStyleManager;
...
@property (nonatomic, readonly) <SXLinkHoverStylingManager> *hoverStyleManager;
