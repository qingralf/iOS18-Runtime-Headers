...
@interface SXStandaloneTextLayout : SXContainerLayout <TSWPColumnMetrics, TSWPLayoutParent> {
    <SXStandaloneTextLayoutDelegate> * _delegate;
}
...
@property (nonatomic) <SXStandaloneTextLayoutDelegate> *delegate;
@property (nonatomic, readonly) TSWPPadding *layoutMargins;
@property (nonatomic, readonly) bool shrinkTextToFit;
@property (nonatomic, readonly) double textScaleFactor; /* unknown property attribute: ? */
