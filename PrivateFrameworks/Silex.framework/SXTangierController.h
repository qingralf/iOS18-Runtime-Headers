...
- (void)endSelection;
- (id)icc;
- (id)initWithViewport:(id)arg1 scrollView:(id)arg2 componentActionHandler:(id)arg3 dragItemProvider:(id)arg4 componentController:(id)arg5 componentInteractionManager:(id)arg6 DOMObjectProvider:(id)arg7 adIgnorableViewFactory:(id)arg8 config:(id)arg9;
...
- (unsigned long long)selectableWordLimit;
- (id)selectedText;
