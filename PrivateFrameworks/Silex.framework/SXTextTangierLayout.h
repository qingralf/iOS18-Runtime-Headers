...
@interface SXTextTangierLayout : TSDContainerLayout <TSWPColumnMetrics, TSWPExteriorTextWrap, TSWPLayoutParent> {
...
@property (nonatomic, retain) SXTextTangierTextWrapper *textWrapper;
