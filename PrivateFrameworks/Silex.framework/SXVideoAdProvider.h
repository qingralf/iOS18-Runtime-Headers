...
@property (nonatomic, readonly) double impressionThreshold; /* unknown property attribute: ? */
@property (nonatomic) <SVVideoMetadata> *metadata;
@property (nonatomic, readonly) UIView *metricsView; /* unknown property attribute: ? */
@property (nonatomic, readonly) double prerollReadyToPlayTimeout;
@property (nonatomic, readonly) UIButton *privacyMarker; /* unknown property attribute: ? */
