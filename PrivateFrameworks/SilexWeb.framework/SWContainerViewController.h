...
@interface SWContainerViewController : UIViewController {
    ...
    <SWPreferredSizeManager> * _preferredSizeManager;
...
@property (nonatomic) bool isPencilInputExpected;
...
@property (nonatomic, readonly) <SWPreferredSizeManager> *preferredSizeManager;
...
- (id)initWithWebContentViewController:(id)arg1 actionProvider:(id)arg2 interactionProvider:(id)arg3 errorProvider:(id)arg4 configurationManager:(id)arg5 presentationManager:(id)arg6 scaleManager:(id)arg7 snapshotManager:(id)arg8 preferredSizeManager:(id)arg9;
...
- (void)setIsPencilInputExpected:(bool)arg1;
