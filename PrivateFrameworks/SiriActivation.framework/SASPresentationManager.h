...
- (void).cxx_destruct;
- (id)_buildPresentationOptionsWithRequestOptions:(id)arg1;
- (void)_forceAllPresentationsOff;
- (void)_informPresentationOfPresentationWithPriority:(id)arg1 nextPresentationToActivate:(long long)arg2;
...
- (void)_presentationsLock_nextPresentationToActivateDidChange:(long long)arg1;
...
- (void)preheatNextPresentationToActivateWithOptions:(id)arg1;
