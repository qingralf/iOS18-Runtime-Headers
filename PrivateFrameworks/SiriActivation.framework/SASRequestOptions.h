...
@interface SASRequestOptions : NSObject <NSCopying, NSSecureCoding> {
    ...
    long long  _previousInteractionInputType;
    ...
    SASUserEngagementContext * _userEngagementContext;
}
...
@property (nonatomic) bool isForBluetoothCar;
...
@property (nonatomic, readonly) bool isSuggestionSourceWithTextInput;
...
@property (nonatomic, copy) SASUserEngagementContext *userEngagementContext;
...
- (long long)previousInteractionInputType;
...
- (void)setIsForBluetoothCar:(bool)arg1;
...
- (void)setPreviousInteractionInputType:(long long)arg1;
...
- (void)setUserEngagementContext:(id)arg1;
- (id)speechFileURL;
