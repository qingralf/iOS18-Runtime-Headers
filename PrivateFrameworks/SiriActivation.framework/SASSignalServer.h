...
- (oneway void)activationRequestFromTostadaWithContext:(id)arg1;
- (oneway void)activationRequestFromVocalShortcutWithContext:(id)arg1;
...
- (oneway void)setHintGlowAssertionFromButtonIdentifier:(id)arg1 context:(id)arg2;
