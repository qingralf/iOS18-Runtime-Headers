...
- (void)_publishUnorderedMessages:(id)arg1 topic:(id)arg2 attempts:(unsigned long long)arg3 completion:(id /* block */)arg4;
- (void)_purgeStagedMessagesWithCompletion:(id /* block */)arg1;
...
- (void)_runPipelineWithCompletion:(id /* block */)arg1;
...
- (void)_stopIdleTimer;
- (void)_vendResource:(long long)arg1 readonly:(bool)arg2 completion:(id /* block */)arg3;
...
- (oneway void)publishUnorderedMessages:(id)arg1 topic:(id)arg2 completion:(id /* block */)arg3;
- (oneway void)purgeStagedMessagesWithCompletion:(id /* block */)arg1;
- (oneway void)resetLogicalClockWithCompletion:(id /* block */)arg1;
- (oneway void)resolveMessages:(id)arg1 completion:(id /* block */)arg2;
- (oneway void)runPipelineWithCompletion:(id /* block */)arg1;
...
- (oneway void)vendResource:(long long)arg1 readonly:(bool)arg2 completion:(id /* block */)arg3;
