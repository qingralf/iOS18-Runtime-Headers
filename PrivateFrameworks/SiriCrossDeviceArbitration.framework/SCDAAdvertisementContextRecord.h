...
@property (nonatomic, readonly, copy) NSUUID *electionParticipantId;
@property (nonatomic, readonly) double voiceTriggerEndTime;

- (void).cxx_destruct;
- (id)_UUIDFromBytes:(const unsigned char*)arg1;
...
- (id)_getElectionParticipantIdForVersion:(unsigned char)arg1 data:(id)arg2;
...
- (id)initWithAdvertisementRecordType:(long long)arg1 voiceTriggerEndTime:(double)arg2 advertisementPayload:(id)arg3 deviceID:(id)arg4 electionParticipantId:(id)arg5;
