...
@interface SCDACoordinator : NSObject <SCDANotifyObserverDelegate, WPHeySiriProtocol> {
    ...
    SCDAWatchdogTimer * _sfDiagnosticsTimer;
...
- (void)_advertise:(id)arg1 afterDelay:(float)arg2 maxInterval:(float)arg3 voiceTriggerLatency:(float)arg4 andMoveTo:(unsigned long long)arg5;
...
- (void)_advertiseWith:(id)arg1 afterDelay:(float)arg2 maxInterval:(float)arg3 voiceTriggerLatency:(float)arg4 thenExecute:(id /* block */)arg5;
- (void)_ageWedgeFilter;
- (void)_cancelOverallTimeout;
- (void)_cancelTimer;
- (int)_cdaParticipantForDeviceClass:(unsigned char)arg1 andProducType:(unsigned char)arg2;
- (void)_clearMyriadSession;
- (void)_clearWiProxReadinessTimer;
- (void)_computeElectionParticipantIds:(id)arg1;
...
- (void)_endAdvertisingAnalyticsContext:(bool)arg1;
...
- (void)faceDetectedBoostWithContext:(id)arg1;
...
- (void)setupAdvIntervalsInDelay:(float*)arg1 interval:(float*)arg2 voiceTriggerLatency:(float*)arg3 withSlowdown:(int)arg4;
