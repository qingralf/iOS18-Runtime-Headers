...
- (void)logCDAElectionAdvertisingStarting:(int)arg1 withDelay:(float)arg2 withInterval:(float)arg3 withVoiceTriggerLatency:(float)arg4 withCdaId:(id)arg5 withTimestamp:(unsigned long long)arg6;
...
- (void)userFeedbackPublishArbitrationParticipationContext:(id)arg1;
