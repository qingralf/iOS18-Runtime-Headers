...
@property (nonatomic, readonly) struct shared_ptr<semskitbridge::Searcher> { struct Searcher {} *x1; struct __shared_weak_count {} *x2; } searcher;
...
- (id)readInfo;
- (struct shared_ptr<semskitbridge::Searcher> { struct Searcher {} *x1; struct __shared_weak_count {} *x2; })searcher;
- (void)teardown;
