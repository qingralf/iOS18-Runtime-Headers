...
@interface CDASchemaCDAUserFeedbackCompleted : SISchemaInstrumentationMessage {
    ...
    bool  _hasExpectedWinnerElectionParticipantId;
...
@property (nonatomic, retain) SISchemaUUID *expectedWinnerElectionParticipantId;
...
- (id)expectedWinnerElectionParticipantId;
...
- (void)setExpectedWinnerElectionParticipantId:(id)arg1;
...
- (void)setHasExpectedWinnerElectionParticipantId:(bool)arg1;
