...
@property (nonatomic, retain) CMSchemaCMInsertEnded *ended;
@property (nonatomic, retain) CMSchemaCMInsertFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) CMSchemaCMInsertStarted *startedOrChanged;
