...
@property (nonatomic, retain) CMSchemaCMSearchEnded *ended;
@property (nonatomic, retain) CMSchemaCMSearchFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) CMSchemaCMSearchStarted *startedOrChanged;
