...
@property (nonatomic) bool hasSearchDataOptOutState;
...
- (void)setAvailableDictationKeyboards:(unsigned int)arg1;
...
- (void)setHasAvailableDictationKeyboards:(bool)arg1;
...
- (void)setHasSearchDataOptOutState:(bool)arg1;
...
- (void)setSearchDataOptOutState:(int)arg1;
