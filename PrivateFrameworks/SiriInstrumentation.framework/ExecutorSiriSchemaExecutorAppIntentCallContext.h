...
@property (nonatomic, retain) ExecutorSiriSchemaExecutorAppIntentCallEnded *ended;
@property (nonatomic, retain) ExecutorSiriSchemaExecutorAppIntentCallFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic) bool hasTraceId;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) ExecutorSiriSchemaExecutorAppIntentCallStarted *startedOrChanged;
