...
@property (nonatomic, retain) FLOWLINKSchemaFLOWLINKAppShortcutFirstRunConfirmationEnded *ended;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) FLOWLINKSchemaFLOWLINKAppShortcutFirstRunConfirmationStarted *startedOrChanged;
