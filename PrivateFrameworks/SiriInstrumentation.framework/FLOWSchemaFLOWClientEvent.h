...
@interface FLOWSchemaFLOWClientEvent : SISchemaTopLevelUnionType <SISchemaInnerEventContainer> {
    ...
    bool  _hasFlowStep;
    bool  _hasLocationAccessPermissionPromptContext;
...
@property (nonatomic, retain) FLOWSchemaFLOWLocationAccessPermissionPromptContext *locationAccessPermissionPromptContext;
...
- (id)jsonData;
- (id)locationAccessPermissionPromptContext;
...
- (void)setHasLocationAccessPermissionPromptContext:(bool)arg1;
...
- (void)setLocationAccessPermissionPromptContext:(id)arg1;
