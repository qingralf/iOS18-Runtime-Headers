...
@property (nonatomic, retain) GATSchemaGATCreateSessionEventEnded *ended;
@property (nonatomic, retain) GATSchemaGATCreateSessionEventFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) GATSchemaGATCreateSessionEventStarted *startedOrChanged;
