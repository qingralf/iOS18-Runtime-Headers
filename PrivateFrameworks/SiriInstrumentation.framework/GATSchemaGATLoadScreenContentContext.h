...
@property (nonatomic, retain) GATSchemaGATLoadScreenContentEventEnded *ended;
@property (nonatomic, retain) GATSchemaGATLoadScreenContentEventFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) GATSchemaGATLoadScreenContentEventStarted *startedOrChanged;
