...
@property (nonatomic, retain) GATSchemaGATRegisterMediaEventEnded *ended;
@property (nonatomic, retain) GATSchemaGATRegisterMediaEventFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) GATSchemaGATRegisterMediaEventStarted *startedOrChanged;
