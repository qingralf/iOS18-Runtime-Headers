...
@interface HALSchemaHALClientEvent : SISchemaTopLevelUnionType <SISchemaInnerEventContainer> {
    ...
    bool  _hasNearbyPersonalDevicesReported;
...
@property (nonatomic, retain) HALSchemaHALNearbyPersonalDevicesReported *nearbyPersonalDevicesReported;
...
- (id)nearbyPersonalDevicesReported;
...
- (void)setHasNearbyPersonalDevicesReported:(bool)arg1;
- (void)setLocalFetchContext:(id)arg1;
- (void)setNearbyPersonalDevicesReported:(id)arg1;
