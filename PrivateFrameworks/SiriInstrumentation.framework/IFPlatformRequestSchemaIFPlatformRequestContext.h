...
@property (nonatomic, retain) IFPlatformRequestSchemaIFPlatformRequestEnded *ended;
@property (nonatomic, retain) IFPlatformRequestSchemaIFPlatformRequestFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic) bool hasTraceId;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) IFPlatformRequestSchemaIFPlatformRequestStarted *startedOrChanged;
