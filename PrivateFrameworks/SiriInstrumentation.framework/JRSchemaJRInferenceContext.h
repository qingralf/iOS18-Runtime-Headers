...
@property (nonatomic, retain) JRSchemaJRInferenceEnded *ended;
@property (nonatomic, retain) JRSchemaJRInferenceFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStarted;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) JRSchemaJRInferenceStarted *started;
