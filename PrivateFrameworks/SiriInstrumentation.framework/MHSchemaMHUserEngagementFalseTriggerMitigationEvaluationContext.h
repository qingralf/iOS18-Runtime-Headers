...
@property (nonatomic, retain) MHSchemaMHUserEngagementFalseTriggerMitigationScoreGenerated *ended;
@property (nonatomic, retain) MHSchemaMHUserEngagementFalseTriggerMitigationFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) MHSchemaMHUserEngagementFalseTriggerMitigationStarted *startedOrChanged;
