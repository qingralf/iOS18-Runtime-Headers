...
- (void)setHasNumSentences:(bool)arg1;
- (void)setHasRequestRoute:(bool)arg1;
- (void)setNumSentences:(unsigned int)arg1;
...
+ (id)lt_initWithFrameworkRequestId:(id)arg1 requestRoute:(long long)arg2 numberOfSentences:(unsigned long long)arg3;
