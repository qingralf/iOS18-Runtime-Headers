...
@interface MTSchemaMTInvocationStarted : SISchemaInstrumentationMessage {
    ...
    bool  _hasApiInvocationMetadata;
...
@property (nonatomic, retain) MTSchemaMTApiInvocationMetadata *apiInvocationMetadata;
...
- (void)setApiInvocationMetadata:(id)arg1;
- (void)setAppInvocationMetadata:(id)arg1;
- (void)setDisplayMode:(int)arg1;
- (void)setHasApiInvocationMetadata:(bool)arg1;
...
+ (id)lt_initWithTask:(long long)arg1 inputMode:(long long)arg2 invocationType:(long long)arg3 explicitLanguageFilterEnabled:(bool)arg4 onDevice:(bool)arg5 translateAppContext:(id)arg6;
