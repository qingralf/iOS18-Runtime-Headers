...
@property (nonatomic) bool hasNetworkInterface;
...
@property (nonatomic, retain) NETSchemaNETNetworkInterface *networkInterface;
...
- (void)setHasNetworkInterface:(bool)arg1;
