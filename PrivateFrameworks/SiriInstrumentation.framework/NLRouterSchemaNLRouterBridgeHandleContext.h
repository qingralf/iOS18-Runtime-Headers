...
@property (nonatomic, retain) NLRouterSchemaNLRouterBridgeHandleEnded *ended;
@property (nonatomic, retain) NLRouterSchemaNLRouterBridgeHandleFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) NLRouterSchemaNLRouterBridgeHandleStarted *startedOrChanged;
