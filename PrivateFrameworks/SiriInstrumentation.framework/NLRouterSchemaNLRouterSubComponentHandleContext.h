...
@property (nonatomic, retain) NLRouterSchemaNLRouterSubComponentHandleEnded *ended;
@property (nonatomic, retain) NLRouterSchemaNLRouterSubComponentHandleFailed *failed;
...
@property (nonatomic, retain) NLRouterSchemaNLRouterSubComponentHandleStarted *startedOrChanged;
