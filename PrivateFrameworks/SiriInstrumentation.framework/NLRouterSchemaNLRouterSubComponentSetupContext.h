...
@property (nonatomic, retain) NLRouterSchemaNLRouterSubComponentSetupEnded *ended;
@property (nonatomic, retain) NLRouterSchemaNLRouterSubComponentSetupFailed *failed;
...
@property (nonatomic, retain) NLRouterSchemaNLRouterSubComponentSetupStarted *startedOrChanged;
