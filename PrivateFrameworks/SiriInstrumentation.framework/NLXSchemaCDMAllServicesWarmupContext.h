...
@property (nonatomic, retain) NLXSchemaCDMAllServicesWarmupEnded *ended;
@property (nonatomic, retain) NLXSchemaCDMAllServicesWarmupFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) NLXSchemaCDMAllServicesWarmupStarted *startedOrChanged;
