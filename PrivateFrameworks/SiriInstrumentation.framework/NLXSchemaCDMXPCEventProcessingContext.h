...
@property (nonatomic, retain) NLXSchemaCDMXPCEventProcessingEnded *ended;
@property (nonatomic, retain) NLXSchemaCDMXPCEventProcessingFailed *failed;
@property (nonatomic) bool hasContextId;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) NLXSchemaCDMXPCEventProcessingStarted *startedOrChanged;
