...
@property (nonatomic, retain) NLXSchemaSSUUserRequestEnded *ended;
@property (nonatomic, retain) NLXSchemaSSUUserRequestFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) NLXSchemaSSUUserRequestStarted *startedOrChanged;
