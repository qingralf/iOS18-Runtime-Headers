...
@property (nonatomic, retain) ODDSiriSchemaODDDictationExperimentCounts *counts;
@property (nonatomic, retain) ODDSiriSchemaODDDictationExperimentDimensions *dimensions;
@property (nonatomic) bool hasCounts;
@property (nonatomic) bool hasDimensions;
@property (nonatomic) bool hasTuples;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) ODDSiriSchemaODDDictationExperimentTuples *tuples;
