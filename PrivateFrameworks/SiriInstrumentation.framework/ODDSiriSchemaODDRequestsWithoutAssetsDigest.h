...
@property (nonatomic, retain) ODDSiriSchemaODDRequestsWithoutAssetsCounts *counts;
@property (nonatomic, retain) ODDSiriSchemaODDRequestsWithoutAssetsDimensions *dimensions;
