...
@property (nonatomic, retain) ORCHSchemaORCHExecuteOnRemoteRequestEnded *ended;
@property (nonatomic, retain) ORCHSchemaORCHExecuteOnRemoteRequestFailed *failed;
@property (nonatomic) bool hasContextId;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) ORCHSchemaORCHExecuteOnRemoteRequestStarted *startedOrChanged;
