...
@interface ORCHSchemaORCHMUXRequestEnded : SISchemaInstrumentationMessage {
    ...
    bool  _hasSelectedUserEphemeralId;
...
@property (nonatomic, retain) SISchemaUUID *selectedUserEphemeralId;
...
- (void)setHasSelectedUserEphemeralId:(bool)arg1;
...
- (void)setSelectedUserEphemeralId:(id)arg1;
