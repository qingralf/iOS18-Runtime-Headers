...
@property (nonatomic, retain) ORCHSchemaORCHNLRouterBridgeEnded *ended;
@property (nonatomic, retain) ORCHSchemaORCHNLRouterBridgeFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic) bool hasTrpId;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) ORCHSchemaORCHNLRouterBridgeStarted *startedOrChanged;
