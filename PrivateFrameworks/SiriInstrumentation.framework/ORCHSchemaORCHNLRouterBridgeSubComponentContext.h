...
@property (nonatomic, retain) ORCHSchemaORCHNLRouterBridgeSubComponentEnded *ended;
@property (nonatomic, retain) ORCHSchemaORCHNLRouterBridgeSubComponentFailed *failed;
...
@property (nonatomic, retain) ORCHSchemaORCHNLRouterBridgeSubComponentStarted *startedOrChanged;
