...
@property (nonatomic, retain) PEGASUSSchemaPEGASUSVideoExecutionTier1 *videoExecutionTier1;
...
- (void)setHasVideoExecutionTier1:(bool)arg1;
...
- (void)setVideoExecutionTier1:(id)arg1;
