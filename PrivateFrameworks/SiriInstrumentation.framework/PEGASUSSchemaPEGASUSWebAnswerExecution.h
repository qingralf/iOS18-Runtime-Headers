...
@property (nonatomic, copy) NSArray *contentAgeInSeconds;
...
- (void).cxx_destruct;
- (void)addContentAgeInSeconds:(unsigned int)arg1;
- (unsigned int)allowListType;
- (unsigned int)answerClass;
- (unsigned int)answerType;
- (void)clearContentAgeInSeconds;
- (id)contentAgeInSeconds;
- (unsigned int)contentAgeInSecondsAtIndex:(unsigned long long)arg1;
...
- (void)setContentAgeInSeconds:(id)arg1;
