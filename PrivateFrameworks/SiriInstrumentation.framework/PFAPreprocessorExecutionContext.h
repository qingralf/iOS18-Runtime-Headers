...
@property (nonatomic, retain) PFAPreprocessorExecutionEnded *ended;
@property (nonatomic, retain) PFAPreprocessorExecutionFailed *failed;
@property (nonatomic) bool hasContextId;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) PFAPreprocessorExecutionStarted *startedOrChanged;
