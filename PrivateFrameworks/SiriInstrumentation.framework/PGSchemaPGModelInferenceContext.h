...
@property (nonatomic, retain) PGSchemaPGModelInferenceEnded *ended;
@property (nonatomic, retain) PGSchemaPGModelInferenceFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) PGSchemaPGModelInferenceStarted *startedOrChanged;
