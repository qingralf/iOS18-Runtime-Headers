...
@property (nonatomic, retain) PGSchemaPGOverridesEnded *ended;
@property (nonatomic, retain) PGSchemaPGOverridesFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) PGSchemaPGOverridesStarted *startedOrChanged;
