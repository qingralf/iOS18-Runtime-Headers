...
@property (nonatomic, retain) PGSchemaPGPrescribedPlanEnded *ended;
@property (nonatomic, retain) PGSchemaPGPrescribedPlanFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) PGSchemaPGPrescribedPlanStarted *startedOrChanged;
