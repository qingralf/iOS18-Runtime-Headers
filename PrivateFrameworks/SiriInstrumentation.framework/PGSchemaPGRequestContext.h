...
@property (nonatomic, retain) PGSchemaPGRequestEnded *ended;
@property (nonatomic, retain) PGSchemaPGRequestFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) PGSchemaPGRequestStarted *startedOrChanged;
