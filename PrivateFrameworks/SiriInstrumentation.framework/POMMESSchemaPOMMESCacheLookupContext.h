...
@property (nonatomic, retain) POMMESSchemaPOMMESCacheLookupEnded *ended;
@property (nonatomic, retain) POMMESSchemaPOMMESCacheLookupFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) POMMESSchemaPOMMESCacheLookupStarted *startedOrChanged;
