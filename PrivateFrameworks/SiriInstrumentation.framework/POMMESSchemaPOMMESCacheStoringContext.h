...
@property (nonatomic, retain) POMMESSchemaPOMMESCacheStoringEnded *ended;
@property (nonatomic, retain) POMMESSchemaPOMMESCacheStoringFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) POMMESSchemaPOMMESCacheStoringStarted *startedOrChanged;
