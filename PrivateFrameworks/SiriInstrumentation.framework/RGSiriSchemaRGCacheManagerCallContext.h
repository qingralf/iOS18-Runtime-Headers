...
@property (nonatomic, retain) RGSiriSchemaRGCacheManagerCallEnded *ended;
@property (nonatomic, retain) RGSiriSchemaRGCacheManagerCallFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic) bool hasTraceId;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) RGSiriSchemaRGCacheManagerCallStarted *startedOrChanged;
