...
@property (nonatomic, retain) RGSiriSchemaRGCatalogEnded *ended;
@property (nonatomic, retain) RGSiriSchemaRGCatalogFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) RGSiriSchemaRGCatalogStarted *startedOrChanged;
