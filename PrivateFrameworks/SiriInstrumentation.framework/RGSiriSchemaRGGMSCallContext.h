...
@property (nonatomic, retain) RGSiriSchemaRGGMSCallEnded *ended;
@property (nonatomic, retain) RGSiriSchemaRGGMSCallFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic) bool hasTraceId;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) RGSiriSchemaRGGMSCallStarted *startedOrChanged;
