...
@property (nonatomic, retain) RGSiriSchemaRGHallucinationDetectionEnded *ended;
@property (nonatomic, retain) RGSiriSchemaRGHallucinationDetectionFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) RGSiriSchemaRGHallucinationDetectionStarted *startedOrChanged;
