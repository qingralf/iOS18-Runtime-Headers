...
@property (nonatomic, retain) RGSiriSchemaRGInferenceEnded *ended;
@property (nonatomic, retain) RGSiriSchemaRGInferenceFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) RGSiriSchemaRGInferenceStarted *startedOrChanged;
