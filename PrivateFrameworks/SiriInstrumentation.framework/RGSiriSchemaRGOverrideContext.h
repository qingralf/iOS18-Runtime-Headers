...
@property (nonatomic, retain) RGSiriSchemaRGOverrideEnded *ended;
@property (nonatomic, retain) RGSiriSchemaRGOverrideFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) RGSiriSchemaRGOverrideStarted *startedOrChanged;
