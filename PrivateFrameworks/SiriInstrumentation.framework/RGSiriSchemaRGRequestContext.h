...
@property (nonatomic, retain) RGSiriSchemaRGRequestEnded *ended;
@property (nonatomic, retain) RGSiriSchemaRGRequestFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) RGSiriSchemaRGRequestStarted *startedOrChanged;
