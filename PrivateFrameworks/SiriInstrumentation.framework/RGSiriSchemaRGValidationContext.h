...
@property (nonatomic, retain) RGSiriSchemaRGValidationEnded *ended;
@property (nonatomic, retain) RGSiriSchemaRGValidationFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) RGSiriSchemaRGValidationStarted *startedOrChanged;
