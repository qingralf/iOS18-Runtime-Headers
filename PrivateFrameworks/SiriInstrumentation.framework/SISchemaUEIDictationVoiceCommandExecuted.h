...
- (unsigned long long)commandExecutionEndTimeInNs;
- (unsigned long long)commandExecutionStartTimeInNs;
...
- (void)setCommandExecutionEndTimeInNs:(unsigned long long)arg1;
- (void)setCommandExecutionStartTimeInNs:(unsigned long long)arg1;
...
- (void)setHasCommandExecutionEndTimeInNs:(bool)arg1;
- (void)setHasCommandExecutionStartTimeInNs:(bool)arg1;
