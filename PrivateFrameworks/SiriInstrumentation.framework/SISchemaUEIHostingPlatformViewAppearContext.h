...
@property (nonatomic, retain) SISchemaUEIHostingPlatformViewAppearEnded *ended;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) SISchemaUEIHostingPlatformViewAppearStarted *startedOrChanged;
