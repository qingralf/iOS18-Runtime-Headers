...
@property (nonatomic, retain) STSchemaSTAnswerSynthesisRequestEnded *ended;
@property (nonatomic, retain) STSchemaSTAnswerSynthesisRequestFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) STSchemaSTAnswerSynthesisRequestStarted *startedOrChanged;
