...
@property (nonatomic, retain) STSchemaSTDisambiguationEnded *ended;
@property (nonatomic, retain) STSchemaSTDisambiguationFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) STSchemaSTDisambiguationStarted *startedOrChanged;
