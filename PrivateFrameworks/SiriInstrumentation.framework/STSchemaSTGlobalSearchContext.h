...
@property (nonatomic, retain) STSchemaSTGlobalSearchRequestEnded *ended;
@property (nonatomic, retain) STSchemaSTGlobalSearchRequestFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) STSchemaSTGlobalSearchRequestStarted *startedOrChanged;
