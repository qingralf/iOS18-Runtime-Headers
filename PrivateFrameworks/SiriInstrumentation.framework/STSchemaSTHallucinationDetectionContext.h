...
@property (nonatomic, retain) STSchemaSTHallucinationDetectionEnded *ended;
@property (nonatomic, retain) STSchemaSTHallucinationDetectionFailed *failed;
@property (nonatomic) bool hasContextId;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) STSchemaSTHallucinationDetectionStarted *startedOrChanged;
