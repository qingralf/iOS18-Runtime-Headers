...
@property (nonatomic, retain) STSchemaSTLLMQURequestEnded *ended;
@property (nonatomic, retain) STSchemaSTLLMQURequestFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) STSchemaSTLLMQURequestStarted *startedOrChanged;
