...
@property (nonatomic, retain) SUGSchemaSUGRequestEnded *ended;
@property (nonatomic, retain) SUGSchemaSUGRequestFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) SUGSchemaSUGRequestStarted *startedOrChanged;
