...
@property (nonatomic, retain) TTMSchemaTTMNeuralCombinerRequestEnded *ended;
@property (nonatomic, retain) TTMSchemaTTMNeuralCombinerRequestFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) TTMSchemaTTMNeuralCombinerRequestStarted *startedOrChanged;
