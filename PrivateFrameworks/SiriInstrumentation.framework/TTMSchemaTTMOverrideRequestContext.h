...
@property (nonatomic, retain) TTMSchemaTTMOverrideRequestEnded *ended;
@property (nonatomic, retain) TTMSchemaTTMOverrideRequestFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) TTMSchemaTTMOverrideRequestStarted *startedOrChanged;
