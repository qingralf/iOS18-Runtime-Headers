...
@property (nonatomic, retain) TTMSchemaTTMRequestEnded *ended;
@property (nonatomic, retain) TTMSchemaTTMRequestFailed *failed;
@property (nonatomic) bool hasEnded;
@property (nonatomic) bool hasFailed;
@property (nonatomic) bool hasStartedOrChanged;
@property (nonatomic, readonly) NSData *jsonData;
@property (nonatomic, retain) TTMSchemaTTMRequestStarted *startedOrChanged;
