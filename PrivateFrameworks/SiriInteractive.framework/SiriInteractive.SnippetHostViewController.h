...
@interface SiriInteractive.SnippetHostViewController : UIViewController <BSInvalidatable, FBSceneDelegate, FBSceneLayerManagerObserver, UIAdaptivePresentationControllerDelegate> {
...
@property (nonatomic) <_TtP15SiriInteractive33SnippetHostViewControllerDelegate_> *delegate;
