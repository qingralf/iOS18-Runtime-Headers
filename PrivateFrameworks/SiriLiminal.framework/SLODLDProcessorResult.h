...
@property (nonatomic, readonly) float conversationalScore;
...
- (id)description;
- (id)features;
- (id)initWithScore:(float)arg1 withVersion:(id)arg2 tokens:(id)arg3 features:(id)arg4 outputEmb:(id)arg5 outputAnchor:(float)arg6 conversationalScore:(float)arg7;
- (float)odldScore;
- (float)outputAnchor;
- (id)outputEmb;
- (id)tokens;
