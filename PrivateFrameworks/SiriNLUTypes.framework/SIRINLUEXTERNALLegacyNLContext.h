...
@interface SIRINLUEXTERNALLegacyNLContext : PBCodable <NSCopying> {
    ...
    NSMutableArray * _responseSemanticValues;
    bool  _strictPrompt;
}
...
@property (nonatomic, retain) NSMutableArray *responseSemanticValues;
...
- (void)addResponseSemanticValues:(id)arg1;
...
- (id)responseSemanticValues;
- (id)responseSemanticValuesAtIndex:(unsigned long long)arg1;
...
- (void)setResponseSemanticValues:(id)arg1;
