...
@interface SIRINLUEXTERNALTurnInput : PBCodable <NSCopying> {
    ...
    SIRINLUEXTERNALCorrectionOutcome * _correctionOutcomeOverride;
...
@property (nonatomic, retain) SIRINLUEXTERNALCorrectionOutcome *correctionOutcomeOverride;
@property (nonatomic, retain) NSMutableArray *executedTasks;
@property (nonatomic, readonly) bool hasCorrectionOutcomeOverride;
...
- (void)setCorrectionOutcomeOverride:(id)arg1;
