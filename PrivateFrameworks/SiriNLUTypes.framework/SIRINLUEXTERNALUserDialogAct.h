...
@interface SIRINLUEXTERNALUserDialogAct : PBCodable <NSCopying> {
    ...
    SIRINLUEXTERNALUserWantedToUndo * _wantedToUndo;
}
...
@property (nonatomic, readonly) bool hasWantedToUndo;
...
@property (nonatomic, retain) SIRINLUEXTERNALUserWantedToUndo *wantedToUndo;
