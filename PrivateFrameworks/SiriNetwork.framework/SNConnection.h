...
- (void)didEncounterError:(id)arg1 error:(id)arg2 analysisInfo:(id)arg3;
...
- (void)sendCommand:(id)arg1 completion:(id /* block */)arg2;
- (void)sendCommands:(id)arg1 completion:(id /* block */)arg2;
