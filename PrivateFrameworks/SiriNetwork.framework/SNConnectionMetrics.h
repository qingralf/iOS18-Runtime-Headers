...
@interface SNConnectionMetrics : NSObject {
    ...
    NETSchemaNETSessionConnectionSnapshotCaptured * _connectionSnapshot;
    ...
    NETSchemaNETDebugSessionConnectionSnapshotCaptured * _debugConnectionSnapshot;
    ...
    SNConnectionMetrics * _remoteMetrics;
    NSNumber * _rssi;
    NSNumber * _signalStrengthBars;
    NSNumber * _simSubscriptions;
    NSString * _snapshotTriggerReason;
    NSNumber * _snr;
...
@property (nonatomic, retain) NETSchemaNETSessionConnectionSnapshotCaptured *connectionSnapshot;
...
@property (nonatomic, retain) NETSchemaNETDebugSessionConnectionSnapshotCaptured *debugConnectionSnapshot;
...
@property (nonatomic, retain) SNConnectionMetrics *remoteMetrics;
@property (nonatomic, copy) NSNumber *rssi;
@property (nonatomic, copy) NSNumber *signalStrengthBars;
@property (nonatomic, copy) NSNumber *simSubscriptions;
@property (nonatomic, copy) NSString *snapshotTriggerReason;
...
- (void)setConnectionSnapshot:(id)arg1;
...
- (void)setDebugConnectionSnapshot:(id)arg1;
...
- (void)setSnapshotTriggerReason:(id)arg1;
- (void)setSnr:(id)arg1;
