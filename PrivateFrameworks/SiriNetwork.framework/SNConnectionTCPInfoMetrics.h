...
@property (nonatomic, readonly, copy) NSNumber *sendBufferBytes;
...
- (id)init;
- (id)initWithInterfaceName:(id)arg1 rttCurrent:(id)arg2 rttSmoothed:(id)arg3 rttVariance:(id)arg4 rttBest:(id)arg5 packetsSent:(id)arg6 packetsReceived:(id)arg7 bytesSent:(id)arg8 bytesReceived:(id)arg9 bytesRetransmitted:(id)arg10 bytesUnacked:(id)arg11 duplicateBytesReceived:(id)arg12 outOfOrderBytesReceived:(id)arg13 sendBufferBytes:(id)arg14 sendBandwidth:(id)arg15 synRetransmits:(id)arg16 tfoSynDataAcked:(id)arg17;
- (id)interfaceName;
