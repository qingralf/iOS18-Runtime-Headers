...
@interface NAFConnection : NSObject <AFAccessibilityListening, AFAudioPowerUpdaterDelegate, AFDeviceRingerSwitchListening, AFInterstitialProviderDelegate, NSXPCListenerDelegate> {
    ...
    <NAFAssistantUIService> * _delegate;
    ...
    <NAFSpeechDelegate> * _speechDelegate;
...
@property (nonatomic) <NAFAssistantUIService> *delegate;
@property (readonly, copy) NSString *description;
@property (nonatomic, readonly) bool hasActiveRequest;
@property (readonly) unsigned long long hash;
@property (nonatomic, readonly) bool isRecording;
@property (nonatomic) <NAFSpeechDelegate> *speechDelegate;
...
- (void)_extendRequestTimeoutForReason:(id)arg1 durationInSeconds:(double)arg2;
...
- (void)_scheduleRequestTimeoutForReason:(id)arg1 durationInSeconds:(double)arg2;
...
- (void)_startRequestTimeoutTimerWithTimeInterval:(double)arg1 reason:(id)arg2;
...
- (void)requestBarrierIfNecessary:(id /* block */)arg1;
- (oneway void)requestDidAskForTimeoutExtension:(double)arg1;
