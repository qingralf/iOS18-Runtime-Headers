...
@property (nonatomic, readonly, copy) SiriSharedUILatencyViewModel *latencyViewModel;
...
- (void).cxx_destruct;
- (id)_copyWithInputType:(long long)arg1 resultTranscriptItems:(id)arg2 conversationTranscriptItems:(id)arg3 additionalPlatterTranscriptItems:(id)arg4 serverUtterances:(id)arg5 speechRecognitionHypothesis:(id)arg6 latencyViewUtterance:(id)arg7;
- (id)_initWithInputType:(long long)arg1 resultTranscriptItems:(id)arg2 conversationTranscriptItems:(id)arg3 additionalPlatterTranscriptItems:(id)arg4 serverUtterances:(id)arg5 speechRecognitionHypothesis:(id)arg6 latencyViewModel:(id)arg7;
- (id)additionalPlatterTranscriptItems;
- (id)conversationTranscriptItems;
- (id)copyWithAdditionalPlatterTranscriptItems:(id)arg1;
- (id)copyWithConversationTranscriptItems:(id)arg1 serverUtterances:(id)arg2 speechRecognitionHypothesis:(id)arg3 latencyViewUtterance:(id)arg4;
...
- (id)copyWithLatencyIntentSummary:(id)arg1;
- (id)copyWithLatencyViewModel:(id)arg1;
...
- (id)copyWithServerUtterances:(id)arg1 speechRecognitionHypothesis:(id)arg2 latencyViewUtterance:(id)arg3;
