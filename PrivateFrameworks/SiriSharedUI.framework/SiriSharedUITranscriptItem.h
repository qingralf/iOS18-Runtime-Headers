...
@interface SiriSharedUITranscriptItem : NSObject {
    ...
    NSUUID * _taskIdentifier;
    UIViewController<SiriSharedUIViewControlling> * _viewController;
}
...
@property (nonatomic, copy) NSUUID *taskIdentifier;
@property (nonatomic, retain) UIViewController<SiriSharedUIViewControlling> *viewController;
