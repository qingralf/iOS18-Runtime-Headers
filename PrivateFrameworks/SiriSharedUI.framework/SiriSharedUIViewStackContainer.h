...
@interface SiriSharedUIViewStackContainer : SiriSharedUIStandardView <SiriSharedUIStackableContentDelegate, SiriSharedUIViewStackContainerHosting> {
    ...
    <SiriSharedUIViewStackContainerDelegate> * _delegate;
    bool  _isInAmbient;
...
@property (nonatomic) <SiriSharedUIViewStackContainerDelegate> *delegate;
...
- (void)addContentView:(id)arg1 fromViewController:(id)arg2;
