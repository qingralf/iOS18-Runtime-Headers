...
@interface SiriTTSInstrumentationMetrics : NSObject <NSSecureCoding> {
    ...
    void synthesisQualityIssue;
    void useHydraFrontend;
    void utterance;
    void voice;
}
...
- (void)setDeviceThermalState:(long long)arg1;
- (void)setEagerRequestGapInterval:(double)arg1;
- (void)setEncounteredIssues:(id)arg1;
...
- (void)setMinimizeDeviceUsage:(bool)arg1;
...
- (void)setSynthesisQualityIssue:(bool)arg1;
- (void)setUseHydraFrontend:(bool)arg1;
