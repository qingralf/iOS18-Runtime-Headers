...
@interface SiriTTSSynthesisEngineRequest : NSObject {
    ...
    float  _rate;
    id /* block */  _synthesisIssueHandler;
    NSString * _text;
    id /* block */  _useHydraFrontendHandler;
    float  _volume;
...
@property (nonatomic, copy) id /* block */ synthesisIssueHandler;
@property (nonatomic, retain) NSString *text;
@property (nonatomic, copy) id /* block */ useHydraFrontendHandler;
...
- (void)setSynthesisIssueHandler:(id /* block */)arg1;
- (void)setText:(id)arg1;
- (void)setUseHydraFrontendHandler:(id /* block */)arg1;
- (void)setVolume:(float)arg1;
- (void)setWordTimingsHandler:(id /* block */)arg1;
- (id /* block */)synthesisIssueHandler;
- (id)text;
- (id /* block */)useHydraFrontendHandler;
- (float)volume;
