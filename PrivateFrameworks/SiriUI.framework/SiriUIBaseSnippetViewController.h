...
@property (nonatomic) bool isInAmbient; /* unknown property attribute: ? */
@property (nonatomic) bool isInAmbientInteractivity; /* unknown property attribute: ? */
@property (nonatomic) bool isPresentedWithSmartDialogText; /* unknown property attribute: ? */
