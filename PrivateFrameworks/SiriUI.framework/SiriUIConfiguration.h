...
@property (nonatomic, readonly) bool showsSensitiveUI;
...
- (id)initWithFlamesViewFidelity:(long long)arg1 isSystemHostedPresentation:(bool)arg2 allowResizingBetweenModes:(bool)arg3 siriViewMode:(long long)arg4 showsSensitiveUI:(bool)arg5;
