...
@property (nonatomic, readonly) <UIViewControllerAnimatedTransitioning> *animationController; /* unknown property attribute: ? */
...
@property (nonatomic) long long operation; /* unknown property attribute: ? */
