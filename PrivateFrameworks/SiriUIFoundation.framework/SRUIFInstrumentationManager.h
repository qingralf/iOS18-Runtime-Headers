...
- (void)emitUUFRSpokenForAceObject:(id)arg1 presentationType:(int)arg2 dialogPhase:(id)arg3 mode:(int)arg4 speakableText:(id)arg5 dialogIdentifierOverride:(id)arg6;
...
- (void)emitVRXInstrumentationEvent:(id)arg1 aceViewId:(id)arg2;
