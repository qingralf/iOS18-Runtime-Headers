...
@interface SRUIFMutableConversationItem : NSObject <NSCopying, SRUIFConversationStorable> {
...
@property (nonatomic, readonly) SRUIFDataStore *associatedDataStore;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (readonly, copy) NSString *description;
@property (nonatomic, retain) SRUIFDialogPhase *dialogPhase;
