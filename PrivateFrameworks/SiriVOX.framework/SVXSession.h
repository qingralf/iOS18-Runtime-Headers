...
- (id)_createClientConfiguration:(id)arg1 storeDemo:(id)arg2 preferences:(id)arg3;
...
- (void)_handleStartListenAfterSpeaking:(id)arg1 record:(id)arg2 taskTracker:(id)arg3;
...
- (id)initWithPerformer:(id)arg1 serviceCommandHandler:(id)arg2 powerLevelManager:(id)arg3 speechSynthesizer:(id)arg4 instanceContext:(id)arg5 preferences:(id)arg6 analytics:(id)arg7 delegate:(id)arg8;
- (void)invalidate;
