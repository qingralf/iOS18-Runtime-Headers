...
@interface HKSPDNDConfigurationService : NSObject <DNDGlobalConfigurationServiceListener, DNDModeConfigurationServiceListener, HDSPSleepFocusModeBridge, HKSPSleepFocusModeBridge> {
...
- (void)updateCachedUUID:(id)arg1 state:(unsigned long long)arg2;

// Image: /System/Library/PrivateFrameworks/SleepDaemon.framework/SleepDaemon

- (bool)_actuallyUpdateModeConfiguration:(id)arg1 state:(unsigned long long)arg2 error:(id*)arg3;
- (bool)_createSleepFocusModeInState:(unsigned long long)arg1 error:(id*)arg2;
- (bool)_updateSleepFocusModeWithState:(unsigned long long)arg1 error:(id*)arg2;
