...
@interface HKSPSleepStore : NSObject <HKSPSleepFocusModeBridgeDelegate, HKSPSleepWidgetManagerDelegate, HKSPXPCConnectionProviderDelegate> {
    ...
    HKSPSleepStoreModelCache * _sleepStoreCache;
...
@property (nonatomic, readonly) HKSPSleepStoreModelCache *sleepStoreCache;
...
- (id)_getSleepEventRecordDoSync:(bool)arg1;
- (id)_getSleepEventRecordFromServerDoSync:(bool)arg1;
- (id)_getSleepModeDoSync:(bool)arg1;
- (id)_getSleepModeFromServerDoSync:(bool)arg1;
- (id)_getSleepScheduleDoSync:(bool)arg1;
- (id)_getSleepScheduleFromServerDoSync:(bool)arg1;
- (id)_getSleepScheduleModelDoSync:(bool)arg1;
- (id)_getSleepScheduleModelFromServerDoSync:(bool)arg1;
- (id)_getSleepScheduleStateFromServerDoSync:(bool)arg1;
- (id)_getSleepScheduleStateOnDoSync:(bool)arg1;
- (id)_getSleepSettingsDoSync:(bool)arg1;
- (id)_getSleepSettingsFromServerDoSync:(bool)arg1;
...
- (void)_notifyObserversForChangedSleepMode:(long long)arg1 reason:(unsigned long long)arg2;
- (void)_notifyObserversForChangedSleepSchedule:(id)arg1;
- (void)_notifyObserversForChangedSleepScheduleState:(unsigned long long)arg1 reason:(unsigned long long)arg2;
...
- (id)clientIdentifier;
- (void)configureSleepFocusWithState:(unsigned long long)arg1 completion:(id /* block */)arg2;
- (void)confirmAwakeWithCompletion:(id /* block */)arg1;
- (void)connect;
- (void)connectSynchronously:(bool)arg1;
- (id)connectionProvider;
- (void)createSleepFocusInState:(unsigned long long)arg1 completion:(id /* block */)arg2;
