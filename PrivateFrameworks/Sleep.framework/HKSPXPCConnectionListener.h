...
@interface HKSPXPCConnectionListener : NSObject <BSDescriptionProviding, NSXPCListenerDelegate> {
    ...
    <HKSPXPCHeartbeatGenerator> * _heartbeatGenerator;
    HKSPThrottler * _logThrottler;
}
...
@property (nonatomic, readonly) <HKSPXPCHeartbeatGenerator> *heartbeatGenerator;
@property (nonatomic, readonly) HKSPThrottler *logThrottler;
...
- (id)heartbeatGenerator;
- (id)initWithConnectionInfo:(id)arg1;
- (id)initWithConnectionInfo:(id)arg1 connectionListener:(id)arg2 heartbeatGenerator:(id)arg3;
