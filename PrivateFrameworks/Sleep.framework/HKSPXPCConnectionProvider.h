...
@interface HKSPXPCConnectionProvider : NSObject <BSDescriptionProviding, HKSPXPCHeartbeatListenerDelegate> {
    ...
    <HKSPXPCHeartbeatListener> * _heartbeatListener;
    bool  _invalidated;
...
@property (nonatomic, readonly) <HKSPXPCHeartbeatListener> *heartbeatListener;
...
- (id)heartbeatListener;
- (id)initWithConnectionInfo:(id)arg1;
- (id)initWithConnectionInfo:(id)arg1 connectionProvider:(id /* block */)arg2 heartbeatListener:(id)arg3;
- (void)invalidate;
- (bool)invalidated;
- (bool)isInvalidated;
- (void)listenerDidReceiveHeartbeat:(id)arg1;
- (id)pendingMessages;
