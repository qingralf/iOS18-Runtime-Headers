...
@interface HDSPAnalyticsDailyReportBuilder : NSObject {
    ...
    HDSPSleepApneaAnalyticsBuilder * _sleepApneaAnalyticsBuilder;
}
...
@property (nonatomic, readonly) HDSPSleepApneaAnalyticsBuilder *sleepApneaAnalyticsBuilder;
...
- (id)environment;
- (id)healthStore;
- (id)initWithEnvironment:(id)arg1 daySummaries:(id)arg2 breathingDisturbanceSamples:(id)arg3 sleepApneaEventSamples:(id)arg4 sleepApneaFeatureStatus:(id)arg5 morningIndexRange:(struct { long long x1; long long x2; })arg6;
