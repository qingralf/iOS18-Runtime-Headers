...
+ (int)biomeSleepModeChangeReasonForSleepModeChangeReason:(unsigned long long)arg1;
+ (int)biomeSleepModeStateForSleepModeState:(long long)arg1;
+ (int)biomeSleepScheduleStateChangeReasonForSleepScheduleStateChangeReason:(unsigned long long)arg1;
+ (int)biomeSleepScheduleStateForSleepScheduleState:(unsigned long long)arg1;
+ (id)sleepModePublisher;

- (void).cxx_destruct;
- (bool)_shouldWriteToBiome;
- (void)_writeSleepModeToBiome:(long long)arg1 reason:(unsigned long long)arg2 forceWrite:(bool)arg3;
- (void)_writeSleepScheduleStateToBiome:(unsigned long long)arg1 reason:(unsigned long long)arg2 forceWrite:(bool)arg3;
- (id)biomeInterface;
- (id)environment;
