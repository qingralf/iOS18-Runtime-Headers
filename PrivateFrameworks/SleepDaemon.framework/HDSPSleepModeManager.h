...
+ (unsigned long long)_sleepModeChangeReasonForBiomeReason:(int)arg1 source:(int)arg2;
...
- (bool)configureFocusModeWithState:(unsigned long long)arg1 error:(id*)arg2;
- (bool)createFocusModeInState:(unsigned long long)arg1 error:(id*)arg2;
