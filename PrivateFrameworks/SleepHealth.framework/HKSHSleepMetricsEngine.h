...
+ (id)sleepMetricsForDaySummaries:(id)arg1;
+ (id)sleepMetricsForDaySummaries:(id)arg1 inMorningIndexRange:(struct { long long x1; long long x2; })arg2;

- (void).cxx_destruct;
- (void)fetchSleepMetricsForMorningIndexRange:(struct { long long x1; long long x2; })arg1 completion:(id /* block */)arg2;
