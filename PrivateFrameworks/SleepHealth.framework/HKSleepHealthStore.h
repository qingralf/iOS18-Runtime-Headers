...
+ (bool)_areAllSamples:(id)arg1 containedInDateInterval:(id)arg2;
+ (bool)_areAllSamplesSleepTrackingSamples:(id)arg1;
+ (id)taskIdentifier;
...
- (void)saveSleepTrackingSamples:(id)arg1 replacingSamplesInDateInterval:(id)arg2 completion:(id /* block */)arg3;
- (id)scheduler;
