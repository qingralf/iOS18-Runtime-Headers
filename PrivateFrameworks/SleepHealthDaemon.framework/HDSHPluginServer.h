...
- (bool)_deleteSleepSamplesWithClientSourceInDateInterval:(id)arg1 error:(id*)arg2;
- (bool)_insertSamplesWithClientSource:(id)arg1 error:(id*)arg2;
- (bool)_insertSleepSamplesWithClientSource:(id)arg1 replacingSamplesInDateInterval:(id)arg2 error:(id*)arg3;
- (void)_performCloudSync;
- (void)_performNanoSyncWithAccessibilityAssertion:(id)arg1;
...
- (void)_saveSleepTrackingSamplesAfterFirstUnlock:(id)arg1 replacingSamplesInDateInterval:(id)arg2 completion:(id /* block */)arg3;
- (void)connectionInvalidated;
- (id)diagnosticDescription;
- (id)exportedInterface;
- (id)initWithUUID:(id)arg1 configuration:(id)arg2 client:(id)arg3 delegate:(id)arg4;
- (id)remoteInterface;
- (void)remote_saveSleepTrackingSamples:(id)arg1 replacingSamplesInDateInterval:(id)arg2 completion:(id /* block */)arg3;
