...
@interface HKSHSleepApneaNotificationsBridgeSettings : NSObject {
    HKSHSleepApneaNotificationsFooter * _footer;
    bool  _settingEnabled;
    bool  _settingVisible;
    bool  _showOnboarding;
}

@property (nonatomic, retain) HKSHSleepApneaNotificationsFooter *footer;
