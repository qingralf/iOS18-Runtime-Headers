...
@interface SLDCollaborationFooterDrawing : NSObject <UISDrawing> {
    bool  _forRemote;
    bool  _isRTL;
...
@property (nonatomic, readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } alignmentRect; /* unknown property attribute: ? */
...
@property (nonatomic, retain) SLDCollaborationFooterSlotTag *tag;
