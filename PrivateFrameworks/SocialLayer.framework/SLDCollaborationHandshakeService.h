...
- (void).cxx_destruct;
- (long long)_acquireSandboxHandleData:(id)arg1 ForFileProviderDocumentURL:(id)arg2 clientConnection:(id)arg3 error:(id*)arg4;
...
- (void)_releaseSandboxHandle:(long long)arg1;
