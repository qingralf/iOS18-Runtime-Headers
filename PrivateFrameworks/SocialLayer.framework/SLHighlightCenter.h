...
@interface SLHighlightCenter : NSObject <APSubjectMonitor, SLHighlightCacheDelegate> {
...
- (void).cxx_destruct;
- (void)_fetchHighlightsWithLimit:(unsigned long long)arg1 reason:(id)arg2 completionBlock:(id /* block */)arg3;
...
- (void)fetchHighlightsWithLimit:(unsigned long long)arg1 reason:(id)arg2 completionBlock:(id /* block */)arg3;
- (id)highlights;
- (id)highlightsCache;
