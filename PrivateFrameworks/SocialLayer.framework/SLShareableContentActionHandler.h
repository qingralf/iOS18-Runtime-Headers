...
- (void)fulfillAsynchronousMetadataAction:(id)arg1 linkMetadata:(id)arg2;
- (void)fulfillAsynchronousMetadataAction:(id)arg1 response:(id)arg2;
...
- (id)lpMetadataForActivityItemsConfiguration:(id)arg1;
- (void)performAction:(id)arg1;
- (void)performActions:(id)arg1;
- (void)performFetchAsynchronousLPMetadataAction:(id)arg1;
