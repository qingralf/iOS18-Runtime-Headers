...
@interface SUCoreDescriptor : NSObject <NSSecureCoding> {
    bool  _allowAutoDownloadOnBattery;
    ...
    bool  _enablePreSUStaging;
    bool  _enablePreSUStagingForOptionalAssets;
    bool  _forcePasscodeRequired;
    bool  _granularlyRamped;
...
@property (nonatomic) bool allowAutoDownloadOnBattery;
...
@property (nonatomic, retain) SUCoreDescriptor *associatedSplatDescriptor;
...
@property (nonatomic) bool granularlyRamped;
...
@property (nonatomic, readonly) bool oneShotBuddyDisabled;
@property (nonatomic, readonly, retain) NSArray *oneShotBuddyDisabledBuilds;
...
- (id)associatedSplatDescriptor;
- (bool)autoDownloadAllowableOverCellular;
- (unsigned long long)autoDownloadOnBatteryDelay;
- (unsigned long long)autoDownloadOnBatteryMinBattery;
...
- (unsigned long long)installAlertInterval;
...
- (id)oneShotBuddyDisabledBuilds;
- (id)overview;
- (id)overviewWithMaxValueLength:(unsigned long long)arg1 providingSubstitutionMap:(id)arg2;
- (unsigned long long)preSUStagingOptionalSize;
- (unsigned long long)preSUStagingRequiredSize;
...
- (id)sepDigest;
- (id)sepTBMDigests;
- (void)setAllowAutoDownloadOnBattery:(bool)arg1;
- (void)setAlternateAssetAudienceUUID:(id)arg1;
- (void)setAssetAudienceUUID:(id)arg1;
- (void)setAssetID:(id)arg1;
- (void)setAssociatedSplatDescriptor:(id)arg1;
- (void)setAutoDownloadAllowableOverCellular:(bool)arg1;
- (void)setAutoDownloadOnBatteryDelay:(unsigned long long)arg1;
- (void)setAutoDownloadOnBatteryMinBattery:(unsigned long long)arg1;
...
- (void)setEnablePreSUStaging:(bool)arg1;
- (void)setEnablePreSUStagingForOptionalAssets:(bool)arg1;
- (void)setForcePasscodeRequired:(bool)arg1;
- (void)setGranularlyRamped:(bool)arg1;
- (void)setHideInstallAlert:(long long)arg1;
- (void)setInstallAlertInterval:(unsigned long long)arg1;
...
- (void)setPreSUStagingOptionalSize:(unsigned long long)arg1;
- (void)setPreSUStagingRequiredSize:(unsigned long long)arg1;
...
- (void)setSuDownloadSize:(unsigned long long)arg1;
...
- (unsigned long long)suDownloadSize;
- (id)summary;
- (id)supportedDevices;
