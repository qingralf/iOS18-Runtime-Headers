...
+ (id)_reloadDescriptor:(id)arg1 allowingDifferences:(id)arg2 forceReload:(bool)arg3 skipMSU:(bool)arg4 defaultValues:(id)arg5 pSUReloadError:(id*)arg6 pDocReloadError:(id*)arg7;
