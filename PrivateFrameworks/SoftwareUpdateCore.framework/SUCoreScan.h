...
@property (nonatomic, retain) SUCoreScanParam *interimScanResult;
...
@property (nonatomic, retain) SUCorePolicy *originalScanPolicy;
...
@property (nonatomic, retain) SUCoreDescriptor *psusPrimaryDescriptor;
@property (nonatomic, retain) SUCoreDescriptor *psusSecondaryDescriptor;
...
+ (id)_phaseName:(int)arg1;
+ (bool)isPreSUStagingEnabledForUpdate:(id)arg1 policy:(id)arg2 reason:(id*)arg3;
...
- (void)_checkSlowReleaseEndComplete:(id /* block */)arg1 scanPolicy:(id)arg2 primary:(id)arg3 secondary:(id)arg4 alternatePrimary:(id)arg5 alternateSecondary:(id)arg6 error:(id)arg7 clearingTransaction:(bool)arg8;
...
- (bool)_decideAndProcessPSUSScanForPrimaryDescriptor:(id)arg1 secondaryDescriptor:(id)arg2 andError:(id)arg3;
...
- (int)_getPhaseAndPostEventAfterReachingScanPhase:(int)arg1;
...
- (id)_operationName;
- (void)_reportPSUSDetermineFinishedEvent:(id)arg1 duration:(double)arg2;
...
- (bool)_shouldPerformPSUSScanFromFoundDescriptor:(id)arg1 policy:(id)arg2;
- (bool)_shouldPerformSplomboScanFromFoundDescriptor:(id)arg1 policy:(id)arg2;
- (id)_simDescriptorAttributes;
- (void)_trackInconsistentAnomalyAndUpdateInterimResult:(id)arg1 reason:(id)arg2;
...
- (void)_updateInterimScanResultForSlowReleaseWithPrimary:(id)arg1 secondary:(id)arg2 error:(id)arg3;
- (void)_updateInterimScanResultForSplomboWithPrimary:(id)arg1 secondary:(id)arg2 majorPrimary:(id)arg3 majorSecondary:(id)arg4 minorPrimary:(id)arg5 minorSecondary:(id)arg6 error:(id)arg7;
- (void)_updateInterimScanResultWithPrimary:(id)arg1 secondary:(id)arg2 majorPrimary:(id)arg3 majorSecondary:(id)arg4 minorPrimary:(id)arg5 minorSecondary:(id)arg6 error:(id)arg7;
...
- (long long)actionCancelPSUSAssetsDetermination:(id*)arg1;
...
- (unsigned long long)actionDecideNextScanStep:(id*)arg1;
- (long long)actionDeterminePSUSAssets:(id*)arg1;
- (unsigned long long)actionDeterminePSUSAssetsFailed:(id)arg1 error:(id*)arg2;
- (unsigned long long)actionDeterminePSUSAssetsSuccess:(id)arg1 error:(id*)arg2;
...
- (unsigned long long)actionScanComplete:(id*)arg1;
...
- (id)psusPrimaryDescriptor;
- (id)psusSecondaryDescriptor;
...
- (void)setInterimScanResult:(id)arg1;
...
- (void)setOriginalScanPolicy:(id)arg1;
- (void)setPendingMobileAssetRequests:(int)arg1;
- (void)setPhase:(int)arg1;
- (void)setPrimaryUpdateAsset:(id)arg1;
- (void)setPsusPrimaryDescriptor:(id)arg1;
- (void)setPsusSecondaryDescriptor:(id)arg1;
