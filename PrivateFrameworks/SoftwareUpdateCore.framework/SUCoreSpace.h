...
+ (void)_checkMinimumRequiredSpace:(unsigned long long)arg1 purgingFromBase:(id)arg2 userInitiated:(bool)arg3 totalRequiredFreeSpace:(unsigned long long)arg4 freeSpaceAvailable:(unsigned long long)arg5 checkAvailableSpaceTransaction:(id)arg6 withCompletionQueue:(id)arg7 completion:(id /* block */)arg8;
...
+ (void)checkPurgeableSpaceCacheDelete:(unsigned long long)arg1 fromBasePath:(id)arg2 cacheDeleteUrgency:(int)arg3 timeout:(int)arg4 additionalOptions:(id)arg5 withCompletionQueue:(id)arg6 completion:(id /* block */)arg7;
