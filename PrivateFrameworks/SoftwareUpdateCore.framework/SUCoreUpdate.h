...
@interface SUCoreUpdate : NSObject <SUCoreFSMDelegate, SUCoreMSUDelegate, SUCoreUpdateDownloaderDelegate> {
...
@property (nonatomic, retain) SUCoreUpdateDownloader *downloadControl;
...
- (void)downloadStalled:(id)arg1;
- (void)downloaded:(id)arg1;
...
- (id)updateFSM;
- (id)updateName;
- (void)updateRemoveFailed:(id)arg1;
- (void)updateRemoved;
