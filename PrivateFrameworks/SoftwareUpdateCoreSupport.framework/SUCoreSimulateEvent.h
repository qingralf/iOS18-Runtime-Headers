...
@property (nonatomic, readonly, retain) NSDictionary *errorUserInfo;
...
- (id)_initWithAction:(long long)arg1 onTrigger:(long long)arg2 forModule:(id)arg3 atIdentity:(id)arg4 atEvent:(id)arg5 inState:(id)arg6 alteration:(id)arg7 startAt:(int)arg8 endAt:(int)arg9 duration:(int)arg10 untilStop:(id)arg11 assetBuildVersions:(id)arg12 assetProductVersions:(id)arg13 assetAttributesPlist:(id)arg14 assetState:(id)arg15 updateInfoPlist:(id)arg16 errorDomain:(id)arg17 errorCode:(long long)arg18 errorUserInfo:(id)arg19 errorRecoverable:(long long)arg20;
- (id)_triggerName;
- (id)alteration;
