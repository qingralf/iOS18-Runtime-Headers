...
@interface SUDescriptor : NSObject <NSCopying, NSSecureCoding> {
    ...
    unsigned int  _autoDownloadOnBatteryDelay;
    unsigned int  _autoDownloadOnBatteryMinBattery;
...
@property (getter=granularlyRamped, nonatomic) bool granularlyRamped;
...
@property (nonatomic) bool isSplombo;
...
@property (getter=rampEnabled, nonatomic) bool rampEnabled;
...
@property (getter=splatComboBuildVersion, nonatomic, retain) NSString *splatComboBuildVersion;
...
- (unsigned int)autoDownloadOnBatteryDelay;
- (unsigned int)autoDownloadOnBatteryMinBattery;
...
- (bool)isRelevantToDeclaration:(id)arg1;
- (bool)isSplatOnly;
- (bool)isSplombo;
...
- (id)releaseDate;
- (id)releaseType;
- (bool)releasedBefore:(double)arg1;
- (id)rsepDigest;
- (id)rsepTBMDigest;
- (id)sepDigest;
- (id)sepTBMDigest;
...
- (void)setAutoDownloadOnBatteryDelay:(unsigned int)arg1;
- (void)setAutoDownloadOnBatteryMinBattery:(unsigned int)arg1;
