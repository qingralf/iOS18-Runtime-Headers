...
- (id)getMandatorySoftwareUpdateDictionaryWithError:(id*)arg1;
- (id)globalSettingsDeclarationWithError:(id*)arg1;
- (void)handleDDMDeclaration:(id)arg1 withResult:(id /* block */)arg2;
- (void)handleUIForDDMDeclaration:(id)arg1;
- (void)handleUIForDDMGlobalSettings:(id)arg1;
...
- (bool)scheduleUpdate:(id)arg1 withError:(id*)arg2;
...
- (bool)setGlobalSettings:(id)arg1 withError:(id*)arg2;
