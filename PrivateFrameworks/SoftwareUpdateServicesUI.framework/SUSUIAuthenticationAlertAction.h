...
@interface SUSUIAuthenticationAlertAction : BSAction {
    ...
    SUAutoInstallForecast * _autoInstallForecast;
...
@property (nonatomic, readonly, retain) SUAutoInstallForecast *autoInstallForecast;
...
- (id)initWithDescriptor:(id)arg1 autoInstallForecast:(id)arg2 forInstallTonight:(bool)arg3 canDeferInstallation:(bool)arg4 completionQueue:(id)arg5 completionBlock:(id /* block */)arg6;
