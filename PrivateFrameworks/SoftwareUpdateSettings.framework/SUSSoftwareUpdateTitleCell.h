...
@interface SUSSoftwareUpdateTitleCell : PSTableCell <SUSSoftwareUpdateCellProtocol> {
    ...
    bool  _showSplomboNotes;
    UILabel * _splomboNotes;
    UIImage * _updateIcon;
...
@property (nonatomic, readonly) UILabel *splomboNotes;
...
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2 specifier:(id)arg3 updateIcon:(id)arg4 showLearnMore:(bool)arg5 showSplomboNotes:(bool)arg6 delegate:(id)arg7;
- (void)layoutSubviews;
- (id)learnMoreLabel;
