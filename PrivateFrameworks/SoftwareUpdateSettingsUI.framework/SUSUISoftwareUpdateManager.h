...
- (void)enrollInBetaUpdatesForProgram:(id)arg1 completion:(id /* block */)arg2;
...
- (void)manager:(id)arg1 handleDDMDeclaration:(id)arg2;
...
- (id)scanError;
- (void)scanFinishedWithUpdates:(id)arg1 options:(id)arg2 andError:(id)arg3;
