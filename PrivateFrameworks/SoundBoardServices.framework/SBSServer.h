...
@interface SBSServer : NSObject <NSXPCListenerDelegate, SBSImplementer, SBSImplementerInternal> {
    <SBSAirDropServiceImplementer> * _airdropServiceDelegate;
...
@property (nonatomic) <SBSAirDropServiceImplementer> *airdropServiceDelegate;
...
- (void)airDropSysdiagnoseInternal:(id)arg1 airDropID:(id)arg2 completionHandler:(id /* block */)arg3;
- (id)airdropServiceDelegate;
- (void)cancelCurrentSysdiagnose:(id /* block */)arg1;
- (void)cancelSysdiagnoseInternal:(id /* block */)arg1;
- (void)clearHomeSWUpdate;
- (void)clearHomeSWUpdateInternal;
- (id)controlsDelegate;
- (void)createSysdiagnose:(id /* block */)arg1;
- (void)createSysdiagnoseInternal:(id /* block */)arg1;
...
- (void)setAirdropServiceDelegate:(id)arg1;
