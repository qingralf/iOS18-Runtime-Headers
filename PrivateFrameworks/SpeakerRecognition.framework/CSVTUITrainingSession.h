...
- (id)createDigitalZeroReporterWithVoiceTriggerEventInfo:(id)arg1 withSessionStatus:(int)arg2;
...
- (id)initWithUtteranceId:(long long)arg1 sessionNumber:(long long)arg2 Locale:(id)arg3 vtAssetConfigVersion:(id)arg4 audioSession:(id)arg5 keywordDetector:(id)arg6 speechRecognizer:(id)arg7 speechRecognitionRequest:(id)arg8 sessionDelegate:(id)arg9 sessionDispatchQueue:(id)arg10 mhUUID:(id)arg11 zeroCounter:(id)arg12 completionWithResult:(id /* block */)arg13;
