...
+ (bool)saveUtterance:(id)arg1 utteranceAudioPath:(id)arg2 numSamplesToWrite:(unsigned long long)arg3;
+ (bool)saveUtteranceAndMetadata:(id)arg1 atDirectory:(id)arg2;
