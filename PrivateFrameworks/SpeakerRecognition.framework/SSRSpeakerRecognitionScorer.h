...
+ (id)createVoiceScorersWithVoiceProfiles:(id)arg1 withConfigFile:(id)arg2 withResourceFile:(id)arg3 withOffsetsType:(unsigned long long)arg4 forRetraining:(bool)arg5;
...
- (id)initWithProfileID:(id)arg1 withModelFile:(id)arg2 withConfigFile:(id)arg3 withResourceFile:(id)arg4 configData:(id)arg5 memoryIndex:(id)arg6 withOffsetsType:(unsigned long long)arg7 forRetraining:(bool)arg8;
- (id)initWithProfileID:(id)arg1 withModelFile:(id)arg2 withConfigFile:(id)arg3 withResourceFile:(id)arg4 withOffsetsType:(unsigned long long)arg5 forRetraining:(bool)arg6;
- (id)modelFilePath;
