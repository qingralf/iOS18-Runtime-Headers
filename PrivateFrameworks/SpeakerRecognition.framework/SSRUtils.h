...
+ (id)concatenateDonationId:(id)arg1 triggerPhraseId:(unsigned long long)arg2;
+ (id)convertSchemaTypeWithLocale:(id)arg1;
+ (unsigned long long)convertToEnrollmentTriggerPhraseWithPhId:(unsigned long long)arg1;
+ (int)convertToSchemaEnumWithPhId:(unsigned long long)arg1;
+ (id)convertToUtteranceDataWithDonationString:(id)arg1;
+ (id)createAVAudioPCMBufferWithNSData:(id)arg1 audioFormat:(unsigned long long)arg2 sampleRate:(float)arg3 numOfChannel:(unsigned int)arg4 isInterleaved:(bool)arg5;
+ (void)createDirectoryIfDoesNotExist:(id)arg1;
+ (unsigned long long)deviceCategoryForDeviceProductType:(id)arg1;
+ (unsigned long long)deviceCategoryFromString:(id)arg1;
