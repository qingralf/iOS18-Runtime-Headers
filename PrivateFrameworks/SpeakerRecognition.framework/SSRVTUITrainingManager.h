...
@interface SSRVTUITrainingManager : NSObject <CSVTUIAudioSessionDelegate, CSVTUIEndpointAnalyzerDelegate, CSVTUITrainingSessionDelegate, SSRVTUITrainingService, SSRVTUITrainingServiceDelegate> {
...
+ (id)trainingManagerWithLocaleID:(id)arg1 withAppDomain:(id)arg2 withSiriSharedUserId:(id)arg3;
...
- (id)_getAudioToneFileName:(int)arg1;
- (void)_playSoundsEffect:(int)arg1;
...
- (id)initWithLocaleIdentifier:(id)arg1 withAudioSession:(id)arg2 withAppDomain:(id)arg3 shouldTrainViaXPC:(bool)arg4 withSiriSharedUserId:(id)arg5;
- (void)playSoundEffectWithAudioTone:(int)arg1;
- (void)playSoundsEffect:(long long)arg1;
