...
@property (nonatomic, readonly) double alternativeTextLeftSpacing; /* unknown property attribute: ? */
@property (nonatomic, retain) UIFont *annotationTextFont;
@property (nonatomic, readonly) bool applyCornerRadiusToAllCandidates; /* unknown property attribute: ? */
@property (nonatomic, retain) UIColor *arrowButtonBackgroundColor;
@property (nonatomic) bool arrowButtonBackgroundHidden;
@property (nonatomic, readonly) UIButtonConfiguration *arrowButtonConfig; /* unknown property attribute: ? */
@property (nonatomic) double arrowButtonHeight;
@property (nonatomic, readonly) bool arrowButtonHighlightBackgroundHidden; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) UIImage *autofillExtraCandidateImage; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } groupHeaderPadding; /* unknown property attribute: ? */
@property (readonly) unsigned long long hash;
@property (nonatomic, readonly) bool hideLinesOnDisambiguationGridEdges; /* unknown property attribute: ? */
@property (nonatomic, readonly) bool hideSlottedCellSeparators; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) double interRowSpacing; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) bool maximizeSortControlWidthWithPadding; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) bool performScalingAnimationOnCellHighlight; /* unknown property attribute: ? */
@property (nonatomic, readonly, copy) NSString *proactiveCandidateContentsGravity; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) bool shouldJustifyRow; /* unknown property attribute: ? */
@property (nonatomic, readonly) bool shouldScrollIfShowingLastVisibleRow; /* unknown property attribute: ? */
@property (nonatomic, readonly) bool shouldUpdateCollectionViewWidthForArrowButtonVisibility; /* unknown property attribute: ? */
@property (nonatomic, readonly) bool showCellBorderForSpaceConfirmationCandidate; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) double slottedCandidatesIterItemSpacing; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) UIColor *spaceConfirmationCandidateCellBackgroundColor; /* unknown property attribute: ? */
@property (nonatomic, readonly) NSDictionary *suggestionCandidateBodyFontAttributes; /* unknown property attribute: ? */
@property (nonatomic, readonly) NSDictionary *suggestionCandidateHeaderFontAttributes; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) double widthOfGridGradient; /* unknown property attribute: ? */
