...
+ (double)_heightForBadgeWithTextWithOrientation:(long long)arg1;
...
+ (struct CGSize { double x1; double x2; })sizeOfBadgeGivenNumberOfDisplayedDigits:(long long)arg1 arrowOrientation:(long long)arg2 badgePresentation:(long long)arg3 badgeIndicator:(long long)arg4 contrasted:(bool)arg5;
