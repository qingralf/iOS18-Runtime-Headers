...
+ (id)_suffixedURLsForURL:(id)arg1;
...
- (void)addVocabularyEntryWithWord:(id)arg1 IPAs:(id)arg2;
...
- (void)setDonationTipKitSeen:(bool)arg1;
...
- (void)setPhoneticVocabularyShowDebugUI:(bool)arg1;
- (void)setPhoneticVocabularyShowUserFacingIPA:(bool)arg1;
- (void)setPhoneticVocabularyShowUserFacingIPAToggle:(bool)arg1;
- (void)setPhoneticVocabularySkipPickingPronunciation:(bool)arg1;
