...
@interface CACSceneManager : NSObject <CACDictationRecognizerModeOverlayManagerDelegate, CACEditingModeOverlayManagerDelegate, CACElementNamesOverlayManagerDelegate, CACLabeledElementsOverlayManagerDelegate, CACLabeledGridOverlayManagerDelegate, CACSimpleContentViewManagerDelegate> {
    ...
    CACEditingModeOverlayManager * _editingModeOverlayManager;
    ...
    CACEditingModeOverlayManager * _linesEditingModeOverlayManager;
    struct CGRect { 
        struct CGPoint { 
            double x; 
            double y; 
...
@property (nonatomic, retain) CACEditingModeOverlayManager *editingModeOverlayManager;
...
@property (nonatomic, readonly) bool isCarPlayScene;
@property (nonatomic, readonly) bool isMainDisplayScene;
...
@property (nonatomic, retain) CACEditingModeOverlayManager *linesEditingModeOverlayManager;
...
- (bool)isOverlayFadingEnabledForEditingModeOverlayManager:(id)arg1;
...
- (id)linesEditingModeOverlayManager;
...
- (double)overlayFadeDelayForEditingModeOverlayManager:(id)arg1;
...
- (float)overlayFadeOpacityForEditingModeOverlayManager:(id)arg1;
...
- (void)setEditingModeOverlayManager:(id)arg1;
...
- (void)setLinesEditingModeOverlayManager:(id)arg1;
