...
- (void).cxx_destruct;
- (id)_actOnStrings:(id)arg1 range:(id)arg2 ambiguityResolution:(id)arg3 substringSearchGranularity:(int)arg4 alwaysCallActionOnClosestMatch:(bool)arg5 options:(id)arg6 provider:(id)arg7 actionBlock:(id /* block */)arg8;
...
- (id)actOnRange:(id)arg1 options:(id)arg2 actionBlock:(id /* block */)arg3;
...
- (id)markerRangeForEnumerationType:(long long)arg1 markerRange:(id)arg2 desiredBlock:(int)arg3 count:(unsigned long long)arg4 options:(int)arg5;
- (id)markerRangeForLineInDesiredBlock:(int)arg1 markerRange:(id)arg2 count:(unsigned long long)arg3 options:(int)arg4;
...
- (void)selectFromPhraseVariants:(id)arg1 insertionString:(id)arg2 range:(id)arg3 recognizedParameters:(id)arg4 commandIdentifer:(id)arg5;
...
- (void)selectFromRange:(id)arg1 insertionString:(id)arg2 commandIdentifier:(id)arg3 recognizedParamaters:(id)arg4;
