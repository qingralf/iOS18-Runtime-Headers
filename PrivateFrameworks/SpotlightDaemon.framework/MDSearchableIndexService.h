...
- (void)_processIndexDataForBundle:(id)arg1 protectionClass:(id)arg2 personaID:(id)arg3 options:(long long)arg4 items:(id)arg5 itemsText:(id)arg6 itemsHTML:(id)arg7 clientState:(id)arg8 expectedClientState:(id)arg9 clientStateName:(id)arg10 deletes:(id)arg11 completionHandler:(id /* block */)arg12;
- (void)_runLibraryDeletedCommand:(id)arg1;
- (id)activityQueue;
...
- (void)deleteAllUserActivities:(id)arg1 fromClient:(id)arg2 options:(long long)arg3 completionHandler:(id /* block */)arg4;
...
- (void)fetchAttributes:(id)arg1 protectionClass:(id)arg2 bundleID:(id)arg3 identifiers:(id)arg4 userCtx:(id)arg5 flags:(unsigned int)arg6 qos:(unsigned int)arg7 reply:(id)arg8 completionHandler:(id /* block */)arg9;
- (bool)fetchCacheFileDescriptors:(id)arg1;
- (void)fetchCacheFileDescriptorsForProtectionClass:(id)arg1 bundleID:(id)arg2 identifiers:(id)arg3 userCtx:(id)arg4 flags:(unsigned int)arg5 qos:(unsigned int)arg6 reply:(id)arg7 completionHandler:(id /* block */)arg8;
...
- (bool)finishIndexingLocked:(id)arg1;
...
- (void)indexFromBundle:(id)arg1 protectionClass:(id)arg2 options:(long long)arg3 items:(id)arg4 itemsText:(id)arg5 itemsHTML:(id)arg6 clientState:(id)arg7 expectedClientState:(id)arg8 clientStateName:(id)arg9 deletes:(id)arg10 userActivities:(bool)arg11 completionHandler:(id /* block */)arg12;
...
- (bool)isInternal;
- (bool)isPrivate;
- (bool)issueCacheCommand:(id)arg1;
- (bool)issueCommand:(id)arg1;
- (bool)openJournalFile:(id)arg1;
...
- (bool)photosLibraryDeleted:(id)arg1;
- (bool)prepareIndexingLocked:(id)arg1;
...
- (bool)quotaDisabled;
- (bool)searchInternal;
- (void)setAllowMail:(bool)arg1;
- (void)setAllowMessagesContent:(bool)arg1;
- (void)setAllowNotifications:(bool)arg1;
- (void)setAllowOpenJournalFile:(bool)arg1;
- (void)setAllowPhotosLibraryDeletion:(bool)arg1;
...
- (bool)transferDeleteJournals:(id)arg1;
- (void)transferDeleteJournalsForProtectionClass:(const char *)arg1 toDirectory:(int)arg2 withCompletionHandler:(id /* block */)arg3;
- (bool)updateCorrections:(id)arg1;
