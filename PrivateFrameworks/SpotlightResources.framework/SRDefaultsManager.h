...
- (void).cxx_destruct;
- (void)_loadAssets:(id)arg1 deliveryType:(id)arg2 shouldUpdate:(bool)arg3;
...
- (bool)forceLoad;
- (id)init;
- (void)loadDefaultsForLocale:(id)arg1 reload:(bool)arg2;
- (void)loadDefaultsFromDefaultAssets:(id)arg1;
- (void)loadFactorsAtPath:(id)arg1 namespaceId:(id)arg2;
- (void)loadSupportedLocalesFromFile:(id)arg1;
