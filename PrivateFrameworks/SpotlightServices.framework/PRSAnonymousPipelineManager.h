...
+ (id)engagementCountForDateKeyForBundle:(id)arg1;
+ (id)engagementCountKeyForBundle:(id)arg1;
+ (id)engagementDateKeyForBundle:(id)arg1;
+ (id)logURLForCurrentTimeAndBundle:(id)arg1 forEngagement:(bool)arg2;
...
- (void)_extractTrainingSamplesForQuery:(id)arg1 withIndexOfEngagedItem:(unsigned long long)arg2 withItems:(id)arg3 withRanker:(id)arg4 withCEPData:(id)arg5 forClientBundle:(id)arg6 debugInfoEnabled:(bool)arg7 keyboardPrimaryLanguage:(id)arg8;
- (void)_increaseUserDefaultsEngagementCountForBundle:(id)arg1;
- (void)_increaseUserDefaultsEngagementCountForDateWithClientBundle:(id)arg1;
- (id)_relativePositionForItem:(id)arg1 inItems:(id)arg2 withIndexOfEngagedItem:(long long)arg3 forClientBundle:(id)arg4;
- (bool)_shouldDataCollectForEngagementReservoirSamplingForClientBundle:(id)arg1;
...
- (void)extractTrainingDataWithItemAtIndex:(unsigned long long)arg1 withItems:(id)arg2 withRanker:(id)arg3 forQuery:(id)arg4 dataCollectAllowed:(bool)arg5 forClientBundle:(id)arg6 keyboardPrimaryLanguage:(id)arg7 clientID:(id)arg8;
- (void)extractTrainingDataWithItemAtIndex:(unsigned long long)arg1 withItems:(id)arg2 withRanker:(id)arg3 forQuery:(id)arg4 dataCollectAllowed:(bool)arg5 queryID:(id)arg6 withCEPData:(id)arg7 forClientBundle:(id)arg8 debugInfoEnabled:(bool)arg9 keyboardPrimaryLanguage:(id)arg10 clientID:(id)arg11;
- (id)init;
