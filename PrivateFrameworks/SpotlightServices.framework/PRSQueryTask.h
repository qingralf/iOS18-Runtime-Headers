...
@property (nonatomic, retain) SFEngagementSignal *engagementSignal;
@property (nonatomic, retain) NSString *fbq;
@property (retain) PRSSearchFeedback *feedback;
@property (nonatomic) <PRSSearchQueryHandler> *handler;
...
@property (nonatomic, retain) NSDictionary *serverRelevanceScores;
...
- (void)setServerRelevanceScoreThreshold:(float)arg1;
- (void)setServerRelevanceScores:(id)arg1;
