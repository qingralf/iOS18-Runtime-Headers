...
- (id)intentBasedSuggestionBlending:(id)arg1 suggestions:(id)arg2;
...
- (id)queue;
- (id)release2022_blendingByPolicyWithQueryContext:(id)arg1 filters:(id)arg2 entityFilters:(id)arg3 contactFilters:(id)arg4 userSuggestion:(id)arg5 userWebSuggestion:(id)arg6 shortcutSuggestionResults:(id)arg7 actionSuggestionResults:(id)arg8 contactSuggestionResults:(id)arg9 serverSuggestionResults:(id)arg10 localSuggestionResults:(id)arg11 options:(id)arg12;
- (id)release2023_blendingByPolicyWithQueryContext:(id)arg1 filters:(id)arg2 entityFilters:(id)arg3 contactFilters:(id)arg4 userSuggestion:(id)arg5 userWebSuggestion:(id)arg6 actionSuggestionResults:(id)arg7 contactSuggestionResults:(id)arg8 serverSuggestionResults:(id)arg9 localSuggestionResults:(id)arg10 options:(id)arg11;
- (id)release2023_blendingWithQueryContext:(id)arg1 filters:(id)arg2 entityFilters:(id)arg3 contactFilters:(id)arg4 userSuggestion:(id)arg5 userWebSuggestion:(id)arg6 shortcutSuggestionResults:(id)arg7 actionSuggestionResults:(id)arg8 contactSuggestionResults:(id)arg9 serverSuggestionResults:(id)arg10 localSuggestionResults:(id)arg11 options:(id)arg12;
- (id)resources;
