...
@property (nonatomic, retain) SSPommesPhotosRanker *rankerReference;
...
- (id)identifier;
- (id)label;
- (void)matchScoreFromMatchInfo:(id)arg1 userQueryToken:(id)arg2;
- (void)matchScoreWhenLabelMatched:(id)arg1 userQueryToken:(id)arg2;
- (void)matchScoreWhenSynonymsMatched:(id)arg1 userQueryToken:(id)arg2;
