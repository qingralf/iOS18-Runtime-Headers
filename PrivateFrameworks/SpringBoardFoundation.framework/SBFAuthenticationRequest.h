...
- (void).cxx_destruct;
- (id)_initWithType:(unsigned long long)arg1 source:(long long)arg2 passcode:(id)arg3 skipSEKeepUserDataOperation:(bool)arg4 verifyOnly:(bool)arg5 handler:(id /* block */)arg6;
- (id)description;
...
- (id)initForPasscode:(id)arg1 source:(long long)arg2 skipSEKeepUserDataOperation:(bool)arg3 handler:(id /* block */)arg4;
- (id)initForPasscode:(id)arg1 source:(long long)arg2 skipSEKeepUserDataOperation:(bool)arg3 verifyOnly:(bool)arg4 handler:(id /* block */)arg5;
- (id)passcode;
