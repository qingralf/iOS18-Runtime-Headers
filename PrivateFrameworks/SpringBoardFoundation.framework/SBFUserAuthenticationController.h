...
@interface SBFUserAuthenticationController : NSObject <SBFAuthenticationAssertionProviding, SBFAuthenticationStatusProvider, SBFMobileKeyBagObserver, SBFPasscodeFieldChangeObserver, SBFSecureDisplayStateProviding, SBFUserAuthenticationModelDelegate> {
...
@property (getter=isInSecureDisplayMode, nonatomic, readonly) bool inSecureDisplayMode;
...
@property (nonatomic, readonly) bool supportsSecureDisplayMode;
...
- (id)authenticationStatusProviderTreatingContinuityUnlockedAsUnlocked:(bool)arg1;
- (id)createGracePeriodAssertionWithReason:(id)arg1;
- (id)createKeybagUnlockAssertionWithReason:(id)arg1;
- (id)createSecureDisplayDeferralAssertionWithReason:(id)arg1;
- (void)dealloc;
- (id)description;
