...
@property (nonatomic, readonly, retain) SBCaptureApplicationDefaults *captureApplicationDefaults;
@property (nonatomic, readonly, retain) SBCaptureButtonDefaults *captureButtonDefaults;
...
@property (nonatomic, readonly, retain) SBPencilDefaults *pencilDefaults;
...
@property (nonatomic, readonly, retain) SBScreenLongevityDefaults *screenLongevityDefaults;
...
- (id)captureApplicationDefaults;
- (id)captureButtonDefaults;
