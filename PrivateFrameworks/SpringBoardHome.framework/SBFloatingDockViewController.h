...
@interface SBFloatingDockViewController : SBHTouchPassThroughViewController <BSDescriptionProviding, SBFloatingDockViewDelegate, SBFolderControllerDelegate, SBFolderPresentingViewControllerDelegate, SBHLibraryIndicatorIconDropInteractionContextProviding, SBHLibraryViewControllerObserver, SBHModalLibraryPresenterContextProviding, SBIconListLayoutObserver, SBIconListModelObserver, SBIconListViewDragDelegate, SBIconLocationPresenting, SBIconViewDelegate, SBIconViewObserver, SBIconViewProviding, SBIconViewQuerying, SBScaleIconZoomAnimationContaining, SBUICoronaAnimationControllerParticipant> {
    ...
    SBHTouchPassThroughView * _scalingView;
...
@property (nonatomic, retain) SBHTouchPassThroughView *scalingView;
...
- (void)listLayoutProviderDidChange:(id)arg1;
