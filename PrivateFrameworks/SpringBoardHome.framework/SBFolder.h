...
@interface SBFolder : NSObject <BSDescriptionProviding, NSCopying, SBFolderObserver, SBHIconBadgeBehaviorProviderProviding, SBIconIndexMutableListObserver, SBIconIndexNode, SBIconListModelDelegate, SBIconListModelObserver, SBTreeNode> {
    NSString * _badge;
    ...
    SBHIconGridSizeClassSet * _listAllowedGridSizeClasses;
    struct SBHIconGridSize { 
        unsigned short columns; 
        unsigned short rows; 
    }  _listGridSize;
    unsigned char  _listModelMutationNotificationIgnoreCount;
    NSString * _listRotatedLayoutClusterGridSizeClass;
    struct SBHIconGridSize { 
        unsigned short columns; 
        unsigned short rows; 
    }  _listWithNonDefaultSizedIconsGridSize;
    SBIconIndexMutableList * _lists;
    bool  _listsAllowIndependentRotatedLayout;
...
@property (nonatomic, readonly) <SBHIconBadgeBehaviorProviding> *effectiveBadgeBehaviorProvider;
...
@property (nonatomic, copy) SBHIconGridSizeClassSet *listAllowedGridSizeClasses;
...
@property (getter=listsAllowIndependentRotatedLayout, nonatomic) bool listsAllowIndependentRotatedLayout;
...
- (bool)_compactListsAndFirst:(bool)arg1;
...
- (void)_updateOverflowCountInList:(id)arg1 forResizingIcon:(id)arg2 fromGridSizeClass:(id)arg3 options:(unsigned long long)arg4;
...
- (id)addIcon:(id)arg1 toListAtIndex:(unsigned long long)arg2 options:(unsigned long long)arg3 didBump:(bool*)arg4;
- (id)addIcons:(id)arg1;
...
- (bool)canRemoveIcons;
- (id)changeGridSizeClassOfIconAtGridPath:(id)arg1 toGridSizeClass:(id)arg2 options:(unsigned long long)arg3 listGridCellInfoOptions:(unsigned long long)arg4;
- (id)changeGridSizeClassOfIconAtIndexPath:(id)arg1 toGridSizeClass:(id)arg2 options:(unsigned long long)arg3 listGridCellInfoOptions:(unsigned long long)arg4;
...
- (id)directlyContainedFolderContainingList:(id)arg1;
- (id)displayName;
- (id)effectiveBadgeBehaviorProvider;
...
- (void)enumerateListsNearestToList:(id)arg1 usingBlock:(id /* block */)arg2;
...
- (id)gridPathForFirstFreeSlotOfRangeOfSizeClass:(id)arg1 avoidingFirstList:(bool)arg2 listGridCellInfoOptions:(unsigned long long)arg3;
- (id)gridPathForFirstFreeSlotOfRangeOfSizeClass:(id)arg1 startingAtList:(id)arg2 avoidingFirstList:(bool)arg3 searchForwards:(bool)arg4 listGridCellInfoOptions:(unsigned long long)arg5;
- (id)gridPathForFirstFreeSlotOfRangeOfSizeClass:(id)arg1 startingAtList:(id)arg2 listGridCellInfoOptions:(unsigned long long)arg3;
...
- (id)gridPathWithList:(id)arg1 gridCellIndex:(unsigned long long)arg2 listGridCellInfoOptions:(unsigned long long)arg3;
...
- (id)initWithDisplayName:(id)arg1 maxListCount:(unsigned long long)arg2 listGridSize:(struct SBHIconGridSize { unsigned short x1; unsigned short x2; })arg3 iconGridSizeClassSizes:(id)arg4;
...
- (id)initWithUniqueIdentifier:(id)arg1 displayName:(id)arg2 maxListCount:(unsigned long long)arg3 listGridSize:(struct SBHIconGridSize { unsigned short x1; unsigned short x2; })arg4;
- (id)initWithUniqueIdentifier:(id)arg1 displayName:(id)arg2 maxListCount:(unsigned long long)arg3 listGridSize:(struct SBHIconGridSize { unsigned short x1; unsigned short x2; })arg4 iconGridSizeClassSizes:(id)arg5;
...
- (id)layerForListIndex:(unsigned long long)arg1 gridSize:(struct SBHIconGridSize { unsigned short x1; unsigned short x2; })arg2 iconImageInfo:(struct SBIconImageInfo { struct CGSize { double x_1_1_1; double x_1_1_2; } x1; double x2; double x3; })arg3 cellSpacing:(struct CGSize { double x1; double x2; })arg4 imageAppearance:(id)arg5 cellProvider:(id /* block */)arg6;
- (id)layerForListIndex:(unsigned long long)arg1 listLayout:(id)arg2 imageAppearance:(id)arg3;
- (id)layerForListIndex:(unsigned long long)arg1 listLayout:(id)arg2 imageAppearance:(id)arg3 cellProvider:(id /* block */)arg4;
- (id)layerForListIndex:(unsigned long long)arg1 listLayout:(id)arg2 traitCollection:(id)arg3;
...
- (id)listRotatedLayoutClusterGridSizeClass;
...
- (void)setListAllowedGridSizeClasses:(id)arg1;
- (void)setListRotatedLayoutClusterGridSizeClass:(id)arg1;
- (void)setListWithNonDefaultSizedIconsGridSize:(struct SBHIconGridSize { unsigned short x1; unsigned short x2; })arg1;
- (void)setListsAllowIndependentRotatedLayout:(bool)arg1;
...
- (void)swapIcon:(id)arg1 withIcon:(id)arg2 options:(unsigned long long)arg3;
