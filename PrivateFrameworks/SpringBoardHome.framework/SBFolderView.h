...
@interface SBFolderView : UIView <BSDescriptionProviding, SBFolderObserver, SBHIconLayoutHiding, SBHIconLayoutHidingCompoundAssertionInvalidationHandler, SBHScrollableIconViewContaining, SBHVisibleContentPresenter, SBIconListLayoutDelegate, SBIconListPageControlDelegate, SBIconListViewDragDelegate, SBIconScrollViewDelegate, UITextFieldDelegate, _UIUpdateCycleIdleObserver> {
    ...
    unsigned long long  _extraPageCountDuringScrolling;
    SBFolder * _folder;
    ...
    bool  _registeredForIdleUpdates;
    bool  _rotating;
...
@property (nonatomic, readonly) unsigned long long currentPageType;
...
@property (nonatomic, readonly) long long firstLeadingCustomPageIndex;
@property (nonatomic, readonly) long long firstTrailingCustomPageIndex;
...
@property (nonatomic, readonly) long long iconSpacingAxisMatchingBehavior;
...
@property (nonatomic, readonly) long long lastLeadingCustomPageIndex;
@property (nonatomic, readonly) long long lastTrailingCustomPageIndex;
@property (nonatomic, readonly) unsigned long long leadingCustomPageCount;
...
@property (nonatomic, readonly) long long nearestIconPageIndex;
...
@property (getter=isRegisteredForIdleUpdates, nonatomic) bool registeredForIdleUpdates;
...
@property (nonatomic, readonly) long long scrollAnimationTargetPageIndex;
...
@property (nonatomic, readonly) unsigned long long totalLeadingCustomPageCount;
@property (nonatomic, readonly) unsigned long long trailingCustomPageCount;
...
- (long long)_adjustPageIndexForPageControl:(long long)arg1;
- (long long)_adjustPageIndexFromPageControl:(long long)arg1;
...
- (void)_removeDisableAutoScrollAssertion:(id)arg1;
...
- (struct CGPoint { double x1; double x2; })_scrollOffsetForPageAtIndex:(long long)arg1 pageHeight:(double)arg2;
- (struct CGPoint { double x1; double x2; })_scrollOffsetForPageAtIndex:(long long)arg1 pageWidth:(double)arg2;
- (struct SBHFloatRange { double x1; double x2; })_scrollRangeForContentAtPageIndex:(long long)arg1 pageHeight:(double)arg2;
- (struct SBHFloatRange { double x1; double x2; })_scrollRangeForContentAtPageIndex:(long long)arg1 pageWidth:(double)arg2;
- (struct SBHFloatRange { double x1; double x2; })_scrollRangeForContentAtPageIndex:(long long)arg1 pageWidthOrHeight:(double)arg2;
- (struct SBHFloatRange { double x1; double x2; })_scrollRangeForPageAtIndex:(long long)arg1;
- (struct SBHFloatRange { double x1; double x2; })_scrollRangeForPageAtIndex:(long long)arg1 pageHeight:(double)arg2;
...
- (void)_updateIconListViewsWithCurrentPageIndex:(long long)arg1 currentPageUniqueIdentifier:(id)arg2;
- (void)_updateIconListViewsWithCurrentPageUniqueIdentifier:(id)arg1;
...
- (unsigned long long)columnCountForPageIndex:(long long)arg1;
- (unsigned long long)columnCountInVisibleColumnRange:(struct SBVisibleColumnRange { unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; })arg1;
- (unsigned long long)columnOrRowCountForScrollingForPageIndex:(long long)arg1;
...
- (id)disableAutoScrollForReason:(id)arg1;
...
- (unsigned long long)extraPageCountDuringScrolling;
...
- (long long)firstTrailingCustomPageIndex;
- (id)folder;
...
- (void)folder:(id)arg1 willRestoreOverflowIcon:(id)arg2 toList:(id)arg3;
...
- (id)iconImageCache;
- (long long)iconInsertionAnimationOriginatingEdgeForIconListView:(id)arg1;
- (id)iconListModelForPageIndex:(long long)arg1;
...
- (long long)iconRemovalAnimationDestinationEdgeForIconListView:(id)arg1;
...
- (bool)isLeadingCustomViewPageHiddenAtIndex:(unsigned long long)arg1;
...
- (long long)lastTrailingCustomPageIndex;
...
- (unsigned long long)leadingCustomPageIndexForPageIndex:(long long)arg1;
...
- (long long)nearestIconPageIndex;
...
- (long long)pageIndexForLeadingCustomPageIndex:(unsigned long long)arg1;
- (long long)pageIndexForTrailingCustomPageIndex:(unsigned long long)arg1;
- (long long)pageIndexForUniqueIdentifier:(id)arg1;
- (struct CGPoint { double x1; double x2; })pointForScrollingDimension:(double)arg1;
...
- (long long)scrollAnimationTargetPageIndex;
...
- (double)scrollingDimensionForPoint:(struct CGPoint { double x1; double x2; })arg1;
- (unsigned int)scrollingDirection;
- (unsigned int)scrollingDirectionTracking:(bool)arg1;
...
- (void)setExtraPageCountDuringScrolling:(unsigned long long)arg1;
...
- (void)setRegisteredForIdleUpdates:(bool)arg1;
...
- (void)setSuppressesEditingStateForListViews:(bool)arg1 animated:(bool)arg2;
...
- (unsigned long long)trailingCustomPageIndexForPageIndex:(long long)arg1;
...
- (id)uniqueIdentifierForPageIndex:(long long)arg1;
