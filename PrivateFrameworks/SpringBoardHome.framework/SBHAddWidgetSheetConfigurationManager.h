...
- (void).cxx_destruct;
- (void)_addCustomApplicationWidgetCollectionsToApplicationWidgetCollections:(id)arg1;
- (void)_addFakeWidgetsToApplicationWidgetCollectionsIfAllowed:(id)arg1;
...
- (bool)_isContainerBundleIdentifierUnprotected:(id)arg1;
- (bool)_isDescriptorAllowed:(id)arg1;
- (bool)_isDescriptorContainerUnprotected:(id)arg1;
- (bool)_isDescriptorSupported:(id)arg1;
- (bool)_isDescriptorSupportedByDelegate:(id)arg1;
...
- (void)_sortApplicationWidgetCollections:(id)arg1;
