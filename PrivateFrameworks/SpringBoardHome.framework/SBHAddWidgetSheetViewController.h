...
@interface SBHAddWidgetSheetViewController : SBHAddWidgetSheetViewControllerBase <SBHAddWidgetSheetViewControllerDelegate, SBHMainAddSheetViewControlling, SBHWidgetDragHandlerPassing, SBHWidgetSheetViewControlling, SBHWidgetWrapperViewControllerDelegate, UICollectionViewDelegate, UISearchControllerDelegate, UISearchResultsUpdating, UISheetPresentationControllerDelegate> {
    ...
    _SBHAddWidgetSheetCollectionView * _collectionView;
    SBHAddWidgetSheetConfiguration * _configuration;
    struct NSDirectionalEdgeInsets { 
        double top; 
        double leading; 
        double bottom; 
    ...
    NSArray * _customApplicationWidgetCollections;
...
@property (nonatomic, retain) _SBHAddWidgetSheetCollectionView *collectionView;
@property (nonatomic, copy) SBHAddWidgetSheetConfiguration *configuration;
@property (nonatomic) struct NSDirectionalEdgeInsets { double x1; double x2; double x3; double x4; } contentInsets;
@property (nonatomic, retain) NSArray *customApplicationWidgetCollections;
...
- (struct SBHPadAddWidgetSheetMetrics { double x1; double x2; double x3; double x4; double x5; double x6; double x7; struct CGSize { double x_8_1_1; double x_8_1_2; } x8; unsigned long long x9; struct CGSize { double x_10_1_1; double x_10_1_2; } x10; double x11; double x12; double x13; })_metricsForCurrentOrientation;
...
- (id)_searchTextForSearchController:(id)arg1;
...
- (id)_updatedContentUnavailableConfigurationUsingState:(id)arg1;
...
- (id)customApplicationWidgetCollections;
- (void)dealloc;
...
- (void)setCustomApplicationWidgetCollections:(id)arg1;
