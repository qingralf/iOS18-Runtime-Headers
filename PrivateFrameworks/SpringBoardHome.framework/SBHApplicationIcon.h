...
- (id)automationID;
- (bool)cancelDownload;
- (void)changeEnablement:(unsigned long long)arg1 ofFeature:(unsigned long long)arg2;
- (void)changeHiddenStatusToHidden:(bool)arg1;
- (void)changeLockedStatusToLocked:(bool)arg1;
