...
@interface SBHHomePullToSearchSettings : PTSettings {
    ...
    double  _searchAffordanceBackgroundMaterialFadeEndThreshold;
    double  _searchAffordanceBackgroundMaterialFadeInteractiveTransitionDistance;
    double  _searchAffordanceBackgroundMaterialFadeStartThreshold;
...
- (void)setSearchAffordanceBackgroundMaterialFadeEndThreshold:(double)arg1;
- (void)setSearchAffordanceBackgroundMaterialFadeInteractiveTransitionDistance:(double)arg1;
- (void)setSearchAffordanceBackgroundMaterialFadeStartThreshold:(double)arg1;
