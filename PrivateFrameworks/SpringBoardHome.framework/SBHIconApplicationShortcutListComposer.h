...
+ (bool)sbh_isDestructiveShortcutItem:(id)arg1;
+ (bool)sbh_isShortcutItemDeleteOrRemove:(id)arg1;
+ (bool)sbh_isShortcutItemSpringBoardOnly:(id)arg1;
+ (unsigned long long)sbh_shortcutSectionForItem:(id)arg1;
