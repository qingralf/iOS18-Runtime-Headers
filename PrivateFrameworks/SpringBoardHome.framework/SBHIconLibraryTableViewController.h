...
@property (nonatomic, retain) SBFolderIconImageCache *folderIconImageCache; /* unknown property attribute: ? */
...
@property (nonatomic) SBHLibrarySearchController *searchController; /* unknown property attribute: ? */
