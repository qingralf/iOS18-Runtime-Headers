...
@interface SBHIconModel : NSObject <BSDescriptionProviding, SBFolderObserver, SBHIconModelApplicationDataSourceObserver, SBHIconStateArchiverDelegate, SBHIconStateUnarchiverDelegate, SBHIconStateUnarchiverIconSource, SBIconDelegate, SBIconObserver, SBSHomeScreenServiceInstalledWebClipsObserver> {
    ...
    NSHashTable * _autosaveDisableAssertions;
    ...
    SBHIconGridSizeClassSet * _rootFolderAllowedGridSizeClasses;
...
@property (nonatomic, readonly, copy) SBHIconGridSizeClassSizeMap *gridSizeClassSizes;
...
- (void).cxx_destruct;
- (void)_addHiddenAppsToIgnoredListForRootFolder:(id)arg1;
...
- (bool)addIcon:(id)arg1 toIgnoredListIfNecessaryBasedOnOtherRootFolder:(id)arg2 toRootFolder:(id)arg3 options:(unsigned long long)arg4 listGridCellInfoOptions:(unsigned long long)arg5;
...
- (bool)addIconToIgnoredListBasedOnDefaultIconState:(id)arg1 toRootFolder:(id)arg2 options:(unsigned long long)arg3 listGridCellInfoOptions:(unsigned long long)arg4;
...
- (id)allowedGridSizeClassesForDockForIconStateUnarchiver:(id)arg1;
- (id)allowedGridSizeClassesForFolderClass:(Class)arg1;
- (id)allowedGridSizeClassesForTodayList;
- (id)allowedGridSizeClassesForTodayListForIconStateUnarchiver:(id)arg1;
- (id)applicationDataSource;
- (id)applicationIconForBundleIdentifier:(id)arg1;
- (id)applicationIconsForBundleIdentifier:(id)arg1;
- (id)applicationWithBundleIdentifier:(id)arg1;
- (id)archivedLeafIdentifiers;
- (id)archiver:(id)arg1 representationForIcon:(id)arg2;
- (id)archiver:(id)arg1 representationForIconDataSource:(id)arg2;
...
- (Class)iconClassForApplicationWithBundleIdentifier:(id)arg1;
- (id)iconGridSizeClassDomainForIconStateArchiver:(id)arg1;
- (id)iconGridSizeClassDomainForIconStateUnarchiver:(id)arg1;
...
- (id)iconState;
- (id)iconStateUnarchiver:(id)arg1 allowedGridSizeClassesForFolderClass:(Class)arg2;
- (id)iconStateUnarchiver:(id)arg1 didUnarchiveWidgetIcon:(id)arg2;
- (id)iconStateUnarchiver:(id)arg1 iconDataSourceForRepresentation:(id)arg2;
- (id)iconStateUnarchiver:(id)arg1 iconForRepresentation:(id)arg2;
...
- (id)iconStateUnarchiver:(id)arg1 supportedGridSizeClassesForWidgetWithKind:(id)arg2 extensionBundleIdentifier:(id)arg3 containerBundleIdentifier:(id)arg4;
...
- (void)layout;
- (void)layoutIfNeeded;
- (id)leafIconContainingDataSourceWithIdentifier:(id)arg1;
...
- (id)listRotatedLayoutClusterGridSizeClassForIconStateUnarchiver:(id)arg1;
...
- (id)rootFolder;
- (id)rootFolderAllowedGridSizeClasses;
- (id)rootFolderIcon;
- (id)rotatedGridSizeClassSizes;
- (id)rotatedGridSizeClassSizesForIconStateUnarchiver:(id)arg1;
...
- (void)setRootFolderAllowedGridSizeClasses:(id)arg1;
...
- (id)versionForIconStateArchiver:(id)arg1;
