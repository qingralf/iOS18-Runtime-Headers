...
- (id)_allowedGridSizeClassesForFolderClass:(Class)arg1;
...
- (bool)_canAddIconDataSource:(id)arg1 toIcon:(id)arg2 withGridSizeClass:(id)arg3;
...
- (id)_listFromRepresentation:(id)arg1 properties:(id)arg2 identifier:(id)arg3 context:(id)arg4 overflow:(id)arg5;
- (struct SBHIconGridSize { unsigned short x1; unsigned short x2; })_listGridSizeForFavoriteTodayList;
- (struct SBHIconGridSize { unsigned short x1; unsigned short x2; })_listGridSizeForFolderClass:(Class)arg1;
- (struct SBHIconGridSize { unsigned short x1; unsigned short x2; })_listGridSizeForTodayList;
- (id)_listRotatedLayoutClusterGridSizeClass;
- (id)_listWithIcons:(id)arg1 properties:(id)arg2 identifier:(id)arg3 folder:(id)arg4 overflow:(id)arg5;
...
- (void)applyProperties:(id)arg1 asDefaultPropertiesToFolder:(id)arg2;
- (id)archive;
...
- (id)gridSizeClassForString:(id)arg1;
- (id)iconModel;
- (id)iconSource;
...
- (id)propertiesForFolderClass:(Class)arg1;
