...
@interface SBHLibraryViewController : SBNestingViewController <SBFOverlayObserving, SBFolderControllerDelegate, SBHIconLibraryTableViewControllerObserver, SBHLibraryCategoryMapProviderObserver, SBHLibraryPodFolderControllerDelegate, SBHLibraryProvider, SBHLibrarySearchControllerDelegate, SBHRootFolderCustomViewPresenting, SBHVisibleContentPresenter, SBIconViewDelegate, SBIconViewProviding, SBNestingViewControllerDelegate, UISearchBarDelegate> {
    ...
    SBHCredenzaSettings * _credenzaSettings;
...
@property (nonatomic) SBHCredenzaSettings *credenzaSettings;
...
@property (nonatomic, readonly, copy) NSArray *podTopLevelDisplayedIcons;
...
- (bool)_hiddenCategoriesDidChangeFromCurrentCategoryMap:(id)arg1 toUpdatedCategoryMap:(id)arg2;
- (id)_hiddenCategoryIdentifierForCategoryMap:(id)arg1;
...
- (id)libraryPodFolderController:(id)arg1 nestingViewControllerForPushingWithProposedController:(id)arg2;
...
- (void)setCredenzaSettings:(id)arg1;
