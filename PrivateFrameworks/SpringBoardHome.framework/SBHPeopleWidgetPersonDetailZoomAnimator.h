...
@interface SBHPeopleWidgetPersonDetailZoomAnimator : NSObject <SBHViewControllerTransitionAnimating> {
    ...
    SBHTouchPassThroughView * _matchMoveView;
    SBHPeopleWidgetPersonDetailInteractionSettings * _settings;
    SBHTouchPassThroughView * _sourceContainerView;
    struct CGRect { 
        struct CGPoint { 
            double x; 
            double y; 
...
@property (nonatomic, retain) SBHTouchPassThroughView *matchMoveView;
@property (nonatomic, readonly) SBHPeopleWidgetPersonDetailInteractionSettings *settings;
@property (nonatomic, retain) SBHTouchPassThroughView *sourceContainerView;
