...
@interface SBHSearchPillView : UIView <SBHSearchAffordance> {
    ...
    UIView * _searchAffordanceReferenceBackgroundView;
...
@property (nonatomic, retain) UIView *searchAffordanceReferenceBackgroundView;
...
- (id)searchAffordanceReferenceBackgroundView;
...
- (void)setSearchAffordanceReferenceBackgroundView:(id)arg1;
