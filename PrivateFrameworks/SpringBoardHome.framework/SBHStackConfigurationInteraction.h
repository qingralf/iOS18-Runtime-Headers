...
- (double)_padApertureOutsetFromWidgetWithGridSize:(id)arg1;
...
- (double)stackConfigurationViewController:(id)arg1 iconContentScaleForGridSizeClass:(id)arg2;
...
- (bool)stackConfigurationViewControllerShouldDisallowLabelArea:(id)arg1;
