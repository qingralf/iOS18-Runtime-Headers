...
- (id)_unraveledWidgetIconForDataSource:(id)arg1 withGridSizeClass:(id)arg2;
...
- (void)iconDragManager:(id)arg1 iconDropSession:(id)arg2 didEnterIconListView:(id)arg3;
- (void)iconDragManager:(id)arg1 iconDropSession:(id)arg2 didExitIconListView:(id)arg3;
- (id)iconDragManager:(id)arg1 iconDropSessionDidUpdate:(id)arg2 inIconListView:(id)arg3 draggedIcons:(id)arg4 proposedDropProposal:(id)arg5;
- (void)iconDragManager:(id)arg1 iconListView:(id)arg2 item:(id)arg3 willAnimateDropWithAnimator:(id)arg4;
- (void)iconDragManager:(id)arg1 iconView:(id)arg2 didEndDragSession:(id)arg3 withOperation:(unsigned long long)arg4;
- (void)iconDragManager:(id)arg1 iconView:(id)arg2 dragLiftAnimationDidChangeDirection:(long long)arg3;
