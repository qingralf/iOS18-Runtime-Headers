...
@interface SBHWidgetSearchController : UISearchController {
    ...
    bool  _applicationCellIncludesGalleryListView;
    ...
    NSString * _widthDefiningGridSizeClass;
}
...
@property (nonatomic, copy) NSString *widthDefiningGridSizeClass;
...
- (void)_setupTextFieldWithPlaceholderText:(id)arg1;
- (id)_textFieldFont;
...
- (id)initWithAddWidgetSheetStyle:(unsigned long long)arg1 placeholderText:(id)arg2;
...
- (void)setWidthDefiningGridSizeClass:(id)arg1;
