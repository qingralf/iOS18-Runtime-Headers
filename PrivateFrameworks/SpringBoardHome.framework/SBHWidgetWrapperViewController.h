...
@interface SBHWidgetWrapperViewController : UIViewController <SBHWidgetStyleManagerDelegate, SBIconViewActionDelegate, SBIconViewObserver> {
...
- (void)setUpWidgetStyleManagerForIconView:(id)arg1;
