...
- (id)directlyContainedNodeIdentifier:(id)arg1;
- (bool)directlyContainsNode:(id)arg1;
- (bool)directlyContainsNodeIdentifier:(id)arg1;
- (bool)directlyContainsNodeIdentifier:(id)arg1 passingTest:(id /* block */)arg2;
