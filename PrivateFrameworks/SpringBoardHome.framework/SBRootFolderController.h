...
@property (nonatomic, readonly) unsigned long long destinationPageOffset;
...
@property (nonatomic, readonly, copy) NSArray *leadingCustomViewControllers;
...
@property (nonatomic, readonly, copy) NSArray *trailingCustomViewControllers;
@property (nonatomic, readonly) long long trailingCustomViewPageIndex;
@property (getter=isTrailingCustomViewVisibleOrTransitionDestination, nonatomic, readonly) bool trailingCustomViewVisibleOrTransitionDestination;
...
+ (struct SBRootFolderPageStateTransitionSnapshot { long long x1; long long x2; unsigned long long x3; double x4; })pageStateTransitionSnapshotForScrollOffset:(double)arg1 pageWidth:(double)arg2 pageSpacing:(double)arg3 pages:(const long long*)arg4 pageCount:(unsigned long long)arg5 userInterfaceLayoutDirection:(long long)arg6 currentPageState:(long long)arg7 currentPageOffset:(unsigned long long)arg8 scrollingDirection:(unsigned int)arg9;
...
- (void)_removeShowDoneButtonAssertion:(id)arg1;
...
- (id)applicationWidgetCollectionsForEditingViewController:(id)arg1 withAllowedSizeClasses:(id*)arg2 allowingNonStackableItems:(bool)arg3;
...
- (id)beginPageStateTransitionToState:(long long)arg1 pageIndex:(long long)arg2 reason:(id)arg3 animated:(bool)arg4 interactive:(bool)arg5;
...
- (id)customViewControllerForPageIndex:(long long)arg1;
- (void)dealloc;
...
- (void)didEndTransitionFromState:(long long)arg1 pageIndex:(long long)arg2 toState:(long long)arg3 pageIndex:(long long)arg4 successfully:(bool)arg5;
...
- (void)enumerateCustomPageViewControllersUsingBlock:(id /* block */)arg1;
...
- (long long)pageState;
- (struct SBRootFolderPageStateTransitionSnapshot { long long x1; long long x2; unsigned long long x3; double x4; })pageStateTransitionSnapshotForScrollOffset:(double)arg1;
...
- (void)performPageStateTransitionToState:(long long)arg1 pageIndex:(long long)arg2 reason:(id)arg3 animated:(bool)arg4 completionHandler:(id /* block */)arg5;
...
- (void)presentWidgetEditingViewControllerFromViewController:(id)arg1 withAllowedSizeClasses:(id)arg2 allowingNonStackableItems:(bool)arg3;
...
- (void)rootFolderViewWantsIconTintViewControllerPresented:(id)arg1;
...
- (void)setLeadingCustomViewPageHidden:(bool)arg1 atIndex:(unsigned long long)arg2;
...
- (id)showDoneButtonForReason:(id)arg1;
...
- (void)willBeginTransitionToState:(long long)arg1 pageIndex:(long long)arg2 animated:(bool)arg3 interactive:(bool)arg4;
