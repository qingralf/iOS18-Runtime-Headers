...
@interface SBRootFolderView : SBFolderView <SBDockViewDelegate, SBFRemoteBasebandLoggingObserver, _UISettingsKeyObserver> {
    ...
    NSIndexSet * _hiddenLeadingCustomPageIndexes;
    ...
    SBSearchBackdropView * _leadingCustomBackdropView;
    ...
    SBHTouchPassThroughView * _titledButtonsContainerView;
...
@property (nonatomic, copy) NSIndexSet *hiddenLeadingCustomPageIndexes;
...
@property (nonatomic, readonly) SBSearchBackdropView *leadingCustomBackdropView;
...
@property (nonatomic, retain) SBHTouchPassThroughView *titledButtonsContainerView;
...
- (id)hiddenLeadingCustomPageIndexes;
...
- (void)iconTintButtonTriggered:(id)arg1;
- (id)idleTextView;
...
- (void)setHiddenLeadingCustomPageIndexes:(id)arg1;
- (void)setIdleText:(id)arg1;
- (void)setIdleText:(id)arg1 animated:(bool)arg2;
