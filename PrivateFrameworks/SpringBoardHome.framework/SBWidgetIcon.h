...
- (id)initWithCHSWidgetDescriptor:(id)arg1 inDomain:(id)arg2;
- (id)initWithCHSWidgetDescriptors:(id)arg1;
- (id)initWithCHSWidgetDescriptors:(id)arg1 inDomain:(id)arg2;
- (id)initWithCHSWidgetDescriptors:(id)arg1 suggestionSource:(long long)arg2;
- (id)initWithCHSWidgetDescriptors:(id)arg1 suggestionSource:(long long)arg2 inDomain:(id)arg3;
