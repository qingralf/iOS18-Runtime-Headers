...
@interface SBSInCallPresentationConfiguration : NSObject <NSSecureCoding> {
    ...
    bool  _requiresDismissedPresentationmode;
    NSString * _sceneBundleIdentifier;
    bool  _screenSharingPresentation;
    bool  _shouldPreferContinuityDisplayForFullScreenPresentation;
...
@property (nonatomic) bool requiresDismissedPresentationmode;
...
@property (nonatomic) bool shouldPreferContinuityDisplayForFullScreenPresentation;
...
- (void)setRequiresDismissedPresentationmode:(bool)arg1;
- (void)setScreenSharingPresentation:(bool)arg1;
- (void)setShouldPreferContinuityDisplayForFullScreenPresentation:(bool)arg1;
