...
@interface SBSUIInCallWindowScene : UIWindowScene {
    ...
    bool  _prefersLockedIdleDurationOnCoversheet;
...
@property (nonatomic) bool prefersLockedIdleDurationOnCoversheet;
...
- (void)setPrefersLockedIdleDurationOnCoversheet:(bool)arg1;
