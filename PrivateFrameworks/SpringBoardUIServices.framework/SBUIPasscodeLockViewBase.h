...
@interface SBUIPasscodeLockViewBase : UIView <SBFLegibilitySettingsProviderDelegate, SBUIBiometricResourceObserver, SBUIPasscodeBiometricAuthenticationViewDelegate, SBUIPasscodeBiometricAuthenticationViewLayoutDelegate, SBUIPasscodeLockView, SBUIPasscodeLockView_Internal, SBUIPhoneUnlockWithWatchControllerObserver, SBUIPoseidonContainerViewControllerLockStatusProvider, SBUIProudLockContainerViewControllerLockStatusProvider> {
    ...
    bool  _alwaysShowPasscodeButtonForFaceIDMatchFailure;
    ...
    bool  _canPeformBiometricAuthentication;
    ...
    <_UIKBFeedbackGenerating> * _keyboardFeedbackBehavior;
    _UILegibilitySettings * _legibilitySettings;
    double  _luminanceBoost;
    bool  _needStatusTextUpdate;
    NSString * _overrideFaceIDReason;
    NSString * _overridePasscodeButtonTitle;
...
@property (nonatomic) double backgroundAlpha; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) bool canPeformBiometricAuthentication;
...
@property (nonatomic, retain) <_UIKBFeedbackGenerating> *keyboardFeedbackBehavior;
...
@property (nonatomic, copy) NSString *overridePasscodeButtonTitle;
...
@property (nonatomic) struct { bool x1; bool x2; double x3; bool x4; double x5; double x6; double x7; double x8; double x9; bool x10; bool x11; bool x12; unsigned long long x13; } proudLockConfiguration;
...
- (bool)_statusStateShouldNotUpdateForUnsupportedGlassesFeedback:(unsigned long long)arg1;
...
- (id)overridePasscodeButtonTitle;
...
- (struct { bool x1; bool x2; double x3; bool x4; double x5; double x6; double x7; double x8; double x9; bool x10; bool x11; bool x12; unsigned long long x13; })proudLockConfiguration;
...
- (void)setOverridePasscodeButtonTitle:(id)arg1;
...
- (void)setProudLockConfiguration:(struct { bool x1; bool x2; double x3; bool x4; double x5; double x6; double x7; double x8; double x9; bool x10; bool x11; bool x12; unsigned long long x13; })arg1;
