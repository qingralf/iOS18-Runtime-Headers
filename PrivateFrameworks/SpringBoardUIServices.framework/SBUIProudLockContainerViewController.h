...
@interface SBUIProudLockContainerViewController : UIViewController <SBUIProudLockContainerViewControllerOrientationProvider> {
    ...
    bool  _suppressAlongsideCoaching;
...
@property (nonatomic) struct { bool x1; bool x2; double x3; bool x4; double x5; double x6; double x7; double x8; double x9; bool x10; bool x11; bool x12; unsigned long long x13; } configuration;
...
- (void)_allowCameraCoveredForUnlockSource:(int)arg1;
...
- (struct { bool x1; bool x2; double x3; bool x4; double x5; double x6; double x7; double x8; double x9; bool x10; bool x11; bool x12; unsigned long long x13; })configuration;
- (id)delegate;
...
- (void)overrideProudLockIconViewLayoutWithSize:(struct CGSize { double x1; double x2; })arg1 offset:(struct CGPoint { double x1; double x2; })arg2 extent:(double)arg3;
...
- (void)setConfiguration:(struct { bool x1; bool x2; double x3; bool x4; double x5; double x6; double x7; double x8; double x9; bool x10; bool x11; bool x12; unsigned long long x13; })arg1;
...
- (void)setSuppressAlongsideCoaching:(bool)arg1;
