...
@interface SBUISystemApertureElementSource : NSObject <SBUISystemApertureHostedElementContext, UIGestureRecognizerDelegate, _UISceneComponentProviding, _UISceneSettingsDiffAction> {
    ...
    NSMutableArray * _alertingAssertionsAwaitingActions;
...
@property (nonatomic, readonly) NSMutableArray *alertingAssertionsAwaitingActions;
...
@property (nonatomic, readonly) NSSet *openSources;
...
- (id)alertingAssertionsAwaitingActions;
