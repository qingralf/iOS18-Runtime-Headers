...
@interface _SBUIBiometricKitInterface : NSObject <BKDevicePearlDelegate, BKMatchOperationDelegate, BKMatchPearlOperationDelegate, BKOperationDelegate> {
...
- (unsigned long long)_matchOperationTriggerForWakeSource:(unsigned long long)arg1;
