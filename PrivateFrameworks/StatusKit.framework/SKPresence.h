...
@interface SKPresence : NSObject <HMDSKPresence, SKPresenceConnectionDelegateProtocol, SKPresenceDaemonDelegateProtocol> {
...
- (bool)hasAssertion;
- (void)hasInitialCloudKitImportOccurredWithCompletion:(id /* block */)arg1;
...
- (void)initialCloudKitImportReceivedWithCompletion:(id /* block */)arg1;
