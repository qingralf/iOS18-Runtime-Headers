...
@interface ChannelActivityActivationResponse : PBCodable <NSCopying> {
    unsigned long long  _activationExpirySeconds;
    struct { 
...
- (unsigned long long)activationExpirySeconds;
...
- (void)setActivationExpirySeconds:(unsigned long long)arg1;
- (void)setHasActivationExpirySeconds:(bool)arg1;
