...
- (void)_getStatusJWTTokenWithCompletion:(id /* block */)arg1;
- (id)accountProvider;
...
- (void)publishProvisionPayloads:(id)arg1 onChannel:(id)arg2 withChannelToken:(id)arg3 publishInitiateTime:(id)arg4 retryCount:(unsigned long long)arg5 completion:(id /* block */)arg6;
- (id)pushManager;
- (void)pushManager:(id)arg1 didReceiveData:(id)arg2 onChannel:(id)arg3 identifier:(unsigned long long)arg4 dateReceived:(id)arg5 dateExpired:(id)arg6;
