...
@property (nonatomic) struct os_unfair_lock_s { unsigned int x1; } presenceSubscriptionsLock;
@property (nonatomic, retain) <SKAPushManaging> *pushManager;
@property (readonly) Class superclass;
@property (nonatomic) struct os_unfair_lock_s { unsigned int x1; } transientSubscriptionsLock;
...
- (struct os_unfair_lock_s { unsigned int x1; })presenceSubscriptionsLock;
- (id)pushManager;
...
- (void)setPresenceSubscriptionsLock:(struct os_unfair_lock_s { unsigned int x1; })arg1;
- (void)setPushManager:(id)arg1;
- (void)setTransientSubscriptionsLock:(struct os_unfair_lock_s { unsigned int x1; })arg1;
- (struct os_unfair_lock_s { unsigned int x1; })transientSubscriptionsLock;
