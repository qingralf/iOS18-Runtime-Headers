...
@interface SCTimedOperationThrottler : NSObject <SCWOperationThrottler, SCWOperationThrottlerDelegate> {
    double  _cooldownTime;
    <SCWOperationThrottlerDelegate> * _delegate;
    SCWOperationThrottler * _operationThrottler;
}

@property double cooldownTime;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (nonatomic) <SCWOperationThrottlerDelegate> *delegate;
@property (readonly, copy) NSString *description;
@property (readonly) unsigned long long hash;
@property (nonatomic, retain) SCWOperationThrottler *operationThrottler;
