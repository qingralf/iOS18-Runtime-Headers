...
@interface SCWDatabaseJSONStore : NSObject <NSFilePresenter, SCWDatabaseStore, SCWDatabaseStoreCoordinator, SCWOperationThrottlerDelegate> {
    NSObject<OS_dispatch_queue> * _accessQueue;
    NSSet * _allowedCommandClasses;
    NSObject<OS_dispatch_source> * _changeListenerSource;
    bool  _cloudBackupEnabled;
    SCWDatabaseSchema * _databaseSchema;
    ...
    <SCWOperationThrottler> * _saveThrottler;
...
@property (nonatomic, retain) NSSet *allowedCommandClasses;
...
@property (nonatomic, retain) SCWDatabaseSchema *databaseSchema;
...
@property (nonatomic, retain) <SCWOperationThrottler> *saveThrottler;
...
- (id)initWithSchema:(id)arg1 fileURL:(id)arg2 allowedCommandClasses:(id)arg3;
- (id)initWithSchema:(id)arg1 parentDirectoryURL:(id)arg2;
- (id)initWithSchema:(id)arg1 parentDirectoryURL:(id)arg2 allowedCommandClasses:(id)arg3;
