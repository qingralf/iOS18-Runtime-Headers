...
- (id)filesystem;
- (id)filesystemType;
- (id)formattableFilesystemWithFilesystem:(id)arg1;
...
- (void)resize:(unsigned long long)arg1 completion:(id /* block */)arg2;
- (id)resizeToSize:(unsigned long long)arg1 completionBlock:(id /* block */)arg2;
- (id)role;
...
- (void)setIsMediaWritable:(bool)arg1;
