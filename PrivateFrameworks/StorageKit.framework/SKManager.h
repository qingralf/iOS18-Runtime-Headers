...
@property (nonatomic, retain) NSObject<OS_dispatch_queue> *frameworkAsyncOperationsQueue;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (nonatomic, copy) NSSet *visibleRoles;

+ (id)BSDNameFromString:(id)arg1;
...
- (id)frameworkAsyncOperationsQueue;
...
- (void)setFrameworkAsyncOperationsQueue:(id)arg1;
