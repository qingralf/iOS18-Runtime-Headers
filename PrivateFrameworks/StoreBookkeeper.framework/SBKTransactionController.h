...
@interface SBKTransactionController : NSObject <SBKTransactionURLOperationDelegate> {
    ...
    MSVTaskAssertion * _backgroundTaskAssertion;
...
@property (nonatomic, retain) SBKStoreAuthenticationController *authenticationController;
@property (nonatomic, retain) MSVTaskAssertion *backgroundTaskAssertion;
...
@property (nonatomic) <SBKTransactionControllerDelegate> *delegate;
...
@property (nonatomic) id networkTypeObserver;
