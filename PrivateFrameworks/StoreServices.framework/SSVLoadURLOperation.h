...
@property (nonatomic, readonly) NSURLCache *URLCache; /* unknown property attribute: ? */
@property (nonatomic, readonly) NSString *URLCacheID; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) bool isURLBagRequest; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) NSData *rawResponseData; /* unknown property attribute: ? */
@property bool recordsMetrics;
@property (copy) NSString *referrerApplicationName;
@property (copy) NSString *referrerURLString;
@property (nonatomic, readonly) SSURLRequestProperties *requestProperties; /* unknown property attribute: ? */
@property (nonatomic, readonly) bool shouldDisableCellular; /* unknown property attribute: ? */
@property (nonatomic, readonly) bool shouldRequireCellular; /* unknown property attribute: ? */
@property (nonatomic, readonly) bool shouldSetCookies; /* unknown property attribute: ? */
@property bool shouldSuppressCookies;
@property bool shouldSuppressUserInfo;
@property (nonatomic, readonly) NSData *sourceAppAuditTokenData; /* unknown property attribute: ? */
@property (nonatomic, readonly) NSString *sourceAppBundleID; /* unknown property attribute: ? */
