...
@interface SZExtractor : NSObject <HMSoftwareUpdateDocumentationAssetExtractor, NSCopying, SZExtractor> {
    NSError * _error;
...
@property (nonatomic, readonly) bool doesConsumeExtractedData; /* unknown property attribute: ? */
@property (nonatomic, retain) NSError *error;
@property (nonatomic, copy) NSString *extractionPath;
@property (nonatomic) <HMSoftwareUpdateDocumentationAssetExtractorDelegate> *extractorDelegate;
...
+ (int)servicePIDWithError:(id*)arg1;
...
+ (id)optionsForArchiveURL:(id)arg1 digest:(id)arg2 fileManager:(id)arg3;
