...
@property (nonatomic, readonly) unsigned int ivarGapForClassHierarchy;
...
- (void)_replaceFieldRecursively:(id)arg1 atOffset:(unsigned int)arg2 withField:(id)arg3;
...
- (unsigned int)ivarGapForClassHierarchy;
- (id)mutableCopy;
