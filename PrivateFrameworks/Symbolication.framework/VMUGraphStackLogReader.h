...
@property (readonly) unsigned long long nodesInUniquingTable; /* unknown property attribute: ? */
...
- (id)initWithTask:(id)arg1 symbolicator:(struct _CSTypeRef { unsigned long long x1; unsigned long long x2; })arg2 graph:(id)arg3 debugTimer:(id)arg4 collectDisklogs:(bool)arg5;
...
- (int)streamFullStackLogsToBlock:(id /* block */)arg1;
