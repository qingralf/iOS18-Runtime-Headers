...
- (void).cxx_destruct;
- (void*)abandoned;
- (unsigned int)abandonedCount;
- (unsigned long long)abandonedSize;
- (unsigned int)allocationsCount;
- (unsigned long long)allocationsSize;
- (void)buildLeakTree;
- (bool)checkAbandoned;
- (bool)checkTaskExistence;
- (void)dealloc;
- (id)debugTimer;
- (unsigned int)detectLeaksWithError:(out id*)arg1;
...
- (unsigned long long)leakedAllocationsSize;
- (id)leakedGraph;
- (void*)leakedNodes;
...
- (void)setAbandonedCount:(unsigned int)arg1;
- (void)setAbandonedSize:(unsigned long long)arg1;
- (void)setAllocationsCount:(unsigned int)arg1;
- (void)setAllocationsSize:(unsigned long long)arg1;
...
- (void)setLeakedAllocationsCount:(unsigned int)arg1;
- (void)setLeakedAllocationsSize:(unsigned long long)arg1;
