...
- (void)addVariantRecursively:(id)arg1 forField:(id)arg2 atOffset:(unsigned int)arg3 withEvaluator:(id /* block */)arg4;
...
- (void)replaceFieldRecursively:(id)arg1 atOffset:(unsigned int)arg2 withField:(id)arg3;
