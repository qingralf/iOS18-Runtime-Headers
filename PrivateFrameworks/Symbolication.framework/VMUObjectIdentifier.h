...
@interface VMUObjectIdentifier : NSObject {
    ...
    struct libSwiftRemoteMirrorWrapper { struct SwiftReflectionInteropContext {} *x1; unsigned long long x2; unsigned long long x3; } * _swiftMirror;
...
@property (nonatomic, readonly) struct libSwiftRemoteMirrorWrapper { struct SwiftReflectionInteropContext {} *x1; unsigned long long x2; unsigned long long x3; }*swiftMirror;
...
- (unsigned long long)countFromPointerInAutoreleasePool:(void*)arg1;
...
- (void)flushRemoteMirrorMemoryCacheEntryForAddress:(unsigned long long)arg1;
...
- (id)labelForOSXPCDictionary:(void*)arg1 length:(unsigned long long)arg2 remoteAddress:(unsigned long long)arg3;
...
- (struct libSwiftRemoteMirrorWrapper { struct SwiftReflectionInteropContext {} *x1; unsigned long long x2; unsigned long long x3; }*)swiftMirror;
...
- (id)symbolForRemoteAddress:(unsigned long long)arg1;
