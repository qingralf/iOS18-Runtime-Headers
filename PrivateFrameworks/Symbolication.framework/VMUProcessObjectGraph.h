...
@interface VMUProcessObjectGraph : VMUObjectGraph <VMUCommonGraphInterface> {
    ...
    bool  _didPhysFootprintDirtyAccounting;
    struct _VMURange { 
    ...
    bool  _hasClassInfosDerivedFromStackBacktraces;
    unsigned int  _idleExitStatus;
    bool  _isTranslatedByRosetta;
...
@property (nonatomic) struct _VMURange { unsigned long long x1; unsigned long long x2; } dyldSharedCacheRange;
...
@property (nonatomic, retain) NSDictionary *ledger;
@property (nonatomic, readonly) unsigned int nodeCount;
@property (nonatomic, readonly) VMUNodeToStringMap *nodeLabels;
...
@property (nonatomic, retain) NSDate *snapshotDate;
...
- (struct { unsigned int x1; unsigned int x2; unsigned int x3; })autoreleasePoolOffsets;
- (id)backtraces;
...
- (struct _VMURange { unsigned long long x1; unsigned long long x2; })dyldSharedCacheRange;
...
- (id)initWithPid:(int)arg1 nodes:(struct _VMUBlockNode { unsigned long long x1; unsigned int x2 : 3; unsigned int x3 : 2; unsigned int x4 : 36; unsigned int x5 : 23; }*)arg2 nodeCount:(unsigned int)arg3 zoneNames:(id)arg4 classInfoMap:(id)arg5 regions:(id)arg6 pthreadOffsets:(id)arg7 userMarked:(void*)arg8 autoreleasePoolOffsets:(struct VMUAutoreleasePoolPageLayout { unsigned int x1; unsigned int x2; unsigned int x3; unsigned long long x4; unsigned int x5; }*)arg9;
- (bool)is64bit;
...
- (struct _CSArchitecture { int x1; int x2; })parseMacOSArchitectureFromProcessDescription;
...
- (void)setDidPhysFootprintDirtyAccounting:(bool)arg1;
- (void)setDyldSharedCacheRange:(struct _VMURange { unsigned long long x1; unsigned long long x2; })arg1;
- (void)setIdleExitStatus:(unsigned int)arg1;
- (void)setIsTranslatedByRosetta:(bool)arg1;
- (void)setLabel:(id)arg1 forNode:(unsigned int)arg2;
- (void)setLedger:(id)arg1;
...
- (void)setSerializationOptions:(unsigned long long)arg1;
- (void)setShowRawClassNames:(bool)arg1;
- (void)setShowsPhysFootprint:(bool)arg1;
- (void)setSnapshotDate:(id)arg1;
