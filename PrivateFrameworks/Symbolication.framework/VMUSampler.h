...
- (int)pid;
- (void)preloadSymbols;
- (unsigned long long)recordSampleTo:(id)arg1 timestamp:(unsigned long long)arg2 thread:(unsigned int)arg3 recordFramePointers:(bool)arg4 clearMemoryCache:(bool)arg5;
...
- (void)setSymbolicator:(struct _CSTypeRef { unsigned long long x1; unsigned long long x2; })arg1;
