...
@property (nonatomic, readonly) VMUMutableClassInfo *sideTableLayoutWithScannableOwnerPointer;
@property (nonatomic, readonly) VMUMutableClassInfo *sideTableLayoutWithUnscannableOwnerPointer;
...
- (void).cxx_destruct;
- (id)initWithSwiftCore:(struct _CSTypeRef { unsigned long long x1; unsigned long long x2; })arg1 memoryReader:(id /* block */)arg2 task:(id)arg3;
