...
- (void)setVMRegionDataExtra:(struct _VMUVMRegionDataExtra { unsigned long long x1; unsigned long long x2; }*)arg1;
- (void)setVMRegionExclaveFlagsData:(struct _VMUVMRegionExclaveFlagsData { unsigned int x1; }*)arg1;
- (id)splitOutRange:(struct _VMURange { unsigned long long x1; unsigned long long x2; })arg1 fromRegionIndex:(unsigned long long)arg2 regions:(id)arg3 newZoneName:(id)arg4 reason:(id)arg5;
- (id)type;
