...
@interface VMUVMRegionIdentifier : NSObject {
    ...
    bool  _recordedPhysFootprint;
    NSMutableArray * _regions;
    VMUTask * _task;
    VMUTaskThreadStates * _threadStates;
}

@property (nonatomic, readonly) bool didPhysFootprintDirtyAccounting;
@property (nonatomic, readonly) NSDictionary *ledger;
@property (nonatomic, readonly) bool recordedPhysFootprint;
...
- (id)descriptionForMallocZoneTotals:(unsigned long long)arg1;
- (id)descriptionForMallocZoneTotals:(unsigned long long)arg1 memorySizeDivisor:(unsigned int)arg2;
...
- (id)descriptionForRegionTotals:(unsigned long long)arg1;
- (id)descriptionForRegionTotals:(unsigned long long)arg1 memorySizeDivisor:(unsigned int)arg2;
