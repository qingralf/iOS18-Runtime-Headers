...
- (id)buildDiagnosticIncidentEventForCaseSignature:(id)arg1 handledResult:(unsigned long long)arg2 dampeningResult:(unsigned long long)arg3 closureType:(unsigned long long)arg4;
...
- (int)checkSignatureValidity:(id)arg1;
- (void)commonPreflightChecksForSignature:(id)arg1 payload:(id)arg2 callback:(id /* block */)arg3;
- (void)dealloc;
- (id)delegate;
...
- (void)parseCaseTriggerResponse:(id)arg1;
...
- (void)submitDiagnosticIncidentEventForCaseSignature:(id)arg1 handledResult:(unsigned long long)arg2 dampeningResult:(unsigned long long)arg3 closureType:(unsigned long long)arg4;
