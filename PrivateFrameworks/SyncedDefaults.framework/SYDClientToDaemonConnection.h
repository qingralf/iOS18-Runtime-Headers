...
+ (void)synchronizeStoresWithIdentifiers:(id)arg1 type:(long long)arg2 testConfiguration:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (bool)getObject:(id*)arg1 forKey:(id)arg2 error:(id*)arg3;
...
- (void)storeDidChangeWithStoreID:(id)arg1 changeDictionary:(id)arg2;
- (id)storeIdentifier;
- (long long)storeType;
