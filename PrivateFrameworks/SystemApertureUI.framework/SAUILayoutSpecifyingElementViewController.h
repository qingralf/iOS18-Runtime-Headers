...
@property (nonatomic, readonly) <SAUILayoutModePreferring> *layoutModePreference; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) SAUIPreferredLayoutModeAssertion *preferredLayoutModeAssertion; /* unknown property attribute: ? */
@property (nonatomic, readonly, copy) NSArray *preferredLayoutModeAssertions; /* unknown property attribute: ? */
...
- (void).cxx_destruct;
- (id)_alertingActivityAssertionWithReason:(id)arg1 implicitlyDismissable:(bool)arg2 withPreferredLayoutMode:(long long)arg3;
...
- (id)alertAssertion;
- (id)alertWithReason:(id)arg1 implicitlyDismissable:(bool)arg2;
...
- (long long)handleElementLongPress:(id)arg1;
