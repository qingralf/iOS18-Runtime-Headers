...
@interface STDynamicAttributionXPCServerHandle : NSObject <STDynamicActivityAttributionServerHandle, STDynamicAttributionXPCClientProtocol, STServerLaunchObserver> {
