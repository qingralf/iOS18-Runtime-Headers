...
@interface STStatusItemsStatusDomainDataDiff : NSObject <BSDebugDescriptionProviding, STStatusDomainDataDiff> {
    BSSettings * _changes;
    STListDataDiff * _statusItemsAttributionListDataDiff;
...
- (id)init;
- (id)initWithChanges:(id)arg1 statusItemsAttributionListDataDiff:(id)arg2 visualDescriptorsByIdentifierDictionaryDataDiff:(id)arg3;
