...
@interface STStatusServer : NSObject <STStatusDomainPublisherServerHandle, STStatusDomainServerHandle> {
    <STStatusServerDelegate> * _delegate;
    STLocalStatusServer * _localStatusServer;
    <STStatusDomainPublisherServerHandle> * _publisherServerHandle;
