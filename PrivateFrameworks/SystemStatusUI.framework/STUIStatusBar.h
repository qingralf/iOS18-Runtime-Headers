...
@interface STUIStatusBar : UIView <BSDebugDescriptionProviding, STUIStatusBarDataBroadcasterListener, UIAccessibilityHUDGestureDelegate, UIGestureRecognizerDelegate, UIPointerInteractionDelegate> {
    ...
    long long  _automaticStyle;
    NSDictionary * _automaticStyleOutliers;
    struct CGRect { 
        struct CGPoint { 
            double x; 
            double y; 
    ...
    STMutableStatusBarData * _currentAggregatedData;
    STMutableStatusBarData * _currentData;
    STUIStatusBarDataAggregator * _dataAggregator;
    NSArray * _disabledPartIdentifiers;
    NSMutableDictionary * _displayItemStates;
    NSArray * _enabledPartIdentifiers;
    UIColor * _foregroundColor;
    UIView * _foregroundView;
    <STUIStatusBarActionable> * _hoveredActionable;
    ...
    struct { 
        ...
        unsigned int visualProviderImplementsUpdateLumaTracking : 1; 
        unsigned int visualProviderImplementsShowSensorActivityIndicatorWithoutPortalView : 1; 
        unsigned int updatingStates : 1; 
        unsigned int forcingIterativeOverflow : 1; 
        unsigned int alwaysAutomaticStyle : 1; 
        unsigned int statusBarHidden : 1; 
    }  _statusBarFlags;
    long long  _style;
    STUIStatusBarStyleAttributes * _styleAttributes;
    <STUIStatusBarActionable> * _targetActionable;
    UIScreen * _targetScreen;
    id /* block */  _updateCompletionHandler;
    <STUIStatusBarVisualProvider> * _visualProvider;
...
@property (nonatomic, retain) NSDictionary *automaticStyleOutliers;
...
@property (nonatomic, readonly) STUIStatusBarDataAggregator *dataAggregator;
...
@property (nonatomic) <STUIStatusBarActionable> *hoveredActionable;
...
@property (getter=_showSensorActivityIndicatorWithoutPortalView, nonatomic, readonly) bool showSensorActivityIndicatorWithoutPortalView;
@property (nonatomic) long long style;
@property (nonatomic, retain) STUIStatusBarStyleAttributes *styleAttributes;
@property (readonly) Class superclass;
@property (nonatomic) <STUIStatusBarActionable> *targetActionable;
@property (nonatomic, retain) UIScreen *targetScreen;
@property (nonatomic, copy) id /* block */ updateCompletionHandler;
@property (getter=_useAutomaticStyle, nonatomic, readonly) bool useAutomaticStyle;
@property (nonatomic, readonly) <STUIStatusBarVisualProvider> *visualProvider;
...
- (id)_expandedDescriptionBuilderWithMultilinePrefix:(id)arg1;
...
- (void)_setAutomaticStyle:(long long)arg1 additionalStylesForRegionIdentifiers:(id)arg2;
...
- (long long)automaticStyle;
- (id)automaticStyleOutliers;
...
- (void)setAutomaticStyle:(long long)arg1;
- (void)setAutomaticStyleOutliers:(id)arg1;
...
- (void)updateForDataChange:(id)arg1;
