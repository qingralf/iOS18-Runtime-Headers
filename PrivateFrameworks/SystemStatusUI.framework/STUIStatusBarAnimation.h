...
@interface STUIStatusBarAnimation : NSObject <BSDebugDescriptionProviding, NSCopying, STUIStatusBarPrioritized> {
    ...
    STUIStatusBarIdentifier * _displayItemIdentifier;
    bool  _enabled;
    NSString * _exclusivityGroupIdentifier;
    NSString * _identifier;
    STUIStatusBarAnimation * _parentAnimation;
...
@property (nonatomic, copy) STUIStatusBarIdentifier *displayItemIdentifier;
...
@property (nonatomic) STUIStatusBarAnimation *parentAnimation;
...
- (void)addTimeout:(double)arg1 withHandler:(id /* block */)arg2;
