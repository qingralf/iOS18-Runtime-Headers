...
@interface STUIStatusBarRegionAxisSquishyLayout : NSObject <STUIStatusBarRegionAxisLayout> {
    ...
    bool  _compressItems;
    <STUIStatusBarRegionAxisSquishyLayoutDynamicHidingDelegate> * _dynamicHidingDelegate;
    NSSet * _dynamicallyHiddenIdentifiers;
    double  _interspace;
...
@property (nonatomic) <STUIStatusBarRegionAxisSquishyLayoutDynamicHidingDelegate> *dynamicHidingDelegate;
@property (nonatomic, retain) NSSet *dynamicallyHiddenIdentifiers;
...
- (id)dynamicallyHiddenIdentifiers;
- (id)init;
- (double)interspace;
...
- (void)setDynamicallyHiddenIdentifiers:(id)arg1;
