...
@interface STUIStatusBarVisualProvider_CarPlay : NSObject <STUIStatusBarCellularItemTypeStringProvider, STUIStatusBarPillRegionVisualProvider, STUIStatusBarVisualProvider_Internal> {
