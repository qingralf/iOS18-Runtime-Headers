...
@interface STUIStatusBarVisualProvider_LegacyPhone : STUIStatusBarVisualProvider_Phone <STUIStatusBarCellularItemTypeStringProvider> {
    ...
    STUIStatusBarRegionAxisCenteringLayout * _centerHorizontalLayout;
    NSLayoutConstraint * _centerTopConstraint;
    STUIStatusBarCellularItem * _condensedCellularItem;
    ...
    STUIStatusBarRegionAxisStackingLayout * _leadingHorizontalLayout;
    ...
    STUIStatusBarRegionAxisStackingLayout * _trailingHorizontalLayout;
...
@property (nonatomic, retain) STUIStatusBarRegionAxisCenteringLayout *centerHorizontalLayout;
@property (nonatomic, retain) NSLayoutConstraint *centerTopConstraint;
@property (nonatomic, retain) STUIStatusBarCellularItem *condensedCellularItem;
...
@property (nonatomic, retain) STUIStatusBarRegionAxisStackingLayout *leadingHorizontalLayout;
...
@property (nonatomic, retain) STUIStatusBarRegionAxisStackingLayout *trailingHorizontalLayout;
