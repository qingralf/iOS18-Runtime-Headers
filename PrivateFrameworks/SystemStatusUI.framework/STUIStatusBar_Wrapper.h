...
@interface STUIStatusBar_Wrapper : UIStatusBar_Base <STBackgroundActivityManagerClient> {
    NSString * _activeBackgroundActivity;
    NSSet * _backgroundActivities;
    long long  _requestedResolvedStyle;
    STUIStatusBar * _statusBar;
}

@property (nonatomic, copy) NSString *activeBackgroundActivity;
@property (nonatomic, copy) NSSet *backgroundActivities;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (readonly, copy) NSString *description;
@property (readonly) unsigned long long hash;
@property (getter=_requestedResolvedStyle, setter=_setRequestedResolvedStyle:, nonatomic) long long requestedResolvedStyle;
@property (nonatomic, retain) STUIStatusBar *statusBar;
...
- (id)_effectiveDataFromData:(id)arg1 activeOverride:(unsigned long long)arg2 activeBackgroundActivity:(id)arg3 canUpdateBackgroundActivity:(bool)arg4;
- (long long)_effectiveStyleFromStyle:(long long)arg1;
- (void)_getStyle:(long long*)arg1 andActiveOverride:(unsigned long long*)arg2 andActiveBackgroundActivity:(id*)arg3 forRequestedStyle:(long long)arg4 updatingBackgroundActivity:(bool)arg5;
...
- (long long)_requestedResolvedStyle;
- (void)_setRequestedResolvedStyle:(long long)arg1;
...
- (void)setActiveBackgroundActivity:(id)arg1;
...
- (void)setBackgroundActivities:(id)arg1;
