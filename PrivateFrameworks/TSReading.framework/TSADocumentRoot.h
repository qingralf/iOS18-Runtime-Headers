...
@property (nonatomic, readonly) bool importingDesignDemoDoc; /* unknown property attribute: ? */
@property (nonatomic, readonly) bool isBrowsingVersions; /* unknown property attribute: ? */
