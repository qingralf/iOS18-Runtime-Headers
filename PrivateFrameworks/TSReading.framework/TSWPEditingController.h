...
@property (nonatomic, readonly) NSSet *selectedObjectsSupportingConnectionLineAttributes; /* unknown property attribute: ? */
@property (nonatomic, readonly) NSSet *selectedObjectsSupportingEndpoints; /* unknown property attribute: ? */
@property (nonatomic, readonly) NSSet *selectedObjectsSupportingFill; /* unknown property attribute: ? */
@property (nonatomic, readonly) NSSet *selectedObjectsSupportingOpacity; /* unknown property attribute: ? */
@property (nonatomic, readonly) NSSet *selectedObjectsSupportingReflection; /* unknown property attribute: ? */
@property (nonatomic, readonly) NSSet *selectedObjectsSupportingResize; /* unknown property attribute: ? */
@property (nonatomic, readonly) NSSet *selectedObjectsSupportingShadow; /* unknown property attribute: ? */
@property (nonatomic, readonly) NSSet *selectedObjectsSupportingShrinkTextToFit; /* unknown property attribute: ? */
@property (nonatomic, readonly) NSSet *selectedObjectsSupportingSmartShapeAttributes; /* unknown property attribute: ? */
@property (nonatomic, readonly) NSSet *selectedObjectsSupportingStroke; /* unknown property attribute: ? */
@property (nonatomic, readonly) NSSet *selectedObjectsSupportingTextInset; /* unknown property attribute: ? */
@property (nonatomic, retain) TSWPSelection *selection;
@property (nonatomic, retain) TSKSelection<TSDTextSelection> *selectionForArrowKeys; /* unknown property attribute: ? */
...
@property (readonly) bool wantsRawArrowKeyEvents; /* unknown property attribute: ? */
...
- (void)addAllDictationInterpretationRangesInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 toRanges:(void*)arg2;
...
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })p_expandParagraphRangeForEnumerator:(struct TSWPParagraphEnumerator { id x1; id x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; unsigned long long x6; bool x7; }*)arg1;
...
- (const void*)p_lastVisibleLineFragmentForCharIndex:(unsigned long long)arg1 eol:(bool)arg2;
...
- (const void*)p_lineFragmentForCharIndex:(unsigned long long)arg1 column:(id*)arg2 eol:(bool)arg3;
- (const void*)p_lineFragmentWithCaretInfo:(struct { unsigned long long x1; bool x2; bool x3; int x4; unsigned long long x5; bool x6; int x7; unsigned long long x8; bool x9; int x10; }*)arg1 forSelection:(id)arg2;
