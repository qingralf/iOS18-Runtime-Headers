...
@interface TVApplicationController : NSObject <AMSUIDynamicViewControllerDelegate, IKAppContextDelegate, IKAppContextDelegatePrivate, IKAppContextInspectorDelegate, IKAppDeviceConfig, _TVAppNavigationControllerDelegate> {
...
@property (nonatomic, copy) id /* block */ dynamicUICompletion;
...
- (void)_openURLControllerDidUpdate:(id)arg1;
- (void)_openURLControllerHandler:(bool)arg1;
- (void)_openURLIfPossibleWithOptions:(id)arg1;
...
- (void)_rootControllerDidDisplay:(id)arg1;
...
- (void)appContext:(id)arg1 openDynamicUIURL:(id)arg2 metricsOverlay:(id)arg3 completion:(id /* block */)arg4;
- (void)appContext:(id)arg1 openMarketingItem:(id)arg2 metricsOverlay:(id)arg3 completion:(id /* block */)arg4;
...
- (void)setDynamicUICompletion:(id /* block */)arg1;
