...
@interface _TVSearchTemplateController : _TVBgImageLoadingViewController <IKAppKeyboardDelegate, TVAppTemplateImpressionable, UISearchBarDelegate, UISearchResultsUpdating, _TVStackCollectionViewControllerDelegate, _UISearchControllerDelegatePrivate> {
