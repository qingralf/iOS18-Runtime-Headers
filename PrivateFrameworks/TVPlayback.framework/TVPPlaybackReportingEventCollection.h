...
@property (nonatomic, readonly) NSDictionary *startupEventsDict;
...
- (void)_addStartupEventWithName:(id)arg1 timestamp:(double)arg2 durationMS:(id)arg3 toDictionary:(id)arg4;
