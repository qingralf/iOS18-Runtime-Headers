...
@interface TVPPlayer : NSObject <AVPlayerItemDelegate, AVPlayerItemMetadataCollectorPushDelegate, AVPlayerPlaybackCoordinatorDelegate, TVPAVFPlayback> {
    ...
    NSObject<OS_dispatch_queue> * _avAssetTrackInspectionQueue;
    ...
    bool  _haveEverEnqueuedPlayerItem;
    ...
    bool  _prefersAudioDescriptions;
    ...
    NSString * _reportingCategory;
    NSMutableDictionary * _reportingValues;
    bool  _respondsToRemoteControlEvents;
    ...
    id  _timeJumpPeriodicObserverToken;
    ...
    bool  _wasMutedPriorToScreenRecording;
}
...
@property (nonatomic, retain) NSObject<OS_dispatch_queue> *avAssetTrackInspectionQueue;
...
@property (nonatomic) struct { long long x1; int x2; unsigned int x3; long long x4; } cachedElapsedCMTime;
...
@property (nonatomic) struct CGSize { double x1; double x2; } preferredMaximumResolutionForExpensiveNetworks;
...
@property (nonatomic, retain) NSMutableDictionary *reportingValues;
...
@property (nonatomic, retain) id timeJumpPeriodicObserverToken;
...
+ (long long)_audioFormatForFormatDescription:(struct opaqueCMFormatDescription { }*)arg1;
+ (id)_audioSelectionCriteriaForPreferredAudioLanguageCodes:(id)arg1 mediaItemLoader:(id)arg2 prefersAudioDescriptions:(bool)arg3;
...
+ (void)_updateAudioSelectionCriteriaForAVQueuePlayer:(id)arg1 mediaItemLoader:(id)arg2 preferredAudioLanguageCodes:(id)arg3 prefersAudioDescriptions:(bool)arg4;
...
- (id)_assetTracksOfType:(id)arg1 fromTracks:(id)arg2;
- (void)_audioRouteChanged:(id)arg1;
- (void)_avPlayerRateDidChange:(id)arg1;
...
- (void)_currentPlayerItemReachedTimeToPauseBuffering:(id)arg1;
- (void)_currentPlayerItemReachedTimeToPausePlayback:(id)arg1;
...
- (void)_outputObscuredDidChangeTo:(bool)arg1;
...
- (void)_screenRecordingStateDidChange:(id)arg1;
...
- (void)_timeControlStatusDidChangeTo:(long long)arg1 oldStatusNum:(id)arg2;
- (void)_updateAVPlayerActionAtItemEnd;
- (void)_updateCurrentMediaItemAudioInfoForPlayerItem:(id)arg1 tracks:(id)arg2;
- (void)_updateCurrentMediaItemVideoRangeForTracks:(id)arg1;
...
- (void)endCoordinatedPlaybackSuspension:(id)arg1;
...
- (void)playWithVolumeRampDuration:(double)arg1;
...
- (id)playbackErrorFromError:(id)arg1 forMediaItem:(id)arg2;
- (void)playerDidHitBeginningOrEnd;
- (bool)playerItem:(id)arg1 shouldSeekToTime:(struct { long long x1; int x2; unsigned int x3; long long x4; }*)arg2 toleranceBefore:(struct { long long x1; int x2; unsigned int x3; long long x4; }*)arg3 toleranceAfter:(struct { long long x1; int x2; unsigned int x3; long long x4; }*)arg4;
...
- (void)setAvAssetTrackInspectionQueue:(id)arg1;
...
- (void)setCachedElapsedCMTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg1;
...
- (void)setHaveEverEnqueuedPlayerItem:(bool)arg1;
...
- (void)setPrefersAudioDescriptions:(bool)arg1;
...
- (void)setReportingValueWithNumber:(id)arg1 forKey:(id)arg2;
- (void)setReportingValueWithString:(id)arg1 forKey:(id)arg2;
- (void)setReportingValues:(id)arg1;
...
- (void)setTimeJumpPeriodicObserverToken:(id)arg1;
...
- (void)setWasMutedPriorToScreenRecording:(bool)arg1;
