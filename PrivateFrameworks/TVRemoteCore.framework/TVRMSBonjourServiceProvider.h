...
@interface TVRMSBonjourServiceProvider : NSObject <NSNetServiceBrowserDelegate, NSNetServiceDelegate, TVRMSServiceProvider> {
    NSMutableDictionary * _cache;
    <TVRMSServiceProviderDelegate> * _delegate;
    NSNetServiceBrowser * _netServiceBrowser;
    NSMutableDictionary * _services;
}

@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (nonatomic) <TVRMSServiceProviderDelegate> *delegate;
