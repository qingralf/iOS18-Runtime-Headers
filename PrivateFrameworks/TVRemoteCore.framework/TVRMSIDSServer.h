...
@interface TVRMSIDSServer : NSObject <IDSServiceDelegate, TVRMSDAAPControlSessionDelegate, TVRMSDiscoverySessionDelegate, TVRMSPairingSessionDelegate, TVRMSSessionManagerDelegate> {
