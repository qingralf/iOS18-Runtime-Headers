...
- (id)initWithType:(long long)arg1 hasTapAction:(bool)arg2 buttonLocation:(long long)arg3;
- (bool)isHighlightEffectDisabled;
- (void)layoutSubviews;
- (id)pointerInteraction:(id)arg1 regionForRequest:(id)arg2 defaultRegion:(id)arg3;
- (id)pointerInteraction:(id)arg1 styleForRegion:(id)arg2;
- (void)setButtonContentView:(id)arg1;
- (void)setButtonLocation:(long long)arg1;
