...
- (id)_symbolImageForMiniPlayerNamed:(id)arg1 buttonType:(long long)arg2;
...
- (id)captionsButtonIcon:(bool)arg1;
...
- (id)iconForButtonType:(long long)arg1 buttonLocation:(long long)arg2;
...
- (id)separatorView;
- (id)symbolImageForButtonPanelNamed:(id)arg1;
