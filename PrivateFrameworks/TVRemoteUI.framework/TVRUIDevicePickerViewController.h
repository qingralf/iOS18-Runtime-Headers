...
@interface TVRUIDevicePickerViewController : UIViewController <TVRUIRemoteDeviceObserving, TVRUIRemoteViewProvider, TVRUITipSourceViewProvider, UITableViewDataSource, UITableViewDelegate> {
    double  _baseHeight;
    <_TVRUIEventDelegate> * _buttonEventDelegate;
    NSArray * _buttons;
    NSIndexPath * _connectedDeviceIndex;
    bool  _contextMenuNeedsUpdate;
    ...
    <TVRUIMenuProvider> * _menuProvider;
    TVRUIButton * _muteButton;
    UIButton * _muteButtonOverride;
    ...
    _TVRUITableViewWrapperView * _tableViewWrapper;
...
@property (nonatomic) bool contextMenuNeedsUpdate;
...
@property (nonatomic) <TVRUIMenuProvider> *menuProvider;
@property (nonatomic, retain) TVRUIButton *muteButton;
@property (nonatomic, retain) UIButton *muteButtonOverride;
...
@property (nonatomic, retain) _TVRUITableViewWrapperView *tableViewWrapper;
...
- (void)_titleWasLongPressed:(id)arg1;
- (void)_toggleState;
- (void)_updateButtonsShapes;
- (void)_updateDevice;
- (void)_updateDeviceNameAutomationIdentifier:(id)arg1;
...
- (void)setContextMenuNeedsUpdate:(bool)arg1;
...
- (void)setMuteButtonOverride:(id)arg1;
