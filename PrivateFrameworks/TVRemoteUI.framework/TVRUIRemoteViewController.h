...
@interface TVRUIRemoteViewController : UIViewController <SBSHardwareButtonEventConsuming, TVRAlertControllerDelegate, TVRUIContentPresenter, TVRUIDeviceDelegate, TVRUIDevicePickerDelegate, TVRUIDeviceSearchDelegate, TVRUITouchpadDelegate, _TVRUIEventDelegate> {
    ...
    TVRUIFindingSession * _findingSession;
    ...
    TVRUINowPlayingController * _nowPlayingController;
    ...
    TVRUIVolumeController * _volumeController;
...
@property (nonatomic, retain) NSArray *deviceObservers;
...
@property (nonatomic, retain) TVRUIFindingSession *findingSession;
...
@property (nonatomic, retain) TVRUINowPlayingController *nowPlayingController;
...
@property (nonatomic, retain) TVRUIVolumeController *volumeController;
...
- (void)_disconnectUserInitiatedAndModifyLockscreenAssertion:(bool)arg1;
- (void)_enableLiveTVButtons:(bool)arg1 animated:(bool)arg2;
- (void)_enableMediaControls:(bool)arg1 animated:(bool)arg2;
- (void)_enableSearch;
- (void)_enableTVRemoteOnLockscreen:(bool)arg1;
...
- (void)devicePickerTitleWasLongPressedForDevice:(id)arg1;
...
- (void)setDeviceObservers:(id)arg1;
...
- (void)setFindingSession:(id)arg1;
...
- (void)wifiStateDidUpdate:(long long)arg1;
