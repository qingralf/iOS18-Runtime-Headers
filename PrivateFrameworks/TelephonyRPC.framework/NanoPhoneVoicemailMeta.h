...
@interface NanoPhoneVoicemailMeta : PBCodable <NSCopying, SYObject> {
    ...
    NSString * _nphReceiverISOCountryCode;
...
@property (nonatomic, readonly) bool hasNphReceiverISOCountryCode;
...
@property (nonatomic, retain) NSString *nphReceiverISOCountryCode;
...
- (void)setNphReceiverISOCountryCode:(id)arg1;
