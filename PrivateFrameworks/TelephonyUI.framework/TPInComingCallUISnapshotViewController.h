...
@property (nonatomic, retain) UIImage *customAvatar;
...
- (id)initWithConfiguration:(id)arg1 style:(long long)arg2 contact:(id)arg3 avatarImage:(id)arg4;
...
- (id)initWithConfiguration:(id)arg1 style:(long long)arg2 nameString:(id)arg3 avatarImage:(id)arg4;
- (id)messageButton;
- (id)mobileLabel;
