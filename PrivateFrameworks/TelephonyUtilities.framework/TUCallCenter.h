...
@interface TUCallCenter : NSObject <TUBargeCallContainer, TUCallContainer> {
    ...
    id /* block */  _isOnenessActiveBlock;
...
@property (nonatomic, readonly) TUDelegateController<TUCallCenterDelegate> *delegateController;
...
@property (nonatomic, copy) id /* block */ isOnenessActiveBlock;
...
- (void)setIsOnenessActiveBlock:(id /* block */)arg1;
