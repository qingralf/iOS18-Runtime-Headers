...
@interface TUCallHistoryController : NSObject <TUCallProviderManagerDelegate> {
    ...
    bool  _shouldUpdateMetadataCache;
...
@property (nonatomic, readonly) bool shouldUpdateMetadataCache;
...
+ (id)callHistoryControllerWithCoalescingStrategy:(unsigned long long)arg1 options:(unsigned long long)arg2 shouldUpdateMetadataCache:(bool)arg3;
+ (id)sharedController;
...
- (id)featureFlags;
- (id)init;
- (id)initWithCoalescingStrategy:(unsigned long long)arg1 options:(unsigned long long)arg2 dataSource:(id)arg3 shouldUpdateMetadataCache:(bool)arg4;
