...
@property (nonatomic, readonly) TUCallProvider *defaultAppProvider;
...
@property (nonatomic, readonly, copy) NSArray *sortedProviders;
...
- (id)joinConversationRequestForRecentCall:(id)arg1;
...
- (id)sortedProviders;
- (id)sortedProvidersPassingTest:(id /* block */)arg1;
- (id)superboxProvider;
