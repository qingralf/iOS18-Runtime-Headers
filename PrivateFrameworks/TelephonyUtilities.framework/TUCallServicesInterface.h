...
- (oneway void)addScreenSharingType:(unsigned long long)arg1 forCallWithUniqueProxyIdentifier:(id)arg2;
...
- (oneway void)handleReceivedCallDTMFUpdate:(id)arg1 forCallWithUniqueProxyIdentifier:(id)arg2;
...
- (id)initWithQueue:(id)arg1 callCenter:(id)arg2 wantsCallNotifications:(bool)arg3;
- (bool)isServerLocal;
...
- (void)performRecordingRequest:(id)arg1 completion:(id /* block */)arg2;
...
- (oneway void)setEmergencyMediaItems:(id)arg1 forCallWithUniqueProxyIdentifier:(id)arg2;
- (oneway void)setHasEmergencyVideoStream:(bool)arg1 forCallWithUniqueProxyIdentifier:(id)arg2;
...
- (oneway void)setLiveVoicemailUnavailableReason:(long long)arg1 forCallWithUniqueProxyIdentifier:(id)arg2;
