...
@property (nonatomic, copy) NSDate *deviceSetupDate;
...
- (id)deviceSetupDate;
- (id)executeBatchFetchRequests:(id)arg1;
...
- (bool)isHandleEligibleForScreenSharingRequests:(id)arg1;
...
- (id)processBatchFetchRequests:(id)arg1;
- (id)resultForSingleHandleFetchRequest:(id)arg1 fetchedContacts:(id)arg2;
- (void)setAppleCareHandles:(id)arg1;
- (void)setDeviceSetupDate:(id)arg1;
...
- (bool)shouldIgnoreHandle:(id)arg1 withFetchRequest:(id)arg2;
