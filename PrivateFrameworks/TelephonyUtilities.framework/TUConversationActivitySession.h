...
@property (getter=isLocalParticipantActive, nonatomic, readonly) bool localParticipantActive;
...
@property (nonatomic, retain) NSArray *persistentSceneIdentifiers;
@property (nonatomic) bool persistentSceneIsEligibleForAutoClose;
...
- (id)initWithActivity:(id)arg1 state:(unsigned long long)arg2 uuid:(id)arg3 endpoint:(id)arg4 locallyInitiated:(bool)arg5 timestamp:(id)arg6 isFirstJoin:(bool)arg7 activeRemoteParticipants:(id)arg8 isLocalParticipantActive:(bool)arg9 applicationState:(unsigned long long)arg10;
...
- (void)setPersistentSceneIdentifiers:(id)arg1;
- (void)setPersistentSceneIsEligibleForAutoClose:(bool)arg1;
