...
- (void)removeConversationLinkDescriptorsWithPredicate:(id)arg1 deleteReason:(long long)arg2 completion:(id /* block */)arg3;
- (unsigned long long)removeConversationLinkDescriptorsWithPredicate:(id)arg1 deleteReason:(long long)arg2 error:(id*)arg3;
- (void)removeLinkDescriptorsFromDataSourceWithPredicate:(id)arg1 completion:(id /* block */)arg2;
- (unsigned long long)removeLinkDescriptorsFromDataSourceWithPredicate:(id)arg1 error:(id*)arg2;
