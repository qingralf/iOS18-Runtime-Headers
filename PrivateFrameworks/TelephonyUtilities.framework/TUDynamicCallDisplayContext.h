...
- (void).cxx_destruct;
- (void)_initializeAsynchronousStateWithCall:(id)arg1 cacheOnly:(bool)arg2;
...
- (id)initWithCall:(id)arg1 contactIdentifier:(id)arg2 serialQueue:(id)arg3 cacheOnly:(bool)arg4;
- (id)initWithCall:(id)arg1 contactIdentifier:(id)arg2 serialQueue:(id)arg3 contactsDataSource:(id)arg4;
- (id)initWithCall:(id)arg1 contactIdentifier:(id)arg2 serialQueue:(id)arg3 contactsDataSource:(id)arg4 cacheOnly:(bool)arg5;
- (id)initWithCoder:(id)arg1;
- (id)initWithDisplayContext:(id)arg1 call:(id)arg2 serialQueue:(id)arg3;
- (id)initWithDisplayContext:(id)arg1 call:(id)arg2 serialQueue:(id)arg3 cacheOnly:(bool)arg4;
- (id)serialQueue;
