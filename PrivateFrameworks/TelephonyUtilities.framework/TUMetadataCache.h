...
- (void).cxx_destruct;
- (void)_updateCacheWithDestinationIDs:(id)arg1 onlyEmptyProviders:(bool)arg2 completion:(id /* block */)arg3;
...
- (void)updateCacheForEmptyDataProvidersWithDestinationIDs:(id)arg1 completion:(id /* block */)arg2;
- (void)updateCacheWithDestinationIDs:(id)arg1;
- (void)updateCacheWithDestinationIDs:(id)arg1 completion:(id /* block */)arg2;
