...
- (void)updateMetadataForCall:(id)arg1 completion:(id /* block */)arg2;
- (void)updateMetadataForDestinationID:(id)arg1;
- (void)updateMetadataForDestinationID:(id)arg1 completion:(id /* block */)arg2;
- (void)updateMetadataForRecentCalls:(id)arg1;
- (void)updateMetadataForRecentCalls:(id)arg1 completion:(id /* block */)arg2;
