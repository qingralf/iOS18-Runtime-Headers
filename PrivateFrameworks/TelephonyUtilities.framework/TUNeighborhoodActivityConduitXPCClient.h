...
- (oneway void)isRingingFaceTimeCallsOnConnectedTVDeviceChanged:(bool)arg1;
- (void)isRingingFaceTimeCallsOnConnectedTVDeviceWithCompletion:(id /* block */)arg1;
...
- (oneway void)splitSessionUpdated:(id)arg1;
