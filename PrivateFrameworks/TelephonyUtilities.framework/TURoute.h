...
@property (getter=isInTipiWithCompanion, nonatomic) bool inTipiWithCompanion;
...
@property (getter=isSmartRoutedTo, nonatomic) bool smartRoutedTo;
...
- (void)setInTipiWithCompanion:(bool)arg1;
...
- (void)setSmartRoutedTo:(bool)arg1;
