...
@interface TUVideoDeviceController : NSObject <TUVideoDeviceControllerProviderDelegate> {
    ...
    id /* block */  _reapplyCameraZoom;
    bool  _retryAfterLocalCameraUIDChange;
...
@property (nonatomic, retain) CALayer *localBackLayerHost;
@property (nonatomic, retain) CALayer *localFrontLayer;
@property (nonatomic, retain) CALayer *localFrontLayerHost;
...
@property (nonatomic, copy) id /* block */ reapplyCameraZoom;
@property (nonatomic) bool retryAfterLocalCameraUIDChange;
...
- (void).cxx_destruct;
- (void)_postIsCinematicFramingAvailable:(bool)arg1;
...
- (id)localBackLayer;
- (id)localBackLayerHost;
- (id)localFrontLayer;
- (id)localFrontLayerHost;
...
- (void)provider:(id)arg1 dockKitTrackingDidChange:(bool)arg2;
...
- (void)setLocalBackLayerHost:(id)arg1;
- (void)setLocalFrontLayer:(id)arg1;
- (void)setLocalFrontLayerHost:(id)arg1;
...
- (void)setReapplyCameraZoom:(id /* block */)arg1;
- (void)setRetryAfterLocalCameraUIDChange:(bool)arg1;
