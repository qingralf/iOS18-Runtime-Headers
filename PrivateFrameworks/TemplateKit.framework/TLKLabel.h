...
@property struct UIEdgeInsets { double x1; double x2; double x3; double x4; } unadjustedCustemAlignmentRectInsets;
@property (nonatomic) bool useButtonColoring;

+ (id)primaryLabel;
+ (id)secondaryLabel;
+ (bool)stringStartsWithQuote:(id)arg1;
+ (id)tertiaryLabel;
...
- (void)setUnadjustedCustemAlignmentRectInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg1;
- (void)setUseButtonColoring:(bool)arg1;
- (bool)supportsColorGlyphs;
- (void)tlk_updateForAppearance:(id)arg1;
- (void)traitCollectionDidChange:(id)arg1;
- (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })unadjustedCustemAlignmentRectInsets;
