...
@property (nonatomic, readonly) struct _NSRange { unsigned long long x1; unsigned long long x2; } truncatedRangeInSelectedText;

// Image: /System/Library/PrivateFrameworks/TextInput.framework/TextInput

+ (id)_selectedTextByDeletingInteriorSentences:(id)arg1 outTruncatedRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; }*)arg2;
...
- (id)initWithUnboundedContextBefore:(id)arg1 markedText:(id)arg2 selectedText:(id)arg3 unboundedContextAfter:(id)arg4 selectedRangeInMarkedText:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg5 truncatedRangeInSelectedText:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg6;
...
- (id)selectedText;
- (id)string;
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })truncatedRangeInSelectedText;
