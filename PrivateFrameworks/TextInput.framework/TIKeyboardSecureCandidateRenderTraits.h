...
@interface TIKeyboardSecureCandidateRenderTraits : NSObject <NSCopying, NSSecureCoding> {
    ...
    bool  _shouldForceDoubleLineCandidateForCellularAutofill;
    bool  _shouldForceDoubleLineCandidateForPasswordAutofill;
...
- (void)setShouldForceDoubleLineCandidateForCellularAutofill:(bool)arg1;
- (void)setShouldForceDoubleLineCandidateForPasswordAutofill:(bool)arg1;
