...
@property (nonatomic, retain) CoreTelephonyMockObject *coreTelephonyMockObject;
...
- (id)generateCellularCandidatesWithRenderTraits:(id)arg1 withKeyboardState:(id)arg2;
- (void)generateHideMyEmailCandidateWithSlotID:(unsigned int)arg1 applicationBundleId:(id)arg2 applicationId:(id)arg3 keyboardState:(id)arg4 secureCandidateWidth:(double)arg5 secureCandidateHash:(unsigned long long)arg6 completionHandler:(id /* block */)arg7;
...
- (bool)hasCoreTelephonyEntitlementForConnection:(id)arg1;
- (bool)hasOneTimeCode;
- (id)initPrivate;
- (bool)isValidedString:(id)arg1;
- (id)laContext;
- (id)lastAutofilledUsername;
- (id)localizedCellularAutofillStringForKey:(id)arg1 defaultValue:(id)arg2;
...
- (void)setCoreTelephonyMockObject:(id)arg1;
