...
- (id)emojiAdornmentCandidates:(id)arg1 emojiGenerator:(void*)arg2 emojiData:(struct __EmojiLocaleDataWrapper { }*)arg3;
...
- (struct __EmojiLocaleDataWrapper { }*)emojiDataForInputModeIdx:(unsigned long long)arg1;
- (void*)emojiGeneratorForInputModeIdx:(unsigned long long)arg1;
...
- (id)initWithActiveInputModes:(id)arg1 inputManager:(id)arg2;
- (bool)isLocaleDisabled:(id)arg1;
- (id)primaryInputMode;
...
- (void)updateForMultilingualKeyboard:(id)arg1;
