...
@property (nonatomic, readonly) NSString *keyboardConfiguration;
...
- (id)initWithInputLanguage:(id)arg1 inputRegion:(id)arg2 inputVariant:(id)arg3 secondaryLanguage:(id)arg4 secondaryRegion:(id)arg5 layoutName:(id)arg6 keyboardType:(unsigned char)arg7 keyboardConfiguration:(id)arg8 userInterfaceIdiom:(long long)arg9 testingParameters:(id)arg10;
- (id)initWithInputLanguage:(id)arg1 inputRegion:(id)arg2 layoutName:(id)arg3 keyboardType:(unsigned char)arg4 keyboardConfiguration:(id)arg5 userInterfaceIdiom:(long long)arg6;
