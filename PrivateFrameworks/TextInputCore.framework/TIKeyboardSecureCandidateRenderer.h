...
- (struct __CFArray { }*)imagesFromSecureCandidates:(id)arg1 withRenderTraits:(id)arg2 outAccessibilityLabels:(id*)arg3 outWidths:(id)arg4;
- (id)init;
...
- (id)slotIDsFromSecureCandidates:(id)arg1 withRenderTraits:(id)arg2 outWidths:(id)arg3;
- (id)updateCachedCandidate:(id)arg1 withCandidateString:(id)arg2;
- (id)updateCachedCandidate:(id)arg1 withStickerIdentifier:(id)arg2;
