...
+ (bool)_drawSingleLineSecureHeaders:(id)arg1 secureContents:(id)arg2 layoutTraits:(id)arg3 renderTraits:(id)arg4 contexts:(struct __CFArray { }*)arg5 availableWidth:(double)arg6 truncationSentinel:(id)arg7 abortInsteadOfTruncating:(bool)arg8 outWidths:(id)arg9;
+ (void)_drawTwoLineCellsWithSecureHeaders:(id)arg1 secureContents:(id)arg2 layoutTraits:(id)arg3 renderTraits:(id)arg4 contexts:(struct __CFArray { }*)arg5 availableWidth:(double)arg6 truncationSentinel:(id)arg7 outWidths:(id)arg8;
...
+ (void)drawSecureHeaders:(id)arg1 secureContents:(id)arg2 inContexts:(struct __CFArray { }*)arg3 traits:(id)arg4 truncationSentinel:(id)arg5 outWidths:(id)arg6;
