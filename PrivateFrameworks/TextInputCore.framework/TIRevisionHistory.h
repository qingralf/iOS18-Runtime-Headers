...
@property (nonatomic, retain) TILRUDictionary *autocorrectionHistory;
...
- (void)acceptText:(id)arg1 isAutocorrection:(bool)arg2 isAutoshifted:(bool)arg3;
- (void)acceptToken:(id)arg1 contextTokens:(id)arg2 saveToDifferentialPrivacy:(int)arg3;
...
- (id)contextForTokenAtIndex:(unsigned long long)arg1;
...
- (void)rejectCandidate:(id)arg1 forInput:(id)arg2 hint:(int)arg3;
- (void)rejectToken:(id)arg1 contextTokens:(id)arg2 negativeLearningHint:(int)arg3 withRevisedToken:(id)arg4;
...
- (void)replaceSelectionWithText:(id)arg1 latinInputString:(id)arg2 negativeLearningHint:(int)arg3 selectedTokenReplacementHandler:(id /* block */)arg4;
