...
@interface AutocorrectionResult : NSObject <NSSecureCoding> {
    ...
    NSArray * _touched;
    NSURL * _typologyLogURL;
    NSURL * _typologyTraceLogURL;
}
...
@property (nonatomic, retain) NSURL *typologyLogURL;
@property (nonatomic, retain) NSURL *typologyTraceLogURL;
...
- (void)setTypologyLogURL:(id)arg1;
- (void)setTypologyTraceLogURL:(id)arg1;
- (id)sourceMetadata;
- (id)tags;
- (id)touchEvents;
- (id)touched;
- (id)typologyLogURL;
- (id)typologyTraceLogURL;
