...
+ (id)loadFromTextInputFile:(id)arg1 withCatenation:(bool)arg2 addWordSpacing:(bool)arg3;
+ (id)sentenceToTransliteratedPlaybackTest:(id)arg1 withCatenation:(bool)arg2 addWordSpacing:(bool)arg3;
