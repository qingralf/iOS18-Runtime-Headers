...
@property (nonatomic) bool printTranslitSummaries;
...
- (bool)attemptToTapPredictionBarCandidateWithString:(id)arg1;
...
- (void)setPrintTranslitSummaries:(bool)arg1;
