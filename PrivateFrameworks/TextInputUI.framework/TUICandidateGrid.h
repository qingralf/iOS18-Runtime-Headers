...
@property (nonatomic) bool isArrowButtonVisible;
...
+ (bool)isWritingToolSuggestionCandidate:(id)arg1;
...
- (bool)indexPathIsFullyVisible:(id)arg1 granularity:(int)arg2;
...
- (void)setIsArrowButtonVisible:(bool)arg1;
