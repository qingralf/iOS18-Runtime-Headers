...
@property (nonatomic, retain) UIKBKeyView *activeKeyCap;
...
- (id)shapeWhenMergedWithKey:(id)arg1 insets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg2;
- (id)splitFactory;
