...
@property (nonatomic, retain) NSMutableDictionary *doubleHeightKeys;
...
+ (double)baseHeightForLayout:(id)arg1 layoutClass:(long long)arg2 landscape:(bool)arg3;
+ (long long)defaultEffectsType;
+ (bool)isSixRowLayout:(id)arg1;
...
+ (struct CGSize { double x1; double x2; })sizeFromScreenTraits:(id)arg1 layout:(id)arg2 layoutClass:(long long)arg3;

- (void).cxx_destruct;
- (id)cache;
- (id)createPreparedKeyFromTree:(id)arg1 withMultiplier:(double)arg2 type:(long long)arg3 shape:(long long)arg4;
...
- (id)name;
- (bool)needsResetFromKeyplane:(id)arg1;
...
- (void)setEffectsType:(long long)arg1;
