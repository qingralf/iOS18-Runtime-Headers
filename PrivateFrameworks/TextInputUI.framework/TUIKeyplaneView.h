...
@interface TUIKeyplaneView : UIView <TUIKeyPopupDelegate> {
    TUIKey * _activeKey;
...
+ (struct CGSize { double x1; double x2; })keyplaneSizeForLayout:(id)arg1 screenTraits:(id)arg2 keyboardType:(long long)arg3;
...
+ (Class)selectorViewClassForKey:(id)arg1;
...
- (bool)_shouldUseUnifiedKeyView:(id)arg1;
...
- (void)changingSelectedVariantForKey:(id)arg1 atPoint:(struct CGPoint { double x1; double x2; })arg2 isDragging:(bool)arg3;
...
- (id)heightConstraint;
- (id)hitTestVariantKeyAtPoint:(struct CGPoint { double x1; double x2; })arg1;
- (id)horizontalBiasButtonConstraint;
- (struct CGSize { double x1; double x2; })idealKeySizeforLayoutType:(long long)arg1;
...
- (id)rightSplitWidth;
- (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })rowInsets;
