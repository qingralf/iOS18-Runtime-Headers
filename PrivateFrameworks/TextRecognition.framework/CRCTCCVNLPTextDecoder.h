...
@interface CRCTCCVNLPTextDecoder : NSObject <CRTextDecoding> {
    ...
    bool  _shouldReverseActivationMatrix;
...
@property (nonatomic, readonly) CRBiDiTransform *bidiTransform;
...
@property (nonatomic, readonly) bool shouldReverseActivationMatrix;
...
+ (void)_adjustBeamSearchResults:(id*)arg1 tokens:(id)arg2 greedyCandidateString:(id)arg3 greedyCandidateTokens:(id)arg4 decodingLocale:(id)arg5;
