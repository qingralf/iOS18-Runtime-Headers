...
+ (id)computeDataDetectorRegionsForText:(id)arg1 locale:(id)arg2 transcriptComponents:(id)arg3 ddQOS:(int)arg4;
+ (id)computeGroupRegionsWithDataDetectorRegions:(id)arg1 inRegion:(id)arg2;
+ (void)debugDataDetectorForRegion:(id)arg1 withImage:(id)arg2 ddQOS:(int)arg3;
