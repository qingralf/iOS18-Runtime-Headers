...
@property (nonatomic) struct vImage_Buffer { void *x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; } vImage;
...
- (id)imageByRectifyingRegion:(id)arg1 toColorSpace:(int)arg2 homography:(struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[3]; }*)arg3;
...
- (id)initWithFloatBuffer:(float*)arg1 width:(unsigned long long)arg2 height:(unsigned long long)arg3;
