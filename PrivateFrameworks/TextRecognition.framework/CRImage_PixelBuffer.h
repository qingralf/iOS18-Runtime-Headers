...
- (id)imageByCroppingRectangle:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 iosurfaceBacking:(bool)arg2;
- (id)imageByCroppingRectangle:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 toSurface:(struct __IOSurface {}**)arg2;
- (id)imageByDilating;
...
- (struct __CVBuffer { }*)pixelBufferWithScale:(double)arg1 paddedToSize:(struct CGSize { double x1; double x2; })arg2 adjustedToSize:(struct CGSize { double x1; double x2; }*)arg3 paddingMode:(unsigned long long)arg4 format:(unsigned int)arg5 hardwareAcceleration:(bool)arg6 toSurface:(struct __IOSurface {}**)arg7;
