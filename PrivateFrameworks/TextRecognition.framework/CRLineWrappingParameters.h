...
@interface CRLineWrappingParameters : NSObject {
    ...
    float  _leadingDistanceRatioTolerance;
    int  _lmContextSize;
    ...
    float  _verticalSpacingRatioTolerance;
...
@property float leadingDistanceRatioTolerance;
...
@property float verticalSpacingRatioTolerance;
...
- (id)initWithLocale:(id)arg1 useStrictConfig:(bool)arg2 useHandwritingConfig:(bool)arg3;
...
- (void)setLeadingDistanceRatioTolerance:(float)arg1;
...
- (void)setVerticalSpacingRatioTolerance:(float)arg1;
