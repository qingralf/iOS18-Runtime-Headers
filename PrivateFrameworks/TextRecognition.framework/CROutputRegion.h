...
@interface CROutputRegion : NSObject <CRCodable, CRDirectionalRegion, CRGeometryProviding, CRIdentifiable, CRTrackableRegion, NSCopying, NSSecureCoding> {
...
@property (nonatomic, retain) CRRegionGeometryInfo *geometryInfo;
