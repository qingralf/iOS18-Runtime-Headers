...
- (id)createSubregionsForString:(id)arg1 topWhiteSpacePoints:(id)arg2 bottomWhiteSpacePoints:(id)arg3 hasBoundarySpacePoints:(bool)arg4 hasCharacterAndWordBoundaries:(bool)arg5 tokenPermutation:(id)arg6;
- (id)description;
