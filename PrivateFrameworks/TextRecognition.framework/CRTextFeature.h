...
@interface CRTextFeature : NSObject <CRDirectionalRegion, CRLineWrappable, NSCoding, NSCopying> {
    ...
    bool  _shouldRotate180DetectorOrientationFallBack;
...
- (void)setShouldRotate180DetectorOrientationFallBack:(bool)arg1;
