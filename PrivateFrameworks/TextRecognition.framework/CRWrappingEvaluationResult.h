...
@interface CRWrappingEvaluationResult : NSObject {
    ...
    <CRLineWrappable> * _featureInTest;
...
@property (retain) <CRLineWrappable> *featureInTest;
...
- (id)initWithTextFeature:(id)arg1 context:(id)arg2 imageSize:(struct CGSize { double x1; double x2; })arg3 parameters:(id)arg4;
- (id)initWithTextFeature:(id)arg1 context:(id)arg2 imageSize:(struct CGSize { double x1; double x2; })arg3 parameters:(id)arg4 skipTextComputation:(bool)arg5;
...
- (void)setLeadingAligned:(bool)arg1;
