...
@property (nonatomic, retain) NSObject<OS_dispatch_queue> *audioOperationQueue;
...
+ (id)avSpeechVoicesForTTSAXResources:(id)arg1;
...
- (void)_setVoiceForAction:(id)arg1 snippet:(id)arg2;
...
- (void)setAudioOperationQueue:(id)arg1;
