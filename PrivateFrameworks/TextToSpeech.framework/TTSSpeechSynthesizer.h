...
@property (nonatomic, retain) NSArray *audioEffects;
@property (nonatomic) unsigned int audioQueueFlags;
@property (nonatomic, readonly) unsigned int audioSessionID;
@property (nonatomic, retain) NSString *bundleIdentifier;
@property (nonatomic, retain) _TtC12TextToSpeech15CoreSynthesizer *coreSynth;
...
@property (nonatomic, retain) NSDictionary *perVoiceSettings;
...
- (bool)_startSpeakingString:(id)arg1 orSSMLString:(id)arg2 withLanguageCode:(id)arg3 jobId:(id)arg4 request:(id*)arg5 error:(id*)arg6;
...
- (id)speechSource;
- (id)speechString;
- (bool)startSpeakingSSML:(id)arg1 withLanguageCode:(id)arg2 jobIdentifier:(id)arg3 request:(id*)arg4 error:(id*)arg5;
...
- (bool)startSpeakingString:(id)arg1 withLanguageCode:(id)arg2 jobIdentifier:(id)arg3 request:(id*)arg4 error:(id*)arg5;
