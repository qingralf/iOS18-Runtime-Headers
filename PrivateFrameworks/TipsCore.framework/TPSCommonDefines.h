...
+ (bool)isAppRestrictedWithBundleIdentifier:(id)arg1;
+ (bool)isAppValidWithBundleIdentifier:(id)arg1;
+ (bool)isChecklistCollectionWithIdentifier:(id)arg1;
...
+ (bool)isPadUI;
+ (bool)isPhoneUI;
+ (bool)isRecordValid:(id)arg1;
+ (bool)isSavedTipsCollectionIdentifier:(id)arg1;
+ (bool)isSeniorUser;
+ (bool)isVisionUI;
