...
@property (nonatomic, retain) NSObject<OS_dispatch_queue> *dataCacheSerialQueue;
...
- (id)dataCacheMap;
- (id)dataCacheSerialQueue;
- (void)dealloc;
- (void)excludeURLFromBackup:(id)arg1;
- (id)formattedDataForPath:(id)arg1 identifier:(id)arg2 attributionIdentifier:(id)arg3 priority:(float)arg4 completionHandler:(id /* block */)arg5;
- (id)formattedDataForRequest:(id)arg1 identifier:(id)arg2 attributionIdentifier:(id)arg3 requestType:(id)arg4 priority:(float)arg5 completionHandler:(id /* block */)arg6;
...
- (void)setDataCacheSerialQueue:(id)arg1;
