...
- (id)attributedString;
- (id)attributedStringForConstellationContent:(id)arg1 defaultAttributes:(id)arg2 identifier:(id)arg3 language:(id)arg4 assetsBaseURL:(id)arg5 assetFileInfoManager:(id)arg6 supportsLinks:(bool)arg7 error:(id*)arg8;
