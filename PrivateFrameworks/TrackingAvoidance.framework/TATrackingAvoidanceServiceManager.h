...
- (id)analyticsManager;
- (id)dataSources;
- (void)debugForceSurfaceStagedDetections:(id)arg1 deviceType:(unsigned long long)arg2 detailsBitmask:(unsigned int)arg3;
- (void)debugStageTADetection:(id)arg1 deviceType:(unsigned long long)arg2 detailsBitmask:(unsigned int)arg3;
