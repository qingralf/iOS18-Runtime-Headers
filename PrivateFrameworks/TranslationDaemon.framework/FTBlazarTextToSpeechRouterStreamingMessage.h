...
@interface FTBlazarTextToSpeechRouterStreamingMessage : NSObject <FLTBFBufferAccessor, NSCopying> {
    NSData * _data;
    const struct BlazarTextToSpeechRouterStreamingMessage { unsigned char x1[1]; } * _root;
...
- (void).cxx_destruct;
- (struct Offset<siri::speech::qss_fb::BlazarTextToSpeechRouterStreamingMessage> { unsigned int x1; })addObjectToBuffer:(void*)arg1;
- (id)copyWithZone:(struct _NSZone { }*)arg1;
- (id)flatbuffData;
- (id)initAndVerifyWithFlatbuffData:(id)arg1;
- (id)initWithFlatbuffData:(id)arg1;
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BlazarTextToSpeechRouterStreamingMessage { unsigned char x1[1]; }*)arg2;
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BlazarTextToSpeechRouterStreamingMessage { unsigned char x1[1]; }*)arg2 verify:(bool)arg3;
- (id)session_message;
