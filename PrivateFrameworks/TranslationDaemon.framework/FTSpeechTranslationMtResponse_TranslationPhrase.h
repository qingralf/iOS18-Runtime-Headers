...
@property (nonatomic, readonly) bool contains_masked_profanity;
...
- (void).cxx_destruct;
- (struct Offset<siri::speech::schema_fb::SpeechTranslationMtResponse_::TranslationPhrase> { unsigned int x1; })addObjectToBuffer:(void*)arg1;
- (float)confidence;
