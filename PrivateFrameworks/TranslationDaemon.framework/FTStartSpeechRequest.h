...
@property (nonatomic, readonly) unsigned int initial_result_candidate_id;
...
@property (nonatomic, readonly) NSArray *multi_user_parameters;
@property (nonatomic, readonly) NSString *request_locale;
@property (nonatomic, readonly) NSString *self_session_id;
...
- (void)multi_user_parameters_enumerateObjectsUsingBlock:(id /* block */)arg1;
- (id)multi_user_parameters_objectAtIndex:(unsigned long long)arg1;
- (id)request_locale;
- (id)self_session_id;
- (id)session_id;
- (id)speech_id;
