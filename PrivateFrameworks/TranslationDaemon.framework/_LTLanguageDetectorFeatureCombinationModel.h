...
- (void).cxx_destruct;
- (id)estimateLanguage:(id)arg1 languageDetectionResults:(id)arg2 partialSpeechResultConfidences:(id)arg3 finalSpeechResults:(id)arg4 modelVersions:(id)arg5 isLowConfidencePair:(bool)arg6;
- (id)estimateLanguage:(id)arg1 languageDetectionResults:(id)arg2 partialSpeechResultConfidences:(id)arg3 finalSpeechResults:(id)arg4 modelVersions:(id)arg5 useFinalThresholds:(bool)arg6 isLowConfidencePair:(bool)arg7;
