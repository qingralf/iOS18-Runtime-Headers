...
@interface _LTOfflineTranslationEngine : NSObject <_LTTranslationEngine> {
    ...
    bool  _isSpeechTranslationCancelled;
    ...
    NSURL * _mtModelURL;
    bool  _notifyDelegateOnSuccessfullCancellation;
...
+ (bool)_needToWaitForBothFinalTranslationResultsWithContext:(id)arg1 lidResult:(id)arg2;
...
- (void)_loadRecognizersWithContext:(id)arg1;
...
- (id)asrModelURLs;
- (void)cancelRecognition:(bool)arg1;
- (void)cancelSpeechTranslation:(bool)arg1;
- (void)endAudio;
- (void)endpoint;
