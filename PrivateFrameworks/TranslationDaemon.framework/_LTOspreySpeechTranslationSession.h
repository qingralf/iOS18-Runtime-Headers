...
@interface _LTOspreySpeechTranslationSession : NSObject <FTSpeechTranslationResponseDelegate, _LTSpeechCompressorDelegate> {
    ...
    bool  _didSendTranslationDidFinish;
    bool  _didTimeout;
...
- (void)initCommon;
- (id)initWithService:(id)arg1 context:(id)arg2 delegate:(id)arg3 selfLoggingManager:(id)arg4;
- (id)initWithService:(id)arg1 context:(id)arg2 text:(id)arg3 delegate:(id)arg4 selfLoggingManager:(id)arg5;
