...
+ (void)_createSymlink:(id)arg1 target:(id)arg2 error:(id*)arg3;
+ (bool)_createSymlinkDirectoryForLocalePair:(id)arg1 assets:(id)arg2 validateIfNeeded:(bool)arg3;
+ (void)_createSymlinksFromDirectory:(id)arg1 target:(id)arg2 error:(id*)arg3;
