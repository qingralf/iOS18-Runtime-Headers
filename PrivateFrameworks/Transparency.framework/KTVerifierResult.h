...
- (void)setStaticAccountKeyStatus:(unsigned long long)arg1;
- (void)setSucceed:(unsigned long long)arg1;
- (void)setUiStatus:(unsigned long long)arg1;
- (void)setUri:(id)arg1;
- (bool)staticAccountKeyEnforced;
- (unsigned long long)staticAccountKeyStatus;
- (unsigned long long)succeed;
- (unsigned long long)uiStatus;
- (void)updateWithStaticKeyEnforced:(unsigned long long)arg1 isFailureIgnoredForDate:(bool)arg2;
- (id)uri;
