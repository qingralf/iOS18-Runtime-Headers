...
+ (void)invokeIDSSupportWithBlock:(id /* block */)arg1 errorHandler:(id /* block */)arg2;
+ (void)invokeIDSXPCWithBlock:(id /* block */)arg1 errorHandler:(id /* block */)arg2;
...
+ (id)mainInstance;
+ (bool)retryable:(id)arg1 counter:(int)arg2;
