...
+ (bool)_isFactorRecordFileType:(id)arg1;
...
+ (id)getSandboxExtensionTokensForIdentifierQueryWithError:(id*)arg1;
...
+ (id)printedOnDemandReferenceCountsPerUserInformationWithError:(id*)arg1;
+ (id)printedRolloutInformation:(id*)arg1;
+ (bool)requiresLogging;
+ (bool)requiresTrialDataVaultAccess;
+ (bool)sysdiagnoseInfoToDir:(id)arg1 error:(id*)arg2;
