...
- (void).cxx_destruct;
- (id)_experimentDeploymentWithNamespaceName:(id)arg1 treatmentLayer:(unsigned long long)arg2;
- (id)_providerForNamespace:(id)arg1;
- (id)_treatmentIdWithNamespaceName:(id)arg1 treatmentLayer:(unsigned long long)arg2;
