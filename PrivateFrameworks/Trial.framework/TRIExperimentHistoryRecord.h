...
+ (id)recordWithEventDate:(id)arg1 eventType:(unsigned char)arg2 deploymentEnvironment:(int)arg3 experimentId:(id)arg4 deploymentId:(int)arg5 treatmentId:(id)arg6 errorOrDeactivationReason:(id)arg7 namespaces:(id)arg8;
+ (bool)supportsSecureCoding;

- (void).cxx_destruct;
- (id)copyWithReplacementDeploymentEnvironment:(int)arg1;
- (id)copyWithReplacementDeploymentId:(int)arg1;
- (id)copyWithReplacementErrorOrDeactivationReason:(id)arg1;
...
- (id)initWithEventDate:(id)arg1 eventType:(unsigned char)arg2 deploymentEnvironment:(int)arg3 experimentId:(id)arg4 deploymentId:(int)arg5 treatmentId:(id)arg6 errorOrDeactivationReason:(id)arg7 namespaces:(id)arg8;
