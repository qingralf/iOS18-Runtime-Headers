...
+ (id)taskWithExperiment:(id)arg1 treatmentId:(id)arg2 factorPackSetId:(id)arg3 taskAttributing:(id)arg4 requiresTreatmentInstallation:(bool)arg5 capabilityModifier:(id)arg6 startTime:(id)arg7 taskOptions:(id)arg8;
