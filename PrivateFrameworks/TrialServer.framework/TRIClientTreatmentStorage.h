...
- (bool)_deleteOnDemandAssetsWithFactorNames:(id)arg1 treatment:(id)arg2 namespace:(id)arg3 forRollouts:(bool)arg4 inUseAssetDeletionBehavior:(unsigned char)arg5;
...
- (bool)_removeRolloutWithDescriptor:(id)arg1 descriptorDir:(id)arg2 treatmentLayer:(unsigned long long)arg3 namespaceName:(id)arg4;
...
- (id)updateSavedTreatmentWithTreatmentId:(id)arg1 deletingAssetsWithFactorNames:(id)arg2 forNamespaceName:(id)arg3 forRollouts:(bool)arg4 inUseAssetDeletionBehavior:(unsigned char)arg5;
