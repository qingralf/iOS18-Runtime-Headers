...
@interface TRIExperimentDatabase : NSObject <TRIExperimentCountProviding> {
    TRIDatabase * _db;
}

- (void).cxx_destruct;
- (bool)_enumerateExperimentRecordsMatchingWhereClause:(id)arg1 bind:(id /* block */)arg2 block:(id /* block */)arg3;
- (id)_statusTypesForFactorPackSetReferenceType:(unsigned int)arg1;
- (void)activeCountWithCompletion:(id /* block */)arg1;
...
- (bool)enumerateExperimentRecordsMatchingNamespaceName:(id)arg1 block:(id /* block */)arg2;
...
- (bool)setTreatmentId:(id)arg1 factorPackSetId:(id)arg2 forExperimentDeployment:(id)arg3 usingTransaction:(id)arg4;
...
- (bool)updateEndDate:(id)arg1 forExperimentDeployment:(id)arg2 usingTransaction:(id)arg3;
