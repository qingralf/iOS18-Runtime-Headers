...
+ (id)_namespaceNamesFromExperimentRecord:(id)arg1;
...
+ (id)taskWithFactorPackSetId:(id)arg1 treatmentId:(id)arg2 taskAttribution:(id)arg3 experimentDeployment:(id)arg4;
...
- (void)_recordExperimentFetchFailedWithReason:(id)arg1 context:(id)arg2;
- (void)_recordExperimentFetchFailedWithTaskError:(int)arg1 context:(id)arg2;
...
- (id)_taskResultForStatus:(int)arg1 reportResultToServer:(bool)arg2 earliestRetryDate:(id)arg3;
...
- (id)initWithFactorPackSetId:(id)arg1 treatmentId:(id)arg2 taskAttribution:(id)arg3 experimentDeployment:(id)arg4;
