...
- (id)_getNextTaskForExperiment:(id)arg1 taskContext:(id)arg2 taskQueue:(id)arg3;
- (id)_nameForNotificationType:(int)arg1;
- (bool)_processExperiment:(id)arg1 taskContext:(id)arg2 taskQueue:(id)arg3;
- (id)_updateExperimentEndDateWithArtifact:(id)arg1 context:(id)arg2 database:(id)arg3 scheduleDeactivationTask:(bool)arg4 scheduleDeactivationNow:(bool)arg5;
- (id)description;
- (id)dimensions;
