...
- (void).cxx_destruct;
- (id)_activeExperimentFactorLevelsForNamespaceName:(id)arg1;
- (void)_experimentRecordsWithDeploymentEnvironments:(id)arg1 privacyFilterPolicy:(unsigned char)arg2 serverContext:(id)arg3 completion:(id /* block */)arg4;
...
- (void)experimentIdsWithActiveStateAndNamespaceName:(id)arg1 completion:(id /* block */)arg2;
