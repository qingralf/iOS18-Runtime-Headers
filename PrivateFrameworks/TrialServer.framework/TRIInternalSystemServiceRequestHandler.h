...
- (void).cxx_destruct;
- (bool)_getOnDemandReferenceCountsAtGlobalPath:(id)arg1 onDemandFactorsPerUser:(id*)arg2 error:(id*)arg3;
...
- (void)getOnDemandReferenceCountsPerUserAtGlobalPath:(id)arg1 completion:(id /* block */)arg2;
...
- (void)saveAssetWithIdentifier:(id)arg1 sourcePath:(id)arg2 flockWitness:(struct TRIFlockWitness_ { int x1; }*)arg3 removeSourceOnFailure:(bool)arg4 sourceExtension:(id)arg5 completion:(id /* block */)arg6;
