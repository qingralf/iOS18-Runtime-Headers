...
- (id)experiment;
- (bool)getFactorPackSetId:(id*)arg1 forExperiment:(id)arg2 treatmentId:(id)arg3 error:(id*)arg4;
- (bool)getTreatment:(id*)arg1 forExperiment:(id)arg2 isServerSideExperiment:(bool)arg3 experimentCovariates:(id)arg4 paths:(id)arg5 experimentEndDate:(id)arg6 error:(id*)arg7;
- (bool)getTreatment:(id*)arg1 forExperiment:(id)arg2 isServerSideExperiment:(bool)arg3 systemCovariates:(id)arg4 userCovariates:(id)arg5 experimentCovariates:(id)arg6 experimentEndDate:(id)arg7 error:(id*)arg8;
