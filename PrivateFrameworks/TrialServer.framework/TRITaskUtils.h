...
+ (bool)updateExperimentHistoryDatabaseWithAllocationStatus:(unsigned char)arg1 forExperiment:(id)arg2 treatment:(id)arg3 deployment:(int)arg4 experimentRecord:(id)arg5 isBecomingObsolete:(bool)arg6 categoricalMetric:(id)arg7 context:(id)arg8;
