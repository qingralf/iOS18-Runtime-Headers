...
@property (nonatomic) struct { unsigned int x1[96]; } ctxHMAC;
...
+ (id)keyedHashWithAlgo:(long long)arg1 key:(id)arg2 data:(id)arg3;

- (long long)algo;
- (struct { unsigned int x1[96]; })ctxHMAC;
...
- (id)initWithKeyedAlgo:(long long)arg1 key:(id)arg2;
- (bool)keyed;
- (void)resetWithAlgo:(long long)arg1;
- (void)setAlgo:(long long)arg1;
- (void)setCtxHMAC:(struct { unsigned int x1[96]; })arg1;
