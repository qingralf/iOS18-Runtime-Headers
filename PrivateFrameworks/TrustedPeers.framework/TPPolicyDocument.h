...
+ (id)redactionWithEncrypter:(id)arg1 redactionName:(id)arg2 encryptionKey:(id)arg3 modelToCategory:(id)arg4 categoriesByView:(id)arg5 introducersByCategory:(id)arg6 keyViewMapping:(id)arg7 error:(id*)arg8;
...
- (id)cloneWithVersionNumber:(unsigned long long)arg1 prependingCategoriesByView:(id)arg2 prependingKeyViewMapping:(id)arg3 prependingRedactions:(id)arg4;
- (id)description;
- (id)encodeProtobuf;
