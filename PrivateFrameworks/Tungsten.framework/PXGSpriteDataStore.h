...
- (id)_init;
- (struct { struct { /* ? */ } *x1; struct { /* ? */ } *x2; struct { /* ? */ } *x3; struct { /* ? */ } *x4; })_mutableSpritesInRange:(struct _PXGSpriteIndexRange { unsigned int x1; unsigned int x2; })arg1;
- (void)applyChangeDetails:(id)arg1;
- (void)clearEntities;
- (void)copySpritesInRange:(struct _PXGSpriteIndexRange { unsigned int x1; unsigned int x2; })arg1 fromSpriteDataStore:(id)arg2;
- (unsigned int)count;
- (void)dealloc;
- (id)description;
