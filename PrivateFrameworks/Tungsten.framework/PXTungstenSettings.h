...
@interface PXTungstenSettings : NSObject {
    ...
    double  _keyboardDampingRatio;
    double  _keyboardUnselectedDimmingFactor;
...
- (void)setKeyboardDampingRatio:(double)arg1;
- (void)setKeyboardUnselectedDimmingFactor:(double)arg1;
