...
@interface TypistHWKeyboard : NSObject {
    ...
    NSString * _keyboardLanguageString;
...
@property (nonatomic, retain) NSString *keyboardLanguageString;
...
- (void)setKeyboardLanguageString:(id)arg1;
