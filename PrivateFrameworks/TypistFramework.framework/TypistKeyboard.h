...
@property (nonatomic) bool prefersPopoverKeys;
...
- (struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })_determineTransformationInFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 segmentStart:(double)arg2 totalSegmentWidth:(unsigned long long)arg3 scale:(double)arg4 characterHeight:(double)arg5 characterWidth:(double)arg6 dimensions:(id)arg7 isLatex:(bool)arg8;
- (id)_dimensionsForLatex:(id)arg1 formula:(id)arg2 withPathMap:(id)arg3 regionCode:(id)arg4 isCursive:(bool)arg5 cumulativeWidth:(unsigned long long)arg6 totalWidth:(unsigned long long)arg7 primaryTextDirection:(unsigned long long)arg8 rotationBias:(double)arg9 characterByCharacterPaths:(id)arg10;
- (id)_dimensionsForText:(id)arg1 withPathMap:(id)arg2 regionCode:(id)arg3 isCursive:(bool)arg4 cumulativeWidth:(unsigned long long*)arg5 totalWidth:(unsigned long long)arg6 segmentTextDirection:(unsigned long long)arg7 primaryTextDirection:(unsigned long long)arg8 rotationBias:(double)arg9 characterByCharacterPaths:(id)arg10;
- (id)_generateArgumentList:(id)arg1;
- (id)_generateHandwritingStream:(id)arg1 inFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 isPencil:(bool)arg3 dimensions:(id)arg4 isLatex:(bool)arg5;
...
- (id)attemptToFindKeystrokeAsSecondaryDisplay:(id)arg1;
- (id)autoshiftRegex;
...
- (id)getActionForKeystroke:(id)arg1 fromKeyPlane:(id)arg2;
- (id)getAllCandidates;
...
- (void)setPrefersPopoverKeys:(bool)arg1;
