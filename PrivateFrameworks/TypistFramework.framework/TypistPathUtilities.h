...
+ (struct CGSize { double x1; double x2; })_getWidthAndHeight:(id)arg1 forCharacters:(id)arg2;
...
+ (id)_shiftThaiStrokes:(id)arg1 withRatio:(double)arg2 ofHeight:(long long)arg3;
...
+ (id)generatePathWithParameters:(id)arg1 fromPoints:(id)arg2;
...
+ (id)getTextClustersFrom:(id)arg1 forCharacters:(id)arg2;
