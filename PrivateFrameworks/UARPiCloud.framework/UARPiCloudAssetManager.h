...
- (long long)getSupportedAccessories:(id)arg1 batchRequest:(bool)arg2 inContainer:(id)arg3;
...
- (void)handleRemoteDownloadRequestForSupportedAccessoriesForProductGroup:(id)arg1 batchRequest:(bool)arg2 inContainer:(id)arg3;
- (void)handleRemoteDownloadResponseForAttestationCertificates:(id)arg1 forSubKeyIdentifier:(id)arg2;
- (void)handleRemoteDownloadResponseForSupportedAccessories:(id)arg1 forProductGroup:(id)arg2 isComplete:(bool)arg3;
...
- (void)remoteFetchCompletionForSupportedAccessories:(id)arg1 productGroup:(id)arg2 isComplete:(bool)arg3 error:(id)arg4;
