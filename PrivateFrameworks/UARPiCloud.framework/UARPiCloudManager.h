...
- (bool)handleRemoteFetchRequestForCHIPAccessoriesMetadata:(id)arg1 batchRequest:(bool)arg2;
- (void)handleRemoteFetchRequestForCHIPAttestationCertificates:(id)arg1;
- (bool)handleRemoteFetchRequestSyncForCHIPAccessoriesMetadata:(id*)arg1 productGroup:(id)arg2 batchRequest:(bool)arg3;
...
- (void)performRemoteFetchForSupportedAccessoriesMetadata:(id)arg1 batchRequest:(bool)arg2;
- (void)performRemoteFetchForSupportedAccessoriesMetadataInZone:(id)arg1;
- (bool)processCHIPAccessoriesRecord:(id)arg1;
- (void)processCHIPAccessoriesRecords:(id)arg1 isComplete:(bool)arg2 productGroup:(id)arg3;
...
- (void)qHandleRemoteFetchRequestForAccessories:(id)arg1;
