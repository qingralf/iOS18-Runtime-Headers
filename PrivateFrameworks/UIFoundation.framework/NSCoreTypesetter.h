...
- (struct { unsigned long long x1; unsigned long long x2; bool x3; })_forcedLineBreakAfterIndex:(unsigned long long)arg1;
...
- (id)_truncationTokenForRange:(inout struct _NSRange { unsigned long long x1; unsigned long long x2; }*)arg1 attributes:(id)arg2 originalLineRef:(struct __CTLine { }*)arg3;
- (struct __CTRun { }*)_truncationTokenRunRefWithContext:(struct { id x1; id x2; struct __CTRun {} *x3; }*)arg1 token:(id)arg2 attributes:(id)arg3;
