...
@property (setter=_setListIntentOrdinal:) long long _listIntentOrdinal; /* unknown property attribute: ? */
@property (setter=_setPresentationIntents:, nonatomic, copy) NSArray *_presentationIntents; /* unknown property attribute: ? */
...
@property long long headerLevel; /* unknown property attribute: ? */
...
@property long long listIntentOrdinal; /* unknown property attribute: ? */
...
@property (setter=_setPresentationIntents:, nonatomic, copy) NSArray *presentationIntents; /* unknown property attribute: ? */
...
- (void)setSecondaryLineBreakMode:(long long)arg1;
...
- (bool)preferredSpansAllLinesForCurrentLanguageWithText:(id)arg1;
- (bool)spansAllLinesForConfiguration:(unsigned long long)arg1 withText:(id)arg2;
