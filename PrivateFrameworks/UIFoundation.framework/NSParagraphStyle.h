...
@property (readonly) long long _listIntentOrdinal; /* unknown property attribute: ? */
@property (nonatomic, readonly, copy) NSArray *_presentationIntents; /* unknown property attribute: ? */
...
@property (readonly) long long headerLevel; /* unknown property attribute: ? */
...
@property (readonly) long long listIntentOrdinal; /* unknown property attribute: ? */
...
@property (nonatomic, readonly, copy) NSArray *presentationIntents; /* unknown property attribute: ? */
