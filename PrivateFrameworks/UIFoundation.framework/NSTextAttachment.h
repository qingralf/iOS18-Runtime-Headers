...
@interface NSTextAttachment : NSObject <NSSecureCoding, NSTextAttachmentLayout, UIAccessibilityContentSizeCategoryImageAdjusting> {
...
@property (nonatomic, readonly) bool ic_isSystemTextAttachment;
...
- (void)_showWithBounds:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 attributes:(struct __CFDictionary { }*)arg2 runRange:(struct { long long x1; long long x2; })arg3 textLayoutFragment:(id)arg4 inContext:(struct CGContext { }*)arg5;
...
- (bool)ic_isSystemTextAttachment;
