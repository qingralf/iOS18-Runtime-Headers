...
+ (void)registerEditedRangeValidator:(id)arg1;
+ (bool)supportsSecureCoding;

- (struct _NSRange { unsigned long long x1; unsigned long long x2; })_applyEditedRangeAdjustmentsToRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
