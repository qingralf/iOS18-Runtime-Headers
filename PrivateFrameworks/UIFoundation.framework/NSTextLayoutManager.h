...
@interface NSTextLayoutManager : NSObject <NSSecureCoding, NSTextSelectionDataSource, NSTextViewportElementProvider> {
    struct { id x1; id x2; double x3; long long x4; long long x5; id x6; bool x7; bool x8; bool x9; } * _activeEnumerationCache;
...
+ (id)textHighlightBackgroundColorForForegroundColor_iOS:(id)arg1;
+ (bool)usesHyphenation;
+ (id)validRenderingAttributes;
+ (Class)viewportLayoutControllerClass;

- (void).cxx_destruct;
- (bool)_addTextAnimationContext:(id)arg1;
- (void)_addTextContainer:(id)arg1;
- (void)_addTextContainerForLocation:(id)arg1;
- (bool)_adjustedTextLayoutFragmentBoundaryTextRangeForTextRange:(id)arg1 location:(out id*)arg2 endLocation:(out id*)arg3;
...
- (void)_debugPrintVariableName:(id)arg1 andRange:(id)arg2;
- (id)_descriptionForTextLayoutFragmentStorage;
- (void)_enumerateTextSegmentAndCategoryInRange:(id)arg1 type:(long long)arg2 options:(unsigned long long)arg3 allowsZeroWidthExtensions:(bool)arg4 usingBlock:(id /* block */)arg5;
...
- (void)_fillLayoutToLocation:(id)arg1 enumerationCache:(struct { id x1; id x2; double x3; long long x4; long long x5; id x6; bool x7; bool x8; bool x9; }*)arg2;
...
- (void)_invalidateTextAnimationContextForTextRange:(id)arg1 reason:(long long)arg2;
...
- (id)_rangeForAllLinesContainingTextInRange:(id)arg1;
- (void)_removeTextAnimationContext:(id)arg1;
...
- (id)_textAnimationContextForLocation:(id)arg1;
...
- (id)attributedStringForTruncatedRange:(id)arg1 defaultAttributedString:(id)arg2;
- (id)baseLocation;
...
- (id)delegate;
- (id)documentRange;
- (void)drawTextHighlightBackgroundForRunTextRanges:(id)arg1 attributes:(id)arg2 documentRange:(id)arg3 origin:(struct CGPoint { double x1; double x2; })arg4 context:(struct CGContext { }*)arg5;
- (void)drawTextHighlightBackgroundForTextRange:(id)arg1 attributes:(id)arg2 options:(unsigned long long)arg3 origin:(struct CGPoint { double x1; double x2; })arg4 context:(struct CGContext { }*)arg5;
- (void)drawTextHighlightBackgroundForTextRange:(id)arg1 highlightStyle:(id)arg2 options:(unsigned long long)arg3 origin:(struct CGPoint { double x1; double x2; })arg4 context:(struct CGContext { }*)arg5;
...
- (void)enumerateTextSegmentAndCategoryInRange:(id)arg1 type:(long long)arg2 options:(unsigned long long)arg3 usingBlock:(id /* block */)arg4;
...
- (struct CGSize { double x1; double x2; })estimatedSizeForLastTextContainer;
...
- (void)markedTextAttributesForRange:(id)arg1 usingBlock:(id /* block */)arg2;
- (long long)maximumNumberOfCachedTextLayoutFragments;
...
- (id)textHighlightRenderingAttributesForTextRange:(id)arg1 attributes:(id)arg2;
...
- (id)viewportRangeForTextContainer:(id)arg1;
