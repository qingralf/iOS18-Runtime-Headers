...
- (void)_drawTextCorrectionMarker:(long long)arg1 characterRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 atOrigin:(struct CGPoint { double x1; double x2; })arg3 graphicsContext:(id)arg4;
...
- (id)attributedString;
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })boundsForMarkedTextAtPoint:(struct CGPoint { double x1; double x2; })arg1 range:(id)arg2 width:(double)arg3 adjustmentCallback:(id /* block */)arg4;
...
- (bool)drawMarkedTextBackgroundAtPoint:(struct CGPoint { double x1; double x2; })arg1 context:(struct CGContext { }*)arg2;
- (bool)drawMarkedTextBackgroundAtPoint:(struct CGPoint { double x1; double x2; })arg1 context:(struct CGContext { }*)arg2 adjustmentCallback:(id /* block */)arg3;
- (bool)drawMarkedTextBackgroundAtPoint:(struct CGPoint { double x1; double x2; })arg1 graphicsContext:(id)arg2;
- (bool)drawMarkedTextBackgroundAtPoint:(struct CGPoint { double x1; double x2; })arg1 graphicsContext:(id)arg2 adjustmentCallback:(id /* block */)arg3;
- (void)drawMarkedTextIndicatorAtPoint:(struct CGPoint { double x1; double x2; })arg1 context:(struct CGContext { }*)arg2;
- (void)drawMarkedTextIndicatorAtPoint:(struct CGPoint { double x1; double x2; })arg1 context:(struct CGContext { }*)arg2 adjustmentCallback:(id /* block */)arg3;
- (void)drawMarkedTextIndicatorAtPoint:(struct CGPoint { double x1; double x2; })arg1 graphicsContext:(id)arg2;
- (void)drawMarkedTextIndicatorAtPoint:(struct CGPoint { double x1; double x2; })arg1 graphicsContext:(id)arg2 adjustmentCallback:(id /* block */)arg3;
- (bool)drawMarkedTextIndicatorAtPoint:(struct CGPoint { double x1; double x2; })arg1 graphicsContext:(id)arg2 backgroundOnly:(bool)arg3 adjustmentCallback:(id /* block */)arg4;
...
- (void)enumerateTextSegmentBoundsInTextRange:(id)arg1 dataSourceLocationsOnly:(bool)arg2 usingBlock:(id /* block */)arg3;
...
- (void)setIsHyphenated:(bool)arg1;
