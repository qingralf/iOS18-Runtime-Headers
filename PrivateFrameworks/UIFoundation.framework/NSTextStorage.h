...
- (bool)beginEditTrackingForContextRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
- (void)beginEditing;
...
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })endEditTracking;
- (void)endEditing;
