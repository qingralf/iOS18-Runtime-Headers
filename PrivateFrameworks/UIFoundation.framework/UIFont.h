...
@property (nonatomic, readonly, copy) NSString *pui_localizedTimeFontName;
@property (nonatomic, readonly, copy) NSString *pui_postScriptName;
@property (nonatomic, readonly, copy) NSURL *pui_referenceURL;
@property (nonatomic, readonly, copy) NSString *pui_timeFontIdentifier;
...
+ (id)_preferredFontForTextStyle:(id)arg1 design:(id)arg2 variant:(long long)arg3 weight:(double)arg4 maximumContentSizeCategory:(id)arg5 compatibleWithTraitCollection:(id)arg6;
+ (id)_preferredFontForTextStyle:(id)arg1 design:(id)arg2 variant:(long long)arg3 weight:(id)arg4 maximumContentSizeCategory:(id)arg5 compatibleWithTraitCollection:(id)arg6 pointSize:(double)arg7 pointSizeForScaling:(double)arg8;
...
- (id)htmlMarkupDescriptionForWebKit:(bool)arg1;
...
+ (id)asc_fontDerivedFromTextStyle:(id)arg1 byApplyingFontWeight:(double)arg2;
...
+ (id)asc_preferredFontForTextStyle:(id)arg1 withTraits:(unsigned int)arg2;
...
+ (id)cuik_createFontFromFont:(id)arg1 withFontGrade:(int)arg2;
+ (id)cuik_preferredTightLeadingBoldFontForTextStyle:(id)arg1;
+ (id)cuik_preferredTightLeadingFontForTextStyle:(id)arg1;
...
+ (id)__ck_preferredFontForStyle:(id)arg1;
...
+ (id)ck_fontWithMessageEntryTextViewFontType:(unsigned long long)arg1;
+ (id)ck_italicBalloonFont;
+ (id)ck_lastResortFontOfSize:(double)arg1;

- (id)__ck_fontScaledByUserPreference;
- (id)__ck_fontWithWeight:(double)arg1;
- (bool)ck_canToggleItalicTraitInText:(id)arg1;
- (id)ck_fontByAddingSymbolicTrait:(unsigned int)arg1;
- (id)ck_fontByRemovingSymbolicTrait:(unsigned int)arg1;
- (id)ck_fontBySettingBoldEnabled:(bool)arg1;
- (id)ck_fontBySettingItalicEnabled:(bool)arg1;
- (bool)ck_hasBoldTrait;
- (bool)ck_hasItalicTrait;
...
+ (id)itk_preferredFontWithTextStyle:(id)arg1 weight:(double)arg2;

- (id)itk_fontWithWeight:(double)arg1;
...
+ (id)mru_controlCenterLargeSubtitleFontWithScale:(double)arg1;
+ (id)mru_controlCenterLargeTitleFont;
+ (id)mru_controlCenterLargeTitleFontWithScale:(double)arg1;
+ (id)mru_controlCenterMediumSubtitleFont;
+ (id)mru_controlCenterMediumSubtitleFontWithScale:(double)arg1;
+ (id)mru_controlCenterMediumTitleFont;
+ (id)mru_controlCenterMediumTitleFontWithScale:(double)arg1;
+ (id)mru_controlCenterMoreButtonBadgeFont;
+ (id)mru_controlCenterMoreButtonTitleFont;
+ (id)mru_controlCenterMoreButtonTitleFontWithScale:(double)arg1;
+ (id)mru_controlCenterRouteButtonFont;
+ (id)mru_controlCenterRouteButtonFontWithScale:(double)arg1;
...
+ (id)mru_timeFont;
+ (id)mru_timeFontWithScale:(double)arg1;
+ (id)mru_titleFont;
...
+ (id)safari_fontDescriptorWithMonospacedDigitAttributes:(id)arg1;
+ (id)safari_monospacedDigitFontForTextStyle:(id)arg1;
+ (id)safari_monospacedDigitFontForTextStyle:(id)arg1 weight:(double)arg2;

- (id)_sf_fontByAddingAttributes:(id)arg1;
...
+ (id)ic_preferredFontForTitleTextWithContentSizeCategory:(id)arg1 isForPrint:(bool)arg2 isReducedSize:(bool)arg3;
...
+ (bool)pk_loadFDICSignageFont;
+ (bool)pk_loadFontWithFileName:(id)arg1 extension:(id)arg2;
...
+ (id)pr_downloadableFontWithPostScriptName:(id)arg1;
...
+ (id)pui_UIFontWithName:(id)arg1 forRole:(id)arg2 includingFallbackFonts:(bool)arg3;
+ (id)pui_UIFontWithPUIFontIdentifier:(id)arg1;
+ (id)pui_UIFontWithPUIFontIdentifier:(id)arg1 forRole:(id)arg2;
+ (id)pui_UIFontWithPUIFontIdentifier:(id)arg1 forRole:(id)arg2 includingFallbackFonts:(bool)arg3;
+ (id)pui_UIFontWithPostScriptName:(id)arg1 inBundle:(id)arg2 relativePath:(id)arg3;
+ (id)pui_UIFontWithPostScriptName:(id)arg1 inBundleAtURL:(id)arg2 relativePath:(id)arg3;
+ (id)pui_UIFontWithPostScriptName:(id)arg1 inBundleWithIdentifier:(id)arg2 relativePath:(id)arg3;
+ (void)pui_clearCachesForInvalidation;
+ (id)pui_defaultFont;
+ (id)pui_defaultFontForRole:(id)arg1;
+ (id)pui_defaultFontIdentifier;
+ (id)pui_defaultFontIdentifierForRole:(id)arg1;
+ (id)pui_replacementFallbackFontNamesForRole:(id)arg1;

- (id)pui_UIFontWithDefaultFallbacksForRole:(id)arg1;
- (id)pui_UIFontWithVariantWeight:(unsigned long long)arg1 forRole:(id)arg2;
- (id)pui_cachedVariantWeight;
- (id)pui_defaultFontFallbacks;
- (id)pui_fontFallbacks;
- (id)pui_fontWithFallbacks:(id)arg1;
- (id)pui_fontWithFallbacks:(id)arg1 beforeFontContainingName:(id)arg2;
- (bool)pui_isReferenceFileContainedInBundle:(id)arg1;
- (bool)pui_isReferenceFileContainedInDirectoryAtURL:(id)arg1;
- (id)pui_localizedTimeFontName;
- (id)pui_maximumAllowedFontWeightFont;
- (id)pui_minimumAllowedFontWeightFont;
- (id)pui_postScriptName;
- (id)pui_referencePathRelativeToBundle:(id)arg1;
- (id)pui_referencePathRelativeToDirectoryAtURL:(id)arg1;
- (id)pui_referenceURL;
- (id)pui_replaceFallbackFontNames:(id)arg1;
- (void)pui_setCachedVariantWeight:(id)arg1;
- (id)pui_timeFontIdentifier;
- (unsigned long long)pui_variantWeight;
- (struct { unsigned long long x1; unsigned long long x2; })pui_variantWeightRange;
