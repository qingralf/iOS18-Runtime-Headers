...
- (id)ck_fontDescriptorByAddingSymbolicTrait:(unsigned int)arg1;
- (id)ck_fontDescriptorByRemovingSymbolicTrait:(unsigned int)arg1;
- (id)ck_fontDescriptorBySettingBoldEnabled:(bool)arg1;
- (id)ck_fontDescriptorBySettingItalicEnabled:(bool)arg1;
