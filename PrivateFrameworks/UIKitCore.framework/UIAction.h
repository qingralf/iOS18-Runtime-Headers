...
+ (id)_sf_openInNewTabActionWithTabOrder:(long long)arg1 handler:(id /* block */)arg2 identifierSuffix:(id)arg3;
+ (id)_sf_openInNewTabActionsWithHandler:(id /* block */)arg1;
+ (id)_sf_openInNewTabActionsWithHandler:(id /* block */)arg1 identifierSuffix:(id)arg2;
...
+ (id)itk_itemWithTitle:(id)arg1;
+ (id)itk_itemWithTitle:(id)arg1 subtitle:(id)arg2;
