...
@interface UIAlertAction : NSObject <NSCopying> {
    ...
    <_UIAlertActionViewRepresentation> * __representer;
    bool  _checked;
...
@property (setter=_setRepresenter:) <_UIAlertActionViewRepresentation> *_representer;
...
+ (id)sf_actionWithContentViewController:(id)arg1 style:(long long)arg2 handler:(id /* block */)arg3 shouldDismissHandler:(id /* block */)arg4;
