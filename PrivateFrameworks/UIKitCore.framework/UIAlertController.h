...
@interface UIAlertController : UIViewController <AAUIAlertControllerProtocol, HUPreloadableViewController, UIAlertControllerContaining, UIAlertControllerVisualStyleProviding, UIPreviewInteractionControllerDelegate, WFAlertPresenter, _UIAlertControllerTextFieldViewControllerContaining> {
    ...
    bool  __shouldInvokeCancelActionOnDimmingViewTap;
...
@property (setter=_setShouldInvokeCancelActionOnDimmingViewTap:, nonatomic) bool _shouldInvokeCancelActionOnDimmingViewTap;
...
- (void)_beginNoPresentingViewControllerPresentation:(id)arg1;
...
- (void)_setShouldInvokeCancelActionOnDimmingViewTap:(bool)arg1;
...
+ (id)alertControllerWithTitle:(id)arg1 message:(id)arg2 imageNamed:(id)arg3 preferredStyle:(long long)arg4;

- (void)setImageIfNecessaryWithName:(id)arg1;
...
+ (id)ds_alertControllerContinuityUnpairError:(id)arg1;
...
+ (id)dkui_unknownFailureAlertControllerWithCompletion:(id /* block */)arg1;

// Image: /System/Library/PrivateFrameworks/FeedbackCore.framework/FeedbackCore

+ (id)fbaAlertControllerWithTitle:(id)arg1 message:(id)arg2 preferredStyle:(long long)arg3;
...
- (void)mf_addAvatarWithAvatarGenerator:(id)arg1 messageListItem:(id)arg2 contactStore:(id)arg3 brandIndicatorProvider:(id)arg4;
...
+ (id)safari_closeAllTabsConfirmationWithCloseAllLabel:(id)arg1 closeHandler:(id /* block */)arg2;
...
+ (bool)addRecoveryActionTo:(id)arg1 for:(id)arg2 onAction:(id /* block */)arg3;
