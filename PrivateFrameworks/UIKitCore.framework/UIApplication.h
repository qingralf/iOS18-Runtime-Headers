...
@interface UIApplication : UIResponder <FBSDisplayLayoutObserver, FBSWorkspaceDelegate, FBSWorkspaceDelegate_Exiting, MSVBackgroundTaskProviding, PKPushRegistryDelegate, UIActivityContinuationManagerApplicationContext, UIApplicationSnapshotPreparing, UIRepeatedActionDelegate, UIStatusBarStyleDelegate_SpringBoardOnly, _UIApplicationInitializationContextFactory, _UIWindowSceneActivator_Internal> {
...
@property (nonatomic, readonly) _UIResponderChainFixerUpper *_responderBasedEventDeliverer;
...
@property (nonatomic, readonly) bool ic_hasConnectedHostedWindowScene;
...
@property (nonatomic, readonly) bool safari_prefersRTLLayout;
...
@property (nonatomic, readonly) UIWindow *tsk_keyWindow;
...
+ (void)_requestSystemUIServiceSceneWithCompletion:(id /* block */)arg1;
...
- (void)_cancelTouchesIfNeededForViewRemovedFromResponderChain:(id)arg1;
...
- (id)_dragEvents;
- (id)_dynamicButtonEventForWindow:(id)arg1;
...
- (id)_responderBasedEventDeliverer;
...
- (long long)defaultStatusForCategory:(long long)arg1 error:(id*)arg2;
- (id)delegate;
...
- (void)noteActiveInterfaceOrientationDidChangeToOrientation:(long long)arg1 willAnimateWithSettings:(id)arg2 fromOrientation:(long long)arg3 screen:(id)arg4;
- (void)noteActiveInterfaceOrientationWillChangeToOrientation:(long long)arg1;
- (void)noteActiveInterfaceOrientationWillChangeToOrientation:(long long)arg1 screen:(id)arg2;
- (id)openSessions;
...
- (bool)ic_hasConnectedHostedWindowScene;
...
- (void)px_navigateToCollection:(id)arg1 selectedObject:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (void)px_navigateToPhotosURL:(id)arg1 completionHandler:(id /* block */)arg2;
