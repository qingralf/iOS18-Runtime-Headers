...
@property (setter=__setVisualEffectblurClippingMode:, nonatomic) unsigned long long __visualEffectblurClippingMode;
...
@property (setter=_setShadowProperties:, nonatomic, retain) UIShadowProperties *_shadowProperties;
@property (setter=_setVisualEffectAllowsTransparentBlurring:, nonatomic) bool _visualEffectAllowsTransparentBlurring;
@property (setter=_setVisualEffectGroupName:, nonatomic, copy) NSString *_visualEffectGroupName;
@property (setter=_setVisualEffectblurClippingMode:, nonatomic) unsigned long long _visualEffectblurClippingMode;
...
- (void)__setVisualEffectblurClippingMode:(unsigned long long)arg1;
- (id)__visualEffectGroupName;
- (unsigned long long)__visualEffectblurClippingMode;
...
- (void)_setVisualEffectAllowsTransparentBlurring:(bool)arg1;
- (void)_setVisualEffectGroupName:(id)arg1;
- (void)_setVisualEffectblurClippingMode:(unsigned long long)arg1;
