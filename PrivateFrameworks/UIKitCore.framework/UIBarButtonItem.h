...
@interface UIBarButtonItem : UIBarItem <MUIPresentationSource, NSCoding, UIMenuForcedAutomaticSelectionDelegate, _UIPopoverPresentationControllerSourceItem_Internal> {
...
@property (nonatomic, readonly) UIBarButtonItem *_itemForPresenting;
...
- (void)set_owningButtonGroup:(id)arg1;
- (long long)style;
...
+ (id)barButtonItemWithWebAppViewModel:(id)arg1;
+ (id)barButtonItemWithWebButtonModel:(id)arg1 navigationBarModel:(id)arg2 actionBlock:(id /* block */)arg3;

// Image: /System/Library/PrivateFrameworks/ChatKit.framework/ChatKit

+ (id)ck_tapbackItemWithChatItem:(id)arg1 target:(id)arg2 action:(SEL)arg3;
...
+ (id)_mui_capsuleConfigurationWithTitle:(id)arg1 titleColor:(id)arg2 image:(id)arg3;
+ (id)mui_capsuleButtonItemWithTitle:(id)arg1 titleColor:(id)arg2 imageName:(id)arg3 action:(id)arg4;
+ (id)mui_capsuleButtonItemWithTitle:(id)arg1 titleColor:(id)arg2 imageName:(id)arg3 menu:(id)arg4;
