...
@property (nonatomic, readonly) struct CGPath { }*itk_CGPath;
@property (nonatomic, readonly) NSMutableArray *itk_allPoints;
@property (nonatomic, readonly) struct CGPoint { double x1; double x2; } itk_centroid;
@property (nonatomic, readonly) double itk_lengthIgnoringCurves;
...
+ (id)_continuousRoundedCARectBezierPath:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 withRoundedCorners:(unsigned long long)arg2 cornerRadius:(struct CGSize { double x1; double x2; })arg3 segments:(int)arg4;
+ (id)_continuousRoundedRectBezierPath:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 withRoundedCorners:(unsigned long long)arg2 cornerRadii:(id)arg3 segments:(int)arg4 smoothPillShapes:(bool)arg5 clampCornerRadii:(bool)arg6;
...
+ (id)bezierPathWithCalloutRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 unitLocation:(double)arg2 edge:(long long)arg3;
+ (double)pointerMargin;

- (void)addPointerAtUnitLocation:(double)arg1 rect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 edge:(long long)arg3;
...
+ (id)itk_allPointsFromCGPath:(struct CGPath { }*)arg1;
+ (struct CGPoint { double x1; double x2; })itk_calculateCenterForPoints:(struct CGPoint { double x1; double x2; })arg1 p2:(struct CGPoint { double x1; double x2; })arg2 p3:(struct CGPoint { double x1; double x2; })arg3 radius:(double)arg4;
+ (bool)itk_cgPathcontainsAnyCurveToPoints:(struct CGPath { }*)arg1;
+ (double)itk_clampedRadius:(double)arg1 p1:(struct CGPoint { double x1; double x2; })arg2 p2:(struct CGPoint { double x1; double x2; })arg3 p3:(struct CGPoint { double x1; double x2; })arg4;
+ (id)itk_groupAndRoundPaths:(id)arg1 radius:(double)arg2 offset:(double)arg3;
+ (struct CGPath { }*)itk_newRoundedPathWithRadius:(double)arg1 points:(id)arg2;
+ (id)itk_pathFromCGPath:(struct CGPath { }*)arg1;
+ (struct CGPoint { double x1; double x2; })itk_projectPoint:(struct CGPoint { double x1; double x2; })arg1 lineStart:(struct CGPoint { double x1; double x2; })arg2 lineEnd:(struct CGPoint { double x1; double x2; })arg3;
+ (id)itk_roundAndGroupNormalizedQuadsForHighlight:(id)arg1 aspectRatio:(double)arg2 expansionScale:(double)arg3 radiusToAvgHeightRatio:(double)arg4;
+ (id)itk_shiftLinePerpendicularlyFromPoint:(struct CGPoint { double x1; double x2; })arg1 to:(struct CGPoint { double x1; double x2; })arg2 radius:(double)arg3;
+ (double)itk_signForRadiusWithVectorStart:(struct CGPoint { double x1; double x2; })arg1 end:(struct CGPoint { double x1; double x2; })arg2 otherPoint:(struct CGPoint { double x1; double x2; })arg3;
+ (id)itk_subpathArrayFromCGPath:(struct CGPath { }*)arg1;
+ (id)mapPaths:(id)arg1 toQuads:(id)arg2;
+ (double)radiusForQuads:(id)arg1 radiusRatio:(double)arg2;

- (id)_itk_flattenWithPath:(id)arg1 clipType:(int)arg2;
- (id)debugQuickLookObject;
- (struct CGPath { }*)itk_CGPath;
- (void)itk_addArcWithCenter:(struct CGPoint { double x1; double x2; })arg1 radius:(double)arg2 startAngle:(double)arg3 endAngle:(double)arg4 clockwise:(bool)arg5;
- (void)itk_addCurveToPoint:(struct CGPoint { double x1; double x2; })arg1 controlPoint1:(struct CGPoint { double x1; double x2; })arg2 controlPoint2:(struct CGPoint { double x1; double x2; })arg3;
- (void)itk_addLineToPoint:(struct CGPoint { double x1; double x2; })arg1;
- (id)itk_allPoints;
- (void)itk_appendBezierPath:(id)arg1;
- (void)itk_appendRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
- (void)itk_applyTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg1;
- (struct CGPoint { double x1; double x2; })itk_centroid;
- (id)itk_expandWithOffset:(double)arg1;
- (id)itk_intersectAndFlattenWithPath:(id)arg1;
- (double)itk_lengthIgnoringCurves;
- (id)itk_pathByFittingToRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
- (id)itk_pathFromFlippingInRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
- (id)itk_subpathArray;
- (id)itk_unionAndFlattenWithPath:(id)arg1;
...
+ (id)px_bezierPathWithRoundedRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 topLeftCornerRadius:(double)arg2 topRightCornerRadius:(double)arg3 bottomLeftCornerRadius:(double)arg4 bottomRightCornerRadius:(double)arg5;

// Image: /System/Library/PrivateFrameworks/ProVideo.framework/ProVideo

- (void)pcxLineToPoint:(struct CGPoint { double x1; double x2; })arg1;
