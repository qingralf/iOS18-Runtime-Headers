...
@property (setter=_setFocusSizeIncrease:, nonatomic) double _focusSizeIncrease;
@property (setter=_setImageContentMode:, nonatomic) long long _imageContentMode;
@property (nonatomic, readonly) UIView *_imageEffectContainerView;
...
+ (id)_defaultImageColorForType:(long long)arg1 andState:(unsigned long long)arg2 idiom:(long long)arg3;
...
+ (id)_defaultSymbolConfigurationForType:(long long)arg1 andState:(unsigned long long)arg2 compact:(bool)arg3 idiom:(long long)arg4;
...
- (void)_setFocusSizeIncrease:(double)arg1;
...
- (void)_updateConfigurationWithObservationTracking:(id)arg1;
...
- (void)popCommSafetyMenu:(id)arg1;
...
+ (id)photosViewRoundedAccessoryConfigurationWithSymbolName:(id)arg1;
...
+ (id)intelligenceButtonWithConfiguration:(id)arg1 primaryAction:(id)arg2;
