...
@interface UIButtonConfigurationVisualProvider : NSObject <UIButtonModernVisualProvider, _UIButtonConfigurationUpdateExecuting> {
    unsigned long long  _accessibilityButtonShapesChangedToken;
    bool  _avoidDefaultTitleAndImageLayout;
...
@property (nonatomic) bool avoidDefaultTitleAndImageLayout; /* unknown property attribute: ? */
@property (nonatomic) UIButton *button; /* unknown property attribute: ? */
...
- (void)setAvoidDefaultTitleAndImageLayout:(bool)arg1;
