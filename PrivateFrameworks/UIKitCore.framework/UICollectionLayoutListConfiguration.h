...
@property (setter=_setSectionHeaderHugsContent:, nonatomic) bool _sectionHeaderHugsContent;
...
- (void)setContentHuggingElements:(unsigned long long)arg1;
