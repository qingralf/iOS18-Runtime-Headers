...
@property (getter=_isHiddenForReordering, setter=_setHiddenForReordering:, nonatomic) bool _hiddenForReordering;
...
- (void)_applyListEnvironmentTraitOverridesUsingNewListAttributes:(id)arg1 previousListAttributes:(id)arg2;
...
- (void)_setHiddenForReordering:(bool)arg1;
...
- (bool)_wasDequeued;
- (void)_willRevealWithLayoutAttributes:(id)arg1;
