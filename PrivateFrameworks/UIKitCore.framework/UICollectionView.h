...
@interface UICollectionView : UIScrollView <UIDataSourceTranslating, _UICollectionDataSourceBackedView, _UICollectionTableIndexOverlayHost, _UIHorizontalIndexTitleBarDelegate, _UIKeyboardAutoRespondingScrollView, _UISelectionInteractionDelegate, _UIUpdateCycleIdleObserver> {
...
@property (setter=_setAllowsBandSelectionForMultipleSelection:, nonatomic) bool _allowsBandSelectionForMultipleSelection;
...
@property (nonatomic, readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } mui_safeVisibleBounds;
...
- (void)_accessibilityPostReorderingAnnouncementForCurrentIndexPath:(id)arg1 targetIndexPath:(id)arg2 previousIndexPath:(id)arg3;
...
- (void)_addReloadDataCompletionBlock:(id /* block */)arg1;
- (void)_addSubview:(id)arg1 positioned:(long long)arg2 relativeTo:(id)arg3;
- (bool)_addUpdateToShadowControllerIfNeeded:(id)arg1;
...
- (bool)_beginReorderingItemAtIndexPath:(id)arg1 isLegacyMovement:(bool)arg2;
...
- (void)_configureSupplementaryViewForDisplay:(id)arg1 withElementKind:(id)arg2 indexPath:(id)arg3 elementCategory:(unsigned long long)arg4;
...
- (struct CGPoint { double x1; double x2; })_contentOffsetForScrollingToItemAtIndexPath:(id)arg1 atScrollPosition:(unsigned long long)arg2 additionalInsets:(struct NSDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })arg3;
- (struct CGPoint { double x1; double x2; })_contentOffsetForScrollingToItemAtIndexPath:(id)arg1 atScrollPosition:(unsigned long long)arg2 additionalInsets:(struct NSDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })arg3 itemFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg4 containingScrollView:(id)arg5 clampToScrollableArea:(bool)arg6;
- (struct CGPoint { double x1; double x2; })_contentOffsetFromProposedOffset:(struct CGPoint { double x1; double x2; })arg1 forScrollingToItemWithFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 atScrollPosition:(unsigned long long)arg3 additionalInsets:(struct NSDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })arg4 containingScrollViewBounds:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg5;
...
- (void)_createAndAppendViewAnimationsForExistingAndDeletedAuxiliariesInCurrentUpdate:(id)arg1 disappearingAnimations:(id)arg2 animationsForOnScreenViews:(id)arg3 newSubviewCollection:(id)arg4 oldVisibleViews:(id)arg5;
- (void)_createAndAppendViewAnimationsForExistingAndNewlyVisibleItemsInCurrentUpdate:(id)arg1 animationsForOnScreenViews:(id)arg2 newSubviewCollection:(id)arg3 oldVisibleViews:(id)arg4 attributesForNewModel:(id)arg5;
- (void)_createAndAppendViewAnimationsForInsertedAuxiliariesInCurrentUpdate:(id)arg1 appearingAnimations:(id)arg2 newSubviewCollection:(id)arg3;
- (void)_createAndAppendViewAnimationsForInsertsInCurrentUpdate:(id)arg1 appearingAnimations:(id)arg2 newSubviewCollection:(id)arg3;
- (void)_createAndAppendViewAnimationsForNewlyVisibleAuxiliariesInCurrentUpdate:(id)arg1 appearingAnimations:(id)arg2 animationsForOnScreenViews:(id)arg3 newSubviewCollection:(id)arg4 attributesForNewModel:(id)arg5;
...
- (void)_deselectItemsAtIndexPaths:(id)arg1 animated:(bool)arg2 transitionCoordinator:(id)arg3;
...
- (void)_enqueueViewForReuse:(id)arg1;
...
- (bool)_highlightItemAtIndexPath:(id)arg1 animated:(bool)arg2 scrollPosition:(unsigned long long)arg3 notifyDelegate:(bool)arg4 playFeedback:(bool)arg5;
...
- (void)_immediatelyBeginDruidBasedReorderIfPossibleWithTouch:(id)arg1;
...
- (id)_indexPathForSupplementaryView:(id)arg1;
...
- (bool)_isCellInvolvedInDragOrDropAnimationAtIndexPath:(id)arg1;
...
- (void)_multiSelectInteractionSelectItemAtIndexPath:(id)arg1;
- (id /* block */)_navigationCompletion;
- (bool)_needsReload;
...
- (void)_populateSubviewCollectionWithExistingVisibleViewsForCurrentUpdate:(id)arg1 addingDeletedViewsToSet:(id)arg2 updateLayoutAttributesIndexPaths:(bool)arg3;
...
- (void)_scrollToItemAtIndexPath:(id)arg1 atScrollPosition:(unsigned long long)arg2 additionalInsets:(struct NSDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })arg3 animated:(bool)arg4;
- (void)_scrollToItemAtPresentationIndexPath:(id)arg1 atScrollPosition:(unsigned long long)arg2 additionalInsets:(struct NSDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })arg3 animated:(bool)arg4;
...
- (void)_selectItemAtIndexPath:(id)arg1 animated:(bool)arg2 scrollPosition:(unsigned long long)arg3 notifyDelegate:(bool)arg4 deselectPrevious:(bool)arg5 performPrimaryAction:(bool)arg6 performCustomSelectionAction:(bool)arg7;
...
- (void)_setAllowsBandSelectionForMultipleSelection:(bool)arg1;
...
- (void)_setupExpandCollapseAnimationsIfNeededWithContext:(id)arg1;
...
- (bool)_shouldSelectionFollowFocusForIndexPath:(id)arg1 initiatedBySelection:(bool)arg2 focusItemStateCandidate:(id)arg3;
...
- (void)_springLoadedInteractionSelectItemAtIndexPath:(id)arg1;
- (void)_startViewAnimationsWithContext:(id)arg1 oldVisibleViews:(id)arg2 viewAnimator:(id)arg3 viewAnimationsCompletedDispatchGroup:(id)arg4;
...
- (void)_updateEditing:(bool)arg1 forView:(id)arg2 atIndexPath:(id)arg3 elementCategory:(unsigned long long)arg4;
...
- (void)_userSelectItemAtIndexPath:(id)arg1 animatedSelection:(bool)arg2;
- (bool)_validateScrollingTargetIndexPath:(id)arg1 raisingExceptionIfNecessary:(bool)arg2;
...
- (bool)indexBarView:(id)arg1 didSelectEntry:(id)arg2 atIndex:(long long)arg3;
...
- (struct CGPoint { double x1; double x2; })__ck_bottomOffsetHidingIndexPath:(id)arg1;
- (struct CGPoint { double x1; double x2; })__ck_bottomOffsetHidingIndexPath:(id)arg1 skippingLayoutUpdate:(bool)arg2;
...
- (struct CGPoint { double x1; double x2; })__ck_offsetForTopOfCellAtIndexPath:(id)arg1 hidingCellAtIndexPath:(id)arg2;
...
- (void)mui_interactiveDeselectAllSelectedIndexPathsUsingTransitionCoordinator:(id)arg1 animated:(bool)arg2;
- (bool)mui_isIndexPathVisible:(id)arg1;
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })mui_safeVisibleBounds;
- (void)mui_scrollToItemAtIndexPath:(id)arg1 atScrollPosition:(long long)arg2 animated:(bool)arg3;
- (void)mui_selectItemAtIndexPath:(id)arg1 animated:(bool)arg2 scrollPosition:(long long)arg3;
