...
@property (getter=_backgroundFillIsCustomized, nonatomic, readonly) bool _backgroundFillIsCustomized;
...
@property (getter=_dragAppearance, setter=_setDragAppearance:, nonatomic) unsigned long long _dragAppearance;
...
- (void)_setDragAppearance:(unsigned long long)arg1;
