...
@property (setter=_setCanReorderItemHandler:, nonatomic, copy) id /* block */ _canReorderItemHandler;
@property (setter=_setDidReorderItemsHandler:, nonatomic, copy) id /* block */ _didReorderItemsHandler;
