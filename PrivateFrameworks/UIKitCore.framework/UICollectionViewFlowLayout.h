...
@interface UICollectionViewFlowLayout : UICollectionViewLayout {
    ...
    <_UICollectionViewUpdateTranslating> * _currentUpdateTranslator;
...
- (void).cxx_destruct;
- (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })_adjustedSectionInsetForSectionInset:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg1 forAxis:(unsigned long long)arg2;
