...
@property (setter=_setShouldInvalidateCollectionViewContentSize:, nonatomic) bool _shouldInvalidateCollectionViewContentSize;
...
- (void)_removeInvalidatedDecorationOfKind:(id)arg1 indexPath:(id)arg2;
- (void)_removeInvalidatedItemIndexPath:(id)arg1;
- (void)_removeInvalidatedSupplementaryOfKind:(id)arg1 indexPath:(id)arg2;
- (bool)_retainExistingSizingInfoForEstimates;
...
- (void)_setShouldInvalidateCollectionViewContentSize:(bool)arg1;
