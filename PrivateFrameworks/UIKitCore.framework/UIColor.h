...
@property (nonatomic, readonly) struct CKColor_t { double x1; double x2; double x3; double x4; } ckColor;
...
@property (nonatomic, readonly) UIColor *itk_colorWith20PercentOpacity;
@property (nonatomic, readonly) UIColor *itk_colorWith40PercentOpacity;
@property (nonatomic, readonly) UIColor *itk_colorWith60PercentOpacity;
@property (nonatomic, readonly) UIColor *itk_colorWith80PercentOpacity;
@property (nonatomic, readonly) UIColor *itk_colorWithMaxSaturation;
@property (nonatomic, readonly, copy) UIColor *itk_resolvedColor;
...
@property (nonatomic, readonly) PUIColorHSBValues *pui_hsbValues;
@property (nonatomic, readonly) PUIColorHSLValues *pui_hslValues;
@property (nonatomic, readonly) double pui_maxLuminance;
@property (nonatomic, readonly) double pui_minLuminance;
...
@property (nonatomic, readonly) UIColor *sf_brightenedColor;
@property (nonatomic, readonly) UIColor *sf_darkenedColor;
@property (nonatomic, readonly) bool sf_isDarkColor;
@property (nonatomic, readonly) UIColor *sf_muchBrightenedColor;
@property (nonatomic, readonly) UIColor *sf_muchDarkenedColor;
@property (nonatomic, readonly) UIColor *sf_slightlyDarkenedColor;
...
+ (id)avkit_tintColorForControlElementIsOverVideo:(bool)arg1 withUserInterfaceStyle:(long long)arg2;
...
- (id)_lp_colorBlendedWithColor:(id)arg1 withFraction:(double)arg2;
- (id)_lp_colorForcingUserInterfaceStyle:(long long)arg1;
- (double)contrastRatioLuminance;
- (double)contrastWithColor:(id)arg1;
- (double)contrastWithLuminance:(double)arg1;
- (bool)contrastsWith:(id)arg1;
- (long long)deprecatedLuminosityLevel;
- (long long)luminosityLevel;
...
+ (id)pk_thicknessButtonBackgroundUseSystemColor:(bool)arg1;
...
- (id)cuik_colorWithAlphaScaled:(double)arg1;
...
+ (id)ck_colorWithCKColor:(struct CKColor_t { double x1; double x2; double x3; double x4; })arg1;
+ (id)dynamicColorWithLightColor:(id)arg1 darkColor:(id)arg2;

- (struct CKColor_t { double x1; double x2; double x3; double x4; })ckColor;
...
+ (id)itk_colorWith256Red:(double)arg1 green:(double)arg2 blue:(double)arg3 alpha:(double)arg4;
+ (id)itk_colorWith256Red:(double)arg1 green:(double)arg2 blue:(double)arg3 unitAlpha:(double)arg4;
+ (id)itk_labelColor;
...
+ (id)ic_emphasisBackgroudColorFromColor:(id)arg1;
...
+ (id)ic_tintColorWithTraitCollection:(id)arg1;
...
+ (id)pkui_colorWithPKColor:(id)arg1;
...
+ (void)pui_determineVarianceAndLuminanceForColor:(id)arg1 amongstColors:(id)arg2 minLuminance:(id)arg3 maxLuminance:(id)arg4 outHue:(out double*)arg5 outSaturation:(out double*)arg6 outLuminance:(out double*)arg7;
+ (void)pui_determineVarianceAndLuminanceForColor:(id)arg1 amongstColors:(id)arg2 minLuminance:(id)arg3 maxLuminance:(id)arg4 outVariance:(out double*)arg5 outLuminance:(out double*)arg6 outSaturation:(out double*)arg7;
+ (void)pui_determineVarianceAndLuminanceForColor:(id)arg1 amongstColors:(id)arg2 outVariance:(out double*)arg3 outLuminance:(out double*)arg4 outSaturation:(out double*)arg5;
+ (double)pui_determineVarianceForHue:(double)arg1 forColors:(id)arg2;
+ (id)pui_wallpaperColorForName:(id)arg1;
...
+ (id)pcxColorWithCalibratedHue:(double)arg1 saturation:(double)arg2 brightness:(double)arg3 alpha:(double)arg4;
+ (id)pcxColorWithCalibratedRed:(double)arg1 green:(double)arg2 blue:(double)arg3 alpha:(double)arg4;
+ (id)pcxColorWithCalibratedWhite:(double)arg1 alpha:(double)arg2;
+ (id)pcxColorWithColorSpace:(struct CGColorSpace { }*)arg1 components:(const double*)arg2 count:(long long)arg3;
+ (id)pcxColorWithColorSpace:(struct CGColorSpace { }*)arg1 hue:(double)arg2 saturation:(double)arg3 brightness:(double)arg4 alpha:(double)arg5;
+ (id)pcxColorWithDeviceCyan:(double)arg1 magenta:(double)arg2 yellow:(double)arg3 black:(double)arg4 alpha:(double)arg5;
+ (id)pcxColorWithDeviceHue:(double)arg1 saturation:(double)arg2 brightness:(double)arg3 alpha:(double)arg4;
+ (id)pcxColorWithDeviceRed:(double)arg1 green:(double)arg2 blue:(double)arg3 alpha:(double)arg4;
+ (id)pcxColorWithDeviceWhite:(double)arg1 alpha:(double)arg2;
+ (id)pcxColorWithGenericGamma22White:(double)arg1 alpha:(double)arg2;
+ (id)pcxColorWithSRGBRed:(double)arg1 green:(double)arg2 blue:(double)arg3 alpha:(double)arg4;
...
- (id)pcxColorUsingColorSpace:(struct CGColorSpace { }*)arg1;
- (void)pcxGetComponents:(double*)arg1;
...
+ (id)sbf_siriIntelligenceLightBlueColor;
+ (id)sbf_siriIntelligenceLightColors;
+ (id)sbf_siriIntelligenceLightOrangeColor;
+ (id)sbf_siriIntelligenceLightPurpleColor;
+ (id)sbf_siriIntelligenceLightRedColor;

// Image: /System/Library/PrivateFrameworks/SpringBoardHome.framework/SpringBoardHome

+ (id)sbh_brightColorWithRandomHue;
+ (id)sbh_colorWithHexString:(id)arg1;
+ (id)sbh_randomColor;
...
+ (id)color:(double)arg1 :(double)arg2 :(double)arg3 :(double)arg4;
+ (id)vfx_colorWithCFXColor:(const struct CFXColor4 { union { float x_1_1_1[4]; struct { float x_2_2_1; float x_2_2_2; float x_2_2_3; float x_2_2_4; } x_1_1_2; } x1; }*)arg1;
+ (id)vfx_colorWithCFXColor:(const struct CFXColor4 { union { float x_1_1_1[4]; struct { float x_2_2_1; float x_2_2_2; float x_2_2_3; float x_2_2_4; } x_1_1_2; } x1; }*)arg1 ignoringColorSpace:(bool)arg2;
+ (id)vfx_colorWithLinearDisplayP3Red:(double)arg1 green:(double)arg2 blue:(double)arg3 alpha:(double)arg4;
+ (id)vfx_colorWithLinearSRGBRed:(double)arg1 green:(double)arg2 blue:(double)arg3 alpha:(double)arg4;
+ (id)vfx_colorWithModelIORed:(double)arg1 green:(double)arg2 blue:(double)arg3 alpha:(double)arg4 options:(id)arg5;

- (double)a;
- (double)b;
- (double)g;
- (double)r;
- (struct CFXColor4 { union { float x_1_1_1[4]; struct { float x_2_2_1; float x_2_2_2; float x_2_2_3; float x_2_2_4; } x_1_1_2; } x1; })vfx_CFXColorIgnoringColorSpace:(bool)arg1 success:(bool*)arg2;
- (void)vfx_colorComponentsForModelIO;
...
- (id)colorByRemovingTransparency;
