...
+ (id)colorEffectBlendColor:(id)arg1;
...
- (id)_filterEntry;
- (id)_filterEntryForTraitCollection:(id)arg1;
- (bool)_needsUpdateForTransitionFromEnvironment:(id)arg1 toEnvironment:(id)arg2 changedTraits:(id)arg3 usage:(long long)arg4;
