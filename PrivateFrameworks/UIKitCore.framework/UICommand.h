...
@property (nonatomic, readonly) ICCalculateGraphingControllerInsertionDecision *calculateGraphingControllerInsertionDecision;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (readonly, copy) NSString *description;
@property (nonatomic, copy) NSString *discoverabilityTitle;
@property (nonatomic, readonly) SEL fallbackAction;
...
+ (id)commandWithTitle:(id)arg1 imageName:(id)arg2 action:(SEL)arg3 fallbackAction:(SEL)arg4;
...
- (void)_performFallbackActionWithSender:(id)arg1 target:(id)arg2;
...
- (id)_resolvedTargetFromFirstTarget:(id)arg1 sender:(id)arg2 shouldUseFallbackActionOut:(bool*)arg3;
...
- (id)initWithTitle:(id)arg1 image:(id)arg2 imageName:(id)arg3 action:(SEL)arg4 fallbackAction:(SEL)arg5 propertyList:(id)arg6 alternates:(id)arg7 discoverabilityTitle:(id)arg8 attributes:(unsigned long long)arg9 state:(long long)arg10;
