...
@property (setter=_setFallbackDriverStyle:, nonatomic) unsigned long long _fallbackDriverStyle;
...
- (bool)_clickPresentationInteraction:(id)arg1 shouldMaintainKeyboardAssertionForFirstResponder:(id)arg2 presentation:(id)arg3;
...
- (id)_defaultPreparationContextWithFirstResponderTarget:(id)arg1;
...
- (void)_delegate_performPreviewActionCommitAnimation:(id /* block */)arg1;
...
- (void)_interactionShouldBeginAtPoint:(struct CAPoint3D { double x1; double x2; double x3; })arg1 completion:(id /* block */)arg2;
...
- (void)_presentMenuAtLocation3D:(struct CAPoint3D { double x1; double x2; double x3; })arg1;
...
- (void)_setFallbackDriverStyle:(unsigned long long)arg1;
