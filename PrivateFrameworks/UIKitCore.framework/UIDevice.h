...
- (void)setSh_hostUserInterfaceIdiom:(long long)arg1;
...
+ (bool)tsk_isPadOrVisionUI;
+ (bool)tsk_landscapePhoneUI;
+ (bool)tsk_padUI;
+ (bool)tsk_phoneDevice;
+ (bool)tsk_phoneUI;
+ (bool)tsk_supportsPencil;
+ (bool)tsk_visionBincompat;
+ (bool)tsk_visionBincompatOrNative;
+ (bool)tsk_visionDevice;
+ (bool)tsk_visionUI;
