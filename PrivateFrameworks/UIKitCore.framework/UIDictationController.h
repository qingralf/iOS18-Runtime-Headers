...
@interface UIDictationController : NSObject <UIAdaptivePresentationControllerDelegate, UIDictationConnectionDelegate, UIDictationConnectionTokenFilterProtocol, VTUIDictationDataSharingOptInPresentationDelegate, _UIAssertionControllerSubject, _UIDictationPrivacySheetControllerDelegate, _UIStandardTextCursorViewAudioLevelProvider, _UITextInputUserInteractionDelegate, _UITouchPhaseChangeDelegate> {
    ...
    UIDictationCursorPositionRestorer * _cursorPositionRestorer;
    ...
    bool  _haveLeakedPartialResultForCommandUtterance;
    bool  _haveReceivedFirstPartialResultForCurrentUtterance;
    NSTimer * _idleTimerResetTimer;
    bool  _ignoreFinalizePhrases;
    bool  _ignoreKeyboardDidHideNotification;
    long long  _ignoreRTIChanges;
    bool  _ignoreUserInteraction;
    ...
    bool  _isDictationUndoGroupingOpen;
    bool  _isDisambiguationUIActive;
    bool  _isOfflineMetricsSessionActive;
    bool  _isProcessingPotentialVoiceCommand;
    ...
    RTIDocumentState * _visibleRTIDocumentStateAtCommandRecognition;
...
@property (nonatomic, retain) NSValue *commandTargetRangeMatchingGazeRange;
@property (nonatomic, retain) NSString *currentEuclidLanguage;
...
@property (nonatomic, retain) UIDictationCursorPositionRestorer *cursorPositionRestorer;
...
@property (nonatomic) bool haveLeakedPartialResultForCommandUtterance;
@property (nonatomic) bool haveReceivedFirstPartialResultForCurrentUtterance;
...
@property (nonatomic) bool ignoreUserInteraction;
...
@property (nonatomic) bool isDictationUndoGroupingOpen;
@property (nonatomic) bool isProcessingPotentialVoiceCommand;
...
@property (nonatomic, retain) RTIDocumentState *visibleRTIDocumentStateAtCommandRecognition;
...
- (void).cxx_destruct;
- (void)_addUndoNotificationObservationWithVoiceCommandUUID:(id)arg1;
- (bool)_allowsMicsInSearchField;
- (void)_applyWKAlternativesPayload:(id)arg1 toAbsoluteRanges:(id)arg2 valueRangeToText:(id)arg3 context:(id)arg4 originalSelectedRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg5 completionHandler:(id /* block */)arg6;
...
- (id)_getBestHypothesisRangeGivenHintRange:(id)arg1 inputDelegateManager:(id)arg2 hypothesisRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; }*)arg3 documentTextInRange:(id*)arg4 forHypothesis:(id)arg5;
...
- (bool)_handleMultipleTextTargetsForText:(id)arg1 payloadText:(id)arg2 voiceCommandUUID:(id)arg3;
- (void)_handlePrivacySheetDismissal;
- (void)_handleRecognizedCommandWithCommandIdentifier:(unsigned long long)arg1 parameters:(id)arg2 strings:(id)arg3 voiceCommandUUID:(id)arg4;
- (void)_handleWKMultipleTextTargetsForText:(id)arg1 payloadText:(id)arg2 voiceCommandUUID:(id)arg3 completionHandler:(id /* block */)arg4;
- (id)_hypothesisRangeFromSelectionRange:(id)arg1 inputDelegateManager:(id)arg2 forHypothesis:(id)arg3;
- (id)_inputDelegateClassName;
- (void)_insertSerializedDictationResult:(id)arg1 withCorrectionIdentifier:(id)arg2;
- (bool)_isNonEmptyDocumentRequiredForCommand:(unsigned long long)arg1;
...
- (id)_rangeByExtendingRange:(id)arg1 backward:(long long)arg2 forward:(long long)arg3 inputDelegateManager:(id)arg4;
- (void)_refreshVisibleRTIDocumentStateWithContinuation:(id /* block */)arg1;
- (void)_removeUndoNotificationObservation;
- (void)_requestDocumentContextWithCompletionHandler:(id /* block */)arg1;
- (void)_requestFullDocumentContextWithCompletionHandler:(id /* block */)arg1;
...
- (bool)_shouldInsertText:(id)arg1;
...
- (bool)canApplyVoiceCommandWithIdentifier:(id)arg1 parameters:(id)arg2 commandUtteranceString:(id)arg3 voiceCommandUUID:(id)arg4;
- (bool)canUndoOrRedo;
...
- (id)commandTargetRangeMatchingGazeRange;
...
- (bool)didRecognizeCommandWithIdentifier:(id)arg1 strings:(id)arg2 parameters:(id)arg3 voiceCommandUUID:(id)arg4 gazeRangeAtCommandRecognitionTime:(id)arg5;
...
- (void)euclidPhoneticString:(id)arg1 maxResultsCount:(unsigned long long)arg2 completion:(id /* block */)arg3;
...
- (void)instrumentDictationVoiceCommandDisambiguationActionWithVoiceCommandUUID:(id)arg1 disambiguationIndex:(id)arg2 totalDisambiguationCount:(id)arg3;
- (void)instrumentDictationVoiceCommandUndoTapActionWithVoiceCommandUUID:(id)arg1 undoTapAlternativeSelection:(bool)arg2;
...
- (void)logEuclidSelection:(id)arg1 suggestedTokens:(id)arg2 correctedToken:(id)arg3 selectedIndex:(long long)arg4;
...
- (void)markDictationUndoEventWithVoiceCommandUUID:(id)arg1 viaTapOnRevertBubble:(bool)arg2;
...
- (void)performTextReplacementForWebKitWithDeltaRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 targetText:(id)arg2 replacementText:(id)arg3 originalSelectedRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg4 voiceCommandDisambiguationSelectedIndex:(id)arg5 voiceCommandDisambiguationTargetCount:(id)arg6 voiceCommandUUID:(id)arg7 completionHandler:(id /* block */)arg8;
...
- (void)preheatEuclidModelWithLanguageCode:(id)arg1 clientID:(id)arg2;
...
- (void)setCommandTargetRangeMatchingGazeRange:(id)arg1;
- (void)setCurrentEuclidLanguage:(id)arg1;
...
- (void)setCursorPositionRestorer:(id)arg1;
...
- (void)setDisambiguationActiveEnabled:(bool)arg1;
...
- (void)setHaveLeakedPartialResultForCommandUtterance:(bool)arg1;
- (void)setHaveReceivedFirstPartialResultForCurrentUtterance:(bool)arg1;
...
- (void)setIgnoreKeyboardDidHideNotification:(bool)arg1;
- (void)setIgnoreUserInteraction:(bool)arg1;
...
- (void)setIsDictationUndoGroupingOpen:(bool)arg1;
- (void)setIsProcessingPotentialVoiceCommand:(bool)arg1;
...
- (void)setVisibleRTIDocumentStateAtCommandRecognition:(id)arg1;
...
- (bool)shouldOverrideManualEndpointingWithReturnKeyType:(long long)arg1;
...
- (void)switchToDictationLanguage:(id)arg1 inputOptions:(id)arg2;
...
- (id)visibleRTIDocumentStateAtCommandRecognition;
