...
+ (bool)_isDictationAssetAvailableForLocale:(id)arg1;
...
+ (id)capitalizeFirstWord:(id)arg1;
...
+ (bool)shouldInsertSpaceBetweenStringA:(id)arg1 andStringB:(id)arg2;
+ (bool)shouldLogCorrectionInfoForCurrentBundleId;
+ (bool)supportsDictationVoiceEditingUIForBundleIdentifier:(id)arg1;
