...
@interface UIDocument : NSObject <NSFilePresenter, NSProgressReporting, UINavigationItemRenameDelegate, UINavigationItemRenameDelegateInternal> {
...
+ (id)_documentWithContentsOfFileURL:(id)arg1 error:(id*)arg2;
...
- (id)_defaultUserActivityForActivityType:(id)arg1;
...
- (id)_navigationItemFileURLForRenaming:(id)arg1;
...
- (id)_readingProgressForURL:(id)arg1;
...
- (void)_updateDefaultUserActivityBecomingCurrent:(bool)arg1;
- (void)_updateLastUsedDate;
- (void)_updateLocalizedName;
- (void)_updatePermissionsState:(bool)arg1;
- (void)_updateUserActivityState:(id)arg1;
- (id)_userActivity;
