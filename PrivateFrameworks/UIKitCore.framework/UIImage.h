...
@property (nonatomic, readonly) UIImageView *itk_imageView;
@property (nonatomic, readonly) double itk_scale;
...
@property (nonatomic, readonly) UIImage *roundingCornersIfSquared;
@property (nonatomic, readonly) double safari_longestEdgeInPixels;
@property (getter=safari_isSVGImage, nonatomic, readonly) bool safari_svgImage;
@property (setter=safari_setThemeColor:, nonatomic, retain) UIColor *safari_themeColor;
...
@property (getter=isSquared, nonatomic, readonly) bool squared;
...
+ (id)_applicationIconImageForBundleIdentifier:(id)arg1 format:(int)arg2 scale:(double)arg3 style:(long long)arg4;
...
+ (id)_baseImageDescriptorForUIApplicationIconFormat:(int)arg1;
...
- (void)_drawInContext:(struct CGContext { }*)arg1 rect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 layout:(id)arg3;
- (void)_drawInContext:(struct CGContext { }*)arg1 rect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 layout:(id)arg3 scale:(double)arg4 applyContentsTransform:(bool)arg5;
...
- (struct CGSize { double x1; double x2; })_fullSize;
- (bool)_hasBaseline;
...
- (id)_imageByApplyingSymbolVariant:(id)arg1;
...
- (long long)_imageOrientationForSymbolLayerConsideringRTLForUserInterfaceLayoutDirection:(long long)arg1;
...
- (struct CGSize { double x1; double x2; })_sizeWithHairlineThickening:(bool)arg1 forTraitCollection:(id)arg2;
...
- (void)_mapkit_prepareThumbnailOfSize:(struct CGSize { double x1; double x2; })arg1 completionHandler:(id /* block */)arg2;
...
+ (id)addBackgroundForImage:(id)arg1 withBackgroundColor:(id)arg2 yShift:(double)arg3;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })_cropRectForRawImageOrientation:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
...
+ (id)cuik_imageFromISImage:(id)arg1;
+ (id)cuik_privateSystemImageNamed:(id)arg1 withConfiguration:(id)arg2;
...
- (id)__ck_resizableBalloonWithBalloonDescriptor:(struct CKBalloonDescriptor_t { BOOL x1; BOOL x2; BOOL x3; BOOL x4; unsigned long long x5; BOOL x6; struct CKColor_t { double x_7_1_1; double x_7_1_2; double x_7_1_3; double x_7_1_4; } x7; long long x8; long long x9; bool x10; bool x11; bool x12; bool x13; })arg1 framed:(bool)arg2;
...
- (id)ckImageWithTintColor:(id)arg1 insets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg2 traitCollection:(id)arg3;
...
+ (id)doc_AppIconForHostBundleIdentifier:(id)arg1;
...
// Image: /System/Library/PrivateFrameworks/FitnessAsset.framework/FitnessAsset
...
+ (id)_gkImageWithCheckedData:(id)arg1;
+ (id)_gkImageWithCheckedData:(id)arg1 scale:(double)arg2;
...
+ (id)hu_systemTabImageWithNamed:(id)arg1 filled:(bool)arg2;
...
+ (id)itk_UIImageFromCIImage:(id)arg1;
+ (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })itk_aspectFitImageFrameForViewWithFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 imageSize:(struct CGSize { double x1; double x2; })arg2;
+ (id)itk_fileIconForURL:(id)arg1 withPreferredSize:(struct CGSize { double x1; double x2; })arg2;
+ (id)itk_imageNamed:(id)arg1 withTint:(id)arg2;
+ (id)itk_imageNamed:(id)arg1 withTint:(id)arg2 size:(struct CGSize { double x1; double x2; })arg3;
+ (id)itk_imageWithCGImage:(struct CGImage { }*)arg1;
+ (id)itk_imageWithCGImage:(struct CGImage { }*)arg1 scale:(double)arg2 orientation:(long long)arg3;
+ (id)itk_imageWithCIImage:(id)arg1;
+ (id)itk_imageWithCVPixelBuffer:(struct __CVBuffer { }*)arg1;
+ (id)itk_imageWithColor:(id)arg1 size:(struct CGSize { double x1; double x2; })arg2;
+ (id)itk_imageWithContentsOfURL:(id)arg1;
+ (id)itk_imageWithData:(id)arg1;
+ (id)itk_imageWithData:(id)arg1 scale:(double)arg2;
+ (id)itk_mainScreenScaledImageWithData:(id)arg1;
+ (id)itk_orientationMetadataFromImageOrientation:(long long)arg1;
+ (id)itk_orientedImageFromCGImage:(struct CGImage { }*)arg1 scale:(double)arg2 transform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg3;
+ (id)itk_orientedImageFromImage:(id)arg1 fromOrientation:(long long)arg2;
+ (id)itk_orientedImageFromImage:(id)arg1 toOrientation:(long long)arg2;
+ (id)itk_symbolImageWithName:(id)arg1;

- (id)itk_HEICData;
- (id)itk_HEICDataLossless;
- (id)itk_HEICDataWithCompressionQuality:(double)arg1;
- (id)itk_HEICDataWithCompressionQuality:(double)arg1 orientation:(long long)arg2;
- (id)itk_JPEGData;
- (id)itk_JPEGDataWithOrientation:(long long)arg1;
- (id)itk_PNGData;
- (id)itk_PNGDataWithOrientation:(long long)arg1;
- (struct CGImage { }*)itk_cgImage;
- (struct CGImage { }*)itk_cgImageGeneratingIfNecessary;
- (unsigned int)itk_cgImagePropertyOrientation;
- (id)itk_ciImage;
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })itk_cropRectZeroAlpha;
- (id)itk_debug;
- (id)itk_decodeInBackground;
- (void)itk_decodeWithCompletion:(id /* block */)arg1;
- (id)itk_horizontallyMirroredImage;
- (id)itk_imageDataWithRequirements:(id)arg1;
- (void)itk_imageDataWithRequirements:(id)arg1 completion:(id /* block */)arg2;
- (id)itk_imageDataWithUTType:(id)arg1;
- (id)itk_imageDataWithUTType:(id)arg1 metadata:(id)arg2;
- (id)itk_imageFromSubrect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
- (long long)itk_imageOrientation;
- (id)itk_imageView;
- (id)itk_imageWithTint:(id)arg1 size:(struct CGSize { double x1; double x2; })arg2;
- (double)itk_scale;
- (id)itk_scaledImageMaxDimension:(double)arg1 scale:(double)arg2;
- (id)itk_scaledImageMinDimension:(double)arg1 scale:(double)arg2;
- (id)itk_scaledImageWithSize:(struct CGSize { double x1; double x2; })arg1 scale:(double)arg2;
- (id)itk_squareStickerImageWithEdgeLength:(double)arg1;

// Image: /System/Library/PrivateFrameworks/MailUI.framework/MailUI

+ (id)mf_imageForChevronType:(long long)arg1;
+ (id)mf_imageForSummarySymbolWithFont:(id)arg1;
+ (id)mui_imageFromSuggestionToken:(id)arg1;
+ (id)mui_imageWithPrivateSystemSymbolName:(id)arg1;
+ (id)mui_imageWithSystemSymbolName:(id)arg1;
+ (id)mui_imageWithSystemSymbolName:(id)arg1 accessibilityDescription:(id)arg2;
...
- (id)mru_imageFittingSize:(struct CGSize { double x1; double x2; })arg1;
...
+ (id)ic_makeCircularImageWithColor:(id)arg1 diameter:(double)arg2;
+ (id)ic_makeCircularImageWithColor:(id)arg1 diameter:(double)arg2 borderColor:(id)arg3 borderWidth:(double)arg4;
...
+ (id)px_imageNamed:(id)arg1 bundle:(id)arg2;
+ (id)px_imageNamed:(id)arg1 configuration:(id)arg2 bundle:(id)arg3;
...
- (void)pruis_determineProminentColorWithCompletion:(id /* block */)arg1;
...
+ (id)pui_imageFromSceneSnapshot:(id)arg1;
+ (id)pui_imageSnapshotFromLayer:(id)arg1 buffer:(struct __IOSurface { }*)arg2;
+ (id)pui_imageWithIOSurface:(id)arg1;
+ (id)pui_imageWithIOSurface:(id)arg1 scale:(double)arg2 orientation:(long long)arg3;
+ (id)pui_thumbnailImageForImage:(id)arg1 thumbnailWidthInPixels:(double)arg2;

- (id)pui_CGImageBackedImage;
- (id)pui_CGImageBackedImageUsingDataProvider;
- (id)pui_CGImageBackedImageWithMaximumBitsPerComponent:(unsigned long long)arg1;
- (id)pui_CGImageBackedImageWithMaximumBitsPerComponent:(unsigned long long)arg1 skipCIF10FitsInSRGBCheck:(bool)arg2;
- (long long)pui_EXIFOrientation;
- (id)pui_averageColor;
- (id)pui_averageColorForRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
- (bool)pui_canDetermineProminentColor;
- (struct CGColorSpace { }*)pui_colorSpace;
- (id)pui_cropImageWithRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 outputSize:(struct CGSize { double x1; double x2; })arg2;
- (id)pui_cropImageWithRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 outputSize:(struct CGSize { double x1; double x2; })arg2 canUseIOSurface:(bool)arg3;
- (id)pui_cropImageWithRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 outputSize:(struct CGSize { double x1; double x2; })arg2 preservingAspectRatio:(bool)arg3;
- (id)pui_cropImageWithRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 outputSize:(struct CGSize { double x1; double x2; })arg2 preservingAspectRatio:(bool)arg3 canUseIOSurface:(bool)arg4;
- (id)pui_imageByManipulatingInDeviceColorSpaceWithBlock:(id /* block */)arg1;
- (id)pui_imageHashData;
- (bool)pui_isSolidColor:(out id*)arg1;
- (id)pui_resizeImageToSize:(struct CGSize { double x1; double x2; })arg1;
- (id)pui_resizeImageToSize:(struct CGSize { double x1; double x2; })arg1 preservingAspectRatio:(bool)arg2;
- (id)pui_scaleImage:(double)arg1;
- (id)pui_scaleImage:(double)arg1 canUseIOSurface:(bool)arg2;
...
+ (id)ps_synchronousIconWithApplicationBundleIdentifier:(id)arg1;
+ (id)ps_synchronousIconWithTypeIdentifier:(id)arg1;

// Image: /System/Library/PrivateFrameworks/ProVideo.framework/ProVideo

+ (id)pcxImageWithSize:(struct CGSize { double x1; double x2; })arg1 flipped:(bool)arg2 drawingHandler:(id /* block */)arg3;

- (id)initPCXImageWithContentsOfURL:(id)arg1;
- (id)initPCXImageWithSize:(struct CGSize { double x1; double x2; })arg1;
- (struct CGImage { }*)pcxCGImageForProposedRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; }*)arg1 context:(id)arg2 hints:(id)arg3;
- (id)pcxImageWithAlpha:(double)arg1;
- (id)pcxImageWithAlpha:(double)arg1 colorSpace:(struct CGColorSpace { }*)arg2;
...
+ (id)safari_dynamicImageWithSize:(struct CGSize { double x1; double x2; })arg1 generator:(id /* block */)arg2;
...
+ (id)safari_largestSizedBitmapImageOrSVGFromImages:(id)arg1;
...
- (id)safari_pngData;
- (void)safari_setThemeColor:(id)arg1;
...
+ (id)actionGlyphForSymbolType:(long long)arg1;
...
+ (id)tpImageForSymbolType:(long long)arg1 scale:(long long)arg2 paletteColors:(id)arg3;
...
- (id)vui_aspectFitImageOfSize:(struct CGSize { double x1; double x2; })arg1;
- (id)vui_croppedImageOfSize:(struct CGSize { double x1; double x2; })arg1;
...
+ (id)imageForTableUIWithType:(id)arg1;
+ (id)imageWithType:(id)arg1 size:(double)arg2;
