...
- (void).cxx_destruct;
- (id)_assetManager;
- (void)_cacheRendition:(id)arg1 forSize:(struct CGSize { double x1; double x2; })arg2 tintColor:(id)arg3 traitCollection:(id)arg4 bold:(bool)arg5 drawMode:(unsigned int)arg6;
- (id)_cachedRenditionWithSize:(struct CGSize { double x1; double x2; })arg1 tintColor:(id)arg2 traitCollection:(id)arg3 bold:(bool)arg4 drawMode:(unsigned int)arg5;
...
- (id)_performLookUpRegisteredObjectForTraitCollection:(id)arg1 withAccessorWithAppearanceName:(id /* block */)arg2;
- (id /* block */)_rebuildStackImage;
