...
@property (nonatomic, readonly) bool _suppressesMaterialRendering;
...
- (id)_hierarchicalColorForLayerLevel:(long long)arg1 effect:(id)arg2 shouldResolveDynamicColors:(bool)arg3;
...
- (id)_paletteColorsWithEffect:(id)arg1 shouldResolveDynamicColors:(bool)arg2;
