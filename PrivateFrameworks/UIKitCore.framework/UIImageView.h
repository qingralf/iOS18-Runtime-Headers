...
@interface UIImageView : UIView <CCUIGlyphTinting, CCUIPunchOutCompensating, CCUIPunchOutRendering, NUCrossFadeViewAnimatable, UIAccessibilityContentSizeCategoryImageAdjusting, UIAccessibilityContentSizeCategoryImageAdjustingInternal, _UIImageContentEffect, _UIImageContentLayoutTarget, _UIImageViewSymbolAnimationPresetClient> {
...
@property (setter=_setPreferredSymbolVariant:, nonatomic, retain) _UIImageSymbolVariant *_preferredSymbolVariant;
...
@property (setter=_setSymbolContentTransitionContainerView:, nonatomic) UIView *_symbolContentTransitionContainerView;
...
@property (nonatomic, copy) UIColor *itk_contentTintColor;
...
- (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })_additionalAlignmentRectInsetsForRenderingSource:(id)arg1;
- (void)_ancestorWillUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;
- (bool)_animatesContents;
- (void)_applyEffectsFromLayout:(id)arg1;
- (id)_applyImageEffectsToCIImage:(id)arg1 multiplyColor:(id)arg2;
- (void)_applyImageLayout:(id)arg1 toLayer:(id)arg2;
- (void)_applySettingsForLegibilityStyle:(long long)arg1;
- (id)_baseMultiplyColorWithImage:(id)arg1 symbolConfiguration:(id)arg2;
- (id)_baseMultiplyColorWithImage:(id)arg1 symbolConfiguration:(id)arg2 shouldResolveDynamicColors:(bool)arg3;
...
- (id)_colorByApplyingDrawMode:(unsigned int)arg1 toColor:(id)arg2;
- (id)_colorByApplyingDrawModeToColor:(id)arg1;
...
- (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })_edgeInsetsForEffectsForImage:(id)arg1;
- (id)_effectForRenderingSource:(id)arg1;
- (id)_effectiveContentEffectsWithImage:(id)arg1 symbolConfiguration:(id)arg2;
...
- (bool)_getDrawModeCompositeOperation:(int*)arg1 whiteComponent:(double*)arg2 drawingAlpha:(double*)arg3 forDrawMode:(unsigned int)arg4;
...
- (id)_imageLoader;
- (bool)_imageSupportsMaterials:(id)arg1 symbolConfiguration:(id)arg2;
...
- (id)_materialForImage:(id)arg1 symbolConfiguration:(id)arg2;
- (double)_maximumEDRForDynamicRange:(long long)arg1;
- (bool)_needsBoldEffectForImage:(id)arg1 symbolConfiguration:(id)arg2;
- (bool)_needsBoldEffectForImage:(id)arg1 symbolConfiguration:(id)arg2 withBaseColor:(id)arg3 withEffects:(id)arg4;
- (bool)_needsImageEffectsForImage:(id)arg1;
- (bool)_needsImageEffectsForImage:(id)arg1 symbolConfiguration:(id)arg2;
- (bool)_overrideTintColorAutomaticallyOverridesTintColor;
- (id)_overridingSymbolConfiguration;
- (id)_placeholderView;
- (id)_preferredSymbolVariant;
- (long long)_preferredVibrancy;
- (id)_rbSymbolLayer;
...
- (void)_renderDrawModeEffectInRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
- (id)_renditionForSource:(id)arg1 size:(struct CGSize { double x1; double x2; })arg2 symbolConfiguration:(id)arg3 withRenditionResult:(id)arg4;
...
- (void)_setLayerAllowsEdgeAntialiasing:(bool)arg1;
...
- (void)_setupSymbolLayerForCurrentSymbolImageLayout:(id)arg1;
...
- (bool)_shouldTreatImageAsTemplate:(id)arg1 symbolConfiguration:(id)arg2;
- (void)_stopLoading;
...
- (id)_symbolContentTransitionContainerView;
...
- (void)ccui_applyGlyphTintColor:(id)arg1;
...
+ (unsigned int)_headphoneDefaultFiltersID:(unsigned int)arg1;
+ (id)_headphoneGetAssetsDictionary:(unsigned int)arg1;
+ (bool)_headphoneIsProductOfDifferentColors:(unsigned int)arg1;

- (void)_headphoneApplyFilters:(id)arg1 pid:(unsigned int)arg2 darkMode:(bool)arg3 deviceColor:(unsigned int)arg4;
...
- (void)setItk_contentTintColor:(id)arg1;
