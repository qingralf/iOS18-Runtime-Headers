...
@property (nonatomic) bool expanded; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) double trackingChangeHysteresis; /* unknown property attribute: ? */
...
- (bool)overlay;
- (double)renderingHeightForDisplayEntry:(id)arg1;
