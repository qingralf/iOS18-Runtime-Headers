...
@property (nonatomic) bool isForDictation;
...
- (id)buttonPressed:(id)arg1 withEvent:(id)arg2 location:(struct CGPoint { double x1; double x2; })arg3 isLocationInsideViewHitArea:(bool)arg4 isForDictation:(bool)arg5 tapAction:(id /* block */)arg6;
...
- (void)reportHandBiasToAnalytics:(long long)arg1;
...
- (void)setIsForDictation:(bool)arg1;
