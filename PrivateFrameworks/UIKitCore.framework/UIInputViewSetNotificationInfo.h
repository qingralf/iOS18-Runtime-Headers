...
@interface UIInputViewSetNotificationInfo : NSObject {
    ...
    bool  _forWritingToolsSheet;
    bool  _forceNotification;
    bool  _nonKeyboardOverride;
...
@property (nonatomic) bool forWritingToolsSheet;
@property (nonatomic) bool forceNotification;
@property (nonatomic) bool nonKeyboardOverride;
...
- (void)setForWritingToolsSheet:(bool)arg1;
- (void)setForceNotification:(bool)arg1;
- (void)setNonKeyboardOverride:(bool)arg1;
