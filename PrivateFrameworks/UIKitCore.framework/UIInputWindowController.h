...
@interface UIInputWindowController : UIApplicationRotationFollowingControllerNoTouches <UIInputViewAnimationHost, UIKeyboardFloatingTransitionControllerDelegate, _UIInputHostController, _UITextEffectsSceneObserver> {
    ...
    bool  _externalTrackingUpdateInProgress;
...
@property (nonatomic, readonly) UIInputViewSetPlacement *animationAwarePlacement;
...
@property (nonatomic, retain) UIInputViewSetNotificationInfo *externalTrackingInfo;
@property (nonatomic) bool externalTrackingUpdateInProgress;
...
@property (nonatomic, retain) UIInputViewSetPlacement *placementDuringAnimation;
...
@property (nonatomic, retain) UITraitCollection *sizeClassCollectionOverride;
...
- (id)_infoForBackdropMatchMoveForLayer:(id)arg1;
...
- (void)animateKeyboardTrackingElementsWithNotificationInfo:(id)arg1 notificationType:(unsigned long long)arg2 updateForStart:(bool)arg3 updateForEnd:(bool)arg4;
...
- (int)hiddenCount;
- (void)hideGuideBackdrop:(bool)arg1;
...
- (struct CGSize { double x1; double x2; })keyboardSizeFromExternalUpdate;
...
- (void)refreshKeyboardLayoutGuideForce:(bool)arg1;
...
- (void)setExternalTrackingInfo:(id)arg1;
- (void)setExternalTrackingUpdateInProgress:(bool)arg1;
...
- (void)setPlacementDuringAnimation:(id)arg1;
...
- (void)setSizeClassCollectionOverride:(id)arg1;
...
- (id)sizeClassCollectionOverride;
...
- (id)transitionGuideBackdrop:(bool)arg1;
...
- (void)updateBackdropRenderConfig:(id)arg1;
- (void)updateForKeyplaneChangeWithContext:(id)arg1;
- (void)updateGestureRecognizers;
- (bool)updateGuideBackdropRenderConfig:(id)arg1 animated:(bool)arg2;
...
- (void)updateKeyboardLayoutGuideWithFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 layoutViews:(bool)arg2;
...
- (void)updateTrackingElementsWithOffset:(struct UIOffset { double x1; double x2; })arg1;
- (void)updateTrackingElementsWithSize:(struct CGSize { double x1; double x2; })arg1;
