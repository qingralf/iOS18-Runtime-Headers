...
@property (setter=setCombinedBackdropView:, nonatomic, retain) _UIKBLightEffectsBackground *_inputCombinedBackdropView;
@property (nonatomic, readonly) UIViewController *_inputViewController;
@property (nonatomic) bool animatingBackdrops;
...
- (id)_updateOrCreateConstraintInDict:(id)arg1 key:(id)arg2 fromItem:(id)arg3 toItem:(id)arg4 tracker:(id)arg5 creator:(id /* block */)arg6;
...
- (void)finalizeTransitionToRenderConfig:(id)arg1;
...
- (id)owner;
- (id)ownerView;
- (void)performAnimatedTransitionToRenderConfig:(id)arg1;
- (id)placement;
...
- (void)setAnimatingBackdrops:(bool)arg1;
- (void)setApplicator:(id)arg1;
- (void)setCombinedBackdropView:(id)arg1;
...
- (void)transitionInAnimatedForRenderConfig:(id)arg1;
- (void)updateCombinedBackdropView;
- (void)updateCombinedBackdropViewAnimated:(bool)arg1 forKeyboardUp:(bool)arg2;
...
- (void)updateRenderConfigForCombinedBackdrop:(id)arg1;
