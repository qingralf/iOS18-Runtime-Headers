...
@property (nonatomic, copy) NSUUID *authenticatingSessionIdentifier;
...
- (id)authenticatingSessionIdentifier;
...
- (void)forwardScrollEventToUIHost:(SEL)arg1 contentTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg2 environmentTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg3;
...
- (void)sendAutoFillDidInsertCallbacksWithTextOperations:(id)arg1;
- (void)setApplicationStateIsActiveForRTI:(bool)arg1;
- (void)setAuthenticatingSessionIdentifier:(id)arg1;
