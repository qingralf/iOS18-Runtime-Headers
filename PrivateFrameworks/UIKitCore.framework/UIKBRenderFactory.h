...
@property (nonatomic, readonly) double dynamicBottomRowMultiplier;
@property (nonatomic) bool dynamicFactory;
@property (nonatomic, readonly) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } dynamicInsets;
...
+ (Class)factoryClassForVisualStyle:(struct { unsigned int x1 : 6; unsigned int x2 : 1; unsigned int x3 : 1; unsigned int x4 : 8; unsigned int x5 : 8; unsigned int x6 : 8; })arg1 renderingContext:(id)arg2;
...
- (void)customizeMicOnTraitsForTraits:(id)arg1 lightKeyboard:(bool)arg2 keyState:(int)arg3;
- (id)cutKeyImageName;
...
- (void)setDynamicFactory:(bool)arg1;
