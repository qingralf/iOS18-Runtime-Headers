...
@property (nonatomic) struct CGSize { double x1; double x2; } floatingContentViewFocusedIncreaseSize;
...
- (id)description;
- (id)extraFiltersForType:(id)arg1;
- (id)fallbackSymbolStyle;
- (double)floatingContentViewCornerRadius;
- (struct CGSize { double x1; double x2; })floatingContentViewFocusedIncreaseSize;
...
- (void)setFloatingContentViewCornerRadius:(double)arg1;
- (void)setFloatingContentViewFocusedIncreaseSize:(struct CGSize { double x1; double x2; })arg1;
- (void)setFloatingContentViewShadowOpacity:(double)arg1;
- (void)setFloatingContentViewShadowRadius:(double)arg1;
- (void)setFloatingContentViewShadowVerticalOffset:(double)arg1;
