...
@interface UIKBScreenTraits : NSObject {
    ...
    bool  _isStickerPickerServiceCollectionView;
...
@property (nonatomic) struct CGSize { double x1; double x2; } preferredContentSizeInPopover;
...
+ (id)traitsForRemoteEmojiKeyboardForHostWidth:(double)arg1 clientWidth:(double)arg2 minorEdge:(bool)arg3 orientation:(long long)arg4 idiom:(long long)arg5 isPopover:(bool)arg6;
...
- (struct CGSize { double x1; double x2; })preferredContentSizeInPopover;
...
- (void)setPreferredContentSizeInPopover:(struct CGSize { double x1; double x2; })arg1;
