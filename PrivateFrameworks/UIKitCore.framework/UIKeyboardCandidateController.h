...
@interface UIKeyboardCandidateController : NSObject <TUICandidateViewDelegate, UIGestureRecognizerDelegate, UIKeyboardCandidateList, UIKeyboardCandidateSceneHostingControllerDelegate, UIKeyboardHostedCandidateInlineFloatingViewDelegate, _UIAssertionControllerSubject> {
    ...
    bool  _hideDisambiguationCandidates;
    UIView * _hostedInlineViewContainer;
    UIKeyboardCandidateSceneHostingController * _hostingController;
    ...
    bool  _isExtended;
    bool  _isTextEffectsButtonPresented;
...
@property (nonatomic) bool hideDisambiguationCandidates;
@property (nonatomic) bool hostTextIsVertical;
@property (nonatomic, retain) UIView *hostedInlineViewContainer;
@property (nonatomic, retain) UIKeyboardCandidateSceneHostingController *hostingController;
@property (nonatomic, readonly) UIView *hostingParentView;
...
@property (nonatomic) bool isTextEffectsButtonPresented;
...
- (void)clientExpandedStateChanged:(bool)arg1;
- (void)clientStateChangedWithIsExpanded:(bool)arg1 isVisible:(bool)arg2;
- (void)clientVisibilityChanged:(bool)arg1;
- (void)collapse;
- (id)currentCandidate;
...
- (id)hostedInlineViewContainer;
- (id)hostingController;
- (id)hostingParentView;
...
- (id)obtainHideDisambiguationCandidatesAssertionForReason:(id)arg1;
- (id)opacities;
...
- (void)setCandidates:(id)arg1 type:(int)arg2 inlineText:(id)arg3 inlineRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg4 maxX:(double)arg5 layout:(bool)arg6 inlineCandidatesAreHosted:(bool)arg7;
...
- (void)setHideDisambiguationCandidates:(bool)arg1;
- (void)setHostedInlineViewContainer:(id)arg1;
...
- (void)setInlineState:(id)arg1 extended:(bool)arg2 animated:(bool)arg3 options:(unsigned long long)arg4 force:(bool)arg5 completion:(id /* block */)arg6;
...
- (void)setIsTextEffectsButtonPresented:(bool)arg1;
- (void)setKey:(id)arg1;
...
- (void)updateArrowButtonImageNameToState:(id)arg1;
- (void)updateConfigurations;
- (void)updateHostedInlineCandidatesWithInlineText:(id)arg1 type:(int)arg2 inlineRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg3 maxX:(double)arg4 layout:(bool)arg5;
