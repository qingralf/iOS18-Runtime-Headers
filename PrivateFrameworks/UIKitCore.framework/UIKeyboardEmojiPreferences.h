...
- (void)_usageForEmoji:(id)arg1 language:(id)arg2 associatedText:(id)arg3 resultIndex:(id)arg4 isFromRecentsCategory:(bool)arg5 isFromEmojiSearch:(bool)arg6 isFromCandidateBar:(bool)arg7 completionHandler:(id /* block */)arg8;
...
- (void)emojiUsedFromEmojiKeyboardPalette:(id)arg1 inputModeIdentifier:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)emojiUsedFromEmojiKeyboardSearch:(id)arg1 inputModeIdentifier:(id)arg2 resultIndex:(id)arg3 query:(id)arg4 completionHandler:(id /* block */)arg5;
