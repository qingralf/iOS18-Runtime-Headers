...
@property (nonatomic, retain) _UIKBLightEffectsBackground *lightEffectsTransitionBackdrop;
...
- (void)beginTransitionAtPoint:(struct CGPoint { double x1; double x2; })arg1 withScale:(double)arg2 recognizer:(id)arg3;
...
- (void)initializeContextAtPoint:(struct CGPoint { double x1; double x2; })arg1 recognizer:(id)arg2;
...
- (id)lightEffectsTransitionBackdrop;
...
- (void)setLightEffectsTransitionBackdrop:(id)arg1;
