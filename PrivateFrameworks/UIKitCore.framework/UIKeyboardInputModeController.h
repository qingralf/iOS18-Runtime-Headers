...
@property (nonatomic, readonly) NSString *hardwareKeyboardExclusivityIdentifier;
@property (nonatomic, copy) NSString *inputModeContextIdentifier;
@property (nonatomic, retain) UIKeyboardInputMode *inputModeThatInvokeEmoji;
...
@property (nonatomic, readonly) NSString *textEffectsButtonLanguageCode;
...
+ (id)multilingualSetForInputModeIdentifier:(id)arg1;
...
- (void)setInputModeThatInvokeEmoji:(id)arg1;
...
- (id)textEffectsButtonLanguageCode;
