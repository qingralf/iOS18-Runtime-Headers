...
@interface UIKeyboardLayoutStar : UIKeyboardLayout <UIKBEmojiHitTestResponder, UIKBKeyplaneViewDelegate, UIKBResizingKeyplaneCoordinatorCoordinatorDelegate, UIKeyboardKeyplaneTransitionDelegate, UIKeyboardPinchGestureRecognizerDelegate, UIKeyboardTypingStyleEstimatorDelegate> {
    ...
    id  _spaceTarget;
    <UIKeyboardKeyplaneTransitionDelegate> * _splitKeyplaneTransitionDelegate;
...
@property (nonatomic, retain) UIKeyboardPathEffectView *pathEffectView;
...
- (void)setPathEffectView:(id)arg1;
...
- (void)setRenderConfig:(id)arg1 updateKeyplane:(bool)arg2;
...
- (void)showKeyboardWithInputMode:(id)arg1 renderConfig:(id)arg2 inputTraits:(id)arg3 screenTraits:(id)arg4 splitTraits:(id)arg5 reload:(bool)arg6;
