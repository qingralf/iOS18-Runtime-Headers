...
@property (nonatomic, retain) UIGlomojiAnalyticsDispatcher *glomojiAnalyticsInstance;
...
- (long long)getRowFromPoint:(struct CGPoint { double x1; double x2; })arg1;
- (id)glomojiAnalyticsInstance;
- (void)hide;
...
- (void)setGlomojiAnalyticsInstance:(id)arg1;
