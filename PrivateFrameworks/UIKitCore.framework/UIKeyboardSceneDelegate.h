...
@property (nonatomic, retain) NSString *hardwareKeyboardExclusivityIdentifier;
...
- (id)_placementForDeactivatedKeyboard:(bool)arg1 currentPlacement:(id)arg2 forSuppressionAssertion:(bool)arg3 wantsAssistant:(bool)arg4 keepAccessories:(bool)arg5;
...
- (id)_simpleViewDescriptionForLogging:(id)arg1;
...
- (void)_updateVisibilityObserversWithReset:(bool)arg1;
...
- (void)addTrackingElement:(id)arg1;
...
- (void)removeTrackingElement:(id)arg1;
...
- (void)setHideSystemInputAssistantViewForWritingTools:(bool)arg1;
...
- (void)updateLightEffectsBackdropAnimated:(bool)arg1;
- (void)updateLocalKeyboardChanged:(id)arg1;
- (void)updateRemoteKeyboardChanged:(id)arg1;
...
- (void)updateTrackingElementsForOffset:(struct UIOffset { double x1; double x2; })arg1;
- (void)updateTrackingElementsForSize:(struct CGSize { double x1; double x2; })arg1;
