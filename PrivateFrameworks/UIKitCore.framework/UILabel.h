...
@interface UILabel : UIView <ABText, HUActsAsLabel, MPUAutoupdatingTextContainer, MUWidthMeasurable, NSCoding, NUCrossFadeViewAnimatable, SBUISystemApertureAccessoryView, UIContentSizeCategoryAdjusting, UILetterformAwareAdjusting, _UILabelVisualStyleSubject, _UIMultilineTextContentSizing, _UIViewBaselineSpacing, _UIViewLanguageAwareAdjusting> {
    _UILabelConfiguration * __configuration;
    <_UILabelImplProtocol> * __impl;
...
@property (setter=_setAssociatedScalingLabel:, nonatomic, retain) UILabel *_associatedScalingLabel;
...
@property (setter=_setDrawingLightInertLayer:, nonatomic) bool _drawingLightInertLayer;
@property (setter=_setDrawingLightReactiveLayer:, nonatomic) bool _drawingLightReactiveLayer;
...
@property (setter=_setLightSourceDescriptor:, nonatomic, retain) _UIIntelligenceLightSourceDescriptor *_lightSourceDescriptor;
...
@property (nonatomic, copy) NSAttributedString *attributedText; /* unknown property attribute: ? */
...
@property (nonatomic, retain) UIFont *font; /* unknown property attribute: ? */
...
- (void)_addViewsForLabelViewTextAttachments:(id)arg1 previousLabelViewTextAttachments:(id)arg2;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })_glyphPathsBoundingRect;
- (bool)_hasBaseline;
...
- (void)_setAssociatedScalingLabel:(id)arg1;
...
- (void)_setDrawingLightInertLayer:(bool)arg1;
- (void)_setDrawingLightReactiveLayer:(bool)arg1;
...
- (void)_setLightSourceDescriptor:(id)arg1;
...
- (void)_setVerticalTextEnabled:(bool)arg1;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })_tightBoundingRect;
...
- (void)setMarqueeLoopPadding:(double)arg1;
- (void)setMarqueeRepeatCount:(unsigned long long)arg1;
...
+ (id)sf_startPageBannerTitleLabelWithFont:(id)arg1;
