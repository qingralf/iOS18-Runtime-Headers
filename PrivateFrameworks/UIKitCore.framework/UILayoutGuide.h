...
@interface UILayoutGuide : NSObject <AVKitLayoutItem, HULayoutAnchorProviding, MUCompositionalStackLayoutItemInternal, MULayoutItem, NSCoding, NSISVariableDelegate, SearchUIAutoLayoutItem, UILayoutItem_Internal, _UILayoutItem, _UIPopoverPresentationControllerSourceItem_Internal> {
...
@property (nonatomic, readonly) bool _isSafeAreaAspectFitLayoutGuide;
