...
@interface UIMenu : UIMenuElement <_UIMenuElementStateObserver> {
    ...
    bool  _hasCustomizedDisplayPreferences;
    UIView * _headerView;
...
@property (nonatomic, copy) UIMenuDisplayPreferences *displayPreferences;
...
- (id)_mutableCopy;
- (void)_resolveElementSizeWithContext:(id)arg1;
- (long long)_resolvedElementSize;
...
- (void)setDisplayPreferences:(id)arg1;
...
+ (long long)ck_indexOfMenuWithMenuIdentifier:(id)arg1 inMenuElementsArray:(id)arg2;
+ (long long)ck_menuInsertionIndexAfterIndex:(unsigned long long)arg1 inMenuElementsArray:(id)arg2;

// Image: /System/Library/PrivateFrameworks/InputToolKitUI.framework/InputToolKitUI

+ (id)itk_menuWithItems:(id)arg1 title:(id)arg2;
+ (id)itk_menuWithItems:(id)arg1 title:(id)arg2 subtitle:(id)arg3;
+ (id)itk_menuWithItems:(id)arg1 title:(id)arg2 subtitle:(id)arg3 image:(id)arg4;

- (id)itk_addItems:(id)arg1;
- (id)itk_addNonNilItem:(id)arg1;
- (id)itk_addNonNilItems:(id)arg1;
...
+ (id)safari_recentlyClosedTabsMenuItemsForProfile:(id)arg1 openHandler:(id /* block */)arg2;
...
- (void)didClose;
- (id)mergingWithPhotosInternalMenu:(id)arg1;
- (id)onClose:(id /* block */)arg1;
- (id)onOpen:(id /* block */)arg1;
- (void)willOpen;
