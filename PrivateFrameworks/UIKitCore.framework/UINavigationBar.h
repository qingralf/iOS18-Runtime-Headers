...
@property (getter=_isActiveTabBarHost, setter=_setActiveTabBarHost:, nonatomic) bool _activeTabBarHost;
...
@property (getter=_wasDecodedUnlockedWithNavigationControllerDelegate, setter=_setDecodedUnlockedWithNavigationControllerDelegate:, nonatomic) bool _decodedUnlockedWithNavigationControllerDelegate;
...
@property (nonatomic, readonly) bool _lostNavigationControllerDelegate;
...
@property (nonatomic, readonly) bool _scrollEdgeAppearanceHasChromelessBehavior;
...
@property (setter=_setTabBarHostedView:, nonatomic, retain) _UITabContainerView *_tabBarHostedView;
...
@property (setter=_setWantsHostedTabBarMetrics:, nonatomic) bool _wantsHostedTabBarMetrics;
...
@property (nonatomic, readonly, retain) NSString *smu_backdropLayerGroupName;
...
+ (Class)_visualProviderClassForNavigationBar:(id)arg1;
...
- (id)_effectiveDelegateForItem:(id)arg1;
...
- (void)_searchScopeBarWillManuallyShowOrHideForNavigationItem:(id)arg1;
...
- (void)_setActiveTabBarHost:(bool)arg1;
...
- (void)_setDecodedUnlockedWithNavigationControllerDelegate:(bool)arg1;
...
- (void)_setStaticNavBarButtonItem:(id)arg1 trailingPosition:(bool)arg2;
...
- (void)_setWantsHostedTabBarMetrics:(bool)arg1;
...
+ (bool)mf_canUseDesktopClassNavigationBar;
+ (bool)mf_shouldUseDesktopClassNavigationBarForTraitCollection:(id)arg1;
...
- (void)siriui_customizeAppearanceGivenSAEEnabled:(bool)arg1;

// Image: /System/Library/PrivateFrameworks/TeaUI.framework/TeaUI

+ (bool)ts_chromelessBarsEnabled;

- (id)fetchCustomTitleViewInView:(id)arg1;
- (id)fetchRegularTitleViewInView:(id)arg1;
- (void)syncBarButtonItems:(id)arg1;
