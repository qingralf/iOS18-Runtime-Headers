...
@interface UINavigationController : UIViewController <AISViewControllerPresentationHandlerProtocol, GKContentRefresh, GKURLHandling, HUPreloadableViewController, HUPresentationDelegate, PASViewControllerPresentationHandlerProtocol, PKUIFlowManagerRenderer, RUIHostingController, UIGestureRecognizerDelegatePrivate, UIInterfaceOrientationMaskOverride, UILayoutContainerViewDelegate, _UINavigationBarDelegatePrivate, _UIScrollViewScrollObserver, _UITVScrollViewManagerDelegate, _UIToolbarDelegateInternal, _UIViewControllerTransitionConductorDelegate> {
    ...
    bool  __wantsTabCrossFadeTransition;
    ...
    <_UIInvalidatable> * _windowRotationLockAssertion;
}
...
@property (setter=_setManagedTabGroup:, nonatomic) UITabGroup *_managedTabGroup;
...
@property (nonatomic, readonly) _UIViewControllerTransitionConductor *_transitionConductor;
...
@property (setter=_setWantsTabCrossfadeTransition:, nonatomic) bool _wantsTabCrossFadeTransition;
...
@property (nonatomic, readonly) UIView *navigationTransitionView;
...
@property (nonatomic, readonly, retain) UIViewController *ts_bottomViewController;
...
- (void)_applyViewControllers:(id /* block */)arg1 transition:(int)arg2 animated:(bool)arg3 operation:(long long)arg4 rescheduleBlock:(id /* block */)arg5;
...
- (void)_didCancelTransitionFromViewController:(id)arg1 toViewController:(id)arg2 wrapperView:(id)arg3 wasCustom:(bool)arg4;
- (void)_didEndTransitionFromView:(id)arg1 toView:(id)arg2 wasCustom:(bool)arg3;
...
- (id)_effectiveDelegateForNavigationItem:(id)arg1;
- (id)_effectiveInteractionActivityTrackingBaseName;
- (int)_effectiveTransitionForTransition:(int)arg1;
- (void)_ensureToViewControllersViewIsLoaded:(id)arg1;
...
- (void)_immediatelyApplyViewControllers:(id)arg1 transition:(int)arg2 animated:(bool)arg3 operation:(long long)arg4;
...
- (void)_navigationBarDidUpdateVisibility:(id)arg1;
...
- (bool)_sanityCheckPushViewController:(id)arg1 transition:(int)arg2 forceImmediate:(bool)arg3;
...
- (void)_scrollToRevealNavigationBarPart:(long long)arg1 animated:(bool)arg2;
...
- (void)_setAllowsInteractivePopWhenNavigationBarHidden:(bool)arg1;
...
- (void)_setManagedTabGroup:(id)arg1;
...
- (void)_setUpHostedRefreshControlForScrollView:(id)arg1;
...
- (void)_setWantsTabCrossfadeTransition:(bool)arg1;
...
- (bool)_shouldCrossFadeNavigationBarBackgroundVisibility;
...
- (void)_updateBottomBarHiddenStateFromOtherNavigationController:(id)arg1;
...
- (void)_updateNavigationBar:(id)arg1 fromItems:(id)arg2 toItems:(id)arg3 animated:(bool)arg4;
...
- (id)disappearingViewControllerForTransitionConductor:(id)arg1;
...
- (id)inputViewAnimationStyleForTransitionConductor:(id)arg1;
...
- (id)topViewControllerForTransitionConductor:(id)arg1;
- (void)transitionConductor:(id)arg1 beginPinningInputViewsForTransitionFromViewController:(id)arg2 toViewController:(id)arg3 forTransitionType:(int)arg4;
- (void)transitionConductor:(id)arg1 didEndCustomTransitionWithContext:(id)arg2 didComplete:(bool)arg3;
- (void)transitionConductor:(id)arg1 didEndTransitionFromView:(id)arg2 toView:(id)arg3;
- (void)transitionConductor:(id)arg1 didStartCustomTransitionWithContext:(id)arg2;
- (void)transitionConductor:(id)arg1 didStartDeferredTransition:(bool)arg2 context:(id)arg3;
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })transitionConductor:(id)arg1 frameForViewController:(id)arg2;
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })transitionConductor:(id)arg1 frameForWrapperViewForViewController:(id)arg2;
- (void)transitionConductor:(id)arg1 interactiveTransitionDidUpdateProgress:(double)arg2 finish:(bool)arg3 transitionCompleted:(bool)arg4 transitionContext:(id)arg5;
- (id)transitionConductor:(id)arg1 retargetedToViewControllerForTransitionFromViewController:(id)arg2 toViewController:(id)arg3 transition:(int)arg4;
- (void)transitionConductor:(id)arg1 willTransitionFromViewController:(id)arg2 toViewController:(id)arg3;
- (void)transitionConductorDidStartImmediateTransition:(id)arg1;
- (void)transitionConductorWillStartImmediateTransition:(id)arg1;
...
- (void)_updateViewControllerStackWithViewController:(id)arg1;
...
- (void)vs_popToViewController:(id)arg1 animated:(bool)arg2 completion:(id /* block */)arg3;
