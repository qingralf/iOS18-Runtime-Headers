...
@property (setter=_setAllowsInteractivePop:, nonatomic) bool _allowsInteractivePop;
@property (setter=_setAllowsInteractivePopWhenNavigationBarHidden:, nonatomic) bool _allowsInteractivePopWhenNavigationBarHidden;
...
@property (getter=_navigationBar, setter=_setNavigationBar:, nonatomic, retain) UINavigationBar *_navigationBar;
@property (getter=_isNavigationBarHidden, setter=_setNavigationBarHidden:, nonatomic) bool _navigationBarHidden;
@property (nonatomic, readonly) unsigned long long _navigationBarVisibility;
@property (setter=_setPendingTitle:, nonatomic, copy) NSString *_pendingTitle;
@property (setter=_setPreferredNavigationBarVisibility:, nonatomic) unsigned long long _preferredNavigationBarVisibility;
...
@property (setter=_setTopPalette:, nonatomic, retain) _UINavigationBarPalette *_topPalette;
...
@property (nonatomic, retain) UIColor *preferredNavigationBarTintColor;
...
- (id)_effectiveTitleForTitle:(id)arg1;
...
- (id)_navigationBar;
- (unsigned long long)_navigationBarVisibility;
- (id)_pendingTitle;
- (unsigned long long)_preferredNavigationBarVisibility;
...
- (void)_setAllowsInteractivePop:(bool)arg1;
...
- (void)_setPreferredNavigationBarVisibility:(unsigned long long)arg1;
...
- (void)setPreferredNavigationBarTintColor:(id)arg1;
