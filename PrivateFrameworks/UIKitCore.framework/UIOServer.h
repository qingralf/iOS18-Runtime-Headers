...
+ (id)_identifierForSceneType:(long long)arg1 spaceIdentifier:(id)arg2;
+ (id)displayDelegateIdentifierForScene:(id)arg1;
+ (id)sharedInstance;

- (void).cxx_destruct;
- (void)_fulfillAwaitingDisplayDelegate:(id)arg1 forIdentifier:(id)arg2;
- (void)activate;
- (void)awaitDisplayDelegateForAction:(id)arg1 sceneType:(long long)arg2 timeout:(double)arg3 completion:(id /* block */)arg4;
