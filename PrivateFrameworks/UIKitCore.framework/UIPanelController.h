...
@property (setter=_setLeadingBorderView:, nonatomic, retain) UIPanelBorderView *_leadingBorderView;
@property (setter=_setNeedsFirstTimeUpdateForTraitCollection:, nonatomic) bool _needsFirstTimeUpdateForTraitCollection;
@property (setter=_setOverlayEdgeShadowView:, nonatomic, retain) _UIDuoShadowView *_overlayEdgeShadowView;
@property (setter=_setPreviousInternalState:, nonatomic, retain) _UIPanelInternalState *_previousInternalState;
@property (setter=_setLeadingPanelShadowView:, nonatomic, retain) _UIDuoShadowView *_primaryOrSupplementaryShadowView;
...
@property (setter=_setSupplementaryBorderView:, nonatomic, retain) UIPanelBorderView *_supplementaryBorderView;
@property (setter=_setSupplementaryParallaxShadowView:, nonatomic, retain) _UIDuoShadowView *_supplementaryParallaxShadowView;
@property (setter=_setSuspendedConfiguration:, nonatomic, retain) UISlidingBarConfiguration *_suspendedConfiguration;
@property (setter=_setTrailingBorderView:, nonatomic, retain) UIPanelBorderView *_trailingBorderView;
...
@property (nonatomic) bool wantsFloatingSidebar;
...
- (id)_primaryOrSupplementaryShadowView;
...
- (void)_setLeadingPanelShadowView:(id)arg1;
...
- (void)setMainViewController:(id)arg1 changingParentage:(bool)arg2 animateTransition:(bool)arg3;
...
- (void)setShowShadowViews:(bool)arg1;
...
- (void)setWantsFloatingSidebar:(bool)arg1;
