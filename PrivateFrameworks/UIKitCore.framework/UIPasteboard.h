...
@property (readonly, copy) NSArray *pcxTypes;
...
- (void)__ck_compositionWithContext:(id)arg1 completionHandler:(id /* block */)arg2;
- (id)__ck_mediaObjectManager;

// Image: /System/Library/PrivateFrameworks/MobileSafari.framework/MobileSafari

+ (bool)safari_canCopyLinksForTabs:(id)arg1;

- (void)_safari_copyRichText:(id)arg1 withPlainTextFallback:(id)arg2;
- (void)safari_copyLinksForTabGroup:(id)arg1;
- (void)safari_copyLinksForTabs:(id)arg1;
...
+ (id)pcxPasteboardWithName:(id)arg1;

- (long long)pcxClearContents;
- (id)pcxDataForType:(id)arg1;
- (id)pcxString;
- (id)pcxTypes;
