...
@interface UIPercentDrivenInteractiveTransition : NSObject <UIViewControllerInteractiveTransitioning> {
    bool  __clampsPercentComplete;
    NSString * __originalFillMode;
    bool  __transitionInterrupted;
    bool  __usesPacedFractionComplete;
    NSUUID * __uuid;
...
@property (setter=_setClampsPercentComplete:, nonatomic) bool _clampsPercentComplete;
...
@property (setter=_setUsesPacedFractionComplete:, nonatomic) bool _usesPacedFractionComplete;
...
- (void)_continueInterruptibleTransitionFromPercentComplete:(double)arg1 reversed:(bool)arg2;
- (double)_durationFactorForPercentComplete:(double)arg1 reversed:(bool)arg2;
- (bool)_isTransitionInterrupted;
- (id)_originalFillMode;
- (void)_resetInteractionController;
- (void)_setClampsPercentComplete:(bool)arg1;
- (void)_setDuration:(double)arg1;
- (void)_setOriginalFillMode:(id)arg1;
- (void)_setTransitionInterrupted:(bool)arg1;
- (void)_setUsesPacedFractionComplete:(bool)arg1;
