...
- (void)_addMagnifierForRowHeight:(double)arg1;
...
- (id)_contentView;
- (id)_createColumnWithTableFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 rowHeight:(double)arg2 paddingAroundWheels:(double)arg3;
