...
@property (nonatomic, readonly) double liftForceExponent;
@property (nonatomic, readonly) double liftProgressFloor;
@property (nonatomic, readonly) UIViewSpringAnimationBehavior *liftProgressSpring;
