...
@interface UIPresentationController : NSObject <UIAppearanceContainer, UIContentContainer, UIFocusEnvironment, UIGestureRecognizerDelegate, UITraitChangeObservable, UITraitChangeObservableInternal, UITraitEnvironment, _UIAppearanceContainer, _UIContentContainerInternal, _UIFallbackEnvironment, _UIGeometryChangeObserver, _UITraitEnvironmentInternal, _UITraitOverrideDelegate, _UITraitTrackingSupporting> {
    ...
    bool  _hasObservationTrackingDictionary;
...
@property (nonatomic, readonly) <UIViewControllerTransitionCoordinator> *_definiteTransitionCoordinator;
...
@property (nonatomic, readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } _occludedFrameOfPresentedViewInContainerView;
...
@property (nonatomic, readonly) bool _presentingOrPresented;
...
@property (nonatomic, readonly) _UIViewControllerTransitionContext *_transitionContext;
@property (nonatomic, readonly) <UIViewControllerTransitionCoordinator> *_transitionCoordinator;
...
@property (nonatomic, readonly) bool _wantsContentOverlayInsetsUpdatesWhileDismissing;
...
- (void)_dismissWithAnimationController:(id)arg1 interactionController:(id)arg2 animated:(bool)arg3 handoffData:(id)arg4;
...
- (bool)_monitorsSystemLayoutFittingSize;
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })_occludedFrameOfPresentedViewInContainerView;
...
- (void)_presentWithAnimationController:(id)arg1 inWindow:(id)arg2 interactionController:(id)arg3 animated:(bool)arg4 handoffData:(id)arg5;
...
- (bool)_shouldCallAppearanceCallbacksFor:(id)arg1;
- (bool)_shouldContinueTouchesOnTargetViewController;
...
- (bool)_shouldPerformWillTransitionToTraitCollectionForParent:(id)arg1;
...
- (void)_updateTraitsIfNecessaryInitiatingPropagation:(bool)arg1;
...
- (void)runTransitionForCurrentStateAnimated:(bool)arg1 handoffData:(id)arg2;
