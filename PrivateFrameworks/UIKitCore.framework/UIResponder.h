...
@property (setter=_setSmartReplyFeedbackInputDashboardViewController:, nonatomic, retain) UIViewController<UIPredictiveViewController> *_smartReplyFeedbackInputDashboardViewController;
@property (nonatomic, readonly) UIView<UITextInputPrivate> *_textSelectingContainer; /* unknown property attribute: ? */
@property (setter=_setWritingToolsInputDashboardViewController:, nonatomic, retain) UIViewController<UIPredictiveViewController> *_writingToolsInputDashboardViewController;
...
- (id)_asTextSelection;
- (id)_assistantBarButtonItemForWritingToolsWithStyle:(long long)arg1;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })_selectionRectForWritingTools;
...
- (void)_setCommonUIInvocationAnimationNeeded:(bool)arg1;
...
- (void)_setSmartReplyFeedbackInputDashboardViewController:(id)arg1;
- (void)_setSuppressSoftwareKeyboard:(bool)arg1;
- (void)_setSuppressWritingToolsForRemoteKeyboard:(bool)arg1;
- (void)_setWritingToolsInputDashboardViewController:(id)arg1;
- (void)_setWritingToolsViewController:(id)arg1;
- (void)_setWritingToolsWantsKeyboardSuppression:(bool)arg1;
- (void)_setWritingToolsWantsKeyboardSuppression:(bool)arg1 suppressAssistant:(bool)arg2;
- (void)_share:(id)arg1;
...
- (id)_smartReplyFeedbackInputDashboardViewController;
- (void)_startProofreadingFromCandidateBar;
- (void)_startRewritingFromCandidateBar;
- (void)_startWritingToolsWithTool:(id)arg1 prompt:(id)arg2 entryPoint:(id)arg3 inputContextHistory:(id)arg4 sender:(id)arg5;
- (void)_startWritingToolsWithTool:(id)arg1 prompt:(id)arg2 sender:(id)arg3;
...
- (id)_writingToolsInputDashboardViewController;
