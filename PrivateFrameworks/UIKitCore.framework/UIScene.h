...
@interface UIScene : UIResponder <BSDebugDescriptionProviding, FBSSceneDelegate, PBPosterSceneSettings, _UIRemoteContentParent> {
...
@property (nonatomic, readonly) _UIChildRemoteContentRegistry *_childRemoteContentRegistry;
...
@property (nonatomic, readonly) _UIApplicationSceneDisplayClientComponent *_displayClientComponent;
...
@property (nonatomic, readonly) <_UIHomeAffordanceNotifying> *_existingHomeAffordanceSceneNotifier;
...
@property (nonatomic, readonly) GCSceneComponent *_gameControllerSceneComponent;
...
@property (nonatomic, readonly) _UIHDRUsageCoordinatorSceneComponent *_hdrUsageCoordinatorSceneComponent;
@property (nonatomic, readonly) <_UIHomeAffordanceNotifying> *_homeAffordanceSceneNotifier;
@property (nonatomic, readonly) bool _hostsWindows;
@property (nonatomic, readonly) NSString *_identifier;
@property (nonatomic, readonly) <_UISceneHostingIntelligenceSupportClient> *_intelligenceClientSceneComponent;
@property (nonatomic, readonly) _UIInterfaceProtectionSceneComponent *_interfaceProtectionSceneComponent;
...
@property (nonatomic, readonly) _UIApplicationSceneKeyboardClientComponent *_keyboardClientComponent;
...
@property (nonatomic, readonly) UISceneSystemProtectionManager *systemProtectionManager;
...
- (id)_childRemoteContentRegistry;
...
- (id)_existingHomeAffordanceSceneNotifier;
...
- (id)_hdrUsageCoordinatorSceneComponent;
- (id)_homeAffordanceSceneNotifier;
- (bool)_hostsWindows;
- (id)_identifier;
- (void)_initializeSceneComponents;
- (id)_intelligenceClientSceneComponent;
- (id)_interfaceProtectionSceneComponent;
