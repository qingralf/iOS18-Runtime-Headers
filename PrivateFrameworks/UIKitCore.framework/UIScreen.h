...
@interface UIScreen : NSObject <BSDebugDescriptionProviding, INUIImageLoaderDelegate, PXDynamicRangeDisplayContext, UICoordinateSpace, UIFocusItemContainer, UITraitEnvironment, _CRKImageLoaderDelegate, _UIFallbackEnvironment, _UIFocusEnvironmentInternal, _UIFocusEnvironmentPrivate, _UIOrientationDebugDescriptionProviding, _UITraitEnvironmentInternal> {
...
@property (getter=_carSession, nonatomic, retain) CARSession *carSession;
...
@property (nonatomic, readonly) <UITraitOverrides> *traitOverrides; /* unknown property attribute: ? */
...
- (void)_setSceneProvidedDisplayCornerRadius:(double)arg1;
...
- (id)itk_displayLinkWithTarget:(id)arg1 selector:(SEL)arg2;
...
+ (bool)tsk_pad1133H;
+ (bool)tsk_pad1180H;
+ (bool)tsk_pad1180HOrLarger;
+ (bool)tsk_pad1194H;
+ (bool)tsk_pad1210H;
+ (bool)tsk_pad1210HOrLarger;
+ (bool)tsk_pad1366H;
+ (bool)tsk_pad1366HOrLarger;
+ (bool)tsk_pad1373H;
+ (bool)tsk_pad1373HOrLarger;
+ (bool)tsk_pad1376H;
+ (bool)tsk_pad1376HOrLarger;
+ (bool)tsk_pad1389H;
+ (bool)tsk_pad1408H;
+ (bool)tsk_pad1590H;
