...
@interface UIScreenEdgePanGestureRecognizer : UIPanGestureRecognizer <_UIAssertionControllerSubject, _UISEGestureFeatureDelegate> {
    id /* block */  _createFeatureBlock;
    unsigned long long  _edges;
    _UIAssertionController * _ignoreHIDEdgeFlagsAssertionController;
    <_UIAssertion> * _mustIgnoreHIDEdgeFlagsAssertion;
...
- (void).cxx_destruct;
- (id)_beginRequiringIgnoresHIDEdgeFlagsForReason:(id)arg1;
...
- (void)_setRecognizesWithoutEdge:(bool)arg1;
