...
@interface UIScrollView : UIView <ICNestedScrollViewPanInteractionDelegate, NSCoding, UIFocusItemScrollableContainer, UIGestureRecognizerDelegateInternal, UIIndexBarAccessoryViewDelegate, UIPanGestureRecognizerDelegateInternal, UIScrollViewDelayedTouchesBeganGestureRecognizerClient, _UIAssertionControllerSubject, _UIPressGestureRecognizerDelegate, _UIScrollEventAsyncDeliveryTarget, _UIScrollToTopView> {
    ...
    bool  _scrollAnimatingViaAssertion;
...
@property (setter=_setIsTransientScrollView:, nonatomic) bool _isTransientScrollView;
...
@property (nonatomic, readonly) bool _wk_canScrollHorizontallyWithoutBouncing;
@property (nonatomic, readonly) bool _wk_canScrollVerticallyWithoutBouncing;
@property (nonatomic, readonly) double _wk_contentHeightIncludingInsets;
@property (nonatomic, readonly) double _wk_contentWidthIncludingInsets;
@property (nonatomic, readonly) bool _wk_isInterruptingDeceleration;
@property (nonatomic, readonly) bool _wk_isScrollAnimating;
@property (nonatomic, readonly) bool _wk_isScrolledBeyondExtents;
@property (nonatomic, readonly) bool _wk_isZoomAnimating;
...
@property (nonatomic) struct CGPoint { double x1; double x2; } contentAlignmentPoint;
...
@property (readonly) struct CGPoint { double x1; double x2; } px_maximumContentOffset;
@property (readonly) struct CGPoint { double x1; double x2; } px_minimumContentOffset;
@property (nonatomic, readonly) unsigned long long px_scrollableAxis;
@property (nonatomic, retain) UIRefreshControl *refreshControl;
@property (getter=isScrollAnimating, nonatomic, readonly) bool scrollAnimating;
...
- (void)_animateScrollToContentOffset:(struct CGPoint { double x1; double x2; })arg1 animationCurve:(int)arg2 animationAdjustsForContentOffsetDelta:(bool)arg3 animation:(id)arg4;
- (void)_animateScrollToContentOffset:(struct CGPoint { double x1; double x2; })arg1 animationCurve:(int)arg2 animationAdjustsForContentOffsetDelta:(bool)arg3 animation:(id)arg4 animationConfigurator:(id /* block */)arg5;
- (struct CGPoint { double x1; double x2; })_animatedOriginalOffset;
- (struct CGPoint { double x1; double x2; })_animatedTargetOffset;
- (struct CGPoint { double x1; double x2; })_animationTargetContentOffset;
...
- (bool)_canScrollFromEdge:(unsigned long long)arg1;
...
- (bool)_contentOffsetIsAtPagingBoundary:(struct CGPoint { double x1; double x2; })arg1;
...
- (struct NSDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })_directionalAccessoryEdgeInsets;
- (unsigned long long)_edgesAllowingScrollAccessoriesExtendedToBoundingPath;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })_focusScrollableContentBounds;
...
- (void)_handleDirectionalScrollToOffset:(struct CGPoint { double x1; double x2; })arg1 clampingToBounds:(bool)arg2 duration:(double)arg3;
...
- (void)_hideScrollIndicatorsIfNeededForNewContentSize:(struct CGSize { double x1; double x2; })arg1 animated:(bool)arg2;
...
- (void)_performContentOffsetChangesShowingScrollIndicators:(id /* block */)arg1;
- (void)_performDirectionalBounceFromOffset:(struct CGPoint { double x1; double x2; })arg1 toTargetOffset:(struct CGPoint { double x1; double x2; })arg2;
- (void)_performDirectionalScrollAnimationToTargetOffset:(struct CGPoint { double x1; double x2; })arg1;
- (void)_performDirectionalScrollAnimationToTargetOffset:(struct CGPoint { double x1; double x2; })arg1 duration:(double)arg2;
...
- (void)_prepareToPageWithHorizontalVelocity:(double)arg1 verticalVelocity:(double)arg2 nudgingBoundsWithVelocity:(bool)arg3;
- (void)_prepareToPageWithHorizontalVelocity:(double)arg1 verticalVelocity:(double)arg2 nudgingBoundsWithVelocity:(bool)arg3 performExtraPageIfPastPagingBoundary:(bool)arg4;
...
- (double)_rubberBandingReversalOffsetForOriginalOffset:(double)arg1 contentMin:(double)arg2 contentMax:(double)arg3 contentOffset:(double)arg4 velocity:(double)arg5 currentDelta:(double)arg6 rubberBandingCoefficient:(double)arg7;
- (struct CGPoint { double x1; double x2; })_rubberBandingReversalOffsetForOriginalOffset:(struct CGPoint { double x1; double x2; })arg1 velocity:(struct CGPoint { double x1; double x2; })arg2 currentPanTranslation:(struct CGPoint { double x1; double x2; })arg3;
...
- (void)_sendAsynchronouslyHandleScrollEvent:(id)arg1 completion:(id /* block */)arg2;
...
- (void)_setDefaultShowsHorizontalScrollIndicator:(bool)arg1;
- (void)_setDefaultShowsVerticalScrollIndicator:(bool)arg1;
...
- (void)_setIsTransientScrollView:(bool)arg1;
...
- (void)_setShowsHorizontalScrollIndicatorFlag:(bool)arg1;
- (void)_setShowsVerticalScrollIndicatorFlag:(bool)arg1;
...
- (void)_stopScrollingAndZoomingAnimationsPinningToContentViewport:(bool)arg1 tramplingAnimationDependentFlags:(bool)arg2;
- (void)_stopScrollingNotify:(bool)arg1 pin:(bool)arg2;
- (void)_stopScrollingNotify:(bool)arg1 pin:(bool)arg2 tramplingAnimationDependentFlags:(bool)arg3;
...
- (id)_takeScrollAnimatingAssertionWithReason:(id)arg1;
...
- (struct CGPoint { double x1; double x2; })_velocityForAnimatedScrollFromOffset:(struct CGPoint { double x1; double x2; })arg1 toOffset:(struct CGPoint { double x1; double x2; })arg2 duration:(double)arg3;
- (double)_velocityScaleFactor;
...
- (struct CGPoint { double x1; double x2; })contentAlignmentPoint;
...
- (void)setContentAlignmentPoint:(struct CGPoint { double x1; double x2; })arg1;
...
- (void)setTransfersHorizontalScrollingToParent:(bool)arg1;
- (void)setTransfersVerticalScrollingToParent:(bool)arg1;
...
- (void)withScrollIndicatorsShownForContentOffsetChanges:(id /* block */)arg1;
- (double)zoomScale;
...
- (struct CGPoint { double x1; double x2; })_wk_clampToScrollExtents:(struct CGPoint { double x1; double x2; })arg1;
...
- (void)_wk_setContentOffsetAndShowScrollIndicators:(struct CGPoint { double x1; double x2; })arg1 animated:(bool)arg2;
- (void)_wk_setTransfersHorizontalScrollingToParent:(bool)arg1;
- (void)_wk_setTransfersVerticalScrollingToParent:(bool)arg1;
...
- (struct CGPoint { double x1; double x2; })__ck_bottomOffset;
...
- (struct CGPoint { double x1; double x2; })px_contentOffsetForEdge:(unsigned int)arg1 padding:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg2;
- (double)px_contentOffsetYFraction;
- (double)px_decelerationOffsetForInitialVelocity:(double)arg1;
- (double)px_initialVelocityForDecelerationOffset:(double)arg1;
- (bool)px_isBouncing;
...
- (struct CGPoint { double x1; double x2; })px_maximumContentOffset;
- (struct CGPoint { double x1; double x2; })px_minimumContentOffset;
- (bool)px_performDecelerationWithInitialVelocity:(double)arg1 axis:(long long)arg2;
- (bool)px_performDecelerationWithInitialVelocity:(double)arg1 axis:(long long)arg2 targetContentOffsetForProposedOffset:(id /* block */)arg3;
...
- (bool)ts_scrollToTop:(bool)arg1 dismissKeyboard:(bool)arg2;
