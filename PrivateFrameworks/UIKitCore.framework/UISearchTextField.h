...
@property (nonatomic, readonly) UIColor *searchPlaceholderColor; /* unknown property attribute: ? */
@property (nonatomic, copy) NSArray *searchSuggestions;
@property (nonatomic, readonly) UIColor *searchTextColor; /* unknown property attribute: ? */
@property (nonatomic, readonly) UITextField *searchTextField; /* unknown property attribute: ? */
