...
+ (double)_effectiveCornerRadiusForTraitCollection:(id)arg1 size:(int)arg2 selected:(bool)arg3;
...
- (id)_focusSystem:(id)arg1 focusItemsInRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2;
