...
@property (nonatomic, readonly) bool animateHighlightingSelectionByDefault; /* unknown property attribute: ? */
@property (nonatomic, readonly) bool animateSlidingSelectionByDefault;
@property (nonatomic, readonly) bool apportionsSegmentWidthsByContentByDefault; /* unknown property attribute: ? */
@property (nonatomic, readonly) UIBlurEffect *backgroundBlurEffect; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) UIVibrancyEffect *highlightedSegmentDefaultVibrancyEffect; /* unknown property attribute: ? */
