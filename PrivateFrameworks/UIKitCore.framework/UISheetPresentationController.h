...
@interface UISheetPresentationController : UIPresentationController <UIDimmingViewDelegate, UIDragInteractionDelegate, UIDropShadowViewDelegate, UIGestureRecognizerDelegate, _UISheetInteractionDelegate, _UISheetLayoutInfoDelegate> {
    ...
    bool  __exteriorPanGestureEnabled;
...
@property (setter=_setDidExpand:, nonatomic) bool _didExpand;
...
@property (getter=_isExteriorPanGestureEnabled, setter=_setExteriorPanGestureEnabled:, nonatomic) bool _exteriorPanGestureEnabled;
...
@property (getter=_isGrabberBlurEnabled, setter=_setGrabberBlurEnabled:, nonatomic) bool _grabberBlurEnabled;
...
@property (getter=_isOcclusionEnabled, setter=_setOcclusionEnabled:, nonatomic) bool _occlusionEnabled;
...
@property (setter=_setPreferredShadowOpacity:, nonatomic) double _preferredShadowOpacity;
...
@property (setter=_setPresentsWithGesture:, nonatomic) bool _presentsWithGesture;
...
@property (setter=_setShadowRadius:, nonatomic) double _shadowRadius;
...
- (id)_configuration;
- (void)_configureHostWindow:(id)arg1;
- (void)_configureRootPresentationControllerForHostWindow:(id)arg1;
...
- (bool)_exteriorPanGestureRecognizerShouldBeginWithEvent:(id)arg1;
...
- (void)_setExteriorPanGestureEnabled:(bool)arg1;
- (void)_setFloatingAppearance:(id)arg1;
- (void)_setGrabberBlurEnabled:(bool)arg1;
...
- (void)_setOcclusionEnabled:(bool)arg1;
- (void)_setPeeksWhenFloating:(bool)arg1;
- (void)_setPreferredShadowOpacity:(double)arg1;
- (void)_setPrefersScrollingResizesWhenDetentDirectionIsDown:(bool)arg1;
- (void)_setPresentsWithGesture:(bool)arg1;
...
- (id)doc_detentForDocumentLandingMode:(long long)arg1;
- (long long)doc_documentLandingModeForDetent:(id)arg1;
