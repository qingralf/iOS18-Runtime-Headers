...
@property (setter=_setWantsFloatingSidebar:, nonatomic) bool _wantsFloatingSidebar;
...
@property (getter=_lastFocusedChildViewControllerColumn, nonatomic, readonly) long long lastFocusedChildViewControllerColumn;
...
@property (readonly) UIColor *primaryBackgroundColor; /* unknown property attribute: ? */
...
@property (getter=_sidebarArrowButtonRecognizer, nonatomic, readonly) UILongPressGestureRecognizer *sidebarArrowButtonRecognizer;
...
@property (nonatomic) _UITabContainerView *tabBarHostedView;
...
- (void)_handleArrowPress:(id)arg1;
...
- (bool)canTileSidebarColumn:(long long)arg1;
