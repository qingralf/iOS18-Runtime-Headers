...
@interface UISwitchModernVisualElement : UISwitchVisualElement <CAAnimationDelegate, UIGestureRecognizerDelegate, UIPointerInteractionDelegate, UISwitchMVEGestureTrackingSessionElement> {
...
@property (nonatomic, retain) UITapGestureRecognizer *selectGestureRecognizer;
...
- (void)setSelectGestureRecognizer:(id)arg1;
