...
- (double)_centerViewWidthForTraitCollection:(id)arg1;
...
- (void)_writingDirectionChanged:(id)arg1;
...
- (bool)updateFloatingAssistantRectEdge:(unsigned long long)arg1 position:(struct CGPoint { double x1; double x2; })arg2;
