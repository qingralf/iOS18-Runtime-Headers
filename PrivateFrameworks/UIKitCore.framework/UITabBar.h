...
@interface UITabBar : UIView <UIBarPositioning, _UIShadowedView, _UITabBarDelegateInternal, _UITabChangeObserver> {
...
@property (setter=_setSuspendBackgroundUpdates:, nonatomic) bool _suspendBackgroundUpdates;
...
- (void)_setSpringLoaded:(bool)arg1 force:(bool)arg2;
- (void)_setSuspendBackgroundUpdates:(bool)arg1;
