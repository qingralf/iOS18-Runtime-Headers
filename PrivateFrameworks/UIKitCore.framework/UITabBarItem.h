...
@interface UITabBarItem : UIBarItem <_UIBarAppearanceChangeObserver, _UIPopoverPresentationControllerSourceItem_Internal, _UITabDataProvider> {
    long long  __barMetrics;
    <_UIPopoverPresentationControllerSourceItem_Internal> * __fallbackSourceItem;
    ...
    <_UITabChangeObserver> * _changeObserver;
    struct UIEdgeInsets { 
        double top; 
        double left; 
        double bottom; 
...
@property (nonatomic, readonly) _UITabBarItemAppearanceStorage *_appearanceStorage;
...
@property (getter=_isPinned, setter=_setPinned:, nonatomic) bool _pinned;
...
@property (nonatomic, readonly) long long preferredPlacement;
@property (nonatomic, copy) UITabBarAppearance *scrollEdgeAppearance;
@property (nonatomic, retain) UIImage *selectedImage;
@property (getter=isSelected, nonatomic, readonly) bool seleted;
@property (getter=isSpringLoaded, nonatomic, readonly) bool springLoaded;
