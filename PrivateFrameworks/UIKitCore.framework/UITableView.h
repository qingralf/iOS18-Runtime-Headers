...
@property (getter=_sectionFooterContentInsets, nonatomic, readonly) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } _sectionFooterContentInsets;
@property (getter=_sectionHeaderContentInsets, nonatomic, readonly) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } _sectionHeaderContentInsets;
@property (setter=_setHeadersHugContent:, nonatomic) bool _sectionHeadersHugContent;
...
@property (getter=_supplementariesFollowSectionContentInsets, nonatomic, readonly) bool supplementariesFollowSectionContentInsets;
@property (getter=_supplementarySectionHeadersHugContent, nonatomic, readonly) bool supplementarySectionHeadersHugContent;
...
- (void)_deselectRowsAtIndexPaths:(id)arg1 animated:(bool)arg2 transitionCoordinator:(id)arg3;
...
- (id)_existingOrTentativeHeaderViewCreatedIfNeededForSection:(long long)arg1;
...
- (double)_headerFooterLeadingMarginWidthIsHeader:(bool)arg1 isFirstSection:(bool)arg2;
...
- (bool)_highlightRowAtIndexPath:(id)arg1 animated:(bool)arg2 scrollPosition:(long long)arg3 usingPresentationValues:(bool)arg4 playFeedback:(bool)arg5;
...
- (id)_nearestCellToPoint:(struct CGPoint { double x1; double x2; })arg1 expandingVisibleCells:(bool)arg2;
...
- (double)_sectionCornerRadius;
- (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })_sectionFooterContentInsets;
...
- (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })_sectionHeaderContentInsets;
- (double)_sectionHeaderFooterPadding;
...
- (void)_setSectionHeadersHugContent:(bool)arg1;
...
- (void)_setSupplementarySectionHeadersHugContent:(bool)arg1;
...
- (double)_sidePadding;
- (struct CGSize { double x1; double x2; })_sizeForHeaderInSection:(long long)arg1;
...
- (void)_updateListEnvironmentTraitOverrideWithSectionContentInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg1;
...
- (void)_userSelectRowAtPendingSelectionIndexPath:(id)arg1 animatedSelection:(bool)arg2;
...
- (long long)contentHuggingElements;
...
- (void)setContentHuggingElements:(long long)arg1;
...
- (bool)vs_canFocusRowAtIndexPath:(id)arg1;
- (bool)vs_containsIndexPath:(id)arg1;
- (bool)vs_hasRowAtIndexPath:(id)arg1;
- (id)vs_indexPathForFirstFocusableRow;
- (id)vs_scrollCompletionOperations;
- (void)vs_scrollToIndexPath:(id)arg1 atScrollPosition:(long long)arg2 animated:(bool)arg3 withCompletion:(id /* block */)arg4;
- (void)vs_scrollToTopAnimated:(bool)arg1;
- (void)vs_scrollToTopAnimated:(bool)arg1 completion:(id /* block */)arg2;
- (struct CGPoint { double x1; double x2; })vs_scrollToTopContentOffset;
- (void)vs_scrollViewDidEndScrollingAnimation;
- (void)vs_setScrollCompletionOperations:(id)arg1;
