...
- (void)_performConfigurationStateModifications:(id /* block */)arg1;
...
- (void)sf_registerDynamicImageProvider:(id /* block */)arg1 forTraitChanges:(id)arg2;
- (void)sf_registerDynamicImageProviderForSystemTraitsAffectingColorAppearance:(id /* block */)arg1;
...
- (void)disableRemoteHoverEffect;
- (void)disableRemoteHoverEffectAndClearBackground;
- (void)objc_updateWithSeparatorSpacing:(double)arg1;
- (void)updateWithSeparatorSpacing:(double)arg1;

// Image: /System/Library/PrivateFrameworks/HealthUI.framework/HealthUI

- (id)hkui_configuredForCHR3rdPartyAPIFlowWhilePrompting:(bool)arg1;
