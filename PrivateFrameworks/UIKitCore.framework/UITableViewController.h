...
@interface UITableViewController : UIViewController <HUViewControllerNavigationBarStateUpdateDelegate, UIDocumentInteractionControllerDelegate, UITableViewDataSource, UITableViewDelegate, UITableViewFocusDelegateLegacy, UIViewControllerPreviewingDelegate, UIViewControllerPreviewingDelegate_Deprecated, _UIKeyboardAutoRespondingScrollViewController> {
...
- (void)presentAttachment:(id)arg1 fromIndexPath:(id)arg2 useRedesign:(bool)arg3 deleteHandler:(id /* block */)arg4;
- (void)presentAttachmentWithImagePush:(id)arg1 fromIndexPath:(id)arg2;
- (void)presentAttachmentWithImagePush:(id)arg1 fromIndexPath:(id)arg2 useRedesign:(bool)arg3 deleteHandler:(id /* block */)arg4;
