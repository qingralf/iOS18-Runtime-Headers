...
@property (nonatomic, readonly) <NSCustomTextRendering> *customRenderController; /* unknown property attribute: ? */
...
@property (nonatomic) bool usesStandardTextScaling; /* unknown property attribute: ? */
...
- (struct CGSize { double x1; double x2; })_clearButtonSize:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
...
- (bool)_isAccessoryViewAnimatable:(id)arg1;
...
- (void)_setShouldUpdatePlaceholderTextAlignmentWhenOverridden:(bool)arg1;
...
- (void)_transitionFromAccessoryView:(id)arg1 toView:(id)arg2 allowingAnimation:(bool)arg3;
...
- (void)_updateButtons;
- (void)_updateButtonsAllowingAnimation:(bool)arg1;
...
- (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })_visionOverrideHorizontalInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg1;
- (struct CGSize { double x1; double x2; })_visionOverrideNaturalHeight:(struct CGSize { double x1; double x2; })arg1;
