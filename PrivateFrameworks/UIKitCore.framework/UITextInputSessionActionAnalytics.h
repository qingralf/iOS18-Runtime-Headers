...
@property (nonatomic, retain) IATextInputActionsInputMode *inputMode;
...
- (void)_performWithInputModeOverride:(id)arg1 block:(id /* block */)arg2;
- (void)_performWithTextInputActionsSource:(long long)arg1 block:(id /* block */)arg2;
