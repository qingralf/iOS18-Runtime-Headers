...
@interface UITextInteractionAssistant : NSObject <UIPointerInteractionDelegate, UIResponderStandardEditActions, UITextCursorAssertionControllerSubject, UITextInteraction_AssistantDelegate, UITextRangeAdjustmentInteractionDelegate, UITextSelectionDisplayInteractionDelegate, UITextSelectionDisplayInteractionDelegate_Internal> {
    ...
    bool  _respondsToConvertPointToRenderSpace;
    bool  _respondsToTextFormattingRestorationMethods;
...
- (struct CGPoint { double x1; double x2; })_selectionViewManager:(id)arg1 convertPointToRenderSpace:(struct CGPoint { double x1; double x2; })arg2 textRange:(id)arg3;
...
- (void)_textRangeAdjustmentForPoint:(struct CGPoint { double x1; double x2; })arg1 withTouchPoint:(struct CGPoint { double x1; double x2; })arg2;
- (void)_textRangeAdjustmentForPoint:(struct CGPoint { double x1; double x2; })arg1 withTouchPoint:(struct CGPoint { double x1; double x2; })arg2 selectionChangeReason:(long long)arg3;
