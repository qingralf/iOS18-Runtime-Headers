...
@interface UITextLoupeSession : NSObject {
    ...
    <_UITextLoupeSessionDelegate> * _delegate;
...
@property (nonatomic) <_UITextLoupeSessionDelegate> *delegate;
...
- (void)_moveToPoint:(struct CGPoint { double x1; double x2; })arg1 withCaretRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 selectionWidget:(id)arg3 trackingCaret:(bool)arg4;
