...
- (id)_gestureView;
- (void)_loupeSessionDidInvalidate:(id)arg1;
- (bool)_pointCloserToEnd:(struct CGPoint { double x1; double x2; })arg1;
...
- (id)selectionWidgetForPoint:(struct CGPoint { double x1; double x2; })arg1;
