...
@interface UITextReplacement : NSObject {
    bool  _isDictationCommandReplacement;
    NSString * _menuTitle;
...
@property (readonly) bool isDictationCommandReplacement;
...
+ (id)replacementWithRange:(id)arg1 original:(id)arg2 replacement:(id)arg3 menuTitle:(id)arg4 isDictationCommandReplacement:(bool)arg5;
