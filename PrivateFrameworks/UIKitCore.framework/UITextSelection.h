...
- (id)_boundedOrInvertedSelectionRangeForExtent:(id)arg1 forPoint:(struct CGPoint { double x1; double x2; })arg2 fromPosition:(id)arg3 inDirection:(long long)arg4;
- (id)_domRange;
...
- (id)underlineRectsForRange:(id)arg1;
