...
@property (setter=_setTransform:, nonatomic, retain) NSValue *_transform;
...
- (void).cxx_destruct;
- (void)_appendToPath:(struct CGPath { }*)arg1 cornerRadius:(double)arg2 edgeInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg3;
