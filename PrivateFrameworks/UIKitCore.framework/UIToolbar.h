...
@interface UIToolbar : UIView <UIAccessibilityHUDGestureDelegate, UIBarPositioning, UIGestureRecognizerDelegatePrivate, _UIBarPositioningInternal> {
    ...
    id /* block */  __itemsDidChangeBlock;
...
@property (setter=_setItemsDidChangeBlock:, nonatomic, copy) id /* block */ _itemsDidChangeBlock;
...
- (void)_setItemsDidChangeBlock:(id /* block */)arg1;
