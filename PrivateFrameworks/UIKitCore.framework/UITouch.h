...
@interface UITouch : NSObject <ASVTouch, _UIResponderForwardableEventComponent> {
    ...
    struct { 
        ...
        unsigned int _isGESTouch : 1; 
        unsigned int _isTransitioningFromGESTouch : 1; 
    }  _touchFlags;
...
@property (nonatomic, readonly) bool _originatesFromPointerEvent;
...
@property (setter=_setPointerSenderID:, nonatomic) unsigned long long _pointerSenderID;
@property (nonatomic, readonly) double _pressure;
@property (setter=_setResponder:, nonatomic, retain) UIResponder<_UIGestureRecognizerContainer> *_responder;
@property (setter=_setSenderID:, nonatomic) unsigned long long _senderID;
@property (setter=_setTouchAuthenticationRecord:, nonatomic, retain) _UISTouchAuthenticationRecord *_touchAuthenticationRecord;
...
- (void)_setPointerSenderID:(unsigned long long)arg1;
