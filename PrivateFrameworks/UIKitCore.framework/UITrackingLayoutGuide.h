...
@interface UITrackingLayoutGuide : UILayoutGuide {
    ...
    bool  _skipAnimationOnNextPassOnly;
    struct UIEdgeInsets { 
        double top; 
        double left; 
        double bottom; 
...
@property (nonatomic) bool skipAnimationOnNextPassOnly;
...
- (void).cxx_destruct;
- (id)_awayFromCombinedTrackedConstraintsForEdgeKey:(id)arg1;
...
- (id)_nearEdgeCombinedTrackedConstraintsForEdgeKey:(id)arg1;
...
- (void)removeTrackedConstraintsFromViewBasedGuide:(id)arg1;
...
- (void)setSkipAnimationOnNextPassOnly:(bool)arg1;
