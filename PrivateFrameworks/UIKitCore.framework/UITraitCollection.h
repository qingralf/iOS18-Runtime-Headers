...
@interface UITraitCollection : NSObject <DOCUIPTraitEnvironment, NSCopying, NSSecureCoding, UIMutableTraitsInternal, _UIFallbackEnvironment> {
    struct { 
...
@property (nonatomic, readonly) double _headroomSuppressionLimit;
@property (nonatomic, readonly) long long _headroomUsage;
@property (nonatomic, readonly) bool _isLargeContentViewerEnabled;
@property (nonatomic, readonly) bool _lp_prefersDarkInterface;
@property (nonatomic, readonly) bool _lp_prefersHighContrast;
...
@property (nonatomic, readonly) bool contextPrefersVariableBlurBottomTabBar;
...
@property (nonatomic, readonly) double itk_contentSizeScaleFactor;
@property (nonatomic, readonly) bool itk_hasCompactHeight;
@property (nonatomic, readonly) bool itk_hasCompactSize;
@property (nonatomic, readonly) bool itk_hasCompactWidth;
@property (nonatomic, readonly) bool itk_isCarPlay;
@property (nonatomic, readonly) bool itk_isDark;
@property (nonatomic, readonly) bool itk_isOptimizedForMac;
@property (nonatomic, readonly) bool itk_isRTL;
@property (nonatomic, readonly) bool itk_isTV;
@property (nonatomic, readonly) bool itk_isVision;
@property (nonatomic, readonly) bool itk_isiPad;
@property (nonatomic, readonly) bool itk_isiPhone;
@property (nonatomic, readonly) UITraitCollection *itk_traitCollectionClampedToNonaccessibilityContentSize;
@property (nonatomic, readonly) long long layoutDirection;
@property (nonatomic, readonly) long long legibilityWeight;
@property (nonatomic, readonly) long long listEnvironment;
...
@property (nonatomic, readonly) long long safari_barTintStyle;
@property (nonatomic, readonly) bool sbh_automaticallyChangesWithUserInterfaceStyle;
@property (nonatomic, readonly) bool sbh_hasIconTintColorOrDarkStyle;
@property (nonatomic, readonly) PUIStylePickerHomeScreenConfiguration *sbh_homeScreenStyleConfiguration;
@property (nonatomic, readonly) SBHIconImageAppearance *sbh_iconImageAppearance;
@property (nonatomic, readonly) SBHIconImageStyleConfiguration *sbh_iconImageStyleConfiguration;
@property (nonatomic, readonly) long long sbh_iconImageUserInterfaceStyle;
@property (nonatomic, readonly) UIColor *sbh_iconTintColor;
@property (nonatomic, readonly) long long sbh_widgetUserInterfaceStyle;
...
+ (id)_defineObjectTraitWithName:(id)arg1 identifier:(id)arg2 defaultValue:(id)arg3 equalityHandler:(id /* block */)arg4 affectsColorAppearance:(bool)arg5 defaultValueRepresentsUnspecified:(bool)arg6 isPrivate:(bool)arg7 placeholderToken:(id)arg8;
...
+ (id)_traitCollectionWithHeadroomSuppressionLimit:(double)arg1;
+ (id)_traitCollectionWithHeadroomUsage:(long long)arg1;
+ (id)_traitCollectionWithInterfaceProtectionState:(long long)arg1;
...
+ (id)traitCollectionWithListEnvironment:(long long)arg1;
...
- (long long)_contrast;
- (id)_description;
- (id)_descriptionForChangeFromTraitCollection:(id)arg1;
- (id)_descriptionForChangeToTraitCollection:(id)arg1;
...
- (void)setListEnvironment:(long long)arg1;
...
+ (bool)enclosingTabSwitcherCanBeFloating;

- (bool)contextPrefersVariableBlurBottomTabBar;
- (id)descriptionOfDOCUIPTraits;
...
- (bool)itk_hasCompactSize;
- (bool)itk_hasCompactWidth;
- (bool)itk_hasEqualSizeToTraitCollection:(id)arg1;
- (bool)itk_isCarPlay;
- (bool)itk_isDark;
...
- (bool)itk_isiPad;
- (bool)itk_isiPhone;
- (void)itk_performAsCurrent:(id /* block */)arg1;
- (id)itk_traitCollectionClampedToNonaccessibilityContentSize;
- (id)itk_traitCollectionWithContentSize:(id)arg1;
...
+ (void)safari_removeAllCustomTraits:(id)arg1;
...
+ (id)prx_traitCollectionWithCustomBackgroundColor:(id)arg1;
...
+ (id)sbh_highestLevelTraitCollectionForView:(id)arg1;
+ (id)sbh_highestLevelTraitCollectionForViewController:(id)arg1;
+ (id)sbh_iconImageAppearanceFromTraitCollection:(id)arg1;
+ (id)sbh_iconImageAppearanceFromTraitCollection:(id)arg1 iconImageStyleConfiguration:(id)arg2;
+ (id)sbh_iconImageAppearanceFromTraitCollection:(id)arg1 overrideIconImageAppearance:(id)arg2;
+ (id)sbh_iconImageAppearanceFromTraitCollection:(id)arg1 overrideIconImageAppearance:(id)arg2 overrideIconImageStyleConfiguration:(id)arg3;
+ (id)sbh_iconImageStyleConfigurationFromTraitCollection:(id)arg1;
+ (id)sbh_iconImageStyleConfigurationFromTraitCollection:(id)arg1 overrideIconImageAppearance:(id)arg2 overrideIconImageStyleConfiguration:(id)arg3;
+ (long long)sbh_materialUserInterfaceStyleFromTraitCollection:(id)arg1;
+ (id)sbh_traitCollectionWithHomeScreenStyleConfiguration:(id)arg1;
+ (id)sbh_traitCollectionWithHomeScreenStyleConfiguration:(id)arg1 userInterfaceStyle:(long long)arg2;
+ (id)sbh_traitCollectionWithIconImageAppearance:(id)arg1;
+ (id)sbh_traitCollectionWithIconImageStyleConfiguration:(id)arg1;
+ (id)sbh_traitCollectionWithIconImageStyleConfiguration:(id)arg1 userInterfaceStyle:(long long)arg2;
+ (id)sbh_traitCollectionWithIconTintColor:(id)arg1;
+ (long long)sbh_userInterfaceStyleForIconImageAppearance:(id)arg1;

- (bool)sbh_automaticallyChangesWithUserInterfaceStyle;
- (bool)sbh_hasIconTintColorOrDarkStyle;
- (id)sbh_homeScreenIconStyleConfiguration;
- (id)sbh_homeScreenIconStyleConfiguration:(bool)arg1;
- (id)sbh_homeScreenStyleConfiguration;
- (id)sbh_iconImageAppearance;
- (id)sbh_iconImageAppearanceInferringIfNecessary:(bool)arg1;
- (id)sbh_iconImageAppearanceWithHomeScreenStyleConfiguration:(id)arg1;
- (id)sbh_iconImageStyleConfiguration;
- (id)sbh_iconImageStyleConfigurationInferringIfNecessary:(bool)arg1;
- (long long)sbh_iconImageUserInterfaceStyle;
- (id)sbh_iconTintColor;
- (id)sbh_iconTintColorInferringIfNecessary:(bool)arg1;
- (long long)sbh_widgetUserInterfaceStyle;
...
- (bool)preferredContentSizeCategoryAllowsMultilineTitleForDoubleLineCells;
