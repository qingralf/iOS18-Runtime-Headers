...
@interface UIView : UIResponder <AVKitLayoutItem, CALayerDelegate, CRKCardSectionView, DOCAppearanceCustomization, DOCUIPTraitEnvironment, DOCUIPTraitObserving, DOCViewAndControllerCommonExtensions, EKUIViewHierarchy, HULayoutAnchorProviding, ICAttachmentPresenterDelegate, ICSupplementalView, MKInfoCardThemeListener, MKStackingViewControllerSizableView, MTVisualStylingProviding, MUCompositionalStackLayoutItemInternal, MULayoutItem, NSCoding, NSISEngineDelegate, NSISVariableDelegate, NSTextViewportRenderingSurface, NTKDialMarkerView, NUIArrangementItem, PBFDisplayContextProviding, PXDynamicRangeDisplayContext, PXGInternalReusableView, PXReusableObject, PXUIViewBasicTile, SearchUIAutoLayoutItem, SharedWithYou.AncestorViewControllerRetrievable, UIAppearance, UIAppearanceContainer, UICoordinateSpace, UIDynamicItem, UIFocusItem, UIFocusItemContainer, UILargeContentViewerItem, UILargeContentViewerItem_Private, UILayoutItem_Internal, UITextEffectsOrdering, UITraitChangeObservable, UITraitChangeObservableInternal, UITraitEnvironment, _UIAppearanceRestriction, _UIDropInteractionOwning, _UIDynamicReferenceSystem, _UIFallbackEnvironment, _UIFocusEnvironmentPrivate, _UIFocusItemContainerForSwiftUIOnly, _UIFocusItemContainerInternal, _UIFocusItemContainerPrivate, _UIFocusItemDebuggable, _UIFocusItemForTVFrameworksOnly, _UIFocusItemInternal, _UIFocusItemPrivate, _UIGeometryChangeObserver, _UIGestureRecognizerContainer, _UILayoutItem, _UILegacyFocusRegion, _UIMultilineTextContentSizing, _UIPopoverPresentationControllerSourceItem_Internal, _UIScrollViewScrollObserver_Internal, _UITraitEnvironmentInternal, _UITraitOverrideDelegate, _UITraitTrackingSupporting, _UIViewSubtreeMonitor> {
    ...
    UIWritingToolsCoordinator * __writingToolsCoordinator;
    ...
    struct { 
        unsigned int hasObservationTrackingDictionary : 1; 
        ...
        unsigned int hasAppEntityIdentifier : 1; 
        unsigned int hasAppIntentIdentifier : 1; 
...
@property (nonatomic, readonly) bool _acceptsInauthenticTouches;
...
@property (nonatomic, readonly) <_UIGestureRecognizerContainer> *_actingParentGestureRecognizerContainer;
...
@property (setter=_setAppEntityIdentifier:, nonatomic, copy) NSString *_appEntityIdentifier;
@property (setter=_setAppIntentIdentifier:, nonatomic, copy) NSString *_appIntentIdentifier;
...
@property (getter=_cropInsets, setter=_setCropInsets:, nonatomic) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } _cropInsets;
...
@property (setter=_setEffectContainerLookupID:, nonatomic, retain) NSUUID *_effectContainerLookupID;
...
@property (nonatomic, readonly) long long _focusItemDeferralMode; /* unknown property attribute: ? */
@property (getter=_focusSpeedBumpEdges, setter=_setFocusSpeedBumpEdges:, nonatomic) unsigned long long _focusSpeedBumpEdges;
...
@property (nonatomic, readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } _intelligenceVisibleBounds;
@property (setter=_setInternalAppIntentsIntelligenceProvider:, nonatomic, retain) id _internalAppIntentsIntelligenceProvider;
...
@property (nonatomic, readonly) bool _isInternalDebugView;
...
@property (getter=_maskView, setter=_setMaskView:, nonatomic, retain) UIView *_maskView;
@property (getter=_matchedViewIdentifier, setter=_setMatchedViewIdentifier:, nonatomic, copy) NSString *_matchedViewIdentifier;
@property (getter=_morphInsets, setter=_setMorphInsets:, nonatomic) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } _morphInsets;
...
@property (getter=_overrideReparentingContainer, setter=_setOverrideReparentingContainer:, nonatomic, retain) UIView *_overrideReparentingContainer;
@property (setter=_setOverrideTintColor:, nonatomic, retain) UIColor *_overrideTintColor;
...
@property (setter=_set_pk_longSqueezeAction:, nonatomic, copy) id /* block */ _pk_longSqueezeAction;
...
@property (nonatomic, readonly) bool _shouldInformFocusAboutBecomingVisible;
...
@property (nonatomic, readonly) UIView *_sourceViewIfPortal;
...
@property (nonatomic, readonly) bool _tvAddsChildFocusItemsBeforeSelf; /* unknown property attribute: ? */
@property (nonatomic, readonly) bool _tvAddsChildFocusItemsButNotSelf; /* unknown property attribute: ? */
@property (nonatomic, readonly) bool _tvAllowsFocusInChildrenWhenFocused; /* unknown property attribute: ? */
...
@property (setter=_setWritingToolsCoordinator:, nonatomic, retain) UIWritingToolsCoordinator *_writingToolsCoordinator;
...
@property (nonatomic, readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } ck_identityTransformFrame;
...
@property (nonatomic, readonly) UIBezierPath *collisionBoundingPath; /* unknown property attribute: ? */
@property (nonatomic, readonly) unsigned long long collisionBoundsType; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) bool doc_inWindowPerformingSnapshotting;
...
@property (nonatomic, readonly) bool enclosedInUIPDocumentLanding;
...
@property (getter=_focusTouchSensitivityStyle, nonatomic, readonly) long long focusTouchSensitivityStyle; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) long long ic_behavior;
...
@property (nonatomic, retain) NSString *ic_preferredContentSizeCategory;
@property (nonatomic, readonly) ICViewControllerManager *ic_viewControllerManager;
@property (nonatomic, readonly) ICWindow *ic_window;
...
@property (nonatomic, copy) UIColor *itk_backgroundColor;
@property (nonatomic, readonly) double itk_backingScaleFactor;
@property (nonatomic, readonly) bool itk_isFirstResponder;
@property (nonatomic, readonly) bool itk_isFlipped;
@property (nonatomic, readonly) CALayer *itk_layer;
@property (nonatomic, readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } itk_safeAreaBounds;
@property (nonatomic) struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; } itk_transform;
@property (nonatomic) bool itk_userInteractionEnabled;
@property (nonatomic, readonly) double itk_viewPointRatioFromWindow;
@property (nonatomic, readonly) double itk_windowPointRatioFromView;
...
@property (setter=nsli_setPiercingToken:) unsigned long long nsli_piercingToken; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) unsigned long long px_containerScrollViewsScrollableAxes;
...
@property (nonatomic, readonly) long long px_layoutDirection;
@property (nonatomic, readonly) unsigned int px_leadingEdge;
@property (nonatomic, readonly) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } px_peripheryInsets;
@property (nonatomic, readonly) UIScrollView *px_rootScrollView;
@property (nonatomic, readonly) UIView *px_rootView;
@property (nonatomic, readonly) double px_screenScale;
@property (setter=px_setSpec:, nonatomic, retain) PXViewSpec *px_spec;
@property (nonatomic, readonly) unsigned int px_trailingEdge;
...
+ (void)__swift_animateByRetargetingAnimations:(id /* block */)arg1 completion:(id /* block */)arg2;
+ (void)__swift_animateUsingSpringBehavior:(id)arg1 tracking:(bool)arg2 animations:(id /* block */)arg3 completion:(id /* block */)arg4;
+ (void)__swift_animateUsingSpringInteractive:(bool)arg1 animations:(id /* block */)arg2 completion:(id /* block */)arg3;
+ (void)__swift_animateUsingSpringWithDampingRatio:(double)arg1 response:(double)arg2 interactive:(bool)arg3 initialDampingRatio:(id)arg4 initialResponse:(id)arg5 dampingRatioSmoothing:(double)arg6 responseSmoothing:(double)arg7 targetSmoothing:(double)arg8 projectionDeceleration:(double)arg9 retargetImpulse:(double)arg10 animations:(id /* block */)arg11 completion:(id /* block */)arg12;
+ (void)__swift_animateUsingSpringWithTension:(double)arg1 friction:(double)arg2 interactive:(bool)arg3 animations:(id /* block */)arg4 completion:(id /* block */)arg5;
+ (void)__swift_animateWithFrictionBounceAnimations:(id /* block */)arg1 completion:(id /* block */)arg2;
+ (void)__swift_createTransformerWithInputAnimatableProperties:(id)arg1 modelValueSetter:(id /* block */)arg2 presentationValueSetter:(id /* block */)arg3;
+ (void)__swift_createTransformerWithInputAnimatableProperties:(id)arg1 presentationValueChangedCallback:(id /* block */)arg2;
+ (void)__swift_createUnsafeTransformerWithInputAnimatableProperties:(id)arg1 modelValueSetter:(id /* block */)arg2 presentationValueSetter:(id /* block */)arg3;
+ (void)__swift_performWithoutRetargetingAnimations:(id /* block */)arg1;
+ (void)__swift_trackVelocity:(id /* block */)arg1;
...
+ (void)_animateInProcessAlongsideTransition:(id /* block */)arg1;
+ (void)_animateInProcessKeyframesAlongsideTransitionWithOptions:(unsigned long long)arg1 animations:(id /* block */)arg2;
+ (void)_animateKeyframeWithID:(id)arg1 relativeStartTime:(double)arg2 relativeDuration:(double)arg3 animations:(id /* block */)arg4;
...
+ (void)_conditionallyPerformWithoutAnimation:(bool)arg1 layout:(id /* block */)arg2;
...
+ (id)_descriptionWithoutTextRedactionForObject:(id)arg1;
...
+ (id)_makeHybridPropertyAnimatorWithDuration:(double)arg1 progressValue:(id)arg2 progressValueReversed:(bool)arg3 progressValueUpdateReason:(unsigned int)arg4 springAnimationBehavior:(id)arg5;
...
+ (void)_performWithInProcessProgressAnimating:(id)arg1 block:(id /* block */)arg2;
...
+ (void)_setAlongsideAnimations:(id /* block */)arg1 toRunByEndOfBlock:(id /* block */)arg2 animated:(bool)arg3;
...
+ (void)_trackVelocity:(id /* block */)arg1;
...
+ (void)removePropertyAnimatorAnimationsInView:(id)arg1;
...
- (void)__swift_animatePropertyWithKey:(id)arg1 currentValue:(double)arg2 targetValue:(double)arg3 newValueCallback:(id /* block */)arg4;
- (id)__swift_projectedTargetForKey:(id)arg1 decelerationFactor:(double)arg2;
- (void)__swift_removeAllRetargetableAnimations:(bool)arg1;
- (void)__swift_removeAllRetargetableAnimationsIfDetatchedFromContext;
- (void)__swift_replaceInProcessAnimationForKey:(id)arg1 behavior:(id)arg2 interactive:(bool)arg3;
- (void)__swift_setPresentationValue:(id)arg1 velocity:(id)arg2 preferredFrameRateRangeMaximum:(long long)arg3 immediate:(bool)arg4 key:(id)arg5;
- (void)__swift_setVelocity:(id)arg1 key:(id)arg2 target:(bool)arg3;
- (void)__swift_stopSettingPresentationValueForKey:(id)arg1;
- (id)__swift_velocityForKey:(id)arg1 target:(bool)arg2;
- (void)__vis_layoutSublayersOfLayer:(id)arg1;
- (bool)_acceptsInauthenticTouches;
- (bool)_accessibilityAddItemsToDragSessionAtPoint3D:(struct CAPoint3D { double x1; double x2; double x3; })arg1;
- (bool)_accessibilityAddItemsToDragSessionAtPoint:(struct CGPoint { double x1; double x2; })arg1;
- (void)_accessibilityBeginDragAtPoint3D:(struct CAPoint3D { double x1; double x2; double x3; })arg1 endpoint:(id)arg2 completion:(id /* block */)arg3;
...
- (id)_appIntentIdentifier;
- (id)_appIntentsAnnotationsDebugDescription;
...
- (bool)_beginDragWithTouches:(id)arg1 orInitialCentroid:(struct CAPoint3D { double x1; double x2; double x3; })arg2 accessibilityEndpoint:(id)arg3;
...
- (void)_collectExistingTraitCollectionsForTraitTracking:(id /* block */)arg1;
...
- (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })_cropInsets;
...
- (id)_deferredAnimationForKey:(id)arg1 ignoringKeyFrames:(bool)arg2;
...
- (void)_didMoveFromSuperview:(id)arg1;
...
- (void)_drawRectWithObservationTracking:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
...
- (void)_intelligenceCollectElementFor:(id)arg1 in:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 using:(id)arg3 transformToRoot:(id /* block */)arg4;
...
- (void)_intelligenceCollectSubelementsIn:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 using:(id)arg2 transformToRoot:(id /* block */)arg3;
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })_intelligenceVisibleBounds;
...
- (struct CACornerRadii { struct CGSize { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; struct CGSize { double x_3_1_1; double x_3_1_2; } x3; struct CGSize { double x_4_1_1; double x_4_1_2; } x4; })_intersectedSceneCornerRadii;
...
- (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })_morphInsets;
- (id)_motionEffects;
...
- (id)_outermostLayer;
- (id)_outlineShape;
- (id)_overrideReparentingContainer;
- (id)_overrideTintColor;
...
- (void)_performSelectorTrackingTraitUsage:(SEL)arg1 withInvalidationSelector:(SEL)arg2;
- (void)_populateArchivedSubviews:(id)arg1;
- (void)_populateInitialTraitCollection:(id)arg1;
...
- (void)_replaceInProcessAnimationForKey:(id)arg1 behavior:(id)arg2 interactive:(bool)arg3;
...
- (void)_setAppEntityIdentifier:(id)arg1;
- (void)_setAppIntentIdentifier:(id)arg1;
...
- (void)_setEffectContainerLookupID:(id)arg1;
- (void)_setFirstResponder:(id)arg1;
- (void)_setFlipsHorizontalAxis:(bool)arg1;
- (void)_setFocusInteractionEnabled:(bool)arg1;
- (void)_setFocusSpeedBumpEdges:(unsigned long long)arg1;
...
- (void)_setInternalAppIntentsIntelligenceProvider:(id)arg1;
...
- (void)_setMatchedViewIdentifier:(id)arg1;
- (void)_setMaximumContentSizeCategory:(id)arg1;
- (void)_setMinimumContentSizeCategory:(id)arg1;
- (void)_setMonitorsSubtree:(bool)arg1;
- (void)_setMorphInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg1;
...
- (void)_setOverrideReparentingContainer:(id)arg1;
- (void)_setOverrideTintColor:(id)arg1;
...
- (void)_setWritingToolsCoordinator:(id)arg1;
...
- (void)_traitCollectionDidChangeInternal:(const struct _UITraitCollectionChangeDescription { id x1; id x2; struct { id x_3_1_1; unsigned long long x_3_1_2[4]; } x3; bool x4; struct _UITraitCollectionTraitChanges { bool x_5_1_1; bool x_5_1_2; } x5; }*)arg1;
...
- (void)setAvkit_extendedDynamicRangeGain:(double)arg1;
...
- (void)annotateWithContact:(id)arg1;
- (void)annotateWithContact:(id)arg1 isPrimary:(bool)arg2 isEditing:(bool)arg3;
- (id)constrainViewToEdgesConstraints:(id)arg1;
...
- (void)_set_pk_longSqueezeAction:(id /* block */)arg1;
...
- (void)Cal_annotateWithCalendar:(id)arg1;
- (void)Cal_annotateWithEvent:(id)arg1;
- (void)Cal_annotateWithNotification:(id)arg1;
- (void)Cal_updateEntityAnnotationStateIsSelected:(bool)arg1 isHighlighted:(bool)arg2 isFocused:(bool)arg3 isDisabled:(bool)arg4 isEditing:(bool)arg5 isPrimary:(bool)arg6;
- (void)annotateWithCalendar:(id)arg1;
- (void)annotateWithEvent:(id)arg1;
- (void)annotateWithNotification:(id)arg1;
- (void)updateEntityAnnotationStateWithIsSelected:(bool)arg1 isHighlighted:(bool)arg2 isFocused:(bool)arg3 isDisabled:(bool)arg4 isEditing:(bool)arg5 isPrimary:(bool)arg6;

// Image: /System/Library/PrivateFrameworks/CameraEditKit.framework/CameraEditKit

+ (void)cek_animateWithSettings:(id)arg1 interactive:(bool)arg2 animations:(id /* block */)arg3 completion:(id /* block */)arg4;
+ (void)cek_animateWithSettings:(id)arg1 mode:(long long)arg2 animations:(id /* block */)arg3 completion:(id /* block */)arg4;
+ (void)cek_modifyAnimationsWithPreferredFrameRateRange:(struct CAFrameRateRange { float x1; float x2; float x3; })arg1 updateReason:(unsigned int)arg2 animations:(id /* block */)arg3;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })ck_identityTransformFrame;
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })ck_identityTransformFrameInView:(id)arg1;
- (void)ck_performAnimationVisibility:(bool)arg1 animated:(bool)arg2 completion:(id /* block */)arg3;
- (void)ck_performHideAnimated:(bool)arg1 completion:(id /* block */)arg2;
- (void)ck_performRevealAnimated:(bool)arg1 completion:(id /* block */)arg2;
- (void)ck_performUnanimatedVisibility:(bool)arg1 completion:(id /* block */)arg2;
...
+ (void)doc_performAllowingAnimations:(bool)arg1 block:(id /* block */)arg2;
+ (void)load;
...
- (void)doc_configureWithStandardPlatterWithCornerRadius:(double)arg1;
...
- (void)registerForTabSwitcherTraitChangesWithHandler:(id /* block */)arg1;
- (void)registerForUIPDocumentLandingTraitChangesWithHandler:(id /* block */)arg1;
...
- (void)addSubviewToBounds:(id)arg1 with:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg2;
...
+ (void)itk_animateWithDuration:(double)arg1 animations:(id /* block */)arg2;
+ (void)itk_animateWithDuration:(double)arg1 animations:(id /* block */)arg2 completion:(id /* block */)arg3;
+ (void)itk_performWithoutAnimation:(id /* block */)arg1;

- (double)itk_alpha;
- (id)itk_autoFadeOutLayerWithPath:(id)arg1;
- (id)itk_autoFadeOutLayerWithPath:(id)arg1 fadeOutDelay:(double)arg2;
- (id)itk_autoFadeOutLayerWithQuad:(id)arg1;
- (id)itk_autoFadeOutLayerWithQuad:(id)arg1 fadeOutDelay:(double)arg2;
- (id)itk_autoFadeOutShapePointLayer;
- (id)itk_autoFadeOutShapeRectLayer;
- (id)itk_backgroundColor;
- (double)itk_backingScaleFactor;
- (bool)itk_clipsToBounds;
- (bool)itk_configureToFillSuperView;
- (id)itk_constraintsToFillLayoutGuide:(id)arg1;
- (id)itk_constraintsToFillView:(id)arg1;
- (id)itk_debug;
- (bool)itk_isDescendantOfView:(id)arg1;
- (bool)itk_isFirstResponder;
- (bool)itk_isFlipped;
- (id)itk_layer;
- (void)itk_layoutIfNeeded;
- (id)itk_renderImageFromViewBackingStore;
- (id)itk_renderImageFromViewBackingStoreWithSubrect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })itk_roundRectToViewScale:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })itk_safeAreaBounds;
- (void)itk_setHidden:(bool)arg1 animated:(bool)arg2;
- (void)itk_setNeedsDisplay;
- (void)itk_setNeedsLayout;
- (struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })itk_transform;
- (bool)itk_userInteractionEnabled;
- (double)itk_viewLengthFromWindowLength:(double)arg1;
- (double)itk_viewPointRatioFromWindow;
- (double)itk_windowLengthFromViewLength:(double)arg1;
- (double)itk_windowPointRatioFromView;
- (void)setItk_alpha:(double)arg1;
- (void)setItk_backgroundColor:(id)arg1;
- (void)setItk_transform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg1;
- (void)setItk_userInteractionEnabled:(bool)arg1;
...
- (void)mui_setAsSourceForPopoverPresentationController:(id)arg1;
- (void)mui_setAsSourceWithExtendedRectForPopoverPresentationController:(id)arg1;
- (void)mui_setAsTargetedSourceOnSceneConfiguration:(id)arg1;
...
+ (void)mru_animateWithSpringParameters:(struct { double x1; double x2; double x3; double x4; double x5; })arg1 options:(unsigned long long)arg2 animations:(id /* block */)arg3;
+ (void)mru_animateWithSpringParameters:(struct { double x1; double x2; double x3; double x4; double x5; })arg1 options:(unsigned long long)arg2 animations:(id /* block */)arg3 completion:(id /* block */)arg4;
...
+ (bool)_sf_usesLeftToRightLayoutOnView:(id)arg1;
+ (void)safari_performWithoutRetargetingAnimations:(id /* block */)arg1;
...
- (void)safari_annotateWithBookmark:(id)arg1;
- (void)safari_annotateWithHistoryItem:(id)arg1 inProfile:(id)arg2;
- (void)safari_annotateWithReadingListItem:(id)arg1;
- (void)safari_annotateWithWindowEntityIdentifier:(id)arg1;
- (void)safari_setTabEntityProviderWithInfoProvider:(id)arg1;
- (id)safari_snapshotImageFromIOSurfaceInRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
- (void)safari_updateVisualStateIsSelected:(bool)arg1 isEditing:(bool)arg2;
- (void)safari_updateWithPrimaryState:(bool)arg1;
...
- (void)SG_setBoundsAndPositionFromFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
...
- (struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })_getAffineTransform;
...
- (void)ic_addAnchorsToFillSuperviewWithPaddingFromDirectionalEdgeInsets:(struct NSDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })arg1 usesSafeAreaLayoutGuide:(bool)arg2;
...
- (id)ic_imageRenderedFromViewHierarchyAfterScreenUpdates:(bool)arg1;
- (id)ic_imageRenderedFromViewHierarchyAfterScreenUpdates:(bool)arg1 fallback:(id /* block */)arg2;
...
- (void)setIc_preferredContentSizeCategory:(id)arg1;
...
+ (id)px_circularGlyphViewWithName:(id)arg1 prefersMulticolor:(bool)arg2 backgroundColor:(id)arg3;
...
- (id)_px_leafScrollViewAtPoint:(struct CGPoint { double x1; double x2; })arg1;
...
- (bool)px_areAllContainerScrollViewsScrolledAtEdge:(unsigned int)arg1;
- (bool)px_areAllScrollViewsContainingPoint:(struct CGPoint { double x1; double x2; })arg1 scrolledAtEdge:(unsigned int)arg2;
...
- (id)px_rootView;
- (unsigned long long)px_scrollableAxesAtPoint:(struct CGPoint { double x1; double x2; })arg1;
...
- (void)pxg_insertIntoView:(id)arg1 atIndex:(long long)arg2;
- (bool)pxg_isChildOfScrollViewController:(id)arg1;
- (bool)pxg_isChildOfView:(id)arg1;
...
- (id)pui_constraintsPinningSubview:(id)arg1 toEdges:(unsigned long long)arg2;
...
+ (id)smu_tvHandoffAnimationViewWithState:(unsigned long long)arg1;
...
- (void)blurAnimationFor:(id)arg1 duration:(double)arg2 startRadius:(double)arg3 endRadius:(double)arg4;
- (id)sbh_darkener;
- (void)scaleAndBlurForDuration:(double)arg1 initiallyHidden:(bool)arg2 visibleAlpha:(double)arg3 completion:(id /* block */)arg4;
- (void)setFilterForUserInterface:(long long)arg1;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })SBSUI_sourceRectForControlCenterInvocationHint;
...
+ (void)suia_animateWithSettings:(id)arg1 interactive:(bool)arg2 animations:(id /* block */)arg3 completion:(id /* block */)arg4;
+ (void)suia_animateWithSettings:(id)arg1 mode:(long long)arg2 animations:(id /* block */)arg3 completion:(id /* block */)arg4;
+ (void)suia_modifyAnimationsWithPreferredFrameRateRange:(struct CAFrameRateRange { float x1; float x2; float x3; })arg1 updateReason:(unsigned int)arg2 animations:(id /* block */)arg3;

- (void)suia_replaceInProcessAnimationForKeyPath:(id)arg1 settings:(id)arg2 interactive:(bool)arg3;
- (void)suia_replaceInProcessAnimationForKeyPath:(id)arg1 settings:(id)arg2 mode:(long long)arg3;
- (void)suia_setBoundsAndPositionFromFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
...
- (id)tk_addedConstraintForItem:(id)arg1 layoutAttribute:(long long)arg2 relatedBy:(long long)arg3 toItem:(id)arg4 attribute:(long long)arg5 multiplier:(double)arg6 constant:(double)arg7;
...
- (id)tk_addedConstraintForLayoutAttribute:(long long)arg1 asGreaterThanOrEqualToValueOfItem:(id)arg2 withOffset:(double)arg3;
...
- (void)tk_constrainLayoutAttribute:(long long)arg1 ofItem:(id)arg2 asEqualToValueOfItem:(id)arg3;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })vk_convertFrameToViewScale:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 shouldRound:(bool)arg2;
