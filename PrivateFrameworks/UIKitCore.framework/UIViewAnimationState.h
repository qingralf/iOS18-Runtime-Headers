...
@interface UIViewAnimationState : NSObject <CAAnimationDelegate> {
    ...
    unsigned int  _shouldDecomposeGeometricTypes;
    double  _start;
...
@property (nonatomic, readonly) bool _runsAlongsideAnimations;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (nonatomic, readonly) id delegate;
@property (readonly, copy) NSString *description;
@property (nonatomic) bool disallowInheritance;
@property (readonly) unsigned long long hash;
@property (nonatomic, readonly) bool isInProcess;
@property (nonatomic, readonly) UIViewAnimationState *nextState;
@property (nonatomic, readonly) struct CAFrameRateRange { float x1; float x2; float x3; } preferredFrameRateRange;
@property (nonatomic, readonly) bool shouldDecomposeGeometricTypes;
...
- (id)_createDeferredAnimationForKey:(id)arg1 ignoringKeyFrames:(bool)arg2;
- (void)_decrementDidEndCount;
- (id)_defaultAnimationForKey:(id)arg1;
- (id)_deferredAnimationForView:(id)arg1 key:(id)arg2 ignoringKeyFrames:(bool)arg3;
- (int)_didEndCount;
...
- (void)setDisallowInheritance:(bool)arg1;
