...
@interface UIViewController : UIResponder <BSTraitEnvironment, DOCAppearanceCustomization, DOCUIPTraitEnvironment, DOCUIPTraitObserving, DOCViewAndControllerCommonExtensions, EKUIFutureTraitEnvironment, GKContentRefresh, GKURLHandling, HUItemPresentationContainer, IMMetricsDataSource, MKInfoCardThemeListener, NSCoding, NSExtensionRequestHandling, PBFDisplayContextProviding, PXAnonymousViewController, PXDiagnosticsEnvironment, PXProgrammaticNavigationParticipant, PaperKit.UIPresentingOverlayViewController, SXHostable, TSPresenterType, UIAppearanceContainer, UIContentContainer, UIFocusEnvironment, UITraitChangeObservable, UITraitChangeObservableInternal, UITraitEnvironment, UIWindowDelegate, VUIControllerPresenter, _UIAlwaysOnEnvironmentObserver, _UIContentContainerInternal, _UIFallbackEnvironment, _UIFocusEnvironmentInternal, _UIOrientationDebugDescriptionProviding, _UIScrollViewScrollObserver_Internal, _UIStatusBarAnimationProviding, _UITraitEnvironmentInternal, _UITraitOverrideDelegate, _UITraitTrackingSupporting, _UIViewServiceDeputy> {
...
@property (setter=_setPreferredTransition:, nonatomic, retain) _UIViewControllerTransition *_preferredTransition;
...
@property (setter=_setTabElementChangeObserver:, nonatomic) <_UIViewControllerTabElementObserver> *_tabElementChangeObserver;
...
@property (nonatomic, readonly) UIViewController *childViewControllerForRepresentedItem;
...
@property (nonatomic) bool ic_shouldHideModeButtonWhenPresented;
...
@property (nonatomic, readonly) UIView *itk_view;
@property (nonatomic, readonly) UIView *itk_viewIfLoaded;
...
@property (nonatomic, retain) UIViewControllerTransition *preferredTransition;
...
@property (nonatomic, readonly) long long px_deprecatedInterfaceOrientation;
...
@property (nonatomic) bool shouldUseSystemSwipeToDismiss;
...
@property (nonatomic, readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } visibleBoundsForOverlay;
...
@property (nonatomic) bool vui_requiresLegacyPresentation; /* unknown property attribute: ? */
...
- (void)_presentViewController:(id)arg1 modalSourceViewController:(id)arg2 presentationController:(id)arg3 animationController:(id)arg4 interactionController:(id)arg5 handoffData:(id)arg6 completion:(id /* block */)arg7;
...
- (void)EKUI_annotateIfNeededWithAppEntityForEvent:(id)arg1 isEditing:(bool)arg2;
...
- (void)gp_addChildViewController:(id)arg1;
...
- (id)ams_parentViewControllerOfClass:(Class)arg1;
...
+ (void)doc_performWithDeferredTransitionsAndAnimationsDisabled:(id /* block */)arg1;
+ (void)load;

- (id)_appearance;
- (void)_doc_liveResizeDidEnd;
- (void)_notifyAppearanceChange:(id)arg1;
- (void)doc_addChildViewController:(id)arg1 addSubviewBlock:(id /* block */)arg2;
...
- (bool)doc_scheduleHandlerIfInLiveResize:(SEL)arg1;
...
+ (void)hu_presentingLockLimitAlertIfNeededFromViewController:(id)arg1 home:(id)arg2 user:(id)arg3 accessory:(id)arg4 include:(bool)arg5 continueActionBlock:(id /* block */)arg6 cancelActionBlock:(id /* block */)arg7;
...
- (void)hu_presentNotificationAlertForNotificationCapableObjects:(id)arg1 notificationsEnabled:(bool)arg2 mainActionBlock:(id /* block */)arg3 notNowActionBlock:(id /* block */)arg4;
...
- (void)ic_hostedNotesUpdateAdditionalSafeAreaInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg1 isModeButtonHidden:(bool)arg2;
...
- (bool)ic_shouldHideModeButtonWhenPresented;
...
- (id)ic_window;
- (id)ic_windowScene;
- (void)setIc_shouldHideModeButtonWhenPresented:(bool)arg1;
...
- (id)representedItemDiagnosticDescription;
...
+ (id)px_freezeViewController:(id)arg1 timeout:(double)arg2;
...
- (id)px_createViewControllerWithHiddenStatusBarForMainViewController:(id)arg1;
- (long long)px_deprecatedInterfaceOrientation;
- (id)px_descendantViewControllerWithClass:(Class)arg1;
...
- (void)px_dismissPresentedViewControllerWithOptions:(unsigned long long)arg1 completionHandler:(id /* block */)arg2;
...
- (bool)tryToPresentMovieForAssetCollection:(id)arg1;
...
- (id)representedItem;
- (void)setShouldUseSystemSwipeToDismiss:(bool)arg1;
- (bool)shouldUseSystemSwipeToDismiss;
...
- (id)sbh_pushOwningIconView:(id)arg1;
- (id)sbh_removeOwningIconView:(id)arg1;
...
- (void)vs_makeFrontmostAnimated:(bool)arg1 completion:(id /* block */)arg2;
- (void)vs_makeTopmostInNavigationStack:(bool)arg1 completion:(id /* block */)arg2;
- (void)vs_setIgnoreInteractionCount:(long long)arg1;
- (void)vs_updateNavigationItemAndForceViewReloadWithSearchController:(id)arg1;
- (void)vs_updateNavigationItemAndForceViewReloadWithSearchController:(id)arg1 rightBarButtonItem:(id)arg2;
- (void)vs_updateViewModel:(id)arg1 withUserInterfaceStyle:(long long)arg2 andPreferredLogoSize:(struct CGSize { double x1; double x2; })arg3;
...
- (void)vui_loadView;
- (void)vui_presentViewController:(id)arg1 animated:(bool)arg2 completion:(id /* block */)arg3;
- (void)vui_presentedContentSizeChanged:(id)arg1;
...
+ (struct CGSize { double x1; double x2; })ICQUIUpsellPrefferredPresentationSize;
+ (id)makeLiftUIViewControllerForController:(id)arg1 withContent:(id)arg2 account:(id)arg3 presenter:(id)arg4 data:(id)arg5;
+ (id)makeLiftUIViewControllerForController:(id)arg1 withURL:(id)arg2 account:(id)arg3 presenter:(id)arg4 data:(id)arg5;
+ (void)setICQUIUpsellPrefferredPresentationSize:(struct CGSize { double x1; double x2; })arg1;

- (void)addChildAndPinToEdgesWithChildViewController:(id)arg1;
- (void)presentPreferredSizeWithViewController:(id)arg1 animated:(bool)arg2 completion:(id /* block */)arg3;
