...
@property (setter=_setShouldBeginFromCurrentState:, nonatomic) bool _shouldBeginFromCurrentState;
...
- (double)_pauseAnimation:(id)arg1 fromStart:(bool)arg2;
- (double)_pauseAnimation:(id)arg1 fromStart:(bool)arg2 minimizingStateModifications:(bool)arg3;
- (bool)_pausesOnCompletion;
...
- (void)_setShouldBeginFromCurrentState:(bool)arg1;
...
- (void)_updateAnimationsToFractionComplete:(double)arg1;
...
- (double)computeCurrentTimingFunction:(double)arg1;
- (double)computeInverseOfCurrentTimingFunction:(double)arg1;
...
+ (id)ck_viewPropertyAnimatorWithMass:(double)arg1 stiffness:(double)arg2 damping:(double)arg3;
+ (id)ck_viewPropertyAnimatorWithMass:(double)arg1 stiffness:(double)arg2 damping:(double)arg3 initialVelocity:(struct CGVector { double x1; double x2; })arg4;
