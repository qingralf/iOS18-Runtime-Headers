...
@interface UIVisualEffectView : UIView <NSSecureCoding, _UIAssertionControllerSubject> {
...
@property (getter=_isContentViewStatic, setter=_setIsContentViewStatic:, nonatomic) bool _isContentViewStatic;
...
- (id)_maskView;
- (id)_obtainDynamicContentAssertionForReason:(id)arg1;
...
- (void)_setIsContentViewStatic:(bool)arg1;
...
+ (id)sf_startPageCellBackgroundEffectViewWithShadow:(bool)arg1 shadowRadius:(double)arg2;
...
- (void)sf_configureAsStartPageBackgroundIgnoringVibrancyWithBackgroundColor:(id)arg1;
