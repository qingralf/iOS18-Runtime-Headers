...
@interface UIWebClip : NSObject {
    ...
    unsigned long long  _eligibilityStatus;
    ...
    NSSet * _trustedClientBundleIdentifiers;
...
@property (nonatomic, readonly) NSURL *_sf_stagedCookiesURL;
@property (readonly) bool alternativeFullScreen;
...
@property (nonatomic, retain) UIImage *darkIconImage;
...
@property (nonatomic, retain) UIImage *tintableIconImage;
@property (nonatomic, copy) NSString *title;
@property (nonatomic, readonly) NSSet *trustedClientBundleIdentifiers;
...
+ (id)clipsIncludingWebClips:(bool)arg1 includingAppClips:(bool)arg2 trustedByClientBundleIdentifier:(id)arg3;
...
+ (id)webClipWithDictionaryRepresentation:(id)arg1;
+ (id)webClipWithIdentifier:(id)arg1;
+ (bool)webClipWithIdentifierExists:(id)arg1;
+ (id)webClipWithURL:(id)arg1;
+ (id)webClipWithUUID:(id)arg1;
+ (id)webClips;
...
- (id)_info;
- (id)_initWithIdentifier:(id)arg1 dictionaryRepresentation:(id)arg2;
- (id)_launchURLWithScheme:(id)arg1;
- (void)_readPropertiesFromInfoPlist:(id)arg1;
- (void)_reloadProperties;
- (void)_removePlaceholderBundleAndClearBadge;
- (void)_removePlaceholderBundleWithCompletion:(id /* block */)arg1;
...
- (void)_updateWebClipWithEligibility:(unsigned long long)arg1;
- (bool)_writeIconImage:(id)arg1 toDiskWithFileName:(id)arg2;
- (bool)_writeImage:(id)arg1 toDiskWithFileName:(id)arg2;
- (bool)addTrustedClientBundleIdentifier:(id)arg1;
...
- (void)dealloc;
- (id)delegate;
- (id)eligibilityAlert:(id /* block */)arg1;
- (unsigned long long)eligibilityStatus;
...
- (void)setTintableIconImage:(id)arg1;
...
- (unsigned long long)supportedOrientations;
- (id)tintableIconImage;
- (id)title;
- (id)trustedClientBundleIdentifiers;
