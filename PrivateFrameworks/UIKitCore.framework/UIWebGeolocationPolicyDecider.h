...
- (bool)_getAuthorizationStatusForToken:(id)arg1 userVisibleDomain:(id)arg2 requestingURL:(id)arg3 promptInfo:(id*)arg4;
...
- (void)clearAllCaches;
- (void)clearAuthorizationForDomain:(id)arg1;
