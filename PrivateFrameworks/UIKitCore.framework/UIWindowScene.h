...
@property (setter=SBSUI_setHearingTestMode:, nonatomic) long long SBSUI_hearingTestMode;
...
@property (nonatomic, readonly) UIWindow *_delegateWindow;
...
@property (nonatomic, readonly) long long _systemUserInterfaceStyle;
@property (nonatomic, readonly) UITraitCollection *_traitCollection;
@property (nonatomic, readonly) <_UIWindowSceneTransitionCoordinator> *_transitionCoordinator;
...
- (void)_hostTraitCollectionDidChange:(id)arg1;
...
- (struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })SBSUI_preferredSystemRootLayerTransform;
- (void)SBSUI_setHearingTestMode:(long long)arg1;
- (bool)SBUI_isHostedBySystemAperture;
- (void)setSBSUI_preferredSystemRootLayerTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg1;
