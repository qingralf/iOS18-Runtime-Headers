...
@property (nonatomic, retain) _UIDoubleTapInteraction *doubleTapInteraction;
...
- (void)_endEffectWithVelocity:(double)arg1 forActiveConfigurationWithCompletionStatus:(bool)arg2;
- (void)_handlePinchGesture:(id)arg1;
- (void)_prepareEffectForActiveConfigurationAtLocation:(struct CGPoint { double x1; double x2; })arg1 completion:(id /* block */)arg2;
- (void)_prepareSceneActivationConfiguration:(id)arg1;
- (void)_prewarmAnimationWithCompletion:(id /* block */)arg1;
- (id)_requestConfigurationForLocation:(struct CGPoint { double x1; double x2; })arg1;
...
- (void)setDoubleTapInteraction:(id)arg1;
