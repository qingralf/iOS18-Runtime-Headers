...
@interface _UIApplicationInfoParser : NSObject {
    ...
    bool  _observationTrackingEnabled;
    bool  _optOutOfRTL;
...
@property (nonatomic, readonly) NSArray *editorRoleDocumentUTTypes;
...
@property (nonatomic, readonly) bool observationTrackingEnabled;
...
@property (nonatomic, readonly) NSArray *viewerRoleDocumentUTTypes;
