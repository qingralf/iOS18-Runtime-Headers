...
@property (getter=_sourceViewController, setter=_setSourceViewController:, nonatomic, retain) UIViewController *sourceViewController;
...
- (bool)_shouldAnimatePresentationForIdiom:(long long)arg1;
- (id)_showTimer;
...
- (void)displayForCopyingFileAtURL:(id)arg1 toURL:(id)arg2 sourceViewController:(id)arg3 completionHandler:(id /* block */)arg4;
- (void)displayForDownloadingURL:(id)arg1 copyToURL:(id)arg2 sourceViewController:(id)arg3 completionHandler:(id /* block */)arg4;
- (void)displayForDownloadingURL:(id)arg1 sourceViewController:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)displayWithTitle:(id)arg1 message:(id)arg2 progress:(id)arg3 buttonTitle:(id)arg4 sourceViewController:(id)arg5 preDisplayTestBlock:(id /* block */)arg6 dismissalHandler:(id /* block */)arg7;
- (void)hideAfterDelay:(double)arg1 forceCompletion:(bool)arg2 replacementDismissalHandler:(id /* block */)arg3;
