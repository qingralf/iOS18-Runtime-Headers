...
@property (nonatomic, readonly) bool hasValidIconSize;
...
- (double)_percentTextXAdjustmentWhenFullForTraitCollection:(id)arg1;
...
- (void)setRounded:(bool)arg1 iconSize:(long long)arg2;
