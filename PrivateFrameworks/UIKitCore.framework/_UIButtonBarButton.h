...
@interface _UIButtonBarButton : UIControl <UIPointerInteractionDelegate, UISpringLoadedInteractionSupporting, _UISelectionInteractionDelegate> {
...
@property (nonatomic, retain) _UISelectionInteraction *_selectionInteraction;
...
- (void)set_selectionInteraction:(id)arg1;
