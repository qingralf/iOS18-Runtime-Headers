...
@interface _UIClickPresentationInteraction : NSObject <UIGestureRecognizerDelegate, UIInteraction, UIInteraction_Internal, _UIClickInteractionDriverDelegate, _UIDragInteractionPresentationDelegate> {
    ...
    struct { 
        ...
        bool shouldMaintainKeyboardAssertion; 
    }  _delegateImplements;
...
@property (nonatomic) struct CAPoint3D { double x1; double x2; double x3; } initialLocation;
...
- (unsigned long long)fallbackDriverStyle;
...
- (struct CAPoint3D { double x1; double x2; double x3; })initialLocation;
...
- (void)setFallbackDriverStyle:(unsigned long long)arg1;
- (void)setFeedbackGenerator:(id)arg1;
- (void)setInitialLocation:(struct CAPoint3D { double x1; double x2; double x3; })arg1;
