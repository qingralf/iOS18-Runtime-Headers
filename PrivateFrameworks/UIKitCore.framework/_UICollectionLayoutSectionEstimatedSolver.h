...
@property (nonatomic, readonly) _UICollectionLayoutContainer *container;
...
@property (nonatomic, retain) _UICollectionLayoutContainer *supplementaryContainer;
...
- (id)unpinnedSectionSupplementaryFrameWithKind:(id)arg1 forIndex:(long long)arg2;
