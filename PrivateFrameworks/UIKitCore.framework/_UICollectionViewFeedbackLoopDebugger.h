...
- (void).cxx_destruct;
- (id)init;
- (void)printCollectedRecordsForCollectionView:(id)arg1 raiseException:(bool)arg2;
...
- (void)recordCollectionViewPointPropertyChange:(id)arg1 fromPoint:(struct CGPoint { double x1; double x2; })arg2 toPoint:(struct CGPoint { double x1; double x2; })arg3;
