...
@property (nonatomic, readonly) long long _headerFooterPinningBehavior;
...
- (void)_configureLayoutAttributesForSwipeActionMasking:(id)arg1 interactionState:(id)arg2;
...
- (void)_updateMaxWidthForLayoutAttributes:(id)arg1;
