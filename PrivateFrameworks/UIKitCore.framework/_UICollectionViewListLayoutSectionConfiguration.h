...
- (struct NSDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })_sectionContentInsetsForAppearanceStyleWithDefaultInsets:(struct NSDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })arg1 headerFootersAreChromeless:(bool)arg2;
...
- (void)setSectionHeaderHugsContent:(bool)arg1;
