...
- (id)_collectionView:(id)arg1 sceneActivationConfigurationForItemAtIndexPath:(id)arg2 point:(struct CGPoint { double x1; double x2; })arg3;
...
- (id)_dci_collectionView:(id)arg1 contextMenuConfigurationForSelectedItemsAtIndexPaths:(id)arg2 point:(struct CGPoint { double x1; double x2; })arg3;
