...
@interface _UIContextMenuContainerView : UIView <_UIPassthroughScrollInteractionDelegate, _UIScrollToTopView> {
    bool  _allowsDragEventsToPassthrough;
...
@property (nonatomic) bool allowsDragEventsToPassthrough;
...
- (void)_sceneGeometryWillUpdate:(id)arg1;
...
- (void)setAllowsDragEventsToPassthrough:(bool)arg1;
