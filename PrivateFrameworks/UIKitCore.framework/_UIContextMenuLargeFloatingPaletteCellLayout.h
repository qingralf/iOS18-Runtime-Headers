...
@interface _UIContextMenuLargeFloatingPaletteCellLayout : NSObject <_UIContextMenuCellLayout> {
...
@property (nonatomic, retain) _UIFloatingContentView *floatingContentView;
...
- (void).cxx_destruct;
- (void)_configureSharedFloatingContentViewStyleForImageStyle:(bool)arg1;
...
- (void)setFloatingContentView:(id)arg1;
