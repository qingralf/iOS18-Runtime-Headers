...
@interface _UIContextMenuLayoutArbiterInput : NSObject {
    ...
    id /* block */  _computePreferredScrollTruncationDetentForHeight;
...
@property (nonatomic, copy) id /* block */ computePreferredScrollTruncationDetentForHeight;
...
- (id)accessoryViews;
- (id /* block */)computePreferredScrollTruncationDetentForHeight;
- (id)init;
...
- (void)setComputePreferredScrollTruncationDetentForHeight:(id /* block */)arg1;
- (void)setMaximumMenuHeight:(double)arg1;
