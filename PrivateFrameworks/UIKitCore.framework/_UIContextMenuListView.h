...
- (void)_configureCell:(id)arg1 inCollectionView:(id)arg2 atIndexPath:(id)arg3 forElement:(id)arg4 section:(id)arg5 size:(long long)arg6;
...
- (void)highlightItemAtIndexPath:(id)arg1 forHover:(bool)arg2 playFeedback:(bool)arg3;
...
- (void)setSubmenuTitleViewExpanded:(bool)arg1 withMaterialGroupName:(id)arg2 associatedCellContentView:(id)arg3 highlighted:(bool)arg4;
