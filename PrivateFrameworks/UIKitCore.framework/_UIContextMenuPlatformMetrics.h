...
@interface _UIContextMenuPlatformMetrics : NSObject <_UIVisualStyleProviding> {
    ...
    bool  _containerViewsHitTestAsOpaque;
    ...
    id /* block */  _menuHighlightBackgroundDescriptorProvider;
    struct NSDirectionalEdgeInsets { 
        double top; 
        double leading; 
        double bottom; 
    ...
    id /* block */  _menuTitleBackgroundProvider;
    ...
    bool  _previewIsConstrainedToSourceWindowBounds;
    ...
    bool  _supportsPassthroughInteraction;
...
@property (nonatomic) bool containerViewsHitTestAsOpaque;
...
@property (nonatomic, retain) UIShape *mediumItemContentShape;
...
@property (nonatomic, copy) id /* block */ menuHeaderBackgroundProvider;
@property (nonatomic, copy) id /* block */ menuHighlightBackgroundDescriptorProvider;
...
@property (nonatomic, copy) id /* block */ menuTitleBackgroundProvider;
...
@property (nonatomic) bool previewIsConstrainedToSourceWindowBounds;
@property (nonatomic) double previewPlatterCornerRadius;
@property (nonatomic) struct CGSize { double x1; double x2; } previewPlatterMaximumSize;
...
@property (nonatomic, retain) _UIShadowProperties *previewShadowSettings;
...
@property (nonatomic, retain) UIShape *smallItemContentShape;
...
@property (nonatomic) bool supportsPassthroughInteraction;
...
- (id)mediumItemContentShape;
- (id)menuBackgroundColor;
- (id)menuBackgroundEffect;
- (double)menuCornerRadius;
- (double)menuGutterWidth;
- (id /* block */)menuHeaderBackgroundProvider;
- (id /* block */)menuHighlightBackgroundDescriptorProvider;
...
- (id /* block */)menuTitleBackgroundProvider;
- (id)menuTitleFont;
...
- (struct CGSize { double x1; double x2; })previewPlatterMaximumSize;
...
- (void)setContainerViewsHitTestAsOpaque:(bool)arg1;
...
- (void)setMediumItemContentShape:(id)arg1;
...
- (void)setMenuHeaderBackgroundProvider:(id /* block */)arg1;
- (void)setMenuHighlightBackgroundDescriptorProvider:(id /* block */)arg1;
...
- (void)setMenuTitleBackgroundProvider:(id /* block */)arg1;
...
- (void)setPreviewIsConstrainedToSourceWindowBounds:(bool)arg1;
- (void)setPreviewPlatterCornerRadius:(double)arg1;
- (void)setPreviewPlatterMaximumSize:(struct CGSize { double x1; double x2; })arg1;
...
- (void)setSmallItemContentShape:(id)arg1;
- (void)setSmallItemLastBaselineToBottom:(double)arg1;
- (void)setSmallItemTopToFirstBaseline:(double)arg1;
...
- (void)setSupportsPassthroughInteraction:(bool)arg1;
