...
@interface _UIContextMenuPreviewPresentationController : UIPresentationController {
    <_UIContextMenuPreviewPresentationControllerDelegate> * _menuPresentationDelegate;
...
@property (nonatomic) <_UIContextMenuPreviewPresentationControllerDelegate> *menuPresentationDelegate;
...
- (void)setMenuPresentationDelegate:(id)arg1;
