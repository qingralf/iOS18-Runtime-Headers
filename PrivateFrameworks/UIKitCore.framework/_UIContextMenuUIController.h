...
@property (nonatomic) bool didAvoidKeyboard;
...
- (bool)_needsToAvoidKeyboardForResponder:(id)arg1;
- (id)_platformMetrics;
...
- (void)setDidAvoidKeyboard:(bool)arg1;
...
- (bool)shouldMaintainKeyboardAssertionForFirstResponder:(id)arg1;
