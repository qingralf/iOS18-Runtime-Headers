...
@property (nonatomic) <_UIDiffableDataSourceSectionControllerDelegate> *delegate;
...
- (void).cxx_destruct;
- (void)__applySnapshot:(id)arg1 toSection:(id)arg2 animatingDifferences:(bool)arg3 viewPropertyAnimator:(id)arg4 animationsProvider:(id /* block */)arg5 isOnDiffableApplyQueue:(bool)arg6 completion:(id /* block */)arg7;
- (void)_applySnapshot:(id)arg1 toSection:(id)arg2 animatingDifferences:(bool)arg3 viewPropertyAnimator:(id)arg4 animationsProvider:(id /* block */)arg5 isOnDiffableApplyQueue:(bool)arg6 completion:(id /* block */)arg7;
- (id)_collectionView;
- (void)_configureCell:(id)arg1 forItem:(id)arg2 inSnapshot:(id)arg3;
...
- (id)_snapshotsMap;
- (void)_updatePreparedCellsForExpansionStateWithSnapshot:(id)arg1;
