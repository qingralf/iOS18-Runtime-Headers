...
@interface _UIDiffableDataSourceViewUpdater : NSObject <_UICollectionViewUpdateItemApplying> {
    ...
    <_UICollectionDataSourceSnapshotTranslating> * _dataSourceSnapshot;
...
@property (nonatomic, retain) <_UICollectionDataSourceSnapshotTranslating> *dataSourceSnapshot;
...
- (long long)_performUpdateWithCollectionViewUpdateItems:(id)arg1 dataSourceSnapshot:(id)arg2 updateHandler:(id /* block */)arg3 completion:(id /* block */)arg4 viewPropertyAnimator:(id)arg5 customAnimationsProvider:(id /* block */)arg6 animated:(bool)arg7;
