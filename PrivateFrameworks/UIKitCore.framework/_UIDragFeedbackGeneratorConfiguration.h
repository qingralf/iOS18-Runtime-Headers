...
@property (nonatomic, retain) NSString *hidTargetUpdatedFeedbackPatternName;
...
- (id)hidTargetUpdatedFeedbackPatternName;
...
- (void)setHidTargetUpdatedFeedbackPatternName:(id)arg1;
