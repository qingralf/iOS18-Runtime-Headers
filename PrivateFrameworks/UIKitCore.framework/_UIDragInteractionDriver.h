...
@property (nonatomic, readonly) UIGestureRecognizer *gestureRecognizerForDragInitiation;
@property (readonly) unsigned long long hash;
@property (nonatomic) struct CGPoint { double x1; double x2; } initialLocationInWindow;
@property (nonatomic, readonly) <UIDragInteractionEffect> *interactionEffect; /* unknown property attribute: ? */
