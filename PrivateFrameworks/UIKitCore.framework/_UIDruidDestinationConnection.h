...
- (oneway void)performDropWithItemCollection:(id)arg1 dataProviderEndpoint:(id)arg2 visibleDroppedItems:(id)arg3 completion:(id /* block */)arg4;
- (oneway void)requestDragPreviewsForIndexSet:(id)arg1 reply:(id /* block */)arg2;
- (void)requestDropWithOperation:(unsigned long long)arg1 layerContext:(id)arg2;
