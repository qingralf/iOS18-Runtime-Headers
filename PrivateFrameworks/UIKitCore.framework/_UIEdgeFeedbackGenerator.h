...
- (void)_positionUpdated:(double)arg1 withVelocity:(double)arg2 atLocation:(struct CGPoint { double x1; double x2; })arg3;
- (double)_previousValue;
- (double)_previousValueUpdateTime;
...
- (void)positionUpdated:(double)arg1 atLocation:(struct CGPoint { double x1; double x2; })arg2;
