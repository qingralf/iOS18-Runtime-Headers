...
@property (nonatomic, readonly) UIHoverGestureRecognizer *hoverGestureRecognizer;
...
- (bool)_isPaginationDirtyForContainerSize:(struct CGSize { double x1; double x2; })arg1;
...
- (id)hoveredIndexPath;
- (id)initWithDelegate:(id)arg1 menu:(id)arg2 titleView:(id)arg3 preferredElementDisplayMode:(unsigned long long)arg4;
...
- (unsigned long long)preferredElementDisplayMode;
...
- (void)setPreferredElementDisplayMode:(unsigned long long)arg1;
