...
@property (getter=_location, setter=_setLocation:, nonatomic) struct CGPoint { double x1; double x2; } location;
...
@property (getter=_view, setter=_setView:, nonatomic) UIView *view;
