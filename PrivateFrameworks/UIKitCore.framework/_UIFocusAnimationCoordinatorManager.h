...
@property (nonatomic, retain) NSMutableArray *inheritedAnimationCoordinatorActiveAnimationStack;
...
+ (id)animationCoordinatorForContext:(id)arg1;
...
- (id)inheritedAnimationCoordinatorActiveAnimationStack;
- (id)init;
- (double)lastFocusUpdateTime;
- (id)lastFocusingItemAnimationCoordinator;
- (void)setActiveFocusAnimationCoordinator:(id)arg1;
- (void)setInheritedAnimationCoordinatorActiveAnimationStack:(id)arg1;
