...
@interface _UIForcedOrientationTransactionToken : NSObject <BSDebugDescriptionProviding, _UIOrientationDebugDescriptionProviding> {
    ...
    bool  _disablesInterfaceAutorotation;
...
@property (nonatomic, readonly) bool disablesInterfaceAutorotation;
...
- (id)initWithOriginalOrientation:(long long)arg1 handler:(id)arg2 reason:(id)arg3 disablingInterfaceAutorotation:(bool)arg4;
