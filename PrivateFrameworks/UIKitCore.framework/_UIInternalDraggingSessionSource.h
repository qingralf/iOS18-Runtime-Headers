...
@property (nonatomic, readonly) bool restrictedToSourceApp;
...
- (void)_setupAnimationForCancelledItems:(id)arg1 returningLayerContext:(id*)arg2;
- (void)_updatedPresentation:(id)arg1;
