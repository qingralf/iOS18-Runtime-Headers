...
- (void)modifySelectionWithExtentPoint:(struct CGPoint { double x1; double x2; })arg1 executionContext:(id)arg2;
...
- (void)selectPositionAtPoint:(struct CGPoint { double x1; double x2; })arg1 granularity:(long long)arg2 completionHandler:(id /* block */)arg3;
- (void)selectPositionAtPoint:(struct CGPoint { double x1; double x2; })arg1 granularity:(long long)arg2 executionContext:(id)arg3;
