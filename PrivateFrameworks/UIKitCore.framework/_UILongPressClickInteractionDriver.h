...
@property (nonatomic, readonly) bool allowsFeedback; /* unknown property attribute: ? */
@property (nonatomic) unsigned long long behavior; /* unknown property attribute: ? */
...
@property (nonatomic) unsigned long long driverStyle; /* unknown property attribute: ? */
...
- (void)_updateTimeoutDebugUI:(double)arg1;
