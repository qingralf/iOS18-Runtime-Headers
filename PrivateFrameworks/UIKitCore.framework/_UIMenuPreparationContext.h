...
@interface _UIMenuPreparationContext : NSObject <NSCopying> {
    ...
    id  _preparer;
    id  _sender;
    id /* block */  _shouldTrackVisibleSelection;
...
@property (nonatomic, copy) id /* block */ shouldTrackVisibleSelection;
...
- (void)setShouldTrackVisibleSelection:(id /* block */)arg1;
...
- (bool)shouldTrackSelectionForVisibleIndex:(unsigned long long)arg1 elementSize:(long long)arg2;
- (id /* block */)shouldTrackVisibleSelection;
