...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })_layoutFrameFor:(id)arg1 withOrder:(long long)arg2;
- (long long)_promptOrder;
- (void)_removeLayoutItem:(id)arg1;
- (void)_reorderLayoutItem:(id)arg1 toOrder:(long long)arg2;
