...
@interface _UINavigationBarTitleView : UIView <_UINavigationBarAugmentedTitleView> {
    ...
    bool  _heightShouldBeIncreasedByTabBarHeight;
...
@property (nonatomic, readonly) double floatingTabBarHeight;
@property (readonly) unsigned long long hash;
@property (nonatomic) double height;
@property (nonatomic) double heightExtension;
@property (nonatomic) bool heightShouldBeIncreasedByTabBarHeight;
...
@property (nonatomic, readonly) _UINavigationBarTitleViewOverlayRects *overlays;
...
- (void)setHeightExtension:(double)arg1;
- (void)setHeightShouldBeIncreasedByTabBarHeight:(bool)arg1;
