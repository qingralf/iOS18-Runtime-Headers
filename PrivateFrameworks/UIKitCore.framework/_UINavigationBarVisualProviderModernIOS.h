...
@interface _UINavigationBarVisualProviderModernIOS : _UINavigationBarVisualProvider <_UIBarAppearanceChangeObserver, _UIBarCustomizerDelegate, _UIBasicAnimationFactory, _UINavigationBarContentViewDelegate, _UINavigationBarTitleRenamerDelegate, _UINavigationControllerRefreshControlHostDelegate, _UINavigationItemChangeObserver, _UITabContainerViewFloatingTabBarHost> {
    ...
    bool  _isHidden;
    bool  _isHostingPlaceholderFromTabBarContainer;
    bool  _isObservingDidEncounterFirstTitleWithExcessiveHeightChanged;
    bool  _isSuppressingTabBar;
...
- (void)_performAnimationWithTransitionCompletion:(id /* block */)arg1 transition:(long long)arg2;
- (void)_popToItem:(id)arg1;
- (void)_postDidEncounterFirstTitleWithExcessiveHeightChanged;
- (void)_prepareLayouts;
- (void)_presentOrDismissSearch:(long long)arg1 withTransitionCoordinator:(id)arg2;
...
- (void)_setupTransitionContextForTransition:(long long)arg1 completion:(id /* block */)arg2;
...
- (void)_updatePlaceholderFromTabBarContainer:(id)arg1;
...
- (bool)_useLargeTitleForDisplayMode:(long long)arg1;
...
- (double)contentViewVerticalOffsetInTabBarContainer:(id)arg1;
...
- (void)tabBarContainerDidLayoutFloatingTabBar:(id)arg1;
- (void)tabBarContainerWillChangeFloatingTabBarVisibility:(id)arg1;
- (id)tabBarHostedView;
- (void)teardown;
- (double)titleAlpha;
