...
@property (nonatomic, readonly, copy) BSAuditToken *_auditToken;
...
+ (id)_cameraCaptureShutterConfigurationWithOptionsProvider:(id /* block */)arg1;
+ (id)_cameraShutterConfigurations;
+ (id)_cameraShutterConfigurationsWithOptions:(id)arg1;
+ (id)_cameraShutterConfigurationsWithOptionsProvider:(id /* block */)arg1;
