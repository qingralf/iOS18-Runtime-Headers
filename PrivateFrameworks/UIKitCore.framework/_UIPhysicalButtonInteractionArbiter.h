...
@interface _UIPhysicalButtonInteractionArbiter : NSObject <BSDebugDescriptionProviding, _UIEventDeferringEnvironmentTargetProviding, _UIEventDeferringRuleOwning, _UIWindowHostingSceneComponentProviding, _UIWindowLevelObserver> {
    struct { 
        unsigned int hasRegisteredAsEventDeferringEnvironmentTargetProvider : 1; 
