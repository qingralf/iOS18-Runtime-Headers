...
- (id)menuView;
- (struct CGVector { double x1; double x2; })modifiedOffsetForPosition:(struct CGPoint { double x1; double x2; })arg1 offset:(struct CGVector { double x1; double x2; })arg2 touchPosition:(struct CGPoint { double x1; double x2; })arg3 axisLock:(unsigned long long)arg4;
