...
@interface _UIRemoteViewController : UIViewController <APBaseExtensionShieldViewDelegate, APSubjectMonitor, UIDimmingViewDelegate, _UIEventDeferringRuleOwning, _UIPhysicalButtonProxyInteractionDelegate, _UIRemoteSheet, _UIRemoteSheet_Internal, _UIRemoteViewController_ViewControllerOperatorInterface> {
    ...
    struct { 
        ...
        unsigned int hasConfiguredAppProtection : 1; 
        unsigned int appProtectionLocked : 1; 
        unsigned int applyShieldWhenPresentedIfNecessary : 1; 
...
@property (nonatomic) _UIZoomTransitionController *_ancestorZoomTransitionController;
@property (getter=_isAppProtectionLocked, nonatomic, readonly) bool _appProtectionLocked;
@property (nonatomic, readonly) NSString *_extensionBundleIdentifierForAppProtection;
...
@property (nonatomic, retain) _UISheetPresentationControllerConfiguration *_proxySheetConfigurationBeforeDeferring;
...
- (void)__viewServiceDidUpdateClientToHostAction:(id)arg1;
...
- (void)__viewServiceDismissInteractionDidBeginAtLocation:(struct CGPoint { double x1; double x2; })arg1 withVelocity:(struct CGPoint { double x1; double x2; })arg2;
- (void)__viewServiceDismissInteractionDidCancelWithVelocity:(struct CGPoint { double x1; double x2; })arg1 originalPosition:(struct CGPoint { double x1; double x2; })arg2;
- (void)__viewServiceDismissInteractionDidDismissWithVelocity:(struct CGPoint { double x1; double x2; })arg1;
- (void)__viewServiceDismissInteractionDidIssueUpdate:(id)arg1;
...
- (id)_ancestorZoomTransitionController;
...
- (void)_hostDidEvaluatePencilBarrelEventFocusForSceneTransition:(id)arg1;
...
- (void)_intelligenceCollectRemoteContentInVisibleRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 withRemoteContextWrapper:(id)arg2;
- (bool)_isAppProtectionLocked;
- (bool)_isHostingRemoteContent;
- (bool)_isUpdatingSize;
- (bool)_isUpdatingSizeInHost;
- (id)_keyboardSceneLayers;
- (void)_movedToParentSceneWithSettings:(id)arg1;
...
- (void)_parentSceneDidUpdateWithDiff:(id)arg1;
- (void)_pencilBarrelEventFocusEvaluatedForSceneTransition:(id)arg1;
...
- (id)_proxySheetConfigurationBeforeDeferring;
...
- (void)_screenDidUpdateCapture:(id)arg1;
...
- (void)_setUpHomeAffordanceObserverInteractionForViewIfNeeded:(id)arg1;
...
- (void)_updateAncestorZoomTransitionControllerWithWindow:(id)arg1;
- (void)_updateLockStatusHostingVisibility;
- (void)_updateProxySheetConfigurationIfNeccessaryGivenOldConfiguration:(id)arg1;
...
- (void)performReplyActionsInsideSynchronousReply:(id /* block */)arg1;
...
- (void)set_ancestorZoomTransitionController:(id)arg1;
- (void)set_proxySheetConfigurationBeforeDeferring:(id)arg1;
...
- (void)synchronizeAnimationsInActionsWithSynchronousReply:(id /* block */)arg1;
