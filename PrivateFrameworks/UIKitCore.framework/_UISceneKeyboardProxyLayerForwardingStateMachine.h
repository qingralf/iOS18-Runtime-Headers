...
@interface _UISceneKeyboardProxyLayerForwardingStateMachine : NSObject <_UISceneKeyboardProxyLayerForwardingHostingEnvironmentObserver, _UISceneKeyboardProxyLayerForwardingPresentationEnvironmentObserver, _UIWindowLevelObserver> {
...
- (void)hostingEnvironmentDidInvalidate:(id)arg1;
