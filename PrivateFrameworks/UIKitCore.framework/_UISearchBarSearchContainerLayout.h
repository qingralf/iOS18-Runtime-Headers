...
@property (nonatomic, readonly) double floatingSearchIconBackgroundAlpha;
@property (nonatomic, readonly) struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; } floatingSearchIconBackgroundLayoutFrame;
@property (nonatomic, retain) UIView *floatingSearchIconBackgroundView;
...
@property (nonatomic) bool hasFloatingSearchIconBackgroundView;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })floatingSearchIconBackgroundLayoutFrame;
- (id)floatingSearchIconBackgroundView;
...
- (void)setDefaultActiveWidth:(double)arg1;
- (void)setDefaultInactiveWidth:(double)arg1;
