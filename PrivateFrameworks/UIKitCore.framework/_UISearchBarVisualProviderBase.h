...
@property (nonatomic, readonly) double defaultActiveSearchFieldWidth;
@property (nonatomic, readonly) double defaultInactiveSearchFieldWidth;
...
- (void)setVisualProviderType:(int)arg1;
- (id)shadowView;
