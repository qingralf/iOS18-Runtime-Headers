...
@property (nonatomic, readonly) struct UIEdgeInsets { double x1; double x2; double x3; double x4; } defaultScopeBarInsets;
@property (nonatomic, readonly) UIView *floatingSearchIconBackgroundView;
@property (nonatomic, readonly) bool isHostedInlineByNavigationBar;
@property (nonatomic, readonly) double minimumHorizontalMargin;
@property (nonatomic, readonly) long long previousLayoutState;
@property (nonatomic, retain) _UISearchBarLayout *prospectiveLayout;
@property (nonatomic, readonly) UIView *searchFieldContainerView;
...
- (double)hostedScopeBarHeightForBarMetrics:(long long)arg1;
- (double)hostedScopeBarTopInsetForBarMetrics:(long long)arg1;
...
- (void)setDeferredAutomaticShowsScopeBarInNavigationBar:(id)arg1 hasContent:(bool)arg2;
