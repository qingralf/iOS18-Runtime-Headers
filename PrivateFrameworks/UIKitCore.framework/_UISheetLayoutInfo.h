...
@interface _UISheetLayoutInfo : NSObject <_UISheetDropShadowState, _UISheetPresentationControllerDetentResolutionContext_Internal, _UIViewBoundingPathChangeObserver> {
    ...
    double  __alpha;
    bool  __alwaysAllowsEdgeAttached;
    ...
    bool  __grabberBlurEnabled;
    double  __grabberSpacing;
    bool  __hasActiveFullDetent;
    bool  __hidden;
...
@property (setter=_setAlwaysAllowsEdgeAttached:, nonatomic) bool _alwaysAllowsEdgeAttached;
...
@property (getter=_isExpanded, nonatomic, readonly) bool _expanded;
...
@property (nonatomic, readonly) bool _hasActiveFullDetent;
...
@property (getter=_isModelDimmingEnabled, nonatomic, readonly) bool _modelDimmingEnabled;
...
- (void)_setAlwaysAllowsEdgeAttached:(bool)arg1;
