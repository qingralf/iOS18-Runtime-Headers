...
@interface _UISheetPresentationControllerConfiguration : NSObject <BSXPCSecureCoding, NSSecureCoding> {
    ...
    bool  __shouldScaleDownBehindDescendantSheets;
...
- (bool)_isEqual:(id)arg1 onlyCheckPropertiesRequiringFencing:(bool)arg2;
- (long long)_mode;
...
- (bool)_shouldFenceChangeToConfiguration:(id)arg1;
