...
@property (nonatomic, readonly) long long defaultMode;
...
@property (nonatomic, readonly) double preferredShadowOpacity;
...
- (bool)supportsEdgeAttachedForTraitCollection:(id)arg1;
- (double)topOffset;
