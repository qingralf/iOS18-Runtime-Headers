...
@property (nonatomic, readonly) bool flatImageContainsCornerRadius; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) id radiosityImage; /* unknown property attribute: ? */
@property (nonatomic, readonly) struct CGSize { double x1; double x2; } radiosityImageScale; /* unknown property attribute: ? */
