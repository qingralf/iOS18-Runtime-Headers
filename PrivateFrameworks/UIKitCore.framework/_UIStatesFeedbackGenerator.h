...
- (void)transitionToState:(id)arg1 ended:(bool)arg2 atLocation:(struct CGPoint { double x1; double x2; })arg3;
- (void)transitionToState:(id)arg1 updated:(double)arg2;
- (void)transitionToState:(id)arg1 updated:(double)arg2 atLocation:(struct CGPoint { double x1; double x2; })arg3;
