...
@interface _UISubtitleCellContentView : UIView <_UIContentView, _UIContentViewComponentDescribing> {
...
@property (nonatomic, readonly) bool _preventFocus; /* unknown property attribute: ? */
...
@property (nonatomic, copy) _UISubtitleCellContentViewConfiguration *configuration;
