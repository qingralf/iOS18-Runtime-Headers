...
@interface _UITextInteractableItem : NSObject {
    ...
    <_UIInvalidatable> * _selectionHiddenAssertion;
...
@property (nonatomic) UIEditMenuInteraction *editMenuInteraction;
...
@property (nonatomic, readonly) unsigned long long preferredElementDisplayMode;
@property (nonatomic, readonly) long long preferredMenuExpression;
...
- (long long)preferredMenuExpression;
