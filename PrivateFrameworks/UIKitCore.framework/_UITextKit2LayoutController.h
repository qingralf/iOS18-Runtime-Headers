...
@property (getter=isEditable) bool editable; /* unknown property attribute: ? */
@property (nonatomic, readonly) UITextPosition *endOfDocument;
@property (nonatomic, readonly) NSTextContainer *firstTextContainer;
@property (readonly) unsigned long long hash;
@property (nonatomic, readonly) bool includesTextListMarkers; /* unknown property attribute: ? */
...
- (void).cxx_destruct;
- (void)_invalidateTemporaryAttributesInRange:(id)arg1;
...
- (id)_writingToolsMinimumContextualRangeForRange:(id)arg1;
...
- (void)resetTextViewportLayoutControllerLayoutForPosition:(id)arg1;
- (void)resumeTiling;
- (id)searchableObject;
