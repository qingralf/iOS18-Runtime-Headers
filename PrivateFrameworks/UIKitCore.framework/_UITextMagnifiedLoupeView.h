...
@interface _UITextMagnifiedLoupeView : UIView <_UITextLoupeView> {
    ...
    bool  _closeLoupeAnimationRunning;
...
- (id)_configuredGroupCompletion:(id /* block */)arg1;
...
- (void)_updateCloseLoupeAnimation:(id /* block */)arg1;
- (void)_updateOpenLoupeAnimation:(id /* block */)arg1;
