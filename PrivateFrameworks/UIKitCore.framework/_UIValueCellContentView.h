...
@interface _UIValueCellContentView : UIView <_UIContentView, _UIContentViewComponentDescribing> {
...
@property (nonatomic, copy) _UIValueCellContentViewConfiguration *configuration;
