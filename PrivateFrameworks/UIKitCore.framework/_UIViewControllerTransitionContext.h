...
@interface _UIViewControllerTransitionContext : NSObject <UIViewControllerContextTransitioningEx> {
    ...
    bool  __needsBottomBarCrossfade;
    double  __percentOffset;
    id /* block */  __postInteractiveCompletionHandler;
    long long  __state;
    bool  __transitioningBottomBarIsTabBar;
...
@property (setter=_setNeedsBottomBarCrossfade:, nonatomic) bool _needsBottomBarCrossfade;
@property (setter=_setPercentOffset:, nonatomic) double _percentOffset;
@property (getter=_isPerformingLayoutToLayoutTransition, setter=_setPerformingLayoutToLayoutTransition:, nonatomic) bool _performingLayoutToLayoutTransition;
@property (setter=_setPostInteractiveCompletionHandler:, nonatomic, copy) id /* block */ _postInteractiveCompletionHandler;
@property (nonatomic, readonly) bool _ranAlongsideAnimations;
@property (setter=_setState:, nonatomic) long long _state;
@property (nonatomic, readonly) bool _transitionHasCompleted;
@property (setter=_setTransitionIsCompleting:, nonatomic) bool _transitionIsCompleting;
@property (setter=_setTransitioningBottomBarIsTabBar:, nonatomic) bool _transitioningBottomBarIsTabBar;
...
+ (id)_associatedTransitionContextForAnimationController:(id)arg1;
+ (id)_associatedTransitionContextsForInteractionController:(id)arg1;
...
- (void)_setNeedsBottomBarCrossfade:(bool)arg1;
- (void)_setPercentOffset:(double)arg1;
- (void)_setPerformingLayoutToLayoutTransition:(bool)arg1;
...
- (void)_setTransitioningBottomBarIsTabBar:(bool)arg1;
