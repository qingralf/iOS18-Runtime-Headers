...
@property (setter=_setInvalidationHandlers:, nonatomic, retain) NSMutableArray *_invalidationHandlers;
...
- (void).cxx_destruct;
- (void)_addInvalidationHandler:(id /* block */)arg1;
...
- (void)_applyVoidBlocks:(id)arg1 releaseBlocks:(id /* block */)arg2;
- (id)_interactiveChangeHandlers;
- (id)_interactiveChangeHandlers:(bool)arg1;
- (id)_invalidationHandlers;
- (id)_invalidationHandlers:(bool)arg1;
- (id)_mainContext;
...
- (void)_setInvalidationHandlers:(id)arg1;
