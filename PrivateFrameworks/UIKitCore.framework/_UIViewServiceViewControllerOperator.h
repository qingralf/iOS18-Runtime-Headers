...
@property (nonatomic, readonly) _UIRemoteViewControllerSceneContext *_sceneContext;
...
- (void)__hostDidMoveToParentSceneWithSettings:(id)arg1;
...
- (void)__hostHomeAffordanceFrameIntersectionDidChange:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
- (void)__hostReadyToReceiveMessagesFromServiceViewController;
- (void)__hostReceivedHomeAffordanceDoubleTapGestureDidSucceed:(bool)arg1;
- (void)__hostSceneDidEnterBackground;
- (void)__hostSceneDidUpdateWithDiff:(id)arg1;
...
- (void)__intelligenceCollectRemoteContentInVisibleRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 withRemoteContextWrapper:(id)arg2;
...
- (void)_eventDispatcherDidCancelTouch:(id)arg1;
