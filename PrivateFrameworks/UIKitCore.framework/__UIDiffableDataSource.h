...
@interface __UIDiffableDataSource : NSObject <UICollectionViewDataSource, UITableViewDataSource> {
    ...
    <_UICollectionViewUpdateExpandCollapseAnimationContext> * _expandCollapseAnimationContext;
    ...
    <_UICollectionViewUpdateItemApplying> * _viewUpdatesSink;
...
@property (nonatomic, readonly) id /* block */ collectionViewCellProvider;
@property (nonatomic, retain) NSMutableArray *completionHandlersForBatchApply;
@property (nonatomic, readonly) NSDiffableDataSourceTransaction *currentTransaction;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (readonly, copy) NSString *description;
@property (nonatomic, copy) id /* block */ didApplySnapshotHandler;
@property (nonatomic, retain) <_UICollectionViewUpdateExpandCollapseAnimationContext> *expandCollapseAnimationContext;
...
@property (nonatomic, readonly) <_UICollectionViewUpdateItemApplying> *viewUpdatesSink;
@property (nonatomic, copy) id /* block */ willApplySnapshotHandler;

+ (void)initialize;

- (void).cxx_destruct;
- (void)_applyDifferencesFromSnapshot:(id)arg1 animatingDifferences:(bool)arg2 completion:(id /* block */)arg3 isOnApplyQueue:(bool)arg4;
...
- (id)_collectionView;
- (long long)_commitNewDataSource:(id)arg1 withViewUpdates:(id)arg2 viewPropertyAnimator:(id)arg3 customAnimationsProvider:(id /* block */)arg4 animated:(bool)arg5 commitAlongsideHandler:(id /* block */)arg6 completion:(id /* block */)arg7;
...
- (void)_commitUpdate:(id)arg1 snapshot:(id)arg2 animated:(bool)arg3 animator:(id)arg4 customAnimationsProvider:(id /* block */)arg5 completion:(id /* block */)arg6;
...
- (void)_onApplyQueue_applyDifferencesFromSnapshot:(id)arg1 animatingDifferences:(bool)arg2 completion:(id /* block */)arg3;
- (void)_onApplyQueue_applyDifferencesFromSnapshot:(id)arg1 viewPropertyAnimator:(id)arg2 customAnimationsProvider:(id /* block */)arg3;
- (void)_onApplyQueue_applyDifferencesFromSnapshot:(id)arg1 viewPropertyAnimator:(id)arg2 customAnimationsProvider:(id /* block */)arg3 animated:(bool)arg4 completion:(id /* block */)arg5;
- (void)_onApplyQueue_reloadFromSnapshot:(id)arg1 completion:(id /* block */)arg2;
- (void)_performApplyWithoutRebasingSectionSnapshots:(id /* block */)arg1;
- (void)_performBatchApplyUsingReloadData:(id /* block */)arg1;
- (void)_performReloadOrReconfigureUpdateWithItems:(id)arg1 dataSourceSnapshot:(id)arg2 animated:(bool)arg3 completion:(id /* block */)arg4;
...
- (id)_validReloadOrReconfigureViewUpdatesInSnapshot:(id)arg1;
...
- (id)emptySnapshot;
- (id)expandCollapseAnimationContext;
...
- (void)setExpandCollapseAnimationContext:(id)arg1;
