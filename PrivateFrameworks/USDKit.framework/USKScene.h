...
@interface USKScene : USKObject {
    NSURL * _fileURL;
    struct TfRefPtr<pxrInternal__aapl__pxrReserved__::UsdStage> { 
...
- (id)initWithUsdStage:(struct TfRefPtr<pxrInternal__aapl__pxrReserved__::UsdStage> { struct TfRefBase {} *x1; })arg1 fileURL:(id)arg2;
...
- (id)subLayerOffsets;
- (id)subLayerPaths;
- (struct TfRefPtr<pxrInternal__aapl__pxrReserved__::UsdStage> { struct TfRefBase {} *x1; })usdStage;
