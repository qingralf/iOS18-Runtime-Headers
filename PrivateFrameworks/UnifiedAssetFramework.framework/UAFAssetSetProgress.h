...
@interface UAFAssetSetProgress : NSObject {
    ...
    unsigned long long  _reportedComplete;
    unsigned long long  _reportedPercent;
    unsigned long long  _reportedStatus;
    unsigned long long  _reportedTotal;
...
- (id)progresses;
- (void)reportPercent:(unsigned long long)arg1 status:(unsigned long long)arg2 totalKnown:(bool)arg3;
- (unsigned long long)reportedComplete;
...
- (void)setReportedComplete:(unsigned long long)arg1;
- (void)setReportedPercent:(unsigned long long)arg1;
- (void)setReportedStatus:(unsigned long long)arg1;
- (void)setReportedTotal:(unsigned long long)arg1;
