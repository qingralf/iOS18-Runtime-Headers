...
+ (void)updateTrialFactors:(id)arg1 rolloutUpdateMode:(long long)arg2 removeUnneededFactors:(bool)arg3 expensiveNetworking:(bool)arg4 updateCount:(unsigned long long)arg5 storeManager:(id)arg6 noRemovalNamespaces:(id)arg7 assetSetNamespaces:(id)arg8 progress:(id /* block */)arg9 completion:(id /* block */)arg10;
+ (void)updateTrialFromAssetSetUsages:(id)arg1 rolloutUpdateMode:(long long)arg2 expensiveNetworking:(bool)arg3 storeManager:(id)arg4 configurationManager:(id)arg5 progress:(id /* block */)arg6 completion:(id /* block */)arg7;
