...
- (id)initWithApplicationTokens:(id)arg1 categoryTokens:(id)arg2 webDomainTokens:(id)arg3 threshold:(id)arg4 includesPastActivity:(bool)arg5;
- (id)initWithBundleIdentifiers:(id)arg1 categoryIdentifiers:(id)arg2 webDomains:(id)arg3 threshold:(id)arg4 includesPastActivity:(bool)arg5;
