...
+ (id)_chronologicalPublisherWithOptions:(id)arg1 eventStreams:(id)arg2;
+ (void)_completion:(id)arg1 options:(id)arg2;
...
+ (void)queryUsageDuringInterval:(id)arg1 partitionInterval:(double)arg2 adjustedStartDate:(id)arg3 eventStreams:(id)arg4 categoryByBundleIdentifier:(id)arg5 categoryByWebDomain:(id)arg6 usageReportHandler:(id /* block */)arg7 completionHandler:(id /* block */)arg8;
