...
- (void).cxx_destruct;
- (id)_encodeIntoUserActivityDataWithSave:(bool)arg1 options:(id)arg2 error:(id*)arg3;
- (bool)_encodeIntoUserActivityStringWithSave:(bool)arg1 options:(id)arg2 completionHandler:(id /* block */)arg3;
- (id)_encodeIntoUserActivityStringWithSave:(bool)arg1 options:(id)arg2 optionalString:(id*)arg3 optionalData:(id*)arg4 error:(id*)arg5;
- (void)_resignCurrent;
...
- (id)callWillSaveDelegateIfDirtyAndPackageUpData:(bool)arg1 options:(id)arg2 clearDirty:(bool)arg3;
- (id)callWillSaveDelegateIfDirtyAndPackageUpData:(bool)arg1 options:(id)arg2 clearDirty:(bool)arg3 completionHandler:(id /* block */)arg4;
...
- (id)decodeUserInfo:(id)arg1 options:(id)arg2;
...
- (id)encodeUserInfo:(id)arg1 options:(id)arg2 error:(id*)arg3;
...
- (void)synchronouslyEncodeUserInfo:(id)arg1 options:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (id)userActivityInfoForSelfWithPayload:(bool)arg1 options:(id)arg2;
- (id)userInfo;
