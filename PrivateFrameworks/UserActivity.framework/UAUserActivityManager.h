...
- (bool)currentUserActivityProxiesWithOptions:(id)arg1 predicate:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (id)encodeUserActivity:(id)arg1 options:(id)arg2;
...
- (bool)initialServerHandshake:(bool)arg1;
