...
+ (unsigned long long)mc_userPasscodeTypeWithPasscode:(id)arg1;
+ (unsigned long long)mc_userPasscodeTypeWithUnlockScreenType:(int)arg1 simplePasscodeType:(int)arg2;
