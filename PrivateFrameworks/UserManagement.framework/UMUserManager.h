...
@interface UMUserManager : NSObject <UMUserKeybagOpaqueDataManagement_Private, UMUserListUpdateObserver, UMUserManagement, UMUserManagement_Private, UMUserPersonaAttributesList, UMUserPersonaBundleManagement, UMUserPersonaLoginSessionManagement, UMUserPersonaManagement, UMUserSessionProvisioning, UMUserSwitchManagement, UMUserSwitchManagement_Private, UMUserVolumeMigration> {
    NSArray * _allUsers;
...
- (id)bundleIdentifiersforPersonaWithPersonaUniqueString:(id)arg1 withError:(id*)arg2;
...
- (void)resumeQuotas;
- (void)resumeSync;
- (bool)setBundleIdentifiers:(id)arg1 forPersonaWithPersonaUniqueString:(id)arg2 withError:(id*)arg3;
