...
@interface UNCKeyedDataStoreRepository : NSObject {
    ...
    id /* block */  _recordValidationTest;
}

@property (nonatomic, copy) id /* block */ recordValidationTest;
...
- (void)setRecordValidationTest:(id /* block */)arg1;
