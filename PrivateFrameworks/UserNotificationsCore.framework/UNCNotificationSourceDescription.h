...
@interface UNCNotificationSourceDescription : NSObject <UNCNotificationSourceDescription> {
    ...
    UNCNotificationSourceSettingsDescription * _defaultSettings;
...
@property (nonatomic, copy) NSArray *defaultCategories;
@property (nonatomic, copy) NSString *defaultIconFile;
@property (nonatomic, retain) UNCNotificationSourceSettingsDescription *defaultSettings;
@property (nonatomic, copy) NSArray *defaultTopics;
