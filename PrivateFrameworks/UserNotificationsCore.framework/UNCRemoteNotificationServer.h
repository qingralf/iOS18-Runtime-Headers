...
- (void)_queue_didChangeProcessState:(id)arg1 forBundleIdentifier:(id)arg2;
...
- (bool)_requestContainsDisallowedPrivateUserInfo:(id)arg1;
...
- (void)didChangeProcessState:(id)arg1 forBundleIdentifier:(id)arg2;
