...
@interface UNSNotificationRecord : NSObject <BSDescriptionProviding, NSSecureCoding> {
    ...
    UNCContactRecord * _communicationContextSender;
...
@property (nonatomic, copy) UNCContactRecord *communicationContextSender;
...
@property (nonatomic, copy) DNDClientEventBehavior *eventBehavior;
...
- (void)setPipelineState:(long long)arg1;
...
- (void)setRevisionNumber:(long long)arg1;
