...
@property (nonatomic, copy) NSString *iconImageBundlePath;
@property (nonatomic, copy) NSString *iconImageName;
@property (nonatomic, copy) NSString *identifier;
@property (nonatomic) bool isSiriActionCandidate;
...
- (void)setIconImageBundlePath:(id)arg1;
- (void)setIconImageName:(id)arg1;
- (void)setIdentifier:(id)arg1;
- (void)setIsSiriActionCandidate:(bool)arg1;
