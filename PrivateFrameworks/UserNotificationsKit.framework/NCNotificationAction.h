...
@property (nonatomic, readonly, copy) NSString *iconImageBundlePath;
@property (nonatomic, readonly, copy) NSString *iconImageName;
@property (nonatomic, readonly, copy) NSString *identifier;
@property (nonatomic, readonly) bool isSiriActionCandidate;
