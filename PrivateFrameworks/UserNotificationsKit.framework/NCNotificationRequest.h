...
@property (nonatomic) bool isPresentedAsBanner;
...
@property (nonatomic, readonly) unsigned long long priorityStatus;
...
@property (nonatomic, readonly) unsigned long long summaryStatus;
...
- (void)setIsPresentedAsBanner:(bool)arg1;
