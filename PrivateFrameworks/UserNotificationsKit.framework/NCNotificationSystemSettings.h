...
@property (getter=areHighlightsEnabled, nonatomic, readonly) bool highlightsEnabled;
@property (nonatomic, readonly) long long listDisplayStyleSetting;
...
+ (id)stringForNotificationListDisplayStyleSetting:(long long)arg1;
...
- (long long)listDisplayStyleSetting;
