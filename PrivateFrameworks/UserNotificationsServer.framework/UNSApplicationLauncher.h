...
- (id)_queue_actionForNotificationResponse:(id)arg1 bundleIdentifier:(id)arg2 withHandler:(id /* block */)arg3 error:(id*)arg4;
...
- (void)_queue_foregroundLaunchApplication:(id)arg1 withOptions:(id)arg2 responseActionIdentifier:(id)arg3 endpoint:(id)arg4 completionHandler:(id /* block */)arg5;
- (id)_queue_foregroundLaunchOptionsForApplication:(id)arg1 withResponse:(id)arg2 actionIdentifier:(id)arg3 launchImageName:(id)arg4 origin:(id)arg5 error:(id*)arg6;
...
- (void)foregroundLaunchOptionsForApplication:(id)arg1 withResponse:(id)arg2 launchImageName:(id)arg3 origin:(id)arg4 queue:(id)arg5 completionHandler:(id /* block */)arg6;
