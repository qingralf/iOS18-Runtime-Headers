...
@interface UNSAttachmentsService : NSObject <UNCAttachmentsService, UNCNotificationRepositoryObserver, UNCPendingNotificationRepositoryObserver> {
...
- (id)_queue_resolveGenmojiAttachmentsForRequest:(id)arg1;
...
- (id)_thumbnailRepresentationsForGlyphData:(id)arg1;
