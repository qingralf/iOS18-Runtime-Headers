...
@property (nonatomic, readonly) NSMutableDictionary *bundleIdentifierToDataProvider;
...
- (id)bundleIdentifierToDataProvider;
- (void)dealloc;
- (id)initWithApplicationLauncher:(id)arg1 daemonLauncher:(id)arg2 categoryRepository:(id)arg3 notificationRepository:(id)arg4 attachmentsService:(id)arg5 topicRepository:(id)arg6 localizationService:(id)arg7 summaryService:(id)arg8 settingsGateway:(id)arg9;
