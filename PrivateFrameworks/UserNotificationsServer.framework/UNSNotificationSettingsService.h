...
@interface UNSNotificationSettingsService : NSObject <UNCNotificationRepositorySettingsProvider, UNSSettingsGatewayObserver> {
...
- (id)notificationSourcesWithFilter:(id)arg1;
