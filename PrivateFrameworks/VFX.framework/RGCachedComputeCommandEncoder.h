...
- (void)dealloc;
- (id)device;
- (void)dispatch:(id)arg1 onTexture2D:(id)arg2;
- (void)dispatch:(id)arg1 threadgroups:(struct { unsigned long long x1; unsigned long long x2; unsigned long long x3; })arg2 threadsPerThreadgroup:(struct { unsigned long long x1; unsigned long long x2; unsigned long long x3; })arg3;
- (void)dispatch:(id)arg1 threadgroupsWithIndirectBuffer:(id)arg2 indirectBufferOffset:(unsigned long long)arg3 threadsPerThreadgroup:(struct { unsigned long long x1; unsigned long long x2; unsigned long long x3; })arg4;
- (void)dispatchOnTexture2D:(id)arg1;
- (void)dispatchOnTexture2DWithoutOptimizedThreadGroupPerGrid:(id)arg1;
- (void)dispatchOnTexture3D:(id)arg1;
- (void)dispatchOnTextureCube:(id)arg1;
- (void)dispatchOnVertices:(id)arg1 vertexCount:(unsigned int)arg2;
- (void)dispatchOne:(id)arg1;
...
- (bool)isEncoding;
- (id)label;
- (void)loadWithCommandBuffer:(id)arg1 label:(id)arg2;
