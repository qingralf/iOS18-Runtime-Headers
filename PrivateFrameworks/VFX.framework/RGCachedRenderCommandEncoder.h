...
- (id)fragmentBufferBoundAt:(unsigned long long)arg1;
...
- (id)label;
- (void)loadWithCommandBuffer:(id)arg1 renderPassDescriptor:(id)arg2;
...
- (void)rg_setLineWidth:(float)arg1;
...
- (void)setCounters:(struct __RGRenderCounters { struct { struct __vfx_counters {} *x_1_1_1; } x1; unsigned int x2; unsigned int x3; unsigned int x4; })arg1;
- (void)setCullMode:(unsigned long long)arg1;
- (void)setDeferredBindingEnabled:(bool)arg1;
...
- (void)setEncoder:(id)arg1 alreadyUsed:(bool)arg2;
...
- (void)setLockCullMode:(bool)arg1;
- (void)setLockFillMode:(bool)arg1;
...
- (id)vertexBufferBoundAt:(unsigned long long)arg1;
