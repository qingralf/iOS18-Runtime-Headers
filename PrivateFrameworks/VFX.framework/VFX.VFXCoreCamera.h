...
@property (nonatomic) struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; } lastFrameWorldTransform;
...
- (bool)isOrthographic;
- (struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; })lastFrameWorldTransform;
- (id)name;
- (struct { })orientation;
- (void)position;
...
- (void)setLastFrameWorldTransform:(struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x1[4]; })arg1;
