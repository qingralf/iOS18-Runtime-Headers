...
- (void)createSparseIndicesBufferForMorphTarget:(struct { float x1; unsigned int x2; unsigned int x3; unsigned long long x4; unsigned long long x5; }*)arg1 withSetupTarget:(struct { unsigned int x1; struct __CFXMesh {} *x2; struct __CFXMeshSource {} *x3; struct __CFXMeshSource {} *x4; unsigned long long x5; }*)arg2 indicesBuffer:(char *)arg3 indicesBufferOffset:(unsigned long long)arg4 indexSize:(unsigned long long)arg5 originalToFirstDeindexedTable:(unsigned int*)arg6 computeContext:(id)arg7;
- (void)createVertexBufferForMorphTarget:(struct { float x1; unsigned int x2; unsigned int x3; unsigned long long x4; unsigned long long x5; }*)arg1 withSetupTarget:(struct { unsigned int x1; struct __CFXMesh {} *x2; struct __CFXMeshSource {} *x3; struct __CFXMeshSource {} *x4; unsigned long long x5; }*)arg2 vertexBuffer:(char *)arg3 vertexBufferOffset:(unsigned long long)arg4 indicesBuffer:(char *)arg5 indicesBufferOffset:(unsigned long long)arg6 indexSize:(unsigned long long)arg7 originalToFirstDeindexedTable:(unsigned int*)arg8 computeContext:(id)arg9;
- (void)dealloc;
