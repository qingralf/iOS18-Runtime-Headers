...
@property (nonatomic, readonly) float averageFPS; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) struct Swapchain { int (**x1)(); }*swapchain;
...
- (void)drawInContext:(struct CGContext { }*)arg1 registry:(void*)arg2;
...
- (struct Swapchain { int (**x1)(); }*)swapchain;
- (void)willPresent;
