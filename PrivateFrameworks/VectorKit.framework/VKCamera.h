...
- (void)setFarClipDistance:(double)arg1;
...
- (void)setNearClipDistance:(double)arg1;
- (void)setNeedsUpdate;
...
- (void)setTransform:(const void*)arg1;
...
- (void)updateCamera:(struct shared_ptr<gdc::Camera> { struct Camera {} *x1; struct __shared_weak_count {} *x2; })arg1 withAdjustment:(struct function<bool (std::shared_ptr<gdc::Camera>, geo::Unit<geo::MeterUnitDescription, double> &, geo::Unit<geo::MeterUnitDescription, double> &)>={__value_func<bool (std::shared_ptr<gdc::Camera>, geo::Unit<geo::MeterUnitDescription, double> &, geo::Unit<geo::MeterUnitDescription, double> &)>={type=[24C] {})arg2;
- (void)updateIfNeeded;
