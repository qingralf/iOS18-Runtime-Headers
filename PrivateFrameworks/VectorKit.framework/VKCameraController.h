...
@property (nonatomic, readonly) unsigned long long regionChangeCount;
...
- (id)getCameraType:(unsigned char)arg1;
- (id)getMapEngineModeType:(unsigned char)arg1;
- (id)getWorldType:(unsigned char)arg1;
- (double)heading;
...
- (unsigned long long)regionChangeCount;
