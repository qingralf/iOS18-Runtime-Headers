...
@interface VKDebugSettings : NSObject {
    ...
    bool  _enableDebugSettingForHillShade;
    ...
    bool  _flyoverDrapeGrid;
    float  _flyoverGridNDCBias;
    float  _flyoverOctileLODConstant;
    float  _flyoverOctileLODMaxRefineDistance;
    bool  _flyoverSkipTileRendering;
    bool  _forceBumpAll;
    bool  _forceBumpNextTap;
    bool  _forceEtaLabelPlacement;
    bool  _forceFlyoverUnificationMode;
    float  _gridZAdjustment;
    ...
    bool  _hiking;
    bool  _hillshade;
    float  _hillshadeBlendMode;
    float  _hillshadeOpacity;
    ...
    struct unique_ptr<md::Monitorable<md::ConfigValue<GEOConfigKeyBOOL, bool>>, std::default_delete<md::Monitorable<md::ConfigValue<GEOConfigKeyBOOL, bool>>>> { 
        struct __compressed_pair<md::Monitorable<md::ConfigValue<GEOConfigKeyBOOL, bool>> *, std::default_delete<md::Monitorable<md::ConfigValue<GEOConfigKeyBOOL, bool>>>> { 
            void *__value_; 
        } __ptr_; 
    }  _labelHighlightingValue;
    bool  _labelHighlightingVerboseLoggingEnabled;
    bool  _labelOcclusionDisabled;
    bool  _labelPOIUpdatesDisabled;
    ...
    bool  _paintDaVinciBuildingMeshBounds;
    ...
    bool  _tourUsePreloadPosition;
    float  _toursAnimationSpeed;
    bool  _toursCorrectElevation;
    bool  _toursForceCompleteTileLoading;
    float  _toursInterestingViewSpeed;
    bool  _toursModulateSpeed;
    float  _toursPreloadHeadTime;
    bool  _toursPreloadSlowsSpeed;
    float  _toursTargetPreloadHeadTime;
    float  _toursViewRecoverySpeed;
    bool  _traceEtaDebugLog;
    bool  _trackingCameraZoomFurther;
    unsigned long long  _trailDebugSelection;
    float  _trailJunctionElevationOffset;
...
@property (nonatomic) bool correctBumpiness;
...
@property (nonatomic) bool enableDebugSettingForHillShade;
...
@property (nonatomic) bool flyoverDrapeGrid;
...
@property (nonatomic) bool flyoverSkipTileRendering;
...
@property (nonatomic) bool forceFlyoverUnificationMode;
...
@property (nonatomic) bool labelPOIUpdatesDisabled;
...
@property (nonatomic) bool labelUseDefaultStyle;
...
@property (nonatomic) bool paintDaVinciBuildingMeshBounds;
...
@property (nonatomic) bool paintFlyoverTiles;
...
@property (nonatomic) bool paintS2KeysInView;
...
@property (nonatomic) bool paintTopographicTiles;
...
@property (nonatomic) bool tourUsePreloadPosition;
@property (nonatomic) float toursAnimationSpeed;
@property (nonatomic) bool toursCorrectElevation;
@property (nonatomic) bool toursForceCompleteTileLoading;
@property (nonatomic) float toursInterestingViewSpeed;
@property (nonatomic) bool toursModulateSpeed;
@property (nonatomic) float toursPreloadHeadTime;
@property (nonatomic) bool toursPreloadSlowsSpeed;
...
- (const struct { unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; bool x6; }*)displayStyleOverride;
...
- (void)setCorrectBumpiness:(bool)arg1;
...
- (void)setEnableDebugSettingForHillShade:(bool)arg1;
...
- (void)setFlyoverDrapeGrid:(bool)arg1;
- (void)setFlyoverGridNDCBias:(float)arg1;
- (void)setFlyoverOctileLODConstant:(float)arg1;
- (void)setFlyoverOctileLODMaxRefineDistance:(float)arg1;
- (void)setFlyoverSkipTileRendering:(bool)arg1;
- (void)setForceBumpAll:(bool)arg1;
- (void)setForceBumpNextTap:(bool)arg1;
- (void)setForceEtaLabelPlacement:(bool)arg1;
- (void)setForceFlyoverUnificationMode:(bool)arg1;
- (void)setGridZAdjustment:(float)arg1;
...
- (void)setHillshadeBlendMode:(float)arg1;
- (void)setHillshadeOpacity:(float)arg1;
...
- (void)setLabelPOIUpdatesDisabled:(bool)arg1;
...
- (void)setLabelUseDefaultStyle:(bool)arg1;
...
- (void)setPaintDaVinciBuildingMeshBounds:(bool)arg1;
...
- (void)setPaintFlyoverTiles:(bool)arg1;
...
- (void)setSkyOffsetAdjustment:(float)arg1;
...
- (void)setTourUsePreloadPosition:(bool)arg1;
- (void)setToursAnimationSpeed:(float)arg1;
- (void)setToursCorrectElevation:(bool)arg1;
- (void)setToursForceCompleteTileLoading:(bool)arg1;
- (void)setToursInterestingViewSpeed:(float)arg1;
- (void)setToursModulateSpeed:(bool)arg1;
- (void)setToursPreloadHeadTime:(float)arg1;
- (void)setToursPreloadSlowsSpeed:(bool)arg1;
- (void)setToursViewRecoverySpeed:(float)arg1;
...
- (void)setTrailJunctionElevationOffset:(float)arg1;
