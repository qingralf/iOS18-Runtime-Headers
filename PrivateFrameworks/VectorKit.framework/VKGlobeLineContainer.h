...
@interface VKGlobeLineContainer : NSObject {
    ...
    <VKRouteMatchedAnnotationPresentation> * _skippedRouteLineSplitAnnotation;
    struct VKGlobeRouteSplit { int (**x1)(); id x2; } * _skippedRouteSplit;
}
...
@property (nonatomic, retain) <VKRouteMatchedAnnotationPresentation> *skippedRouteLineSplitAnnotation;
...
- (void)setSkipped:(struct _retain_ptr<VKPolylineOverlay *, geo::_retain_objc_arc, geo::_release_objc_arc, geo::_hash_objc, geo::_equal_objc> { int (**x1)(); id x2; struct _retain_objc_arc { } x3; struct _release_objc_arc { } x4; })arg1 skipped:(bool)arg2;
- (void)setSkippedRouteLineSplitAnnotation:(id)arg1;
- (id)skippedRouteLineSplitAnnotation;
- (void)update;
