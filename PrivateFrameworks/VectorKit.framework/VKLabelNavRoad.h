...
@property (nonatomic, readonly) unsigned char roadClass;
...
- (void)getRoadEdge:(struct GeoCodecsRoadEdge { struct GeoCodecsRoadFeature {} *x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; struct GeoCodecsConnectivityJunction {} *x6; struct GeoCodecsConnectivityJunction {} *x7; }*)arg1;
- (bool)hasShield;
- (bool)hasVisibleShields;
- (bool)hasVisibleSigns;
- (id)initWithRoadEdge:(const struct GeoCodecsRoadEdge { struct GeoCodecsRoadFeature {} *x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; struct GeoCodecsConnectivityJunction {} *x6; struct GeoCodecsConnectivityJunction {} *x7; }*)arg1 navJunctionA:(id)arg2 routeOffset:(struct PolylineCoordinate { unsigned int x1; float x2; })arg3 tile:(const void*)arg4;
...
- (bool)matchesRoadEdge:(const struct GeoCodecsRoadEdge { struct GeoCodecsRoadFeature {} *x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; struct GeoCodecsConnectivityJunction {} *x6; struct GeoCodecsConnectivityJunction {} *x7; }*)arg1;
- (id)name;
- (id)navJunctionA;
