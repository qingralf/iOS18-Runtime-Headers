...
- (void).cxx_destruct;
- (id)_initWithImages:(id)arg1 displayStyles:(struct { unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; bool x6; }*)arg2 displayStylesCount:(unsigned long long)arg3 scale:(double)arg4 camera:(id)arg5;
- (id)_initWithImages:(id)arg1 displayStyles:(struct { unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; bool x6; }*)arg2 displayStylesCount:(unsigned long long)arg3 scale:(double)arg4 camera:(id)arg5 elevationScale:(float)arg6 targetPointElevation:(float)arg7 colorSpace:(struct __CFString { }*)arg8;
- (id)colorSpace;
