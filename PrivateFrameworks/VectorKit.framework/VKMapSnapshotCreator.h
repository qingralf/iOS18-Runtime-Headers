...
@interface VKMapSnapshotCreator : NSObject <MapEngineDelegate, VKNotificationObserverDelegate> {
    ...
    struct { unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; bool x6; } * _displayStyles;
...
- (id)initWithSize:(struct CGSize { double x1; double x2; })arg1 scale:(double)arg2 homeQueue:(id)arg3 signpostId:(unsigned long long)arg4 mapType:(int)arg5 mapDisplayStyles:(struct { unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; bool x6; }*)arg6 mapDisplayStylesCount:(unsigned long long)arg7 auditToken:(id)arg8;
- (id)initWithSize:(struct CGSize { double x1; double x2; })arg1 scale:(double)arg2 homeQueue:(id)arg3 signpostId:(unsigned long long)arg4 mapType:(int)arg5 mapDisplayStyles:(struct { unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; bool x6; }*)arg6 mapDisplayStylesCount:(unsigned long long)arg7 auditToken:(id)arg8 useMultisampling:(bool)arg9 withError:(out id*)arg10;
- (void)labelManagerDidLayout;
- (void)labelMarkerDidChangeState:(const void*)arg1;
- (long long)labelScaleFactor;
- (bool)localizeLabels;
- (void)locationInHikingContextualRegion:(bool)arg1;
