...
@interface VKMapView : CALayer {
    ...
    unsigned char  _applicationSubState;
    ...
    <VKLabelSelectionFilter> * _labelSelectionFilter;
...
@property (nonatomic, readonly) bool isFlyoverUnificationEnabled;
...
@property (nonatomic) <VKLabelSelectionFilter> *labelSelectionFilter;
...
@property (nonatomic) struct { unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; bool x6; } mapDisplayStyle;
...
@property (getter=isOfflineMode, nonatomic) bool offlineMode;
...
- (void)_applyMapDisplayStyle:(struct { unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; bool x6; })arg1 animated:(bool)arg2 duration:(double)arg3;
...
- (bool)enableGlobe;
- (void)enableMapDisplayStyleDebugOverride:(struct { unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; bool x6; })arg1;
...
- (id)labelSelectionFilter;
- (bool)labelsDisabled;
- (bool)loadMuninAvailability;
- (bool)localizeLabels;
- (void)location:(struct { double x1; double x2; })arg1 isInHikingContextualRegion:(bool)arg2;
...
- (id)mapDelegate;
- (void)mapDidFinishChangingMapDisplayStyle:(struct { unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; bool x6; })arg1;
- (void)mapDidReloadStylesheet:(id)arg1;
- (struct { unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; bool x6; })mapDisplayStyle;
...
- (void)puckAnimator:(id)arg1 updatedPosition:(const void*)arg2 course:(const void*)arg3 polylineCoordinate:(struct PolylineCoordinate { unsigned int x1; float x2; })arg4;
...
- (void)requestHikingContextualRegionDoesIntersectForLocation:(struct { double x1; double x2; })arg1;
...
- (void)setApplicationSubState:(unsigned char)arg1;
...
- (void)setLabelSelectionFilter:(id)arg1;
- (void)setLoadMuninAvailability:(bool)arg1;
- (void)setLoadMuninMetadata:(bool)arg1;
- (void)setLocalizeLabels:(bool)arg1;
- (void)setMapDelegate:(id)arg1;
- (void)setMapDisplayStyle:(struct { unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; bool x6; })arg1;
- (void)setMapDisplayStyle:(struct { unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; bool x6; })arg1 animated:(bool)arg2;
- (void)setMapDisplayStyle:(struct { unsigned char x1; unsigned char x2; unsigned char x3; unsigned char x4; unsigned char x5; bool x6; })arg1 animated:(bool)arg2 duration:(double)arg3;
...
- (void)setPreviouslySelectedLabelMarker:(id)arg1;
...
- (void)setShowsContourLabels:(bool)arg1;
- (void)setShowsHiking:(bool)arg1;
- (void)setShowsHiking:(bool)arg1 withTopographicFeatures:(bool)arg2;
- (void)setShowsHillshade:(bool)arg1;
- (void)setShowsLabels:(bool)arg1;
- (void)setShowsLiveEVData:(bool)arg1;
- (void)setShowsPhysicalFeatureLabels:(bool)arg1;
