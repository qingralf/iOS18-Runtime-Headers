...
@property (nonatomic, readonly) /* Warning: unhandled struct encoding: '{Coordinate3D<geo::Radians' */ struct  puckCoordinate; /* unknown property attribute:  double>=d}} */
...
- (struct Coordinate3D<geo::Radians, double> { struct Unit<geo::RadianUnitDescription, double> { double x_1_1_1; } x1; struct Unit<geo::RadianUnitDescription, double> { double x_2_1_1; } x2; struct Unit<geo::MeterUnitDescription, double> { double x_3_1_1; } x3; })puckCoordinate;
...
- (void)updatePuckOffset:(bool)arg1;
