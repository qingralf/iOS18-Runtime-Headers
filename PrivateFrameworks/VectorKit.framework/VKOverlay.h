...
- (void)drawKey:(const struct { unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; }*)arg1 withData:(id)arg2 inIOSurface:(struct __IOSurface { }*)arg3 withTimestamp:(double)arg4 withTileScale:(float)arg5;
