...
@property (nonatomic, readonly) bool allows3DPuck;
@property (nonatomic, readonly) bool canMakeSharingThumbnails;
@property (nonatomic, readonly) unsigned char explicitDefaultRefreshRate;
...
@property (nonatomic, readonly) unsigned char preferredFrequencyUpdate;
...
@property (nonatomic, readonly) BOOL tileZBias;
...
- (unsigned char)preferredFrequencyUpdate;
