...
@property (nonatomic, readonly) struct PolylineCoordinate { unsigned int x1; float x2; } projectedCoordinate;
...
- (struct PolylineCoordinate { unsigned int x1; float x2; })projectedCoordinate;
