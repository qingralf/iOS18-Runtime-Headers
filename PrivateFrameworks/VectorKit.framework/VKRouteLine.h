...
@property (nonatomic, readonly) void*arrows;
...
- (double)_findSimplifiedOffsetFor:(const struct PolylineCoordinate { unsigned int x1; float x2; }*)arg1 betweenA:(const struct PolylineCoordinate { unsigned int x1; float x2; }*)arg2 andB:(const struct PolylineCoordinate { unsigned int x1; float x2; }*)arg3;
- (struct optional<std::pair<const unsigned int, const unsigned int>> { union { BOOL x_1_1_1; struct pair<const unsigned int, const unsigned int> { unsigned int x_2_2_1; unsigned int x_2_2_2; } x_1_1_2; } x1; bool x2; })_getSnappedSegment:(struct fast_shared_ptr<md::RouteLineSection, mdm::MDAllocator> { struct _fast_shared_ptr_control {} *x1; })arg1 coord:(const struct PolylineCoordinate { unsigned int x1; float x2; }*)arg2;
...
- (bool)buildRouteLine:(id)arg1 matchToRoads:(bool)arg2 shouldGenerateSnapPath:(bool)arg3 viewUnitsPerPoint:(double)arg4 force:(bool)arg5 boundsInflation:(float)arg6 isGradientTraffic:(bool)arg7 currentLegIndex:(unsigned int)arg8 elevationSource:(void*)arg9 elevationSourceContext:(void*)arg10;
- (id)composedRoute;
- (void)createMeshIfNecessary:(long long)arg1;
- (void)dealloc;
- (void)forEachSection:(id /* block */)arg1;
- (void)generateArrowsForManeuverDisplayMode:(int)arg1 routeLineWidth:(double)arg2 collideTrafficFeatures:(const void*)arg3;
...
- (void)splitRouteLineAtAnnotation:(id)arg1 puckOffset:(struct PolylineCoordinate { unsigned int x1; float x2; })arg2;
