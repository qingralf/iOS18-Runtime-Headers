...
@property (nonatomic, readonly) const struct QuadTile { unsigned char x1; unsigned char x2; int x3; int x4; unsigned long long x5; }*tile;
...
- (id)initWithQuadTile:(struct QuadTile { unsigned char x1; unsigned char x2; int x3; int x4; unsigned long long x5; })arg1 width:(int)arg2 height:(int)arg3 scale:(float)arg4 tileSizeInMeters:(float)arg5 minElevationInMeters:(short)arg6;
- (short)minElevationInMeters;
- (id)rasterData;
- (float)scale;
- (void)setRasterData:(id)arg1;
- (const struct QuadTile { unsigned char x1; unsigned char x2; int x3; int x4; unsigned long long x5; }*)tile;
