...
- (id).cxx_construct;
- (void).cxx_destruct;
- (id)initWithMapPoints:(const struct { double x1; double x2; }*)arg1 elevations:(const double*)arg2 count:(unsigned long long)arg3 needsElevationCorrection:(bool)arg4;
