...
@interface VSAppDescription : NSObject {
    ...
    NSNumber * _visionOSCompatible;
}

@property (nonatomic, copy) NSNumber *adamID;
@property (nonatomic, copy) NSNumber *appSizeBytes;
...
@property (getter=isVisionOSCompatible, nonatomic, retain) NSNumber *visionOSCompatible;
...
- (void)setVisionOSCompatible:(id)arg1;
