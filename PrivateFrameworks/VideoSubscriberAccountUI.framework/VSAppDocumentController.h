...
- (void).cxx_destruct;
- (id)_getSupportedButtonTextsforTemplate:(id)arg1 andElementKeys:(id)arg2 supportedCount:(unsigned long long)arg3;
...
- (void)_notifyDidUpdateLogoViewModel:(id)arg1;
