...
@property (getter=isDecided, nonatomic, readonly) bool decided;
@property (nonatomic, readonly) NSString *decidedLockupSubtitle;
...
- (id)initWithBundle:(id)arg1 restrictionsCenter:(id)arg2 privacyFacade:(id)arg3;
- (id)initWithBundle:(id)arg1 restrictionsCenter:(id)arg2 privacyFacade:(id)arg3 adamID:(id)arg4;
- (void)installApp;
...
- (void)setForceDSIDlessInstall:(bool)arg1;
