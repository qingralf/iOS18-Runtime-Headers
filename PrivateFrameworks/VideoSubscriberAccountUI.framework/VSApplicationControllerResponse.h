...
@interface VSApplicationControllerResponse : NSObject {
    ...
    NSArray * _applicationUserAccounts;
...
@property (nonatomic, copy) NSArray *applicationUserAccounts;
...
- (void)setApplicationUserAccounts:(id)arg1;
