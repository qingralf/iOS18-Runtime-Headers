...
- (void)_enqueueUserAccountUpdateOperationIfRequiredForResponse:(id)arg1 asDependencyOf:(id)arg2;
...
- (void)applicationController:(id)arg1 didUpdateLogoViewModel:(id)arg2;
