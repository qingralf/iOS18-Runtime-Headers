...
@interface VSIdentityProviderViewController : UIViewController <PSStateRestoration, VSAuthenticationViewControllerDelegate, VSIdentityProviderRequestManagerDelegate> {
...
- (void)identityProviderRequestManager:(id)arg1 didUpdateLogoViewModel:(id)arg2;
