...
@interface FocusableTextView : VUIBaseView <VUILabelBaselineProtocol> {
    ...
    long long  _originalMaximumNumberOfLines;
    bool  _selectable;
...
- (void)_configureAlignmentWithTextAlignment:(long long)arg1 allowsTextAlignmentOverride:(bool)arg2;
...
- (long long)originalMaximumNumberOfLines;
- (bool)selectable;
...
- (void)setOriginalMaximumNumberOfLines:(long long)arg1;
