...
+ (void)_playMediaInfo:(id)arg1 multiviewMediaInfos:(id)arg2 watchType:(long long)arg3 extrasInfo:(id)arg4 playType:(id)arg5 isRentAndWatchNow:(bool)arg6 targetResponder:(id)arg7 completion:(id /* block */)arg8;
+ (void)_playPlayables:(id)arg1 multiviewPlayables:(id)arg2 appContext:(id)arg3 watchType:(long long)arg4 isUpNextPlayback:(bool)arg5 userPlaybackInitiationDate:(id)arg6 openURLCompletionDate:(id)arg7 playType:(id)arg8 playbackContext:(unsigned long long)arg9 targetResponder:(id)arg10;
...
+ (void)presentPlaybackWithMediaInfo:(id)arg1 multiviewMediaInfos:(id)arg2 extrasInfo:(id)arg3 isCoWatching:(bool)arg4 watchType:(long long)arg5 playType:(id)arg6 allowsCellular:(bool)arg7 previewMetadata:(id)arg8 targetResponder:(id)arg9 completion:(id /* block */)arg10;
