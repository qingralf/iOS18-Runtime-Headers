...
@property (nonatomic) bool shouldForceVPPAPrompt;
...
- (void)_openPunchoutURL:(id /* block */)arg1 afterInstallation:(bool)arg2;
...
- (void)setShouldForceVPPAPrompt:(bool)arg1;
