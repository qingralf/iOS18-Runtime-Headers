...
@interface VUIBackgroundMediaController : VUIBaseViewController <AVPlayerViewControllerDelegate, AVPlayerViewControllerDelegatePrivate, VUIBackgroundMediaPlayback> {
    ...
    bool  _disableSupplementalSubtitle;
    NSNumber * _elapsedTimeWhenStopped;
    ...
    NSString * _playbackInitiatorForRTCReporting;
    ...
    NSNumber * _prefersAudioDescriptions;
    bool  _prefersAudioOverPictureInPicture;
    TVPPlayer * _prefetchPlayer;
    AVPlayerViewController * _prefetchPlayerViewController;
    bool  _prefetchesVideoFrame;
    ...
    TVPPlayer * _rampDownPlayer;
    bool  _recordPausedMediaEventAsStop;
    ...
    bool  _stopsPlaybackWhenInactive;
    bool  _supportsMediaSharing;
    NSString * _titleForLogging;
    bool  _updatesNowPlayingInfoCenter;
    bool  _useForegroundAudioSessionInBackgroundMode;
    double  _videoAudioRampDuration;
    bool  _videoFrameFallbackEnabled;
...
@property (nonatomic) bool disableSupplementalSubtitle;
@property (nonatomic, retain) NSNumber *elapsedTimeWhenStopped;
...
@property (nonatomic, retain) NSString *playbackInitiatorForRTCReporting;
...
@property (nonatomic, retain) NSNumber *prefersAudioDescriptions;
@property (nonatomic) bool prefersAudioOverPictureInPicture;
@property (nonatomic, retain) TVPPlayer *prefetchPlayer;
@property (nonatomic, retain) AVPlayerViewController *prefetchPlayerViewController;
...
@property (nonatomic, retain) TVPPlayer *rampDownPlayer;
...
@property (nonatomic) bool supportsMediaSharing;
...
@property (getter=isVideoFrameFallbackEnabled, nonatomic) bool videoFrameFallbackEnabled;
...
- (void)_addPlaybackViewControllerForPlayback:(bool)arg1 restoringAVPlayerViewController:(bool)arg2;
...
- (void)_configurePlayerViewController:(id)arg1;
...
- (void)_externalPlaybackStateChanged:(id)arg1;
...
- (bool)_playlist:(id)arg1 contentMatchesPlaylist:(id)arg2;
- (void)_populatePlayerWithMediaItemsIfNeeded:(id)arg1;
- (void)_postDidStopPlaybackNotification;
- (void)_postWillStartPlaybackNotification:(bool)arg1;
...
- (id)createTransitionViewAtIndex:(unsigned long long)arg1 oldView:(id)arg2;
- (id)currentMediaInfo;
...
- (id)initWithName:(id)arg1 mediaInfoFetchController:(id)arg2;
...
- (id)playbackInitiatorForRTCReporting;
...
- (id)prefersAudioDescriptions;
- (bool)prefersAudioOverPictureInPicture;
- (id)prefetchPlayer;
- (id)prefetchPlayerViewController;
...
- (void)setDisableSupplementalSubtitle:(bool)arg1;
- (void)setElapsedTimeWhenStopped:(id)arg1;
...
- (void)setPlaybackInitiatorForRTCReporting:(id)arg1;
...
- (void)setPrefersAudioDescriptions:(id)arg1;
- (void)setPrefersAudioOverPictureInPicture:(bool)arg1;
- (void)setPrefetchPlayer:(id)arg1;
- (void)setPrefetchPlayerViewController:(id)arg1;
...
- (void)setRampDownPlayer:(id)arg1;
...
- (void)setSupportsMediaSharing:(bool)arg1;
