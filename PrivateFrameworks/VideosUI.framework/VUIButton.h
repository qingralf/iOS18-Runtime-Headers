...
@interface VUIButton : UIControl <UIPointerInteractionDelegate, VUILabelBaselineProtocol, VUIViewScrollPercentageUpdateProtocol> {
    ...
    id /* block */  _longPressActionHandler;
...
@property (nonatomic, copy) id /* block */ longPressActionHandler;
...
- (struct CGSize { double x1; double x2; })_calculateContentSizeForCustomButtonThatFit:(struct CGSize { double x1; double x2; })arg1;
...
- (void)_configure;
- (void)_crossFadeButtonImageTo:(id)arg1;
...
- (void)layoutSubviews;
- (id /* block */)longPressActionHandler;
...
- (void)setLongPressActionHandler:(id /* block */)arg1;
