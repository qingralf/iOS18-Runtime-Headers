...
@interface VUIDownloadButton : VUIButton {
    ...
    NSString * _notDownloadStateText;
    ...
    <VUISeasonDownloadDataSourceProvider> * _seasonDownloadDataSourceProvider;
...
@property (nonatomic, retain) NSString *notDownloadStateText;
...
@property (nonatomic, retain) <VUISeasonDownloadDataSourceProvider> *seasonDownloadDataSourceProvider;
...
- (void)_updateButtonToEnqueuedWithProperties:(id)arg1;
...
- (id)initTVShowDownloadButtonWithType:(unsigned long long)arg1;
- (id)initWithAssetController:(id)arg1 type:(unsigned long long)arg2;
- (id)initWithDownloadButtonViewModel:(id)arg1 isForLibrary:(bool)arg2 type:(unsigned long long)arg3 textLayout:(id)arg4;
...
- (id)seasonDownloadDataSourceProvider;
...
- (void)setNotDownloadStateText:(id)arg1;
...
- (void)setSeasonDownloadDataSourceProvider:(id)arg1;
