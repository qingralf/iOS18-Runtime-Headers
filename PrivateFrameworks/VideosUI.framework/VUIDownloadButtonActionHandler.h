...
@property (nonatomic, copy) id /* block */ presentAlertBlock;
...
- (void)_startDownloadIfPossibleRemovingFromUIOnCancellationOrFailure:(bool)arg1 prefer3DOrImmersiveDownload:(bool)arg2;
...
- (void)performAction:(bool)arg1 confirmBeforeStopDownloading:(bool)arg2 prefer3DOrImmersiveDownload:(bool)arg3;
- (id /* block */)presentAlertBlock;
...
- (void)setPresentAlertBlock:(id /* block */)arg1;
