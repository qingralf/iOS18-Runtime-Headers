...
@interface VUIDownloadManager : NSObject <TVPDownloadDelegate, TVPDownloadSessionDelegate> {
    ...
    NSMutableArray * _failedDownloads;
    bool  _isInitialized;
...
- (void)_configureDownloadFromUserPrefs:(id)arg1 allowCellular:(bool)arg2 quality:(long long)arg3 prefer3DOrImmersiveDownload:(bool)arg4;
...
- (void)_loadImageForVideoManagedObject:(id)arg1 download:(id)arg2;
...
- (void)_loadStorageSettingsImageFromMediaLibraryForVideoManagedObject:(id)arg1 download:(id)arg2;
...
- (void)addDownloadForVideoManagedObject:(id)arg1 allowCellular:(bool)arg2 quality:(long long)arg3 shouldMarkAsDeletedOnCancellationOrFailure:(bool)arg4 prefer3DOrImmersiveDownload:(bool)arg5;
...
- (void)download:(id)arg1 willDownloadVariants:(id)arg2;
...
- (bool)isInitialized;
- (void)loadImageForVideoManagedObject:(id)arg1;
- (id)mutableDownloads;
...
- (void)setFailedDownloads:(id)arg1;
