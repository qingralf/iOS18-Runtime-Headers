...
@property (nonatomic, readonly) bool allowsSceneAssociation;
...
- (id)initWithTitle:(id)arg1 showTitle:(id)arg2 seasonTitle:(id)arg3 seasonNumber:(id)arg4 episodeNumber:(id)arg5 imageUrlFormat:(id)arg6 artworkImage:(struct CGImage { }*)arg7 fallbackUrl:(id)arg8 isTVShow:(bool)arg9 allowsSceneAssociation:(bool)arg10;
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 imageUrlFormat:(id)arg3 artworkImage:(struct CGImage { }*)arg4 fallbackUrl:(id)arg5 allowsSceneAssociation:(bool)arg6;
