...
@interface VUILibraryEpisodeShelfViewController : VUIShelfViewController <TVShelfViewLayoutDelegate, UICollectionViewDelegate, VUIDialogInteractionControllerDelegate, VUIEpisodeDetailViewControllerDelegate, VUILibraryDownloadPopoverViewControllerDelegate> {
...
@property (nonatomic, retain) VUIMediaCollection *season;
