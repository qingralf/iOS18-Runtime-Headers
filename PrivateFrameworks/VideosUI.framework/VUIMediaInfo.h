...
- (void)_populateMediaItem:(id)arg1 withOtherMediaItem:(id)arg2;
...
- (id)_sportingEventTimeSpanStringFromMediaItem:(id)arg1;
- (id)_sportingEventTimeSpanStringFromStartTime:(id)arg1 endTime:(id)arg2;
...
- (id)initWithPlaybackContext:(unsigned long long)arg1 storeAuxMediaItem:(id)arg2;
