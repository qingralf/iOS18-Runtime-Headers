...
@interface VUIMediaInfoFetchController : NSObject {
    NSObject<OS_dispatch_queue> * _imageDecodingQueue;
...
@property (nonatomic, retain) NSObject<OS_dispatch_queue> *imageDecodingQueue;
...
- (void)populatePlaylistWithMediaItems:(id)arg1 atIndex:(unsigned long long)arg2;
...
- (void)removePopulatedMediaItems:(id)arg1 atIndex:(unsigned long long)arg2;
- (void)setImageDecodingQueue:(id)arg1;
