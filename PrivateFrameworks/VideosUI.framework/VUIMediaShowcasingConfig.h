...
@interface VUIMediaShowcasingConfig : NSObject {
    ...
    bool  _allowsFullscreenMediaTransition;
    ...
    double  _focusDebounceThreshold;
    ...
    float  _sidebarOpenDuringAnimationThreshold;
...
@property (nonatomic) bool allowsFullscreenMediaTransition;
...
- (void)setAllowsFullscreenMediaTransition:(bool)arg1;
...
- (void)setFocusDebounceThreshold:(double)arg1;
...
- (void)setSidebarOpenDuringAnimationThreshold:(float)arg1;
