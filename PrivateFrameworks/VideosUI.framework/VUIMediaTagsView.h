...
- (void)_adjustViewsPositionFor:(id)arg1 topPadding:(double)arg2;
- (void)_adjustViewsPositionVerticallyCenteredFor:(id)arg1 preferredSize:(struct CGSize { double x1; double x2; })arg2;
...
- (id)_newLabelAsSubview:(id)arg1 textLayout:(id)arg2;
- (id)_newLabelAsSubview:(id)arg1 withAttributedString:(id)arg2 textLayout:(id)arg3;
