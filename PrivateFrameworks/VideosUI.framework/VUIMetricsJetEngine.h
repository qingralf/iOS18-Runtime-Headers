...
+ (id)convertClickDataToImpressionsData:(id)arg1 index:(long long)arg2 ignoreHosted:(bool)arg3;
+ (id)convertClickDataToLocationData:(id)arg1 index:(long long)arg2;
+ (id)sharedInstance;
...
- (id)recordEventWithTopic:(id)arg1 eventType:(id)arg2 eventData:(id)arg3 pageData:(id)arg4;
