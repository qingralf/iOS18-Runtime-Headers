...
- (void)_catchUpToLiveDidBegin:(id)arg1;
- (void)_catchUpToLiveDidEnd:(id)arg1;
- (void)_catchUpToLiveItemDidChange:(id)arg1;
- (void)_catchUpToLiveItemWillChange:(id)arg1;
...
- (void)_handleBackgroundEnterPIPChange:(id)arg1;
- (void)_handleBackgroundExitPIPChange:(id)arg1;
...
- (void)_liveSportsPostPlayAutoPlayWillStart:(id)arg1;
