...
@property (nonatomic, retain) NSObject<VUIControllerPresenter> *presentingViewController;
...
- (void)_configureFor2Dor3DWithPresentingController:(id)arg1 completion:(id /* block */)arg2;
