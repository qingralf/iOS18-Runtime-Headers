...
- (bool)_canShowUpsellForChannelId:(id)arg1 showId:(id)arg2 duration:(double)arg3 elapsedTime:(double)arg4;
- (void)_canShowUpsellForPolicy:(id)arg1 duration:(double)arg2 elapsedTime:(double)arg3 completion:(id /* block */)arg4;
...
- (id)appContext;
- (void)canShowUpsellForMediaItem:(id)arg1 withElapsedTime:(double)arg2 completion:(id /* block */)arg3;
...
- (void)setHasShownPostPlay:(bool)arg1;
