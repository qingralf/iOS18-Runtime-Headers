...
+ (unsigned long long)postPlayTypeFromString:(id)arg1;

- (void).cxx_destruct;
- (void)_dispatchAutoPlayEvent;
- (void)_initWithFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 andTVImageProxy:(id)arg2 andTitle:(id)arg3 andHeader:(id)arg4 andType:(unsigned long long)arg5;
...
- (id)header;
- (id)headerLabel;
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 andEpisodeArtworkURLStringFormat:(id)arg2 andTitle:(id)arg3 andHeader:(id)arg4 andType:(unsigned long long)arg5;
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 andTVImageProxy:(id)arg2 andTitle:(id)arg3 andHeader:(id)arg4 andType:(unsigned long long)arg5;
- (void)layoutSubviews;
- (id)nextEpisodeLabel;
