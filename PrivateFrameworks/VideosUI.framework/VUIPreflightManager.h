...
@interface VUIPreflightManager : NSObject {
    ...
    bool  _isSubscriptionPurchaseWithoutPlayback;
...
@property (nonatomic) bool isSubscriptionPurchaseWithoutPlayback;
...
- (void)_promptForHighQualityDownloadsWithCompletion:(id /* block */)arg1;
- (id)_ratingDomain;
- (id)_ratingValue;
...
- (void)setIsSubscriptionPurchaseWithoutPlayback:(bool)arg1;
