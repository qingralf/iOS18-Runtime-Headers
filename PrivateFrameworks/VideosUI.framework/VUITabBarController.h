...
- (id)_tabBarChildViewControllerWithIdentifier:(id)arg1 documentRef:(id)arg2 isNonServerTab:(bool)arg3 title:(id)arg4 isSelectedTab:(bool)arg5 appContext:(id)arg6 iconResource:(id)arg7 contextData:(id)arg8 uiConfigDict:(id)arg9;
