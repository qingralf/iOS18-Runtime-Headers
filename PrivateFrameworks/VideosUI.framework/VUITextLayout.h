...
@interface VUITextLayout : NSObject <NSCopying> {
    ...
    bool  _appliesColorToStringAttachments;
    ...
    bool  _enableAXUnderlineButtonShape;
...
@property (nonatomic) bool enableAXUnderlineButtonShape;
...
- (id)attributedStringWithString:(id)arg1 isHighlighted:(bool)arg2 isDisabled:(bool)arg3;
...
- (void)setAppliesColorToStringAttachments:(bool)arg1;
...
- (void)setEnableAXUnderlineButtonShape:(bool)arg1;
