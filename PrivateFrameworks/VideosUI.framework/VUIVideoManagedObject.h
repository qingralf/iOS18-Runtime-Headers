...
@property (nonatomic, retain) NSString *downloadedPlaybackMode;
@property (nonatomic, copy) NSNumber *dsid;
@property (nonatomic, copy) NSNumber *duration;
@property (nonatomic, copy) NSNumber *enqueuedOrder;
...
@property (nonatomic, copy) NSString *playablePassThrough;
