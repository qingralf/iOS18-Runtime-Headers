...
@property (nonatomic, readonly) NSNumber *autoExitOnBroadcastEndInSeconds;
...
@property (nonatomic, readonly) bool containsEligiblePlaybackMode;
...
@property (nonatomic, readonly) bool fullscreenTransferEligible;
@property (nonatomic, readonly) NSString *groupActivityDay;
@property (nonatomic, readonly) NSString *hlsProgramID;
...
@property (nonatomic, readonly) bool isKeyPlayAvailable;
...
@property (nonatomic, readonly) NSDictionary *liveSportsPostPlayShelfFetchPolicy;
...
@property (nonatomic, readonly) bool makeAdditionalPlayerTabsRequest;
@property (nonatomic, readonly) NSDictionary *mediaMetrics;
@property (nonatomic, readonly) NSString *mediaType;
@property (nonatomic, retain) VUIContentMetadata *metadata;
@property (nonatomic, readonly) NSString *playablePassThrough;
...
@property (nonatomic, readonly) NSString *preferredAudioLanguageCode;
@property (nonatomic, readonly) NSString *preferredPlaybackMode;
...
@property (nonatomic, readonly) bool reportVPAFWhenPlayingInBackground;
...
@property (nonatomic, readonly) NSArray *startTimeInfos;
...
+ (bool)isMediaCharacteristicAnAudioVariantID:(id)arg1;
...
- (id)adamID;
- (id)artworkURL;
- (id)autoExitOnBroadcastEndInSeconds;
- (id)bookmarkID;
- (id)buyParams;
- (id)canonicalID;
- (id)channelID;
...
- (id)knownAudioVariantIDs;
- (id)liveSportsPostPlayShelfFetchPolicy;
