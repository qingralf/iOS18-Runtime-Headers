...
@interface VideosExtrasRootViewController : UIViewController <IKAppContextDelegate, IKAppDeviceConfig, IKApplication, UICollectionViewDelegate, UINavigationControllerDelegate> {
