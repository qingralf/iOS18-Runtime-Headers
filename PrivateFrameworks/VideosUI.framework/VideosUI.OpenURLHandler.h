...
- (void)processItunesExtrasStoreLink:(id)arg1;
- (void)processNonDeeplinkURL:(id)arg1 contextData:(id)arg2 sharedWatchUrl:(id)arg3 appContext:(id)arg4 completion:(id /* block */)arg5;
