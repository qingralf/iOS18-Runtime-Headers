...
@interface VideosUI.SearchListCell : VUIBaseListViewCell <VUIZoomTransitionSourceViewProviding> {
...
- (id)resultsContextLabel;
- (void)setButtonView:(id)arg1;
- (void)setHighlighted:(bool)arg1;
- (void)setResultsContextLabel:(id)arg1;
