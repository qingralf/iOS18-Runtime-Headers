...
@property (setter=_setImageShape:, nonatomic) long long _imageShape;
...
@property (nonatomic, readonly) NSURL *latestImageURL;
...
- (id)_focusedColor;
- (id)_imageProxyWithSize:(struct CGSize { double x1; double x2; })arg1 sizeComputationOnly:(bool)arg2;
...
- (void)_setImageShape:(long long)arg1;
