...
@property (nonatomic, readonly) <UINamedLayerContentProvider> *contentProvider; /* unknown property attribute: ? */
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (nonatomic, retain) UIImage *decodedImage;
@property (readonly, copy) NSString *description;
@property (nonatomic) bool fixedFrame; /* unknown property attribute: ? */
