...
@interface VisionCoreTensorDescriptor : VisionCoreDescriptor {
    ...
    unsigned long long  _storageByteCount;
...
- (id)initWithANSTTensorDescriptor:(id)arg1;
- (id)initWithCoder:(id)arg1;
- (id)initWithName:(id)arg1 dataType:(unsigned long long)arg2 shape:(id)arg3 strides:(id)arg4;
- (id)initWithName:(id)arg1 dataType:(unsigned long long)arg2 shape:(id)arg3 strides:(id)arg4 storageByteCount:(unsigned long long)arg5;
