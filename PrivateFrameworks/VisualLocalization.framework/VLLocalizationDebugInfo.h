...
@interface VLLocalizationDebugInfo : NSObject <NSSecureCoding> {
    ...
    VLLocalizationCrowdsourcingDetails * _crowdsourcingDetails;
    double  _duration;
...
@property (nonatomic, readonly) VLLocalizationCrowdsourcingDetails *crowdsourcingDetails;
