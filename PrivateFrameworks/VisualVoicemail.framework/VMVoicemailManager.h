...
@interface VMVoicemailManager : NSObject <VMClientXPCProtocol> {
    ...
    NSObject<OS_dispatch_queue> * _internalClientQueue;
...
@property (nonatomic, readonly) NSObject<OS_dispatch_queue> *internalClientQueue;
...
- (void)_fetchInitialStateIfNecessaryWithForce:(bool)arg1 waitStates:(bool)arg2 waitMails:(bool)arg3 waitAccounts:(bool)arg4 session:(id)arg5;
...
- (void)call_greetingDidChangeByCarrier:(id)arg1;
...
- (id)fetchAccounts;
- (void)greetingChangedByCarrier:(id)arg1;
- (void)greetingForAccountUUID:(id)arg1 completion:(id /* block */)arg2;
- (id)init;
- (id)initAsync:(id)arg1 delegate:(id)arg2 delegateQueue:(id)arg3;
- (id)initAsyncWithStateSync:(bool)arg1 mailSync:(bool)arg2 session:(id)arg3 delegate:(id)arg4 delegateQueue:(id)arg5;
- (id)initWithClient:(id)arg1 synchronously:(bool)arg2 queryState:(bool)arg3 fetchMail:(bool)arg4 session:(id)arg5 delegate:(id)arg6 delegateQueue:(id)arg7;
- (id)initWithDelegate:(id)arg1 delegateQueue:(id)arg2;
- (id)initWithStateSync:(bool)arg1 mailSync:(bool)arg2 delegate:(id)arg3 delegateQueue:(id)arg4;
- (id)initWithoutMailSync;
- (void)insertVoicemail:(id)arg1;
- (id)internalClientQueue;
- (bool)isAccountOnline:(id)arg1;
- (bool)isAccountSubscribed:(id)arg1;
- (bool)isCallVoicemailSupportedForAccountUUID:(id)arg1;
