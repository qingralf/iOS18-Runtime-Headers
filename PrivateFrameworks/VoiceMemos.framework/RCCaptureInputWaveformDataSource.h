...
@property (nonatomic) bool emptyCopy;
...
- (id)capturedFragment;
- (id)copyWithTrackIndex:(unsigned long long)arg1 emptyCopy:(bool)arg2;
...
- (id)initWithDestinationComposition:(id)arg1 destinationFragment:(id)arg2 trackIndex:(unsigned long long)arg3;
- (id)segmentsInCompositionByConvertingFromActiveLoadingFragment:(id)arg1;
- (void)setEmptyCopy:(bool)arg1;
