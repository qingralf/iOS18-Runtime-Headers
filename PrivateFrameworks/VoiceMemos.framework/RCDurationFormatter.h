...
- (id)_onQueueStringFromDuration:(double)arg1 byReplacingDigitsWithDigit:(long long)arg2 hideComponentOptions:(long long)arg3 style:(long long)arg4 shouldPadMinute:(bool)arg5;
...
- (struct RCDurationStrings { id x1; id x2; id x3; id x4; })durationStringsFromDurationIntegers:(struct RCDurationIntegers { unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; })arg1 hideComponentOptions:(long long)arg2 style:(long long)arg3 shouldPadMinute:(bool)arg4;
- (id)init;
...
- (id)stringFromDuration:(double)arg1 hideComponentOptions:(long long)arg2 style:(long long)arg3 shouldPadMinute:(bool)arg4;
