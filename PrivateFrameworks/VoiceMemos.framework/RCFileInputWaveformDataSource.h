...
- (id)initWithAVFileURL:(id)arg1 savesGeneratedWaveform:(bool)arg2 segmentFlushInterval:(double)arg3 trackIndex:(unsigned long long)arg4;
- (id)initWithAVFileURL:(id)arg1 trackIndex:(unsigned long long)arg2;
