...
- (id)_onQueueAddPendingServiceMessageReplyBlockInvalidationHandler:(id /* block */)arg1;
...
- (void)_valueForServiceKey:(id)arg1 synchronous:(bool)arg2 completion:(id /* block */)arg3;
...
- (oneway void)importRecordingWithSourceAudioURL:(id)arg1 name:(id)arg2 date:(id)arg3 userInfo:(id)arg4 importCompletionBlock:(id /* block */)arg5;
- (oneway void)importRecordingsFromCloud:(id /* block */)arg1;
- (id)init;
- (id)observeFinalizingRecordings:(id /* block */)arg1;
- (oneway void)openAudioFile:(id)arg1 settings:(id)arg2 metadata:(id)arg3 accessRequestHandler:(id /* block */)arg4;
...
- (oneway void)prepareToExportCompositionAVURL:(id)arg1 accessRequestHandler:(id /* block */)arg2;
- (id)prepareToExportCompositionAVURL:(id)arg1 error:(id*)arg2;
...
- (id)valueForServiceKey:(id)arg1;
- (oneway void)valueForServiceKey:(id)arg1 completion:(id /* block */)arg2;
