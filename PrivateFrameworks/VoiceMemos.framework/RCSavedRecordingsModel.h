...
+ (void)_determineImportabilityOfRecordingWithAudioAsset:(id)arg1 preferredFormat:(unsigned int)arg2 completionHandler:(id /* block */)arg3;
...
+ (id)standardPathForRecordingWithCreationDate:(id)arg1 uniqueID:(id)arg2 fileExtension:(id)arg3;
+ (id)standardURLForRecordingWithCreationDate:(id)arg1 fileExtension:(id)arg2;
...
- (id)duplicateRecording:(id)arg1 copyingResources:(bool)arg2 creationDate:(id)arg3 error:(id*)arg4;
...
- (id)existingFoldersWithName:(id)arg1 searchOption:(int)arg2;
- (id)existingRecordingsWithName:(id)arg1 searchOption:(int)arg2 error:(id*)arg3;
...
- (id)transactionsAndChangesForObjectID:(id)arg1;
