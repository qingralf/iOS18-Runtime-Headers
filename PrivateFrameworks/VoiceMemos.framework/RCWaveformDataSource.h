...
@property (nonatomic, readonly) bool supportsLiveInput;
...
- (id)initWithWaveformGenerator:(id)arg1 generatedWaveformOutputURL:(id)arg2 trackIndex:(unsigned long long)arg3;
