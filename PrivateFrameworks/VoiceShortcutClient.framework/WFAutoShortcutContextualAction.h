...
@property (nonatomic, readonly) WFExecutableAppShortcut *executableAppShortcut;
@property (nonatomic, readonly) bool isTopHitEligible;
@property (nonatomic, readonly) unsigned long long orderOfShortcut;
@property (nonatomic, readonly) NSString *parameterlessIdentifier;
...
@property (nonatomic, readonly) NSArray *searchKeywords;
...
- (id)executableAppShortcut;
- (unsigned long long)hash;
- (id)initWithAutoShortcut:(id)arg1 bundleIdentifier:(id)arg2;
- (id)initWithAutoShortcut:(id)arg1 identifier:(id)arg2 parameterlessIdentifier:(id)arg3 phrase:(id)arg4 alternativePhrases:(id)arg5 bundleIdentifier:(id)arg6 actionIdentifier:(id)arg7 orderOfShortcut:(unsigned long long)arg8 parentAction:(id)arg9 prominentDisplayEligibility:(id)arg10 executableAppShortcut:(id)arg11;
- (id)initWithAutoShortcut:(id)arg1 phrase:(id)arg2 alternativePhrases:(id)arg3 bundleIdentifier:(id)arg4;
- (id)initWithCoder:(id)arg1;
- (id)initWithExecutableAppShortcut:(id)arg1 index:(unsigned long long)arg2;
- (bool)isEligibleForProminentDisplay;
- (bool)isEqual:(id)arg1;
- (bool)isTopHitEligible;
- (unsigned long long)orderOfShortcut;
- (id)parameterlessIdentifier;
- (id)parentAction;
- (id)phrase;
- (id)relatedApp;
- (id)searchKeywords;
