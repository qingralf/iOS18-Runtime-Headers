...
@property (nonatomic, readonly) bool availableFromLockedContext;
...
@property (nonatomic, readonly) NSString *spotlightActionIdentifier;
...
@property (nonatomic, readonly, copy) NSString *uniquePrivateIdentifier;
...
- (bool)wf_shouldLaunchAppWithSurface:(unsigned long long)arg1 linkAction:(id)arg2 actionMetadata:(id)arg3 appBundleIdentifier:(id)arg4 actionIdentifier:(id)arg5;
- (id)workflowRunKind;
