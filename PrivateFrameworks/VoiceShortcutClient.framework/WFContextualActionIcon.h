...
@property (nonatomic, readonly, copy) NSString *lnPropertyIdentifier;
@property (nonatomic, readonly) NSString *systemName;
@property (nonatomic, readonly) WFIcon *wfIcon;

+ (id)iconWithApplicationBundleIdentifier:(id)arg1;
+ (void)iconWithINImage:(id)arg1 displayStyle:(unsigned long long)arg2 completion:(id /* block */)arg3;
...
- (id)initWithLNPropertyIdentifier:(id)arg1 displayStyle:(unsigned long long)arg2;
- (id)initWithSystemName:(id)arg1;
- (bool)isEqual:(id)arg1;
- (id)lnPropertyIdentifier;
- (void)loadLNPropertyImageWithCompletion:(id /* block */)arg1;
- (id)renderedImage;
- (id)systemName;
- (id)wfIcon;
