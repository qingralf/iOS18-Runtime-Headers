...
@property (nonatomic, readonly) WFEncodedTypedValue *encodedTypedValue;
...
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 identifier:(id)arg3 image:(id)arg4 selected:(bool)arg5 hideSubtitle:(bool)arg6 encodedTypedValue:(id)arg7 serializedPossibleState:(id)arg8;
