...
- (id)endColor;
- (id)initWithBaseColor:(id)arg1 darkBaseColor:(id)arg2 accessibilityBaseColor:(id)arg3 darkAccessibilityBaseColor:(id)arg4 startColor:(id)arg5 endColor:(id)arg6;
- (id)initWithBaseColor:(id)arg1 startColor:(id)arg2 endColor:(id)arg3;
