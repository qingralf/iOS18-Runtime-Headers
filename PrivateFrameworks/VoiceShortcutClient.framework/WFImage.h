...
+ (id)applicationIconImageForBundleIdentifier:(id)arg1 length:(double)arg2 scale:(double)arg3;
+ (void)applicationIconImageForBundleIdentifier:(id)arg1 length:(double)arg2 scale:(double)arg3 completionHandler:(id /* block */)arg4;
+ (id)applicationIconImageForCalendarDate:(id)arg1 descriptor:(id)arg2;
...
+ (id)glyphNamed:(id)arg1 pointSize:(double)arg2 symbolWeight:(long long)arg3 scaleFactor:(double)arg4;
...
- (id)roundedWithContinuousCornerRadius:(double)arg1 size:(struct CGSize { double x1; double x2; })arg2;
- (double)scale;
