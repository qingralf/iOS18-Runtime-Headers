...
- (id)initWithAction:(id)arg1 appBundleIdentifier:(id)arg2 extensionBundleIdentifier:(id)arg3 contextualParameters:(id)arg4 authenticationPolicy:(long long)arg5 icon:(id)arg6;
