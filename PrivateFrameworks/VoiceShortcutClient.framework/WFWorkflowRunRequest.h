...
@interface WFWorkflowRunRequest : NSObject <NSSecureCoding> {
    ...
    bool  _handlesDialogRequests;
    bool  _handlesSiriActionRequests;
...
@property (getter=isStepwise, nonatomic, readonly) bool stepwise;
...
- (void)setHandlesDialogRequests:(bool)arg1;
- (void)setHandlesSiriActionRequests:(bool)arg1;
