...
@interface WFWorkflowRunningContext : NSObject <NSCopying, NSSecureCoding> {
    ...
    bool  _shouldForwardDialogRequests;
    bool  _shouldForwardSiriActionRequests;
    bool  _stepwise;
...
@property (getter=isStepwise, nonatomic) bool stepwise;
...
- (id)copyWithCustomIdentity:(id)arg1;
...
- (void)setShouldForwardDialogRequests:(bool)arg1;
- (void)setShouldForwardSiriActionRequests:(bool)arg1;
- (void)setStepwise:(bool)arg1;
