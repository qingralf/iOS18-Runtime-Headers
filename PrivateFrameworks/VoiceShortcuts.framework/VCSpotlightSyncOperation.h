...
@interface VCSpotlightSyncOperation : NSObject {
    ...
    NSDictionary * _referencesToIndex;
...
@property (nonatomic, readonly) NSDictionary *referencesToIndex;
@property (nonatomic, readonly) NSObject<OS_os_transaction> *transaction;

+ (void)_fillIdentifiersToRemove:(id*)arg1 referencesToIndex:(id*)arg2 withMaximumUpdatedItems:(long long)arg3 references:(id)arg4 localState:(id)arg5;
