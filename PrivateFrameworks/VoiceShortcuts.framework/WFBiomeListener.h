...
@property (nonatomic, retain) NSMutableDictionary *seenTransactionIdentifiers;
...
- (bool)isTransactionEventDuplicate:(id)arg1 forTrigger:(id)arg2 withSeenTransactionIdentifiers:(id)arg3;
- (id)queue;
...
- (id)seenTransactionIdentifiers;
- (void)setSeenTransactionIdentifiers:(id)arg1;
- (id)triggerIDToSinks;
