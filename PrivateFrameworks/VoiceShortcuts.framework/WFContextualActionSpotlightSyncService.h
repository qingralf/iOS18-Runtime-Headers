...
@interface WFContextualActionSpotlightSyncService : NSObject <CSSearchableIndexDelegate, FCActivityManagerObserving, MTAlarmDataSourceObserver, WFDatabaseResultObserver> {
    ...
    WFDatabaseResult * _folderDatabaseResult;
...
@property (nonatomic, readonly) WFDatabaseResult *folderDatabaseResult;
...
- (id)queue;
- (void)queue_fetchWipeAndIndexActionsInDomainWithDescriptiveName:(id)arg1 identifiers:(id)arg2 batchSize:(unsigned long long)arg3 fetcher:(id /* block */)arg4 completionBlock:(id /* block */)arg5;
...
- (void)queue_getFolderAppEntityContextualActionsWithCompletionHandler:(id /* block */)arg1;
...
- (void)queue_v2GetAppShortcutContextualActionsForBundleIdentifiers:(id)arg1 completionHandler:(id /* block */)arg2;
