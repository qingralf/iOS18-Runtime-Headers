...
- (void)deactivateEphemeralTriggerIfNeeded:(id)arg1 completion:(id /* block */)arg2;
...
- (id)initWithDatabaseProvider:(id)arg1 notificationManager:(id)arg2 notificationScheduler:(id)arg3;
