...
@interface VTUIProximityEnrollTrainingViewController : UIViewController <AFMyriadDelegate, AFUISiriLanguageDelegate, SCDADelegate, SSRVTUITrainingManagerDelegate, VTUIEnrollmentDelegate, VTUISiriDataSharingOptInPresentationDelegate, VTUIVoiceSelectionViewControllerDelegate> {
