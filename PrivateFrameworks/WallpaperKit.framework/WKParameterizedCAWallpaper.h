...
@interface WKParameterizedCAWallpaper : WKAbstractWallpaper <WKValueBasedWallpaper> {
    WKParameterizedCAWallpaperInput * __wallpaperValue;
}

@property (nonatomic, retain) WKParameterizedCAWallpaperInput *_wallpaperValue;
...
- (id)initWithIdentifier:(long long)arg1 name:(id)arg2 fileURL:(id)arg3;
