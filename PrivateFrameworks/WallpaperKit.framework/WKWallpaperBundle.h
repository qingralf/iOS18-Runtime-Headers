...
@interface WKWallpaperBundle : NSObject <NAIdentifiable, WKDescribable, WKWallpaperRepresenting> {
    ...
    NSString * _name;
    bool  _offloaded;
    NSDictionary * _preferredProminentColors;
...
@property (nonatomic, readonly, copy) NSDictionary *preferredProminentColors;
...
+ (id)_createWallpaperBundleInDirectory:(id)arg1 version:(long long)arg2 identifier:(long long)arg3 name:(id)arg4 family:(id)arg5 disableParallax:(bool)arg6 isOffloaded:(bool)arg7 logicalScreenClass:(id)arg8 thumbnailImageURL:(id)arg9 adjustmentTraits:(id)arg10 preferredProminentColors:(id)arg11 preferredTitleColors:(id)arg12 assetMapping:(id)arg13;
+ (id)na_identity;
...
- (void)_loadBundle;
- (id)_parameterizedCAWallpaperWithMetadataDictionary:(id)arg1 wallpaperAppearance:(id)arg2;
