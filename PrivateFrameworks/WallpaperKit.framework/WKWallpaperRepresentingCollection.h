...
@property (nonatomic, readonly) bool disableRotation;
...
- (id)initWithWallpaperCollectionIdentifier:(id)arg1 displayName:(id)arg2 previewWallpaperRepresenting:(id)arg3 wallpapersShareBaseAppearance:(bool)arg4 hiddenFromPicker:(bool)arg5 disableRotation:(bool)arg6 wallpaperRepresentingCollection:(id)arg7 downloadManager:(id)arg8;
