...
@interface WLKNetworkRequestOperation : WLKAsyncOperation {
    ...
    WLKMetricsActivity * _nwactivity;
    long long  _options;
...
@property (nonatomic, retain) WLKMetricsActivity *nwactivity;
...
- (id)initWithURLRequest:(id)arg1 options:(long long)arg2 activity:(id)arg3;
- (id)nwactivity;
- (long long)options;
