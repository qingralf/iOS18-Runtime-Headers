...
@interface WLKNotificationsImpl_iOS : NSObject <UNUserNotificationCenterDelegate, UNUserNotificationCenterDelegatePrivate, WLKNotificationsImpl> {
    NSMutableSet * _notificationTopics;
...
@property (nonatomic, retain) NSMutableSet *notificationTopics;
...
- (void).cxx_destruct;
- (void)_accountChangedNotification:(id)arg1;
...
- (void)setNotificationTopics:(id)arg1;
