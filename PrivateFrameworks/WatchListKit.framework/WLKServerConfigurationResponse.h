...
@property (getter=isFromDiskCache, nonatomic) bool fromDiskCache;
@property (nonatomic, readonly) bool naturalLanguageSearchProperty;
@property (nonatomic, readonly) NSDictionary *requiredRequestKeyValuePairsDictionary;
@property (nonatomic, readonly) NSDictionary *responseDictionary;
@property (nonatomic, readonly) NSDictionary *searchReportConcernProps;
