...
@property (nonatomic, readonly, copy) NSString *webClipIDString;
...
- (id)localAttributesWithLastVisitTime:(id)arg1 queuedNavigation:(id)arg2;
- (id)pinnedPageTitle;
- (id)pinnedPageURL;
- (id)queuedNavigation;
