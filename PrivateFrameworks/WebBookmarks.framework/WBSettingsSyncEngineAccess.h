...
- (void).cxx_destruct;
- (void)_attemptUpdatingSavingPerSiteSettingsWithRecord:(id)arg1;
- (id)_deviceClass;
- (void)_didUpdateIOSDefaultBrowserWithRecord:(id)arg1;
- (void)_didUpdateStartPageBackgroundImageVisibilityWithRecord:(id)arg1;
- (void)_installMobileAssetIfApplicableWithURL:(id)arg1;
...
- (void)_updateStartPageCloudTabsConsent:(id)arg1;
