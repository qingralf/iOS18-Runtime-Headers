...
@interface WBTab : NSObject <BookmarkableTab, NSCopying, NSMutableCopying, NSSecureCoding, WBBookmarkRepresentable, WBSCloudTabItem, WBSerializable> {
...
@property (nonatomic, readonly) bool hasLinkToCopy;
...
- (id)initWithBookmark:(id)arg1 isPrivateBrowsing:(bool)arg2;
...
- (id)initWithUUID:(id)arg1 title:(id)arg2 url:(id)arg3 deviceIdentifier:(id)arg4 isPrivateBrowsing:(bool)arg5;
...
+ (unsigned long long)linkCountForTabs:(id)arg1;
