...
- (id)_cyclerRepresentationOfTabGroupFavorite:(id)arg1;
- (id)_cyclerRepresentationOfTopScopedBookmarkListForTabGroup:(id)arg1;
...
- (id)_tabGroupFavoriteBeforeIndex:(unsigned long long)arg1 inList:(id)arg2;
