...
@interface WBTabGroupSyncAgentProxy : NSObject <WBSDeallocationSentinelObserver, WBTabGroupManagerObserver, WBTabGroupSyncAgentProtocol, WBTabGroupSyncAgentSyncObserver> {
