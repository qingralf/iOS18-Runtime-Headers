...
@property (nonatomic, readonly, copy) NSData *deprecatedUsernameAccountHash;
...
@property (nonatomic, readonly) bool userHasSharedTabGroups;
...
- (id)_descendantIDsOfBookmarkFolderID:(int)arg1;
...
- (void)_enumerateBookmarksMatchingString:(id)arg1 statementSuffix:(id)arg2 usingBlock:(id /* block */)arg3;
...
- (bool)_performSafariVersionUpgradesOutsideSafariProcessFromPreviousVersion:(id)arg1;
