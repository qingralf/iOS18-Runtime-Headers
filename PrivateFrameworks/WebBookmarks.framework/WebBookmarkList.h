...
- (id)_bookmarkAtIndex:(unsigned int)arg1 paginate:(bool)arg2 skipDecodingSyncData:(bool)arg3;
...
- (id)bookmarkAtIndex:(unsigned int)arg1 skipDecodingSyncData:(bool)arg2;
