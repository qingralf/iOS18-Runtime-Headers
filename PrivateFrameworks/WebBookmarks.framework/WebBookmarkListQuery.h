...
- (int)_childCountInDatabaseForFolderFetchInCollection:(id)arg1 skipCountingInDatabaseBookmarksThatAreDeletedInMemory:(bool)arg2 countShouldUseNumChildrenIfPossible:(bool)arg3;
...
- (id)bookmarksInCollection:(id)arg1 fromIndex:(unsigned int)arg2 toIndex:(unsigned int)arg3 skipDecodingSyncData:(bool)arg4;
...
- (id)initWithFolderID:(int)arg1 inCollection:(id)arg2 usingFilter:(id)arg3 options:(unsigned long long)arg4;
- (bool)isCustomQuery;
