...
- (void)_migrateWindowBookmark:(id)arg1;
...
- (id)_specialTabsWithUUID:(id)arg1 privateBrowsing:(bool)arg2;
- (id)_tabGroupForBookmark:(id)arg1 kind:(long long)arg2;
- (id)_tabGroupWithID:(int)arg1 kind:(long long)arg2;
...
- (id)remoteDevicesForProfileBookmark:(id)arg1;
