...
- (bool)contentFilterOverriddenWhiteListContainsURL:(id)arg1 withAppleAllowList:(id)arg2;
- (id)contentFilterOverriddenWhiteListedSites;
- (id)contentFilterOverriddenWhiteListedSitesBuffer;
- (id)contentFilterOverriddenWhiteListedSitesBufferWithAdditionalURLStrings:(id)arg1;
