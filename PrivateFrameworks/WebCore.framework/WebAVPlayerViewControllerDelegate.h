...
@property (nonatomic) /* Warning: unhandled struct encoding: '{RefPtr<WebCore::VideoPresentationInterfaceAVKit' */ struct  fullscreenInterface; /* unknown property attribute:  WTF::DefaultRefDerefTraits<WebCore::VideoPresentationInterfaceAVKit>>=^{VideoPresentationInterfaceAVKit}} */
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;

- (id).cxx_construct;
- (void).cxx_destruct;
- (struct RefPtr<WebCore::VideoPresentationInterfaceAVKit, WTF::RawPtrTraits<WebCore::VideoPresentationInterfaceAVKit>, WTF::DefaultRefDerefTraits<WebCore::VideoPresentationInterfaceAVKit>> { struct VideoPresentationInterfaceAVKit {} *x1; })fullscreenInterface;
...
- (void)setFullscreenInterface:(struct RefPtr<WebCore::VideoPresentationInterfaceAVKit, WTF::RawPtrTraits<WebCore::VideoPresentationInterfaceAVKit>, WTF::DefaultRefDerefTraits<WebCore::VideoPresentationInterfaceAVKit>> { struct VideoPresentationInterfaceAVKit {} *x1; })arg1;
