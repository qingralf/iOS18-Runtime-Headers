...
- (void)accessibilityOverrideProcessNotification:(id)arg1 notificationData:(id)arg2;
...
- (void)handleNotificationRelayToChrome:(id)arg1 notificationData:(id)arg2;
...
- (id)nextMarkerForCharacterOffset:(void*)arg1;
- (id)nextMarkerForMarker:(id)arg1;
- (long long)positionForTextMarker:(id)arg1;
- (id)previousMarkerForCharacterOffset:(void*)arg1;
- (id)previousMarkerForMarker:(id)arg1;
- (struct optional<WebCore::SimpleRange> { union { BOOL x_1_1_1; struct SimpleRange { struct BoundaryPoint { struct Ref<WebCore::Node, WTF::RawPtrTraits<WebCore::Node>, WTF::DefaultRefDerefTraits<WebCore::Node>> { struct Node {} *x_1_4_1; } x_1_3_1; unsigned int x_1_3_2; } x_2_2_1; struct BoundaryPoint { struct Ref<WebCore::Node, WTF::RawPtrTraits<WebCore::Node>, WTF::DefaultRefDerefTraits<WebCore::Node>> { struct Node {} *x_1_4_1; } x_2_3_1; unsigned int x_2_3_2; } x_2_2_2; } x_1_1_2; } x1; bool x2; })rangeForTextMarkers:(id)arg1;
