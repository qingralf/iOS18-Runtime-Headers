...
@property (nonatomic) /* Warning: unhandled struct encoding: '{ObjectIdentifierGeneric<WebCore::AXIDType' */ struct  identifier; /* unknown property attribute:  WTF::SupportsObjectIdentifierNullState::Yes>=Q} */
...
- (void)detach;
- (struct ObjectIdentifierGeneric<WebCore::AXIDType, WTF::ObjectIdentifierMainThreadAccessTraits<uint64_t>, unsigned long long, WTF::SupportsObjectIdentifierNullState::Yes> { unsigned long long x1; })identifier;
- (id)initWithAccessibilityObject:(void*)arg1;
- (id)innerHTML;
- (bool)isIsolatedObject;
- (id)lineRectsAndText;
- (id)outerHTML;
- (void)setIdentifier:(struct ObjectIdentifierGeneric<WebCore::AXIDType, WTF::ObjectIdentifierMainThreadAccessTraits<uint64_t>, unsigned long long, WTF::SupportsObjectIdentifierNullState::Yes> { unsigned long long x1; })arg1;
