...
- (void)dealloc;
- (id)error;
- (id)initWithSession:(id)arg1 identifier:(unsigned long long)arg2 request:(id)arg3 targetDispatcher:(struct RefCountedSerialFunctionDispatcher { int (**x1)(); }*)arg4;
- (id)originalRequest;
- (float)priority;
- (void*)resource;
