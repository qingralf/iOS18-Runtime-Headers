...
- (id)_frameView;
- (bool)_handleEditingKeyEvent:(void*)arg1;
...
- (void)copy:(id)arg1;
- (struct Command { struct EditorInternalCommand {} *x1; unsigned char x2; struct RefPtr<WebCore::Document, WTF::RawPtrTraits<WebCore::Document>, WTF::DefaultRefDerefTraits<WebCore::Document>> { struct Document {} *x_3_1_1; } x3; struct RefPtr<WebCore::LocalFrame, WTF::RawPtrTraits<WebCore::LocalFrame>, WTF::DefaultRefDerefTraits<WebCore::LocalFrame>> { struct LocalFrame {} *x_4_1_1; } x4; })coreCommandByName:(const char *)arg1;
- (struct Command { struct EditorInternalCommand {} *x1; unsigned char x2; struct RefPtr<WebCore::Document, WTF::RawPtrTraits<WebCore::Document>, WTF::DefaultRefDerefTraits<WebCore::Document>> { struct Document {} *x_3_1_1; } x3; struct RefPtr<WebCore::LocalFrame, WTF::RawPtrTraits<WebCore::LocalFrame>, WTF::DefaultRefDerefTraits<WebCore::LocalFrame>> { struct LocalFrame {} *x_4_1_1; } x4; })coreCommandBySelector:(SEL)arg1;
