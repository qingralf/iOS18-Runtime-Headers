...
- (void)_notificationDidClick:(id)arg1;
- (void)_notificationDidShow:(id)arg1;
- (id)_notificationIDForTesting:(struct OpaqueJSValue { }*)arg1;
...
- (void)_removeDictationAlternatives:(struct ObjectIdentifierGeneric<WebCore::DictationContextType, WTF::ObjectIdentifierMainThreadAccessTraits<uint64_t>, unsigned long long, WTF::SupportsObjectIdentifierNullState::Yes> { unsigned long long x1; })arg1;
...
- (void)_setPortsForUpgradingInsecureSchemeForTesting:(unsigned short)arg1 withSecurePort:(unsigned short)arg2;
...
- (void)_setTopContentInsetForTesting:(float)arg1;
...
- (void)_showDictationAlternativeUI:(const struct FloatRect { struct FloatPoint { float x_1_1_1; float x_1_1_2; } x1; struct FloatSize { float x_2_1_1; float x_2_1_2; } x2; }*)arg1 forDictationContext:(struct ObjectIdentifierGeneric<WebCore::DictationContextType, WTF::ObjectIdentifierMainThreadAccessTraits<uint64_t>, unsigned long long, WTF::SupportsObjectIdentifierNullState::Yes> { unsigned long long x1; })arg2;
