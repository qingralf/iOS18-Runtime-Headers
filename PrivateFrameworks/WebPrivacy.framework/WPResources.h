...
- (void)requestRestrictedOpenerDomains:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)requestStorageAccessPromptQuirksData:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)requestStorageAccessUserAgentStringQuirksData:(id)arg1 completionHandler:(id /* block */)arg2;
