...
- (void)displayLoadingSpinner:(bool)arg1;
- (void)doneTapped;
...
- (bool)hasEVCert;
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 webSheetViewController:(id)arg2;
- (bool)isCertTrustDone;
- (bool)isChinaRegion;
- (bool)isConfigurationProfileMIMEType:(id)arg1;
