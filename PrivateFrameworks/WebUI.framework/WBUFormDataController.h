...
@interface WBUFormDataController : WBSFormDataController <MCProfileConnectionObserver, WBSFormAutoFillCorrectionManagerDelegate, WBSFormFieldClassificationCorrectorDelegate> {
    WBSSavedAccount * _accountSavedWithGeneratedPassword;
...
@property (nonatomic, retain) NSSet *previouslyFilledVirtualCardNumbers;
...
- (bool)_updatePasswordOfPreviouslySavedAccount:(id)arg1 withPasswordEditedByUser:(id)arg2;
...
- (void)showPasswordSavedPromptForSavedAccount:(id)arg1 webView:(id)arg2;
