...
- (void)_enableSoftAPWithSSID:(id)arg1 password:(id)arg2 channels:(id)arg3 secret:(id)arg4 srp:(id)arg5 completion:(id /* block */)arg6 enabled:(bool)arg7 error:(id)arg8 channel:(id)arg9 currentChannel:(long long)arg10;
...
- (void)softAPDidStart:(bool)arg1 ssid:(id)arg2 psk:(id)arg3 secret:(id)arg4 srp:(id)arg5 channel:(id)arg6 error:(id)arg7 completion:(id /* block */)arg8;
- (id)sourceDevice;
- (id)ssid;
