...
- (id)initWithOptions:(unsigned long long)arg1 byoMOC:(id)arg2;
...
- (void)performPruneTestBSSes:(id)arg1;
...
- (void)processMetricDiagnosticState:(id)arg1;
- (void)processMetricFault:(id)arg1;
