...
@interface WFClient : NSObject {
    ...
    NSObject<OS_dispatch_queue> * _stateMonitorQueue;
...
@property (nonatomic, retain) NSObject<OS_dispatch_queue> *stateMonitorQueue;
...
- (void)setRandomAddressModeForNetwork:(id)arg1 mode:(unsigned long long)arg2 randomMAC:(id)arg3;
- (void)setRssiThresholdNumber:(id)arg1;
- (void)setSerialClientQueue:(id)arg1;
- (void)setShowAllHS20Networks:(bool)arg1;
- (void)setStateMonitorQueue:(id)arg1;
- (void)setUserAutoJoinState:(bool)arg1;
- (void)setUserAutoJoinState:(bool)arg1 completion:(id /* block */)arg2;
