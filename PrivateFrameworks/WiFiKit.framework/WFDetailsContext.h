...
@property (nonatomic, copy) id /* block */ credentialsTappedHandler; /* unknown property attribute: ? */
@property (getter=isCredentialsVisible, nonatomic) bool credentialsVisible;
@property (getter=isCurrent, nonatomic) bool current;
@property (nonatomic, retain) DADevice *daDevice;
...
@property (getter=isJoinable, nonatomic) bool joinable; /* unknown property attribute: ? */
...
@property (nonatomic, readonly, copy) NSString *portalURL; /* unknown property attribute: ? */
...
@property (nonatomic) unsigned long long privateAddressMode; /* unknown property attribute: ? */
