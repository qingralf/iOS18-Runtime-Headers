...
@interface WFInterface : NSObject {
    ...
    NSArray * _deviceScanChannelsPerCurLocale;
...
@property (nonatomic, retain) NSArray *deviceScanChannelsPerCurLocale;
...
- (id)deviceScanChannelsPerCurLocale;
- (void)disassociateFromCarPlayUserConfiguredNetwork;
- (void)disassociateFromCurrentNetwork;
- (void)disassociateFromCurrentNetworkWithCompletion:(id /* block */)arg1;
- (bool)hasNoGatewayIP;
...
- (id)initWithDevice:(struct __WiFiDeviceClient { }*)arg1 coreWiFiInterface:(id)arg2 interfaceName:(id)arg3;
- (id)interfaceName;
- (id)ipMonitor;
- (int)ipState;
...
- (void)setDeviceScanChannelsPerCurLocale:(id)arg1;
