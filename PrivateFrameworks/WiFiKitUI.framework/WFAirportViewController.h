...
@property unsigned long long currentNetworkSignalBars; /* unknown property attribute: ? */
@property long long currentNetworkState;
@property (nonatomic, copy) NSString *currentNetworkSubtitle; /* unknown property attribute: ? */
@property (nonatomic, copy) NSString *currentUnconfiguredHeaderText;
@property (readonly, copy) NSString *debugDescription; /* unknown property attribute: ? */
@property (readonly, copy) NSString *description;
@property (nonatomic) long long deviceCapability; /* unknown property attribute: ? */
@property (nonatomic) bool disablePowerModification;
@property (nonatomic) bool disabled; /* unknown property attribute: ? */
...
@property (nonatomic) bool isUsingSwiftList;
...
@property (nonatomic) bool networkListVisible; /* unknown property attribute: ? */
...
@property (nonatomic) bool usePlacardCell;
@property (nonatomic, copy) NSString *userAutoJoinDisabledWarning;
@property (nonatomic) bool userAutoJoinEnabled; /* unknown property attribute: ? */
...
- (long long)rowCountWithPlacardCell:(long long)arg1;
- (id)screenProtector;
- (void)scrollToAirportCell:(unsigned long long)arg1;
- (id)sections;
...
- (void)setIsUsingSwiftList:(bool)arg1;
...
- (void)setUsePlacardCell:(bool)arg1;
