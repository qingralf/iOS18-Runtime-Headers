...
@property (nonatomic, copy) NSString *displayFriendlyName;
...
- (void)setDisplayFriendlyName:(id)arg1;
...
- (void)setNetworkQualityVisible:(bool)arg1;
...
- (void)setWifiOutrankEnabled:(bool)arg1;
- (id)ssid;
