...
@interface WFValueListViewController : WFInsetTableViewController {
    ...
    WFValueListViewController * _sublist;
    bool  _switchOn;
...
@property (nonatomic, retain) WFValueListViewController *sublist;
...
- (id)initWithTitles:(id)arg1 switchTitle:(id)arg2 sublist:(id)arg3;
- (id)initWithTitles:(id)arg1 switchTitle:(id)arg2 sublist:(id)arg3 appearanceProxy:(id)arg4;
