...
- (void)dealloc;
- (bool)getActiveTrafficRegistrationWithCompletionHandler:(id /* block */)arg1;
- (id)init;
- (void)invalidatedActiveTrafficRegistration:(id)arg1;
- (bool)performRealtimeConnectivityCheckWithConfiguration:(id)arg1 error:(id*)arg2;
...
- (bool)setTrafficRegistration:(id)arg1 onInvalidationHandler:(id /* block */)arg2 error:(id*)arg3;
