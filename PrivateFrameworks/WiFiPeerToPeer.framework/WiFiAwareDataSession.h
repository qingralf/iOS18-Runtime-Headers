...
@interface WiFiAwareDataSession : NSObject <WiFiAwareDatapathXPCDelegate, WiFiP2PXPCConnectionDelegate> {
    ...
    <WiFiAwareDataSessionPairingDelegate> * _pairingDelegate;
...
@property (nonatomic, copy) WiFiAwarePublishServiceSpecificInfo *pairSetupServiceSpecificInfo;
@property bool pairingCachingEnabled;
@property (nonatomic) <WiFiAwareDataSessionPairingDelegate> *pairingDelegate;
...
- (void)datapathPairingRequestStartedWithPairingMethod:(long long)arg1 pairingAuthenticationInputCompletionHandler:(id /* block */)arg2;
...
- (void)generateDiversifiedPINWithCompletionHandler:(id /* block */)arg1;
...
- (id)pairSetupServiceSpecificInfo;
- (bool)pairingCachingEnabled;
- (id)pairingDelegate;
- (long long)pairingMethod;
- (id)passphrase;
- (id)pmk;
- (id)pmkID;
...
- (void)setPairSetupServiceSpecificInfo:(id)arg1;
- (void)setPairingCachingEnabled:(bool)arg1;
- (void)setPairingDelegate:(id)arg1;
- (void)setPairingMethod:(long long)arg1;
