...
- (id)initWithDiscoveryResult:(id)arg1 serviceType:(long long)arg2 passphrase:(id)arg3 pmk:(id)arg4 pmkID:(id)arg5 serviceSpecificInfo:(id)arg6 internetSharingConfiguration:(id)arg7 pairingMethod:(long long)arg8 pairingCachingEnabled:(bool)arg9 pairSetupServiceSpecificInfo:(id)arg10;
- (id)internetSharingConfiguration;
- (bool)internetSharingEqual:(id)arg1;
- (bool)isEqual:(id)arg1;
- (id)pairSetupServiceSpecificInfo;
- (bool)pairSetupServiceSpecificInfoEqual:(id)arg1;
