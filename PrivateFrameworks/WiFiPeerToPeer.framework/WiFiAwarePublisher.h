...
- (id)exportedObject;
- (void)generateDiversifiedPINForDataSession:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)publishPairingRequestIndicatedBySubscriber:(id)arg1 withPairingMethod:(long long)arg2 pairingAuthenticationGeneratedCompletionHandler:(id /* block */)arg3;
