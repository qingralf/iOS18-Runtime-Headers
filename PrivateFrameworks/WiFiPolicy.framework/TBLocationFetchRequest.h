...
@interface TBLocationFetchRequest : NSObject <NSCopying, TBFetchRequest> {
    bool  _cacheable;
...
@property (nonatomic, retain) TBLocationFetchRequestDescriptor *descriptor;
...
@property (nonatomic, retain) NSDictionary *userInfo; /* unknown property attribute: ? */
