...
@property (nonatomic, readonly) unsigned long long accessPointCount; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) double centroidLat; /* unknown property attribute: ? */
@property (nonatomic) double centroidLat;
@property (nonatomic, readonly) double centroidLng; /* unknown property attribute: ? */
...
@property (nonatomic, readonly) unsigned long long tileKey; /* unknown property attribute: ? */
