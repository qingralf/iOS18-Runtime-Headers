...
- (bool)askToLaunchTapToRadarWithMessage:(id)arg1 timeout:(double)arg2;
- (bool)askToLaunchTapToRadarWithMessage:(id)arg1 timeout:(double)arg2 completionHandler:(id /* block */)arg3;
