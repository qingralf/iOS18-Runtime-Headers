...
- (id)initWithInterfaceName:(id)arg1 andDuration:(double)arg2 andInterfaceCapabilities:(id)arg3;
- (id)initWithInterfaceName:(id)arg1 andInterfaceCapabilities:(id)arg2;
- (id)interfaceName;
- (id)label;
- (id)lastSampleBssid;
