...
+ (unsigned long long)getMaxPhyrateWithNss:(unsigned long long)arg1 Bw:(unsigned long long)arg2 Phy:(int)arg3;
+ (void)initialize;
+ (int)maxPhyModeFrom:(int)arg1;
...
+ (struct { unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; unsigned long long x6; })ratePercentagesWithTxRate:(unsigned long long)arg1 rxRate:(unsigned long long)arg2 txFallbackRate:(unsigned long long)arg3 txFrames:(unsigned long long)arg4 rxFrames:(unsigned long long)arg5 nss:(unsigned long long)arg6 bw:(unsigned long long)arg7 phyMode:(int)arg8 band:(int)arg9 deviceMaxRate:(long long)arg10;
...
+ (void)updateConfig;
+ (unsigned long long)validateRate:(unsigned long long)arg1 frames:(unsigned long long)arg2;
