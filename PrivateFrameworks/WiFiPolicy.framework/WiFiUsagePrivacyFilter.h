...
+ (int)bandFromAppleChannelSpec:(int)arg1;
+ (int)bandFromChanInfo:(id)arg1;
...
+ (unsigned long long)channelWidthAppleChannelSpec:(int)arg1;
...
+ (id)getLabelForPhyModes:(int)arg1;
...
+ (id)getLabelsForNetworkProperties:(id)arg1;
...
+ (id)subBandForBSPAsStringFromChannel:(long long)arg1 andBand:(int)arg2;
