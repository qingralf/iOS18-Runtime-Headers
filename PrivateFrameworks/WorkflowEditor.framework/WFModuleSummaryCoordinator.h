...
- (void)commitParameterState:(id)arg1 forKey:(id)arg2;
- (id)contents;
...
- (void)summaryEditor:(id)arg1 didCommitAuxiliaryParameterState:(id)arg2 forKey:(id)arg3;
...
- (id)templateBuilder;
- (id)templateView;
- (id)transformParameterStateForSerialization:(id)arg1 arrayIndex:(unsigned long long)arg2 parameter:(id)arg3;
