...
- (void)configureViewForRuntimeUIWithParameter:(id)arg1 state:(id)arg2 processing:(bool)arg3 shouldFocus:(bool)arg4 variableProvider:(id)arg5 updateBlock:(id /* block */)arg6;
