...
@property (nonatomic, copy) NSString *overrideLocalizedName;
...
- (void)intentExecutor:(id)arg1 needsAppProtectionUnlockWithCompletionHandler:(id /* block */)arg2;
...
- (void)setOverrideLocalizedName:(id)arg1;
