...
@property (nonatomic, retain) NSString *externalActionIdentifier;
@property (nonatomic, retain) NSString *externalBundleIdentifier;
...
@property (nonatomic, readonly) bool hasExternalActionIdentifier;
@property (nonatomic, readonly) bool hasExternalBundleIdentifier;
