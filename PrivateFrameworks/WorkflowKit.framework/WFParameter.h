...
@interface WFParameter : NSObject {
    ...
    <WFPropertyListObject> * _defaultSerializedRepresentation;
...
@property (nonatomic, readonly, copy) <WFPropertyListObject> *defaultSerializedRepresentation;
@property (nonatomic, readonly) NSSet *defaultSupportedVariableTypes;
@property (nonatomic, readonly, copy) WFParameterDefinition *definition;
...
- (void).cxx_destruct;
- (id)_localizedStringForKey:(id)arg1 context:(id)arg2;
...
- (id)localizedDescriptionWithContext:(id)arg1;
- (id)localizedLabel;
