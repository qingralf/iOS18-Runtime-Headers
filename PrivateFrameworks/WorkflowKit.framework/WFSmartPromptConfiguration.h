...
- (id)initWithOutputContentCollection:(id)arg1 reference:(id)arg2 source:(id)arg3;
- (id)initWithSmartPromptStates:(id)arg1 attributionSet:(id)arg2 previousAttributions:(id)arg3 contentItemCache:(id)arg4 action:(id)arg5 contentDestination:(id)arg6 reference:(id)arg7 workflowName:(id)arg8 source:(id)arg9 isWebpageCoercion:(bool)arg10;
