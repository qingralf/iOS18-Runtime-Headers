...
@property (nonatomic, readonly) WFWorkflowCreationOptions *creationOptions;
...
@property (nonatomic, readonly) unsigned long long storageState;
...
- (bool)createReferenceIfNecessaryWithName:(id)arg1 nameCollisionBehavior:(unsigned long long)arg2 error:(id*)arg3;
...
- (id)initWithCreationOptions:(id)arg1 database:(id)arg2 error:(id*)arg3;
...
- (bool)renameWorkflowTo:(id)arg1 error:(id*)arg2;
...
- (void)setUserProvidedName:(bool)arg1;
...
- (id)source;
- (id)storageProvider;
- (unsigned long long)storageState;
