...
@property (nonatomic, retain) WFAction *lastExecutedAction;
...
- (void)didRunAction:(id)arg1 error:(id)arg2 withCompletion:(id /* block */)arg3;
...
- (void)setLastExecutedAction:(id)arg1;
