/* Generated by RuntimeBrowser
   Image: /System/Library/PrivateFrameworks/WorkoutKitServices.framework/WorkoutKitServices
 */
...
- (void)endActiveWorkoutPlanWithIdentifier:(id)arg1 completion:(id /* block */)arg2;
- (void)handleUninstalledAppIds:(id)arg1 completion:(id /* block */)arg2;
- (void)iconForBundleId:(id)arg1 completion:(id /* block */)arg2;
- (void)openWorkoutAppWithActivityType:(long long)arg1 autostart:(bool)arg2 completion:(id /* block */)arg3;
- (void)openWorkoutAppWithWorkoutCompositionData:(id)arg1 completion:(id /* block */)arg2;
- (void)openWorkoutAppWithWorkoutPlanData:(id)arg1 autostartWorkoutPlan:(bool)arg2 completion:(id /* block */)arg3;
