...
@property (nonatomic, retain) NSString *x_apple_creator_identity;
@property (nonatomic, retain) NSString *x_apple_creator_team_identity;
...
@property (nonatomic, retain) NSString *x_apple_special_day;
...
- (void)setX_apple_creator_identity:(id)arg1;
- (void)setX_apple_creator_team_identity:(id)arg1;
- (void)setX_apple_dontschedule:(bool)arg1;
- (void)setX_apple_ews_busystatus:(int)arg1;
- (void)setX_apple_needs_reply:(bool)arg1;
- (void)setX_apple_special_day:(id)arg1;
...
- (id)x_apple_creator_identity;
- (id)x_apple_creator_team_identity;
