...
@property (nonatomic, retain) ICSDate *x_apple_alternative_due_date_for_calendar;
...
- (void)setX_apple_alternative_due_date_for_calendar:(id)arg1;
- (void)setX_apple_appLinkData:(id)arg1;
- (void)setX_apple_sort_order:(unsigned long long)arg1;
- (bool)validate:(id*)arg1;
- (id)x_apple_activity;
- (id)x_apple_alternative_due_date_for_calendar;
