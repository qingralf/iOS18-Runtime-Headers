...
- (bool)_deleteAppLibrary:(id)arg1 documentsFolder:(id)arg2 error:(id*)arg3;
- (bool)_doesAppLibraryMatchWithItemURL:(id)arg1 appLibraryRowID:(id)arg2;
...
- (id)_locateMatchingItemForTemplateItem:(id)arg1 parentItem:(id)arg2 options:(unsigned long long)arg3 fileURL:(id)arg4 fields:(unsigned long long*)arg5 shouldReject:(bool*)arg6 additionalAttrs:(id)arg7 importBookmark:(id)arg8 ignoreImportBookmark:(bool*)arg9 stillPendingFields:(unsigned long long*)arg10 error:(id*)arg11;
...
- (id)_parseImportBookmark:(id)arg1 templateItem:(id)arg2 fileURL:(id)arg3 ignoreImportBookmark:(bool*)arg4;
...
- (void)_resolveConflictLosersForItem:(id)arg1 localItem:(id)arg2;
- (bool)_shouldRejectItemDeleteDueToEtags:(id)arg1 baseVersion:(id)arg2 error:(id*)arg3;
...
- (bool)deleteItem:(id)arg1 recursively:(bool)arg2 baseVersion:(id)arg3 error:(id*)arg4;
- (id)getOrCreateTrashItemInAppLibrary:(id)arg1 error:(id*)arg2;
- (id)importAppLibraryRootFromTemplateItem:(id)arg1;
- (id)importNewItemAtURL:(id)arg1 parentItem:(id)arg2 templateItem:(id)arg3 fields:(unsigned long long)arg4 options:(unsigned long long)arg5 additionalItemAttributes:(id)arg6 importBookmark:(id)arg7 stillPendingFields:(unsigned long long*)arg8 error:(id*)arg9;
