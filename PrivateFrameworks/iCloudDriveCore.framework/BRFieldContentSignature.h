...
+ (unsigned long long)localEditCounterFromVersionIdentifier:(id)arg1;

- (void).cxx_destruct;
- (id)_initWithVersionIdentifier:(id)arg1 size:(long long)arg2 contentSignature:(id)arg3;
- (id)_initWithVersionIdentifier:(id)arg1 size:(long long)arg2 oldVersionIdentifier:(id)arg3 contentSignature:(id)arg4;
