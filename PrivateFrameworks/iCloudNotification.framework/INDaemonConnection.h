...
- (void).cxx_destruct;
- (void)appLaunchLinkDidPresentForBundleIdentifier:(id)arg1 completion:(id /* block */)arg2;
...
- (void)getCacheDataForLink:(id)arg1 completion:(id /* block */)arg2;
...
- (void)registerDeviceForLoggedOutiCloudNotificationsWithReason:(unsigned long long)arg1 completion:(id /* block */)arg2;
...
- (void)unregisterDeviceFromLoggedOutiCloudNotificationsWithCompletion:(id /* block */)arg1;
