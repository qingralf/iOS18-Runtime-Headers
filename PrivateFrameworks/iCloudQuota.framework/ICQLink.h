...
@property (nonatomic, retain) NSData *serverUIContent;
...
+ (void)performAsyncHTTPPostCallWithURL:(id)arg1 parameters:(id)arg2;
...
- (void)getCachedContentWithCompletion:(id /* block */)arg1;
...
- (void)setServerUIContent:(id)arg1;
