...
@property (nonatomic, retain) NSMutableDictionary *dismissedRecommendations;
...
- (void)appLaunchLinkDidPresentForBundleIdentifier:(id)arg1;
...
- (void)dealloc;
- (bool)didDismissRecommendationForBundleId:(id)arg1;
- (void)dismissRecommendationForBundleId:(id)arg1;
- (id)dismissedRecommendations;
- (bool)fetchOfferIfNeeded;
- (void)forcePostFollowup;
- (void)getDefaultOfferWithCompletion:(id /* block */)arg1;
- (void)getEventOfferWithOptions:(id)arg1 completion:(id /* block */)arg2;
...
- (void)removeCachedOfferForType:(long long)arg1;
- (void)setBuddyOfferEnabled:(bool)arg1;
- (void)setCachedOfferForType:(long long)arg1 daemonOffer:(id)arg2 bundleIdentifier:(id)arg3;
- (void)setCachedOffers:(id)arg1;
- (void)setCachedOffersLock:(id)arg1;
- (void)setDismissedRecommendations:(id)arg1;
...
- (bool)shouldPresentAppLaunchLink:(id)arg1;
...
- (void)_getCachedLinkData:(id)arg1 completion:(id /* block */)arg2;
- (void)fetchAndPresentUpsellForBundleIdentifier:(id)arg1 event:(id)arg2 completion:(id /* block */)arg3;
- (id)flowManager;
