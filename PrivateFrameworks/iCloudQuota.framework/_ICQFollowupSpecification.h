...
@property (nonatomic) bool eventOffer;
...
+ (void)clearFollowupWithController:(id)arg1 offerType:(long long)arg2 completion:(id /* block */)arg3;
+ (void)clearLegacyFollowupWithController:(id)arg1;
+ (void)clearNotificationWithController:(id)arg1 offerType:(long long)arg2 completion:(id /* block */)arg3;
