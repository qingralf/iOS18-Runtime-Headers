...
- (void)_startUpsellWithOffer:(id)arg1 link:(id)arg2 preloadedRemoteUIData:(id)arg3 error:(id)arg4 isPostPurchaseFlow:(bool)arg5;
- (id)_topMostPresentingViewController;
- (void)beginFlowWithViewController:(id)arg1;
- (void)beginPostPurchaseFlowWithOffer:(id)arg1 link:(id)arg2;
- (id)delegate;
- (id)flowManager;
- (id)flowOptions;
- (id)init;
