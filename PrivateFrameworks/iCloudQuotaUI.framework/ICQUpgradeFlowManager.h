...
@interface ICQUpgradeFlowManager : NSObject <ICQLiftUIPresenterDelegate, ICQPageDelegate, ICQServerHookDelegate, ICQUIOSLOPresenterDelegate, ICQUIRemoteUIPresenterDelegate, RUIServerHookDelegate, RemoteUIControllerDelegate, UINavigationControllerDelegate> {
    ...
    ICQOffer * _offer;
    ICQUIOSLOPresenter * _osloPresenter;
...
@property (nonatomic, retain) ICQUIOSLOPresenter *osloPresenter;
...
- (void)_configurePresentingViewController:(id)arg1 andPresentedViewController:(id)arg2;
...
- (void)_presentRemoteViewWithData:(id)arg1 andRequest:(id)arg2;
...
- (void)beginJourney;
- (void)beginOSLOFlowWithPresentingViewController:(id)arg1;
- (void)beginPostPurchaseFlowWithLink:(id)arg1 offer:(id)arg2;
...
- (void)purchaseFlowCompletedWith:(bool)arg1 error:(id)arg2;
