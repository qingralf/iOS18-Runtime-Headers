...
@interface ICSBackupViewController : PSListController <AAUISpecifierProviderDelegate, BYClientDaemonCloudSyncProtocol, ICQUpgradeFlowManagerDelegate, MBManagerDelegate> {
    ACAccount * _account;
...
- (id)_buildBackupSpecifiersWithTip:(id)arg1;
- (id)_buildHeaderCardSpecifier;
- (void)_checkSupportForManualAndAutoBackupOnCellularWithCompletion:(id /* block */)arg1;
