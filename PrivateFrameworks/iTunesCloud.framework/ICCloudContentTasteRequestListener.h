...
- (void)setContentTaste:(long long)arg1 forAlbumStoreID:(long long)arg2 persistentID:(long long)arg3 timeStamp:(id)arg4 configuration:(id)arg5 withCompletionHandler:(id /* block */)arg6;
...
- (void)setContentTaste:(long long)arg1 forArtistStoreID:(long long)arg2 persistentID:(long long)arg3 timeStamp:(id)arg4 configuration:(id)arg5 withCompletionHandler:(id /* block */)arg6;
...
- (void)setContentTaste:(long long)arg1 forMediaItem:(long long)arg2 storeIdentifier:(long long)arg3 persistentID:(long long)arg4 timeStamp:(id)arg5 configuration:(id)arg6 withCompletionHandler:(id /* block */)arg7;
...
- (void)setContentTaste:(long long)arg1 forPlaylistGlobalID:(id)arg2 persistentID:(long long)arg3 timeStamp:(id)arg4 configuration:(id)arg5 withCompletionHandler:(id /* block */)arg6;
