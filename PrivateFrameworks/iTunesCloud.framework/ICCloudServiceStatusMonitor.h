...
- (void)_requestCapabilitiesWithPrivacyPromptPolicy:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)requestCapabilitiesWithPrivacyPromptPolicy:(long long)arg1 completionHandler:(id /* block */)arg2;
