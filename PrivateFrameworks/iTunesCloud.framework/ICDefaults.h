...
@property (nonatomic, copy) NSDictionary *accountNotificationsNewMusicDictionary;
...
@property (nonatomic, copy) NSDictionary *cachedHomeProperties;
...
@property (nonatomic, readonly) ICAuthServiceClientTokenProviderDebugConfiguration *debugFetchConfiguration;
@property (nonatomic, readonly) ICAuthServiceClientTokenProviderDebugConfiguration *debugRefreshConfiguration;
...
@property (nonatomic, copy) NSArray *prefetchKeyIdentifiers;
@property (nonatomic, readonly) bool presetsFound;
...
@property (nonatomic, readonly) bool shouldForceServerToUseDAAPDebugFeature;
@property (nonatomic, readonly) bool shouldForceServerToUseDAAPDebugFeatureAlwaysBackoff;
@property (nonatomic, readonly) bool shouldForceServerToUseDAAPDebugFeatureAlwaysPerformResetSync;
@property (nonatomic, readonly) bool shouldForceSilentAuthentications;
@property (nonatomic) bool shouldForceStreamingOnlyKeysForPlayback;
@property (nonatomic, readonly) bool shouldForceWatchInitialSyncCompletion;
...
- (id)accountNotificationsNewMusicDictionary;
- (id)accountNotificationsShowInLibraryDictionary;
- (void)addDebugConfiguration:(id)arg1;
...
- (id)debugFetchConfiguration;
- (id)debugRefreshConfiguration;
...
- (void)setAccountNotificationsNewMusicDictionary:(id)arg1;
...
- (void)setCachedHomeProperties:(id)arg1;
...
- (void)setCachedU18MinorAccountStatus:(bool)arg1;
...
- (void)setPrefetchKeyIdentifiers:(id)arg1;
