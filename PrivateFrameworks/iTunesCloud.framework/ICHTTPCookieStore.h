...
- (bool)_saveCookies:(id)arg1 userIdentifier:(id)arg2;
- (void)dealloc;
...
- (bool)removeCookiesWithProperties:(id)arg1;
- (bool)saveCookies:(id)arg1 forURL:(id)arg2;
- (bool)saveCookies:(id)arg1 forURL:(id)arg2 userIdentifier:(id)arg3;
- (bool)saveGlobalAccountCookies:(id)arg1 forURL:(id)arg2;
