...
- (struct DevicePresetTokenResult { id x1; id x2; bool x3; })_checkTokenPresetsForDSID:(id)arg1 forceRefresh:(bool)arg2;
- (id)_clientConnection;
- (void)_commitCache;
- (struct DevicePresetTokenResult { id x1; id x2; bool x3; })_devicePresetForConfiguration:(id)arg1 withDSID:(id)arg2;
- (void)_handleLibraryAuthServiceClientTokenDidChangeDistributedNotification:(id)arg1;
- (void)_handleUserIdentityStoreDidChangeNotification:(id)arg1;
- (bool)_isPrivacyAcknowledgementRequiredForAccountDSID:(id)arg1;
- (void)_loadCache;
