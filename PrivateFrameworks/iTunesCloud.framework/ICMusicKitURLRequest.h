...
- (void)_buildStoreURLRequestWithUpdatedDomains:(id)arg1 completionHandler:(id /* block */)arg2;
- (id)_buildStoreURLRequestWithUpdatedDomains:(id)arg1 withBag:(id)arg2;
