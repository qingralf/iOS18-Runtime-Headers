...
@property (getter=isAutoRenewEnabled, nonatomic) bool autoRenewEnabled;
...
@property (getter=isInFreePeriod, nonatomic) bool inFreePeriod;
@property (getter=isInFreeTrial, nonatomic) bool inFreeTrial;
@property (nonatomic, copy) NSDate *initialPurchaseTimestamp;
...
@property (nonatomic, copy) NSDate *serviceBeginsTimestamp;
@property (nonatomic, copy) NSString *sessionIdentifier;
@property (nonatomic) long long sourceType;
@property (nonatomic) long long statusCode;
@property (nonatomic) long long statusType;
@property (nonatomic, copy) NSDate *studentExpirationDate;
@property (nonatomic, copy) NSString *studentVerificationId;
@property (nonatomic, copy) NSString *studentVerifier;
...
- (void)setInFreePeriod:(bool)arg1;
...
- (void)setServiceBeginsTimestamp:(id)arg1;
- (void)setSessionIdentifier:(id)arg1;
- (void)setSourceType:(long long)arg1;
- (void)setStatusCode:(long long)arg1;
- (void)setStatusType:(long long)arg1;
- (void)setStudentExpirationDate:(id)arg1;
- (void)setStudentVerificationId:(id)arg1;
- (void)setStudentVerifier:(id)arg1;
