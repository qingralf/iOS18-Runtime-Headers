...
@property (getter=isCollaborativePlaylist, nonatomic) bool collaborativePlaylist;
...
- (void)setCollaborativePlaylist:(bool)arg1;
...
- (void)setSharedActivityType:(long long)arg1;
