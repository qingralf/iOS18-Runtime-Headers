...
@property (getter=isCollaborativePlaylist, nonatomic, readonly) bool collaborativePlaylist;
...
@property (nonatomic, readonly) long long sharedActivityType;
