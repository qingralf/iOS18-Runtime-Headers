...
@property (nonatomic, readonly) unsigned long long requestBytesSent;
...
@property (nonatomic, readonly) unsigned long long responseBytesReceived;
...
- (unsigned long long)responseBytesReceived;
- (id)responseDate;
