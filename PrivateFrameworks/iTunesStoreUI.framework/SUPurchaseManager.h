...
@interface SUPurchaseManager : NSObject <SSDownloadManagerObserver, SSEventMonitorDelegate, SSPurchaseRequestDelegate, SSPurchaseRequestDelegatePrivate, SUContinuationDelegate> {
