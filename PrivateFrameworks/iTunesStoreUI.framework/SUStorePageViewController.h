...
@interface SUStorePageViewController : SUViewController <ISURLOperationDelegate, SUMenuViewControllerDelegate, SUPreviewOverlayContainer, SUUITabBarItemRootViewController, UIPopoverControllerDelegate> {
...
- (void)_logInternalEventWithOperation:(id)arg1;
