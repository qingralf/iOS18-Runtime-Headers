...
@interface CNVCardParser : NSObject {
    ...
    <_TtP5vCard25CNVCardTagInclusionPolicy_> * _tagInclusionPolicy;
    NSString * _uid;
...
@property (nonatomic, readonly) <_TtP5vCard25CNVCardTagInclusionPolicy_> *tagInclusionPolicy;

+ (unsigned long long)countOfCardsInData:(id)arg1;
+ (unsigned long long)inferredStringEncodingFromData:(id)arg1;
+ (bool)isTagSyntacticallyValid:(id)arg1;
