...
- (void)sendMessage:(id)arg1 category:(unsigned int)arg2 type:(unsigned short)arg3 reporter:(long long)arg4;
...
- (void)startReporter:(long long)arg1;
- (void)stopReporter:(long long)arg1;
