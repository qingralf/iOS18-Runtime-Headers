...
@interface FPMemoryObject : NSObject <FPMemoryObject> {
    unsigned int  _accurateSizes;
    unsigned long long  _cleanSize;
    unsigned long long  _dirtySize;
    unsigned int  _hasProcessViewForSingleTotalRegions;
    unsigned int  _isProcessViewForSingleTotalRegions;
...
@property (nonatomic, readonly) unsigned int totalRegions;
