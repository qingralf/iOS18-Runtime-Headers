...
@property (nonatomic, readonly) bool doOwnedAccountingAdjustments;
@property (nonatomic, readonly) unsigned long long physFootprint;
@property (nonatomic, readonly) unsigned int task;

+ (unsigned int)_dirtyFlagsFromEntryState:(unsigned int)arg1;
...
- (id)extendedInfoForRegionType:(int)arg1 at:(unsigned long long)arg2 extendedInfoProvider:(id)arg3;
- (void)gatherData:(unsigned long long)arg1 extendedInfoProvider:(id)arg2;
