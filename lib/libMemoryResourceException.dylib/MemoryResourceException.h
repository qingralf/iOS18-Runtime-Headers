...
- (void).cxx_destruct;
- (void)_generateMemgraphWithContentLevel:(unsigned int)arg1 timeoutSecs:(unsigned long long)arg2 memgraphFailedReasonOut:(unsigned long long*)arg3;
- (void)_populateAddtionalMetadataWithOptions:(unsigned long long)arg1 timeoutSecs:(unsigned long long)arg2;
...
- (id)osVersion;
- (int)pid;
- (void)populateAdditionalMetadataWithDiagnostics:(bool)arg1;
- (int)ppid;
...
- (void)setGcoreCapture:(bool)arg1;
- (void)setGcoreFilePath:(id)arg1;
- (void)setIsMSLEnabled:(bool)arg1;
- (void)setLiteDiagFilePath:(id)arg1;
