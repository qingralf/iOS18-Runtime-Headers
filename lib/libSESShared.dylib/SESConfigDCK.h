...
- (id)boolValueForSetting:(unsigned long long)arg1 manufacturer:(id)arg2 brand:(id)arg3 uuid:(id)arg4 error:(id*)arg5;
...
- (id)getSettingForKey:(id)arg1 error:(id*)arg2;
...
- (id)intValueForSetting:(unsigned long long)arg1 manufacturer:(id)arg2 brand:(id)arg3 uuid:(id)arg4 error:(id*)arg5;
