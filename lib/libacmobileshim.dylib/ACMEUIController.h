...
@property (readonly) UIView *managerApprovalDialogSummaryView; /* unknown property attribute: ? */
...
@property (readonly) unsigned long long signInDialogContentStyle; /* unknown property attribute: ? */
