...
@interface NetworkQualityResult : NSObject <NSCopying, NSSecureCoding> {
    ...
    NSString * _latencyMeasurementServiceType;
    NSString * _loadGeneratingNetworkServiceType;
    NSString * _osVersion;
    NSDictionary * _otherValues;
    NSDictionary * _protocolNames;
    bool  _proxied;
...
- (bool)isCellular;
- (id)latency;
- (id)latencyMeasurementServiceType;
- (id)loadGeneratingNetworkServiceType;
...
- (void)setLatencyMeasurementServiceType:(id)arg1;
- (void)setLoadGeneratingNetworkServiceType:(id)arg1;
- (void)setOsVersion:(id)arg1;
- (void)setOtherValues:(id)arg1;
- (void)setProtocolNames:(id)arg1;
