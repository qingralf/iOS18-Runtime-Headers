...
+ (void)postAnalyticsATLFailureEvent:(unsigned short)arg1 aid:(id)arg2 error:(id)arg3;
+ (void)postAnalyticsAppletProvisioningFailureEvent:(unsigned short)arg1 responseCode:(unsigned short)arg2;
...
+ (void)postAnalyticsContactlessErrorsEvent:(unsigned short)arg1 status:(unsigned short)arg2 error:(id)arg3;
+ (void)postAnalyticsExpressSetupFailureEvent:(unsigned short)arg1 context:(unsigned short)arg2 error:(id)arg3;
...
+ (void)postAnalyticsSEFailureEvent:(unsigned short)arg1 context:(id)arg2 error:(id)arg3;
...
+ (void)postHardwareExceptionEventWithAssertionCounter:(unsigned int)arg1 hardwareType:(unsigned int)arg2 wdogDump:(unsigned int*)arg3 hwFltDump:(unsigned int*)arg4 wdgTickInfo:(unsigned int*)arg5 assertionData:(id)arg6;
+ (void)postMiddlewareExceptionEvent:(unsigned int)arg1 mwVersion:(unsigned int)arg2 errorType:(unsigned int)arg3 errorCode:(unsigned int)arg4 breadcrumb:(unsigned long long)arg5 description:(id)arg6;
