...
@interface NFServiceWhitelistChecker : NSObject <NSCopying> {
    ...
    NSMutableOrderedSet * _nfcCardSessionAIDPrefixList;
    bool  _nfcCardSessionAccess;
    ...
    bool  _seCredentialManagerAccess;
...
@property (nonatomic, readonly) NSOrderedSet *nfcCardSessionAIDPrefixList;
@property (nonatomic, readonly) bool nfcCardSessionAccess;
...
@property (nonatomic, readonly) bool seCredentialManagerAccess;
...
- (void)_initCardSessionEntitlementsWithSecTask:(struct __SecTask { }*)arg1;
...
- (id)nfcCardSessionAIDPrefixList;
