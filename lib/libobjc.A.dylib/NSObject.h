...
@property (setter=_ui_setObservationTrackingDictionary:, nonatomic, retain) id _ui_observationTrackingDictionary;
...
@property (nonatomic, copy) id /* block */ accessibilityExpandedStatusBlock;
...
@property (nonatomic, retain) NSString *browserAccessibilityCurrentStatus;
@property (nonatomic) bool browserAccessibilityHasDOMFocus;
@property (nonatomic) bool browserAccessibilityIsRequired;
@property (nonatomic) long long browserAccessibilityPressedState;
@property (nonatomic, retain) NSString *browserAccessibilityRoleDescription;
@property (nonatomic, retain) NSString *browserAccessibilitySortDirection;
...
@property (nonatomic, readonly) bool ic_isDeallocating;
...
@property (nonatomic, readonly) long long musicKit_assetAdamID;
...
@property (nonatomic, readonly, copy) NSString *musicKit_cloudAlbumLibraryID;
@property (nonatomic, readonly) long long musicKit_cloudID;
@property (nonatomic, readonly) NSString *musicKit_commandDialogAction_localizedTitle;
@property (nonatomic, readonly) long long musicKit_commandDialogAction_type;
@property (nonatomic, readonly) NSArray *musicKit_commandDialog_actions;
@property (nonatomic, readonly, copy) NSString *musicKit_commandDialog_localizedMessage;
@property (nonatomic, readonly, copy) NSString *musicKit_commandDialog_localizedTitle;
@property (nonatomic, readonly) <MusicKit_SoftLinking_MPCPlayerCommandDialog> *musicKit_commandStatus_dialog;
@property (nonatomic, readonly) NSError *musicKit_commandStatus_error;
@property (nonatomic, readonly) long long musicKit_commandStatus_type;
@property (nonatomic, readonly, copy) MusicKit_SoftLinking_DeviceLocalID *musicKit_containedDeviceLocalID;
...
@property (nonatomic, readonly, copy) NSArray *musicKit_formerIDs;
@property (nonatomic, readonly) long long musicKit_globalItemCount;
...
@property (nonatomic, readonly, copy) MusicKit_SoftLinking_MPModelKind *musicKit_modelKind;
...
@property (nonatomic, readonly, copy) NSString *musicKit_occurrenceID;
...
@property (nonatomic, readonly) long long musicKit_purchasedAdamID;
@property (nonatomic, readonly) long long musicKit_reportingAdamID;
...
@property (nonatomic, readonly) long long musicKit_syncID;
...
@property (setter=_swiftui_setAccessibilityLabel:, nonatomic, copy) NSString *swiftui_accessibilityLabel;
...
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })accessibilityLineRangeForPosition:(long long)arg1;
- (long long)accessibilityLineStartPositionFromCurrentSelection;
- (id)browserAccessibilityAttributedValueInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
- (unsigned long long)browserAccessibilityContainerType;
- (id)browserAccessibilityCurrentStatus;
- (void)browserAccessibilityDeleteTextAtCursor:(long long)arg1;
- (bool)browserAccessibilityHasDOMFocus;
- (void)browserAccessibilityInsertTextAtCursor:(id)arg1;
- (bool)browserAccessibilityIsRequired;
- (long long)browserAccessibilityPressedState;
- (id)browserAccessibilityRoleDescription;
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })browserAccessibilitySelectedTextRange;
- (void)browserAccessibilitySetSelectedTextRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
- (id)browserAccessibilitySortDirection;
- (id)browserAccessibilityValueInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
- (void)setBrowserAccessibilityContainerType:(unsigned long long)arg1;
- (void)setBrowserAccessibilityCurrentStatus:(id)arg1;
- (void)setBrowserAccessibilityHasDOMFocus:(bool)arg1;
- (void)setBrowserAccessibilityIsRequired:(bool)arg1;
- (void)setBrowserAccessibilityPressedState:(long long)arg1;
- (void)setBrowserAccessibilityRoleDescription:(id)arg1;
- (void)setBrowserAccessibilitySortDirection:(id)arg1;
...
- (void)setSharedObservers:(id)arg1;
...
- (id)musicKit_artworkCatalogWithFittingSize:(struct CGSize { double x1; double x2; })arg1;
...
+ (id)stk_loggingDescriptionFromLoggable:(id)arg1 isPretty:(bool)arg2;
...
- (void)_swiftui_setAccessibilityLabel:(id)arg1;
- (id /* block */)accessibilitySwiftUIDefaultActionStoredBlock;
- (id)accessibilitySwiftUIStoredLinkRotor;
...
- (void)swiftui_addRenderedSubview:(id)arg1 positioned:(long long)arg2 relativeTo:(id)arg3;
...
+ (id)ITK_loggingDescriptionFromLoggable:(id)arg1 isPretty:(bool)arg2;
...
- (id)_mf_lockOrderingForType:(long long)arg1;
...
- (struct { double x1; double x2; double x3; double x4; double x5; float x6; float x7; bool x8; bool x9; bool x10; })_durationSnapshot;
...
- (id)musicKit_insertItemsCommand_insertAtEndOfUpNextCommandRequestWithPlaybackIntent:(id)arg1;
- (id)musicKit_insertWithPlaybackIntent:(id)arg1;
- (id)musicKit_playerPath;
- (id)musicKit_playerPath_bundleID;
- (bool)musicKit_playerPath_hasNonLocalEndpointRoute;
...
+ (void)px_swizzleOnceAsSubclassOfClass:(Class)arg1 context:(const void*)arg2 usingBlock:(id /* block */)arg3;
...
+ (id)pf_secureDecodedFromData:(id)arg1 classReplacementMap:(id)arg2;
+ (id)pf_secureDecodedFromData:(id)arg1 ofClasses:(id)arg2 classReplacementMap:(id)arg3;
...
- (id)inputNamed:(id)arg1;
- (id)outputNamed:(id)arg1;
...
- (bool)_accessibilityActivateTextViewLink:(id)arg1;
- (float)_accessibilityActivationDelay;
- (id)_accessibilityActiveKeyboard;
- (id)_accessibilityActiveURL;
- (void)_accessibilityAddAutoCorrectionAttributes:(id)arg1;
...
- (id)_accessibilityConvertMathExpression:(id)arg1;
...
- (void)_accessibilityInsertTextAtCursor:(id)arg1;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })_accessibilityKeyboardFrame;
...
- (id)_accessibilityNextOpaqueElementsForTechnology:(id)arg1 startElement:(id)arg2 direction:(long long)arg3 searchType:(long long)arg4 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg5 shouldScrollToVisible:(bool)arg6 honorsGroups:(bool)arg7;
...
- (void)_accessibilityPostValueChangedNotificationWithChangeType:(struct __CFString { }*)arg1 insertedText:(id)arg2 keyInputDelegate:(id)arg3;
- (void)_accessibilityPostValueChangedNotificationWithInsertedText:(id)arg1;
- (void)_accessibilityPostValueChangedNotificationWithInsertedText:(id)arg1 keyInputDelegate:(id)arg2;
...
- (id)_accessibilityProcessMathExpression:(id)arg1;
...
- (id)_processMathChildrenExpressions:(id)arg1;
- (id)_processMathMultiscriptExpressions:(id)arg1;
...
- (void)_setAccessibilityShouldUseViewHierarchyForFindingScrollParent:(bool)arg1;
...
- (unsigned long long)beaxContainerTypeFromUIKitContainerType:(unsigned long long)arg1;
...
- (void)_textEffects_sourceCanGenerateTargetedPreviewForChunk:(id)arg1 completion:(id /* block */)arg2;
- (void)_textEffects_sourceCanGenerateTargetedPreviewsWithCompletion:(id /* block */)arg1;
- (void)_textEffects_updatedTargetedPreviewGeometryForChunk:(id)arg1 previous:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 completion:(id /* block */)arg3;
...
- (id)accessibilityHitTest:(struct CGPoint { double x1; double x2; })arg1 withEvent:(id)arg2;
...
- (void)setAccessibilityExpandedStatus:(long long)arg1;
- (void)setAccessibilityExpandedStatusBlock:(id /* block */)arg1;
...
- (void)setAccessibilityNextTextNavigationElement:(id)arg1;
- (void)setAccessibilityNextTextNavigationElementBlock:(id /* block */)arg1;
...
- (void)setAccessibilityPreviousTextNavigationElement:(id)arg1;
- (void)setAccessibilityPreviousTextNavigationElementBlock:(id /* block */)arg1;
...
- (void)setAccessibilityTextInputResponder:(id)arg1;
- (void)setAccessibilityTextInputResponderBlock:(id /* block */)arg1;
...
- (id)VFX_setupDisplayLinkWithQueue:(id)arg1 screen:(id)arg2 policy:(unsigned long long)arg3;
