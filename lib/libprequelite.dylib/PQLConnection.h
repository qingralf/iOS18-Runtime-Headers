...
@property (nonatomic, copy) id /* block */ profilingHookV2;
...
- (bool)_executeStmt:(id)arg1 mustSucceed:(bool)arg2 preparationTime:(unsigned long long)arg3;
- (void)_fireFlushNotifications;
- (bool)_fullSync;
- (bool)_incrementalVacuum:(unsigned long long)arg1;
- (id)_newStatementForBuilder:(id /* block */)arg1 preparationTime:(unsigned long long*)arg2;
- (id)_newStatementForFormat:(id)arg1 preparationTime:(unsigned long long*)arg2 arguments:(char *)arg3;
...
- (void)setProfilingHookV2:(id /* block */)arg1;
...
- (bool)br_isTableExists:(id)arg1;
- (void)br_makeNextFlushCheckpoint;
- (id)dataWithSQL:(id)arg1;
...
- (void)setAutoRollbackHandlerForSwift:(id /* block */)arg1;
