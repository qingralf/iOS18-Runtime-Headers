...
- (id)initWithNativeEncoder:(struct unique_ptr<webrtc::VideoEncoder, std::default_delete<webrtc::VideoEncoder>> { struct __compressed_pair<webrtc::VideoEncoder *, std::default_delete<webrtc::VideoEncoder>> { struct VideoEncoder {} *x_1_1_1; } x1; })arg1;
- (long long)releaseEncoder;
- (struct unique_ptr<webrtc::VideoEncoder, std::default_delete<webrtc::VideoEncoder>> { struct __compressed_pair<webrtc::VideoEncoder *, std::default_delete<webrtc::VideoEncoder>> { struct VideoEncoder {} *x_1_1_1; } x1; })releaseWrappedEncoder;
- (id)scalingSettings;
