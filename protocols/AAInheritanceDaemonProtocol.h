...
- (void)setupBeneficiaryManifest:(void *)arg1 contactInfo:(void *)arg2 setupAuthToken:(void *)arg3 completion:(void *)arg4; // needs 4 arg types, found 10: AKBeneficiaryManifest *, <AAInheritanceContactInfo> *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, AABeneficiary *, NSError *, void*
