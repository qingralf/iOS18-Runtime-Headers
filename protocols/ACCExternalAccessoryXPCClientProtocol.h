...
- (void)enqueueLocationNMEASentence:(NSString *)arg1 forUUID:(NSString *)arg2 withTimestamps:(NSArray *)arg3;
...
- (void)handleIncomingNotification:(NSString *)arg1 withPayload:(NSDictionary *)arg2 aboutAccessory:(NSDictionary *)arg3;
