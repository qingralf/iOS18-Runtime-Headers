...
- (void)siriRemoteViewController:(AFUISiriRemoteSceneViewController *)arg1 inputTypeDidChange:(long long)arg2;
...
- (void)siriRemoteViewController:(AFUISiriRemoteSceneViewController *)arg1 willChangeKeyboardVisibility:(bool)arg2;
