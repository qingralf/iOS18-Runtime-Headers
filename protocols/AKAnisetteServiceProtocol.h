...
- (void)fetchAttestationDataForRequestData:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 8: AKAttestationRequestData *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, AKAttestationData *, NSError *, void*
- (void)fetchPeerAttestationDataForRequest:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 8: NSURLRequest *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, AKAttestationData *, NSError *, void*
- (void)resetDeviceIdentityWithCompletion:(void *)arg1; // needs 1 arg types, found 6: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
