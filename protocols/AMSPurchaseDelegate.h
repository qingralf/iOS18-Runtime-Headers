...
- (void)purchase:(void *)arg1 handlePaymentSheetRequest:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 9: AMSPurchase *, AMSPaymentSheetRequest *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, AMSPaymentSheetResult *, NSError *, void*
