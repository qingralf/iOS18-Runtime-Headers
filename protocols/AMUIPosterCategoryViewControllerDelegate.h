...
- (void)posterCategoryViewController:(AMUIPosterCategoryViewController *)arg1 didSetBiometricAuthenticationDisabled:(bool)arg2;
...
- (bool)posterCategoryViewController:(AMUIPosterCategoryViewController *)arg1 wantsBiometricAuthenticationBlockedForDeepUserInteraction:(bool)arg2;
