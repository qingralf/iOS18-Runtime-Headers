...
- (void)presentExportFlowWithData:(void *)arg1 forProcess:(void *)arg2 windowSceneIdentifier:(void *)arg3 completionHandler:(void *)arg4; // needs 4 arg types, found 9: NSData *, BSProcessHandle *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
- (void)presentPINEntryInterface;
- (void)setDelegate:(id <ASCAuthorizationPresenterDelegate>)arg1;
