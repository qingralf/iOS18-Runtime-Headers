...
- (void)handleAlertPresentationRequest:(void *)arg1 resultHandler:(void *)arg2; // needs 2 arg types, found 8: ASDAlertPresentationRequest *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, ASDAlertPresentationResult *, NSError *, void*
