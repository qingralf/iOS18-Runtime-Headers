...
- (NSString *)buildType;
- (bool)canDevicePerformAppAction:(NSString *)arg1 appCapabilities:(NSArray *)arg2;
- (bool)canDevicePerformAppAction:(NSString *)arg1 withAppCapabilities:(NSArray *)arg2;
