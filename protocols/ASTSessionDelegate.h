...
- (void)session:(ASTSession *)arg1 didReceiveResultForTest:(NSNumber *)arg2;
- (void)session:(void *)arg1 didRequestInstructionalPrompt:(void *)arg2 withConfirmation:(void *)arg3; // needs 3 arg types, found 9: ASTSession *, ASTInstructionalPrompt *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSNumber *, NSString *, void*
- (void)session:(void *)arg1 didRequestSuiteRunWithDestinations:(void *)arg2 confirmation:(void *)arg3; // needs 3 arg types, found 8: ASTSession *, NSArray *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, long long, void*
