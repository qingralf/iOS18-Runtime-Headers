...
- (struct tuple<int, id<NSSecureCoding>> { struct __tuple_impl<std::__tuple_indices<0, 1>, int, id<NSSecureCoding>> { int x_1_1_1; id x_1_1_2; } x1; })getMXSessionProperty:(NSString *)arg1 forSessionID:(unsigned int)arg2;
...
- (NSDictionary *)getSessionsWithMicrophoneInjectionPreference;
- (struct tuple<int, audit_token_t> { struct __tuple_impl<std::__tuple_indices<0, 1>, int, audit_token_t> { int x_1_1_1; struct { unsigned int x_2_2_1[8]; } x_1_1_2; } x1; })getSourceProcessAuditToken:(unsigned int)arg1;
...
- (int)setMXSessionProperty:(NSString *)arg1 forSessionID:(unsigned int)arg2 value:(id <NSSecureCoding>)arg3;
- (int)setMicrophoneInjectionCapability:(bool)arg1;
