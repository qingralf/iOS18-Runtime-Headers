...
- (void)performHapticFeedbackForUUID:(void *)arg1 withHapticType:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 8: NSString *, NSNumber *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
...
- (void)setDelegate:(id <AVOutputDeviceDelegate>)arg1;
- (void)setDisplayCornerMasks:(NSDictionary *)arg1;
...
- (void)setMediaRemoteData:(void *)arg1 completionHandler:(void *)arg2; // needs 2 arg types, found 7: NSData *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
...
- (void)suggestUIWithURLs:(void *)arg1 completionHandler:(void *)arg2; // needs 2 arg types, found 7: NSArray *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
