...
- (void)getClearedInfoWithCompletion:(void *)arg1; // needs 1 arg types, found 7: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, id, NSError *, void*
...
- (void)withdrawBulletinWithPublisherBulletinID:(NSString *)arg1 shouldSync:(bool)arg2;
