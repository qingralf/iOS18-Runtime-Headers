...
- (void)hostEnvironment:(id <BLSHBacklightSceneHostEnvironment>)arg1 hostDidSet1HzFlipbook:(bool)arg2;
- (void)hostEnvironment:(id <BLSHBacklightSceneHostEnvironment>)arg1 hostDidSetAlwaysOnEnabledForEnvironment:(bool)arg2;
- (void)hostEnvironment:(id <BLSHBacklightSceneHostEnvironment>)arg1 hostDidSetCacheFlipbookOnDisplayWake:(bool)arg2;
