...
- (<BLSHSystemActivityAsserting> *)createSystemActivityAssertionWithIdentifier:(void *)arg1 configurator:(void *)arg2; // needs 2 arg types, found 7: NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, <SWSystemActivityAssertionConfiguring> *, void*
