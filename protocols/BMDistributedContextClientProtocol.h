...
- (bool)registerForUpdates:(BMDSL *)arg1 withIdentifier:(NSString *)arg2 forUseCase:(NSString *)arg3 withOptions:(unsigned long long)arg4 forDeviceTypes:(long long)arg5 withError:(id*)arg6;
- (bool)registerForUpdates:(BMDSL *)arg1 withIdentifier:(NSString *)arg2 forUseCase:(NSString *)arg3 withOptions:(unsigned long long)arg4 forDevices:(NSArray *)arg5 withError:(id*)arg6;
