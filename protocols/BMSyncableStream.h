...
- (BMBookmarkablePublisher *)publisherForDevice:(BMDevice *)arg1 withUseCase:(NSString *)arg2;
- (BMBookmarkablePublisher *)publisherForDevice:(BMDevice *)arg1 withUseCase:(NSString *)arg2 options:(BMPublisherOptions *)arg3;
