...
- (void)morphFromPresentable:(id <BNPresentable>)arg1 toPresentable:(id <BNPresentable>)arg2 withOptions:(unsigned long long)arg3 userInfo:(NSDictionary *)arg4 stateChange:(bool)arg5;
