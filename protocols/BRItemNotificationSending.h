...
- (void)watchItemWithFileObjectID:(void *)arg1 options:(void *)arg2 request:(void *)arg3 gatherReply:(void *)arg4; // needs 4 arg types, found 9: BRFileObjectID *, unsigned short, NSFileProviderRequest *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
