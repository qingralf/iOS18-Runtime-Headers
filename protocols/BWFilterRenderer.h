...
- (int)prepareForRenderingWithParameters:(id <BWFilterRendererParameters>)arg1 inputVideoFormat:(BWVideoFormat *)arg2 inputMediaPropertiesByAttachedMediaKey:(NSDictionary *)arg3;
