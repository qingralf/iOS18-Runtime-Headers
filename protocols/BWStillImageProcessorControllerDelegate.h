...
- (struct __CVBuffer { }*)processorController:(BWStillImageProcessorController *)arg1 newOutputPixelBufferForProcessorInput:(BWStillImageProcessorControllerInput *)arg2 type:(unsigned long long)arg3 attachedMediaKey:(NSString *)arg4 pixelFormat:(unsigned int)arg5 dimensions:(struct { int x1; int x2; })arg6;
...
- (struct { int x1; int x2; })processorController:(BWStillImageProcessorController *)arg1 outputPixelBufferDimensionsForProcessorInput:(BWStillImageProcessorControllerInput *)arg2 type:(unsigned long long)arg3 attachedMediaKey:(NSString *)arg4;
