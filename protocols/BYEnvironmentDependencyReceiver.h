...
- (void)setBuddyBackgroundViewController:(BuddyBackgroundViewController *)arg1;
...
- (void)setExpressSettingsCache:(id <BYExpressSettingsSetupCache>)arg1;
...
- (void)setIntelligenceProvider:(id <IntelligenceProvider>)arg1;
...
- (void)setMultilingualFlowManager:(id <BuddyMultilingualFlowManager>)arg1;
...
- (void)setPasscodeCacheManager:(BYPasscodeCacheManager *)arg1;
