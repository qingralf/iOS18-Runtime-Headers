...
- (<UIFocusItemContainer> *)browserControllerFocusItemContainer:(BrowserController *)arg1;
...
- (<UIFocusEnvironment> *)browserControllerParentFocusEnvironment:(BrowserController *)arg1;
- (NSArray *)browserControllerPreferredFocusEnvironments:(BrowserController *)arg1;
...
- (<TabSnapshotGeneratorDelegate> *)tabSnapshotGeneratorDelegateForBrowserController:(BrowserController *)arg1;
...
- (void)browserController:(BrowserController *)arg1 didConnectToScene:(UIWindowScene *)arg2 session:(UISceneSession *)arg3 options:(UISceneConnectionOptions *)arg4;
...
- (void)browserController:(BrowserController *)arg1 overrideDownloadQuickLookPreview:(_SFDownload *)arg2 isContentManaged:(bool)arg3;
...
- (void)browserControllerWillCreateBackgroundTab:(BrowserController *)arg1;
