...
- (bool)cameraConnectionIsSpatialCapture:(CCCameraConnection *)arg1;
...
- (bool)cameraConnectionPauseCapture:(CCCameraConnection *)arg1;
- (bool)cameraConnectionResumeCapture:(CCCameraConnection *)arg1;
