...
- (void)remoteSecretValidator:(void *)arg1 attemptCircleJoinWithPiggybackingContext:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 9: CDPDRemoteDeviceSecretValidator *, CDPContext *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, NSError *, void*
