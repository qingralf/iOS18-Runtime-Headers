...
- (void)appendMediaPayloadToText:(CKBrowserItemPayload *)arg1;
...
- (void)generatePreviewAndStoreInCacheForSendingPhotoFromPayload:(CKBrowserItemPayload *)arg1;
...
- (void)requestTransitionPluginFromFullScreen:(NSString *)arg1 toExpanded:(bool)arg2;
