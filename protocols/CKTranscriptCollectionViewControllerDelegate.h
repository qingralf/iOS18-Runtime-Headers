...
- (CKMessagePartChatItem *)currentlyFocusedChatItemForTapbackInTranscriptCollectionViewController:(CKViewController<CKCoreTranscriptControllerProtocol> *)arg1;
...
- (void)transcriptCollectionViewController:(CKViewController<CKCoreTranscriptControllerProtocol> *)arg1 didTapAttributionButtonForChatItem:(CKMessageStatusChatItem *)arg2 parentIndexPath:(NSIndexPath *)arg3 sender:(id)arg4;
...
- (void)transcriptCollectionViewController:(CKViewController<CKCoreTranscriptControllerProtocol> *)arg1 shouldScrollToHighlightedMessage:(CKTranscriptHighlightedMessageScrollContext *)arg2;
...
- (void)transcriptCollectionViewController:(CKViewController<CKCoreTranscriptControllerProtocol> *)arg1 viewedCommSafetyAssociatedItemsWithIndexPath:(NSIndexPath *)arg2;
...
- (void)transcriptCollectionViewControllerDidChangeAssociatedChatItem:(CKViewController<CKCoreTranscriptControllerProtocol> *)arg1 chatItemDiff:(CKChatItemDiff *)arg2;
...
- (void)transcriptCollectionViewControllerDidSetChatItems:(CKViewController<CKCoreTranscriptControllerProtocol> *)arg1;
...
- (bool)transcriptCollectionViewControllerShouldScrollToBottomForLocalSentMessage:(CKViewController<CKCoreTranscriptControllerProtocol> *)arg1;
...
- (long long)transcriptCollectionViewControllerWantsCurrentDesiredIntent:(CKViewController<CKCoreTranscriptControllerProtocol> *)arg1;
- (void)transcriptCollectionViewControllerWillBeginFullscreenEffectAnimationForOutgoingMessage:(CKViewController<CKCoreTranscriptControllerProtocol> *)arg1;
...
- (void)viewDidLayoutSubviewsForTranscriptCollectionViewController:(CKViewController<CKCoreTranscriptControllerProtocol> *)arg1;

@optional

- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })effectiveVisibleRectOfCollectionViewForTranscriptCollectionViewController:(CKViewController<CKCoreTranscriptControllerProtocol> *)arg1;
- (NSString *)firstUnreadMessageItemGUIDForTranscriptCollectionViewController:(CKViewController<CKCoreTranscriptControllerProtocol> *)arg1;
- (void)launchAppFromExtensionWith:(CKViewController<CKCoreTranscriptControllerProtocol> *)arg1;
- (NSArray *)transcriptCollectionViewController:(CKViewController<CKCoreTranscriptControllerProtocol> *)arg1 accessoriesForContextMenuWithConfiguration:(UIContextMenuConfiguration *)arg2;
...
- (void)transcriptCollectionViewController:(CKViewController<CKCoreTranscriptControllerProtocol> *)arg1 didRemoveChatItems:(NSIndexSet *)arg2 associatedChatItems:(NSIndexSet *)arg3;
...
- (void)transcriptCollectionViewController:(CKViewController<CKCoreTranscriptControllerProtocol> *)arg1 scrolledToRichCard:(IMRichCard *)arg2;
- (void)transcriptCollectionViewController:(CKViewController<CKCoreTranscriptControllerProtocol> *)arg1 selectedChipAction:(IMChipAction *)arg2;
- (void)transcriptCollectionViewController:(CKViewController<CKCoreTranscriptControllerProtocol> *)arg1 selectedSuggestedReply:(IMChipReply *)arg2 messageGUID:(NSString *)arg3;
...
- (void)transcriptCollectionViewControllerDidUpdateTranscriptChatItems:(CKViewController<CKCoreTranscriptControllerProtocol> *)arg1;
...
- (void)transcriptCollectionViewControllerWillUpdateTranscriptChatItems:(CKViewController<CKCoreTranscriptControllerProtocol> *)arg1;
