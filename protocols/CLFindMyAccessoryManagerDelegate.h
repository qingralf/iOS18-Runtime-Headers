...
- (void)findMyAccessoryManager:(CLFindMyAccessoryManager *)arg1 didFetchAISAccessoryCapabilities:(NSData *)arg2 fromDevice:(NSUUID *)arg3 error:(NSError *)arg4;
- (void)findMyAccessoryManager:(CLFindMyAccessoryManager *)arg1 didFetchAISAccessoryCategory:(unsigned char)arg2 fromDevice:(NSUUID *)arg3 error:(NSError *)arg4;
- (void)findMyAccessoryManager:(CLFindMyAccessoryManager *)arg1 didFetchAISBatteryLevel:(unsigned char)arg2 fromDevice:(NSUUID *)arg3 error:(NSError *)arg4;
- (void)findMyAccessoryManager:(CLFindMyAccessoryManager *)arg1 didFetchAISBatteryType:(unsigned char)arg2 fromDevice:(NSUUID *)arg3 error:(NSError *)arg4;
- (void)findMyAccessoryManager:(CLFindMyAccessoryManager *)arg1 didFetchAISFirmwareVersion:(NSData *)arg2 fromDevice:(NSUUID *)arg3 error:(NSError *)arg4;
- (void)findMyAccessoryManager:(CLFindMyAccessoryManager *)arg1 didFetchAISManufacturerName:(NSString *)arg2 fromDevice:(NSUUID *)arg3 error:(NSError *)arg4;
- (void)findMyAccessoryManager:(CLFindMyAccessoryManager *)arg1 didFetchAISModelName:(NSString *)arg2 fromDevice:(NSUUID *)arg3 error:(NSError *)arg4;
- (void)findMyAccessoryManager:(CLFindMyAccessoryManager *)arg1 didFetchAISNetworkID:(unsigned char)arg2 fromDevice:(NSUUID *)arg3 error:(NSError *)arg4;
- (void)findMyAccessoryManager:(CLFindMyAccessoryManager *)arg1 didFetchAISProductData:(NSData *)arg2 fromDevice:(NSUUID *)arg3 error:(NSError *)arg4;
- (void)findMyAccessoryManager:(CLFindMyAccessoryManager *)arg1 didFetchAISProtocolImplementation:(unsigned int)arg2 fromDevice:(NSUUID *)arg3 error:(NSError *)arg4;
- (void)findMyAccessoryManager:(CLFindMyAccessoryManager *)arg1 didFetchAISSerialNumber:(NSData *)arg2 fromDevice:(NSUUID *)arg3 error:(NSError *)arg4;
