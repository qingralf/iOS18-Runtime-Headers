...
- (void)addPredictionObservable:(void *)arg1 doOnTimeout:(void *)arg2; // needs 2 arg types, found 6: CNObservable *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, void*
