...
- (void)headerView:(CNContactHeaderView *)arg1 didRequestToBlockContact:(bool)arg2;
- (void)headerView:(CNContactHeaderView *)arg1 didUpdateSensitiveContentOverride:(bool)arg2;
...
- (bool)headerViewShouldCacheContactBackgroundColor:(CNContactHeaderView *)arg1;
- (bool)isHeaderViewContactBlocked:(CNContactHeaderView *)arg1;
