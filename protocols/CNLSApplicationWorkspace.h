...
- (NSArray *)applicationsAvailableForDefaultAppCategory:(unsigned long long)arg1;
- (NSArray *)applicationsAvailableForHandlingURLScheme:(NSString *)arg1;
- (NSArray *)applicationsForUserActivityType:(NSString *)arg1;
- (CNApplicationProxy *)defaultApplicationForDefaultAppCategory:(unsigned long long)arg1;
