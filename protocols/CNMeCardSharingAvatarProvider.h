...
- (void)generatePosterAnimationControllerWithWindowScene:(void *)arg1 imageHandler:(void *)arg2; // needs 2 arg types, found 8: UIWindowScene *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, _TtC10ContactsUI49CNPosterOnboardingSettingsAnimationViewController *, NSError *, void*
