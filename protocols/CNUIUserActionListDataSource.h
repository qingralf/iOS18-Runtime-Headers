...
- (void)registerDelegate:(id <CNUIUserActionListDataSourceDelegate>)arg1 withContactIdentifier:(NSString *)arg2;
...
- (bool)tracksChanges;
- (void)unregisterDelegate:(id <CNUIUserActionListDataSourceDelegate>)arg1;
