...
- (void)nowPlayingViewControllerAttributionButtonTapped:(CPUINowPlayingViewController *)arg1;
...
- (bool)nowPlayingViewControllerShouldHideBackButton:(CPUINowPlayingViewController *)arg1;
- (bool)nowPlayingViewControllerShouldOverrideRightBarButtons:(CPUINowPlayingViewController *)arg1;
