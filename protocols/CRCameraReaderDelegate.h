...
- (NSArray *)cameraReader:(CRCameraReader *)arg1 auxiliaryIDCornerDetection:(struct __CVBuffer { }*)arg2;
...
- (bool)cameraReader:(CRCameraReader *)arg1 shouldReturnIDImage:(CRCameraReaderOutputIDCard *)arg2;
