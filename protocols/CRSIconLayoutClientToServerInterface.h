...
- (void)fetchApplicationIconInformationForBundleIdentifier:(void *)arg1 vehicleID:(void *)arg2 drawBorder:(void *)arg3 completion:(void *)arg4; // needs 4 arg types, found 10: NSString *, NSString *, NSNumber *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, CRSApplicationIcon *, NSError *, void*
