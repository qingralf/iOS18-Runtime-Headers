...
- (void)resetForNewRequestWithSampleRate:(unsigned long long)arg1 recordContext:(CSAudioRecordContext *)arg2 disableRCSelection:(bool)arg3;
...
- (void)processASRFeatures:(CSASRFeatures *)arg1 fromServer:(bool)arg2;
