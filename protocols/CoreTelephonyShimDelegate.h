...
- (void)carrierBundleSISWiFiOutrankPolicyChangedForSubscription:(NSDictionary *)arg1;
...
- (void)networkSlicingActiveChangedTo:(bool)arg1 forSliceIndex:(unsigned long long)arg2;
- (void)nonTerrestrialNetworkActiveChangedTo:(bool)arg1;
...
- (void)stewieActiveChangedTo:(bool)arg1;
