...
- (void)getPreTrackRequestForInvitationWithIdentifier:(void *)arg1 completionHandler:(void *)arg2; // needs 2 arg types, found 8: NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, DAAlishaKeyEncryptedRequest *, NSError *, void*
...
- (void)ppidRequestForInvitationWithIdentifier:(void *)arg1 completionHandler:(void *)arg2; // needs 2 arg types, found 8: NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, DAAlishaKeyEncryptedRequest *, NSError *, void*
...
- (void)setProductPlanIdentifier:(void *)arg1 forInvitationIdentifier:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 8: DAAlishaKeyEncryptedRequest *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
