...
- (void)annotatedAttachmentsForParameters:(void *)arg1 withHandler:(void *)arg2; // needs 2 arg types, found 7: NSDictionary *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, DEAnnotatedGroup *, void*
