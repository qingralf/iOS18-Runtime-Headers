...
- (void)ensureNetworkConnectionWithCompletionHandler:(void *)arg1; // needs 1 arg types, found 6: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
- (void)fetchEnrollmentProfileWithWebAuthURL:(void *)arg1 machineInfo:(void *)arg2 anchorCertificateRefs:(void *)arg3 completionHandler:(void *)arg4; // needs 4 arg types, found 11: NSURL *, NSData *, NSArray *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSData *, bool, NSError *, void*
...
- (void)requestMDMUsernameAndPasswordWithCompletionHandler:(void *)arg1; // needs 1 arg types, found 8: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSString *, NSString *, bool, void*
...
- (void)requestSoftwareUpdateWithOSVersion:(void *)arg1 buildVersion:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 8: NSString *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
- (void)requestUserConsentWithCloudConfig:(void *)arg1 completionHandler:(void *)arg2; // needs 2 arg types, found 7: NSDictionary *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, void*
