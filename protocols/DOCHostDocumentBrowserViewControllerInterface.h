...
- (void)_didDenyCreateDocumentSessionWithError:(NSError *)arg1;
...
- (void)_didTriggerBarButtonWithUUID:(NSUUID *)arg1 overflowAction:(bool)arg2;
...
- (void)performBrowserStateChange:(DOCUIPBrowserState *)arg1;
