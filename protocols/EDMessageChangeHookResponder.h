...
- (void)persistenceDidAddNewMessages:(NSDictionary *)arg1;
...
- (void)persistenceDidUpdateAuthenticationStateForMessages:(NSArray *)arg1;
...
- (void)persistenceWillUpdateAuthenticationStateForMessages:(NSArray *)arg1;
