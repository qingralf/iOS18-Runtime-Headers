...
- (NSArray *)domainsToRemoveForSearchableIndex:(EDSearchableIndex *)arg1;
- (long long)indexingTypeForSearchableIndex:(EDSearchableIndex *)arg1 item:(id <EDIndexableItem>)arg2;
- (NSArray *)itemsToIndexForSearchableIndex:(EDSearchableIndex *)arg1 excludingIdentifiers:(NSArray *)arg2 count:(unsigned long long)arg3 cancelationToken:(EFCancelationToken *)arg4;
- (NSArray *)itemsToRemoveForSearchableIndex:(EDSearchableIndex *)arg1;
...
- (void)searchableIndex:(EDSearchableIndex *)arg1 indexGeneratedSummaries:(NSArray *)arg2;
