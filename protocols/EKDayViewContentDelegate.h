...
- (void)dayViewContent:(EKDayViewContent *)arg1 didSelectEvent:(EKEvent *)arg2 userInitiated:(bool)arg3 dateSelected:(EKCalendarDate *)arg4;
- (void)dayViewContent:(EKDayViewContent *)arg1 didSelectEvents:(NSArray *)arg2 userInitiated:(bool)arg3;
...
- (bool)dayViewContentShouldAnnotateAppEntities:(EKDayViewContent *)arg1 onDayStarting:(EKCalendarDate *)arg2;
