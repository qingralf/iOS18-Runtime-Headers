...
- (void)dayView:(EKDayView *)arg1 didSelectEvents:(NSArray *)arg2 userInitiated:(bool)arg3;
...
- (bool)dayViewShouldAnnotateAppEntities:(EKDayView *)arg1 onDayStarting:(EKCalendarDate *)arg2;
