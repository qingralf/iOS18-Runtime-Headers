...
- (bool)interaction:(EKUIRightClickEmptySpaceInteraction *)arg1 canCreateReminderAtPoint:(struct CGPoint { double x1; double x2; })arg2 inView:(UIView *)arg3;
...
- (void)interaction:(EKUIRightClickEmptySpaceInteraction *)arg1 createReminderAtPoint:(struct CGPoint { double x1; double x2; })arg2 inView:(UIView *)arg3;
