...
- (void)sortedEmojis:(void *)arg1 keyword:(void *)arg2 localeIdentifier:(void *)arg3 handler:(void *)arg4; // needs 4 arg types, found 9: NSArray *, NSString *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSArray *, void*
