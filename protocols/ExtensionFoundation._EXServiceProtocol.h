...
@protocol ExtensionFoundation._EXServiceProtocol
...
- (void)extensionsWith:(void *)arg1 reply:(void *)arg2; // needs 2 arg types, found 8: _EXQuery *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, _EXQueryResult *, NSError *, void*
