...
- (byref oneway void)sceneID:(void *)arg1 didUpdateClientSettingsWithDiff:(void *)arg2 transitionContext:(void *)arg3 completion:(void *)arg4; // needs 4 arg types, found 9: FBSSceneIdentity *, FBSSceneClientSettingsDiff *, FBSSceneTransitionContext *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
