...
- (void)dumpStateTo:(void *)arg1 options:(void *)arg2 request:(void *)arg3 completionHandler:(void *)arg4; // needs 4 arg types, found 9: FPCTLTermDumper *, unsigned long long, FPDRequest *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
...
- (NSProgress *)evictItemAtURL:(void *)arg1 evictionReason:(void *)arg2 request:(void *)arg3 completionHandler:(void *)arg4; // needs 4 arg types, found 10: NSURL *, unsigned int, FPDRequest *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, FPItemID *, NSError *, void*
- (void)evictItemWithID:(void *)arg1 evictionReason:(void *)arg2 request:(void *)arg3 completionHandler:(void *)arg4; // needs 4 arg types, found 9: FPItemID *, unsigned int, FPDRequest *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
...
- (bool)isProviderForRealPathURL:(NSURL *)arg1;
- (void)itemChangedAtURL:(NSURL *)arg1 request:(FPDRequest *)arg2;
- (void)itemForItemID:(void *)arg1 creatingPlaceholderIfMissing:(void *)arg2 ignoreAlternateContentsURL:(void *)arg3 request:(void *)arg4 completionHandler:(void *)arg5; // needs 5 arg types, found 11: FPItemID *, bool, bool, FPDRequest *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, FPItem *, NSError *, void*
...
- (void)launchFeedbackForDomain:(void *)arg1 itemIdentifier:(void *)arg2 triggeringError:(void *)arg3 completionHandler:(void *)arg4; // needs 4 arg types, found 9: FPDDomain *, NSString *, NSError *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
- (void)listRemoteVersionsOfItemAtURL:(void *)arg1 includeCachedVersions:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 10: NSURL *, bool, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, FPItem *, NSArray *, NSError *, void*
...
- (void)reimportItemsBelowItemWithID:(void *)arg1 markItemDataless:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 8: FPItemID *, bool, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
- (void)reindexAllItemsWithDropReason:(void *)arg1 completionHandler:(void *)arg2; // needs 2 arg types, found 7: unsigned long long, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
- (void)reindexItemsWithIndexReason:(void *)arg1 identifiers:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 8: long long, NSArray *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
...
- (NSArray *)rootURLs;
- (NSArray *)rootURLsWithTransientState:(bool*)arg1;
- (void)saveFPCKTelemetryReport:(void *)arg1 completionHandler:(void *)arg2; // needs 2 arg types, found 7: NSDictionary *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
...
- (bool)startWithReason:(NSString *)arg1 userAllowedDBDrop:(bool)arg2 error:(id*)arg3;
...
- (void)triggerFeedbackApprovalRequestForItemURL:(void *)arg1 domain:(void *)arg2 uiOnly:(void *)arg3 completionHandler:(void *)arg4; // needs 4 arg types, found 9: NSURL *, FPDDomain *, bool, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, void*
...
- (void)didChangeItemID:(void *)arg1 completionHandler:(void *)arg2; // needs 2 arg types, found 6: FPItemID *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, void*
...
- (void)disableDBQueryStatisticsWithCompletionHandler:(void *)arg1; // needs 1 arg types, found 6: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
...
- (void)fetchLatestVersionForURL:(void *)arg1 request:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 10: NSURL *, FPDRequest *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSString *, FPSandboxingURLWrapper *, NSError *, void*
- (void)fetchTelemetryReportWithCompletionHandler:(void *)arg1; // needs 1 arg types, found 7: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSDictionary *, NSError *, void*
...
- (void)getDBQueryStatisticsWithQueryPlan:(void *)arg1 completionHandler:(void *)arg2; // needs 2 arg types, found 8: bool, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSDictionary *, NSError *, void*
...
- (void)getKnownFolderLocations:(void *)arg1 request:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 9: unsigned long long, FPDRequest *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSFileProviderKnownFolderLocations *, NSError *, void*
...
- (void)importProgressForItemsPendingReconciliationWithCompletionHandler:(void *)arg1; // needs 1 arg types, found 7: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, FPImportProgressReport *, NSError *, void*
- (void)importProgressForItemsPendingScanningDiskWithCompletionHandler:(void *)arg1; // needs 1 arg types, found 7: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, FPImportProgressReport *, NSError *, void*
- (void)importProgressForItemsPendingScanningProviderWithCompletionHandler:(void *)arg1; // needs 1 arg types, found 7: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, FPImportProgressReport *, NSError *, void*
...
- (void)pauseSyncForItemAtURL:(void *)arg1 bundleID:(void *)arg2 behavior:(void *)arg3 request:(void *)arg4 completionHandler:(void *)arg5; // needs 5 arg types, found 11: NSURL *, NSString *, unsigned long long, FPDRequest *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, FPItemID *, NSError *, void*
...
- (void)resetDBQueryStatisticsWithCompletionHandler:(void *)arg1; // needs 1 arg types, found 6: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
- (void)resumeSyncForItemAtURL:(void *)arg1 bundleID:(void *)arg2 behavior:(void *)arg3 request:(void *)arg4 completionHandler:(void *)arg5; // needs 5 arg types, found 11: NSURL *, NSString *, unsigned long long, FPDRequest *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, FPItemID *, NSError *, void*
