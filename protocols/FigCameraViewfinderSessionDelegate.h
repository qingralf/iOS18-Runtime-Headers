...
- (void)cameraViewfinderSessionDidFinishMovieRecording:(FigCameraViewfinderSession *)arg1;
- (void)cameraViewfinderSessionDidStartMovieRecording:(FigCameraViewfinderSession *)arg1;
