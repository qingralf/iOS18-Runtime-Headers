...
- (void)captureSessionDidFinishMovieRecording:(long long)arg1;
- (void)captureSessionDidReconfigureWhileRunning:(FigCaptureSessionProxy *)arg1;
- (void)captureSessionDidStart:(FigCaptureSessionProxy *)arg1;
- (void)captureSessionDidStartMovieRecording:(long long)arg1;
- (void)captureSessionDidStop:(long long)arg1;
- (void)captureSessionWillStart:(FigCaptureSessionProxy *)arg1;
