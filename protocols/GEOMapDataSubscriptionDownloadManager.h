...
- (void)forceUpdateForUserInitiatedSubscriptionsForDataType:(unsigned long long)arg1 mode:(unsigned long long)arg2 auditToken:(GEOApplicationAuditToken *)arg3;
- (void)setDelegate:(id <GEOMapDataSubscriptionDownloadManagerDelegate>)arg1;
- (void)startDownloadForSubscriptionIdentifiers:(NSArray *)arg1 mode:(unsigned long long)arg2 auditToken:(GEOApplicationAuditToken *)arg3;
...
- (void)runAutomaticOfflineDataUpdateBackgroundTask:(BGSystemTask *)arg1;
- (void)runRetryOfflineDownloadBackgroundTask:(BGSystemTask *)arg1;
