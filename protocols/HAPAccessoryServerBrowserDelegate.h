...
- (void)accessoryServerBrowser:(void *)arg1 getCachedOperationalCertificateDataForFabricID:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 8: HAPAccessoryServerBrowser *, NSNumber *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, HMMTRCachedFabricCertificateData *, void*
...
- (void)accessoryServerBrowser:(HAPAccessoryServerBrowser *)arg1 getLockedState:(bool*)arg2;
...
- (bool)supportsCommissioningCertificateRetrievalForHomeUUID:(NSUUID *)arg1;
