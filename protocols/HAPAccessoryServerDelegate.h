...
- (void)accessoryServer:(HAPAccessoryServer *)arg1 didUpdateConnectionState:(bool)arg2 linkLayerType:(long long)arg3 bookkeeping:(HAPAccessoryServerBookkeeping *)arg4 withError:(NSError *)arg5;
