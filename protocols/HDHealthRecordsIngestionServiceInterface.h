...
- (void)remote_triggerDownloadIssuerRegistryWithOptions:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 9: unsigned long long, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSArray *, NSNumber *, NSError *, void*
- (void)remote_triggerDownloadPublicKeysWithOptions:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 9: unsigned long long, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSArray *, NSNumber *, NSError *, void*
