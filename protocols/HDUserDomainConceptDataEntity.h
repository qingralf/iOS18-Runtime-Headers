...
+ (bool)willDeleteUserDomainConcept:(HKUserDomainConcept *)arg1 userDomainConceptID:(long long)arg2 syncProvenance:(long long)arg3 profile:(HDProfile *)arg4 transaction:(HDDatabaseTransaction *)arg5 error:(id*)arg6;
