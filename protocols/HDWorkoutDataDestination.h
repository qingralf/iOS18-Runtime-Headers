...
- (void)addMetadataToWorkoutActivity:(NSDictionary *)arg1 withSampleStartDate:(NSDate *)arg2 dataSource:(id <HDWorkoutDataSource>)arg3;
- (void)didDisconnectFromRemoteWithError:(NSError *)arg1;
- (void)didReceiveDataFromRemoteWorkoutSession:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 8: NSArray *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, NSError *, void*
