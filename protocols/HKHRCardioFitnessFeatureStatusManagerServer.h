...
- (void)remote_notificationStatusWithCompletion:(void *)arg1; // needs 1 arg types, found 7: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, HKHRCardioFitnessNotificationStatus *, NSError *, void*
- (void)remote_onboardingStatusWithCompletion:(void *)arg1; // needs 1 arg types, found 7: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, HKHRCardioFitnessOnboardingStatus *, NSError *, void*
