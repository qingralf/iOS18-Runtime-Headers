...
- (void)client:(void *)arg1 fetchWithFilters:(void *)arg2 isMultiHop:(void *)arg3 completion:(void *)arg4; // needs 4 arg types, found 11: HMEMessageDatagramClient *, NSArray *, bool, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSUUID *, NSDictionary *, NSError *, void*
...
- (NSUUID *)client:(void *)arg1 sendConnectWithAddedFilters:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 10: HMEMessageDatagramClient *, NSArray *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSUUID *, NSDictionary *, NSError *, void*
