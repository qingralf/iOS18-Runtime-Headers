...
- (void)home:(HMHome *)arg1 didUpdateDismissedWalletKeyUWBUnlockOnboarding:(bool)arg2;
...
- (void)home:(HMHome *)arg1 didUpdateSupportsResidentActionSetStateEvaluation:(bool)arg2;
