...
+ (void)shouldShowBetaEnrollmentButtonForHomeID:(void *)arg1 homeKitIdentifiers:(void *)arg2 withCompletion:(void *)arg3; // needs 3 arg types, found 9: NSUUID *, NSSet *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, NSError *, void*
