...
- (bool)styleSelectorSelectionHasBlockQuote:(ICStyleSelectorViewController *)arg1;
- (bool)styleSelectorShouldDisableTextStyles:(ICStyleSelectorViewController *)arg1;
- (bool)styleSelectorShouldUseCompactTopInset:(ICStyleSelectorViewController *)arg1;
