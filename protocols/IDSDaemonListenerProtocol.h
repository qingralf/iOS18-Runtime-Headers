...
- (void)IDQueryCompletedWithFromURI:(NSString *)arg1 idStatusUpdates:(NSData *)arg2 service:(NSString *)arg3 success:(bool)arg4 error:(NSError *)arg5;
...
- (void)didCancelMessageWithSuccess:(bool)arg1 onAccount:(NSString *)arg2 error:(NSError *)arg3 identifier:(NSString *)arg4;
...
- (void)emptyXPCReply;
- (void)finishedProvisioningPseudonym:(IDSPseudonym *)arg1 success:(bool)arg2 error:(NSError *)arg3 forRequestUUID:(NSString *)arg4;
- (void)finishedRenewingPseudonym:(IDSPseudonym *)arg1 success:(bool)arg2 error:(NSError *)arg3 requestUUID:(NSString *)arg4;
- (void)finishedReportingRequestUUID:(NSString *)arg1 withError:(NSError *)arg2;
- (void)finishedRevokingPseudonymWithSuccess:(bool)arg1 error:(NSError *)arg2 requestUUID:(NSString *)arg3;
- (void)finishedSigningForRequest:(NSString *)arg1 signedData:(NSData *)arg2 error:(NSError *)arg3;
- (void)finishedVerifyingSignedDataForRequest:(NSString *)arg1 success:(bool)arg2 error:(NSError *)arg3;
...
- (void)session:(NSString *)arg1 didReceiveActiveLightweightParticipants:(NSArray *)arg2 success:(bool)arg3;
- (void)session:(NSString *)arg1 didReceiveActiveParticipants:(NSArray *)arg2 success:(bool)arg3;
- (void)session:(NSString *)arg1 didReceiveBlockedParticipantIDs:(NSArray *)arg2 withCode:(unsigned int)arg3 withType:(unsigned short)arg4 isTruncated:(bool)arg5;
...
- (void)session:(NSString *)arg1 didReceiveQueryBlockedParticipantIDs:(NSArray *)arg2 withCode:(unsigned int)arg3 isTruncated:(bool)arg4;
...
- (void)session:(NSString *)arg1 didRemoveParticipantIDs:(NSArray *)arg2 withCode:(unsigned int)arg3 isTruncated:(bool)arg4;
