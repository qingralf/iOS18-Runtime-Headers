...
- (void)reportiMessageUnknownSender:(NSString *)arg1 messageID:(NSString *)arg2 isBlackholed:(bool)arg3 isJunked:(bool)arg4 messageServerTimestamp:(NSNumber *)arg5 toURI:(NSString *)arg6;
...
- (void)setForceTCPFallbackOnCellUsingReinitiate:(bool)arg1 forSessionWithUniqueID:(NSString *)arg2;
- (void)setForceTCPFallbackOnWiFiUsingReinitiate:(bool)arg1 forSessionWithUniqueID:(NSString *)arg2;
...
- (void)updateMembers:(NSArray *)arg1 forGroup:(NSString *)arg2 sessionID:(NSString *)arg3 withContext:(NSData *)arg4 messagingCapabilities:(IDSMessagingCapabilities *)arg5 triggeredLocally:(bool)arg6 lightweightStatusDict:(NSDictionary *)arg7;
...
- (void)updateParticipantType:(unsigned short)arg1 forGroup:(NSString *)arg2 sessionID:(NSString *)arg3 members:(NSArray *)arg4 triggeredLocally:(bool)arg5 withContext:(NSData *)arg6 lightweightStatusDict:(NSDictionary *)arg7;
