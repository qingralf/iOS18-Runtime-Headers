...
- (void)groupSessionDidConnectUnderlyingLinks:(IDSGroupSession *)arg1;
- (void)groupSessionDidDisconnectUnderlyingLinks:(IDSGroupSession *)arg1;
- (void)groupSessionDidInitialize:(IDSGroupSession *)arg1 error:(NSError *)arg2;
...
- (void)session:(IDSGroupSession *)arg1 didReceiveJoinedParticipantID:(unsigned long long)arg2 withContext:(NSData *)arg3;
- (void)session:(IDSGroupSession *)arg1 didReceiveLeftParticipantID:(unsigned long long)arg2 withContext:(NSData *)arg3;
...
- (void)sessionDidReceiveRemoteParticipantUpgrade:(IDSGroupSession *)arg1 remoteParticipantID:(NSNumber *)arg2 participantType:(unsigned short)arg3 error:(NSError *)arg4;
