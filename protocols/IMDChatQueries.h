...
- (NSArray *)chatRecordsWithHandles:(NSArray *)arg1 serviceName:(NSString *)arg2 displayName:(NSString *)arg3 groupID:(NSString *)arg4 style:(unsigned char)arg5 useOriginalGroupID:(bool)arg6;
- (NSArray *)chatRecordsWithIdentifier:(NSString *)arg1;
- (NSArray *)copyDuplicateGroupChatRecordsWithLimit:(long long)arg1;
