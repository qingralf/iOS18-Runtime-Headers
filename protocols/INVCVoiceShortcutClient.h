...
- (void)loadDataWithItemProviderRequestMetadata:(void *)arg1 type:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 9: WFItemProviderRequestMetadata *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSData *, NSError *, void*
- (void)loadFileURLWithItemProviderRequestMetadata:(void *)arg1 type:(void *)arg2 openInPlace:(void *)arg3 completion:(void *)arg4; // needs 4 arg types, found 11: WFItemProviderRequestMetadata *, NSString *, bool, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSSecurityScopedURLWrapper *, bool, NSError *, void*
