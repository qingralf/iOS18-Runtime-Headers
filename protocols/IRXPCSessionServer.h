...
- (void)_addEvent:(IREvent *)arg1 forCandidate:(IRCandidate *)arg2;
...
- (void)_invalidate;
- (void)_requestCurrentContextWithBundleID:(NSString *)arg1;
- (void)_runWithConfiguration:(IRConfiguration *)arg1;
- (void)_setSpotOnLocationWithParameters:(IRSessionSpotOnLocationParameters *)arg1;
