...
- (void)evaluateRequest:(void *)arg1 uiDelegate:(void *)arg2 originator:(void *)arg3 reply:(void *)arg4; // needs 4 arg types, found 10: EvaluationRequest *, <LAUIDelegate> *, <LAOriginatorProt> *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSDictionary *, NSError *, void*
