...
- (void)executor:(void *)arg1 needsAppProtectionUnlockWithCompletionHandler:(void *)arg2; // needs 2 arg types, found 7: LNActionExecutor *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, void*
...
- (bool)executor:(LNActionExecutor *)arg1 shouldOpenActionURL:(LNAction *)arg2;
