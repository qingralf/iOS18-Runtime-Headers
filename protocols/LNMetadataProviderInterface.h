...
- (NSArray *)actionIdentifiersForBundleIdentifier:(NSString *)arg1 error:(id*)arg2;
...
- (NSArray *)bundleRegistrationsWithError:(id*)arg1;
...
- (NSArray *)entityIdentifiersForBundleIdentifier:(NSString *)arg1 error:(id*)arg2;
- (NSArray *)enumsForBundleIdentifier:(NSString *)arg1 error:(id*)arg2;
- (NSDictionary *)enumsWithError:(id*)arg1;
- (NSArray *)examplePhrasesForBundleIdentifier:(NSString *)arg1 error:(id*)arg2;
