...
- (void)manager:(MBManager *)arg1 didUpdateProgress:(float)arg2 estimatedTimeRemaining:(unsigned long long)arg3 bytesRemaining:(long long)arg4 state:(NSString *)arg5;
...
- (void)managerDidFinishScan:(MBManager *)arg1 bytesUsed:(unsigned long long)arg2;
