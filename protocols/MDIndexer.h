...
- (void)deleteAllInteractionsWithBundleID:(void *)arg1 fromClient:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 8: NSString *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
- (void)deleteAllSearchableItemsWithBundleID:(void *)arg1 fromClient:(void *)arg2 protectionClass:(void *)arg3 shouldGC:(void *)arg4 completionHandler:(void *)arg5; // needs 5 arg types, found 10: NSString *, NSString *, NSString *, bool, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
- (void)deleteAllUserActivities:(void *)arg1 fromClient:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 8: NSString *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
- (void)deleteSearchableItemsWithDomainIdentifiers:(void *)arg1 protectionClass:(void *)arg2 forBundleID:(void *)arg3 fromClient:(void *)arg4 options:(void *)arg5 completionHandler:(void *)arg6; // needs 6 arg types, found 11: NSArray *, NSString *, NSString *, NSString *, long long, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
...
- (void)rewriteFirstPassQueryWithQueryString:(NSString *)arg1 context:(CSSearchQueryContext *)arg2 trimmedSearchStringTokens:(NSArray *)arg3 populateDateSynonyms:(bool)arg4;
- (void)rewriteQueryWithQueryString:(void *)arg1 context:(void *)arg2 matchInfo:(void *)arg3 rewriteHandler:(void *)arg4; // needs 4 arg types, found 10: NSString *, CSSearchQueryContext *, NSDictionary *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSArray *, NSError *, void*
...
- (void)transferDeleteJournalsForProtectionClass:(void *)arg1 toDirectory:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 8: NSString *, int, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
