...
- (void)activeFormatDidChangeFor:(id <MFQueuePlayerItem>)arg1;
...
- (void)pauseForSleepTimerWithFadeOut:(void *)arg1 identifier:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 9: double, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSString *, NSError *, void*
