...
- (void)effectiveRateDidChangeTo:(float)arg1 forItem:(id <MFQueuePlayerItem>)arg2 timeStamp:(id <MFTimeStamp>)arg3;
...
- (void)itemIsReadyForMetrics:(id <MFQueuePlayerItem>)arg1 accessLog:(AVPlayerItemAccessLog *)arg2;
...
- (void)mediaServicesPurgeDidOccurWithTimeStamp:(id <MFTimeStamp>)arg1;
- (void)overlappedPlaybackDidEndFrom:(id <MFQueuePlayerItem>)arg1 to:(id <MFQueuePlayerItem>)arg2 transitionTime:(id <MFOverlappingTransitionTime>)arg3 transitionType:(long long)arg4 timeStamp:(id <MFTimeStamp>)arg5;
- (void)overlappedPlaybackWillBeginFrom:(id <MFQueuePlayerItem>)arg1 to:(id <MFQueuePlayerItem>)arg2 transitionTime:(id <MFOverlappingTransitionTime>)arg3 transitionType:(long long)arg4 timeStamp:(id <MFTimeStamp>)arg5;
...
- (void)renderingModeDidChange:(long long)arg1 timeStamp:(id <MFTimeStamp>)arg2;
...
- (void)stackControllerDidCancelTransitionFrom:(id <MFQueuePlayerItem>)arg1 to:(id <MFQueuePlayerItem>)arg2 type:(long long)arg3 reason:(NSError *)arg4;
