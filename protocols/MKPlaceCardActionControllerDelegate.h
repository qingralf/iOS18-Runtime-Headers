...
- (void)placeActionManager:(id <MKPlaceActionManagerProtocol>)arg1 didSelectAddOrEditNoteWithEnvironment:(MKPlaceActionEnvironment *)arg2 selectedAdd:(bool)arg3;
- (void)placeActionManager:(id <MKPlaceActionManagerProtocol>)arg1 didSelectAddOrRemoveFromLibraryWithEnvironment:(MKPlaceActionEnvironment *)arg2 selectedAdd:(bool)arg3;
...
- (void)placeCardActionControllerDidSelectCreateCustomRoute:(MKPlaceCardActionsViewController *)arg1;
