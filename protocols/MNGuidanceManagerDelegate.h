...
- (void)guidanceManager:(void *)arg1 announce:(void *)arg2 isImportant:(void *)arg3 shortPromptType:(void *)arg4 stage:(void *)arg5 completionBlock:(void *)arg6; // needs 6 arg types, found 11: MNGuidanceManager *, NSString *, bool, unsigned long long, unsigned long long, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, unsigned long long, void*
- (void)guidanceManager:(MNGuidanceManager *)arg1 didProcessSpeechEvent:(GEOComposedGuidanceEvent *)arg2;
- (void)guidanceManager:(MNGuidanceManager *)arg1 didUpdateNavTrayGuidance:(MNNavTrayGuidanceEvent *)arg2;
