...
- (void)locationTracker:(MNLocationTracker *)arg1 didSwitchToNewTransportTypeWithRoute:(MNActiveRouteInfo *)arg2 rerouteReason:(unsigned long long)arg3 request:(GEODirectionsRequest *)arg4 response:(GEODirectionsResponse *)arg5;
