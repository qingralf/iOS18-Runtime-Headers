...
- (id)initWithTimeCodeTrack:(AVAssetTrack *)arg1 assetReader:(AVAssetReader *)arg2 associatedMetadataTracks:(NSArray *)arg3 version:(MIOVersion *)arg4 unknownStreamId:(NSString *)arg5 reader:(MOVStreamReader *)arg6 delegate:(id <MOVStreamReaderDelegate>)arg7 error:(id*)arg8;
- (id)initWithVideoTrack:(AVAssetTrack *)arg1 assetReader:(AVAssetReader *)arg2 associatedMetadataTracks:(NSArray *)arg3 version:(MIOVersion *)arg4 bufferCacheMode:(int)arg5 unknownStreamId:(NSString *)arg6 reader:(MOVStreamReader *)arg7 delegate:(id <MOVStreamReaderDelegate>)arg8 error:(id*)arg9;
