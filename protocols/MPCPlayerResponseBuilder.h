...
- (MPModelGenericObject *)lastSectionModelObject:(MPModelGenericObject *)arg1 propertySet:(MPPropertySet *)arg2 chain:(MPMiddlewareChain *)arg3;
- (MPNowPlayingParticipant *)participant:(MPNowPlayingParticipant *)arg1 atIndexPath:(NSIndexPath *)arg2 chain:(MPMiddlewareChain *)arg3;
...
- (NSString *)playerItemContentID:(NSString *)arg1 atIndexPath:(NSIndexPath *)arg2 chain:(MPMiddlewareChain *)arg3;
- (NSArray *)playerItemCurrentLanguageOptions:(NSArray *)arg1 atIndexPath:(NSIndexPath *)arg2 chain:(MPMiddlewareChain *)arg3;
- (struct { double x1; double x2; double x3; double x4; double x5; float x6; float x7; bool x8; bool x9; bool x10; })playerItemDuration:(struct { double x1; double x2; double x3; double x4; double x5; float x6; float x7; bool x8; bool x9; bool x10; })arg1 atIndexPath:(NSIndexPath *)arg2 chain:(MPMiddlewareChain *)arg3;
...
- (bool)playerItemIsFavoritable:(bool)arg1 atIndexPath:(NSIndexPath *)arg2 chain:(MPMiddlewareChain *)arg3;
...
- (double)playerSleepTimerFireDate:(double)arg1 chain:(MPMiddlewareChain *)arg2;
- (long long)playerSleepTimerStopMode:(long long)arg1 chain:(MPMiddlewareChain *)arg2;
- (double)playerSleepTimerTime:(double)arg1 chain:(MPMiddlewareChain *)arg2;
...
- (NSString *)queueItemIdentifier:(NSString *)arg1 atIndexPath:(NSIndexPath *)arg2 chain:(MPMiddlewareChain *)arg3;
- (ICMusicSubscriptionStatus *)requestingUserSubscriptionStatus:(ICMusicSubscriptionStatus *)arg1 chain:(MPMiddlewareChain *)arg2;
- (bool)sectionIsAutoPlaySection:(bool)arg1 atIndex:(long long)arg2 chain:(MPMiddlewareChain *)arg3;
- (NSDictionary *)tracklistProperties:(NSDictionary *)arg1 chain:(MPMiddlewareChain *)arg2;
