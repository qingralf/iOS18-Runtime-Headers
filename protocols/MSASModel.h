...
- (void)validateInvitationForAlbum:(void *)arg1 completionBlock:(void *)arg2; // needs 2 arg types, found 8: MSASAlbum *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, NSError *, void*
