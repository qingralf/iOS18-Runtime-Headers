...
- (<MTLLogState> *)newLogStateWithDescriptor:(MTLLogStateDescriptor *)arg1 error:(id*)arg2;
...
- (<MTLResidencySet> *)newResidencySetWithDescriptor:(MTLResidencySetDescriptor *)arg1 error:(id*)arg2;
