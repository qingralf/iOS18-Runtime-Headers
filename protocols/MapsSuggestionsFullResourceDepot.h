...
- (void)setOneAppGuardian:(MapsSuggestionsAppGuardian *)arg1;
- (void)setOneAppProtectionConnector:(id <MapsSuggestionsAppProtectionConnector>)arg1;
- (void)setOneBiome:(MapsSuggestionsBiome *)arg1;
- (void)setOneBiomeConnector:(id <MapsSuggestionsBiomeConnector>)arg1;
- (void)setOneContactActivity:(MapsSuggestionsContactActivity *)arg1;
...
- (void)setOneFindMy:(MapsSuggestionsFindMy *)arg1;
