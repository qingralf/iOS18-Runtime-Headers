...
- (void)handleCredentialsUpdate:(void *)arg1 forUniqueID:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 8: NSSet *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
