...
- (void)LILookup:(void *)arg1 name:(void *)arg2 reply:(void *)arg3; // needs 3 arg types, found 15: NSString *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, int, int, NSString *, NSData *, NSString *, NSData *, NSData *, NSData *, void*
