...
- (void)mediaViewDidEndDecelerating:(NUMediaView *)arg1;
- (void)mediaViewDidEndDragging:(NUMediaView *)arg1 willDecelerate:(bool)arg2;
...
- (void)mediaViewDidPlayToEnd:(NUMediaView *)arg1;
...
- (void)mediaViewWillBeginDragging:(NUMediaView *)arg1;
