...
- (int)loadPetsRegionsWithOptions:(void *)arg1 resultHandler:(void *)arg2; // needs 2 arg types, found 9: PFParallaxAssetRequestOptions *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSArray *, NSArray *, NSError *, void*
