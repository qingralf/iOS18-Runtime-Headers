...
- (PGTitleTuple *)titleWithHighlightInfo:(PGHighlightTailorHighlightInfo *)arg1 sharingFilter:(unsigned short)arg2 curatedAssets:(NSArray *)arg3 keyAsset:(PHAsset *)arg4 createVerboseTitle:(bool)arg5 error:(out id*)arg6;
