...
- (void)paletteViewContentSizeDidChange:(PKDrawingPaletteView *)arg1;

@optional

- (void)paletteView:(PKDrawingPaletteView *)arg1 didChangeColor:(UIColor *)arg2;
- (void)paletteView:(PKDrawingPaletteView *)arg1 didReceivePencilInteractionDidTap:(UIPencilInteraction *)arg2;
