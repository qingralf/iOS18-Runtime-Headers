...
- (void)passFooterContentViewDidInvalidateAuthorization:(PKPassFooterContentView *)arg1;
- (void)passFooterContentViewDidTransact:(PKPassFooterContentView *)arg1 success:(bool)arg2;
