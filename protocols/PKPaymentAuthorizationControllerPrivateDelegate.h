...
- (void)paymentAuthorizationController:(void *)arg1 didRequestMerchantSessionWithURL:(void *)arg2 merchantSessionUpdate:(void *)arg3; // needs 3 arg types, found 8: PKPaymentAuthorizationController *, NSURL *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, PKPaymentRequestMerchantSessionUpdate *, void*
