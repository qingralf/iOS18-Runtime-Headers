...
- (void)carKeyAcceptInvitationWithInvitationIdentifier:(void *)arg1 activationCode:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 8: NSString *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, DAShareRecipientResult *, void*
- (void)carKeyAccountAttestationRequestForCredential:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 8: PKAppletSubcredential *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, PKAppletSubcredentialAccountAttestationRequest *, NSError *, void*
- (void)carKeyDecryptData:(void *)arg1 credential:(void *)arg2 ephemeralPublicKey:(void *)arg3 completion:(void *)arg4; // needs 4 arg types, found 10: NSData *, PKAppletSubcredential *, NSData *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSData *, NSError *, void*
- (void)carKeyGetPretrackRequestForKeyWithInvitationIdentifier:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 8: NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, PKSubcredentialEncryptedContainer *, NSError *, void*
- (void)carKeyGetProductPlanIdentifierRequestForInvitationWithIdentifier:(void *)arg1 transportIdentifier:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 9: NSString *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, PKSubcredentialEncryptedContainer *, NSError *, void*
- (void)carKeyHandleRecipientMessage:(void *)arg1 forInvitationIdentifier:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 8: PKSharingCarKeyMessage *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, DAShareRecipientResult *, void*
- (void)carKeyRejectInvitation:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 8: PKSharingCarKeyMessage *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, PKSharingCarKeyMessage *, NSError *, void*
- (void)carKeyRetryActivationCodeWithInvitationIdentifier:(void *)arg1 activationCode:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 8: NSString *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, DAShareRecipientResult *, void*
- (void)carKeyRoutingInformationForInvitationWithIdentifier:(void *)arg1 transportIdentifier:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 9: NSString *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSString *, NSError *, void*
- (void)carKeySetAccountAttestation:(void *)arg1 forCredential:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 8: NSData *, PKAppletSubcredential *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
- (void)carKeySetEncryptedProductPlanIdentifierContainer:(void *)arg1 invitationIdentifier:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 8: PKSubcredentialEncryptedContainer *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
- (void)carKeyStartShareAcceptanceFlow:(void *)arg1 transportIdentifier:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 8: PKSharingCarKeyInvitation *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
- (void)carKeyUpdateTrackingAttestation:(void *)arg1 forCredential:(void *)arg2 encryptedContainer:(void *)arg3 completion:(void *)arg4; // needs 4 arg types, found 9: NSData *, PKAppletSubcredential *, PKSubcredentialEncryptedContainer *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, void*
...
- (void)clearProvisioningSupportDataOfType:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 6: unsigned long long, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, void*
...
- (void)createShareInvitationForPartialShareInvitation:(void *)arg1 existingTransportIdentifier:(void *)arg2 authorization:(void *)arg3 completion:(void *)arg4; // needs 4 arg types, found 11: PKPartialShareInvitation *, NSString *, NSData *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, PKSharingMessage *, PKPassShare *, NSError *, void*
...
- (void)generateAuxiliaryCapabilitiesForRequirements:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 8: NSArray *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSMapTable *, NSError *, void*
...
- (void)generateIdentityProvisioningAttestationsWithISOCredential:(void *)arg1 pairingID:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 9: NSString *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, PKIdentityProvisioningAttestations *, NSError *, void*
...
- (NSSet *)passesWithReaderIdentifier:(NSString *)arg1;
...
- (void)plansForPaymentPassWithUniqueIdentifier:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 7: NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSArray *, void*
...
- (void)rejectShareForMailboxAddress:(NSString *)arg1;
...
- (void)removeExpressPassWithUniqueIdentifierV2:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 8: NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, NSSet *, void*
...
- (void)revokeCredentialsWithReaderIdentifiers:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 7: NSSet *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, void*
...
- (void)saveProvisioningSupportData:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 7: NSArray *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
- (bool)secureElementIsAvailable;
- (bool)secureElementSupportsExpressMode;
- (void)serviceProviderDataForSecureElementPass:(void *)arg1 encrypted:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 9: PKSecureElementPass *, bool, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSDictionary *, NSError *, void*
