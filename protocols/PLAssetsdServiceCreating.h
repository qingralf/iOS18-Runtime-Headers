...
- (void)getLibraryManagementServiceWithReply:(void *)arg1; // needs 1 arg types, found 7: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, <PLAssetsdLibraryManagementServiceProtocol> *, NSError *, void*
...
- (void)getNonBindingDebugServiceWithReply:(void *)arg1; // needs 1 arg types, found 7: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, <PLAssetsdNonBindingDebugServiceProtocol> *, NSError *, void*
...
- (void)getPhotoKitAddServiceWithReply:(void *)arg1; // needs 1 arg types, found 7: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, <PLAssetsdPhotoKitAddServiceProtocol> *, NSError *, void*
- (void)getPhotoKitServiceWithReply:(void *)arg1; // needs 1 arg types, found 7: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, <PLAssetsdPhotoKitServiceProtocol> *, NSError *, void*
- (void)getPrivacySupportServiceWithReply:(void *)arg1; // needs 1 arg types, found 7: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, <PLAssetsdPrivacySupportServiceProtocol> *, NSError *, void*
- (void)getResourceAvailabilityServiceWithReply:(void *)arg1; // needs 1 arg types, found 7: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, <PLAssetsdResourceAvailabilityServiceProtocol> *, NSError *, void*
...
- (void)getSystemLibraryURLReadOnlyServiceWithReply:(void *)arg1; // needs 1 arg types, found 7: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, <PLAssetsdSystemLibraryURLReadOnlyServiceProtocol> *, NSError *, void*
