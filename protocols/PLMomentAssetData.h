...
- (<PLPhotosHighlightData> *)dayHighlightBeingCollageAssetsMixed;
- (<PLPhotosHighlightData> *)dayHighlightBeingCollageAssetsPrivate;
- (<PLPhotosHighlightData> *)dayHighlightBeingCollageAssetsShared;
- (bool)favorite;
- (NSString *)globalUUID;
...
- (void)setDayHighlightBeingCollageAssetsMixed:(id <PLPhotosHighlightData>)arg1;
- (void)setDayHighlightBeingCollageAssetsPrivate:(id <PLPhotosHighlightData>)arg1;
- (void)setDayHighlightBeingCollageAssetsShared:(id <PLPhotosHighlightData>)arg1;
