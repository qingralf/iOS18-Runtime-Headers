...
- (void)executeFetchEmbeddingQuery:(void *)arg1 batchHandler:(void *)arg2; // needs 2 arg types, found 8: PSIQuery *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, PSIQuery *, NSMutableArray *, void*
...
- (NSArray *)groupsFromGroupIds:(struct __CFSet { }*)arg1 dateFilter:(PSIDateFilter *)arg2 searchResultTypes:(unsigned long long)arg3;
