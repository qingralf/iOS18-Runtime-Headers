...
- (bool)oneUpAccessoryViewControllersManager:(PUOneUpAccessoryViewControllersManager *)arg1 preventAlbumAttributionWidgetForAssetReference:(PUAssetReference *)arg2;
