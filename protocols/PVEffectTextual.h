...
- (NSAttributedString *)attributedStringAtIndex:(unsigned long long)arg1;
...
- (NSString *)mainTitle;
- (int)orientation;
- (void)setAttributedString:(NSAttributedString *)arg1 atIndex:(unsigned long long)arg2;
- (void)setMainTitle:(NSString *)arg1;
- (void)setString:(NSString *)arg1 atIndex:(unsigned long long)arg2;
...
- (NSArray *)textTransformsAtTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg1 forcePosterFrame:(bool)arg2 includeTransformAnimation:(bool)arg3 includePlayableAspectScale:(bool)arg4 viewSize:(struct CGSize { double x1; double x2; })arg5 viewOrigin:(int)arg6;
