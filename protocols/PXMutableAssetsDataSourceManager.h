...
- (void)setCurationEnabledForAllCollections:(bool)arg1 curationLength:(long long)arg2 collectionsToDiff:(NSSet *)arg3;
...
- (void)setIncludeOthersInSocialGroupAssets:(bool)arg1 provideIncrementalChangeDetailsForAssetCollections:(NSSet *)arg2;
