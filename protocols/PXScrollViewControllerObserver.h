...
- (bool)scrollViewController:(PXScrollViewController *)arg1 shouldBeginScrollingWithPanAtLocation:(struct CGPoint { double x1; double x2; })arg2 inCoordinateSpace:(id <UICoordinateSpace>)arg3 velocity:(struct CGPoint { double x1; double x2; })arg4;
