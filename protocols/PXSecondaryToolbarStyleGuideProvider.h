...
- (double)secondaryToolbarControllerMaximumAccessoryViewPaddingToContentView:(PXSecondaryToolbarController *)arg1;
- (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })secondaryToolbarControllerScrollableContentPadding:(PXSecondaryToolbarController *)arg1;
