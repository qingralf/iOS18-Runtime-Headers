...
- (unsigned long long)currentRecommendedChargeLimitWithError:(id*)arg1;
- (void)currentRecommendedChargeLimitWithHandler:(void *)arg1; // needs 1 arg types, found 7: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, unsigned long long, NSError *, void*
...
- (unsigned char)getMCLLimitWithError:(id*)arg1;
- (void)getMCLLimitWithHandler:(void *)arg1; // needs 1 arg types, found 7: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, unsigned char, NSError *, void*
...
- (bool)setMCLLimit:(unsigned char)arg1 error:(id*)arg2;
- (void)setMCLLimit:(void *)arg1 withHandler:(void *)arg2; // needs 2 arg types, found 8: unsigned char, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, NSError *, void*
...
- (void)temporarilyDisableMCLWithHandler:(void *)arg1; // needs 1 arg types, found 7: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, NSError *, void*
