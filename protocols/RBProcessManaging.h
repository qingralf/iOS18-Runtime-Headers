...
- (void)executeLaunchRequest:(void *)arg1 withCompletion:(void *)arg2; // needs 2 arg types, found 9: RBSLaunchRequest *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, RBSProcessHandle *, NSDictionary *, NSError *, void*
