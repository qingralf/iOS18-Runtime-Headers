...
- (oneway void)saveClipToCameraRoll:(void *)arg1 extensionToken:(void *)arg2 handler:(void *)arg3; // needs 3 arg types, found 8: NSURL *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
