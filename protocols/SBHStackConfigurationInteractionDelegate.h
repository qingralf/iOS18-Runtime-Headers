...
- (double)stackConfigurationInteraction:(SBHStackConfigurationInteraction *)arg1 iconContentScaleForGridSizeClass:(NSString *)arg2;
...
- (bool)stackConfigurationInteractionShouldDisallowLabelArea:(SBHStackConfigurationInteraction *)arg1;
