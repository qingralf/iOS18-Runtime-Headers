...
- (double)stackConfigurationViewController:(SBHStackConfigurationViewController *)arg1 iconContentScaleForGridSizeClass:(NSString *)arg2;
...
- (bool)stackConfigurationViewControllerShouldDisallowLabelArea:(SBHStackConfigurationViewController *)arg1;
