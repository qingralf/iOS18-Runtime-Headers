...
- (bool)icon:(SBLeafIcon *)arg1 canMakeIconLayerQuicklyWithInfo:(struct SBIconImageInfo { struct CGSize { double x_1_1_1; double x_1_1_2; } x1; double x2; double x3; })arg2 traitCollection:(UITraitCollection *)arg3 options:(unsigned long long)arg4;
...
- (UIImage *)icon:(SBLeafIcon *)arg1 imageWithInfo:(struct SBIconImageInfo { struct CGSize { double x_1_1_1; double x_1_1_2; } x1; double x2; double x3; })arg2 traitCollection:(UITraitCollection *)arg3 options:(unsigned long long)arg4;
- (bool)icon:(SBLeafIcon *)arg1 launchFromLocation:(NSString *)arg2 context:(id)arg3;
- (CALayer *)icon:(SBLeafIcon *)arg1 layerWithInfo:(struct SBIconImageInfo { struct CGSize { double x_1_1_1; double x_1_1_2; } x1; double x2; double x3; })arg2 traitCollection:(UITraitCollection *)arg3 options:(unsigned long long)arg4;
- (void)icon:(SBLeafIcon *)arg1 prepareToMakeLayerWithInfo:(struct SBIconImageInfo { struct CGSize { double x_1_1_1; double x_1_1_2; } x1; double x2; double x3; })arg2 traitCollection:(UITraitCollection *)arg3 options:(unsigned long long)arg4;
