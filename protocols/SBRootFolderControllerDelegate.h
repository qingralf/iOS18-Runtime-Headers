...
- (void)rootFolderControllerWantsIconTintViewControllerPresented:(SBRootFolderController *)arg1;
- (void)rootFolderControllerWillAnimateWidgetInsertionForStackConfigurationInteraction:(SBRootFolderController *)arg1;
- (unsigned long long)widgetSheetPresenterTypeForRootFolderController:(SBRootFolderController *)arg1;
