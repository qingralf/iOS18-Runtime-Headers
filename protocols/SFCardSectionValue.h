...
- (void)setRfBinaryButtonCardSection:(RFBinaryButtonCardSection *)arg1;
- (void)setRfButtonCardSection:(RFButtonCardSection *)arg1;
- (void)setRfDisambiguationTitleCardSection:(RFDisambiguationTitleCardSection *)arg1;
...
- (void)setRfFactItemDetailedNumberCardSection:(RFFactItemDetailedNumberCardSection *)arg1;
- (void)setRfFactItemHeroButtonCardSection:(RFFactItemHeroButtonCardSection *)arg1;
- (void)setRfFactItemHeroNumberCardSection:(RFFactItemHeroNumberCardSection *)arg1;
- (void)setRfFactItemImageRightCardSection:(RFFactItemImageRightCardSection *)arg1;
- (void)setRfFactItemShortHeroNumberCardSection:(RFFactItemShortHeroNumberCardSection *)arg1;
...
- (void)setRfMapCardSection:(RFMapCardSection *)arg1;
- (void)setRfMultiButtonCardSection:(RFMultiButtonCardSection *)arg1;
- (void)setRfPrimaryHeaderMarqueeCardSection:(RFPrimaryHeaderMarqueeCardSection *)arg1;
- (void)setRfPrimaryHeaderRichCardSection:(RFPrimaryHeaderRichCardSection *)arg1;
- (void)setRfPrimaryHeaderStackedImageCardSection:(RFPrimaryHeaderStackedImageCardSection *)arg1;
- (void)setRfPrimaryHeaderStandardCardSection:(RFPrimaryHeaderStandardCardSection *)arg1;
- (void)setRfReferenceCenteredCardSection:(RFReferenceCenteredCardSection *)arg1;
- (void)setRfReferenceFootnoteCardSection:(RFReferenceFootnoteCardSection *)arg1;
- (void)setRfReferenceItemButtonCardSection:(RFReferenceItemButtonCardSection *)arg1;
- (void)setRfReferenceItemLogoCardSection:(RFReferenceItemLogoCardSection *)arg1;
- (void)setRfReferenceRichCardSection:(RFReferenceRichCardSection *)arg1;
- (void)setRfReferenceStandardCardSection:(RFReferenceStandardCardSection *)arg1;
- (void)setRfSecondaryHeaderEmphasizedCardSection:(RFSecondaryHeaderEmphasizedCardSection *)arg1;
- (void)setRfSecondaryHeaderStandardCardSection:(RFSecondaryHeaderStandardCardSection *)arg1;
- (void)setRfSimpleItemPlayerCardSection:(RFSimpleItemPlayerCardSection *)arg1;
- (void)setRfSimpleItemReverseRichCardSection:(RFSimpleItemReverseRichCardSection *)arg1;
- (void)setRfSimpleItemRichCardSection:(RFSimpleItemRichCardSection *)arg1;
- (void)setRfSimpleItemRichSearchResultCardSection:(RFSimpleItemRichSearchResultCardSection *)arg1;
- (void)setRfSimpleItemStandardCardSection:(RFSimpleItemStandardCardSection *)arg1;
- (void)setRfSimpleItemVisualElementCardSection:(RFSimpleItemVisualElementCardSection *)arg1;
- (void)setRfSummaryItemAlignedTextCardSection:(RFSummaryItemAlignedTextCardSection *)arg1;
- (void)setRfSummaryItemButtonCardSection:(RFSummaryItemButtonCardSection *)arg1;
- (void)setRfSummaryItemDetailedTextCardSection:(RFSummaryItemDetailedTextCardSection *)arg1;
- (void)setRfSummaryItemImageRightCardSection:(RFSummaryItemImageRightCardSection *)arg1;
- (void)setRfSummaryItemPairCardSection:(RFSummaryItemPairCardSection *)arg1;
- (void)setRfSummaryItemPairNumberCardSection:(RFSummaryItemPairNumberCardSection *)arg1;
- (void)setRfSummaryItemPlayerCardSection:(RFSummaryItemPlayerCardSection *)arg1;
...
- (void)setRfSummaryItemSwitchV2CardSection:(RFSummaryItemSwitchV2CardSection *)arg1;
- (void)setRfSummaryItemTextCardSection:(RFSummaryItemTextCardSection *)arg1;
- (void)setRfTableHeaderCardSection:(RFTableHeaderCardSection *)arg1;
- (void)setRfTableRowCardSection:(RFTableRowCardSection *)arg1;
- (void)setRichTitleCardSection:(SFRichTitleCardSection *)arg1;
- (void)setRowCardSection:(SFRowCardSection *)arg1;
- (void)setSafariTableOfContentsCardSection:(SFSafariTableOfContentsCardSection *)arg1;
