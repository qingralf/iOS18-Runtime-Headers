...
- (void)collectFormMetadataForTestingAtURL:(NSURL *)arg1;
- (void)collectURLsForPrefillingAtURL:(NSURL *)arg1;
- (void)diagnosticsFormMetadataWithCompletionHandler:(void *)arg1; // needs 1 arg types, found 6: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSArray *, void*
...
- (void)setStrongPasswordElementViewableIfAppropriate:(bool)arg1 frame:(SFFormAutoFillFrameHandle *)arg2 passwordControlUniqueIDs:(NSArray *)arg3;
