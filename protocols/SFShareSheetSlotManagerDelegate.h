...
- (void)willPerformInServiceActivityWithRequest:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 9: UISUIActivityExtensionItemDataRequest *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSArray *, UISDActivityItemData *, NSError *, void*
