...
- (_SFDownload *)webViewController:(SFWebViewController *)arg1 didStartDownload:(WKDownload *)arg2;
...
- (void)webViewController:(void *)arg1 authenticationChallenge:(void *)arg2 shouldAllowLegacyTLS:(void *)arg3; // needs 3 arg types, found 8: SFWebViewController *, NSURLAuthenticationChallenge *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, void*
- (void)webViewController:(void *)arg1 contextMenuConfigurationForElement:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 8: SFWebViewController *, WKContextMenuElementInfo *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, UIContextMenuConfiguration *, void*
...
- (void)webViewController:(void *)arg1 requestNotificationPermissionForSecurityOrigin:(void *)arg2 decisionHandler:(void *)arg3; // needs 3 arg types, found 8: SFWebViewController *, WKSecurityOrigin *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, void*
- (void)webViewController:(void *)arg1 requestPresentingViewControllerWithCompletionHandler:(void *)arg2; // needs 2 arg types, found 8: SFWebViewController *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, UIViewController *, NSError *, void*
...
- (bool)webViewControllerCanFindNextOrPrevious:(SFWebViewController *)arg1;
- (bool)webViewControllerCanPromptForAccountSecurityRecommendation:(SFWebViewController *)arg1;
- (void)webViewControllerDidExitElementFullscreen:(SFWebViewController *)arg1;
...
- (void)webViewControllerDidUpdateCanEnterFullScreen:(SFWebViewController *)arg1;
- (void)webViewControllerDidUpdateNowPlayingStatus:(SFWebViewController *)arg1;
- (void)webViewControllerDidUpdateThemeColor:(SFWebViewController *)arg1;
- (bool)webViewControllerShouldAutofillESimInformation:(SFWebViewController *)arg1;
- (bool)webViewControllerShouldFillStringForFind:(SFWebViewController *)arg1;
