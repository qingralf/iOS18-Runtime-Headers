...
- (void)interactor:(void *)arg1 showingModeRestriction:(void *)arg2 continueHandler:(void *)arg3; // needs 3 arg types, found 8: <SHSheetInteractor> *, UIActivityCollaborationModeRestriction *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, void*
