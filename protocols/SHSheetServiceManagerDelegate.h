...
- (void)serviceManager:(void *)arg1 willPerformActivityInServiceForRequest:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 10: SHSheetServiceManager *, UISUIActivityExtensionItemDataRequest *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSArray *, UISDActivityItemData *, NSError *, void*
