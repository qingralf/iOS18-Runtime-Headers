...
- (void)postToMessageBusWithMessage:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 8: NSData *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, NSError *, void*
...
- (void)submitExternalActivationRequestWithRequestInfo:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 8: AFRequestInfo *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, NSError *, void*
