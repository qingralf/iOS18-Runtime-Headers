...
- (void)fetchSuggestedCheckInURLForWorkoutSuggestionWithHandler:(void *)arg1; // needs 1 arg types, found 7: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSURL *, NSError *, void*
...
- (void)showAlwaysOnPromptWithConfiguration:(void *)arg1 handler:(void *)arg2; // needs 2 arg types, found 7: SMSessionConfiguration *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
