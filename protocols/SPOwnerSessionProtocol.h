...
- (void)delegatedLocationForContext:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 8: SPDelegatedLocationContext *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, SPDelegatedLocationResult *, NSError *, void*
...
- (void)peripheralConnectionMaterialForAccessoryIdentifier:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 8: NSUUID *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, SPPeripheralConnectionMaterial *, NSError *, void*
...
- (void)removeBeaconFromGroup:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 7: SPBeacon *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
...
- (void)setDelegatedLocationUpdateBlock:(void *)arg1; // needs 1 arg types, found 6: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, SPDelegatedLocationResult *, void*
- (void)setDeviceEventUpdateBlock:(void *)arg1; // needs 1 arg types, found 6: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, SPDeviceEventFetchResult *, void*
...
- (void)stopFetchingUnauthorizedEncryptedPayloadWithCompletion:(void *)arg1; // needs 1 arg types, found 6: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
- (void)stopRefreshing;
...
- (void)subscribeDelegatedLocationUpdatesForContext:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 7: SPDelegatedLocationContext *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
...
- (void)unsubscribeDelegatedLocationUpdatesWithCompletion:(void *)arg1; // needs 1 arg types, found 6: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
