...
- (NSString *)actOnRange:(void *)arg1 options:(void *)arg2 actionBlock:(void *)arg3; // needs 3 arg types, found 9: <SRCSTextMarkerRangeProtocol> *, NSDictionary *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, <SRCSTextMarkerRangeProtocol> *, NSString *, void*
