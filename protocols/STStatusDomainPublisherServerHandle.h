...
- (void)replaceDataChangeRecord:(void *)arg1 forPublisherClient:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 7: STStatusDomainDataChangeRecord *, <STStatusDomainPublisherClientHandle> *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, void*
- (void)replaceVolatileDataChangeRecord:(void *)arg1 forPublisherClient:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 7: STStatusDomainDataChangeRecord *, <STStatusDomainPublisherClientHandle> *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, void*
