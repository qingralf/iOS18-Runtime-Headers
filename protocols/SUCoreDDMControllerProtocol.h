...
- (SUCoreDDMDeclarationGlobalSettings *)globalSettingsDeclarationWithError:(id*)arg1;
- (bool)scheduleUpdate:(SUCoreDDMDeclaration *)arg1 withError:(id*)arg2;
- (bool)setGlobalSettings:(SUCoreDDMDeclarationGlobalSettings *)arg1 withError:(id*)arg2;
