...
- (void)sessionService:(id <SVXClientSessionServicing>)arg1 didBecomeActiveWithActivationContext:(SVXActivationContext *)arg2 turnID:(NSUUID *)arg3;
...
- (void)sessionService:(id <SVXClientSessionServicing>)arg1 willBecomeActiveWithActivationContext:(SVXActivationContext *)arg2 turnID:(NSUUID *)arg3;
