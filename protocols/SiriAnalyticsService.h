...
- (void)enqueueLargeMessageObjectFromPath:(void *)arg1 dataUploadEvent:(void *)arg2 requestIdentifier:(void *)arg3 completion:(void *)arg4; // needs 4 arg types, found 10: NSString *, DUSchemaDUEvent *, NSUUID *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, NSError *, void*
