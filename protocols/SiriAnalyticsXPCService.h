...
- (oneway void)publishUnorderedMessages:(void *)arg1 topic:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 7: NSArray *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, void*
- (oneway void)purgeStagedMessagesWithCompletion:(void *)arg1; // needs 1 arg types, found 7: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, NSError *, void*
...
- (oneway void)runPipelineWithCompletion:(void *)arg1; // needs 1 arg types, found 7: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, NSError *, void*
...
- (oneway void)vendResource:(void *)arg1 readonly:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 10: long long, bool, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSString *, NSURL *, NSError *, void*
