...
- (void)siriSnippetViewController:(id <SiriSharedUIViewControlling>)arg1 informHostOfBackgroundView:(UIView *)arg2 isSnippetAsyncColored:(bool)arg3;
- (void)siriSnippetViewController:(id <SiriSharedUIViewControlling>)arg1 isBackgroundColorUpdateSuccessful:(bool)arg2;
