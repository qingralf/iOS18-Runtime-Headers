...
- (void)debugForceSurfaceStagedDetections:(NSData *)arg1 deviceType:(unsigned long long)arg2 detailsBitmask:(unsigned int)arg3;
- (void)debugStageTADetection:(NSData *)arg1 deviceType:(unsigned long long)arg2 detailsBitmask:(unsigned int)arg3;
