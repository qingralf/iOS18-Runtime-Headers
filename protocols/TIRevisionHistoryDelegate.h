...
- (void)decrementLanguageModelCount:(NSString *)arg1 latinInputString:(NSString *)arg2 tokenID:(struct TITokenID { unsigned int x1; unsigned int x2; })arg3 contextTokens:(TIContextTokens *)arg4;
...
- (void)incrementLanguageModelCount:(NSString *)arg1 latinInputString:(NSString *)arg2 tokenID:(struct TITokenID { unsigned int x1; unsigned int x2; })arg3 contextTokens:(TIContextTokens *)arg4 saveToDifferentialPrivacy:(int)arg5;
