...
- (NSDictionary *)getOnDemandReferenceCountsPerUserAtGlobalPath:(NSString *)arg1 error:(id*)arg2;
- (NSArray *)getSandboxExtensionTokensForIdentifierQueryWithError:(id*)arg1;
