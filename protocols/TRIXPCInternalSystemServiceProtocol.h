...
- (void)getOnDemandReferenceCountsPerUserAtGlobalPath:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 8: NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSDictionary *, NSError *, void*
...
- (void)saveAssetWithIdentifier:(void *)arg1 sourcePath:(void *)arg2 flockWitness:(void *)arg3 removeSourceOnFailure:(void *)arg4 sourceExtension:(void *)arg5 completion:(void *)arg6; // needs 6 arg types, found 11: NSString<TRIAssetId> *, NSString *, struct TRIFlockWitness_ { int x1; }*, bool, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, void*
