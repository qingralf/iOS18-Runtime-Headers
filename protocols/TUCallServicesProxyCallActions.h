...
- (oneway void)addScreenSharingType:(unsigned long long)arg1 forCallWithUniqueProxyIdentifier:(NSString *)arg2;
...
- (oneway void)setEmergencyMediaItems:(NSSet *)arg1 forCallWithUniqueProxyIdentifier:(NSString *)arg2;
- (oneway void)setHasEmergencyVideoStream:(bool)arg1 forCallWithUniqueProxyIdentifier:(NSString *)arg2;
- (oneway void)setIsSendingVideo:(bool)arg1 forCallWithUniqueProxyIdentifier:(NSString *)arg2;
- (oneway void)setLiveVoicemailUnavailableReason:(long long)arg1 forCallWithUniqueProxyIdentifier:(NSString *)arg2;
