...
- (void)endMediaRequestWithUUID:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 7: NSUUID *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
...
- (void)prewarmMediaRequest:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 8: TUMomentsMediaRecordRequest *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSUUID *, NSError *, void*
...
- (void)sendVideoMessageWithRequest:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 7: TUMomentsMessageSendRequest *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
- (void)setDelegate:(id <TUMomentsControllerDataSourceDelegate>)arg1;
- (void)startMediaRequest:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 8: TUMomentsMediaRecordRequest *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSUUID *, NSError *, void*
