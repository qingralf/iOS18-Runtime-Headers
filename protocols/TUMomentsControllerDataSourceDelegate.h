...
- (void)dataSource:(id <TUMomentsControllerDataSource>)arg1 didFinishRecordingMedia:(TUMomentsRawVideoMessageDescriptor *)arg2;
- (void)dataSource:(id <TUMomentsControllerDataSource>)arg1 didReceiveLocallyRequestedMomentDescriptor:(TUMomentDescriptor *)arg2;
- (void)dataSource:(id <TUMomentsControllerDataSource>)arg1 didReceiveMediaRecordingError:(NSError *)arg2;
