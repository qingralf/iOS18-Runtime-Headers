...
- (void)assetAvailablityUpdateForAccessory:(UARPAccessory *)arg1 assetID:(UARPAssetID *)arg2;
...
- (void)assetStagingPause:(UARPAccessory *)arg1;
- (void)assetStagingResume:(UARPAccessory *)arg1;
...
- (void)supportedAccessories:(NSSet *)arg1 forProductGroup:(UARPProductGroup *)arg2 isComplete:(bool)arg3;
