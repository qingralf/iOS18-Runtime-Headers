...
- (bool)getSupportedAccessories:(NSString *)arg1 assetID:(UARPAssetID *)arg2 batchRequest:(bool)arg3;
- (bool)getSupportedAccessories:(NSMutableSet *)arg1 forProductGroup:(NSString *)arg2;
