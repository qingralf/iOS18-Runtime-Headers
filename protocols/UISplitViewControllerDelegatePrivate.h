...
- (long long)_splitViewController:(UISplitViewController *)arg1 overrideProposedPermission:(long long)arg2 forInteractivePresentationGesture:(UIGestureRecognizer *)arg3 inView:(UIView *)arg4;
