...
- (UIColor *)defaultAccessoryBackgroundColorForAccessorySystemType:(long long)arg1 header:(bool)arg2 sidebarStyle:(long long)arg3 cellConfigurationState:(UICellConfigurationState *)arg4 traitCollection:(UITraitCollection *)arg5;
- (UIColor *)defaultAccessoryTintColorForAccessorySystemType:(long long)arg1 header:(bool)arg2 sidebarStyle:(long long)arg3 cellConfigurationState:(UICellConfigurationState *)arg4 traitCollection:(UITraitCollection *)arg5 inheritedTintColor:(UIColor *)arg6;
...
- (double)defaultRowHeightForTableView:(id <UITableConstantsTableProviding>)arg1 cellStyle:(long long)arg2 hasDetailText:(bool)arg3;
...
- (struct _UITableConstantsBackgroundProperties { long long x1; id x2; id x3; id x4; bool x5; long long x6; long long x7; double x8; double x9; bool x10; id x11; long long x12; double x13; struct NSDirectionalEdgeInsets { double x_14_1_1; double x_14_1_2; double x_14_1_3; double x_14_1_4; } x14; })defaultSidebarHeaderBackgroundPropertiesWithState:(id <_UICellConfigurationStateReadonly>)arg1 traitCollection:(UITraitCollection *)arg2;
...
- (struct { id x1; id x2; id x3; id x4; id x5; id x6; double x7; long long x8; long long x9; long long x10; })contentPropertiesForSidebarElementWithTraitCollection:(UITraitCollection *)arg1 state:(id <_UICellConfigurationStateReadonly>)arg2 isHeader:(bool)arg3 cellStyle:(long long)arg4 sidebarStyle:(long long)arg5;
...
- (UIColor *)defaultSidebarImageTintColorForTraitCollection:(UITraitCollection *)arg1 state:(id <_UICellConfigurationStateReadonly>)arg2 isHeader:(bool)arg3 style:(long long)arg4;
...
- (UIColor *)defaultSidebarTextColorForTraitCollection:(UITraitCollection *)arg1 state:(id <_UICellConfigurationStateReadonly>)arg2 isHeader:(bool)arg3 isSecondaryText:(bool)arg4 style:(long long)arg5;
