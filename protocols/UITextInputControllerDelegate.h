...
- (void)textInput:(UITextInputController *)arg1 didApplyAttributedText:(NSAttributedString *)arg2 toCharacterRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg3;
...
- (void)textInput:(UITextInputController *)arg1 undoRedoDidApplyAttributedText:(NSAttributedString *)arg2 toCharacterRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg3;
- (void)textInput:(UITextInputController *)arg1 willChangeCharactersInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2;
