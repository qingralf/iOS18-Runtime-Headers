...
- (struct CGPoint { double x1; double x2; })_convertPointToRenderSpace:(struct CGPoint { double x1; double x2; })arg1 textRange:(UITextRange *)arg2;
...
- (bool)canPerformDictationAction:(NSString *)arg1;
