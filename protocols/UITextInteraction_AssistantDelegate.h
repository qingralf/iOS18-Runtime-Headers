...
- (struct CGPoint { double x1; double x2; })convertPointToRenderSpace:(struct CGPoint { double x1; double x2; })arg1 textRange:(UITextRange *)arg2;
...
- (<_UIInvalidatable> *)obtainSelectionGrabberSuppressionAssertion;
- (void)presentMenuForInputUI:(NSString *)arg1 preferredArrowDirection:(long long)arg2;
