...
- (bool)audioUnit:(struct OpaqueAudioComponentInstance { }*)arg1 setParameter:(unsigned int)arg2 scope:(unsigned int)arg3 element:(unsigned int)arg4 value:(float)arg5 bufferOffsetInFrames:(unsigned int)arg6 outStatus:(int*)arg7;
