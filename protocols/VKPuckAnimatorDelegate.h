...
- (void)puckAnimator:(VKPuckAnimator *)arg1 updatedPosition:(const void*)arg2 course:(const void*)arg3 polylineCoordinate:(struct PolylineCoordinate { unsigned int x1; float x2; })arg4;
