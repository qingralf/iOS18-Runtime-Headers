...
- (void)getExternalPasskeyRequestForApplicationIdentifier:(void *)arg1 relyingPartyIdentifier:(void *)arg2 credentialID:(void *)arg3 completionHandler:(void *)arg4; // needs 4 arg types, found 9: NSString *, NSString *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, ASPasskeyCredentialRequest *, void*
- (void)getExternalPasskeyRequestForWebFrameIdentifier:(void *)arg1 relyingPartyIdentifier:(void *)arg2 credentialID:(void *)arg3 completionHandler:(void *)arg4; // needs 4 arg types, found 9: WBSGlobalFrameIdentifier *, NSString *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, ASPasskeyCredentialRequest *, void*
- (void)getIsPasskeyAssertionRequestRunningForWebFrameIdentifier:(void *)arg1 orApplicationIdentifier:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 8: WBSGlobalFrameIdentifier *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, void*
...
- (void)getPasskeyAssertionRequestParametersForCABLEWithCompletionHandler:(void *)arg1; // needs 1 arg types, found 6: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, ASPasskeyCredentialRequestParameters *, void*
...
- (void)isOrigin:(void *)arg1 relatedToRelyingPartyIdentifier:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 8: NSString *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, void*
