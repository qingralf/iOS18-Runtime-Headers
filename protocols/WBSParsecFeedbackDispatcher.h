...
- (void)userDidEngageWithCompletionListItem:(id <WBSCompletionListItem>)arg1 onActionButton:(bool)arg2 method:(long long)arg3 doesMatchSiriSuggestion:(bool)arg4 voiceSearchQueryID:(NSNumber *)arg5;
