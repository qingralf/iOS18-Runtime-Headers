...
- (bool)preferenceShouldBeEnabled:(WBSPerSitePreference *)arg1 forDomain:(NSString *)arg2;
- (bool)preferenceShouldBeEnabledForDefaultValue:(WBSPerSitePreference *)arg1;
- (bool)preferenceShowsTabsInPrivateBrowsing:(WBSPerSitePreference *)arg1;
- (bool)shouldDeleteUnrecognizedPreference;
- (bool)shouldUseSmallWarningIconForPreference:(WBSPerSitePreference *)arg1;
