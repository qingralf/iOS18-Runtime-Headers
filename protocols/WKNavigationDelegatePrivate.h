...
- (void)_webCryptoMasterKeyForWebView:(void *)arg1 completionHandler:(void *)arg2; // needs 2 arg types, found 7: WKWebView *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSData *, void*
...
- (void)_webView:(WKWebView *)arg1 didPromptForStorageAccess:(NSString *)arg2 forSubFrameDomain:(NSString *)arg3 forQuirk:(bool)arg4;
