...
- (bool)_focusWebViewFromServiceWorker:(WKWebView *)arg1;
- (NSString *)_hostSceneBundleIdentifierForWebView:(WKWebView *)arg1;
- (NSString *)_hostSceneIdentifierForWebView:(WKWebView *)arg1;
...
- (void)_webView:(WKWebView *)arg1 didAdjustVisibilityWithSelectors:(NSArray *)arg2;
...
- (void)_webView:(void *)arg1 requestStorageAccessPanelForDomain:(void *)arg2 underCurrentDomain:(void *)arg3 forQuirkDomains:(void *)arg4 completionHandler:(void *)arg5; // needs 5 arg types, found 10: WKWebView *, NSString *, NSString *, NSDictionary *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, void*
...
- (void)_webView:(void *)arg1 requestWebAuthenticationConditionalMediationRegistrationForUser:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 8: WKWebView *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, void*
...
- (void)_webView:(void *)arg1 startXRSessionWithFeatures:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 9: WKWebView *, unsigned long long, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, id, UIViewController *, void*
- (void)_webView:(WKWebView *)arg1 supportedXRSessionFeatures:(unsigned long long*)arg2 arFeatures:(unsigned long long*)arg3;
...
- (void)_webViewEndXRSession:(WKWebView *)arg1 withReason:(long long)arg2;
...
- (void)_webViewRecentlyAccessedGamepadsForTesting:(WKWebView *)arg1;
- (void)_webViewRequestPointerLock:(WKWebView *)arg1;
- (void)_webViewStatusBarWasTapped:(WKWebView *)arg1;
- (void)_webViewStoppedAccessingGamepadsForTesting:(WKWebView *)arg1;
