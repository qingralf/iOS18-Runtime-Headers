...
- (oneway void)handleInteraction:(void *)arg1 keybagLockPolicy:(void *)arg2 action:(void *)arg3 handler:(void *)arg4; // needs 4 arg types, found 9: WRWidgetRendererSessionKey *, NSNumber *, LNAction *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
