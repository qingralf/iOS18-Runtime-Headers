...
- (void)getControlTemplatesWithRequests:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 7: NSArray *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
...
- (void)getWidgetRelevancesWithRequest:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 7: _TtC9WidgetKit22WidgetRelevanceRequest *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
...
- (void)invalidate;
- (void)performCleanup;
- (void)pushTokensDidChange:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 7: _TtC9WidgetKit33ControlsConfigurationXPCContainer *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
- (void)setControlState:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 7: _TtC9WidgetKit25ModifyControlStateRequest *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
