...
- (void)loadModelNewInstance:(void *)arg1 options:(void *)arg2 modelInstParams:(void *)arg3 qos:(void *)arg4 withReply:(void *)arg5; // needs 5 arg types, found 16: _ANEModel *, NSDictionary *, _ANEModelInstanceParameters *, unsigned int, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, NSDictionary *, unsigned long long, unsigned long long, BOOL, NSString *, NSError *, void*
...
- (void)reportTelemetryToPPS:(NSString *)arg1 playload:(NSDictionary *)arg2;
