...
- (void)credentialListViewController:(void *)arg1 didFinishWithOneTimeCodeCredential:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 7: _ASCredentialListViewController *, ASOneTimeCodeCredential *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, void*
...
- (void)credentialListViewController:(void *)arg1 didFinishWithText:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 7: _ASCredentialListViewController *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, void*
