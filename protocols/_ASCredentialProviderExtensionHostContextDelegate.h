...
- (void)prepareToCompleteOneTimeCodeRequestWithHostContext:(void *)arg1 credential:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 7: _ASCredentialProviderExtensionHostContext *, ASOneTimeCodeCredential *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, void*
...
- (void)prepareToCompleteSelectionRequestWithHostContext:(void *)arg1 text:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 7: _ASCredentialProviderExtensionHostContext *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, void*
