...
- (void)prepareToCompleteOneTimeCodeRequestWithSelectedCredential:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 6: ASOneTimeCodeCredential *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, void*
...
- (void)prepareToCompleteRequestWithSelectedText:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 6: NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, void*
