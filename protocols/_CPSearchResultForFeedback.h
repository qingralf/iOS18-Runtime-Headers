...
- (void)setPhotosAggregatedInfo:(_CPPhotosAggregatedInfo *)arg1;
- (void)setPhotosAttributes:(_CPPhotosAttributes *)arg1;
...
- (void)setSafariAttributes:(_CPSafariAttributes *)arg1;
