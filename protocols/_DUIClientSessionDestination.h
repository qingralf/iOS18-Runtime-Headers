...
- (oneway void)performDropWithItemCollection:(void *)arg1 dataProviderEndpoint:(void *)arg2 visibleDroppedItems:(void *)arg3 completion:(void *)arg4; // needs 4 arg types, found 9: PBItemCollection *, NSXPCListenerEndpoint *, NSArray *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, _DUITargetLayerDescriptor *, void*
