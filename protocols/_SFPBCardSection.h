...
- (void)addReferencedCommands:(_SFPBCommand *)arg1;
...
- (_SFPBCommand *)referencedCommandsAtIndex:(unsigned long long)arg1;
- (unsigned long long)referencedCommandsCount;
- (int)requiredLevelOfDetail;
- (NSString *)resultIdentifier;
- (_SFPBCommand *)secondaryCommand;
- (int)separatorStyle;
- (void)setAppEntityAnnotation:(_SFPBAppEntityAnnotation *)arg1;
...
- (void)setSecondaryCommand:(_SFPBCommand *)arg1;
