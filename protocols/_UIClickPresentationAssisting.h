...
- (id /* block */)keyboardAssertionInvalidationHandler:(void *)arg1; // needs 1 arg types, found 6: id /* block */, UIResponder *, _UIClickPresentation *, void*, id, SEL
...
- (void)setKeyboardAssertionInvalidationHandler:(void *)arg1; // needs 1 arg types, found 7: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, bool, id /* block */, UIResponder *, _UIClickPresentation *, void*
