...
- (void)solveForContainer:(_UICollectionLayoutContainer *)arg1 supplementaryContainer:(id <NSCollectionLayoutContainer>)arg2 traitCollection:(UITraitCollection *)arg3 layoutAxis:(unsigned long long)arg4 frameCount:(long long)arg5 preferredSizes:(_UICollectionPreferredSizes *)arg6 layoutRTL:(bool)arg7;
- (void)solveForContainer:(_UICollectionLayoutContainer *)arg1 traitCollection:(UITraitCollection *)arg2 layoutAxis:(unsigned long long)arg3 frameCount:(long long)arg4;
- (void)solveForContainer:(_UICollectionLayoutContainer *)arg1 traitCollection:(UITraitCollection *)arg2 layoutAxis:(unsigned long long)arg3 frameCount:(long long)arg4 preferredSizes:(_UICollectionPreferredSizes *)arg5;
...
- (_UICollectionLayoutFramesQueryResult *)unpinnedSectionSupplementaryFrameWithKind:(NSString *)arg1 forIndex:(long long)arg2;
