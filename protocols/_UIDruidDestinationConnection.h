...
- (id /* block */)dropPerformBlock:(void *)arg1; // needs 1 arg types, found 8: id /* block */, PBItemCollection *, NSArray *, NSArray *, id*, void*, id, SEL
...
- (void)requestDropWithOperation:(unsigned long long)arg1 layerContext:(_DUITargetLayerDescriptor *)arg2;
...
- (void)setDropPerformBlock:(void *)arg1; // needs 1 arg types, found 9: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, PBItemCollection *, NSArray *, NSArray *, id*, void*
...
- (void)setUpdatedPresentationBlock:(void *)arg1; // needs 1 arg types, found 6: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, _DUIPresentationUpdate *, void*
- (void)takePotentialDrop:(_DUIPotentialDrop *)arg1;
- (id /* block */)updatedPresentationBlock:(void *)arg1; // needs 1 arg types, found 5: id /* block */, _DUIPresentationUpdate *, void*, id, SEL
