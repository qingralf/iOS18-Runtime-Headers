...
- (id /* block */)canHandOffCancelledItemsBlock:(void *)arg1; // needs 1 arg types, found 6: id /* block */, NSArray *, id*, void*, id, SEL
- (void)cancelDrag;
...
- (bool)isCancelled;
- (void)setCanHandOffCancelledItemsBlock:(void *)arg1; // needs 1 arg types, found 7: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, bool, id /* block */, NSArray *, id*, void*
