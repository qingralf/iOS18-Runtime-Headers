...
- (long long)isRemoteRuleOwningElement:(id <_UIEventDeferringRuleOwning>)arg1 andContainingWindow:(UIWindow *)arg2 visibleComparedToLocalTargetWindow:(UIWindow *)arg3;
