...
- (_UIImageContentRendition *)_renditionForSource:(id <_UIImageContentLayoutSource>)arg1 size:(struct CGSize { double x1; double x2; })arg2 symbolConfiguration:(UIImageSymbolConfiguration *)arg3 withRenditionResult:(_UIImageContentRenditionResult *)arg4;
