...
- (void)titleViewChangedTabBarSizingDisposition:(UIView<_UINavigationBarAugmentedTitleView> *)arg1;
...
- (double)titleViewFloatingTabBarHeight:(UIView<_UINavigationBarAugmentedTitleView> *)arg1;
